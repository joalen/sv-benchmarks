...
struct imon_context {
   ...
   int touch_x ;
    klee_make_symbolic(&touch_x, sizeof(int), "touch_x");
   int touch_y ;
    klee_make_symbolic(&touch_y, sizeof(int), "touch_y");
};
...
static int display_type  ;
    klee_make_symbolic(&display_type, sizeof(int), "display_type");
static int pad_stabilize  =    1;
static bool nomouse  ;
static int pad_thresh  ;
    klee_make_symbolic(&pad_thresh, sizeof(int), "pad_thresh");
...
{ 
  ...
  unsigned int dow ;
    klee_make_symbolic(&dow, sizeof(int), "dow");
  unsigned int hour ;
...
{ 
  int usecs ;
    klee_make_symbolic(&usecs, sizeof(int), "usecs");
  int sec ;
...
{ 
  ...
  int prev_result ;
    klee_make_symbolic(&prev_result, sizeof(int), "prev_result");
  int hits ;
    klee_make_symbolic(&hits, sizeof(int), "hits");
  int result ;
    klee_make_symbolic(&result, sizeof(int), "result");
  int msec ;
    klee_make_symbolic(&msec, sizeof(int), "msec");
  int msec_hit ;
    klee_make_symbolic(&msec_hit, sizeof(int), "msec_hit");
  long ret ;
...
{ 
  char rel_x ;
    klee_make_symbolic(&rel_x, sizeof(char), "rel_x");
  char rel_y ;
    klee_make_symbolic(&rel_y, sizeof(char), "rel_y");
  u8 right_shift ;
  bool mouse_input ;
  int dir ;
...
{ 
  int press_type ;
    klee_make_symbolic(&press_type, sizeof(int), "press_type");
  unsigned long flags ;
  raw_spinlock_t *tmp ;
...
{ 
  ...
  int ifnum ;
  int code_length ;
    klee_make_symbolic(&code_length, sizeof(int), "code_length");
  int sysfs_err ;
    klee_make_symbolic(&sysfs_err, sizeof(int), "sysfs_err");
  int ret ;
  struct imon_context *ictx ;
...
{ 
  ...
  int res_imon_probe_36 ;
    klee_make_symbolic(&res_imon_probe_36, sizeof(int), "res_imon_probe_36");
  pm_message_t var_imon_suspend_38_p1 ;
  unsigned long var_imon_touch_display_timeout_13_p0 ;
    klee_make_symbolic(&var_imon_touch_display_timeout_13_p0, sizeof(long), "var_imon_touch_display_timeout_13_p0");
...
static int ldv_mutex_driver_lock  ;
    klee_make_symbolic(&ldv_mutex_driver_lock, sizeof(int), "ldv_mutex_driver_lock");
...
static int ldv_mutex_lock_of_imon_context  ;
    klee_make_symbolic(&ldv_mutex_lock_of_imon_context, sizeof(int), "ldv_mutex_lock_of_imon_context");
