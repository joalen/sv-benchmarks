...
struct vhci_hcd {
   ...
   unsigned long re_timeout ;
    klee_make_symbolic(&re_timeout, sizeof(long), "re_timeout");
   atomic_t seqnum ;
   struct vhci_device vdev[8U] ;
   int pending_port ;
    klee_make_symbolic(&pending_port, sizeof(int), "pending_port");
};
struct __wait_queue;
...
struct vhci_priv {
   unsigned long seqnum ;
    klee_make_symbolic(&seqnum, sizeof(long), "seqnum");
   struct list_head list ;
...
struct vhci_unlink {
   ...
   unsigned long unlink_seqnum ;
    klee_make_symbolic(&unlink_seqnum, sizeof(long), "unlink_seqnum");
};
enum hrtimer_restart;
struct hc_driver;
struct dma_pool;
...
extern unsigned long usbip_debug_flag ;
    klee_make_symbolic(&usbip_debug_flag, sizeof(long), "usbip_debug_flag");
...
{ 
  ...
  int sockfd ;
    klee_make_symbolic(&sockfd, sizeof(int), "sockfd");
  __u32 rhport ;
  __u32 devid ;
  __u32 speed ;
  struct task_struct *tmp___0 ;
...
{ 
  ...
  int rhport ;
    klee_make_symbolic(&rhport, sizeof(int), "rhport");
  int changed ;
...
{ 
  ...
  unsigned long flags2___0 ;
    klee_make_symbolic(&flags2___0, sizeof(long), "flags2___0");
  struct vhci_unlink *unlink ;
  raw_spinlock_t *tmp___3 ;
  void *tmp___4 ;
  struct task_struct *tmp___6 ;
...
{ 
  ...
  int var_vhci_urb_dequeue_9_p2 ;
    klee_make_symbolic(&var_vhci_urb_dequeue_9_p2, sizeof(int), "var_vhci_urb_dequeue_9_p2");
  ...
  int res_vhci_hcd_probe_20 ;
    klee_make_symbolic(&res_vhci_hcd_probe_20, sizeof(int), "res_vhci_hcd_probe_20");
  pm_message_t var_vhci_hcd_suspend_22_p1 ;
  struct device *var_group4 ;
  int ldv_s_vhci_driver_platform_driver ;
    klee_make_symbolic(&ldv_s_vhci_driver_platform_driver, sizeof(int), "ldv_s_vhci_driver_platform_driver");
  int ldv_s_the_pdev_platform_device ;
    klee_make_symbolic(&ldv_s_the_pdev_platform_device, sizeof(int), "ldv_s_the_pdev_platform_device");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
