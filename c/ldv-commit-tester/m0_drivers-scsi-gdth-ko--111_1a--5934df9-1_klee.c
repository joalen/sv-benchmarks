...
struct queue_limits {
   ...
   unsigned char no_cluster ;
    klee_make_symbolic(&no_cluster, sizeof(char), "no_cluster");
...
struct request_queue {
   ...
   int unplug_thresh ;
    klee_make_symbolic(&unplug_thresh, sizeof(int), "unplug_thresh");
   unsigned long unplug_delay ;
    klee_make_symbolic(&unplug_delay, sizeof(long), "unplug_delay");
   ...
   unsigned int ordered ;
    klee_make_symbolic(&ordered, sizeof(int), "ordered");
   unsigned int next_ordered ;
    klee_make_symbolic(&next_ordered, sizeof(int), "next_ordered");
   unsigned int ordseq ;
    klee_make_symbolic(&ordseq, sizeof(int), "ordseq");
   int orderr ;
    klee_make_symbolic(&orderr, sizeof(int), "orderr");
   int ordcolor ;
    klee_make_symbolic(&ordcolor, sizeof(int), "ordcolor");
...
struct __anonstruct_gdth_ioctl_general_165 {
   ...
   unsigned long data_len ;
    klee_make_symbolic(&data_len, sizeof(long), "data_len");
...
struct __anonstruct_gdth_pci_str_221 {
   struct pci_dev *pdev ;
   unsigned long dpmem ;
    klee_make_symbolic(&dpmem, sizeof(long), "dpmem");
   unsigned long io ;
...
struct gdth_cmndinfo {
   ...
   int internal_command ;
    klee_make_symbolic(&internal_command, sizeof(int), "internal_command");
...
static int elastidx  ;
    klee_make_symbolic(&elastidx, sizeof(int), "elastidx");
static int eoldidx  ;
    klee_make_symbolic(&eoldidx, sizeof(int), "eoldidx");
static int major  ;
...
{ 
  int orig_length ;
    klee_make_symbolic(&orig_length, sizeof(int), "orig_length");
  int drive ;
    klee_make_symbolic(&drive, sizeof(int), "drive");
  int wb_mode ;
    klee_make_symbolic(&wb_mode, sizeof(int), "wb_mode");
  int i ;
  int found ;
...
{ 
  ...
  int no_mdrv ;
    klee_make_symbolic(&no_mdrv, sizeof(int), "no_mdrv");
  int drv_no ;
    klee_make_symbolic(&drv_no, sizeof(int), "drv_no");
  int is_mirr ;
    klee_make_symbolic(&is_mirr, sizeof(int), "is_mirr");
  u32 cnt ;
  u64 paddr ;
  int rc ;
...
{ 
  ...
  u16 device ;
  unsigned long base0 ;
    klee_make_symbolic(&base0, sizeof(long), "base0");
  unsigned long base1 ;
  unsigned long base2 ;
  int rc ;
...
{ 
  register int gdtsema0 ;
    klee_make_symbolic(&gdtsema0, sizeof(int), "gdtsema0");
  unsigned char tmp ;
  unsigned char tmp___0 ;
...
{ 
  int answer_found ;
    klee_make_symbolic(&answer_found, sizeof(int), "answer_found");
  int wait_index ;
    klee_make_symbolic(&wait_index, sizeof(int), "wait_index");
  int tmp ;
...
{ 
  u32 drv_cyls ;
  int drv_hds ;
    klee_make_symbolic(&drv_hds, sizeof(int), "drv_hds");
  int drv_secs ;
    klee_make_symbolic(&drv_secs, sizeof(int), "drv_secs");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
  int tmp___2 ;
...
{ 
  ...
  int cmd_index ;
  int read_write ;
    klee_make_symbolic(&read_write, sizeof(int), "read_write");
  int sgcnt ;
    klee_make_symbolic(&sgcnt, sizeof(int), "sgcnt");
  int mode64 ;
    klee_make_symbolic(&mode64, sizeof(int), "mode64");
  size_t __len ;
  void *__ret ;
  __u64 tmp___0 ;
  size_t __len___0 ;
...
{ 
  gdth_evt_str *e ;
  int eindex ;
    klee_make_symbolic(&eindex, sizeof(int), "eindex");
  unsigned long flags ;
  raw_spinlock_t *tmp ;
  size_t __len ;
  void *__ret ;
...
{ 
  ...
  u32 info ;
  int cyls ;
    klee_make_symbolic(&cyls, sizeof(int), "cyls");
  int hds ;
    klee_make_symbolic(&hds, sizeof(int), "hds");
  int secs ;
...
{ 
  ...
  unsigned int var_gdth_unlocked_ioctl_66_p1 ;
    klee_make_symbolic(&var_gdth_unlocked_ioctl_66_p1, sizeof(int), "var_gdth_unlocked_ioctl_66_p1");
  unsigned long var_gdth_unlocked_ioctl_66_p2 ;
    klee_make_symbolic(&var_gdth_unlocked_ioctl_66_p2, sizeof(long), "var_gdth_unlocked_ioctl_66_p2");
  struct inode *var_group2 ;
  int res_gdth_open_57 ;
    klee_make_symbolic(&res_gdth_open_57, sizeof(int), "res_gdth_open_57");
  struct pci_dev *var_group3 ;
  struct pci_device_id  const  *var_gdth_pci_init_one_15_p1 ;
  int res_gdth_pci_init_one_15 ;
    klee_make_symbolic(&res_gdth_pci_init_one_15, sizeof(int), "res_gdth_pci_init_one_15");
  ...
  int var_gdth_interrupt_42_p0 ;
    klee_make_symbolic(&var_gdth_interrupt_42_p0, sizeof(int), "var_gdth_interrupt_42_p0");
  void *var_gdth_interrupt_42_p1 ;
  int ldv_s_gdth_fops_file_operations ;
    klee_make_symbolic(&ldv_s_gdth_fops_file_operations, sizeof(int), "ldv_s_gdth_fops_file_operations");
  int ldv_s_gdth_pci_driver_pci_driver ;
    klee_make_symbolic(&ldv_s_gdth_pci_driver_pci_driver, sizeof(int), "ldv_s_gdth_pci_driver_pci_driver");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
