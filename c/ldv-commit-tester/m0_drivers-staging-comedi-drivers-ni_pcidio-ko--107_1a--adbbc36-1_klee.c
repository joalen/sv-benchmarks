...
struct mite_dma_descriptor_ring {
   ...
   unsigned int n_links ;
    klee_make_symbolic(&n_links, sizeof(int), "n_links");
...
struct mite_struct {
   ...
   unsigned int fifo_size ;
    klee_make_symbolic(&fifo_size, sizeof(int), "fifo_size");
   spinlock_t lock ;
};
struct nidio_board {
   int dev_id ;
   ...
   char const   *name ;
   int n_8255 ;
    klee_make_symbolic(&n_8255, sizeof(int), "n_8255");
...
struct nidio96_private {
   struct mite_struct *mite ;
   int boardtype ;
    klee_make_symbolic(&boardtype, sizeof(int), "boardtype");
   int dio ;
    klee_make_symbolic(&dio, sizeof(int), "dio");
   unsigned short OpModeBits ;
    klee_make_symbolic(&OpModeBits, sizeof(short), "OpModeBits");
...
{ 
  ...
  unsigned long addressLow ;
    klee_make_symbolic(&addressLow, sizeof(long), "addressLow");
  int bit_shift ;
    klee_make_symbolic(&bit_shift, sizeof(int), "bit_shift");
  long tmp ;
...
{ 
  ...
  struct mite_struct *mite ;
  long AuxData ;
    klee_make_symbolic(&AuxData, sizeof(long), "AuxData");
  short data1 ;
    klee_make_symbolic(&data1, sizeof(short), "data1");
  short data2 ;
...
{ 
  ...
  int main_fpga_data_len ;
    klee_make_symbolic(&main_fpga_data_len, sizeof(int), "main_fpga_data_len");
  int scarab_a_data_len ;
    klee_make_symbolic(&scarab_a_data_len, sizeof(int), "scarab_a_data_len");
  int scarab_b_data_len ;
    klee_make_symbolic(&scarab_b_data_len, sizeof(int), "scarab_b_data_len");
...
{ 
  ...
  int var_nidio_interrupt_6_p0 ;
    klee_make_symbolic(&var_nidio_interrupt_6_p0, sizeof(int), "var_nidio_interrupt_6_p0");
