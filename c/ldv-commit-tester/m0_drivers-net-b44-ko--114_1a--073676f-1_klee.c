...
static int dma_desc_align_mask  ;
    klee_make_symbolic(&dma_desc_align_mask, sizeof(int), "dma_desc_align_mask");
static int dma_desc_sync_size  ;
    klee_make_symbolic(&dma_desc_sync_size, sizeof(int), "dma_desc_sync_size");
static int instance  ;
...
{ 
  int magicsync ;
    klee_make_symbolic(&magicsync, sizeof(int), "magicsync");
  int k ;
  ...
  int len ;
  int ethaddr_bytes ;
    klee_make_symbolic(&ethaddr_bytes, sizeof(int), "ethaddr_bytes");
  int tmp ;
  int tmp___0 ;
...
{ 
  u32 val ;
  int plen0 ;
    klee_make_symbolic(&plen0, sizeof(int), "plen0");
  int plen1 ;
    klee_make_symbolic(&plen1, sizeof(int), "plen1");
  int plen2 ;
    klee_make_symbolic(&plen2, sizeof(int), "plen2");
  u8 *pwol_pattern ;
  u8 pwol_mask[16U] ;
  void *tmp ;
  unsigned long tmp___0 ;
...
{ 
  ...
  int i ;
  int num_ents ;
    klee_make_symbolic(&num_ents, sizeof(int), "num_ents");
  int __min1 ;
...
{ 
  int b44_version_printed ;
    klee_make_symbolic(&b44_version_printed, sizeof(int), "b44_version_printed");
  struct net_device *dev ;
  struct b44 *bp ;
  int err ;
  int tmp ;
...
{ 
  unsigned int dma_desc_align_size ;
    klee_make_symbolic(&dma_desc_align_size, sizeof(int), "dma_desc_align_size");
  int tmp ;
  int err ;
  unsigned int __max1 ;
...
{ 
  ...
  int var_b44_get_sset_count_69_p1 ;
    klee_make_symbolic(&var_b44_get_sset_count_69_p1, sizeof(int), "var_b44_get_sset_count_69_p1");
  struct ethtool_stats *var_group7 ;
  u64 *var_b44_get_ethtool_stats_70_p2 ;
  int res_b44_open_45 ;
    klee_make_symbolic(&res_b44_open_45, sizeof(int), "res_b44_open_45");
  int res_b44_close_53 ;
    klee_make_symbolic(&res_b44_close_53, sizeof(int), "res_b44_close_53");
  struct sk_buff *var_group8 ;
  void *var_b44_set_mac_addr_43_p1 ;
  struct ifreq *var_group9 ;
  int var_b44_ioctl_73_p2 ;
    klee_make_symbolic(&var_b44_ioctl_73_p2, sizeof(int), "var_b44_ioctl_73_p2");
  int var_b44_change_mtu_34_p1 ;
    klee_make_symbolic(&var_b44_change_mtu_34_p1, sizeof(int), "var_b44_change_mtu_34_p1");
  struct ssb_device *var_group10 ;
  struct ssb_device_id  const  *var_b44_init_one_75_p1 ;
  int res_b44_init_one_75 ;
    klee_make_symbolic(&res_b44_init_one_75, sizeof(int), "res_b44_init_one_75");
  pm_message_t var_b44_suspend_77_p1 ;
  int var_b44_interrupt_31_p0 ;
    klee_make_symbolic(&var_b44_interrupt_31_p0, sizeof(int), "var_b44_interrupt_31_p0");
  void *var_b44_interrupt_31_p1 ;
  unsigned long var_b44_timer_25_p0 ;
    klee_make_symbolic(&var_b44_timer_25_p0, sizeof(long), "var_b44_timer_25_p0");
  int ldv_s_b44_netdev_ops_net_device_ops ;
    klee_make_symbolic(&ldv_s_b44_netdev_ops_net_device_ops, sizeof(int), "ldv_s_b44_netdev_ops_net_device_ops");
  int ldv_s_b44_ssb_driver_ssb_driver ;
    klee_make_symbolic(&ldv_s_b44_ssb_driver_ssb_driver, sizeof(int), "ldv_s_b44_ssb_driver_ssb_driver");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
