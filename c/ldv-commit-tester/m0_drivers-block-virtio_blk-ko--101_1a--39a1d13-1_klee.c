...
{ 
  ...
  unsigned long out ;
    klee_make_symbolic(&out, sizeof(long), "out");
  unsigned long in ;
    klee_make_symbolic(&in, sizeof(long), "in");
  struct virtblk_req *vbr ;
  void *tmp ;
  sector_t tmp___0 ;
...
{ 
  ...
  unsigned int var_virtblk_ioctl_5_p2 ;
    klee_make_symbolic(&var_virtblk_ioctl_5_p2, sizeof(int), "var_virtblk_ioctl_5_p2");
  unsigned long var_virtblk_ioctl_5_p3 ;
    klee_make_symbolic(&var_virtblk_ioctl_5_p3, sizeof(long), "var_virtblk_ioctl_5_p3");
