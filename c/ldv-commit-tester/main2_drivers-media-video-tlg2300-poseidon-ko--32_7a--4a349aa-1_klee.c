...
struct running_context {
   u32 freq ;
   int audio_idx ;
    klee_make_symbolic(&audio_idx, sizeof(int), "audio_idx");
   v4l2_std_id tvnormid ;
   int sig_index ;
    klee_make_symbolic(&sig_index, sizeof(int), "sig_index");
   struct v4l2_pix_format pix ;
};
struct poseidon;
struct video_data {
   ...
   char *dst ;
   int lines_copied ;
    klee_make_symbolic(&lines_copied, sizeof(int), "lines_copied");
   int prev_left ;
    klee_make_symbolic(&prev_left, sizeof(int), "prev_left");
   int lines_per_field ;
    klee_make_symbolic(&lines_per_field, sizeof(int), "lines_per_field");
   int lines_size ;
    klee_make_symbolic(&lines_size, sizeof(int), "lines_size");
   u8 endpoint_addr ;
   ...
   struct front_face *front ;
   int is_streaming ;
    klee_make_symbolic(&is_streaming, sizeof(int), "is_streaming");
   int users ;
...
struct poseidon_audio {
   ...
   unsigned int copied_position ;
    klee_make_symbolic(&copied_position, sizeof(int), "copied_position");
   struct snd_pcm_substream *capture_pcm_substream ;
   unsigned int rcv_position ;
    klee_make_symbolic(&rcv_position, sizeof(int), "rcv_position");
   struct snd_card *card ;
   int card_close ;
    klee_make_symbolic(&card_close, sizeof(int), "card_close");
   int users ;
   int pm_state ;
...
struct radio_data {
   ...
   unsigned int is_radio_streaming ;
    klee_make_symbolic(&is_radio_streaming, sizeof(int), "is_radio_streaming");
   int pre_emphasis ;
    klee_make_symbolic(&pre_emphasis, sizeof(int), "pre_emphasis");
...
struct pd_dvb_adapter {
   ...
   int prev_freq ;
    klee_make_symbolic(&prev_freq, sizeof(int), "prev_freq");
   int bandwidth ;
    klee_make_symbolic(&bandwidth, sizeof(int), "bandwidth");
   unsigned long last_jiffies ;
    klee_make_symbolic(&last_jiffies, sizeof(long), "last_jiffies");
};
struct front_face {
   enum v4l2_buf_type type ;
   struct videobuf_queue q ;
...
struct poseidon {
   ...
   int cur_transfer_mode ;
    klee_make_symbolic(&cur_transfer_mode, sizeof(int), "cur_transfer_mode");
...
struct poseidon_format {
   char *name ;
   int fourcc ;
    klee_make_symbolic(&fourcc, sizeof(int), "fourcc");
   int depth ;
...
struct video_std_to_audio_std {
   ...
   int audio_std ;
    klee_make_symbolic(&audio_std, sizeof(int), "audio_std");
};
...
{ 
  int need_init ;
    klee_make_symbolic(&need_init, sizeof(int), "need_init");
  bool ret ;
...
{ 
  ...
  char *buf ;
  int field_num ;
    klee_make_symbolic(&field_num, sizeof(int), "field_num");
  int tmp ;
...
{ 
  ...
  unsigned int vbi_delta ;
    klee_make_symbolic(&vbi_delta, sizeof(int), "vbi_delta");
...
{ 
  ...
  struct video_data *video ;
  int bubble_err ;
    klee_make_symbolic(&bubble_err, sizeof(int), "bubble_err");
  int head ;
...
{ 
  ...
  int array_size ;
    klee_make_symbolic(&array_size, sizeof(int), "array_size");
...
{ 
  ...
  int res_pd_video_open_64 ;
    klee_make_symbolic(&res_pd_video_open_64, sizeof(int), "res_pd_video_open_64");
  ...
  int ldv_s_pd_video_fops_v4l2_file_operations ;
    klee_make_symbolic(&ldv_s_pd_video_fops_v4l2_file_operations, sizeof(int), "ldv_s_pd_video_fops_v4l2_file_operations");
  int tmp ;
  int tmp___0 ;
...
{ 
  ...
  unsigned char *cp ;
  unsigned int oldptr ;
    klee_make_symbolic(&oldptr, sizeof(int), "oldptr");
  unsigned int cnt ;
...
{ 
  ...
  struct snd_pcm_substream *substream ;
  int period_elapsed ;
    klee_make_symbolic(&period_elapsed, sizeof(int), "period_elapsed");
  int ret ;
...
{ 
  ...
  int res_snd_pd_capture_open_0 ;
    klee_make_symbolic(&res_snd_pd_capture_open_0, sizeof(int), "res_snd_pd_capture_open_0");
  struct snd_pcm_hw_params *var_group2 ;
  int var_snd_pd_capture_trigger_9_p1 ;
    klee_make_symbolic(&var_snd_pd_capture_trigger_9_p1, sizeof(int), "var_snd_pd_capture_trigger_9_p1");
  unsigned long var_snd_pcm_pd_get_page_11_p1 ;
    klee_make_symbolic(&var_snd_pcm_pd_get_page_11_p1, sizeof(long), "var_snd_pcm_pd_get_page_11_p1");
  int ldv_s_pcm_capture_ops_snd_pcm_ops ;
    klee_make_symbolic(&ldv_s_pcm_capture_ops_snd_pcm_ops, sizeof(int), "ldv_s_pcm_capture_ops_snd_pcm_ops");
  int tmp ;
  int tmp___0 ;
...
{ 
  long nl ;
    klee_make_symbolic(&nl, sizeof(long), "nl");
  unsigned int msec ;
    klee_make_symbolic(&msec, sizeof(int), "msec");
  long ret ;
  long __x ;
...
{ 
  ...
  int var_poseidon_ts_bus_ctrl_1_p1 ;
    klee_make_symbolic(&var_poseidon_ts_bus_ctrl_1_p1, sizeof(int), "var_poseidon_ts_bus_ctrl_1_p1");
  int ldv_s_poseidon_frontend_ops_dvb_frontend_ops ;
    klee_make_symbolic(&ldv_s_poseidon_frontend_ops_dvb_frontend_ops, sizeof(int), "ldv_s_poseidon_frontend_ops_dvb_frontend_ops");
  int tmp ;
  int tmp___0 ;
...
{ 
  ...
  int res_poseidon_fm_open_3 ;
    klee_make_symbolic(&res_poseidon_fm_open_3, sizeof(int), "res_poseidon_fm_open_3");
  ...
  int ldv_s_poseidon_fm_fops_v4l2_file_operations ;
    klee_make_symbolic(&ldv_s_poseidon_fm_fops_v4l2_file_operations, sizeof(int), "ldv_s_poseidon_fm_fops_v4l2_file_operations");
  int tmp ;
  int tmp___0 ;
...
{ 
  ...
  int ret ;
  int new_one ;
    klee_make_symbolic(&new_one, sizeof(int), "new_one");
  void *tmp___0 ;
  struct device *dev ;
  struct lock_class_key __key ;
  char const   *tmp___1 ;
...
{ 
  ...
  unsigned long var_pm_notifier_block_2_p1 ;
    klee_make_symbolic(&var_pm_notifier_block_2_p1, sizeof(long), "var_pm_notifier_block_2_p1");
  ...
  int res_poseidon_probe_18 ;
    klee_make_symbolic(&res_poseidon_probe_18, sizeof(int), "res_poseidon_probe_18");
  pm_message_t var_poseidon_suspend_12_p1 ;
  int ldv_s_poseidon_driver_usb_driver ;
    klee_make_symbolic(&ldv_s_poseidon_driver_usb_driver, sizeof(int), "ldv_s_poseidon_driver_usb_driver");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
...
static int ldv_mutex_lock_of_poseidon  ;
    klee_make_symbolic(&ldv_mutex_lock_of_poseidon, sizeof(int), "ldv_mutex_lock_of_poseidon");
...
static int ldv_mutex_power_lock_of_snd_card  ;
    klee_make_symbolic(&ldv_mutex_power_lock_of_snd_card, sizeof(int), "ldv_mutex_power_lock_of_snd_card");
