...
struct ni_65xx_board {
   ...
   unsigned int num_dio_ports ;
    klee_make_symbolic(&num_dio_ports, sizeof(int), "num_dio_ports");
   unsigned int num_di_ports ;
    klee_make_symbolic(&num_di_ports, sizeof(int), "num_di_ports");
   unsigned int num_do_ports ;
    klee_make_symbolic(&num_do_ports, sizeof(int), "num_do_ports");
   unsigned char invert_outputs : 1 ;
};
struct ni_65xx_private {
   struct mite_struct *mite ;
   unsigned int filter_interval ;
    klee_make_symbolic(&filter_interval, sizeof(int), "filter_interval");
...
struct ni_65xx_subdevice_private {
   unsigned int base_port ;
    klee_make_symbolic(&base_port, sizeof(int), "base_port");
};
...
{ 
  ...
  unsigned int filter_resolution_ns ;
    klee_make_symbolic(&filter_resolution_ns, sizeof(int), "filter_resolution_ns");
  unsigned int max_filter_interval ;
    klee_make_symbolic(&max_filter_interval, sizeof(int), "max_filter_interval");
...
{ 
  ...
  unsigned int max_ports_per_bitfield ;
    klee_make_symbolic(&max_ports_per_bitfield, sizeof(int), "max_ports_per_bitfield");
  unsigned int read_bits ;
    klee_make_symbolic(&read_bits, sizeof(int), "read_bits");
  unsigned int j ;
    klee_make_symbolic(&j, sizeof(int), "j");
  unsigned int port_offset ;
    klee_make_symbolic(&port_offset, sizeof(int), "port_offset");
  unsigned int tmp ;
  unsigned int port ;
  struct ni_65xx_subdevice_private *tmp___0 ;
  unsigned int base_port_channel ;
    klee_make_symbolic(&base_port_channel, sizeof(int), "base_port_channel");
  unsigned int port_mask ;
    klee_make_symbolic(&port_mask, sizeof(int), "port_mask");
  unsigned int port_data ;
    klee_make_symbolic(&port_data, sizeof(int), "port_data");
  unsigned int port_read_bits ;
    klee_make_symbolic(&port_read_bits, sizeof(int), "port_read_bits");
  int bitshift ;
    klee_make_symbolic(&bitshift, sizeof(int), "bitshift");
...
{ 
  ...
  int var_ni_65xx_interrupt_14_p0 ;
    klee_make_symbolic(&var_ni_65xx_interrupt_14_p0, sizeof(int), "var_ni_65xx_interrupt_14_p0");
