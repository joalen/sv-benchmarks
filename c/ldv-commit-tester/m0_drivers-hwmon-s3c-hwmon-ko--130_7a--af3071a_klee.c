...
typedef unsigned long mm_segment_t;
    klee_make_symbolic(&mm_segment_t, sizeof(long), "mm_segment_t");
...
struct thread_info {
   ...
   unsigned long tp_value ;
    klee_make_symbolic(&tp_value, sizeof(long), "tp_value");
...
{ 
  ...
  int res_s3c_hwmon_probe_10 ;
    klee_make_symbolic(&res_s3c_hwmon_probe_10, sizeof(int), "res_s3c_hwmon_probe_10");
  int ldv_s_s3c_hwmon_driver_platform_driver ;
    klee_make_symbolic(&ldv_s_s3c_hwmon_driver_platform_driver, sizeof(int), "ldv_s_s3c_hwmon_driver_platform_driver");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
