...
struct slip {
   ...
   unsigned char *xhead ;
   int xleft ;
    klee_make_symbolic(&xleft, sizeof(int), "xleft");
   unsigned long tx_compressed ;
   unsigned long rx_compressed ;
   unsigned long tx_misses ;
    klee_make_symbolic(&tx_misses, sizeof(long), "tx_misses");
   int mtu ;
   int buffsize ;
    klee_make_symbolic(&buffsize, sizeof(int), "buffsize");
   int xdata ;
    klee_make_symbolic(&xdata, sizeof(int), "xdata");
   int xbits ;
    klee_make_symbolic(&xbits, sizeof(int), "xbits");
   unsigned long flags ;
   unsigned char mode ;
   unsigned char leased ;
    klee_make_symbolic(&leased, sizeof(char), "leased");
   dev_t line ;
   pid_t pid ;
   unsigned char outfill ;
    klee_make_symbolic(&outfill, sizeof(char), "outfill");
   unsigned char keepalive ;
    klee_make_symbolic(&keepalive, sizeof(char), "keepalive");
...
{ 
  ...
  unsigned long c_rx_dropped ;
    klee_make_symbolic(&c_rx_dropped, sizeof(long), "c_rx_dropped");
  unsigned long c_rx_fifo_errors ;
    klee_make_symbolic(&c_rx_fifo_errors, sizeof(long), "c_rx_fifo_errors");
  unsigned long c_tx_fifo_errors ;
    klee_make_symbolic(&c_tx_fifo_errors, sizeof(long), "c_tx_fifo_errors");
  unsigned long c_collisions ;
    klee_make_symbolic(&c_collisions, sizeof(long), "c_collisions");
  struct slip *sl ;
  void *tmp ;
...
{ 
  ...
  int i ;
  unsigned short v ;
    klee_make_symbolic(&v, sizeof(short), "v");
  short bits ;
    klee_make_symbolic(&bits, sizeof(short), "bits");
  unsigned char *tmp ;
  unsigned char *tmp___0 ;
  unsigned char *tmp___1 ;
  unsigned char *tmp___2 ;
...
{ 
  struct slip *sl ;
  unsigned char s ;
    klee_make_symbolic(&s, sizeof(char), "s");
  int tmp ;
  int tmp___0 ;
...
{ 
  int res_sl_init_14 ;
    klee_make_symbolic(&res_sl_init_14, sizeof(int), "res_sl_init_14");
  int res_sl_open_11 ;
    klee_make_symbolic(&res_sl_open_11, sizeof(int), "res_sl_open_11");
  int res_sl_close_10 ;
    klee_make_symbolic(&res_sl_close_10, sizeof(int), "res_sl_close_10");
  struct sk_buff *var_group2 ;
  struct rtnl_link_stats64 var_group3 ;
  int var_sl_change_mtu_12_p1 ;
    klee_make_symbolic(&var_sl_change_mtu_12_p1, sizeof(int), "var_sl_change_mtu_12_p1");
  struct ifreq var_group4 ;
  int var_sl_ioctl_30_p2 ;
    klee_make_symbolic(&var_sl_ioctl_30_p2, sizeof(int), "var_sl_ioctl_30_p2");
  struct tty_struct var_group5 ;
  int res_slip_open_21 ;
    klee_make_symbolic(&res_slip_open_21, sizeof(int), "res_slip_open_21");
  struct file *var_group6 ;
  unsigned int var_slip_ioctl_28_p2 ;
    klee_make_symbolic(&var_slip_ioctl_28_p2, sizeof(int), "var_slip_ioctl_28_p2");
  unsigned long var_slip_ioctl_28_p3 ;
    klee_make_symbolic(&var_slip_ioctl_28_p3, sizeof(long), "var_slip_ioctl_28_p3");
  unsigned int var_slip_compat_ioctl_29_p2 ;
    klee_make_symbolic(&var_slip_compat_ioctl_29_p2, sizeof(int), "var_slip_compat_ioctl_29_p2");
  unsigned long var_slip_compat_ioctl_29_p3 ;
    klee_make_symbolic(&var_slip_compat_ioctl_29_p3, sizeof(long), "var_slip_compat_ioctl_29_p3");
  unsigned char const   *var_slip_receive_buf_18_p1 ;
  char *var_slip_receive_buf_18_p2 ;
  int var_slip_receive_buf_18_p3 ;
    klee_make_symbolic(&var_slip_receive_buf_18_p3, sizeof(int), "var_slip_receive_buf_18_p3");
  unsigned long var_sl_keepalive_34_p0 ;
    klee_make_symbolic(&var_sl_keepalive_34_p0, sizeof(long), "var_sl_keepalive_34_p0");
  unsigned long var_sl_outfill_33_p0 ;
    klee_make_symbolic(&var_sl_outfill_33_p0, sizeof(long), "var_sl_outfill_33_p0");
  int ldv_s_sl_netdev_ops_net_device_ops ;
    klee_make_symbolic(&ldv_s_sl_netdev_ops_net_device_ops, sizeof(int), "ldv_s_sl_netdev_ops_net_device_ops");
  int ldv_s_sl_ldisc_tty_ldisc_ops ;
    klee_make_symbolic(&ldv_s_sl_ldisc_tty_ldisc_ops, sizeof(int), "ldv_s_sl_ldisc_tty_ldisc_ops");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
