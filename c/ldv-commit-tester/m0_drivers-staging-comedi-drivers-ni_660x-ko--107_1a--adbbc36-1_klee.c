...
struct ni_660x_board {
   ...
   unsigned int n_chips ;
    klee_make_symbolic(&n_chips, sizeof(int), "n_chips");
};
...
{ 
  ...
  unsigned int global_interrupt_config_bits ;
    klee_make_symbolic(&global_interrupt_config_bits, sizeof(int), "global_interrupt_config_bits");
  struct ni_660x_board  const  *tmp ;
  struct ni_660x_private *tmp___0 ;
  struct ni_660x_private *tmp___1 ;
  int tmp___2 ;
...
{ 
  unsigned int counter_4_7_first_pfi ;
    klee_make_symbolic(&counter_4_7_first_pfi, sizeof(int), "counter_4_7_first_pfi");
  unsigned int counter_4_7_last_pfi ;
    klee_make_symbolic(&counter_4_7_last_pfi, sizeof(int), "counter_4_7_last_pfi");
  unsigned int active_chipset ;
    klee_make_symbolic(&active_chipset, sizeof(int), "active_chipset");
  unsigned int idle_chipset ;
    klee_make_symbolic(&idle_chipset, sizeof(int), "idle_chipset");
  unsigned int active_bits ;
    klee_make_symbolic(&active_bits, sizeof(int), "active_bits");
  unsigned int idle_bits ;
    klee_make_symbolic(&idle_bits, sizeof(int), "idle_bits");
  struct ni_660x_board  const  *tmp ;
  unsigned int tmp___0 ;
  unsigned int tmp___1 ;
  unsigned int tmp___2 ;
...
{ 
  ...
  int var_ni_660x_interrupt_33_p0 ;
    klee_make_symbolic(&var_ni_660x_interrupt_33_p0, sizeof(int), "var_ni_660x_interrupt_33_p0");
