...
struct snd_mixer_oss {
   ...
   unsigned int mask_recsrc ;
    klee_make_symbolic(&mask_recsrc, sizeof(int), "mask_recsrc");
   ...
   int oss_dev_alloc ;
    klee_make_symbolic(&oss_dev_alloc, sizeof(int), "oss_dev_alloc");
   int oss_recsrc ;
    klee_make_symbolic(&oss_recsrc, sizeof(int), "oss_recsrc");
};
struct snd_mixer_oss_file {
   struct snd_card *card ;
...
struct slot {
   ...
   unsigned int capture_item ;
    klee_make_symbolic(&capture_item, sizeof(int), "capture_item");
   struct snd_mixer_oss_assign_table *assigned ;
   unsigned char allocated : 1 ;
};
struct snd_mixer_oss_assign_table {
   int oss_id ;
    klee_make_symbolic(&oss_id, sizeof(int), "oss_id");
   char const   *name ;
   int index ;
};
...
{ 
  long orange ;
    klee_make_symbolic(&orange, sizeof(long), "orange");
  long nrange ;
    klee_make_symbolic(&nrange, sizeof(long), "nrange");
...
{ 
  ...
  int res_snd_mixer_oss_open_0 ;
    klee_make_symbolic(&res_snd_mixer_oss_open_0, sizeof(int), "res_snd_mixer_oss_open_0");
  unsigned int var_snd_mixer_oss_ioctl_13_p1 ;
    klee_make_symbolic(&var_snd_mixer_oss_ioctl_13_p1, sizeof(int), "var_snd_mixer_oss_ioctl_13_p1");
  unsigned long var_snd_mixer_oss_ioctl_13_p2 ;
    klee_make_symbolic(&var_snd_mixer_oss_ioctl_13_p2, sizeof(long), "var_snd_mixer_oss_ioctl_13_p2");
  int ldv_s_snd_mixer_oss_f_ops_file_operations ;
    klee_make_symbolic(&ldv_s_snd_mixer_oss_f_ops_file_operations, sizeof(int), "ldv_s_snd_mixer_oss_f_ops_file_operations");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
...
static int ldv_rsem_controls_rwsem_of_snd_card  ;
    klee_make_symbolic(&ldv_rsem_controls_rwsem_of_snd_card, sizeof(int), "ldv_rsem_controls_rwsem_of_snd_card");
static int ldv_wsem_controls_rwsem_of_snd_card  ;
    klee_make_symbolic(&ldv_wsem_controls_rwsem_of_snd_card, sizeof(int), "ldv_wsem_controls_rwsem_of_snd_card");
