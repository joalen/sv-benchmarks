...
struct il_queue {
   ...
   dma_addr_t dma_addr ;
   int n_win ;
    klee_make_symbolic(&n_win, sizeof(int), "n_win");
   u32 id ;
   int low_mark ;
...
struct il_host_cmd {
   ...
   unsigned long reply_page ;
    klee_make_symbolic(&reply_page, sizeof(long), "reply_page");
   void (*callback)(struct il_priv * , struct il_device_cmd * , struct il_rx_pkt * ) ;
   u32 flags ;
   u16 len ;
   u8 id ;
...
struct il_force_reset {
   ...
   unsigned long reset_duration ;
    klee_make_symbolic(&reset_duration, sizeof(long), "reset_duration");
   unsigned long last_force_reset_jiffies ;
    klee_make_symbolic(&last_force_reset_jiffies, sizeof(long), "last_force_reset_jiffies");
};
struct il_power_mgr {
...
struct __anonstruct__3945_402 {
   ...
   u32 sta_supp_rates ;
   int last_rx_rssi ;
    klee_make_symbolic(&last_rx_rssi, sizeof(int), "last_rx_rssi");
...
struct il_priv {
   ...
   int frames_count ;
    klee_make_symbolic(&frames_count, sizeof(int), "frames_count");
   enum ieee80211_band band ;
   int alloc_rxb_page ;
    klee_make_symbolic(&alloc_rxb_page, sizeof(int), "alloc_rxb_page");
   ...
   int fw_idx ;
    klee_make_symbolic(&fw_idx, sizeof(int), "fw_idx");
   u32 ucode_ver ;
   ...
   unsigned long txq_ctx_active_msk ;
    klee_make_symbolic(&txq_ctx_active_msk, sizeof(long), "txq_ctx_active_msk");
   ...
   unsigned long stop_reason ;
    klee_make_symbolic(&stop_reason, sizeof(long), "stop_reason");
...
struct il_mod_params {
   ...
   int disable_hw_scan ;
    klee_make_symbolic(&disable_hw_scan, sizeof(int), "disable_hw_scan");
   int num_of_queues ;
...
struct il_cfg {
   ...
   u8 valid_rx_ant ;
   unsigned int sku ;
    klee_make_symbolic(&sku, sizeof(int), "sku");
   u16 eeprom_ver ;
   ...
   int num_of_ampdu_queues ;
    klee_make_symbolic(&num_of_ampdu_queues, sizeof(int), "num_of_ampdu_queues");
   u32 pll_cfg_val ;
   bool set_l0s ;
   bool use_bsm ;
   u16 led_compensation ;
   int chain_noise_num_beacons ;
    klee_make_symbolic(&chain_noise_num_beacons, sizeof(int), "chain_noise_num_beacons");
...
struct il3945_rs_sta {
   ...
   unsigned long last_partial_flush ;
    klee_make_symbolic(&last_partial_flush, sizeof(long), "last_partial_flush");
...
{ 
  ...
  int spectrum_resp_status ;
    klee_make_symbolic(&spectrum_resp_status, sizeof(int), "spectrum_resp_status");
  int duration ;
...
{ 
  int thermal_spin ;
    klee_make_symbolic(&thermal_spin, sizeof(int), "thermal_spin");
  u32 rfkill ;
  int tmp ;
  u32 tmp___0 ;
  int tmp___1 ;
...
{ 
  ...
  void *tmp ;
  int ant ;
    klee_make_symbolic(&ant, sizeof(int), "ant");
  int tmp___0 ;
  u32 tmp___1 ;
  int tmp___2 ;
  int tmp___3 ;
...
{ 
  int next_rate ;
    klee_make_symbolic(&next_rate, sizeof(int), "next_rate");
  u8 tmp ;
  int tmp___0 ;
...
{ 
  unsigned long flags_spin ;
    klee_make_symbolic(&flags_spin, sizeof(long), "flags_spin");
...
{ 
  int temp_diff ;
    klee_make_symbolic(&temp_diff, sizeof(int), "temp_diff");
  int tmp ;
  u32 tmp___0 ;
  int tmp___1 ;
  u32 tmp___2 ;
...
{ 
  ...
  int power_changed ;
    klee_make_symbolic(&power_changed, sizeof(int), "power_changed");
  int i ;
  s8 const   *clip_pwrs ;
  int power ;
    klee_make_symbolic(&power, sizeof(int), "power");
  int delta_idx ;
    klee_make_symbolic(&delta_idx, sizeof(int), "delta_idx");
  s8 _min1 ;
  signed char _min2 ;
...
{ 
  ...
  u8 i ;
  int ref_temp ;
    klee_make_symbolic(&ref_temp, sizeof(int), "ref_temp");
  int temperature ;
  int tmp ;
  int power_idx ;
    klee_make_symbolic(&power_idx, sizeof(int), "power_idx");
  u8 tmp___0 ;
  s32 actual_idx ;
  int tmp___1 ;
...
{ 
  ...
  int idx ;
  int prev_idx ;
    klee_make_symbolic(&prev_idx, sizeof(int), "prev_idx");
...
{ 
  int unflushed ;
    klee_make_symbolic(&unflushed, sizeof(int), "unflushed");
  int i ;
  unsigned long flags ;
  struct il_priv *il ;
  int tmp ;
...
{ 
  ...
  s8 current_count ;
  int scale_rate_idx ;
    klee_make_symbolic(&scale_rate_idx, sizeof(int), "scale_rate_idx");
  int first_idx ;
