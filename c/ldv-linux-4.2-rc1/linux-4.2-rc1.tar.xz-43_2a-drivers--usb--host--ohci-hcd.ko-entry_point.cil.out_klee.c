...
struct ed {
   ...
   unsigned int takeback_wdh_cnt ;
    klee_make_symbolic(&takeback_wdh_cnt, sizeof(int), "takeback_wdh_cnt");
...
struct ohci_hcd {
   ...
   unsigned int prev_frame_no ;
    klee_make_symbolic(&prev_frame_no, sizeof(int), "prev_frame_no");
   unsigned int wdh_cnt ;
    klee_make_symbolic(&wdh_cnt, sizeof(int), "wdh_cnt");
   unsigned int prev_wdh_cnt ;
    klee_make_symbolic(&prev_wdh_cnt, sizeof(int), "prev_wdh_cnt");
   u32 prev_donehead ;
...
{ 
  ...
  unsigned int frame_no ;
    klee_make_symbolic(&frame_no, sizeof(int), "frame_no");
  unsigned long flags ;
  struct usb_hcd *tmp ;
  struct usb_hcd *tmp___0 ;
  struct usb_hcd *tmp___1 ;
  ...
  u16 tmp___8 ;
  int active_cnt ;
    klee_make_symbolic(&active_cnt, sizeof(int), "active_cnt");
  int i ;
  unsigned int tmp___9 ;
  struct usb_hcd *tmp___10 ;
  unsigned long tmp___11 ;
