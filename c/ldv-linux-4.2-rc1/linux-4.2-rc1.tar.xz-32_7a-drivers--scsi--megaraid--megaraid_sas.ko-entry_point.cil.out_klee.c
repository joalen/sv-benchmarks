...
struct megasas_instance {
   ...
   unsigned int fw_crash_buffer_size ;
    klee_make_symbolic(&fw_crash_buffer_size, sizeof(int), "fw_crash_buffer_size");
   unsigned int fw_crash_state ;
    klee_make_symbolic(&fw_crash_state, sizeof(int), "fw_crash_state");
   unsigned int fw_crash_buffer_offset ;
    klee_make_symbolic(&fw_crash_buffer_offset, sizeof(int), "fw_crash_buffer_offset");
   u32 drv_buf_index ;
   u32 drv_buf_alloc ;
...
{ 
  ...
  unsigned long buff_addr ;
    klee_make_symbolic(&buff_addr, sizeof(long), "buff_addr");
  unsigned long dmachunk ;
    klee_make_symbolic(&dmachunk, sizeof(long), "dmachunk");
  unsigned long src_addr ;
    klee_make_symbolic(&src_addr, sizeof(long), "src_addr");
  unsigned long flags ;
  u32 buff_offset ;
  raw_spinlock_t *tmp ;
...
{ 
  ...
  int crash_support ;
    klee_make_symbolic(&crash_support, sizeof(int), "crash_support");
  int tmp ;
...
{ 
  ...
  unsigned long ldvarg67 ;
    klee_make_symbolic(&ldvarg67, sizeof(long), "ldvarg67");
...
{ 
  ...
  int threshold_reply_count ;
    klee_make_symbolic(&threshold_reply_count, sizeof(int), "threshold_reply_count");
