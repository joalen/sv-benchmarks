...
int mpt_fwfault_debug  ;
    klee_make_symbolic(&mpt_fwfault_debug, sizeof(int), "mpt_fwfault_debug");
static int mpt_msi_enable_spi  ;
    klee_make_symbolic(&mpt_msi_enable_spi, sizeof(int), "mpt_msi_enable_spi");
static int mpt_msi_enable_fc  ;
    klee_make_symbolic(&mpt_msi_enable_fc, sizeof(int), "mpt_msi_enable_fc");
static int mpt_msi_enable_sas  ;
    klee_make_symbolic(&mpt_msi_enable_sas, sizeof(int), "mpt_msi_enable_sas");
static int mpt_channel_mapping  ;
    klee_make_symbolic(&mpt_channel_mapping, sizeof(int), "mpt_channel_mapping");
static int mpt_debug_level  ;
    klee_make_symbolic(&mpt_debug_level, sizeof(int), "mpt_debug_level");
...
{ 
  ...
  u8 cb_idx ;
  int freeme ;
    klee_make_symbolic(&freeme, sizeof(int), "freeme");
  u32 reply_dma_low ;
  u16 ioc_stat ;
  u32 log_info ;
...
{ 
  ...
  u8 event ;
  int evHandlers ;
    klee_make_symbolic(&evHandlers, sizeof(int), "evHandlers");
  int freereq ;
    klee_make_symbolic(&freereq, sizeof(int), "freereq");
  int _min1 ;
...
{ 
  ...
  raw_spinlock_t *tmp ;
  int req_offset ;
    klee_make_symbolic(&req_offset, sizeof(int), "req_offset");
  struct list_head  const  *__mptr ;
  int tmp___0 ;
...
{ 
  char *psge ;
  int flags_length ;
    klee_make_symbolic(&flags_length, sizeof(int), "flags_length");
...
{ 
  ...
  unsigned long port ;
    klee_make_symbolic(&port, sizeof(long), "port");
  u32 msize ;
  u32 psize ;
  int r ;
  struct pci_dev *pdev ;
...
{ 
  ...
  u32 device_state ;
  int recovery_state ;
    klee_make_symbolic(&recovery_state, sizeof(int), "recovery_state");
  int err ;
...
{ 
  int hard_reset_done ;
    klee_make_symbolic(&hard_reset_done, sizeof(int), "hard_reset_done");
  int alt_ioc_ready ;
    klee_make_symbolic(&alt_ioc_ready, sizeof(int), "alt_ioc_ready");
  int hard ;
    klee_make_symbolic(&hard, sizeof(int), "hard");
  int rc ;
  int ii ;
  int ret ;
  int reset_alt_ioc_active ;
    klee_make_symbolic(&reset_alt_ioc_active, sizeof(int), "reset_alt_ioc_active");
  int irq_allocated ;
    klee_make_symbolic(&irq_allocated, sizeof(int), "irq_allocated");
  u8 *a ;
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
...
{ 
  int sz_first ;
    klee_make_symbolic(&sz_first, sizeof(int), "sz_first");
  int sz_last ;
    klee_make_symbolic(&sz_last, sizeof(int), "sz_last");
...
{ 
  u32 ioc_state ;
  int statefault ;
    klee_make_symbolic(&statefault, sizeof(int), "statefault");
  int cntdn ;
    klee_make_symbolic(&cntdn, sizeof(int), "cntdn");
  int hard_reset_done ;
  int r ;
  int ii ;
  int whoinit ;
    klee_make_symbolic(&whoinit, sizeof(int), "whoinit");
  unsigned long __ms ;
...
{ 
  ...
  int reply_sz ;
  int cmdStatus ;
    klee_make_symbolic(&cmdStatus, sizeof(int), "cmdStatus");
  int request_size ;
...
{ 
  ...
  int failcnt ;
    klee_make_symbolic(&failcnt, sizeof(int), "failcnt");
  int t ;
...
{ 
  int u16cnt ;
    klee_make_symbolic(&u16cnt, sizeof(int), "u16cnt");
  int failcnt ;
  int t ;
  u16 *hs_reply ;
...
{ 
  ...
  int rc ;
  int data_sz ;
    klee_make_symbolic(&data_sz, sizeof(int), "data_sz");
  int copy_sz ;
...
{ 
  ...
  int handle_inactive_volumes ;
    klee_make_symbolic(&handle_inactive_volumes, sizeof(int), "handle_inactive_volumes");
  int tmp ;
  void *tmp___0 ;
  int tmp___1 ;
  int tmp___2 ;
...
{ 
  ...
  int rc ;
  int iocpage2sz ;
    klee_make_symbolic(&iocpage2sz, sizeof(int), "iocpage2sz");
  int i ;
  int tmp ;
  void *tmp___0 ;
  int tmp___1 ;
...
{ 
  ...
  dma_addr_t ioc3_dma ;
  int iocpage3sz ;
    klee_make_symbolic(&iocpage3sz, sizeof(int), "iocpage3sz");
  int tmp ;
  void *tmp___0 ;
  void *tmp___1 ;
  int tmp___2 ;
...
{ 
  ...
  dma_addr_t ioc4_dma ;
  int iocpage4sz ;
    klee_make_symbolic(&iocpage4sz, sizeof(int), "iocpage4sz");
  int tmp ;
  void *tmp___0 ;
  int tmp___1 ;
...
{ 
  ...
  dma_addr_t ioc1_dma ;
  int iocpage1sz ;
    klee_make_symbolic(&iocpage1sz, sizeof(int), "iocpage1sz");
  u32 tmp ;
  int tmp___0 ;
  void *tmp___1 ;
  int tmp___2 ;
...
{ 
  u8 cb_idx ;
  int scsi ;
    klee_make_symbolic(&scsi, sizeof(int), "scsi");
  int fc ;
    klee_make_symbolic(&fc, sizeof(int), "fc");
  int sas ;
    klee_make_symbolic(&sas, sizeof(int), "sas");
  int lan ;
    klee_make_symbolic(&lan, sizeof(int), "lan");
  int ctl ;
    klee_make_symbolic(&ctl, sizeof(int), "ctl");
  int targ ;
    klee_make_symbolic(&targ, sizeof(int), "targ");
  int dmp ;
    klee_make_symbolic(&dmp, sizeof(int), "dmp");
  char *drvname ;
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
...
{ 
  ...
  int r ;
  int handlers ;
    klee_make_symbolic(&handlers, sizeof(int), "handlers");
  u8 event ;
  u8 evState ;
  int idx ;
