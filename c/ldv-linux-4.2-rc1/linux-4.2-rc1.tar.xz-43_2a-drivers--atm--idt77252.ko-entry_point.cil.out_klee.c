...
struct scq_info {
   ...
   unsigned long trans_start ;
   unsigned long scd ;
    klee_make_symbolic(&scd, sizeof(long), "scd");
   spinlock_t skblock ;
...
struct rate_estimator {
   ...
   unsigned int ewma_log ;
    klee_make_symbolic(&ewma_log, sizeof(int), "ewma_log");
   u64 cells ;
   u64 last_cells ;
   long avcps ;
    klee_make_symbolic(&avcps, sizeof(long), "avcps");
   u32 cps ;
   u32 maxcps ;
};
struct idt77252_dev;
...
struct vc_map {
   ...
   u8 max_er ;
   unsigned int ntste ;
    klee_make_symbolic(&ntste, sizeof(int), "ntste");
   spinlock_t lock ;
   ...
   int scd_index ;
    klee_make_symbolic(&scd_index, sizeof(int), "scd_index");
...
struct idt77252_dev {
   ...
   unsigned long srambase ;
    klee_make_symbolic(&srambase, sizeof(long), "srambase");
   void *fbq[4U] ;
   struct mutex mutex ;
   spinlock_t cmd_lock ;
   unsigned long softstat ;
    klee_make_symbolic(&softstat, sizeof(long), "softstat");
   unsigned long flags ;
   struct work_struct tqueue ;
   unsigned long tct_base ;
    klee_make_symbolic(&tct_base, sizeof(long), "tct_base");
   unsigned long rct_base ;
    klee_make_symbolic(&rct_base, sizeof(long), "rct_base");
   unsigned long rt_base ;
    klee_make_symbolic(&rt_base, sizeof(long), "rt_base");
   unsigned long scd_base ;
    klee_make_symbolic(&scd_base, sizeof(long), "scd_base");
   unsigned long tst[2U] ;
   unsigned long abrst_base ;
    klee_make_symbolic(&abrst_base, sizeof(long), "abrst_base");
   unsigned long fifo_base ;
    klee_make_symbolic(&fifo_base, sizeof(long), "fifo_base");
   unsigned long irqstat[16U] ;
   unsigned int sramsize ;
    klee_make_symbolic(&sramsize, sizeof(int), "sramsize");
   unsigned int tct_size ;
    klee_make_symbolic(&tct_size, sizeof(int), "tct_size");
   unsigned int rct_size ;
    klee_make_symbolic(&rct_size, sizeof(int), "rct_size");
   unsigned int scd_size ;
    klee_make_symbolic(&scd_size, sizeof(int), "scd_size");
   unsigned int tst_size ;
    klee_make_symbolic(&tst_size, sizeof(int), "tst_size");
   unsigned int tst_free ;
    klee_make_symbolic(&tst_free, sizeof(int), "tst_free");
   unsigned int abrst_size ;
    klee_make_symbolic(&abrst_size, sizeof(int), "abrst_size");
   ...
   unsigned int vcimask ;
    klee_make_symbolic(&vcimask, sizeof(int), "vcimask");
   unsigned int utopia_pcr ;
    klee_make_symbolic(&utopia_pcr, sizeof(int), "utopia_pcr");
   unsigned int link_pcr ;
    klee_make_symbolic(&link_pcr, sizeof(int), "link_pcr");
   struct vc_map **vcs ;
   struct vc_map **scd2vc ;
   struct tst_info *soft_tst ;
   unsigned int tst_index ;
    klee_make_symbolic(&tst_index, sizeof(int), "tst_index");
   struct timer_list tst_timer ;
   spinlock_t tst_lock ;
   unsigned long tst_state ;
    klee_make_symbolic(&tst_state, sizeof(long), "tst_state");
...
{ 
  unsigned long tct ;
    klee_make_symbolic(&tct, sizeof(long), "tct");
  int i ;
...
{ 
  ...
  unsigned long jump ;
    klee_make_symbolic(&jump, sizeof(long), "jump");
  unsigned long flags ;
  u32 pc ;
  int e ;
...
{ 
  unsigned long cl ;
    klee_make_symbolic(&cl, sizeof(long), "cl");
  unsigned long avail ;
    klee_make_symbolic(&avail, sizeof(long), "avail");
  unsigned long idle ;
  int e ;
  int r ;
...
{ 
  int tst_free ;
  int tst_used ;
    klee_make_symbolic(&tst_used, sizeof(int), "tst_used");
  int tst_entries ;
    klee_make_symbolic(&tst_entries, sizeof(int), "tst_entries");
  unsigned long tmpl ;
    klee_make_symbolic(&tmpl, sizeof(long), "tmpl");
  unsigned long modl ;
    klee_make_symbolic(&modl, sizeof(long), "modl");
  int tcr ;
    klee_make_symbolic(&tcr, sizeof(int), "tcr");
  int tcra ;
    klee_make_symbolic(&tcra, sizeof(int), "tcra");
  int tmp ;
  int tmp___0 ;
...
{ 
  ...
  unsigned int linkrate ;
    klee_make_symbolic(&linkrate, sizeof(int), "linkrate");
  unsigned int rsvdcr ;
    klee_make_symbolic(&rsvdcr, sizeof(int), "rsvdcr");
  unsigned int tst_entries ;
  struct net_device *tmp ;
  char tname[10U] ;
  u32 size ;
  u_char pci_byte ;
    klee_make_symbolic(&pci_byte, sizeof(char), "pci_byte");
  u32 conf ;
  int i ;
  int k ;
...
{ 
  ...
  unsigned char ldvarg4 ;
    klee_make_symbolic(&ldvarg4, sizeof(char), "ldvarg4");
