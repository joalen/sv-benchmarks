...
struct crypt_config {
   ...
   unsigned int iv_size ;
    klee_make_symbolic(&iv_size, sizeof(int), "iv_size");
   void *iv_private ;
   struct crypto_ablkcipher **tfms ;
   unsigned int tfms_count ;
    klee_make_symbolic(&tfms_count, sizeof(int), "tfms_count");
   unsigned int dmreq_start ;
    klee_make_symbolic(&dmreq_start, sizeof(int), "dmreq_start");
   unsigned int per_bio_data_size ;
   unsigned long flags ;
   unsigned int key_size ;
    klee_make_symbolic(&key_size, sizeof(int), "key_size");
   unsigned int key_parts ;
    klee_make_symbolic(&key_parts, sizeof(int), "key_parts");
   unsigned int key_extra_size ;
    klee_make_symbolic(&key_extra_size, sizeof(int), "key_extra_size");
   u8 key[0U] ;
};
...
{ 
  ...
  unsigned int salt_size ;
    klee_make_symbolic(&salt_size, sizeof(int), "salt_size");
  unsigned int tmp ;
  struct crypto_cipher *essiv_tfm ;
  int r ;
  int err ;
...
{ 
  struct iv_lmk_private *lmk ;
  int subkey_size ;
    klee_make_symbolic(&subkey_size, sizeof(int), "subkey_size");
  unsigned int tmp ;
...
{ 
  ...
  unsigned long __lengthof__desc_desc ;
    klee_make_symbolic(&__lengthof__desc_desc, sizeof(long), "__lengthof__desc_desc");
  void *tmp___0 ;
...
{ 
  struct iv_tcw_private *tcw ;
  int key_offset ;
    klee_make_symbolic(&key_offset, sizeof(int), "key_offset");
...
{ 
  unsigned int key_index ;
    klee_make_symbolic(&key_index, sizeof(int), "key_index");
  void *tmp ;
...
{ 
  ...
  unsigned int nr_iovecs ;
    klee_make_symbolic(&nr_iovecs, sizeof(int), "nr_iovecs");
  gfp_t gfp_mask ;
  unsigned int i ;
  unsigned int len ;
  unsigned int remaining_size ;
    klee_make_symbolic(&remaining_size, sizeof(int), "remaining_size");
  struct page *page ;
  struct bio_vec *bvec ;
  long tmp ;
  void *tmp___0 ;
...
{ 
  ...
  struct bio *clone ;
  int crypt_finished ;
    klee_make_symbolic(&crypt_finished, sizeof(int), "crypt_finished");
  sector_t sector ;
  int r ;
  long tmp ;
...
{ 
  int r ;
  int key_string_len ;
    klee_make_symbolic(&key_string_len, sizeof(int), "key_string_len");
  size_t tmp ;
  int tmp___0 ;
  int tmp___1 ;
...
{ 
  ...
  unsigned int opt_params ;
    klee_make_symbolic(&opt_params, sizeof(int), "opt_params");
  unsigned long long tmpll ;
    klee_make_symbolic(&tmpll, sizeof(long), "tmpll");
  int ret ;
...
{ 
  ...
  int num_feature_args ;
    klee_make_symbolic(&num_feature_args, sizeof(int), "num_feature_args");
  int tmp ;
  unsigned int tmp___0 ;
  int tmp___1 ;
  unsigned int tmp___2 ;
