...
struct ib_uverbs_event_file {
   struct kref ref ;
   int is_async ;
    klee_make_symbolic(&is_async, sizeof(int), "is_async");
   struct ib_uverbs_file *uverbs_file ;
   spinlock_t lock ;
   int is_closed ;
    klee_make_symbolic(&is_closed, sizeof(int), "is_closed");
...
{ 
  ...
  int eventsz ;
    klee_make_symbolic(&eventsz, sizeof(int), "eventsz");
  int ret ;
...
{ 
  unsigned int pollflags ;
    klee_make_symbolic(&pollflags, sizeof(int), "pollflags");
  struct ib_uverbs_event_file *file ;
  int tmp ;
...
{ 
  ...
  int ret ;
  int new_xrcd ;
    klee_make_symbolic(&new_xrcd, sizeof(int), "new_xrcd");
  unsigned long tmp ;
  void *tmp___0 ;
  long tmp___1 ;
  bool tmp___2 ;
...
{ 
  ...
  int sg_ind ;
    klee_make_symbolic(&sg_ind, sizeof(int), "sg_ind");
  int is_ud ;
    klee_make_symbolic(&is_ud, sizeof(int), "is_ud");
  ssize_t ret ;
  unsigned long tmp ;
  void *tmp___0 ;
  unsigned long tmp___1 ;
