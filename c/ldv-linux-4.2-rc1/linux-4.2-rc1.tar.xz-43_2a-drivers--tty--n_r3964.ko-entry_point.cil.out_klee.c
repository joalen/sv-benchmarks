...
struct r3964_client_message {
   int msg_id ;
    klee_make_symbolic(&msg_id, sizeof(int), "msg_id");
   int arg ;
...
struct r3964_info {
   ...
   unsigned char priority ;
    klee_make_symbolic(&priority, sizeof(char), "priority");
   ...
   unsigned int tx_position ;
    klee_make_symbolic(&tx_position, sizeof(int), "tx_position");
   unsigned int rx_position ;
    klee_make_symbolic(&rx_position, sizeof(int), "rx_position");
   unsigned char last_rx ;
    klee_make_symbolic(&last_rx, sizeof(char), "last_rx");
   unsigned char bcc ;
    klee_make_symbolic(&bcc, sizeof(char), "bcc");
   unsigned int blocks_in_rx_queue ;
    klee_make_symbolic(&blocks_in_rx_queue, sizeof(int), "blocks_in_rx_queue");
   struct r3964_client_info *firstClient ;
   unsigned int state ;
   unsigned int flags ;
   struct timer_list tmr ;
   int nRetry ;
    klee_make_symbolic(&nRetry, sizeof(int), "nRetry");
};
struct pollfd {
   int fd ;
