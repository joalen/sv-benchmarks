...
struct path_selector_type {
   ...
   unsigned int table_args ;
    klee_make_symbolic(&table_args, sizeof(int), "table_args");
   unsigned int info_args ;
    klee_make_symbolic(&info_args, sizeof(int), "info_args");
...
struct priority_group {
   ...
   unsigned int pg_num ;
    klee_make_symbolic(&pg_num, sizeof(int), "pg_num");
   unsigned int bypassed ;
    klee_make_symbolic(&bypassed, sizeof(int), "bypassed");
   unsigned int nr_pgpaths ;
    klee_make_symbolic(&nr_pgpaths, sizeof(int), "nr_pgpaths");
...
struct multipath {
   ...
   unsigned int nr_priority_groups ;
    klee_make_symbolic(&nr_priority_groups, sizeof(int), "nr_priority_groups");
   struct list_head priority_groups ;
   wait_queue_head_t pg_init_wait ;
   unsigned int pg_init_required ;
    klee_make_symbolic(&pg_init_required, sizeof(int), "pg_init_required");
   unsigned int pg_init_in_progress ;
    klee_make_symbolic(&pg_init_in_progress, sizeof(int), "pg_init_in_progress");
   unsigned int pg_init_delay_retry ;
    klee_make_symbolic(&pg_init_delay_retry, sizeof(int), "pg_init_delay_retry");
   unsigned int nr_valid_paths ;
    klee_make_symbolic(&nr_valid_paths, sizeof(int), "nr_valid_paths");
   struct pgpath *current_pgpath ;
   struct priority_group *current_pg ;
   struct priority_group *next_pg ;
   unsigned int repeat_count ;
    klee_make_symbolic(&repeat_count, sizeof(int), "repeat_count");
   ...
   unsigned int pg_init_retries ;
    klee_make_symbolic(&pg_init_retries, sizeof(int), "pg_init_retries");
   unsigned int pg_init_count ;
    klee_make_symbolic(&pg_init_count, sizeof(int), "pg_init_count");
   unsigned int pg_init_delay_msecs ;
    klee_make_symbolic(&pg_init_delay_msecs, sizeof(int), "pg_init_delay_msecs");
...
{ 
  ...
  unsigned int min_ios ;
    klee_make_symbolic(&min_ios, sizeof(int), "min_ios");
  unsigned int tmp ;
  void *tmp___0 ;
  struct lock_class_key __key ;
  struct lock_class_key __key___0 ;
...
{ 
  ...
  unsigned long pg_init_delay ;
    klee_make_symbolic(&pg_init_delay, sizeof(long), "pg_init_delay");
  struct list_head  const  *__mptr ;
  bool tmp ;
  struct list_head  const  *__mptr___0 ;
...
{ 
  ...
  unsigned int ps_argc ;
    klee_make_symbolic(&ps_argc, sizeof(int), "ps_argc");
...
{ 
  ...
  unsigned int nr_selector_args ;
    klee_make_symbolic(&nr_selector_args, sizeof(int), "nr_selector_args");
  unsigned int nr_args ;
    klee_make_symbolic(&nr_args, sizeof(int), "nr_args");
  struct priority_group *pg ;
  struct dm_target *ti ;
  void *tmp ;
  void *tmp___0 ;
...
{ 
  unsigned int hw_argc ;
    klee_make_symbolic(&hw_argc, sizeof(int), "hw_argc");
  int ret ;
...
{ 
  ...
  unsigned int pg_count ;
    klee_make_symbolic(&pg_count, sizeof(int), "pg_count");
  unsigned int next_pg_num ;
    klee_make_symbolic(&next_pg_num, sizeof(int), "next_pg_num");
  struct priority_group *pg ;
  long tmp ;
...
{ 
  struct priority_group *pg ;
  unsigned int pgnum ;
    klee_make_symbolic(&pgnum, sizeof(int), "pgnum");
  unsigned long flags ;
  char dummy ;
...
{ 
  unsigned long flags ;
  int limit_reached ;
    klee_make_symbolic(&limit_reached, sizeof(int), "limit_reached");
  raw_spinlock_t *tmp ;
...
{ 
  ...
  unsigned int delay_retry ;
    klee_make_symbolic(&delay_retry, sizeof(int), "delay_retry");
  int tmp ;
  raw_spinlock_t *tmp___0 ;
  int tmp___1 ;
...
{ 
  int busy ;
  int has_active ;
    klee_make_symbolic(&has_active, sizeof(int), "has_active");
  struct multipath *m ;
  struct priority_group *pg ;
  struct pgpath *pgpath ;
  unsigned long flags ;
