...
struct fimc_dma_offset {
   int y_h ;
    klee_make_symbolic(&y_h, sizeof(int), "y_h");
   int y_v ;
    klee_make_symbolic(&y_v, sizeof(int), "y_v");
   int cb_h ;
    klee_make_symbolic(&cb_h, sizeof(int), "cb_h");
   int cb_v ;
    klee_make_symbolic(&cb_v, sizeof(int), "cb_v");
   int cr_h ;
    klee_make_symbolic(&cr_h, sizeof(int), "cr_h");
   int cr_v ;
    klee_make_symbolic(&cr_v, sizeof(int), "cr_v");
};
struct fimc_effect {
   u32 type ;
   u8 pat_cb ;
...
struct fimc_vid_cap {
   ...
   int active_buf_cnt ;
    klee_make_symbolic(&active_buf_cnt, sizeof(int), "active_buf_cnt");
   int buf_index ;
    klee_make_symbolic(&buf_index, sizeof(int), "buf_index");
   unsigned int frame_count ;
    klee_make_symbolic(&frame_count, sizeof(int), "frame_count");
   unsigned int reqbufs_count ;
    klee_make_symbolic(&reqbufs_count, sizeof(int), "reqbufs_count");
   bool streaming ;
   int input_index ;
    klee_make_symbolic(&input_index, sizeof(int), "input_index");
   u32 input ;
...
struct fimc_drvdata {
   ...
   int num_entities ;
    klee_make_symbolic(&num_entities, sizeof(int), "num_entities");
   unsigned long lclk_frequency ;
    klee_make_symbolic(&lclk_frequency, sizeof(long), "lclk_frequency");
   u8 cistatus2 ;
   u8 dma_pix_hoff ;
   u8 alpha_color ;
   u8 out_buf_count ;
...
struct clk_onecell_data {
   ...
   unsigned int clk_num ;
    klee_make_symbolic(&clk_num, sizeof(int), "clk_num");
};
struct flite_drvdata {
   unsigned short max_width ;
    klee_make_symbolic(&max_width, sizeof(short), "max_width");
   unsigned short max_height ;
    klee_make_symbolic(&max_height, sizeof(short), "max_height");
   unsigned short out_width_align ;
    klee_make_symbolic(&out_width_align, sizeof(short), "out_width_align");
   unsigned short win_hor_offs_align ;
    klee_make_symbolic(&win_hor_offs_align, sizeof(short), "win_hor_offs_align");
   unsigned short out_hor_offs_align ;
    klee_make_symbolic(&out_hor_offs_align, sizeof(short), "out_hor_offs_align");
   unsigned short max_dma_bufs ;
    klee_make_symbolic(&max_dma_bufs, sizeof(short), "max_dma_bufs");
   unsigned short num_instances ;
    klee_make_symbolic(&num_instances, sizeof(short), "num_instances");
};
struct fimc_lite_events {
   unsigned int data_overflow ;
    klee_make_symbolic(&data_overflow, sizeof(int), "data_overflow");
};
struct flite_frame {
   u16 f_width ;
   u16 f_height ;
...
struct fimc_lite {
   ...
   unsigned int source_subdev_grp_id ;
    klee_make_symbolic(&source_subdev_grp_id, sizeof(int), "source_subdev_grp_id");
   unsigned long state ;
   struct list_head pending_buf_q ;
   struct list_head active_buf_q ;
...
struct fimc_camclk_info {
   ...
   unsigned long frequency ;
    klee_make_symbolic(&frequency, sizeof(long), "frequency");
};
...
struct cam_clk_provider {
   ...
   int num_clocks ;
    klee_make_symbolic(&num_clocks, sizeof(int), "num_clocks");
};
struct fimc_is;
struct fimc_md {
   ...
   int num_sensors ;
    klee_make_symbolic(&num_sensors, sizeof(int), "num_sensors");
...
struct v4l2_of_bus_mipi_csi2 {
   ...
   unsigned char clock_lane ;
    klee_make_symbolic(&clock_lane, sizeof(char), "clock_lane");
   unsigned short num_data_lanes ;
    klee_make_symbolic(&num_data_lanes, sizeof(short), "num_data_lanes");
...
struct v4l2_of_bus_parallel {
   ...
   unsigned char data_shift ;
    klee_make_symbolic(&data_shift, sizeof(char), "data_shift");
};
...
struct v4l2_of_endpoint {
   ...
   unsigned int nr_of_link_frequencies ;
    klee_make_symbolic(&nr_of_link_frequencies, sizeof(int), "nr_of_link_frequencies");
};
...
struct fimc_is_video {
   ...
   unsigned int buf_mask ;
    klee_make_symbolic(&buf_mask, sizeof(int), "buf_mask");
   unsigned int frame_count ;
   int streaming ;
...
struct fimc_isp {
   ...
   unsigned int cac_margin_x ;
    klee_make_symbolic(&cac_margin_x, sizeof(int), "cac_margin_x");
   unsigned int cac_margin_y ;
    klee_make_symbolic(&cac_margin_y, sizeof(int), "cac_margin_y");
   unsigned long state ;
...
struct sensor_drv_data {
   ...
   unsigned short open_timeout ;
    klee_make_symbolic(&open_timeout, sizeof(short), "open_timeout");
};
struct fimc_is_sensor {
   struct sensor_drv_data  const  *drvdata ;
   unsigned int i2c_bus ;
    klee_make_symbolic(&i2c_bus, sizeof(int), "i2c_bus");
   u8 test_pattern ;
};
...
struct fimc_is {
   ...
   unsigned int sensor_index ;
    klee_make_symbolic(&sensor_index, sizeof(int), "sensor_index");
...
{ 
  ...
  int ty ;
    klee_make_symbolic(&ty, sizeof(int), "ty");
  int sx ;
    klee_make_symbolic(&sx, sizeof(int), "sx");
  int sy ;
...
{ 
  ...
  void *tmp___0 ;
  int last_buf ;
    klee_make_symbolic(&last_buf, sizeof(int), "last_buf");
  int tmp___1 ;
  int tmp___2 ;
  int tmp___3 ;
...
{ 
  unsigned int max_alpha ;
    klee_make_symbolic(&max_alpha, sizeof(int), "max_alpha");
  int tmp ;
  struct fimc_ctrls *ctrls ;
  struct v4l2_ctrl_handler *handler ;
...
{ 
  unsigned int has_alpha ;
    klee_make_symbolic(&has_alpha, sizeof(int), "has_alpha");
  struct fimc_ctrls *ctrls ;
...
{ 
  ...
  unsigned int camblk_cfg ;
    klee_make_symbolic(&camblk_cfg, sizeof(int), "camblk_cfg");
  int ret ;
  int __ret_warn_on ;
  long tmp ;
  long tmp___0 ;
...
{ 
  ...
  int tmp___5 ;
  unsigned int plane ;
    klee_make_symbolic(&plane, sizeof(int), "plane");
  int tmp___6 ;
  unsigned int size ;
  s32 index ;
  s32 tmp___7 ;
...
{ 
  ...
  struct fimc_vid_cap *vid_cap ;
  int min_bufs ;
    klee_make_symbolic(&min_bufs, sizeof(int), "min_bufs");
  int ret ;
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
...
{ 
  ...
  struct fimc_fmt *fmt ;
  unsigned long wh ;
    klee_make_symbolic(&wh, sizeof(long), "wh");
  int i ;
  unsigned int size ;
  unsigned int _max1 ;
...
{ 
  ...
  int buf_id ;
    klee_make_symbolic(&buf_id, sizeof(int), "buf_id");
  int tmp___1 ;
  int tmp___2 ;
  int ret ;
  int tmp___3 ;
...
{ 
  ...
  struct platform_device *pdev ;
  int plat_entity ;
    klee_make_symbolic(&plat_entity, sizeof(int), "plat_entity");
  int tmp ;
  bool tmp___0 ;
  int tmp___1 ;
  int tmp___2 ;
...
{ 
  ...
  int pad ;
  int fimc_id ;
    klee_make_symbolic(&fimc_id, sizeof(int), "fimc_id");
  int ret ;
  u32 flags ;
  u32 link_mask ;
  void *tmp___0 ;
