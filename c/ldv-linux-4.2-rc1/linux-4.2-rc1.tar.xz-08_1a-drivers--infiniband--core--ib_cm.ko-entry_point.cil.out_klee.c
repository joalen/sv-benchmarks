...
{ 
  ...
  __be64 service_mask ;
  int data_cmp ;
    klee_make_symbolic(&data_cmp, sizeof(int), "data_cmp");
...
{ 
  ...
  struct rb_node  const  *__mptr ;
  int cmp ;
    klee_make_symbolic(&cmp, sizeof(int), "cmp");
  int tmp ;
  int tmp___0 ;
...
{ 
  int wait_time ;
    klee_make_symbolic(&wait_time, sizeof(int), "wait_time");
  unsigned long flags ;
  raw_spinlock_t *tmp ;
  unsigned long tmp___0 ;
...
{ 
  ...
  u16 attr_id ;
  int paths ;
    klee_make_symbolic(&paths, sizeof(int), "paths");
  __u16 tmp ;
  void *tmp___0 ;
  struct lock_class_key __key ;
  atomic_long_t __constr_expr_0 ;
