...
struct iscsi_bus_flash_conn {
   ...
   unsigned int tcp_xmit_wsf ;
    klee_make_symbolic(&tcp_xmit_wsf, sizeof(int), "tcp_xmit_wsf");
   unsigned int tcp_recv_wsf ;
    klee_make_symbolic(&tcp_recv_wsf, sizeof(int), "tcp_recv_wsf");
   int hdrdgst_en ;
...
struct iscsi_bus_flash_session {
   ...
   unsigned int target_id ;
   int flash_state ;
    klee_make_symbolic(&flash_state, sizeof(int), "flash_state");
   void *dd_data ;
   struct device dev ;
   ...
   int default_taskmgmt_timeout ;
    klee_make_symbolic(&default_taskmgmt_timeout, sizeof(int), "default_taskmgmt_timeout");
   int initial_r2t_en ;
...
struct be_aic_obj {
   ...
   u32 et_eqd ;
   ulong jiffs ;
    klee_make_symbolic(&jiffs, sizeof(long), "jiffs");
   u64 eq_prev ;
};
struct beiscsi_hba;
struct be_eq_obj {
...
struct __anonstruct_fw_config_355 {
   ...
   unsigned int eqid_count ;
    klee_make_symbolic(&eqid_count, sizeof(int), "eqid_count");
   unsigned int cqid_count ;
    klee_make_symbolic(&cqid_count, sizeof(int), "cqid_count");
   ...
   unsigned long ulp_supported ;
    klee_make_symbolic(&ulp_supported, sizeof(long), "ulp_supported");
};
struct beiscsi_hba {
   ...
   unsigned int state ;
   int get_boot ;
    klee_make_symbolic(&get_boot, sizeof(int), "get_boot");
   bool fw_timeout ;
   bool ue_detected ;
...
{ 
  ...
  unsigned short cid_from_ulp ;
    klee_make_symbolic(&cid_from_ulp, sizeof(short), "cid_from_ulp");
...
{ 
  ...
  unsigned int req_memsize ;
    klee_make_symbolic(&req_memsize, sizeof(int), "req_memsize");
  int ret ;
  uint32_t log_value ;
  int tmp ;
  uint32_t log_value___0 ;
...
{ 
  ...
  unsigned int doorbell_offset ;
    klee_make_symbolic(&doorbell_offset, sizeof(int), "doorbell_offset");
  unsigned int writables ;
  unsigned int i ;
  u32 doorbell ;
  unsigned int _min1 ;
...
{ 
  ...
  int status ;
  int ulp_num ;
    klee_make_symbolic(&ulp_num, sizeof(int), "ulp_num");
  uint32_t log_value ;
  uint32_t log_value___0 ;
  int tmp ;
...
{ 
  ...
  unsigned int ulp_icd_start ;
    klee_make_symbolic(&ulp_icd_start, sizeof(int), "ulp_icd_start");
  unsigned int ulp_num ;
  void *tmp ;
  uint32_t log_value ;
  void *tmp___0 ;
...
{ 
  ...
  struct hwi_context_memory *phwi_context ;
  int eqd ;
    klee_make_symbolic(&eqd, sizeof(int), "eqd");
  int i ;
  int num ;
  ulong now ;
