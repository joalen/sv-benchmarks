...
struct tsc2005_platform_data {
   int ts_pressure_max ;
    klee_make_symbolic(&ts_pressure_max, sizeof(int), "ts_pressure_max");
   int ts_pressure_fudge ;
    klee_make_symbolic(&ts_pressure_fudge, sizeof(int), "ts_pressure_fudge");
   int ts_x_max ;
    klee_make_symbolic(&ts_x_max, sizeof(int), "ts_x_max");
   int ts_x_fudge ;
    klee_make_symbolic(&ts_x_fudge, sizeof(int), "ts_x_fudge");
   int ts_y_max ;
    klee_make_symbolic(&ts_y_max, sizeof(int), "ts_y_max");
   int ts_y_fudge ;
    klee_make_symbolic(&ts_y_fudge, sizeof(int), "ts_y_fudge");
   int ts_x_plate_ohm ;
    klee_make_symbolic(&ts_x_plate_ohm, sizeof(int), "ts_x_plate_ohm");
   unsigned int esd_timeout_ms ;
    klee_make_symbolic(&esd_timeout_ms, sizeof(int), "esd_timeout_ms");
   void (*set_reset)(bool  ) ;
};
struct regulator;
...
struct tsc2005 {
   ...
   struct mutex mutex ;
   int in_x ;
    klee_make_symbolic(&in_x, sizeof(int), "in_x");
   int in_y ;
    klee_make_symbolic(&in_y, sizeof(int), "in_y");
   int in_z1 ;
    klee_make_symbolic(&in_z1, sizeof(int), "in_z1");
   int in_z2 ;
    klee_make_symbolic(&in_z2, sizeof(int), "in_z2");
   spinlock_t lock ;
   struct timer_list penup_timer ;
   unsigned int esd_timeout ;
    klee_make_symbolic(&esd_timeout, sizeof(int), "esd_timeout");
   struct delayed_work esd_work ;
   unsigned long last_valid_interrupt ;
    klee_make_symbolic(&last_valid_interrupt, sizeof(long), "last_valid_interrupt");
   unsigned int x_plate_ohm ;
    klee_make_symbolic(&x_plate_ohm, sizeof(int), "x_plate_ohm");
   bool opened ;
   bool suspended ;
   bool pen_down ;
...
{ 
  ...
  unsigned int max_p ;
    klee_make_symbolic(&max_p, sizeof(int), "max_p");
  unsigned int fudge_x ;
    klee_make_symbolic(&fudge_x, sizeof(int), "fudge_x");
  unsigned int fudge_y ;
    klee_make_symbolic(&fudge_y, sizeof(int), "fudge_y");
  unsigned int fudge_p ;
    klee_make_symbolic(&fudge_p, sizeof(int), "fudge_p");
  unsigned int x_plate_ohm ;
  unsigned int esd_timeout ;
  int error ;
  void *tmp___0 ;
