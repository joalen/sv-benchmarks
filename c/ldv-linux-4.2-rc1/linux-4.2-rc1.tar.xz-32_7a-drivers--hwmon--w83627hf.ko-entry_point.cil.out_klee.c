...
struct w83627hf_sio_data {
   enum chips type ;
   int sioaddr ;
    klee_make_symbolic(&sioaddr, sizeof(int), "sioaddr");
};
...
{ 
  ...
  int i ;
  int num_temps ;
    klee_make_symbolic(&num_temps, sizeof(int), "num_temps");
...
{ 
  long in0 ;
    klee_make_symbolic(&in0, sizeof(long), "in0");
  int tmp ;
...
{ 
  ...
  int num_temps ;
  int num_pwms ;
    klee_make_symbolic(&num_pwms, sizeof(int), "num_pwms");
  int tmp___0 ;
  int tmp___1 ;
  int tmp___2 ;
  int tmp___3 ;
