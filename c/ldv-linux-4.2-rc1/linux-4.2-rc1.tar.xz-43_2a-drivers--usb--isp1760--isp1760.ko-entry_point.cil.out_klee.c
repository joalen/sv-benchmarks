...
struct isp1760_hcd {
   ...
   int atl_done_map ;
    klee_make_symbolic(&atl_done_map, sizeof(int), "atl_done_map");
   struct isp1760_slotinfo int_slots[32U] ;
   int int_done_map ;
    klee_make_symbolic(&int_done_map, sizeof(int), "int_done_map");
   ...
   unsigned long reset_done ;
    klee_make_symbolic(&reset_done, sizeof(long), "reset_done");
...
struct isp1760_udc {
   ...
   unsigned int devstatus ;
    klee_make_symbolic(&devstatus, sizeof(int), "devstatus");
};
struct isp1760_device {
   struct device *dev ;
   void *regs ;
   unsigned int devflags ;
    klee_make_symbolic(&devflags, sizeof(int), "devflags");
...
struct isp1760_qh {
   ...
   int tt_buffer_dirty ;
    klee_make_symbolic(&tt_buffer_dirty, sizeof(int), "tt_buffer_dirty");
};
struct urb_listitem {
   struct list_head urb_list ;
   struct urb *urb ;
...
{ 
  int ret ;
  int any_ret ;
    klee_make_symbolic(&any_ret, sizeof(int), "any_ret");
...
{ 
  ...
  struct isp1760_hcd *tmp ;
  int skip_map ;
    klee_make_symbolic(&skip_map, sizeof(int), "skip_map");
  int __ret_warn_on ;
  long tmp___0 ;
  int __ret_warn_on___0 ;
  long tmp___1 ;
...
{ 
  int last_qtd ;
    klee_make_symbolic(&last_qtd, sizeof(int), "last_qtd");
  struct isp1760_qtd *qtd ;
...
{ 
  ...
  int curr_slot ;
    klee_make_symbolic(&curr_slot, sizeof(int), "curr_slot");
  int free_slot ;
    klee_make_symbolic(&free_slot, sizeof(int), "free_slot");
  int n ;
...
{ 
  ...
  unsigned long spinflags ;
    klee_make_symbolic(&spinflags, sizeof(long), "spinflags");
  unsigned long tmp___0 ;
  unsigned long tmp___1 ;
...
{ 
  ...
  int retval ;
  int qh_in_queue ;
    klee_make_symbolic(&qh_in_queue, sizeof(int), "qh_in_queue");
  int tmp___0 ;
  int tmp___1 ;
  struct list_head  const  *__mptr ;
  struct list_head  const  *__mptr___0 ;
...
{ 
  struct urb *urb ;
  int urb_was_running ;
    klee_make_symbolic(&urb_was_running, sizeof(int), "urb_was_running");
  int tmp ;
  struct list_head  const  *__mptr ;
  int tmp___0 ;
