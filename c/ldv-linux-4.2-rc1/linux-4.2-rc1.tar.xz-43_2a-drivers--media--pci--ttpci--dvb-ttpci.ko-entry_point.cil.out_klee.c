...
typedef int video_format_t;
    klee_make_symbolic(&video_format_t, sizeof(int), "video_format_t");
typedef int video_displayformat_t;
    klee_make_symbolic(&video_displayformat_t, sizeof(int), "video_displayformat_t");
...
typedef int video_stream_source_t;
    klee_make_symbolic(&video_stream_source_t, sizeof(int), "video_stream_source_t");
enum ldv_31545 {
    VIDEO_STOPPED = 0,
    VIDEO_PLAYING = 1,
    VIDEO_FREEZED = 2
...
union __anonunion_u_328 {
   ...
   unsigned char vsync_field ;
    klee_make_symbolic(&vsync_field, sizeof(char), "vsync_field");
};
struct video_event {
   __s32 type ;
...
struct video_status {
   int video_blank ;
    klee_make_symbolic(&video_blank, sizeof(int), "video_blank");
...
typedef int audio_stream_source_t;
    klee_make_symbolic(&audio_stream_source_t, sizeof(int), "audio_stream_source_t");
enum ldv_31572 {
    AUDIO_STOPPED = 0,
    AUDIO_PLAYING = 1,
    AUDIO_PAUSED = 2
...
typedef int audio_channel_select_t;
    klee_make_symbolic(&audio_channel_select_t, sizeof(int), "audio_channel_select_t");
struct audio_mixer {
   unsigned int volume_left ;
    klee_make_symbolic(&volume_left, sizeof(int), "volume_left");
   unsigned int volume_right ;
    klee_make_symbolic(&volume_right, sizeof(int), "volume_right");
};
typedef struct audio_mixer audio_mixer_t;
struct audio_status {
   int AV_sync_state ;
    klee_make_symbolic(&AV_sync_state, sizeof(int), "AV_sync_state");
   int mute_state ;
    klee_make_symbolic(&mute_state, sizeof(int), "mute_state");
   audio_play_state_t play_state ;
   audio_stream_source_t stream_source ;
   audio_channel_select_t channel_select ;
   int bypass_mode ;
    klee_make_symbolic(&bypass_mode, sizeof(int), "bypass_mode");
...
struct osd_cmd_s {
   OSD_Command cmd ;
   int x0 ;
    klee_make_symbolic(&x0, sizeof(int), "x0");
   int y0 ;
    klee_make_symbolic(&y0, sizeof(int), "y0");
   int x1 ;
...
struct ipack {
   ...
   u16 *pid ;
   int mpeg ;
    klee_make_symbolic(&mpeg, sizeof(int), "mpeg");
   u8 check ;
   int which ;
   ...
   int count ;
   int repack_subids ;
    klee_make_symbolic(&repack_subids, sizeof(int), "repack_subids");
};
struct ipv4_devconf {
   void *sysctl ;
   int data[29U] ;
...
struct av7110 {
   ...
   int analog_tuner_flags ;
    klee_make_symbolic(&analog_tuner_flags, sizeof(int), "analog_tuner_flags");
   int current_input ;
    klee_make_symbolic(&current_input, sizeof(int), "current_input");
   u32 current_freq ;
   struct tasklet_struct debi_tasklet ;
   struct tasklet_struct gpio_tasklet ;
   int adac_type ;
    klee_make_symbolic(&adac_type, sizeof(int), "adac_type");
   void *iobuf ;
   struct dvb_ringbuffer avout ;
   struct dvb_ringbuffer aout ;
   void *bmpbuf ;
   int bmpp ;
    klee_make_symbolic(&bmpp, sizeof(int), "bmpp");
   int bmplen ;
    klee_make_symbolic(&bmplen, sizeof(int), "bmplen");
   ...
   int rec_mode ;
    klee_make_symbolic(&rec_mode, sizeof(int), "rec_mode");
   int playing ;
   int osdwin ;
    klee_make_symbolic(&osdwin, sizeof(int), "osdwin");
   u16 osdbpp[8U] ;
   ...
   int feeding1 ;
    klee_make_symbolic(&feeding1, sizeof(int), "feeding1");
   u32 ttbp ;
   ...
   u16 display_panscan ;
   int display_ar ;
    klee_make_symbolic(&display_ar, sizeof(int), "display_ar");
   int trickmode ;
    klee_make_symbolic(&trickmode, sizeof(int), "trickmode");
   ...
   u8 *kbuf[2U] ;
   int sinfo ;
    klee_make_symbolic(&sinfo, sizeof(int), "sinfo");
   int feeding ;
    klee_make_symbolic(&feeding, sizeof(int), "feeding");
   int arm_errors ;
    klee_make_symbolic(&arm_errors, sizeof(int), "arm_errors");
   int registered ;
   ...
   u32 avtype ;
   int arm_ready ;
    klee_make_symbolic(&arm_ready, sizeof(int), "arm_ready");
   ...
   unsigned long size_fw ;
    klee_make_symbolic(&size_fw, sizeof(long), "size_fw");
   unsigned char *bin_dpram ;
   unsigned long size_dpram ;
    klee_make_symbolic(&size_dpram, sizeof(long), "size_dpram");
   unsigned char *bin_root ;
   unsigned long size_root ;
    klee_make_symbolic(&size_root, sizeof(long), "size_root");
...
int av7110_debug ;
    klee_make_symbolic(&av7110_debug, sizeof(int), "av7110_debug");
...
{ 
  ...
  uint size ;
  uint lpb ;
    klee_make_symbolic(&lpb, sizeof(int), "lpb");
  uint bnum ;
    klee_make_symbolic(&bnum, sizeof(int), "bnum");
  uint brest ;
    klee_make_symbolic(&brest, sizeof(int), "brest");
  int i ;
  int rc ;
    klee_make_symbolic(&rc, sizeof(int), "rc");
  int release_rc ;
    klee_make_symbolic(&release_rc, sizeof(int), "release_rc");
  long tmp ;
...
{ 
  ...
  int val ;
  int balance ;
    klee_make_symbolic(&balance, sizeof(int), "balance");
  int tmp ;
...
{ 
  ...
  int sw ;
    klee_make_symbolic(&sw, sizeof(int), "sw");
  u8 *p ;
  int ret ;
...
{ 
  ...
  int add ;
    klee_make_symbolic(&add, sizeof(int), "add");
  int check ;
...
{ 
  ...
  int c ;
  int fill ;
    klee_make_symbolic(&fill, sizeof(int), "fill");
  u8 tshead[4U] ;
  u8 tmp ;
...
{ 
  int l ;
  int pes_start ;
    klee_make_symbolic(&pes_start, sizeof(int), "pes_start");
  u8 obuf[188U] ;
  long c ;
...
{ 
  ...
  unsigned long ldvarg28 ;
    klee_make_symbolic(&ldvarg28, sizeof(long), "ldvarg28");
...
{ 
  int free ;
  int non_blocking ;
    klee_make_symbolic(&non_blocking, sizeof(int), "non_blocking");
  u8 *page ;
  unsigned long tmp ;
  int res ;
...
{ 
  unsigned long ldvarg55 ;
    klee_make_symbolic(&ldvarg55, sizeof(long), "ldvarg55");
  size_t ldvarg64 ;
  size_t ldvarg61 ;
  loff_t ldvarg58 ;
  int ldvarg57 ;
...
static int pids_off  ;
    klee_make_symbolic(&pids_off, sizeof(int), "pids_off");
static int adac  =    0;
static int hw_sections  ;
    klee_make_symbolic(&hw_sections, sizeof(int), "hw_sections");
static int rgb_on  ;
    klee_make_symbolic(&rgb_on, sizeof(int), "rgb_on");
static int volume  =    255;
static int budgetpatch  ;
    klee_make_symbolic(&budgetpatch, sizeof(int), "budgetpatch");
static int wss_cfg_4_3  =    16392;
static int wss_cfg_16_9  =    7;
static int tv_standard  ;
    klee_make_symbolic(&tv_standard, sizeof(int), "tv_standard");
static int full_ts  ;
    klee_make_symbolic(&full_ts, sizeof(int), "full_ts");
...
static int av7110_num  ;
    klee_make_symbolic(&av7110_num, sizeof(int), "av7110_num");
...
{ 
  ...
  int ac3_off ;
    klee_make_symbolic(&ac3_off, sizeof(int), "ac3_off");
  int streamid ;
    klee_make_symbolic(&streamid, sizeof(int), "streamid");
  int nframes ;
...
static int av_cnt  ;
    klee_make_symbolic(&av_cnt, sizeof(int), "av_cnt");
