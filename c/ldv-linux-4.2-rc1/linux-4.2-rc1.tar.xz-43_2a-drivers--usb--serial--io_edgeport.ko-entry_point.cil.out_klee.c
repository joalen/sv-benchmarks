...
struct edgeport_serial {
   ...
   int is_epic ;
    klee_make_symbolic(&is_epic, sizeof(int), "is_epic");
...
{ 
  ...
  int length ;
  int bytes_avail ;
    klee_make_symbolic(&bytes_avail, sizeof(int), "bytes_avail");
  int position ;
    klee_make_symbolic(&position, sizeof(int), "position");
  int txCredits ;
    klee_make_symbolic(&txCredits, sizeof(int), "txCredits");
  int portNumber ;
    klee_make_symbolic(&portNumber, sizeof(int), "portNumber");
  int result ;
  int status ;
  struct _ddebug descriptor ;
  long tmp ;
...
{ 
  ...
  struct TxFifo *fifo ;
  int copySize ;
    klee_make_symbolic(&copySize, sizeof(int), "copySize");
  int bytesleft ;
    klee_make_symbolic(&bytesleft, sizeof(int), "bytesleft");
  int firsthalf ;
    klee_make_symbolic(&firsthalf, sizeof(int), "firsthalf");
  int secondhalf ;
    klee_make_symbolic(&secondhalf, sizeof(int), "secondhalf");
  unsigned long flags ;
  unsigned int _min1 ;
  unsigned int _min2 ;
  struct _ddebug descriptor ;
...
{ 
  ...
  void *tmp ;
  int num_chars ;
    klee_make_symbolic(&num_chars, sizeof(int), "num_chars");
  unsigned long flags ;
  struct _ddebug descriptor ;
  long tmp___0 ;
  struct _ddebug descriptor___0 ;
