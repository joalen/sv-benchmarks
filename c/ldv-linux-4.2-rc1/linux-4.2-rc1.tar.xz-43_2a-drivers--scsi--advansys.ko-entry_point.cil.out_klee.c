...
struct asc_dvc_var {
   ...
   unsigned int max_dma_count ;
    klee_make_symbolic(&max_dma_count, sizeof(int), "max_dma_count");
   uchar no_scam ;
   ...
   unsigned int uc_break ;
    klee_make_symbolic(&uc_break, sizeof(int), "uc_break");
};
...
struct asc_stats {
   unsigned int queuecommand ;
    klee_make_symbolic(&queuecommand, sizeof(int), "queuecommand");
   unsigned int reset ;
    klee_make_symbolic(&reset, sizeof(int), "reset");
   unsigned int biosparam ;
    klee_make_symbolic(&biosparam, sizeof(int), "biosparam");
   ...
   unsigned int build_error ;
    klee_make_symbolic(&build_error, sizeof(int), "build_error");
   unsigned int adv_build_noreq ;
    klee_make_symbolic(&adv_build_noreq, sizeof(int), "adv_build_noreq");
   unsigned int adv_build_nosg ;
    klee_make_symbolic(&adv_build_nosg, sizeof(int), "adv_build_nosg");
   unsigned int exe_noerror ;
    klee_make_symbolic(&exe_noerror, sizeof(int), "exe_noerror");
   unsigned int exe_busy ;
    klee_make_symbolic(&exe_busy, sizeof(int), "exe_busy");
   unsigned int exe_error ;
    klee_make_symbolic(&exe_error, sizeof(int), "exe_error");
   unsigned int exe_unknown ;
    klee_make_symbolic(&exe_unknown, sizeof(int), "exe_unknown");
   unsigned int xfer_cnt ;
    klee_make_symbolic(&xfer_cnt, sizeof(int), "xfer_cnt");
   unsigned int xfer_elem ;
    klee_make_symbolic(&xfer_elem, sizeof(int), "xfer_elem");
   unsigned int xfer_sect ;
    klee_make_symbolic(&xfer_sect, sizeof(int), "xfer_sect");
};
...
{ 
  ...
  ushort num ;
    klee_make_symbolic(&num, sizeof(short), "num");
  uchar tmp ;
  uchar *tmp___0 ;
  uchar *tmp___1 ;
  uchar *tmp___2 ;
...
{ 
  int i ;
  int warn_code ;
    klee_make_symbolic(&warn_code, sizeof(int), "warn_code");
  unsigned int iop_base ;
  __le32 phy_addr ;
  __le32 phy_size ;
...
{ 
  ...
  int carr_num ;
    klee_make_symbolic(&carr_num, sizeof(int), "carr_num");
  int i ;
...
{ 
  ...
  uchar tmp___1 ;
  int cdb16_len ;
    klee_make_symbolic(&cdb16_len, sizeof(int), "cdb16_len");
  void *tmp___2 ;
  int tmp___3 ;
  void *tmp___4 ;
  void *tmp___5 ;
...
{ 
  ...
  unsigned long data_cnt ;
    klee_make_symbolic(&data_cnt, sizeof(long), "data_cnt");
  uint tmp ;
  uint tmp___0 ;
