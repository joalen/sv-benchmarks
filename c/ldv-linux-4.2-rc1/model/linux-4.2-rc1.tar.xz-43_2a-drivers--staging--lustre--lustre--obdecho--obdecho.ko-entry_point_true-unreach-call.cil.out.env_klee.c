...
// Function: block_debug_check
// with type: int block_debug_check(char *, void *, int, __u64 , __u64 )
// with return type: int
int __VERIFIER_nondet_int(void);
...
// Function: block_debug_setup
// with type: int block_debug_setup(void *, int, __u64 , __u64 )
// with return type: int
int __VERIFIER_nondet_int(void);
...
// with type: int class_connect(struct lustre_handle *, struct obd_device *, struct obd_uuid *)
// with return type: int
int __VERIFIER_nondet_int(void);
...
// Function: class_disconnect
// with type: int class_disconnect(struct obd_export *)
// with return type: int
int __VERIFIER_nondet_int(void);
...
// Function: lprocfs_read_helper
// with type: __s64 lprocfs_read_helper(struct lprocfs_counter *, struct lprocfs_counter_header *, enum lprocfs_stats_flags , enum lprocfs_fields_flags )
// with return type: __s64 
...
// Function: lprocfs_stats_alloc_one
// with type: int lprocfs_stats_alloc_one(struct lprocfs_stats *, unsigned int)
// with return type: int
int __VERIFIER_nondet_int(void);
...
// Function: lu_site_purge
// with type: int lu_site_purge(const struct lu_env *, struct lu_site *, int)
// with return type: int
int __VERIFIER_nondet_int(void);
