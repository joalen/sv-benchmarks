...
// Function: ldv_resume_early_32
// with type: int ldv_resume_early_32()
// with return type: int
int __VERIFIER_nondet_int(void);
int ldv_resume_early_32() {
  // Simple type
  return __VERIFIER_nondet_int();
}
...
// Function: ldv_suspend_33
// with type: int ldv_suspend_33()
// with return type: int
int __VERIFIER_nondet_int(void);
int ldv_suspend_33() {
  // Simple type
...
// Function: ldv_suspend_late_32
// with type: int ldv_suspend_late_32()
// with return type: int
int __VERIFIER_nondet_int(void);
int ldv_suspend_late_32() {
  // Simple type
  return __VERIFIER_nondet_int();
}
