...
struct swap_extent {
   ...
   unsigned long start_page ;
    klee_make_symbolic(&start_page, sizeof(long), "start_page");
...
struct swap_info_struct {
   ...
   unsigned int lowest_bit ;
    klee_make_symbolic(&lowest_bit, sizeof(int), "lowest_bit");
   unsigned int highest_bit ;
    klee_make_symbolic(&highest_bit, sizeof(int), "highest_bit");
   unsigned int pages ;
   unsigned int inuse_pages ;
    klee_make_symbolic(&inuse_pages, sizeof(int), "inuse_pages");
   unsigned int cluster_next ;
    klee_make_symbolic(&cluster_next, sizeof(int), "cluster_next");
   unsigned int cluster_nr ;
    klee_make_symbolic(&cluster_nr, sizeof(int), "cluster_nr");
   ...
   unsigned int old_block_size ;
    klee_make_symbolic(&old_block_size, sizeof(int), "old_block_size");
...
struct writeback_control {
   ...
   struct inode *inode ;
   int wb_id ;
    klee_make_symbolic(&wb_id, sizeof(int), "wb_id");
   int wb_lcand_id ;
    klee_make_symbolic(&wb_lcand_id, sizeof(int), "wb_lcand_id");
   int wb_tcand_id ;
    klee_make_symbolic(&wb_tcand_id, sizeof(int), "wb_tcand_id");
   size_t wb_bytes ;
...
struct cfs_cpu_partition {
   ...
   unsigned int cpt_spread_rotor ;
    klee_make_symbolic(&cpt_spread_rotor, sizeof(int), "cpt_spread_rotor");
};
struct cfs_cpt_table {
   unsigned int ctb_version ;
    klee_make_symbolic(&ctb_version, sizeof(int), "ctb_version");
   unsigned int ctb_spread_rotor ;
    klee_make_symbolic(&ctb_spread_rotor, sizeof(int), "ctb_spread_rotor");
   unsigned int ctb_nparts ;
    klee_make_symbolic(&ctb_nparts, sizeof(int), "ctb_nparts");
...
struct cfs_debug_limit_state {
   unsigned long cdls_next ;
    klee_make_symbolic(&cdls_next, sizeof(long), "cdls_next");
   unsigned int cdls_delay ;
    klee_make_symbolic(&cdls_delay, sizeof(int), "cdls_delay");
   int cdls_count ;
    klee_make_symbolic(&cdls_count, sizeof(int), "cdls_count");
};
struct libcfs_debug_msg_data {
   char const   *msg_file ;
   char const   *msg_fn ;
   int msg_subsys ;
    klee_make_symbolic(&msg_subsys, sizeof(int), "msg_subsys");
   int msg_line ;
    klee_make_symbolic(&msg_line, sizeof(int), "msg_line");
   int msg_mask ;
    klee_make_symbolic(&msg_mask, sizeof(int), "msg_mask");
...
struct cfs_hash_bucket {
   ...
   unsigned int hsb_index ;
    klee_make_symbolic(&hsb_index, sizeof(int), "hsb_index");
   int hsb_depmax ;
    klee_make_symbolic(&hsb_depmax, sizeof(int), "hsb_depmax");
   long hsb_head[0U] ;
};
struct cfs_hash_bd {
   struct cfs_hash_bucket *bd_bucket ;
   unsigned int bd_offset ;
    klee_make_symbolic(&bd_offset, sizeof(int), "bd_offset");
};
struct cfs_hash {
...
struct __anonstruct_lnet_md_t_382 {
   ...
   int max_size ;
    klee_make_symbolic(&max_size, sizeof(int), "max_size");
...
struct __anonstruct_lnet_kiov_t_383 {
   ...
   unsigned int kiov_len ;
    klee_make_symbolic(&kiov_len, sizeof(int), "kiov_len");
   unsigned int kiov_offset ;
    klee_make_symbolic(&kiov_offset, sizeof(int), "kiov_offset");
};
...
typedef unsigned long lnet_seq_t;
    klee_make_symbolic(&lnet_seq_t, sizeof(long), "lnet_seq_t");
struct __anonstruct_lnet_event_t_384 {
   ...
   unsigned int pt_index ;
    klee_make_symbolic(&pt_index, sizeof(int), "pt_index");
   __u64 match_bits ;
   unsigned int rlength ;
    klee_make_symbolic(&rlength, sizeof(int), "rlength");
   unsigned int mlength ;
    klee_make_symbolic(&mlength, sizeof(int), "mlength");
...
struct fs_struct {
   ...
   seqcount_t seq ;
   int umask ;
    klee_make_symbolic(&umask, sizeof(int), "umask");
   int in_exec ;
    klee_make_symbolic(&in_exec, sizeof(int), "in_exec");
   struct path root ;
   struct path pwd ;
};
...
struct lprocfs_counter_header {
   unsigned int lc_config ;
    klee_make_symbolic(&lc_config, sizeof(int), "lc_config");
   char const   *lc_name ;
   char const   *lc_units ;
};
...
struct lprocfs_stats {
   unsigned short ls_num ;
    klee_make_symbolic(&ls_num, sizeof(short), "ls_num");
   unsigned short ls_biggest_alloc_num ;
    klee_make_symbolic(&ls_biggest_alloc_num, sizeof(short), "ls_biggest_alloc_num");
...
struct ptlrpc_cli_ctx {
   ...
   unsigned long cc_expire ;
    klee_make_symbolic(&cc_expire, sizeof(long), "cc_expire");
   unsigned char cc_early_expire : 1 ;
   unsigned long cc_flags ;
    klee_make_symbolic(&cc_flags, sizeof(long), "cc_flags");
...
struct ptlrpc_sec {
   ...
   atomic_t ps_nctx ;
   int ps_id ;
    klee_make_symbolic(&ps_id, sizeof(int), "ps_id");
   ...
   unsigned long ps_gc_interval ;
    klee_make_symbolic(&ps_gc_interval, sizeof(long), "ps_gc_interval");
   unsigned long ps_gc_next ;
    klee_make_symbolic(&ps_gc_next, sizeof(long), "ps_gc_next");
};
struct ptlrpc_svc_ctx {
...
struct adaptive_timeout {
   ...
   unsigned int at_flags ;
    klee_make_symbolic(&at_flags, sizeof(int), "at_flags");
   unsigned int at_current ;
    klee_make_symbolic(&at_current, sizeof(int), "at_current");
   unsigned int at_worst_ever ;
    klee_make_symbolic(&at_worst_ever, sizeof(int), "at_worst_ever");
...
struct obd_import {
   ...
   unsigned long imp_sec_expire ;
    klee_make_symbolic(&imp_sec_expire, sizeof(long), "imp_sec_expire");
   ...
   int imp_state_hist_idx ;
    klee_make_symbolic(&imp_state_hist_idx, sizeof(int), "imp_state_hist_idx");
   int imp_generation ;
    klee_make_symbolic(&imp_generation, sizeof(int), "imp_generation");
   __u32 imp_conn_cnt ;
   int imp_last_generation_checked ;
    klee_make_symbolic(&imp_last_generation_checked, sizeof(int), "imp_last_generation_checked");
   __u64 imp_last_replay_transno ;
   __u64 imp_peer_committed_transno ;
   __u64 imp_last_transno_checked ;
   struct lustre_handle imp_remote_handle ;
   unsigned long imp_next_ping ;
    klee_make_symbolic(&imp_next_ping, sizeof(long), "imp_next_ping");
   ...
   int imp_connect_error ;
    klee_make_symbolic(&imp_connect_error, sizeof(int), "imp_connect_error");
   __u32 imp_msg_magic ;
...
struct lu_device_type {
   ...
   unsigned int ldt_device_nr ;
    klee_make_symbolic(&ldt_device_nr, sizeof(int), "ldt_device_nr");
...
struct lu_object_header {
   ...
   unsigned long loh_flags ;
    klee_make_symbolic(&loh_flags, sizeof(long), "loh_flags");
   atomic_t loh_ref ;
   __u32 loh_attr ;
...
struct lu_site {
   ...
   int ls_purge_start ;
    klee_make_symbolic(&ls_purge_start, sizeof(int), "ls_purge_start");
...
struct lu_context {
   ...
   unsigned int lc_version ;
    klee_make_symbolic(&lc_version, sizeof(int), "lc_version");
   unsigned int lc_cookie ;
    klee_make_symbolic(&lc_cookie, sizeof(int), "lc_cookie");
};
struct lu_env {
...
struct ptlrpc_request_set {
   ...
   int set_rc ;
    klee_make_symbolic(&set_rc, sizeof(int), "set_rc");
   int set_max_inflight ;
    klee_make_symbolic(&set_max_inflight, sizeof(int), "set_max_inflight");
...
struct ptlrpc_reply_state {
   ...
   int rs_size ;
    klee_make_symbolic(&rs_size, sizeof(int), "rs_size");
   __u32 rs_opc ;
   __u64 rs_transno ;
   __u64 rs_xid ;
   ...
   int rs_repbuf_len ;
    klee_make_symbolic(&rs_repbuf_len, sizeof(int), "rs_repbuf_len");
   int rs_repdata_len ;
    klee_make_symbolic(&rs_repdata_len, sizeof(int), "rs_repdata_len");
   struct lustre_msg_v2 *rs_msg ;
   int rs_nlocks ;
    klee_make_symbolic(&rs_nlocks, sizeof(int), "rs_nlocks");
...
struct ptlrpc_request_pool {
   ...
   int prp_rq_size ;
    klee_make_symbolic(&prp_rq_size, sizeof(int), "prp_rq_size");
...
struct ptlrpc_nrs {
   ...
   unsigned long nrs_req_queued ;
    klee_make_symbolic(&nrs_req_queued, sizeof(long), "nrs_req_queued");
   unsigned long nrs_req_started ;
    klee_make_symbolic(&nrs_req_started, sizeof(long), "nrs_req_started");
   unsigned int nrs_num_pols ;
    klee_make_symbolic(&nrs_num_pols, sizeof(int), "nrs_num_pols");
...
struct ptlrpc_nrs_pol_desc {
   ...
   unsigned int pd_flags ;
    klee_make_symbolic(&pd_flags, sizeof(int), "pd_flags");
   atomic_t pd_refs ;
};
...
struct ptlrpc_nrs_policy {
   ...
   unsigned int pol_flags ;
    klee_make_symbolic(&pol_flags, sizeof(int), "pol_flags");
   long pol_req_queued ;
    klee_make_symbolic(&pol_req_queued, sizeof(long), "pol_req_queued");
   long pol_req_started ;
    klee_make_symbolic(&pol_req_started, sizeof(long), "pol_req_started");
   long pol_ref ;
    klee_make_symbolic(&pol_ref, sizeof(long), "pol_ref");
...
struct ptlrpc_nrs_request {
   ...
   unsigned int nr_res_idx ;
    klee_make_symbolic(&nr_res_idx, sizeof(int), "nr_res_idx");
...
struct ptlrpc_request {
   int rq_type ;
    klee_make_symbolic(&rq_type, sizeof(int), "rq_type");
   int rq_status ;
    klee_make_symbolic(&rq_status, sizeof(int), "rq_status");
   ...
   unsigned int rq_nr_resend ;
    klee_make_symbolic(&rq_nr_resend, sizeof(int), "rq_nr_resend");
   enum rq_phase rq_phase ;
   enum rq_phase rq_next_phase ;
   atomic_t rq_refcount ;
   short rq_request_portal ;
    klee_make_symbolic(&rq_request_portal, sizeof(short), "rq_request_portal");
   short rq_reply_portal ;
    klee_make_symbolic(&rq_reply_portal, sizeof(short), "rq_reply_portal");
   int rq_nob_received ;
    klee_make_symbolic(&rq_nob_received, sizeof(int), "rq_nob_received");
   int rq_reqlen ;
    klee_make_symbolic(&rq_reqlen, sizeof(int), "rq_reqlen");
   int rq_replen ;
    klee_make_symbolic(&rq_replen, sizeof(int), "rq_replen");
   ...
   int rq_reqbuf_len ;
    klee_make_symbolic(&rq_reqbuf_len, sizeof(int), "rq_reqbuf_len");
   int rq_reqdata_len ;
    klee_make_symbolic(&rq_reqdata_len, sizeof(int), "rq_reqdata_len");
   int rq_repbuf_len ;
    klee_make_symbolic(&rq_repbuf_len, sizeof(int), "rq_repbuf_len");
   int rq_repdata_len ;
    klee_make_symbolic(&rq_repdata_len, sizeof(int), "rq_repdata_len");
   int rq_clrbuf_len ;
    klee_make_symbolic(&rq_clrbuf_len, sizeof(int), "rq_clrbuf_len");
   int rq_clrdata_len ;
    klee_make_symbolic(&rq_clrdata_len, sizeof(int), "rq_clrdata_len");
   unsigned int rq_reply_off ;
    klee_make_symbolic(&rq_reply_off, sizeof(int), "rq_reply_off");
   __u32 rq_req_swab_mask ;
   __u32 rq_rep_swab_mask ;
   int rq_import_generation ;
    klee_make_symbolic(&rq_import_generation, sizeof(int), "rq_import_generation");
   enum lustre_imp_state rq_send_state ;
   int rq_early_count ;
    klee_make_symbolic(&rq_early_count, sizeof(int), "rq_early_count");
   lnet_handle_md_t rq_req_md_h ;
   struct ptlrpc_cb_id rq_req_cbid ;
   long rq_delay_limit ;
    klee_make_symbolic(&rq_delay_limit, sizeof(long), "rq_delay_limit");
   unsigned long rq_queued_time ;
    klee_make_symbolic(&rq_queued_time, sizeof(long), "rq_queued_time");
...
struct ptlrpc_bulk_desc {
   ...
   int bd_import_generation ;
    klee_make_symbolic(&bd_import_generation, sizeof(int), "bd_import_generation");
   __u32 bd_portal ;
   ...
   int bd_iov_count ;
    klee_make_symbolic(&bd_iov_count, sizeof(int), "bd_iov_count");
   int bd_max_iov ;
    klee_make_symbolic(&bd_max_iov, sizeof(int), "bd_max_iov");
   int bd_nob ;
    klee_make_symbolic(&bd_nob, sizeof(int), "bd_nob");
   int bd_nob_transferred ;
    klee_make_symbolic(&bd_nob_transferred, sizeof(int), "bd_nob_transferred");
   __u64 bd_last_xid ;
   struct ptlrpc_cb_id bd_cbid ;
   lnet_nid_t bd_sender ;
   int bd_md_count ;
    klee_make_symbolic(&bd_md_count, sizeof(int), "bd_md_count");
   int bd_md_max_brw ;
    klee_make_symbolic(&bd_md_max_brw, sizeof(int), "bd_md_max_brw");
...
struct ptlrpc_thread {
   ...
   __u32 t_flags ;
   unsigned int t_id ;
    klee_make_symbolic(&t_id, sizeof(int), "t_id");
   pid_t t_pid ;
...
struct ptlrpc_request_buffer_desc {
   ...
   int rqbd_refcount ;
    klee_make_symbolic(&rqbd_refcount, sizeof(int), "rqbd_refcount");
   char *rqbd_buffer ;
...
struct ptlrpc_service {
   ...
   int srv_nthrs_cpt_init ;
    klee_make_symbolic(&srv_nthrs_cpt_init, sizeof(int), "srv_nthrs_cpt_init");
   int srv_nthrs_cpt_limit ;
    klee_make_symbolic(&srv_nthrs_cpt_limit, sizeof(int), "srv_nthrs_cpt_limit");
   struct dentry *srv_debugfs_entry ;
   struct lprocfs_stats *srv_stats ;
   int srv_hpreq_ratio ;
    klee_make_symbolic(&srv_hpreq_ratio, sizeof(int), "srv_hpreq_ratio");
   int srv_max_req_size ;
    klee_make_symbolic(&srv_max_req_size, sizeof(int), "srv_max_req_size");
   int srv_max_reply_size ;
    klee_make_symbolic(&srv_max_reply_size, sizeof(int), "srv_max_reply_size");
   int srv_buf_size ;
    klee_make_symbolic(&srv_buf_size, sizeof(int), "srv_buf_size");
   int srv_nbuf_per_group ;
    klee_make_symbolic(&srv_nbuf_per_group, sizeof(int), "srv_nbuf_per_group");
   __u32 srv_req_portal ;
   __u32 srv_rep_portal ;
   __u32 srv_ctx_tags ;
   int srv_watchdog_factor ;
    klee_make_symbolic(&srv_watchdog_factor, sizeof(int), "srv_watchdog_factor");
   unsigned char srv_is_stopping : 1 ;
   int srv_hist_nrqbds_cpt_max ;
    klee_make_symbolic(&srv_hist_nrqbds_cpt_max, sizeof(int), "srv_hist_nrqbds_cpt_max");
   int srv_ncpts ;
    klee_make_symbolic(&srv_ncpts, sizeof(int), "srv_ncpts");
   __u32 *srv_cpts ;
   int srv_cpt_bits ;
    klee_make_symbolic(&srv_cpt_bits, sizeof(int), "srv_cpt_bits");
...
struct ptlrpc_service_part {
   ...
   int scp_cpt ;
    klee_make_symbolic(&scp_cpt, sizeof(int), "scp_cpt");
   int scp_thr_nextid ;
    klee_make_symbolic(&scp_thr_nextid, sizeof(int), "scp_thr_nextid");
   int scp_nthrs_starting ;
    klee_make_symbolic(&scp_nthrs_starting, sizeof(int), "scp_nthrs_starting");
   int scp_nthrs_stopping ;
    klee_make_symbolic(&scp_nthrs_stopping, sizeof(int), "scp_nthrs_stopping");
   int scp_nthrs_running ;
    klee_make_symbolic(&scp_nthrs_running, sizeof(int), "scp_nthrs_running");
   struct list_head scp_threads ;
   spinlock_t scp_lock ;
   int scp_nrqbds_total ;
    klee_make_symbolic(&scp_nrqbds_total, sizeof(int), "scp_nrqbds_total");
   int scp_nrqbds_posted ;
    klee_make_symbolic(&scp_nrqbds_posted, sizeof(int), "scp_nrqbds_posted");
   int scp_rqbd_allocating ;
    klee_make_symbolic(&scp_rqbd_allocating, sizeof(int), "scp_rqbd_allocating");
   int scp_nreqs_incoming ;
    klee_make_symbolic(&scp_nreqs_incoming, sizeof(int), "scp_nreqs_incoming");
   struct list_head scp_rqbd_idle ;
   struct list_head scp_rqbd_posted ;
   struct list_head scp_req_incoming ;
   long scp_rqbd_timeout ;
    klee_make_symbolic(&scp_rqbd_timeout, sizeof(long), "scp_rqbd_timeout");
   wait_queue_head_t scp_waitq ;
   struct list_head scp_hist_reqs ;
   struct list_head scp_hist_rqbds ;
   int scp_hist_nrqbds ;
    klee_make_symbolic(&scp_hist_nrqbds, sizeof(int), "scp_hist_nrqbds");
   __u64 scp_hist_seq ;
   __u64 scp_hist_seq_culled ;
   spinlock_t scp_req_lock ;
   int scp_nreqs_active ;
    klee_make_symbolic(&scp_nreqs_active, sizeof(int), "scp_nreqs_active");
   int scp_nhreqs_active ;
    klee_make_symbolic(&scp_nhreqs_active, sizeof(int), "scp_nhreqs_active");
   int scp_hreq_count ;
    klee_make_symbolic(&scp_hreq_count, sizeof(int), "scp_hreq_count");
   ...
   unsigned long scp_at_checktime ;
    klee_make_symbolic(&scp_at_checktime, sizeof(long), "scp_at_checktime");
   unsigned int scp_at_check ;
    klee_make_symbolic(&scp_at_check, sizeof(int), "scp_at_check");
...
struct lustre_intent_data {
   int it_disposition ;
    klee_make_symbolic(&it_disposition, sizeof(int), "it_disposition");
   int it_status ;
    klee_make_symbolic(&it_status, sizeof(int), "it_status");
   __u64 it_lock_handle ;
   __u64 it_lock_bits ;
   int it_lock_mode ;
    klee_make_symbolic(&it_lock_mode, sizeof(int), "it_lock_mode");
   int it_remote_lock_mode ;
    klee_make_symbolic(&it_remote_lock_mode, sizeof(int), "it_remote_lock_mode");
...
struct lookup_intent {
   int it_op ;
    klee_make_symbolic(&it_op, sizeof(int), "it_op");
   int it_create_mode ;
    klee_make_symbolic(&it_create_mode, sizeof(int), "it_create_mode");
   __u64 it_flags ;
...
struct ldlm_pool {
   ...
   int pl_grant_plan ;
    klee_make_symbolic(&pl_grant_plan, sizeof(int), "pl_grant_plan");
...
struct ldlm_namespace {
   ...
   int ns_nr_unused ;
    klee_make_symbolic(&ns_nr_unused, sizeof(int), "ns_nr_unused");
   unsigned int ns_max_unused ;
    klee_make_symbolic(&ns_max_unused, sizeof(int), "ns_max_unused");
   unsigned int ns_max_age ;
    klee_make_symbolic(&ns_max_age, sizeof(int), "ns_max_age");
   unsigned long ns_next_dump ;
    klee_make_symbolic(&ns_next_dump, sizeof(long), "ns_next_dump");
   ...
   unsigned int ns_max_parallel_ast ;
    klee_make_symbolic(&ns_max_parallel_ast, sizeof(int), "ns_max_parallel_ast");
...
struct ldlm_interval_tree {
   int lit_size ;
    klee_make_symbolic(&lit_size, sizeof(int), "lit_size");
...
struct ldlm_lock {
   ...
   unsigned long l_last_activity ;
    klee_make_symbolic(&l_last_activity, sizeof(long), "l_last_activity");
   unsigned long l_last_used ;
    klee_make_symbolic(&l_last_used, sizeof(long), "l_last_used");
   ...
   unsigned long l_callback_timeout ;
    klee_make_symbolic(&l_callback_timeout, sizeof(long), "l_callback_timeout");
   __u32 l_pid ;
   int l_bl_ast_run ;
    klee_make_symbolic(&l_bl_ast_run, sizeof(int), "l_bl_ast_run");
...
struct ldlm_resource {
   ...
   int lr_lvb_len ;
    klee_make_symbolic(&lr_lvb_len, sizeof(int), "lr_lvb_len");
   void *lr_lvb_data ;
   unsigned long lr_contention_time ;
    klee_make_symbolic(&lr_contention_time, sizeof(long), "lr_contention_time");
...
struct tg_export_data {
   ...
   loff_t ted_lr_off ;
   int ted_lr_idx ;
    klee_make_symbolic(&ted_lr_idx, sizeof(int), "ted_lr_idx");
};
...
struct filter_export_data {
   ...
   spinlock_t fed_lock ;
   long fed_dirty ;
    klee_make_symbolic(&fed_dirty, sizeof(long), "fed_dirty");
   long fed_grant ;
    klee_make_symbolic(&fed_grant, sizeof(long), "fed_grant");
   struct list_head fed_mod_list ;
   int fed_mod_count ;
    klee_make_symbolic(&fed_mod_count, sizeof(int), "fed_mod_count");
   long fed_pending ;
    klee_make_symbolic(&fed_pending, sizeof(long), "fed_pending");
   __u32 fed_group ;
   __u8 fed_pagesize ;
};
...
struct obd_export {
   ...
   unsigned long exp_last_request_time ;
    klee_make_symbolic(&exp_last_request_time, sizeof(long), "exp_last_request_time");
...
struct lu_client_seq {
   ...
   int lcs_update ;
    klee_make_symbolic(&lcs_update, sizeof(int), "lcs_update");
};
struct dt_device;
struct dt_object;
struct lu_server_seq {
...
struct lu_client_fld {
   ...
   int lcf_count ;
    klee_make_symbolic(&lcf_count, sizeof(int), "lcf_count");
   spinlock_t lcf_lock ;
   struct fld_cache *lcf_cache ;
   char lcf_name[80U] ;
   int lcf_flags ;
    klee_make_symbolic(&lcf_flags, sizeof(int), "lcf_flags");
};
struct client_capa {
   struct inode *inode ;
...
struct obd_capa {
   ...
   unsigned long c_expiry ;
    klee_make_symbolic(&c_expiry, sizeof(long), "c_expiry");
   spinlock_t c_lock ;
   int c_site ;
    klee_make_symbolic(&c_site, sizeof(int), "c_site");
   union __anonunion_u_404 u ;
};
struct osc_async_rc {
   int ar_rc ;
    klee_make_symbolic(&ar_rc, sizeof(int), "ar_rc");
   int ar_force_sync ;
    klee_make_symbolic(&ar_force_sync, sizeof(int), "ar_force_sync");
   __u64 ar_min_xid ;
};
struct lov_oinfo {
   struct ost_id loi_oi ;
   int loi_ost_idx ;
    klee_make_symbolic(&loi_ost_idx, sizeof(int), "loi_ost_idx");
   int loi_ost_gen ;
    klee_make_symbolic(&loi_ost_gen, sizeof(int), "loi_ost_gen");
...
struct obd_type {
   ...
   char *typ_name ;
   int typ_refcnt ;
    klee_make_symbolic(&typ_refcnt, sizeof(int), "typ_refcnt");
...
struct client_obd {
   ...
   int cl_conn_count ;
    klee_make_symbolic(&cl_conn_count, sizeof(int), "cl_conn_count");
   int cl_default_mds_easize ;
    klee_make_symbolic(&cl_default_mds_easize, sizeof(int), "cl_default_mds_easize");
   int cl_max_mds_easize ;
    klee_make_symbolic(&cl_max_mds_easize, sizeof(int), "cl_max_mds_easize");
   int cl_default_mds_cookiesize ;
    klee_make_symbolic(&cl_default_mds_cookiesize, sizeof(int), "cl_default_mds_cookiesize");
   int cl_max_mds_cookiesize ;
    klee_make_symbolic(&cl_max_mds_cookiesize, sizeof(int), "cl_max_mds_cookiesize");
   enum lustre_sec_part cl_sp_me ;
   enum lustre_sec_part cl_sp_to ;
   struct sptlrpc_flavor cl_flvr_mgc ;
   long cl_dirty ;
    klee_make_symbolic(&cl_dirty, sizeof(long), "cl_dirty");
   long cl_dirty_max ;
    klee_make_symbolic(&cl_dirty_max, sizeof(long), "cl_dirty_max");
   long cl_dirty_transit ;
    klee_make_symbolic(&cl_dirty_transit, sizeof(long), "cl_dirty_transit");
   long cl_avail_grant ;
    klee_make_symbolic(&cl_avail_grant, sizeof(long), "cl_avail_grant");
   long cl_lost_grant ;
    klee_make_symbolic(&cl_lost_grant, sizeof(long), "cl_lost_grant");
   long cl_reserved_grant ;
    klee_make_symbolic(&cl_reserved_grant, sizeof(long), "cl_reserved_grant");
   struct list_head cl_cache_waiters ;
   unsigned long cl_next_shrink_grant ;
    klee_make_symbolic(&cl_next_shrink_grant, sizeof(long), "cl_next_shrink_grant");
   struct list_head cl_grant_shrink_list ;
   int cl_grant_shrink_interval ;
    klee_make_symbolic(&cl_grant_shrink_interval, sizeof(int), "cl_grant_shrink_interval");
   int cl_chunkbits ;
    klee_make_symbolic(&cl_chunkbits, sizeof(int), "cl_chunkbits");
   int cl_chunk ;
    klee_make_symbolic(&cl_chunk, sizeof(int), "cl_chunk");
   int cl_extent_tax ;
    klee_make_symbolic(&cl_extent_tax, sizeof(int), "cl_extent_tax");
   ...
   int cl_r_in_flight ;
    klee_make_symbolic(&cl_r_in_flight, sizeof(int), "cl_r_in_flight");
   int cl_w_in_flight ;
    klee_make_symbolic(&cl_w_in_flight, sizeof(int), "cl_w_in_flight");
   atomic_t cl_pending_w_pages ;
   atomic_t cl_pending_r_pages ;
   __u32 cl_max_pages_per_rpc ;
   int cl_max_rpcs_in_flight ;
    klee_make_symbolic(&cl_max_rpcs_in_flight, sizeof(int), "cl_max_rpcs_in_flight");
   ...
   int cl_qchk_stat ;
    klee_make_symbolic(&cl_qchk_stat, sizeof(int), "cl_qchk_stat");
...
struct echo_client_obd {
   ...
   int ec_nstripes ;
    klee_make_symbolic(&ec_nstripes, sizeof(int), "ec_nstripes");
   __u64 ec_unique ;
};
struct lov_qos_oss {
...
struct ost_pool {
   ...
   unsigned int op_count ;
    klee_make_symbolic(&op_count, sizeof(int), "op_count");
   unsigned int op_size ;
    klee_make_symbolic(&op_size, sizeof(int), "op_size");
...
struct lov_obd {
   ...
   __u32 lov_tgt_size ;
   int lov_connects ;
    klee_make_symbolic(&lov_connects, sizeof(int), "lov_connects");
   int lov_pool_count ;
    klee_make_symbolic(&lov_pool_count, sizeof(int), "lov_pool_count");
...
struct lmv_tgt_desc {
   ...
   struct obd_export *ltd_exp ;
   int ltd_idx ;
    klee_make_symbolic(&ltd_idx, sizeof(int), "ltd_idx");
...
struct lmv_obd {
   ...
   int max_easize ;
    klee_make_symbolic(&max_easize, sizeof(int), "max_easize");
   int max_def_easize ;
    klee_make_symbolic(&max_def_easize, sizeof(int), "max_def_easize");
   int max_cookiesize ;
    klee_make_symbolic(&max_cookiesize, sizeof(int), "max_cookiesize");
   int max_def_cookiesize ;
    klee_make_symbolic(&max_def_cookiesize, sizeof(int), "max_def_cookiesize");
   int server_timeout ;
    klee_make_symbolic(&server_timeout, sizeof(int), "server_timeout");
   int tgts_size ;
    klee_make_symbolic(&tgts_size, sizeof(int), "tgts_size");
...
struct niobuf_local {
   ...
   struct dentry *dentry ;
   int lnb_grant_used ;
    klee_make_symbolic(&lnb_grant_used, sizeof(int), "lnb_grant_used");
   int rc ;
...
struct obd_trans_info {
   ...
   int oti_numcookies ;
    klee_make_symbolic(&oti_numcookies, sizeof(int), "oti_numcookies");
...
struct obd_llog_group {
   int olg_seq ;
    klee_make_symbolic(&olg_seq, sizeof(int), "olg_seq");
...
struct obd_device {
   ...
   int obd_minor ;
    klee_make_symbolic(&obd_minor, sizeof(int), "obd_minor");
   ...
   int obd_num_exports ;
    klee_make_symbolic(&obd_num_exports, sizeof(int), "obd_num_exports");
   ...
   int obd_max_recoverable_clients ;
    klee_make_symbolic(&obd_max_recoverable_clients, sizeof(int), "obd_max_recoverable_clients");
   atomic_t obd_connected_clients ;
   int obd_stale_clients ;
    klee_make_symbolic(&obd_stale_clients, sizeof(int), "obd_stale_clients");
   int obd_delayed_clients ;
    klee_make_symbolic(&obd_delayed_clients, sizeof(int), "obd_delayed_clients");
   spinlock_t obd_recovery_task_lock ;
   __u64 obd_next_recovery_transno ;
   int obd_replayed_requests ;
    klee_make_symbolic(&obd_replayed_requests, sizeof(int), "obd_replayed_requests");
   int obd_requests_queued_for_recovery ;
    klee_make_symbolic(&obd_requests_queued_for_recovery, sizeof(int), "obd_requests_queued_for_recovery");
   wait_queue_head_t obd_next_transno_waitq ;
   struct timer_list obd_recovery_timer ;
   time_t obd_recovery_start ;
   time_t obd_recovery_end ;
   int obd_recovery_time_hard ;
    klee_make_symbolic(&obd_recovery_time_hard, sizeof(int), "obd_recovery_time_hard");
   int obd_recovery_timeout ;
    klee_make_symbolic(&obd_recovery_timeout, sizeof(int), "obd_recovery_timeout");
   int obd_recovery_ir_factor ;
    klee_make_symbolic(&obd_recovery_ir_factor, sizeof(int), "obd_recovery_ir_factor");
   struct target_recovery_data obd_recovery_data ;
   int obd_replayed_locks ;
    klee_make_symbolic(&obd_replayed_locks, sizeof(int), "obd_replayed_locks");
   ...
   int obd_recovery_stage ;
    klee_make_symbolic(&obd_recovery_stage, sizeof(int), "obd_recovery_stage");
   union __anonunion_u_406 u ;
   unsigned int obd_cntr_base ;
    klee_make_symbolic(&obd_cntr_base, sizeof(int), "obd_cntr_base");
   struct lprocfs_stats *obd_stats ;
   unsigned int md_cntr_base ;
    klee_make_symbolic(&md_cntr_base, sizeof(int), "md_cntr_base");
   ...
   int obd_pool_limit ;
    klee_make_symbolic(&obd_pool_limit, sizeof(int), "obd_pool_limit");
   __u64 obd_pool_slv ;
   struct lu_ref obd_reference ;
   int obd_conn_inprogress ;
    klee_make_symbolic(&obd_conn_inprogress, sizeof(int), "obd_conn_inprogress");
...
struct md_op_data {
   ...
   char const   *op_name ;
   int op_namelen ;
    klee_make_symbolic(&op_namelen, sizeof(int), "op_namelen");
   __u32 op_mode ;
   ...
   unsigned int op_attr_flags ;
    klee_make_symbolic(&op_attr_flags, sizeof(int), "op_attr_flags");
   __u64 op_valid ;
...
struct md_enqueue_info {
   ...
   unsigned int mi_generation ;
    klee_make_symbolic(&mi_generation, sizeof(int), "mi_generation");
};
struct obd_ops {
...
struct blkg_policy_data {
   struct blkcg_gq *blkg ;
   int plid ;
    klee_make_symbolic(&plid, sizeof(int), "plid");
...
struct lustre_mount_data {
   ...
   int lmd_mgs_failnodes ;
    klee_make_symbolic(&lmd_mgs_failnodes, sizeof(int), "lmd_mgs_failnodes");
   int lmd_exclude_count ;
    klee_make_symbolic(&lmd_exclude_count, sizeof(int), "lmd_exclude_count");
   int lmd_recovery_time_soft ;
    klee_make_symbolic(&lmd_recovery_time_soft, sizeof(int), "lmd_recovery_time_soft");
   int lmd_recovery_time_hard ;
    klee_make_symbolic(&lmd_recovery_time_hard, sizeof(int), "lmd_recovery_time_hard");
   char *lmd_dev ;
   char *lmd_profile ;
   char *lmd_mgssec ;
   char *lmd_opts ;
...
struct lustre_sb_info {
   int lsi_flags ;
    klee_make_symbolic(&lsi_flags, sizeof(int), "lsi_flags");
...
struct posix_acl_entry {
   short e_tag ;
    klee_make_symbolic(&e_tag, sizeof(short), "e_tag");
   unsigned short e_perm ;
    klee_make_symbolic(&e_perm, sizeof(short), "e_perm");
...
struct posix_acl {
   ...
   unsigned int a_count ;
    klee_make_symbolic(&a_count, sizeof(int), "a_count");
...
struct cl_object {
   ...
   int co_slice_off ;
    klee_make_symbolic(&co_slice_off, sizeof(int), "co_slice_off");
};
...
struct cl_object_conf {
   ...
   int coc_opc ;
    klee_make_symbolic(&coc_opc, sizeof(int), "coc_opc");
};
struct cl_object_operations {
...
struct cl_page {
   ...
   unsigned long cp_index ;
    klee_make_symbolic(&cp_index, sizeof(long), "cp_index");
   ...
   int cp_error ;
    klee_make_symbolic(&cp_error, sizeof(int), "cp_error");
   ...
   unsigned int cp_flags ;
    klee_make_symbolic(&cp_flags, sizeof(int), "cp_flags");
...
struct cl_lock_descr {
   ...
   unsigned long cld_start ;
    klee_make_symbolic(&cld_start, sizeof(long), "cld_start");
   unsigned long cld_end ;
    klee_make_symbolic(&cld_end, sizeof(long), "cld_end");
   __u64 cld_gid ;
...
struct cl_lock {
   ...
   int cll_depth ;
    klee_make_symbolic(&cll_depth, sizeof(int), "cll_depth");
   struct task_struct *cll_intransit_owner ;
   int cll_error ;
    klee_make_symbolic(&cll_error, sizeof(int), "cll_error");
   int cll_holds ;
    klee_make_symbolic(&cll_holds, sizeof(int), "cll_holds");
   int cll_users ;
    klee_make_symbolic(&cll_users, sizeof(int), "cll_users");
   unsigned long cll_flags ;
    klee_make_symbolic(&cll_flags, sizeof(long), "cll_flags");
...
struct cl_page_list {
   unsigned int pl_nr ;
    klee_make_symbolic(&pl_nr, sizeof(int), "pl_nr");
...
struct cl_io_rw_common {
   ...
   size_t crw_count ;
   int crw_nonblock ;
    klee_make_symbolic(&crw_nonblock, sizeof(int), "crw_nonblock");
};
struct cl_rd_io {
...
struct cl_wr_io {
   ...
   int wr_append ;
    klee_make_symbolic(&wr_append, sizeof(int), "wr_append");
   int wr_sync ;
    klee_make_symbolic(&wr_sync, sizeof(int), "wr_sync");
};
struct cl_setattr_io {
   struct ost_lvb sa_attr ;
   unsigned int sa_valid ;
    klee_make_symbolic(&sa_valid, sizeof(int), "sa_valid");
   struct obd_capa *sa_capa ;
};
struct cl_fault_io {
   unsigned long ft_index ;
    klee_make_symbolic(&ft_index, sizeof(long), "ft_index");
   int ft_nob ;
    klee_make_symbolic(&ft_nob, sizeof(int), "ft_nob");
   int ft_writable ;
    klee_make_symbolic(&ft_writable, sizeof(int), "ft_writable");
   int ft_executable ;
    klee_make_symbolic(&ft_executable, sizeof(int), "ft_executable");
   int ft_mkwrite ;
    klee_make_symbolic(&ft_mkwrite, sizeof(int), "ft_mkwrite");
...
struct cl_fsync_io {
   ...
   unsigned int fi_nr_written ;
    klee_make_symbolic(&fi_nr_written, sizeof(int), "fi_nr_written");
};
...
struct cl_io {
   ...
   size_t ci_nob ;
   int ci_result ;
    klee_make_symbolic(&ci_result, sizeof(int), "ci_result");
   ...
   unsigned int ci_owned_nr ;
    klee_make_symbolic(&ci_owned_nr, sizeof(int), "ci_owned_nr");
};
struct cl_req_obj {
...
struct cl_req {
   ...
   unsigned int crq_nrpages ;
    klee_make_symbolic(&crq_nrpages, sizeof(int), "crq_nrpages");
   struct cl_req_obj *crq_o ;
   unsigned int crq_nrobjs ;
    klee_make_symbolic(&crq_nrobjs, sizeof(int), "crq_nrobjs");
   struct list_head crq_layers ;
};
struct cl_sync_io {
   atomic_t csi_sync_nr ;
   int csi_sync_rc ;
    klee_make_symbolic(&csi_sync_rc, sizeof(int), "csi_sync_rc");
...
struct ccc_grouplock {
   ...
   unsigned long cg_gid ;
    klee_make_symbolic(&cg_gid, sizeof(long), "cg_gid");
};
struct cl_client_cache {
   atomic_t ccc_users ;
   ...
   unsigned long ccc_lru_max ;
    klee_make_symbolic(&ccc_lru_max, sizeof(long), "ccc_lru_max");
   unsigned int ccc_lru_shrinkers ;
    klee_make_symbolic(&ccc_lru_shrinkers, sizeof(int), "ccc_lru_shrinkers");
};
struct mdc_rpc_lock {
   struct mutex rpcl_mutex ;
   struct lookup_intent *rpcl_it ;
   int rpcl_fakes ;
    klee_make_symbolic(&rpcl_fakes, sizeof(int), "rpcl_fakes");
};
...
struct __anonstruct_f_422 {
   ...
   unsigned long f_glimpse_time ;
    klee_make_symbolic(&f_glimpse_time, sizeof(long), "f_glimpse_time");
   struct list_head f_agl_list ;
   __u64 f_agl_index ;
   int f_async_rc ;
    klee_make_symbolic(&f_async_rc, sizeof(int), "f_async_rc");
   char f_jobid[32U] ;
};
...
struct ll_inode_info {
   ...
   unsigned long lli_rmtperm_time ;
    klee_make_symbolic(&lli_rmtperm_time, sizeof(long), "lli_rmtperm_time");
...
struct ll_ra_info {
   ...
   unsigned long ra_max_pages ;
    klee_make_symbolic(&ra_max_pages, sizeof(long), "ra_max_pages");
   unsigned long ra_max_pages_per_file ;
    klee_make_symbolic(&ra_max_pages_per_file, sizeof(long), "ra_max_pages_per_file");
   unsigned long ra_max_read_ahead_whole_pages ;
    klee_make_symbolic(&ra_max_read_ahead_whole_pages, sizeof(long), "ra_max_read_ahead_whole_pages");
};
...
struct ll_rw_process_info {
   pid_t rw_pid ;
   int rw_op ;
    klee_make_symbolic(&rw_op, sizeof(int), "rw_op");
...
struct ll_sb_info {
   ...
   int ll_flags ;
    klee_make_symbolic(&ll_flags, sizeof(int), "ll_flags");
   ...
   unsigned int ll_namelen ;
    klee_make_symbolic(&ll_namelen, sizeof(int), "ll_namelen");
   struct file_operations *ll_fop ;
   unsigned int ll_md_brw_size ;
    klee_make_symbolic(&ll_md_brw_size, sizeof(int), "ll_md_brw_size");
   struct lu_site *ll_site ;
   struct cl_device *ll_cl ;
   struct ll_rw_extents_info ll_rw_extents_info ;
   int ll_extent_process_count ;
    klee_make_symbolic(&ll_extent_process_count, sizeof(int), "ll_extent_process_count");
   struct ll_rw_process_info ll_rw_process_info[10U] ;
   unsigned int ll_offset_process_count ;
    klee_make_symbolic(&ll_offset_process_count, sizeof(int), "ll_offset_process_count");
   struct ll_rw_process_info ll_rw_offset_info[100U] ;
   unsigned int ll_rw_offset_entry_count ;
    klee_make_symbolic(&ll_rw_offset_entry_count, sizeof(int), "ll_rw_offset_entry_count");
   int ll_stats_track_id ;
    klee_make_symbolic(&ll_stats_track_id, sizeof(int), "ll_stats_track_id");
   enum stats_track_type ll_stats_track_type ;
   int ll_rw_stats_on ;
    klee_make_symbolic(&ll_rw_stats_on, sizeof(int), "ll_rw_stats_on");
   unsigned int ll_sa_max ;
    klee_make_symbolic(&ll_sa_max, sizeof(int), "ll_sa_max");
...
struct ll_readahead_state {
   ...
   unsigned long ras_last_readpage ;
    klee_make_symbolic(&ras_last_readpage, sizeof(long), "ras_last_readpage");
   unsigned long ras_consecutive_pages ;
    klee_make_symbolic(&ras_consecutive_pages, sizeof(long), "ras_consecutive_pages");
   unsigned long ras_consecutive_requests ;
    klee_make_symbolic(&ras_consecutive_requests, sizeof(long), "ras_consecutive_requests");
   unsigned long ras_window_start ;
    klee_make_symbolic(&ras_window_start, sizeof(long), "ras_window_start");
   unsigned long ras_window_len ;
    klee_make_symbolic(&ras_window_len, sizeof(long), "ras_window_len");
   unsigned long ras_next_readahead ;
    klee_make_symbolic(&ras_next_readahead, sizeof(long), "ras_next_readahead");
   unsigned long ras_requests ;
    klee_make_symbolic(&ras_requests, sizeof(long), "ras_requests");
   unsigned long ras_request_index ;
    klee_make_symbolic(&ras_request_index, sizeof(long), "ras_request_index");
   struct list_head ras_read_beads ;
   unsigned long ras_stride_length ;
    klee_make_symbolic(&ras_stride_length, sizeof(long), "ras_stride_length");
   unsigned long ras_stride_pages ;
    klee_make_symbolic(&ras_stride_pages, sizeof(long), "ras_stride_pages");
   unsigned long ras_stride_offset ;
    klee_make_symbolic(&ras_stride_offset, sizeof(long), "ras_stride_offset");
   unsigned long ras_consecutive_stride_requests ;
    klee_make_symbolic(&ras_consecutive_stride_requests, sizeof(long), "ras_consecutive_stride_requests");
};
struct ll_file_data {
...
struct ll_statahead_info {
   ...
   unsigned int sai_generation ;
    klee_make_symbolic(&sai_generation, sizeof(int), "sai_generation");
   unsigned int sai_max ;
    klee_make_symbolic(&sai_max, sizeof(int), "sai_max");
   __u64 sai_sent ;
   __u64 sai_replied ;
   __u64 sai_index ;
   ...
   unsigned int sai_consecutive_miss ;
    klee_make_symbolic(&sai_consecutive_miss, sizeof(int), "sai_consecutive_miss");
   unsigned int sai_miss_hidden ;
    klee_make_symbolic(&sai_miss_hidden, sizeof(int), "sai_miss_hidden");
   unsigned int sai_skip_hidden ;
    klee_make_symbolic(&sai_skip_hidden, sizeof(int), "sai_skip_hidden");
...
struct ll_dio_pages {
   ...
   size_t ldp_size ;
   int ldp_nr ;
    klee_make_symbolic(&ldp_nr, sizeof(int), "ldp_nr");
};
...
extern unsigned int libcfs_subsystem_debug ;
    klee_make_symbolic(&libcfs_subsystem_debug, sizeof(int), "libcfs_subsystem_debug");
extern unsigned int libcfs_debug ;
    klee_make_symbolic(&libcfs_debug, sizeof(int), "libcfs_debug");
...
static int lloop_major  ;
    klee_make_symbolic(&lloop_major, sizeof(int), "lloop_major");
...
{ 
  ...
  int rw ;
  int inactive ;
    klee_make_symbolic(&inactive, sizeof(int), "inactive");
  struct libcfs_debug_msg_data msgdata ;
  int tmp ;
...
{ 
  ...
  unsigned int count ;
  unsigned long times ;
    klee_make_symbolic(&times, sizeof(long), "times");
  unsigned long total_count ;
    klee_make_symbolic(&total_count, sizeof(long), "total_count");
  struct lu_env *env ;
  int refcheck ;
    klee_make_symbolic(&refcheck, sizeof(int), "refcheck");
  int ret ;
  ...
  int tmp___4 ;
  int exiting ;
    klee_make_symbolic(&exiting, sizeof(int), "exiting");
  int tmp___5 ;
  struct cfs_debug_limit_state cdls ;
  struct libcfs_debug_msg_data msgdata ;
  int tmp___6 ;
...
{ 
  ...
  long __pu_val ;
    klee_make_symbolic(&__pu_val, sizeof(long), "__pu_val");
  u16 tmp___2 ;
  long tmp___3 ;
  bool tmp___4 ;
  int minor ;
...
{ 
  unsigned long ldvarg1 ;
    klee_make_symbolic(&ldvarg1, sizeof(long), "ldvarg1");
