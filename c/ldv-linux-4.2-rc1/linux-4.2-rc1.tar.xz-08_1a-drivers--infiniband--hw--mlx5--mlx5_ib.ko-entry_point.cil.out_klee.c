...
struct mlx5_uuar_info {
   ...
   int num_low_latency_uuars ;
    klee_make_symbolic(&num_low_latency_uuars, sizeof(int), "num_low_latency_uuars");
...
struct mlx5_bf {
   ...
   int need_lock ;
    klee_make_symbolic(&need_lock, sizeof(int), "need_lock");
   spinlock_t lock ;
   spinlock_t lock32 ;
   int uuarn ;
    klee_make_symbolic(&uuarn, sizeof(int), "uuarn");
};
...
struct mlx5_cmd {
   ...
   u8 log_stride ;
   int max_reg_cmds ;
    klee_make_symbolic(&max_reg_cmds, sizeof(int), "max_reg_cmds");
   int events ;
   u32 *vector ;
   spinlock_t alloc_lock ;
   ...
   unsigned long bitmask ;
    klee_make_symbolic(&bitmask, sizeof(long), "bitmask");
   char wq_name[32U] ;
   struct workqueue_struct *wq ;
   ...
   int checksum_disabled ;
    klee_make_symbolic(&checksum_disabled, sizeof(int), "checksum_disabled");
...
struct mlx5_core_health {
   ...
   u32 prev ;
   int miss_counter ;
    klee_make_symbolic(&miss_counter, sizeof(int), "miss_counter");
};
...
struct mlx5_priv {
   ...
   int fw_pages ;
    klee_make_symbolic(&fw_pages, sizeof(int), "fw_pages");
   atomic_t reg_pages ;
...
struct mlx5_cmd_work_ent {
   ...
   void *uout ;
   int uout_size ;
    klee_make_symbolic(&uout_size, sizeof(int), "uout_size");
   ...
   int page_queue ;
    klee_make_symbolic(&page_queue, sizeof(int), "page_queue");
   u8 status ;
   u8 token ;
   u64 ts1 ;
   u64 ts2 ;
...
struct mlx5_mr_cache {
   ...
   unsigned long last_add ;
    klee_make_symbolic(&last_add, sizeof(long), "last_add");
};
...
struct mlx5_ib_dev {
   ...
   int fill_delay ;
    klee_make_symbolic(&fill_delay, sizeof(int), "fill_delay");
   struct ib_odp_caps odp_caps ;
...
struct mlx5_core_srq {
   ...
   int max_avail_gather ;
    klee_make_symbolic(&max_avail_gather, sizeof(int), "max_avail_gather");
   int wqe_shift ;
...
struct mlx5_core_cq {
   u32 cqn ;
   int cqe_sz ;
    klee_make_symbolic(&cqe_sz, sizeof(int), "cqe_sz");
   __be32 *set_ci_db ;
   __be32 *arm_db ;
   atomic_t refcount ;
   struct completion free ;
   ...
   int irqn ;
    klee_make_symbolic(&irqn, sizeof(int), "irqn");
...
struct mlx5_ib_qp {
   ...
   int wq_sig ;
    klee_make_symbolic(&wq_sig, sizeof(int), "wq_sig");
   int scat_cqe ;
    klee_make_symbolic(&scat_cqe, sizeof(int), "scat_cqe");
   int max_inline_data ;
    klee_make_symbolic(&max_inline_data, sizeof(int), "max_inline_data");
   struct mlx5_bf *bf ;
   int has_rq ;
    klee_make_symbolic(&has_rq, sizeof(int), "has_rq");
   int uuarn ;
   int create_type ;
    klee_make_symbolic(&create_type, sizeof(int), "create_type");
   u32 pa_lkey ;
   bool signature_en ;
   int disable_page_faults ;
    klee_make_symbolic(&disable_page_faults, sizeof(int), "disable_page_faults");
...
struct mlx5_shared_mr_info {
   int mr_id ;
    klee_make_symbolic(&mr_id, sizeof(int), "mr_id");
   struct ib_umem *umem ;
};
struct mlx5_ib_cq {
   struct ib_cq ibcq ;
...
struct mlx5_ib_mr {
   ...
   int order ;
   int umred ;
    klee_make_symbolic(&umred, sizeof(int), "umred");
   int npages ;
   struct mlx5_ib_dev *dev ;
...
struct ib_umem_odp {
   ...
   int notifiers_seq ;
    klee_make_symbolic(&notifiers_seq, sizeof(int), "notifiers_seq");
   int notifiers_count ;
    klee_make_symbolic(&notifiers_count, sizeof(int), "notifiers_count");
   struct list_head no_private_counters ;
   struct ib_umem *umem ;
   struct umem_odp_node interval_tree ;
   struct completion notifier_completion ;
   int dying ;
    klee_make_symbolic(&dying, sizeof(int), "dying");
};
enum hrtimer_restart;
...
{ 
  ...
  int oper_mtu ;
    klee_make_symbolic(&oper_mtu, sizeof(int), "oper_mtu");
  int err ;
...
{ 
  ...
  struct mlx5_uar *uars ;
  int gross_uuars ;
    klee_make_symbolic(&gross_uuars, sizeof(int), "gross_uuars");
  int num_uars ;
  int ver ;
...
{ 
  ...
  unsigned long command ;
    klee_make_symbolic(&command, sizeof(long), "command");
  unsigned long idx ;
  phys_addr_t pfn ;
  int tmp___1 ;
  int tmp___2 ;
...
{ 
  ...
  unsigned long ldvarg10 ;
    klee_make_symbolic(&ldvarg10, sizeof(long), "ldvarg10");
  void *ldvarg12 ;
  void *tmp___2 ;
  void *ldvarg9 ;
  void *tmp___3 ;
...
{ 
  int dump ;
    klee_make_symbolic(&dump, sizeof(int), "dump");
...
{ 
  ...
  int npages ;
  int ncont ;
    klee_make_symbolic(&ncont, sizeof(int), "ncont");
  int err ;
  int tmp ;
  long tmp___0 ;
  bool tmp___1 ;
...
{ 
  ...
  void *dcqe ;
  int ssize ;
    klee_make_symbolic(&ssize, sizeof(int), "ssize");
  int dsize ;
    klee_make_symbolic(&dsize, sizeof(int), "dsize");
  int i ;
  u8 sw_own ;
  struct task_struct *tmp___0 ;
  struct task_struct *tmp___1 ;
...
{ 
  ...
  int err ;
  int npas ;
    klee_make_symbolic(&npas, sizeof(int), "npas");
  int page_shift ;
  int inlen ;
  int cqe_size ;
  unsigned long flags ;
  ...
  int resized ;
    klee_make_symbolic(&resized, sizeof(int), "resized");
...
static int wq_signature  ;
    klee_make_symbolic(&wq_signature, sizeof(int), "wq_signature");
...
{ 
  ...
  int wqe_length ;
    klee_make_symbolic(&wqe_length, sizeof(int), "wqe_length");
  int ret ;
  struct _ddebug descriptor ;
  struct task_struct *tmp___0 ;
  long tmp___1 ;
...
{ 
  int wqe_size ;
    klee_make_symbolic(&wqe_size, sizeof(int), "wqe_size");
  int wq_size ;
    klee_make_symbolic(&wq_size, sizeof(int), "wq_size");
  __u32 tmp ;
...
{ 
  int inl_size ;
    klee_make_symbolic(&inl_size, sizeof(int), "inl_size");
  int size ;
  int __max1 ;
  int __max2 ;
  int __max1___0 ;
...
{ 
  int desc_sz ;
    klee_make_symbolic(&desc_sz, sizeof(int), "desc_sz");
  __u32 tmp ;
  struct task_struct *tmp___0 ;
  __u32 tmp___1 ;
  struct task_struct *tmp___2 ;
...
{ 
  int med ;
    klee_make_symbolic(&med, sizeof(int), "med");
  int i ;
  int t ;
...
{ 
  int minidx ;
    klee_make_symbolic(&minidx, sizeof(int), "minidx");
  int tmp ;
  int i ;
  int tmp___0 ;
...
{ 
  int nuuars ;
    klee_make_symbolic(&nuuars, sizeof(int), "nuuars");
  int high_uuar ;
    klee_make_symbolic(&high_uuar, sizeof(int), "high_uuar");
...
{ 
  ...
  int page_shift ;
  int uar_index ;
    klee_make_symbolic(&uar_index, sizeof(int), "uar_index");
  int npages ;
  u32 offset ;
  int uuarn ;
  int ncont ;
...
{ 
  ...
  __u32 tmp___24 ;
  int rcqe_sz ;
    klee_make_symbolic(&rcqe_sz, sizeof(int), "rcqe_sz");
  int scqe_sz ;
    klee_make_symbolic(&scqe_sz, sizeof(int), "scqe_sz");
  int tmp___25 ;
  int tmp___26 ;
  int tmp___27 ;
  __u16 tmp___28 ;
...
{ 
  ...
  int mlx5_st ;
    klee_make_symbolic(&mlx5_st, sizeof(int), "mlx5_st");
  int err ;
  void *tmp___1 ;
  __u32 tmp___2 ;
  struct task_struct *tmp___3 ;
...
{ 
  ...
  void *addr ;
  int inl___0 ;
    klee_make_symbolic(&inl___0, sizeof(int), "inl___0");
  int copy ;
...
{ 
  ...
  u16 block_size ;
  int prot_size ;
    klee_make_symbolic(&prot_size, sizeof(int), "prot_size");
  u16 tmp___2 ;
  __u32 tmp___3 ;
  __u32 tmp___4 ;
  __u16 tmp___5 ;
...
{ 
  ...
  u32 klm_oct_size ;
  int region_len ;
    klee_make_symbolic(&region_len, sizeof(int), "region_len");
  int ret ;
  long tmp___1 ;
  long tmp___2 ;
  long tmp___3 ;
...
{ 
  int writ ;
    klee_make_symbolic(&writ, sizeof(int), "writ");
  int li ;
...
{ 
  ...
  struct mlx5_qp_context *context ;
  int mlx5_state ;
    klee_make_symbolic(&mlx5_state, sizeof(int), "mlx5_state");
  int err ;
  void *tmp___1 ;
  __u32 tmp___2 ;
...
{ 
  unsigned long umem_page_shift ;
    klee_make_symbolic(&umem_page_shift, sizeof(long), "umem_page_shift");
  int tmp ;
  int shift ;
...
static int srq_signature  ;
    klee_make_symbolic(&srq_signature, sizeof(int), "srq_signature");
...
{ 
  ...
  int inlen ;
  int is_xrc ;
    klee_make_symbolic(&is_xrc, sizeof(int), "is_xrc");
  u32 flgs ;
  u32 xrcdn ;
  __u32 max_srq_wqes ;
  __u32 tmp___0 ;
...
{ 
  ...
  struct mlx5_cache_ent *ent ;
  int shrink ;
    klee_make_symbolic(&shrink, sizeof(int), "shrink");
  int c ;
  struct task_struct *tmp ;
...
{ 
  ...
  int page_index_alignment ;
    klee_make_symbolic(&page_index_alignment, sizeof(int), "page_index_alignment");
  int page_index_mask ;
    klee_make_symbolic(&page_index_mask, sizeof(int), "page_index_mask");
  size_t pages_mapped ;
  size_t pages_to_map ;
  size_t pages_iter ;
  int use_emergency_buf ;
    klee_make_symbolic(&use_emergency_buf, sizeof(int), "use_emergency_buf");
  int __min1 ;
  int __min2 ;
  unsigned long tmp ;
  struct task_struct *tmp___0 ;
...
{ 
  ...
  struct mlx5_ib_mr *mr ;
  int access_mode ;
    klee_make_symbolic(&access_mode, sizeof(int), "access_mode");
  int err ;
  int ndescs ;
    klee_make_symbolic(&ndescs, sizeof(int), "ndescs");
  int __y ;
...
{ 
  ...
  u64 blk_start_idx ;
  int in_block ;
    klee_make_symbolic(&in_block, sizeof(int), "in_block");
  u64 addr ;
  u64 __max1 ;
  unsigned long tmp ;
  u64 __max2 ;
...
{ 
  ...
  struct mlx5_ib_dev *tmp ;
  int srcu_key ;
    klee_make_symbolic(&srcu_key, sizeof(int), "srcu_key");
  unsigned int current_seq ;
    klee_make_symbolic(&current_seq, sizeof(int), "current_seq");
  u64 start_idx ;
  int npages ;
  int ret ;
  struct mlx5_ib_mr *mr ;
...
{ 
  ...
  size_t bcnt ;
  int inline_segment ;
    klee_make_symbolic(&inline_segment, sizeof(int), "inline_segment");
...
{ 
  ...
  int resume_with_error ;
    klee_make_symbolic(&resume_with_error, sizeof(int), "resume_with_error");
  u16 wqe_index ;
  int requestor ;
    klee_make_symbolic(&requestor, sizeof(int), "requestor");
  unsigned long tmp___0 ;
  struct task_struct *tmp___1 ;
  struct task_struct *tmp___2 ;
  struct task_struct *tmp___3 ;
...
{ 
  ...
  int prefetch_activated ;
    klee_make_symbolic(&prefetch_activated, sizeof(int), "prefetch_activated");
  u32 rkey ;
  int ret ;
