...
struct CommandList {
   ...
   int abort_pending ;
    klee_make_symbolic(&abort_pending, sizeof(int), "abort_pending");
...
struct hpsa_scsi_dev_t {
   ...
   int offload_to_be_enabled ;
    klee_make_symbolic(&offload_to_be_enabled, sizeof(int), "offload_to_be_enabled");
   int hba_ioaccel_enabled ;
    klee_make_symbolic(&hba_ioaccel_enabled, sizeof(int), "hba_ioaccel_enabled");
   ...
   int nphysical_disks ;
    klee_make_symbolic(&nphysical_disks, sizeof(int), "nphysical_disks");
   int supports_aborts ;
    klee_make_symbolic(&supports_aborts, sizeof(int), "supports_aborts");
   u8 expose_state ;
};
...
struct ctlr_info {
   ...
   int needs_abort_tags_swizzled ;
    klee_make_symbolic(&needs_abort_tags_swizzled, sizeof(int), "needs_abort_tags_swizzled");
...
{ 
  int ld ;
    klee_make_symbolic(&ld, sizeof(int), "ld");
  struct ctlr_info *h ;
...
{ 
  ...
  int i ;
  int sg_limit ;
    klee_make_symbolic(&sg_limit, sizeof(int), "sg_limit");
  int chained ;
    klee_make_symbolic(&chained, sizeof(int), "chained");
  int last_sg ;
    klee_make_symbolic(&last_sg, sizeof(int), "last_sg");
...
{ 
  int first_queue ;
    klee_make_symbolic(&first_queue, sizeof(int), "first_queue");
  int last_queue ;
    klee_make_symbolic(&last_queue, sizeof(int), "last_queue");
  int rq ;
...
{ 
  ...
  int refcount ;
  int reply_queue ;
    klee_make_symbolic(&reply_queue, sizeof(int), "reply_queue");
  u32 tmp ;
  int tmp___0 ;
  int tmp___1 ;
  int tmp___2 ;
...
{ 
  ...
  struct CommandList *c ;
  int failcount ;
    klee_make_symbolic(&failcount, sizeof(int), "failcount");
