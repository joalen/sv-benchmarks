...
unsigned int fcoe_debug_logging  ;
    klee_make_symbolic(&fcoe_debug_logging, sizeof(int), "fcoe_debug_logging");
...
char __pcpu_unique_fcoe_percpu  ;
    klee_make_symbolic(&__pcpu_unique_fcoe_percpu, sizeof(char), "__pcpu_unique_fcoe_percpu");
...
{ 
  ...
  unsigned int targ_cpu ;
    klee_make_symbolic(&targ_cpu, sizeof(int), "targ_cpu");
  int pscr_ret__ ;
...
{ 
  unsigned int selected_cpu ;
    klee_make_symbolic(&selected_cpu, sizeof(int), "selected_cpu");
...
{ 
  int dcbx ;
    klee_make_symbolic(&dcbx, sizeof(int), "dcbx");
  u8 fup ;
  u8 up___0 ;
  struct net_device *netdev ;
  struct fcoe_ctlr *ctlr ;
