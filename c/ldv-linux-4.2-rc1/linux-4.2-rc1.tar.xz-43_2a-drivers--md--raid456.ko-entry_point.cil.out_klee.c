...
struct raid6_calls {
   ...
   char const   *name ;
   int prefer ;
    klee_make_symbolic(&prefer, sizeof(int), "prefer");
};
struct iovec {
   void *iov_base ;
...
struct __anonstruct____missing_field_name_263 {
   ...
   int total_nr_elements ;
    klee_make_symbolic(&total_nr_elements, sizeof(int), "total_nr_elements");
   int elems_per_part ;
    klee_make_symbolic(&elems_per_part, sizeof(int), "elems_per_part");
...
struct stripe_head {
   ...
   int overwrite_disks ;
    klee_make_symbolic(&overwrite_disks, sizeof(int), "overwrite_disks");
...
struct r5conf {
   ...
   int rmw_level ;
    klee_make_symbolic(&rmw_level, sizeof(int), "rmw_level");
   int max_degraded ;
   ...
   int min_nr_stripes ;
    klee_make_symbolic(&min_nr_stripes, sizeof(int), "min_nr_stripes");
   ...
   unsigned long cache_state ;
    klee_make_symbolic(&cache_state, sizeof(long), "cache_state");
...
struct bitmap {
   ...
   int cluster_slot ;
    klee_make_symbolic(&cluster_slot, sizeof(int), "cluster_slot");
};
...
{ 
  ...
  unsigned long do_wakeup ;
    klee_make_symbolic(&do_wakeup, sizeof(long), "do_wakeup");
  int i ;
  unsigned long flags ;
  struct list_head *list ;
  int tmp ;
...
{ 
  ...
  struct stripe_head *head_sh ;
  int last_stripe ;
    klee_make_symbolic(&last_stripe, sizeof(int), "last_stripe");
  struct _ddebug descriptor ;
  long tmp ;
  int tmp___0 ;
  int tmp___1 ;
...
{ 
  ...
  int last_stripe ;
  int synflags ;
    klee_make_symbolic(&synflags, sizeof(int), "synflags");
  unsigned long txflags ;
    klee_make_symbolic(&txflags, sizeof(long), "txflags");
  struct _ddebug descriptor ;
  long tmp ;
  int tmp___0 ;
  struct list_head  const  *__mptr ;
...
{ 
  ...
  int tmp___11 ;
  int qd_idx___0 ;
    klee_make_symbolic(&qd_idx___0, sizeof(int), "qd_idx___0");
...
{ 
  ...
  int ldvarg38 ;
    klee_make_symbolic(&ldvarg38, sizeof(int), "ldvarg38");
