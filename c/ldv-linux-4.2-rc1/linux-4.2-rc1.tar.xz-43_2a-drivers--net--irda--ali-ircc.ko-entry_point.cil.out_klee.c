...
struct ali_chip {
   ...
   int cfg[2U] ;
   unsigned char entr1 ;
    klee_make_symbolic(&entr1, sizeof(char), "entr1");
   unsigned char entr2 ;
    klee_make_symbolic(&entr2, sizeof(char), "entr2");
   unsigned char cid_index ;
    klee_make_symbolic(&cid_index, sizeof(char), "cid_index");
   unsigned char cid_value ;
    klee_make_symbolic(&cid_value, sizeof(char), "cid_value");
...
struct ali_ircc_cb {
   ...
   unsigned char rcvFramesOverflow ;
    klee_make_symbolic(&rcvFramesOverflow, sizeof(char), "rcvFramesOverflow");
   ktime_t stamp ;
   spinlock_t lock ;
   __u32 new_speed ;
   int index ;
   unsigned char fifo_opti_buf ;
    klee_make_symbolic(&fifo_opti_buf, sizeof(char), "fifo_opti_buf");
};
...
{ 
  ...
  int lcr ;
    klee_make_symbolic(&lcr, sizeof(int), "lcr");
  int divisor ;
...
{ 
  ...
  unsigned char FIFO_OPTI ;
    klee_make_symbolic(&FIFO_OPTI, sizeof(char), "FIFO_OPTI");
  unsigned char Hi ;
    klee_make_symbolic(&Hi, sizeof(char), "Hi");
  unsigned char Lo ;
    klee_make_symbolic(&Lo, sizeof(char), "Lo");
  unsigned char tmp___0 ;
  unsigned char tmp___1 ;
  struct _ddebug descriptor ;
  unsigned char tmp___2 ;
...
{ 
  unsigned char newMask ;
    klee_make_symbolic(&newMask, sizeof(char), "newMask");
  int iobase ;
  struct _ddebug descriptor ;
  long tmp ;
