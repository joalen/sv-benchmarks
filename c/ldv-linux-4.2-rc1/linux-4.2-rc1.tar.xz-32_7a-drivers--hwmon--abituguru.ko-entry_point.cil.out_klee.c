...
struct abituguru_data {
   ...
   char uguru_ready ;
    klee_make_symbolic(&uguru_ready, sizeof(char), "uguru_ready");
   unsigned char update_timeouts ;
    klee_make_symbolic(&update_timeouts, sizeof(char), "update_timeouts");
...
static int fan_sensors  ;
    klee_make_symbolic(&fan_sensors, sizeof(int), "fan_sensors");
static int pwms  ;
    klee_make_symbolic(&pwms, sizeof(int), "pwms");
...
{ 
  int report_errors ;
    klee_make_symbolic(&report_errors, sizeof(int), "report_errors");
  int tmp ;
  struct _ddebug descriptor ;
  long tmp___0 ;
...
{ 
  ...
  unsigned long user_val ;
    klee_make_symbolic(&user_val, sizeof(long), "user_val");
  int tmp___0 ;
  int tmp___1 ;
...
{ 
  ...
  int sysfs_names_free ;
    klee_make_symbolic(&sysfs_names_free, sizeof(int), "sysfs_names_free");
  int sysfs_attr_i ;
    klee_make_symbolic(&sysfs_attr_i, sizeof(int), "sysfs_attr_i");
  int res ;
  char *sysfs_filename ;
  u8 probe_order[16U] ;
  void *tmp ;
...
{ 
  ...
  void *tmp ;
  char success ;
    klee_make_symbolic(&success, sizeof(char), "success");
  struct _ddebug descriptor ;
  long tmp___0 ;
  struct _ddebug descriptor___0 ;
  long tmp___1 ;
...
#include "model/linux-4.2-rc1.tar.xz-32_7a-drivers--hwmon--abituguru.ko-entry_point_true-unreach-call.cil.out.env.c"
#include <klee/klee.h>
