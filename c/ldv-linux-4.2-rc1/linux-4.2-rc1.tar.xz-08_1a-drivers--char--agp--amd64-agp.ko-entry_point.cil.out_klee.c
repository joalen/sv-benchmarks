...
struct amd_l3_cache {
   unsigned int indices ;
    klee_make_symbolic(&indices, sizeof(int), "indices");
   u8 subcaches[4U] ;
};
...
struct agp_bridge_driver {
   ...
   int num_aperture_sizes ;
    klee_make_symbolic(&num_aperture_sizes, sizeof(int), "num_aperture_sizes");
...
struct agp_bridge_data {
   ...
   unsigned long scratch_page ;
    klee_make_symbolic(&scratch_page, sizeof(long), "scratch_page");
   struct page *scratch_page_page ;
   dma_addr_t scratch_page_dma ;
   unsigned long gart_bus_addr ;
    klee_make_symbolic(&gart_bus_addr, sizeof(long), "gart_bus_addr");
   unsigned long gatt_bus_addr ;
    klee_make_symbolic(&gatt_bus_addr, sizeof(long), "gatt_bus_addr");
   u32 mode ;
   ...
   atomic_t agp_in_use ;
   int max_memory_agp ;
    klee_make_symbolic(&max_memory_agp, sizeof(int), "max_memory_agp");
   int aperture_size_idx ;
    klee_make_symbolic(&aperture_size_idx, sizeof(int), "aperture_size_idx");
   int capndx ;
    klee_make_symbolic(&capndx, sizeof(int), "capndx");
   int flags ;
   char major_version ;
    klee_make_symbolic(&major_version, sizeof(char), "major_version");
   char minor_version ;
    klee_make_symbolic(&minor_version, sizeof(char), "minor_version");
   struct list_head list ;
   u32 apbase_config ;
   struct list_head mapped_list ;
...
extern int agp_off ;
    klee_make_symbolic(&agp_off, sizeof(int), "agp_off");
extern int agp_try_unsupported_boot ;
    klee_make_symbolic(&agp_try_unsupported_boot, sizeof(int), "agp_try_unsupported_boot");
static struct resource *aperture_resource  ;
static bool agp_try_unsupported  =    1;
static int agp_bridges_found  ;
    klee_make_symbolic(&agp_bridges_found, sizeof(int), "agp_bridges_found");
...
{ 
  ...
  long long tmp ;
  int mask_type ;
    klee_make_symbolic(&mask_type, sizeof(int), "mask_type");
  struct agp_bridge_data *bridge ;
  u32 pte ;
...
{ 
  unsigned long gatt_bus ;
    klee_make_symbolic(&gatt_bus, sizeof(long), "gatt_bus");
  phys_addr_t tmp ;
  int i ;
  bool tmp___0 ;
  int tmp___1 ;
