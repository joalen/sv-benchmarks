...
struct cyapa {
   ...
   u8 gen ;
   int max_abs_x ;
    klee_make_symbolic(&max_abs_x, sizeof(int), "max_abs_x");
   int max_abs_y ;
    klee_make_symbolic(&max_abs_y, sizeof(int), "max_abs_y");
   int physical_size_x ;
    klee_make_symbolic(&physical_size_x, sizeof(int), "physical_size_x");
   int physical_size_y ;
    klee_make_symbolic(&physical_size_y, sizeof(int), "physical_size_y");
   u8 x_origin ;
   u8 y_origin ;
   int electrodes_x ;
    klee_make_symbolic(&electrodes_x, sizeof(int), "electrodes_x");
   int electrodes_y ;
    klee_make_symbolic(&electrodes_y, sizeof(int), "electrodes_y");
   int electrodes_rx ;
    klee_make_symbolic(&electrodes_rx, sizeof(int), "electrodes_rx");
   int aligned_electrodes_rx ;
    klee_make_symbolic(&aligned_electrodes_rx, sizeof(int), "aligned_electrodes_rx");
   int max_z ;
    klee_make_symbolic(&max_z, sizeof(int), "max_z");
...
{ 
  int error ;
  int waiting_time ;
    klee_make_symbolic(&waiting_time, sizeof(int), "waiting_time");
...
{ 
  ...
  void *tmp ;
  int max_baseline ;
    klee_make_symbolic(&max_baseline, sizeof(int), "max_baseline");
  int min_baseline ;
    klee_make_symbolic(&min_baseline, sizeof(int), "min_baseline");
  int tries ;
  int ret ;
  struct _ddebug descriptor ;
  long tmp___0 ;
...
{ 
  ...
  int empty_count ;
    klee_make_symbolic(&empty_count, sizeof(int), "empty_count");
  int buf_len ;
...
{ 
  int resp_len ;
  int max_output_len ;
    klee_make_symbolic(&max_output_len, sizeof(int), "max_output_len");
  u16 tmp ;
  u16 tmp___0 ;
...
{ 
  ...
  u8 cmd[256U] ;
  int cmd_len ;
    klee_make_symbolic(&cmd_len, sizeof(int), "cmd_len");
  u16 cmd_data_len ;
  u16 cmd_crc ;
  u16 meta_data_crc ;
  u8 resp_data[11U] ;
  int resp_len ;
  int records_num ;
    klee_make_symbolic(&records_num, sizeof(int), "records_num");
  u8 *data ;
  int error ;
...
{ 
  ...
  int record_index ;
    klee_make_symbolic(&record_index, sizeof(int), "record_index");
  int i ;
  u16 tmp ;
  u16 tmp___0 ;
  u8 const   *data ;
...
{ 
  ...
  int flash_records_count ;
    klee_make_symbolic(&flash_records_count, sizeof(int), "flash_records_count");
  int i ;
  int error ;
...
{ 
  ...
  int error ;
  int calibrate_error ;
    klee_make_symbolic(&calibrate_error, sizeof(int), "calibrate_error");
...
{ 
  ...
  u16 offset ;
  int read_elements ;
    klee_make_symbolic(&read_elements, sizeof(int), "read_elements");
  bool read_global_idac ;
  int sum ;
    klee_make_symbolic(&sum, sizeof(int), "sum");
  int count ;
  int max_element_cnt ;
    klee_make_symbolic(&max_element_cnt, sizeof(int), "max_element_cnt");
  int tmp_max ;
    klee_make_symbolic(&tmp_max, sizeof(int), "tmp_max");
  int tmp_min ;
    klee_make_symbolic(&tmp_min, sizeof(int), "tmp_min");
  int tmp_ave ;
    klee_make_symbolic(&tmp_ave, sizeof(int), "tmp_ave");
  int tmp_sum ;
    klee_make_symbolic(&tmp_sum, sizeof(int), "tmp_sum");
  int tmp_count ;
    klee_make_symbolic(&tmp_count, sizeof(int), "tmp_count");
  int electrodes_rx ;
  int electrodes_tx ;
    klee_make_symbolic(&electrodes_tx, sizeof(int), "electrodes_tx");
  int i ;
  int error ;
  int _min1 ;
  int _min2 ;
...
{ 
  ...
  int gidac_mutual_max ;
    klee_make_symbolic(&gidac_mutual_max, sizeof(int), "gidac_mutual_max");
  int gidac_mutual_min ;
    klee_make_symbolic(&gidac_mutual_min, sizeof(int), "gidac_mutual_min");
  int gidac_mutual_ave ;
    klee_make_symbolic(&gidac_mutual_ave, sizeof(int), "gidac_mutual_ave");
  int lidac_mutual_max ;
    klee_make_symbolic(&lidac_mutual_max, sizeof(int), "lidac_mutual_max");
  int lidac_mutual_min ;
    klee_make_symbolic(&lidac_mutual_min, sizeof(int), "lidac_mutual_min");
  int lidac_mutual_ave ;
    klee_make_symbolic(&lidac_mutual_ave, sizeof(int), "lidac_mutual_ave");
  int gidac_self_rx ;
    klee_make_symbolic(&gidac_self_rx, sizeof(int), "gidac_self_rx");
  int gidac_self_tx ;
    klee_make_symbolic(&gidac_self_tx, sizeof(int), "gidac_self_tx");
  int lidac_self_max ;
    klee_make_symbolic(&lidac_self_max, sizeof(int), "lidac_self_max");
  int lidac_self_min ;
    klee_make_symbolic(&lidac_self_min, sizeof(int), "lidac_self_min");
  int lidac_self_ave ;
    klee_make_symbolic(&lidac_self_ave, sizeof(int), "lidac_self_ave");
  int raw_cap_mutual_max ;
    klee_make_symbolic(&raw_cap_mutual_max, sizeof(int), "raw_cap_mutual_max");
  int raw_cap_mutual_min ;
    klee_make_symbolic(&raw_cap_mutual_min, sizeof(int), "raw_cap_mutual_min");
  int raw_cap_mutual_ave ;
    klee_make_symbolic(&raw_cap_mutual_ave, sizeof(int), "raw_cap_mutual_ave");
  int raw_cap_self_max ;
    klee_make_symbolic(&raw_cap_self_max, sizeof(int), "raw_cap_self_max");
  int raw_cap_self_min ;
    klee_make_symbolic(&raw_cap_self_min, sizeof(int), "raw_cap_self_min");
  int raw_cap_self_ave ;
    klee_make_symbolic(&raw_cap_self_ave, sizeof(int), "raw_cap_self_ave");
  int mutual_diffdata_max ;
    klee_make_symbolic(&mutual_diffdata_max, sizeof(int), "mutual_diffdata_max");
  int mutual_diffdata_min ;
    klee_make_symbolic(&mutual_diffdata_min, sizeof(int), "mutual_diffdata_min");
  int mutual_diffdata_ave ;
    klee_make_symbolic(&mutual_diffdata_ave, sizeof(int), "mutual_diffdata_ave");
  int self_diffdata_max ;
    klee_make_symbolic(&self_diffdata_max, sizeof(int), "self_diffdata_max");
  int self_diffdata_min ;
    klee_make_symbolic(&self_diffdata_min, sizeof(int), "self_diffdata_min");
  int self_diffdata_ave ;
    klee_make_symbolic(&self_diffdata_ave, sizeof(int), "self_diffdata_ave");
  int mutual_baseline_max ;
    klee_make_symbolic(&mutual_baseline_max, sizeof(int), "mutual_baseline_max");
  int mutual_baseline_min ;
    klee_make_symbolic(&mutual_baseline_min, sizeof(int), "mutual_baseline_min");
  int mutual_baseline_ave ;
    klee_make_symbolic(&mutual_baseline_ave, sizeof(int), "mutual_baseline_ave");
  int self_baseline_max ;
    klee_make_symbolic(&self_baseline_max, sizeof(int), "self_baseline_max");
  int self_baseline_min ;
    klee_make_symbolic(&self_baseline_min, sizeof(int), "self_baseline_min");
  int self_baseline_ave ;
    klee_make_symbolic(&self_baseline_ave, sizeof(int), "self_baseline_ave");
  int error ;
  int resume_error ;
    klee_make_symbolic(&resume_error, sizeof(int), "resume_error");
  int size ;
  ssize_t tmp___0 ;
  int tmp___1 ;
...
{ 
  ...
  unsigned int touch_num ;
    klee_make_symbolic(&touch_num, sizeof(int), "touch_num");
  int i ;
