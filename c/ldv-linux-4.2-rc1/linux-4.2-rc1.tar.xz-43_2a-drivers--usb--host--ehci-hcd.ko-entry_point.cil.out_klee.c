...
struct ehci_stats {
   unsigned long normal ;
    klee_make_symbolic(&normal, sizeof(long), "normal");
   unsigned long error ;
    klee_make_symbolic(&error, sizeof(long), "error");
   unsigned long iaa ;
    klee_make_symbolic(&iaa, sizeof(long), "iaa");
   unsigned long lost_iaa ;
    klee_make_symbolic(&lost_iaa, sizeof(long), "lost_iaa");
   unsigned long complete ;
    klee_make_symbolic(&complete, sizeof(long), "complete");
   unsigned long unlink ;
    klee_make_symbolic(&unlink, sizeof(long), "unlink");
};
...
struct ehci_hcd {
   ...
   unsigned int enabled_hrtimer_events ;
    klee_make_symbolic(&enabled_hrtimer_events, sizeof(int), "enabled_hrtimer_events");
   ktime_t hr_timeouts[11U] ;
   struct hrtimer hrtimer ;
   int PSS_poll_count ;
    klee_make_symbolic(&PSS_poll_count, sizeof(int), "PSS_poll_count");
   int ASS_poll_count ;
    klee_make_symbolic(&ASS_poll_count, sizeof(int), "ASS_poll_count");
   int died_poll_count ;
    klee_make_symbolic(&died_poll_count, sizeof(int), "died_poll_count");
   ...
   unsigned int async_unlink_cycle ;
    klee_make_symbolic(&async_unlink_cycle, sizeof(int), "async_unlink_cycle");
   unsigned int async_count ;
    klee_make_symbolic(&async_count, sizeof(int), "async_count");
   unsigned int periodic_size ;
    klee_make_symbolic(&periodic_size, sizeof(int), "periodic_size");
   __le32 *periodic ;
   dma_addr_t periodic_dma ;
   struct list_head intr_qh_list ;
   unsigned int i_thresh ;
    klee_make_symbolic(&i_thresh, sizeof(int), "i_thresh");
   union ehci_shadow *pshadow ;
   struct list_head intr_unlink_wait ;
   struct list_head intr_unlink ;
   unsigned int intr_unlink_wait_cycle ;
    klee_make_symbolic(&intr_unlink_wait_cycle, sizeof(int), "intr_unlink_wait_cycle");
   unsigned int intr_unlink_cycle ;
    klee_make_symbolic(&intr_unlink_cycle, sizeof(int), "intr_unlink_cycle");
   unsigned int now_frame ;
    klee_make_symbolic(&now_frame, sizeof(int), "now_frame");
   unsigned int last_iso_frame ;
    klee_make_symbolic(&last_iso_frame, sizeof(int), "last_iso_frame");
   unsigned int intr_count ;
    klee_make_symbolic(&intr_count, sizeof(int), "intr_count");
   unsigned int isoc_count ;
    klee_make_symbolic(&isoc_count, sizeof(int), "isoc_count");
   unsigned int periodic_count ;
    klee_make_symbolic(&periodic_count, sizeof(int), "periodic_count");
   unsigned int uframe_periodic_max ;
    klee_make_symbolic(&uframe_periodic_max, sizeof(int), "uframe_periodic_max");
   ...
   unsigned long companion_ports ;
    klee_make_symbolic(&companion_ports, sizeof(long), "companion_ports");
   unsigned long owned_ports ;
    klee_make_symbolic(&owned_ports, sizeof(long), "owned_ports");
   unsigned long port_c_suspend ;
    klee_make_symbolic(&port_c_suspend, sizeof(long), "port_c_suspend");
   unsigned long suspended_ports ;
    klee_make_symbolic(&suspended_ports, sizeof(long), "suspended_ports");
   ...
   unsigned int random_frame ;
    klee_make_symbolic(&random_frame, sizeof(int), "random_frame");
...
struct ehci_qh {
   ...
   unsigned int unlink_cycle ;
    klee_make_symbolic(&unlink_cycle, sizeof(int), "unlink_cycle");
   u8 qh_state ;
   u8 xacterrs ;
   u8 gap_uf ;
...
struct ehci_iso_sched {
   ...
   unsigned int span ;
    klee_make_symbolic(&span, sizeof(int), "span");
...
struct ehci_iso_stream {
   ...
   unsigned int next_uframe ;
    klee_make_symbolic(&next_uframe, sizeof(int), "next_uframe");
   __le32 splits ;
   u16 uperiod ;
   u16 maxp ;
...
struct ehci_tt {
   ...
   int tt_port ;
    klee_make_symbolic(&tt_port, sizeof(int), "tt_port");
};
...
{ 
  unsigned int uf ;
    klee_make_symbolic(&uf, sizeof(int), "uf");
  long tmp ;
...
{ 
  ...
  char *next ;
  char mark ;
    klee_make_symbolic(&mark, sizeof(char), "mark");
  __le32 list_end ;
  __le32 tmp ;
  struct ehci_qh_hw *hw ;
  __le32 tmp___0 ;
...
{ 
  ...
  unsigned int seen_count ;
    klee_make_symbolic(&seen_count, sizeof(int), "seen_count");
  char *next ;
  unsigned int i ;
  __le32 tag ;
  void *tmp ;
...
{ 
  ...
  unsigned long resume_needed ;
    klee_make_symbolic(&resume_needed, sizeof(long), "resume_needed");
  int tmp___0 ;
  long tmp___1 ;
  struct _ddebug descriptor ;
  struct usb_hcd *tmp___2 ;
...
{ 
  ...
  int last_status ;
    klee_make_symbolic(&last_status, sizeof(int), "last_status");
  int stopped ;
...
{ 
  ...
  int is_input ;
    klee_make_symbolic(&is_input, sizeof(int), "is_input");
  u32 token ;
  int i ;
  struct scatterlist *sg ;
  long tmp ;
  ...
  __u16 tmp___1 ;
  int this_qtd_len ;
    klee_make_symbolic(&this_qtd_len, sizeof(int), "this_qtd_len");
  int __min1___0 ;
  ...
  long tmp___4 ;
  int one_more ;
    klee_make_symbolic(&one_more, sizeof(int), "one_more");
  long tmp___5 ;
  long tmp___6 ;
  __le32 tmp___7 ;
  long tmp___8 ;
...
{ 
  unsigned int start_uf ;
    klee_make_symbolic(&start_uf, sizeof(int), "start_uf");
  unsigned int i ;
  unsigned int j ;
  ...
  int c_usecs ;
    klee_make_symbolic(&c_usecs, sizeof(int), "c_usecs");
  int tt_usecs ;
    klee_make_symbolic(&tt_usecs, sizeof(int), "tt_usecs");
  struct ehci_tt *tt ;
...
{ 
  struct ehci_per_sched *ps ;
  unsigned int uframe ;
    klee_make_symbolic(&uframe, sizeof(int), "uframe");
  unsigned int uf ;
  unsigned int x ;
...
{ 
  ...
  int ufs ;
    klee_make_symbolic(&ufs, sizeof(int), "ufs");
...
{ 
  ...
  unsigned int uframe ;
  unsigned int c_mask ;
    klee_make_symbolic(&c_mask, sizeof(int), "c_mask");
  struct ehci_qh_hw *hw ;
  struct ehci_tt *tt ;
  struct _ddebug descriptor ;
  struct usb_hcd *tmp ;
...
{ 
  ...
  int think_time ;
  int hs_transfers ;
    klee_make_symbolic(&hs_transfers, sizeof(int), "hs_transfers");
  struct usb_hcd *tmp___1 ;
  struct usb_hcd *tmp___2 ;
  long tmp___3 ;
  unsigned int _max1 ;
...
{ 
  ...
  unsigned int num_itds ;
    klee_make_symbolic(&num_itds, sizeof(int), "num_itds");
...
{ 
  ...
  unsigned int j ;
  unsigned int s_mask ;
    klee_make_symbolic(&s_mask, sizeof(int), "s_mask");
  unsigned int c_mask ;
  unsigned int m ;
  int usecs ;
  int c_usecs ;
...
{ 
  int packet ;
    klee_make_symbolic(&packet, sizeof(int), "packet");
  unsigned int next_uframe ;
  unsigned int uframe ;
  unsigned int frame ;
  struct ehci_iso_sched *iso_sched ;
...
{ 
  ...
  unsigned int uframe ;
  int urb_index ;
    klee_make_symbolic(&urb_index, sizeof(int), "urb_index");
  struct ehci_iso_stream *stream ;
  struct usb_device *dev ;
  bool retval ;
  long tmp ;
...
{ 
  ...
  int new_owner ;
    klee_make_symbolic(&new_owner, sizeof(int), "new_owner");
  void *tmp ;
  struct usb_hcd *tmp___0 ;
  int tmp___1 ;
...
{ 
  ...
  u32 cmd ;
  int bh ;
    klee_make_symbolic(&bh, sizeof(int), "bh");
  unsigned long flags ;
  struct _ddebug descriptor ;
  struct usb_hcd *tmp___0 ;
  long tmp___1 ;
  ...
  u32 ppcd ;
  int pstatus ;
    klee_make_symbolic(&pstatus, sizeof(int), "pstatus");
...
{ 
  ...
  struct ehci_qh *qh ;
  int eptype ;
    klee_make_symbolic(&eptype, sizeof(int), "eptype");
  int tmp___0 ;
  int epnum ;
  int tmp___1 ;
  int is_out ;
