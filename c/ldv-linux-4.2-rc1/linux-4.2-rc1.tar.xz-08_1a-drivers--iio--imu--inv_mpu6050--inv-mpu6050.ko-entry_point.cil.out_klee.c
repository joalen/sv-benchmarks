...
struct inv_mpu6050_state {
   ...
   unsigned int powerup_count ;
    klee_make_symbolic(&powerup_count, sizeof(int), "powerup_count");
...
int ldv_irq_line_1  ;
    klee_make_symbolic(&ldv_irq_line_1, sizeof(int), "ldv_irq_line_1");
int ldv_irq_1_0  =    0;
...
int ldv_irq_line_2  ;
    klee_make_symbolic(&ldv_irq_line_2, sizeof(int), "ldv_irq_line_2");
...
{ 
  ...
  unsigned short primary ;
    klee_make_symbolic(&primary, sizeof(short), "primary");
  unsigned short secondary ;
    klee_make_symbolic(&secondary, sizeof(short), "secondary");
  char *name ;
  char const   *tmp ;
  struct acpi_device *tmp___0 ;
  acpi_handle tmp___1 ;
