...
struct thinkpad_id_data {
   unsigned int vendor ;
    klee_make_symbolic(&vendor, sizeof(int), "vendor");
...
struct attribute_set {
   unsigned int members ;
    klee_make_symbolic(&members, sizeof(int), "members");
   unsigned int max_members ;
    klee_make_symbolic(&max_members, sizeof(int), "max_members");
...
struct tp_led_table {
   acpi_string name ;
   int on_value ;
    klee_make_symbolic(&on_value, sizeof(int), "on_value");
   int off_value ;
    klee_make_symbolic(&off_value, sizeof(int), "off_value");
   int state ;
};
...
static int experimental  ;
    klee_make_symbolic(&experimental, sizeof(int), "experimental");
static u32 dbg_level  ;
static struct workqueue_struct *tpacpi_wq  ;
static unsigned int bright_maxlvl  ;
    klee_make_symbolic(&bright_maxlvl, sizeof(int), "bright_maxlvl");
static int dbg_wlswemul  ;
    klee_make_symbolic(&dbg_wlswemul, sizeof(int), "dbg_wlswemul");
static bool tpacpi_wlsw_emulstate  ;
static int dbg_bluetoothemul  ;
    klee_make_symbolic(&dbg_bluetoothemul, sizeof(int), "dbg_bluetoothemul");
static bool tpacpi_bluetooth_emulstate  ;
static int dbg_wwanemul  ;
    klee_make_symbolic(&dbg_wwanemul, sizeof(int), "dbg_wwanemul");
static bool tpacpi_wwan_emulstate  ;
static int dbg_uwbemul  ;
    klee_make_symbolic(&dbg_uwbemul, sizeof(int), "dbg_uwbemul");
...
{ 
  ...
  va_list ap ;
  char res_type ;
    klee_make_symbolic(&res_type, sizeof(char), "res_type");
  int success ;
...
{ 
  ...
  int tmp ;
  int hw_blocked ;
    klee_make_symbolic(&hw_blocked, sizeof(int), "hw_blocked");
...
{ 
  ...
  bool hw_state ;
  int sw_status ;
    klee_make_symbolic(&sw_status, sizeof(int), "sw_status");
  long tmp ;
  void *tmp___0 ;
...
{ 
  unsigned long fwvers ;
    klee_make_symbolic(&fwvers, sizeof(long), "fwvers");
  u16 ec_version ;
  u16 bios_version ;
...
static unsigned int hotkey_config_change  ;
    klee_make_symbolic(&hotkey_config_change, sizeof(int), "hotkey_config_change");
...
static int hotkey_autosleep_ack  ;
    klee_make_symbolic(&hotkey_autosleep_ack, sizeof(int), "hotkey_autosleep_ack");
...
{ 
  ...
  unsigned int si ;
  unsigned int so ;
    klee_make_symbolic(&so, sizeof(int), "so");
  unsigned long t ;
  unsigned int change_detector ;
    klee_make_symbolic(&change_detector, sizeof(int), "change_detector");
  unsigned int poll_freq ;
    klee_make_symbolic(&poll_freq, sizeof(int), "poll_freq");
  bool was_frozen ;
  long tmp ;
  bool tmp___0 ;
  long tmp___1 ;
...
{ 
  int wlsw ;
    klee_make_symbolic(&wlsw, sizeof(int), "wlsw");
...
{ 
  ...
  int status ;
  int hkeyv ;
    klee_make_symbolic(&hkeyv, sizeof(int), "hkeyv");
  bool radiosw_state ;
  bool tabletsw_state ;
  unsigned long quirks ;
  unsigned long keymap_id ;
    klee_make_symbolic(&keymap_id, sizeof(long), "keymap_id");
  long tmp___103 ;
    klee_make_symbolic(&tmp___103, sizeof(long), "tmp___103");
  long tmp___104 ;
...
static int adaptive_keyboard_prev_mode  ;
    klee_make_symbolic(&adaptive_keyboard_prev_mode, sizeof(int), "adaptive_keyboard_prev_mode");
static int adaptive_keyboard_get_mode(void) 
{ 
  int mode ;
  int tmp ;
...
{ 
  unsigned int scancode ;
    klee_make_symbolic(&scancode, sizeof(int), "scancode");
  bool tmp ;
...
static int video_orig_autosw  ;
    klee_make_symbolic(&video_orig_autosw, sizeof(int), "video_orig_autosw");
...
{ 
  int ivga ;
    klee_make_symbolic(&ivga, sizeof(int), "ivga");
  bool tmp ;
  int tmp___0 ;
  bool tmp___1 ;
  int tmp___2 ;
...
{ 
  int autosw ;
    klee_make_symbolic(&autosw, sizeof(int), "autosw");
  int res ;
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
...
{ 
  char *cmd ;
  int newstatus ;
    klee_make_symbolic(&newstatus, sizeof(int), "newstatus");
  size_t tmp ;
  int tmp___0 ;
  size_t tmp___1 ;
  int tmp___2 ;
...
{ 
  unsigned long cmos_cmd ;
    klee_make_symbolic(&cmos_cmd, sizeof(long), "cmos_cmd");
  int res ;
  int tmp ;
...
{ 
  ...
  unsigned long useful_leds ;
    klee_make_symbolic(&useful_leds, sizeof(long), "useful_leds");
  char const   *tmp ;
  void *tmp___0 ;
  bool tmp___1 ;
  int tmp___2 ;
...
{ 
  char *cmd ;
  int beep_cmd ;
    klee_make_symbolic(&beep_cmd, sizeof(int), "beep_cmd");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
...
{ 
  ...
  int i ;
  int acpi_tmp7 ;
    klee_make_symbolic(&acpi_tmp7, sizeof(int), "acpi_tmp7");
  int res ;
  int tmp ;
  int tmp___0 ;
  bool tmp___1 ;
...
{ 
  ...
  unsigned int current_value ;
    klee_make_symbolic(&current_value, sizeof(int), "current_value");
  unsigned int i ;
  int tmp ;
...
{ 
  ...
  int bcl_levels ;
    klee_make_symbolic(&bcl_levels, sizeof(int), "bcl_levels");
...
static int software_mute_orig_mode  ;
    klee_make_symbolic(&software_mute_orig_mode, sizeof(int), "software_mute_orig_mode");
...
static int fan_watchdog_maxinterval  ;
    klee_make_symbolic(&fan_watchdog_maxinterval, sizeof(int), "fan_watchdog_maxinterval");
...
{ 
  acpi_handle temp ;
  int output ;
    klee_make_symbolic(&output, sizeof(int), "output");
  acpi_status tmp ;
  int tmp___0 ;
...
{ 
  int is_thinkpad ;
    klee_make_symbolic(&is_thinkpad, sizeof(int), "is_thinkpad");
  bool tmp ;
  int tmp___0 ;
  bool tmp___1 ;
  int tmp___2 ;
...
{ 
  ...
  unsigned long ldvarg119 ;
    klee_make_symbolic(&ldvarg119, sizeof(long), "ldvarg119");
