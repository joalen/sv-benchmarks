...
struct dm_target_io {
   ...
   unsigned int target_bio_nr ;
    klee_make_symbolic(&target_bio_nr, sizeof(int), "target_bio_nr");
...
struct dm_kcopyd_throttle {
   unsigned int throttle ;
    klee_make_symbolic(&throttle, sizeof(int), "throttle");
   unsigned int num_io_jobs ;
    klee_make_symbolic(&num_io_jobs, sizeof(int), "num_io_jobs");
   unsigned int io_period ;
    klee_make_symbolic(&io_period, sizeof(int), "io_period");
   unsigned int total_period ;
    klee_make_symbolic(&total_period, sizeof(int), "total_period");
   unsigned int last_jiffies ;
    klee_make_symbolic(&last_jiffies, sizeof(int), "last_jiffies");
};
...
struct dm_snap_pending_exception {
   ...
   int copy_error ;
    klee_make_symbolic(&copy_error, sizeof(int), "copy_error");
...
struct dm_origin {
   ...
   unsigned int split_boundary ;
    klee_make_symbolic(&split_boundary, sizeof(int), "split_boundary");
   struct list_head hash_list ;
};
...
{ 
  ...
  unsigned int available_sectors ;
    klee_make_symbolic(&available_sectors, sizeof(int), "available_sectors");
  long tmp ;
  int tmp___0 ;
