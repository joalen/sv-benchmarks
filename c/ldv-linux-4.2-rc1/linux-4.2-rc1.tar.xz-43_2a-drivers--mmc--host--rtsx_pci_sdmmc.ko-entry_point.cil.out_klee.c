...
struct rtsx_pcr {
   ...
   unsigned int card_inserted ;
    klee_make_symbolic(&card_inserted, sizeof(int), "card_inserted");
   unsigned int card_removed ;
    klee_make_symbolic(&card_removed, sizeof(int), "card_removed");
   unsigned int card_exist ;
    klee_make_symbolic(&card_exist, sizeof(int), "card_exist");
   ...
   unsigned int cur_clock ;
    klee_make_symbolic(&cur_clock, sizeof(int), "cur_clock");
   bool remove_pci ;
   bool msi_en ;
   u32 extra_caps ;
   u8 ic_version ;
...
struct realtek_pci_sdmmc {
   ...
   s32 cookie ;
   int cookie_sg_count ;
    klee_make_symbolic(&cookie_sg_count, sizeof(int), "cookie_sg_count");
   bool using_cookie ;
};
...
{ 
  ...
  int count ;
  int using_cookie ;
    klee_make_symbolic(&using_cookie, sizeof(int), "using_cookie");
  struct device *tmp ;
...
{ 
  ...
  struct mmc_data *data ;
  int uhs ;
    klee_make_symbolic(&uhs, sizeof(int), "uhs");
  int tmp ;
  u8 cfg2 ;
  int err ;
  int resp_type ;
    klee_make_symbolic(&resp_type, sizeof(int), "resp_type");
  size_t data_len ;
  struct _ddebug descriptor ;
  struct device *tmp___0 ;
  long tmp___1 ;
...
{ 
  ...
  int start_final ;
    klee_make_symbolic(&start_final, sizeof(int), "start_final");
  int len_final ;
    klee_make_symbolic(&len_final, sizeof(int), "len_final");
  u8 final_phase ;
  struct device *tmp ;
  struct _ddebug descriptor ;
  struct device *tmp___0 ;
