...
struct solos_card {
   ...
   int tx_mask ;
    klee_make_symbolic(&tx_mask, sizeof(int), "tx_mask");
   struct pci_dev *dev ;
   ...
   int using_dma ;
    klee_make_symbolic(&using_dma, sizeof(int), "using_dma");
   int dma_alignment ;
    klee_make_symbolic(&dma_alignment, sizeof(int), "dma_alignment");
   int fpga_version ;
    klee_make_symbolic(&fpga_version, sizeof(int), "fpga_version");
   int buffer_size ;
    klee_make_symbolic(&buffer_size, sizeof(int), "buffer_size");
   int atmel_flash ;
    klee_make_symbolic(&atmel_flash, sizeof(int), "atmel_flash");
};
struct solos_param {
   struct list_head list ;
   pid_t pid ;
...
{ 
  ...
  int rate_up ;
    klee_make_symbolic(&rate_up, sizeof(int), "rate_up");
  int rate_down ;
    klee_make_symbolic(&rate_down, sizeof(int), "rate_down");
  long tmp ;
...
{ 
  ...
  unsigned long flags ;
  int cmdpid ;
    klee_make_symbolic(&cmdpid, sizeof(int), "cmdpid");
  int found ;
...
{ 
  ...
  int expand_by ;
    klee_make_symbolic(&expand_by, sizeof(int), "expand_by");
  int ret ;
