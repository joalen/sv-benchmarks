...
struct gr_ep {
   ...
   unsigned int dma_start ;
    klee_make_symbolic(&dma_start, sizeof(int), "dma_start");
...
struct gr_udc {
   ...
   int irqi ;
    klee_make_symbolic(&irqi, sizeof(int), "irqi");
   int irqo ;
    klee_make_symbolic(&irqo, sizeof(int), "irqo");
   ...
   unsigned int nepi ;
    klee_make_symbolic(&nepi, sizeof(int), "nepi");
   unsigned int nepo ;
    klee_make_symbolic(&nepo, sizeof(int), "nepo");
   struct list_head ep_list ;
   spinlock_t lock ;
...
{ 
  ...
  int powstate ;
    klee_make_symbolic(&powstate, sizeof(int), "powstate");
  struct _ddebug descriptor ;
  long tmp___0 ;
  struct _ddebug descriptor___0 ;
  long tmp___1 ;
