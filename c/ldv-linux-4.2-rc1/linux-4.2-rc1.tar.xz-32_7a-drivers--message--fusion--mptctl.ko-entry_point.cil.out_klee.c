...
struct mpt_fw_xfer {
   unsigned int iocnum ;
    klee_make_symbolic(&iocnum, sizeof(int), "iocnum");
   unsigned int fwlen ;
...
struct _mpt_ioctl_header {
   ...
   int maxDataSize ;
    klee_make_symbolic(&maxDataSize, sizeof(int), "maxDataSize");
};
...
union __anonunion_u_329 {
   ...
   unsigned int asUlong ;
    klee_make_symbolic(&asUlong, sizeof(int), "asUlong");
};
struct mpt_ioctl_pci_info2 {
   union __anonunion_u_329 u ;
   int segmentID ;
    klee_make_symbolic(&segmentID, sizeof(int), "segmentID");
};
struct mpt_ioctl_iocinfo {
   mpt_ioctl_header hdr ;
   int adapterType ;
    klee_make_symbolic(&adapterType, sizeof(int), "adapterType");
   int port ;
   int pciId ;
    klee_make_symbolic(&pciId, sizeof(int), "pciId");
   int hwRev ;
    klee_make_symbolic(&hwRev, sizeof(int), "hwRev");
   int subSystemDevice ;
    klee_make_symbolic(&subSystemDevice, sizeof(int), "subSystemDevice");
   int subSystemVendor ;
    klee_make_symbolic(&subSystemVendor, sizeof(int), "subSystemVendor");
   int numDevices ;
    klee_make_symbolic(&numDevices, sizeof(int), "numDevices");
   int FWVersion ;
    klee_make_symbolic(&FWVersion, sizeof(int), "FWVersion");
   int BIOSVersion ;
    klee_make_symbolic(&BIOSVersion, sizeof(int), "BIOSVersion");
   char driverVersion[32U] ;
   char busChangeEvent ;
    klee_make_symbolic(&busChangeEvent, sizeof(char), "busChangeEvent");
   char hostId ;
    klee_make_symbolic(&hostId, sizeof(char), "hostId");
   char rsvd[2U] ;
...
struct mpt_ioctl_eventquery {
   ...
   unsigned short eventEntries ;
    klee_make_symbolic(&eventEntries, sizeof(short), "eventEntries");
...
struct mpt_ioctl_replace_fw {
   mpt_ioctl_header hdr ;
   int newImageSize ;
    klee_make_symbolic(&newImageSize, sizeof(int), "newImageSize");
   u8 newImage[1U] ;
};
struct mpt_ioctl_command {
   ...
   char *senseDataPtr ;
   int maxReplyBytes ;
    klee_make_symbolic(&maxReplyBytes, sizeof(int), "maxReplyBytes");
   int dataInSize ;
    klee_make_symbolic(&dataInSize, sizeof(int), "dataInSize");
   int dataOutSize ;
    klee_make_symbolic(&dataOutSize, sizeof(int), "dataOutSize");
   int maxSenseBytes ;
    klee_make_symbolic(&maxSenseBytes, sizeof(int), "maxSenseBytes");
   int dataSgeOffset ;
    klee_make_symbolic(&dataSgeOffset, sizeof(int), "dataSgeOffset");
   char MF[1U] ;
};
...
struct _hp_header {
   unsigned int iocnum ;
   unsigned int host ;
    klee_make_symbolic(&host, sizeof(int), "host");
   unsigned int channel ;
   unsigned int id ;
   unsigned int lun ;
...
{ 
  char *sense_data ;
  int req_index ;
    klee_make_symbolic(&req_index, sizeof(int), "req_index");
  int sz ;
  int _min1 ;
...
{ 
  ...
  unsigned int iocnumX ;
    klee_make_symbolic(&iocnumX, sizeof(int), "iocnumX");
  int nonblock ;
...
{ 
  ...
  int ret ;
  int numfrags ;
    klee_make_symbolic(&numfrags, sizeof(int), "numfrags");
  int maxfrags ;
  ...
  u32 nib ;
  int fw_bytes_copied ;
    klee_make_symbolic(&fw_bytes_copied, sizeof(int), "fw_bytes_copied");
  int i ;
    klee_make_symbolic(&i, sizeof(int), "i");
  int sge_offset ;
    klee_make_symbolic(&sge_offset, sizeof(int), "sge_offset");
  u16 iocstat ;
...
{ 
  ...
  int numfrags ;
  int fragcnt ;
    klee_make_symbolic(&fragcnt, sizeof(int), "fragcnt");
  int alloc_sz ;
    klee_make_symbolic(&alloc_sz, sizeof(int), "alloc_sz");
  int _min1 ;
  int _min2 ;
  int bytes_allocd ;
    klee_make_symbolic(&bytes_allocd, sizeof(int), "bytes_allocd");
  int this_alloc ;
    klee_make_symbolic(&this_alloc, sizeof(int), "this_alloc");
  dma_addr_t pa ;
  int i ;
  int buflist_ent ;
    klee_make_symbolic(&buflist_ent, sizeof(int), "buflist_ent");
  int sg_spill ;
    klee_make_symbolic(&sg_spill, sizeof(int), "sg_spill");
  int dir ;
...
{ 
  ...
  unsigned int port ;
  int cim_rev ;
    klee_make_symbolic(&cim_rev, sizeof(int), "cim_rev");
  struct scsi_device *sdev ;
  VirtDevice *vdevice ;
  void *tmp ;
  long tmp___0 ;
...
{ 
  ...
  int lun ;
  int maxWordsLeft ;
    klee_make_symbolic(&maxWordsLeft, sizeof(int), "maxWordsLeft");
  int numBytes ;
...
{ 
  ...
  int numBytes ;
  int maxEvents ;
    klee_make_symbolic(&maxEvents, sizeof(int), "maxEvents");
  int max ;
  unsigned long tmp ;
  unsigned long tmp___0 ;
...
{ 
  ...
  int iocnum ;
  int newFwSize ;
    klee_make_symbolic(&newFwSize, sizeof(int), "newFwSize");
  unsigned long tmp ;
  unsigned long tmp___0 ;
...
{ 
  ...
  int sgSize ;
    klee_make_symbolic(&sgSize, sizeof(int), "sgSize");
  int iocnum ;
  int flagsLength ;
  ...
  int rc ;
  int msgContext ;
    klee_make_symbolic(&msgContext, sizeof(int), "msgContext");
  u16 req_idx ;
  ulong timeout ;
  unsigned long timeleft ;
  struct scsi_device *sdev ;
  ...
  int qtag ;
    klee_make_symbolic(&qtag, sizeof(int), "qtag");
  int scsidir ;
  ...
  int qtag___0 ;
    klee_make_symbolic(&qtag___0, sizeof(int), "qtag___0");
  int scsidir___0 ;
    klee_make_symbolic(&scsidir___0, sizeof(int), "scsidir___0");
  int dataSize___0 ;
    klee_make_symbolic(&dataSize___0, sizeof(int), "dataSize___0");
  SCSITaskMgmt_t *pScsiTm ;
  IOCInit_t *pInit ;
  u32 high_addr ;
  u32 sense_high ;
