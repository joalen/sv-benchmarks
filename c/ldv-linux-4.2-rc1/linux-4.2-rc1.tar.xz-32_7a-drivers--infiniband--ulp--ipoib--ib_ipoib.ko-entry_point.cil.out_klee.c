...
struct ib_sa_mcmember_rec {
   ...
   u8 join_state ;
   int proxy_join ;
    klee_make_symbolic(&proxy_join, sizeof(int), "proxy_join");
};
struct ib_sa_client {
   atomic_t users ;
...
struct ipoib_mcast {
   ...
   unsigned long created ;
    klee_make_symbolic(&created, sizeof(long), "created");
   unsigned long backoff ;
    klee_make_symbolic(&backoff, sizeof(long), "backoff");
   unsigned long delay_until ;
    klee_make_symbolic(&delay_until, sizeof(long), "delay_until");
   unsigned long flags ;
   unsigned char logcount ;
    klee_make_symbolic(&logcount, sizeof(char), "logcount");
...
struct ipoib_cm_tx {
   ...
   unsigned int tx_head ;
    klee_make_symbolic(&tx_head, sizeof(int), "tx_head");
   unsigned int tx_tail ;
    klee_make_symbolic(&tx_tail, sizeof(int), "tx_tail");
   unsigned long flags ;
   u32 mtu ;
};
struct ipoib_cm_rx_buf {
...
struct ipoib_cm_dev_priv {
   ...
   int nonsrq_conn_qp ;
    klee_make_symbolic(&nonsrq_conn_qp, sizeof(int), "nonsrq_conn_qp");
   int max_cm_mtu ;
    klee_make_symbolic(&max_cm_mtu, sizeof(int), "max_cm_mtu");
   int num_frags ;
    klee_make_symbolic(&num_frags, sizeof(int), "num_frags");
};
...
struct ipoib_dev_priv {
   ...
   unsigned int admin_mtu ;
    klee_make_symbolic(&admin_mtu, sizeof(int), "admin_mtu");
   unsigned int mcast_mtu ;
    klee_make_symbolic(&mcast_mtu, sizeof(int), "mcast_mtu");
   unsigned int max_ib_mtu ;
    klee_make_symbolic(&max_ib_mtu, sizeof(int), "max_ib_mtu");
   ...
   unsigned int tx_outstanding ;
    klee_make_symbolic(&tx_outstanding, sizeof(int), "tx_outstanding");
   ...
   struct list_head list ;
   int child_type ;
    klee_make_symbolic(&child_type, sizeof(int), "child_type");
   struct ipoib_cm_dev_priv cm ;
   struct list_head fs_list ;
   struct dentry *mcg_dentry ;
   struct dentry *path_dentry ;
   int hca_caps ;
    klee_make_symbolic(&hca_caps, sizeof(int), "hca_caps");
...
struct ipoib_ah {
   ...
   unsigned int last_send ;
    klee_make_symbolic(&last_send, sizeof(int), "last_send");
};
struct ipoib_path {
   struct net_device *dev ;
...
struct ipoib_neigh {
   ...
   atomic_t refcnt ;
   unsigned long alive ;
    klee_make_symbolic(&alive, sizeof(long), "alive");
};
...
struct ip_mc_list {
   ...
   spinlock_t lock ;
   char tm_running ;
    klee_make_symbolic(&tm_running, sizeof(char), "tm_running");
   char reporter ;
    klee_make_symbolic(&reporter, sizeof(char), "reporter");
   char unsolicit_count ;
    klee_make_symbolic(&unsolicit_count, sizeof(char), "unsolicit_count");
   char loaded ;
    klee_make_symbolic(&loaded, sizeof(char), "loaded");
   unsigned char gsquery ;
    klee_make_symbolic(&gsquery, sizeof(char), "gsquery");
   unsigned char crcount ;
    klee_make_symbolic(&crcount, sizeof(char), "crcount");
   struct callback_head rcu ;
};
struct ipv4_devconf {
   void *sysctl ;
...
struct ipoib_mcast_iter {
   ...
   unsigned int queuelen ;
    klee_make_symbolic(&queuelen, sizeof(int), "queuelen");
   unsigned int complete ;
    klee_make_symbolic(&complete, sizeof(int), "complete");
   unsigned int send_only ;
    klee_make_symbolic(&send_only, sizeof(int), "send_only");
};
enum hrtimer_restart;
...
struct ipoib_cm_rx {
   ...
   int recv_count ;
    klee_make_symbolic(&recv_count, sizeof(int), "recv_count");
};
...
int ipoib_max_conn_qp ;
    klee_make_symbolic(&ipoib_max_conn_qp, sizeof(int), "ipoib_max_conn_qp");
...
int ipoib_sendq_size ;
    klee_make_symbolic(&ipoib_sendq_size, sizeof(int), "ipoib_sendq_size");
int ipoib_recvq_size ;
    klee_make_symbolic(&ipoib_recvq_size, sizeof(int), "ipoib_recvq_size");
struct ib_sa_client ipoib_sa_client  ;
int ipoib_debug_level  ;
    klee_make_symbolic(&ipoib_debug_level, sizeof(int), "ipoib_debug_level");
...
{ 
  ...
  unsigned long neigh_obsolete ;
    klee_make_symbolic(&neigh_obsolete, sizeof(long), "neigh_obsolete");
  unsigned long dt ;
...
{ 
  ...
  int i ;
  int wait_flushed ;
    klee_make_symbolic(&wait_flushed, sizeof(int), "wait_flushed");
  raw_spinlock_t *tmp ;
  bool __warned ;
  int tmp___0 ;
  int tmp___1 ;
...
{ 
  unsigned long umcast_val ;
    klee_make_symbolic(&umcast_val, sizeof(long), "umcast_val");
  unsigned long tmp ;
  struct device  const  *__mptr ;
...
{ 
  int pkey ;
    klee_make_symbolic(&pkey, sizeof(int), "pkey");
  int ret ;
  int tmp ;
  struct device  const  *__mptr ;
...
{ 
  ...
  unsigned short ldvarg23 ;
    klee_make_symbolic(&ldvarg23, sizeof(short), "ldvarg23");
...
static int data_debug_level  ;
    klee_make_symbolic(&data_debug_level, sizeof(int), "data_debug_level");
struct ipoib_ah *ipoib_create_ah(struct net_device *dev , struct ib_pd *pd , struct ib_ah_attr *attr ) 
{ 
  struct ipoib_ah *ah ;
  struct ib_ah *vah ;
...
{ 
  ...
  void *tmp ;
  unsigned int wr_id ;
    klee_make_symbolic(&wr_id, sizeof(int), "wr_id");
  struct sk_buff *skb ;
  u64 mapping[2U] ;
  union ib_gid *dgid ;
  long tmp___0 ;
...
static int mcast_debug_level  ;
    klee_make_symbolic(&mcast_debug_level, sizeof(int), "mcast_debug_level");
...
{ 
  ...
  int ret ;
  int set_qkey ;
    klee_make_symbolic(&set_qkey, sizeof(int), "set_qkey");
  unsigned int tmp___0 ;
  int tmp___1 ;
  int tmp___2 ;
  __u32 tmp___3 ;
...
static int data_debug_level___0  ;
    klee_make_symbolic(&data_debug_level___0, sizeof(int), "data_debug_level___0");
...
{ 
  ...
  struct ib_qp_attr qp_attr ;
  int qp_attr_mask ;
    klee_make_symbolic(&qp_attr_mask, sizeof(int), "qp_attr_mask");
  int ret ;
...
{ 
  ...
  struct ipoib_cm_rx *p ;
  unsigned int psn ;
    klee_make_symbolic(&psn, sizeof(int), "psn");
  int ret ;
  void *tmp___0 ;
  long tmp___1 ;
  bool tmp___2 ;
...
{ 
  ...
  int has_srq ;
    klee_make_symbolic(&has_srq, sizeof(int), "has_srq");
