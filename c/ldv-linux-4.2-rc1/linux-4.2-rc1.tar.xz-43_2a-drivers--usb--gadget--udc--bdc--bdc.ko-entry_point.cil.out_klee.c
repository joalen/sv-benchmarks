...
struct bd_list {
   ...
   int num_tabs ;
    klee_make_symbolic(&num_tabs, sizeof(int), "num_tabs");
   int max_bdi ;
    klee_make_symbolic(&max_bdi, sizeof(int), "max_bdi");
   int eqp_bdi ;
    klee_make_symbolic(&eqp_bdi, sizeof(int), "eqp_bdi");
   int hwd_bdi ;
    klee_make_symbolic(&hwd_bdi, sizeof(int), "hwd_bdi");
   int num_bds_table ;
    klee_make_symbolic(&num_bds_table, sizeof(int), "num_bds_table");
};
struct bdc_req;
struct bd_transfer {
   struct bdc_req *req ;
   int start_bdi ;
    klee_make_symbolic(&start_bdi, sizeof(int), "start_bdi");
   int next_hwd_bdi ;
    klee_make_symbolic(&next_hwd_bdi, sizeof(int), "next_hwd_bdi");
   int num_bds ;
    klee_make_symbolic(&num_bds, sizeof(int), "num_bds");
};
struct bdc_ep;
struct bdc_req {
...
struct bdc {
   ...
   unsigned int num_eps ;
    klee_make_symbolic(&num_eps, sizeof(int), "num_eps");
...
{ 
  int sp_buff_size ;
    klee_make_symbolic(&sp_buff_size, sizeof(int), "sp_buff_size");
  u32 low32 ;
  u32 upp32 ;
  u32 tmp ;
  struct _ddebug descriptor ;
...
{ 
  ...
  unsigned int num_ieps ;
    klee_make_symbolic(&num_ieps, sizeof(int), "num_ieps");
  unsigned int num_oeps ;
    klee_make_symbolic(&num_oeps, sizeof(int), "num_oeps");
  struct _ddebug descriptor ;
  long tmp ;
  u32 tmp___0 ;
  struct _ddebug descriptor___0 ;
...
{ 
  ...
  u32 cmd_status ;
  int reset_bdc ;
    klee_make_symbolic(&reset_bdc, sizeof(int), "reset_bdc");
  int ret ;
  struct _ddebug descriptor ;
  long tmp ;
  struct _ddebug descriptor___0 ;
...
{ 
  ...
  int num_tabs ;
  int bd_p_tab ;
    klee_make_symbolic(&bd_p_tab, sizeof(int), "bd_p_tab");
  struct bdc *bdc ;
  struct bd_table *bd_table ;
  dma_addr_t dma ;
  int tmp ;
...
{ 
  int bd_needed ;
    klee_make_symbolic(&bd_needed, sizeof(int), "bd_needed");
  int remaining ;
...
{ 
  ...
  bool found ;
  int tbi ;
    klee_make_symbolic(&tbi, sizeof(int), "tbi");
  int bdi ;
    klee_make_symbolic(&bdi, sizeof(int), "bdi");
  struct _ddebug descriptor ;
  long tmp ;
  struct _ddebug descriptor___0 ;
  long tmp___0 ;
...
{ 
  int end_bdi ;
    klee_make_symbolic(&end_bdi, sizeof(int), "end_bdi");
...
{ 
  struct bd_list *bd_list ;
  int available1 ;
    klee_make_symbolic(&available1, sizeof(int), "available1");
  int available2 ;
    klee_make_symbolic(&available2, sizeof(int), "available2");
  struct bdc *bdc ;
  int chain_bd1 ;
    klee_make_symbolic(&chain_bd1, sizeof(int), "chain_bd1");
  int chain_bd2 ;
    klee_make_symbolic(&chain_bd2, sizeof(int), "chain_bd2");
  int available_bd ;
    klee_make_symbolic(&available_bd, sizeof(int), "available_bd");
  int tmp ;
  int tmp___0 ;
...
{ 
  ...
  int tmp ;
  int local_bdi ;
    klee_make_symbolic(&local_bdi, sizeof(int), "local_bdi");
...
{ 
  ...
  int ret ;
  int bdnum ;
    klee_make_symbolic(&bdnum, sizeof(int), "bdnum");
  u32 req_len ;
  int tmp ;
  u32 __y ;
  long tmp___0 ;
...
{ 
  int num_bds ;
  int bd_available ;
    klee_make_symbolic(&bd_available, sizeof(int), "bd_available");
  struct bdc_ep *ep ;
  int ret ;
  struct _ddebug descriptor ;
  long tmp ;
...
{ 
  ...
  int eqp_bdi ;
  int curr_hw_dqpi ;
    klee_make_symbolic(&curr_hw_dqpi, sizeof(int), "curr_hw_dqpi");
  bool start_pending ;
  bool end_pending ;
  bool first_remove ;
...
{ 
  int short_bdi ;
    klee_make_symbolic(&short_bdi, sizeof(int), "short_bdi");
  int start_bdi ;
  int end_bdi ;
  int max_len_bds ;
    klee_make_symbolic(&max_len_bds, sizeof(int), "max_len_bds");
  int chain_bds ;
    klee_make_symbolic(&chain_bds, sizeof(int), "chain_bds");
  struct bd_list *bd_list ;
  int actual_length ;
    klee_make_symbolic(&actual_length, sizeof(int), "actual_length");
  int length_short ;
    klee_make_symbolic(&length_short, sizeof(int), "length_short");
  struct bd_transfer *bd_xfr ;
...
{ 
  ...
  struct usb_ctrlrequest *setup_pkt ;
  int delegate_setup ;
    klee_make_symbolic(&delegate_setup, sizeof(int), "delegate_setup");
  int ret ;
  int config ;
...
{ 
  ...
  int bdi ;
  int gbdi ;
    klee_make_symbolic(&gbdi, sizeof(int), "gbdi");
  dma_addr_t dma ;
