...
struct mmc_card {
   ...
   unsigned int drive_strength ;
    klee_make_symbolic(&drive_strength, sizeof(int), "drive_strength");
...
struct mmc_host {
   ...
   int hold_retune ;
    klee_make_symbolic(&hold_retune, sizeof(int), "hold_retune");
   unsigned int retune_period ;
    klee_make_symbolic(&retune_period, sizeof(int), "retune_period");
...
struct sdhci_host {
   ...
   unsigned int align_sz ;
    klee_make_symbolic(&align_sz, sizeof(int), "align_sz");
   unsigned int align_mask ;
    klee_make_symbolic(&align_mask, sizeof(int), "align_mask");
...
{ 
  int gpio_cd ;
    klee_make_symbolic(&gpio_cd, sizeof(int), "gpio_cd");
  int tmp ;
  long tmp___0 ;
  u32 tmp___1 ;
...
{ 
  ...
  unsigned int override_timeout_clk ;
    klee_make_symbolic(&override_timeout_clk, sizeof(int), "override_timeout_clk");
  int ret ;
  int __ret_warn_on ;
  long tmp ;
  u16 tmp___0 ;
