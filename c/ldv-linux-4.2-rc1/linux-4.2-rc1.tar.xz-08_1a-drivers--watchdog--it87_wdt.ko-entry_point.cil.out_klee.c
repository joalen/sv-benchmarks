...
static unsigned int gpact  ;
    klee_make_symbolic(&gpact, sizeof(int), "gpact");
static unsigned int ciract  ;
    klee_make_symbolic(&ciract, sizeof(int), "ciract");
...
static unsigned long wdt_status  ;
    klee_make_symbolic(&wdt_status, sizeof(long), "wdt_status");
...
{ 
  unsigned char cfg ;
    klee_make_symbolic(&cfg, sizeof(char), "cfg");
  int tm ;
...
{ 
  int rc ;
  int try_gameport ;
    klee_make_symbolic(&try_gameport, sizeof(int), "try_gameport");
  u8 chip_rev ;
  int gp_rreq_fail ;
    klee_make_symbolic(&gp_rreq_fail, sizeof(int), "gp_rreq_fail");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
  int tmp___2 ;
