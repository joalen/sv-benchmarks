...
struct fc_fcp_internal {
   ...
   unsigned long last_can_queue_ramp_down_time ;
    klee_make_symbolic(&last_can_queue_ramp_down_time, sizeof(long), "last_can_queue_ramp_down_time");
   unsigned long last_can_queue_ramp_up_time ;
    klee_make_symbolic(&last_can_queue_ramp_up_time, sizeof(long), "last_can_queue_ramp_up_time");
   int max_can_queue ;
    klee_make_symbolic(&max_can_queue, sizeof(int), "max_can_queue");
};
...
unsigned int fc_debug_logging  ;
    klee_make_symbolic(&fc_debug_logging, sizeof(int), "fc_debug_logging");
...
{ 
  ...
  unsigned int len ;
  int redisc ;
    klee_make_symbolic(&redisc, sizeof(int), "redisc");
...
{ 
  ...
  unsigned int seq_cnt ;
    klee_make_symbolic(&seq_cnt, sizeof(int), "seq_cnt");
  unsigned int len ;
  int error ;
  struct fc_lport *tmp ;
  long tmp___0 ;
...
{ 
  ...
  struct fc_lport *lport ;
  unsigned int f_ctl ;
    klee_make_symbolic(&f_ctl, sizeof(int), "f_ctl");
  int tmp ;
...
{ 
  ...
  int rc ;
  int has_rec ;
    klee_make_symbolic(&has_rec, sizeof(int), "has_rec");
  char const   *tmp ;
  long tmp___0 ;
  long tmp___1 ;
  bool tmp___2 ;
...
{ 
  ...
  struct fs_fdmi_attrs *hba_attrs ;
  int numattrs ;
    klee_make_symbolic(&numattrs, sizeof(int), "numattrs");
...
{ 
  unsigned int old_mfs ;
    klee_make_symbolic(&old_mfs, sizeof(int), "old_mfs");
  int rc ;
...
{ 
  unsigned int mfs ;
    klee_make_symbolic(&mfs, sizeof(int), "mfs");
  __u16 tmp ;
  __u16 tmp___0 ;
...
{ 
  ...
  void *page_addr ;
  int using_sg ;
    klee_make_symbolic(&using_sg, sizeof(int), "using_sg");
  u32 f_ctl ;
  int __ret_warn_on ;
  long tmp ;
  struct fc_exch *_ep ;
  ...
  unsigned long _min2___2 ;
    klee_make_symbolic(&_min2___2, sizeof(long), "_min2___2");
  struct page *tmp___6 ;
...
{ 
  int ba_done ;
    klee_make_symbolic(&ba_done, sizeof(int), "ba_done");
...
{ 
  ...
  unsigned long ticks_left ;
    klee_make_symbolic(&ticks_left, sizeof(long), "ticks_left");
  int tmp ;
  struct fc_exch *_ep ;
  struct fc_seq  const  *__mptr ;
  long tmp___0 ;
...
{ 
  ...
  unsigned int rec_tov ;
    klee_make_symbolic(&rec_tov, sizeof(int), "rec_tov");
  void *tmp ;
  __u16 tmp___0 ;
  __u16 tmp___1 ;
  __u32 tmp___2 ;
...
{ 
  ...
  unsigned long wait_tmo ;
    klee_make_symbolic(&wait_tmo, sizeof(long), "wait_tmo");
  long tmp___0 ;
  int tmp___1 ;
  int tmp___2 ;
