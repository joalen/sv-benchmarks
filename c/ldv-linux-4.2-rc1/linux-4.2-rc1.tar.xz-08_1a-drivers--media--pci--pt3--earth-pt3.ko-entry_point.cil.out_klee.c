...
struct pt3_adapter {
   ...
   int adap_idx ;
    klee_make_symbolic(&adap_idx, sizeof(int), "adap_idx");
   struct dvb_demux demux ;
   ...
   int num_feeds ;
    klee_make_symbolic(&num_feeds, sizeof(int), "num_feeds");
   bool cur_lna ;
   bool cur_lnb ;
   ...
   int buf_ofs ;
    klee_make_symbolic(&buf_ofs, sizeof(int), "buf_ofs");
   int num_bufs ;
    klee_make_symbolic(&num_bufs, sizeof(int), "num_bufs");
   int num_discard ;
    klee_make_symbolic(&num_discard, sizeof(int), "num_discard");
   struct xfer_desc_buffer desc_buf[4U] ;
   int num_desc_bufs ;
    klee_make_symbolic(&num_desc_bufs, sizeof(int), "num_desc_bufs");
};
struct pt3_board {
   struct pci_dev *pdev ;
   void *regs[2U] ;
   struct mutex lock ;
   int lnb_on_cnt ;
    klee_make_symbolic(&lnb_on_cnt, sizeof(int), "lnb_on_cnt");
   int lna_on_cnt ;
    klee_make_symbolic(&lna_on_cnt, sizeof(int), "lna_on_cnt");
   int num_bufs ;
