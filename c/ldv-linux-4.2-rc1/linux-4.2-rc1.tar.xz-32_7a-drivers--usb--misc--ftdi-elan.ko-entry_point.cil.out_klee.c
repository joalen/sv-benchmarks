...
struct u132_command {
   ...
   u32 value ;
   int follows ;
    klee_make_symbolic(&follows, sizeof(int), "follows");
   void *buffer ;
};
struct u132_respond {
   u8 header ;
...
struct u132_target {
   ...
   struct urb *urb ;
   int toggle_bits ;
    klee_make_symbolic(&toggle_bits, sizeof(int), "toggle_bits");
   int error_count ;
   int condition_code ;
    klee_make_symbolic(&condition_code, sizeof(int), "condition_code");
   int repeat_number ;
    klee_make_symbolic(&repeat_number, sizeof(int), "repeat_number");
   int halted ;
   ...
   int non_null ;
    klee_make_symbolic(&non_null, sizeof(int), "non_null");
   int active ;
   int abandoning ;
    klee_make_symbolic(&abandoning, sizeof(int), "abandoning");
...
struct usb_ftdi {
   ...
   int command_next ;
    klee_make_symbolic(&command_next, sizeof(int), "command_next");
   int command_head ;
    klee_make_symbolic(&command_head, sizeof(int), "command_head");
   struct u132_command command[32U] ;
   int respond_next ;
    klee_make_symbolic(&respond_next, sizeof(int), "respond_next");
   int respond_head ;
    klee_make_symbolic(&respond_head, sizeof(int), "respond_head");
   ...
   int gone_away ;
    klee_make_symbolic(&gone_away, sizeof(int), "gone_away");
   int stuck_status ;
    klee_make_symbolic(&stuck_status, sizeof(int), "stuck_status");
   int status_queue_delay ;
    klee_make_symbolic(&status_queue_delay, sizeof(int), "status_queue_delay");
   ...
   int ed_found ;
    klee_make_symbolic(&ed_found, sizeof(int), "ed_found");
};
...
{ 
  int ed_number ;
    klee_make_symbolic(&ed_number, sizeof(int), "ed_number");
...
{ 
  ...
  struct u132_target *target ;
  int command_size ;
    klee_make_symbolic(&command_size, sizeof(int), "command_size");
  struct u132_command *command ;
  int command_size___0 ;
    klee_make_symbolic(&command_size___0, sizeof(int), "command_size___0");
...
{ 
  ...
  int work_delay_in_msec ;
    klee_make_symbolic(&work_delay_in_msec, sizeof(int), "work_delay_in_msec");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
  int tmp___2 ;
...
{ 
  ...
  int retry_on_empty ;
    klee_make_symbolic(&retry_on_empty, sizeof(int), "retry_on_empty");
  int retry_on_timeout ;
    klee_make_symbolic(&retry_on_timeout, sizeof(int), "retry_on_timeout");
  struct usb_ftdi *ftdi ;
  char *p ;
  int tmp ;
  int tmp___0 ;
  ...
  size_t tmp___3 ;
  int packet_bytes ;
    klee_make_symbolic(&packet_bytes, sizeof(int), "packet_bytes");
  int retval ;
...
{ 
  int ed_commands ;
    klee_make_symbolic(&ed_commands, sizeof(int), "ed_commands");
  int b ;
  int I ;
...
{ 
  ...
  int retry_on_timeout ;
  int empty_packets ;
    klee_make_symbolic(&empty_packets, sizeof(int), "empty_packets");
  int packet_bytes ;
  int retval ;
  unsigned int tmp ;
  int tmp___0 ;
  ...
  int tmp___6 ;
  unsigned char s0 ;
    klee_make_symbolic(&s0, sizeof(char), "s0");
  unsigned char s1 ;
    klee_make_symbolic(&s1, sizeof(char), "s1");
  int tmp___7 ;
  int tmp___8 ;
  int tmp___9 ;
  ...
  char *d___0 ;
  int m___0 ;
    klee_make_symbolic(&m___0, sizeof(int), "m___0");
  u8 *c___1 ;
  int s___0 ;
    klee_make_symbolic(&s___0, sizeof(int), "s___0");
  u8 *tmp___13 ;
  int tmp___14 ;
  ...
  u32 data ;
  int ed_number___0 ;
    klee_make_symbolic(&ed_number___0, sizeof(int), "ed_number___0");
  int ed_type ;
    klee_make_symbolic(&ed_type, sizeof(int), "ed_type");
  u16 ed_length___0 ;
...
{ 
  int command_size ;
  int respond_size ;
    klee_make_symbolic(&respond_size, sizeof(int), "respond_size");
  struct u132_command *command ;
  struct u132_respond *respond ;
  int result ;
  u8 tmp ;
...
{ 
  ...
  int retry_on_timeout ;
  int retry_on_status ;
    klee_make_symbolic(&retry_on_status, sizeof(int), "retry_on_status");
  int packet_bytes ;
  int retval ;
  unsigned int tmp ;
  int tmp___0 ;
  ...
  char s1 ;
  char s2 ;
    klee_make_symbolic(&s2, sizeof(char), "s2");
  int tmp___5 ;
  char b1 ;
...
{ 
  int retval ;
  int long_stop ;
    klee_make_symbolic(&long_stop, sizeof(int), "long_stop");
  int retry_on_timeout ;
  int retry_on_empty ;
  int err_count ;
    klee_make_symbolic(&err_count, sizeof(int), "err_count");
  int read_stop ;
    klee_make_symbolic(&read_stop, sizeof(int), "read_stop");
  int read_stuck ;
    klee_make_symbolic(&read_stuck, sizeof(int), "read_stuck");
  int packet_bytes ;
  unsigned int tmp ;
  char diag[94U] ;
  char *d ;
...
{ 
  int UxxxStatus ;
    klee_make_symbolic(&UxxxStatus, sizeof(int), "UxxxStatus");
  int tmp ;
  u8 fn ;
  int activePCIfn ;
    klee_make_symbolic(&activePCIfn, sizeof(int), "activePCIfn");
  u32 pcidata ;
  u32 pciVID ;
  u32 pciPID ;
  int reg ;
...
{ 
  int devices ;
    klee_make_symbolic(&devices, sizeof(int), "devices");
  int retval ;
  u32 hc_control ;
  int num_ports ;
...
{ 
  ...
  int activePCIfn ;
  int max_devices ;
    klee_make_symbolic(&max_devices, sizeof(int), "max_devices");
  int controllers ;
    klee_make_symbolic(&controllers, sizeof(int), "controllers");
  int unrecognized ;
    klee_make_symbolic(&unrecognized, sizeof(int), "unrecognized");
  u32 pciVID ;
  u32 pciPID ;
  int devices ;
