...
struct __anonstruct____missing_field_name_281 {
   ...
   unsigned short page_index ;
    klee_make_symbolic(&page_index, sizeof(short), "page_index");
   unsigned short page_count ;
    klee_make_symbolic(&page_count, sizeof(short), "page_count");
};
...
struct ceph_msg {
   ...
   bool needs_out_seq ;
   int front_alloc_len ;
    klee_make_symbolic(&front_alloc_len, sizeof(int), "front_alloc_len");
   unsigned long ack_stamp ;
    klee_make_symbolic(&ack_stamp, sizeof(long), "ack_stamp");
...
struct ceph_connection {
   ...
   u32 peer_global_seq ;
   int auth_retry ;
    klee_make_symbolic(&auth_retry, sizeof(int), "auth_retry");
   void *auth_reply_buf ;
   int auth_reply_buf_len ;
    klee_make_symbolic(&auth_reply_buf_len, sizeof(int), "auth_reply_buf_len");
   struct mutex mutex ;
   ...
   int out_kvec_left ;
    klee_make_symbolic(&out_kvec_left, sizeof(int), "out_kvec_left");
   int out_skip ;
    klee_make_symbolic(&out_skip, sizeof(int), "out_skip");
   int out_kvec_bytes ;
    klee_make_symbolic(&out_kvec_bytes, sizeof(int), "out_kvec_bytes");
   bool out_kvec_is_msg ;
   int out_more ;
    klee_make_symbolic(&out_more, sizeof(int), "out_more");
   __le64 out_temp_ack ;
   ...
   u32 in_data_crc ;
   char in_tag ;
    klee_make_symbolic(&in_tag, sizeof(char), "in_tag");
   int in_base_pos ;
    klee_make_symbolic(&in_base_pos, sizeof(int), "in_base_pos");
   __le64 in_temp_ack ;
...
struct ceph_msgpool {
   ...
   int type ;
   int front_len ;
    klee_make_symbolic(&front_len, sizeof(int), "front_len");
};
struct ceph_client;
...
struct ceph_mon_client {
   ...
   int pending_auth ;
    klee_make_symbolic(&pending_auth, sizeof(int), "pending_auth");
   bool hunting ;
   int cur_mon ;
    klee_make_symbolic(&cur_mon, sizeof(int), "cur_mon");
   unsigned long sub_sent ;
    klee_make_symbolic(&sub_sent, sizeof(long), "sub_sent");
   unsigned long sub_renew_after ;
    klee_make_symbolic(&sub_renew_after, sizeof(long), "sub_renew_after");
   struct ceph_connection con ;
   struct rb_root generic_request_tree ;
   int num_generic_requests ;
    klee_make_symbolic(&num_generic_requests, sizeof(int), "num_generic_requests");
   u64 last_tid ;
   int want_mdsmap ;
    klee_make_symbolic(&want_mdsmap, sizeof(int), "want_mdsmap");
   int want_next_osdmap ;
    klee_make_symbolic(&want_next_osdmap, sizeof(int), "want_next_osdmap");
   u32 have_osdmap ;
   u32 have_mdsmap ;
...
struct ceph_auth_client {
   ...
   unsigned int want_keys ;
    klee_make_symbolic(&want_keys, sizeof(int), "want_keys");
   struct mutex mutex ;
};
struct ceph_pagelist {
...
struct ceph_osd {
   ...
   int o_osd ;
    klee_make_symbolic(&o_osd, sizeof(int), "o_osd");
   int o_incarnation ;
    klee_make_symbolic(&o_incarnation, sizeof(int), "o_incarnation");
   ...
   unsigned long lru_ttl ;
    klee_make_symbolic(&lru_ttl, sizeof(long), "lru_ttl");
   int o_marked_for_keepalive ;
    klee_make_symbolic(&o_marked_for_keepalive, sizeof(int), "o_marked_for_keepalive");
...
struct ceph_osd_request {
   ...
   int r_pg_osds[16U] ;
   int r_num_pg_osds ;
    klee_make_symbolic(&r_num_pg_osds, sizeof(int), "r_num_pg_osds");
   struct ceph_msg *r_request ;
   struct ceph_msg *r_reply ;
   int r_flags ;
    klee_make_symbolic(&r_flags, sizeof(int), "r_flags");
   u32 r_sent ;
   unsigned int r_num_ops ;
    klee_make_symbolic(&r_num_ops, sizeof(int), "r_num_ops");
   ...
   int r_result ;
    klee_make_symbolic(&r_result, sizeof(int), "r_result");
   int r_reply_op_len[3U] ;
   s32 r_reply_op_result[3U] ;
   int r_got_reply ;
    klee_make_symbolic(&r_got_reply, sizeof(int), "r_got_reply");
   int r_linger ;
    klee_make_symbolic(&r_linger, sizeof(int), "r_linger");
   ...
   unsigned long r_stamp ;
    klee_make_symbolic(&r_stamp, sizeof(long), "r_stamp");
   struct ceph_snap_context *r_snapc ;
};
struct ceph_osd_event {
   u64 cookie ;
   int one_shot ;
    klee_make_symbolic(&one_shot, sizeof(int), "one_shot");
...
struct ceph_options {
   ...
   unsigned long mount_timeout ;
    klee_make_symbolic(&mount_timeout, sizeof(long), "mount_timeout");
   unsigned long osd_idle_ttl ;
    klee_make_symbolic(&osd_idle_ttl, sizeof(long), "osd_idle_ttl");
   unsigned long osd_keepalive_timeout ;
    klee_make_symbolic(&osd_keepalive_timeout, sizeof(long), "osd_keepalive_timeout");
   struct ceph_entity_addr *mon_addr ;
   int num_mon ;
    klee_make_symbolic(&num_mon, sizeof(int), "num_mon");
   char *name ;
...
struct ceph_client {
   ...
   int auth_err ;
    klee_make_symbolic(&auth_err, sizeof(int), "auth_err");
...
struct rbd_device {
   ...
   unsigned long open_count ;
    klee_make_symbolic(&open_count, sizeof(long), "open_count");
};
struct rbd_options {
   int queue_depth ;
   bool read_only ;
...
static int rbd_major  ;
    klee_make_symbolic(&rbd_major, sizeof(int), "rbd_major");
...
{ 
  ...
  unsigned long open_count_before ;
    klee_make_symbolic(&open_count_before, sizeof(long), "open_count_before");
  unsigned long tmp ;
  long tmp___0 ;
...
{ 
  ...
  struct ceph_osd_request *osd_req ;
  int num_osd_ops ;
    klee_make_symbolic(&num_osd_ops, sizeof(int), "num_osd_ops");
  bool tmp ;
  int tmp___0 ;
  long tmp___1 ;
  long tmp___2 ;
...
{ 
  ...
  unsigned int xferred ;
    klee_make_symbolic(&xferred, sizeof(int), "xferred");
  int result ;
  bool more ;
  bool tmp ;
  int tmp___0 ;
...
{ 
  ...
  unsigned int bio_offset ;
    klee_make_symbolic(&bio_offset, sizeof(int), "bio_offset");
  struct page **pages ;
  enum obj_operation_type op_type ;
  u64 img_offset ;
  u64 resid ;
  ...
  unsigned int clone_size ;
    klee_make_symbolic(&clone_size, sizeof(int), "clone_size");
  long tmp___3 ;
...
{ 
  ...
  u32 page_count___0 ;
  int img_result ;
    klee_make_symbolic(&img_result, sizeof(int), "img_result");
  u64 parent_length ;
  bool tmp ;
  int tmp___0 ;
  long tmp___1 ;
...
{ 
  int new_dev_id ;
    klee_make_symbolic(&new_dev_id, sizeof(int), "new_dev_id");
  int tmp ;
  struct _ddebug descriptor ;
  char const   *tmp___0 ;
  long tmp___1 ;
...
{ 
  ...
  int dev_id ;
  unsigned long ul ;
    klee_make_symbolic(&ul, sizeof(long), "ul");
  bool already ;
  int ret ;
  struct list_head  const  *__mptr ;
  int tmp___0 ;
