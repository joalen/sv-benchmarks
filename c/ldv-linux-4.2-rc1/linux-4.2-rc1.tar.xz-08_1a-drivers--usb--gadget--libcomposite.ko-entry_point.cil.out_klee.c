...
struct usb_os_desc {
   ...
   int ext_prop_len ;
    klee_make_symbolic(&ext_prop_len, sizeof(int), "ext_prop_len");
   int ext_prop_count ;
    klee_make_symbolic(&ext_prop_count, sizeof(int), "ext_prop_count");
...
struct usb_os_desc_table {
   int if_id ;
    klee_make_symbolic(&if_id, sizeof(int), "if_id");
...
struct usb_function {
   ...
   unsigned int os_desc_n ;
    klee_make_symbolic(&os_desc_n, sizeof(int), "os_desc_n");
...
struct usb_composite_dev {
   ...
   unsigned int deactivations ;
    klee_make_symbolic(&deactivations, sizeof(int), "deactivations");
   int delayed_status ;
    klee_make_symbolic(&delayed_status, sizeof(int), "delayed_status");
   spinlock_t lock ;
...
struct gadget_info {
   ...
   bool use_os_desc ;
   char b_vendor_code ;
    klee_make_symbolic(&b_vendor_code, sizeof(char), "b_vendor_code");
   char qw_sign[14U] ;
};
struct config_usb_cfg {
   struct config_group group ;
...
{ 
  ...
  u16 max ;
  int num_req_streams ;
    klee_make_symbolic(&num_req_streams, sizeof(int), "num_req_streams");
  int tmp___0 ;
  char *tmp___1 ;
  int tmp___2 ;
...
{ 
  ...
  int want_comp_desc ;
    klee_make_symbolic(&want_comp_desc, sizeof(int), "want_comp_desc");
...
{ 
  ...
  unsigned int n_gs ;
    klee_make_symbolic(&n_gs, sizeof(int), "n_gs");
  unsigned int n_s ;
    klee_make_symbolic(&n_s, sizeof(int), "n_s");
  void *stash ;
  void *tmp ;
  void *tmp___0 ;
...
{ 
  ...
  unsigned int n_gstrings ;
    klee_make_symbolic(&n_gstrings, sizeof(int), "n_gstrings");
  unsigned int i ;
  int ret ;
...
{ 
  unsigned int primary_lang ;
    klee_make_symbolic(&primary_lang, sizeof(int), "primary_lang");
  unsigned int sub_lang ;
    klee_make_symbolic(&sub_lang, sizeof(int), "sub_lang");
  u16 num ;
  int ret ;
...
{ 
  ...
  int langs ;
    klee_make_symbolic(&langs, sizeof(int), "langs");
  int ret ;
  void *tmp ;
  void *tmp___0 ;
  struct config_group  const  *__mptr ;
