...
typedef unsigned long DAC960_IO_Address_T;
    klee_make_symbolic(&DAC960_IO_Address_T, sizeof(long), "DAC960_IO_Address_T");
typedef unsigned long DAC960_PCI_Address_T;
    klee_make_symbolic(&DAC960_PCI_Address_T, sizeof(long), "DAC960_PCI_Address_T");
typedef unsigned int DAC960_BusAddress32_T;
    klee_make_symbolic(&DAC960_BusAddress32_T, sizeof(int), "DAC960_BusAddress32_T");
typedef unsigned long long DAC960_BusAddress64_T;
    klee_make_symbolic(&DAC960_BusAddress64_T, sizeof(long), "DAC960_BusAddress64_T");
typedef unsigned int DAC960_ByteCount32_T;
    klee_make_symbolic(&DAC960_ByteCount32_T, sizeof(int), "DAC960_ByteCount32_T");
typedef unsigned long long DAC960_ByteCount64_T;
    klee_make_symbolic(&DAC960_ByteCount64_T, sizeof(long), "DAC960_ByteCount64_T");
struct dma_loaf {
   void *cpu_base ;
   dma_addr_t dma_base ;
   size_t length ;
...
struct DAC960_SCSI_Inquiry {
   ...
   unsigned char AdditionalLength ;
    klee_make_symbolic(&AdditionalLength, sizeof(char), "AdditionalLength");
   unsigned char  ;
   unsigned char  ;
   bool SftRe ;
   bool CmdQue ;
...
struct DAC960_SCSI_Inquiry_UnitSerialNumber {
   ...
   unsigned char PageLength ;
    klee_make_symbolic(&PageLength, sizeof(char), "PageLength");
...
struct DAC960_SCSI_RequestSense {
   ...
   unsigned char SegmentNumber ;
    klee_make_symbolic(&SegmentNumber, sizeof(char), "SegmentNumber");
   ...
   unsigned char AdditionalSenseLength ;
    klee_make_symbolic(&AdditionalSenseLength, sizeof(char), "AdditionalSenseLength");
   unsigned char CommandSpecificInformation[4U] ;
   unsigned char AdditionalSenseCode ;
    klee_make_symbolic(&AdditionalSenseCode, sizeof(char), "AdditionalSenseCode");
   unsigned char AdditionalSenseCodeQualifier ;
    klee_make_symbolic(&AdditionalSenseCodeQualifier, sizeof(char), "AdditionalSenseCodeQualifier");
};
...
typedef unsigned char DAC960_V1_CommandIdentifier_T;
    klee_make_symbolic(&DAC960_V1_CommandIdentifier_T, sizeof(char), "DAC960_V1_CommandIdentifier_T");
typedef unsigned short DAC960_V1_CommandStatus_T;
    klee_make_symbolic(&DAC960_V1_CommandStatus_T, sizeof(short), "DAC960_V1_CommandStatus_T");
enum ldv_27343 {
...
struct __anonstruct_DeadDrives_266 {
   unsigned char TargetID ;
    klee_make_symbolic(&TargetID, sizeof(char), "TargetID");
   unsigned char Channel ;
    klee_make_symbolic(&Channel, sizeof(char), "Channel");
};
struct DAC960_V1_Enquiry {
   unsigned char NumberOfLogicalDrives ;
    klee_make_symbolic(&NumberOfLogicalDrives, sizeof(char), "NumberOfLogicalDrives");
   unsigned int  ;
   unsigned int LogicalDriveSizes[32U] ;
   unsigned short FlashAge ;
    klee_make_symbolic(&FlashAge, sizeof(short), "FlashAge");
   struct __anonstruct_StatusFlags_264 StatusFlags ;
   unsigned char  ;
   unsigned char MinorFirmwareVersion ;
    klee_make_symbolic(&MinorFirmwareVersion, sizeof(char), "MinorFirmwareVersion");
   unsigned char MajorFirmwareVersion ;
    klee_make_symbolic(&MajorFirmwareVersion, sizeof(char), "MajorFirmwareVersion");
   enum ldv_27343 RebuildFlag ;
   unsigned char MaxCommands ;
    klee_make_symbolic(&MaxCommands, sizeof(char), "MaxCommands");
   unsigned char OfflineLogicalDriveCount ;
    klee_make_symbolic(&OfflineLogicalDriveCount, sizeof(char), "OfflineLogicalDriveCount");
   unsigned char  ;
   unsigned short EventLogSequenceNumber ;
    klee_make_symbolic(&EventLogSequenceNumber, sizeof(short), "EventLogSequenceNumber");
   unsigned char CriticalLogicalDriveCount ;
    klee_make_symbolic(&CriticalLogicalDriveCount, sizeof(char), "CriticalLogicalDriveCount");
   unsigned int  ;
   unsigned char DeadDriveCount ;
    klee_make_symbolic(&DeadDriveCount, sizeof(char), "DeadDriveCount");
   unsigned char  ;
   unsigned char RebuildCount ;
    klee_make_symbolic(&RebuildCount, sizeof(char), "RebuildCount");
...
struct __anonstruct_HardwareID_267 {
   ...
   unsigned char ActualChannels ;
    klee_make_symbolic(&ActualChannels, sizeof(char), "ActualChannels");
   enum ldv_27355 Model ;
   enum ldv_27356 ProductFamily ;
};
struct __anonstruct_FirmwareID_268 {
   unsigned char MajorVersion ;
    klee_make_symbolic(&MajorVersion, sizeof(char), "MajorVersion");
   unsigned char MinorVersion ;
    klee_make_symbolic(&MinorVersion, sizeof(char), "MinorVersion");
   unsigned char TurnID ;
    klee_make_symbolic(&TurnID, sizeof(char), "TurnID");
   char FirmwareType ;
    klee_make_symbolic(&FirmwareType, sizeof(char), "FirmwareType");
};
...
struct DAC960_V1_Enquiry2 {
   ...
   unsigned char ConfiguredChannels ;
    klee_make_symbolic(&ConfiguredChannels, sizeof(char), "ConfiguredChannels");
   unsigned char ActualChannels ;
   unsigned char MaxTargets ;
    klee_make_symbolic(&MaxTargets, sizeof(char), "MaxTargets");
   unsigned char MaxTags ;
    klee_make_symbolic(&MaxTags, sizeof(char), "MaxTags");
   unsigned char MaxLogicalDrives ;
    klee_make_symbolic(&MaxLogicalDrives, sizeof(char), "MaxLogicalDrives");
   unsigned char MaxArms ;
    klee_make_symbolic(&MaxArms, sizeof(char), "MaxArms");
   unsigned char MaxSpans ;
    klee_make_symbolic(&MaxSpans, sizeof(char), "MaxSpans");
   unsigned char  ;
   unsigned int  ;
   unsigned int MemorySize ;
    klee_make_symbolic(&MemorySize, sizeof(int), "MemorySize");
   unsigned int CacheSize ;
    klee_make_symbolic(&CacheSize, sizeof(int), "CacheSize");
   unsigned int FlashMemorySize ;
    klee_make_symbolic(&FlashMemorySize, sizeof(int), "FlashMemorySize");
   unsigned int NonVolatileMemorySize ;
    klee_make_symbolic(&NonVolatileMemorySize, sizeof(int), "NonVolatileMemorySize");
   struct __anonstruct_MemoryType_269 MemoryType ;
   unsigned short ClockSpeed ;
    klee_make_symbolic(&ClockSpeed, sizeof(short), "ClockSpeed");
   unsigned short MemorySpeed ;
    klee_make_symbolic(&MemorySpeed, sizeof(short), "MemorySpeed");
   unsigned short HardwareSpeed ;
    klee_make_symbolic(&HardwareSpeed, sizeof(short), "HardwareSpeed");
   unsigned int  ;
   unsigned int  ;
   unsigned char  ;
   unsigned char  ;
   ...
   unsigned short MaxScatterGatherEntries ;
    klee_make_symbolic(&MaxScatterGatherEntries, sizeof(short), "MaxScatterGatherEntries");
   unsigned short MaxDriveCommands ;
    klee_make_symbolic(&MaxDriveCommands, sizeof(short), "MaxDriveCommands");
   unsigned short MaxIODescriptors ;
    klee_make_symbolic(&MaxIODescriptors, sizeof(short), "MaxIODescriptors");
   unsigned short MaxCombinedSectors ;
    klee_make_symbolic(&MaxCombinedSectors, sizeof(short), "MaxCombinedSectors");
   unsigned char Latency ;
    klee_make_symbolic(&Latency, sizeof(char), "Latency");
   unsigned char  ;
   unsigned char SCSITimeout ;
    klee_make_symbolic(&SCSITimeout, sizeof(char), "SCSITimeout");
   unsigned char  ;
   unsigned short MinFreeLines ;
    klee_make_symbolic(&MinFreeLines, sizeof(short), "MinFreeLines");
   unsigned int  ;
   unsigned int  ;
   unsigned char RebuildRateConstant ;
    klee_make_symbolic(&RebuildRateConstant, sizeof(char), "RebuildRateConstant");
   unsigned char  ;
   unsigned char  ;
   unsigned char  ;
   unsigned int  ;
   ...
   unsigned short PhysicalDriveBlockSize ;
    klee_make_symbolic(&PhysicalDriveBlockSize, sizeof(short), "PhysicalDriveBlockSize");
   unsigned short LogicalDriveBlockSize ;
    klee_make_symbolic(&LogicalDriveBlockSize, sizeof(short), "LogicalDriveBlockSize");
   unsigned short MaxBlocksPerCommand ;
    klee_make_symbolic(&MaxBlocksPerCommand, sizeof(short), "MaxBlocksPerCommand");
   unsigned short BlockFactor ;
    klee_make_symbolic(&BlockFactor, sizeof(short), "BlockFactor");
   unsigned short CacheLineSize ;
    klee_make_symbolic(&CacheLineSize, sizeof(short), "CacheLineSize");
   struct __anonstruct_SCSICapability_270 SCSICapability ;
   unsigned char  ;
   unsigned int  ;
   unsigned short FirmwareBuildNumber ;
    klee_make_symbolic(&FirmwareBuildNumber, sizeof(short), "FirmwareBuildNumber");
...
struct DAC960_V1_LogicalDriveInformation {
   unsigned int LogicalDriveSize ;
    klee_make_symbolic(&LogicalDriveSize, sizeof(int), "LogicalDriveSize");
...
struct DAC960_V1_EventLogEntry {
   unsigned char MessageType ;
    klee_make_symbolic(&MessageType, sizeof(char), "MessageType");
   unsigned char MessageLength ;
    klee_make_symbolic(&MessageLength, sizeof(char), "MessageLength");
   unsigned char TargetID : 5 ;
   unsigned char Channel : 3 ;
   unsigned char LogicalUnit : 6 ;
   unsigned char  ;
   unsigned short SequenceNumber ;
    klee_make_symbolic(&SequenceNumber, sizeof(short), "SequenceNumber");
   unsigned char ErrorCode : 7 ;
   bool Valid ;
   unsigned char SegmentNumber ;
   unsigned char SenseKey : 4 ;
...
struct DAC960_V1_DeviceState {
   ...
   unsigned char SynchronousMultiplier ;
    klee_make_symbolic(&SynchronousMultiplier, sizeof(char), "SynchronousMultiplier");
   unsigned char SynchronousOffset : 5 ;
   unsigned char  ;
   unsigned int DiskSize ;
    klee_make_symbolic(&DiskSize, sizeof(int), "DiskSize");
   unsigned short  ;
};
typedef struct DAC960_V1_DeviceState DAC960_V1_DeviceState_T;
struct DAC960_V1_RebuildProgress {
   unsigned int LogicalDriveNumber ;
    klee_make_symbolic(&LogicalDriveNumber, sizeof(int), "LogicalDriveNumber");
   unsigned int LogicalDriveSize ;
   unsigned int RemainingBlocks ;
    klee_make_symbolic(&RemainingBlocks, sizeof(int), "RemainingBlocks");
};
...
struct DAC960_V1_BackgroundInitializationStatus {
   ...
   unsigned int BlocksCompleted ;
    klee_make_symbolic(&BlocksCompleted, sizeof(int), "BlocksCompleted");
   unsigned char Reserved1[12U] ;
   unsigned int LogicalDriveNumber ;
   unsigned char RAIDLevel ;
    klee_make_symbolic(&RAIDLevel, sizeof(char), "RAIDLevel");
...
struct DAC960_V1_ErrorTableEntry {
   unsigned char ParityErrorCount ;
    klee_make_symbolic(&ParityErrorCount, sizeof(char), "ParityErrorCount");
   unsigned char SoftErrorCount ;
    klee_make_symbolic(&SoftErrorCount, sizeof(char), "SoftErrorCount");
   unsigned char HardErrorCount ;
    klee_make_symbolic(&HardErrorCount, sizeof(char), "HardErrorCount");
   unsigned char MiscErrorCount ;
    klee_make_symbolic(&MiscErrorCount, sizeof(char), "MiscErrorCount");
};
...
struct DAC960_V1_Config2 {
   ...
   unsigned char OEMModelNumber ;
    klee_make_symbolic(&OEMModelNumber, sizeof(char), "OEMModelNumber");
   unsigned char PhysicalSector ;
    klee_make_symbolic(&PhysicalSector, sizeof(char), "PhysicalSector");
   unsigned char LogicalSector ;
    klee_make_symbolic(&LogicalSector, sizeof(char), "LogicalSector");
   ...
   unsigned char DefaultRebuildRate ;
    klee_make_symbolic(&DefaultRebuildRate, sizeof(char), "DefaultRebuildRate");
   unsigned char  ;
   unsigned char BlocksPerCacheLine ;
    klee_make_symbolic(&BlocksPerCacheLine, sizeof(char), "BlocksPerCacheLine");
   unsigned char BlocksPerStripe ;
    klee_make_symbolic(&BlocksPerStripe, sizeof(char), "BlocksPerStripe");
   struct __anonstruct_ChannelParameters_272 ChannelParameters[6U] ;
   unsigned char SCSIInitiatorID ;
    klee_make_symbolic(&SCSIInitiatorID, sizeof(char), "SCSIInitiatorID");
   unsigned char  ;
   enum ldv_27422 StartupMode ;
   unsigned char SimultaneousDeviceSpinUpCount ;
    klee_make_symbolic(&SimultaneousDeviceSpinUpCount, sizeof(char), "SimultaneousDeviceSpinUpCount");
   unsigned char SecondsDelayBetweenSpinUps ;
    klee_make_symbolic(&SecondsDelayBetweenSpinUps, sizeof(char), "SecondsDelayBetweenSpinUps");
   ...
   unsigned short Checksum ;
    klee_make_symbolic(&Checksum, sizeof(short), "Checksum");
};
...
struct __anonstruct_Type3B_275 {
   ...
   unsigned char CommandOpcode2 ;
    klee_make_symbolic(&CommandOpcode2, sizeof(char), "CommandOpcode2");
...
struct __anonstruct_Type3E_278 {
   ...
   unsigned char OperationQualifier ;
    klee_make_symbolic(&OperationQualifier, sizeof(char), "OperationQualifier");
   unsigned short SequenceNumber ;
...
struct __anonstruct_Type4_280 {
   ...
   unsigned int LogicalBlockAddress ;
    klee_make_symbolic(&LogicalBlockAddress, sizeof(int), "LogicalBlockAddress");
   DAC960_BusAddress32_T BusAddress ;
...
typedef unsigned short DAC960_V2_CommandIdentifier_T;
    klee_make_symbolic(&DAC960_V2_CommandIdentifier_T, sizeof(short), "DAC960_V2_CommandIdentifier_T");
typedef unsigned char DAC960_V2_CommandStatus_T;
    klee_make_symbolic(&DAC960_V2_CommandStatus_T, sizeof(char), "DAC960_V2_CommandStatus_T");
...
struct DAC960_V2_ControllerInfo {
   ...
   unsigned short BusInterfaceSpeedMHz ;
    klee_make_symbolic(&BusInterfaceSpeedMHz, sizeof(short), "BusInterfaceSpeedMHz");
   unsigned char BusWidthBits ;
    klee_make_symbolic(&BusWidthBits, sizeof(char), "BusWidthBits");
   unsigned char FlashCodeTypeOrProductID ;
    klee_make_symbolic(&FlashCodeTypeOrProductID, sizeof(char), "FlashCodeTypeOrProductID");
   unsigned char NumberOfHostPortsPresent ;
    klee_make_symbolic(&NumberOfHostPortsPresent, sizeof(char), "NumberOfHostPortsPresent");
   ...
   unsigned char FirmwareMajorVersion ;
    klee_make_symbolic(&FirmwareMajorVersion, sizeof(char), "FirmwareMajorVersion");
   unsigned char FirmwareMinorVersion ;
    klee_make_symbolic(&FirmwareMinorVersion, sizeof(char), "FirmwareMinorVersion");
   unsigned char FirmwareTurnNumber ;
    klee_make_symbolic(&FirmwareTurnNumber, sizeof(char), "FirmwareTurnNumber");
   unsigned char FirmwareBuildNumber ;
   unsigned char FirmwareReleaseDay ;
    klee_make_symbolic(&FirmwareReleaseDay, sizeof(char), "FirmwareReleaseDay");
   unsigned char FirmwareReleaseMonth ;
    klee_make_symbolic(&FirmwareReleaseMonth, sizeof(char), "FirmwareReleaseMonth");
   unsigned char FirmwareReleaseYearHigh2Digits ;
    klee_make_symbolic(&FirmwareReleaseYearHigh2Digits, sizeof(char), "FirmwareReleaseYearHigh2Digits");
   unsigned char FirmwareReleaseYearLow2Digits ;
    klee_make_symbolic(&FirmwareReleaseYearLow2Digits, sizeof(char), "FirmwareReleaseYearLow2Digits");
   unsigned char HardwareRevision ;
    klee_make_symbolic(&HardwareRevision, sizeof(char), "HardwareRevision");
   unsigned int  ;
   unsigned char HardwareReleaseDay ;
    klee_make_symbolic(&HardwareReleaseDay, sizeof(char), "HardwareReleaseDay");
   unsigned char HardwareReleaseMonth ;
    klee_make_symbolic(&HardwareReleaseMonth, sizeof(char), "HardwareReleaseMonth");
   unsigned char HardwareReleaseYearHigh2Digits ;
    klee_make_symbolic(&HardwareReleaseYearHigh2Digits, sizeof(char), "HardwareReleaseYearHigh2Digits");
   unsigned char HardwareReleaseYearLow2Digits ;
    klee_make_symbolic(&HardwareReleaseYearLow2Digits, sizeof(char), "HardwareReleaseYearLow2Digits");
   unsigned char ManufacturingBatchNumber ;
    klee_make_symbolic(&ManufacturingBatchNumber, sizeof(char), "ManufacturingBatchNumber");
   unsigned char  ;
   unsigned char ManufacturingPlantNumber ;
    klee_make_symbolic(&ManufacturingPlantNumber, sizeof(char), "ManufacturingPlantNumber");
   unsigned char  ;
   unsigned char HardwareManufacturingDay ;
    klee_make_symbolic(&HardwareManufacturingDay, sizeof(char), "HardwareManufacturingDay");
   unsigned char HardwareManufacturingMonth ;
    klee_make_symbolic(&HardwareManufacturingMonth, sizeof(char), "HardwareManufacturingMonth");
   unsigned char HardwareManufacturingYearHigh2Digits ;
    klee_make_symbolic(&HardwareManufacturingYearHigh2Digits, sizeof(char), "HardwareManufacturingYearHigh2Digits");
   unsigned char HardwareManufacturingYearLow2Digits ;
    klee_make_symbolic(&HardwareManufacturingYearLow2Digits, sizeof(char), "HardwareManufacturingYearLow2Digits");
   unsigned char MaximumNumberOfPDDperXLD ;
    klee_make_symbolic(&MaximumNumberOfPDDperXLD, sizeof(char), "MaximumNumberOfPDDperXLD");
   unsigned char MaximumNumberOfILDperXLD ;
    klee_make_symbolic(&MaximumNumberOfILDperXLD, sizeof(char), "MaximumNumberOfILDperXLD");
   unsigned short NonvolatileMemorySizeKB ;
    klee_make_symbolic(&NonvolatileMemorySizeKB, sizeof(short), "NonvolatileMemorySizeKB");
   unsigned char MaximumNumberOfXLD ;
    klee_make_symbolic(&MaximumNumberOfXLD, sizeof(char), "MaximumNumberOfXLD");
   unsigned int  ;
   unsigned char ControllerSerialNumber[16U] ;
   unsigned char Reserved3[16U] ;
   unsigned int  ;
   unsigned char OEM_Code ;
    klee_make_symbolic(&OEM_Code, sizeof(char), "OEM_Code");
   ...
   unsigned char PhysicalDeviceChannelNumber ;
    klee_make_symbolic(&PhysicalDeviceChannelNumber, sizeof(char), "PhysicalDeviceChannelNumber");
   unsigned char PhysicalDeviceTargetID ;
    klee_make_symbolic(&PhysicalDeviceTargetID, sizeof(char), "PhysicalDeviceTargetID");
   unsigned char PhysicalDeviceLogicalUnit ;
    klee_make_symbolic(&PhysicalDeviceLogicalUnit, sizeof(char), "PhysicalDeviceLogicalUnit");
   unsigned short MaximumDataTransferSizeInBlocks ;
    klee_make_symbolic(&MaximumDataTransferSizeInBlocks, sizeof(short), "MaximumDataTransferSizeInBlocks");
   unsigned short MaximumScatterGatherEntries ;
    klee_make_symbolic(&MaximumScatterGatherEntries, sizeof(short), "MaximumScatterGatherEntries");
   unsigned short LogicalDevicesPresent ;
    klee_make_symbolic(&LogicalDevicesPresent, sizeof(short), "LogicalDevicesPresent");
   unsigned short LogicalDevicesCritical ;
    klee_make_symbolic(&LogicalDevicesCritical, sizeof(short), "LogicalDevicesCritical");
   unsigned short LogicalDevicesOffline ;
    klee_make_symbolic(&LogicalDevicesOffline, sizeof(short), "LogicalDevicesOffline");
   unsigned short PhysicalDevicesPresent ;
    klee_make_symbolic(&PhysicalDevicesPresent, sizeof(short), "PhysicalDevicesPresent");
   unsigned short PhysicalDisksPresent ;
    klee_make_symbolic(&PhysicalDisksPresent, sizeof(short), "PhysicalDisksPresent");
   unsigned short PhysicalDisksCritical ;
    klee_make_symbolic(&PhysicalDisksCritical, sizeof(short), "PhysicalDisksCritical");
   unsigned short PhysicalDisksOffline ;
    klee_make_symbolic(&PhysicalDisksOffline, sizeof(short), "PhysicalDisksOffline");
   unsigned short MaximumParallelCommands ;
    klee_make_symbolic(&MaximumParallelCommands, sizeof(short), "MaximumParallelCommands");
   unsigned char NumberOfPhysicalChannelsPresent ;
    klee_make_symbolic(&NumberOfPhysicalChannelsPresent, sizeof(char), "NumberOfPhysicalChannelsPresent");
   unsigned char NumberOfVirtualChannelsPresent ;
    klee_make_symbolic(&NumberOfVirtualChannelsPresent, sizeof(char), "NumberOfVirtualChannelsPresent");
   unsigned char NumberOfPhysicalChannelsPossible ;
    klee_make_symbolic(&NumberOfPhysicalChannelsPossible, sizeof(char), "NumberOfPhysicalChannelsPossible");
   unsigned char NumberOfVirtualChannelsPossible ;
    klee_make_symbolic(&NumberOfVirtualChannelsPossible, sizeof(char), "NumberOfVirtualChannelsPossible");
   unsigned char MaximumTargetsPerChannel[16U] ;
   unsigned char Reserved4[12U] ;
   unsigned short MemorySizeMB ;
    klee_make_symbolic(&MemorySizeMB, sizeof(short), "MemorySizeMB");
   unsigned short CacheSizeMB ;
    klee_make_symbolic(&CacheSizeMB, sizeof(short), "CacheSizeMB");
   unsigned int ValidCacheSizeInBytes ;
    klee_make_symbolic(&ValidCacheSizeInBytes, sizeof(int), "ValidCacheSizeInBytes");
   unsigned int DirtyCacheSizeInBytes ;
    klee_make_symbolic(&DirtyCacheSizeInBytes, sizeof(int), "DirtyCacheSizeInBytes");
   unsigned short MemorySpeedMHz ;
    klee_make_symbolic(&MemorySpeedMHz, sizeof(short), "MemorySpeedMHz");
   unsigned char MemoryDataWidthBits ;
    klee_make_symbolic(&MemoryDataWidthBits, sizeof(char), "MemoryDataWidthBits");
   DAC960_V2_MemoryType_T MemoryType ;
   unsigned char CacheMemoryTypeName[16U] ;
   unsigned short ExecutionMemorySizeMB ;
    klee_make_symbolic(&ExecutionMemorySizeMB, sizeof(short), "ExecutionMemorySizeMB");
   unsigned short ExecutionL2CacheSizeMB ;
    klee_make_symbolic(&ExecutionL2CacheSizeMB, sizeof(short), "ExecutionL2CacheSizeMB");
   unsigned char Reserved5[8U] ;
   unsigned short ExecutionMemorySpeedMHz ;
    klee_make_symbolic(&ExecutionMemorySpeedMHz, sizeof(short), "ExecutionMemorySpeedMHz");
   unsigned char ExecutionMemoryDataWidthBits ;
    klee_make_symbolic(&ExecutionMemoryDataWidthBits, sizeof(char), "ExecutionMemoryDataWidthBits");
   DAC960_V2_MemoryType_T ExecutionMemoryType ;
   unsigned char ExecutionMemoryTypeName[16U] ;
   unsigned short FirstProcessorSpeedMHz ;
    klee_make_symbolic(&FirstProcessorSpeedMHz, sizeof(short), "FirstProcessorSpeedMHz");
   DAC960_V2_ProcessorType_T FirstProcessorType ;
   unsigned char FirstProcessorCount ;
    klee_make_symbolic(&FirstProcessorCount, sizeof(char), "FirstProcessorCount");
   unsigned char Reserved6[12U] ;
   unsigned char FirstProcessorName[16U] ;
   unsigned short SecondProcessorSpeedMHz ;
    klee_make_symbolic(&SecondProcessorSpeedMHz, sizeof(short), "SecondProcessorSpeedMHz");
   DAC960_V2_ProcessorType_T SecondProcessorType ;
   unsigned char SecondProcessorCount ;
    klee_make_symbolic(&SecondProcessorCount, sizeof(char), "SecondProcessorCount");
   unsigned char Reserved7[12U] ;
   unsigned char SecondProcessorName[16U] ;
   unsigned short CurrentProfilingDataPageNumber ;
    klee_make_symbolic(&CurrentProfilingDataPageNumber, sizeof(short), "CurrentProfilingDataPageNumber");
   unsigned short ProgramsAwaitingProfilingData ;
    klee_make_symbolic(&ProgramsAwaitingProfilingData, sizeof(short), "ProgramsAwaitingProfilingData");
   unsigned short CurrentCommandTimeTraceDataPageNumber ;
    klee_make_symbolic(&CurrentCommandTimeTraceDataPageNumber, sizeof(short), "CurrentCommandTimeTraceDataPageNumber");
   unsigned short ProgramsAwaitingCommandTimeTraceData ;
    klee_make_symbolic(&ProgramsAwaitingCommandTimeTraceData, sizeof(short), "ProgramsAwaitingCommandTimeTraceData");
   unsigned char Reserved8[8U] ;
   unsigned short PhysicalDeviceBusResets ;
    klee_make_symbolic(&PhysicalDeviceBusResets, sizeof(short), "PhysicalDeviceBusResets");
   unsigned short PhysicalDeviceParityErrors ;
    klee_make_symbolic(&PhysicalDeviceParityErrors, sizeof(short), "PhysicalDeviceParityErrors");
   unsigned short PhysicalDeviceSoftErrors ;
    klee_make_symbolic(&PhysicalDeviceSoftErrors, sizeof(short), "PhysicalDeviceSoftErrors");
   unsigned short PhysicalDeviceCommandsFailed ;
    klee_make_symbolic(&PhysicalDeviceCommandsFailed, sizeof(short), "PhysicalDeviceCommandsFailed");
   unsigned short PhysicalDeviceMiscellaneousErrors ;
    klee_make_symbolic(&PhysicalDeviceMiscellaneousErrors, sizeof(short), "PhysicalDeviceMiscellaneousErrors");
   unsigned short PhysicalDeviceCommandTimeouts ;
    klee_make_symbolic(&PhysicalDeviceCommandTimeouts, sizeof(short), "PhysicalDeviceCommandTimeouts");
   unsigned short PhysicalDeviceSelectionTimeouts ;
    klee_make_symbolic(&PhysicalDeviceSelectionTimeouts, sizeof(short), "PhysicalDeviceSelectionTimeouts");
   unsigned short PhysicalDeviceRetriesDone ;
    klee_make_symbolic(&PhysicalDeviceRetriesDone, sizeof(short), "PhysicalDeviceRetriesDone");
   unsigned short PhysicalDeviceAbortsDone ;
    klee_make_symbolic(&PhysicalDeviceAbortsDone, sizeof(short), "PhysicalDeviceAbortsDone");
   unsigned short PhysicalDeviceHostCommandAbortsDone ;
    klee_make_symbolic(&PhysicalDeviceHostCommandAbortsDone, sizeof(short), "PhysicalDeviceHostCommandAbortsDone");
   unsigned short PhysicalDevicePredictedFailuresDetected ;
    klee_make_symbolic(&PhysicalDevicePredictedFailuresDetected, sizeof(short), "PhysicalDevicePredictedFailuresDetected");
   unsigned short PhysicalDeviceHostCommandsFailed ;
    klee_make_symbolic(&PhysicalDeviceHostCommandsFailed, sizeof(short), "PhysicalDeviceHostCommandsFailed");
   unsigned short PhysicalDeviceHardErrors ;
    klee_make_symbolic(&PhysicalDeviceHardErrors, sizeof(short), "PhysicalDeviceHardErrors");
   unsigned char Reserved9[6U] ;
   unsigned short LogicalDeviceSoftErrors ;
    klee_make_symbolic(&LogicalDeviceSoftErrors, sizeof(short), "LogicalDeviceSoftErrors");
   unsigned short LogicalDeviceCommandsFailed ;
    klee_make_symbolic(&LogicalDeviceCommandsFailed, sizeof(short), "LogicalDeviceCommandsFailed");
   unsigned short LogicalDeviceHostCommandAbortsDone ;
    klee_make_symbolic(&LogicalDeviceHostCommandAbortsDone, sizeof(short), "LogicalDeviceHostCommandAbortsDone");
   unsigned short  ;
   unsigned short ControllerMemoryErrors ;
    klee_make_symbolic(&ControllerMemoryErrors, sizeof(short), "ControllerMemoryErrors");
   unsigned short ControllerHostCommandAbortsDone ;
    klee_make_symbolic(&ControllerHostCommandAbortsDone, sizeof(short), "ControllerHostCommandAbortsDone");
   unsigned int  ;
   unsigned short BackgroundInitializationsActive ;
    klee_make_symbolic(&BackgroundInitializationsActive, sizeof(short), "BackgroundInitializationsActive");
   unsigned short LogicalDeviceInitializationsActive ;
    klee_make_symbolic(&LogicalDeviceInitializationsActive, sizeof(short), "LogicalDeviceInitializationsActive");
   unsigned short PhysicalDeviceInitializationsActive ;
    klee_make_symbolic(&PhysicalDeviceInitializationsActive, sizeof(short), "PhysicalDeviceInitializationsActive");
   unsigned short ConsistencyChecksActive ;
    klee_make_symbolic(&ConsistencyChecksActive, sizeof(short), "ConsistencyChecksActive");
   unsigned short RebuildsActive ;
    klee_make_symbolic(&RebuildsActive, sizeof(short), "RebuildsActive");
   unsigned short OnlineExpansionsActive ;
    klee_make_symbolic(&OnlineExpansionsActive, sizeof(short), "OnlineExpansionsActive");
   unsigned short PatrolActivitiesActive ;
    klee_make_symbolic(&PatrolActivitiesActive, sizeof(short), "PatrolActivitiesActive");
   unsigned short  ;
   unsigned char FlashType ;
    klee_make_symbolic(&FlashType, sizeof(char), "FlashType");
   unsigned char  ;
   unsigned short FlashSizeMB ;
    klee_make_symbolic(&FlashSizeMB, sizeof(short), "FlashSizeMB");
   unsigned int FlashLimit ;
    klee_make_symbolic(&FlashLimit, sizeof(int), "FlashLimit");
   unsigned int FlashCount ;
    klee_make_symbolic(&FlashCount, sizeof(int), "FlashCount");
   unsigned int  ;
   unsigned char FlashTypeName[16U] ;
   unsigned char RebuildRate ;
    klee_make_symbolic(&RebuildRate, sizeof(char), "RebuildRate");
   unsigned char BackgroundInitializationRate ;
    klee_make_symbolic(&BackgroundInitializationRate, sizeof(char), "BackgroundInitializationRate");
   unsigned char ForegroundInitializationRate ;
    klee_make_symbolic(&ForegroundInitializationRate, sizeof(char), "ForegroundInitializationRate");
   unsigned char ConsistencyCheckRate ;
    klee_make_symbolic(&ConsistencyCheckRate, sizeof(char), "ConsistencyCheckRate");
   unsigned int  ;
   unsigned int MaximumDP ;
    klee_make_symbolic(&MaximumDP, sizeof(int), "MaximumDP");
   unsigned int FreeDP ;
    klee_make_symbolic(&FreeDP, sizeof(int), "FreeDP");
   unsigned int MaximumIOP ;
    klee_make_symbolic(&MaximumIOP, sizeof(int), "MaximumIOP");
   unsigned int FreeIOP ;
    klee_make_symbolic(&FreeIOP, sizeof(int), "FreeIOP");
   unsigned short MaximumCombLengthInBlocks ;
    klee_make_symbolic(&MaximumCombLengthInBlocks, sizeof(short), "MaximumCombLengthInBlocks");
   unsigned short NumberOfConfigurationGroups ;
    klee_make_symbolic(&NumberOfConfigurationGroups, sizeof(short), "NumberOfConfigurationGroups");
...
struct DAC960_V2_LogicalDeviceInfo {
   ...
   unsigned char LogicalUnit ;
    klee_make_symbolic(&LogicalUnit, sizeof(char), "LogicalUnit");
   DAC960_V2_LogicalDeviceState_T LogicalDeviceState ;
   unsigned char RAIDLevel ;
   unsigned char StripeSize ;
    klee_make_symbolic(&StripeSize, sizeof(char), "StripeSize");
   ...
   unsigned char RAID5WriteUpdate ;
    klee_make_symbolic(&RAID5WriteUpdate, sizeof(char), "RAID5WriteUpdate");
   unsigned char RAID5Algorithm ;
    klee_make_symbolic(&RAID5Algorithm, sizeof(char), "RAID5Algorithm");
   unsigned short LogicalDeviceNumber ;
    klee_make_symbolic(&LogicalDeviceNumber, sizeof(short), "LogicalDeviceNumber");
   bool BIOSDisabled ;
   bool CDROMBootEnabled ;
   ...
   unsigned short SoftErrors ;
    klee_make_symbolic(&SoftErrors, sizeof(short), "SoftErrors");
   unsigned short CommandsFailed ;
    klee_make_symbolic(&CommandsFailed, sizeof(short), "CommandsFailed");
   unsigned short HostCommandAbortsDone ;
    klee_make_symbolic(&HostCommandAbortsDone, sizeof(short), "HostCommandAbortsDone");
   unsigned short DeferredWriteErrors ;
    klee_make_symbolic(&DeferredWriteErrors, sizeof(short), "DeferredWriteErrors");
   unsigned int  ;
   unsigned int  ;
   unsigned short  ;
   unsigned short DeviceBlockSizeInBytes ;
    klee_make_symbolic(&DeviceBlockSizeInBytes, sizeof(short), "DeviceBlockSizeInBytes");
   unsigned int OriginalDeviceSize ;
    klee_make_symbolic(&OriginalDeviceSize, sizeof(int), "OriginalDeviceSize");
   unsigned int ConfigurableDeviceSize ;
    klee_make_symbolic(&ConfigurableDeviceSize, sizeof(int), "ConfigurableDeviceSize");
   unsigned int  ;
...
struct DAC960_V2_PhysicalDeviceInfo {
   ...
   unsigned char NegotiatedDataWidthBits ;
    klee_make_symbolic(&NegotiatedDataWidthBits, sizeof(char), "NegotiatedDataWidthBits");
   unsigned short NegotiatedSynchronousMegaTransfers ;
    klee_make_symbolic(&NegotiatedSynchronousMegaTransfers, sizeof(short), "NegotiatedSynchronousMegaTransfers");
   unsigned char NumberOfPortConnections ;
    klee_make_symbolic(&NumberOfPortConnections, sizeof(char), "NumberOfPortConnections");
   unsigned char DriveAccessibilityBitmap ;
    klee_make_symbolic(&DriveAccessibilityBitmap, sizeof(char), "DriveAccessibilityBitmap");
   unsigned int  ;
   unsigned char NetworkAddress[16U] ;
   unsigned short MaximumTags ;
    klee_make_symbolic(&MaximumTags, sizeof(short), "MaximumTags");
   bool ConsistencyCheckInProgress ;
   bool RebuildInProgress ;
   ...
   unsigned char LongOperationStatus ;
    klee_make_symbolic(&LongOperationStatus, sizeof(char), "LongOperationStatus");
   unsigned char ParityErrors ;
    klee_make_symbolic(&ParityErrors, sizeof(char), "ParityErrors");
   unsigned char SoftErrors ;
   unsigned char HardErrors ;
    klee_make_symbolic(&HardErrors, sizeof(char), "HardErrors");
   unsigned char MiscellaneousErrors ;
    klee_make_symbolic(&MiscellaneousErrors, sizeof(char), "MiscellaneousErrors");
   unsigned char CommandTimeouts ;
    klee_make_symbolic(&CommandTimeouts, sizeof(char), "CommandTimeouts");
   unsigned char Retries ;
    klee_make_symbolic(&Retries, sizeof(char), "Retries");
   unsigned char Aborts ;
    klee_make_symbolic(&Aborts, sizeof(char), "Aborts");
   unsigned char PredictedFailuresDetected ;
    klee_make_symbolic(&PredictedFailuresDetected, sizeof(char), "PredictedFailuresDetected");
   unsigned int  ;
   unsigned short  ;
   unsigned short DeviceBlockSizeInBytes ;
   unsigned int OriginalDeviceSize ;
...
struct DAC960_V2_HealthStatusBuffer {
   unsigned int MicrosecondsFromControllerStartTime ;
    klee_make_symbolic(&MicrosecondsFromControllerStartTime, sizeof(int), "MicrosecondsFromControllerStartTime");
   unsigned int MillisecondsFromControllerStartTime ;
    klee_make_symbolic(&MillisecondsFromControllerStartTime, sizeof(int), "MillisecondsFromControllerStartTime");
   unsigned int SecondsFrom1January1970 ;
    klee_make_symbolic(&SecondsFrom1January1970, sizeof(int), "SecondsFrom1January1970");
   unsigned int  ;
   unsigned int StatusChangeCounter ;
    klee_make_symbolic(&StatusChangeCounter, sizeof(int), "StatusChangeCounter");
   unsigned int  ;
   unsigned int DebugOutputMessageBufferIndex ;
    klee_make_symbolic(&DebugOutputMessageBufferIndex, sizeof(int), "DebugOutputMessageBufferIndex");
   unsigned int CodedMessageBufferIndex ;
    klee_make_symbolic(&CodedMessageBufferIndex, sizeof(int), "CodedMessageBufferIndex");
   unsigned int CurrentTimeTracePageNumber ;
    klee_make_symbolic(&CurrentTimeTracePageNumber, sizeof(int), "CurrentTimeTracePageNumber");
   unsigned int CurrentProfilerPageNumber ;
    klee_make_symbolic(&CurrentProfilerPageNumber, sizeof(int), "CurrentProfilerPageNumber");
   unsigned int NextEventSequenceNumber ;
    klee_make_symbolic(&NextEventSequenceNumber, sizeof(int), "NextEventSequenceNumber");
   unsigned int  ;
   unsigned char Reserved1[16U] ;
   unsigned char Reserved2[64U] ;
};
...
struct DAC960_V2_Event {
   unsigned int EventSequenceNumber ;
    klee_make_symbolic(&EventSequenceNumber, sizeof(int), "EventSequenceNumber");
   unsigned int EventTime ;
    klee_make_symbolic(&EventTime, sizeof(int), "EventTime");
   unsigned int EventCode ;
    klee_make_symbolic(&EventCode, sizeof(int), "EventCode");
   unsigned char  ;
   unsigned char Channel ;
   unsigned char TargetID ;
   unsigned char LogicalUnit ;
   ...
   unsigned int EventSpecificParameter ;
    klee_make_symbolic(&EventSpecificParameter, sizeof(int), "EventSpecificParameter");
...
struct DAC960_V2_PhysicalToLogicalDevice {
   ...
   unsigned char PreviousBootController ;
    klee_make_symbolic(&PreviousBootController, sizeof(char), "PreviousBootController");
   unsigned char PreviousBootChannel ;
    klee_make_symbolic(&PreviousBootChannel, sizeof(char), "PreviousBootChannel");
   unsigned char PreviousBootTargetID ;
    klee_make_symbolic(&PreviousBootTargetID, sizeof(char), "PreviousBootTargetID");
   unsigned char PreviousBootLogicalUnit ;
    klee_make_symbolic(&PreviousBootLogicalUnit, sizeof(char), "PreviousBootLogicalUnit");
};
...
struct __anonstruct_ExtendedScatterGather_285 {
   unsigned short ScatterGatherList0Length ;
    klee_make_symbolic(&ScatterGatherList0Length, sizeof(short), "ScatterGatherList0Length");
   unsigned short ScatterGatherList1Length ;
    klee_make_symbolic(&ScatterGatherList1Length, sizeof(short), "ScatterGatherList1Length");
   unsigned short ScatterGatherList2Length ;
    klee_make_symbolic(&ScatterGatherList2Length, sizeof(short), "ScatterGatherList2Length");
   unsigned short  ;
...
struct __anonstruct_Common_286 {
   ...
   unsigned char DataTransferPageNumber ;
    klee_make_symbolic(&DataTransferPageNumber, sizeof(char), "DataTransferPageNumber");
   DAC960_BusAddress64_T RequestSenseBusAddress ;
   unsigned int  ;
   DAC960_V2_CommandTimeout_T CommandTimeout ;
   unsigned char RequestSenseSize ;
    klee_make_symbolic(&RequestSenseSize, sizeof(char), "RequestSenseSize");
   unsigned char IOCTL_Opcode ;
    klee_make_symbolic(&IOCTL_Opcode, sizeof(char), "IOCTL_Opcode");
...
struct __anonstruct_SCSI_10_287 {
   ...
   unsigned char CDBLength ;
    klee_make_symbolic(&CDBLength, sizeof(char), "CDBLength");
...
struct __anonstruct_ControllerInfo_289 {
   ...
   unsigned char ControllerNumber ;
    klee_make_symbolic(&ControllerNumber, sizeof(char), "ControllerNumber");
   DAC960_V2_CommandTimeout_T CommandTimeout ;
   unsigned char RequestSenseSize ;
   unsigned char IOCTL_Opcode ;
   unsigned char Reserved[10U] ;
...
struct __anonstruct_GetEvent_292 {
   ...
   unsigned short EventSequenceNumberHigh16 ;
    klee_make_symbolic(&EventSequenceNumberHigh16, sizeof(short), "EventSequenceNumberHigh16");
   unsigned char ControllerNumber ;
   DAC960_V2_CommandTimeout_T CommandTimeout ;
   unsigned char RequestSenseSize ;
   unsigned char IOCTL_Opcode ;
   unsigned short EventSequenceNumberLow16 ;
    klee_make_symbolic(&EventSequenceNumberLow16, sizeof(short), "EventSequenceNumberLow16");
...
struct __anonstruct_SetMemoryMailbox_296 {
   ...
   unsigned char FirstCommandMailboxSizeKB ;
    klee_make_symbolic(&FirstCommandMailboxSizeKB, sizeof(char), "FirstCommandMailboxSizeKB");
   unsigned char FirstStatusMailboxSizeKB ;
    klee_make_symbolic(&FirstStatusMailboxSizeKB, sizeof(char), "FirstStatusMailboxSizeKB");
   unsigned char SecondCommandMailboxSizeKB ;
    klee_make_symbolic(&SecondCommandMailboxSizeKB, sizeof(char), "SecondCommandMailboxSizeKB");
   unsigned char SecondStatusMailboxSizeKB ;
    klee_make_symbolic(&SecondStatusMailboxSizeKB, sizeof(char), "SecondStatusMailboxSizeKB");
   DAC960_BusAddress64_T RequestSenseBusAddress ;
   unsigned int  ;
   DAC960_V2_CommandTimeout_T CommandTimeout ;
   unsigned char RequestSenseSize ;
   ...
   unsigned char HealthStatusBufferSizeKB ;
    klee_make_symbolic(&HealthStatusBufferSizeKB, sizeof(char), "HealthStatusBufferSizeKB");
   unsigned char  ;
...
struct DAC960_ControllerInfo {
   ...
   unsigned char Channels ;
    klee_make_symbolic(&Channels, sizeof(char), "Channels");
   unsigned char Targets ;
    klee_make_symbolic(&Targets, sizeof(char), "Targets");
   unsigned char PCI_Bus ;
    klee_make_symbolic(&PCI_Bus, sizeof(char), "PCI_Bus");
   unsigned char PCI_Device ;
    klee_make_symbolic(&PCI_Device, sizeof(char), "PCI_Device");
   unsigned char PCI_Function ;
    klee_make_symbolic(&PCI_Function, sizeof(char), "PCI_Function");
   unsigned char IRQ_Channel ;
    klee_make_symbolic(&IRQ_Channel, sizeof(char), "IRQ_Channel");
...
struct DAC960_V1_UserCommand {
   ...
   int DataTransferLength ;
    klee_make_symbolic(&DataTransferLength, sizeof(int), "DataTransferLength");
...
struct DAC960_V2_UserCommand {
   ...
   int RequestSenseLength ;
    klee_make_symbolic(&RequestSenseLength, sizeof(int), "RequestSenseLength");
   void *DataTransferBuffer ;
...
struct DAC960_privdata {
   ...
   unsigned int MemoryWindowSize ;
    klee_make_symbolic(&MemoryWindowSize, sizeof(int), "MemoryWindowSize");
};
...
union DAC960_V1_StatusMailbox {
   unsigned int Word ;
    klee_make_symbolic(&Word, sizeof(int), "Word");
...
struct __anonstruct_Fields_299 {
   ...
   int DataTransferResidue ;
    klee_make_symbolic(&DataTransferResidue, sizeof(int), "DataTransferResidue");
};
...
struct DAC960_Command {
   int CommandIdentifier ;
    klee_make_symbolic(&CommandIdentifier, sizeof(int), "CommandIdentifier");
   ...
   unsigned int BlockNumber ;
    klee_make_symbolic(&BlockNumber, sizeof(int), "BlockNumber");
   unsigned int BlockCount ;
    klee_make_symbolic(&BlockCount, sizeof(int), "BlockCount");
   unsigned int SegmentCount ;
    klee_make_symbolic(&SegmentCount, sizeof(int), "SegmentCount");
   int DmaDirection ;
    klee_make_symbolic(&DmaDirection, sizeof(int), "DmaDirection");
...
struct __anonstruct_V1_304 {
   unsigned char GeometryTranslationHeads ;
    klee_make_symbolic(&GeometryTranslationHeads, sizeof(char), "GeometryTranslationHeads");
   unsigned char GeometryTranslationSectors ;
    klee_make_symbolic(&GeometryTranslationSectors, sizeof(char), "GeometryTranslationSectors");
   unsigned char PendingRebuildFlag ;
    klee_make_symbolic(&PendingRebuildFlag, sizeof(char), "PendingRebuildFlag");
   unsigned short StripeSize ;
   unsigned short SegmentSize ;
    klee_make_symbolic(&SegmentSize, sizeof(short), "SegmentSize");
   unsigned short NewEventLogSequenceNumber ;
    klee_make_symbolic(&NewEventLogSequenceNumber, sizeof(short), "NewEventLogSequenceNumber");
   unsigned short OldEventLogSequenceNumber ;
    klee_make_symbolic(&OldEventLogSequenceNumber, sizeof(short), "OldEventLogSequenceNumber");
   unsigned short DeviceStateChannel ;
    klee_make_symbolic(&DeviceStateChannel, sizeof(short), "DeviceStateChannel");
   unsigned short DeviceStateTargetID ;
    klee_make_symbolic(&DeviceStateTargetID, sizeof(short), "DeviceStateTargetID");
...
struct __anonstruct_V2_305 {
   ...
   unsigned int PhysicalDeviceIndex ;
    klee_make_symbolic(&PhysicalDeviceIndex, sizeof(int), "PhysicalDeviceIndex");
...
struct DAC960_Controller {
   ...
   unsigned char FirmwareVersion[12U] ;
   unsigned char Bus ;
    klee_make_symbolic(&Bus, sizeof(char), "Bus");
   unsigned char Device ;
    klee_make_symbolic(&Device, sizeof(char), "Device");
   unsigned char Function ;
    klee_make_symbolic(&Function, sizeof(char), "Function");
   unsigned char IRQ_Channel ;
   unsigned char Channels ;
   unsigned char Targets ;
   unsigned char MemorySize ;
   unsigned char LogicalDriveCount ;
    klee_make_symbolic(&LogicalDriveCount, sizeof(char), "LogicalDriveCount");
   unsigned short CommandAllocationGroupSize ;
    klee_make_symbolic(&CommandAllocationGroupSize, sizeof(short), "CommandAllocationGroupSize");
   unsigned short ControllerQueueDepth ;
    klee_make_symbolic(&ControllerQueueDepth, sizeof(short), "ControllerQueueDepth");
   unsigned short DriverQueueDepth ;
    klee_make_symbolic(&DriverQueueDepth, sizeof(short), "DriverQueueDepth");
   unsigned short MaxBlocksPerCommand ;
   unsigned short ControllerScatterGatherLimit ;
    klee_make_symbolic(&ControllerScatterGatherLimit, sizeof(short), "ControllerScatterGatherLimit");
   unsigned short DriverScatterGatherLimit ;
    klee_make_symbolic(&DriverScatterGatherLimit, sizeof(short), "DriverScatterGatherLimit");
   u64 BounceBufferLimit ;
   unsigned int CombinedStatusBufferLength ;
    klee_make_symbolic(&CombinedStatusBufferLength, sizeof(int), "CombinedStatusBufferLength");
   unsigned int InitialStatusLength ;
    klee_make_symbolic(&InitialStatusLength, sizeof(int), "InitialStatusLength");
   unsigned int CurrentStatusLength ;
    klee_make_symbolic(&CurrentStatusLength, sizeof(int), "CurrentStatusLength");
   unsigned int ProgressBufferLength ;
    klee_make_symbolic(&ProgressBufferLength, sizeof(int), "ProgressBufferLength");
   unsigned int UserStatusLength ;
    klee_make_symbolic(&UserStatusLength, sizeof(int), "UserStatusLength");
   struct dma_loaf DmaPages ;
   unsigned long MonitoringTimerCount ;
    klee_make_symbolic(&MonitoringTimerCount, sizeof(long), "MonitoringTimerCount");
   unsigned long PrimaryMonitoringTime ;
    klee_make_symbolic(&PrimaryMonitoringTime, sizeof(long), "PrimaryMonitoringTime");
   unsigned long SecondaryMonitoringTime ;
    klee_make_symbolic(&SecondaryMonitoringTime, sizeof(long), "SecondaryMonitoringTime");
   unsigned long ShutdownMonitoringTimer ;
    klee_make_symbolic(&ShutdownMonitoringTimer, sizeof(long), "ShutdownMonitoringTimer");
   unsigned long LastProgressReportTime ;
    klee_make_symbolic(&LastProgressReportTime, sizeof(long), "LastProgressReportTime");
   unsigned long LastCurrentStatusTime ;
    klee_make_symbolic(&LastCurrentStatusTime, sizeof(long), "LastCurrentStatusTime");
   ...
   int req_q_index ;
    klee_make_symbolic(&req_q_index, sizeof(int), "req_q_index");
   spinlock_t queue_lock ;
...
static int DAC960_ControllerCount  ;
    klee_make_symbolic(&DAC960_ControllerCount, sizeof(int), "DAC960_ControllerCount");
...
{ 
  ...
  int drive_nr ;
    klee_make_symbolic(&drive_nr, sizeof(int), "drive_nr");
  int ret ;
  DAC960_V2_LogicalDeviceInfo_T *i ;
  sector_t tmp ;
...
{ 
  int CommandAllocationLength ;
    klee_make_symbolic(&CommandAllocationLength, sizeof(int), "CommandAllocationLength");
  int CommandAllocationGroupSize ;
  int CommandsRemaining ;
    klee_make_symbolic(&CommandsRemaining, sizeof(int), "CommandsRemaining");
  int CommandIdentifier ;
  int CommandGroupByteCount ;
    klee_make_symbolic(&CommandGroupByteCount, sizeof(int), "CommandGroupByteCount");
...
{ 
  ...
  DAC960_V1_CommandStatus_T CommandStatus ;
  int TimeoutCounter ;
    klee_make_symbolic(&TimeoutCounter, sizeof(int), "TimeoutCounter");
  int i ;
  bool tmp ;
  int tmp___0 ;
  bool tmp___1 ;
...
{ 
  ...
  unsigned short LogicalDeviceNumber ;
  int ModelNameLength ;
    klee_make_symbolic(&ModelNameLength, sizeof(int), "ModelNameLength");
  bool tmp ;
  bool tmp___0 ;
  int tmp___1 ;
  bool tmp___2 ;
...
{ 
  int SerialNumberLength ;
    klee_make_symbolic(&SerialNumberLength, sizeof(int), "SerialNumberLength");
  int i ;
  unsigned char VendorCharacter ;
    klee_make_symbolic(&VendorCharacter, sizeof(char), "VendorCharacter");
  unsigned char ModelCharacter ;
    klee_make_symbolic(&ModelCharacter, sizeof(char), "ModelCharacter");
  unsigned char RevisionCharacter ;
    klee_make_symbolic(&RevisionCharacter, sizeof(char), "RevisionCharacter");
  unsigned char SerialNumberCharacter ;
    klee_make_symbolic(&SerialNumberCharacter, sizeof(char), "SerialNumberCharacter");
...
{ 
  int MajorNumber ;
    klee_make_symbolic(&MajorNumber, sizeof(int), "MajorNumber");
  int n ;
...
{ 
  int MajorNumber ;
  int disk ;
    klee_make_symbolic(&disk, sizeof(int), "disk");
...
{ 
  ...
  unsigned char DeviceFunction ;
    klee_make_symbolic(&DeviceFunction, sizeof(char), "DeviceFunction");
  unsigned char ErrorStatus ;
    klee_make_symbolic(&ErrorStatus, sizeof(char), "ErrorStatus");
  unsigned char Parameter0 ;
    klee_make_symbolic(&Parameter0, sizeof(char), "Parameter0");
  unsigned char Parameter1 ;
    klee_make_symbolic(&Parameter1, sizeof(char), "Parameter1");
...
{ 
  int Controller_Number ;
    klee_make_symbolic(&Controller_Number, sizeof(int), "Controller_Number");
  void *tmp ;
  DAC960_Controller_T *Controller ;
...
{ 
  ...
  unsigned int OldCriticalLogicalDriveCount ;
    klee_make_symbolic(&OldCriticalLogicalDriveCount, sizeof(int), "OldCriticalLogicalDriveCount");
  unsigned int NewCriticalLogicalDriveCount ;
    klee_make_symbolic(&NewCriticalLogicalDriveCount, sizeof(int), "NewCriticalLogicalDriveCount");
  int LogicalDriveNumber ;
  int LogicalDriveNumber___0 ;
    klee_make_symbolic(&LogicalDriveNumber___0, sizeof(int), "LogicalDriveNumber___0");
  char *DAC960_EventMessages[13U] ;
  DAC960_V1_EventLogEntry_T *EventLogEntry ;
  unsigned char SenseKey ;
    klee_make_symbolic(&SenseKey, sizeof(char), "SenseKey");
  unsigned char AdditionalSenseCode ;
  unsigned char AdditionalSenseCodeQualifier ;
  ...
  int LogicalDriveNumber___1 ;
    klee_make_symbolic(&LogicalDriveNumber___1, sizeof(int), "LogicalDriveNumber___1");
  ...
  unsigned int LogicalDriveNumber___2 ;
    klee_make_symbolic(&LogicalDriveNumber___2, sizeof(int), "LogicalDriveNumber___2");
  unsigned int LogicalDriveSize ;
  unsigned int BlocksCompleted ;
  unsigned int LogicalDriveNumber___3 ;
    klee_make_symbolic(&LogicalDriveNumber___3, sizeof(int), "LogicalDriveNumber___3");
  unsigned int LogicalDriveSize___0 ;
    klee_make_symbolic(&LogicalDriveSize___0, sizeof(int), "LogicalDriveSize___0");
  unsigned int BlocksCompleted___0 ;
    klee_make_symbolic(&BlocksCompleted___0, sizeof(int), "BlocksCompleted___0");
  unsigned int LogicalDriveNumber___4 ;
    klee_make_symbolic(&LogicalDriveNumber___4, sizeof(int), "LogicalDriveNumber___4");
  unsigned int LogicalDriveSize___1 ;
    klee_make_symbolic(&LogicalDriveSize___1, sizeof(int), "LogicalDriveSize___1");
  unsigned int BlocksCompleted___1 ;
    klee_make_symbolic(&BlocksCompleted___1, sizeof(int), "BlocksCompleted___1");
  DAC960_SCSI_Inquiry_T *InquiryStandardData ;
  DAC960_SCSI_Inquiry_UnitSerialNumber_T *InquiryUnitSerialNumber ;
  DAC960_V1_DCDB_T *DCDB ;
  dma_addr_t DCDB_DMA ;
...
{ 
  ...
  int EventListIndex ;
    klee_make_symbolic(&EventListIndex, sizeof(int), "EventListIndex");
  int EventCode ;
  unsigned char EventType ;
    klee_make_symbolic(&EventType, sizeof(char), "EventType");
  unsigned char *EventMessage ;
...
{ 
  ...
  unsigned int DeviceIndex ;
    klee_make_symbolic(&DeviceIndex, sizeof(int), "DeviceIndex");
  void *tmp___3 ;
  void *tmp___4 ;
  unsigned int DeviceIndex___0 ;
    klee_make_symbolic(&DeviceIndex___0, sizeof(int), "DeviceIndex___0");
  ...
  void *tmp___5 ;
  unsigned long LogicalDeviceSize ;
    klee_make_symbolic(&LogicalDeviceSize, sizeof(long), "LogicalDeviceSize");
  int LogicalDriveNumber ;
...
{ 
  ...
  unsigned int NewStatusBufferLength ;
    klee_make_symbolic(&NewStatusBufferLength, sizeof(int), "NewStatusBufferLength");
  void *tmp ;
  void *tmp___0 ;
...
{ 
  ...
  int AnnouncementLines ;
    klee_make_symbolic(&AnnouncementLines, sizeof(int), "AnnouncementLines");
  bool tmp___0 ;
...
{ 
  ...
  unsigned long XChannel ;
    klee_make_symbolic(&XChannel, sizeof(long), "XChannel");
  unsigned long XTargetID ;
    klee_make_symbolic(&XTargetID, sizeof(long), "XTargetID");
...
{ 
  ...
  unsigned long XLogicalDriveNumber ;
    klee_make_symbolic(&XLogicalDriveNumber, sizeof(long), "XLogicalDriveNumber");
...
{ 
  ...
  int ProgressMessageLength ;
    klee_make_symbolic(&ProgressMessageLength, sizeof(int), "ProgressMessageLength");
  size_t tmp ;
  unsigned char *CurrentStatusBuffer ;
...
{ 
  long ErrorCode ;
    klee_make_symbolic(&ErrorCode, sizeof(long), "ErrorCode");
  bool tmp ;
  int tmp___0 ;
  ...
  int ControllerNumber___0 ;
    klee_make_symbolic(&ControllerNumber___0, sizeof(int), "ControllerNumber___0");
  int DataTransferLength ;
  ...
  long ret___0 ;
    klee_make_symbolic(&ret___0, sizeof(long), "ret___0");
  int __x___2 ;
    klee_make_symbolic(&__x___2, sizeof(int), "__x___2");
  ...
  int ControllerNumber___1 ;
    klee_make_symbolic(&ControllerNumber___1, sizeof(int), "ControllerNumber___1");
  int DataTransferLength___0 ;
    klee_make_symbolic(&DataTransferLength___0, sizeof(int), "DataTransferLength___0");
  int DataTransferResidue ;
  int RequestSenseLength ;
  ...
  long ret___1 ;
    klee_make_symbolic(&ret___1, sizeof(long), "ret___1");
  int __x___4 ;
    klee_make_symbolic(&__x___4, sizeof(int), "__x___4");
  DAC960_V2_GetHealthStatus_T *UserSpaceGetHealthStatus ;
  DAC960_V2_GetHealthStatus_T GetHealthStatus ;
  DAC960_V2_HealthStatusBuffer_T HealthStatusBuffer ;
  DAC960_Controller_T *Controller___2 ;
  int ControllerNumber___2 ;
    klee_make_symbolic(&ControllerNumber___2, sizeof(int), "ControllerNumber___2");
  ...
  long __ret___1 ;
    klee_make_symbolic(&__ret___1, sizeof(long), "__ret___1");
  long __int___0 ;
...
{ 
  ...
  int ldvarg27 ;
    klee_make_symbolic(&ldvarg27, sizeof(int), "ldvarg27");
  char *ldvarg31 ;
  void *tmp___12 ;
  loff_t *ldvarg29 ;
  void *tmp___13 ;
  ...
  unsigned int ldvarg33 ;
    klee_make_symbolic(&ldvarg33, sizeof(int), "ldvarg33");
  int ldvarg35 ;
  ...
  unsigned long ldvarg39 ;
    klee_make_symbolic(&ldvarg39, sizeof(long), "ldvarg39");
  int ldvarg41 ;
  ...
  int ldvarg43 ;
    klee_make_symbolic(&ldvarg43, sizeof(int), "ldvarg43");
  void *ldvarg44 ;
  void *tmp___17 ;
  int tmp___18 ;
  int tmp___19 ;
