...
struct snic {
   ...
   unsigned long stats_time ;
    klee_make_symbolic(&stats_time, sizeof(long), "stats_time");
   unsigned long stats_reset_time ;
    klee_make_symbolic(&stats_reset_time, sizeof(long), "stats_reset_time");
   struct vnic_dev *vdev ;
   ...
   unsigned int err_intr_offset ;
    klee_make_symbolic(&err_intr_offset, sizeof(int), "err_intr_offset");
   int link_status ;
   ...
   unsigned int max_tag_id ;
    klee_make_symbolic(&max_tag_id, sizeof(int), "max_tag_id");
   ...
   unsigned int reset_stats ;
    klee_make_symbolic(&reset_stats, sizeof(int), "reset_stats");
   atomic64_t io_cmpl_skip ;
...
struct snic_req_info {
   ...
   struct snic *snic ;
   ulong sge_va ;
    klee_make_symbolic(&sge_va, sizeof(long), "sge_va");
   u64 snsbuf_va ;
...
struct snic_io_hdr {
   ...
   __le32 cmnd_id ;
   ulong init_ctx ;
    klee_make_symbolic(&init_ctx, sizeof(long), "init_ctx");
   u8 type ;
   u8 status ;
   u8 protocol ;
   u8 flags ;
...
unsigned int snic_trace_max_pages ;
    klee_make_symbolic(&snic_trace_max_pages, sizeof(int), "snic_trace_max_pages");
...
unsigned int snic_max_qdepth ;
    klee_make_symbolic(&snic_max_qdepth, sizeof(int), "snic_max_qdepth");
unsigned int snic_log_level ;
    klee_make_symbolic(&snic_log_level, sizeof(int), "snic_log_level");
...
{ 
  int qsz ;
    klee_make_symbolic(&qsz, sizeof(int), "qsz");
  u32 __min1 ;
  u32 __min2 ;
...
{ 
  ...
  int ret ;
  int nretries ;
    klee_make_symbolic(&nretries, sizeof(int), "nretries");
  int tmp___0 ;
...
{ 
  ...
  unsigned int intr_offset ;
    klee_make_symbolic(&intr_offset, sizeof(int), "intr_offset");
  unsigned int err_intr_enable ;
    klee_make_symbolic(&err_intr_enable, sizeof(int), "err_intr_enable");
  unsigned int err_intr_offset ;
  unsigned int i ;
  int ret ;
  bool __warned ;
...
{ 
  ...
  unsigned long wq_work_done ;
    klee_make_symbolic(&wq_work_done, sizeof(long), "wq_work_done");
  int tmp ;
...
{ 
  ...
  unsigned long iocmpl_work_done ;
    klee_make_symbolic(&iocmpl_work_done, sizeof(long), "iocmpl_work_done");
  int tmp ;
...
{ 
  ...
  u32 max_sgs ;
  ulong ctx ;
    klee_make_symbolic(&ctx, sizeof(long), "ctx");
  unsigned long flags ;
  int ret ;
  bool __warned ;
  int __ret_warn_once ;
...
{ 
  ...
  long act_reqs ;
    klee_make_symbolic(&act_reqs, sizeof(long), "act_reqs");
  int q_num ;
...
{ 
  ...
  long act_ios ;
    klee_make_symbolic(&act_ios, sizeof(long), "act_ios");
  long act_fwreqs ;
    klee_make_symbolic(&act_fwreqs, sizeof(long), "act_fwreqs");
  long tmp ;
...
{ 
  unsigned int num_ent ;
    klee_make_symbolic(&num_ent, sizeof(int), "num_ent");
  unsigned int cq_idx ;
    klee_make_symbolic(&cq_idx, sizeof(int), "cq_idx");
  unsigned int nent_per_cq ;
    klee_make_symbolic(&nent_per_cq, sizeof(int), "nent_per_cq");
...
{ 
  ...
  struct scsi_lun lun ;
  int tm_tag ;
    klee_make_symbolic(&tm_tag, sizeof(int), "tm_tag");
  int ret ;
  bool __warned ;
  int __ret_warn_once ;
  int __ret_warn_on ;
...
{ 
  ...
  int req_id ;
    klee_make_symbolic(&req_id, sizeof(int), "req_id");
  int tag ;
  int ret ;
  int tmp ;
  long tmp___0 ;
...
{ 
  ...
  int ret ;
  int tmf ;
    klee_make_symbolic(&tmf, sizeof(int), "tmf");
  int tag ;
  struct device  const  *__mptr ;
  struct scsi_target *tmp___1 ;
  struct scsi_target *tmp___2 ;
...
{ 
  ...
  unsigned long flags ;
  int lr_res ;
    klee_make_symbolic(&lr_res, sizeof(int), "lr_res");
  int ret ;
  raw_spinlock_t *tmp ;
  void *tmp___0 ;
  void *tmp___1 ;
...
{ 
  ...
  int ret ;
  int dr_supp ;
    klee_make_symbolic(&dr_supp, sizeof(int), "dr_supp");
  long tmp___0 ;
  int tmp___1 ;
  long tmp___2 ;
  void *tmp___3 ;
...
{ 
  ...
  int tag ;
  int abt_cnt ;
    klee_make_symbolic(&abt_cnt, sizeof(int), "abt_cnt");
  int tmf ;
  struct Scsi_Host *tmp ;
  void *tmp___0 ;
  long tmp___1 ;
...
{ 
  ...
  unsigned int fetch_idx ;
    klee_make_symbolic(&fetch_idx, sizeof(int), "fetch_idx");
  int ret ;
  void *p ;
  void *tmp ;
...
{ 
  ...
  void *tbuf ;
  int tbuf_sz ;
    klee_make_symbolic(&tbuf_sz, sizeof(int), "tbuf_sz");
  int ret ;
  struct lock_class_key __key ;
  u32 tmp ;
