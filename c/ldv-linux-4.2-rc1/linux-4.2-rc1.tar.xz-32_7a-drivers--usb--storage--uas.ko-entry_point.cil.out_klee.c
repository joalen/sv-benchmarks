...
struct uas_dev_info {
   ...
   unsigned int status_pipe ;
    klee_make_symbolic(&status_pipe, sizeof(int), "status_pipe");
   unsigned int data_in_pipe ;
    klee_make_symbolic(&data_in_pipe, sizeof(int), "data_in_pipe");
   unsigned int data_out_pipe ;
    klee_make_symbolic(&data_out_pipe, sizeof(int), "data_out_pipe");
...
struct uas_cmd_info {
   ...
   unsigned int uas_tag ;
    klee_make_symbolic(&uas_tag, sizeof(int), "uas_tag");
   struct urb *cmd_urb ;
...
#include "model/linux-4.2-rc1.tar.xz-32_7a-drivers--usb--storage--uas.ko-entry_point_true-unreach-call.cil.out.env.c"
#include <klee/klee.h>
