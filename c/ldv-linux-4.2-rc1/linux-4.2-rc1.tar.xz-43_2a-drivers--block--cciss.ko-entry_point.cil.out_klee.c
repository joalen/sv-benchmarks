...
static int cciss_allow_hpsa  ;
    klee_make_symbolic(&cciss_allow_hpsa, sizeof(int), "cciss_allow_hpsa");
...
{ 
  ...
  unsigned long ldvarg42 ;
    klee_make_symbolic(&ldvarg42, sizeof(long), "ldvarg42");
  ...
  unsigned long ldvarg63 ;
    klee_make_symbolic(&ldvarg63, sizeof(long), "ldvarg63");
