...
union __anonunion_byte6_offset_267 {
   unsigned short block_count ;
    klee_make_symbolic(&block_count, sizeof(short), "block_count");
   unsigned short parameter_count ;
    klee_make_symbolic(&parameter_count, sizeof(short), "parameter_count");
};
...
struct TW_Command {
   unsigned char opcode__sgloffset ;
    klee_make_symbolic(&opcode__sgloffset, sizeof(char), "opcode__sgloffset");
   unsigned char size ;
   unsigned char request_id ;
    klee_make_symbolic(&request_id, sizeof(char), "request_id");
   unsigned char unit__hostid ;
    klee_make_symbolic(&unit__hostid, sizeof(char), "unit__hostid");
...
struct TAG_TW_Command_Apache {
   unsigned char opcode__reserved ;
    klee_make_symbolic(&opcode__reserved, sizeof(char), "opcode__reserved");
   unsigned char unit ;
    klee_make_symbolic(&unit, sizeof(char), "unit");
   unsigned short request_id__lunl ;
    klee_make_symbolic(&request_id__lunl, sizeof(short), "request_id__lunl");
   unsigned char status ;
   unsigned char sgl_offset ;
    klee_make_symbolic(&sgl_offset, sizeof(char), "sgl_offset");
   unsigned short sgl_entries__lunh ;
    klee_make_symbolic(&sgl_entries__lunh, sizeof(short), "sgl_entries__lunh");
...
struct __anonstruct_status_block_271 {
   ...
   unsigned char padding ;
    klee_make_symbolic(&padding, sizeof(char), "padding");
   unsigned char severity__reserved ;
    klee_make_symbolic(&severity__reserved, sizeof(char), "severity__reserved");
};
struct __anonstruct_header_desc_272 {
   unsigned char size_header ;
    klee_make_symbolic(&size_header, sizeof(char), "size_header");
   unsigned short reserved ;
    klee_make_symbolic(&reserved, sizeof(short), "reserved");
   unsigned char size_sense ;
    klee_make_symbolic(&size_sense, sizeof(char), "size_sense");
};
...
struct TAG_TW_Initconnect {
   ...
   unsigned short message_credits ;
    klee_make_symbolic(&message_credits, sizeof(short), "message_credits");
   u32 features ;
   unsigned short fw_srl ;
    klee_make_symbolic(&fw_srl, sizeof(short), "fw_srl");
   unsigned short fw_arch_id ;
    klee_make_symbolic(&fw_arch_id, sizeof(short), "fw_arch_id");
   unsigned short fw_branch ;
    klee_make_symbolic(&fw_branch, sizeof(short), "fw_branch");
   unsigned short fw_build ;
    klee_make_symbolic(&fw_build, sizeof(short), "fw_build");
   u32 result ;
};
typedef struct TAG_TW_Initconnect TW_Initconnect;
struct TAG_TW_Event {
   unsigned int sequence_id ;
    klee_make_symbolic(&sequence_id, sizeof(int), "sequence_id");
   unsigned int time_stamp_sec ;
    klee_make_symbolic(&time_stamp_sec, sizeof(int), "time_stamp_sec");
   unsigned short aen_code ;
    klee_make_symbolic(&aen_code, sizeof(short), "aen_code");
   unsigned char severity ;
    klee_make_symbolic(&severity, sizeof(char), "severity");
   unsigned char retrieved ;
    klee_make_symbolic(&retrieved, sizeof(char), "retrieved");
   unsigned char repeat_count ;
    klee_make_symbolic(&repeat_count, sizeof(char), "repeat_count");
   unsigned char parameter_len ;
    klee_make_symbolic(&parameter_len, sizeof(char), "parameter_len");
   unsigned char parameter_data[98U] ;
};
typedef struct TAG_TW_Event TW_Event;
struct TAG_TW_Ioctl_Driver_Command {
   unsigned int control_code ;
    klee_make_symbolic(&control_code, sizeof(int), "control_code");
   unsigned int status ;
   unsigned int unique_id ;
   unsigned int sequence_id ;
   unsigned int os_specific ;
    klee_make_symbolic(&os_specific, sizeof(int), "os_specific");
...
struct TAG_TW_Lock {
   unsigned long timeout_msec ;
    klee_make_symbolic(&timeout_msec, sizeof(long), "timeout_msec");
   unsigned long time_remaining_msec ;
    klee_make_symbolic(&time_remaining_msec, sizeof(long), "time_remaining_msec");
   unsigned long force_flag ;
    klee_make_symbolic(&force_flag, sizeof(long), "force_flag");
};
typedef struct TAG_TW_Lock TW_Lock;
struct __anonstruct_TW_Param_Apache_274 {
   unsigned short table_id ;
    klee_make_symbolic(&table_id, sizeof(short), "table_id");
   unsigned short parameter_id ;
    klee_make_symbolic(&parameter_id, sizeof(short), "parameter_id");
   unsigned short parameter_size_bytes ;
    klee_make_symbolic(&parameter_size_bytes, sizeof(short), "parameter_size_bytes");
   unsigned short actual_parameter_size_bytes ;
    klee_make_symbolic(&actual_parameter_size_bytes, sizeof(short), "actual_parameter_size_bytes");
...
struct TAG_TW_Compatibility_Info {
   ...
   unsigned short working_srl ;
    klee_make_symbolic(&working_srl, sizeof(short), "working_srl");
   unsigned short working_branch ;
    klee_make_symbolic(&working_branch, sizeof(short), "working_branch");
   unsigned short working_build ;
    klee_make_symbolic(&working_build, sizeof(short), "working_build");
   unsigned short driver_srl_high ;
    klee_make_symbolic(&driver_srl_high, sizeof(short), "driver_srl_high");
   unsigned short driver_branch_high ;
    klee_make_symbolic(&driver_branch_high, sizeof(short), "driver_branch_high");
   unsigned short driver_build_high ;
    klee_make_symbolic(&driver_build_high, sizeof(short), "driver_build_high");
   unsigned short driver_srl_low ;
    klee_make_symbolic(&driver_srl_low, sizeof(short), "driver_srl_low");
   unsigned short driver_branch_low ;
    klee_make_symbolic(&driver_branch_low, sizeof(short), "driver_branch_low");
   unsigned short driver_build_low ;
    klee_make_symbolic(&driver_build_low, sizeof(short), "driver_build_low");
   unsigned short fw_on_ctlr_srl ;
    klee_make_symbolic(&fw_on_ctlr_srl, sizeof(short), "fw_on_ctlr_srl");
   unsigned short fw_on_ctlr_branch ;
    klee_make_symbolic(&fw_on_ctlr_branch, sizeof(short), "fw_on_ctlr_branch");
   unsigned short fw_on_ctlr_build ;
    klee_make_symbolic(&fw_on_ctlr_build, sizeof(short), "fw_on_ctlr_build");
};
...
struct TAG_TW_Device_Extension {
   ...
   unsigned char free_head ;
    klee_make_symbolic(&free_head, sizeof(char), "free_head");
   unsigned char free_tail ;
    klee_make_symbolic(&free_tail, sizeof(char), "free_tail");
   unsigned char pending_queue[256U] ;
   unsigned char pending_head ;
    klee_make_symbolic(&pending_head, sizeof(char), "pending_head");
   unsigned char pending_tail ;
    klee_make_symbolic(&pending_tail, sizeof(char), "pending_tail");
   int state[256U] ;
   unsigned int posted_request_count ;
    klee_make_symbolic(&posted_request_count, sizeof(int), "posted_request_count");
   unsigned int max_posted_request_count ;
    klee_make_symbolic(&max_posted_request_count, sizeof(int), "max_posted_request_count");
   unsigned int pending_request_count ;
    klee_make_symbolic(&pending_request_count, sizeof(int), "pending_request_count");
   unsigned int max_pending_request_count ;
    klee_make_symbolic(&max_pending_request_count, sizeof(int), "max_pending_request_count");
   unsigned int max_sgl_entries ;
    klee_make_symbolic(&max_sgl_entries, sizeof(int), "max_sgl_entries");
   unsigned int sgl_entries ;
    klee_make_symbolic(&sgl_entries, sizeof(int), "sgl_entries");
   unsigned int num_resets ;
    klee_make_symbolic(&num_resets, sizeof(int), "num_resets");
   unsigned int sector_count ;
    klee_make_symbolic(&sector_count, sizeof(int), "sector_count");
   unsigned int max_sector_count ;
    klee_make_symbolic(&max_sector_count, sizeof(int), "max_sector_count");
   unsigned int aen_count ;
    klee_make_symbolic(&aen_count, sizeof(int), "aen_count");
   struct Scsi_Host *host ;
   long flags ;
   int reset_print ;
    klee_make_symbolic(&reset_print, sizeof(int), "reset_print");
   TW_Event *event_queue[256U] ;
   unsigned char error_index ;
    klee_make_symbolic(&error_index, sizeof(char), "error_index");
   unsigned char event_queue_wrapped ;
    klee_make_symbolic(&event_queue_wrapped, sizeof(char), "event_queue_wrapped");
   unsigned int error_sequence_id ;
    klee_make_symbolic(&error_sequence_id, sizeof(int), "error_sequence_id");
   int ioctl_sem_lock ;
    klee_make_symbolic(&ioctl_sem_lock, sizeof(int), "ioctl_sem_lock");
   u32 ioctl_msec ;
   int chrdev_request_id ;
    klee_make_symbolic(&chrdev_request_id, sizeof(int), "chrdev_request_id");
   wait_queue_head_t ioctl_wqueue ;
   struct mutex ioctl_lock ;
   char aen_clobber ;
    klee_make_symbolic(&aen_clobber, sizeof(char), "aen_clobber");
...
static unsigned int twa_device_extension_count  ;
    klee_make_symbolic(&twa_device_extension_count, sizeof(int), "twa_device_extension_count");
...
{ 
  ...
  TW_Command_Apache_Header *header ;
  unsigned short aen ;
    klee_make_symbolic(&aen, sizeof(short), "aen");
  int retval ;
...
{ 
  ...
  unsigned short aen ;
  int first_reset ;
    klee_make_symbolic(&first_reset, sizeof(int), "first_reset");
  int queue ;
...
{ 
  ...
  unsigned short fw_on_ctlr_arch_id ;
    klee_make_symbolic(&fw_on_ctlr_arch_id, sizeof(short), "fw_on_ctlr_arch_id");
  unsigned short fw_on_ctlr_branch ;
  unsigned short fw_on_ctlr_build ;
  u32 init_connect_result ;
  int tmp ;
...
{ 
  ...
  unsigned long data_buffer_length_adjusted ;
    klee_make_symbolic(&data_buffer_length_adjusted, sizeof(long), "data_buffer_length_adjusted");
  unsigned long flags ;
  dma_addr_t dma_handle ;
  int request_id ;
  unsigned int sequence_id ;
  unsigned char event_index ;
    klee_make_symbolic(&event_index, sizeof(char), "event_index");
  unsigned char start_index ;
    klee_make_symbolic(&start_index, sizeof(char), "start_index");
  TW_Ioctl_Driver_Command driver_command ;
...
{ 
  ...
  unsigned long before ;
    klee_make_symbolic(&before, sizeof(long), "before");
  int retval ;
...
{ 
  ...
  TW_SG_Entry *sgl ;
  unsigned int pae ;
    klee_make_symbolic(&pae, sizeof(int), "pae");
...
{ 
  ...
  int response_request_id ;
    klee_make_symbolic(&response_request_id, sizeof(int), "response_request_id");
...
{ 
  ...
  int retval ;
  int flashed ;
    klee_make_symbolic(&flashed, sizeof(int), "flashed");
  int do_soft_reset ;
    klee_make_symbolic(&do_soft_reset, sizeof(int), "do_soft_reset");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
  int tmp___2 ;
