...
struct dm_cell_key {
   int virtual ;
    klee_make_symbolic(&virtual, sizeof(int), "virtual");
   dm_thin_id dev ;
...
struct io_tracker {
   ...
   unsigned long idle_time ;
    klee_make_symbolic(&idle_time, sizeof(long), "idle_time");
   unsigned long last_update_time ;
    klee_make_symbolic(&last_update_time, sizeof(long), "last_update_time");
};
struct dm_hook_info {
   bio_end_io_t *bi_end_io ;
   void *bi_private ;
...
struct cache {
   ...
   int sectors_per_block_shift ;
    klee_make_symbolic(&sectors_per_block_shift, sizeof(int), "sectors_per_block_shift");
   spinlock_t lock ;
   ...
   unsigned int nr_ctr_args ;
    klee_make_symbolic(&nr_ctr_args, sizeof(int), "nr_ctr_args");
   char const   **ctr_args ;
   ...
   unsigned long last_commit_jiffies ;
    klee_make_symbolic(&last_commit_jiffies, sizeof(long), "last_commit_jiffies");
   struct dm_bio_prison *prison ;
   struct dm_deferred_set *all_io_ds ;
   mempool_t *migration_pool ;
   struct dm_cache_policy *policy ;
   unsigned int policy_nr_args ;
    klee_make_symbolic(&policy_nr_args, sizeof(int), "policy_nr_args");
   bool need_tick_bio ;
   bool sized ;
   bool invalidate ;
...
struct dm_cache_migration {
   ...
   unsigned long start_jiffies ;
    klee_make_symbolic(&start_jiffies, sizeof(long), "start_jiffies");
   dm_oblock_t old_oblock ;
...
struct cache_args {
   ...
   int policy_argc ;
    klee_make_symbolic(&policy_argc, sizeof(int), "policy_argc");
...
{ 
  unsigned long block_size___0 ;
    klee_make_symbolic(&block_size___0, sizeof(long), "block_size___0");
  bool tmp ;
  int tmp___0 ;
  char const   *tmp___1 ;
  int tmp___2 ;
...
{ 
  int r1 ;
    klee_make_symbolic(&r1, sizeof(int), "r1");
  int r2 ;
    klee_make_symbolic(&r2, sizeof(int), "r2");
  int r3 ;
    klee_make_symbolic(&r3, sizeof(int), "r3");
  int r4 ;
    klee_make_symbolic(&r4, sizeof(int), "r4");
  char const   *tmp ;
  char const   *tmp___0 ;
  char const   *tmp___1 ;
  char const   *tmp___2 ;
...
{ 
  ...
  unsigned int sb_block_size ;
    klee_make_symbolic(&sb_block_size, sizeof(int), "sb_block_size");
  unsigned int tmp ;
  void *tmp___0 ;
  int tmp___1 ;
...
{ 
  ...
  unsigned long sb_flags ;
    klee_make_symbolic(&sb_flags, sizeof(long), "sb_flags");
  void *tmp ;
  int tmp___0 ;
  int tmp___1 ;
