...
typedef unsigned int upstat_t;
    klee_make_symbolic(&upstat_t, sizeof(int), "upstat_t");
struct uart_state;
struct console;
struct uart_port {
   spinlock_t lock ;
...
int jsm_debug  ;
    klee_make_symbolic(&jsm_debug, sizeof(int), "jsm_debug");
...
{ 
  struct jsm_channel *ch ;
  int linestatus ;
    klee_make_symbolic(&linestatus, sizeof(int), "linestatus");
  unsigned long lock_flags ;
  unsigned char tmp ;
  struct _ddebug descriptor ;
  long tmp___0 ;
...
{ 
  ...
  unsigned long lock_flags2 ;
    klee_make_symbolic(&lock_flags2, sizeof(long), "lock_flags2");
  int outofloop_count ;
    klee_make_symbolic(&outofloop_count, sizeof(int), "outofloop_count");
  struct _ddebug descriptor ;
  long tmp___0 ;
  struct _ddebug descriptor___0 ;
  long tmp___1 ;
...
{ 
  unsigned char ldvarg6 ;
    klee_make_symbolic(&ldvarg6, sizeof(char), "ldvarg6");
  void *ldvarg5 ;
  void *tmp ;
  int ldvarg4 ;
...
{ 
  unsigned char mstat ;
    klee_make_symbolic(&mstat, sizeof(char), "mstat");
  unsigned int result ;
...
{ 
  ...
  char ldvarg12 ;
    klee_make_symbolic(&ldvarg12, sizeof(char), "ldvarg12");
...
{ 
  ...
  unsigned char uart_poll ;
    klee_make_symbolic(&uart_poll, sizeof(char), "uart_poll");
  uint i ;
  struct _ddebug descriptor ;
  long tmp ;
  struct _ddebug descriptor___0 ;
