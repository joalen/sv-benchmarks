...
{ 
  ...
  unsigned long pscr_ret__ ;
    klee_make_symbolic(&pscr_ret__, sizeof(long), "pscr_ret__");
  void const   *__vpp_verify ;
  unsigned long pfo_ret__ ;
    klee_make_symbolic(&pfo_ret__, sizeof(long), "pfo_ret__");
  unsigned long pfo_ret_____0 ;
    klee_make_symbolic(&pfo_ret_____0, sizeof(long), "pfo_ret_____0");
  unsigned long pfo_ret_____1 ;
    klee_make_symbolic(&pfo_ret_____1, sizeof(long), "pfo_ret_____1");
  unsigned long pfo_ret_____2 ;
    klee_make_symbolic(&pfo_ret_____2, sizeof(long), "pfo_ret_____2");
