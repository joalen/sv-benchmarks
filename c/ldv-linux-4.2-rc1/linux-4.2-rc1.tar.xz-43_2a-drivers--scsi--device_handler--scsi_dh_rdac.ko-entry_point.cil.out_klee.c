...
struct rdac_controller {
   u8 array_id[16U] ;
   int use_ms10 ;
    klee_make_symbolic(&use_ms10, sizeof(int), "use_ms10");
   struct kref kref ;
   struct list_head node ;
   ...
   spinlock_t ms_lock ;
   int ms_queued ;
    klee_make_symbolic(&ms_queued, sizeof(int), "ms_queued");
...
struct rdac_dh_data {
   ...
   unsigned char state ;
   char lun_state ;
    klee_make_symbolic(&lun_state, sizeof(char), "lun_state");
   char preferred ;
    klee_make_symbolic(&preferred, sizeof(char), "preferred");
