...
{ 
  unsigned long the_time ;
    klee_make_symbolic(&the_time, sizeof(long), "the_time");
...
{ 
  ...
  long xcnt ;
    klee_make_symbolic(&xcnt, sizeof(long), "xcnt");
  unsigned int tmp ;
  unsigned char tmp___0 ;
...
{ 
  char default_period ;
    klee_make_symbolic(&default_period, sizeof(char), "default_period");
...
{ 
  ...
  long total_len ;
    klee_make_symbolic(&total_len, sizeof(long), "total_len");
  dma_addr_t dma_addr ;
  long tmp ;
...
{ 
  ...
  struct scsi_ctrl_blk *prev ;
  int num_scb ;
    klee_make_symbolic(&num_scb, sizeof(int), "num_scb");
  int i ;
  int error ;
