...
struct rio_mport {
   ...
   int host_deviceid ;
    klee_make_symbolic(&host_deviceid, sizeof(int), "host_deviceid");
   struct rio_ops *ops ;
   unsigned char id ;
   unsigned char index ;
   unsigned int sys_size ;
    klee_make_symbolic(&sys_size, sizeof(int), "sys_size");
...
struct rio_scan_node {
   int mport_id ;
    klee_make_symbolic(&mport_id, sizeof(int), "mport_id");
   struct list_head node ;
   struct rio_scan *ops ;
};
struct exception_table_entry {
...
static int hdid[8U]  ;
static int ids_num  ;
    klee_make_symbolic(&ids_num, sizeof(int), "ids_num");
...
static unsigned char next_portid  ;
    klee_make_symbolic(&next_portid, sizeof(char), "next_portid");
...
{ 
  u32 result ;
  int p_port ;
    klee_make_symbolic(&p_port, sizeof(int), "p_port");
  int rc ;
  struct rio_dev *prev ;
  int tmp ;
  struct _ddebug descriptor ;
...
{ 
  u32 regval ;
  int checkcount ;
    klee_make_symbolic(&checkcount, sizeof(int), "checkcount");
  int tmp ;
