...
struct md_cluster_info {
   ...
   int slot_number ;
    klee_make_symbolic(&slot_number, sizeof(int), "slot_number");
   struct completion completion ;
   ...
   unsigned long recovery_map ;
    klee_make_symbolic(&recovery_map, sizeof(long), "recovery_map");
...
struct cluster_msg {
   ...
   char uuid[16U] ;
   int raid_slot ;
    klee_make_symbolic(&raid_slot, sizeof(int), "raid_slot");
};
...
{ 
  ...
  int ret ;
  int ops_rv ;
    klee_make_symbolic(&ops_rv, sizeof(int), "ops_rv");
  char str[64U] ;
  bool tmp ;
  int tmp___0 ;
  void *tmp___1 ;
