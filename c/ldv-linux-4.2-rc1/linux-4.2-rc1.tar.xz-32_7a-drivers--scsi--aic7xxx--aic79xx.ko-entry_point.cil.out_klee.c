...
union __anonunion_bus_space_handle_t_267 {
   u_long ioport ;
    klee_make_symbolic(&ioport, sizeof(long), "ioport");
...
typedef int ahd_chip;
    klee_make_symbolic(&ahd_chip, sizeof(int), "ahd_chip");
enum ldv_27843 {
    AHD_FENONE = 0,
    AHD_WIDE = 1,
...
typedef int ahd_flag;
    klee_make_symbolic(&ahd_flag, sizeof(int), "ahd_flag");
...
struct scb {
   ...
   u_int sg_count ;
    klee_make_symbolic(&sg_count, sizeof(int), "sg_count");
   u_int crc_retry_count ;
    klee_make_symbolic(&crc_retry_count, sizeof(int), "crc_retry_count");
};
struct scb_tailq {
...
struct scb_data {
   ...
   int scbs_left ;
    klee_make_symbolic(&scbs_left, sizeof(int), "scbs_left");
   int sgs_left ;
    klee_make_symbolic(&sgs_left, sizeof(int), "sgs_left");
   int sense_left ;
    klee_make_symbolic(&sense_left, sizeof(int), "sense_left");
   uint16_t numscbs ;
   uint16_t maxhscbs ;
   uint8_t init_level ;
};
...
typedef int ahd_msg_flags;
    klee_make_symbolic(&ahd_msg_flags, sizeof(int), "ahd_msg_flags");
enum ldv_27952 {
    MSG_TYPE_NONE = 0,
...
typedef int ahd_mode;
    klee_make_symbolic(&ahd_mode, sizeof(int), "ahd_mode");
...
struct ahd_softc {
   ...
   u_int cmdcmplt_bucket ;
    klee_make_symbolic(&cmdcmplt_bucket, sizeof(int), "cmdcmplt_bucket");
   ...
   u_int num_critical_sections ;
    klee_make_symbolic(&num_critical_sections, sizeof(int), "num_critical_sections");
   uint8_t *overrun_buf ;
   ...
   u_int msgout_len ;
    klee_make_symbolic(&msgout_len, sizeof(int), "msgout_len");
   u_int msgout_index ;
    klee_make_symbolic(&msgout_index, sizeof(int), "msgout_index");
   u_int msgin_index ;
    klee_make_symbolic(&msgin_index, sizeof(int), "msgin_index");
   bus_dma_tag_t parent_dmat ;
   bus_dma_tag_t shared_data_dmat ;
   struct map_node shared_data_map ;
   struct ahd_suspend_state suspend_state ;
   u_int enabled_luns ;
    klee_make_symbolic(&enabled_luns, sizeof(int), "enabled_luns");
   u_int init_level ;
    klee_make_symbolic(&init_level, sizeof(int), "init_level");
   u_int pci_cachesize ;
    klee_make_symbolic(&pci_cachesize, sizeof(int), "pci_cachesize");
   uint8_t iocell_opts[4U] ;
   u_int stack_size ;
    klee_make_symbolic(&stack_size, sizeof(int), "stack_size");
   ...
   int seltime ;
    klee_make_symbolic(&seltime, sizeof(int), "seltime");
   u_int int_coalescing_timer ;
    klee_make_symbolic(&int_coalescing_timer, sizeof(int), "int_coalescing_timer");
   u_int int_coalescing_maxcmds ;
    klee_make_symbolic(&int_coalescing_maxcmds, sizeof(int), "int_coalescing_maxcmds");
   u_int int_coalescing_mincmds ;
    klee_make_symbolic(&int_coalescing_mincmds, sizeof(int), "int_coalescing_mincmds");
   u_int int_coalescing_threshold ;
    klee_make_symbolic(&int_coalescing_threshold, sizeof(int), "int_coalescing_threshold");
   u_int int_coalescing_stop_threshold ;
    klee_make_symbolic(&int_coalescing_stop_threshold, sizeof(int), "int_coalescing_stop_threshold");
...
struct ahd_devinfo {
   int our_scsiid ;
    klee_make_symbolic(&our_scsiid, sizeof(int), "our_scsiid");
   int target_offset ;
    klee_make_symbolic(&target_offset, sizeof(int), "target_offset");
...
struct ahd_linux_device {
   ...
   int active ;
   int openings ;
    klee_make_symbolic(&openings, sizeof(int), "openings");
   u_int qfrozen ;
    klee_make_symbolic(&qfrozen, sizeof(int), "qfrozen");
   u_long commands_issued ;
    klee_make_symbolic(&commands_issued, sizeof(long), "commands_issued");
   u_int tag_success_count ;
    klee_make_symbolic(&tag_success_count, sizeof(int), "tag_success_count");
   ahd_linux_dev_flags flags ;
   struct timer_list timer ;
   u_int maxtags ;
    klee_make_symbolic(&maxtags, sizeof(int), "maxtags");
   u_int tags_on_last_queuefull ;
    klee_make_symbolic(&tags_on_last_queuefull, sizeof(int), "tags_on_last_queuefull");
   u_int last_queuefull_same_count ;
    klee_make_symbolic(&last_queuefull_same_count, sizeof(int), "last_queuefull_same_count");
   u_int commands_since_idle_or_otag ;
    klee_make_symbolic(&commands_since_idle_or_otag, sizeof(int), "commands_since_idle_or_otag");
};
struct scb_platform_data {
...
struct ins_format4 {
   unsigned char opcode_ext ;
    klee_make_symbolic(&opcode_ext, sizeof(char), "opcode_ext");
   unsigned short source : 9 ;
   unsigned short destination : 9 ;
   unsigned char ret : 1 ;
   unsigned char opcode : 4 ;
...
struct spi_transport_attrs {
   int period ;
   int min_period ;
    klee_make_symbolic(&min_period, sizeof(int), "min_period");
   int offset ;
   int max_offset ;
    klee_make_symbolic(&max_offset, sizeof(int), "max_offset");
   ...
   unsigned int support_dt_only ;
    klee_make_symbolic(&support_dt_only, sizeof(int), "support_dt_only");
   unsigned int support_ius ;
    klee_make_symbolic(&support_ius, sizeof(int), "support_ius");
   unsigned int support_qas ;
    klee_make_symbolic(&support_qas, sizeof(int), "support_qas");
...
struct __anonstruct_scsi_syncrates_286 {
   u_int period_factor ;
    klee_make_symbolic(&period_factor, sizeof(int), "period_factor");
   u_int period ;
};
enum hrtimer_restart;
...
{ 
  u_int oldvalue ;
    klee_make_symbolic(&oldvalue, sizeof(int), "oldvalue");
  uint16_t tmp ;
...
{ 
  u_int intstat ;
    klee_make_symbolic(&intstat, sizeof(int), "intstat");
  uint8_t tmp ;
  u_int tmp___0 ;
  uint8_t tmp___1 ;
  int tmp___2 ;
...
{ 
  ...
  int packetized ;
    klee_make_symbolic(&packetized, sizeof(int), "packetized");
  uint8_t tmp ;
  uint8_t tmp___0 ;
...
{ 
  u_int active_fifo ;
    klee_make_symbolic(&active_fifo, sizeof(int), "active_fifo");
  uint8_t tmp ;
...
{ 
  ...
  ahd_mode_state saved_modes ;
  u_int saved_scbptr ;
    klee_make_symbolic(&saved_scbptr, sizeof(int), "saved_scbptr");
  u_int ccscbctl ;
    klee_make_symbolic(&ccscbctl, sizeof(int), "ccscbctl");
  u_int scbid ;
    klee_make_symbolic(&scbid, sizeof(int), "scbid");
  u_int next_scbid ;
    klee_make_symbolic(&next_scbid, sizeof(int), "next_scbid");
  u_int fifo_mode ;
    klee_make_symbolic(&fifo_mode, sizeof(int), "fifo_mode");
  u_int i ;
  ...
  u_int comp_head ;
    klee_make_symbolic(&comp_head, sizeof(int), "comp_head");
  u_int tmp___2 ;
  uint16_t tmp___3 ;
  u_int tail ;
...
{ 
  u_int seqintsrc ;
    klee_make_symbolic(&seqintsrc, sizeof(int), "seqintsrc");
  uint8_t tmp ;
  uint32_t datacnt ;
  uint32_t sgptr ;
  uint32_t tmp___0 ;
  ...
  uint32_t data_len ;
  u_int dfcntrl ;
    klee_make_symbolic(&dfcntrl, sizeof(int), "dfcntrl");
  uint8_t tmp___13 ;
  struct ahd_dma64_seg *sg ;
  void *tmp___14 ;
  struct ahd_dma_seg *sg___0 ;
...
{ 
  ...
  struct scb *scb ;
  u_int scb_index ;
    klee_make_symbolic(&scb_index, sizeof(int), "scb_index");
  char *tmp ;
...
{ 
  u_int seqintcode ;
    klee_make_symbolic(&seqintcode, sizeof(int), "seqintcode");
  uint8_t tmp ;
  int tmp___0 ;
  char *tmp___1 ;
  struct scb *scb ;
  ...
  struct scb *scb___0 ;
  u_int scbid___0 ;
    klee_make_symbolic(&scbid___0, sizeof(int), "scbid___0");
  char *tmp___7 ;
  struct scb *scb___1 ;
  u_int scbid___1 ;
    klee_make_symbolic(&scbid___1, sizeof(int), "scbid___1");
  u_int bus_phase ;
    klee_make_symbolic(&bus_phase, sizeof(int), "bus_phase");
  uint8_t tmp___8 ;
  char *tmp___9 ;
  char *tmp___10 ;
  ...
  struct ahd_transinfo *tinfo ;
  u_int scbid___2 ;
    klee_make_symbolic(&scbid___2, sizeof(int), "scbid___2");
  struct scb *scb___3 ;
  u_int scb_index ;
  uint8_t tmp___11 ;
  char *tmp___12 ;
  ...
  struct scb *scb___4 ;
  u_int scb_index___0 ;
    klee_make_symbolic(&scb_index___0, sizeof(int), "scb_index___0");
  u_int bus_phase___0 ;
    klee_make_symbolic(&bus_phase___0, sizeof(int), "bus_phase___0");
  uint8_t tmp___17 ;
  uint8_t tmp___18 ;
  uint8_t tmp___19 ;
  char *tmp___20 ;
  ...
  u_int lastphase ;
    klee_make_symbolic(&lastphase, sizeof(int), "lastphase");
  uint8_t tmp___39 ;
  uint8_t tmp___40 ;
  uint8_t tmp___41 ;
  char *tmp___42 ;
  u_int lastphase___0 ;
    klee_make_symbolic(&lastphase___0, sizeof(int), "lastphase___0");
  uint8_t tmp___43 ;
  uint8_t tmp___44 ;
  uint8_t tmp___45 ;
  char *tmp___46 ;
  struct scb *scb___5 ;
  u_int scbindex ;
    klee_make_symbolic(&scbindex, sizeof(int), "scbindex");
  u_int lastphase___1 ;
    klee_make_symbolic(&lastphase___1, sizeof(int), "lastphase___1");
  uint8_t tmp___47 ;
  ...
  struct scb *scb___6 ;
  u_int scbid___3 ;
    klee_make_symbolic(&scbid___3, sizeof(int), "scbid___3");
  char *tmp___51 ;
  u_int tmp___52 ;
    klee_make_symbolic(&tmp___52, sizeof(int), "tmp___52");
  u_int scbid___4 ;
    klee_make_symbolic(&scbid___4, sizeof(int), "scbid___4");
  struct scb *scb___7 ;
  u_int lun ;
  u_int tag ;
  cam_status error ;
  ...
  u_int scbid___5 ;
    klee_make_symbolic(&scbid___5, sizeof(int), "scbid___5");
  struct scb *scb___8 ;
  uint8_t tmp___53 ;
  uint8_t tmp___54 ;
  uint8_t tmp___55 ;
...
{ 
  struct scb *scb ;
  u_int status0 ;
    klee_make_symbolic(&status0, sizeof(int), "status0");
  u_int status3 ;
    klee_make_symbolic(&status3, sizeof(int), "status3");
  u_int status ;
    klee_make_symbolic(&status, sizeof(int), "status");
  u_int lqistat1 ;
    klee_make_symbolic(&lqistat1, sizeof(int), "lqistat1");
  u_int lqostat0 ;
    klee_make_symbolic(&lqostat0, sizeof(int), "lqostat0");
  u_int scbid ;
  u_int busfreetime ;
    klee_make_symbolic(&busfreetime, sizeof(int), "busfreetime");
  uint8_t tmp ;
  uint8_t tmp___0 ;
  uint8_t tmp___1 ;
  uint8_t tmp___2 ;
  ...
  uint8_t tmp___4 ;
  u_int simode0 ;
    klee_make_symbolic(&simode0, sizeof(int), "simode0");
  uint8_t tmp___5 ;
  uint8_t tmp___6 ;
  u_int now_lvd ;
    klee_make_symbolic(&now_lvd, sizeof(int), "now_lvd");
  uint8_t tmp___7 ;
  char *tmp___8 ;
  char *tmp___9 ;
  char *tmp___10 ;
  ...
  char *tmp___14 ;
  u_int lqostat1 ;
    klee_make_symbolic(&lqostat1, sizeof(int), "lqostat1");
  int restart ;
    klee_make_symbolic(&restart, sizeof(int), "restart");
  int clear_fifo ;
    klee_make_symbolic(&clear_fifo, sizeof(int), "clear_fifo");
  int packetized ;
  u_int mode ;
  uint8_t tmp___15 ;
  uint8_t tmp___16 ;
...
{ 
  ...
  u_int lqistat1 ;
  u_int lqistat2 ;
    klee_make_symbolic(&lqistat2, sizeof(int), "lqistat2");
  u_int msg_out ;
    klee_make_symbolic(&msg_out, sizeof(int), "msg_out");
  u_int curphase ;
    klee_make_symbolic(&curphase, sizeof(int), "curphase");
  u_int lastphase ;
  u_int perrdiag ;
    klee_make_symbolic(&perrdiag, sizeof(int), "perrdiag");
  u_int cur_col ;
    klee_make_symbolic(&cur_col, sizeof(int), "cur_col");
  int silent ;
    klee_make_symbolic(&silent, sizeof(int), "silent");
  uint8_t tmp ;
  uint8_t tmp___0 ;
  u_int lqistate ;
    klee_make_symbolic(&lqistate, sizeof(int), "lqistate");
  uint8_t tmp___1 ;
  char *tmp___2 ;
  uint8_t tmp___3 ;
  uint8_t tmp___4 ;
...
{ 
  ...
  u_int saved_scbptr ;
  u_int waiting_h ;
    klee_make_symbolic(&waiting_h, sizeof(int), "waiting_h");
  u_int waiting_t ;
    klee_make_symbolic(&waiting_t, sizeof(int), "waiting_t");
  u_int next ;
...
{ 
  ...
  u_int lastphase ;
  u_int saved_scsiid ;
    klee_make_symbolic(&saved_scsiid, sizeof(int), "saved_scsiid");
  u_int saved_lun ;
    klee_make_symbolic(&saved_lun, sizeof(int), "saved_lun");
  u_int target ;
  u_int initiator_role_id ;
    klee_make_symbolic(&initiator_role_id, sizeof(int), "initiator_role_id");
  u_int scbid ;
  u_int ppr_busfree ;
    klee_make_symbolic(&ppr_busfree, sizeof(int), "ppr_busfree");
  int printerror ;
  ...
  int sent_msg ;
    klee_make_symbolic(&sent_msg, sizeof(int), "sent_msg");
  ...
  int aborted ;
    klee_make_symbolic(&aborted, sizeof(int), "aborted");
  u_int tag___0 ;
    klee_make_symbolic(&tag___0, sizeof(int), "tag___0");
  char *tmp___11 ;
  uint16_t tmp___12 ;
...
{ 
  ...
  u_int scbid ;
  u_int seq_flags ;
    klee_make_symbolic(&seq_flags, sizeof(int), "seq_flags");
  u_int curphase ;
  u_int lastphase ;
  int found ;
  uint8_t tmp ;
...
{ 
  ahd_mode_state saved_modes ;
  int stepping ;
    klee_make_symbolic(&stepping, sizeof(int), "stepping");
  int steps ;
    klee_make_symbolic(&steps, sizeof(int), "steps");
  int first_instr ;
    klee_make_symbolic(&first_instr, sizeof(int), "first_instr");
  u_int simode0 ;
  u_int simode1 ;
    klee_make_symbolic(&simode1, sizeof(int), "simode1");
  u_int simode3 ;
    klee_make_symbolic(&simode3, sizeof(int), "simode3");
  u_int lqimode0 ;
    klee_make_symbolic(&lqimode0, sizeof(int), "lqimode0");
  u_int lqimode1 ;
    klee_make_symbolic(&lqimode1, sizeof(int), "lqimode1");
  u_int lqomode0 ;
    klee_make_symbolic(&lqomode0, sizeof(int), "lqomode0");
  u_int lqomode1 ;
    klee_make_symbolic(&lqomode1, sizeof(int), "lqomode1");
  struct cs *cs ;
  u_int seqaddr ;
    klee_make_symbolic(&seqaddr, sizeof(int), "seqaddr");
  u_int i ;
  uint16_t tmp ;
  char *tmp___0 ;
  char *tmp___1 ;
...
{ 
  u_int auto_negotiate_orig ;
    klee_make_symbolic(&auto_negotiate_orig, sizeof(int), "auto_negotiate_orig");
...
{ 
  ...
  u_int old_ppr ;
    klee_make_symbolic(&old_ppr, sizeof(int), "old_ppr");
  int active ;
  int update_needed ;
    klee_make_symbolic(&update_needed, sizeof(int), "update_needed");
  int options ;
...
{ 
  ...
  struct ahd_tmode_tstate *tstate ;
  u_int oldwidth ;
    klee_make_symbolic(&oldwidth, sizeof(int), "oldwidth");
  int active ;
  int update_needed ;
  char *tmp ;
  int tmp___0 ;
...
{ 
  ...
  u_int period ;
  u_int ppr_opts ;
    klee_make_symbolic(&ppr_opts, sizeof(int), "ppr_opts");
  u_int con_opts ;
    klee_make_symbolic(&con_opts, sizeof(int), "con_opts");
  u_int offset ;
  u_int saved_negoaddr ;
    klee_make_symbolic(&saved_negoaddr, sizeof(int), "saved_negoaddr");
  uint8_t iocell_opts[4U] ;
  uint8_t tmp ;
...
{ 
  ...
  int pending_scb_count ;
    klee_make_symbolic(&pending_scb_count, sizeof(int), "pending_scb_count");
  int paused ;
    klee_make_symbolic(&paused, sizeof(int), "paused");
  u_int saved_scbptr ;
  ahd_mode_state saved_modes ;
  struct ahd_devinfo devinfo ;
  struct ahd_initiator_tinfo *tinfo ;
  ...
  uint8_t tmp___2 ;
  u_int scb_tag ;
    klee_make_symbolic(&scb_tag, sizeof(int), "scb_tag");
  u_int control ;
...
{ 
  ...
  role_t role ;
  int our_id ;
    klee_make_symbolic(&our_id, sizeof(int), "our_id");
  uint8_t tmp ;
  uint8_t tmp___0 ;
  uint8_t tmp___1 ;
  uint8_t tmp___2 ;
...
{ 
  ...
  uint8_t tmp___3 ;
  u_int identify_msg ;
    klee_make_symbolic(&identify_msg, sizeof(int), "identify_msg");
  u_int tmp___4 ;
  u_int tmp___5 ;
  u_int tmp___6 ;
  uint8_t tmp___7 ;
...
{ 
  ...
  struct ahd_tmode_tstate *tstate ;
  int dowide ;
    klee_make_symbolic(&dowide, sizeof(int), "dowide");
  int dosync ;
    klee_make_symbolic(&dosync, sizeof(int), "dosync");
  int doppr ;
    klee_make_symbolic(&doppr, sizeof(int), "doppr");
  u_int period ;
  u_int ppr_options ;
    klee_make_symbolic(&ppr_options, sizeof(int), "ppr_options");
  u_int offset ;
...
{ 
  ...
  u_int bus_phase ;
  int end_session ;
    klee_make_symbolic(&end_session, sizeof(int), "end_session");
  uint8_t tmp ;
  uint8_t tmp___0 ;
  int lastbyte ;
    klee_make_symbolic(&lastbyte, sizeof(int), "lastbyte");
  int phasemis ;
    klee_make_symbolic(&phasemis, sizeof(int), "phasemis");
  int msgdone ;
    klee_make_symbolic(&msgdone, sizeof(int), "msgdone");
  struct ahd_phase_table_entry  const  *tmp___1 ;
  u_int tmp___2 ;
  int phasemis___0 ;
    klee_make_symbolic(&phasemis___0, sizeof(int), "phasemis___0");
  int message_done ;
    klee_make_symbolic(&message_done, sizeof(int), "message_done");
  struct ahd_phase_table_entry  const  *tmp___3 ;
  int msgdone___0 ;
    klee_make_symbolic(&msgdone___0, sizeof(int), "msgdone___0");
  int msgout_request ;
    klee_make_symbolic(&msgout_request, sizeof(int), "msgout_request");
  uint8_t tmp___4 ;
  uint8_t tmp___5 ;
  uint8_t tmp___6 ;
  uint8_t tmp___7 ;
  u_int tmp___8 ;
  int lastbyte___0 ;
    klee_make_symbolic(&lastbyte___0, sizeof(int), "lastbyte___0");
  int msgdone___1 ;
    klee_make_symbolic(&msgdone___1, sizeof(int), "msgdone___1");
  uint8_t tmp___9 ;
  uint8_t tmp___10 ;
  uint8_t tmp___11 ;
  uint8_t tmp___12 ;
...
{ 
  ...
  u_int offset ;
  u_int saved_offset ;
    klee_make_symbolic(&saved_offset, sizeof(int), "saved_offset");
  char *tmp ;
  char *tmp___0 ;
  int tmp___1 ;
  u_int bus_width ;
    klee_make_symbolic(&bus_width, sizeof(int), "bus_width");
  u_int saved_width ;
    klee_make_symbolic(&saved_width, sizeof(int), "saved_width");
  u_int sending_reply ;
    klee_make_symbolic(&sending_reply, sizeof(int), "sending_reply");
  char *tmp___2 ;
  char *tmp___3 ;
  char *tmp___4 ;
  int tmp___5 ;
  u_int period___0 ;
    klee_make_symbolic(&period___0, sizeof(int), "period___0");
  u_int offset___0 ;
    klee_make_symbolic(&offset___0, sizeof(int), "offset___0");
  u_int bus_width___0 ;
    klee_make_symbolic(&bus_width___0, sizeof(int), "bus_width___0");
  u_int ppr_options___0 ;
    klee_make_symbolic(&ppr_options___0, sizeof(int), "ppr_options___0");
  u_int saved_width___0 ;
    klee_make_symbolic(&saved_width___0, sizeof(int), "saved_width___0");
  u_int saved_offset___0 ;
    klee_make_symbolic(&saved_offset___0, sizeof(int), "saved_offset___0");
  u_int saved_ppr_options ;
    klee_make_symbolic(&saved_ppr_options, sizeof(int), "saved_ppr_options");
  char *tmp___6 ;
  char *tmp___7 ;
  int tmp___8 ;
  char *tmp___9 ;
...
{ 
  ...
  u_int scb_index ;
  u_int last_msg ;
    klee_make_symbolic(&last_msg, sizeof(int), "last_msg");
  int response ;
  uint8_t tmp ;
  char *tmp___0 ;
  char *tmp___1 ;
  ...
  char *tmp___4 ;
  int tag_type ;
    klee_make_symbolic(&tag_type, sizeof(int), "tag_type");
  int mask ;
...
{ 
  u_int sxfrctl1 ;
    klee_make_symbolic(&sxfrctl1, sizeof(int), "sxfrctl1");
  int wait ;
  uint32_t cmd ;
  uint8_t tmp ;
  uint32_t mod_cmd ;
...
{ 
  ahd_mode_state saved_modes ;
  u_int sblkctl ;
    klee_make_symbolic(&sblkctl, sizeof(int), "sblkctl");
  uint8_t tmp ;
  char *tmp___0 ;
  uint8_t tmp___1 ;
  char *tmp___2 ;
...
{ 
  ...
  struct scb *first_scb ;
  u_int col_idx ;
    klee_make_symbolic(&col_idx, sizeof(int), "col_idx");
  struct scb *next_scb ;
  struct scb *tmp ;
...
{ 
  ...
  dma_addr_t sense_busaddr ;
  int newcount ;
    klee_make_symbolic(&newcount, sizeof(int), "newcount");
  int i ;
  int offset ;
  void *tmp ;
  int tmp___0 ;
  ...
  u_int tmp___8 ;
  int offset___1 ;
    klee_make_symbolic(&offset___1, sizeof(int), "offset___1");
  void *tmp___9 ;
  int tmp___10 ;
  int _min1 ;
  int _min2 ;
  ...
  u_int col_tag ;
    klee_make_symbolic(&col_tag, sizeof(int), "col_tag");
  void *tmp___11 ;
  void *tmp___12 ;
  u_int tmp___13 ;
  u_int tmp___14 ;
...
{ 
  ...
  int error ;
  u_int warn_user ;
    klee_make_symbolic(&warn_user, sizeof(int), "warn_user");
  ...
  char *tmp___8 ;
  u_int term_stat ;
    klee_make_symbolic(&term_stat, sizeof(int), "term_stat");
  char *tmp___9 ;
  char *tmp___10 ;
  char *tmp___11 ;
...
{ 
  ...
  u_int scsiseq_template ;
    klee_make_symbolic(&scsiseq_template, sizeof(int), "scsiseq_template");
  u_int wait ;
  u_int i ;
  u_int target ;
  uint8_t tmp ;
  ...
  int lun ;
  u_int negodat3 ;
    klee_make_symbolic(&negodat3, sizeof(int), "negodat3");
  uint8_t tmp___6 ;
  uint8_t tmp___7 ;
...
{ 
  int targ ;
  int max_targ ;
    klee_make_symbolic(&max_targ, sizeof(int), "max_targ");
  char *tmp ;
  struct ahd_tmode_tstate *tmp___0 ;
  struct ahd_devinfo devinfo ;
  struct ahd_initiator_tinfo *tinfo ;
...
{ 
  u_int hcntrl ;
    klee_make_symbolic(&hcntrl, sizeof(int), "hcntrl");
  uint8_t tmp ;
...
{ 
  u_int intstat ;
  u_int maxloops ;
    klee_make_symbolic(&maxloops, sizeof(int), "maxloops");
  uint8_t tmp ;
  uint8_t tmp___0 ;
  uint8_t tmp___1 ;
  uint8_t tmp___2 ;
...
{ 
  u_int scbid ;
  u_int scb_offset ;
    klee_make_symbolic(&scb_offset, sizeof(int), "scb_offset");
  u_int saved_scbptr ;
...
{ 
  int targ ;
  char chan ;
    klee_make_symbolic(&chan, sizeof(char), "chan");
  int slun ;
...
{ 
  ...
  ahd_mode_state saved_modes ;
  u_int prev_tag ;
    klee_make_symbolic(&prev_tag, sizeof(int), "prev_tag");
  u_int prev_pos ;
    klee_make_symbolic(&prev_pos, sizeof(int), "prev_pos");
  int tmp ;
...
{ 
  u_int qinpos ;
    klee_make_symbolic(&qinpos, sizeof(int), "qinpos");
  u_int wrap_qinpos ;
    klee_make_symbolic(&wrap_qinpos, sizeof(int), "wrap_qinpos");
  u_int wrap_qinfifonext ;
    klee_make_symbolic(&wrap_qinfifonext, sizeof(int), "wrap_qinfifonext");
...
{ 
  ...
  ahd_mode_state saved_modes ;
  u_int pending_cmds ;
    klee_make_symbolic(&pending_cmds, sizeof(int), "pending_cmds");
  int tmp ;
...
{ 
  ...
  ahd_mode_state saved_modes ;
  u_int qinstart ;
    klee_make_symbolic(&qinstart, sizeof(int), "qinstart");
  u_int qinpos ;
  u_int qintail ;
    klee_make_symbolic(&qintail, sizeof(int), "qintail");
  u_int tid_next ;
    klee_make_symbolic(&tid_next, sizeof(int), "tid_next");
  u_int tid_prev ;
    klee_make_symbolic(&tid_prev, sizeof(int), "tid_prev");
  u_int scbid ;
  u_int seq_flags2 ;
    klee_make_symbolic(&seq_flags2, sizeof(int), "seq_flags2");
  u_int savedscbptr ;
    klee_make_symbolic(&savedscbptr, sizeof(int), "savedscbptr");
  uint32_t busaddr ;
  int found ;
  int targets ;
    klee_make_symbolic(&targets, sizeof(int), "targets");
  uint8_t tmp ;
  uint8_t tmp___0 ;
  uint8_t tmp___1 ;
  int tmp___2 ;
  ...
  uint16_t tmp___5 ;
  u_int tid_head ;
    klee_make_symbolic(&tid_head, sizeof(int), "tid_head");
  u_int tid_tail ;
    klee_make_symbolic(&tid_tail, sizeof(int), "tid_tail");
  char *tmp___6 ;
  char *tmp___7 ;
  int tmp___8 ;
  int tmp___9 ;
  u_int tail_offset ;
    klee_make_symbolic(&tail_offset, sizeof(int), "tail_offset");
  uint16_t tmp___10 ;
  int tmp___11 ;
  uint16_t tmp___12 ;
  int tmp___13 ;
...
{ 
  ...
  u_int j ;
  u_int maxtarget ;
    klee_make_symbolic(&maxtarget, sizeof(int), "maxtarget");
  u_int minlun ;
    klee_make_symbolic(&minlun, sizeof(int), "minlun");
  u_int maxlun ;
    klee_make_symbolic(&maxlun, sizeof(int), "maxlun");
  int found ;
  ahd_mode_state saved_modes ;
  u_int scbid ;
  u_int tcl ;
    klee_make_symbolic(&tcl, sizeof(int), "tcl");
  int tmp ;
  cam_status ostat ;
  uint32_t tmp___0 ;
  uint32_t tmp___1 ;
...
{ 
  ...
  u_int initiator ;
    klee_make_symbolic(&initiator, sizeof(int), "initiator");
  u_int target ;
  u_int max_scsiid ;
    klee_make_symbolic(&max_scsiid, sizeof(int), "max_scsiid");
  int found ;
  u_int fifo ;
    klee_make_symbolic(&fifo, sizeof(int), "fifo");
  u_int next_fifo ;
    klee_make_symbolic(&next_fifo, sizeof(int), "next_fifo");
  uint8_t scsiseq ;
  char *tmp ;
  uint8_t tmp___0 ;
  uint8_t tmp___1 ;
...
{ 
  struct ahd_softc *ahd ;
  u_long s ;
    klee_make_symbolic(&s, sizeof(long), "s");
  int enint_coal ;
    klee_make_symbolic(&enint_coal, sizeof(int), "enint_coal");
  char *tmp ;
...
{ 
  ...
  unsigned long __lengthofcs_table ;
    klee_make_symbolic(&__lengthofcs_table, sizeof(long), "__lengthofcs_table");
  void *tmp ;
  u_int *begin_set ;
  unsigned long __lengthofbegin_set ;
    klee_make_symbolic(&__lengthofbegin_set, sizeof(long), "__lengthofbegin_set");
  void *tmp___0 ;
  u_int *end_set ;
  unsigned long __lengthofend_set ;
    klee_make_symbolic(&__lengthofend_set, sizeof(long), "__lengthofend_set");
  void *tmp___1 ;
  struct patch  const  *cur_patch ;
  u_int cs_count ;
    klee_make_symbolic(&cs_count, sizeof(int), "cs_count");
  u_int cur_cs ;
    klee_make_symbolic(&cur_cs, sizeof(int), "cur_cs");
  u_int i ;
  int downloaded ;
  ...
  u_int sg_prefetch_cnt ;
    klee_make_symbolic(&sg_prefetch_cnt, sizeof(int), "sg_prefetch_cnt");
  u_int sg_prefetch_cnt_limit ;
    klee_make_symbolic(&sg_prefetch_cnt_limit, sizeof(int), "sg_prefetch_cnt_limit");
  u_int sg_prefetch_align ;
    klee_make_symbolic(&sg_prefetch_align, sizeof(int), "sg_prefetch_align");
  u_int sg_size ;
    klee_make_symbolic(&sg_size, sizeof(int), "sg_size");
  u_int cacheline_mask ;
    klee_make_symbolic(&cacheline_mask, sizeof(int), "cacheline_mask");
...
{ 
  int last_probe ;
    klee_make_symbolic(&last_probe, sizeof(int), "last_probe");
  int i ;
  u_int stack_entry ;
    klee_make_symbolic(&stack_entry, sizeof(int), "stack_entry");
  uint8_t tmp ;
  uint8_t tmp___0 ;
...
{ 
  ...
  u_int printed_mask ;
    klee_make_symbolic(&printed_mask, sizeof(int), "printed_mask");
  int tmp ;
  int entry ;
...
{ 
  ...
  ahd_mode_state saved_modes ;
  u_int dffstat ;
    klee_make_symbolic(&dffstat, sizeof(int), "dffstat");
  int paused ;
  u_int scb_index ;
  u_int saved_scb_index ;
    klee_make_symbolic(&saved_scb_index, sizeof(int), "saved_scb_index");
  u_int cur_col ;
  int i ;
  int tmp ;
  ...
  struct scb *fifo_scb ;
  u_int fifo_scbptr ;
    klee_make_symbolic(&fifo_scbptr, sizeof(int), "fifo_scbptr");
  uint16_t tmp___58 ;
  char *tmp___59 ;
  uint8_t tmp___60 ;
  uint8_t tmp___61 ;
...
{ 
  int i ;
  int maxaddr ;
    klee_make_symbolic(&maxaddr, sizeof(int), "maxaddr");
  uint32_t checksum ;
  uint8_t *vpdarray ;
...
{ 
  uint32_t cmd ;
  u_int targpcistat ;
    klee_make_symbolic(&targpcistat, sizeof(int), "targpcistat");
  u_int pci_status1 ;
    klee_make_symbolic(&pci_status1, sizeof(int), "pci_status1");
  int error ;
  uint8_t hcntrl ;
  int tmp ;
  uint8_t tmp___0 ;
...
{ 
  ...
  u_int adapter_control ;
    klee_make_symbolic(&adapter_control, sizeof(int), "adapter_control");
  int have_seeprom ;
    klee_make_symbolic(&have_seeprom, sizeof(int), "have_seeprom");
  int error ;
  u_int start_addr ;
    klee_make_symbolic(&start_addr, sizeof(int), "start_addr");
  char *tmp ;
  char *tmp___0 ;
  char *tmp___1 ;
  u_int nvram_scb ;
    klee_make_symbolic(&nvram_scb, sizeof(int), "nvram_scb");
  uint16_t *sc_data ;
  int i ;
  uint16_t *tmp___2 ;
  u_int tmp___3 ;
...
{ 
  ...
  u_int devconfig1 ;
    klee_make_symbolic(&devconfig1, sizeof(int), "devconfig1");
...
static int ahd_linux_unit  ;
    klee_make_symbolic(&ahd_linux_unit, sizeof(int), "ahd_linux_unit");
void ahd_delay(long usec ) 
{ 
...
{ 
  ...
  void *tmp ;
  int rtn ;
    klee_make_symbolic(&rtn, sizeof(int), "rtn");
...
{ 
  ...
  long tmp___1 ;
  int flags___0 ;
    klee_make_symbolic(&flags___0, sizeof(int), "flags___0");
...
{ 
  ...
  u_int cdb_byte ;
    klee_make_symbolic(&cdb_byte, sizeof(int), "cdb_byte");
  int retval ;
  int paused ;
  int wait ;
  struct ahd_initiator_tinfo *tinfo ;
...
{ 
  int tags ;
    klee_make_symbolic(&tags, sizeof(int), "tags");
  int i ;
  int j ;
  unsigned long tmp ;
...
{ 
  u_int target_id ;
    klee_make_symbolic(&target_id, sizeof(int), "target_id");
  u_int numtarg ;
    klee_make_symbolic(&numtarg, sizeof(int), "numtarg");
  unsigned long s ;
  struct ahd_devinfo devinfo ;
  struct ahd_initiator_tinfo *tinfo ;
  struct ahd_tmode_tstate *tstate ;
...
{ 
  struct ahd_linux_device *dev ;
  int was_queuing ;
    klee_make_symbolic(&was_queuing, sizeof(int), "was_queuing");
  int now_queuing ;
    klee_make_symbolic(&now_queuing, sizeof(int), "now_queuing");
  void *tmp ;
  u_int usertags ;
    klee_make_symbolic(&usertags, sizeof(int), "usertags");
...
{ 
  int warned_user ;
    klee_make_symbolic(&warned_user, sizeof(int), "warned_user");
  u_int tags ;
...
{ 
  ...
  u_long flags ;
  int ours ;
    klee_make_symbolic(&ours, sizeof(int), "ours");
...
{ 
  ...
  unsigned int target_ppr_options ;
    klee_make_symbolic(&target_ppr_options, sizeof(int), "target_ppr_options");
  long tmp ;
  int __ret_warn_on ;
...
{ 
  ...
  u_int sense_offset ;
    klee_make_symbolic(&sense_offset, sizeof(int), "sense_offset");
  unsigned long _min1 ;
  u_long tmp___1 ;
  unsigned long _min2 ;
  size_t __min1 ;
...
{ 
  int status ;
  int new_status ;
    klee_make_symbolic(&new_status, sizeof(int), "new_status");
  int do_fallback ;
    klee_make_symbolic(&do_fallback, sizeof(int), "do_fallback");
  int scsi_status ;
    klee_make_symbolic(&scsi_status, sizeof(int), "scsi_status");
  uint32_t tmp ;
  uint32_t tmp___0 ;
...
{ 
  ...
  u_int saved_scbptr ;
  u_int active_scbptr ;
    klee_make_symbolic(&active_scbptr, sizeof(int), "active_scbptr");
  u_int last_phase ;
    klee_make_symbolic(&last_phase, sizeof(int), "last_phase");
  u_int saved_scsiid ;
  u_int cdb_byte ;
  int retval ;
  int was_paused ;
    klee_make_symbolic(&was_paused, sizeof(int), "was_paused");
  int paused ;
  int wait ;
  int disconnected ;
...
{ 
  ...
  int ldvarg15 ;
    klee_make_symbolic(&ldvarg15, sizeof(int), "ldvarg15");
  int ldvarg6 ;
  ...
  int ldvarg10 ;
    klee_make_symbolic(&ldvarg10, sizeof(int), "ldvarg10");
  int ldvarg9 ;
...
{ 
  ...
  int printed_options ;
    klee_make_symbolic(&printed_options, sizeof(int), "printed_options");
...
{ 
  ...
  unsigned int master_devfn ;
    klee_make_symbolic(&master_devfn, sizeof(int), "master_devfn");
