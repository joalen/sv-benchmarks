...
{ 
  ...
  unsigned int req_sects ;
    klee_make_symbolic(&req_sects, sizeof(int), "req_sects");
  sector_t end_sect ;
  sector_t tmp___5 ;
  sector_t __min1 ;
  sector_t __min2 ;
...
{ 
  ...
  unsigned long no_space_timeout ;
    klee_make_symbolic(&no_space_timeout, sizeof(long), "no_space_timeout");
  unsigned int __var ;
  char const   *tmp___1 ;
...
{ 
  int r ;
  int pool_created ;
    klee_make_symbolic(&pool_created, sizeof(int), "pool_created");
  struct pool_c *pt ;
  struct pool *pool ;
  struct pool_features pf ;
...
{ 
  int r ;
  int unformatted ;
    klee_make_symbolic(&unformatted, sizeof(int), "unformatted");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
...
{ 
  ...
  unsigned int open_devices ;
    klee_make_symbolic(&open_devices, sizeof(int), "open_devices");
  struct dm_thin_device *td ;
  struct dm_thin_device *tmp ;
  struct list_head  const  *__mptr ;
  struct list_head  const  *__mptr___0 ;
