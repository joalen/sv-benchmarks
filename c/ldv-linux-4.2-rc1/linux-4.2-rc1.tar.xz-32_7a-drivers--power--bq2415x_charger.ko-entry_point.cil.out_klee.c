...
struct bq2415x_platform_data {
   int current_limit ;
    klee_make_symbolic(&current_limit, sizeof(int), "current_limit");
   int weak_battery_voltage ;
    klee_make_symbolic(&weak_battery_voltage, sizeof(int), "weak_battery_voltage");
   int battery_regulation_voltage ;
    klee_make_symbolic(&battery_regulation_voltage, sizeof(int), "battery_regulation_voltage");
   int charge_current ;
    klee_make_symbolic(&charge_current, sizeof(int), "charge_current");
   int termination_current ;
    klee_make_symbolic(&termination_current, sizeof(int), "termination_current");
   int resistor_sense ;
    klee_make_symbolic(&resistor_sense, sizeof(int), "resistor_sense");
...
struct bq2415x_device {
   ...
   char *name ;
   int autotimer ;
    klee_make_symbolic(&autotimer, sizeof(int), "autotimer");
   int automode ;
    klee_make_symbolic(&automode, sizeof(int), "automode");
   int id ;
};
...
{ 
  int ret ;
  int charger ;
    klee_make_symbolic(&charger, sizeof(int), "charger");
  int boost ;
    klee_make_symbolic(&boost, sizeof(int), "boost");
...
{ 
  ...
  int ret ;
  int mA ;
    klee_make_symbolic(&mA, sizeof(int), "mA");
  struct _ddebug descriptor ;
  long tmp ;
