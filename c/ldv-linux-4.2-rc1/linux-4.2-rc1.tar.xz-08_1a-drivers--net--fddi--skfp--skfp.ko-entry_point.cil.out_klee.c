...
{ 
  ...
  void *tmp___0 ;
  int ldvarg3 ;
    klee_make_symbolic(&ldvarg3, sizeof(int), "ldvarg3");
  void *ldvarg0 ;
  void *tmp___1 ;
  int ldvarg2 ;
    klee_make_symbolic(&ldvarg2, sizeof(int), "ldvarg2");
...
{ 
  ...
  u_short x ;
    klee_make_symbolic(&x, sizeof(short), "x");
  u_long time ;
...
{ 
  ...
  int i ;
  unsigned char __x ;
    klee_make_symbolic(&__x, sizeof(char), "__x");
  unsigned char tmp ;
  bool tmp___0 ;
  int tmp___1 ;
...
{ 
  ...
  unsigned char __x___0 ;
    klee_make_symbolic(&__x___0, sizeof(char), "__x___0");
  unsigned char tmp___5 ;
  unsigned char __x___1 ;
    klee_make_symbolic(&__x___1, sizeof(char), "__x___1");
