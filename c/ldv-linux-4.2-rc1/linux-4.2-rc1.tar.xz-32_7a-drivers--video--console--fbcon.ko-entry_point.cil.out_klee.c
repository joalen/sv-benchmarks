...
struct display {
   ...
   int userfont ;
    klee_make_symbolic(&userfont, sizeof(int), "userfont");
   u_short scrollmode ;
    klee_make_symbolic(&scrollmode, sizeof(short), "scrollmode");
   u_short inverse ;
    klee_make_symbolic(&inverse, sizeof(short), "inverse");
   short yscroll ;
    klee_make_symbolic(&yscroll, sizeof(short), "yscroll");
   int vrows ;
    klee_make_symbolic(&vrows, sizeof(int), "vrows");
   int cursor_shape ;
    klee_make_symbolic(&cursor_shape, sizeof(int), "cursor_shape");
   int con_rotate ;
    klee_make_symbolic(&con_rotate, sizeof(int), "con_rotate");
   u32 xres_virtual ;
   u32 yres_virtual ;
   u32 height ;
   u32 width ;
...
struct fbcon_ops {
   ...
   struct display *p ;
   int currcon ;
    klee_make_symbolic(&currcon, sizeof(int), "currcon");
   int cur_blink_jiffies ;
    klee_make_symbolic(&cur_blink_jiffies, sizeof(int), "cur_blink_jiffies");
   int cursor_flash ;
    klee_make_symbolic(&cursor_flash, sizeof(int), "cursor_flash");
   int cursor_reset ;
    klee_make_symbolic(&cursor_reset, sizeof(int), "cursor_reset");
   int blank_state ;
    klee_make_symbolic(&blank_state, sizeof(int), "blank_state");
   int graphics ;
    klee_make_symbolic(&graphics, sizeof(int), "graphics");
   int save_graphics ;
    klee_make_symbolic(&save_graphics, sizeof(int), "save_graphics");
   int flags ;
   int rotate ;
    klee_make_symbolic(&rotate, sizeof(int), "rotate");
   int cur_rotate ;
    klee_make_symbolic(&cur_rotate, sizeof(int), "cur_rotate");
   char *cursor_data ;
   u8 *fontbuffer ;
   u8 *fontdata ;
   u8 *cursor_src ;
...
extern int console_blanked ;
    klee_make_symbolic(&console_blanked, sizeof(int), "console_blanked");
...
static int logo_lines  ;
    klee_make_symbolic(&logo_lines, sizeof(int), "logo_lines");
static int logo_shown  =    -1;
static int fbcon_softback_size  =    32768;
static unsigned long softback_buf  ;
    klee_make_symbolic(&softback_buf, sizeof(long), "softback_buf");
static unsigned long softback_curr  ;
    klee_make_symbolic(&softback_curr, sizeof(long), "softback_curr");
static unsigned long softback_in  ;
    klee_make_symbolic(&softback_in, sizeof(long), "softback_in");
static unsigned long softback_top  ;
    klee_make_symbolic(&softback_top, sizeof(long), "softback_top");
static unsigned long softback_end  ;
    klee_make_symbolic(&softback_end, sizeof(long), "softback_end");
static int softback_lines  ;
    klee_make_symbolic(&softback_lines, sizeof(int), "softback_lines");
static int first_fb_vc  ;
    klee_make_symbolic(&first_fb_vc, sizeof(int), "first_fb_vc");
static int last_fb_vc  =    62;
static int fbcon_is_default  =    1;
static int fbcon_has_exited  ;
    klee_make_symbolic(&fbcon_has_exited, sizeof(int), "fbcon_has_exited");
static int primary_device  =    -1;
static int fbcon_has_console_bind  ;
    klee_make_symbolic(&fbcon_has_console_bind, sizeof(int), "fbcon_has_console_bind");
static int map_override  ;
    klee_make_symbolic(&map_override, sizeof(int), "map_override");
static char fontname[40U]  ;
static int info_idx  =    -1;
static int initial_rotation  ;
    klee_make_symbolic(&initial_rotation, sizeof(int), "initial_rotation");
static int fbcon_has_sysfs  ;
    klee_make_symbolic(&fbcon_has_sysfs, sizeof(int), "fbcon_has_sysfs");
static struct consw  const  fb_con ;
static int fbcon_set_origin(struct vc_data *vc ) ;
static int fbcon_cursor_noblink  ;
    klee_make_symbolic(&fbcon_cursor_noblink, sizeof(int), "fbcon_cursor_noblink");
...
{ 
  ...
  unsigned short charmask ;
    klee_make_symbolic(&charmask, sizeof(short), "charmask");
  int col ;
...
{ 
  struct vc_data *vc ;
  int oldidx ;
    klee_make_symbolic(&oldidx, sizeof(int), "oldidx");
  struct fb_info *info ;
  ...
  int show_logo ;
    klee_make_symbolic(&show_logo, sizeof(int), "show_logo");
  int tmp___3 ;
...
{ 
  ...
  struct display *p ;
  int logo ;
    klee_make_symbolic(&logo, sizeof(int), "logo");
  int new_rows ;
    klee_make_symbolic(&new_rows, sizeof(int), "new_rows");
  int new_cols ;
    klee_make_symbolic(&new_cols, sizeof(int), "new_cols");
  int rows ;
  int cols ;
  int charcnt ;
    klee_make_symbolic(&charcnt, sizeof(int), "charcnt");
  int cap ;
...
{ 
  ...
  struct display *p ;
  u_int y_break ;
    klee_make_symbolic(&y_break, sizeof(int), "y_break");
  int tmp ;
  u_int b ;
  int tmp___0 ;
  int tmp___1 ;
...
{ 
  unsigned short chr ;
    klee_make_symbolic(&chr, sizeof(short), "chr");
...
{ 
  ...
  unsigned short attr ;
    klee_make_symbolic(&attr, sizeof(short), "attr");
  int tmp ;
...
{ 
  ...
  struct display *p ;
  int scroll_partial ;
    klee_make_symbolic(&scroll_partial, sizeof(int), "scroll_partial");
  int tmp ;
...
{ 
  ...
  u16 t ;
  int ypan ;
    klee_make_symbolic(&ypan, sizeof(int), "ypan");
  __u16 _r ;
  __u16 _v ;
  int ywrap ;
    klee_make_symbolic(&ywrap, sizeof(int), "ywrap");
  __u16 _r___0 ;
  u16 _v___0 ;
  int yres ;
  ...
  __u32 _v___2 ;
  int good_pan ;
    klee_make_symbolic(&good_pan, sizeof(int), "good_pan");
  int good_wrap ;
    klee_make_symbolic(&good_wrap, sizeof(int), "good_wrap");
  int reading_fast ;
    klee_make_symbolic(&reading_fast, sizeof(int), "reading_fast");
  int fast_copyarea ;
    klee_make_symbolic(&fast_copyarea, sizeof(int), "fast_copyarea");
  int fast_imageblit ;
    klee_make_symbolic(&fast_imageblit, sizeof(int), "fast_imageblit");
...
{ 
  ...
  struct fb_var_screeninfo var ;
  int x_diff ;
    klee_make_symbolic(&x_diff, sizeof(int), "x_diff");
  int y_diff ;
    klee_make_symbolic(&y_diff, sizeof(int), "y_diff");
  int virt_w ;
    klee_make_symbolic(&virt_w, sizeof(int), "virt_w");
  int virt_h ;
    klee_make_symbolic(&virt_h, sizeof(int), "virt_h");
  int virt_fw ;
    klee_make_symbolic(&virt_fw, sizeof(int), "virt_fw");
  int virt_fh ;
    klee_make_symbolic(&virt_fh, sizeof(int), "virt_fh");
  unsigned int _r ;
    klee_make_symbolic(&_r, sizeof(int), "_r");
  unsigned int _v ;
    klee_make_symbolic(&_v, sizeof(int), "_v");
  unsigned int _r___0 ;
    klee_make_symbolic(&_r___0, sizeof(int), "_r___0");
  unsigned int _v___0 ;
    klee_make_symbolic(&_v___0, sizeof(int), "_v___0");
  unsigned int _r___1 ;
    klee_make_symbolic(&_r___1, sizeof(int), "_r___1");
  unsigned int _v___1 ;
    klee_make_symbolic(&_v___1, sizeof(int), "_v___1");
  unsigned int _r___2 ;
    klee_make_symbolic(&_r___2, sizeof(int), "_r___2");
  unsigned int _v___2 ;
    klee_make_symbolic(&_v___2, sizeof(int), "_v___2");
  struct fb_videomode  const  *mode ;
...
{ 
  ...
  int ret ;
  int prev_console ;
    klee_make_symbolic(&prev_console, sizeof(int), "prev_console");
  int charcnt ;
...
{ 
  ...
  unsigned short charmask ;
  unsigned short oldc ;
    klee_make_symbolic(&oldc, sizeof(short), "oldc");
  int tmp ;
...
{ 
  ...
  struct display *p ;
  int resize ;
    klee_make_symbolic(&resize, sizeof(int), "resize");
  int cnt ;
  ...
  int count___0 ;
    klee_make_symbolic(&count___0, sizeof(int), "count___0");
  unsigned short c___0 ;
    klee_make_symbolic(&c___0, sizeof(short), "c___0");
  unsigned short newc ;
    klee_make_symbolic(&newc, sizeof(short), "newc");
  int cols ;
  int rows ;
  __u32 _r ;
  __u32 _v ;
...
{ 
  ...
  unsigned long offset___0 ;
    klee_make_symbolic(&offset___0, sizeof(long), "offset___0");
...
{ 
  ...
  int scrollback_old ;
    klee_make_symbolic(&scrollback_old, sizeof(int), "scrollback_old");
  struct vc_data *conp2 ;
  unsigned long p ;
  unsigned long q ;
    klee_make_symbolic(&q, sizeof(long), "q");
  int i ;
  int tmp ;
...
{ 
  int i ;
  int new_idx ;
    klee_make_symbolic(&new_idx, sizeof(int), "new_idx");
  int ret ;
  struct fb_info *info ;
  int tmp ;
...
{ 
  ...
  int j ;
  int mapped ;
    klee_make_symbolic(&mapped, sizeof(int), "mapped");
  int pending ;
