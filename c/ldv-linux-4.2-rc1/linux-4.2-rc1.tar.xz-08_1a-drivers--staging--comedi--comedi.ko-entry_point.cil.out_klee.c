...
struct comedi_async {
   ...
   unsigned int scans_done ;
    klee_make_symbolic(&scans_done, sizeof(int), "scans_done");
...
struct comedi_device {
   ...
   unsigned int detach_count ;
    klee_make_symbolic(&detach_count, sizeof(int), "detach_count");
...
struct comedi_file {
   ...
   unsigned int last_detach_count ;
    klee_make_symbolic(&last_detach_count, sizeof(int), "last_detach_count");
   bool last_attached ;
};
enum hrtimer_restart;
...
{ 
  ...
  unsigned int old_detach_count ;
    klee_make_symbolic(&old_detach_count, sizeof(int), "old_detach_count");
  struct _ddebug descriptor ;
  long tmp___0 ;
  unsigned int runflags ;
...
{ 
  unsigned int chanmask ;
    klee_make_symbolic(&chanmask, sizeof(int), "chanmask");
  unsigned int mask ;
  unsigned int bits ;
...
{ 
  ...
  unsigned int num_samples ;
    klee_make_symbolic(&num_samples, sizeof(int), "num_samples");
  unsigned int bits_per_sample ;
    klee_make_symbolic(&bits_per_sample, sizeof(int), "bits_per_sample");
  unsigned int tmp ;
  unsigned int tmp___0 ;
...
{ 
  ...
  unsigned int scans_left ;
    klee_make_symbolic(&scans_left, sizeof(int), "scans_left");
...
{ 
  ...
  struct comedi_cmd *cmd ;
  unsigned int nscans ;
    klee_make_symbolic(&nscans, sizeof(int), "nscans");
  unsigned int scans_left ;
  unsigned int tmp ;
  unsigned int scan_pos ;
    klee_make_symbolic(&scan_pos, sizeof(int), "scan_pos");
  unsigned int tmp___0 ;
  unsigned long long samples_left ;
    klee_make_symbolic(&samples_left, sizeof(long), "samples_left");
...
{ 
  ...
  unsigned int scan_length ;
    klee_make_symbolic(&scan_length, sizeof(int), "scan_length");
  unsigned int tmp ;
  unsigned int tmp___0 ;
  unsigned int nscans ;
...
{ 
  unsigned int max_samples ;
    klee_make_symbolic(&max_samples, sizeof(int), "max_samples");
  unsigned int nbytes ;
  unsigned int tmp ;
  unsigned int tmp___0 ;
