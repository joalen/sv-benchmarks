...
struct ar_context {
   ...
   unsigned int last_buffer_index ;
    klee_make_symbolic(&last_buffer_index, sizeof(int), "last_buffer_index");
   u32 regs ;
...
struct context {
   ...
   int total_allocation ;
    klee_make_symbolic(&total_allocation, sizeof(int), "total_allocation");
   u32 current_bus ;
   bool running ;
   bool flushing ;
   ...
   int prev_z ;
    klee_make_symbolic(&prev_z, sizeof(int), "prev_z");
...
struct iso_context {
   ...
   unsigned long flushing_completions ;
    klee_make_symbolic(&flushing_completions, sizeof(long), "flushing_completions");
   u32 mc_buffer_bus ;
   u16 mc_completed ;
   u16 last_timestamp ;
   u8 sync ;
...
struct fw_ohci {
   ...
   int request_generation ;
    klee_make_symbolic(&request_generation, sizeof(int), "request_generation");
   unsigned int quirks ;
    klee_make_symbolic(&quirks, sizeof(int), "quirks");
   unsigned int pri_req_max ;
    klee_make_symbolic(&pri_req_max, sizeof(int), "pri_req_max");
   u32 bus_time ;
   bool bus_time_running ;
   bool is_root ;
   bool csr_state_setclear_abdicate ;
   int n_ir ;
    klee_make_symbolic(&n_ir, sizeof(int), "n_ir");
   int n_it ;
    klee_make_symbolic(&n_it, sizeof(int), "n_it");
   spinlock_t lock ;
...
struct __anonstruct_ohci_quirks_254 {
   ...
   unsigned short revision ;
    klee_make_symbolic(&revision, sizeof(short), "revision");
   unsigned short flags ;
};
struct driver_data {
   u8 inline_data[8U] ;
...
static int param_quirks  ;
    klee_make_symbolic(&param_quirks, sizeof(int), "param_quirks");
static int param_debug  ;
    klee_make_symbolic(&param_debug, sizeof(int), "param_debug");
...
{ 
  unsigned int i ;
  unsigned int next_i ;
    klee_make_symbolic(&next_i, sizeof(int), "next_i");
  unsigned int last ;
...
{ 
  ...
  u32 tcode ;
  int evt ;
    klee_make_symbolic(&evt, sizeof(int), "evt");
...
{ 
  ...
  unsigned int end_buffer_index ;
    klee_make_symbolic(&end_buffer_index, sizeof(int), "end_buffer_index");
  unsigned int end_buffer_offset ;
    klee_make_symbolic(&end_buffer_offset, sizeof(int), "end_buffer_offset");
  void *p ;
  void *end ;
  void *buffer_end ;
  unsigned int tmp ;
...
{ 
  ...
  int self_id_count ;
    klee_make_symbolic(&self_id_count, sizeof(int), "self_id_count");
  int generation ;
  int new_generation ;
    klee_make_symbolic(&new_generation, sizeof(int), "new_generation");
  int i ;
  int j ;
...
{ 
  ...
  unsigned int res_count ;
    klee_make_symbolic(&res_count, sizeof(int), "res_count");
...
{ 
  ...
  int end_page ;
    klee_make_symbolic(&end_page, sizeof(int), "end_page");
  int i ;
  int length ;
  int offset ;
  u32 _min1 ;
...
{ 
  ...
  int payload_per_buffer ;
    klee_make_symbolic(&payload_per_buffer, sizeof(int), "payload_per_buffer");
  size_t _max1 ;
  unsigned long _max2 ;
