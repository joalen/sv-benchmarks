...
struct ubi_wl_entry {
   ...
   int ec ;
    klee_make_symbolic(&ec, sizeof(int), "ec");
   int pnum ;
...
struct ubi_volume {
   ...
   int metaonly ;
    klee_make_symbolic(&metaonly, sizeof(int), "metaonly");
   int reserved_pebs ;
...
struct ubi_debug_info {
   ...
   unsigned int power_cut_counter ;
    klee_make_symbolic(&power_cut_counter, sizeof(int), "power_cut_counter");
   unsigned int power_cut_min ;
    klee_make_symbolic(&power_cut_min, sizeof(int), "power_cut_min");
   unsigned int power_cut_max ;
    klee_make_symbolic(&power_cut_max, sizeof(int), "power_cut_max");
...
struct ubi_device {
   ...
   int fm_work_scheduled ;
    klee_make_symbolic(&fm_work_scheduled, sizeof(int), "fm_work_scheduled");
   struct rb_root used ;
...
struct mtd_dev_param {
   ...
   int ubi_num ;
   int vid_hdr_offs ;
    klee_make_symbolic(&vid_hdr_offs, sizeof(int), "vid_hdr_offs");
   int max_beb_per1024 ;
    klee_make_symbolic(&max_beb_per1024, sizeof(int), "max_beb_per1024");
};
...
struct ubi_sgl {
   int list_pos ;
    klee_make_symbolic(&list_pos, sizeof(int), "list_pos");
   int page_pos ;
    klee_make_symbolic(&page_pos, sizeof(int), "page_pos");
...
static int mtd_devs  ;
    klee_make_symbolic(&mtd_devs, sizeof(int), "mtd_devs");
...
{ 
  struct mtd_info *mtd ;
  int mtd_num ;
    klee_make_symbolic(&mtd_num, sizeof(int), "mtd_num");
  char *endp ;
  unsigned long tmp ;
  bool tmp___0 ;
  long tmp___1 ;
...
{ 
  ...
  unsigned long ldvarg72 ;
    klee_make_symbolic(&ldvarg72, sizeof(long), "ldvarg72");
  int ldvarg74 ;
...
{ 
  ...
  int pnum ;
  int old_pnum ;
    klee_make_symbolic(&old_pnum, sizeof(int), "old_pnum");
  int tries ;
  int vol_id ;
  struct ubi_vid_hdr *vid_hdr ;
  uint32_t crc ;
...
{ 
  ...
  struct ubi_wl_entry *e ;
  int enough ;
    klee_make_symbolic(&enough, sizeof(int), "enough");
...
{ 
  int ret ;
  int retried ;
    klee_make_symbolic(&retried, sizeof(int), "retried");
  struct ubi_fm_pool *pool ;
  struct ubi_fm_pool *wl_pool ;
  struct task_struct *tmp ;
  long tmp___0 ;
...
{ 
  ...
  long tmp___70 ;
    klee_make_symbolic(&tmp___70, sizeof(long), "tmp___70");
...
static int ubiblock_devs  ;
    klee_make_symbolic(&ubiblock_devs, sizeof(int), "ubiblock_devs");
...
static int ubiblock_major  ;
    klee_make_symbolic(&ubiblock_major, sizeof(int), "ubiblock_major");
...
{ 
  int ret ;
  int leb ;
    klee_make_symbolic(&leb, sizeof(int), "leb");
  int offset ;
  int bytes_left ;
    klee_make_symbolic(&bytes_left, sizeof(int), "bytes_left");
  int to_read ;
  u64 pos ;
  struct request *req ;
  struct request *tmp ;
...
{ 
  ...
  unsigned long ldvarg53 ;
    klee_make_symbolic(&ldvarg53, sizeof(long), "ldvarg53");
