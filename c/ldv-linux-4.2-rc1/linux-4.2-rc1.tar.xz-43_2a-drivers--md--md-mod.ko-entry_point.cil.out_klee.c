...
{ 
  ...
  unsigned long new_delay ;
    klee_make_symbolic(&new_delay, sizeof(long), "new_delay");
...
{ 
  int err ;
  int did_freeze ;
    klee_make_symbolic(&did_freeze, sizeof(int), "did_freeze");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
  wait_queue_t __wait ;
...
static int md_unloading  ;
    klee_make_symbolic(&md_unloading, sizeof(int), "md_unloading");
...
{ 
  ...
  unsigned long ldvarg50 ;
    klee_make_symbolic(&ldvarg50, sizeof(long), "ldvarg50");
  fmode_t ldvarg57 ;
...
{ 
  ...
  int node_offset ;
    klee_make_symbolic(&node_offset, sizeof(int), "node_offset");
  int tmp ;
  int size ;
  loff_t offset ;
  int last_page_size ;
