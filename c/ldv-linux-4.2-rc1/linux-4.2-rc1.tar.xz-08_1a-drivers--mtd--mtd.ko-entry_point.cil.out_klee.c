...
struct mtd_concat {
   struct mtd_info mtd ;
   int num_subdev ;
    klee_make_symbolic(&num_subdev, sizeof(int), "num_subdev");
...
struct blkpg_partition {
   ...
   int pno ;
    klee_make_symbolic(&pno, sizeof(int), "pno");
   char devname[64U] ;
   char volname[64U] ;
};
...
{ 
  ...
  int major ;
  int mtdnr ;
    klee_make_symbolic(&mtdnr, sizeof(int), "mtdnr");
  void *tmp ;
  struct _ddebug descriptor ;
  long tmp___0 ;
  struct mtd_info *mtd ;
...
{ 
  ...
  unsigned long entry_low ;
    klee_make_symbolic(&entry_low, sizeof(long), "entry_low");
  unsigned long entry_high ;
    klee_make_symbolic(&entry_high, sizeof(long), "entry_high");
  size_t total_len ;
  int i ;
  int err ;
  uint64_t __to ;
...
{ 
  ...
  int num_erase_region ;
    klee_make_symbolic(&num_erase_region, sizeof(int), "num_erase_region");
  int max_writebufsize ;
    klee_make_symbolic(&max_writebufsize, sizeof(int), "max_writebufsize");
  void *tmp ;
  int j ;
...
{ 
  struct mtd_part *part ;
  int ispart ;
    klee_make_symbolic(&ispart, sizeof(int), "ispart");
  struct list_head  const  *__mptr ;
  struct list_head  const  *__mptr___0 ;
