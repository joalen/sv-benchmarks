...
struct fc_rport_priv {
   ...
   unsigned int major_retries ;
    klee_make_symbolic(&major_retries, sizeof(int), "major_retries");
   unsigned int e_d_tov ;
    klee_make_symbolic(&e_d_tov, sizeof(int), "e_d_tov");
   unsigned int r_a_tov ;
    klee_make_symbolic(&r_a_tov, sizeof(int), "r_a_tov");
...
struct fc_fcp_pkt {
   ...
   struct timer_list timer ;
   int wait_for_comp ;
    klee_make_symbolic(&wait_for_comp, sizeof(int), "wait_for_comp");
   u32 recov_retry ;
...
struct fc_exch {
   ...
   struct fc_seq seq ;
   int resp_active ;
    klee_make_symbolic(&resp_active, sizeof(int), "resp_active");
...
struct fc_disc {
   unsigned char retry_count ;
    klee_make_symbolic(&retry_count, sizeof(char), "retry_count");
   unsigned char pending ;
    klee_make_symbolic(&pending, sizeof(char), "pending");
   unsigned char requested ;
    klee_make_symbolic(&requested, sizeof(char), "requested");
   unsigned short seq_count ;
    klee_make_symbolic(&seq_count, sizeof(short), "seq_count");
   unsigned char buf_len ;
    klee_make_symbolic(&buf_len, sizeof(char), "buf_len");
   u16 disc_id ;
...
struct fc_lport {
   ...
   unsigned long boot_time ;
    klee_make_symbolic(&boot_time, sizeof(long), "boot_time");
   ...
   unsigned int service_params ;
    klee_make_symbolic(&service_params, sizeof(int), "service_params");
   unsigned int e_d_tov ;
   unsigned int r_a_tov ;
   ...
   unsigned int lso_max ;
    klee_make_symbolic(&lso_max, sizeof(int), "lso_max");
...
struct fcoe_ctlr_device {
   ...
   int fcf_dev_loss_tmo ;
    klee_make_symbolic(&fcf_dev_loss_tmo, sizeof(int), "fcf_dev_loss_tmo");
...
struct fcoe_ctlr {
   ...
   unsigned long sol_time ;
    klee_make_symbolic(&sol_time, sizeof(long), "sol_time");
   unsigned long sel_time ;
    klee_make_symbolic(&sel_time, sizeof(long), "sel_time");
   unsigned long port_ka_time ;
    klee_make_symbolic(&port_ka_time, sizeof(long), "port_ka_time");
   unsigned long ctlr_ka_time ;
    klee_make_symbolic(&ctlr_ka_time, sizeof(long), "ctlr_ka_time");
   struct timer_list timer ;
...
struct bnx2fc_hba {
   ...
   int hash_tbl_segment_count ;
    klee_make_symbolic(&hash_tbl_segment_count, sizeof(int), "hash_tbl_segment_count");
   ...
   int wait_for_link_down ;
    klee_make_symbolic(&wait_for_link_down, sizeof(int), "wait_for_link_down");
   int num_ofld_sess ;
    klee_make_symbolic(&num_ofld_sess, sizeof(int), "num_ofld_sess");
   struct list_head vports ;
   char chip_num[16U] ;
};
struct bnx2fc_interface {
   ...
   unsigned long if_flags ;
    klee_make_symbolic(&if_flags, sizeof(long), "if_flags");
...
struct bnx2fc_rport {
   ...
   unsigned long retry_delay_timestamp ;
    klee_make_symbolic(&retry_delay_timestamp, sizeof(long), "retry_delay_timestamp");
...
struct bnx2fc_cmd {
   ...
   unsigned long req_flags ;
    klee_make_symbolic(&req_flags, sizeof(long), "req_flags");
   u8 rec_retry ;
   u8 srr_retry ;
   u32 srr_offset ;
   u8 srr_rctl ;
...
struct fcoe_percpu_s {
   ...
   int crc_eof_offset ;
    klee_make_symbolic(&crc_eof_offset, sizeof(int), "crc_eof_offset");
};
struct kcqe {
   u32 kcqe_info0 ;
   u32 kcqe_info1 ;
...
unsigned int bnx2fc_debug_level ;
    klee_make_symbolic(&bnx2fc_debug_level, sizeof(int), "bnx2fc_debug_level");
...
{ 
  ...
  int rc ;
  int task_idx ;
    klee_make_symbolic(&task_idx, sizeof(int), "task_idx");
  int index ;
  u32 did ;
  u32 sid ;
  u16 xid ;
...
char __pcpu_scope_bnx2fc_percpu  ;
    klee_make_symbolic(&__pcpu_scope_bnx2fc_percpu, sizeof(char), "__pcpu_scope_bnx2fc_percpu");
char __pcpu_unique_bnx2fc_percpu  ;
    klee_make_symbolic(&__pcpu_unique_bnx2fc_percpu, sizeof(char), "__pcpu_unique_bnx2fc_percpu");
...
{ 
  ...
  unsigned short oxid ;
    klee_make_symbolic(&oxid, sizeof(short), "oxid");
...
{ 
  ...
  struct fcoe_ctlr *ctlr ;
  int wait_for_upload ;
    klee_make_symbolic(&wait_for_upload, sizeof(int), "wait_for_upload");
  u32 link_possible ;
  int tmp___0 ;
  struct list_head  const  *__mptr ;
  struct list_head  const  *__mptr___0 ;
...
{ 
  int fcoe_min_xid ;
    klee_make_symbolic(&fcoe_min_xid, sizeof(int), "fcoe_min_xid");
  int fcoe_max_xid ;
    klee_make_symbolic(&fcoe_max_xid, sizeof(int), "fcoe_max_xid");
...
{ 
  ...
  int sel_san_mac ;
    klee_make_symbolic(&sel_san_mac, sizeof(int), "sel_san_mac");
...
{ 
  ...
  struct fc_lport *lport ;
  int wait_cnt ;
    klee_make_symbolic(&wait_cnt, sizeof(int), "wait_cnt");
  long tmp ;
  int tmp___0 ;
  int tmp___1 ;
  int tmp___2 ;
...
{ 
  ...
  int orig_task_idx ;
    klee_make_symbolic(&orig_task_idx, sizeof(int), "orig_task_idx");
  int index ;
  int i ;
...
{ 
  ...
  dma_addr_t addr ;
  int task_ctx_arr_sz ;
    klee_make_symbolic(&task_ctx_arr_sz, sizeof(int), "task_ctx_arr_sz");
  int i ;
  void *tmp ;
  void *tmp___0 ;
  void *tmp___1 ;
...
{ 
  int i ;
  int segment_count ;
    klee_make_symbolic(&segment_count, sizeof(int), "segment_count");
  u32 *pbl ;
  dma_addr_t dma_address ;
...
{ 
  ...
  int segment_array_size ;
    klee_make_symbolic(&segment_array_size, sizeof(int), "segment_array_size");
  int dma_segment_array_size ;
    klee_make_symbolic(&dma_segment_array_size, sizeof(int), "dma_segment_array_size");
...
{ 
  ...
  struct bnx2fc_rport *tgt ;
  int logo_issued ;
    klee_make_symbolic(&logo_issued, sizeof(int), "logo_issued");
  int rc ;
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
...
{ 
  ...
  int num_pri_ios ;
    klee_make_symbolic(&num_pri_ios, sizeof(int), "num_pri_ios");
  size_t bd_tbl_sz ;
  int arr_sz ;
    klee_make_symbolic(&arr_sz, sizeof(int), "arr_sz");
  unsigned int tmp ;
  u16 min_xid ;
  u16 max_xid ;
  long tmp___0 ;
...
{ 
  ...
  int sg_frags ;
    klee_make_symbolic(&sg_frags, sizeof(int), "sg_frags");
...
{ 
  ...
  unsigned char *dummy ;
  int fcp_sns_len ;
    klee_make_symbolic(&fcp_sns_len, sizeof(int), "fcp_sns_len");
  int fcp_rsp_len ;
    klee_make_symbolic(&fcp_rsp_len, sizeof(int), "fcp_rsp_len");
  u8 tmp ;
  char *tmp___0 ;
  char *tmp___1 ;
