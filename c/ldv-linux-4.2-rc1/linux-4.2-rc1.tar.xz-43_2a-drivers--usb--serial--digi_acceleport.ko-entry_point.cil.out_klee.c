...
struct digi_serial {
   ...
   int ds_oob_port_num ;
    klee_make_symbolic(&ds_oob_port_num, sizeof(int), "ds_oob_port_num");
   int ds_device_started ;
    klee_make_symbolic(&ds_device_started, sizeof(int), "ds_device_started");
};
struct digi_port {
   spinlock_t dp_port_lock ;
   int dp_port_num ;
    klee_make_symbolic(&dp_port_num, sizeof(int), "dp_port_num");
   int dp_out_buf_len ;
    klee_make_symbolic(&dp_out_buf_len, sizeof(int), "dp_out_buf_len");
   unsigned char dp_out_buf[8U] ;
   int dp_write_urb_in_use ;
    klee_make_symbolic(&dp_write_urb_in_use, sizeof(int), "dp_write_urb_in_use");
   unsigned int dp_modem_signals ;
    klee_make_symbolic(&dp_modem_signals, sizeof(int), "dp_modem_signals");
   int dp_transmit_idle ;
    klee_make_symbolic(&dp_transmit_idle, sizeof(int), "dp_transmit_idle");
   wait_queue_head_t dp_transmit_idle_wait ;
   int dp_throttled ;
    klee_make_symbolic(&dp_throttled, sizeof(int), "dp_throttled");
   int dp_throttle_restart ;
    klee_make_symbolic(&dp_throttle_restart, sizeof(int), "dp_throttle_restart");
...
{ 
  ...
  unsigned int old_iflag ;
    klee_make_symbolic(&old_iflag, sizeof(int), "old_iflag");
