...
struct lu_context_key {
   ...
   int lct_index ;
    klee_make_symbolic(&lct_index, sizeof(int), "lct_index");
   atomic_t lct_used ;
...
struct cl_object_header {
   ...
   unsigned long coh_pages ;
    klee_make_symbolic(&coh_pages, sizeof(long), "coh_pages");
   struct list_head coh_locks ;
   struct cl_object_header *coh_parent ;
   spinlock_t coh_attr_guard ;
   unsigned short coh_page_bufsize ;
    klee_make_symbolic(&coh_page_bufsize, sizeof(short), "coh_page_bufsize");
   unsigned char coh_nesting ;
    klee_make_symbolic(&coh_nesting, sizeof(char), "coh_nesting");
};
enum cl_page_state {
    CPS_CACHED = 0,
    CPS_OWNED = 1,
...
struct cl_lock_closure {
   ...
   int clc_wait ;
    klee_make_symbolic(&clc_wait, sizeof(int), "clc_wait");
   int clc_nr ;
    klee_make_symbolic(&clc_nr, sizeof(int), "clc_nr");
};
struct cl_lock {
   atomic_t cll_ref ;
...
struct echo_device {
   ...
   int ed_next_islov ;
    klee_make_symbolic(&ed_next_islov, sizeof(int), "ed_next_islov");
};
struct echo_object {
   ...
   atomic_t eo_npages ;
   int eo_deleted ;
    klee_make_symbolic(&eo_deleted, sizeof(int), "eo_deleted");
};
...
struct echo_session_info {
   unsigned long dummy ;
    klee_make_symbolic(&dummy, sizeof(long), "dummy");
};
...
{ 
  ...
  unsigned int cpuid___0 ;
    klee_make_symbolic(&cpuid___0, sizeof(int), "cpuid___0");
  int pscr_ret__ ;
...
{ 
  ...
  unsigned int num_cpu ;
    klee_make_symbolic(&num_cpu, sizeof(int), "num_cpu");
  unsigned long flags ;
  __u64 ret ;
...
{ 
  ...
  int tmp___0 ;
  char lost ;
    klee_make_symbolic(&lost, sizeof(char), "lost");
  struct cfs_debug_limit_state cdls ;
  struct libcfs_debug_msg_data msgdata ;
  int tmp___1 ;
...
{ 
  int lsm_size ;
    klee_make_symbolic(&lsm_size, sizeof(int), "lsm_size");
  int tmp ;
  struct libcfs_debug_msg_data __msg_data ;
  long tmp___0 ;
  void *tmp___1 ;
...
{ 
  ...
  int rc ;
  int cleanup ;
    klee_make_symbolic(&cleanup, sizeof(int), "cleanup");
  void *tmp ;
  char *tmp___0 ;
  struct libcfs_debug_msg_data __msg_data ;
  long tmp___1 ;
...
{ 
  ...
  int still_used ;
    klee_make_symbolic(&still_used, sizeof(int), "still_used");
  struct libcfs_debug_msg_data __msg_data ;
  long tmp ;
  struct list_head  const  *__mptr ;
  struct libcfs_debug_msg_data msgdata ;
...
{ 
  ...
  int page_size ;
    klee_make_symbolic(&page_size, sizeof(int), "page_size");
  int tmp___0 ;
  int refcheck ;
  int rc ;
  int i ;
...
{ 
  ...
  int nob ;
    klee_make_symbolic(&nob, sizeof(int), "nob");
  int i ;
  unsigned long tmp ;
...
{ 
  ...
  int rc ;
  int created ;
    klee_make_symbolic(&created, sizeof(int), "created");
  struct cfs_debug_limit_state cdls ;
  struct libcfs_debug_msg_data msgdata ;
  int tmp ;
  struct cfs_debug_limit_state cdls___0 ;
...
{ 
  unsigned long stripe_count ;
    klee_make_symbolic(&stripe_count, sizeof(long), "stripe_count");
  unsigned long stripe_size ;
    klee_make_symbolic(&stripe_size, sizeof(long), "stripe_size");
  unsigned long width ;
    klee_make_symbolic(&width, sizeof(long), "width");
  unsigned long woffset ;
    klee_make_symbolic(&woffset, sizeof(long), "woffset");
  int stripe_index ;
    klee_make_symbolic(&stripe_index, sizeof(int), "stripe_index");
  u64 offset ;
  uint32_t __base ;
  uint32_t __rem ;
...
{ 
  ...
  int rc ;
  int verify ;
    klee_make_symbolic(&verify, sizeof(int), "verify");
  gfp_t gfp_mask ;
  int brw_flags ;
    klee_make_symbolic(&brw_flags, sizeof(int), "brw_flags");
  __u64 tmp ;
  __u64 tmp___0 ;
  struct libcfs_debug_msg_data __msg_data ;
  long tmp___1 ;
  ...
  int vrc ;
    klee_make_symbolic(&vrc, sizeof(int), "vrc");
  __u64 tmp___19 ;
  struct libcfs_debug_msg_data __msg_data___4 ;
  long tmp___20 ;
...
{ 
  ...
  void *tmp___2 ;
  int lpages ;
    klee_make_symbolic(&lpages, sizeof(int), "lpages");
  struct libcfs_debug_msg_data __msg_data ;
  long tmp___3 ;
  struct page *page ;
  __u64 tmp___4 ;
...
{ 
  ...
  int rc ;
  int async ;
    klee_make_symbolic(&async, sizeof(int), "async");
  long test_mode ;
    klee_make_symbolic(&test_mode, sizeof(long), "test_mode");
  struct libcfs_debug_msg_data __msg_data ;
  long tmp___1 ;
