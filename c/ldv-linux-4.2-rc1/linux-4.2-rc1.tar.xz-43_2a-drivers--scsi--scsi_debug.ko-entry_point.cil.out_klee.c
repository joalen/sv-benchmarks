...
struct sdebug_hrtimer {
   struct hrtimer hrt ;
   int qa_indx ;
    klee_make_symbolic(&qa_indx, sizeof(int), "qa_indx");
};
...
static unsigned int sdebug_store_sectors  ;
    klee_make_symbolic(&sdebug_store_sectors, sizeof(int), "sdebug_store_sectors");
static sector_t sdebug_capacity  ;
static int sdebug_heads  ;
    klee_make_symbolic(&sdebug_heads, sizeof(int), "sdebug_heads");
static int sdebug_cylinders_per  ;
    klee_make_symbolic(&sdebug_cylinders_per, sizeof(int), "sdebug_cylinders_per");
static int sdebug_sectors_per  ;
    klee_make_symbolic(&sdebug_sectors_per, sizeof(int), "sdebug_sectors_per");
...
static unsigned long map_size  ;
    klee_make_symbolic(&map_size, sizeof(long), "map_size");
static int num_aborts  ;
    klee_make_symbolic(&num_aborts, sizeof(int), "num_aborts");
static int num_dev_resets  ;
    klee_make_symbolic(&num_dev_resets, sizeof(int), "num_dev_resets");
static int num_target_resets  ;
    klee_make_symbolic(&num_target_resets, sizeof(int), "num_target_resets");
static int num_bus_resets  ;
    klee_make_symbolic(&num_bus_resets, sizeof(int), "num_bus_resets");
static int num_host_resets  ;
    klee_make_symbolic(&num_host_resets, sizeof(int), "num_host_resets");
static int dix_writes  ;
    klee_make_symbolic(&dix_writes, sizeof(int), "dix_writes");
static int dix_reads  ;
    klee_make_symbolic(&dix_reads, sizeof(int), "dix_reads");
static int dif_errors  ;
    klee_make_symbolic(&dif_errors, sizeof(int), "dif_errors");
...
{ 
  ...
  int asc ;
    klee_make_symbolic(&asc, sizeof(int), "asc");
...
{ 
  ...
  int port_a ;
  int port_b ;
    klee_make_symbolic(&port_b, sizeof(int), "port_b");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
  int tmp___2 ;
...
{ 
  unsigned int gran ;
    klee_make_symbolic(&gran, sizeof(int), "gran");
...
{ 
  unsigned char pq_pdt ;
    klee_make_symbolic(&pq_pdt, sizeof(char), "pq_pdt");
  unsigned char *arr ;
  unsigned char *cmd ;
  int alloc_len ;
  ...
  void *tmp ;
  int lu_id_num ;
    klee_make_symbolic(&lu_id_num, sizeof(int), "lu_id_num");
  int port_group_id ;
    klee_make_symbolic(&port_group_id, sizeof(int), "port_group_id");
  int target_dev_id ;
    klee_make_symbolic(&target_dev_id, sizeof(int), "target_dev_id");
  int len ;
  char lu_id_str[6U] ;
  int host_no ;
  int tmp___0 ;
...
{ 
  unsigned char *cmd ;
  int power_cond ;
    klee_make_symbolic(&power_cond, sizeof(int), "power_cond");
  int start ;
...
{ 
  ...
  unsigned int capac ;
    klee_make_symbolic(&capac, sizeof(int), "capac");
  int tmp ;
...
{ 
  ...
  int port_group_a ;
    klee_make_symbolic(&port_group_a, sizeof(int), "port_group_a");
  int port_group_b ;
    klee_make_symbolic(&port_group_b, sizeof(int), "port_group_b");
  int port_a ;
  int port_b ;
  void *tmp ;
  int tmp___0 ;
...
{ 
  ...
  int len ;
  int errsts ;
    klee_make_symbolic(&errsts, sizeof(int), "errsts");
  int count ;
  int bump ;
    klee_make_symbolic(&bump, sizeof(int), "bump");
  int na ;
    klee_make_symbolic(&na, sizeof(int), "na");
...
{ 
  unsigned char dbd ;
    klee_make_symbolic(&dbd, sizeof(char), "dbd");
  unsigned char llbaa ;
    klee_make_symbolic(&llbaa, sizeof(char), "llbaa");
  int pcontrol ;
    klee_make_symbolic(&pcontrol, sizeof(int), "pcontrol");
  int pcode ;
    klee_make_symbolic(&pcode, sizeof(int), "pcode");
  int subpcode ;
    klee_make_symbolic(&subpcode, sizeof(int), "subpcode");
  int bd_len ;
    klee_make_symbolic(&bd_len, sizeof(int), "bd_len");
  unsigned char dev_spec ;
    klee_make_symbolic(&dev_spec, sizeof(char), "dev_spec");
  int k ;
  int alloc_len ;
  int msense_6 ;
    klee_make_symbolic(&msense_6, sizeof(int), "msense_6");
  int offset ;
  int len ;
  int target_dev_id ;
  int target ;
...
{ 
  ...
  int md_len ;
    klee_make_symbolic(&md_len, sizeof(int), "md_len");
  int bd_len ;
  int off ;
    klee_make_symbolic(&off, sizeof(int), "off");
  int spf ;
    klee_make_symbolic(&spf, sizeof(int), "spf");
  int pg_len ;
  ...
  int mpage ;
    klee_make_symbolic(&mpage, sizeof(int), "mpage");
  unsigned char arr[512U] ;
  unsigned char *cmd ;
  int mselect6 ;
    klee_make_symbolic(&mselect6, sizeof(int), "mselect6");
...
{ 
  int ppc ;
    klee_make_symbolic(&ppc, sizeof(int), "ppc");
  int sp ;
  int pcontrol ;
  int pcode ;
  int subpcode ;
...
{ 
  ...
  int prot_ret ;
    klee_make_symbolic(&prot_ret, sizeof(int), "prot_ret");
  int tmp___6 ;
...
{ 
  ...
  sector_t sector ;
  int ppage_offset ;
    klee_make_symbolic(&ppage_offset, sizeof(int), "ppage_offset");
  int dpage_offset ;
    klee_make_symbolic(&dpage_offset, sizeof(int), "dpage_offset");
...
{ 
  ...
  int lun_cnt ;
    klee_make_symbolic(&lun_cnt, sizeof(int), "lun_cnt");
  int i ;
  int upper ;
    klee_make_symbolic(&upper, sizeof(int), "upper");
  int num ;
  int n ;
  int want_wlun ;
    klee_make_symbolic(&want_wlun, sizeof(int), "want_wlun");
  int shortish ;
    klee_make_symbolic(&shortish, sizeof(int), "shortish");
  u64 lun ;
  unsigned char *cmd ;
  int select_report ;
    klee_make_symbolic(&select_report, sizeof(int), "select_report");
...
{ 
  int qa_indx ;
  int retiring ;
    klee_make_symbolic(&retiring, sizeof(int), "retiring");
  unsigned long iflags ;
...
{ 
  ...
  int r_qmax ;
    klee_make_symbolic(&r_qmax, sizeof(int), "r_qmax");
  struct sdebug_queued_cmd *sqcp ;
  struct sdebug_dev_info *devip ;
  int tmp ;
...
{ 
  ...
  int sectors_per_part ;
    klee_make_symbolic(&sectors_per_part, sizeof(int), "sectors_per_part");
  int num_sectors ;
    klee_make_symbolic(&num_sectors, sizeof(int), "num_sectors");
  int k ;
  int heads_by_sects ;
    klee_make_symbolic(&heads_by_sects, sizeof(int), "heads_by_sects");
  int start_sec ;
    klee_make_symbolic(&start_sec, sizeof(int), "start_sec");
  int end_sec ;
    klee_make_symbolic(&end_sec, sizeof(int), "end_sec");
...
{ 
  ...
  int k ;
  int num_in_q ;
    klee_make_symbolic(&num_in_q, sizeof(int), "num_in_q");
  int qdepth ;
    klee_make_symbolic(&qdepth, sizeof(int), "qdepth");
  int inject ;
    klee_make_symbolic(&inject, sizeof(int), "inject");
  struct sdebug_queued_cmd *sqcp ;
  struct scsi_device *sdp ;
  int tmp ;
  long ret ;
...
{ 
  ...
  int minLen ;
    klee_make_symbolic(&minLen, sizeof(int), "minLen");
  bool tmp ;
  int tmp___0 ;
  bool tmp___1 ;
  int tmp___2 ;
...
{ 
  unsigned long iflags ;
  int ndelay ;
    klee_make_symbolic(&ndelay, sizeof(int), "ndelay");
  int res ;
  int k ;
  unsigned long tmp ;
  int tmp___0 ;
...
{ 
  int nth ;
    klee_make_symbolic(&nth, sizeof(int), "nth");
  int tmp ;
...
{ 
  int delta_hosts ;
    klee_make_symbolic(&delta_hosts, sizeof(int), "delta_hosts");
  int tmp ;
...
{ 
  unsigned long sz ;
  int host_to_add ;
    klee_make_symbolic(&host_to_add, sizeof(int), "host_to_add");
  int k ;
  int ret ;
  void *tmp ;
  int dif_size ;
    klee_make_symbolic(&dif_size, sizeof(int), "dif_size");
  void *tmp___0 ;
  unsigned int _min1 ;
  unsigned int _max1 ;
...
{ 
  int k ;
  int devs_per_host ;
    klee_make_symbolic(&devs_per_host, sizeof(int), "devs_per_host");
  int error ;
...
{ 
  ...
  int errsts_no_connect ;
    klee_make_symbolic(&errsts_no_connect, sizeof(int), "errsts_no_connect");
  u32 flags ;
  u16 sa ;
  u8 opcode ;
  bool has_wlun_rl ;
...
{ 
  ...
  struct Scsi_Host *hpnt ;
  int host_prot ;
    klee_make_symbolic(&host_prot, sizeof(int), "host_prot");
  struct device  const  *__mptr ;
