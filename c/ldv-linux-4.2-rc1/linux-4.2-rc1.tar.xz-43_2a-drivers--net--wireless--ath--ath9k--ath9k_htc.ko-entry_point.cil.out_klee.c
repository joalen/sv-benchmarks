...
struct ath_dynack {
   bool enabled ;
   int ackto ;
    klee_make_symbolic(&ackto, sizeof(int), "ackto");
   unsigned long lto ;
    klee_make_symbolic(&lto, sizeof(long), "lto");
...
struct ath9k_htc_priv {
   ...
   unsigned long fw_flags ;
    klee_make_symbolic(&fw_flags, sizeof(long), "fw_flags");
   struct ath9k_hw_cal_data caldata ;
...
{ 
  ...
  void *tmp___26 ;
  int ldvarg103 ;
    klee_make_symbolic(&ldvarg103, sizeof(int), "ldvarg103");
...
int ath9k_htc_led_blink ;
    klee_make_symbolic(&ath9k_htc_led_blink, sizeof(int), "ath9k_htc_led_blink");
