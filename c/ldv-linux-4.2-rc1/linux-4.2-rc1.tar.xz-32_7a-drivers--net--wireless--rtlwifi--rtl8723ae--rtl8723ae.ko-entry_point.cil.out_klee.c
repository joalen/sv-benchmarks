...
{ 
  ...
  long tmp___92 ;
    klee_make_symbolic(&tmp___92, sizeof(long), "tmp___92");
  unsigned long __ms ;
...
{ 
  ...
  long undecoratedsmoothed_pwdb ;
    klee_make_symbolic(&undecoratedsmoothed_pwdb, sizeof(long), "undecoratedsmoothed_pwdb");
  u8 bt_rssi_state ;
  int tmp ;
  int tmp___0 ;
  long tmp___1 ;
...
{ 
  ...
  long reg_eac ;
    klee_make_symbolic(&reg_eac, sizeof(long), "reg_eac");
  long reg_eb4 ;
    klee_make_symbolic(&reg_eb4, sizeof(long), "reg_eb4");
  long reg_ebc ;
    klee_make_symbolic(&reg_ebc, sizeof(long), "reg_ebc");
  long reg_ec4 ;
    klee_make_symbolic(&reg_ec4, sizeof(long), "reg_ec4");
  long reg_ecc ;
    klee_make_symbolic(&reg_ecc, sizeof(long), "reg_ecc");
  long reg_tmp ;
