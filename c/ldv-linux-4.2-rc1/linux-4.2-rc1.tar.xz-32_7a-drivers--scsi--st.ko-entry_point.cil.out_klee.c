...
struct scsi_tape {
   ...
   unsigned char write_pending ;
    klee_make_symbolic(&write_pending, sizeof(char), "write_pending");
   int nbr_finished ;
    klee_make_symbolic(&nbr_finished, sizeof(int), "nbr_finished");
   int nbr_waits ;
    klee_make_symbolic(&nbr_waits, sizeof(int), "nbr_waits");
   int nbr_requests ;
    klee_make_symbolic(&nbr_requests, sizeof(int), "nbr_requests");
   int nbr_dio ;
    klee_make_symbolic(&nbr_dio, sizeof(int), "nbr_dio");
   int nbr_pages ;
    klee_make_symbolic(&nbr_pages, sizeof(int), "nbr_pages");
...
static int debug_flag  ;
    klee_make_symbolic(&debug_flag, sizeof(int), "debug_flag");
...
{ 
  ...
  unsigned long ldvarg33 ;
    klee_make_symbolic(&ldvarg33, sizeof(long), "ldvarg33");
