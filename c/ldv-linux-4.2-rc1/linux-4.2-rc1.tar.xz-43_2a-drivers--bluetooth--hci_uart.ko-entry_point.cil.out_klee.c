...
struct discovery_state {
   ...
   unsigned long scan_duration ;
    klee_make_symbolic(&scan_duration, sizeof(long), "scan_duration");
};
struct hci_conn_hash {
   ...
   unsigned int amp_num ;
    klee_make_symbolic(&amp_num, sizeof(int), "amp_num");
   unsigned int sco_num ;
    klee_make_symbolic(&sco_num, sizeof(int), "sco_num");
   unsigned int le_num ;
    klee_make_symbolic(&le_num, sizeof(int), "le_num");
   unsigned int le_num_slave ;
    klee_make_symbolic(&le_num_slave, sizeof(int), "le_num_slave");
};
struct amp_assoc {
   __u16 len ;
   __u16 offset ;
...
struct hci_dev {
   ...
   unsigned int adv_instance_cnt ;
    klee_make_symbolic(&adv_instance_cnt, sizeof(int), "adv_instance_cnt");
...
struct hci_uart_proto {
   ...
   unsigned int init_speed ;
    klee_make_symbolic(&init_speed, sizeof(int), "init_speed");
   unsigned int oper_speed ;
    klee_make_symbolic(&oper_speed, sizeof(int), "oper_speed");
...
struct hci_uart {
   ...
   unsigned long hdev_flags ;
    klee_make_symbolic(&hdev_flags, sizeof(long), "hdev_flags");
   ...
   unsigned long tx_state ;
    klee_make_symbolic(&tx_state, sizeof(long), "tx_state");
   spinlock_t rx_lock ;
   unsigned int init_speed ;
   unsigned int oper_speed ;
};
...
struct bcsp_struct {
   ...
   unsigned long rx_count ;
    klee_make_symbolic(&rx_count, sizeof(long), "rx_count");
   struct sk_buff *rx_skb ;
   u8 rxseq_txack ;
   u8 rxack ;
...
struct ll_struct {
   unsigned long rx_state ;
    klee_make_symbolic(&rx_state, sizeof(long), "rx_state");
   unsigned long rx_count ;
   struct sk_buff *rx_skb ;
   struct sk_buff_head txq ;
   spinlock_t hcill_lock ;
   unsigned long hcill_state ;
    klee_make_symbolic(&hcill_state, sizeof(long), "hcill_state");
...
struct ath_struct {
   ...
   unsigned int cur_sleep ;
    klee_make_symbolic(&cur_sleep, sizeof(int), "cur_sleep");
   struct sk_buff *rx_skb ;
   struct sk_buff_head txq ;
...
{ 
  unsigned long valid_flags ;
    klee_make_symbolic(&valid_flags, sizeof(long), "valid_flags");
...
{ 
  char pkt_delim ;
    klee_make_symbolic(&pkt_delim, sizeof(char), "pkt_delim");
  unsigned char *tmp ;
...
{ 
  ...
  int pkts_to_be_removed ;
    klee_make_symbolic(&pkts_to_be_removed, sizeof(int), "pkts_to_be_removed");
  u8 seqno ;
  __u32 tmp___0 ;
  struct _ddebug descriptor ;
  __u32 tmp___1 ;
...
{ 
  struct bcsp_struct *bcsp___0 ;
  int pass_up ;
    klee_make_symbolic(&pass_up, sizeof(int), "pass_up");
  struct _ddebug descriptor ;
  long tmp ;
  struct _ddebug descriptor___0 ;
  long tmp___0 ;
...
{ 
  ...
  int i ;
  int to_remove ;
    klee_make_symbolic(&to_remove, sizeof(int), "to_remove");
  u8 seq ;
  __u32 tmp___0 ;
  int tmp___1 ;
  int tmp___2 ;
...
{ 
  char delim ;
    klee_make_symbolic(&delim, sizeof(char), "delim");
  unsigned char *tmp ;
