...
struct dm_target {
   ...
   unsigned int num_flush_bios ;
    klee_make_symbolic(&num_flush_bios, sizeof(int), "num_flush_bios");
   unsigned int num_discard_bios ;
    klee_make_symbolic(&num_discard_bios, sizeof(int), "num_discard_bios");
   unsigned int num_write_same_bios ;
    klee_make_symbolic(&num_write_same_bios, sizeof(int), "num_write_same_bios");
   unsigned int per_bio_data_size ;
    klee_make_symbolic(&per_bio_data_size, sizeof(int), "per_bio_data_size");
...
{ 
  ...
  unsigned short tmp___0 ;
    klee_make_symbolic(&tmp___0, sizeof(short), "tmp___0");
...
{ 
  int i ;
  int rebuild ;
    klee_make_symbolic(&rebuild, sizeof(int), "rebuild");
  int metadata_available ;
    klee_make_symbolic(&metadata_available, sizeof(int), "metadata_available");
  int ret ;
...
{ 
  unsigned long min_region_size ;
    klee_make_symbolic(&min_region_size, sizeof(long), "min_region_size");
  int tmp ;
  bool tmp___0 ;
  int tmp___1 ;
...
{ 
  ...
  unsigned int rebuild_cnt ;
    klee_make_symbolic(&rebuild_cnt, sizeof(int), "rebuild_cnt");
  unsigned int rebuilds_per_group ;
    klee_make_symbolic(&rebuilds_per_group, sizeof(int), "rebuilds_per_group");
  unsigned int copies ;
    klee_make_symbolic(&copies, sizeof(int), "copies");
  unsigned int d ;
    klee_make_symbolic(&d, sizeof(int), "d");
  unsigned int group_size ;
    klee_make_symbolic(&group_size, sizeof(int), "group_size");
  unsigned int last_group_start ;
    klee_make_symbolic(&last_group_start, sizeof(int), "last_group_start");
  int tmp ;
  int tmp___0 ;
  char *tmp___1 ;
  int tmp___2 ;
...
{ 
  ...
  unsigned int raid10_copies ;
    klee_make_symbolic(&raid10_copies, sizeof(int), "raid10_copies");
  unsigned int i ;
  unsigned long value ;
  unsigned long region_size ;
    klee_make_symbolic(&region_size, sizeof(long), "region_size");
...
{ 
  ...
  unsigned long num_raid_params ;
    klee_make_symbolic(&num_raid_params, sizeof(long), "num_raid_params");
  unsigned long num_raid_devs ;
    klee_make_symbolic(&num_raid_devs, sizeof(long), "num_raid_devs");
  struct raid_set *rs ;
  int tmp ;
  int tmp___0 ;
  long tmp___1 ;
...
{ 
  ...
  unsigned int raid_param_cnt ;
    klee_make_symbolic(&raid_param_cnt, sizeof(int), "raid_param_cnt");
  unsigned int sz ;
    klee_make_symbolic(&sz, sizeof(int), "sz");
  int i ;
  int array_in_sync ;
    klee_make_symbolic(&array_in_sync, sizeof(int), "array_in_sync");
  sector_t sync ;
  int tmp ;
  unsigned int tmp___0 ;
  int tmp___1 ;
