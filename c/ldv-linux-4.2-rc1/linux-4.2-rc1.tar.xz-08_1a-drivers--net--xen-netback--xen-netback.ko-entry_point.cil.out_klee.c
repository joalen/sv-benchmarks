...
typedef unsigned int pending_ring_idx_t;
    klee_make_symbolic(&pending_ring_idx_t, sizeof(int), "pending_ring_idx_t");
...
struct xenvif_stats {
   ...
   unsigned long tx_zerocopy_sent ;
    klee_make_symbolic(&tx_zerocopy_sent, sizeof(long), "tx_zerocopy_sent");
   unsigned long tx_zerocopy_success ;
    klee_make_symbolic(&tx_zerocopy_success, sizeof(long), "tx_zerocopy_success");
   unsigned long tx_zerocopy_fail ;
    klee_make_symbolic(&tx_zerocopy_fail, sizeof(long), "tx_zerocopy_fail");
   unsigned long tx_frag_overflow ;
    klee_make_symbolic(&tx_frag_overflow, sizeof(long), "tx_frag_overflow");
};
struct xenvif_queue {
   unsigned int id ;
   char name[21U] ;
   ...
   unsigned int rx_queue_max ;
    klee_make_symbolic(&rx_queue_max, sizeof(int), "rx_queue_max");
   unsigned int rx_queue_len ;
    klee_make_symbolic(&rx_queue_len, sizeof(int), "rx_queue_len");
   unsigned long last_rx_time ;
    klee_make_symbolic(&last_rx_time, sizeof(long), "last_rx_time");
   bool stalled ;
   struct gnttab_copy grant_copy_op[4352U] ;
   struct xenvif_rx_meta meta[256U] ;
   unsigned long credit_bytes ;
    klee_make_symbolic(&credit_bytes, sizeof(long), "credit_bytes");
   unsigned long credit_usec ;
    klee_make_symbolic(&credit_usec, sizeof(long), "credit_usec");
   unsigned long remaining_credit ;
    klee_make_symbolic(&remaining_credit, sizeof(long), "remaining_credit");
...
struct xenvif {
   ...
   u8 fe_dev_addr[6U] ;
   int gso_mask ;
    klee_make_symbolic(&gso_mask, sizeof(int), "gso_mask");
   int gso_prefix_mask ;
    klee_make_symbolic(&gso_prefix_mask, sizeof(int), "gso_prefix_mask");
   ...
   unsigned long drain_timeout ;
    klee_make_symbolic(&drain_timeout, sizeof(long), "drain_timeout");
   unsigned long stall_timeout ;
    klee_make_symbolic(&stall_timeout, sizeof(long), "stall_timeout");
   struct xenvif_queue *queues ;
   unsigned int num_queues ;
    klee_make_symbolic(&num_queues, sizeof(int), "num_queues");
   unsigned int stalled_queues ;
    klee_make_symbolic(&stalled_queues, sizeof(int), "stalled_queues");
...
struct xenvif_rx_cb {
   unsigned long expires ;
   int meta_slots_used ;
    klee_make_symbolic(&meta_slots_used, sizeof(int), "meta_slots_used");
};
struct page_counter {
   atomic_long_t count ;
   unsigned long limit ;
...
struct netrx_pending_operations {
   unsigned int copy_prod ;
    klee_make_symbolic(&copy_prod, sizeof(int), "copy_prod");
   unsigned int copy_cons ;
    klee_make_symbolic(&copy_cons, sizeof(int), "copy_cons");
   unsigned int meta_prod ;
    klee_make_symbolic(&meta_prod, sizeof(int), "meta_prod");
   unsigned int meta_cons ;
    klee_make_symbolic(&meta_cons, sizeof(int), "meta_cons");
   struct gnttab_copy *copy ;
   struct xenvif_rx_meta *meta ;
   int copy_off ;
    klee_make_symbolic(&copy_off, sizeof(int), "copy_off");
...
unsigned int rx_drain_timeout_msecs ;
    klee_make_symbolic(&rx_drain_timeout_msecs, sizeof(int), "rx_drain_timeout_msecs");
unsigned int rx_stall_timeout_msecs ;
    klee_make_symbolic(&rx_stall_timeout_msecs, sizeof(int), "rx_stall_timeout_msecs");
unsigned int xenvif_max_queues  ;
    klee_make_symbolic(&xenvif_max_queues, sizeof(int), "xenvif_max_queues");
...
{ 
  ...
  int old_meta_prod ;
    klee_make_symbolic(&old_meta_prod, sizeof(int), "old_meta_prod");
  int gso_type ;
...
{ 
  ...
  unsigned int req___0 ;
    klee_make_symbolic(&req___0, sizeof(int), "req___0");
  unsigned int rsp___0 ;
    klee_make_symbolic(&rsp___0, sizeof(int), "rsp___0");
...
{ 
  ...
  unsigned long max_credit ;
    klee_make_symbolic(&max_credit, sizeof(long), "max_credit");
  unsigned long _min1 ;
...
{ 
  ...
  int drop_err ;
    klee_make_symbolic(&drop_err, sizeof(int), "drop_err");
  int more_data ;
    klee_make_symbolic(&more_data, sizeof(int), "more_data");
...
{ 
  ...
  unsigned int frag_overflow ;
    klee_make_symbolic(&frag_overflow, sizeof(int), "frag_overflow");
  long tmp___0 ;
  u16 tmp___1 ;
...
{ 
  ...
  int newerr ;
    klee_make_symbolic(&newerr, sizeof(int), "newerr");
  long tmp___5 ;
  long tmp___6 ;
  struct _ddebug descriptor___0 ;
  long tmp___7 ;
...
{ 
  unsigned int nr_mops ;
    klee_make_symbolic(&nr_mops, sizeof(int), "nr_mops");
  unsigned int nr_cops ;
    klee_make_symbolic(&nr_cops, sizeof(int), "nr_cops");
  int work_done ;
  int ret ;
  int tmp ;
  long tmp___0 ;
...
{ 
  ...
  int err ;
  int sg ;
    klee_make_symbolic(&sg, sizeof(int), "sg");
  char const   *script ;
  struct backend_info *be ;
  void *tmp ;
  struct xenbus_transaction __constr_expr_0 ;
...
{ 
  ...
  unsigned long b ;
  unsigned long u ;
    klee_make_symbolic(&u, sizeof(long), "u");
  char *ratestr ;
  struct xenbus_transaction __constr_expr_0 ;
  void *tmp ;
  bool tmp___0 ;
...
{ 
  ...
  unsigned int requested_num_queues ;
    klee_make_symbolic(&requested_num_queues, sizeof(int), "requested_num_queues");
  struct xenvif_queue *queue ;
  struct xenbus_transaction __constr_expr_0 ;
  void *tmp ;
...
{ 
  ...
  unsigned long tx_ring_ref ;
    klee_make_symbolic(&tx_ring_ref, sizeof(long), "tx_ring_ref");
  unsigned long rx_ring_ref ;
    klee_make_symbolic(&rx_ring_ref, sizeof(long), "rx_ring_ref");
...
{ 
  ...
  unsigned int queue_index ;
  unsigned long accum ;
    klee_make_symbolic(&accum, sizeof(long), "accum");
  void *vif_stats ;
