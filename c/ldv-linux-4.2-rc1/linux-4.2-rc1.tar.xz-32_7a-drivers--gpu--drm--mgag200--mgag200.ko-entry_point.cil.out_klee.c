...
struct mga_crtc {
   ...
   u8 lut_b[256U] ;
   int last_dpms ;
    klee_make_symbolic(&last_dpms, sizeof(int), "last_dpms");
   bool enabled ;
};
...
struct mga_device {
   ...
   enum mga_type type ;
   int has_sdram ;
    klee_make_symbolic(&has_sdram, sizeof(int), "has_sdram");
   struct drm_display_mode mode ;
   int bpp_shifts[4U] ;
   int fb_mtrr ;
...
{ 
  int offset ;
  int orig ;
    klee_make_symbolic(&orig, sizeof(int), "orig");
  int test1 ;
    klee_make_symbolic(&test1, sizeof(int), "test1");
  int test2 ;
    klee_make_symbolic(&test2, sizeof(int), "test2");
  int orig1 ;
    klee_make_symbolic(&orig1, sizeof(int), "orig1");
  int orig2 ;
    klee_make_symbolic(&orig2, sizeof(int), "orig2");
  unsigned int tmp ;
...
{ 
  ...
  unsigned long __y___0 ;
    klee_make_symbolic(&__y___0, sizeof(long), "__y___0");
...
{ 
  ...
  unsigned int pllreffreq ;
    klee_make_symbolic(&pllreffreq, sizeof(int), "pllreffreq");
  unsigned int delta ;
    klee_make_symbolic(&delta, sizeof(int), "delta");
  unsigned int tmpdelta ;
    klee_make_symbolic(&tmpdelta, sizeof(int), "tmpdelta");
  unsigned int permitteddelta ;
    klee_make_symbolic(&permitteddelta, sizeof(int), "permitteddelta");
  unsigned int testp ;
    klee_make_symbolic(&testp, sizeof(int), "testp");
  unsigned int testm ;
    klee_make_symbolic(&testm, sizeof(int), "testm");
  unsigned int testn ;
    klee_make_symbolic(&testn, sizeof(int), "testn");
  unsigned int p ;
  unsigned int m ;
  ...
  unsigned int computed ;
    klee_make_symbolic(&computed, sizeof(int), "computed");
...
{ 
  ...
  int tmpcount ;
    klee_make_symbolic(&tmpcount, sizeof(int), "tmpcount");
  int vcount ;
    klee_make_symbolic(&vcount, sizeof(int), "vcount");
  bool pll_locked ;
  u8 tmp ;
  unsigned int tmp___0 ;
  unsigned int tmp___1 ;
...
{ 
  ...
  unsigned int tmpdelta ;
  int testr ;
    klee_make_symbolic(&testr, sizeof(int), "testr");
  int testn ;
  int testm ;
  int testo ;
    klee_make_symbolic(&testo, sizeof(int), "testo");
  unsigned int p ;
  unsigned int m ;
  unsigned int n ;
  unsigned int computed ;
  unsigned int vco ;
    klee_make_symbolic(&vco, sizeof(int), "vco");
  int tmp ;
...
{ 
  ...
  u8 tmp ;
  int iter_max ;
    klee_make_symbolic(&iter_max, sizeof(int), "iter_max");
  unsigned int tmp___0 ;
  unsigned int tmp___1 ;
  unsigned int tmp___2 ;
  unsigned int tmp___3 ;
...
{ 
  ...
  int option ;
  int option2 ;
    klee_make_symbolic(&option2, sizeof(int), "option2");
  int i ;
  unsigned char misc ;
...
{ 
  ...
  bool ldvarg66 ;
  int ldvarg67 ;
    klee_make_symbolic(&ldvarg67, sizeof(int), "ldvarg67");
  uint32_t ldvarg65 ;
  int tmp ;
...
{ 
  ...
  bool found ;
  int colour_count ;
    klee_make_symbolic(&colour_count, sizeof(int), "colour_count");
  u64 gpu_addr ;
  u8 reg_index ;
  u8 this_row[48U] ;
  long tmp ;
