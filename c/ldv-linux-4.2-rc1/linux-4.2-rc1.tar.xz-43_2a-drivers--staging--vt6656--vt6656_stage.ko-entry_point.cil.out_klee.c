...
struct vnt_private {
   ...
   u32 rx_buf_sz ;
   int mc_list_count ;
    klee_make_symbolic(&mc_list_count, sizeof(int), "mc_list_count");
   spinlock_t lock ;
   ...
   u32 current_rssi ;
   int tx_rx_ant_inv ;
    klee_make_symbolic(&tx_rx_ant_inv, sizeof(int), "tx_rx_ant_inv");
   u32 rx_antenna_sel ;
   u8 rx_antenna_mode ;
   u8 tx_antenna_mode ;
   u8 radio_ctl ;
   ...
   int short_slot_time ;
    klee_make_symbolic(&short_slot_time, sizeof(int), "short_slot_time");
   u16 current_aid ;
   u16 seq_counter ;
   ...
   u32 free_cmd_queue ;
   int cmd_running ;
    klee_make_symbolic(&cmd_running, sizeof(int), "cmd_running");
   unsigned long key_entry_inuse ;
    klee_make_symbolic(&key_entry_inuse, sizeof(long), "key_entry_inuse");
   u8 auto_fb_ctrl ;
   u8 bb_vga[4U] ;
   u8 bb_pre_ed_rssi ;
   u8 bb_pre_ed_index ;
...
{ 
  unsigned int frame_time ;
    klee_make_symbolic(&frame_time, sizeof(int), "frame_time");
...
{ 
  ...
  u32 tmp ;
  int ext_bit ;
    klee_make_symbolic(&ext_bit, sizeof(int), "ext_bit");
  u8 preamble_type ;
...
{ 
  ...
  u8 rate[12U] ;
  long rx_dbm ;
    klee_make_symbolic(&rx_dbm, sizeof(long), "rx_dbm");
  struct _ddebug descriptor ;
  long tmp ;
  struct _ddebug descriptor___0 ;
  long tmp___0 ;
