...
typedef int ahc_feature;
    klee_make_symbolic(&ahc_feature, sizeof(int), "ahc_feature");
enum ldv_27844 {
    AHC_BUGNONE = 0,
...
typedef int scb_flag;
    klee_make_symbolic(&scb_flag, sizeof(int), "scb_flag");
...
struct ahc_syncrate {
   u_int sxfr_u2 ;
    klee_make_symbolic(&sxfr_u2, sizeof(int), "sxfr_u2");
   u_int sxfr ;
...
struct ahc_softc {
   ...
   u_int untagged_queue_lock ;
    klee_make_symbolic(&untagged_queue_lock, sizeof(int), "untagged_queue_lock");
   ...
   char channel ;
   char channel_b ;
    klee_make_symbolic(&channel_b, sizeof(char), "channel_b");
   uint8_t our_id ;
   uint8_t our_id_b ;
   int unsolicited_ints ;
    klee_make_symbolic(&unsolicited_ints, sizeof(int), "unsolicited_ints");
   ...
   u_int pci_target_perr_count ;
    klee_make_symbolic(&pci_target_perr_count, sizeof(int), "pci_target_perr_count");
   u_int instruction_ram_size ;
    klee_make_symbolic(&instruction_ram_size, sizeof(int), "instruction_ram_size");
   char const   *description ;
   char *name ;
   int unit ;
   ...
   int seltime_b ;
    klee_make_symbolic(&seltime_b, sizeof(int), "seltime_b");
...
struct seeprom_descriptor {
   ...
   u_int sd_control_offset ;
    klee_make_symbolic(&sd_control_offset, sizeof(int), "sd_control_offset");
   u_int sd_status_offset ;
    klee_make_symbolic(&sd_status_offset, sizeof(int), "sd_status_offset");
   u_int sd_dataout_offset ;
    klee_make_symbolic(&sd_dataout_offset, sizeof(int), "sd_dataout_offset");
...
u_int aic7xxx_verbose ;
    klee_make_symbolic(&aic7xxx_verbose, sizeof(int), "aic7xxx_verbose");
...
{ 
  ...
  u_int saved_tag ;
    klee_make_symbolic(&saved_tag, sizeof(int), "saved_tag");
  uint32_t tmp ;
...
{ 
  ...
  u_int modnext ;
    klee_make_symbolic(&modnext, sizeof(int), "modnext");
  char *tmp ;
...
{ 
  ...
  uint8_t tmp___24 ;
  u_int rejbyte ;
    klee_make_symbolic(&rejbyte, sizeof(int), "rejbyte");
  uint8_t tmp___25 ;
  char *tmp___26 ;
  u_int lastphase ;
  ...
  struct scb *scb___1 ;
  u_int scb_index___1 ;
    klee_make_symbolic(&scb_index___1, sizeof(int), "scb_index___1");
  uint8_t tmp___39 ;
  uint8_t tmp___40 ;
  uint8_t tmp___41 ;
  u_int scbindex ;
  ...
  uint8_t tmp___47 ;
  u_int dscommand1 ;
    klee_make_symbolic(&dscommand1, sizeof(int), "dscommand1");
  uint8_t tmp___48 ;
  u_int scbindex___0 ;
    klee_make_symbolic(&scbindex___0, sizeof(int), "scbindex___0");
  char *tmp___49 ;
  uint8_t tmp___50 ;
  char *tmp___51 ;
  u_int scbptr ;
    klee_make_symbolic(&scbptr, sizeof(int), "scbptr");
  uint8_t tmp___52 ;
  uint8_t tmp___53 ;
  char *tmp___54 ;
  uint8_t tmp___55 ;
...
{ 
  ...
  struct scb *scb ;
  char cur_channel ;
    klee_make_symbolic(&cur_channel, sizeof(char), "cur_channel");
  char intr_channel ;
    klee_make_symbolic(&intr_channel, sizeof(char), "intr_channel");
  uint8_t tmp ;
  uint8_t tmp___0 ;
  uint8_t tmp___1 ;
  uint8_t tmp___2 ;
  ...
  struct ahc_devinfo devinfo ;
  u_int mesg_out ;
    klee_make_symbolic(&mesg_out, sizeof(int), "mesg_out");
  u_int curphase ;
  u_int errorphase ;
    klee_make_symbolic(&errorphase, sizeof(int), "errorphase");
  u_int lastphase ;
  u_int scsirate ;
    klee_make_symbolic(&scsirate, sizeof(int), "scsirate");
  u_int i ;
  u_int sstat2 ;
    klee_make_symbolic(&sstat2, sizeof(int), "sstat2");
  int silent ;
...
{ 
  ...
  u_int scsirate ;
  u_int sxfrctl0 ;
    klee_make_symbolic(&sxfrctl0, sizeof(int), "sxfrctl0");
  uint8_t tmp ;
  char *tmp___0 ;
  char *tmp___1 ;
  int tmp___2 ;
...
{ 
  u_int scsisigo ;
    klee_make_symbolic(&scsisigo, sizeof(int), "scsisigo");
  uint8_t tmp ;
...
{ 
  ...
  u_int targ_scsirate ;
    klee_make_symbolic(&targ_scsirate, sizeof(int), "targ_scsirate");
  struct ahc_syncrate  const  *syncrate ;
  u_int period ;
  u_int ppr_options ;
  u_int offset ;
...
{ 
  ...
  u_int sxfrctl1_a ;
    klee_make_symbolic(&sxfrctl1_a, sizeof(int), "sxfrctl1_a");
  u_int sxfrctl1_b ;
    klee_make_symbolic(&sxfrctl1_b, sizeof(int), "sxfrctl1_b");
  int error ;
  int wait ;
  u_int sblkctl___0 ;
    klee_make_symbolic(&sblkctl___0, sizeof(int), "sblkctl___0");
  uint8_t tmp ;
  uint8_t tmp___0 ;
  uint8_t tmp___1 ;
  uint8_t tmp___2 ;
  ...
  uint8_t tmp___4 ;
  u_int sblkctl___1 ;
    klee_make_symbolic(&sblkctl___1, sizeof(int), "sblkctl___1");
  uint8_t tmp___5 ;
...
{ 
  int scbsize ;
    klee_make_symbolic(&scbsize, sizeof(int), "scbsize");
  int i ;
  int j ;
...
{ 
  int term ;
    klee_make_symbolic(&term, sizeof(int), "term");
  int error ;
  u_int i ;
  u_int scsi_conf ;
    klee_make_symbolic(&scsi_conf, sizeof(int), "scsi_conf");
...
{ 
  ...
  u_int scsi_conf ;
  u_int ultraenb ;
    klee_make_symbolic(&ultraenb, sizeof(int), "ultraenb");
  u_int discenable ;
    klee_make_symbolic(&discenable, sizeof(int), "discenable");
  u_int tagenable ;
    klee_make_symbolic(&tagenable, sizeof(int), "tagenable");
...
{ 
  ...
  int found ;
  int have_qregs ;
    klee_make_symbolic(&have_qregs, sizeof(int), "have_qregs");
  cam_status ostat ;
  cam_status cstat ;
  uint32_t tmp ;
  uint32_t tmp___0 ;
...
{ 
  ...
  u_int count ;
  u_int active_scb ;
    klee_make_symbolic(&active_scb, sizeof(int), "active_scb");
  uint8_t tmp ;
  uint8_t tmp___0 ;
  u_int scb_index ;
  uint8_t tmp___1 ;
...
{ 
  u_int curscb ;
    klee_make_symbolic(&curscb, sizeof(int), "curscb");
  u_int next ;
  uint8_t tmp ;
  uint8_t tmp___0 ;
  uint8_t tmp___1 ;
...
{ 
  ...
  u_int sblkctl ;
  u_int scsiseq ;
    klee_make_symbolic(&scsiseq, sizeof(int), "scsiseq");
  u_int simode1 ;
  int found ;
  int restart_needed ;
    klee_make_symbolic(&restart_needed, sizeof(int), "restart_needed");
  char cur_channel ;
  uint8_t tmp ;
  uint8_t tmp___0 ;
  uint8_t tmp___1 ;
...
{ 
  ...
  u_int scsiseq ;
  u_int dscommand0 ;
    klee_make_symbolic(&dscommand0, sizeof(int), "dscommand0");
  uint32_t devconfig ;
  int error ;
  uint8_t sblkctl ;
  char *tmp ;
  ...
  uint8_t tmp___4 ;
  u_int sfunct ;
    klee_make_symbolic(&sfunct, sizeof(int), "sfunct");
  uint8_t tmp___5 ;
  uint8_t tmp___6 ;
  uint32_t tmp___7 ;
  ...
  uint32_t tmp___10 ;
  u_int sfunct___0 ;
    klee_make_symbolic(&sfunct___0, sizeof(int), "sfunct___0");
  uint8_t tmp___11 ;
  int tmp___12 ;
...
{ 
  ...
  int ramps ;
    klee_make_symbolic(&ramps, sizeof(int), "ramps");
  int single_user ;
    klee_make_symbolic(&single_user, sizeof(int), "single_user");
  uint32_t devconfig ;
  uint8_t tmp ;
...
{ 
  int num_scbs ;
    klee_make_symbolic(&num_scbs, sizeof(int), "num_scbs");
  int test_num_scbs ;
    klee_make_symbolic(&test_num_scbs, sizeof(int), "test_num_scbs");
  int enable ;
    klee_make_symbolic(&enable, sizeof(int), "enable");
  int pcheck ;
    klee_make_symbolic(&pcheck, sizeof(int), "pcheck");
  int fast ;
    klee_make_symbolic(&fast, sizeof(int), "fast");
  int large ;
    klee_make_symbolic(&large, sizeof(int), "large");
  int tmp ;
  uint8_t tmp___0 ;
  uint8_t tmp___1 ;
  uint8_t tmp___2 ;
...
{ 
  int error ;
  u_int status1 ;
    klee_make_symbolic(&status1, sizeof(int), "status1");
  uint32_t cmd ;
  uint8_t hcntrl ;
  int tmp ;
  uint32_t tmp___0 ;
...
{ 
  ...
  int have_autoterm ;
    klee_make_symbolic(&have_autoterm, sizeof(int), "have_autoterm");
  char *tmp ;
  u_int start_addr ;
...
{ 
  ...
  int externalcable_present ;
    klee_make_symbolic(&externalcable_present, sizeof(int), "externalcable_present");
  int eeprom_present ;
    klee_make_symbolic(&eeprom_present, sizeof(int), "eeprom_present");
  int enableSEC_low ;
    klee_make_symbolic(&enableSEC_low, sizeof(int), "enableSEC_low");
  int enableSEC_high ;
    klee_make_symbolic(&enableSEC_high, sizeof(int), "enableSEC_high");
  int enablePRI_low ;
    klee_make_symbolic(&enablePRI_low, sizeof(int), "enablePRI_low");
  int enablePRI_high ;
    klee_make_symbolic(&enablePRI_high, sizeof(int), "enablePRI_high");
  int sum ;
...
u_int aic7xxx_allow_memio ;
    klee_make_symbolic(&aic7xxx_allow_memio, sizeof(int), "aic7xxx_allow_memio");
...
static int ahc_linux_unit  ;
    klee_make_symbolic(&ahc_linux_unit, sizeof(int), "ahc_linux_unit");
void ahc_delay(long usec ) 
{ 
...
{ 
  ...
  int maxsync ;
  int ultra ;
    klee_make_symbolic(&ultra, sizeof(int), "ultra");
  int flags___0 ;
...
{ 
  u_long s ;
  int unblock_reqs ;
    klee_make_symbolic(&unblock_reqs, sizeof(int), "unblock_reqs");
...
{ 
  ...
  u_int active_scb_index ;
    klee_make_symbolic(&active_scb_index, sizeof(int), "active_scb_index");
  u_int last_phase ;
