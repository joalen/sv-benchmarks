...
struct fotg210_hcd {
   ...
   unsigned int next_frame ;
    klee_make_symbolic(&next_frame, sizeof(int), "next_frame");
...
struct fotg210_qh {
   ...
   unsigned short period ;
    klee_make_symbolic(&period, sizeof(short), "period");
...
static int log2_irq_thresh  ;
    klee_make_symbolic(&log2_irq_thresh, sizeof(int), "log2_irq_thresh");
static unsigned int park  ;
    klee_make_symbolic(&park, sizeof(int), "park");
...
{ 
  ...
  unsigned short allocated_max ;
    klee_make_symbolic(&allocated_max, sizeof(short), "allocated_max");
  unsigned long flags ;
  ssize_t ret ;
  void *tmp ;
  struct usb_hcd *tmp___0 ;
