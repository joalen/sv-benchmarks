...
struct __anonstruct_parts_346 {
   ushort index ;
   ushort bottombits ;
    klee_make_symbolic(&bottombits, sizeof(short), "bottombits");
};
...
struct slic_hostcmd {
   ...
   u32 cmdsize ;
   ushort numbufs ;
    klee_make_symbolic(&numbufs, sizeof(short), "numbufs");
...
struct slic_cmdqmem {
   int pagecnt ;
    klee_make_symbolic(&pagecnt, sizeof(int), "pagecnt");
   u32 *pages[32U] ;
...
struct ether_header {
   ...
   ushort ether_type ;
    klee_make_symbolic(&ether_type, sizeof(short), "ether_type");
};
struct adapter;
struct sliccard {
   uint busnumber ;
   ...
   uint slotnumber ;
    klee_make_symbolic(&slotnumber, sizeof(int), "slotnumber");
   uint state ;
   uint cardnum ;
    klee_make_symbolic(&cardnum, sizeof(int), "cardnum");
   uint card_size ;
    klee_make_symbolic(&card_size, sizeof(int), "card_size");
   uint adapters_activated ;
    klee_make_symbolic(&adapters_activated, sizeof(int), "adapters_activated");
   uint adapters_allocated ;
    klee_make_symbolic(&adapters_allocated, sizeof(int), "adapters_allocated");
   uint adapters_sleeping ;
    klee_make_symbolic(&adapters_sleeping, sizeof(int), "adapters_sleeping");
   uint gennumber ;
    klee_make_symbolic(&gennumber, sizeof(int), "gennumber");
   u32 events ;
   u32 loadlevel_current ;
   u32 load ;
   uint reset_in_progress ;
    klee_make_symbolic(&reset_in_progress, sizeof(int), "reset_in_progress");
   u32 pingstatus ;
   u32 bad_pingstatus ;
   struct timer_list loadtimer ;
   u32 loadtimerset ;
   uint config_set ;
    klee_make_symbolic(&config_set, sizeof(int), "config_set");
...
struct physcard {
   ...
   uint adapters_allocd ;
    klee_make_symbolic(&adapters_allocd, sizeof(int), "adapters_allocd");
};
struct base_driver {
...
struct slic_upr {
   uint adapter ;
    klee_make_symbolic(&adapter, sizeof(int), "adapter");
   u32 upr_request ;
   u32 upr_data ;
   u32 upr_data_h ;
   u32 upr_buffer ;
...
struct slic_ifevents {
   uint oflow802 ;
    klee_make_symbolic(&oflow802, sizeof(int), "oflow802");
   uint uflow802 ;
    klee_make_symbolic(&uflow802, sizeof(int), "uflow802");
   uint Tprtoflow ;
    klee_make_symbolic(&Tprtoflow, sizeof(int), "Tprtoflow");
   uint rcvearly ;
    klee_make_symbolic(&rcvearly, sizeof(int), "rcvearly");
   uint Bufov ;
    klee_make_symbolic(&Bufov, sizeof(int), "Bufov");
   uint Carre ;
    klee_make_symbolic(&Carre, sizeof(int), "Carre");
   uint Longe ;
    klee_make_symbolic(&Longe, sizeof(int), "Longe");
   uint Invp ;
    klee_make_symbolic(&Invp, sizeof(int), "Invp");
   uint Crc ;
    klee_make_symbolic(&Crc, sizeof(int), "Crc");
   uint Drbl ;
    klee_make_symbolic(&Drbl, sizeof(int), "Drbl");
   uint Code ;
    klee_make_symbolic(&Code, sizeof(int), "Code");
   uint IpHlen ;
    klee_make_symbolic(&IpHlen, sizeof(int), "IpHlen");
   uint IpLen ;
    klee_make_symbolic(&IpLen, sizeof(int), "IpLen");
   uint IpCsum ;
    klee_make_symbolic(&IpCsum, sizeof(int), "IpCsum");
   uint TpCsum ;
    klee_make_symbolic(&TpCsum, sizeof(int), "TpCsum");
   uint TpHlen ;
    klee_make_symbolic(&TpHlen, sizeof(int), "TpHlen");
};
struct adapter {
   void *ifp ;
   ...
   uint physport ;
    klee_make_symbolic(&physport, sizeof(int), "physport");
   uint cardindex ;
    klee_make_symbolic(&cardindex, sizeof(int), "cardindex");
   uint card_size ;
   uint chipid ;
   ...
   uint slotnumber ;
   uint functionnumber ;
    klee_make_symbolic(&functionnumber, sizeof(int), "functionnumber");
   ushort vendid ;
    klee_make_symbolic(&vendid, sizeof(short), "vendid");
   ushort devid ;
    klee_make_symbolic(&devid, sizeof(short), "devid");
   ushort subsysid ;
   ...
   uint queues_initialized ;
    klee_make_symbolic(&queues_initialized, sizeof(int), "queues_initialized");
   uint allocated ;
    klee_make_symbolic(&allocated, sizeof(int), "allocated");
   uint activated ;
    klee_make_symbolic(&activated, sizeof(int), "activated");
   u32 intrregistered ;
   uint isp_initialized ;
    klee_make_symbolic(&isp_initialized, sizeof(int), "isp_initialized");
   uint gennumber ;
   ...
   unsigned char linkstate ;
    klee_make_symbolic(&linkstate, sizeof(char), "linkstate");
   unsigned char linkspeed ;
    klee_make_symbolic(&linkspeed, sizeof(char), "linkspeed");
   unsigned char linkduplex ;
    klee_make_symbolic(&linkduplex, sizeof(char), "linkduplex");
   uint flags ;
   unsigned char macaddr[6U] ;
   unsigned char currmacaddr[6U] ;
   u32 macopts ;
   ushort devflags_prev ;
    klee_make_symbolic(&devflags_prev, sizeof(short), "devflags_prev");
   u64 mcastmask ;
   struct mcast_address *mcastaddrs ;
   struct slic_upr *upr_list ;
   uint upr_busy ;
    klee_make_symbolic(&upr_busy, sizeof(int), "upr_busy");
   ...
   ushort slic_handle_ix ;
    klee_make_symbolic(&slic_handle_ix, sizeof(short), "slic_handle_ix");
   u32 xmitq_full ;
   u32 all_reg_writes ;
   u32 icr_reg_writes ;
   u32 isr_reg_writes ;
...
static unsigned int rcv_count  ;
    klee_make_symbolic(&rcv_count, sizeof(int), "rcv_count");
...
{ 
  unsigned char crcpoly ;
    klee_make_symbolic(&crcpoly, sizeof(char), "crcpoly");
  u32 __x ;
  u32 tmp ;
  u32 tmp___0 ;
...
{ 
  ...
  u32 section ;
  int thissectionsize ;
    klee_make_symbolic(&thissectionsize, sizeof(int), "thissectionsize");
  int codeaddr ;
    klee_make_symbolic(&codeaddr, sizeof(int), "codeaddr");
  struct slic_regs *slic_regs ;
  u32 instruction ;
  u32 baseaddress ;
  u32 i ;
  ...
  u32 sectstart[3U] ;
  int ucode_start ;
    klee_make_symbolic(&ucode_start, sizeof(int), "ucode_start");
  int index ;
  unsigned long __ms ;
  unsigned long tmp ;
  unsigned long __ms___0 ;
...
{ 
  u32 linkstatus ;
  uint linkup ;
    klee_make_symbolic(&linkup, sizeof(int), "linkup");
  unsigned char linkspeed ;
  unsigned char linkduplex ;
  struct slic_shmem *pshmem ;
...
{ 
  ...
  int cmdcnt ;
    klee_make_symbolic(&cmdcnt, sizeof(int), "cmdcnt");
  void *cmdaddr ;
  ulong phys_addr ;
...
{ 
  int count ;
  int pre_count ;
    klee_make_symbolic(&pre_count, sizeof(int), "pre_count");
  int errors ;
...
{ 
  ...
  int status ;
  uint macaddrs ;
    klee_make_symbolic(&macaddrs, sizeof(int), "macaddrs");
  ushort eecodesize ;
    klee_make_symbolic(&eecodesize, sizeof(short), "eecodesize");
  ushort dramsize ;
    klee_make_symbolic(&dramsize, sizeof(short), "dramsize");
  ushort ee_chksum ;
    klee_make_symbolic(&ee_chksum, sizeof(short), "ee_chksum");
  ushort calc_chksum ;
    klee_make_symbolic(&calc_chksum, sizeof(short), "calc_chksum");
  struct slic_config_mac *pmac ;
  unsigned char fruformat ;
    klee_make_symbolic(&fruformat, sizeof(char), "fruformat");
  unsigned char oemfruformat ;
    klee_make_symbolic(&oemfruformat, sizeof(char), "oemfruformat");
...
{ 
  ...
  struct physcard *physcard ;
  ushort card_hostid ;
    klee_make_symbolic(&card_hostid, sizeof(short), "card_hostid");
  u16 *hostid_reg ;
  uint i ;
  uint rdhostid_offset ;
    klee_make_symbolic(&rdhostid_offset, sizeof(int), "rdhostid_offset");
  void *tmp ;
  void *tmp___0 ;
...
{ 
  ...
  int did_version ;
    klee_make_symbolic(&did_version, sizeof(int), "did_version");
  int err ;
