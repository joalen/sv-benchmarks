...
struct icp_qat_fw_loader_ae_data {
   ...
   unsigned int ustore_size ;
    klee_make_symbolic(&ustore_size, sizeof(int), "ustore_size");
   unsigned int free_addr ;
    klee_make_symbolic(&free_addr, sizeof(int), "free_addr");
   unsigned int free_size ;
    klee_make_symbolic(&free_size, sizeof(int), "free_size");
   unsigned int live_ctx_mask ;
    klee_make_symbolic(&live_ctx_mask, sizeof(int), "live_ctx_mask");
};
struct icp_qat_fw_loader_hal_handle {
   struct icp_qat_fw_loader_ae_data aes[12U] ;
   unsigned int ae_mask ;
    klee_make_symbolic(&ae_mask, sizeof(int), "ae_mask");
   unsigned int slice_mask ;
    klee_make_symbolic(&slice_mask, sizeof(int), "slice_mask");
   unsigned int revision_id ;
    klee_make_symbolic(&revision_id, sizeof(int), "revision_id");
   unsigned int ae_max_num ;
    klee_make_symbolic(&ae_max_num, sizeof(int), "ae_max_num");
   unsigned int upc_mask ;
    klee_make_symbolic(&upc_mask, sizeof(int), "upc_mask");
   unsigned int max_ustore ;
    klee_make_symbolic(&max_ustore, sizeof(int), "max_ustore");
};
struct icp_qat_fw_loader_handle {
...
struct service_hndl {
   ...
   unsigned long init_status ;
    klee_make_symbolic(&init_status, sizeof(long), "init_status");
   unsigned long start_status ;
    klee_make_symbolic(&start_status, sizeof(long), "start_status");
   char *name ;
   struct list_head list ;
   int admin ;
    klee_make_symbolic(&admin, sizeof(int), "admin");
};
enum hrtimer_restart;
struct firmware {
   size_t size ;
...
struct crypto_type {
   ...
   unsigned int maskclear ;
    klee_make_symbolic(&maskclear, sizeof(int), "maskclear");
   unsigned int maskset ;
    klee_make_symbolic(&maskset, sizeof(int), "maskset");
   unsigned int tfmsize ;
    klee_make_symbolic(&tfmsize, sizeof(int), "tfmsize");
};
struct sha1_state {
   u32 state[5U] ;
   u64 count ;
...
struct shash_alg {
   ...
   unsigned int descsize ;
    klee_make_symbolic(&descsize, sizeof(int), "descsize");
   unsigned int digestsize ;
   unsigned int statesize ;
    klee_make_symbolic(&statesize, sizeof(int), "statesize");
...
struct crypto_authenc_keys {
   ...
   unsigned int authkeylen ;
    klee_make_symbolic(&authkeylen, sizeof(int), "authkeylen");
   unsigned int enckeylen ;
    klee_make_symbolic(&enckeylen, sizeof(int), "enckeylen");
};
struct crypto_rng;
struct rng_alg {
...
struct icp_qat_uclo_aeslice {
   ...
   unsigned int ctx_mask_assigned ;
    klee_make_symbolic(&ctx_mask_assigned, sizeof(int), "ctx_mask_assigned");
   unsigned int new_uaddr[8U] ;
};
struct icp_qat_uclo_aedata {
   unsigned int slice_num ;
    klee_make_symbolic(&slice_num, sizeof(int), "slice_num");
   unsigned int eff_ustore_size ;
    klee_make_symbolic(&eff_ustore_size, sizeof(int), "eff_ustore_size");
...
struct icp_qat_uclo_encap_uwblock {
   ...
   unsigned int words_num ;
    klee_make_symbolic(&words_num, sizeof(int), "words_num");
   uint64_t micro_words ;
};
struct icp_qat_uclo_encap_page {
   unsigned int def_page ;
    klee_make_symbolic(&def_page, sizeof(int), "def_page");
   unsigned int page_region ;
    klee_make_symbolic(&page_region, sizeof(int), "page_region");
   unsigned int beg_addr_v ;
    klee_make_symbolic(&beg_addr_v, sizeof(int), "beg_addr_v");
   unsigned int beg_addr_p ;
    klee_make_symbolic(&beg_addr_p, sizeof(int), "beg_addr_p");
   unsigned int micro_words_num ;
    klee_make_symbolic(&micro_words_num, sizeof(int), "micro_words_num");
   unsigned int uwblock_num ;
    klee_make_symbolic(&uwblock_num, sizeof(int), "uwblock_num");
...
struct icp_qat_uclo_encapme {
   ...
   unsigned int ae_reg_num ;
    klee_make_symbolic(&ae_reg_num, sizeof(int), "ae_reg_num");
   struct icp_qat_uof_ae_reg *ae_reg ;
   unsigned int init_regsym_num ;
    klee_make_symbolic(&init_regsym_num, sizeof(int), "init_regsym_num");
   struct icp_qat_uof_init_regsym *init_regsym ;
   unsigned int sbreak_num ;
    klee_make_symbolic(&sbreak_num, sizeof(int), "sbreak_num");
   struct icp_qat_uof_sbreak *sbreak ;
   unsigned int uwords_num ;
    klee_make_symbolic(&uwords_num, sizeof(int), "uwords_num");
};
struct icp_qat_uof_initmem;
struct icp_qat_uclo_init_mem_table {
   unsigned int entry_num ;
    klee_make_symbolic(&entry_num, sizeof(int), "entry_num");
   struct icp_qat_uof_initmem *init_mem ;
};
struct icp_qat_uclo_objhdr {
   char *file_buff ;
   unsigned int checksum ;
    klee_make_symbolic(&checksum, sizeof(int), "checksum");
   unsigned int size ;
};
struct icp_qat_uof_strtable {
   unsigned int table_len ;
    klee_make_symbolic(&table_len, sizeof(int), "table_len");
...
struct icp_qat_uclo_objhandle {
   unsigned int prod_type ;
    klee_make_symbolic(&prod_type, sizeof(int), "prod_type");
   unsigned int prod_rev ;
    klee_make_symbolic(&prod_rev, sizeof(int), "prod_rev");
   ...
   int uimage_num ;
    klee_make_symbolic(&uimage_num, sizeof(int), "uimage_num");
   int uword_in_bytes ;
    klee_make_symbolic(&uword_in_bytes, sizeof(int), "uword_in_bytes");
   int global_inited ;
    klee_make_symbolic(&global_inited, sizeof(int), "global_inited");
   unsigned int ae_num ;
    klee_make_symbolic(&ae_num, sizeof(int), "ae_num");
   unsigned int ustore_phy_size ;
    klee_make_symbolic(&ustore_phy_size, sizeof(int), "ustore_phy_size");
   void *obj_buf ;
   uint64_t *uword_buf ;
};
struct icp_qat_uof_uword_block {
   ...
   unsigned int uword_offset ;
    klee_make_symbolic(&uword_offset, sizeof(int), "uword_offset");
   unsigned int reserved ;
};
struct icp_qat_uof_filehdr {
   unsigned short file_id ;
    klee_make_symbolic(&file_id, sizeof(short), "file_id");
   unsigned short reserved1 ;
    klee_make_symbolic(&reserved1, sizeof(short), "reserved1");
   char min_ver ;
    klee_make_symbolic(&min_ver, sizeof(char), "min_ver");
   char maj_ver ;
    klee_make_symbolic(&maj_ver, sizeof(char), "maj_ver");
   unsigned short reserved2 ;
    klee_make_symbolic(&reserved2, sizeof(short), "reserved2");
   unsigned short max_chunks ;
    klee_make_symbolic(&max_chunks, sizeof(short), "max_chunks");
   unsigned short num_chunks ;
    klee_make_symbolic(&num_chunks, sizeof(short), "num_chunks");
};
...
struct icp_qat_uof_objhdr {
   unsigned int cpu_type ;
    klee_make_symbolic(&cpu_type, sizeof(int), "cpu_type");
   unsigned short min_cpu_ver ;
    klee_make_symbolic(&min_cpu_ver, sizeof(short), "min_cpu_ver");
   unsigned short max_cpu_ver ;
    klee_make_symbolic(&max_cpu_ver, sizeof(short), "max_cpu_ver");
   short max_chunks ;
   short num_chunks ;
...
struct icp_qat_uof_memvar_attr {
   unsigned int offset_in_byte ;
    klee_make_symbolic(&offset_in_byte, sizeof(int), "offset_in_byte");
   unsigned int value ;
};
struct icp_qat_uof_initmem {
   unsigned int sym_name ;
    klee_make_symbolic(&sym_name, sizeof(int), "sym_name");
   char region ;
    klee_make_symbolic(&region, sizeof(char), "region");
   char scope ;
    klee_make_symbolic(&scope, sizeof(char), "scope");
   unsigned short reserved1 ;
   unsigned int addr ;
    klee_make_symbolic(&addr, sizeof(int), "addr");
   unsigned int num_in_bytes ;
    klee_make_symbolic(&num_in_bytes, sizeof(int), "num_in_bytes");
   unsigned int val_attr_num ;
    klee_make_symbolic(&val_attr_num, sizeof(int), "val_attr_num");
};
struct icp_qat_uof_init_regsym {
   unsigned int sym_name ;
   char init_type ;
    klee_make_symbolic(&init_type, sizeof(char), "init_type");
   char value_type ;
    klee_make_symbolic(&value_type, sizeof(char), "value_type");
   char reg_type ;
    klee_make_symbolic(&reg_type, sizeof(char), "reg_type");
   unsigned char ctx ;
    klee_make_symbolic(&ctx, sizeof(char), "ctx");
   unsigned int reg_addr ;
    klee_make_symbolic(&reg_addr, sizeof(int), "reg_addr");
   unsigned int value ;
};
struct icp_qat_uof_varmem_seg {
   unsigned int sram_base ;
    klee_make_symbolic(&sram_base, sizeof(int), "sram_base");
   unsigned int sram_size ;
    klee_make_symbolic(&sram_size, sizeof(int), "sram_size");
   unsigned int sram_alignment ;
    klee_make_symbolic(&sram_alignment, sizeof(int), "sram_alignment");
   unsigned int sdram_base ;
    klee_make_symbolic(&sdram_base, sizeof(int), "sdram_base");
   unsigned int sdram_size ;
    klee_make_symbolic(&sdram_size, sizeof(int), "sdram_size");
   unsigned int sdram_alignment ;
    klee_make_symbolic(&sdram_alignment, sizeof(int), "sdram_alignment");
   unsigned int sdram1_base ;
    klee_make_symbolic(&sdram1_base, sizeof(int), "sdram1_base");
   unsigned int sdram1_size ;
    klee_make_symbolic(&sdram1_size, sizeof(int), "sdram1_size");
   unsigned int sdram1_alignment ;
    klee_make_symbolic(&sdram1_alignment, sizeof(int), "sdram1_alignment");
   unsigned int scratch_base ;
    klee_make_symbolic(&scratch_base, sizeof(int), "scratch_base");
   unsigned int scratch_size ;
    klee_make_symbolic(&scratch_size, sizeof(int), "scratch_size");
   unsigned int scratch_alignment ;
    klee_make_symbolic(&scratch_alignment, sizeof(int), "scratch_alignment");
};
struct icp_qat_uof_sbreak {
   unsigned int page_num ;
    klee_make_symbolic(&page_num, sizeof(int), "page_num");
   unsigned int virt_uaddr ;
    klee_make_symbolic(&virt_uaddr, sizeof(int), "virt_uaddr");
   unsigned char sbreak_type ;
    klee_make_symbolic(&sbreak_type, sizeof(char), "sbreak_type");
   unsigned char reg_type ;
   unsigned short reserved1 ;
   unsigned int addr_offset ;
    klee_make_symbolic(&addr_offset, sizeof(int), "addr_offset");
   unsigned int reg_addr ;
};
struct icp_qat_uof_code_page {
   ...
   unsigned int neigh_reg_tab_offset ;
    klee_make_symbolic(&neigh_reg_tab_offset, sizeof(int), "neigh_reg_tab_offset");
   unsigned int uc_var_tab_offset ;
    klee_make_symbolic(&uc_var_tab_offset, sizeof(int), "uc_var_tab_offset");
   unsigned int imp_var_tab_offset ;
    klee_make_symbolic(&imp_var_tab_offset, sizeof(int), "imp_var_tab_offset");
   unsigned int imp_expr_tab_offset ;
    klee_make_symbolic(&imp_expr_tab_offset, sizeof(int), "imp_expr_tab_offset");
   unsigned int code_area_offset ;
    klee_make_symbolic(&code_area_offset, sizeof(int), "code_area_offset");
};
struct icp_qat_uof_image {
   unsigned int img_name ;
    klee_make_symbolic(&img_name, sizeof(int), "img_name");
   unsigned int ae_assigned ;
    klee_make_symbolic(&ae_assigned, sizeof(int), "ae_assigned");
   unsigned int ctx_assigned ;
    klee_make_symbolic(&ctx_assigned, sizeof(int), "ctx_assigned");
   unsigned int cpu_type ;
   unsigned int entry_address ;
    klee_make_symbolic(&entry_address, sizeof(int), "entry_address");
   unsigned int fill_pattern[2U] ;
   unsigned int reloadable_size ;
    klee_make_symbolic(&reloadable_size, sizeof(int), "reloadable_size");
   unsigned char sensitivity ;
    klee_make_symbolic(&sensitivity, sizeof(char), "sensitivity");
   unsigned char reserved ;
   unsigned short ae_mode ;
    klee_make_symbolic(&ae_mode, sizeof(short), "ae_mode");
   unsigned short max_ver ;
    klee_make_symbolic(&max_ver, sizeof(short), "max_ver");
   unsigned short min_ver ;
   unsigned short image_attrib ;
    klee_make_symbolic(&image_attrib, sizeof(short), "image_attrib");
   unsigned short reserved2 ;
   unsigned short page_region_num ;
    klee_make_symbolic(&page_region_num, sizeof(short), "page_region_num");
   unsigned short numpages ;
    klee_make_symbolic(&numpages, sizeof(short), "numpages");
   unsigned int reg_tab_offset ;
    klee_make_symbolic(&reg_tab_offset, sizeof(int), "reg_tab_offset");
   unsigned int init_reg_sym_tab ;
    klee_make_symbolic(&init_reg_sym_tab, sizeof(int), "init_reg_sym_tab");
   unsigned int sbreak_tab ;
    klee_make_symbolic(&sbreak_tab, sizeof(int), "sbreak_tab");
   unsigned int app_metadata ;
    klee_make_symbolic(&app_metadata, sizeof(int), "app_metadata");
};
...
struct icp_qat_uof_ae_reg {
   ...
   unsigned int vis_name ;
    klee_make_symbolic(&vis_name, sizeof(int), "vis_name");
   unsigned short type ;
   unsigned short addr ;
   unsigned short access_mode ;
    klee_make_symbolic(&access_mode, sizeof(short), "access_mode");
   unsigned char visible ;
    klee_make_symbolic(&visible, sizeof(char), "visible");
   unsigned char reserved1 ;
   unsigned short ref_count ;
    klee_make_symbolic(&ref_count, sizeof(short), "ref_count");
   unsigned short reserved2 ;
   unsigned int xo_id ;
    klee_make_symbolic(&xo_id, sizeof(int), "xo_id");
};
struct icp_qat_uof_code_area {
   unsigned int micro_words_num ;
   unsigned int uword_block_tab ;
    klee_make_symbolic(&uword_block_tab, sizeof(int), "uword_block_tab");
};
struct icp_qat_uof_batch_init {
   unsigned int ae ;
...
{ 
  ...
  unsigned long wait_jiffies ;
    klee_make_symbolic(&wait_jiffies, sizeof(long), "wait_jiffies");
...
{ 
  ...
  struct list_head *itr ;
  unsigned long best ;
    klee_make_symbolic(&best, sizeof(long), "best");
  struct list_head *tmp ;
  struct list_head  const  *__mptr ;
  int tmp___0 ;
  int tmp___1 ;
...
{ 
  int i ;
  unsigned long bank ;
    klee_make_symbolic(&bank, sizeof(long), "bank");
  unsigned long num_inst ;
    klee_make_symbolic(&num_inst, sizeof(long), "num_inst");
  unsigned long num_msg_sym ;
    klee_make_symbolic(&num_msg_sym, sizeof(long), "num_msg_sym");
  unsigned long num_msg_asym ;
    klee_make_symbolic(&num_msg_asym, sizeof(long), "num_msg_asym");
  int msg_size ;
    klee_make_symbolic(&msg_size, sizeof(int), "msg_size");
  struct qat_crypto_instance *inst___0 ;
  char key[64U] ;
  char val[64U] ;
  int tmp ;
...
{ 
  ...
  unsigned long __lengthof__shash_desc ;
    klee_make_symbolic(&__lengthof__shash_desc, sizeof(long), "__lengthof__shash_desc");
  void *tmp___0 ;
  ...
  int digest_size ;
    klee_make_symbolic(&digest_size, sizeof(int), "digest_size");
  unsigned int tmp___2 ;
  char *ipad ;
  unsigned long __lengthofipad ;
    klee_make_symbolic(&__lengthofipad, sizeof(long), "__lengthofipad");
  void *tmp___3 ;
  char *opad ;
  unsigned long __lengthofopad ;
    klee_make_symbolic(&__lengthofopad, sizeof(long), "__lengthofopad");
  void *tmp___4 ;
...
{ 
  struct crypto_authenc_keys keys ;
  int alg ;
    klee_make_symbolic(&alg, sizeof(int), "alg");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
  int tmp___2 ;
...
{ 
  ...
  int i ;
  int bufless ;
    klee_make_symbolic(&bufless, sizeof(int), "bufless");
...
{ 
  ...
  int i ;
  int bufs ;
    klee_make_symbolic(&bufs, sizeof(int), "bufs");
  int sg_nctr ;
    klee_make_symbolic(&sg_nctr, sizeof(int), "sg_nctr");
  int n ;
    klee_make_symbolic(&n, sizeof(int), "n");
  int tmp ;
  int assoc_n ;
    klee_make_symbolic(&assoc_n, sizeof(int), "assoc_n");
  int tmp___0 ;
  ...
  long tmp___19 ;
  int y___0 ;
    klee_make_symbolic(&y___0, sizeof(int), "y___0");
  void *tmp___20 ;
  int tmp___21 ;
  long tmp___22 ;
...
{ 
  ...
  int qat_res ;
    klee_make_symbolic(&qat_res, sizeof(int), "qat_res");
  long tmp ;
...
{ 
  ...
  int digst_size ;
    klee_make_symbolic(&digst_size, sizeof(int), "digst_size");
...
{ 
  int maj ;
    klee_make_symbolic(&maj, sizeof(int), "maj");
  int min ;
...
{ 
  unsigned int outval ;
    klee_make_symbolic(&outval, sizeof(int), "outval");
  unsigned char *ptr ;
...
{ 
  ...
  unsigned int ustore_size ;
  unsigned int uaddr ;
    klee_make_symbolic(&uaddr, sizeof(int), "uaddr");
  unsigned int i ;
  int tmp ;
  int tmp___0 ;
...
{ 
  ...
  unsigned int patt_pos ;
    klee_make_symbolic(&patt_pos, sizeof(int), "patt_pos");
  struct icp_qat_uclo_objhandle *obj_handle ;
  uint64_t *fill_data ;
  void *tmp ;
  int tmp___0 ;
...
{ 
  int i ;
  unsigned int topbit ;
    klee_make_symbolic(&topbit, sizeof(int), "topbit");
  unsigned int inbyte ;
...
{ 
  unsigned int chksum ;
    klee_make_symbolic(&chksum, sizeof(int), "chksum");
  char *tmp ;
  int tmp___0 ;
...
{ 
  ...
  int ae ;
  int mflag ;
    klee_make_symbolic(&mflag, sizeof(int), "mflag");
  struct icp_qat_uclo_objhandle *obj_handle ;
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
...
{ 
  ...
  unsigned char ctx_mask ;
    klee_make_symbolic(&ctx_mask, sizeof(char), "ctx_mask");
  struct icp_qat_uof_init_regsym *init_regsym ;
  unsigned int exp_res ;
    klee_make_symbolic(&exp_res, sizeof(int), "exp_res");
...
{ 
  ...
  unsigned char nn_mode ;
    klee_make_symbolic(&nn_mode, sizeof(char), "nn_mode");
  unsigned char s ;
  struct icp_qat_uof_image *uof_image ;
  struct icp_qat_uclo_aedata *ae_data ;
  struct icp_qat_uclo_objhandle *obj_handle ;
...
{ 
  unsigned int uw_physical_addr ;
    klee_make_symbolic(&uw_physical_addr, sizeof(int), "uw_physical_addr");
  unsigned int uw_relative_addr ;
    klee_make_symbolic(&uw_relative_addr, sizeof(int), "uw_relative_addr");
  unsigned int i ;
  unsigned int words_num ;
  unsigned int cpylen ;
    klee_make_symbolic(&cpylen, sizeof(int), "cpylen");
  struct icp_qat_uclo_objhandle *obj_handle ;
  uint64_t fill_pat ;
...
{ 
  unsigned int cur_ctx ;
    klee_make_symbolic(&cur_ctx, sizeof(int), "cur_ctx");
...
{ 
  unsigned int base_cnt ;
    klee_make_symbolic(&base_cnt, sizeof(int), "base_cnt");
  unsigned int cur_cnt ;
    klee_make_symbolic(&cur_cnt, sizeof(int), "cur_cnt");
  unsigned int csr ;
    klee_make_symbolic(&csr, sizeof(int), "csr");
  int times ;
    klee_make_symbolic(&times, sizeof(int), "times");
  int elapsed_cycles ;
    klee_make_symbolic(&elapsed_cycles, sizeof(int), "elapsed_cycles");
  int tmp ;
...
{ 
  ...
  unsigned int new_csr ;
    klee_make_symbolic(&new_csr, sizeof(int), "new_csr");
...
{ 
  unsigned int ae_reset_csr ;
    klee_make_symbolic(&ae_reset_csr, sizeof(int), "ae_reset_csr");
...
{ 
  unsigned int misc_ctl ;
    klee_make_symbolic(&misc_ctl, sizeof(int), "misc_ctl");
  unsigned char ae ;
...
{ 
  ...
  unsigned int csr_val ;
    klee_make_symbolic(&csr_val, sizeof(int), "csr_val");
  unsigned int times ;
  unsigned int tmp ;
...
{ 
  unsigned int ustore_addr ;
    klee_make_symbolic(&ustore_addr, sizeof(int), "ustore_addr");
  unsigned int i ;
  unsigned int uwrd_lo ;
    klee_make_symbolic(&uwrd_lo, sizeof(int), "uwrd_lo");
  unsigned int uwrd_hi ;
    klee_make_symbolic(&uwrd_hi, sizeof(int), "uwrd_hi");
  uint64_t tmp ;
...
{ 
  ...
  unsigned int savctx ;
    klee_make_symbolic(&savctx, sizeof(int), "savctx");
  int ret ;
  int tmp ;
...
{ 
  ...
  unsigned int max_en_ae_id ;
    klee_make_symbolic(&max_en_ae_id, sizeof(int), "max_en_ae_id");
...
{ 
  ...
  unsigned int misc_control ;
    klee_make_symbolic(&misc_control, sizeof(int), "misc_control");
...
{ 
  ...
  unsigned int ind_lm_addr0 ;
    klee_make_symbolic(&ind_lm_addr0, sizeof(int), "ind_lm_addr0");
  unsigned int ind_lm_addr1 ;
    klee_make_symbolic(&ind_lm_addr1, sizeof(int), "ind_lm_addr1");
  unsigned int ind_lm_addr_byte0 ;
    klee_make_symbolic(&ind_lm_addr_byte0, sizeof(int), "ind_lm_addr_byte0");
  unsigned int ind_lm_addr_byte1 ;
    klee_make_symbolic(&ind_lm_addr_byte1, sizeof(int), "ind_lm_addr_byte1");
  unsigned int ind_cnt_sig ;
    klee_make_symbolic(&ind_cnt_sig, sizeof(int), "ind_cnt_sig");
  unsigned int ind_sig ;
    klee_make_symbolic(&ind_sig, sizeof(int), "ind_sig");
  unsigned int act_sig ;
    klee_make_symbolic(&act_sig, sizeof(int), "act_sig");
  unsigned int csr_val ;
  unsigned int newcsr_val ;
    klee_make_symbolic(&newcsr_val, sizeof(int), "newcsr_val");
  unsigned int savctx ;
  unsigned int savcc ;
    klee_make_symbolic(&savcc, sizeof(int), "savcc");
  unsigned int wakeup_events ;
    klee_make_symbolic(&wakeup_events, sizeof(int), "wakeup_events");
  unsigned int savpc ;
    klee_make_symbolic(&savpc, sizeof(int), "savpc");
  unsigned int ctxarb_ctl ;
    klee_make_symbolic(&ctxarb_ctl, sizeof(int), "ctxarb_ctl");
  unsigned int ctx_enables ;
    klee_make_symbolic(&ctx_enables, sizeof(int), "ctx_enables");
  int tmp ;
  unsigned int ctx_status ;
    klee_make_symbolic(&ctx_status, sizeof(int), "ctx_status");
...
{ 
  ...
  unsigned int ctxarb_cntl ;
    klee_make_symbolic(&ctxarb_cntl, sizeof(int), "ctxarb_cntl");
  unsigned int ustore_addr ;
  unsigned int ctx_enables ;
  unsigned short reg_addr ;
  int status ;
...
{ 
  unsigned short src_hiaddr ;
    klee_make_symbolic(&src_hiaddr, sizeof(short), "src_hiaddr");
  unsigned short src_lowaddr ;
    klee_make_symbolic(&src_lowaddr, sizeof(short), "src_lowaddr");
  unsigned short dest_addr ;
    klee_make_symbolic(&dest_addr, sizeof(short), "dest_addr");
  unsigned short data16hi ;
    klee_make_symbolic(&data16hi, sizeof(short), "data16hi");
  unsigned short data16lo ;
    klee_make_symbolic(&data16lo, sizeof(short), "data16lo");
  uint64_t insts[4U] ;
  int num_inst ;
  int code_off ;
    klee_make_symbolic(&code_off, sizeof(int), "code_off");
  int imm_w1 ;
    klee_make_symbolic(&imm_w1, sizeof(int), "imm_w1");
  int imm_w0 ;
    klee_make_symbolic(&imm_w0, sizeof(int), "imm_w0");
  int tmp ;
...
{ 
  int i ;
  int val_indx ;
    klee_make_symbolic(&val_indx, sizeof(int), "val_indx");
  unsigned int cur_value ;
    klee_make_symbolic(&cur_value, sizeof(int), "cur_value");
  uint64_t const   *inst_arr ;
  int fixup_offset ;
    klee_make_symbolic(&fixup_offset, sizeof(int), "fixup_offset");
  int usize ;
    klee_make_symbolic(&usize, sizeof(int), "usize");
  int orig_num ;
    klee_make_symbolic(&orig_num, sizeof(int), "orig_num");
  int tmp ;
  unsigned int tmp___0 ;
...
{ 
  ...
  unsigned int gpra0 ;
    klee_make_symbolic(&gpra0, sizeof(int), "gpra0");
  unsigned int gpra1 ;
    klee_make_symbolic(&gpra1, sizeof(int), "gpra1");
  unsigned int gpra2 ;
    klee_make_symbolic(&gpra2, sizeof(int), "gpra2");
  unsigned int gprb0 ;
    klee_make_symbolic(&gprb0, sizeof(int), "gprb0");
  unsigned int gprb1 ;
    klee_make_symbolic(&gprb1, sizeof(int), "gprb1");
...
{ 
  ...
  int micro_inst_num ;
    klee_make_symbolic(&micro_inst_num, sizeof(int), "micro_inst_num");
  int alloc_inst_size ;
    klee_make_symbolic(&alloc_inst_size, sizeof(int), "alloc_inst_size");
  int first_exec ;
    klee_make_symbolic(&first_exec, sizeof(int), "first_exec");
  int stat ;
  void *tmp ;
  unsigned int addr ;
  unsigned int *value ;
...
{ 
  ...
  unsigned short dr_offset ;
    klee_make_symbolic(&dr_offset, sizeof(short), "dr_offset");
...
{ 
  unsigned int gprval ;
    klee_make_symbolic(&gprval, sizeof(int), "gprval");
  unsigned int ctx_enables ;
  unsigned short src_hiaddr ;
  unsigned short src_lowaddr ;
  unsigned short gpr_addr ;
    klee_make_symbolic(&gpr_addr, sizeof(short), "gpr_addr");
  unsigned short xfr_addr ;
    klee_make_symbolic(&xfr_addr, sizeof(short), "xfr_addr");
  unsigned short data16hi ;
  unsigned short data16low ;
    klee_make_symbolic(&data16low, sizeof(short), "data16low");
  unsigned short reg_mask ;
    klee_make_symbolic(&reg_mask, sizeof(short), "reg_mask");
  int status ;
  uint64_t micro_inst[5U] ;
  int num_inst ;
  int code_off ;
  unsigned short gprnum ;
    klee_make_symbolic(&gprnum, sizeof(short), "gprnum");
  unsigned short dly ;
    klee_make_symbolic(&dly, sizeof(short), "dly");
