...
struct p80211_rxmeta {
   ...
   u64 hosttime ;
   unsigned int rxrate ;
    klee_make_symbolic(&rxrate, sizeof(int), "rxrate");
...
struct wlandevice {
   ...
   unsigned int ethconv ;
    klee_make_symbolic(&ethconv, sizeof(int), "ethconv");
   ...
   u32 macmode ;
   int linkstatus ;
    klee_make_symbolic(&linkstatus, sizeof(int), "linkstatus");
   u8 wep_keys[4U][32U] ;
   u8 wep_keylens[4U] ;
   int hostwep ;
    klee_make_symbolic(&hostwep, sizeof(int), "hostwep");
   unsigned long request_pending ;
    klee_make_symbolic(&request_pending, sizeof(long), "request_pending");
   netdevice_t *netdev ;
...
struct hfa384x_pdr_mkk_measurements {
   double carrier_freq ;
    klee_make_symbolic(&carrier_freq, sizeof(double), "carrier_freq");
   double occupied_band ;
    klee_make_symbolic(&occupied_band, sizeof(double), "occupied_band");
   double power_density ;
    klee_make_symbolic(&power_density, sizeof(double), "power_density");
   double tx_spur_f1 ;
    klee_make_symbolic(&tx_spur_f1, sizeof(double), "tx_spur_f1");
   double tx_spur_f2 ;
    klee_make_symbolic(&tx_spur_f2, sizeof(double), "tx_spur_f2");
   double tx_spur_f3 ;
    klee_make_symbolic(&tx_spur_f3, sizeof(double), "tx_spur_f3");
   double tx_spur_f4 ;
    klee_make_symbolic(&tx_spur_f4, sizeof(double), "tx_spur_f4");
   double tx_spur_l1 ;
    klee_make_symbolic(&tx_spur_l1, sizeof(double), "tx_spur_l1");
   double tx_spur_l2 ;
    klee_make_symbolic(&tx_spur_l2, sizeof(double), "tx_spur_l2");
   double tx_spur_l3 ;
    klee_make_symbolic(&tx_spur_l3, sizeof(double), "tx_spur_l3");
   double tx_spur_l4 ;
    klee_make_symbolic(&tx_spur_l4, sizeof(double), "tx_spur_l4");
   double rx_spur_f1 ;
    klee_make_symbolic(&rx_spur_f1, sizeof(double), "rx_spur_f1");
   double rx_spur_f2 ;
    klee_make_symbolic(&rx_spur_f2, sizeof(double), "rx_spur_f2");
   double rx_spur_l1 ;
    klee_make_symbolic(&rx_spur_l1, sizeof(double), "rx_spur_l1");
   double rx_spur_l2 ;
    klee_make_symbolic(&rx_spur_l2, sizeof(double), "rx_spur_l2");
};
...
struct hfa384x_rridresult {
   ...
   unsigned int riddata_len ;
    klee_make_symbolic(&riddata_len, sizeof(int), "riddata_len");
};
...
struct prism2sta_accesslist {
   unsigned int modify ;
    klee_make_symbolic(&modify, sizeof(int), "modify");
   unsigned int cnt ;
   u8 addr[60U][6U] ;
   unsigned int cnt1 ;
...
struct hfa384x {
   ...
   unsigned long usb_flags ;
    klee_make_symbolic(&usb_flags, sizeof(long), "usb_flags");
   unsigned char req_timer_done : 1 ;
   unsigned char resp_timer_done : 1 ;
   int endp_in ;
    klee_make_symbolic(&endp_in, sizeof(int), "endp_in");
   int endp_out ;
    klee_make_symbolic(&endp_out, sizeof(int), "endp_out");
   int sniff_fcs ;
    klee_make_symbolic(&sniff_fcs, sizeof(int), "sniff_fcs");
   int sniff_channel ;
    klee_make_symbolic(&sniff_channel, sizeof(int), "sniff_channel");
   int sniff_truncate ;
    klee_make_symbolic(&sniff_truncate, sizeof(int), "sniff_truncate");
   int sniffhdr ;
    klee_make_symbolic(&sniffhdr, sizeof(int), "sniffhdr");
   wait_queue_head_t cmdq ;
   u32 state ;
   u32 isap ;
   u8 port_enabled[8U] ;
   unsigned int dlstate ;
    klee_make_symbolic(&dlstate, sizeof(int), "dlstate");
   hfa384x_downloadbuffer_t bufinfo ;
   u16 dltimeout ;
   int scanflag ;
    klee_make_symbolic(&scanflag, sizeof(int), "scanflag");
   int join_ap ;
    klee_make_symbolic(&join_ap, sizeof(int), "join_ap");
   int join_retries ;
    klee_make_symbolic(&join_retries, sizeof(int), "join_retries");
   ...
   unsigned int presniff_port_type ;
    klee_make_symbolic(&presniff_port_type, sizeof(int), "presniff_port_type");
   u16 presniff_wepflags ;
   u32 dot11_desired_bss_type ;
   int dbmadjust ;
    klee_make_symbolic(&dbmadjust, sizeof(int), "dbmadjust");
   u8 dot11_grp_addr[32U][6U] ;
   unsigned int dot11_grpcnt ;
    klee_make_symbolic(&dot11_grpcnt, sizeof(int), "dot11_grpcnt");
   ...
   unsigned int accessmode ;
    klee_make_symbolic(&accessmode, sizeof(int), "accessmode");
...
struct usbctlx_rrid_completor {
   ...
   unsigned int riddatalen ;
    klee_make_symbolic(&riddatalen, sizeof(int), "riddatalen");
};
...
struct s3crcrec {
   ...
   unsigned int dowrite ;
    klee_make_symbolic(&dowrite, sizeof(int), "dowrite");
};
...
struct pda {
   ...
   unsigned int nrec ;
    klee_make_symbolic(&nrec, sizeof(int), "nrec");
};
struct imgchunk {
   u32 addr ;
   u32 len ;
...
struct cfg80211_csa_settings {
   ...
   unsigned int n_counter_offsets_beacon ;
    klee_make_symbolic(&n_counter_offsets_beacon, sizeof(int), "n_counter_offsets_beacon");
   unsigned int n_counter_offsets_presp ;
    klee_make_symbolic(&n_counter_offsets_presp, sizeof(int), "n_counter_offsets_presp");
...
struct cfg80211_mgmt_tx_params {
   ...
   int n_csa_offsets ;
    klee_make_symbolic(&n_csa_offsets, sizeof(int), "n_csa_offsets");
...
int prism2_reset_holdtime ;
    klee_make_symbolic(&prism2_reset_holdtime, sizeof(int), "prism2_reset_holdtime");
int prism2_reset_settletime ;
    klee_make_symbolic(&prism2_reset_settletime, sizeof(int), "prism2_reset_settletime");
...
{ 
  ...
  int tmp___0 ;
  int ret___1 ;
    klee_make_symbolic(&ret___1, sizeof(int), "ret___1");
  int tmp___1 ;
  int tmp___2 ;
...
{ 
  ...
  int result ;
  int runqueue ;
    klee_make_symbolic(&runqueue, sizeof(int), "runqueue");
...
{ 
  ...
  u32 dlbufaddr ;
  int nburns ;
    klee_make_symbolic(&nburns, sizeof(int), "nburns");
  u32 burnlen ;
  u32 burndaddr ;
  u16 burnlo ;
  u16 burnhi ;
  int nwrites ;
    klee_make_symbolic(&nwrites, sizeof(int), "nwrites");
  u8 *writebuf ;
  u16 writepage ;
  u16 writeoffset ;
  u32 writelen ;
...
{ 
  ...
  u16 *pda___0 ;
  int pdaok ;
    klee_make_symbolic(&pdaok, sizeof(int), "pdaok");
  int morepdrs ;
    klee_make_symbolic(&morepdrs, sizeof(int), "morepdrs");
  int currpdr ;
    klee_make_symbolic(&currpdr, sizeof(int), "currpdr");
  size_t i ;
  u16 pdrlen ;
  u16 pdrcode ;
  u16 currpage ;
...
{ 
  int result ;
  int result1 ;
    klee_make_symbolic(&result1, sizeof(int), "result1");
  int result2 ;
...
{ 
  int usbpktlen ;
    klee_make_symbolic(&usbpktlen, sizeof(int), "usbpktlen");
  int result ;
  int ret ;
  char *ptr ;
...
{ 
  ...
  unsigned long flags ;
  int sched ;
    klee_make_symbolic(&sched, sizeof(int), "sched");
  int tmp ;
  int tmp___0 ;
...
{ 
  ...
  unsigned long flags ;
  int reap ;
    klee_make_symbolic(&reap, sizeof(int), "reap");
  hfa384x_usbctlx_t *ctlx ;
  struct list_head  const  *__mptr ;
...
{ 
  hfa384x_usbctlx_t *ctlx ;
  int run_queue ;
    klee_make_symbolic(&run_queue, sizeof(int), "run_queue");
  unsigned long flags ;
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
...
{ 
  ...
  unsigned int skblen ;
    klee_make_symbolic(&skblen, sizeof(int), "skblen");
  u8 *datap ;
  u16 fc ;
  struct sk_buff *skb ;
  hfa384x_t *hw ;
...
{ 
  ...
  int delete_resptimer ;
    klee_make_symbolic(&delete_resptimer, sizeof(int), "delete_resptimer");
  int timer_ok ;
    klee_make_symbolic(&timer_ok, sizeof(int), "timer_ok");
  int run_queue ;
  hfa384x_usbctlx_t *ctlx ;
  unsigned long flags ;
  struct _ddebug descriptor ;
...
{ 
  ...
  int timeout ;
  int istmpenable ;
    klee_make_symbolic(&istmpenable, sizeof(int), "istmpenable");
...
{ 
  ...
  int result ;
  int isget ;
    klee_make_symbolic(&isget, sizeof(int), "isget");
  struct mibrec *mib ;
  u16 which ;
...
static int prism2_doreset  ;
    klee_make_symbolic(&prism2_doreset, sizeof(int), "prism2_doreset");
...
{ 
  hfa384x_t *hw ;
  int nbss ;
    klee_make_symbolic(&nbss, sizeof(int), "nbss");
...
{ 
  ...
  int j ;
  int currchunk ;
    klee_make_symbolic(&currchunk, sizeof(int), "currchunk");
  u32 nextaddr ;
  u32 s3start ;
  u32 s3end ;
  u32 cstart ;
...
{ 
  ...
  u16 *pda16 ;
  int curroff ;
    klee_make_symbolic(&curroff, sizeof(int), "curroff");
...
{ 
  ...
  long tmp___1 ;
  int lenleft ;
    klee_make_symbolic(&lenleft, sizeof(int), "lenleft");
  struct _ddebug descriptor___0 ;
  long tmp___2 ;
  struct _ddebug descriptor___1 ;
  long tmp___3 ;
...
{ 
  ...
  int result ;
  int trump ;
    klee_make_symbolic(&trump, sizeof(int), "trump");
  struct _ddebug descriptor ;
  long tmp ;
  struct _ddebug descriptor___0 ;
  long tmp___0 ;
...
{ 
  ...
  int foo ;
    klee_make_symbolic(&foo, sizeof(int), "foo");
  struct _ddebug descriptor ;
  long tmp ;
  struct _ddebug descriptor___0 ;
  long tmp___0 ;
...
{ 
  ...
  unsigned int payload_length ;
    klee_make_symbolic(&payload_length, sizeof(int), "payload_length");
  unsigned int payload_offset ;
    klee_make_symbolic(&payload_offset, sizeof(int), "payload_offset");
  u8 daddr[6U] ;
  u8 saddr[6U] ;
...
extern void cfg80211_disconnected(struct net_device * , u16  , u8 const   * , size_t  ,
                                  bool  , gfp_t  ) ;
int wlan_watchdog ;
    klee_make_symbolic(&wlan_watchdog, sizeof(int), "wlan_watchdog");
int wlan_wext_write ;
    klee_make_symbolic(&wlan_wext_write, sizeof(int), "wlan_wext_write");
...
{ 
  ...
  int err ;
  int numbss ;
    klee_make_symbolic(&numbss, sizeof(int), "numbss");
  int i ;
  u8 ie_buf[46U] ;
  int ie_len ;
...
{ 
  ...
  int chan ;
  int is_wep ;
    klee_make_symbolic(&is_wep, sizeof(int), "is_wep");
  int result ;
  int err ;
...
{ 
  int result ;
  int txresult ;
    klee_make_symbolic(&txresult, sizeof(int), "txresult");
  wlandevice_t *wlandev ;
