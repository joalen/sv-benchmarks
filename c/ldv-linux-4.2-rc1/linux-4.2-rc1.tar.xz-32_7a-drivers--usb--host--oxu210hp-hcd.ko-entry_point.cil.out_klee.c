...
struct oxu_hcd {
   ...
   unsigned int periodic_sched ;
    klee_make_symbolic(&periodic_sched, sizeof(int), "periodic_sched");
   ...
   unsigned long actions ;
    klee_make_symbolic(&actions, sizeof(long), "actions");
   unsigned int stamp ;
...
{ 
  int n_blocks ;
    klee_make_symbolic(&n_blocks, sizeof(int), "n_blocks");
  int a_blocks ;
    klee_make_symbolic(&a_blocks, sizeof(int), "a_blocks");
  int i ;
...
{ 
  ...
  unsigned int count ;
  int do_status ;
    klee_make_symbolic(&do_status, sizeof(int), "do_status");
  u8 state ;
  struct oxu_murb *murb ;
  int tmp___0 ;
  long tmp___1 ;
...
{ 
  ...
  unsigned int now_uframe ;
    klee_make_symbolic(&now_uframe, sizeof(int), "now_uframe");
  unsigned int mod ;
  ...
  unsigned int uframes ;
    klee_make_symbolic(&uframes, sizeof(int), "uframes");
...
{ 
  ...
  unsigned long memstart ;
    klee_make_symbolic(&memstart, sizeof(long), "memstart");
  unsigned long memlen ;
    klee_make_symbolic(&memlen, sizeof(long), "memlen");
  int irq ;
  int ret ;
  struct oxu_info *info ;
  int tmp ;
