...
typedef int ldlm_mode_t;
    klee_make_symbolic(&ldlm_mode_t, sizeof(int), "ldlm_mode_t");
typedef int ldlm_type_t;
    klee_make_symbolic(&ldlm_type_t, sizeof(int), "ldlm_type_t");
struct ldlm_extent {
   __u64 start ;
   __u64 end ;
   __u64 gid ;
...
struct l_wait_info {
   long lwi_timeout ;
    klee_make_symbolic(&lwi_timeout, sizeof(long), "lwi_timeout");
   long lwi_interval ;
    klee_make_symbolic(&lwi_interval, sizeof(long), "lwi_interval");
   int lwi_allow_intr ;
    klee_make_symbolic(&lwi_allow_intr, sizeof(int), "lwi_allow_intr");
...
struct dt_device_param {
   unsigned int ddp_max_name_len ;
    klee_make_symbolic(&ddp_max_name_len, sizeof(int), "ddp_max_name_len");
   unsigned int ddp_max_nlink ;
    klee_make_symbolic(&ddp_max_nlink, sizeof(int), "ddp_max_nlink");
   unsigned int ddp_block_shift ;
    klee_make_symbolic(&ddp_block_shift, sizeof(int), "ddp_block_shift");
   mntopt_t ddp_mntopts ;
   unsigned int ddp_max_ea_size ;
    klee_make_symbolic(&ddp_max_ea_size, sizeof(int), "ddp_max_ea_size");
   void *ddp_mnt ;
   int ddp_mount_type ;
    klee_make_symbolic(&ddp_mount_type, sizeof(int), "ddp_mount_type");
   unsigned long long ddp_maxbytes ;
    klee_make_symbolic(&ddp_maxbytes, sizeof(long), "ddp_maxbytes");
   int ddp_grant_reserved ;
    klee_make_symbolic(&ddp_grant_reserved, sizeof(int), "ddp_grant_reserved");
   short ddp_inodespace ;
    klee_make_symbolic(&ddp_inodespace, sizeof(short), "ddp_inodespace");
   int ddp_grant_frag ;
    klee_make_symbolic(&ddp_grant_frag, sizeof(int), "ddp_grant_frag");
};
...
struct dof_regular {
   int striped ;
    klee_make_symbolic(&striped, sizeof(int), "striped");
};
struct dof_dir {
...
struct llog_handle {
   ...
   int lgh_last_idx ;
    klee_make_symbolic(&lgh_last_idx, sizeof(int), "lgh_last_idx");
   int lgh_cur_idx ;
    klee_make_symbolic(&lgh_cur_idx, sizeof(int), "lgh_cur_idx");
...
struct llog_ctxt {
   int loc_idx ;
    klee_make_symbolic(&loc_idx, sizeof(int), "loc_idx");
   ...
   long loc_flags ;
    klee_make_symbolic(&loc_flags, sizeof(long), "loc_flags");
...
struct ll_iattr {
   ...
   unsigned int ia_attr_flags ;
    klee_make_symbolic(&ia_attr_flags, sizeof(int), "ia_attr_flags");
};
...
struct kstatfs {
   long f_type ;
    klee_make_symbolic(&f_type, sizeof(long), "f_type");
   long f_bsize ;
    klee_make_symbolic(&f_bsize, sizeof(long), "f_bsize");
   u64 f_blocks ;
   u64 f_bfree ;
   u64 f_bavail ;
   u64 f_files ;
   ...
   long f_namelen ;
    klee_make_symbolic(&f_namelen, sizeof(long), "f_namelen");
   long f_frsize ;
    klee_make_symbolic(&f_frsize, sizeof(long), "f_frsize");
   long f_flags ;
   long f_spare[4U] ;
};
struct lustre_attr {
...
extern unsigned long cfs_fail_loc ;
    klee_make_symbolic(&cfs_fail_loc, sizeof(long), "cfs_fail_loc");
...
extern unsigned int obd_alloc_fail_rate ;
    klee_make_symbolic(&obd_alloc_fail_rate, sizeof(int), "obd_alloc_fail_rate");
...
{ 
  ...
  unsigned int coffset ;
    klee_make_symbolic(&coffset, sizeof(int), "coffset");
  struct libcfs_debug_msg_data __msg_data ;
  long tmp___2 ;
...
{ 
  int rc1 ;
    klee_make_symbolic(&rc1, sizeof(int), "rc1");
  int rc2 ;
...
{ 
  int __v ;
    klee_make_symbolic(&__v, sizeof(int), "__v");
  int tmp ;
  struct libcfs_debug_msg_data __msg_data ;
  long tmp___0 ;
  struct libcfs_debug_msg_data msgdata ;
...
{ 
  struct ptlrpc_request *req ;
  int xattr_namelen ;
    klee_make_symbolic(&xattr_namelen, sizeof(int), "xattr_namelen");
  char *tmp ;
  int rc ;
...
{ 
  ...
  long tmp___1 ;
  int lmmsize ;
    klee_make_symbolic(&lmmsize, sizeof(int), "lmmsize");
  ...
  int tmp___5 ;
  int lmvsize ;
    klee_make_symbolic(&lmvsize, sizeof(int), "lmvsize");
...
{ 
  int committed ;
    klee_make_symbolic(&committed, sizeof(int), "committed");
  bool tmp ;
  struct libcfs_debug_msg_data __msg_data ;
  long tmp___0 ;
  struct libcfs_debug_msg_data msgdata___0 ;
...
{ 
  ...
  int rc ;
  int saved_rc ;
    klee_make_symbolic(&saved_rc, sizeof(int), "saved_rc");
  struct cfs_debug_limit_state cdls ;
  struct libcfs_debug_msg_data msgdata ;
  int tmp___0 ;
...
{ 
  ...
  int resends ;
    klee_make_symbolic(&resends, sizeof(int), "resends");
  ...
  wait_queue_t __wait ;
  long __timeout ;
    klee_make_symbolic(&__timeout, sizeof(long), "__timeout");
  sigset_t __blocked ;
  int __allow_intr ;
    klee_make_symbolic(&__allow_intr, sizeof(int), "__allow_intr");
  ...
  long tmp___9 ;
  long remaining ;
    klee_make_symbolic(&remaining, sizeof(long), "remaining");
  long tmp___10 ;
...
{ 
  int rc ;
  int mdsize ;
    klee_make_symbolic(&mdsize, sizeof(int), "mdsize");
  int *max_easize ;
  int *default_easize ;
  int mdsize___0 ;
    klee_make_symbolic(&mdsize___0, sizeof(int), "mdsize___0");
  int *max_cookiesize ;
...
{ 
  ...
  int ldvarg51 ;
    klee_make_symbolic(&ldvarg51, sizeof(int), "ldvarg51");
  int ldvarg32 ;
  ...
  void *tmp___3 ;
  int ldvarg53 ;
    klee_make_symbolic(&ldvarg53, sizeof(int), "ldvarg53");
  int ldvarg64 ;
    klee_make_symbolic(&ldvarg64, sizeof(int), "ldvarg64");
  char *ldvarg29 ;
  void *tmp___4 ;
  ...
  u64 ldvarg33 ;
  int ldvarg48 ;
    klee_make_symbolic(&ldvarg48, sizeof(int), "ldvarg48");
  void *ldvarg28 ;
  void *tmp___7 ;
  char *ldvarg34 ;
  void *tmp___8 ;
  ...
  void *tmp___11 ;
  int ldvarg80 ;
    klee_make_symbolic(&ldvarg80, sizeof(int), "ldvarg80");
  ...
  __u64 ldvarg62 ;
  int ldvarg65 ;
    klee_make_symbolic(&ldvarg65, sizeof(int), "ldvarg65");
  __u64 ldvarg57 ;
  ...
  void *tmp___26 ;
  int ldvarg137 ;
    klee_make_symbolic(&ldvarg137, sizeof(int), "ldvarg137");
  ...
  unsigned int ldvarg117 ;
    klee_make_symbolic(&ldvarg117, sizeof(int), "ldvarg117");
  int tmp___43 ;
  int tmp___44 ;
  int tmp___45 ;
  int tmp___46 ;
...
extern unsigned int obd_timeout ;
    klee_make_symbolic(&obd_timeout, sizeof(int), "obd_timeout");
...
{ 
  ...
  int count ;
  int maxdata ;
    klee_make_symbolic(&maxdata, sizeof(int), "maxdata");
  struct list_head cancels ;
  struct obd_import *tmp ;
  void *tmp___0 ;
  void *tmp___1 ;
...
{ 
  ...
  int rc ;
  int easize ;
    klee_make_symbolic(&easize, sizeof(int), "easize");
  struct obd_import *tmp___1 ;
  void *tmp___2 ;
  void *tmp___3 ;
  void *tmp___4 ;
...
{ 
  ...
  void *lvb_data ;
  int lvb_len ;
    klee_make_symbolic(&lvb_len, sizeof(int), "lvb_len");
  struct libcfs_debug_msg_data __msg_data ;
  long tmp ;
  void *tmp___0 ;
  struct libcfs_debug_msg_data __msg_data___0 ;
...
{ 
  ...
  void *tmp___0 ;
  int ldvarg104 ;
    klee_make_symbolic(&ldvarg104, sizeof(int), "ldvarg104");
  int tmp___1 ;
...
{ 
  int ldvarg141 ;
    klee_make_symbolic(&ldvarg141, sizeof(int), "ldvarg141");
  loff_t ldvarg142 ;
  char *ldvarg144 ;
  void *tmp ;
  size_t ldvarg143 ;
