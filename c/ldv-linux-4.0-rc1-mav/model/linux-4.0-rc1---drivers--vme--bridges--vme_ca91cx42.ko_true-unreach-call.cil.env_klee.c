...
// Function: vme_irq_handler
// with type: void vme_irq_handler(struct vme_bridge *, int, int)
// with return type: void
...
// Function: vme_register_bridge
// with type: int vme_register_bridge(struct vme_bridge *)
// with return type: int
int __VERIFIER_nondet_int(void);
...
// Function: vme_unregister_bridge
// with type: void vme_unregister_bridge(struct vme_bridge *)
// with return type: void
