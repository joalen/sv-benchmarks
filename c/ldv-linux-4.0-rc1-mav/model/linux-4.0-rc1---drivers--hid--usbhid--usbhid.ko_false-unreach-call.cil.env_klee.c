...
// Function: hid_add_device
// with type: int hid_add_device(struct hid_device *)
// with return type: int
int __VERIFIER_nondet_int(void);
...
// with type: int hid_check_keys_pressed(struct hid_device *)
// with return type: int
int __VERIFIER_nondet_int(void);
...
// Function: hid_destroy_device
// with type: void hid_destroy_device(struct hid_device *)
// with return type: void
...
// with type: int hid_input_report(struct hid_device *, int, u8 *, int, int)
// with return type: int
int __VERIFIER_nondet_int(void);
...
// with type: void hid_output_report(struct hid_report *, __u8 *)
// with return type: void
...
// with type: int hid_parse_report(struct hid_device *, __u8 *, unsigned int)
// with return type: int
int __VERIFIER_nondet_int(void);
...
// Function: hid_set_field
// with type: int hid_set_field(struct hid_field *, unsigned int, __s32 )
// with return type: int
int __VERIFIER_nondet_int(void);
...
// Function: hidinput_count_leds
// with type: unsigned int hidinput_count_leds(struct hid_device *)
...
// Function: usb_block_urb
// with type: void usb_block_urb(struct urb *)
// with return type: void
