...
struct ipmi_ipmb_addr {
   ...
   unsigned char slave_addr ;
    klee_make_symbolic(&slave_addr, sizeof(char), "slave_addr");
   unsigned char lun ;
};
struct ipmi_lan_addr {
   ...
   unsigned char privilege ;
    klee_make_symbolic(&privilege, sizeof(char), "privilege");
   unsigned char session_handle ;
    klee_make_symbolic(&session_handle, sizeof(char), "session_handle");
   unsigned char remote_SWID ;
    klee_make_symbolic(&remote_SWID, sizeof(char), "remote_SWID");
   unsigned char local_SWID ;
    klee_make_symbolic(&local_SWID, sizeof(char), "local_SWID");
   unsigned char lun ;
};
...
struct ipmi_device_id {
   unsigned char device_id ;
    klee_make_symbolic(&device_id, sizeof(char), "device_id");
   unsigned char device_revision ;
    klee_make_symbolic(&device_revision, sizeof(char), "device_revision");
   unsigned char firmware_revision_1 ;
    klee_make_symbolic(&firmware_revision_1, sizeof(char), "firmware_revision_1");
   unsigned char firmware_revision_2 ;
    klee_make_symbolic(&firmware_revision_2, sizeof(char), "firmware_revision_2");
   unsigned char ipmi_version ;
    klee_make_symbolic(&ipmi_version, sizeof(char), "ipmi_version");
   unsigned char additional_device_support ;
    klee_make_symbolic(&additional_device_support, sizeof(char), "additional_device_support");
   unsigned int manufacturer_id ;
    klee_make_symbolic(&manufacturer_id, sizeof(int), "manufacturer_id");
   unsigned int product_id ;
    klee_make_symbolic(&product_id, sizeof(int), "product_id");
...
struct cmd_rcvr {
   ...
   unsigned char cmd ;
   unsigned int chans ;
    klee_make_symbolic(&chans, sizeof(int), "chans");
...
struct seq_table {
   ...
   unsigned long orig_timeout ;
    klee_make_symbolic(&orig_timeout, sizeof(long), "orig_timeout");
   unsigned int retries_left ;
    klee_make_symbolic(&retries_left, sizeof(int), "retries_left");
   long seqid ;
    klee_make_symbolic(&seqid, sizeof(long), "seqid");
   struct ipmi_recv_msg *recv_msg ;
};
struct ipmi_channel {
   unsigned char medium ;
    klee_make_symbolic(&medium, sizeof(char), "medium");
   unsigned char protocol ;
    klee_make_symbolic(&protocol, sizeof(char), "protocol");
   unsigned char address ;
    klee_make_symbolic(&address, sizeof(char), "address");
   unsigned char lun ;
};
...
struct bmc_device {
   ...
   int guid_set ;
    klee_make_symbolic(&guid_set, sizeof(int), "guid_set");
   char name[16U] ;
...
struct ipmi_smi {
   ...
   int curr_seq ;
    klee_make_symbolic(&curr_seq, sizeof(int), "curr_seq");
   ...
   unsigned int waiting_events_count ;
    klee_make_symbolic(&waiting_events_count, sizeof(int), "waiting_events_count");
   char delivering_events ;
    klee_make_symbolic(&delivering_events, sizeof(char), "delivering_events");
   char event_msg_printed ;
    klee_make_symbolic(&event_msg_printed, sizeof(char), "event_msg_printed");
   atomic_t event_waiters ;
   unsigned int ticks_to_req_ev ;
    klee_make_symbolic(&ticks_to_req_ev, sizeof(int), "ticks_to_req_ev");
   int last_needs_timer ;
    klee_make_symbolic(&last_needs_timer, sizeof(int), "last_needs_timer");
   unsigned char event_receiver ;
    klee_make_symbolic(&event_receiver, sizeof(char), "event_receiver");
   unsigned char event_receiver_lun ;
    klee_make_symbolic(&event_receiver_lun, sizeof(char), "event_receiver_lun");
   unsigned char local_sel_device ;
    klee_make_symbolic(&local_sel_device, sizeof(char), "local_sel_device");
   unsigned char local_event_generator ;
    klee_make_symbolic(&local_event_generator, sizeof(char), "local_event_generator");
   int maintenance_mode ;
    klee_make_symbolic(&maintenance_mode, sizeof(int), "maintenance_mode");
   bool maintenance_mode_enable ;
   int auto_maintenance_timeout ;
    klee_make_symbolic(&auto_maintenance_timeout, sizeof(int), "auto_maintenance_timeout");
   spinlock_t maintenance_mode_lock ;
   void (*null_user_handler)(ipmi_smi_t  , struct ipmi_recv_msg * ) ;
   int curr_channel ;
    klee_make_symbolic(&curr_channel, sizeof(int), "curr_channel");
   struct ipmi_channel channels[16U] ;
   struct proc_dir_entry *proc_dir ;
   char proc_dir_name[10U] ;
   atomic_t stats[28U] ;
   int run_to_completion ;
    klee_make_symbolic(&run_to_completion, sizeof(int), "run_to_completion");
};
...
{ 
  ...
  unsigned long flags ;
  unsigned char seq ;
    klee_make_symbolic(&seq, sizeof(char), "seq");
  unsigned long seqid ;
...
{ 
  ...
  unsigned char ipmb_seq ;
    klee_make_symbolic(&ipmb_seq, sizeof(char), "ipmb_seq");
  long seqid ;
  int broadcast ;
    klee_make_symbolic(&broadcast, sizeof(int), "broadcast");
  struct ipmi_lan_addr *lan_addr ;
  unsigned char ipmb_seq___0 ;
    klee_make_symbolic(&ipmb_seq___0, sizeof(char), "ipmb_seq___0");
  long seqid___0 ;
    klee_make_symbolic(&seqid___0, sizeof(long), "seqid___0");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
...
{ 
  unsigned char saddr ;
    klee_make_symbolic(&saddr, sizeof(char), "saddr");
  unsigned char lun ;
  int rv ;
  int tmp ;
...
{ 
  ...
  unsigned char orig_dev_id ;
    klee_make_symbolic(&orig_dev_id, sizeof(char), "orig_dev_id");
  int warn_printed ;
    klee_make_symbolic(&warn_printed, sizeof(int), "warn_printed");
...
{ 
  ...
  int rv ;
  int deliver_count ;
    klee_make_symbolic(&deliver_count, sizeof(int), "deliver_count");
  unsigned long flags ;
  struct list_head *__ptr ;
  struct list_head  const  *__mptr ;
  struct list_head *________p1 ;
...
{ 
  int requeue ;
    klee_make_symbolic(&requeue, sizeof(int), "requeue");
  int chan ;
  struct ipmi_recv_msg *recv_msg ;
...
{ 
  ...
  int i ;
  unsigned int waiting_msgs ;
    klee_make_symbolic(&waiting_msgs, sizeof(int), "waiting_msgs");
  struct list_head  const  *__mptr ;
  struct list_head  const  *__mptr___0 ;
  struct list_head  const  *__mptr___1 ;
...
{ 
  ipmi_smi_t intf ;
  int nt ;
    klee_make_symbolic(&nt, sizeof(int), "nt");
  int tmp ;
  struct list_head *__ptr ;
  struct list_head  const  *__mptr ;
  struct list_head *________p1 ;
  ...
  int tmp___0 ;
  int lnt ;
    klee_make_symbolic(&lnt, sizeof(int), "lnt");
  int tmp___1 ;
  unsigned int tmp___2 ;
  struct list_head *__ptr___0 ;
  struct list_head  const  *__mptr___0 ;
...
static int has_panicked  ;
    klee_make_symbolic(&has_panicked, sizeof(int), "has_panicked");
...
{ 
  ...
  unsigned long ldv_14_ldv_param_3_1_default ;
    klee_make_symbolic(&ldv_14_ldv_param_3_1_default, sizeof(long), "ldv_14_ldv_param_3_1_default");
