...
struct ims_pcu {
   ...
   unsigned int device_no ;
    klee_make_symbolic(&device_no, sizeof(int), "device_no");
   ...
   int update_firmware_status ;
    klee_make_symbolic(&update_firmware_status, sizeof(int), "update_firmware_status");
   u8 device_id ;
   u8 ofn_reg_addr ;
...
struct ims_pcu_attribute {
   ...
   size_t field_offset ;
   int field_length ;
    klee_make_symbolic(&field_length, sizeof(int), "field_length");
};
...
{ 
  ...
  unsigned short keycode ;
    klee_make_symbolic(&keycode, sizeof(short), "keycode");
...
{ 
  unsigned int n_fw_records ;
    klee_make_symbolic(&n_fw_records, sizeof(int), "n_fw_records");
  int retval ;
...
{ 
  ...
  int desired_brightness ;
    klee_make_symbolic(&desired_brightness, sizeof(int), "desired_brightness");
  __le16 br_val ;
  int error ;
...
{ 
  ...
  int ldv_0_ldv_param_3_2_default ;
    klee_make_symbolic(&ldv_0_ldv_param_3_2_default, sizeof(int), "ldv_0_ldv_param_3_2_default");
  int tmp ;
...
{ 
  ...
  unsigned long ldv_1_ldv_param_9_3_default ;
    klee_make_symbolic(&ldv_1_ldv_param_9_3_default, sizeof(long), "ldv_1_ldv_param_9_3_default");
  void *tmp ;
  void *tmp___0 ;
  int tmp___1 ;
  int tmp___2 ;
