...
struct ttusb {
   ...
   int disconnecting ;
    klee_make_symbolic(&disconnecting, sizeof(int), "disconnecting");
   int iso_streaming ;
    klee_make_symbolic(&iso_streaming, sizeof(int), "iso_streaming");
   unsigned int bulk_out_pipe ;
    klee_make_symbolic(&bulk_out_pipe, sizeof(int), "bulk_out_pipe");
   unsigned int bulk_in_pipe ;
    klee_make_symbolic(&bulk_in_pipe, sizeof(int), "bulk_in_pipe");
   unsigned int isoc_in_pipe ;
    klee_make_symbolic(&isoc_in_pipe, sizeof(int), "isoc_in_pipe");
   void *iso_buffer ;
   dma_addr_t iso_dma_handle ;
   struct urb *iso_urb[4U] ;
   int running_feed_count ;
    klee_make_symbolic(&running_feed_count, sizeof(int), "running_feed_count");
   int last_channel ;
    klee_make_symbolic(&last_channel, sizeof(int), "last_channel");
   int last_filter ;
    klee_make_symbolic(&last_filter, sizeof(int), "last_filter");
   u8 c ;
   fe_sec_tone_mode_t tone ;
   fe_sec_voltage_t voltage ;
   int mux_state ;
    klee_make_symbolic(&mux_state, sizeof(int), "mux_state");
   u8 mux_npacks ;
   u8 muxpack[264U] ;
   int muxpack_ptr ;
    klee_make_symbolic(&muxpack_ptr, sizeof(int), "muxpack_ptr");
   int muxpack_len ;
    klee_make_symbolic(&muxpack_len, sizeof(int), "muxpack_len");
   int insync ;
...
static int numpkt  ;
    klee_make_symbolic(&numpkt, sizeof(int), "numpkt");
static int numts  ;
    klee_make_symbolic(&numts, sizeof(int), "numts");
static int numstuff  ;
    klee_make_symbolic(&numstuff, sizeof(int), "numstuff");
static int numsec  ;
    klee_make_symbolic(&numsec, sizeof(int), "numsec");
static int numinvalid  ;
    klee_make_symbolic(&numinvalid, sizeof(int), "numinvalid");
static unsigned long lastj  ;
    klee_make_symbolic(&lastj, sizeof(long), "lastj");
...
{ 
  int maxwork ;
    klee_make_symbolic(&maxwork, sizeof(int), "maxwork");
  int tmp ;
  u8 *tmp___0 ;
  u8 *tmp___1 ;
  int avail ;
...
{ 
  struct ttusb *ttusb ;
  int feed_type ;
    klee_make_symbolic(&feed_type, sizeof(int), "feed_type");
  int tmp ;
...
{ 
  ...
  struct i2c_msg tuner_msg ;
  int tuner_frequency ;
    klee_make_symbolic(&tuner_frequency, sizeof(int), "tuner_frequency");
  u8 band ;
  u8 cp ;
  u8 filter ;
  int tmp ;
...
{ 
  ...
  unsigned int ldv_1_ldv_param_3_2_default ;
    klee_make_symbolic(&ldv_1_ldv_param_3_2_default, sizeof(int), "ldv_1_ldv_param_3_2_default");
  int tmp ;
...
{ 
  ...
  int ldv_3_probe_retval_default ;
    klee_make_symbolic(&ldv_3_probe_retval_default, sizeof(int), "ldv_3_probe_retval_default");
