...
struct snd_hwdep_dsp_status {
   ...
   unsigned int num_dsps ;
    klee_make_symbolic(&num_dsps, sizeof(int), "num_dsps");
   unsigned int dsp_loaded ;
    klee_make_symbolic(&dsp_loaded, sizeof(int), "dsp_loaded");
   unsigned int chip_ready ;
    klee_make_symbolic(&chip_ready, sizeof(int), "chip_ready");
...
struct snd_hwdep_dsp_image {
   ...
   unsigned long driver_data ;
    klee_make_symbolic(&driver_data, sizeof(long), "driver_data");
};
...
struct snd_hwdep {
   ...
   char name[80U] ;
   int iface ;
    klee_make_symbolic(&iface, sizeof(int), "iface");
   int oss_type ;
    klee_make_symbolic(&oss_type, sizeof(int), "oss_type");
   int ossreg ;
    klee_make_symbolic(&ossreg, sizeof(int), "ossreg");
...
struct vx_ibl_info {
   ...
   int min_size ;
    klee_make_symbolic(&min_size, sizeof(int), "min_size");
   int granularity ;
    klee_make_symbolic(&granularity, sizeof(int), "granularity");
};
struct vx_pipe {
   int number ;
   ...
   unsigned int differed_type ;
    klee_make_symbolic(&differed_type, sizeof(int), "differed_type");
   pcx_time_t pcx_time ;
   struct snd_pcm_substream *substream ;
   int hbuf_size ;
    klee_make_symbolic(&hbuf_size, sizeof(int), "hbuf_size");
   int buffer_bytes ;
    klee_make_symbolic(&buffer_bytes, sizeof(int), "buffer_bytes");
   int period_bytes ;
    klee_make_symbolic(&period_bytes, sizeof(int), "period_bytes");
   int hw_ptr ;
    klee_make_symbolic(&hw_ptr, sizeof(int), "hw_ptr");
   int position ;
    klee_make_symbolic(&position, sizeof(int), "position");
   int transferred ;
    klee_make_symbolic(&transferred, sizeof(int), "transferred");
   int align ;
    klee_make_symbolic(&align, sizeof(int), "align");
   u64 cur_count ;
   unsigned int references ;
    klee_make_symbolic(&references, sizeof(int), "references");
...
struct snd_vx_hardware {
   ...
   unsigned int num_codecs ;
    klee_make_symbolic(&num_codecs, sizeof(int), "num_codecs");
   unsigned int num_ins ;
    klee_make_symbolic(&num_ins, sizeof(int), "num_ins");
   unsigned int num_outs ;
    klee_make_symbolic(&num_outs, sizeof(int), "num_outs");
   unsigned int output_level_max ;
    klee_make_symbolic(&output_level_max, sizeof(int), "output_level_max");
...
struct vx_core {
   ...
   unsigned int chip_status ;
    klee_make_symbolic(&chip_status, sizeof(int), "chip_status");
   unsigned int pcm_running ;
    klee_make_symbolic(&pcm_running, sizeof(int), "pcm_running");
   struct device *dev ;
   struct snd_hwdep *hwdep ;
   struct vx_rmh irq_rmh ;
   unsigned int audio_info ;
    klee_make_symbolic(&audio_info, sizeof(int), "audio_info");
   unsigned int audio_ins ;
    klee_make_symbolic(&audio_ins, sizeof(int), "audio_ins");
   unsigned int audio_outs ;
    klee_make_symbolic(&audio_outs, sizeof(int), "audio_outs");
   struct vx_pipe **playback_pipes ;
   struct vx_pipe **capture_pipes ;
   unsigned int audio_source ;
    klee_make_symbolic(&audio_source, sizeof(int), "audio_source");
   unsigned int audio_source_target ;
    klee_make_symbolic(&audio_source_target, sizeof(int), "audio_source_target");
   unsigned int clock_mode ;
    klee_make_symbolic(&clock_mode, sizeof(int), "clock_mode");
   unsigned int clock_source ;
    klee_make_symbolic(&clock_source, sizeof(int), "clock_source");
   unsigned int freq ;
    klee_make_symbolic(&freq, sizeof(int), "freq");
   unsigned int freq_detected ;
    klee_make_symbolic(&freq_detected, sizeof(int), "freq_detected");
   unsigned int uer_detected ;
    klee_make_symbolic(&uer_detected, sizeof(int), "uer_detected");
   unsigned int uer_bits ;
    klee_make_symbolic(&uer_bits, sizeof(int), "uer_bits");
...
typedef int snd_ctl_elem_type_t;
    klee_make_symbolic(&snd_ctl_elem_type_t, sizeof(int), "snd_ctl_elem_type_t");
typedef int snd_ctl_elem_iface_t;
    klee_make_symbolic(&snd_ctl_elem_iface_t, sizeof(int), "snd_ctl_elem_iface_t");
struct snd_ctl_elem_id {
   unsigned int numid ;
    klee_make_symbolic(&numid, sizeof(int), "numid");
   snd_ctl_elem_iface_t iface ;
   unsigned int device ;
   unsigned int subdevice ;
    klee_make_symbolic(&subdevice, sizeof(int), "subdevice");
...
struct __anonstruct_integer_189 {
   ...
   long max ;
   long step ;
    klee_make_symbolic(&step, sizeof(long), "step");
};
...
struct __anonstruct_enumerated_191 {
   unsigned int items ;
    klee_make_symbolic(&items, sizeof(int), "items");
   unsigned int item ;
    klee_make_symbolic(&item, sizeof(int), "item");
   char name[64U] ;
   __u64 names_ptr ;
   unsigned int names_length ;
    klee_make_symbolic(&names_length, sizeof(int), "names_length");
};
...
struct snd_kcontrol_new {
   ...
   unsigned long private_value ;
    klee_make_symbolic(&private_value, sizeof(long), "private_value");
};
struct snd_ctl_file;
...
struct snd_ctl_file {
   ...
   struct fasync_struct *fasync ;
   int subscribed ;
    klee_make_symbolic(&subscribed, sizeof(int), "subscribed");
...
struct vx_audio_level {
   ...
   unsigned int monitor_mute ;
    klee_make_symbolic(&monitor_mute, sizeof(int), "monitor_mute");
   short level ;
   short monitor_level ;
    klee_make_symbolic(&monitor_level, sizeof(short), "monitor_level");
};
struct vx_vu_meter {
   int saturated ;
    klee_make_symbolic(&saturated, sizeof(int), "saturated");
   int vu_level ;
    klee_make_symbolic(&vu_level, sizeof(int), "vu_level");
   int peak_level ;
    klee_make_symbolic(&peak_level, sizeof(int), "peak_level");
};
struct vx_cmd_info {
   unsigned int opcode ;
   ...
   int st_type ;
    klee_make_symbolic(&st_type, sizeof(int), "st_type");
   int st_length ;
    klee_make_symbolic(&st_length, sizeof(int), "st_length");
};
enum hrtimer_restart;
struct request;
struct device_private {
...
{ 
  unsigned long end_time ;
    klee_make_symbolic(&end_time, sizeof(long), "end_time");
  char *reg_names[27U] ;
  unsigned char tmp ;
...
{ 
  int nirq ;
    klee_make_symbolic(&nirq, sizeof(int), "nirq");
  int tmp ;
...
{ 
  unsigned int i ;
  int no_fillup ;
    klee_make_symbolic(&no_fillup, sizeof(int), "no_fillup");
  int tmp ;
...
{ 
  int err ;
  int cold_reset ;
    klee_make_symbolic(&cold_reset, sizeof(int), "cold_reset");
...
{ 
  unsigned int header ;
    klee_make_symbolic(&header, sizeof(int), "header");
  int tmp ;
  int tmp___0 ;
  int __ret_warn_on ;
  long tmp___1 ;
...
{ 
  ...
  int i ;
  int cur_state ;
    klee_make_symbolic(&cur_state, sizeof(int), "cur_state");
  int tmp ;
  unsigned long __ms ;
...
{ 
  ...
  struct vx_rmh rmh ;
  int data_mode ;
    klee_make_symbolic(&data_mode, sizeof(int), "data_mode");
  void *tmp ;
...
{ 
  ...
  struct vx_pipe *pipe ;
  unsigned int audio ;
    klee_make_symbolic(&audio, sizeof(int), "audio");
  int err ;
  int __ret_warn_on ;
  long tmp ;
  long tmp___0 ;
...
{ 
  ...
  int capture ;
    klee_make_symbolic(&capture, sizeof(int), "capture");
  int eob ;
    klee_make_symbolic(&eob, sizeof(int), "eob");
  int __ret_warn_on ;
  long tmp___0 ;
  long tmp___1 ;
...
{ 
  struct vx_rmh rmh ;
  int preferred ;
    klee_make_symbolic(&preferred, sizeof(int), "preferred");
  int tmp ;
  void *tmp___0 ;
  void *tmp___1 ;
...
{ 
  ...
  int err ;
  unsigned int outs ;
    klee_make_symbolic(&outs, sizeof(int), "outs");
  unsigned int ins ;
...
{ 
  ...
  unsigned int ldv_0_ldv_param_18_1_default ;
    klee_make_symbolic(&ldv_0_ldv_param_18_1_default, sizeof(int), "ldv_0_ldv_param_18_1_default");
  unsigned long ldv_0_ldv_param_21_1_default ;
    klee_make_symbolic(&ldv_0_ldv_param_21_1_default, sizeof(long), "ldv_0_ldv_param_21_1_default");
...
{ 
  ...
  unsigned int ldv_1_ldv_param_18_1_default ;
    klee_make_symbolic(&ldv_1_ldv_param_18_1_default, sizeof(int), "ldv_1_ldv_param_18_1_default");
  unsigned long ldv_1_ldv_param_21_1_default ;
    klee_make_symbolic(&ldv_1_ldv_param_21_1_default, sizeof(long), "ldv_1_ldv_param_21_1_default");
...
{ 
  struct vx_core *chip ;
  int codec ;
    klee_make_symbolic(&codec, sizeof(int), "codec");
...
{ 
  ...
  unsigned int val[2U] ;
  unsigned int vmax ;
    klee_make_symbolic(&vmax, sizeof(int), "vmax");
...
{ 
  ...
  char *dir[2U] ;
  int val___0 ;
    klee_make_symbolic(&val___0, sizeof(int), "val___0");
...
{ 
  int hexfreq ;
    klee_make_symbolic(&hexfreq, sizeof(int), "hexfreq");
  int __ret_warn_on ;
  long tmp ;
  long tmp___0 ;
...
{ 
  int src_changed ;
    klee_make_symbolic(&src_changed, sizeof(int), "src_changed");
  unsigned long __ms ;
  unsigned long tmp ;
