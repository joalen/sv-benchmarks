...
struct ms_status_register {
   unsigned char reserved ;
    klee_make_symbolic(&reserved, sizeof(char), "reserved");
   unsigned char interrupt ;
    klee_make_symbolic(&interrupt, sizeof(char), "interrupt");
   unsigned char status0 ;
    klee_make_symbolic(&status0, sizeof(char), "status0");
...
struct ms_id_register {
   ...
   unsigned char if_mode ;
    klee_make_symbolic(&if_mode, sizeof(char), "if_mode");
   unsigned char category ;
    klee_make_symbolic(&category, sizeof(char), "category");
   unsigned char class ;
    klee_make_symbolic(&class, sizeof(char), "class");
};
struct ms_param_register {
   unsigned char system ;
    klee_make_symbolic(&system, sizeof(char), "system");
   unsigned char block_address_msb ;
    klee_make_symbolic(&block_address_msb, sizeof(char), "block_address_msb");
   unsigned short block_address ;
    klee_make_symbolic(&block_address, sizeof(short), "block_address");
   unsigned char cp ;
    klee_make_symbolic(&cp, sizeof(char), "cp");
   unsigned char page_address ;
    klee_make_symbolic(&page_address, sizeof(char), "page_address");
};
struct ms_extra_data_register {
   unsigned char overwrite_flag ;
    klee_make_symbolic(&overwrite_flag, sizeof(char), "overwrite_flag");
   unsigned char management_flag ;
    klee_make_symbolic(&management_flag, sizeof(char), "management_flag");
   unsigned short logical_address ;
    klee_make_symbolic(&logical_address, sizeof(short), "logical_address");
};
struct ms_register {
...
struct ms_register_addr {
   unsigned char r_offset ;
    klee_make_symbolic(&r_offset, sizeof(char), "r_offset");
   unsigned char r_length ;
    klee_make_symbolic(&r_length, sizeof(char), "r_length");
   unsigned char w_offset ;
    klee_make_symbolic(&w_offset, sizeof(char), "w_offset");
   unsigned char w_length ;
    klee_make_symbolic(&w_length, sizeof(char), "w_length");
};
enum memstick_param {
    MEMSTICK_POWER = 1,
...
struct memstick_device_id {
   unsigned char match_flags ;
    klee_make_symbolic(&match_flags, sizeof(char), "match_flags");
   unsigned char type ;
   unsigned char category ;
   unsigned char class ;
};
struct __anonstruct____missing_field_name_225 {
   unsigned char data_len ;
    klee_make_symbolic(&data_len, sizeof(char), "data_len");
...
struct memstick_request {
   unsigned char tpc ;
    klee_make_symbolic(&tpc, sizeof(char), "tpc");
...
struct ms_boot_header {
   unsigned short block_id ;
    klee_make_symbolic(&block_id, sizeof(short), "block_id");
   unsigned short format_reserved ;
    klee_make_symbolic(&format_reserved, sizeof(short), "format_reserved");
   unsigned char reserved0[184U] ;
   unsigned char data_entry ;
    klee_make_symbolic(&data_entry, sizeof(char), "data_entry");
...
struct ms_system_item {
   ...
   unsigned char data_type_id ;
    klee_make_symbolic(&data_type_id, sizeof(char), "data_type_id");
...
struct ms_boot_attr_info {
   unsigned char memorystick_class ;
    klee_make_symbolic(&memorystick_class, sizeof(char), "memorystick_class");
   unsigned char format_unique_value1 ;
    klee_make_symbolic(&format_unique_value1, sizeof(char), "format_unique_value1");
   unsigned short block_size ;
    klee_make_symbolic(&block_size, sizeof(short), "block_size");
   unsigned short number_of_blocks ;
    klee_make_symbolic(&number_of_blocks, sizeof(short), "number_of_blocks");
   unsigned short number_of_effective_blocks ;
    klee_make_symbolic(&number_of_effective_blocks, sizeof(short), "number_of_effective_blocks");
   unsigned short page_size ;
    klee_make_symbolic(&page_size, sizeof(short), "page_size");
   unsigned char extra_data_size ;
    klee_make_symbolic(&extra_data_size, sizeof(char), "extra_data_size");
   unsigned char format_unique_value2 ;
    klee_make_symbolic(&format_unique_value2, sizeof(char), "format_unique_value2");
   unsigned char assembly_time[8U] ;
   unsigned char format_unique_value3 ;
    klee_make_symbolic(&format_unique_value3, sizeof(char), "format_unique_value3");
   unsigned char serial_number[3U] ;
   unsigned char assembly_manufacturer_code ;
    klee_make_symbolic(&assembly_manufacturer_code, sizeof(char), "assembly_manufacturer_code");
   unsigned char assembly_model_code[3U] ;
   unsigned short memory_manufacturer_code ;
    klee_make_symbolic(&memory_manufacturer_code, sizeof(short), "memory_manufacturer_code");
   unsigned short memory_device_code ;
    klee_make_symbolic(&memory_device_code, sizeof(short), "memory_device_code");
   unsigned short implemented_capacity ;
    klee_make_symbolic(&implemented_capacity, sizeof(short), "implemented_capacity");
   ...
   unsigned short controller_number ;
    klee_make_symbolic(&controller_number, sizeof(short), "controller_number");
   unsigned short controller_function ;
    klee_make_symbolic(&controller_function, sizeof(short), "controller_function");
   unsigned char reserved0[9U] ;
   unsigned char transfer_supporting ;
    klee_make_symbolic(&transfer_supporting, sizeof(char), "transfer_supporting");
   unsigned short format_unique_value5 ;
    klee_make_symbolic(&format_unique_value5, sizeof(short), "format_unique_value5");
   unsigned char format_type ;
    klee_make_symbolic(&format_type, sizeof(char), "format_type");
   unsigned char memorystick_application ;
    klee_make_symbolic(&memorystick_application, sizeof(char), "memorystick_application");
   unsigned char device_type ;
    klee_make_symbolic(&device_type, sizeof(char), "device_type");
...
struct msb_data {
   unsigned int usage_count ;
    klee_make_symbolic(&usage_count, sizeof(int), "usage_count");
   struct memstick_dev *card ;
   struct gendisk *disk ;
   struct request_queue *queue ;
   spinlock_t q_lock ;
   ...
   int caps ;
   int disk_id ;
    klee_make_symbolic(&disk_id, sizeof(int), "disk_id");
   ...
   int boot_block_count ;
    klee_make_symbolic(&boot_block_count, sizeof(int), "boot_block_count");
   bool read_only ;
   unsigned short page_size ;
   int block_size ;
   int pages_in_block ;
    klee_make_symbolic(&pages_in_block, sizeof(int), "pages_in_block");
   int zone_count ;
   ...
   int logical_block_count ;
    klee_make_symbolic(&logical_block_count, sizeof(int), "logical_block_count");
   ...
   unsigned long valid_cache_bitmap ;
    klee_make_symbolic(&valid_cache_bitmap, sizeof(long), "valid_cache_bitmap");
   int cache_block_lba ;
    klee_make_symbolic(&cache_block_lba, sizeof(int), "cache_block_lba");
   ...
   int current_sg_offset ;
    klee_make_symbolic(&current_sg_offset, sizeof(int), "current_sg_offset");
   struct ms_register regs ;
   int current_page ;
    klee_make_symbolic(&current_page, sizeof(int), "current_page");
   int state ;
   int exit_error ;
    klee_make_symbolic(&exit_error, sizeof(int), "exit_error");
   bool int_polling ;
   unsigned long int_timeout ;
    klee_make_symbolic(&int_timeout, sizeof(long), "int_timeout");
};
struct chs_entry {
   unsigned long size ;
   unsigned char sec ;
...
{ 
  ...
  int cmplen ;
    klee_make_symbolic(&cmplen, sizeof(int), "cmplen");
...
{ 
  int total_free_blocks ;
    klee_make_symbolic(&total_free_blocks, sizeof(int), "total_free_blocks");
  int i ;
...
{ 
  ...
  int tmp ;
  int chunklen ;
    klee_make_symbolic(&chunklen, sizeof(int), "chunklen");
  size_t _min1 ;
  size_t _min2 ;
  bool tmp___0 ;
  int tmp___1 ;
...
{ 
  int error ;
  int current_try ;
    klee_make_symbolic(&current_try, sizeof(int), "current_try");
  long tmp ;
  int tmp___0 ;
  int tmp___1 ;
  __u16 tmp___2 ;
...
{ 
  ...
  int size_to_read ;
    klee_make_symbolic(&size_to_read, sizeof(int), "size_to_read");
  u16 pba ;
  long tmp ;
  void *tmp___0 ;
  u16 bad_block ;
...
{ 
  ...
  int raw_size_in_megs ;
    klee_make_symbolic(&raw_size_in_megs, sizeof(int), "raw_size_in_megs");
  void *tmp___0 ;
