...
struct __anonstruct_ax25_digi_273 {
   ...
   unsigned char ndigi ;
    klee_make_symbolic(&ndigi, sizeof(char), "ndigi");
   signed char lastrepeat ;
    klee_make_symbolic(&lastrepeat, sizeof(char), "lastrepeat");
};
typedef struct __anonstruct_ax25_digi_273 ax25_digi;
struct __anonstruct_ax25_dama_info_274 {
   char slave ;
    klee_make_symbolic(&slave, sizeof(char), "slave");
   struct timer_list slave_timer ;
   unsigned short slave_timeout ;
    klee_make_symbolic(&slave_timeout, sizeof(short), "slave_timeout");
};
...
struct ax25_cb {
   ...
   unsigned char iamdigi ;
    klee_make_symbolic(&iamdigi, sizeof(char), "iamdigi");
   unsigned char state ;
   unsigned char modulus ;
    klee_make_symbolic(&modulus, sizeof(char), "modulus");
   unsigned char pidincl ;
    klee_make_symbolic(&pidincl, sizeof(char), "pidincl");
   unsigned short vs ;
    klee_make_symbolic(&vs, sizeof(short), "vs");
   unsigned short vr ;
    klee_make_symbolic(&vr, sizeof(short), "vr");
   unsigned short va ;
    klee_make_symbolic(&va, sizeof(short), "va");
   unsigned char condition ;
    klee_make_symbolic(&condition, sizeof(char), "condition");
   unsigned char backoff ;
    klee_make_symbolic(&backoff, sizeof(char), "backoff");
   unsigned char n2 ;
    klee_make_symbolic(&n2, sizeof(char), "n2");
   unsigned char n2count ;
    klee_make_symbolic(&n2count, sizeof(char), "n2count");
   struct timer_list t1timer ;
   struct timer_list t2timer ;
   struct timer_list t3timer ;
   struct timer_list idletimer ;
   unsigned long t1 ;
    klee_make_symbolic(&t1, sizeof(long), "t1");
   unsigned long t2 ;
    klee_make_symbolic(&t2, sizeof(long), "t2");
   unsigned long t3 ;
    klee_make_symbolic(&t3, sizeof(long), "t3");
   unsigned long idle ;
    klee_make_symbolic(&idle, sizeof(long), "idle");
   unsigned long rtt ;
    klee_make_symbolic(&rtt, sizeof(long), "rtt");
   unsigned short paclen ;
    klee_make_symbolic(&paclen, sizeof(short), "paclen");
   unsigned short fragno ;
    klee_make_symbolic(&fragno, sizeof(short), "fragno");
   unsigned short fraglen ;
    klee_make_symbolic(&fraglen, sizeof(short), "fraglen");
...
struct sockaddr_rose {
   ...
   int srose_ndigis ;
    klee_make_symbolic(&srose_ndigis, sizeof(int), "srose_ndigis");
...
struct rose_cause_struct {
   ...
   unsigned char diagnostic ;
    klee_make_symbolic(&diagnostic, sizeof(char), "diagnostic");
};
struct rose_facilities_struct {
   ...
   unsigned char source_ndigis ;
    klee_make_symbolic(&source_ndigis, sizeof(char), "source_ndigis");
   unsigned char dest_ndigis ;
    klee_make_symbolic(&dest_ndigis, sizeof(char), "dest_ndigis");
   ax25_address source_digis[6U] ;
   ax25_address dest_digis[6U] ;
   unsigned int rand ;
    klee_make_symbolic(&rand, sizeof(int), "rand");
...
struct rose_neigh {
   ...
   unsigned short use ;
    klee_make_symbolic(&use, sizeof(short), "use");
   unsigned int number ;
    klee_make_symbolic(&number, sizeof(int), "number");
   char restarted ;
    klee_make_symbolic(&restarted, sizeof(char), "restarted");
   char dce_mode ;
    klee_make_symbolic(&dce_mode, sizeof(char), "dce_mode");
   char loopback ;
...
struct rose_route {
   ...
   unsigned int lci1 ;
    klee_make_symbolic(&lci1, sizeof(int), "lci1");
   unsigned int lci2 ;
    klee_make_symbolic(&lci2, sizeof(int), "lci2");
...
struct rose_sock {
   ...
   unsigned int lci ;
    klee_make_symbolic(&lci, sizeof(int), "lci");
   unsigned int rand ;
   unsigned char state ;
   unsigned char condition ;
   unsigned char qbitincl ;
    klee_make_symbolic(&qbitincl, sizeof(char), "qbitincl");
   unsigned char defer ;
   ...
   unsigned short va ;
   unsigned short vl ;
    klee_make_symbolic(&vl, sizeof(short), "vl");
   unsigned long t1 ;
   unsigned long t2 ;
   unsigned long t3 ;
   unsigned long hb ;
    klee_make_symbolic(&hb, sizeof(long), "hb");
   unsigned long idle ;
   struct sk_buff_head ack_queue ;
...
typedef int pao_T_____33;
    klee_make_symbolic(&pao_T_____33, sizeof(int), "pao_T_____33");
typedef int pao_T_____34;
    klee_make_symbolic(&pao_T_____34, sizeof(int), "pao_T_____34");
typedef int pao_T_____35;
    klee_make_symbolic(&pao_T_____35, sizeof(int), "pao_T_____35");
typedef int pao_T_____36;
    klee_make_symbolic(&pao_T_____36, sizeof(int), "pao_T_____36");
typedef int pao_T_____37;
    klee_make_symbolic(&pao_T_____37, sizeof(int), "pao_T_____37");
typedef int pao_T_____38;
    klee_make_symbolic(&pao_T_____38, sizeof(int), "pao_T_____38");
typedef int pao_T_____39;
    klee_make_symbolic(&pao_T_____39, sizeof(int), "pao_T_____39");
typedef int pao_T_____40;
    klee_make_symbolic(&pao_T_____40, sizeof(int), "pao_T_____40");
struct rose_route_struct {
   ...
   unsigned char ndigis ;
    klee_make_symbolic(&ndigis, sizeof(char), "ndigis");
...
extern int ax25_uid_policy ;
    klee_make_symbolic(&ax25_uid_policy, sizeof(int), "ax25_uid_policy");
...
int sysctl_rose_restart_request_timeout ;
    klee_make_symbolic(&sysctl_rose_restart_request_timeout, sizeof(int), "sysctl_rose_restart_request_timeout");
int sysctl_rose_call_request_timeout ;
    klee_make_symbolic(&sysctl_rose_call_request_timeout, sizeof(int), "sysctl_rose_call_request_timeout");
int sysctl_rose_reset_request_timeout ;
    klee_make_symbolic(&sysctl_rose_reset_request_timeout, sizeof(int), "sysctl_rose_reset_request_timeout");
int sysctl_rose_clear_request_timeout ;
    klee_make_symbolic(&sysctl_rose_clear_request_timeout, sizeof(int), "sysctl_rose_clear_request_timeout");
int sysctl_rose_no_activity_timeout ;
    klee_make_symbolic(&sysctl_rose_no_activity_timeout, sizeof(int), "sysctl_rose_no_activity_timeout");
int sysctl_rose_ack_hold_back_timeout ;
    klee_make_symbolic(&sysctl_rose_ack_hold_back_timeout, sizeof(int), "sysctl_rose_ack_hold_back_timeout");
int sysctl_rose_routing_control ;
    klee_make_symbolic(&sysctl_rose_routing_control, sizeof(int), "sysctl_rose_routing_control");
int sysctl_rose_link_fail_timeout ;
    klee_make_symbolic(&sysctl_rose_link_fail_timeout, sizeof(int), "sysctl_rose_link_fail_timeout");
int sysctl_rose_maximum_vcs ;
    klee_make_symbolic(&sysctl_rose_maximum_vcs, sizeof(int), "sysctl_rose_maximum_vcs");
int sysctl_rose_window_size ;
    klee_make_symbolic(&sysctl_rose_window_size, sizeof(int), "sysctl_rose_window_size");
...
{ 
  ...
  int size ;
  int qbit ;
    klee_make_symbolic(&qbit, sizeof(int), "qbit");
  bool tmp ;
  struct task_struct *tmp___0 ;
  int tmp___1 ;
  int tmp___2 ;
...
{ 
  ...
  int n ;
  int er ;
    klee_make_symbolic(&er, sizeof(int), "er");
  int qbit ;
...
{ 
  ...
  void *argp ;
  long amount ;
    klee_make_symbolic(&amount, sizeof(long), "amount");
  int tmp ;
  int __ret_pu ;
  unsigned int __pu_val ;
  struct sk_buff *skb ;
  long amount___0 ;
    klee_make_symbolic(&amount___0, sizeof(long), "amount___0");
  int __ret_pu___0 ;
...
{ 
  ...
  int ldv_27_ret_default ;
    klee_make_symbolic(&ldv_27_ret_default, sizeof(int), "ldv_27_ret_default");
  int tmp ;
  int tmp___0 ;
...
{ 
  ...
  int ldv_5_ldv_param_12_2_default ;
    klee_make_symbolic(&ldv_5_ldv_param_12_2_default, sizeof(int), "ldv_5_ldv_param_12_2_default");
  int ldv_5_ldv_param_12_3_default ;
    klee_make_symbolic(&ldv_5_ldv_param_12_3_default, sizeof(int), "ldv_5_ldv_param_12_3_default");
  int *ldv_5_ldv_param_15_2_default ;
  int ldv_5_ldv_param_15_3_default ;
    klee_make_symbolic(&ldv_5_ldv_param_15_3_default, sizeof(int), "ldv_5_ldv_param_15_3_default");
  ...
  int ldv_5_ldv_param_18_2_default ;
    klee_make_symbolic(&ldv_5_ldv_param_18_2_default, sizeof(int), "ldv_5_ldv_param_18_2_default");
  char *ldv_5_ldv_param_18_3_default ;
  int *ldv_5_ldv_param_18_4_default ;
  unsigned int ldv_5_ldv_param_21_1_default ;
    klee_make_symbolic(&ldv_5_ldv_param_21_1_default, sizeof(int), "ldv_5_ldv_param_21_1_default");
  unsigned long ldv_5_ldv_param_21_2_default ;
    klee_make_symbolic(&ldv_5_ldv_param_21_2_default, sizeof(long), "ldv_5_ldv_param_21_2_default");
  int ldv_5_ldv_param_24_1_default ;
    klee_make_symbolic(&ldv_5_ldv_param_24_1_default, sizeof(int), "ldv_5_ldv_param_24_1_default");
  long long ldv_5_ldv_param_27_1_default ;
    klee_make_symbolic(&ldv_5_ldv_param_27_1_default, sizeof(long), "ldv_5_ldv_param_27_1_default");
  ...
  int ldv_5_ldv_param_33_2_default ;
    klee_make_symbolic(&ldv_5_ldv_param_33_2_default, sizeof(int), "ldv_5_ldv_param_33_2_default");
  char *ldv_5_ldv_param_36_1_default ;
  unsigned long ldv_5_ldv_param_36_2_default ;
    klee_make_symbolic(&ldv_5_ldv_param_36_2_default, sizeof(long), "ldv_5_ldv_param_36_2_default");
  long long *ldv_5_ldv_param_36_3_default ;
  unsigned long ldv_5_ldv_param_39_3_default ;
    klee_make_symbolic(&ldv_5_ldv_param_39_3_default, sizeof(long), "ldv_5_ldv_param_39_3_default");
  int ldv_5_ldv_param_39_4_default ;
    klee_make_symbolic(&ldv_5_ldv_param_39_4_default, sizeof(int), "ldv_5_ldv_param_39_4_default");
  ...
  unsigned long ldv_5_ldv_param_43_3_default ;
    klee_make_symbolic(&ldv_5_ldv_param_43_3_default, sizeof(long), "ldv_5_ldv_param_43_3_default");
  int ldv_5_ldv_param_46_2_default ;
    klee_make_symbolic(&ldv_5_ldv_param_46_2_default, sizeof(int), "ldv_5_ldv_param_46_2_default");
  unsigned long ldv_5_ldv_param_46_3_default ;
    klee_make_symbolic(&ldv_5_ldv_param_46_3_default, sizeof(long), "ldv_5_ldv_param_46_3_default");
  int ldv_5_ldv_param_46_4_default ;
    klee_make_symbolic(&ldv_5_ldv_param_46_4_default, sizeof(int), "ldv_5_ldv_param_46_4_default");
  int ldv_5_ldv_param_49_1_default ;
    klee_make_symbolic(&ldv_5_ldv_param_49_1_default, sizeof(int), "ldv_5_ldv_param_49_1_default");
  int ldv_5_ldv_param_49_2_default ;
    klee_make_symbolic(&ldv_5_ldv_param_49_2_default, sizeof(int), "ldv_5_ldv_param_49_2_default");
  char *ldv_5_ldv_param_49_3_default ;
  unsigned int ldv_5_ldv_param_49_4_default ;
    klee_make_symbolic(&ldv_5_ldv_param_49_4_default, sizeof(int), "ldv_5_ldv_param_49_4_default");
  int ldv_5_ldv_param_52_1_default ;
    klee_make_symbolic(&ldv_5_ldv_param_52_1_default, sizeof(int), "ldv_5_ldv_param_52_1_default");
  struct socket *ldv_5_ldv_param_55_1_default ;
  int ldv_5_ldv_param_9_2_default ;
    klee_make_symbolic(&ldv_5_ldv_param_9_2_default, sizeof(int), "ldv_5_ldv_param_9_2_default");
  int ldv_5_ldv_param_9_3_default ;
    klee_make_symbolic(&ldv_5_ldv_param_9_3_default, sizeof(int), "ldv_5_ldv_param_9_3_default");
...
{ 
  ...
  int ldv_6_ldv_param_12_2_default ;
    klee_make_symbolic(&ldv_6_ldv_param_12_2_default, sizeof(int), "ldv_6_ldv_param_12_2_default");
  int ldv_6_ldv_param_12_3_default ;
    klee_make_symbolic(&ldv_6_ldv_param_12_3_default, sizeof(int), "ldv_6_ldv_param_12_3_default");
  int *ldv_6_ldv_param_15_2_default ;
  int ldv_6_ldv_param_15_3_default ;
    klee_make_symbolic(&ldv_6_ldv_param_15_3_default, sizeof(int), "ldv_6_ldv_param_15_3_default");
  int ldv_6_ldv_param_18_1_default ;
    klee_make_symbolic(&ldv_6_ldv_param_18_1_default, sizeof(int), "ldv_6_ldv_param_18_1_default");
  int ldv_6_ldv_param_18_2_default ;
    klee_make_symbolic(&ldv_6_ldv_param_18_2_default, sizeof(int), "ldv_6_ldv_param_18_2_default");
  char *ldv_6_ldv_param_18_3_default ;
  int *ldv_6_ldv_param_18_4_default ;
  unsigned int ldv_6_ldv_param_21_1_default ;
    klee_make_symbolic(&ldv_6_ldv_param_21_1_default, sizeof(int), "ldv_6_ldv_param_21_1_default");
  unsigned long ldv_6_ldv_param_21_2_default ;
    klee_make_symbolic(&ldv_6_ldv_param_21_2_default, sizeof(long), "ldv_6_ldv_param_21_2_default");
  int ldv_6_ldv_param_24_1_default ;
    klee_make_symbolic(&ldv_6_ldv_param_24_1_default, sizeof(int), "ldv_6_ldv_param_24_1_default");
  long long ldv_6_ldv_param_27_1_default ;
    klee_make_symbolic(&ldv_6_ldv_param_27_1_default, sizeof(long), "ldv_6_ldv_param_27_1_default");
  int ldv_6_ldv_param_27_2_default ;
    klee_make_symbolic(&ldv_6_ldv_param_27_2_default, sizeof(int), "ldv_6_ldv_param_27_2_default");
  int ldv_6_ldv_param_33_2_default ;
    klee_make_symbolic(&ldv_6_ldv_param_33_2_default, sizeof(int), "ldv_6_ldv_param_33_2_default");
  char *ldv_6_ldv_param_36_1_default ;
  unsigned long ldv_6_ldv_param_36_2_default ;
    klee_make_symbolic(&ldv_6_ldv_param_36_2_default, sizeof(long), "ldv_6_ldv_param_36_2_default");
  long long *ldv_6_ldv_param_36_3_default ;
  unsigned long ldv_6_ldv_param_39_3_default ;
    klee_make_symbolic(&ldv_6_ldv_param_39_3_default, sizeof(long), "ldv_6_ldv_param_39_3_default");
  int ldv_6_ldv_param_39_4_default ;
    klee_make_symbolic(&ldv_6_ldv_param_39_4_default, sizeof(int), "ldv_6_ldv_param_39_4_default");
  struct socket *ldv_6_ldv_param_3_1_default ;
  int ldv_6_ldv_param_3_2_default ;
    klee_make_symbolic(&ldv_6_ldv_param_3_2_default, sizeof(int), "ldv_6_ldv_param_3_2_default");
  unsigned long ldv_6_ldv_param_43_3_default ;
    klee_make_symbolic(&ldv_6_ldv_param_43_3_default, sizeof(long), "ldv_6_ldv_param_43_3_default");
  int ldv_6_ldv_param_46_2_default ;
    klee_make_symbolic(&ldv_6_ldv_param_46_2_default, sizeof(int), "ldv_6_ldv_param_46_2_default");
  unsigned long ldv_6_ldv_param_46_3_default ;
    klee_make_symbolic(&ldv_6_ldv_param_46_3_default, sizeof(long), "ldv_6_ldv_param_46_3_default");
  int ldv_6_ldv_param_46_4_default ;
    klee_make_symbolic(&ldv_6_ldv_param_46_4_default, sizeof(int), "ldv_6_ldv_param_46_4_default");
  int ldv_6_ldv_param_49_1_default ;
    klee_make_symbolic(&ldv_6_ldv_param_49_1_default, sizeof(int), "ldv_6_ldv_param_49_1_default");
  int ldv_6_ldv_param_49_2_default ;
    klee_make_symbolic(&ldv_6_ldv_param_49_2_default, sizeof(int), "ldv_6_ldv_param_49_2_default");
  char *ldv_6_ldv_param_49_3_default ;
  unsigned int ldv_6_ldv_param_49_4_default ;
    klee_make_symbolic(&ldv_6_ldv_param_49_4_default, sizeof(int), "ldv_6_ldv_param_49_4_default");
  int ldv_6_ldv_param_52_1_default ;
    klee_make_symbolic(&ldv_6_ldv_param_52_1_default, sizeof(int), "ldv_6_ldv_param_52_1_default");
  struct socket *ldv_6_ldv_param_55_1_default ;
  int ldv_6_ldv_param_9_2_default ;
    klee_make_symbolic(&ldv_6_ldv_param_9_2_default, sizeof(int), "ldv_6_ldv_param_9_2_default");
  int ldv_6_ldv_param_9_3_default ;
    klee_make_symbolic(&ldv_6_ldv_param_9_3_default, sizeof(int), "ldv_6_ldv_param_9_3_default");
  struct ldv_struct_dummy_resourceless_instance_5 *data ;
  void *tmp ;
  int tmp___0 ;
  void *tmp___1 ;
...
{ 
  ...
  int ldv_7_ldv_param_12_2_default ;
    klee_make_symbolic(&ldv_7_ldv_param_12_2_default, sizeof(int), "ldv_7_ldv_param_12_2_default");
  int ldv_7_ldv_param_12_3_default ;
    klee_make_symbolic(&ldv_7_ldv_param_12_3_default, sizeof(int), "ldv_7_ldv_param_12_3_default");
  int *ldv_7_ldv_param_15_2_default ;
  int ldv_7_ldv_param_15_3_default ;
    klee_make_symbolic(&ldv_7_ldv_param_15_3_default, sizeof(int), "ldv_7_ldv_param_15_3_default");
  int ldv_7_ldv_param_18_1_default ;
    klee_make_symbolic(&ldv_7_ldv_param_18_1_default, sizeof(int), "ldv_7_ldv_param_18_1_default");
  int ldv_7_ldv_param_18_2_default ;
    klee_make_symbolic(&ldv_7_ldv_param_18_2_default, sizeof(int), "ldv_7_ldv_param_18_2_default");
  char *ldv_7_ldv_param_18_3_default ;
  int *ldv_7_ldv_param_18_4_default ;
  unsigned int ldv_7_ldv_param_21_1_default ;
    klee_make_symbolic(&ldv_7_ldv_param_21_1_default, sizeof(int), "ldv_7_ldv_param_21_1_default");
  unsigned long ldv_7_ldv_param_21_2_default ;
    klee_make_symbolic(&ldv_7_ldv_param_21_2_default, sizeof(long), "ldv_7_ldv_param_21_2_default");
  int ldv_7_ldv_param_24_1_default ;
    klee_make_symbolic(&ldv_7_ldv_param_24_1_default, sizeof(int), "ldv_7_ldv_param_24_1_default");
  long long ldv_7_ldv_param_27_1_default ;
    klee_make_symbolic(&ldv_7_ldv_param_27_1_default, sizeof(long), "ldv_7_ldv_param_27_1_default");
  int ldv_7_ldv_param_27_2_default ;
    klee_make_symbolic(&ldv_7_ldv_param_27_2_default, sizeof(int), "ldv_7_ldv_param_27_2_default");
  int ldv_7_ldv_param_33_2_default ;
    klee_make_symbolic(&ldv_7_ldv_param_33_2_default, sizeof(int), "ldv_7_ldv_param_33_2_default");
  char *ldv_7_ldv_param_36_1_default ;
  unsigned long ldv_7_ldv_param_36_2_default ;
    klee_make_symbolic(&ldv_7_ldv_param_36_2_default, sizeof(long), "ldv_7_ldv_param_36_2_default");
  long long *ldv_7_ldv_param_36_3_default ;
  unsigned long ldv_7_ldv_param_39_3_default ;
    klee_make_symbolic(&ldv_7_ldv_param_39_3_default, sizeof(long), "ldv_7_ldv_param_39_3_default");
  int ldv_7_ldv_param_39_4_default ;
    klee_make_symbolic(&ldv_7_ldv_param_39_4_default, sizeof(int), "ldv_7_ldv_param_39_4_default");
  struct socket *ldv_7_ldv_param_3_1_default ;
  int ldv_7_ldv_param_3_2_default ;
    klee_make_symbolic(&ldv_7_ldv_param_3_2_default, sizeof(int), "ldv_7_ldv_param_3_2_default");
  unsigned long ldv_7_ldv_param_43_3_default ;
    klee_make_symbolic(&ldv_7_ldv_param_43_3_default, sizeof(long), "ldv_7_ldv_param_43_3_default");
  int ldv_7_ldv_param_46_2_default ;
    klee_make_symbolic(&ldv_7_ldv_param_46_2_default, sizeof(int), "ldv_7_ldv_param_46_2_default");
  unsigned long ldv_7_ldv_param_46_3_default ;
    klee_make_symbolic(&ldv_7_ldv_param_46_3_default, sizeof(long), "ldv_7_ldv_param_46_3_default");
  int ldv_7_ldv_param_46_4_default ;
    klee_make_symbolic(&ldv_7_ldv_param_46_4_default, sizeof(int), "ldv_7_ldv_param_46_4_default");
  int ldv_7_ldv_param_49_1_default ;
    klee_make_symbolic(&ldv_7_ldv_param_49_1_default, sizeof(int), "ldv_7_ldv_param_49_1_default");
  int ldv_7_ldv_param_49_2_default ;
    klee_make_symbolic(&ldv_7_ldv_param_49_2_default, sizeof(int), "ldv_7_ldv_param_49_2_default");
  char *ldv_7_ldv_param_49_3_default ;
  unsigned int ldv_7_ldv_param_49_4_default ;
    klee_make_symbolic(&ldv_7_ldv_param_49_4_default, sizeof(int), "ldv_7_ldv_param_49_4_default");
  int ldv_7_ldv_param_52_1_default ;
    klee_make_symbolic(&ldv_7_ldv_param_52_1_default, sizeof(int), "ldv_7_ldv_param_52_1_default");
  struct socket *ldv_7_ldv_param_55_1_default ;
  int ldv_7_ldv_param_9_2_default ;
    klee_make_symbolic(&ldv_7_ldv_param_9_2_default, sizeof(int), "ldv_7_ldv_param_9_2_default");
  int ldv_7_ldv_param_9_3_default ;
    klee_make_symbolic(&ldv_7_ldv_param_9_3_default, sizeof(int), "ldv_7_ldv_param_9_3_default");
  struct ldv_struct_dummy_resourceless_instance_5 *data ;
  void *tmp ;
  int tmp___0 ;
  void *tmp___1 ;
...
{ 
  ...
  int ldv_12_ldv_param_3_1_default ;
    klee_make_symbolic(&ldv_12_ldv_param_3_1_default, sizeof(int), "ldv_12_ldv_param_3_1_default");
  int tmp ;
...
{ 
  ...
  unsigned short ldv_14_ldv_param_3_2_default ;
    klee_make_symbolic(&ldv_14_ldv_param_3_2_default, sizeof(short), "ldv_14_ldv_param_3_2_default");
  void *ldv_14_ldv_param_3_3_default ;
  void *ldv_14_ldv_param_3_4_default ;
  unsigned int ldv_14_ldv_param_3_5_default ;
    klee_make_symbolic(&ldv_14_ldv_param_3_5_default, sizeof(int), "ldv_14_ldv_param_3_5_default");
  int tmp ;
  int tmp___0 ;
...
{ 
  ...
  unsigned long ldv_15_ldv_param_3_1_default ;
    klee_make_symbolic(&ldv_15_ldv_param_3_1_default, sizeof(long), "ldv_15_ldv_param_3_1_default");
...
{ 
  ...
  int queued ;
  int frametype ;
    klee_make_symbolic(&frametype, sizeof(int), "frametype");
  int ns ;
...
{ 
  ...
  unsigned int lci_i ;
    klee_make_symbolic(&lci_i, sizeof(int), "lci_i");
  unsigned int lci_o ;
    klee_make_symbolic(&lci_o, sizeof(int), "lci_o");
  int tmp ;
  int tmp___0 ;
...
{ 
  ...
  unsigned short end ;
    klee_make_symbolic(&end, sizeof(short), "end");
  struct sk_buff *tmp ;
...
{ 
  ...
  unsigned int new_lci ;
    klee_make_symbolic(&new_lci, sizeof(int), "new_lci");
  unsigned char cause ;
  unsigned char diagnostic ;
  struct net_device *dev ;
  int res ;
...
{ 
  struct rose_sock *rose ;
  unsigned short vc ;
    klee_make_symbolic(&vc, sizeof(short), "vc");
...
{ 
  ...
  int len ;
  int faclen ;
    klee_make_symbolic(&faclen, sizeof(int), "faclen");
  int tmp ;
  unsigned char *tmp___0 ;
  unsigned char *tmp___1 ;
  unsigned char *tmp___2 ;
...
{ 
  unsigned char *pt ;
  unsigned char l ;
    klee_make_symbolic(&l, sizeof(char), "l");
  unsigned char lg ;
    klee_make_symbolic(&lg, sizeof(char), "lg");
  unsigned char n ;
  int fac_national_digis_received ;
    klee_make_symbolic(&fac_national_digis_received, sizeof(int), "fac_national_digis_received");
  unsigned char tmp ;
  unsigned char tmp___0 ;
...
{ 
  int facilities_len ;
    klee_make_symbolic(&facilities_len, sizeof(int), "facilities_len");
  int len ;
  unsigned char *tmp ;
  int __ret_warn_on ;
  long tmp___0 ;
...
{ 
  ...
  int len ;
  int nb ;
    klee_make_symbolic(&nb, sizeof(int), "nb");
  unsigned char *tmp ;
  unsigned char *tmp___0 ;
  unsigned char *tmp___1 ;
  unsigned char *tmp___2 ;
  unsigned char *tmp___3 ;
  int maxdigi ;
    klee_make_symbolic(&maxdigi, sizeof(int), "maxdigi");
  unsigned char *tmp___4 ;
  unsigned char *tmp___5 ;
  unsigned char *tmp___6 ;
  unsigned char *tmp___7 ;
