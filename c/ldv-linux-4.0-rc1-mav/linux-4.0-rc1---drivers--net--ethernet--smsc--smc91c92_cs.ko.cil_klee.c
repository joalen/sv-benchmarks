...
typedef unsigned char cisdata_t;
    klee_make_symbolic(&cisdata_t, sizeof(char), "cisdata_t");
...
struct __anonstruct_dev_274 {
   u_char type ;
   u_char wp ;
    klee_make_symbolic(&wp, sizeof(char), "wp");
   u_int speed ;
   u_int size ;
};
struct cistpl_device_t {
   u_char ndev ;
    klee_make_symbolic(&ndev, sizeof(char), "ndev");
...
struct __anonstruct_id_275 {
   u_char mfr ;
    klee_make_symbolic(&mfr, sizeof(char), "mfr");
   u_char info ;
    klee_make_symbolic(&info, sizeof(char), "info");
};
...
struct cistpl_manfid_t {
   u_short manf ;
    klee_make_symbolic(&manf, sizeof(short), "manf");
   u_short card ;
    klee_make_symbolic(&card, sizeof(short), "card");
};
...
struct cistpl_funcid_t {
   ...
   u_char sysinit ;
    klee_make_symbolic(&sysinit, sizeof(char), "sysinit");
};
...
struct cistpl_bar_t {
   u_char attr ;
    klee_make_symbolic(&attr, sizeof(char), "attr");
   u_int size ;
};
typedef struct cistpl_bar_t cistpl_bar_t;
struct cistpl_config_t {
   u_char last_idx ;
    klee_make_symbolic(&last_idx, sizeof(char), "last_idx");
   u_int base ;
    klee_make_symbolic(&base, sizeof(int), "base");
   u_int rmask[4U] ;
   u_char subtuples ;
    klee_make_symbolic(&subtuples, sizeof(char), "subtuples");
};
...
struct cistpl_timing_t {
   ...
   u_int waitscale ;
    klee_make_symbolic(&waitscale, sizeof(int), "waitscale");
   u_int ready ;
    klee_make_symbolic(&ready, sizeof(int), "ready");
   u_int rdyscale ;
    klee_make_symbolic(&rdyscale, sizeof(int), "rdyscale");
   u_int reserved ;
    klee_make_symbolic(&reserved, sizeof(int), "reserved");
   u_int rsvscale ;
    klee_make_symbolic(&rsvscale, sizeof(int), "rsvscale");
};
...
struct cistpl_io_t {
   u_char flags ;
   u_char nwin ;
    klee_make_symbolic(&nwin, sizeof(char), "nwin");
   struct __anonstruct_win_276 win[16U] ;
};
typedef struct cistpl_io_t cistpl_io_t;
struct cistpl_irq_t {
   u_int IRQInfo1 ;
    klee_make_symbolic(&IRQInfo1, sizeof(int), "IRQInfo1");
   u_int IRQInfo2 ;
    klee_make_symbolic(&IRQInfo2, sizeof(int), "IRQInfo2");
};
typedef struct cistpl_irq_t cistpl_irq_t;
struct __anonstruct_win_277 {
   u_int len ;
   u_int card_addr ;
    klee_make_symbolic(&card_addr, sizeof(int), "card_addr");
   u_int host_addr ;
    klee_make_symbolic(&host_addr, sizeof(int), "host_addr");
};
struct cistpl_mem_t {
   u_char flags ;
   u_char nwin ;
...
struct cistpl_cftable_entry_cb_t {
   ...
   cistpl_power_t vpp2 ;
   u_char io ;
    klee_make_symbolic(&io, sizeof(char), "io");
   cistpl_irq_t irq ;
   u_char mem ;
    klee_make_symbolic(&mem, sizeof(char), "mem");
   u_char subtuples ;
};
typedef struct cistpl_cftable_entry_cb_t cistpl_cftable_entry_cb_t;
struct __anonstruct_geo_278 {
   u_char buswidth ;
    klee_make_symbolic(&buswidth, sizeof(char), "buswidth");
   u_int erase_block ;
    klee_make_symbolic(&erase_block, sizeof(int), "erase_block");
   u_int read_block ;
    klee_make_symbolic(&read_block, sizeof(int), "read_block");
   u_int write_block ;
    klee_make_symbolic(&write_block, sizeof(int), "write_block");
   u_int partition ;
    klee_make_symbolic(&partition, sizeof(int), "partition");
   u_int interleave ;
    klee_make_symbolic(&interleave, sizeof(int), "interleave");
};
struct cistpl_device_geo_t {
   u_char ngeo ;
    klee_make_symbolic(&ngeo, sizeof(char), "ngeo");
   struct __anonstruct_geo_278 geo[4U] ;
};
typedef struct cistpl_device_geo_t cistpl_device_geo_t;
struct cistpl_vers_2_t {
   u_char vers ;
    klee_make_symbolic(&vers, sizeof(char), "vers");
   u_char comply ;
    klee_make_symbolic(&comply, sizeof(char), "comply");
   u_short dindex ;
    klee_make_symbolic(&dindex, sizeof(short), "dindex");
   u_char vspec8 ;
    klee_make_symbolic(&vspec8, sizeof(char), "vspec8");
   u_char vspec9 ;
    klee_make_symbolic(&vspec9, sizeof(char), "vspec9");
   u_char nhdr ;
    klee_make_symbolic(&nhdr, sizeof(char), "nhdr");
   u_char vendor ;
    klee_make_symbolic(&vendor, sizeof(char), "vendor");
   u_char info ;
   char str[244U] ;
};
...
struct cistpl_org_t {
   u_char data_org ;
    klee_make_symbolic(&data_org, sizeof(char), "data_org");
   char desc[30U] ;
};
...
struct cistpl_format_t {
   u_char type ;
   u_char edc ;
    klee_make_symbolic(&edc, sizeof(char), "edc");
   u_int offset ;
   u_int length ;
};
...
struct tuple_t {
   u_int Attributes ;
    klee_make_symbolic(&Attributes, sizeof(int), "Attributes");
   cisdata_t DesiredTuple ;
   u_int Flags ;
    klee_make_symbolic(&Flags, sizeof(int), "Flags");
   u_int LinkOffset ;
    klee_make_symbolic(&LinkOffset, sizeof(int), "LinkOffset");
   u_int CISOffset ;
    klee_make_symbolic(&CISOffset, sizeof(int), "CISOffset");
   cisdata_t TupleCode ;
   cisdata_t TupleLink ;
...
struct smc_private {
   ...
   spinlock_t lock ;
   u_short manfid ;
    klee_make_symbolic(&manfid, sizeof(short), "manfid");
   u_short cardid ;
    klee_make_symbolic(&cardid, sizeof(short), "cardid");
   struct sk_buff *saved_skb ;
   int packets_waiting ;
    klee_make_symbolic(&packets_waiting, sizeof(int), "packets_waiting");
   void *base ;
   u_short cfg ;
    klee_make_symbolic(&cfg, sizeof(short), "cfg");
   struct timer_list media ;
   int watchdog ;
    klee_make_symbolic(&watchdog, sizeof(int), "watchdog");
   int tx_err ;
    klee_make_symbolic(&tx_err, sizeof(int), "tx_err");
   u_short media_status ;
    klee_make_symbolic(&media_status, sizeof(short), "media_status");
   u_short fast_poll ;
    klee_make_symbolic(&fast_poll, sizeof(short), "fast_poll");
   u_short link_status ;
    klee_make_symbolic(&link_status, sizeof(short), "link_status");
   struct mii_if_info mii_if ;
   int duplex ;
   int rx_ovrn ;
    klee_make_symbolic(&rx_ovrn, sizeof(int), "rx_ovrn");
};
...
{ 
  ...
  int da ;
    klee_make_symbolic(&da, sizeof(int), "da");
  int c ;
...
{ 
  ...
  unsigned int iouart ;
    klee_make_symbolic(&iouart, sizeof(int), "iouart");
  unsigned long __ms ;
...
{ 
  ...
  unsigned short tmp___2 ;
    klee_make_symbolic(&tmp___2, sizeof(short), "tmp___2");
...
{ 
  ...
  u_short s ;
    klee_make_symbolic(&s, sizeof(short), "s");
  unsigned long __ms ;
  unsigned long tmp ;
  unsigned short tmp___0 ;
...
{ 
  ...
  unsigned int ioaddr ;
  u_long mir ;
    klee_make_symbolic(&mir, sizeof(long), "mir");
  struct _ddebug descriptor ;
  long tmp___0 ;
  u_long mcr ;
    klee_make_symbolic(&mcr, sizeof(long), "mcr");
  unsigned short tmp___1 ;
  unsigned short tmp___2 ;
  unsigned short tmp___3 ;
  int tmp___4 ;
...
{ 
  ...
  int dat ;
    klee_make_symbolic(&dat, sizeof(int), "dat");
  unsigned char tmp ;
...
{ 
  ...
  unsigned int ioaddr ;
  u_char packet_no ;
    klee_make_symbolic(&packet_no, sizeof(char), "packet_no");
  unsigned short tmp___0 ;
  u_char *buf ;
  u_int length ;
  struct _ddebug descriptor ;
...
{ 
  ...
  unsigned int ioaddr ;
  u_short num_pages ;
    klee_make_symbolic(&num_pages, sizeof(short), "num_pages");
  short time_out ;
    klee_make_symbolic(&time_out, sizeof(short), "time_out");
  short ir ;
    klee_make_symbolic(&ir, sizeof(short), "ir");
  unsigned long flags ;
  struct _ddebug descriptor ;
  unsigned short tmp___0 ;
  long tmp___1 ;
...
{ 
  ...
  unsigned int ioaddr ;
  int saved_packet ;
    klee_make_symbolic(&saved_packet, sizeof(int), "saved_packet");
  unsigned short tmp___0 ;
  int packet_no ;
  unsigned short tmp___1 ;
  int tx_status ;
    klee_make_symbolic(&tx_status, sizeof(int), "tx_status");
  unsigned short tmp___2 ;
  unsigned short tmp___3 ;
...
{ 
  ...
  unsigned int ioaddr ;
  u_short card_stats ;
    klee_make_symbolic(&card_stats, sizeof(short), "card_stats");
  u_short ephs ;
    klee_make_symbolic(&ephs, sizeof(short), "ephs");
  struct _ddebug descriptor ;
  long tmp___0 ;
  unsigned short tmp___1 ;
...
{ 
  ...
  unsigned int ioaddr ;
  u_short saved_bank ;
    klee_make_symbolic(&saved_bank, sizeof(short), "saved_bank");
  u_short saved_pointer ;
    klee_make_symbolic(&saved_pointer, sizeof(short), "saved_pointer");
  u_short mask ;
  u_short status ;
  unsigned int handled ;
    klee_make_symbolic(&handled, sizeof(int), "handled");
  char bogus_cnt ;
    klee_make_symbolic(&bogus_cnt, sizeof(char), "bogus_cnt");
  bool tmp___0 ;
  int tmp___1 ;
  struct _ddebug descriptor ;
  long tmp___2 ;
  ...
  u_char cor ;
    klee_make_symbolic(&cor, sizeof(char), "cor");
  u_char tmp___11 ;
...
{ 
  ...
  u_short rx_cfg_setting ;
    klee_make_symbolic(&rx_cfg_setting, sizeof(short), "rx_cfg_setting");
  int i ;
...
{ 
  ...
  u_short i ;
  u_short media ;
    klee_make_symbolic(&media, sizeof(short), "media");
  u_short saved_bank ;
  u_short link ;
  unsigned long flags ;
  bool tmp___0 ;
...
{ 
  ...
  int ldv_2_ldv_param_10_1_default ;
    klee_make_symbolic(&ldv_2_ldv_param_10_1_default, sizeof(int), "ldv_2_ldv_param_10_1_default");
  int ldv_2_ldv_param_13_2_default ;
    klee_make_symbolic(&ldv_2_ldv_param_13_2_default, sizeof(int), "ldv_2_ldv_param_13_2_default");
