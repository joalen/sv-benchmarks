...
{ 
  ...
  unsigned long long c ;
    klee_make_symbolic(&c, sizeof(long), "c");
  unsigned long long c2 ;
    klee_make_symbolic(&c2, sizeof(long), "c2");
  long timeout ;
  wait_queue_t wait ;
  struct task_struct *tmp ;
  unsigned long _min1 ;
...
{ 
  ...
  int ldv_0_ldv_param_5_0_default ;
    klee_make_symbolic(&ldv_0_ldv_param_5_0_default, sizeof(int), "ldv_0_ldv_param_5_0_default");
