...
typedef int ixgb_mac_type;
    klee_make_symbolic(&ixgb_mac_type, sizeof(int), "ixgb_mac_type");
typedef int ixgb_phy_type;
    klee_make_symbolic(&ixgb_phy_type, sizeof(int), "ixgb_phy_type");
typedef int ixgb_fc_type;
    klee_make_symbolic(&ixgb_fc_type, sizeof(int), "ixgb_fc_type");
typedef int ixgb_bus_type;
    klee_make_symbolic(&ixgb_bus_type, sizeof(int), "ixgb_bus_type");
typedef int ixgb_bus_speed;
    klee_make_symbolic(&ixgb_bus_speed, sizeof(int), "ixgb_bus_speed");
typedef int ixgb_bus_width;
    klee_make_symbolic(&ixgb_bus_width, sizeof(int), "ixgb_bus_width");
struct ixgb_rx_desc {
   __le64 buff_addr ;
   __le16 length ;
   __le16 reserved ;
