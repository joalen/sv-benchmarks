...
struct peak_usb_adapter {
   ...
   unsigned int ctrl_count ;
    klee_make_symbolic(&ctrl_count, sizeof(int), "ctrl_count");
   ...
   u32 us_per_ts_scale ;
   int rx_buffer_size ;
    klee_make_symbolic(&rx_buffer_size, sizeof(int), "rx_buffer_size");
   int tx_buffer_size ;
    klee_make_symbolic(&tx_buffer_size, sizeof(int), "tx_buffer_size");
   int sizeof_dev_private ;
    klee_make_symbolic(&sizeof_dev_private, sizeof(int), "sizeof_dev_private");
};
...
struct peak_usb_device {
   ...
   unsigned int ctrl_idx ;
    klee_make_symbolic(&ctrl_idx, sizeof(int), "ctrl_idx");
   u32 state ;
...
struct pcan_usb_pro_interface {
   ...
   struct peak_time_ref time_ref ;
   int cm_ignore_count ;
    klee_make_symbolic(&cm_ignore_count, sizeof(int), "cm_ignore_count");
   int dev_opened_count ;
    klee_make_symbolic(&dev_opened_count, sizeof(int), "dev_opened_count");
};
...
struct pcan_usb_pro_msg {
   u8 *rec_ptr ;
   int rec_buffer_size ;
    klee_make_symbolic(&rec_buffer_size, sizeof(int), "rec_buffer_size");
   int rec_buffer_len ;
    klee_make_symbolic(&rec_buffer_len, sizeof(int), "rec_buffer_len");
...
{ 
  ...
  int sizeof_candev ;
    klee_make_symbolic(&sizeof_candev, sizeof(int), "sizeof_candev");
  struct peak_usb_device *dev ;
  struct net_device *netdev ;
  int i ;
  int err ;
