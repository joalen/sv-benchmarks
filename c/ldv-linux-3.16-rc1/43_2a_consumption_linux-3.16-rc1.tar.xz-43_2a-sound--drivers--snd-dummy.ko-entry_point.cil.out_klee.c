...
struct snd_dummy {
   ...
   int iobox ;
    klee_make_symbolic(&iobox, sizeof(int), "iobox");
...
struct dummy_systimer_pcm {
   ...
   unsigned long base_time ;
    klee_make_symbolic(&base_time, sizeof(long), "base_time");
   unsigned int frac_pos ;
    klee_make_symbolic(&frac_pos, sizeof(int), "frac_pos");
   unsigned int frac_period_rest ;
    klee_make_symbolic(&frac_period_rest, sizeof(int), "frac_period_rest");
   unsigned int frac_buffer_size ;
    klee_make_symbolic(&frac_buffer_size, sizeof(int), "frac_buffer_size");
   unsigned int frac_period_size ;
    klee_make_symbolic(&frac_period_size, sizeof(int), "frac_period_size");
   unsigned int rate ;
   int elapsed ;
    klee_make_symbolic(&elapsed, sizeof(int), "elapsed");
   struct snd_pcm_substream *substream ;
};
...
{ 
  ...
  unsigned int rate ;
  long sec ;
    klee_make_symbolic(&sec, sizeof(long), "sec");
  unsigned long nsecs ;
    klee_make_symbolic(&nsecs, sizeof(long), "nsecs");
  u64 tmp ;
