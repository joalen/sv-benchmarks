...
struct frad_state {
   ...
   int dce_pvc_count ;
    klee_make_symbolic(&dce_pvc_count, sizeof(int), "dce_pvc_count");
   struct timer_list timer ;
   unsigned long last_poll ;
    klee_make_symbolic(&last_poll, sizeof(long), "last_poll");
   int reliable ;
    klee_make_symbolic(&reliable, sizeof(int), "reliable");
   int dce_changed ;
    klee_make_symbolic(&dce_changed, sizeof(int), "dce_changed");
   int request ;
    klee_make_symbolic(&request, sizeof(int), "request");
   int fullrep_sent ;
    klee_make_symbolic(&fullrep_sent, sizeof(int), "fullrep_sent");
   u32 last_errors ;
   u8 n391cnt ;
   u8 txseq ;
   u8 rxseq ;
...
{ 
  ...
  int stat_len ;
  int reptype ;
    klee_make_symbolic(&reptype, sizeof(int), "reptype");
  int error ;
    klee_make_symbolic(&error, sizeof(int), "error");
  int no_ram ;
    klee_make_symbolic(&no_ram, sizeof(int), "no_ram");
  int i ;
  struct frad_state *tmp___2 ;
  int tmp___3 ;
  int tmp___4 ;
