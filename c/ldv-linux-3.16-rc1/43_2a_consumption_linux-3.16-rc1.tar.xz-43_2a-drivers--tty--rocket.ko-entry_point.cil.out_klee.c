...
typedef unsigned char Byte_t;
    klee_make_symbolic(&Byte_t, sizeof(char), "Byte_t");
typedef unsigned int ByteIO_t;
    klee_make_symbolic(&ByteIO_t, sizeof(int), "ByteIO_t");
typedef unsigned int Word_t;
    klee_make_symbolic(&Word_t, sizeof(int), "Word_t");
typedef unsigned int WordIO_t;
    klee_make_symbolic(&WordIO_t, sizeof(int), "WordIO_t");
typedef unsigned int DWordIO_t;
    klee_make_symbolic(&DWordIO_t, sizeof(int), "DWordIO_t");
struct __anonstruct_CONTROLLER_T_203 {
   int CtlID ;
    klee_make_symbolic(&CtlID, sizeof(int), "CtlID");
   int CtlNum ;
    klee_make_symbolic(&CtlNum, sizeof(int), "CtlNum");
   int BusType ;
    klee_make_symbolic(&BusType, sizeof(int), "BusType");
   int boardType ;
    klee_make_symbolic(&boardType, sizeof(int), "boardType");
   int isUPCI ;
    klee_make_symbolic(&isUPCI, sizeof(int), "isUPCI");
   WordIO_t PCIIO ;
   WordIO_t PCIIO2 ;
   ByteIO_t MBaseIO ;
   ByteIO_t MReg1IO ;
   ...
   Byte_t MReg3 ;
   int NumAiop ;
    klee_make_symbolic(&NumAiop, sizeof(int), "NumAiop");
   int AltChanRingIndicator ;
    klee_make_symbolic(&AltChanRingIndicator, sizeof(int), "AltChanRingIndicator");
...
struct __anonstruct_CHANNEL_T_204 {
   CONTROLLER_T *CtlP ;
   int AiopNum ;
    klee_make_symbolic(&AiopNum, sizeof(int), "AiopNum");
   int ChanID ;
    klee_make_symbolic(&ChanID, sizeof(int), "ChanID");
   int ChanNum ;
    klee_make_symbolic(&ChanNum, sizeof(int), "ChanNum");
   int rtsToggle ;
    klee_make_symbolic(&rtsToggle, sizeof(int), "rtsToggle");
   ByteIO_t Cmd ;
   ByteIO_t IntChan ;
   ByteIO_t IntMask ;
   DWordIO_t IndexAddr ;
...
struct r_port {
   ...
   CHANNEL_t channel ;
   int intmask ;
    klee_make_symbolic(&intmask, sizeof(int), "intmask");
   int xmit_fifo_room ;
    klee_make_symbolic(&xmit_fifo_room, sizeof(int), "xmit_fifo_room");
   unsigned char *xmit_buf ;
   int xmit_head ;
   ...
   int cd_status ;
    klee_make_symbolic(&cd_status, sizeof(int), "cd_status");
...
struct __anonstruct_rocketModel_t_205 {
   unsigned long model ;
    klee_make_symbolic(&model, sizeof(long), "model");
   char modelString[80U] ;
   unsigned long numPorts ;
    klee_make_symbolic(&numPorts, sizeof(long), "numPorts");
   int loadrm2 ;
    klee_make_symbolic(&loadrm2, sizeof(int), "loadrm2");
   int startingPortNumber ;
    klee_make_symbolic(&startingPortNumber, sizeof(int), "startingPortNumber");
};
...
struct rocket_ports {
   ...
   int callout_major ;
    klee_make_symbolic(&callout_major, sizeof(int), "callout_major");
...
static unsigned long board1  ;
    klee_make_symbolic(&board1, sizeof(long), "board1");
static unsigned long board2  ;
    klee_make_symbolic(&board2, sizeof(long), "board2");
static unsigned long board3  ;
    klee_make_symbolic(&board3, sizeof(long), "board3");
static unsigned long board4  ;
    klee_make_symbolic(&board4, sizeof(long), "board4");
static unsigned long controller  ;
    klee_make_symbolic(&controller, sizeof(long), "controller");
static bool support_low_speed  ;
static unsigned long modem1  ;
    klee_make_symbolic(&modem1, sizeof(long), "modem1");
static unsigned long modem2  ;
    klee_make_symbolic(&modem2, sizeof(long), "modem2");
static unsigned long modem3  ;
    klee_make_symbolic(&modem3, sizeof(long), "modem3");
static unsigned long modem4  ;
    klee_make_symbolic(&modem4, sizeof(long), "modem4");
...
static int max_board  ;
    klee_make_symbolic(&max_board, sizeof(int), "max_board");
...
static unsigned long nextLineNumber  ;
    klee_make_symbolic(&nextLineNumber, sizeof(long), "nextLineNumber");
...
{ 
  unsigned int CharNStat ;
    klee_make_symbolic(&CharNStat, sizeof(int), "CharNStat");
  int ToRecv ;
    klee_make_symbolic(&ToRecv, sizeof(int), "ToRecv");
  int wRecv ;
    klee_make_symbolic(&wRecv, sizeof(int), "wRecv");
  int space ;
...
{ 
  ...
  unsigned int ChanStatus ;
    klee_make_symbolic(&ChanStatus, sizeof(int), "ChanStatus");
  unsigned char tmp ;
  unsigned short tmp___0 ;
...
{ 
  ...
  int aiop ;
    klee_make_symbolic(&aiop, sizeof(int), "aiop");
  int ch ;
    klee_make_symbolic(&ch, sizeof(int), "ch");
  int line ;
  unsigned int xmitmask ;
    klee_make_symbolic(&xmitmask, sizeof(int), "xmitmask");
  unsigned int i ;
    klee_make_symbolic(&i, sizeof(int), "i");
  unsigned int CtlMask ;
    klee_make_symbolic(&CtlMask, sizeof(int), "CtlMask");
  unsigned char AiopMask ;
    klee_make_symbolic(&AiopMask, sizeof(char), "AiopMask");
  Word_t bit ;
  unsigned short tmp ;
  unsigned short tmp___0 ;
  unsigned char tmp___1 ;
...
{ 
  unsigned int rocketMode ;
    klee_make_symbolic(&rocketMode, sizeof(int), "rocketMode");
  struct r_port *info ;
  int line ;
  CONTROLLER_T *ctlp ;
  unsigned char tmp ;
...
{ 
  ...
  int ChanNum ;
  int RingInd ;
    klee_make_symbolic(&RingInd, sizeof(int), "RingInd");
  unsigned char tmp ;
...
{ 
  ...
  int check_time ;
    klee_make_symbolic(&check_time, sizeof(int), "check_time");
  int exit_time ;
    klee_make_symbolic(&exit_time, sizeof(int), "exit_time");
  int txcnt ;
...
{ 
  int num_aiops ;
    klee_make_symbolic(&num_aiops, sizeof(int), "num_aiops");
  int aiop ;
  int max_num_aiops ;
    klee_make_symbolic(&max_num_aiops, sizeof(int), "max_num_aiops");
  int num_chan ;
  ...
  CONTROLLER_t *ctlp ;
  int fast_clock ;
    klee_make_symbolic(&fast_clock, sizeof(int), "fast_clock");
  int altChanRingIndicator ;
    klee_make_symbolic(&altChanRingIndicator, sizeof(int), "altChanRingIndicator");
  int ports_per_aiop ;
    klee_make_symbolic(&ports_per_aiop, sizeof(int), "ports_per_aiop");
  WordIO_t ConfigIO ;
  ByteIO_t UPCIRingInd ;
...
{ 
  ...
  int num_chan ;
  int total_num_chan ;
    klee_make_symbolic(&total_num_chan, sizeof(int), "total_num_chan");
  int aiop ;
  int chan ;
  unsigned int aiopio[4U] ;
  CONTROLLER_t *ctlp ;
...
{ 
  ...
  int pci_boards_found ;
    klee_make_symbolic(&pci_boards_found, sizeof(int), "pci_boards_found");
  int isa_boards_found ;
    klee_make_symbolic(&isa_boards_found, sizeof(int), "isa_boards_found");
  int i ;
  struct resource *tmp ;
  int tmp___0 ;
...
{ 
  ...
  Byte_t R[4U] ;
  int brd9600 ;
    klee_make_symbolic(&brd9600, sizeof(int), "brd9600");
...
{ 
  ...
  Byte_t Ch ;
  int RxFIFOEnabled ;
    klee_make_symbolic(&RxFIFOEnabled, sizeof(int), "RxFIFOEnabled");
  unsigned short tmp ;
...
{ 
  ...
  Byte_t Ch ;
  int TxEnabled ;
    klee_make_symbolic(&TxEnabled, sizeof(int), "TxEnabled");
  unsigned char tmp ;
...
{ 
  ...
  unsigned char ldvarg14 ;
    klee_make_symbolic(&ldvarg14, sizeof(char), "ldvarg14");
  unsigned char tmp___9 ;
  int ldvarg4 ;
    klee_make_symbolic(&ldvarg4, sizeof(int), "ldvarg4");
  int tmp___10 ;
  char ldvarg13 ;
    klee_make_symbolic(&ldvarg13, sizeof(char), "ldvarg13");
  char tmp___11 ;
