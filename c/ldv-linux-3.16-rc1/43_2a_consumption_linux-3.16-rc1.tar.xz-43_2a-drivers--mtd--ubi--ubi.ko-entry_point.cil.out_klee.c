...
{ 
  ...
  unsigned long ldvarg100 ;
    klee_make_symbolic(&ldvarg100, sizeof(long), "ldvarg100");
  unsigned long tmp___0 ;
  ...
  unsigned long ldvarg104 ;
    klee_make_symbolic(&ldvarg104, sizeof(long), "ldvarg104");
  unsigned long tmp___4 ;
  int tmp___5 ;
...
{ 
  ...
  struct gendisk *gd ;
  int disk_capacity ;
    klee_make_symbolic(&disk_capacity, sizeof(int), "disk_capacity");
  int ret ;
  struct ubiblock *tmp ;
  void *tmp___0 ;
  struct lock_class_key __key ;
