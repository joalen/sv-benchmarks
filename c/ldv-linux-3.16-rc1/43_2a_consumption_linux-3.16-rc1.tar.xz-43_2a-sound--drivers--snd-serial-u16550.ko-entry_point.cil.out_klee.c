...
struct snd_uart16550 {
   ...
   int filemode ;
    klee_make_symbolic(&filemode, sizeof(int), "filemode");
   ...
   unsigned int speed_base ;
    klee_make_symbolic(&speed_base, sizeof(int), "speed_base");
   unsigned char divisor ;
    klee_make_symbolic(&divisor, sizeof(char), "divisor");
   unsigned char old_divisor_lsb ;
    klee_make_symbolic(&old_divisor_lsb, sizeof(char), "old_divisor_lsb");
   unsigned char old_divisor_msb ;
    klee_make_symbolic(&old_divisor_msb, sizeof(char), "old_divisor_msb");
   unsigned char old_line_ctrl_reg ;
    klee_make_symbolic(&old_line_ctrl_reg, sizeof(char), "old_line_ctrl_reg");
   short fifo_limit ;
    klee_make_symbolic(&fifo_limit, sizeof(short), "fifo_limit");
   short fifo_count ;
    klee_make_symbolic(&fifo_count, sizeof(short), "fifo_count");
   int adaptor ;
    klee_make_symbolic(&adaptor, sizeof(int), "adaptor");
   int prev_in ;
    klee_make_symbolic(&prev_in, sizeof(int), "prev_in");
   unsigned char rstatus ;
    klee_make_symbolic(&rstatus, sizeof(char), "rstatus");
   int prev_out ;
    klee_make_symbolic(&prev_out, sizeof(int), "prev_out");
   unsigned char prev_status[16U] ;
   unsigned char tx_buff[32768U] ;
   int buff_in_count ;
    klee_make_symbolic(&buff_in_count, sizeof(int), "buff_in_count");
   int buff_in ;
    klee_make_symbolic(&buff_in, sizeof(int), "buff_in");
   int buff_out ;
    klee_make_symbolic(&buff_out, sizeof(int), "buff_out");
   int drop_on_full ;
    klee_make_symbolic(&drop_on_full, sizeof(int), "drop_on_full");
...
{ 
  ...
  int substream ;
    klee_make_symbolic(&substream, sizeof(int), "substream");
...
{ 
  unsigned long flags ;
  unsigned char midi_byte ;
    klee_make_symbolic(&midi_byte, sizeof(char), "midi_byte");
  unsigned char addr_byte ;
    klee_make_symbolic(&addr_byte, sizeof(char), "addr_byte");
  struct snd_uart16550 *uart ;
  char first ;
    klee_make_symbolic(&first, sizeof(char), "first");
  unsigned long lasttime ;
    klee_make_symbolic(&lasttime, sizeof(long), "lasttime");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
  int tmp___2 ;
