...
// Function: nfc_hci_recv_frame
// with type: void nfc_hci_recv_frame(struct nfc_hci_dev *, struct sk_buff *)
// with return type: void
...
// Function: st21nfca_hci_probe
// with type: int st21nfca_hci_probe(void *, struct nfc_phy_ops *, char *, int, int, int, struct nfc_hci_dev **)
// with return type: int
int __VERIFIER_nondet_int(void);
...
// Function: st21nfca_hci_remove
// with type: void st21nfca_hci_remove(struct nfc_hci_dev *)
// with return type: void
