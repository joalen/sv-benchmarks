...
struct pvscsi_adapter {
   ...
   unsigned int req_pages ;
    klee_make_symbolic(&req_pages, sizeof(int), "req_pages");
   ...
   unsigned int cmp_pages ;
    klee_make_symbolic(&cmp_pages, sizeof(int), "cmp_pages");
   dma_addr_t cmpRingPA ;
   struct PVSCSIRingMsgDesc *msg_ring ;
   unsigned int msg_pages ;
    klee_make_symbolic(&msg_pages, sizeof(int), "msg_pages");
...
static int pvscsi_ring_pages  ;
    klee_make_symbolic(&pvscsi_ring_pages, sizeof(int), "pvscsi_ring_pages");
