...
struct ata_port {
   ...
   unsigned int last_tag ;
    klee_make_symbolic(&last_tag, sizeof(int), "last_tag");
   struct ata_link link ;
...
struct __anonstruct_hdma_230 {
   ...
   unsigned long pkt_ofs ;
    klee_make_symbolic(&pkt_ofs, sizeof(long), "pkt_ofs");
};
struct pdc_host_priv {
   unsigned int doing_hdma ;
    klee_make_symbolic(&doing_hdma, sizeof(int), "doing_hdma");
   unsigned int hdma_prod ;
    klee_make_symbolic(&hdma_prod, sizeof(int), "hdma_prod");
   unsigned int hdma_cons ;
    klee_make_symbolic(&hdma_cons, sizeof(int), "hdma_cons");
...
{ 
  ...
  unsigned int dimm_sg ;
    klee_make_symbolic(&dimm_sg, sizeof(int), "dimm_sg");
  unsigned int tmp ;
  unsigned int tmp___0 ;
  unsigned int tmp___1 ;
  unsigned int tmp___2 ;
...
{ 
  ...
  unsigned int host_sg ;
    klee_make_symbolic(&host_sg, sizeof(int), "host_sg");
  unsigned int dimm_sg ;
...
{ 
  ...
  void *dimm_mmio ;
  unsigned int portno ;
    klee_make_symbolic(&portno, sizeof(int), "portno");
  unsigned int i ;
  unsigned int si ;
  unsigned int idx ;
  ...
  unsigned int sgt_len ;
    klee_make_symbolic(&sgt_len, sizeof(int), "sgt_len");
  __le32 *buf ;
  int __ret_warn_on ;
...
{ 
  ...
  unsigned int port_ofs ;
    klee_make_symbolic(&port_ofs, sizeof(int), "port_ofs");
...
{ 
  ...
  u8 page_mask ;
  long dist ;
    klee_make_symbolic(&dist, sizeof(long), "dist");
  void *mmio ;
  void *dimm_mmio ;
