...
struct smsc9420_pdata {
   ...
   int tx_ring_head ;
    klee_make_symbolic(&tx_ring_head, sizeof(int), "tx_ring_head");
   int tx_ring_tail ;
    klee_make_symbolic(&tx_ring_tail, sizeof(int), "tx_ring_tail");
   int rx_ring_head ;
    klee_make_symbolic(&rx_ring_head, sizeof(int), "rx_ring_head");
   int rx_ring_tail ;
    klee_make_symbolic(&rx_ring_tail, sizeof(int), "rx_ring_tail");
   spinlock_t int_lock ;
   spinlock_t phy_lock ;
...
static uint smsc_debug  ;
    klee_make_symbolic(&smsc_debug, sizeof(int), "smsc_debug");
