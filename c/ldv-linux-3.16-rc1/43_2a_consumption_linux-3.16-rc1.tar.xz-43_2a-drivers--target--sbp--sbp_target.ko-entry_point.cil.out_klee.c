...
struct sbp_session {
   ...
   int reconnect_hold ;
    klee_make_symbolic(&reconnect_hold, sizeof(int), "reconnect_hold");
...
struct sbp_tport {
   ...
   s32 directory_id ;
   int mgt_orb_timeout ;
    klee_make_symbolic(&mgt_orb_timeout, sizeof(int), "mgt_orb_timeout");
   int max_reconnect_timeout ;
    klee_make_symbolic(&max_reconnect_timeout, sizeof(int), "max_reconnect_timeout");
   int max_logins_per_lun ;
    klee_make_symbolic(&max_logins_per_lun, sizeof(int), "max_logins_per_lun");
};
struct sbp_target_agent {
   spinlock_t lock ;
...
struct sbp_management_request {
   ...
   int generation ;
   int node_addr ;
    klee_make_symbolic(&node_addr, sizeof(int), "node_addr");
   int speed ;
};
...
{ 
  ...
  int login_response_len ;
    klee_make_symbolic(&login_response_len, sizeof(int), "login_response_len");
  __u32 tmp ;
  __u32 tmp___0 ;
  bool tmp___1 ;
  __u32 tmp___2 ;
...
{ 
  ...
  struct sbp_session *sess ;
  int sess_gen ;
    klee_make_symbolic(&sess_gen, sizeof(int), "sess_gen");
  int sess_node ;
    klee_make_symbolic(&sess_node, sizeof(int), "sess_node");
  int rcode ;
...
{ 
  int pg_tbl_sz ;
    klee_make_symbolic(&pg_tbl_sz, sizeof(int), "pg_tbl_sz");
  int ret ;
  struct sbp_page_table_entry *pg_tbl ;
  __u32 tmp ;
  __u32 tmp___0 ;
...
{ 
  ...
  int ret ;
  int unpacked_lun ;
    klee_make_symbolic(&unpacked_lun, sizeof(int), "unpacked_lun");
  u32 data_length ;
  enum dma_data_direction data_dir ;
  struct _ddebug descriptor ;
  long tmp ;
...
{ 
  ...
  int sg_miter_flags ;
    klee_make_symbolic(&sg_miter_flags, sizeof(int), "sg_miter_flags");
  int max_payload ;
    klee_make_symbolic(&max_payload, sizeof(int), "max_payload");
  int pg_size ;
    klee_make_symbolic(&pg_size, sizeof(int), "pg_size");
  int speed ;
  int node_id ;
  int generation ;
  int num_pte ;
    klee_make_symbolic(&num_pte, sizeof(int), "num_pte");
  int length ;
  int tfr_length ;
    klee_make_symbolic(&tfr_length, sizeof(int), "tfr_length");
  int rcode ;
  ...
  int _min2 ;
  int _min3 ;
    klee_make_symbolic(&_min3, sizeof(int), "_min3");
  int __ret_warn_on ;
  long tmp___6 ;
...
{ 
  ...
  int ret ;
  int status_data_len ;
    klee_make_symbolic(&status_data_len, sizeof(int), "status_data_len");
  struct _ddebug descriptor ;
  long tmp ;
  struct _ddebug descriptor___0 ;
  u64 tmp___0 ;
...
{ 
  ...
  struct sbp_management_request *req ;
  int prev_state ;
    klee_make_symbolic(&prev_state, sizeof(int), "prev_state");
  void *tmp ;
...
{ 
  ...
  int idx ;
  int mgt_agt_addr ;
    klee_make_symbolic(&mgt_agt_addr, sizeof(int), "mgt_agt_addr");
  int ret ;
  int i ;
  u32 *data ;
  void *tmp ;
...
{ 
  ...
  char c ;
  char nibble ;
    klee_make_symbolic(&nibble, sizeof(char), "nibble");
  int pos ;
