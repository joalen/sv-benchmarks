...
struct cfv_info {
   ...
   unsigned int watermark_tx ;
    klee_make_symbolic(&watermark_tx, sizeof(int), "watermark_tx");
   spinlock_t tx_lock ;
   ...
   unsigned long reserved_mem ;
    klee_make_symbolic(&reserved_mem, sizeof(long), "reserved_mem");
...
{ 
  ...
  int rxcnt ;
    klee_make_symbolic(&rxcnt, sizeof(int), "rxcnt");
  int err ;
