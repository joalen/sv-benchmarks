...
struct throttling_tstate {
   unsigned int cpu ;
   int target_state ;
    klee_make_symbolic(&target_state, sizeof(int), "target_state");
};
...
struct cpufreq_policy {
   ...
   unsigned int restore_freq ;
    klee_make_symbolic(&restore_freq, sizeof(int), "restore_freq");
   unsigned int suspend_freq ;
    klee_make_symbolic(&suspend_freq, sizeof(int), "suspend_freq");
   unsigned int policy ;
   struct cpufreq_governor *governor ;
   void *governor_data ;
...
struct cpufreq_frequency_table {
   ...
   unsigned int driver_data ;
    klee_make_symbolic(&driver_data, sizeof(int), "driver_data");
...
{ 
  ...
  struct acpi_processor *pr ;
  int saved ;
    klee_make_symbolic(&saved, sizeof(int), "saved");
  void *tmp ;
  char const   *tmp___0 ;
  char const   *tmp___1 ;
  char const   *tmp___2 ;
...
static int ignore_tpc  ;
    klee_make_symbolic(&ignore_tpc, sizeof(int), "ignore_tpc");
static int acpi_processor_get_throttling(struct acpi_processor *pr ) ;
static int acpi_processor_update_tsd_coord(void) 
{ 
  int count ;
  int count_target ;
    klee_make_symbolic(&count_target, sizeof(int), "count_target");
  int retval ;
...
{ 
  ...
  unsigned long long tpc ;
    klee_make_symbolic(&tpc, sizeof(long), "tpc");
...
{ 
  ...
  int throttling_limit ;
    klee_make_symbolic(&throttling_limit, sizeof(int), "throttling_limit");
  int current_state ;
    klee_make_symbolic(&current_state, sizeof(int), "current_state");
  struct acpi_processor_limit *limit ;
  int target_state ;
  int tmp ;
...
static unsigned int nocst  ;
    klee_make_symbolic(&nocst, sizeof(int), "nocst");
static int bm_check_disable  ;
    klee_make_symbolic(&bm_check_disable, sizeof(int), "bm_check_disable");
static unsigned int latency_factor  =    2U;
char __pcpu_unique_acpi_cpuidle_device  ;
    klee_make_symbolic(&__pcpu_unique_acpi_cpuidle_device, sizeof(char), "__pcpu_unique_acpi_cpuidle_device");
struct cpuidle_device *acpi_cpuidle_device  ;
char __pcpu_unique_acpi_cstate  ;
    klee_make_symbolic(&__pcpu_unique_acpi_cstate, sizeof(char), "__pcpu_unique_acpi_cstate");
...
{ 
  ...
  unsigned long reason ;
    klee_make_symbolic(&reason, sizeof(long), "reason");
...
{ 
  ...
  u64 count ;
  int current_count ;
    klee_make_symbolic(&current_count, sizeof(int), "current_count");
  int i ;
  struct acpi_buffer buffer ;
...
{ 
  int bm_check_flag ;
    klee_make_symbolic(&bm_check_flag, sizeof(int), "bm_check_flag");
  int bm_control_flag ;
    klee_make_symbolic(&bm_control_flag, sizeof(int), "bm_control_flag");
...
static int c3_cpu_count  ;
    klee_make_symbolic(&c3_cpu_count, sizeof(int), "c3_cpu_count");
...
static int acpi_processor_registered  ;
    klee_make_symbolic(&acpi_processor_registered, sizeof(int), "acpi_processor_registered");
int acpi_processor_power_init(struct acpi_processor *pr ) 
{ 
  acpi_status status ;
  int retval ;
  struct cpuidle_device *dev ;
  int first_run ;
    klee_make_symbolic(&first_run, sizeof(int), "first_run");
  int tmp ;
  void *tmp___0 ;
  void const   *__vpp_verify ;
  unsigned long __ptr ;
...
char __pcpu_unique_cpufreq_thermal_reduction_pctg  ;
    klee_make_symbolic(&__pcpu_unique_cpufreq_thermal_reduction_pctg, sizeof(char), "__pcpu_unique_cpufreq_thermal_reduction_pctg");
unsigned int cpufreq_thermal_reduction_pctg  ;
    klee_make_symbolic(&cpufreq_thermal_reduction_pctg, sizeof(int), "cpufreq_thermal_reduction_pctg");
...
{ 
  int max_state ;
    klee_make_symbolic(&max_state, sizeof(int), "max_state");
  int tmp ;
...
{ 
  ...
  int result ;
  int max_pstate ;
    klee_make_symbolic(&max_pstate, sizeof(int), "max_pstate");
  void *tmp ;
  int tmp___0 ;
...
static int acpi_processor_ppc_status  ;
    klee_make_symbolic(&acpi_processor_ppc_status, sizeof(int), "acpi_processor_ppc_status");
...
{ 
  ...
  int i ;
  int last_invalid ;
    klee_make_symbolic(&last_invalid, sizeof(int), "last_invalid");
  void *tmp ;
...
{ 
  acpi_status status ;
  int is_done ;
    klee_make_symbolic(&is_done, sizeof(int), "is_done");
  bool tmp ;
  int tmp___0 ;
...
{ 
  ...
  unsigned long __ptr___4 ;
    klee_make_symbolic(&__ptr___4, sizeof(long), "__ptr___4");
  void const   *__vpp_verify___5 ;
  unsigned long __ptr___5 ;
    klee_make_symbolic(&__ptr___5, sizeof(long), "__ptr___5");
