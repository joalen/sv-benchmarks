...
struct loopback_setup {
   ...
   unsigned int rate_shift ;
    klee_make_symbolic(&rate_shift, sizeof(int), "rate_shift");
   unsigned int format ;
   unsigned int rate ;
   unsigned int channels ;
...
struct loopback_pcm {
   ...
   unsigned int pcm_buffer_size ;
    klee_make_symbolic(&pcm_buffer_size, sizeof(int), "pcm_buffer_size");
   unsigned int buf_pos ;
    klee_make_symbolic(&buf_pos, sizeof(int), "buf_pos");
   unsigned int silent_size ;
    klee_make_symbolic(&silent_size, sizeof(int), "silent_size");
   unsigned int pcm_period_size ;
    klee_make_symbolic(&pcm_period_size, sizeof(int), "pcm_period_size");
   unsigned int pcm_bps ;
    klee_make_symbolic(&pcm_bps, sizeof(int), "pcm_bps");
   unsigned int pcm_salign ;
    klee_make_symbolic(&pcm_salign, sizeof(int), "pcm_salign");
   unsigned int pcm_rate_shift ;
    klee_make_symbolic(&pcm_rate_shift, sizeof(int), "pcm_rate_shift");
   unsigned char period_update_pending : 1 ;
   unsigned int irq_pos ;
    klee_make_symbolic(&irq_pos, sizeof(int), "irq_pos");
   unsigned int period_size_frac ;
    klee_make_symbolic(&period_size_frac, sizeof(int), "period_size_frac");
   unsigned int last_drift ;
    klee_make_symbolic(&last_drift, sizeof(int), "last_drift");
...
{ 
  ...
  int salign ;
    klee_make_symbolic(&salign, sizeof(int), "salign");
  int tmp ;
  ssize_t tmp___0 ;
  ssize_t tmp___1 ;
...
{ 
  ...
  unsigned int src_off ;
    klee_make_symbolic(&src_off, sizeof(int), "src_off");
  unsigned int dst_off ;
  unsigned int clear_bytes ;
    klee_make_symbolic(&clear_bytes, sizeof(int), "clear_bytes");
  snd_pcm_uframes_t appl_ptr ;
...
{ 
  unsigned long last_pos ;
    klee_make_symbolic(&last_pos, sizeof(long), "last_pos");
  unsigned int delta ;
...
{ 
  ...
  unsigned long delta_play ;
    klee_make_symbolic(&delta_play, sizeof(long), "delta_play");
  unsigned long delta_capt ;
    klee_make_symbolic(&delta_capt, sizeof(long), "delta_capt");
  unsigned int running ;
  unsigned int count1 ;
    klee_make_symbolic(&count1, sizeof(int), "count1");
  unsigned int count2 ;
...
{ 
  ...
  int dev ;
  int substr ;
    klee_make_symbolic(&substr, sizeof(int), "substr");
  int substr_count ;
    klee_make_symbolic(&substr_count, sizeof(int), "substr_count");
  int idx ;
...
{ 
  struct loopback *loopback ;
  int sub ;
    klee_make_symbolic(&sub, sizeof(int), "sub");
  int num ;
...
{ 
  ...
  int err ;
  int cards ;
    klee_make_symbolic(&cards, sizeof(int), "cards");
