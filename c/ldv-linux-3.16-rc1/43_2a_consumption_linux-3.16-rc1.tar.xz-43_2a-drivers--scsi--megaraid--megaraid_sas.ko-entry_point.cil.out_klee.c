...
struct MEGASAS_RAID_MFA_IO_REQUEST_DESCRIPTOR {
   unsigned char RequestFlags ;
    klee_make_symbolic(&RequestFlags, sizeof(char), "RequestFlags");
...
struct __anonstruct_capability_244 {
   ...
   unsigned char encryptionType ;
    klee_make_symbolic(&encryptionType, sizeof(char), "encryptionType");
...
struct megasas_instance {
   ...
   unsigned long last_time ;
    klee_make_symbolic(&last_time, sizeof(long), "last_time");
   u32 mfiStatus ;
   u32 last_seq_num ;
   struct list_head internal_reset_pending_q ;
   void *ctrl_context ;
   unsigned int msix_vectors ;
    klee_make_symbolic(&msix_vectors, sizeof(int), "msix_vectors");
   struct msix_entry msixentry[128U] ;
   struct megasas_irq_context irq_context[128U] ;
   u64 map_id ;
   struct megasas_cmd *map_update_cmd ;
   unsigned long bar ;
    klee_make_symbolic(&bar, sizeof(long), "bar");
   long reset_flags ;
    klee_make_symbolic(&reset_flags, sizeof(long), "reset_flags");
   struct mutex reset_mutex ;
   struct timer_list sriov_heartbeat_timer ;
   char skip_heartbeat_timer_del ;
    klee_make_symbolic(&skip_heartbeat_timer_del, sizeof(char), "skip_heartbeat_timer_del");
   u8 requestorId ;
   u64 initiator_sas_address ;
   u64 ld_sas_address[64U] ;
   char PlasmaFW111 ;
    klee_make_symbolic(&PlasmaFW111, sizeof(char), "PlasmaFW111");
   char mpio ;
    klee_make_symbolic(&mpio, sizeof(char), "mpio");
   int throttlequeuedepth ;
    klee_make_symbolic(&throttlequeuedepth, sizeof(int), "throttlequeuedepth");
   u8 mask_interrupts ;
   u8 is_imr ;
};
struct MR_LD_VF_MAP {
...
static int msix_disable  ;
    klee_make_symbolic(&msix_disable, sizeof(int), "msix_disable");
static unsigned int msix_vectors  ;
static int allow_vf_ioctls  ;
    klee_make_symbolic(&allow_vf_ioctls, sizeof(int), "allow_vf_ioctls");
...
static int megasas_mgmt_majorno  ;
    klee_make_symbolic(&megasas_mgmt_majorno, sizeof(int), "megasas_mgmt_majorno");
...
static int megasas_poll_wait_aen  ;
    klee_make_symbolic(&megasas_poll_wait_aen, sizeof(int), "megasas_poll_wait_aen");
...
{ 
  ...
  int sge_count ;
    klee_make_symbolic(&sge_count, sizeof(int), "sge_count");
...
{ 
  int num_cnt ;
    klee_make_symbolic(&num_cnt, sizeof(int), "num_cnt");
  int sge_bytes ;
    klee_make_symbolic(&sge_bytes, sizeof(int), "sge_bytes");
  u32 sge_sz ;
  u32 frame_count ;
  long tmp ;
...
{ 
  ...
  u32 tmp___1 ;
  int outstanding___0 ;
    klee_make_symbolic(&outstanding___0, sizeof(int), "outstanding___0");
  int tmp___2 ;
...
{ 
  int exception ;
    klee_make_symbolic(&exception, sizeof(int), "exception");
  struct megasas_header *hdr ;
  unsigned long flags ;
...
{ 
  int ret ;
  int pd_index ;
    klee_make_symbolic(&pd_index, sizeof(int), "pd_index");
  struct megasas_cmd *cmd ;
  struct megasas_dcmd_frame *dcmd ;
...
{ 
  int ret ;
  int ld_index ;
    klee_make_symbolic(&ld_index, sizeof(int), "ld_index");
  int ids ;
    klee_make_symbolic(&ids, sizeof(int), "ids");
  struct megasas_cmd *cmd ;
  struct megasas_dcmd_frame *dcmd ;
...
{ 
  ...
  unsigned long bar_list ;
    klee_make_symbolic(&bar_list, sizeof(long), "bar_list");
  int i ;
  int loop ;
    klee_make_symbolic(&loop, sizeof(int), "loop");
  int fw_msix_count ;
    klee_make_symbolic(&fw_msix_count, sizeof(int), "fw_msix_count");
...
{ 
  ...
  int j ;
  int doscan ;
    klee_make_symbolic(&doscan, sizeof(int), "doscan");
  u32 seq_num ;
  u32 wait_time ;
  int error ;
  int tmp ;
...
{ 
  ...
  unsigned long ldvarg52 ;
    klee_make_symbolic(&ldvarg52, sizeof(long), "ldvarg52");
...
{ 
  int i ;
  int sg_processed ;
    klee_make_symbolic(&sg_processed, sizeof(int), "sg_processed");
  int sge_count ;
  struct scatterlist *os_sgl ;
  struct fusion_context *fusion ;
...
{ 
  ...
  int hb_seconds_missed ;
    klee_make_symbolic(&hb_seconds_missed, sizeof(int), "hb_seconds_missed");
  u32 fw_state ;
  u32 tmp ;
  int tmp___0 ;
...
{ 
  ...
  struct MR_LD_RAID *raid ;
  int ldCount ;
    klee_make_symbolic(&ldCount, sizeof(int), "ldCount");
  int num_lds ;
    klee_make_symbolic(&num_lds, sizeof(int), "num_lds");
  u16 ld ;
  u8 tmp ;
...
{ 
  ...
  u8 tmp___7 ;
  uint stripIdx ;
    klee_make_symbolic(&stripIdx, sizeof(int), "stripIdx");
  u8 tmp___8 ;
  u8 tmp___9 ;
