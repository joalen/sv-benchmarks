...
struct analog_port {
   ...
   unsigned char mask ;
   char saitek ;
    klee_make_symbolic(&saitek, sizeof(char), "saitek");
   char cooked ;
    klee_make_symbolic(&cooked, sizeof(char), "cooked");
   int bads ;
    klee_make_symbolic(&bads, sizeof(int), "bads");
   int reads ;
    klee_make_symbolic(&reads, sizeof(int), "reads");
   int speed ;
   int loop ;
   ...
   int initial[4U] ;
   int axtime ;
    klee_make_symbolic(&axtime, sizeof(int), "axtime");
};
struct analog_types {
   char *name ;
   int value ;
...
static unsigned int js_nargs  ;
    klee_make_symbolic(&js_nargs, sizeof(int), "js_nargs");
...
{ 
  ...
  unsigned int loopout ;
    klee_make_symbolic(&loopout, sizeof(int), "loopout");
  unsigned int timeout ;
    klee_make_symbolic(&timeout, sizeof(int), "timeout");
  unsigned char data[4U] ;
  unsigned char this ;
    klee_make_symbolic(&this, sizeof(char), "this");
  unsigned char last ;
...
{ 
  ...
  char saitek ;
  char chf ;
    klee_make_symbolic(&chf, sizeof(char), "chf");
  int tmp___0 ;
  int tmp___1 ;
  int tmp___2 ;
  int tmp___3 ;
