...
struct hfcsusb {
   ...
   int ctrl_in_idx ;
    klee_make_symbolic(&ctrl_in_idx, sizeof(int), "ctrl_in_idx");
   int ctrl_out_idx ;
    klee_make_symbolic(&ctrl_out_idx, sizeof(int), "ctrl_out_idx");
   int ctrl_cnt ;
    klee_make_symbolic(&ctrl_cnt, sizeof(int), "ctrl_cnt");
   struct urb *ctrl_urb ;
...
static int hfcsusb_cnt  ;
    klee_make_symbolic(&hfcsusb_cnt, sizeof(int), "hfcsusb_cnt");
...
{ 
  ...
  int status ;
  int fillempty ;
    klee_make_symbolic(&fillempty, sizeof(int), "fillempty");
  __u8 threshbit ;
  __u8 *p ;
  int tmp ;
  size_t __len ;
