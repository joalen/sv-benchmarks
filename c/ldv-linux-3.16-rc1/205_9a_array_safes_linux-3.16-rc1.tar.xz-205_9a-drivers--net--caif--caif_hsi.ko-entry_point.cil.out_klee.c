...
struct caif_payload_info {
   ...
   unsigned short channel_id ;
    klee_make_symbolic(&channel_id, sizeof(short), "channel_id");
};
...
struct caif_dev_common {
   ...
   int use_frag ;
    klee_make_symbolic(&use_frag, sizeof(int), "use_frag");
   int use_fcs ;
    klee_make_symbolic(&use_fcs, sizeof(int), "use_fcs");
   int use_stx ;
    klee_make_symbolic(&use_stx, sizeof(int), "use_stx");
};
struct cfhsi_desc {
   u8 header ;
   u8 offset ;
...
struct cfhsi_rx_state {
   int state ;
   int nfrms ;
    klee_make_symbolic(&nfrms, sizeof(int), "nfrms");
   int pld_len ;
...
struct cfhsi {
   ...
   int tx_state ;
    klee_make_symbolic(&tx_state, sizeof(int), "tx_state");
   ...
   spinlock_t lock ;
   int flow_off_sent ;
    klee_make_symbolic(&flow_off_sent, sizeof(int), "flow_off_sent");
   struct list_head list ;
   ...
   int aggregation_len ;
    klee_make_symbolic(&aggregation_len, sizeof(int), "aggregation_len");
...
{ 
  ...
  int hpad ;
    klee_make_symbolic(&hpad, sizeof(int), "hpad");
  int tpad ;
    klee_make_symbolic(&tpad, sizeof(int), "tpad");
  int len ;
...
{ 
  ...
  int hpad___0 ;
    klee_make_symbolic(&hpad___0, sizeof(int), "hpad___0");
  int tpad___0 ;
    klee_make_symbolic(&tpad___0, sizeof(int), "tpad___0");
  bool tmp ;
...
{ 
  int rx_sz ;
    klee_make_symbolic(&rx_sz, sizeof(int), "rx_sz");
  int nfrms ;
  u16 *plen ;
  u8 *pfrm ;
  int __ret_warn_on ;
...
{ 
  int res ;
  int desc_pld_len ;
    klee_make_symbolic(&desc_pld_len, sizeof(int), "desc_pld_len");
  int rx_len ;
  int rx_state ;
    klee_make_symbolic(&rx_state, sizeof(int), "rx_state");
  struct cfhsi_desc *desc ;
  u8 *rx_ptr ;
  u8 *rx_buf ;
...
{ 
  struct cfhsi *cfhsi ;
  int start_xfer ;
    klee_make_symbolic(&start_xfer, sizeof(int), "start_xfer");
  int timer_active ;
