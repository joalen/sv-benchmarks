...
{ 
  ...
  u32 packet_count ;
  int cfo_khz_a ;
    klee_make_symbolic(&cfo_khz_a, sizeof(int), "cfo_khz_a");
  int cfo_khz_b ;
    klee_make_symbolic(&cfo_khz_b, sizeof(int), "cfo_khz_b");
  int cfo_ave ;
    klee_make_symbolic(&cfo_ave, sizeof(int), "cfo_ave");
  int adjust_xtal ;
    klee_make_symbolic(&adjust_xtal, sizeof(int), "adjust_xtal");
  int cfo_ave_diff ;
    klee_make_symbolic(&cfo_ave_diff, sizeof(int), "cfo_ave_diff");
  int tmp ;
  int tmp___0 ;
  long tmp___1 ;
  long tmp___2 ;
...
{ 
  ...
  u8 tx_num ;
  char tx_pwr_diff ;
    klee_make_symbolic(&tx_pwr_diff, sizeof(char), "tx_pwr_diff");
