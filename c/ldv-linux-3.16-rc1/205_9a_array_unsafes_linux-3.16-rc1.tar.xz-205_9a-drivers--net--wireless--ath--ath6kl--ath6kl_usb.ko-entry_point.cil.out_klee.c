...
struct htc_service_connect_req {
   ...
   unsigned int max_rxmsg_sz ;
    klee_make_symbolic(&max_rxmsg_sz, sizeof(int), "max_rxmsg_sz");
};
...
struct __anonstruct_pipe_295 {
   ...
   int ctrl_response_len ;
    klee_make_symbolic(&ctrl_response_len, sizeof(int), "ctrl_response_len");
...
struct ath6kl_fw_recovery {
   ...
   unsigned long err_reason ;
    klee_make_symbolic(&err_reason, sizeof(long), "err_reason");
   unsigned long hb_poll ;
    klee_make_symbolic(&hb_poll, sizeof(long), "hb_poll");
...
struct ath6kl_usb_pipe {
   ...
   unsigned int usb_pipe_handle ;
    klee_make_symbolic(&usb_pipe_handle, sizeof(int), "usb_pipe_handle");
   u32 flags ;
   u8 ep_address ;
   u8 logical_pipe_num ;
...
{ 
  ...
  int i ;
  int urbcount ;
    klee_make_symbolic(&urbcount, sizeof(int), "urbcount");
  int status ;
  u8 pipe_num ;
  unsigned int tmp ;
...
{ 
  ...
  struct urb *urb ;
  int usb_status ;
    klee_make_symbolic(&usb_status, sizeof(int), "usb_status");
