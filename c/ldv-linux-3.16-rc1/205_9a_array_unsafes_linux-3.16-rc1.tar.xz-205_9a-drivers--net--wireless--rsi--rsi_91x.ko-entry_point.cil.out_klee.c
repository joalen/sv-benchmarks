...
{ 
  ...
  unsigned long tstamp_1 ;
    klee_make_symbolic(&tstamp_1, sizeof(long), "tstamp_1");
  unsigned long tstamp_2 ;
    klee_make_symbolic(&tstamp_2, sizeof(long), "tstamp_2");
  u8 q_num ;
  int status ;
  int tmp ;
  __u32 tmp___0 ;
...
{ 
  ...
  char rssi ;
    klee_make_symbolic(&rssi, sizeof(char), "rssi");
  u8 hdrlen ;
  u8 channel ;
  s32 freq ;
...
{ 
  unsigned long dbg_zone ;
    klee_make_symbolic(&dbg_zone, sizeof(long), "dbg_zone");
  int ret ;
