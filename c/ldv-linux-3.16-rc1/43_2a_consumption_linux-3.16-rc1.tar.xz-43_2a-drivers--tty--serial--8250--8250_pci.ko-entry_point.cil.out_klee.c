...
struct pciserial_board {
   ...
   unsigned int base_baud ;
    klee_make_symbolic(&base_baud, sizeof(int), "base_baud");
   unsigned int uart_offset ;
    klee_make_symbolic(&uart_offset, sizeof(int), "uart_offset");
   unsigned int reg_shift ;
    klee_make_symbolic(&reg_shift, sizeof(int), "reg_shift");
   unsigned int first_offset ;
    klee_make_symbolic(&first_offset, sizeof(int), "first_offset");
};
...
{ 
  unsigned long oldval ;
    klee_make_symbolic(&oldval, sizeof(long), "oldval");
...
{ 
  ...
  unsigned short sub_serports ;
    klee_make_symbolic(&sub_serports, sizeof(short), "sub_serports");
...
{ 
  unsigned int num_serial ;
    klee_make_symbolic(&num_serial, sizeof(int), "num_serial");
  int tmp ;
...
{ 
  ...
  unsigned long deviceID ;
    klee_make_symbolic(&deviceID, sizeof(long), "deviceID");
  unsigned int number_uarts ;
    klee_make_symbolic(&number_uarts, sizeof(int), "number_uarts");
  void *tmp ;
...
{ 
  u8 qmcr ;
  int rs422 ;
    klee_make_symbolic(&rs422, sizeof(int), "rs422");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
...
{ 
  ...
  unsigned int offset ;
  unsigned int maxnr ;
    klee_make_symbolic(&maxnr, sizeof(int), "maxnr");
  int tmp ;
...
{ 
  ...
  unsigned long ciobase ;
    klee_make_symbolic(&ciobase, sizeof(long), "ciobase");
  u8 config_base ;
  struct _ddebug descriptor ;
  long tmp ;
...
{ 
  ...
  int num_iomem ;
    klee_make_symbolic(&num_iomem, sizeof(int), "num_iomem");
  int num_port ;
    klee_make_symbolic(&num_port, sizeof(int), "num_port");
  int first_port ;
