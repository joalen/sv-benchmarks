...
struct st21nfca_nfc_platform_data {
   unsigned int gpio_irq ;
    klee_make_symbolic(&gpio_irq, sizeof(int), "gpio_irq");
   unsigned int gpio_ena ;
    klee_make_symbolic(&gpio_ena, sizeof(int), "gpio_ena");
...
struct nfc_hci_dev {
   ...
   u8 hw_bsid ;
   int async_cb_type ;
    klee_make_symbolic(&async_cb_type, sizeof(int), "async_cb_type");
...
struct st21nfca_i2c_phy {
   ...
   int current_read_len ;
    klee_make_symbolic(&current_read_len, sizeof(int), "current_read_len");
   int crc_trials ;
    klee_make_symbolic(&crc_trials, sizeof(int), "crc_trials");
   int powered ;
    klee_make_symbolic(&powered, sizeof(int), "powered");
   int run_mode ;
    klee_make_symbolic(&run_mode, sizeof(int), "run_mode");
   int hard_fault ;
    klee_make_symbolic(&hard_fault, sizeof(int), "hard_fault");
