...
struct tc_bus {
   ...
   int num_tcslots ;
    klee_make_symbolic(&num_tcslots, sizeof(int), "num_tcslots");
   struct tcinfo info ;
};
struct tc_driver;
struct tc_dev {
...
{ 
  struct device *bdev ;
  int dfx_bus_tc ;
    klee_make_symbolic(&dfx_bus_tc, sizeof(int), "dfx_bus_tc");
  int dfx_use_mmio ;
    klee_make_symbolic(&dfx_use_mmio, sizeof(int), "dfx_use_mmio");
...
{ 
  int dfx_bus_pci ;
    klee_make_symbolic(&dfx_bus_pci, sizeof(int), "dfx_bus_pci");
  int dfx_bus_eisa ;
    klee_make_symbolic(&dfx_bus_eisa, sizeof(int), "dfx_bus_eisa");
  int dfx_bus_tc ;
  int dfx_use_mmio ;
  int num ;
...
{ 
  int status ;
  int timeout_cnt ;
    klee_make_symbolic(&timeout_cnt, sizeof(int), "timeout_cnt");
