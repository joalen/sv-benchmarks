...
struct ppp {
   ...
   unsigned long last_pong ;
    klee_make_symbolic(&last_pong, sizeof(long), "last_pong");
   unsigned int req_timeout ;
    klee_make_symbolic(&req_timeout, sizeof(int), "req_timeout");
   unsigned int cr_retries ;
    klee_make_symbolic(&cr_retries, sizeof(int), "cr_retries");
   unsigned int term_retries ;
    klee_make_symbolic(&term_retries, sizeof(int), "term_retries");
   unsigned int keepalive_interval ;
    klee_make_symbolic(&keepalive_interval, sizeof(int), "keepalive_interval");
   unsigned int keepalive_timeout ;
    klee_make_symbolic(&keepalive_timeout, sizeof(int), "keepalive_timeout");
   u8 seq ;
   u8 echo_id ;
};
...
{ 
  ...
  unsigned int magic_len ;
    klee_make_symbolic(&magic_len, sizeof(int), "magic_len");
  u32 magic ;
  unsigned char *tmp ;
  __u16 tmp___0 ;
  size_t __len ;
...
{ 
  ...
  unsigned int nak_len ;
    klee_make_symbolic(&nak_len, sizeof(int), "nak_len");
  unsigned int rej_len ;
    klee_make_symbolic(&rej_len, sizeof(int), "rej_len");
  void *tmp ;
  int tmp___0 ;
  size_t __len ;
  void *__ret ;
