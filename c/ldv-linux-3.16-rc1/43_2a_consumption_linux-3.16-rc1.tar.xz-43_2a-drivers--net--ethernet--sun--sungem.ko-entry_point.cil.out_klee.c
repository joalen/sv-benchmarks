...
struct gem {
   ...
   int cell_enabled ;
    klee_make_symbolic(&cell_enabled, sizeof(int), "cell_enabled");
   u32 msg_enable ;
   u32 status ;
   struct napi_struct napi ;
   int tx_fifo_sz ;
    klee_make_symbolic(&tx_fifo_sz, sizeof(int), "tx_fifo_sz");
   int rx_fifo_sz ;
    klee_make_symbolic(&rx_fifo_sz, sizeof(int), "rx_fifo_sz");
   int rx_pause_off ;
   ...
   u32 swrst_base ;
   int want_autoneg ;
    klee_make_symbolic(&want_autoneg, sizeof(int), "want_autoneg");
   int last_forced_speed ;
    klee_make_symbolic(&last_forced_speed, sizeof(int), "last_forced_speed");
   enum link_state lstate ;
   struct timer_list link_timer ;
   int timer_ticks ;
    klee_make_symbolic(&timer_ticks, sizeof(int), "timer_ticks");
   int wake_on_lan ;
    klee_make_symbolic(&wake_on_lan, sizeof(int), "wake_on_lan");
   struct work_struct reset_task ;
   int volatile   reset_task_pending ;
   enum gem_phy_type phy_type ;
   struct mii_phy phy_mii ;
   int mii_phy_addr ;
    klee_make_symbolic(&mii_phy_addr, sizeof(int), "mii_phy_addr");
...
{ 
  ...
  unsigned char *tmp ;
  int walk ;
    klee_make_symbolic(&walk, sizeof(int), "walk");
  int incomplete ;
...
{ 
  int cluster_start ;
    klee_make_symbolic(&cluster_start, sizeof(int), "cluster_start");
  int curr ;
    klee_make_symbolic(&curr, sizeof(int), "curr");
  int count ;
  int kick ;
    klee_make_symbolic(&kick, sizeof(int), "kick");
  struct gem_rxd *rxd ;
...
{ 
  ...
  struct net_device *dev ;
  int restart_aneg ;
    klee_make_symbolic(&restart_aneg, sizeof(int), "restart_aneg");
  u32 val ;
  unsigned int tmp ;
  int tmp___0 ;
  int tmp___1 ;
...
{ 
  unsigned long gemreg_base ;
    klee_make_symbolic(&gemreg_base, sizeof(long), "gemreg_base");
  unsigned long gemreg_len ;
    klee_make_symbolic(&gemreg_len, sizeof(long), "gemreg_len");
  struct net_device *dev ;
  struct gem *gp ;
  int err ;
