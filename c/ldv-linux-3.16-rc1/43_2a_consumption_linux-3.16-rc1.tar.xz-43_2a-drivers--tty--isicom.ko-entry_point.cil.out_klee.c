...
struct isi_board {
   ...
   unsigned char port_count ;
    klee_make_symbolic(&port_count, sizeof(char), "port_count");
   unsigned short status ;
    klee_make_symbolic(&status, sizeof(short), "status");
   unsigned short port_status ;
    klee_make_symbolic(&port_status, sizeof(short), "port_status");
   unsigned short shift_count ;
    klee_make_symbolic(&shift_count, sizeof(short), "shift_count");
...
{ 
  ...
  short txcount ;
    klee_make_symbolic(&txcount, sizeof(short), "txcount");
  short wrd ;
    klee_make_symbolic(&wrd, sizeof(short), "wrd");
  short residue ;
    klee_make_symbolic(&residue, sizeof(short), "residue");
  short word_count ;
    klee_make_symbolic(&word_count, sizeof(short), "word_count");
  short cnt ;
...
{ 
  ...
  u16 channel ;
  short byte_count ;
    klee_make_symbolic(&byte_count, sizeof(short), "byte_count");
  unsigned char *rp ;
  unsigned short tmp ;
  struct _ddebug descriptor ;
  long tmp___0 ;
...
{ 
  ...
  struct isi_board *card ;
  unsigned long baud ;
    klee_make_symbolic(&baud, sizeof(long), "baud");
  unsigned long base ;
  u16 channel_setup ;
  u16 channel ;
  u16 shift_count ;
  unsigned char flow_ctrl ;
    klee_make_symbolic(&flow_ctrl, sizeof(char), "flow_ctrl");
  int tmp ;
  int tmp___0 ;
...
{ 
  ...
  int reconfig_port ;
    klee_make_symbolic(&reconfig_port, sizeof(int), "reconfig_port");
  unsigned long tmp ;
  bool tmp___0 ;
  int tmp___1 ;
  unsigned long flags ;
...
{ 
  ...
  unsigned int portcount ;
    klee_make_symbolic(&portcount, sizeof(int), "portcount");
  int retval ;
...
static unsigned int card_count  ;
    klee_make_symbolic(&card_count, sizeof(int), "card_count");
static int isicom_probe(struct pci_dev *pdev , struct pci_device_id  const  *ent ) 
{ 
...
{ 
  ...
  unsigned char ldvarg9 ;
    klee_make_symbolic(&ldvarg9, sizeof(char), "ldvarg9");
