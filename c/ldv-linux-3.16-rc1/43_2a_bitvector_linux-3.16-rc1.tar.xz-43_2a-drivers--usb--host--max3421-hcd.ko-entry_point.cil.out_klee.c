...
struct max3421_hcd {
   ...
   int loaded_epnum ;
    klee_make_symbolic(&loaded_epnum, sizeof(int), "loaded_epnum");
   int urb_done ;
    klee_make_symbolic(&urb_done, sizeof(int), "urb_done");
   size_t curr_len ;
   u8 hien ;
   u8 mode ;
   u8 iopins[2U] ;
...
{ 
  ...
  struct max3421_hcd *tmp ;
  int old_epnum ;
    klee_make_symbolic(&old_epnum, sizeof(int), "old_epnum");
  int same_ep ;
    klee_make_symbolic(&same_ep, sizeof(int), "same_ep");
  int rcvtog ;
    klee_make_symbolic(&rcvtog, sizeof(int), "rcvtog");
  int sndtog ;
    klee_make_symbolic(&sndtog, sizeof(int), "sndtog");
...
{ 
  ...
  int epnum ;
  int force_toggles ;
    klee_make_symbolic(&force_toggles, sizeof(int), "force_toggles");
  struct usb_host_endpoint *ep ;
...
{ 
  ...
  struct max3421_ep *max3421_ep ;
  int switch_sndfifo ;
    klee_make_symbolic(&switch_sndfifo, sizeof(int), "switch_sndfifo");
  int tmp___1 ;
  int tmp___2 ;
  struct _ddebug descriptor ;
  long tmp___3 ;
...
{ 
  ...
  struct max3421_hcd *tmp ;
  unsigned int jk ;
    klee_make_symbolic(&jk, sizeof(int), "jk");
  unsigned int have_conn ;
    klee_make_symbolic(&have_conn, sizeof(int), "have_conn");
  u32 old_port_status ;
  u32 chg ;
  unsigned long flags ;
  u8 hrsl ;
...
{ 
  ...
  int i_worked ;
    klee_make_symbolic(&i_worked, sizeof(int), "i_worked");
  bool tmp___1 ;
  int tmp___2 ;
  long volatile   __ret ;
