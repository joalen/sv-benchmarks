...
struct xfrm_replay_state_esn {
   unsigned int bmp_len ;
    klee_make_symbolic(&bmp_len, sizeof(int), "bmp_len");
   __u32 oseq ;
   __u32 seq ;
   __u32 oseq_hi ;
   __u32 seq_hi ;
...
struct xfrm_algo {
   ...
   unsigned int alg_key_len ;
    klee_make_symbolic(&alg_key_len, sizeof(int), "alg_key_len");
   char alg_key[0U] ;
};
struct xfrm_algo_auth {
   ...
   unsigned int alg_trunc_len ;
    klee_make_symbolic(&alg_trunc_len, sizeof(int), "alg_trunc_len");
   char alg_key[0U] ;
};
struct xfrm_algo_aead {
   ...
   unsigned int alg_icv_len ;
    klee_make_symbolic(&alg_icv_len, sizeof(int), "alg_icv_len");
   char alg_key[0U] ;
};
struct xfrm_stats {
   __u32 replay_window ;
...
struct xfrm_state {
   ...
   long saved_tmo ;
    klee_make_symbolic(&saved_tmo, sizeof(long), "saved_tmo");
   unsigned long lastused ;
    klee_make_symbolic(&lastused, sizeof(long), "lastused");
...
struct xfrm_mode {
   ...
   struct module *owner ;
   unsigned int encap ;
    klee_make_symbolic(&encap, sizeof(int), "encap");
   int flags ;
};
struct xfrm_tmpl {
   struct xfrm_id id ;
   ...
   unsigned short encap_family ;
    klee_make_symbolic(&encap_family, sizeof(short), "encap_family");
   u32 reqid ;
   u8 mode ;
   u8 share ;
   u8 optional ;
...
struct pktgen_dev {
   ...
   __u32 flags ;
   int removal_mark ;
    klee_make_symbolic(&removal_mark, sizeof(int), "removal_mark");
   int min_pkt_size ;
    klee_make_symbolic(&min_pkt_size, sizeof(int), "min_pkt_size");
   int max_pkt_size ;
    klee_make_symbolic(&max_pkt_size, sizeof(int), "max_pkt_size");
   int pkt_overhead ;
    klee_make_symbolic(&pkt_overhead, sizeof(int), "pkt_overhead");
   int nfrags ;
   ...
   __u32 clone_count ;
   int last_ok ;
    klee_make_symbolic(&last_ok, sizeof(int), "last_ok");
   ktime_t next_tx ;
   ktime_t started_at ;
   ktime_t stopped_at ;
   u64 idle_acc ;
   __u32 seq_num ;
   int clone_skb ;
    klee_make_symbolic(&clone_skb, sizeof(int), "clone_skb");
   char dst_min[32U] ;
   char dst_max[32U] ;
   char src_min[32U] ;
   char src_max[32U] ;
   ...
   unsigned int nr_labels ;
    klee_make_symbolic(&nr_labels, sizeof(int), "nr_labels");
   __be32 labels[16U] ;
   __u8 vlan_p ;
   __u8 vlan_cfi ;
   __u16 vlan_id ;
   ...
   unsigned int cflows ;
    klee_make_symbolic(&cflows, sizeof(int), "cflows");
   unsigned int lflow ;
    klee_make_symbolic(&lflow, sizeof(int), "lflow");
   unsigned int nflows ;
    klee_make_symbolic(&nflows, sizeof(int), "nflows");
   unsigned int curfl ;
    klee_make_symbolic(&curfl, sizeof(int), "curfl");
   u16 queue_map_min ;
   u16 queue_map_max ;
   __u32 skb_priority ;
   int node ;
...
typedef unsigned long pao_T_____41;
    klee_make_symbolic(&pao_T_____41, sizeof(long), "pao_T_____41");
typedef unsigned long pao_T_____42;
    klee_make_symbolic(&pao_T_____42, sizeof(long), "pao_T_____42");
typedef unsigned long pao_T_____43;
    klee_make_symbolic(&pao_T_____43, sizeof(long), "pao_T_____43");
typedef unsigned long pao_T_____44;
    klee_make_symbolic(&pao_T_____44, sizeof(long), "pao_T_____44");
typedef unsigned long pao_T_____45;
    klee_make_symbolic(&pao_T_____45, sizeof(long), "pao_T_____45");
typedef unsigned long pao_T_____46;
    klee_make_symbolic(&pao_T_____46, sizeof(long), "pao_T_____46");
typedef unsigned long pao_T_____47;
    klee_make_symbolic(&pao_T_____47, sizeof(long), "pao_T_____47");
typedef unsigned long pao_T_____48;
    klee_make_symbolic(&pao_T_____48, sizeof(long), "pao_T_____48");
...
static int pg_net_id  ;
    klee_make_symbolic(&pg_net_id, sizeof(int), "pg_net_id");
...
static int pg_delay_d  ;
    klee_make_symbolic(&pg_delay_d, sizeof(int), "pg_delay_d");
static int pg_clone_skb_d  ;
    klee_make_symbolic(&pg_clone_skb_d, sizeof(int), "pg_clone_skb_d");
static int debug  ;
...
{ 
  ...
  unsigned long __lengthoftb ;
    klee_make_symbolic(&__lengthoftb, sizeof(long), "__lengthoftb");
  void *tmp___1 ;
  ...
  unsigned long tmp___72 ;
    klee_make_symbolic(&tmp___72, sizeof(long), "tmp___72");
  int tmp___73 ;
  ...
  long tmp___79 ;
    klee_make_symbolic(&tmp___79, sizeof(long), "tmp___79");
  int tmp___80 ;
    klee_make_symbolic(&tmp___80, sizeof(int), "tmp___80");
  unsigned long tmp___81 ;
    klee_make_symbolic(&tmp___81, sizeof(long), "tmp___81");
  ...
  unsigned long tmp___84 ;
    klee_make_symbolic(&tmp___84, sizeof(long), "tmp___84");
  struct _ddebug descriptor___3 ;
  long tmp___85 ;
    klee_make_symbolic(&tmp___85, sizeof(long), "tmp___85");
  int tmp___86 ;
    klee_make_symbolic(&tmp___86, sizeof(int), "tmp___86");
  unsigned long tmp___87 ;
    klee_make_symbolic(&tmp___87, sizeof(long), "tmp___87");
  struct _ddebug descriptor___4 ;
  long tmp___88 ;
    klee_make_symbolic(&tmp___88, sizeof(long), "tmp___88");
  int tmp___89 ;
  ...
  unsigned long tmp___104 ;
    klee_make_symbolic(&tmp___104, sizeof(long), "tmp___104");
  int tmp___105 ;
  ...
  long tmp___108 ;
    klee_make_symbolic(&tmp___108, sizeof(long), "tmp___108");
  int tmp___109 ;
    klee_make_symbolic(&tmp___109, sizeof(int), "tmp___109");
  long tmp___110 ;
    klee_make_symbolic(&tmp___110, sizeof(long), "tmp___110");
  int tmp___111 ;
    klee_make_symbolic(&tmp___111, sizeof(int), "tmp___111");
  long tmp___112 ;
    klee_make_symbolic(&tmp___112, sizeof(long), "tmp___112");
  int tmp___113 ;
    klee_make_symbolic(&tmp___113, sizeof(int), "tmp___113");
  long tmp___114 ;
    klee_make_symbolic(&tmp___114, sizeof(long), "tmp___114");
  int tmp___115 ;
    klee_make_symbolic(&tmp___115, sizeof(int), "tmp___115");
  long tmp___116 ;
    klee_make_symbolic(&tmp___116, sizeof(long), "tmp___116");
  int tmp___117 ;
  ...
  long tmp___122 ;
    klee_make_symbolic(&tmp___122, sizeof(long), "tmp___122");
  int tmp___123 ;
    klee_make_symbolic(&tmp___123, sizeof(int), "tmp___123");
  long tmp___124 ;
    klee_make_symbolic(&tmp___124, sizeof(long), "tmp___124");
  struct _ddebug descriptor___9 ;
  long tmp___125 ;
    klee_make_symbolic(&tmp___125, sizeof(long), "tmp___125");
  struct _ddebug descriptor___10 ;
  long tmp___126 ;
    klee_make_symbolic(&tmp___126, sizeof(long), "tmp___126");
  struct _ddebug descriptor___11 ;
  long tmp___127 ;
    klee_make_symbolic(&tmp___127, sizeof(long), "tmp___127");
  int tmp___128 ;
    klee_make_symbolic(&tmp___128, sizeof(int), "tmp___128");
  long tmp___129 ;
    klee_make_symbolic(&tmp___129, sizeof(long), "tmp___129");
  int tmp___130 ;
    klee_make_symbolic(&tmp___130, sizeof(int), "tmp___130");
  long tmp___131 ;
    klee_make_symbolic(&tmp___131, sizeof(long), "tmp___131");
  int tmp___132 ;
    klee_make_symbolic(&tmp___132, sizeof(int), "tmp___132");
  long tmp___133 ;
    klee_make_symbolic(&tmp___133, sizeof(long), "tmp___133");
  struct _ddebug descriptor___12 ;
  long tmp___134 ;
    klee_make_symbolic(&tmp___134, sizeof(long), "tmp___134");
  struct _ddebug descriptor___13 ;
  long tmp___135 ;
    klee_make_symbolic(&tmp___135, sizeof(long), "tmp___135");
  struct _ddebug descriptor___14 ;
  long tmp___136 ;
    klee_make_symbolic(&tmp___136, sizeof(long), "tmp___136");
  int tmp___137 ;
    klee_make_symbolic(&tmp___137, sizeof(int), "tmp___137");
  long tmp___138 ;
    klee_make_symbolic(&tmp___138, sizeof(long), "tmp___138");
  int tmp___139 ;
    klee_make_symbolic(&tmp___139, sizeof(int), "tmp___139");
  long tmp___140 ;
    klee_make_symbolic(&tmp___140, sizeof(long), "tmp___140");
  int tmp___141 ;
  ...
  long tmp___144 ;
    klee_make_symbolic(&tmp___144, sizeof(long), "tmp___144");
  int tmp___145 ;
...
{ 
  ...
  int msec_per_try ;
    klee_make_symbolic(&msec_per_try, sizeof(int), "msec_per_try");
  int i ;
  struct _ddebug descriptor ;
  long tmp ;
  struct _ddebug descriptor___0 ;
...
{ 
  int ntxq ;
    klee_make_symbolic(&ntxq, sizeof(int), "ntxq");
  bool tmp ;
  int i ;
  int set ;
...
{ 
  struct xfrm_state *x ;
  int nhead ;
    klee_make_symbolic(&nhead, sizeof(int), "nhead");
  int ret ;
  __u8 *eth ;
  struct iphdr *iph ;
  unsigned int tmp ;
...
{ 
  ...
  int len ;
  int frag_len ;
    klee_make_symbolic(&frag_len, sizeof(int), "frag_len");
  unsigned char *tmp___1 ;
  int node ;
  int tmp___2 ;
  long tmp___3 ;
...
{ 
  ...
  int datalen ;
  int iplen ;
    klee_make_symbolic(&iplen, sizeof(int), "iplen");
  struct iphdr *iph ;
  __be16 protocol ;
  __be32 *mpls ;
  __be16 *vlan_tci ;
...
{ 
  ...
  int datalen ;
  int udplen ;
    klee_make_symbolic(&udplen, sizeof(int), "udplen");
  struct ipv6hdr *iph ;
  __be16 protocol ;
  __be32 *mpls ;
  __be16 *vlan_tci ;
...
{ 
  struct pktgen_dev *pkt_dev ;
  int started ;
    klee_make_symbolic(&started, sizeof(int), "started");
  struct _ddebug descriptor ;
  long tmp ;
  struct list_head  const  *__mptr ;
  ktime_t tmp___0 ;
