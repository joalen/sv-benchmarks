...
struct fwentry {
   ...
   int extfw_size ;
    klee_make_symbolic(&extfw_size, sizeof(int), "extfw_size");
   int intfw_size ;
    klee_make_symbolic(&intfw_size, sizeof(int), "intfw_size");
   u8 *extfw ;
   u8 *intfw ;
   enum board_type board_type ;
   struct mib_fw_version fw_version ;
   int loaded ;
    klee_make_symbolic(&loaded, sizeof(int), "loaded");
};
struct at76_priv {
   ...
   int wep_enabled ;
    klee_make_symbolic(&wep_enabled, sizeof(int), "wep_enabled");
   int wep_key_id ;
    klee_make_symbolic(&wep_key_id, sizeof(int), "wep_key_id");
   u8 wep_keys[4U][13U] ;
   u8 wep_keys_len[4U] ;
   int channel ;
   ...
   u8 essid[32U] ;
   int essid_size ;
    klee_make_symbolic(&essid_size, sizeof(int), "essid_size");
   int radio_on ;
    klee_make_symbolic(&radio_on, sizeof(int), "radio_on");
   int promisc ;
    klee_make_symbolic(&promisc, sizeof(int), "promisc");
   int preamble_type ;
    klee_make_symbolic(&preamble_type, sizeof(int), "preamble_type");
   int auth_mode ;
    klee_make_symbolic(&auth_mode, sizeof(int), "auth_mode");
   int txrate ;
    klee_make_symbolic(&txrate, sizeof(int), "txrate");
   int frag_threshold ;
    klee_make_symbolic(&frag_threshold, sizeof(int), "frag_threshold");
   int rts_threshold ;
   ...
   int scan_min_time ;
    klee_make_symbolic(&scan_min_time, sizeof(int), "scan_min_time");
   int scan_max_time ;
    klee_make_symbolic(&scan_max_time, sizeof(int), "scan_max_time");
   int scan_mode ;
    klee_make_symbolic(&scan_mode, sizeof(int), "scan_mode");
   int scan_need_any ;
    klee_make_symbolic(&scan_need_any, sizeof(int), "scan_need_any");
   bool scanning ;
   u16 assoc_id ;
   u8 pm_mode ;
   u32 pm_period ;
   ...
   int mac80211_registered ;
    klee_make_symbolic(&mac80211_registered, sizeof(int), "mac80211_registered");
};
struct dfu_status {
   ...
   unsigned char string ;
    klee_make_symbolic(&string, sizeof(char), "string");
};
...
{ 
  int ret ;
  int need_dfu_state ;
    klee_make_symbolic(&need_dfu_state, sizeof(int), "need_dfu_state");
  int is_done ;
  ...
  int blockno ;
    klee_make_symbolic(&blockno, sizeof(int), "blockno");
...
static int tx_activity  ;
    klee_make_symbolic(&tx_activity, sizeof(int), "tx_activity");
...
{ 
  int tx_lastactivity ;
    klee_make_symbolic(&tx_lastactivity, sizeof(int), "tx_lastactivity");
...
{ 
  int ret ;
  int op_mode ;
    klee_make_symbolic(&op_mode, sizeof(int), "op_mode");
  int blockno ;
  int bsize ;
  u8 *block ;
  u8 *buf ;
...
{ 
  int ret ;
  int need_remap ;
    klee_make_symbolic(&need_remap, sizeof(int), "need_remap");
  int tmp ;
...
{ 
  ...
  int submit_len ;
    klee_make_symbolic(&submit_len, sizeof(int), "submit_len");
  int ret ;
  size_t __len ;
  void *__ret ;
  bool tmp___0 ;
...
{ 
  ...
  int op_mode ;
  int need_ext_fw ;
    klee_make_symbolic(&need_ext_fw, sizeof(int), "need_ext_fw");
