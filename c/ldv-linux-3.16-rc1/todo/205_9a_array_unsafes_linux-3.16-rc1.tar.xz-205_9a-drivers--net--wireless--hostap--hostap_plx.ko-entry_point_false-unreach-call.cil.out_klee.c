...
struct hostap_cmd_queue {
   ...
   atomic_t usecnt ;
   int del_req ;
    klee_make_symbolic(&del_req, sizeof(int), "del_req");
};
struct local_info;
...
struct hostap_plx_priv {
   ...
   unsigned int cor_offset ;
    klee_make_symbolic(&cor_offset, sizeof(int), "cor_offset");
};
...
struct set_tim_data {
   struct list_head list ;
   int aid ;
    klee_make_symbolic(&aid, sizeof(int), "aid");
   int set ;
...
static int ignore_cis  ;
    klee_make_symbolic(&ignore_cis, sizeof(int), "ignore_cis");
...
{ 
  ...
  int issue ;
    klee_make_symbolic(&issue, sizeof(int), "issue");
  int issued ;
    klee_make_symbolic(&issued, sizeof(int), "issued");
  unsigned long flags ;
  struct hostap_cmd_queue *entry ;
  wait_queue_t wait ;
...
{ 
  ...
  local_info_t *local ;
  int was_resetting ;
    klee_make_symbolic(&was_resetting, sizeof(int), "was_resetting");
  void *tmp ;
  int tmp___0 ;
  int tmp___1 ;
  bool tmp___2 ;
...
{ 
  ...
  int res ;
  int rx_pending ;
    klee_make_symbolic(&rx_pending, sizeof(int), "rx_pending");
  u16 len ;
  u16 hdr_len ;
  u16 rxfid ;
  u16 status ;
...
{ 
  ...
  int rx_hdrlen ;
    klee_make_symbolic(&rx_hdrlen, sizeof(int), "rx_hdrlen");
  unsigned char *tmp ;
...
{ 
  ...
  u16 fc ;
  int show_dump ;
    klee_make_symbolic(&show_dump, sizeof(int), "show_dump");
  int res ;
  char *payload ;
  struct hfa384x_tx_frame txdesc ;
...
{ 
  unsigned long last_inquire ;
    klee_make_symbolic(&last_inquire, sizeof(long), "last_inquire");
...
{ 
  ...
  u16 inten ;
  int prev_stuck ;
    klee_make_symbolic(&prev_stuck, sizeof(int), "prev_stuck");
  void *tmp ;
...
{ 
  unsigned long last_magic_err ;
    klee_make_symbolic(&last_magic_err, sizeof(long), "last_magic_err");
  struct net_device *dev ;
  unsigned short tmp ;
  unsigned short tmp___0 ;
  int tmp___1 ;
...
{ 
  ...
  int id ;
  int variant ;
    klee_make_symbolic(&variant, sizeof(int), "variant");
  int major ;
...
{ 
  struct net_device *dev ;
  int ram16 ;
    klee_make_symbolic(&ram16, sizeof(int), "ram16");
  int i ;
  int ret ;
  int tmp ;
  int tmp___0 ;
...
{ 
  ...
  int tmp___0 ;
  int rest_len ;
    klee_make_symbolic(&rest_len, sizeof(int), "rest_len");
  int data_off ;
    klee_make_symbolic(&data_off, sizeof(int), "data_off");
  int block_len ;
  int tmp___1 ;
  int tmp___2 ;
  unsigned long __ms ;
...
{ 
  unsigned char corsave ;
    klee_make_symbolic(&corsave, sizeof(char), "corsave");
...
{ 
  ...
  int pos ;
  unsigned int rmsz ;
    klee_make_symbolic(&rmsz, sizeof(int), "rmsz");
  unsigned int rasz ;
    klee_make_symbolic(&rasz, sizeof(int), "rasz");
  unsigned int manfid1 ;
    klee_make_symbolic(&manfid1, sizeof(int), "manfid1");
  unsigned int manfid2 ;
    klee_make_symbolic(&manfid2, sizeof(int), "manfid2");
...
{ 
  unsigned int pccard_ioaddr ;
    klee_make_symbolic(&pccard_ioaddr, sizeof(int), "pccard_ioaddr");
  unsigned int plx_ioaddr ;
    klee_make_symbolic(&plx_ioaddr, sizeof(int), "plx_ioaddr");
  unsigned long pccard_attr_mem ;
    klee_make_symbolic(&pccard_attr_mem, sizeof(long), "pccard_attr_mem");
  unsigned int pccard_attr_len ;
    klee_make_symbolic(&pccard_attr_len, sizeof(int), "pccard_attr_len");
  void *attr_mem ;
  unsigned int cor_offset ;
  unsigned int cor_index ;
    klee_make_symbolic(&cor_index, sizeof(int), "cor_index");
  u32 reg ;
  local_info_t *local ;
  struct net_device *dev ;
  struct hostap_interface *iface ;
  ...
  int irq_registered ;
    klee_make_symbolic(&irq_registered, sizeof(int), "irq_registered");
  int tmd7160 ;
    klee_make_symbolic(&tmd7160, sizeof(int), "tmd7160");
  struct hostap_plx_priv *hw_priv ;
  void *tmp ;
  int tmp___0 ;
  unsigned long __ms ;
...
{ 
  int i ;
  int deleted_index ;
    klee_make_symbolic(&deleted_index, sizeof(int), "deleted_index");
