...
struct phy_init_data {
   unsigned int num_consumers ;
    klee_make_symbolic(&num_consumers, sizeof(int), "num_consumers");
...
struct dwc3_event_buffer {
   ...
   unsigned int length ;
   unsigned int lpos ;
    klee_make_symbolic(&lpos, sizeof(int), "lpos");
   unsigned int count ;
   unsigned int flags ;
   dma_addr_t dma ;
   struct dwc3 *dwc ;
...
struct dwc3_ep {
   ...
   unsigned int current_trb ;
    klee_make_symbolic(&current_trb, sizeof(int), "current_trb");
   u8 number ;
   u8 type ;
   u8 resource_index ;
   u32 interval ;
...
struct dwc3_event_depevt {
   ...
   unsigned short parameters ;
    klee_make_symbolic(&parameters, sizeof(short), "parameters");
};
...
{ 
  int last_fifo_depth ;
    klee_make_symbolic(&last_fifo_depth, sizeof(int), "last_fifo_depth");
  int ram1_depth ;
    klee_make_symbolic(&ram1_depth, sizeof(int), "ram1_depth");
  int fifo_size ;
    klee_make_symbolic(&fifo_size, sizeof(int), "fifo_size");
  int mdwidth ;
    klee_make_symbolic(&mdwidth, sizeof(int), "mdwidth");
  int num ;
  struct dwc3_ep *dep ;
  int mult ;
...
{ 
  ...
  unsigned int last_one ;
    klee_make_symbolic(&last_one, sizeof(int), "last_one");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
  struct list_head  const  *__mptr ;
...
{ 
  ...
  unsigned int pwropt ;
    klee_make_symbolic(&pwropt, sizeof(int), "pwropt");
  struct _ddebug descriptor ;
  long tmp ;
  u32 u1u2 ;
  u32 reg ;
...
{ 
  unsigned int is_ss ;
    klee_make_symbolic(&is_ss, sizeof(int), "is_ss");
...
{ 
  ...
  unsigned int direction___0 ;
    klee_make_symbolic(&direction___0, sizeof(int), "direction___0");
  struct _ddebug descriptor ;
  long tmp___2 ;
  unsigned int direction___1 ;
    klee_make_symbolic(&direction___1, sizeof(int), "direction___1");
