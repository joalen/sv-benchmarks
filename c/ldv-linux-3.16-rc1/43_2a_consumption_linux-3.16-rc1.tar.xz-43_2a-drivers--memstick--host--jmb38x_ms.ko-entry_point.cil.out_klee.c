...
struct jmb38x_ms_host {
   ...
   unsigned char cmd_flags ;
    klee_make_symbolic(&cmd_flags, sizeof(char), "cmd_flags");
   unsigned char io_pos ;
    klee_make_symbolic(&io_pos, sizeof(char), "io_pos");
   unsigned char ifmode ;
    klee_make_symbolic(&ifmode, sizeof(char), "ifmode");
   unsigned int io_word[2U] ;
};
struct jmb38x_ms {
   struct pci_dev *pdev ;
   int host_cnt ;
    klee_make_symbolic(&host_cnt, sizeof(int), "host_cnt");
...
{ 
  ...
  unsigned int off ;
  unsigned int t_size ;
    klee_make_symbolic(&t_size, sizeof(int), "t_size");
  unsigned int p_cnt ;
    klee_make_symbolic(&p_cnt, sizeof(int), "p_cnt");
  unsigned char *buf ;
  struct page *pg ;
  unsigned long flags ;
  unsigned int p_off ;
    klee_make_symbolic(&p_off, sizeof(int), "p_off");
  struct page *tmp ;
  unsigned int _min1 ;
...
{ 
  ...
  unsigned int t_val ;
    klee_make_symbolic(&t_val, sizeof(int), "t_val");
...
{ 
  ...
  unsigned int host_ctl ;
    klee_make_symbolic(&host_ctl, sizeof(int), "host_ctl");
  unsigned int tmp___0 ;
  unsigned int clock_ctl ;
    klee_make_symbolic(&clock_ctl, sizeof(int), "clock_ctl");
  unsigned int clock_delay ;
    klee_make_symbolic(&clock_delay, sizeof(int), "clock_delay");
  int rc ;
  struct _ddebug descriptor ;
  long tmp___1 ;
  struct _ddebug descriptor___0 ;
...
{ 
  struct jmb38x_ms *jm ;
  int pci_dev_busy ;
    klee_make_symbolic(&pci_dev_busy, sizeof(int), "pci_dev_busy");
  int rc ;
  int cnt ;
  void *tmp ;
