...
typedef unsigned long xen_ulong_t;
    klee_make_symbolic(&xen_ulong_t, sizeof(long), "xen_ulong_t");
typedef long xen_long_t;
    klee_make_symbolic(&xen_long_t, sizeof(long), "xen_long_t");
...
static unsigned int xennet_max_queues  ;
    klee_make_symbolic(&xennet_max_queues, sizeof(int), "xennet_max_queues");
...
{ 
  ...
  unsigned int max_queues ;
    klee_make_symbolic(&max_queues, sizeof(int), "max_queues");
  struct netfront_queue *queue ;
  unsigned int num_queues ;
  struct xenbus_transaction __constr_expr_0 ;
  unsigned int _min1 ;
