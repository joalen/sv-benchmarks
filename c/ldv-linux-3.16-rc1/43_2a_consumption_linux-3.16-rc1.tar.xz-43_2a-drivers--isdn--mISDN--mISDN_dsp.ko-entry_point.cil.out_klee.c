...
struct dsp_features {
   int hfc_id ;
    klee_make_symbolic(&hfc_id, sizeof(int), "hfc_id");
   int hfc_dtmf ;
    klee_make_symbolic(&hfc_dtmf, sizeof(int), "hfc_dtmf");
   int hfc_conf ;
    klee_make_symbolic(&hfc_conf, sizeof(int), "hfc_conf");
   int hfc_loops ;
    klee_make_symbolic(&hfc_loops, sizeof(int), "hfc_loops");
   int hfc_echocanhw ;
    klee_make_symbolic(&hfc_echocanhw, sizeof(int), "hfc_echocanhw");
   int pcm_id ;
    klee_make_symbolic(&pcm_id, sizeof(int), "pcm_id");
   int pcm_slots ;
    klee_make_symbolic(&pcm_slots, sizeof(int), "pcm_slots");
   int pcm_banks ;
    klee_make_symbolic(&pcm_banks, sizeof(int), "pcm_banks");
   int unclocked ;
    klee_make_symbolic(&unclocked, sizeof(int), "unclocked");
   int unordered ;
    klee_make_symbolic(&unordered, sizeof(int), "unordered");
};
struct dsp;
...
struct dsp_conf {
   ...
   int software ;
    klee_make_symbolic(&software, sizeof(int), "software");
   int hardware ;
    klee_make_symbolic(&hardware, sizeof(int), "hardware");
};
struct dsp_dtmf {
   int enable ;
    klee_make_symbolic(&enable, sizeof(int), "enable");
   int treshold ;
    klee_make_symbolic(&treshold, sizeof(int), "treshold");
   int software ;
   int hardware ;
   int size ;
   short buffer[102U] ;
...
struct dsp {
   ...
   int b_active ;
    klee_make_symbolic(&b_active, sizeof(int), "b_active");
   struct dsp_echo echo ;
   int rx_disabled ;
    klee_make_symbolic(&rx_disabled, sizeof(int), "rx_disabled");
   int rx_is_off ;
    klee_make_symbolic(&rx_is_off, sizeof(int), "rx_is_off");
   int tx_mix ;
    klee_make_symbolic(&tx_mix, sizeof(int), "tx_mix");
   struct dsp_tone tone ;
   struct dsp_dtmf dtmf ;
   int tx_volume ;
    klee_make_symbolic(&tx_volume, sizeof(int), "tx_volume");
   int rx_volume ;
    klee_make_symbolic(&rx_volume, sizeof(int), "rx_volume");
   struct work_struct workq ;
   struct sk_buff_head sendq ;
   int hdlc ;
    klee_make_symbolic(&hdlc, sizeof(int), "hdlc");
   int data_pending ;
    klee_make_symbolic(&data_pending, sizeof(int), "data_pending");
   u32 conf_id ;
   struct dsp_conf *conf ;
   struct dsp_conf_member *member ;
   int rx_W ;
    klee_make_symbolic(&rx_W, sizeof(int), "rx_W");
   int rx_R ;
    klee_make_symbolic(&rx_R, sizeof(int), "rx_R");
   int rx_init ;
    klee_make_symbolic(&rx_init, sizeof(int), "rx_init");
   int tx_W ;
    klee_make_symbolic(&tx_W, sizeof(int), "tx_W");
   int tx_R ;
    klee_make_symbolic(&tx_R, sizeof(int), "tx_R");
   int rx_delay[5U] ;
   int tx_delay[5U] ;
   u8 tx_buff[32768U] ;
   u8 rx_buff[32768U] ;
   int last_tx ;
    klee_make_symbolic(&last_tx, sizeof(int), "last_tx");
   int cmx_delay ;
    klee_make_symbolic(&cmx_delay, sizeof(int), "cmx_delay");
   int tx_dejitter ;
    klee_make_symbolic(&tx_dejitter, sizeof(int), "tx_dejitter");
   int tx_data ;
    klee_make_symbolic(&tx_data, sizeof(int), "tx_data");
   struct dsp_features features ;
   int features_rx_off ;
    klee_make_symbolic(&features_rx_off, sizeof(int), "features_rx_off");
   int features_fill_empty ;
    klee_make_symbolic(&features_fill_empty, sizeof(int), "features_fill_empty");
   int pcm_slot_rx ;
    klee_make_symbolic(&pcm_slot_rx, sizeof(int), "pcm_slot_rx");
   int pcm_bank_rx ;
    klee_make_symbolic(&pcm_bank_rx, sizeof(int), "pcm_bank_rx");
   int pcm_slot_tx ;
    klee_make_symbolic(&pcm_slot_tx, sizeof(int), "pcm_slot_tx");
   int pcm_bank_tx ;
    klee_make_symbolic(&pcm_bank_tx, sizeof(int), "pcm_bank_tx");
   int hfc_conf ;
   int bf_enable ;
    klee_make_symbolic(&bf_enable, sizeof(int), "bf_enable");
   u32 bf_p[18U] ;
   u32 bf_s[1024U] ;
   int bf_crypt_pos ;
    klee_make_symbolic(&bf_crypt_pos, sizeof(int), "bf_crypt_pos");
   u8 bf_data_in[9U] ;
   u8 bf_crypt_out[9U] ;
   int bf_decrypt_in_pos ;
    klee_make_symbolic(&bf_decrypt_in_pos, sizeof(int), "bf_decrypt_in_pos");
   int bf_decrypt_out_pos ;
    klee_make_symbolic(&bf_decrypt_out_pos, sizeof(int), "bf_decrypt_out_pos");
   u8 bf_crypt_inring[16U] ;
   u8 bf_data_out[9U] ;
   int bf_sync ;
    klee_make_symbolic(&bf_sync, sizeof(int), "bf_sync");
...
struct mISDN_dsp_element {
   ...
   int num_args ;
    klee_make_symbolic(&num_args, sizeof(int), "num_args");
...
int dsp_options  ;
    klee_make_symbolic(&dsp_options, sizeof(int), "dsp_options");
int dsp_debug  ;
    klee_make_symbolic(&dsp_debug, sizeof(int), "dsp_debug");
int dsp_poll  ;
    klee_make_symbolic(&dsp_poll, sizeof(int), "dsp_poll");
int dsp_tics  ;
    klee_make_symbolic(&dsp_tics, sizeof(int), "dsp_tics");
spinlock_t dsp_lock  ;
...
unsigned long dsp_spl_jiffies ;
    klee_make_symbolic(&dsp_spl_jiffies, sizeof(long), "dsp_spl_jiffies");
...
{ 
  ...
  int rx_off ;
    klee_make_symbolic(&rx_off, sizeof(int), "rx_off");
  int tmp ;
...
{ 
  ...
  int cont ;
    klee_make_symbolic(&cont, sizeof(int), "cont");
  u8 *data ;
  int len ;
  int tmp ;
...
{ 
  int err ;
  int tics ;
    klee_make_symbolic(&tics, sizeof(int), "tics");
  struct lock_class_key __key ;
...
{ 
  ...
  struct dsp *finddsp ;
  int memb ;
    klee_make_symbolic(&memb, sizeof(int), "memb");
  int i ;
  ...
  int same_hfc ;
    klee_make_symbolic(&same_hfc, sizeof(int), "same_hfc");
  int same_pcm ;
    klee_make_symbolic(&same_pcm, sizeof(int), "same_pcm");
  int current_conf ;
    klee_make_symbolic(&current_conf, sizeof(int), "current_conf");
  int all_conf ;
    klee_make_symbolic(&all_conf, sizeof(int), "all_conf");
  int tx_data ;
  struct list_head  const  *__mptr ;
  struct list_head  const  *__mptr___0 ;
  int tmp ;
...
{ 
  ...
  int o_r ;
    klee_make_symbolic(&o_r, sizeof(int), "o_r");
  int o_rr ;
    klee_make_symbolic(&o_rr, sizeof(int), "o_rr");
  int preload ;
    klee_make_symbolic(&preload, sizeof(int), "preload");
  struct mISDNhead *hh ;
  struct mISDNhead *thh ;
  int tx_data_only ;
    klee_make_symbolic(&tx_data_only, sizeof(int), "tx_data_only");
  unsigned char *tmp ;
  u8 *tmp___0 ;
  u8 *tmp___1 ;
  u8 *tmp___2 ;
...
static int dsp_count_valid  ;
    klee_make_symbolic(&dsp_count_valid, sizeof(int), "dsp_count_valid");
void dsp_cmx_send(void *arg ) 
{ 
  struct dsp_conf *conf ;
  struct dsp_conf_member *member ;
  struct dsp *dsp ;
  int mustmix ;
    klee_make_symbolic(&mustmix, sizeof(int), "mustmix");
  int members ;
  ...
  int rr ;
  int jittercheck ;
    klee_make_symbolic(&jittercheck, sizeof(int), "jittercheck");
  int delay ;
...
{ 
  u_int w ;
  u_int ww ;
    klee_make_symbolic(&ww, sizeof(int), "ww");
  u8 *d ;
  u8 *p ;
  int space ;
...
{ 
  ...
  s32 treshl ;
  int lowgroup ;
    klee_make_symbolic(&lowgroup, sizeof(int), "lowgroup");
  int highgroup ;
    klee_make_symbolic(&highgroup, sizeof(int), "highgroup");
  s64 cos2pik_ ;
  int tmp ;
  u8 *tmp___0 ;
  s32 *tmp___1 ;
...
{ 
  ...
  int pcm_val ;
    klee_make_symbolic(&pcm_val, sizeof(int), "pcm_val");
  int seg_end[8U] ;
...
{ 
  short mu ;
    klee_make_symbolic(&mu, sizeof(short), "mu");
  short e ;
    klee_make_symbolic(&e, sizeof(short), "e");
  short f ;
    klee_make_symbolic(&f, sizeof(short), "f");
  short y ;
...
{ 
  int deftaps ;
    klee_make_symbolic(&deftaps, sizeof(int), "deftaps");
  int len ;
  struct mISDN_ctrl_req cq ;
  size_t tmp ;
  char *_dup ;
  unsigned long __lengthof_dup ;
    klee_make_symbolic(&__lengthof_dup, sizeof(long), "__lengthof_dup");
  void *tmp___0 ;
  char *dup ;
  char *tok ;
  char *name ;
