...
struct tc_ratespec {
   ...
   unsigned short overhead ;
    klee_make_symbolic(&overhead, sizeof(short), "overhead");
   short cell_align ;
    klee_make_symbolic(&cell_align, sizeof(short), "cell_align");
   unsigned short mpu ;
    klee_make_symbolic(&mpu, sizeof(short), "mpu");
   __u32 rate ;
};
struct tc_sizespec {
   unsigned char cell_log ;
...
struct tc_cbq_lssopt {
   unsigned char change ;
    klee_make_symbolic(&change, sizeof(char), "change");
   unsigned char flags ;
   unsigned char ewma_log ;
    klee_make_symbolic(&ewma_log, sizeof(char), "ewma_log");
   unsigned char level ;
   __u32 maxidle ;
   __u32 minidle ;
   __u32 offtime ;
...
struct tc_cbq_wrropt {
   ...
   unsigned char cpriority ;
    klee_make_symbolic(&cpriority, sizeof(char), "cpriority");
   unsigned char __reserved ;
    klee_make_symbolic(&__reserved, sizeof(char), "__reserved");
   __u32 allot ;
   __u32 weight ;
};
struct tc_cbq_ovl {
   unsigned char strategy ;
    klee_make_symbolic(&strategy, sizeof(char), "strategy");
   unsigned char priority2 ;
    klee_make_symbolic(&priority2, sizeof(char), "priority2");
   __u16 pad ;
   __u32 penalty ;
};
struct tc_cbq_police {
   unsigned char police ;
    klee_make_symbolic(&police, sizeof(char), "police");
   unsigned char __res1 ;
    klee_make_symbolic(&__res1, sizeof(char), "__res1");
   unsigned short __res2 ;
    klee_make_symbolic(&__res2, sizeof(short), "__res2");
};
struct tc_cbq_fopt {
   __u32 split ;
   __u32 defmap ;
...
struct Qdisc_class_hash {
   ...
   unsigned int hashsize ;
    klee_make_symbolic(&hashsize, sizeof(int), "hashsize");
   unsigned int hashmask ;
    klee_make_symbolic(&hashmask, sizeof(int), "hashmask");
   unsigned int hashelems ;
    klee_make_symbolic(&hashelems, sizeof(int), "hashelems");
};
struct qdisc_walker {
   int stop ;
...
typedef long psched_tdiff_t;
    klee_make_symbolic(&psched_tdiff_t, sizeof(long), "psched_tdiff_t");
...
struct cbq_class {
   ...
   unsigned char ovl_strategy ;
    klee_make_symbolic(&ovl_strategy, sizeof(char), "ovl_strategy");
   unsigned char police ;
   u32 defmap ;
   long maxidle ;
    klee_make_symbolic(&maxidle, sizeof(long), "maxidle");
   long offtime ;
    klee_make_symbolic(&offtime, sizeof(long), "offtime");
   long minidle ;
    klee_make_symbolic(&minidle, sizeof(long), "minidle");
   u32 avpkt ;
   struct qdisc_rate_table *R_tab ;
   void (*overlimit)(struct cbq_class * ) ;
   psched_tdiff_t penalty ;
   long allot ;
    klee_make_symbolic(&allot, sizeof(long), "allot");
   long quantum ;
    klee_make_symbolic(&quantum, sizeof(long), "quantum");
   long weight ;
   struct Qdisc *qdisc ;
   ...
   unsigned char delayed ;
    klee_make_symbolic(&delayed, sizeof(char), "delayed");
   unsigned char level ;
   psched_time_t last ;
   psched_time_t undertime ;
   long avgidle ;
    klee_make_symbolic(&avgidle, sizeof(long), "avgidle");
   long deficit ;
    klee_make_symbolic(&deficit, sizeof(long), "deficit");
   ...
   int refcnt ;
   int filters ;
    klee_make_symbolic(&filters, sizeof(int), "filters");
...
struct cbq_sched_data {
   ...
   unsigned int activemask ;
    klee_make_symbolic(&activemask, sizeof(int), "activemask");
   ...
   int toplevel ;
    klee_make_symbolic(&toplevel, sizeof(int), "toplevel");
   u32 hgenerator ;
};
