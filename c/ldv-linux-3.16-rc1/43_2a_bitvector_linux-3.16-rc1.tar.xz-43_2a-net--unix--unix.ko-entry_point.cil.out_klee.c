...
struct unix_sock {
   ...
   unsigned char recursion_level ;
    klee_make_symbolic(&recursion_level, sizeof(char), "recursion_level");
   unsigned long gc_flags ;
    klee_make_symbolic(&gc_flags, sizeof(long), "gc_flags");
...
unsigned int unix_tot_inflight ;
    klee_make_symbolic(&unix_tot_inflight, sizeof(int), "unix_tot_inflight");
...
{ 
  ...
  unsigned char max_level ;
    klee_make_symbolic(&max_level, sizeof(char), "max_level");
  int unix_sock_count ;
    klee_make_symbolic(&unix_sock_count, sizeof(int), "unix_sock_count");
  struct sock *sk ;
  struct sock *tmp ;
  unsigned char _max1 ;
    klee_make_symbolic(&_max1, sizeof(char), "_max1");
  unsigned char _max2 ;
    klee_make_symbolic(&_max2, sizeof(char), "_max2");
  long tmp___0 ;
...
{ 
  ...
  int err ;
  int peeked ;
    klee_make_symbolic(&peeked, sizeof(int), "peeked");
  int skip ;
  long tmp___0 ;
  bool tmp___1 ;
...
{ 
  ...
  int noblock ;
  int check_creds ;
    klee_make_symbolic(&check_creds, sizeof(int), "check_creds");
  int target ;
...
{ 
  ...
  struct sock *other ;
  int peer_mode ;
    klee_make_symbolic(&peer_mode, sizeof(int), "peer_mode");
...
{ 
  ...
  unsigned long bucket ;
    klee_make_symbolic(&bucket, sizeof(long), "bucket");
  struct sock *sk ;
  unsigned long count ;
  struct net *tmp ;
  struct net *tmp___0 ;
...
{ 
  ...
  unsigned long ldvarg79 ;
    klee_make_symbolic(&ldvarg79, sizeof(long), "ldvarg79");
...
{ 
  ...
  bool hit ;
  int nfd ;
    klee_make_symbolic(&nfd, sizeof(int), "nfd");
  struct file **fp ;
  struct sock *sk ;
  struct file **tmp ;
  struct sock *tmp___0 ;
...
{ 
  ...
  long total_refs ;
    klee_make_symbolic(&total_refs, sizeof(long), "total_refs");
  long inflight_refs ;
    klee_make_symbolic(&inflight_refs, sizeof(long), "inflight_refs");
  long tmp ;
  long tmp___0 ;
