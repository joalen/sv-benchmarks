...
{ 
  ...
  unsigned int hdr_padded_len ;
    klee_make_symbolic(&hdr_padded_len, sizeof(int), "hdr_padded_len");
  char *p ;
  void *tmp ;
  long tmp___0 ;
  size_t __len ;
...
{ 
  ...
  long tmp___4 ;
  int num_skb_frags ;
    klee_make_symbolic(&num_skb_frags, sizeof(int), "num_skb_frags");
  void *tmp___5 ;
  struct _ddebug descriptor ;
  long tmp___6 ;
  long tmp___7 ;
...
{ 
  ...
  unsigned int out_num ;
    klee_make_symbolic(&out_num, sizeof(int), "out_num");
  unsigned int tmp ;
  bool tmp___0 ;
  int tmp___1 ;
  long tmp___2 ;
...
{ 
  ...
  int i ;
  int total_vqs ;
    klee_make_symbolic(&total_vqs, sizeof(int), "total_vqs");
  char const   **names ;
  bool tmp ;
  void *tmp___0 ;
  void *tmp___1 ;
