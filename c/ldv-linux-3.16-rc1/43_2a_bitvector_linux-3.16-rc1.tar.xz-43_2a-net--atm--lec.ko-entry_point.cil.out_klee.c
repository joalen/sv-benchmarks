...
struct atmlec_config_msg {
   unsigned int maximum_unknown_frame_count ;
    klee_make_symbolic(&maximum_unknown_frame_count, sizeof(int), "maximum_unknown_frame_count");
   unsigned int max_unknown_frame_time ;
    klee_make_symbolic(&max_unknown_frame_time, sizeof(int), "max_unknown_frame_time");
   unsigned short max_retry_count ;
    klee_make_symbolic(&max_retry_count, sizeof(short), "max_retry_count");
   unsigned int aging_time ;
    klee_make_symbolic(&aging_time, sizeof(int), "aging_time");
   unsigned int forward_delay_time ;
    klee_make_symbolic(&forward_delay_time, sizeof(int), "forward_delay_time");
   unsigned int arp_response_time ;
    klee_make_symbolic(&arp_response_time, sizeof(int), "arp_response_time");
   unsigned int flush_timeout ;
    klee_make_symbolic(&flush_timeout, sizeof(int), "flush_timeout");
   unsigned int path_switching_delay ;
    klee_make_symbolic(&path_switching_delay, sizeof(int), "path_switching_delay");
   unsigned int lane_version ;
    klee_make_symbolic(&lane_version, sizeof(int), "lane_version");
   int mtu ;
   int is_proxy ;
    klee_make_symbolic(&is_proxy, sizeof(int), "is_proxy");
};
struct __anonstruct_normal_276 {
   ...
   unsigned int targetless_le_arp ;
    klee_make_symbolic(&targetless_le_arp, sizeof(int), "targetless_le_arp");
   unsigned int no_source_le_narp ;
    klee_make_symbolic(&no_source_le_narp, sizeof(int), "no_source_le_narp");
};
...
struct atmlec_msg {
   ...
   int sizeoftlvs ;
    klee_make_symbolic(&sizeoftlvs, sizeof(int), "sizeoftlvs");
...
struct lec_priv {
   unsigned short lecid ;
    klee_make_symbolic(&lecid, sizeof(short), "lecid");
   ...
   unsigned long vcc_timeout_period ;
    klee_make_symbolic(&vcc_timeout_period, sizeof(long), "vcc_timeout_period");
   unsigned short max_retry_count ;
   unsigned long aging_time ;
   unsigned long forward_delay_time ;
   int topology_change ;
    klee_make_symbolic(&topology_change, sizeof(int), "topology_change");
   ...
   int lane_version ;
   int itfnum ;
    klee_make_symbolic(&itfnum, sizeof(int), "itfnum");
...
struct lec_vcc_priv {
   ...
   int xoff ;
    klee_make_symbolic(&xoff, sizeof(int), "xoff");
};
struct lec_arp_table {
   ...
   unsigned char mac_addr[6U] ;
   int is_rdesc ;
    klee_make_symbolic(&is_rdesc, sizeof(int), "is_rdesc");
   struct atm_vcc *vcc ;
   ...
   unsigned char no_tries ;
    klee_make_symbolic(&no_tries, sizeof(char), "no_tries");
   unsigned char status ;
    klee_make_symbolic(&status, sizeof(char), "status");
   unsigned short flags ;
   unsigned short packets_flooded ;
    klee_make_symbolic(&packets_flooded, sizeof(short), "packets_flooded");
   unsigned long flush_tran_id ;
    klee_make_symbolic(&flush_tran_id, sizeof(long), "flush_tran_id");
   struct timer_list timer ;
...
struct lec_state {
   ...
   int itf ;
   int arp_table ;
    klee_make_symbolic(&arp_table, sizeof(int), "arp_table");
   int misc_table ;
    klee_make_symbolic(&misc_table, sizeof(int), "misc_table");
};
struct ipv4_devconf {
   void *sysctl ;
   int data[28U] ;
...
{ 
  ...
  int i ;
  int remove_vcc ;
    klee_make_symbolic(&remove_vcc, sizeof(int), "remove_vcc");
  struct hlist_node *____ptr ;
  struct hlist_node  const  *__mptr ;
  struct lec_arp_table *tmp ;
  int tmp___0 ;
...
{ 
  unsigned long time_to_check ;
    klee_make_symbolic(&time_to_check, sizeof(long), "time_to_check");
  struct _ddebug descriptor ;
  long tmp ;
  struct _ddebug descriptor___0 ;
  long tmp___0 ;
...
{ 
  ...
  int i ;
  int found_entry ;
    klee_make_symbolic(&found_entry, sizeof(int), "found_entry");
  struct _ddebug descriptor ;
  long tmp ;
  size_t __len ;
  void *__ret ;
