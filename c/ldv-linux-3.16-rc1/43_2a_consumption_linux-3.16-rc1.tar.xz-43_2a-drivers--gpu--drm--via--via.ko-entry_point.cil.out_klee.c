...
struct drm_wait_vblank_reply {
   ...
   unsigned int sequence ;
   long tval_sec ;
    klee_make_symbolic(&tval_sec, sizeof(long), "tval_sec");
   long tval_usec ;
    klee_make_symbolic(&tval_usec, sizeof(long), "tval_usec");
};
...
struct drm_mode_config {
   ...
   int num_bridge ;
    klee_make_symbolic(&num_bridge, sizeof(int), "num_bridge");
...
struct _drm_via_tex_region {
   ...
   unsigned char inUse ;
    klee_make_symbolic(&inUse, sizeof(char), "inUse");
   int age ;
...
struct _drm_via_sarea {
   ...
   unsigned int nbox ;
    klee_make_symbolic(&nbox, sizeof(int), "nbox");
   struct drm_clip_rect boxes[8U] ;
   drm_via_tex_region_t texList[65U] ;
   int texAge ;
    klee_make_symbolic(&texAge, sizeof(int), "texAge");
   int ctxOwner ;
    klee_make_symbolic(&ctxOwner, sizeof(int), "ctxOwner");
   int vertexPrim ;
    klee_make_symbolic(&vertexPrim, sizeof(int), "vertexPrim");
   char XvMCLockArea[384U] ;
   unsigned int XvMCDisplaying[10U] ;
   unsigned int XvMCSubPicOn[10U] ;
   unsigned int XvMCCtxNoGrabbed ;
    klee_make_symbolic(&XvMCCtxNoGrabbed, sizeof(int), "XvMCCtxNoGrabbed");
   unsigned int pfCurrentOffset ;
    klee_make_symbolic(&pfCurrentOffset, sizeof(int), "pfCurrentOffset");
};
...
struct __anonstruct_drm_via_state_t_208 {
   unsigned int texture ;
    klee_make_symbolic(&texture, sizeof(int), "texture");
   uint32_t z_addr ;
   uint32_t d_addr ;
   ...
   int agp_texture ;
    klee_make_symbolic(&agp_texture, sizeof(int), "agp_texture");
   int multitex ;
    klee_make_symbolic(&multitex, sizeof(int), "multitex");
   struct drm_device *dev ;
   drm_local_map_t *map_cache ;
   uint32_t vertex_count ;
   int agp ;
    klee_make_symbolic(&agp, sizeof(int), "agp");
...
struct _drm_via_sg_info {
   ...
   int num_desc_pages ;
    klee_make_symbolic(&num_desc_pages, sizeof(int), "num_desc_pages");
   int num_desc ;
    klee_make_symbolic(&num_desc, sizeof(int), "num_desc");
   enum dma_data_direction direction ;
   unsigned char *bounce_buffer ;
   dma_addr_t chain_start ;
   uint32_t free_on_sequence ;
   unsigned int descriptors_per_page ;
    klee_make_symbolic(&descriptors_per_page, sizeof(int), "descriptors_per_page");
   int aborted ;
...
struct _drm_via_blitq {
   ...
   unsigned int serviced ;
    klee_make_symbolic(&serviced, sizeof(int), "serviced");
   unsigned int head ;
   ...
   unsigned int num_outstanding ;
    klee_make_symbolic(&num_outstanding, sizeof(int), "num_outstanding");
   unsigned long end ;
...
struct drm_via_private {
   ...
   unsigned long agpAddr ;
    klee_make_symbolic(&agpAddr, sizeof(long), "agpAddr");
   wait_queue_head_t decoder_queue[5U] ;
   char *dma_ptr ;
   unsigned int dma_low ;
    klee_make_symbolic(&dma_low, sizeof(int), "dma_low");
   unsigned int dma_high ;
    klee_make_symbolic(&dma_high, sizeof(int), "dma_high");
   ...
   int last_vblank_valid ;
    klee_make_symbolic(&last_vblank_valid, sizeof(int), "last_vblank_valid");
   unsigned int usec_per_vblank ;
    klee_make_symbolic(&usec_per_vblank, sizeof(int), "usec_per_vblank");
   ...
   unsigned int idle_fault ;
    klee_make_symbolic(&idle_fault, sizeof(int), "idle_fault");
   int vram_initialized ;
    klee_make_symbolic(&vram_initialized, sizeof(int), "vram_initialized");
   struct drm_mm vram_mm ;
   int agp_initialized ;
    klee_make_symbolic(&agp_initialized, sizeof(int), "agp_initialized");
   struct drm_mm agp_mm ;
   struct idr object_idr ;
   unsigned long vram_offset ;
    klee_make_symbolic(&vram_offset, sizeof(long), "vram_offset");
   unsigned long agp_offset ;
    klee_make_symbolic(&agp_offset, sizeof(long), "agp_offset");
...
struct _drm_via_init {
   ...
   unsigned long sarea_priv_offset ;
    klee_make_symbolic(&sarea_priv_offset, sizeof(long), "sarea_priv_offset");
   unsigned long fb_offset ;
    klee_make_symbolic(&fb_offset, sizeof(long), "fb_offset");
   unsigned long mmio_offset ;
    klee_make_symbolic(&mmio_offset, sizeof(long), "mmio_offset");
   unsigned long agpAddr ;
};
...
struct _drm_via_dma_init {
   ...
   unsigned long reg_pause_addr ;
    klee_make_symbolic(&reg_pause_addr, sizeof(long), "reg_pause_addr");
};
...
struct drm_via_blitsync {
   __u32 sync_handle ;
   unsigned int engine ;
    klee_make_symbolic(&engine, sizeof(int), "engine");
};
...
struct drm_via_dmablit {
   ...
   __u32 flags ;
   int to_fb ;
    klee_make_symbolic(&to_fb, sizeof(int), "to_fb");
...
{ 
  ...
  unsigned int cur_irq_sequence ;
    klee_make_symbolic(&cur_irq_sequence, sizeof(int), "cur_irq_sequence");
  drm_via_irq_t *cur_irq ;
  int ret ;
  maskarray_t *masks ;
  int real_irq ;
    klee_make_symbolic(&real_irq, sizeof(int), "real_irq");
  long tmp ;
  wait_queue_t entry ;
  ...
  unsigned long end___0 ;
    klee_make_symbolic(&end___0, sizeof(long), "end___0");
...
{ 
  ...
  drm_via_irq_t *cur_irq ;
  int force_sequence ;
    klee_make_symbolic(&force_sequence, sizeof(int), "force_sequence");
  int tmp ;
...
int via_max_ioctl ;
    klee_make_symbolic(&via_max_ioctl, sizeof(int), "via_max_ioctl");
...
{ 
  ...
  int user_key ;
    klee_make_symbolic(&user_key, sizeof(int), "user_key");
  struct via_memblock *item ;
  drm_via_private_t *dev_priv ;
  struct via_file_private *file_priv ;
  unsigned long tmpSize ;
    klee_make_symbolic(&tmpSize, sizeof(long), "tmpSize");
  void *tmp ;
  long tmp___0 ;
...
{ 
  ...
  unsigned int end ;
  unsigned long lo ;
    klee_make_symbolic(&lo, sizeof(long), "lo");
  unsigned long hi ;
  ...
  unsigned int i ;
  int npot ;
    klee_make_symbolic(&npot, sizeof(int), "npot");
  uint32_t *tmp___2 ;
  uint32_t *tmp___3 ;
  uint32_t *tmp___4 ;
  uint32_t *tmp___5 ;
...
{ 
  ...
  int ret ;
  int have_fire ;
    klee_make_symbolic(&have_fire, sizeof(int), "have_fire");
  uint32_t const   *buf ;
  uint32_t const   *tmp ;
...
{ 
  uint32_t cmd ;
  int hz_mode ;
    klee_make_symbolic(&hz_mode, sizeof(int), "hz_mode");
  hazard_t hz ;
  uint32_t const   *buf ;
...
{ 
  ...
  int cme_video ;
    klee_make_symbolic(&cme_video, sizeof(int), "cme_video");
  int supported_3d ;
    klee_make_symbolic(&supported_3d, sizeof(int), "supported_3d");
...
{ 
  ...
  verifier_state_t state ;
  int fire_count ;
    klee_make_symbolic(&fire_count, sizeof(int), "fire_count");
...
{ 
  ...
  unsigned int cur_descriptor_page ;
    klee_make_symbolic(&cur_descriptor_page, sizeof(int), "cur_descriptor_page");
  unsigned int descriptor_this_page ;
    klee_make_symbolic(&descriptor_this_page, sizeof(int), "descriptor_this_page");
...
{ 
  ...
  unsigned int num_descriptors_this_page ;
    klee_make_symbolic(&num_descriptors_this_page, sizeof(int), "num_descriptors_this_page");
  unsigned char *mem_addr ;
  ...
  unsigned long line_len ;
    klee_make_symbolic(&line_len, sizeof(long), "line_len");
  unsigned int remaining_len ;
    klee_make_symbolic(&remaining_len, sizeof(int), "remaining_len");
  int num_desc ;
  int cur_line ;
    klee_make_symbolic(&cur_line, sizeof(int), "cur_line");
  dma_addr_t next ;
  drm_via_descriptor_t *desc_ptr ;
  unsigned long _min1 ;
...
{ 
  ...
  unsigned long first_pfn ;
    klee_make_symbolic(&first_pfn, sizeof(long), "first_pfn");
  void *tmp ;
  struct task_struct *tmp___0 ;
  struct task_struct *tmp___1 ;
  struct task_struct *tmp___2 ;
...
{ 
  ...
  int cur ;
  int done_transfer ;
    klee_make_symbolic(&done_transfer, sizeof(int), "done_transfer");
  unsigned long irqsave ;
    klee_make_symbolic(&irqsave, sizeof(long), "irqsave");
  uint32_t status ;
  long tmp ;
  int tmp___0 ;
  int tmp___1 ;
...
{ 
  ...
  int cur_released ;
    klee_make_symbolic(&cur_released, sizeof(int), "cur_released");
  long tmp ;
  unsigned int tmp___0 ;
  long tmp___1 ;
...
{ 
  int draw ;
    klee_make_symbolic(&draw, sizeof(int), "draw");
  int ret ;
  long ret___0 ;
