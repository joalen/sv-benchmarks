...
typedef unsigned long cfs_time_t;
    klee_make_symbolic(&cfs_time_t, sizeof(long), "cfs_time_t");
typedef long cfs_duration_t;
    klee_make_symbolic(&cfs_duration_t, sizeof(long), "cfs_duration_t");
...
typedef long long_ptr_t;
    klee_make_symbolic(&long_ptr_t, sizeof(long), "long_ptr_t");
...
struct __anonstruct_cfs_binheap_node_t_274 {
   unsigned int chn_index ;
    klee_make_symbolic(&chn_index, sizeof(int), "chn_index");
};
...
struct nameidata {
   ...
   unsigned int seq ;
   unsigned int m_seq ;
    klee_make_symbolic(&m_seq, sizeof(int), "m_seq");
   int last_type ;
...
struct md_identity {
   ...
   int mi_nperms ;
    klee_make_symbolic(&mi_nperms, sizeof(int), "mi_nperms");
...
struct upcall_cache_entry {
   ...
   int ue_flags ;
    klee_make_symbolic(&ue_flags, sizeof(int), "ue_flags");
...
struct ldlm_namespace {
   ...
   unsigned int ns_timeouts ;
    klee_make_symbolic(&ns_timeouts, sizeof(int), "ns_timeouts");
   unsigned int ns_ctime_age_limit ;
    klee_make_symbolic(&ns_ctime_age_limit, sizeof(int), "ns_ctime_age_limit");
   ...
   unsigned int ns_contended_locks ;
    klee_make_symbolic(&ns_contended_locks, sizeof(int), "ns_contended_locks");
   unsigned int ns_contention_time ;
    klee_make_symbolic(&ns_contention_time, sizeof(int), "ns_contention_time");
   unsigned int ns_max_nolock_size ;
    klee_make_symbolic(&ns_max_nolock_size, sizeof(int), "ns_max_nolock_size");
...
static int llog_test_rand  ;
    klee_make_symbolic(&llog_test_rand, sizeof(int), "llog_test_rand");
...
{ 
  int i ;
  int last_idx ;
    klee_make_symbolic(&last_idx, sizeof(int), "last_idx");
  int active_recs ;
    klee_make_symbolic(&active_recs, sizeof(int), "active_recs");
  int tmp ;
  struct cfs_debug_limit_state cdls ;
  struct libcfs_debug_msg_data msgdata ;
  int tmp___0 ;
...
{ 
  ...
  int i ;
  int num_recs ;
    klee_make_symbolic(&num_recs, sizeof(int), "num_recs");
  struct cfs_debug_limit_state cdls ;
  struct libcfs_debug_msg_data msgdata ;
  int tmp ;
  struct cfs_debug_limit_state cdls___0 ;
...
static int cat_counter  ;
    klee_make_symbolic(&cat_counter, sizeof(int), "cat_counter");
...
static int plain_counter  ;
    klee_make_symbolic(&plain_counter, sizeof(int), "plain_counter");
...
static int cancel_count  ;
    klee_make_symbolic(&cancel_count, sizeof(int), "cancel_count");
