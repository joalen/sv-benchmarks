...
{ 
  ...
  void *tmphlprbuf ;
  int tmphlprbufsz ;
    klee_make_symbolic(&tmphlprbufsz, sizeof(int), "tmphlprbufsz");
  int hlprblknow ;
    klee_make_symbolic(&hlprblknow, sizeof(int), "hlprblknow");
  int helperlen ;
    klee_make_symbolic(&helperlen, sizeof(int), "helperlen");
  u8 *helperbuf ;
  u32 tx_len ;
...
{ 
  ...
  u8 const   *firmware ;
  int firmwarelen ;
    klee_make_symbolic(&firmwarelen, sizeof(int), "firmwarelen");
  int tmpfwbufsz ;
    klee_make_symbolic(&tmpfwbufsz, sizeof(int), "tmpfwbufsz");
  int ret ;
  unsigned int tries ;
  unsigned int offset ;
  u8 base0 ;
  ...
  int tx_blocks ;
    klee_make_symbolic(&tx_blocks, sizeof(int), "tx_blocks");
  int count ;
  struct _ddebug descriptor ;
  long tmp ;
  size_t __len ;
...
{ 
  ...
  int ret ;
  int num_blocks ;
    klee_make_symbolic(&num_blocks, sizeof(int), "num_blocks");
  int blksz ;
...
{ 
  ...
  int ret ;
  int buf_block_len ;
    klee_make_symbolic(&buf_block_len, sizeof(int), "buf_block_len");
  int blksz ;
  int i ;
  ...
  void *tmpbuf ;
  int tmpbufsz ;
    klee_make_symbolic(&tmpbufsz, sizeof(int), "tmpbufsz");
  size_t __len ;
  void *__ret ;
...
{ 
  ...
  u8 fws0 ;
  int pollnum ;
    klee_make_symbolic(&pollnum, sizeof(int), "pollnum");
  struct _ddebug descriptor ;
  long tmp ;
  int tmp___0 ;
  struct _ddebug descriptor___0 ;
