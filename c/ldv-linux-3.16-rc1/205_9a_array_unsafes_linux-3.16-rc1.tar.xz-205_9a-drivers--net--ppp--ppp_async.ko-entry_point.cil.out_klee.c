...
struct asyncppp {
   ...
   unsigned int state ;
   unsigned int rbits ;
    klee_make_symbolic(&rbits, sizeof(int), "rbits");
   int mru ;
    klee_make_symbolic(&mru, sizeof(int), "mru");
   spinlock_t xmit_lock ;
   spinlock_t recv_lock ;
   unsigned long xmit_flags ;
    klee_make_symbolic(&xmit_flags, sizeof(long), "xmit_flags");
   u32 xaccm[8U] ;
   u32 raccm ;
   unsigned int bytes_sent ;
    klee_make_symbolic(&bytes_sent, sizeof(int), "bytes_sent");
   unsigned int bytes_rcvd ;
    klee_make_symbolic(&bytes_rcvd, sizeof(int), "bytes_rcvd");
   struct sk_buff *tpkt ;
   int tpkt_pos ;
    klee_make_symbolic(&tpkt_pos, sizeof(int), "tpkt_pos");
   u16 tfcs ;
   unsigned char *optr ;
   unsigned char *olim ;
   ...
   struct sk_buff *rpkt ;
   int lcp_fcs ;
    klee_make_symbolic(&lcp_fcs, sizeof(int), "lcp_fcs");
...
{ 
  int fcs ;
    klee_make_symbolic(&fcs, sizeof(int), "fcs");
  int i ;
  ...
  unsigned char *data ;
  int islcp ;
    klee_make_symbolic(&islcp, sizeof(int), "islcp");
  u16 tmp ;
...
{ 
  ...
  struct tty_struct *tty ;
  int tty_stuffed ;
    klee_make_symbolic(&tty_stuffed, sizeof(int), "tty_stuffed");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
  int tmp___2 ;
