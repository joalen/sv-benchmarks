...
{ 
  ...
  long best_rate ;
    klee_make_symbolic(&best_rate, sizeof(long), "best_rate");
  long best_error ;
    klee_make_symbolic(&best_error, sizeof(long), "best_error");
  long error ;
  int best_tseg ;
    klee_make_symbolic(&best_tseg, sizeof(int), "best_tseg");
  int best_brp ;
    klee_make_symbolic(&best_brp, sizeof(int), "best_brp");
  int brp ;
    klee_make_symbolic(&brp, sizeof(int), "brp");
  int tsegall ;
    klee_make_symbolic(&tsegall, sizeof(int), "tsegall");
  int tseg ;
    klee_make_symbolic(&tseg, sizeof(int), "tseg");
  int tseg1 ;
    klee_make_symbolic(&tseg1, sizeof(int), "tseg1");
  int tseg2 ;
    klee_make_symbolic(&tseg2, sizeof(int), "tseg2");
  int spt_error ;
    klee_make_symbolic(&spt_error, sizeof(int), "spt_error");
  int spt ;
    klee_make_symbolic(&spt, sizeof(int), "spt");
  int sampl_pt ;
    klee_make_symbolic(&sampl_pt, sizeof(int), "sampl_pt");
  u64 v64 ;
  int tmp___0 ;
  uint32_t __base ;
  uint32_t __rem ;
...
{ 
  ...
  int tseg1 ;
  int alltseg ;
    klee_make_symbolic(&alltseg, sizeof(int), "alltseg");
  u64 brp64 ;
  uint32_t __base ;
  uint32_t __rem ;
  uint32_t __base___0 ;
