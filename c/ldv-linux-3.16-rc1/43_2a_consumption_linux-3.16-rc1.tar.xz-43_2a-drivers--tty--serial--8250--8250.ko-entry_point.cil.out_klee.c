...
struct uart_8250_port {
   ...
   unsigned short capabilities ;
    klee_make_symbolic(&capabilities, sizeof(short), "capabilities");
   unsigned short bugs ;
    klee_make_symbolic(&bugs, sizeof(short), "bugs");
   unsigned int tx_loadsz ;
    klee_make_symbolic(&tx_loadsz, sizeof(int), "tx_loadsz");
   unsigned char acr ;
    klee_make_symbolic(&acr, sizeof(char), "acr");
   unsigned char ier ;
   ...
   unsigned char mcr_mask ;
    klee_make_symbolic(&mcr_mask, sizeof(char), "mcr_mask");
   unsigned char mcr_force ;
    klee_make_symbolic(&mcr_force, sizeof(char), "mcr_force");
   unsigned char cur_iotype ;
    klee_make_symbolic(&cur_iotype, sizeof(char), "cur_iotype");
   unsigned char lsr_saved_flags ;
    klee_make_symbolic(&lsr_saved_flags, sizeof(char), "lsr_saved_flags");
   unsigned char msr_saved_flags ;
    klee_make_symbolic(&msr_saved_flags, sizeof(char), "msr_saved_flags");
...
struct uart_8250_dma {
   ...
   void *tx_param ;
   int rx_chan_id ;
    klee_make_symbolic(&rx_chan_id, sizeof(int), "rx_chan_id");
   int tx_chan_id ;
    klee_make_symbolic(&tx_chan_id, sizeof(int), "tx_chan_id");
...
static unsigned int skip_txen_test  ;
    klee_make_symbolic(&skip_txen_test, sizeof(int), "skip_txen_test");
...
static unsigned int probe_rsa_count  ;
    klee_make_symbolic(&probe_rsa_count, sizeof(int), "probe_rsa_count");
...
{ 
  unsigned char old_fcr ;
    klee_make_symbolic(&old_fcr, sizeof(char), "old_fcr");
  unsigned char old_mcr ;
    klee_make_symbolic(&old_mcr, sizeof(char), "old_mcr");
  unsigned char old_lcr ;
    klee_make_symbolic(&old_lcr, sizeof(char), "old_lcr");
  unsigned short old_dl ;
    klee_make_symbolic(&old_dl, sizeof(short), "old_dl");
  int count ;
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
...
{ 
  unsigned char old_dll ;
    klee_make_symbolic(&old_dll, sizeof(char), "old_dll");
  unsigned char old_dlm ;
    klee_make_symbolic(&old_dlm, sizeof(char), "old_dlm");
  unsigned char old_lcr ;
  unsigned int id ;
  int tmp ;
  int tmp___0 ;
...
{ 
  ...
  unsigned int iersave ;
    klee_make_symbolic(&iersave, sizeof(int), "iersave");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
  int tmp___2 ;
  ...
  int tmp___6 ;
  unsigned short quot ;
    klee_make_symbolic(&quot, sizeof(short), "quot");
  int tmp___7 ;
  int tmp___8 ;
...
{ 
  ...
  unsigned char scratch3 ;
    klee_make_symbolic(&scratch3, sizeof(char), "scratch3");
  unsigned char save_lcr ;
    klee_make_symbolic(&save_lcr, sizeof(char), "save_lcr");
  unsigned char save_mcr ;
    klee_make_symbolic(&save_mcr, sizeof(char), "save_mcr");
  struct uart_port *port ;
  unsigned long flags ;
  unsigned int old_capabilities ;
    klee_make_symbolic(&old_capabilities, sizeof(int), "old_capabilities");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
  int tmp___2 ;
...
{ 
  ...
  unsigned char save_ier ;
    klee_make_symbolic(&save_ier, sizeof(char), "save_ier");
  unsigned char save_ICP ;
    klee_make_symbolic(&save_ICP, sizeof(char), "save_ICP");
  unsigned int ICP ;
    klee_make_symbolic(&ICP, sizeof(int), "ICP");
  unsigned long irqs ;
...
{ 
  ...
  struct uart_port  const  *__mptr ;
  int dma_err ;
    klee_make_symbolic(&dma_err, sizeof(int), "dma_err");
  int tmp ;
...
{ 
  unsigned char int0 ;
    klee_make_symbolic(&int0, sizeof(char), "int0");
  unsigned char int1 ;
    klee_make_symbolic(&int1, sizeof(char), "int1");
  unsigned char int2 ;
    klee_make_symbolic(&int2, sizeof(char), "int2");
  unsigned char int3 ;
    klee_make_symbolic(&int3, sizeof(char), "int3");
  unsigned int iir ;
  int tmp ;
  int ret ;
  int tmp___0 ;
...
{ 
  ...
  unsigned int tmout___0 ;
    klee_make_symbolic(&tmout___0, sizeof(int), "tmout___0");
  unsigned int msr ;
...
{ 
  ...
  int tmp___1 ;
  unsigned char fctr ;
    klee_make_symbolic(&fctr, sizeof(char), "fctr");
  int tmp___2 ;
  unsigned char iir1 ;
    klee_make_symbolic(&iir1, sizeof(char), "iir1");
  int tmp___3 ;
  int tmp___4 ;
...
{ 
  ...
  unsigned int quot ;
  int fifo_bug ;
    klee_make_symbolic(&fifo_bug, sizeof(int), "fifo_bug");
  unsigned char efr ;
    klee_make_symbolic(&efr, sizeof(char), "efr");
  int tmp ;
  unsigned int baud_x32 ;
    klee_make_symbolic(&baud_x32, sizeof(int), "baud_x32");
  u16 quot___0 ;
  u8 quot_frac ;
  unsigned int __x ;
...
{ 
  ...
  struct uart_port  const  *__mptr ;
  int probeflags ;
    klee_make_symbolic(&probeflags, sizeof(int), "probeflags");
  int ret ;
...
{ 
  ...
  int i ;
  int irqflag ;
    klee_make_symbolic(&irqflag, sizeof(int), "irqflag");
...
{ 
  ...
  unsigned char ldvarg3 ;
    klee_make_symbolic(&ldvarg3, sizeof(char), "ldvarg3");
...
{ 
  ...
  struct dma_tx_state state ;
  int dma_status ;
    klee_make_symbolic(&dma_status, sizeof(int), "dma_status");
  enum dma_status tmp ;
...
#include "model/43_2a_consumption_linux-3.16-rc1.tar.xz-43_2a-drivers--tty--serial--8250--8250.ko-entry_point_true-unreach-call.cil.out.env.c"
#include <klee/klee.h>
