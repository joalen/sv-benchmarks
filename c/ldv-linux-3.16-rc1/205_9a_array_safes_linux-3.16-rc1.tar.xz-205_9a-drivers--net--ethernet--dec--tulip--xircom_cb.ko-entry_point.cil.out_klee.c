...
struct xircom_private {
   ...
   int transmit_used ;
    klee_make_symbolic(&transmit_used, sizeof(int), "transmit_used");
   spinlock_t lock ;
   struct pci_dev *pdev ;
   struct net_device *dev ;
};
...
{ 
  ...
  unsigned short tmp16 ;
    klee_make_symbolic(&tmp16, sizeof(short), "tmp16");
  int rc ;
...
{ 
  ...
  int newlink ;
    klee_make_symbolic(&newlink, sizeof(int), "newlink");
...
{ 
  ...
  unsigned long flags ;
  int nextdescriptor ;
    klee_make_symbolic(&nextdescriptor, sizeof(int), "nextdescriptor");
  int desc ;
