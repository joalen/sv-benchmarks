...
struct mts64 {
   ...
   int pardev_claimed ;
    klee_make_symbolic(&pardev_claimed, sizeof(int), "pardev_claimed");
   int open_count ;
    klee_make_symbolic(&open_count, sizeof(int), "open_count");
   int current_midi_output_port ;
    klee_make_symbolic(&current_midi_output_port, sizeof(int), "current_midi_output_port");
   int current_midi_input_port ;
    klee_make_symbolic(&current_midi_input_port, sizeof(int), "current_midi_input_port");
   u8 mode[5U] ;
   struct snd_rawmidi_substream *midi_input_substream[5U] ;
   int smpte_switch ;
    klee_make_symbolic(&smpte_switch, sizeof(int), "smpte_switch");
   u8 time[4U] ;
   u8 fps ;
};
...
static int device_count  ;
    klee_make_symbolic(&device_count, sizeof(int), "device_count");
