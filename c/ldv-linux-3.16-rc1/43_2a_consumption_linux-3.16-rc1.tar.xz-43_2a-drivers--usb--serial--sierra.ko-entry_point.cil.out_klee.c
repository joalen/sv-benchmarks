...
struct sierra_intf_private {
   ...
   unsigned int open_ports ;
    klee_make_symbolic(&open_ports, sizeof(int), "open_ports");
};
struct sierra_port_private {
   spinlock_t lock ;
   int outstanding_urbs ;
    klee_make_symbolic(&outstanding_urbs, sizeof(int), "outstanding_urbs");
   struct usb_anchor active ;
   struct usb_anchor delayed ;
   int num_out_urbs ;
    klee_make_symbolic(&num_out_urbs, sizeof(int), "num_out_urbs");
   int num_in_urbs ;
    klee_make_symbolic(&num_in_urbs, sizeof(int), "num_in_urbs");
   struct urb *in_urbs[8U] ;
   int rts_state ;
    klee_make_symbolic(&rts_state, sizeof(int), "rts_state");
   int dtr_state ;
    klee_make_symbolic(&dtr_state, sizeof(int), "dtr_state");
   int cts_state ;
    klee_make_symbolic(&cts_state, sizeof(int), "cts_state");
   int dsr_state ;
    klee_make_symbolic(&dsr_state, sizeof(int), "dsr_state");
   int dcd_state ;
    klee_make_symbolic(&dcd_state, sizeof(int), "dcd_state");
   int ri_state ;
    klee_make_symbolic(&ri_state, sizeof(int), "ri_state");
};
...
{ 
  ...
  int do_send ;
    klee_make_symbolic(&do_send, sizeof(int), "do_send");
  int retval ;
...
{ 
  ...
  long tmp___1 ;
  int old_dcd_state ;
    klee_make_symbolic(&old_dcd_state, sizeof(int), "old_dcd_state");
...
{ 
  int ok_cnt ;
    klee_make_symbolic(&ok_cnt, sizeof(int), "ok_cnt");
  int err ;
  int i ;
  struct urb *urb ;
  struct sierra_port_private *portdata ;
