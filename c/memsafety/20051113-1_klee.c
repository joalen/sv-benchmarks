...
{
  short a;  
    klee_make_symbolic(&a, sizeof(short), "a");
  unsigned short b;
    klee_make_symbolic(&b, sizeof(short), "b");
  unsigned short c;
    klee_make_symbolic(&c, sizeof(short), "c");
  unsigned long long Count;
    klee_make_symbolic(&Count, sizeof(long), "Count");
  long long Count2;
    klee_make_symbolic(&Count2, sizeof(long), "Count2");
...
typedef struct
{
  ...
  unsigned long long d;
    klee_make_symbolic(&d, sizeof(long), "d");
  long long e;
    klee_make_symbolic(&e, sizeof(long), "e");
  long long f;
