...
{ int s__info_callback = __VERIFIER_nondet_int() ;
  ...
  int s__s3__tmp__cert_request ;
    klee_make_symbolic(&s__s3__tmp__cert_request, sizeof(int), "s__s3__tmp__cert_request");
  int s__s3__tmp__reuse_message = __VERIFIER_nondet_int() ;
  int s__s3__tmp__use_rsa_tmp ;
    klee_make_symbolic(&s__s3__tmp__use_rsa_tmp, sizeof(int), "s__s3__tmp__use_rsa_tmp");
