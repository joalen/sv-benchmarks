...
int  max_response_len;
    klee_make_symbolic(&max_response_len, sizeof(int), "max_response_len");
unsigned char * response;
int  act_response_len;
    klee_make_symbolic(&act_response_len, sizeof(int), "act_response_len");
int  transport_err;
    klee_make_symbolic(&transport_err, sizeof(int), "transport_err");
} ;
struct smp_target_obj{
char  device_name [256];
int  subvalue;
    klee_make_symbolic(&subvalue, sizeof(int), "subvalue");
unsigned char  sas_addr [8];
int  interface_selector;
    klee_make_symbolic(&interface_selector, sizeof(int), "interface_selector");
int  opened;
...
char  const* name;
int  has_arg;
    klee_make_symbolic(&has_arg, sizeof(int), "has_arg");
int * flag;
int  val;
...
struct opts_t{
int  do_adn;
    klee_make_symbolic(&do_adn, sizeof(int), "do_adn");
int  do_brief;
    klee_make_symbolic(&do_brief, sizeof(int), "do_brief");
int  desc_type;
    klee_make_symbolic(&desc_type, sizeof(int), "desc_type");
int  desc_type_given;
    klee_make_symbolic(&desc_type_given, sizeof(int), "desc_type_given");
int  filter;
    klee_make_symbolic(&filter, sizeof(int), "filter");
int  do_hex;
    klee_make_symbolic(&do_hex, sizeof(int), "do_hex");
int  ign_zp;
    klee_make_symbolic(&ign_zp, sizeof(int), "ign_zp");
int  do_num;
    klee_make_symbolic(&do_num, sizeof(int), "do_num");
int  num_given;
    klee_make_symbolic(&num_given, sizeof(int), "num_given");
int  do_1line;
    klee_make_symbolic(&do_1line, sizeof(int), "do_1line");
int  phy_id;
    klee_make_symbolic(&phy_id, sizeof(int), "phy_id");
int  phy_id_given;
    klee_make_symbolic(&phy_id_given, sizeof(int), "phy_id_given");
int  do_raw;
    klee_make_symbolic(&do_raw, sizeof(int), "do_raw");
int  do_summary;
    klee_make_symbolic(&do_summary, sizeof(int), "do_summary");
int  verbose;
    klee_make_symbolic(&verbose, sizeof(int), "verbose");
int  sa_given;
    klee_make_symbolic(&sa_given, sizeof(int), "sa_given");
unsigned long long  sa;
    klee_make_symbolic(&sa, sizeof(long), "sa");
char  const* zpi_fn;
FILE* zpi_filep;
} ;
...
extern char * optarg;
extern int  optind;
    klee_make_symbolic(&optind, sizeof(int), "optind");
extern char * optarg;
extern int  optind;
...
int  def_req_len;
    klee_make_symbolic(&def_req_len, sizeof(int), "def_req_len");
int  def_resp_len;
    klee_make_symbolic(&def_resp_len, sizeof(int), "def_resp_len");
} ;
struct smp_val_name{
int  value;
...
unsigned int  unum;
    klee_make_symbolic(&unum, sizeof(int), "unum");
char * cp;
char  c = 'c';
char  c2;
    klee_make_symbolic(&c2, sizeof(char), "c2");
char  c3;
    klee_make_symbolic(&c3, sizeof(char), "c3");
...
long long  num;
long long  ll;
    klee_make_symbolic(&ll, sizeof(long), "ll");
...
int  res;
int  dword_resp_len;
    klee_make_symbolic(&dword_resp_len, sizeof(int), "dword_resp_len");
int  mnum_desc;
    klee_make_symbolic(&mnum_desc, sizeof(int), "mnum_desc");
