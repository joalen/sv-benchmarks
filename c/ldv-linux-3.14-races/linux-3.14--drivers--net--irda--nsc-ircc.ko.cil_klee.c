...
static int pnp_succeeded  ;
    klee_make_symbolic(&pnp_succeeded, sizeof(int), "pnp_succeeded");
...
{ 
  ...
  int chip_index ;
    klee_make_symbolic(&chip_index, sizeof(int), "chip_index");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
  int tmp___2 ;
...
{ 
  ...
  int reg ;
  int com ;
    klee_make_symbolic(&com, sizeof(int), "com");
  int pnp ;
    klee_make_symbolic(&pnp, sizeof(int), "pnp");
  unsigned char tmp ;
  unsigned char tmp___0 ;
  unsigned char tmp___1 ;
...
{ 
  ...
  int irqt ;
    klee_make_symbolic(&irqt, sizeof(int), "irqt");
  int dma1 ;
    klee_make_symbolic(&dma1, sizeof(int), "dma1");
  int dma2 ;
  int enabled ;
  int susp ;
    klee_make_symbolic(&susp, sizeof(int), "susp");
  unsigned char tmp ;
  unsigned char tmp___0 ;
  unsigned char tmp___1 ;
  unsigned char tmp___2 ;
...
{ 
  ...
  unsigned char tmp ;
  int tmp_2;
    klee_make_symbolic(&tmp_2, sizeof(int), "tmp_2");
...
{ 
  int bsr ;
    klee_make_symbolic(&bsr, sizeof(int), "bsr");
  unsigned char tmp ;
  unsigned char tmp___0 ;
  unsigned char tmp___1 ;
