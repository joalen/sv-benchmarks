...
int DevicePowerState ;
    klee_make_symbolic(&DevicePowerState, sizeof(int), "DevicePowerState");
int s  ;
...
int KbFilter_PnP(int DeviceObject , int Irp ) 
{ int devExt ;
    klee_make_symbolic(&devExt, sizeof(int), "devExt");
  int irpStack ;
  ...
  int devExt__Started ;
    klee_make_symbolic(&devExt__Started, sizeof(int), "devExt__Started");
  int devExt__Removed ;
    klee_make_symbolic(&devExt__Removed, sizeof(int), "devExt__Removed");
  int devExt__SurpriseRemoved ;
    klee_make_symbolic(&devExt__SurpriseRemoved, sizeof(int), "devExt__SurpriseRemoved");
...
{ int irpStack__MinorFunction = __VERIFIER_nondet_int() ;
  int devExt__DeviceState ;
    klee_make_symbolic(&devExt__DeviceState, sizeof(int), "devExt__DeviceState");
...
{ int Irp__IoStatus__Information ;
  ...
  int Irp__IoStatus__Status ;
  int hookKeyboard ;
    klee_make_symbolic(&hookKeyboard, sizeof(int), "hookKeyboard");
  int connectData ;
    klee_make_symbolic(&connectData, sizeof(int), "connectData");
  int status ;
  int tmp ;
  int __cil_tmp17 ;
