...
{ int DeviceObject__DeviceExtension = __VERIFIER_nondet_int() ;
  ...
  int disketteExtension__HoldNewRequests ;
    klee_make_symbolic(&disketteExtension__HoldNewRequests, sizeof(int), "disketteExtension__HoldNewRequests");
  int disketteExtension__FloppyThread = __VERIFIER_nondet_int() ;
  ...
  int disketteExtension ;
    klee_make_symbolic(&disketteExtension, sizeof(int), "disketteExtension");
  int ntStatus ;
...
{ int DeviceObject__DeviceExtension = __VERIFIER_nondet_int() ;
  ...
  int disketteExtension__IsStarted ;
    klee_make_symbolic(&disketteExtension__IsStarted, sizeof(int), "disketteExtension__IsStarted");
  int disketteExtension__HoldNewRequests ;
  int ntStatus ;
  int pnpStatus ;
