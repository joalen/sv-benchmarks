...
{ int FilterDevice__Flags ;
    klee_make_symbolic(&FilterDevice__Flags, sizeof(int), "FilterDevice__Flags");
  int TargetDevice__Characteristics ;
    klee_make_symbolic(&TargetDevice__Characteristics, sizeof(int), "TargetDevice__Characteristics");
  int FilterDevice__Characteristics ;
    klee_make_symbolic(&FilterDevice__Characteristics, sizeof(int), "FilterDevice__Characteristics");
  int propFlags ;
    klee_make_symbolic(&propFlags, sizeof(int), "propFlags");
...
{ int DeviceObject__DeviceExtension = __VERIFIER_nondet_int() ;
  ...
  int deviceExtension ;
    klee_make_symbolic(&deviceExtension, sizeof(int), "deviceExtension");
  int status ;
...
{ int DeviceObject__DeviceExtension = __VERIFIER_nondet_int() ;
  ...
  int deviceExtension ;
  int wmilibContext ;
    klee_make_symbolic(&wmilibContext, sizeof(int), "wmilibContext");
...
{ int Irp__CurrentLocation = __VERIFIER_nondet_int() ;
  ...
  int totalCounters__QueueDepth ;
    klee_make_symbolic(&totalCounters__QueueDepth, sizeof(int), "totalCounters__QueueDepth");
  ...
  int totalCounters ;
    klee_make_symbolic(&totalCounters, sizeof(int), "totalCounters");
  int diskCounters ;
    klee_make_symbolic(&diskCounters, sizeof(int), "diskCounters");
  int tmp ;
  int __cil_tmp24 ;
  ...
  int __cil_tmp26 ;
    klee_make_symbolic(&__cil_tmp26, sizeof(int), "__cil_tmp26");
...
{ int DeviceObject__DeviceExtension = __VERIFIER_nondet_int() ;
  ...
  int registrationFlag ;
    klee_make_symbolic(&registrationFlag, sizeof(int), "registrationFlag");
  int sizeof__MOUNTDEV_NAME = __VERIFIER_nondet_int() ;
  int output__NameLength = __VERIFIER_nondet_int() ;
  int outputSize ;
    klee_make_symbolic(&outputSize, sizeof(int), "outputSize");
  ...
  int __cil_tmp30 ;
    klee_make_symbolic(&__cil_tmp30, sizeof(int), "__cil_tmp30");
  int __cil_tmp31 ;
  ...
  long __cil_tmp37 ;
    klee_make_symbolic(&__cil_tmp37, sizeof(long), "__cil_tmp37");
  int __cil_tmp38 ;
