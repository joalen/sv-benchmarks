...
int routine  ;
    klee_make_symbolic(&routine, sizeof(int), "routine");
int myStatus  ;
    klee_make_symbolic(&myStatus, sizeof(int), "myStatus");
int pirp  ;
    klee_make_symbolic(&pirp, sizeof(int), "pirp");
int Executive ;
    klee_make_symbolic(&Executive, sizeof(int), "Executive");
int Suspended ;
    klee_make_symbolic(&Suspended, sizeof(int), "Suspended");
int KernelMode ;
    klee_make_symbolic(&KernelMode, sizeof(int), "KernelMode");
int DeviceUsageTypePaging ;
    klee_make_symbolic(&DeviceUsageTypePaging, sizeof(int), "DeviceUsageTypePaging");
...
{ int ioStatus__Status = __VERIFIER_nondet_int() ;
  int ioctl ;
    klee_make_symbolic(&ioctl, sizeof(int), "ioctl");
...
{ int deviceExtension__Active = __VERIFIER_nondet_int() ;
  ...
  int cdb ;
    klee_make_symbolic(&cdb, sizeof(int), "cdb");
  int inquiryDataPtr ;
    klee_make_symbolic(&inquiryDataPtr, sizeof(int), "inquiryDataPtr");
  int attempt ;
    klee_make_symbolic(&attempt, sizeof(int), "attempt");
  int tmp ;
    klee_make_symbolic(&tmp, sizeof(int), "tmp");
  int deviceParameterHandle = __VERIFIER_nondet_int() ;
  int keyValue ;
    klee_make_symbolic(&keyValue, sizeof(int), "keyValue");
  {
  {
...
{ int Irp__Tail__Overlay__CurrentStackLocation = __VERIFIER_nondet_int() ;
  ...
  int Irp__IoStatus__Status ;
    klee_make_symbolic(&Irp__IoStatus__Status, sizeof(int), "Irp__IoStatus__Status");
  ...
  int DeviceObject__Flags ;
    klee_make_symbolic(&DeviceObject__Flags, sizeof(int), "DeviceObject__Flags");
  int irpSp ;
    klee_make_symbolic(&irpSp, sizeof(int), "irpSp");
  int status ;
  int setPagable ;
    klee_make_symbolic(&setPagable, sizeof(int), "setPagable");
  int tmp ;
  int tmp___0 ;
...
{ int deviceExtension__PlayActive = __VERIFIER_nondet_int() ;
  ...
  int returnValue ;
    klee_make_symbolic(&returnValue, sizeof(int), "returnValue");
  long __cil_tmp10 ;
  int __cil_tmp11 ;
...
{ int Irp__Tail__Overlay__CurrentStackLocation = __VERIFIER_nondet_int() ;
  ...
  int Irp__IoStatus__Information ;
    klee_make_symbolic(&Irp__IoStatus__Information, sizeof(int), "Irp__IoStatus__Information");
  ...
  int srb__CdbLength ;
    klee_make_symbolic(&srb__CdbLength, sizeof(int), "srb__CdbLength");
  int cdb__CDB10__OperationCode ;
    klee_make_symbolic(&cdb__CDB10__OperationCode, sizeof(int), "cdb__CDB10__OperationCode");
  int srb__TimeOutValue ;
    klee_make_symbolic(&srb__TimeOutValue, sizeof(int), "srb__TimeOutValue");
  ...
  int currentIrpStack ;
    klee_make_symbolic(&currentIrpStack, sizeof(int), "currentIrpStack");
  int deviceExtension ;
  int cdaudioDataOut ;
    klee_make_symbolic(&cdaudioDataOut, sizeof(int), "cdaudioDataOut");
  int srb = __VERIFIER_nondet_int() ;
  ...
  int tracksToReturn ;
    klee_make_symbolic(&tracksToReturn, sizeof(int), "tracksToReturn");
  int tracksOnCd ;
    klee_make_symbolic(&tracksOnCd, sizeof(int), "tracksOnCd");
  int tracksInBuffer ;
    klee_make_symbolic(&tracksInBuffer, sizeof(int), "tracksInBuffer");
  int userPtr ;
    klee_make_symbolic(&userPtr, sizeof(int), "userPtr");
  ...
  int inputBuffer ;
    klee_make_symbolic(&inputBuffer, sizeof(int), "inputBuffer");
  int inputBuffer___0 ;
    klee_make_symbolic(&inputBuffer___0, sizeof(int), "inputBuffer___0");
  int tmp___7 ;
  ...
  int __cil_tmp59 ;
    klee_make_symbolic(&__cil_tmp59, sizeof(int), "__cil_tmp59");
  int __cil_tmp60 ;
  ...
  int __cil_tmp64 ;
    klee_make_symbolic(&__cil_tmp64, sizeof(int), "__cil_tmp64");
  int __cil_tmp65 ;
  ...
  int __cil_tmp69 ;
    klee_make_symbolic(&__cil_tmp69, sizeof(int), "__cil_tmp69");
  int __cil_tmp70 ;
  ...
  int __cil_tmp79 ;
    klee_make_symbolic(&__cil_tmp79, sizeof(int), "__cil_tmp79");
  int __cil_tmp80 ;
  ...
  int __cil_tmp83 ;
    klee_make_symbolic(&__cil_tmp83, sizeof(int), "__cil_tmp83");
  int __cil_tmp84 ;
    klee_make_symbolic(&__cil_tmp84, sizeof(int), "__cil_tmp84");
  int __cil_tmp85 ;
  ...
  int __cil_tmp93 ;
    klee_make_symbolic(&__cil_tmp93, sizeof(int), "__cil_tmp93");
  int __cil_tmp94 ;
  ...
  int __cil_tmp109 ;
    klee_make_symbolic(&__cil_tmp109, sizeof(int), "__cil_tmp109");
  int __cil_tmp110 ;
...
{ int currentIrpStack__Parameters__DeviceIoControl__IoControlCode = __VERIFIER_nondet_int() ;
  ...
  int deviceExtension__PlayActive ;
    klee_make_symbolic(&deviceExtension__PlayActive, sizeof(int), "deviceExtension__PlayActive");
  ...
  int i = __VERIFIER_nondet_int() ;
  int bytesTransfered ;
    klee_make_symbolic(&bytesTransfered, sizeof(int), "bytesTransfered");
  int Toc = __VERIFIER_nondet_int() ;
  int tmp ;
  int tracksToReturn ;
  int tracksOnCd ;
  ...
  int __cil_tmp40 ;
    klee_make_symbolic(&__cil_tmp40, sizeof(int), "__cil_tmp40");
  int __cil_tmp41 ;
  ...
  int __cil_tmp45 ;
    klee_make_symbolic(&__cil_tmp45, sizeof(int), "__cil_tmp45");
  int __cil_tmp46 ;
  ...
  int __cil_tmp50 ;
    klee_make_symbolic(&__cil_tmp50, sizeof(int), "__cil_tmp50");
  int __cil_tmp51 ;
  ...
  int __cil_tmp55 ;
    klee_make_symbolic(&__cil_tmp55, sizeof(int), "__cil_tmp55");
  int __cil_tmp56 ;
...
{ int currentIrpStack__Parameters__DeviceIoControl__IoControlCode = __VERIFIER_nondet_int() ;
  int deviceExtension__TargetDeviceObject = __VERIFIER_nondet_int() ;
  int irpSp__Control ;
    klee_make_symbolic(&irpSp__Control, sizeof(int), "irpSp__Control");
  int tmp ;
  int tmp___0 ;
  int __cil_tmp8 ;
...
{ int pirp__IoStatus__Status ;
    klee_make_symbolic(&pirp__IoStatus__Status, sizeof(int), "pirp__IoStatus__Status");
...
{ int Irp__PendingReturned = __VERIFIER_nondet_int() ;
  int returnVal2 ;
    klee_make_symbolic(&returnVal2, sizeof(int), "returnVal2");
  int compRetStatus ;
    klee_make_symbolic(&compRetStatus, sizeof(int), "compRetStatus");
...
int PoCallDriver(int DeviceObject , int Irp ) 
{
  int compRetStatus ;
  int returnVal ;
    klee_make_symbolic(&returnVal, sizeof(int), "returnVal");
  int lcontext = __VERIFIER_nondet_int() ;
