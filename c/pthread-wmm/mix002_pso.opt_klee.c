...
int __unbuffered_cnt;
    klee_make_symbolic(&__unbuffered_cnt, sizeof(int), "__unbuffered_cnt");
...
int __unbuffered_p0_EAX;
    klee_make_symbolic(&__unbuffered_p0_EAX, sizeof(int), "__unbuffered_p0_EAX");
...
int __unbuffered_p0_EBX;
    klee_make_symbolic(&__unbuffered_p0_EBX, sizeof(int), "__unbuffered_p0_EBX");
...
int __unbuffered_p1_EAX;
    klee_make_symbolic(&__unbuffered_p1_EAX, sizeof(int), "__unbuffered_p1_EAX");
...
int __unbuffered_p1_EBX;
    klee_make_symbolic(&__unbuffered_p1_EBX, sizeof(int), "__unbuffered_p1_EBX");
...
int __unbuffered_p2_EAX;
    klee_make_symbolic(&__unbuffered_p2_EAX, sizeof(int), "__unbuffered_p2_EAX");
...
int __unbuffered_p2_EBX;
    klee_make_symbolic(&__unbuffered_p2_EBX, sizeof(int), "__unbuffered_p2_EBX");
