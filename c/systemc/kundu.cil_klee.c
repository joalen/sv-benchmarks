...
int P_2_pc  ;
    klee_make_symbolic(&P_2_pc, sizeof(int), "P_2_pc");
int P_2_st  ;
    klee_make_symbolic(&P_2_st, sizeof(int), "P_2_st");
int P_2_i  ;
    klee_make_symbolic(&P_2_i, sizeof(int), "P_2_i");
int P_2_ev  ;
    klee_make_symbolic(&P_2_ev, sizeof(int), "P_2_ev");
void P_2(void) 
{ 
