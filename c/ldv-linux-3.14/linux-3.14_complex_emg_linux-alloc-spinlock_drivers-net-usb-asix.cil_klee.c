...
struct ax88172a_private {
   ...
   u16 oldmode ;
   int use_embdphy ;
    klee_make_symbolic(&use_embdphy, sizeof(int), "use_embdphy");
   struct asix_rx_fixup_info rx_fixup_info ;
};
struct device_private {
   void *driver_data ;
...
{ 
  ...
  unsigned long gpio_bits ;
    klee_make_symbolic(&gpio_bits, sizeof(long), "gpio_bits");
  struct _ddebug descriptor ;
  long tmp ;
...
{ 
  ...
  int ret ;
  int embd_phy ;
    klee_make_symbolic(&embd_phy, sizeof(int), "embd_phy");
  u16 rx_ctl ;
  int tmp ;
  struct _ddebug descriptor ;
  long tmp___0 ;
...
{ 
  ...
  u8 status ;
  int gpio0 ;
    klee_make_symbolic(&gpio0, sizeof(int), "gpio0");
  u32 phyid ;
  struct _ddebug descriptor ;
  long tmp ;
  struct _ddebug descriptor___0 ;
...
{ 
  ...
  u16 medium ;
  int old_rx_urb_size ;
    klee_make_symbolic(&old_rx_urb_size, sizeof(int), "old_rx_urb_size");
...
{ 
  ...
  void *tmp ;
  int ll_mtu ;
    klee_make_symbolic(&ll_mtu, sizeof(int), "ll_mtu");
  struct _ddebug descriptor ;
  long tmp___0 ;
...
int ldv_0_ldv_param_18_2_default  ;
    klee_make_symbolic(&ldv_0_ldv_param_18_2_default, sizeof(int), "ldv_0_ldv_param_18_2_default");
...
int ldv_1_ldv_param_18_2_default  ;
    klee_make_symbolic(&ldv_1_ldv_param_18_2_default, sizeof(int), "ldv_1_ldv_param_18_2_default");
...
unsigned int ldv_5_ldv_param_20_2_default  ;
    klee_make_symbolic(&ldv_5_ldv_param_20_2_default, sizeof(int), "ldv_5_ldv_param_20_2_default");
...
{ 
  ...
  int headroom ;
    klee_make_symbolic(&headroom, sizeof(int), "headroom");
  unsigned int tmp ;
  int tailroom ;
    klee_make_symbolic(&tailroom, sizeof(int), "tailroom");
  int tmp___0 ;
  u32 packet_len ;
  u32 padbytes ;
  void *tmp___1 ;
