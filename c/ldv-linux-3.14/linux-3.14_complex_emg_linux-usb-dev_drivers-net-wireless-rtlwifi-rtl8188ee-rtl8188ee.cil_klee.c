...
struct wireless_stats {
   unsigned long txbytesunicast ;
    klee_make_symbolic(&txbytesunicast, sizeof(long), "txbytesunicast");
   unsigned long txbytesmulticast ;
    klee_make_symbolic(&txbytesmulticast, sizeof(long), "txbytesmulticast");
   unsigned long txbytesbroadcast ;
    klee_make_symbolic(&txbytesbroadcast, sizeof(long), "txbytesbroadcast");
   unsigned long rxbytesunicast ;
    klee_make_symbolic(&rxbytesunicast, sizeof(long), "rxbytesunicast");
   long rx_snr_db[4U] ;
   long recv_signal_power ;
    klee_make_symbolic(&recv_signal_power, sizeof(long), "recv_signal_power");
   long signal_quality ;
    klee_make_symbolic(&signal_quality, sizeof(long), "signal_quality");
   long last_sigstrength_inpercent ;
    klee_make_symbolic(&last_sigstrength_inpercent, sizeof(long), "last_sigstrength_inpercent");
   u32 rssi_calculate_cnt ;
   long signal_strength ;
    klee_make_symbolic(&signal_strength, sizeof(long), "signal_strength");
...
struct rssi_sta {
   long undec_sm_pwdb ;
    klee_make_symbolic(&undec_sm_pwdb, sizeof(long), "undec_sm_pwdb");
   long undec_sm_cck ;
    klee_make_symbolic(&undec_sm_cck, sizeof(long), "undec_sm_cck");
};
struct rtl_tid_data {
   u16 seq_number ;
...
struct rtl_io {
   ...
   unsigned long pci_mem_end ;
    klee_make_symbolic(&pci_mem_end, sizeof(long), "pci_mem_end");
   unsigned long pci_mem_start ;
    klee_make_symbolic(&pci_mem_start, sizeof(long), "pci_mem_start");
   unsigned long pci_base_addr ;
    klee_make_symbolic(&pci_base_addr, sizeof(long), "pci_base_addr");
...
struct rtl_dm {
   long entry_min_undec_sm_pwdb ;
    klee_make_symbolic(&entry_min_undec_sm_pwdb, sizeof(long), "entry_min_undec_sm_pwdb");
   long undec_sm_cck ;
   long undec_sm_pwdb ;
   long entry_max_undec_sm_pwdb ;
    klee_make_symbolic(&entry_max_undec_sm_pwdb, sizeof(long), "entry_max_undec_sm_pwdb");
   s32 ofdm_pkt_cnt ;
   ...
   char ofdm_index[2U] ;
   char cck_index ;
    klee_make_symbolic(&cck_index, sizeof(char), "cck_index");
   char delta_power_index ;
    klee_make_symbolic(&delta_power_index, sizeof(char), "delta_power_index");
   char delta_power_index_last ;
    klee_make_symbolic(&delta_power_index_last, sizeof(char), "delta_power_index_last");
   char power_index_offset ;
    klee_make_symbolic(&power_index_offset, sizeof(char), "power_index_offset");
...
struct rtl_efuse {
   ...
   u8 autoload_status ;
   short epromtype ;
    klee_make_symbolic(&epromtype, sizeof(short), "epromtype");
   u16 eeprom_vid ;
   u16 eeprom_did ;
   u16 eeprom_svid ;
   u16 eeprom_smid ;
...
struct rtl_ps_ctl {
   ...
   unsigned long last_sleep_jiffies ;
    klee_make_symbolic(&last_sleep_jiffies, sizeof(long), "last_sleep_jiffies");
   unsigned long last_awake_jiffies ;
    klee_make_symbolic(&last_awake_jiffies, sizeof(long), "last_awake_jiffies");
   unsigned long last_delaylps_stamp_jiffies ;
    klee_make_symbolic(&last_delaylps_stamp_jiffies, sizeof(long), "last_delaylps_stamp_jiffies");
   unsigned long last_dtim ;
    klee_make_symbolic(&last_dtim, sizeof(long), "last_dtim");
...
struct rtl_debug {
   ...
   int global_debuglevel ;
    klee_make_symbolic(&global_debuglevel, sizeof(int), "global_debuglevel");
...
struct rtl_dmsp_ctl {
   ...
   long rssivalmin_for_anothermacofdmsp ;
    klee_make_symbolic(&rssivalmin_for_anothermacofdmsp, sizeof(long), "rssivalmin_for_anothermacofdmsp");
};
struct ps_t {
   u8 pre_ccastate ;
   u8 cur_ccasate ;
   ...
   u8 cur_rfstate ;
   long rssi_val_min ;
    klee_make_symbolic(&rssi_val_min, sizeof(long), "rssi_val_min");
};
struct dig_t {
   u32 rssi_lowthresh ;
   u32 rssi_highthresh ;
   ...
   long last_min_undec_pwdb_for_dm ;
    klee_make_symbolic(&last_min_undec_pwdb_for_dm, sizeof(long), "last_min_undec_pwdb_for_dm");
   long rssi_highpower_lowthresh ;
    klee_make_symbolic(&rssi_highpower_lowthresh, sizeof(long), "rssi_highpower_lowthresh");
   long rssi_highpower_highthresh ;
    klee_make_symbolic(&rssi_highpower_highthresh, sizeof(long), "rssi_highpower_highthresh");
   u32 recover_cnt ;
   u32 pre_igvalue ;
   u32 cur_igvalue ;
   long rssi_val ;
    klee_make_symbolic(&rssi_val, sizeof(long), "rssi_val");
   u8 dig_enable_flag ;
   ...
   char back_val ;
    klee_make_symbolic(&back_val, sizeof(char), "back_val");
   char back_range_max ;
    klee_make_symbolic(&back_range_max, sizeof(char), "back_range_max");
   char back_range_min ;
    klee_make_symbolic(&back_range_min, sizeof(char), "back_range_min");
   u8 rx_gain_max ;
   u8 rx_gain_min ;
   ...
   char backoffval_range_max ;
    klee_make_symbolic(&backoffval_range_max, sizeof(char), "backoffval_range_max");
   char backoffval_range_min ;
    klee_make_symbolic(&backoffval_range_min, sizeof(char), "backoffval_range_min");
   u8 dig_min_0 ;
   u8 dig_min_1 ;
...
struct rtl_priv {
   ...
   int max_fw_size ;
    klee_make_symbolic(&max_fw_size, sizeof(int), "max_fw_size");
   ...
   __le32 *usb_data ;
   int usb_data_index ;
    klee_make_symbolic(&usb_data_index, sizeof(int), "usb_data_index");
   bool initialized ;
   bool enter_ps ;
   u8 rate_mask[5U] ;
   u8 priv[0U] ;
...
struct rtl_pci {
   ...
   int rxringcount ;
    klee_make_symbolic(&rxringcount, sizeof(int), "rxringcount");
   u16 rxbuffersize ;
   u32 receive_config ;
   u8 irq_alloc ;
   u32 irq_mask[2U] ;
...
{ 
  long ele_a ;
    klee_make_symbolic(&ele_a, sizeof(long), "ele_a");
  long ele_d ;
    klee_make_symbolic(&ele_d, sizeof(long), "ele_d");
  long ele_c ;
    klee_make_symbolic(&ele_c, sizeof(long), "ele_c");
  long value32 ;
    klee_make_symbolic(&value32, sizeof(long), "value32");
...
{ 
  ...
  u8 indx___0 ;
  long x___0 ;
    klee_make_symbolic(&x___0, sizeof(long), "x___0");
  long y___0 ;
    klee_make_symbolic(&y___0, sizeof(long), "y___0");
...
{ 
  ...
  long tmp_entry_max_pwdb ;
    klee_make_symbolic(&tmp_entry_max_pwdb, sizeof(long), "tmp_entry_max_pwdb");
  long tmp_entry_min_pwdb ;
    klee_make_symbolic(&tmp_entry_min_pwdb, sizeof(long), "tmp_entry_min_pwdb");
  u64 cur_txok_cnt ;
  u64 cur_rxok_cnt ;
...
{ 
  ...
  long ele_d ;
  long temp_cck ;
    klee_make_symbolic(&temp_cck, sizeof(long), "temp_cck");
  char ofdm_index[2U] ;
  char cck_index ;
  char ofdm_old[2U] ;
  char cck_old ;
    klee_make_symbolic(&cck_old, sizeof(char), "cck_old");
  int i ;
  bool is2t ;
  u8 ofdm_min_index ;
  u8 rf ;
...
{ 
  ...
  int jj ;
  int kk ;
    klee_make_symbolic(&kk, sizeof(int), "kk");
  long tmp ;
  long tmp___0 ;
  long tmp___1 ;
...
{ 
  long offset ;
  long pwrout_dbm ;
    klee_make_symbolic(&pwrout_dbm, sizeof(long), "pwrout_dbm");
...
{ 
  ...
  u8 level ;
  long dbm ;
    klee_make_symbolic(&dbm, sizeof(long), "dbm");
  long tmp ;
  long tmp___0 ;
...
{ 
  ...
  long y ;
  long tx0_c ;
    klee_make_symbolic(&tx0_c, sizeof(long), "tx0_c");
  u32 tmp ;
...
{ 
  ...
  bool patha_ok ;
  long reg_e94 ;
    klee_make_symbolic(&reg_e94, sizeof(long), "reg_e94");
  long reg_e9c ;
    klee_make_symbolic(&reg_e9c, sizeof(long), "reg_e9c");
  long reg_ea4 ;
    klee_make_symbolic(&reg_ea4, sizeof(long), "reg_ea4");
  long reg_eb4 ;
    klee_make_symbolic(&reg_eb4, sizeof(long), "reg_eb4");
  long reg_ebc ;
    klee_make_symbolic(&reg_ebc, sizeof(long), "reg_ebc");
  long reg_tmp ;
    klee_make_symbolic(&reg_tmp, sizeof(long), "reg_tmp");
  bool is12simular ;
  bool is13simular ;
  bool is23simular ;
  u32 iqk_bb_reg[9U] ;
...
unsigned char ldv_0_ldv_param_28_6_default  ;
    klee_make_symbolic(&ldv_0_ldv_param_28_6_default, sizeof(char), "ldv_0_ldv_param_28_6_default");
unsigned int ldv_0_ldv_param_31_1_default  ;
    klee_make_symbolic(&ldv_0_ldv_param_31_1_default, sizeof(int), "ldv_0_ldv_param_31_1_default");
...
unsigned char ldv_0_ldv_param_34_2_default  ;
    klee_make_symbolic(&ldv_0_ldv_param_34_2_default, sizeof(char), "ldv_0_ldv_param_34_2_default");
...
unsigned int ldv_0_ldv_param_40_2_default  ;
    klee_make_symbolic(&ldv_0_ldv_param_40_2_default, sizeof(int), "ldv_0_ldv_param_40_2_default");
unsigned int ldv_0_ldv_param_40_3_default  ;
    klee_make_symbolic(&ldv_0_ldv_param_40_3_default, sizeof(int), "ldv_0_ldv_param_40_3_default");
...
unsigned char ldv_0_ldv_param_60_1_default  ;
    klee_make_symbolic(&ldv_0_ldv_param_60_1_default, sizeof(char), "ldv_0_ldv_param_60_1_default");
unsigned int ldv_0_ldv_param_63_1_default  ;
    klee_make_symbolic(&ldv_0_ldv_param_63_1_default, sizeof(int), "ldv_0_ldv_param_63_1_default");
unsigned int ldv_0_ldv_param_63_2_default  ;
    klee_make_symbolic(&ldv_0_ldv_param_63_2_default, sizeof(int), "ldv_0_ldv_param_63_2_default");
unsigned int ldv_0_ldv_param_63_3_default  ;
    klee_make_symbolic(&ldv_0_ldv_param_63_3_default, sizeof(int), "ldv_0_ldv_param_63_3_default");
...
unsigned char ldv_0_ldv_param_73_2_default  ;
    klee_make_symbolic(&ldv_0_ldv_param_73_2_default, sizeof(char), "ldv_0_ldv_param_73_2_default");
unsigned char *ldv_0_ldv_param_73_3_default  ;
unsigned char ldv_0_ldv_param_76_1_default  ;
    klee_make_symbolic(&ldv_0_ldv_param_76_1_default, sizeof(char), "ldv_0_ldv_param_76_1_default");
unsigned char *ldv_0_ldv_param_76_2_default  ;
unsigned int ldv_0_ldv_param_79_1_default  ;
    klee_make_symbolic(&ldv_0_ldv_param_79_1_default, sizeof(int), "ldv_0_ldv_param_79_1_default");
unsigned char *ldv_0_ldv_param_79_2_default  ;
_Bool ldv_0_ldv_param_79_3_default  ;
unsigned char ldv_0_ldv_param_79_4_default  ;
    klee_make_symbolic(&ldv_0_ldv_param_79_4_default, sizeof(char), "ldv_0_ldv_param_79_4_default");
_Bool ldv_0_ldv_param_79_5_default  ;
_Bool ldv_0_ldv_param_79_6_default  ;
int ldv_0_ldv_param_83_1_default  ;
    klee_make_symbolic(&ldv_0_ldv_param_83_1_default, sizeof(int), "ldv_0_ldv_param_83_1_default");
unsigned int ldv_0_ldv_param_87_2_default  ;
    klee_make_symbolic(&ldv_0_ldv_param_87_2_default, sizeof(int), "ldv_0_ldv_param_87_2_default");
unsigned int ldv_0_ldv_param_87_3_default  ;
    klee_make_symbolic(&ldv_0_ldv_param_87_3_default, sizeof(int), "ldv_0_ldv_param_87_3_default");
unsigned int ldv_0_ldv_param_87_4_default  ;
    klee_make_symbolic(&ldv_0_ldv_param_87_4_default, sizeof(int), "ldv_0_ldv_param_87_4_default");
unsigned char ldv_0_ldv_param_91_1_default  ;
    klee_make_symbolic(&ldv_0_ldv_param_91_1_default, sizeof(char), "ldv_0_ldv_param_91_1_default");
unsigned int ldv_0_ldv_param_94_1_default  ;
    klee_make_symbolic(&ldv_0_ldv_param_94_1_default, sizeof(int), "ldv_0_ldv_param_94_1_default");
unsigned int ldv_0_ldv_param_94_2_default  ;
    klee_make_symbolic(&ldv_0_ldv_param_94_2_default, sizeof(int), "ldv_0_ldv_param_94_2_default");
unsigned char ldv_0_ldv_param_97_2_default  ;
    klee_make_symbolic(&ldv_0_ldv_param_97_2_default, sizeof(char), "ldv_0_ldv_param_97_2_default");
...
{ 
  ...
  struct rtl_dm *rtldm ;
  char rx_pwr_all ;
    klee_make_symbolic(&rx_pwr_all, sizeof(char), "rx_pwr_all");
  char rx_pwr[4U] ;
  u8 rf_rx_num ;
  u8 evm ;
  u8 pwdb_all ;
