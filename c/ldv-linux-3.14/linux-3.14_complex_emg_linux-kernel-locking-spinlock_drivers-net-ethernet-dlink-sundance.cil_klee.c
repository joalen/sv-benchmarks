...
struct netdev_private {
   ...
   int cur_task ;
    klee_make_symbolic(&cur_task, sizeof(int), "cur_task");
   spinlock_t mcastlock ;
   u16 mcast_filter[4U] ;
   struct mii_if_info mii_if ;
   int mii_preamble_required ;
    klee_make_symbolic(&mii_preamble_required, sizeof(int), "mii_preamble_required");
...
{ 
  ...
  int phy_end ;
    klee_make_symbolic(&phy_end, sizeof(int), "phy_end");
  int phy_idx ;
...
{ 
  ...
  void *ioaddr ;
  int mii_lpa ;
    klee_make_symbolic(&mii_lpa, sizeof(int), "mii_lpa");
  int tmp___0 ;
  int negotiated ;
...
{ 
  ...
  void *ioaddr ;
  int hw_frame_id ;
    klee_make_symbolic(&hw_frame_id, sizeof(int), "hw_frame_id");
  int tx_cnt ;
  ...
  int i ;
  int intr_status ;
    klee_make_symbolic(&intr_status, sizeof(int), "intr_status");
  unsigned int tmp___0 ;
  unsigned int tmp___1 ;
  unsigned int tmp___2 ;
  unsigned int tmp___3 ;
  ...
  struct sk_buff *skb ;
  int sw_frame_id ;
    klee_make_symbolic(&sw_frame_id, sizeof(int), "sw_frame_id");
  int entry___0 ;
