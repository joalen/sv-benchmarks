...
static int force32  ;
    klee_make_symbolic(&force32, sizeof(int), "force32");
...
{ 
  ...
  int rx_int_var ;
    klee_make_symbolic(&rx_int_var, sizeof(int), "rx_int_var");
  int tx_int_var ;
    klee_make_symbolic(&tx_int_var, sizeof(int), "tx_int_var");
  int boguscnt ;
...
{ 
  int bogus_cnt ;
    klee_make_symbolic(&bogus_cnt, sizeof(int), "bogus_cnt");
  unsigned char tmp ;
