...
struct ace_private {
   ...
   unsigned long std_refill_busy ;
    klee_make_symbolic(&std_refill_busy, sizeof(long), "std_refill_busy");
   unsigned long mini_refill_busy ;
    klee_make_symbolic(&mini_refill_busy, sizeof(long), "mini_refill_busy");
   unsigned long jumbo_refill_busy ;
    klee_make_symbolic(&jumbo_refill_busy, sizeof(long), "jumbo_refill_busy");
   ...
   int tasklet_pending ;
    klee_make_symbolic(&tasklet_pending, sizeof(int), "tasklet_pending");
   int jumbo ;
...
{ 
  ...
  struct ace_private *ap ;
  int boards_found ;
    klee_make_symbolic(&boards_found, sizeof(int), "boards_found");
  void *tmp ;
  int tmp___0 ;
  void *tmp___1 ;
...
{ 
  ...
  struct pci_dev *pdev ;
  unsigned long myjif ;
    klee_make_symbolic(&myjif, sizeof(long), "myjif");
  u64 tmp_ptr ;
  u32 tig_ver ;
  u32 mac1 ;
  u32 mac2 ;
  ...
  int board_idx ;
  int ecode ;
    klee_make_symbolic(&ecode, sizeof(int), "ecode");
  short i ;
  unsigned char cache_size ;
    klee_make_symbolic(&cache_size, sizeof(char), "cache_size");
  void *tmp___0 ;
  unsigned int tmp___1 ;
  unsigned int tmp___2 ;
...
{ 
  ...
  short i ;
  short idx ;
    klee_make_symbolic(&idx, sizeof(short), "idx");
  struct sk_buff *skb ;
  struct rx_desc *rd ;
  dma_addr_t mapping ;
...
{ 
  ...
  u32 idx ;
  int mini_count ;
    klee_make_symbolic(&mini_count, sizeof(int), "mini_count");
  int std_count ;
    klee_make_symbolic(&std_count, sizeof(int), "std_count");
  ...
  u32 skbidx ;
  int bd_flags ;
    klee_make_symbolic(&bd_flags, sizeof(int), "bd_flags");
  int desc_type ;
...
{ 
  ...
  int cur_size ;
  int run_tasklet ;
    klee_make_symbolic(&run_tasklet, sizeof(int), "run_tasklet");
  int tmp___2 ;
  int tmp___3 ;
  int tmp___4 ;
  bool tmp___5 ;
...
{ 
  ...
  unsigned long maxjiff ;
    klee_make_symbolic(&maxjiff, sizeof(long), "maxjiff");
  int tmp___0 ;
  dma_addr_t mapping ;
  u32 vlan_tag ;
  int tmp___1 ;
...
{ 
  void *tdest ;
  short tsize ;
    klee_make_symbolic(&tsize, sizeof(short), "tsize");
  short i ;
  u32 __min1 ;
  u32 __min2 ;
  u32 __min1___0 ;
