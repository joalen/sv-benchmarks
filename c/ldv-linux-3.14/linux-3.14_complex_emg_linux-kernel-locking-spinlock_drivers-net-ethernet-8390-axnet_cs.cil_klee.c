...
struct axnet_dev_t {
   ...
   u_char duplex_flag ;
    klee_make_symbolic(&duplex_flag, sizeof(char), "duplex_flag");
   int phy_id ;
...
{ 
  ...
  int j ;
  int j2 ;
    klee_make_symbolic(&j2, sizeof(int), "j2");
  int ret ;
  struct _ddebug descriptor ;
  long tmp___0 ;
...
{ 
  long e8390_base ;
    klee_make_symbolic(&e8390_base, sizeof(long), "e8390_base");
  struct ei_device *ei_local ;
  void *tmp ;
  int txsr ;
    klee_make_symbolic(&txsr, sizeof(int), "txsr");
  int isr ;
    klee_make_symbolic(&isr, sizeof(int), "isr");
  int tickssofar ;
    klee_make_symbolic(&tickssofar, sizeof(int), "tickssofar");
...
{ 
  ...
  int length ;
  int send_length ;
    klee_make_symbolic(&send_length, sizeof(int), "send_length");
  int output_page ;
    klee_make_symbolic(&output_page, sizeof(int), "output_page");
  unsigned long flags ;
  u8 packet[60U] ;
  int _max1 ;
...
{ 
  ...
  long e8390_base ;
  int interrupts ;
    klee_make_symbolic(&interrupts, sizeof(int), "interrupts");
  int nr_serviced ;
    klee_make_symbolic(&nr_serviced, sizeof(int), "nr_serviced");
  int i ;
  struct ei_device *ei_local ;
  int handled ;
...
{ 
  ...
  unsigned char tx_was_aborted ;
    klee_make_symbolic(&tx_was_aborted, sizeof(char), "tx_was_aborted");
...
{ 
  ...
  unsigned char rxing_page ;
    klee_make_symbolic(&rxing_page, sizeof(char), "rxing_page");
  unsigned char this_frame ;
    klee_make_symbolic(&this_frame, sizeof(char), "this_frame");
  unsigned char next_frame ;
    klee_make_symbolic(&next_frame, sizeof(char), "next_frame");
  unsigned short current_offset ;
    klee_make_symbolic(&current_offset, sizeof(short), "current_offset");
  int rx_pkt_count ;
    klee_make_symbolic(&rx_pkt_count, sizeof(int), "rx_pkt_count");
  struct e8390_pkt_hdr rx_frame ;
  int pkt_len ;
    klee_make_symbolic(&pkt_len, sizeof(int), "pkt_len");
  int pkt_stat ;
    klee_make_symbolic(&pkt_stat, sizeof(int), "pkt_stat");
  unsigned char tmp___0 ;
  struct sk_buff *skb ;
...
{ 
  ...
  unsigned char was_txing ;
    klee_make_symbolic(&was_txing, sizeof(char), "was_txing");
  unsigned char must_resend ;
    klee_make_symbolic(&must_resend, sizeof(char), "must_resend");
  struct ei_device *ei_local ;
  void *tmp___0 ;
  unsigned char tmp___1 ;
  struct _ddebug descriptor ;
  ...
  unsigned char tx_completed ;
    klee_make_symbolic(&tx_completed, sizeof(char), "tx_completed");
...
{ 
  ...
  int i ;
  int endcfg ;
    klee_make_symbolic(&endcfg, sizeof(int), "endcfg");
  short tmp___1 ;
  unsigned char tmp___2 ;
  short tmp___3 ;
