...
static int tlan_devices_installed  ;
    klee_make_symbolic(&tlan_devices_installed, sizeof(int), "tlan_devices_installed");
static int aui[8U]  ;
...
static int tlan_have_pci  ;
    klee_make_symbolic(&tlan_have_pci, sizeof(int), "tlan_have_pci");
static int tlan_have_eisa  ;
    klee_make_symbolic(&tlan_have_eisa, sizeof(int), "tlan_have_eisa");
...
{ 
  ...
  unsigned long flags ;
  unsigned int txlen ;
    klee_make_symbolic(&txlen, sizeof(int), "txlen");
  int tmp___0 ;
  unsigned int _max1 ;
...
{ 
  ...
  void *tmp ;
  int eoc ;
    klee_make_symbolic(&eoc, sizeof(int), "eoc");
...
{ 
  ...
  bool err ;
  int minten ;
    klee_make_symbolic(&minten, sizeof(int), "minten");
  struct tlan_priv *priv ;
  void *tmp___0 ;
  unsigned long flags ;
