...
struct cnic_eth_dev {
   ...
   u32 ctx_tbl_len ;
   int ctx_blk_size ;
    klee_make_symbolic(&ctx_blk_size, sizeof(int), "ctx_blk_size");
   u32 starting_cid ;
   u32 max_iscsi_conn ;
   u32 max_fcoe_conn ;
   u32 max_rdma_conn ;
   ...
   u8 iscsi_mac[6U] ;
   int num_irq ;
    klee_make_symbolic(&num_irq, sizeof(int), "num_irq");
...
struct bnx2_sw_tx_bd {
   ...
   unsigned short is_gso ;
    klee_make_symbolic(&is_gso, sizeof(short), "is_gso");
...
struct bnx2_napi {
   ...
   u32 cnic_tag ;
   int cnic_present ;
    klee_make_symbolic(&cnic_present, sizeof(int), "cnic_present");
...
struct bnx2 {
   ...
   unsigned int current_interval ;
    klee_make_symbolic(&current_interval, sizeof(int), "current_interval");
   struct timer_list timer ;
   ...
   u32 fw_last_msg ;
   int rx_max_ring ;
    klee_make_symbolic(&rx_max_ring, sizeof(int), "rx_max_ring");
   int rx_ring_size ;
    klee_make_symbolic(&rx_ring_size, sizeof(int), "rx_ring_size");
   int rx_max_pg_ring ;
    klee_make_symbolic(&rx_max_pg_ring, sizeof(int), "rx_max_pg_ring");
   int rx_pg_ring_size ;
    klee_make_symbolic(&rx_pg_ring_size, sizeof(int), "rx_pg_ring_size");
   ...
   int ctx_pages ;
    klee_make_symbolic(&ctx_pages, sizeof(int), "ctx_pages");
   void *ctx_blk[4U] ;
   ...
   int status_stats_size ;
    klee_make_symbolic(&status_stats_size, sizeof(int), "status_stats_size");
   struct bnx2_irq irq_tbl[9U] ;
   int irq_nvecs ;
    klee_make_symbolic(&irq_nvecs, sizeof(int), "irq_nvecs");
   u8 func ;
   u8 num_tx_rings ;
   u8 num_rx_rings ;
   int num_req_tx_rings ;
    klee_make_symbolic(&num_req_tx_rings, sizeof(int), "num_req_tx_rings");
   int num_req_rx_rings ;
    klee_make_symbolic(&num_req_rx_rings, sizeof(int), "num_req_rx_rings");
   u32 leds_save ;
...
{ 
  ...
  int sb_id ;
    klee_make_symbolic(&sb_id, sizeof(int), "sb_id");
...
{ 
  int i ;
  int status_blk_size ;
    klee_make_symbolic(&status_blk_size, sizeof(int), "status_blk_size");
  int err ;
...
{ 
  ...
  u32 new_bmcr ;
  int force_link_down ;
    klee_make_symbolic(&force_link_down, sizeof(int), "force_link_down");
  int tmp___0 ;
  int tmp___1 ;
  u32 tmp___2 ;
...
{ 
  ...
  u16 sw_ring_cons ;
  int tx_pkt ;
    klee_make_symbolic(&tx_pkt, sizeof(int), "tx_pkt");
  int index ;
...
{ 
  ...
  unsigned int raw_len ;
    klee_make_symbolic(&raw_len, sizeof(int), "raw_len");
  int pages ;
  long tmp ;
  struct l2_fhdr *tmp___0 ;
  unsigned int i ;
...
{ 
  ...
  int rx_pkt ;
    klee_make_symbolic(&rx_pkt, sizeof(int), "rx_pkt");
  int pg_ring_used ;
    klee_make_symbolic(&pg_ring_used, sizeof(int), "pg_ring_used");
  unsigned int len ;
...
{ 
  ...
  __u32 tmp___9 ;
  int j___1 ;
    klee_make_symbolic(&j___1, sizeof(int), "j___1");
  __u32 tmp___10 ;
  __u32 tmp___11 ;
...
{ 
  ...
  int j ;
  int entry_count ;
    klee_make_symbolic(&entry_count, sizeof(int), "entry_count");
  int rc ;
...
{ 
  ...
  int rc ;
  int align_start ;
    klee_make_symbolic(&align_start, sizeof(int), "align_start");
  int align_end ;
    klee_make_symbolic(&align_end, sizeof(int), "align_end");
  void *tmp ;
  void *tmp___0 ;
  u32 page_start ;
  u32 page_end ;
...
{ 
  ...
  int i ;
  int is_5709 ;
    klee_make_symbolic(&is_5709, sizeof(int), "is_5709");
...
{ 
  int check_link ;
    klee_make_symbolic(&check_link, sizeof(int), "check_link");
  u32 bmcr ;
  int tmp ;
  u32 phy2 ;
  u32 bmcr___0 ;
...
{ 
  int i ;
  int total_vecs ;
    klee_make_symbolic(&total_vecs, sizeof(int), "total_vecs");
  int rc ;
...
{ 
  ...
  int tmp ;
  int msix_vecs ;
    klee_make_symbolic(&msix_vecs, sizeof(int), "msix_vecs");
  int _max1 ;
  int _max2 ;
  int _max1___0 ;
  int _max2___0 ;
...
{ 
  ...
  void *tmp ;
  int support_serdes ;
    klee_make_symbolic(&support_serdes, sizeof(int), "support_serdes");
  int support_copper ;
    klee_make_symbolic(&support_copper, sizeof(int), "support_copper");
  bool tmp___0 ;
...
{ 
  int version_printed ;
    klee_make_symbolic(&version_printed, sizeof(int), "version_printed");
  struct net_device *dev ;
  struct bnx2 *bp ;
  int rc ;
  char str[40U] ;
...
unsigned long long ldv_1_ldv_param_40_1_default  ;
    klee_make_symbolic(&ldv_1_ldv_param_40_1_default, sizeof(long), "ldv_1_ldv_param_40_1_default");
