...
struct soc_camera_device {
   ...
   unsigned char devnum ;
    klee_make_symbolic(&devnum, sizeof(char), "devnum");
...
struct sh_csi2_client_config {
   ...
   unsigned char lanes ;
    klee_make_symbolic(&lanes, sizeof(char), "lanes");
...
struct sh_mobile_ceu_cam {
   unsigned int ceu_left ;
    klee_make_symbolic(&ceu_left, sizeof(int), "ceu_left");
   unsigned int ceu_top ;
    klee_make_symbolic(&ceu_top, sizeof(int), "ceu_top");
   unsigned int width ;
   unsigned int height ;
...
{ 
  ...
  unsigned long top1 ;
    klee_make_symbolic(&top1, sizeof(long), "top1");
  unsigned long top2 ;
    klee_make_symbolic(&top2, sizeof(long), "top2");
  unsigned long bottom1 ;
    klee_make_symbolic(&bottom1, sizeof(long), "bottom1");
  unsigned long bottom2 ;
    klee_make_symbolic(&bottom2, sizeof(long), "bottom2");
  u32 status ;
  bool planar ;
  int ret ;
  u32 tmp ;
...
{ 
  unsigned int mant_pre ;
    klee_make_symbolic(&mant_pre, sizeof(int), "mant_pre");
...
{ 
  ...
  unsigned int cdwdr_width ;
    klee_make_symbolic(&cdwdr_width, sizeof(int), "cdwdr_width");
  unsigned int in_width ;
    klee_make_symbolic(&in_width, sizeof(int), "in_width");
  unsigned int in_height ;
    klee_make_symbolic(&in_height, sizeof(int), "in_height");
  unsigned int left_offset ;
    klee_make_symbolic(&left_offset, sizeof(int), "left_offset");
  unsigned int top_offset ;
    klee_make_symbolic(&top_offset, sizeof(int), "top_offset");
  u32 camor ;
  struct _ddebug descriptor ;
  long tmp___0 ;
  int __ret_warn_on ;
  ...
  unsigned int w_factor ;
    klee_make_symbolic(&w_factor, sizeof(int), "w_factor");
...
{ 
  ...
  unsigned long common_flags ;
    klee_make_symbolic(&common_flags, sizeof(long), "common_flags");
  u32 capsr ;
  u32 tmp___1 ;
  unsigned int yuv_lineskip ;
    klee_make_symbolic(&yuv_lineskip, sizeof(int), "yuv_lineskip");
  int ret ;
  int tmp___2 ;
  int tmp___3 ;
...
{ 
  ...
  int formats ;
    klee_make_symbolic(&formats, sizeof(int), "formats");
  struct sh_mobile_ceu_cam *cam ;
  enum v4l2_mbus_pixelcode code ;
...
{ 
  ...
  unsigned int scale_cam_h ;
    klee_make_symbolic(&scale_cam_h, sizeof(int), "scale_cam_h");
  unsigned int scale_cam_v ;
    klee_make_symbolic(&scale_cam_v, sizeof(int), "scale_cam_v");
  unsigned int scale_ceu_h ;
    klee_make_symbolic(&scale_ceu_h, sizeof(int), "scale_ceu_h");
  unsigned int scale_ceu_v ;
    klee_make_symbolic(&scale_ceu_v, sizeof(int), "scale_ceu_v");
  unsigned int out_width ;
    klee_make_symbolic(&out_width, sizeof(int), "out_width");
  unsigned int out_height ;
    klee_make_symbolic(&out_height, sizeof(int), "out_height");
  int interm_width ;
    klee_make_symbolic(&interm_width, sizeof(int), "interm_width");
  int interm_height ;
    klee_make_symbolic(&interm_height, sizeof(int), "interm_height");
  u32 capsr ;
  u32 cflcr ;
  int ret ;
  struct _ddebug descriptor ;
...
{ 
  ...
  unsigned int ceu_sub_width ;
    klee_make_symbolic(&ceu_sub_width, sizeof(int), "ceu_sub_width");
  unsigned int ceu_sub_height ;
    klee_make_symbolic(&ceu_sub_height, sizeof(int), "ceu_sub_height");
  u16 scale_v ;
  u16 scale_h ;
  int ret ;
  bool image_mode ;
