...
struct phy_table {
   ...
   int id ;
   int ta ;
    klee_make_symbolic(&ta, sizeof(int), "ta");
...
struct mii_phy {
   ...
   u_int ana ;
    klee_make_symbolic(&ana, sizeof(int), "ana");
   u_int fdx ;
    klee_make_symbolic(&fdx, sizeof(int), "fdx");
   u_int ttm ;
    klee_make_symbolic(&ttm, sizeof(int), "ttm");
   u_int mci ;
    klee_make_symbolic(&mci, sizeof(int), "mci");
};
struct sia_phy {
   u_char mc ;
   u_char ext ;
    klee_make_symbolic(&ext, sizeof(char), "ext");
   int csr13 ;
    klee_make_symbolic(&csr13, sizeof(int), "csr13");
   int csr14 ;
    klee_make_symbolic(&csr14, sizeof(int), "csr14");
   int csr15 ;
    klee_make_symbolic(&csr15, sizeof(int), "csr15");
   int gepc ;
    klee_make_symbolic(&gepc, sizeof(int), "gepc");
   int gep ;
    klee_make_symbolic(&gep, sizeof(int), "gep");
};
struct parameters {
   bool fdx ;
   int autosense ;
    klee_make_symbolic(&autosense, sizeof(int), "autosense");
};
struct de4x5_srom {
   ...
   char reserved[12U] ;
   char id_block_crc ;
    klee_make_symbolic(&id_block_crc, sizeof(char), "id_block_crc");
   char reserved2 ;
    klee_make_symbolic(&reserved2, sizeof(char), "reserved2");
   char version ;
   char num_controllers ;
    klee_make_symbolic(&num_controllers, sizeof(char), "num_controllers");
   char ieee_addr[6U] ;
   char info[100U] ;
   short chksum ;
...
struct pkt_stats {
   u_int bins[16U] ;
   u_int unicast ;
    klee_make_symbolic(&unicast, sizeof(int), "unicast");
   u_int multicast ;
   u_int broadcast ;
    klee_make_symbolic(&broadcast, sizeof(int), "broadcast");
   u_int excessive_collisions ;
    klee_make_symbolic(&excessive_collisions, sizeof(int), "excessive_collisions");
   u_int tx_underruns ;
    klee_make_symbolic(&tx_underruns, sizeof(int), "tx_underruns");
   u_int excessive_underruns ;
    klee_make_symbolic(&excessive_underruns, sizeof(int), "excessive_underruns");
   u_int rx_runt_frames ;
    klee_make_symbolic(&rx_runt_frames, sizeof(int), "rx_runt_frames");
   u_int rx_collision ;
    klee_make_symbolic(&rx_collision, sizeof(int), "rx_collision");
   u_int rx_dribble ;
    klee_make_symbolic(&rx_dribble, sizeof(int), "rx_dribble");
   u_int rx_overflow ;
    klee_make_symbolic(&rx_overflow, sizeof(int), "rx_overflow");
};
struct __anonstruct_cache_249 {
   u_long lock ;
    klee_make_symbolic(&lock, sizeof(long), "lock");
   s32 csr0 ;
   s32 csr6 ;
   s32 csr7 ;
   s32 gep ;
   ...
   s32 csr15 ;
   int save_cnt ;
    klee_make_symbolic(&save_cnt, sizeof(int), "save_cnt");
   struct sk_buff_head queue ;
};
struct de4x5_private {
   char adapter_name[80U] ;
   u_long interrupt ;
    klee_make_symbolic(&interrupt, sizeof(long), "interrupt");
   struct de4x5_desc *rx_ring ;
   struct de4x5_desc *tx_ring ;
   struct sk_buff *tx_skb[32U] ;
   struct sk_buff *rx_skb[8U] ;
   int rx_new ;
    klee_make_symbolic(&rx_new, sizeof(int), "rx_new");
   int rx_old ;
    klee_make_symbolic(&rx_old, sizeof(int), "rx_old");
   int tx_new ;
    klee_make_symbolic(&tx_new, sizeof(int), "tx_new");
   int tx_old ;
    klee_make_symbolic(&tx_old, sizeof(int), "tx_old");
   ...
   char rxRingSize ;
    klee_make_symbolic(&rxRingSize, sizeof(char), "rxRingSize");
   char txRingSize ;
    klee_make_symbolic(&txRingSize, sizeof(char), "txRingSize");
   int bus ;
    klee_make_symbolic(&bus, sizeof(int), "bus");
   int bus_num ;
    klee_make_symbolic(&bus_num, sizeof(int), "bus_num");
   int device ;
   int state ;
   int chipset ;
   ...
   int c_media ;
    klee_make_symbolic(&c_media, sizeof(int), "c_media");
   bool fdx ;
   int linkOK ;
    klee_make_symbolic(&linkOK, sizeof(int), "linkOK");
   int autosense ;
   bool tx_enable ;
   int setup_f ;
    klee_make_symbolic(&setup_f, sizeof(int), "setup_f");
   int local_state ;
    klee_make_symbolic(&local_state, sizeof(int), "local_state");
   struct mii_phy phy[8U] ;
   struct sia_phy sia ;
   int active ;
   int mii_cnt ;
    klee_make_symbolic(&mii_cnt, sizeof(int), "mii_cnt");
   int timeout ;
   struct timer_list timer ;
   int tmp ;
   ...
   int cfrv ;
    klee_make_symbolic(&cfrv, sizeof(int), "cfrv");
   int rx_ovf ;
    klee_make_symbolic(&rx_ovf, sizeof(int), "rx_ovf");
   bool useSROM ;
   bool useMII ;
   int asBitValid ;
    klee_make_symbolic(&asBitValid, sizeof(int), "asBitValid");
   int asPolarity ;
    klee_make_symbolic(&asPolarity, sizeof(int), "asPolarity");
   int asBit ;
    klee_make_symbolic(&asBit, sizeof(int), "asBit");
   int defMedium ;
    klee_make_symbolic(&defMedium, sizeof(int), "defMedium");
   int tcount ;
    klee_make_symbolic(&tcount, sizeof(int), "tcount");
   int infoblock_init ;
    klee_make_symbolic(&infoblock_init, sizeof(int), "infoblock_init");
   int infoleaf_offset ;
    klee_make_symbolic(&infoleaf_offset, sizeof(int), "infoleaf_offset");
   s32 infoblock_csr6 ;
   int infoblock_media ;
    klee_make_symbolic(&infoblock_media, sizeof(int), "infoblock_media");
   int (*infoleaf_fn)(struct net_device * ) ;
   u_char *rst ;
   u_char ibn ;
    klee_make_symbolic(&ibn, sizeof(char), "ibn");
...
static char const   *de4x5_signatures[5U]  = {      "DE425",      "DE434",      "DE435",      "DE450", 
        "DE500"};
static int dec_only  ;
    klee_make_symbolic(&dec_only, sizeof(int), "dec_only");
...
{ 
  ...
  u_long iobase ;
  int omr ;
    klee_make_symbolic(&omr, sizeof(int), "omr");
  unsigned int tmp___0 ;
  unsigned int tmp___1 ;
...
{ 
  u_char pb ;
    klee_make_symbolic(&pb, sizeof(char), "pb");
  u_short vendor ;
  u_short status ;
  u_int irq ;
  u_int device ;
...
{ 
  u_char pb ;
  u_char pbus ;
    klee_make_symbolic(&pbus, sizeof(char), "pbus");
  u_char dev_num ;
    klee_make_symbolic(&dev_num, sizeof(char), "dev_num");
  u_char dnum ;
    klee_make_symbolic(&dnum, sizeof(char), "dnum");
  u_char timer ;
...
{ 
  ...
  int next_tick ;
  int linkBad ;
    klee_make_symbolic(&linkBad, sizeof(int), "linkBad");
...
{ 
  ...
  int ana ;
  int anlpa ;
    klee_make_symbolic(&anlpa, sizeof(int), "anlpa");
  int cap ;
    klee_make_symbolic(&cap, sizeof(int), "cap");
  int cr ;
    klee_make_symbolic(&cr, sizeof(int), "cr");
  int slnk ;
    klee_make_symbolic(&slnk, sizeof(int), "slnk");
  int sr ;
...
{ 
  ...
  u_long iobase ;
  int sisr ;
    klee_make_symbolic(&sisr, sizeof(int), "sisr");
  unsigned int tmp___0 ;
...
{ 
  ...
  int status ;
  int siglen ;
    klee_make_symbolic(&siglen, sizeof(int), "siglen");
...
{ 
  ...
  short sigLength ;
    klee_make_symbolic(&sigLength, sizeof(short), "sigLength");
  s8 data ;
  int i ;
  int j ;
  unsigned char tmp ;
...
{ 
  ...
  u_char flags ;
  u_char csr6 ;
    klee_make_symbolic(&csr6, sizeof(char), "csr6");
  int tmp___0 ;
  int tmp___1 ;
  u_char *tmp___2 ;
  u_char *tmp___3 ;
...
{ 
  int r2 ;
    klee_make_symbolic(&r2, sizeof(int), "r2");
  int r3 ;
    klee_make_symbolic(&r3, sizeof(int), "r3");
...
int ldv_2_ldv_param_10_2_default  ;
    klee_make_symbolic(&ldv_2_ldv_param_10_2_default, sizeof(int), "ldv_2_ldv_param_10_2_default");
int ldv_2_ldv_param_7_1_default  ;
    klee_make_symbolic(&ldv_2_ldv_param_7_1_default, sizeof(int), "ldv_2_ldv_param_7_1_default");
...
int ldv_3_ldv_param_10_2_default  ;
    klee_make_symbolic(&ldv_3_ldv_param_10_2_default, sizeof(int), "ldv_3_ldv_param_10_2_default");
...
int ldv_4_ldv_param_7_1_default  ;
    klee_make_symbolic(&ldv_4_ldv_param_7_1_default, sizeof(int), "ldv_4_ldv_param_7_1_default");
