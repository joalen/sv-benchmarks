...
struct tx_pkt_header {
   ...
   unsigned short vlan ;
    klee_make_symbolic(&vlan, sizeof(short), "vlan");
};
...
struct atl2_adapter {
   ...
   unsigned long cfg_phy ;
    klee_make_symbolic(&cfg_phy, sizeof(long), "cfg_phy");
   bool mac_disabled ;
   dma_addr_t ring_dma ;
   void *ring_vir_addr ;
   int ring_size ;
    klee_make_symbolic(&ring_size, sizeof(int), "ring_size");
...
{ 
  ...
  int free_hole ;
    klee_make_symbolic(&free_hole, sizeof(int), "free_hole");
  int tmp ;
  int tmp___0 ;
...
{ 
  ...
  u32 copy_len ;
  int txs_unused ;
    klee_make_symbolic(&txs_unused, sizeof(int), "txs_unused");
  int txbuf_unused ;
    klee_make_symbolic(&txbuf_unused, sizeof(int), "txbuf_unused");
  int tmp___0 ;
  long tmp___1 ;
  u16 vlan_tag ;
...
{ 
  ...
  u16 phy_data ;
  int reconfig ;
    klee_make_symbolic(&reconfig, sizeof(int), "reconfig");
  u32 value ;
  bool tmp ;
  bool tmp___0 ;
  int tmp___1 ;
...
{ 
  ...
  int mmio_len ;
    klee_make_symbolic(&mmio_len, sizeof(int), "mmio_len");
  int err ;
  int tmp ;
  int tmp___0 ;
  void *tmp___1 ;
...
static unsigned int num_TxMemSize  ;
    klee_make_symbolic(&num_TxMemSize, sizeof(int), "num_TxMemSize");
static int RxMemBlock[5U]  = {      -1,      -1,      -1,      -1, 
        -1};
static unsigned int num_RxMemBlock  ;
    klee_make_symbolic(&num_RxMemBlock, sizeof(int), "num_RxMemBlock");
static int MediaType[5U]  = {      -1,      -1,      -1,      -1, 
        -1};
static unsigned int num_MediaType  ;
    klee_make_symbolic(&num_MediaType, sizeof(int), "num_MediaType");
static int IntModTimer[5U]  = {      -1,      -1,      -1,      -1, 
        -1};
static unsigned int num_IntModTimer  ;
    klee_make_symbolic(&num_IntModTimer, sizeof(int), "num_IntModTimer");
static int FlashVendor[5U]  = {      -1,      -1,      -1,      -1, 
        -1};
static unsigned int num_FlashVendor  ;
    klee_make_symbolic(&num_FlashVendor, sizeof(int), "num_FlashVendor");
