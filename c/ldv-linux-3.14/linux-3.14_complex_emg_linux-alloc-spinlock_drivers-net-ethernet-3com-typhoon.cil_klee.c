...
struct transmit_ring {
   ...
   u32 lastRead ;
   int writeRegister ;
    klee_make_symbolic(&writeRegister, sizeof(int), "writeRegister");
};
...
{ 
  ...
  int len ;
  int wrap_len ;
    klee_make_symbolic(&wrap_len, sizeof(int), "wrap_len");
  u32 cleared ;
  u32 ready ;
  long tmp ;
  long tmp___0 ;
...
{ 
  int lastWrite ;
    klee_make_symbolic(&lastWrite, sizeof(int), "lastWrite");
  int cmdCleared ;
    klee_make_symbolic(&cmdCleared, sizeof(int), "cmdCleared");
  int tmp ;
...
{ 
  int respReady ;
    klee_make_symbolic(&respReady, sizeof(int), "respReady");
  int respCleared ;
    klee_make_symbolic(&respCleared, sizeof(int), "respCleared");
  int tmp ;
...
{ 
  ...
  int err ;
  int got_resp ;
    klee_make_symbolic(&got_resp, sizeof(int), "got_resp");
  int freeCmd ;
    klee_make_symbolic(&freeCmd, sizeof(int), "freeCmd");
  int freeResp ;
    klee_make_symbolic(&freeResp, sizeof(int), "freeResp");
  int len ;
  int wrap_len ;
  long tmp ;
...
{ 
  ...
  dma_addr_t skb_dma ;
  int numDesc ;
    klee_make_symbolic(&numDesc, sizeof(int), "numDesc");
...
{ 
  ...
  struct typhoon *tp ;
  int card_id ;
    klee_make_symbolic(&card_id, sizeof(int), "card_id");
  void *ioaddr ;
  void *shared ;
  dma_addr_t shared_dma ;
  struct cmd_desc xp_cmd ;
