...
struct __anonstruct_tx_205 {
   ...
   unsigned int cur_buf_num ;
    klee_make_symbolic(&cur_buf_num, sizeof(int), "cur_buf_num");
...
struct nvt_dev {
   ...
   unsigned long cir_addr ;
    klee_make_symbolic(&cir_addr, sizeof(long), "cir_addr");
   unsigned long cir_wake_addr ;
    klee_make_symbolic(&cir_wake_addr, sizeof(long), "cir_wake_addr");
   int cir_irq ;
    klee_make_symbolic(&cir_irq, sizeof(int), "cir_irq");
   int cir_wake_irq ;
    klee_make_symbolic(&cir_wake_irq, sizeof(int), "cir_wake_irq");
   u8 chip_major ;
   u8 chip_minor ;
...
{ 
  ...
  u8 val ;
  unsigned int b_idx ;
    klee_make_symbolic(&b_idx, sizeof(int), "b_idx");
  bool overrun ;
  int i ;
