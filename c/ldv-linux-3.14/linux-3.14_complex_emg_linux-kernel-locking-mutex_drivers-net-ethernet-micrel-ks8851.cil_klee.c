...
{ 
  unsigned int pmecr ;
    klee_make_symbolic(&pmecr, sizeof(int), "pmecr");
...
{ 
  struct sk_buff *skb ;
  unsigned int rxfc ;
    klee_make_symbolic(&rxfc, sizeof(int), "rxfc");
  unsigned int rxlen ;
  ...
  unsigned int rxalign ;
    klee_make_symbolic(&rxalign, sizeof(int), "rxalign");
...
{ 
  ...
  void *tmp ;
  int ksreg ;
    klee_make_symbolic(&ksreg, sizeof(int), "ksreg");
  int result ;
...
{ 
  unsigned int both_done ;
    klee_make_symbolic(&both_done, sizeof(int), "both_done");
  int ret ;
  unsigned int rd ;
...
{ 
  ...
  int ret ;
  unsigned int cider ;
    klee_make_symbolic(&cider, sizeof(int), "cider");
  void *tmp ;
  long tmp___0 ;
  long tmp___1 ;
  struct lock_class_key __key ;
