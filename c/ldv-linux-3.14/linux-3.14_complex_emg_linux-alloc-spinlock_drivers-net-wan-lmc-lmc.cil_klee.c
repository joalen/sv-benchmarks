...
struct lmc_regfile_t {
   unsigned long csr_busmode ;
    klee_make_symbolic(&csr_busmode, sizeof(long), "csr_busmode");
   unsigned long csr_txpoll ;
    klee_make_symbolic(&csr_txpoll, sizeof(long), "csr_txpoll");
   unsigned long csr_rxpoll ;
    klee_make_symbolic(&csr_rxpoll, sizeof(long), "csr_rxpoll");
   unsigned long csr_rxlist ;
    klee_make_symbolic(&csr_rxlist, sizeof(long), "csr_rxlist");
   unsigned long csr_txlist ;
    klee_make_symbolic(&csr_txlist, sizeof(long), "csr_txlist");
   unsigned long csr_status ;
    klee_make_symbolic(&csr_status, sizeof(long), "csr_status");
   unsigned long csr_command ;
    klee_make_symbolic(&csr_command, sizeof(long), "csr_command");
   unsigned long csr_intr ;
    klee_make_symbolic(&csr_intr, sizeof(long), "csr_intr");
   unsigned long csr_missed_frames ;
    klee_make_symbolic(&csr_missed_frames, sizeof(long), "csr_missed_frames");
   unsigned long csr_9 ;
    klee_make_symbolic(&csr_9, sizeof(long), "csr_9");
   unsigned long csr_10 ;
    klee_make_symbolic(&csr_10, sizeof(long), "csr_10");
   unsigned long csr_11 ;
    klee_make_symbolic(&csr_11, sizeof(long), "csr_11");
   unsigned long csr_12 ;
    klee_make_symbolic(&csr_12, sizeof(long), "csr_12");
   unsigned long csr_13 ;
    klee_make_symbolic(&csr_13, sizeof(long), "csr_13");
   unsigned long csr_14 ;
    klee_make_symbolic(&csr_14, sizeof(long), "csr_14");
   unsigned long csr_15 ;
    klee_make_symbolic(&csr_15, sizeof(long), "csr_15");
};
...
struct lmc___softc {
   ...
   int hang ;
    klee_make_symbolic(&hang, sizeof(int), "hang");
   int rxdesc ;
    klee_make_symbolic(&rxdesc, sizeof(int), "rxdesc");
   int bad_packet ;
    klee_make_symbolic(&bad_packet, sizeof(int), "bad_packet");
   int some_counter ;
    klee_make_symbolic(&some_counter, sizeof(int), "some_counter");
   u32 txgo ;
   ...
   unsigned int lmc_next_rx ;
    klee_make_symbolic(&lmc_next_rx, sizeof(int), "lmc_next_rx");
   unsigned int lmc_next_tx ;
    klee_make_symbolic(&lmc_next_tx, sizeof(int), "lmc_next_tx");
   unsigned int volatile   lmc_taint_tx ;
   unsigned int volatile   lmc_taint_rx ;
   int lmc_tx_start ;
    klee_make_symbolic(&lmc_tx_start, sizeof(int), "lmc_tx_start");
   int lmc_txfull ;
    klee_make_symbolic(&lmc_txfull, sizeof(int), "lmc_txfull");
   int lmc_txbusy ;
    klee_make_symbolic(&lmc_txbusy, sizeof(int), "lmc_txbusy");
   u16 lmc_miireg16 ;
   int lmc_ok ;
    klee_make_symbolic(&lmc_ok, sizeof(int), "lmc_ok");
   int last_link_status ;
    klee_make_symbolic(&last_link_status, sizeof(int), "last_link_status");
   int lmc_cardtype ;
    klee_make_symbolic(&lmc_cardtype, sizeof(int), "lmc_cardtype");
   u32 last_frameerr ;
   ...
   int tx_TimeoutInd ;
    klee_make_symbolic(&tx_TimeoutInd, sizeof(int), "tx_TimeoutInd");
   int tx_TimeoutDisplay ;
    klee_make_symbolic(&tx_TimeoutDisplay, sizeof(int), "tx_TimeoutDisplay");
   unsigned int lastlmc_taint_tx ;
    klee_make_symbolic(&lastlmc_taint_tx, sizeof(int), "lastlmc_taint_tx");
   int lasttx_packets ;
    klee_make_symbolic(&lasttx_packets, sizeof(int), "lasttx_packets");
   u32 tx_clockState ;
   u32 lmc_crcSize ;
   LMC_XINFO lmc_xinfo ;
   char lmc_yel ;
    klee_make_symbolic(&lmc_yel, sizeof(char), "lmc_yel");
   char lmc_blue ;
    klee_make_symbolic(&lmc_blue, sizeof(char), "lmc_blue");
   char lmc_red ;
    klee_make_symbolic(&lmc_red, sizeof(char), "lmc_red");
   char lmc_timing ;
    klee_make_symbolic(&lmc_timing, sizeof(char), "lmc_timing");
   int got_irq ;
    klee_make_symbolic(&got_irq, sizeof(int), "got_irq");
...
{ 
  u16 mii17 ;
  int cable ;
    klee_make_symbolic(&cable, sizeof(int), "cable");
  unsigned int tmp ;
...
{ 
  ...
  int ret ;
  int hw_hdsk ;
    klee_make_symbolic(&hw_hdsk, sizeof(int), "hw_hdsk");
  unsigned int tmp ;
...
{ 
  ...
  s32 stat ;
  unsigned int badtx ;
    klee_make_symbolic(&badtx, sizeof(int), "badtx");
  u32 firstcsr ;
  int max_work ;
    klee_make_symbolic(&max_work, sizeof(int), "max_work");
  int handled ;
    klee_make_symbolic(&handled, sizeof(int), "handled");
  int n_compl ;
    klee_make_symbolic(&n_compl, sizeof(int), "n_compl");
  u32 error ;
  int tmp___0 ;
...
{ 
  ...
  unsigned int next_rx ;
    klee_make_symbolic(&next_rx, sizeof(int), "next_rx");
  int rxIntLoopCnt ;
    klee_make_symbolic(&rxIntLoopCnt, sizeof(int), "rxIntLoopCnt");
  int localLengthErrCnt ;
    klee_make_symbolic(&localLengthErrCnt, sizeof(int), "localLengthErrCnt");
  long stat ;
    klee_make_symbolic(&stat, sizeof(long), "stat");
  struct sk_buff *skb ;
  struct sk_buff *nsb ;
  u16 len ;
...
{ 
  ...
  int n ;
  int datav ;
    klee_make_symbolic(&datav, sizeof(int), "datav");
...
int ldv_4_ldv_param_12_1_default  ;
    klee_make_symbolic(&ldv_4_ldv_param_12_1_default, sizeof(int), "ldv_4_ldv_param_12_1_default");
...
int ldv_4_ldv_param_24_1_default  ;
    klee_make_symbolic(&ldv_4_ldv_param_24_1_default, sizeof(int), "ldv_4_ldv_param_24_1_default");
int ldv_4_ldv_param_9_1_default  ;
    klee_make_symbolic(&ldv_4_ldv_param_9_1_default, sizeof(int), "ldv_4_ldv_param_9_1_default");
...
int ldv_5_ldv_param_12_1_default  ;
    klee_make_symbolic(&ldv_5_ldv_param_12_1_default, sizeof(int), "ldv_5_ldv_param_12_1_default");
...
int ldv_5_ldv_param_9_1_default  ;
    klee_make_symbolic(&ldv_5_ldv_param_9_1_default, sizeof(int), "ldv_5_ldv_param_9_1_default");
...
int ldv_6_ldv_param_9_1_default  ;
    klee_make_symbolic(&ldv_6_ldv_param_9_1_default, sizeof(int), "ldv_6_ldv_param_9_1_default");
struct timer_list *ldv_7_container_timer_list  ;
