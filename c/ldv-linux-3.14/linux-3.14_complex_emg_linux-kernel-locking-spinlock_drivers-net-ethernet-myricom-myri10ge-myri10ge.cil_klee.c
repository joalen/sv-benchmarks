...
struct mcp_gen_header {
   ...
   unsigned int led_pattern ;
    klee_make_symbolic(&led_pattern, sizeof(int), "led_pattern");
   unsigned int led_pattern_dflt ;
    klee_make_symbolic(&led_pattern_dflt, sizeof(int), "led_pattern_dflt");
};
...
struct myri10ge_slice_state {
   ...
   int stuck ;
    klee_make_symbolic(&stuck, sizeof(int), "stuck");
   int cached_dca_tag ;
   ...
   unsigned long lock_napi_yield ;
    klee_make_symbolic(&lock_napi_yield, sizeof(long), "lock_napi_yield");
   unsigned long lock_poll_yield ;
    klee_make_symbolic(&lock_poll_yield, sizeof(long), "lock_poll_yield");
   unsigned long busy_poll_miss ;
    klee_make_symbolic(&busy_poll_miss, sizeof(long), "busy_poll_miss");
   unsigned long busy_poll_cnt ;
    klee_make_symbolic(&busy_poll_cnt, sizeof(long), "busy_poll_cnt");
   char irq_desc[32U] ;
};
struct myri10ge_priv {
...
int ldv_1_ldv_param_16_1_default  ;
    klee_make_symbolic(&ldv_1_ldv_param_16_1_default, sizeof(int), "ldv_1_ldv_param_16_1_default");
...
unsigned long ldv_3_ldv_param_3_1_default  ;
    klee_make_symbolic(&ldv_3_ldv_param_3_1_default, sizeof(long), "ldv_3_ldv_param_3_1_default");
