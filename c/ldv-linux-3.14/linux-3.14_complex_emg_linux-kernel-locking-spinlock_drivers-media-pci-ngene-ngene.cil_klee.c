...
struct ngene_channel {
   ...
   bool has_demux ;
   int demod_type ;
    klee_make_symbolic(&demod_type, sizeof(int), "demod_type");
   ...
   u32 DataFormatFlags ;
   int AudioDTOUpdated ;
    klee_make_symbolic(&AudioDTOUpdated, sizeof(int), "AudioDTOUpdated");
   u32 AudioDTOValue ;
   int (*set_tone)(struct dvb_frontend * , fe_sec_tone_mode_t  ) ;
   u8 lnbh ;
   int minor ;
   ...
   u8 dma_on ;
   int soundstreamon ;
    klee_make_symbolic(&soundstreamon, sizeof(int), "soundstreamon");
   int audiomute ;
    klee_make_symbolic(&audiomute, sizeof(int), "audiomute");
   int soundbuffisallocated ;
    klee_make_symbolic(&soundbuffisallocated, sizeof(int), "soundbuffisallocated");
   int sndbuffflag ;
    klee_make_symbolic(&sndbuffflag, sizeof(int), "sndbuffflag");
   int tun_rdy ;
    klee_make_symbolic(&tun_rdy, sizeof(int), "tun_rdy");
   int dec_rdy ;
    klee_make_symbolic(&dec_rdy, sizeof(int), "dec_rdy");
   int tun_dec_rdy ;
    klee_make_symbolic(&tun_dec_rdy, sizeof(int), "tun_dec_rdy");
   int lastbufferflag ;
    klee_make_symbolic(&lastbufferflag, sizeof(int), "lastbufferflag");
   struct ngene_tvnorm *tvnorms ;
   int tvnorm_num ;
    klee_make_symbolic(&tvnorm_num, sizeof(int), "tvnorm_num");
   int tvnorm ;
...
struct ngene {
   ...
   u8 *CmdDoneByte ;
   int BootFirmware ;
    klee_make_symbolic(&BootFirmware, sizeof(int), "BootFirmware");
   void *OverflowBuffer ;
   ...
   int EventQueueOverflowCount ;
    klee_make_symbolic(&EventQueueOverflowCount, sizeof(int), "EventQueueOverflowCount");
   int EventQueueOverflowFlag ;
    klee_make_symbolic(&EventQueueOverflowFlag, sizeof(int), "EventQueueOverflowFlag");
   struct tasklet_struct event_tasklet ;
   struct EVENT_BUFFER *EventBuffer ;
   int EventQueueWriteIndex ;
    klee_make_symbolic(&EventQueueWriteIndex, sizeof(int), "EventQueueWriteIndex");
   int EventQueueReadIndex ;
    klee_make_symbolic(&EventQueueReadIndex, sizeof(int), "EventQueueReadIndex");
   wait_queue_head_t cmd_wq ;
   int cmd_done ;
    klee_make_symbolic(&cmd_done, sizeof(int), "cmd_done");
   struct semaphore cmd_mutex ;
   struct semaphore stream_mutex ;
   struct semaphore pll_mutex ;
   struct semaphore i2c_switch_mutex ;
   int i2c_current_channel ;
    klee_make_symbolic(&i2c_current_channel, sizeof(int), "i2c_current_channel");
   int i2c_current_bus ;
    klee_make_symbolic(&i2c_current_bus, sizeof(int), "i2c_current_bus");
   spinlock_t cmd_lock ;
   ...
   int tx_busy ;
    klee_make_symbolic(&tx_busy, sizeof(int), "tx_busy");
   wait_queue_head_t tx_wq ;
   wait_queue_head_t rx_wq ;
   u8 uart_rbuf[4096U] ;
   int uart_rp ;
    klee_make_symbolic(&uart_rp, sizeof(int), "uart_rp");
   int uart_wp ;
    klee_make_symbolic(&uart_wp, sizeof(int), "uart_wp");
   u8 *tsout_buf ;
   ...
   unsigned long exp_val ;
    klee_make_symbolic(&exp_val, sizeof(long), "exp_val");
   int prev_cmd ;
    klee_make_symbolic(&prev_cmd, sizeof(int), "prev_cmd");
   struct ngene_ci ci ;
};
struct ngene_info {
   int type ;
   ...
   u8 lnb[4U] ;
   int i2c_access ;
    klee_make_symbolic(&i2c_access, sizeof(int), "i2c_access");
   u8 ntsc ;
   u8 tsf[4U] ;
   u8 i2s[4U] ;
   int (*gate_ctrl)(struct dvb_frontend * , int  ) ;
...
static int one_adapter  ;
    klee_make_symbolic(&one_adapter, sizeof(int), "one_adapter");
static int shutdown_workaround  ;
    klee_make_symbolic(&shutdown_workaround, sizeof(int), "shutdown_workaround");
static int debug  ;
...
{ 
  ...
  u8 *bconf ;
  int bconf___0 ;
    klee_make_symbolic(&bconf___0, sizeof(int), "bconf___0");
...
short ldv_3_ldv_param_9_1_default  ;
    klee_make_symbolic(&ldv_3_ldv_param_9_1_default, sizeof(short), "ldv_3_ldv_param_9_1_default");
