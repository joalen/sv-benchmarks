...
struct if_irda_qos {
   unsigned long baudrate ;
    klee_make_symbolic(&baudrate, sizeof(long), "baudrate");
   unsigned short data_size ;
    klee_make_symbolic(&data_size, sizeof(short), "data_size");
   unsigned short window_size ;
    klee_make_symbolic(&window_size, sizeof(short), "window_size");
   unsigned short min_turn_time ;
    klee_make_symbolic(&min_turn_time, sizeof(short), "min_turn_time");
   unsigned short max_turn_time ;
    klee_make_symbolic(&max_turn_time, sizeof(short), "max_turn_time");
   unsigned char add_bofs ;
    klee_make_symbolic(&add_bofs, sizeof(char), "add_bofs");
   unsigned char link_disc ;
    klee_make_symbolic(&link_disc, sizeof(char), "link_disc");
};
struct if_irda_line {
   __u8 dtr ;
   __u8 rts ;
...
union __anonunion_ifr_ifru_255 {
   ...
   unsigned int ifru_receiving ;
    klee_make_symbolic(&ifru_receiving, sizeof(int), "ifru_receiving");
   unsigned int ifru_mode ;
    klee_make_symbolic(&ifru_mode, sizeof(int), "ifru_mode");
   unsigned int ifru_dongle ;
    klee_make_symbolic(&ifru_dongle, sizeof(int), "ifru_dongle");
};
struct if_irda_req {
...
struct irda_skb_cb {
   unsigned int default_qdisc_pad ;
    klee_make_symbolic(&default_qdisc_pad, sizeof(int), "default_qdisc_pad");
   magic_t magic ;
   __u32 next_speed ;
   __u16 mtt ;
   __u16 xbofs ;
...
struct __anonstruct_chipio_t_264 {
   int cfg_base ;
    klee_make_symbolic(&cfg_base, sizeof(int), "cfg_base");
   int sir_base ;
    klee_make_symbolic(&sir_base, sizeof(int), "sir_base");
   int fir_base ;
    klee_make_symbolic(&fir_base, sizeof(int), "fir_base");
   int mem_base ;
    klee_make_symbolic(&mem_base, sizeof(int), "mem_base");
   int sir_ext ;
    klee_make_symbolic(&sir_ext, sizeof(int), "sir_ext");
   int fir_ext ;
    klee_make_symbolic(&fir_ext, sizeof(int), "fir_ext");
   int irq ;
   int irq2 ;
    klee_make_symbolic(&irq2, sizeof(int), "irq2");
   int dma ;
   int dma2 ;
   ...
   __u32 new_speed ;
   int dongle_id ;
    klee_make_symbolic(&dongle_id, sizeof(int), "dongle_id");
};
...
struct st_fifo {
   ...
   int pending_bytes ;
    klee_make_symbolic(&pending_bytes, sizeof(int), "pending_bytes");
   int head ;
...
struct eventflag {
   unsigned char TxFIFOUnderRun ;
    klee_make_symbolic(&TxFIFOUnderRun, sizeof(char), "TxFIFOUnderRun");
   unsigned char EOMessage ;
    klee_make_symbolic(&EOMessage, sizeof(char), "EOMessage");
   unsigned char TxFIFOReady ;
    klee_make_symbolic(&TxFIFOReady, sizeof(char), "TxFIFOReady");
   unsigned char EarlyEOM ;
    klee_make_symbolic(&EarlyEOM, sizeof(char), "EarlyEOM");
   unsigned char PHYErr ;
    klee_make_symbolic(&PHYErr, sizeof(char), "PHYErr");
   unsigned char CRCErr ;
    klee_make_symbolic(&CRCErr, sizeof(char), "CRCErr");
   unsigned char RxFIFOOverRun ;
    klee_make_symbolic(&RxFIFOOverRun, sizeof(char), "RxFIFOOverRun");
   unsigned char EOPacket ;
    klee_make_symbolic(&EOPacket, sizeof(char), "EOPacket");
   unsigned char RxAvail ;
    klee_make_symbolic(&RxAvail, sizeof(char), "RxAvail");
   unsigned char TooLargePacket ;
    klee_make_symbolic(&TooLargePacket, sizeof(char), "TooLargePacket");
   unsigned char SIRBad ;
    klee_make_symbolic(&SIRBad, sizeof(char), "SIRBad");
   unsigned char Unknown ;
    klee_make_symbolic(&Unknown, sizeof(char), "Unknown");
   unsigned char TimeOut ;
    klee_make_symbolic(&TimeOut, sizeof(char), "TimeOut");
   unsigned char RxDMATC ;
    klee_make_symbolic(&RxDMATC, sizeof(char), "RxDMATC");
   unsigned char TxDMATC ;
    klee_make_symbolic(&TxDMATC, sizeof(char), "TxDMATC");
};
struct via_ircc_cb {
   ...
   unsigned int RetryCount ;
    klee_make_symbolic(&RetryCount, sizeof(int), "RetryCount");
   unsigned int RxDataReady ;
    klee_make_symbolic(&RxDataReady, sizeof(int), "RxDataReady");
   unsigned int RxLastCount ;
    klee_make_symbolic(&RxLastCount, sizeof(int), "RxLastCount");
};
...
{ 
  unsigned char iVal ;
    klee_make_symbolic(&iVal, sizeof(char), "iVal");
...
{ 
  int dongle_id___0 ;
    klee_make_symbolic(&dongle_id___0, sizeof(int), "dongle_id___0");
  int tmp ;
