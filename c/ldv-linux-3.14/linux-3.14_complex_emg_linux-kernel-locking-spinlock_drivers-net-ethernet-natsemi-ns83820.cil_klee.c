...
struct ns83820 {
   ...
   unsigned int ihr ;
    klee_make_symbolic(&ihr, sizeof(int), "ihr");
...
{ 
  unsigned int next_empty ;
    klee_make_symbolic(&next_empty, sizeof(int), "next_empty");
  u32 cmdsts ;
  __le32 *sg ;
  dma_addr_t buf ;
  long tmp ;
...
{ 
  ...
  int newlinkstate ;
    klee_make_symbolic(&newlinkstate, sizeof(int), "newlinkstate");
...
{ 
  ...
  int rx_rc ;
    klee_make_symbolic(&rx_rc, sizeof(int), "rx_rc");
  int len ;
  u32 cmdsts ;
  __le32 *desc ;
  unsigned long flags ;
  ...
  long tmp___0 ;
  unsigned short tag ;
    klee_make_symbolic(&tag, sizeof(short), "tag");
  __u16 tmp___1 ;
  long tmp___2 ;
  long tmp___3 ;
...
{ 
  ...
  unsigned int tx_done_idx ;
    klee_make_symbolic(&tx_done_idx, sizeof(int), "tx_done_idx");
  ...
  int do_intr ;
    klee_make_symbolic(&do_intr, sizeof(int), "do_intr");
...
{ 
  ...
  u32 tanar ;
  int have_optical ;
    klee_make_symbolic(&have_optical, sizeof(int), "have_optical");
  int fullduplex ;
  unsigned int tmp___0 ;
  unsigned int tmp___1 ;
  unsigned int tmp___2 ;
