...
{ 
  ...
  void *tmp ;
  int jumbo ;
    klee_make_symbolic(&jumbo, sizeof(int), "jumbo");
  int i ;
  u32 r ;
  u8 zero[6U] ;
...
static int only_32bit_dma  ;
    klee_make_symbolic(&only_32bit_dma, sizeof(int), "only_32bit_dma");
...
unsigned int ldv_2_ldv_param_47_1_default  ;
    klee_make_symbolic(&ldv_2_ldv_param_47_1_default, sizeof(int), "ldv_2_ldv_param_47_1_default");
