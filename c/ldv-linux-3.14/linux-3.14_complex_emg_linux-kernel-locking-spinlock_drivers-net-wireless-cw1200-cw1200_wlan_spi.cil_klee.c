...
struct cw1200_queue {
   ...
   int tx_locked_cnt ;
    klee_make_symbolic(&tx_locked_cnt, sizeof(int), "tx_locked_cnt");
   int *link_map_cache ;
   bool overfull ;
   spinlock_t lock ;
   u8 queue_id ;
   ...
   unsigned long ttl ;
    klee_make_symbolic(&ttl, sizeof(long), "ttl");
};
struct cw1200_queue_stats {
   spinlock_t lock ;
   int *link_map_cache ;
...
struct cw1200_scan {
   ...
   int direct_probe ;
    klee_make_symbolic(&direct_probe, sizeof(int), "direct_probe");
};
...
struct cw1200_common {
   ...
   int hw_refclk ;
    klee_make_symbolic(&hw_refclk, sizeof(int), "hw_refclk");
   bool hw_have_5ghz ;
   ...
   int tx_burst_idx ;
    klee_make_symbolic(&tx_burst_idx, sizeof(int), "tx_burst_idx");
   ...
   int cqm_rssi_thold ;
    klee_make_symbolic(&cqm_rssi_thold, sizeof(int), "cqm_rssi_thold");
   unsigned int cqm_rssi_hyst ;
    klee_make_symbolic(&cqm_rssi_hyst, sizeof(int), "cqm_rssi_hyst");
   bool cqm_use_rssi ;
   int cqm_beacon_loss_count ;
    klee_make_symbolic(&cqm_beacon_loss_count, sizeof(int), "cqm_beacon_loss_count");
   int channel_switch_in_progress ;
    klee_make_symbolic(&channel_switch_in_progress, sizeof(int), "channel_switch_in_progress");
   ...
   int bh_error ;
    klee_make_symbolic(&bh_error, sizeof(int), "bh_error");
   ...
   u8 wsm_tx_seq ;
   int hw_bufs_used ;
    klee_make_symbolic(&hw_bufs_used, sizeof(int), "hw_bufs_used");
   ...
   int firmware_ready ;
    klee_make_symbolic(&firmware_ready, sizeof(int), "firmware_ready");
   atomic_t tx_lock ;
   int wsm_enable_wsm_dumps ;
    klee_make_symbolic(&wsm_enable_wsm_dumps, sizeof(int), "wsm_enable_wsm_dumps");
   ...
   int join_complete_status ;
    klee_make_symbolic(&join_complete_status, sizeof(int), "join_complete_status");
   int join_dtim_period ;
    klee_make_symbolic(&join_dtim_period, sizeof(int), "join_dtim_period");
   bool delayed_unjoin ;
   ...
   int bss_loss_state ;
    klee_make_symbolic(&bss_loss_state, sizeof(int), "bss_loss_state");
   u32 bss_loss_confirm_id ;
   int delayed_link_loss ;
    klee_make_symbolic(&delayed_link_loss, sizeof(int), "delayed_link_loss");
   struct work_struct bss_params_work ;
   struct tx_policy_cache tx_policy_cache ;
   struct work_struct tx_policy_upload_work ;
   int ps_mode_switch_in_progress ;
    klee_make_symbolic(&ps_mode_switch_in_progress, sizeof(int), "ps_mode_switch_in_progress");
...
struct cw1200_platform_data_spi {
   ...
   int powerup ;
    klee_make_symbolic(&powerup, sizeof(int), "powerup");
...
int ldv_4_ldv_param_12_3_default  ;
    klee_make_symbolic(&ldv_4_ldv_param_12_3_default, sizeof(int), "ldv_4_ldv_param_12_3_default");
