...
struct sh_vou_pdata {
   ...
   int i2c_adap ;
    klee_make_symbolic(&i2c_adap, sizeof(int), "i2c_adap");
...
struct sh_vou_device {
   ...
   v4l2_std_id std ;
   int pix_idx ;
    klee_make_symbolic(&pix_idx, sizeof(int), "pix_idx");
...
struct sh_vou_fmt {
   ...
   char *desc ;
   unsigned char bpp ;
    klee_make_symbolic(&bpp, sizeof(char), "bpp");
   unsigned char rgb ;
    klee_make_symbolic(&rgb, sizeof(char), "rgb");
   unsigned char yf ;
    klee_make_symbolic(&yf, sizeof(char), "yf");
   unsigned char pkf ;
    klee_make_symbolic(&pkf, sizeof(char), "pkf");
};
struct sh_vou_geometry {
   ...
   int scale_idx_h ;
    klee_make_symbolic(&scale_idx_h, sizeof(int), "scale_idx_h");
   int scale_idx_v ;
    klee_make_symbolic(&scale_idx_v, sizeof(int), "scale_idx_v");
};
...
{ 
  unsigned int row_coeff ;
    klee_make_symbolic(&row_coeff, sizeof(int), "row_coeff");
  u32 dataswap ;
...
{ 
  ...
  unsigned int black_left ;
    klee_make_symbolic(&black_left, sizeof(int), "black_left");
  unsigned int black_top ;
    klee_make_symbolic(&black_top, sizeof(int), "black_top");
  unsigned int width_max ;
    klee_make_symbolic(&width_max, sizeof(int), "width_max");
  unsigned int frame_in_height ;
    klee_make_symbolic(&frame_in_height, sizeof(int), "frame_in_height");
  unsigned int frame_out_height ;
    klee_make_symbolic(&frame_out_height, sizeof(int), "frame_out_height");
  unsigned int frame_out_top ;
    klee_make_symbolic(&frame_out_top, sizeof(int), "frame_out_top");
  struct v4l2_rect *rect ;
  struct v4l2_pix_format *pix ;
  u32 vouvcr ;
  u32 dsr_h ;
...
{ 
  unsigned int best_err ;
    klee_make_symbolic(&best_err, sizeof(int), "best_err");
  unsigned int best ;
    klee_make_symbolic(&best, sizeof(int), "best");
  unsigned int img_height_max ;
    klee_make_symbolic(&img_height_max, sizeof(int), "img_height_max");
  int i ;
  int idx ;
  ...
  unsigned int found___0 ;
    klee_make_symbolic(&found___0, sizeof(int), "found___0");
  long ret___0 ;
...
{ 
  ...
  unsigned int height_max ;
    klee_make_symbolic(&height_max, sizeof(int), "height_max");
  unsigned int img_height_max ;
  int i ;
  int idx ;
  unsigned int err ;
...
unsigned long long ldv_4_ldv_param_35_2_default  ;
    klee_make_symbolic(&ldv_4_ldv_param_35_2_default, sizeof(long), "ldv_4_ldv_param_35_2_default");
