...
struct pch_gbe_rx_ring {
   ...
   unsigned int rx_buff_pool_size ;
    klee_make_symbolic(&rx_buff_pool_size, sizeof(int), "rx_buff_pool_size");
   unsigned int size ;
   unsigned int count ;
   unsigned int next_to_use ;
   unsigned int next_to_clean ;
...
struct pch_gbe_adapter {
   ...
   unsigned long rx_buffer_len ;
    klee_make_symbolic(&rx_buffer_len, sizeof(long), "rx_buffer_len");
   unsigned long tx_queue_len ;
   bool have_msi ;
   bool rx_stop_flag ;
   int hwts_tx_en ;
...
{ 
  ...
  struct pch_gbe_hw  const  *__mptr ;
  unsigned long tmp2 ;
    klee_make_symbolic(&tmp2, sizeof(long), "tmp2");
  unsigned long tmp3 ;
    klee_make_symbolic(&tmp3, sizeof(long), "tmp3");
  struct _ddebug descriptor ;
  unsigned int tmp ;
  unsigned int tmp___0 ;
...
{ 
  struct pch_gbe_hw *hw ;
  unsigned long rgmii ;
    klee_make_symbolic(&rgmii, sizeof(long), "rgmii");
...
{ 
  ...
  unsigned int frame_ctrl ;
    klee_make_symbolic(&frame_ctrl, sizeof(int), "frame_ctrl");
  unsigned int ring_num ;
    klee_make_symbolic(&ring_num, sizeof(int), "ring_num");
  long tmp ;
  struct iphdr *iph ;
...
{ 
  ...
  int size ;
  int desNo ;
    klee_make_symbolic(&desNo, sizeof(int), "desNo");
  void *tmp ;
  void *tmp___0 ;
...
{ 
  ...
  unsigned long old_rx_buffer_len ;
    klee_make_symbolic(&old_rx_buffer_len, sizeof(long), "old_rx_buffer_len");
  int err ;
  bool tmp___0 ;
  struct _ddebug descriptor ;
  long tmp___1 ;
...
unsigned short ldv_5_ldv_param_16_2_default  ;
    klee_make_symbolic(&ldv_5_ldv_param_16_2_default, sizeof(short), "ldv_5_ldv_param_16_2_default");
