...
struct CapabilityRid {
   ...
   char oui[3U] ;
   char zero ;
    klee_make_symbolic(&zero, sizeof(char), "zero");
   __le16 prodNum ;
   char manName[32U] ;
   char prodName[16U] ;
   char prodVer[8U] ;
   ...
   char rxDiversity ;
    klee_make_symbolic(&rxDiversity, sizeof(char), "rxDiversity");
   char txDiversity ;
    klee_make_symbolic(&txDiversity, sizeof(char), "txDiversity");
...
struct aironet_ioctl {
   ...
   unsigned short ridnum ;
    klee_make_symbolic(&ridnum, sizeof(short), "ridnum");
   unsigned char *data ;
};
...
struct __anonstruct_xmit_307 {
   struct sk_buff *skb ;
   int fid ;
    klee_make_symbolic(&fid, sizeof(int), "fid");
};
...
struct airo_info {
   ...
   ConfigRid config ;
   char keyindex ;
    klee_make_symbolic(&keyindex, sizeof(char), "keyindex");
   char defindex ;
    klee_make_symbolic(&defindex, sizeof(char), "defindex");
   struct proc_dir_entry *proc_entry ;
   spinlock_t aux_lock ;
   unsigned long flags ;
   unsigned long jobs ;
    klee_make_symbolic(&jobs, sizeof(long), "jobs");
   ...
   unsigned long scan_timeout ;
    klee_make_symbolic(&scan_timeout, sizeof(long), "scan_timeout");
   struct iw_spy_data spy_data ;
   struct iw_public_data wireless_data ;
   ...
   unsigned long ridbus ;
    klee_make_symbolic(&ridbus, sizeof(long), "ridbus");
   ...
   char proc_name[16U] ;
   int wep_capable ;
    klee_make_symbolic(&wep_capable, sizeof(int), "wep_capable");
   int max_wep_idx ;
    klee_make_symbolic(&max_wep_idx, sizeof(int), "max_wep_idx");
   unsigned int bssListFirst ;
    klee_make_symbolic(&bssListFirst, sizeof(int), "bssListFirst");
   unsigned int bssListNext ;
    klee_make_symbolic(&bssListNext, sizeof(int), "bssListNext");
   unsigned int bssListRidLen ;
    klee_make_symbolic(&bssListRidLen, sizeof(int), "bssListRidLen");
...
struct proc_data {
   int release_buffer ;
    klee_make_symbolic(&release_buffer, sizeof(int), "release_buffer");
   int readlen ;
   ...
   int maxwritelen ;
    klee_make_symbolic(&maxwritelen, sizeof(int), "maxwritelen");
   char *wbuffer ;
...
static int maxencrypt  ;
    klee_make_symbolic(&maxencrypt, sizeof(int), "maxencrypt");
static int auto_wep  ;
    klee_make_symbolic(&auto_wep, sizeof(int), "auto_wep");
static int aux_bap  ;
    klee_make_symbolic(&aux_bap, sizeof(int), "aux_bap");
static int adhoc  ;
    klee_make_symbolic(&adhoc, sizeof(int), "adhoc");
static int probe  =    1;
static kuid_t proc_kuid  ;
static int proc_uid  ;
    klee_make_symbolic(&proc_uid, sizeof(int), "proc_uid");
static kgid_t proc_kgid  ;
static int proc_gid  ;
    klee_make_symbolic(&proc_gid, sizeof(int), "proc_gid");
static int airo_perm  =    365;
static int proc_perm  =    420;
static int do8bitIO  ;
    klee_make_symbolic(&do8bitIO, sizeof(int), "do8bitIO");
...
{ 
  ...
  __u32 tmp___2 ;
  int mcast ;
    klee_make_symbolic(&mcast, sizeof(int), "mcast");
  __u16 tmp___3 ;
  int tmp___4 ;
...
{ 
  int coeff_position ;
    klee_make_symbolic(&coeff_position, sizeof(int), "coeff_position");
  int byte_position ;
    klee_make_symbolic(&byte_position, sizeof(int), "byte_position");
  int tmp ;
  u8 *tmp___0 ;
  __u32 tmp___1 ;
  int tmp___2 ;
...
{ 
  int npacks ;
    klee_make_symbolic(&npacks, sizeof(int), "npacks");
  int pending ;
  unsigned long flags ;
  struct airo_info *ai ;
  __u32 tmp ;
...
{ 
  ...
  unsigned long aux_len ;
    klee_make_symbolic(&aux_len, sizeof(long), "aux_len");
...
{ 
  ...
  unsigned long wake_at ;
    klee_make_symbolic(&wake_at, sizeof(long), "wake_at");
  unsigned long _max1 ;
...
{ 
  union iwreq_data wrqu ;
  int scan_forceloss ;
    klee_make_symbolic(&scan_forceloss, sizeof(int), "scan_forceloss");
  u16 status ;
  int tmp ;
...
{ 
  ...
  Resp rsp ;
  int miclen ;
    klee_make_symbolic(&miclen, sizeof(int), "miclen");
  u16 txFid ;
  MICBuffer pMic ;
  int tmp ;
  int tmp___0 ;
...
{ 
  ...
  int i___0 ;
  int v___1 ;
    klee_make_symbolic(&v___1, sizeof(int), "v___1");
  int i___1 ;
    klee_make_symbolic(&i___1, sizeof(int), "i___1");
  int v___2 ;
    klee_make_symbolic(&v___2, sizeof(int), "v___2");
  int i___2 ;
    klee_make_symbolic(&i___2, sizeof(int), "i___2");
  int v___3 ;
    klee_make_symbolic(&v___3, sizeof(int), "v___3");
  int i___3 ;
    klee_make_symbolic(&i___3, sizeof(int), "i___3");
  int v___4 ;
    klee_make_symbolic(&v___4, sizeof(int), "v___4");
  int i___4 ;
    klee_make_symbolic(&i___4, sizeof(int), "i___4");
  int v___5 ;
    klee_make_symbolic(&v___5, sizeof(int), "v___5");
  int i___5 ;
    klee_make_symbolic(&i___5, sizeof(int), "i___5");
  int v___6 ;
    klee_make_symbolic(&v___6, sizeof(int), "v___6");
  int i___6 ;
    klee_make_symbolic(&i___6, sizeof(int), "i___6");
  int v___7 ;
    klee_make_symbolic(&v___7, sizeof(int), "v___7");
  int i___7 ;
    klee_make_symbolic(&i___7, sizeof(int), "i___7");
  int tmp___5 ;
  int tmp___6 ;
  int tmp___7 ;
  int tmp___8 ;
...
{ 
  ...
  __le16 lastindex ;
  int klen ;
    klee_make_symbolic(&klen, sizeof(int), "klen");
  int __min1 ;
...
{ 
  ...
  int rc ;
  int doLoseSync ;
    klee_make_symbolic(&doLoseSync, sizeof(int), "doLoseSync");
  void *tmp___0 ;
  char *tmp___1 ;
  void *tmp___2 ;
  Cmd cmd ;
...
{ 
  struct airo_info *local ;
  int rthr ;
    klee_make_symbolic(&rthr, sizeof(int), "rthr");
...
{ 
  struct airo_info *local ;
  int fthr ;
    klee_make_symbolic(&fthr, sizeof(int), "fthr");
...
{ 
  ...
  int index ;
  int current_index ;
    klee_make_symbolic(&current_index, sizeof(int), "current_index");
  int tmp ;
  int index___0 ;
...
{ 
  ...
  int index ;
  int wep_key_len ;
    klee_make_symbolic(&wep_key_len, sizeof(int), "wep_key_len");
  u8 buf[16U] ;
  int tmp ;
...
{ 
  ...
  int set_key ;
    klee_make_symbolic(&set_key, sizeof(int), "set_key");
  int rc ;
  wep_key_t key ;
  int tmp ;
  __u16 _min1 ;
...
{ 
  ...
  int i ;
  int loseSync ;
    klee_make_symbolic(&loseSync, sizeof(int), "loseSync");
  bool tmp ;
  void *tmp___0 ;
  u16 dBm ;
  int tmp___1 ;
...
{ 
  ...
  Resp rsp ;
  int wake ;
    klee_make_symbolic(&wake, sizeof(int), "wake");
  int tmp ;
...
{ 
  ...
  unsigned int num_null_ies ;
    klee_make_symbolic(&num_null_ies, sizeof(int), "num_null_ies");
  u16 length ;
  u8 *ie ;
  int _min1 ;
  int _min2 ;
...
{ 
  unsigned short ridcode ;
    klee_make_symbolic(&ridcode, sizeof(short), "ridcode");
  unsigned char *iobuf ;
  int len ;
  struct airo_info *ai ;
  int tmp ;
...
{ 
  int rchar ;
    klee_make_symbolic(&rchar, sizeof(int), "rchar");
  unsigned char rbyte ;
    klee_make_symbolic(&rbyte, sizeof(char), "rbyte");
  unsigned short tmp ;
  unsigned long __ms ;
...
int ldv_9_ldv_param_3_1_default  ;
    klee_make_symbolic(&ldv_9_ldv_param_3_1_default, sizeof(int), "ldv_9_ldv_param_3_1_default");
int ldv_9_ldv_param_9_2_default  ;
    klee_make_symbolic(&ldv_9_ldv_param_9_2_default, sizeof(int), "ldv_9_ldv_param_9_2_default");
int ldv_statevar_0  ;
