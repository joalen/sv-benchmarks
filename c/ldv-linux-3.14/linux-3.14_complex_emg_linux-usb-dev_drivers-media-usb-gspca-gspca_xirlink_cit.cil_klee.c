...
struct __anonstruct_cv_246 {
   unsigned short cv1 ;
    klee_make_symbolic(&cv1, sizeof(short), "cv1");
   unsigned short cv2 ;
    klee_make_symbolic(&cv2, sizeof(short), "cv2");
   unsigned short cv3 ;
    klee_make_symbolic(&cv3, sizeof(short), "cv3");
};
struct __anonstruct_sv_248 {
   unsigned short sv1 ;
    klee_make_symbolic(&sv1, sizeof(short), "sv1");
   unsigned short sv2 ;
    klee_make_symbolic(&sv2, sizeof(short), "sv2");
   unsigned short sv3 ;
    klee_make_symbolic(&sv3, sizeof(short), "sv3");
   unsigned short sv4 ;
    klee_make_symbolic(&sv4, sizeof(short), "sv4");
};
...
static int ibm_netcam_pro  ;
    klee_make_symbolic(&ibm_netcam_pro, sizeof(int), "ibm_netcam_pro");
static int rca_input  ;
    klee_make_symbolic(&rca_input, sizeof(int), "rca_input");
...
{ 
  ...
  int new_contrast ;
    klee_make_symbolic(&new_contrast, sizeof(int), "new_contrast");
...
{ 
  int clock_div ;
    klee_make_symbolic(&clock_div, sizeof(int), "clock_div");
  int fps[8U] ;
  int packet_size ;
...
{ 
  unsigned short compression ;
    klee_make_symbolic(&compression, sizeof(short), "compression");
  int clock_div ;
...
{ 
  int new_button_state ;
    klee_make_symbolic(&new_button_state, sizeof(int), "new_button_state");
  struct sd *sd ;
