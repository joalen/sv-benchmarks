...
struct pegasus {
   ...
   u32 wolopts ;
   int dev_index ;
    klee_make_symbolic(&dev_index, sizeof(int), "dev_index");
   int intr_interval ;
    klee_make_symbolic(&intr_interval, sizeof(int), "intr_interval");
...
static int pegasus_count  ;
    klee_make_symbolic(&pegasus_count, sizeof(int), "pegasus_count");
