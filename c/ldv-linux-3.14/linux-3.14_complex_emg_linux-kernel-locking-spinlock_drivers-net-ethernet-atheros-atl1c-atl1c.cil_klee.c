...
struct atl1c_adapter {
   ...
   unsigned int rx_page_offset ;
    klee_make_symbolic(&rx_page_offset, sizeof(int), "rx_page_offset");
   unsigned int rx_frag_size ;
    klee_make_symbolic(&rx_frag_size, sizeof(int), "rx_frag_size");
   struct atl1c_hw hw ;
...
{ 
  unsigned int head_size ;
    klee_make_symbolic(&head_size, sizeof(int), "head_size");
  int mtu ;
  int __y ;
...
{ 
  struct atl1c_hw *hw ;
  int max_pay_load ;
    klee_make_symbolic(&max_pay_load, sizeof(int), "max_pay_load");
...
unsigned int ldv_1_ldv_param_37_1_default  ;
    klee_make_symbolic(&ldv_1_ldv_param_37_1_default, sizeof(int), "ldv_1_ldv_param_37_1_default");
