...
struct netdev_private {
   ...
   unsigned int tx_q_bytes ;
    klee_make_symbolic(&tx_q_bytes, sizeof(int), "tx_q_bytes");
...
{ 
  ...
  int fasteth ;
    klee_make_symbolic(&fasteth, sizeof(int), "fasteth");
  int result ;
    klee_make_symbolic(&result, sizeof(int), "result");
  int mii_reg ;
    klee_make_symbolic(&mii_reg, sizeof(int), "mii_reg");
  bool tmp___0 ;
  bool tmp___1 ;
  int tmp___2 ;
  int negotiated ;
...
{ 
  ...
  void *ioaddr ;
  int work_limit ;
    klee_make_symbolic(&work_limit, sizeof(int), "work_limit");
  int handled ;
...
{ 
  ...
  int filbit ;
    klee_make_symbolic(&filbit, sizeof(int), "filbit");
  u32 tmp___0 ;
  u32 tmp___1 ;
