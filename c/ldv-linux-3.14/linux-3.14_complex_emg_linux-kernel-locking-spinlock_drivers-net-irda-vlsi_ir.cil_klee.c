...
struct vlsi_irda_dev {
   ...
   int new_baud ;
    klee_make_symbolic(&new_baud, sizeof(int), "new_baud");
   dma_addr_t busaddr ;
   void *virtaddr ;
...
{ 
  ...
  u16 word ;
  unsigned int delta1 ;
    klee_make_symbolic(&delta1, sizeof(int), "delta1");
  unsigned int delta2 ;
    klee_make_symbolic(&delta2, sizeof(int), "delta2");
  struct timeval now ;
  unsigned int iobase ;
  bool tmp___0 ;
  bool tmp___1 ;
...
{ 
  u16 status ;
  int crclen ;
    klee_make_symbolic(&crclen, sizeof(int), "crclen");
  int len ;
  struct sk_buff *skb ;
  int ret ;
...
{ 
  ...
  int baudrate ;
  int fifocnt ;
    klee_make_symbolic(&fifocnt, sizeof(int), "fifocnt");
  int tmp ;
...
{ 
  ...
  unsigned int chip_io_extent ;
    klee_make_symbolic(&chip_io_extent, sizeof(int), "chip_io_extent");
...
{ 
  ...
  u8 irintr ;
  int boguscount ;
    klee_make_symbolic(&boguscount, sizeof(int), "boguscount");
  unsigned long flags ;
  int handled ;
...
int ldv_2_ldv_param_3_2_default  ;
    klee_make_symbolic(&ldv_2_ldv_param_3_2_default, sizeof(int), "ldv_2_ldv_param_3_2_default");
