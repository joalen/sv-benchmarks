...
struct mlx5_caps {
   ...
   int log_max_msg ;
    klee_make_symbolic(&log_max_msg, sizeof(int), "log_max_msg");
   int num_ports ;
    klee_make_symbolic(&num_ports, sizeof(int), "num_ports");
   int max_ra_res_qp ;
    klee_make_symbolic(&max_ra_res_qp, sizeof(int), "max_ra_res_qp");
   int max_ra_req_qp ;
    klee_make_symbolic(&max_ra_req_qp, sizeof(int), "max_ra_req_qp");
   int max_srq_wqes ;
   ...
   u8 ext_port_cap[2U] ;
   int max_vf ;
    klee_make_symbolic(&max_vf, sizeof(int), "max_vf");
   u32 reserved_lkey ;
   u8 local_ca_ack_delay ;
   u8 log_max_mcg ;
   u32 max_qp_mcg ;
...
struct mlx5_priv {
   ...
   int reg_pages ;
    klee_make_symbolic(&reg_pages, sizeof(int), "reg_pages");
...
int mlx5_core_debug_mask  ;
    klee_make_symbolic(&mlx5_core_debug_mask, sizeof(int), "mlx5_core_debug_mask");
...
{ 
  unsigned long poll_end ;
    klee_make_symbolic(&poll_end, sizeof(long), "poll_end");
  unsigned long tmp ;
  u8 own ;
...
{ 
  ...
  struct mlx5_cmd_mailbox *next ;
  int data_only ;
    klee_make_symbolic(&data_only, sizeof(int), "data_only");
  int offset ;
  int dump_len ;
...
{ 
  ...
  int pages_queue ;
    klee_make_symbolic(&pages_queue, sizeof(int), "pages_queue");
  gfp_t gfp ;
  int err ;
  u8 status ;
  long tmp ;
...
{ 
  ...
  int err ;
  int no_sq ;
    klee_make_symbolic(&no_sq, sizeof(int), "no_sq");
  void *tmp ;
  struct task_struct *tmp___0 ;
  __u32 tmp___1 ;
  char const   *tmp___2 ;
...
{ 
  ...
  char tbuf[18U] ;
  int is_str ;
    klee_make_symbolic(&is_str, sizeof(int), "is_str");
  u64 field ;
  int ret ;
  struct task_struct *tmp ;
  unsigned long tmp___0 ;
...
{ 
  int tot_uuars ;
    klee_make_symbolic(&tot_uuars, sizeof(int), "tot_uuars");
...
{ 
  ...
  struct mlx5_manage_pages_outbox *out ;
  int num_claimed ;
    klee_make_symbolic(&num_claimed, sizeof(int), "num_claimed");
  int outlen ;
  u64 addr ;
  int err ;
  int i ;
...
{ 
  ...
  struct rb_node *p ;
  int nclaimed ;
    klee_make_symbolic(&nclaimed, sizeof(int), "nclaimed");
  int err ;
  struct rb_node  const  *__mptr ;
  int tmp___0 ;
  struct task_struct *tmp___1 ;
