...
struct usbvision_v4l2_format_st {
   ...
   int bytes_per_pixel ;
    klee_make_symbolic(&bytes_per_pixel, sizeof(int), "bytes_per_pixel");
   int depth ;
   int format ;
...
struct usbvision_frame_header {
   unsigned char magic_1 ;
    klee_make_symbolic(&magic_1, sizeof(char), "magic_1");
   unsigned char magic_2 ;
    klee_make_symbolic(&magic_2, sizeof(char), "magic_2");
   unsigned char header_length ;
    klee_make_symbolic(&header_length, sizeof(char), "header_length");
   unsigned char frame_num ;
    klee_make_symbolic(&frame_num, sizeof(char), "frame_num");
   unsigned char frame_phase ;
    klee_make_symbolic(&frame_phase, sizeof(char), "frame_phase");
   unsigned char frame_latency ;
    klee_make_symbolic(&frame_latency, sizeof(char), "frame_latency");
   unsigned char data_format ;
    klee_make_symbolic(&data_format, sizeof(char), "data_format");
   unsigned char format_param ;
    klee_make_symbolic(&format_param, sizeof(char), "format_param");
   unsigned char frame_width_lo ;
    klee_make_symbolic(&frame_width_lo, sizeof(char), "frame_width_lo");
   unsigned char frame_width_hi ;
    klee_make_symbolic(&frame_width_hi, sizeof(char), "frame_width_hi");
   unsigned char frame_height_lo ;
    klee_make_symbolic(&frame_height_lo, sizeof(char), "frame_height_lo");
   unsigned char frame_height_hi ;
    klee_make_symbolic(&frame_height_hi, sizeof(char), "frame_height_hi");
   __u16 frame_width ;
   __u16 frame_height ;
};
struct usbvision_frame {
   ...
   int index ;
   int frmwidth ;
    klee_make_symbolic(&frmwidth, sizeof(int), "frmwidth");
   int frmheight ;
    klee_make_symbolic(&frmheight, sizeof(int), "frmheight");
   int volatile   grabstate ;
   int scanstate ;
    klee_make_symbolic(&scanstate, sizeof(int), "scanstate");
   struct list_head frame ;
   int curline ;
    klee_make_symbolic(&curline, sizeof(int), "curline");
   long scanlength ;
    klee_make_symbolic(&scanlength, sizeof(long), "scanlength");
   long bytes_read ;
    klee_make_symbolic(&bytes_read, sizeof(long), "bytes_read");
   struct usbvision_v4l2_format_st v4l2_format ;
   int v4l2_linesize ;
    klee_make_symbolic(&v4l2_linesize, sizeof(int), "v4l2_linesize");
...
struct usb_usbvision {
   ...
   int registered_i2c ;
    klee_make_symbolic(&registered_i2c, sizeof(int), "registered_i2c");
   struct urb *ctrl_urb ;
   unsigned char ctrl_urb_buffer[8U] ;
   int ctrl_urb_busy ;
    klee_make_symbolic(&ctrl_urb_busy, sizeof(int), "ctrl_urb_busy");
   struct usb_ctrlrequest ctrl_urb_setup ;
   wait_queue_head_t ctrl_urb_wq ;
   int have_tuner ;
    klee_make_symbolic(&have_tuner, sizeof(int), "have_tuner");
   int tuner_type ;
    klee_make_symbolic(&tuner_type, sizeof(int), "tuner_type");
   int bridge_type ;
    klee_make_symbolic(&bridge_type, sizeof(int), "bridge_type");
   int radio ;
    klee_make_symbolic(&radio, sizeof(int), "radio");
   int video_inputs ;
    klee_make_symbolic(&video_inputs, sizeof(int), "video_inputs");
   unsigned long freq ;
    klee_make_symbolic(&freq, sizeof(long), "freq");
   int audio_mute ;
    klee_make_symbolic(&audio_mute, sizeof(int), "audio_mute");
   int audio_channel ;
    klee_make_symbolic(&audio_channel, sizeof(int), "audio_channel");
   int isoc_mode ;
    klee_make_symbolic(&isoc_mode, sizeof(int), "isoc_mode");
   unsigned int nr ;
   struct usb_device *dev ;
   int num_alt ;
   ...
   unsigned char iface_alt ;
    klee_make_symbolic(&iface_alt, sizeof(char), "iface_alt");
   unsigned char vin_reg2_preset ;
    klee_make_symbolic(&vin_reg2_preset, sizeof(char), "vin_reg2_preset");
   ...
   int dev_model ;
    klee_make_symbolic(&dev_model, sizeof(int), "dev_model");
   enum stream_state streaming ;
   int last_error ;
    klee_make_symbolic(&last_error, sizeof(int), "last_error");
   int curwidth ;
    klee_make_symbolic(&curwidth, sizeof(int), "curwidth");
   int curheight ;
    klee_make_symbolic(&curheight, sizeof(int), "curheight");
   int stretch_width ;
    klee_make_symbolic(&stretch_width, sizeof(int), "stretch_width");
   int stretch_height ;
    klee_make_symbolic(&stretch_height, sizeof(int), "stretch_height");
   char *fbuf ;
   int max_frame_size ;
    klee_make_symbolic(&max_frame_size, sizeof(int), "max_frame_size");
   int fbuf_size ;
    klee_make_symbolic(&fbuf_size, sizeof(int), "fbuf_size");
   ...
   int scratch_read_ptr ;
    klee_make_symbolic(&scratch_read_ptr, sizeof(int), "scratch_read_ptr");
   int scratch_write_ptr ;
    klee_make_symbolic(&scratch_write_ptr, sizeof(int), "scratch_write_ptr");
   int scratch_headermarker[20U] ;
   int scratch_headermarker_read_ptr ;
    klee_make_symbolic(&scratch_headermarker_read_ptr, sizeof(int), "scratch_headermarker_read_ptr");
   int scratch_headermarker_write_ptr ;
    klee_make_symbolic(&scratch_headermarker_write_ptr, sizeof(int), "scratch_headermarker_write_ptr");
   ...
   unsigned char video_endp ;
    klee_make_symbolic(&video_endp, sizeof(char), "video_endp");
   unsigned char *intra_frame_buffer ;
   int block_pos ;
    klee_make_symbolic(&block_pos, sizeof(int), "block_pos");
   int request_intra ;
    klee_make_symbolic(&request_intra, sizeof(int), "request_intra");
   int last_isoc_frame_num ;
    klee_make_symbolic(&last_isoc_frame_num, sizeof(int), "last_isoc_frame_num");
   int isoc_packet_size ;
    klee_make_symbolic(&isoc_packet_size, sizeof(int), "isoc_packet_size");
   int used_bandwidth ;
    klee_make_symbolic(&used_bandwidth, sizeof(int), "used_bandwidth");
   int compr_level ;
    klee_make_symbolic(&compr_level, sizeof(int), "compr_level");
   int last_compr_level ;
    klee_make_symbolic(&last_compr_level, sizeof(int), "last_compr_level");
   int usb_bandwidth ;
    klee_make_symbolic(&usb_bandwidth, sizeof(int), "usb_bandwidth");
   unsigned long isoc_urb_count ;
    klee_make_symbolic(&isoc_urb_count, sizeof(long), "isoc_urb_count");
   unsigned long urb_length ;
    klee_make_symbolic(&urb_length, sizeof(long), "urb_length");
   unsigned long isoc_data_count ;
    klee_make_symbolic(&isoc_data_count, sizeof(long), "isoc_data_count");
   unsigned long header_count ;
    klee_make_symbolic(&header_count, sizeof(long), "header_count");
   unsigned long scratch_ovf_count ;
    klee_make_symbolic(&scratch_ovf_count, sizeof(long), "scratch_ovf_count");
   unsigned long isoc_skip_count ;
    klee_make_symbolic(&isoc_skip_count, sizeof(long), "isoc_skip_count");
   unsigned long isoc_err_count ;
    klee_make_symbolic(&isoc_err_count, sizeof(long), "isoc_err_count");
   unsigned long isoc_packet_count ;
    klee_make_symbolic(&isoc_packet_count, sizeof(long), "isoc_packet_count");
   unsigned long time_in_irq ;
    klee_make_symbolic(&time_in_irq, sizeof(long), "time_in_irq");
   int isoc_measure_bandwidth_count ;
    klee_make_symbolic(&isoc_measure_bandwidth_count, sizeof(int), "isoc_measure_bandwidth_count");
   int frame_num ;
   int max_strip_len ;
    klee_make_symbolic(&max_strip_len, sizeof(int), "max_strip_len");
   int comprblock_pos ;
    klee_make_symbolic(&comprblock_pos, sizeof(int), "comprblock_pos");
   int strip_len_errors ;
    klee_make_symbolic(&strip_len_errors, sizeof(int), "strip_len_errors");
   int strip_magic_errors ;
    klee_make_symbolic(&strip_magic_errors, sizeof(int), "strip_magic_errors");
   int strip_line_number_errors ;
    klee_make_symbolic(&strip_line_number_errors, sizeof(int), "strip_line_number_errors");
...
static int switch_svideo_input  ;
    klee_make_symbolic(&switch_svideo_input, sizeof(int), "switch_svideo_input");
...
{ 
  int free___0 ;
    klee_make_symbolic(&free___0, sizeof(int), "free___0");
...
{ 
  int len_part ;
    klee_make_symbolic(&len_part, sizeof(int), "len_part");
...
{ 
  int err_code ;
    klee_make_symbolic(&err_code, sizeof(int), "err_code");
...
{ 
  int IFB_size ;
    klee_make_symbolic(&IFB_size, sizeof(int), "IFB_size");
  void *tmp ;
...
{ 
  ...
  int found_header ;
    klee_make_symbolic(&found_header, sizeof(int), "found_header");
  int tmp ;
...
{ 
  ...
  unsigned char rv ;
    klee_make_symbolic(&rv, sizeof(char), "rv");
  unsigned char gv ;
    klee_make_symbolic(&gv, sizeof(char), "gv");
  unsigned char bv ;
    klee_make_symbolic(&bv, sizeof(char), "bv");
  int clipmask_index ;
    klee_make_symbolic(&clipmask_index, sizeof(int), "clipmask_index");
  int bytes_per_pixel ;
  int stretch_bytes ;
    klee_make_symbolic(&stretch_bytes, sizeof(int), "stretch_bytes");
  int clipmask_add ;
    klee_make_symbolic(&clipmask_add, sizeof(int), "clipmask_add");
  int tmp ;
  unsigned char *tmp___0 ;
  unsigned char *tmp___1 ;
  int mm_y ;
    klee_make_symbolic(&mm_y, sizeof(int), "mm_y");
  int mm_yc ;
    klee_make_symbolic(&mm_yc, sizeof(int), "mm_yc");
  int mm_u ;
    klee_make_symbolic(&mm_u, sizeof(int), "mm_u");
  int mm_v ;
    klee_make_symbolic(&mm_v, sizeof(int), "mm_v");
  int mm_r ;
    klee_make_symbolic(&mm_r, sizeof(int), "mm_r");
  int mm_g ;
    klee_make_symbolic(&mm_g, sizeof(int), "mm_g");
  int mm_b ;
    klee_make_symbolic(&mm_b, sizeof(int), "mm_b");
  ...
  int mm_y___0 ;
    klee_make_symbolic(&mm_y___0, sizeof(int), "mm_y___0");
  int mm_yc___0 ;
    klee_make_symbolic(&mm_yc___0, sizeof(int), "mm_yc___0");
  int mm_u___0 ;
    klee_make_symbolic(&mm_u___0, sizeof(int), "mm_u___0");
  int mm_v___0 ;
    klee_make_symbolic(&mm_v___0, sizeof(int), "mm_v___0");
  int mm_r___0 ;
    klee_make_symbolic(&mm_r___0, sizeof(int), "mm_r___0");
  int mm_g___0 ;
    klee_make_symbolic(&mm_g___0, sizeof(int), "mm_g___0");
  int mm_b___0 ;
    klee_make_symbolic(&mm_b___0, sizeof(int), "mm_b___0");
...
{ 
  int rest_pixel ;
    klee_make_symbolic(&rest_pixel, sizeof(int), "rest_pixel");
  int idx ;
    klee_make_symbolic(&idx, sizeof(int), "idx");
  int pos ;
    klee_make_symbolic(&pos, sizeof(int), "pos");
  int extra_pos ;
    klee_make_symbolic(&extra_pos, sizeof(int), "extra_pos");
  int block_len ;
    klee_make_symbolic(&block_len, sizeof(int), "block_len");
  int block_type_pos ;
    klee_make_symbolic(&block_type_pos, sizeof(int), "block_type_pos");
  int block_type_len ;
    klee_make_symbolic(&block_type_len, sizeof(int), "block_type_len");
  unsigned char block_byte ;
    klee_make_symbolic(&block_byte, sizeof(char), "block_byte");
  unsigned char block_code ;
    klee_make_symbolic(&block_code, sizeof(char), "block_code");
  unsigned char block_type ;
    klee_make_symbolic(&block_type, sizeof(char), "block_type");
  unsigned char block_type_byte ;
    klee_make_symbolic(&block_type_byte, sizeof(char), "block_type_byte");
  unsigned char integrator ;
    klee_make_symbolic(&integrator, sizeof(char), "integrator");
...
{ 
  ...
  int strip_len ;
    klee_make_symbolic(&strip_len, sizeof(int), "strip_len");
  int strip_ptr ;
    klee_make_symbolic(&strip_ptr, sizeof(int), "strip_ptr");
  int startblock_pos ;
    klee_make_symbolic(&startblock_pos, sizeof(int), "startblock_pos");
  int block_pos ;
  int block_type_pos ;
  int clipmask_index ;
  int image_size ;
...
{ 
  ...
  unsigned int pixel_per_line ;
    klee_make_symbolic(&pixel_per_line, sizeof(int), "pixel_per_line");
  unsigned int block ;
    klee_make_symbolic(&block, sizeof(int), "block");
  int pixel ;
    klee_make_symbolic(&pixel, sizeof(int), "pixel");
  int block_split ;
    klee_make_symbolic(&block_split, sizeof(int), "block_split");
  int y_ptr ;
    klee_make_symbolic(&y_ptr, sizeof(int), "y_ptr");
  int u_ptr ;
    klee_make_symbolic(&u_ptr, sizeof(int), "u_ptr");
  int v_ptr ;
    klee_make_symbolic(&v_ptr, sizeof(int), "v_ptr");
  int y_odd_offset ;
    klee_make_symbolic(&y_odd_offset, sizeof(int), "y_odd_offset");
  int y_block_size ;
    klee_make_symbolic(&y_block_size, sizeof(int), "y_block_size");
  int uv_block_size ;
    klee_make_symbolic(&uv_block_size, sizeof(int), "uv_block_size");
  int sub_block_size ;
    klee_make_symbolic(&sub_block_size, sizeof(int), "sub_block_size");
  int y_step[4U] ;
  int y_step_size ;
    klee_make_symbolic(&y_step_size, sizeof(int), "y_step_size");
  int uv_step[4U] ;
  int uv_step_size ;
    klee_make_symbolic(&uv_step_size, sizeof(int), "uv_step_size");
  unsigned char y[2U] ;
  unsigned char u ;
    klee_make_symbolic(&u, sizeof(char), "u");
  unsigned char v ;
    klee_make_symbolic(&v, sizeof(char), "v");
  int y_ ;
    klee_make_symbolic(&y_, sizeof(int), "y_");
  int u_ ;
    klee_make_symbolic(&u_, sizeof(int), "u_");
  int v_ ;
    klee_make_symbolic(&v_, sizeof(int), "v_");
  int vb ;
    klee_make_symbolic(&vb, sizeof(int), "vb");
  int uvg ;
    klee_make_symbolic(&uvg, sizeof(int), "uvg");
  int ur ;
    klee_make_symbolic(&ur, sizeof(int), "ur");
  int r_ ;
    klee_make_symbolic(&r_, sizeof(int), "r_");
  int g_ ;
    klee_make_symbolic(&g_, sizeof(int), "g_");
  int b_ ;
    klee_make_symbolic(&b_, sizeof(int), "b_");
  unsigned char g ;
    klee_make_symbolic(&g, sizeof(char), "g");
  int clipmask_even_index ;
    klee_make_symbolic(&clipmask_even_index, sizeof(int), "clipmask_even_index");
  int clipmask_odd_index ;
    klee_make_symbolic(&clipmask_odd_index, sizeof(int), "clipmask_odd_index");
  int bytes_per_pixel ;
  int clipmask_add ;
  int stretch_bytes ;
  int tmp ;
...
{ 
  ...
  long copylen ;
    klee_make_symbolic(&copylen, sizeof(long), "copylen");
...
{ 
  ...
  int packet_len ;
    klee_make_symbolic(&packet_len, sizeof(int), "packet_len");
  int packet_stat ;
    klee_make_symbolic(&packet_stat, sizeof(int), "packet_stat");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
...
{ 
  ...
  int distortion ;
    klee_make_symbolic(&distortion, sizeof(int), "distortion");
...
{ 
  int err_code ;
  int usb_width ;
    klee_make_symbolic(&usb_width, sizeof(int), "usb_width");
  int usb_height ;
    klee_make_symbolic(&usb_height, sizeof(int), "usb_height");
  unsigned int frame_rate ;
    klee_make_symbolic(&frame_rate, sizeof(int), "frame_rate");
  unsigned int frame_drop ;
    klee_make_symbolic(&frame_drop, sizeof(int), "frame_drop");
...
{ 
  ...
  unsigned char dvi_yuv_value ;
    klee_make_symbolic(&dvi_yuv_value, sizeof(char), "dvi_yuv_value");
  unsigned int tmp ;
  int tmp___0 ;
...
{ 
  struct usb_device *dev ;
  int buf_idx ;
    klee_make_symbolic(&buf_idx, sizeof(int), "buf_idx");
  int err_code ;
  int reg_value ;
...
static int usbvision_nr  ;
    klee_make_symbolic(&usbvision_nr, sizeof(int), "usbvision_nr");
...
{ 
  ...
  int tmp___0 ;
  int setup_ok ;
    klee_make_symbolic(&setup_ok, sizeof(int), "setup_ok");
...
{ 
  ...
  void *tmp ;
  int format_idx ;
    klee_make_symbolic(&format_idx, sizeof(int), "format_idx");
...
int ldv_11_probe_retval_default  ;
    klee_make_symbolic(&ldv_11_probe_retval_default, sizeof(int), "ldv_11_probe_retval_default");
...
unsigned long ldv_13_ldv_param_18_2_default  ;
    klee_make_symbolic(&ldv_13_ldv_param_18_2_default, sizeof(long), "ldv_13_ldv_param_18_2_default");
long long *ldv_13_ldv_param_18_3_default  ;
unsigned int ldv_13_ldv_param_21_1_default  ;
    klee_make_symbolic(&ldv_13_ldv_param_21_1_default, sizeof(int), "ldv_13_ldv_param_21_1_default");
unsigned long ldv_13_ldv_param_21_2_default  ;
    klee_make_symbolic(&ldv_13_ldv_param_21_2_default, sizeof(long), "ldv_13_ldv_param_21_2_default");
...
unsigned int ldv_13_ldv_param_52_2_default  ;
    klee_make_symbolic(&ldv_13_ldv_param_52_2_default, sizeof(int), "ldv_13_ldv_param_52_2_default");
unsigned long long ldv_13_ldv_param_56_2_default  ;
    klee_make_symbolic(&ldv_13_ldv_param_56_2_default, sizeof(long), "ldv_13_ldv_param_56_2_default");
...
unsigned long ldv_14_ldv_param_18_2_default  ;
    klee_make_symbolic(&ldv_14_ldv_param_18_2_default, sizeof(long), "ldv_14_ldv_param_18_2_default");
long long *ldv_14_ldv_param_18_3_default  ;
unsigned int ldv_14_ldv_param_21_1_default  ;
    klee_make_symbolic(&ldv_14_ldv_param_21_1_default, sizeof(int), "ldv_14_ldv_param_21_1_default");
unsigned long ldv_14_ldv_param_21_2_default  ;
    klee_make_symbolic(&ldv_14_ldv_param_21_2_default, sizeof(long), "ldv_14_ldv_param_21_2_default");
...
unsigned int ldv_14_ldv_param_52_2_default  ;
    klee_make_symbolic(&ldv_14_ldv_param_52_2_default, sizeof(int), "ldv_14_ldv_param_52_2_default");
unsigned long long ldv_14_ldv_param_56_2_default  ;
    klee_make_symbolic(&ldv_14_ldv_param_56_2_default, sizeof(long), "ldv_14_ldv_param_56_2_default");
...
{ 
  ...
  unsigned char ser_cont ;
    klee_make_symbolic(&ser_cont, sizeof(char), "ser_cont");
  unsigned int tmp ;
  int idx ;
...
{ 
  ...
  int i ;
  int rdcount ;
    klee_make_symbolic(&rdcount, sizeof(int), "rdcount");
  int count ;
