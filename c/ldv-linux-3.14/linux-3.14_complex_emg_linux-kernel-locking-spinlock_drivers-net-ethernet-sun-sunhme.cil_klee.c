...
struct happy_meal {
   ...
   unsigned int happy_flags ;
    klee_make_symbolic(&happy_flags, sizeof(int), "happy_flags");
   int irq ;
   enum happy_transceiver tcvr_type ;
   unsigned int happy_bursts ;
    klee_make_symbolic(&happy_bursts, sizeof(int), "happy_bursts");
   unsigned int paddr ;
    klee_make_symbolic(&paddr, sizeof(int), "paddr");
   unsigned short hm_revision ;
    klee_make_symbolic(&hm_revision, sizeof(short), "hm_revision");
   unsigned short sw_bmcr ;
    klee_make_symbolic(&sw_bmcr, sizeof(short), "sw_bmcr");
   unsigned short sw_bmsr ;
    klee_make_symbolic(&sw_bmsr, sizeof(short), "sw_bmsr");
   unsigned short sw_physid1 ;
    klee_make_symbolic(&sw_physid1, sizeof(short), "sw_physid1");
   unsigned short sw_physid2 ;
    klee_make_symbolic(&sw_physid2, sizeof(short), "sw_physid2");
   unsigned short sw_advertise ;
    klee_make_symbolic(&sw_advertise, sizeof(short), "sw_advertise");
   unsigned short sw_lpa ;
    klee_make_symbolic(&sw_lpa, sizeof(short), "sw_lpa");
   unsigned short sw_expansion ;
    klee_make_symbolic(&sw_expansion, sizeof(short), "sw_expansion");
   unsigned short sw_csconfig ;
    klee_make_symbolic(&sw_csconfig, sizeof(short), "sw_csconfig");
   unsigned int auto_speed ;
    klee_make_symbolic(&auto_speed, sizeof(int), "auto_speed");
   unsigned int forced_speed ;
    klee_make_symbolic(&forced_speed, sizeof(int), "forced_speed");
   unsigned int poll_data ;
    klee_make_symbolic(&poll_data, sizeof(int), "poll_data");
   unsigned int poll_flag ;
    klee_make_symbolic(&poll_flag, sizeof(int), "poll_flag");
   unsigned int linkcheck ;
    klee_make_symbolic(&linkcheck, sizeof(int), "linkcheck");
   unsigned int lnkup ;
    klee_make_symbolic(&lnkup, sizeof(int), "lnkup");
   unsigned int lnkdown ;
    klee_make_symbolic(&lnkdown, sizeof(int), "lnkdown");
   unsigned int lnkcnt ;
    klee_make_symbolic(&lnkcnt, sizeof(int), "lnkcnt");
   ...
   int qfe_ent ;
    klee_make_symbolic(&qfe_ent, sizeof(int), "qfe_ent");
};
struct quattro {
   ...
   struct quattro *next ;
   int nranges ;
    klee_make_symbolic(&nranges, sizeof(int), "nranges");
};
...
{ 
  void *tregs ;
  unsigned short mr2 ;
    klee_make_symbolic(&mr2, sizeof(short), "mr2");
  unsigned short mr3 ;
    klee_make_symbolic(&mr3, sizeof(short), "mr3");
  int ret ;
  int tmp ;
  int tmp___0 ;
...
{ 
  ...
  void *tregs ;
  int restart_timer ;
    klee_make_symbolic(&restart_timer, sizeof(int), "restart_timer");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
  int tmp___2 ;
...
{ 
  unsigned long tconfig ;
    klee_make_symbolic(&tconfig, sizeof(long), "tconfig");
  unsigned int tmp ;
  unsigned int tmp___0 ;
  unsigned int tmp___1 ;
  u32 reread ;
...
{ 
  ...
  int frag ;
  int first_entry ;
    klee_make_symbolic(&first_entry, sizeof(int), "first_entry");
  dma_addr_t tmp___3 ;
...
static int hme_version_printed  ;
    klee_make_symbolic(&hme_version_printed, sizeof(int), "hme_version_printed");
...
{ 
  ...
  int n_hmes ;
    klee_make_symbolic(&n_hmes, sizeof(int), "n_hmes");
  struct list_head  const  *__mptr ;
  struct list_head  const  *__mptr___0 ;
...
{ 
  int this_offset ;
    klee_make_symbolic(&this_offset, sizeof(int), "this_offset");
  void *p ;
  unsigned char tmp ;
  unsigned char tmp___0 ;
  unsigned char tmp___1 ;
...
{ 
  ...
  unsigned long hpreg_res ;
    klee_make_symbolic(&hpreg_res, sizeof(long), "hpreg_res");
  int i ;
  int qfe_slot ;
    klee_make_symbolic(&qfe_slot, sizeof(int), "qfe_slot");
  char prom_name[64U] ;
  int err ;
...
#include "model/linux-3.14__complex_emg__linux-kernel-locking-spinlock__drivers-net-ethernet-sun-sunhme_true-unreach-call.cil.env.c"
#include <klee/klee.h>
