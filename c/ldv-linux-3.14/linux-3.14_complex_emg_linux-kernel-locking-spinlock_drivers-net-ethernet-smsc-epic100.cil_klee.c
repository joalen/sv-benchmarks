...
struct epic_private {
   ...
   unsigned int reschedule_in_poll ;
    klee_make_symbolic(&reschedule_in_poll, sizeof(int), "reschedule_in_poll");
   unsigned int cur_tx ;
   ...
   int chip_flags ;
    klee_make_symbolic(&chip_flags, sizeof(int), "chip_flags");
   struct timer_list timer ;
   int tx_threshold ;
   ...
   u16 advertising ;
   int mii_phy_cnt ;
    klee_make_symbolic(&mii_phy_cnt, sizeof(int), "mii_phy_cnt");
...
{ 
  ...
  int entry ;
  int txstatus ;
    klee_make_symbolic(&txstatus, sizeof(int), "txstatus");
  long tmp ;
