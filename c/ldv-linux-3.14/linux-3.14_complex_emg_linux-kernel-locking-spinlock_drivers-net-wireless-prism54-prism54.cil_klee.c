...
struct __anonstruct_islpci_private_250 {
   ...
   unsigned long stats_timestamp ;
    klee_make_symbolic(&stats_timestamp, sizeof(long), "stats_timestamp");
   ...
   int state_off ;
    klee_make_symbolic(&state_off, sizeof(int), "state_off");
   int wpa ;
    klee_make_symbolic(&wpa, sizeof(int), "wpa");
   struct list_head bss_wpa_list ;
   int num_bss_wpa ;
    klee_make_symbolic(&num_bss_wpa, sizeof(int), "num_bss_wpa");
   struct mutex wpa_lock ;
   u8 wpa_ie[64U] ;
   size_t wpa_ie_len ;
   struct work_struct reset_task ;
   int reset_task_pending ;
    klee_make_symbolic(&reset_task_pending, sizeof(int), "reset_task_pending");
};
...
struct obj_bss {
   ...
   char reserved ;
   short age ;
    klee_make_symbolic(&age, sizeof(short), "age");
   char quality ;
    klee_make_symbolic(&quality, sizeof(char), "quality");
   char rssi ;
   ...
   char beacon_period ;
    klee_make_symbolic(&beacon_period, sizeof(char), "beacon_period");
   char dtim_period ;
    klee_make_symbolic(&dtim_period, sizeof(char), "dtim_period");
   short capinfo ;
    klee_make_symbolic(&capinfo, sizeof(short), "capinfo");
   short rates ;
    klee_make_symbolic(&rates, sizeof(short), "rates");
   short basic_rates ;
    klee_make_symbolic(&basic_rates, sizeof(short), "basic_rates");
   int  ;
};
struct obj_bsslist {
   u32 nr ;
...
struct oid_t {
   enum oid_num_t oid ;
   short range ;
    klee_make_symbolic(&range, sizeof(short), "range");
   short size ;
   char flags ;
};
union oid_res_t {
...
int pc_debug ;
    klee_make_symbolic(&pc_debug, sizeof(int), "pc_debug");
...
{ 
  ...
  int newskb_offset ;
    klee_make_symbolic(&newskb_offset, sizeof(int), "newskb_offset");
  unsigned long flags ;
  u32 curr_frag ;
  long tmp___0 ;
  unsigned char *src ;
...
{ 
  ...
  long wait_cycle_jiffies ;
    klee_make_symbolic(&wait_cycle_jiffies, sizeof(long), "wait_cycle_jiffies");
  unsigned long tmp___0 ;
  long timeout_left ;
    klee_make_symbolic(&timeout_left, sizeof(long), "timeout_left");
  int err ;
  wait_queue_t wait ;
...
{ 
  ...
  union oid_res_t r ;
  int rvalue ;
    klee_make_symbolic(&rvalue, sizeof(int), "rvalue");
...
{ 
  ...
  int authen ;
    klee_make_symbolic(&authen, sizeof(int), "authen");
  int invoke ;
    klee_make_symbolic(&invoke, sizeof(int), "invoke");
  int exunencrypt ;
    klee_make_symbolic(&exunencrypt, sizeof(int), "exunencrypt");
  union oid_res_t r ;
  int index ;
  int current_index ;
...
{ 
  ...
  int ret ;
  int response_op ;
    klee_make_symbolic(&response_op, sizeof(int), "response_op");
  islpci_state_t tmp___0 ;
...
{ 
  ...
  long fw_len ;
    klee_make_symbolic(&fw_len, sizeof(long), "fw_len");
  u32 const   *fw_ptr ;
  int tmp___0 ;
  long _fw_len ;
    klee_make_symbolic(&_fw_len, sizeof(long), "_fw_len");
  u32 *dev_fw_ptr ;
  long tmp___1 ;
  long tmp___2 ;
...
{ 
  ...
  void *device ;
  int powerstate ;
    klee_make_symbolic(&powerstate, sizeof(int), "powerstate");
  unsigned int tmp ;
  islpci_state_t tmp___0 ;
  int tmp___1 ;
  int tmp___2 ;
...
{ 
  int ret ;
  int reslen ;
    klee_make_symbolic(&reslen, sizeof(int), "reslen");
  struct islpci_mgmtframe *response ;
  int dlen ;
  void *cache ;
  void *_res ;
...
{ 
  ...
  struct obj_key *key ;
  int t___0 ;
    klee_make_symbolic(&t___0, sizeof(int), "t___0");
  int i___1 ;
  ...
  int t___1 ;
    klee_make_symbolic(&t___1, sizeof(int), "t___1");
  int i___2 ;
