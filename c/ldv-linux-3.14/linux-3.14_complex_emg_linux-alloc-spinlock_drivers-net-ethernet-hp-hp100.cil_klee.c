...
struct hp100_ring {
   u_int *pdl ;
   u_int pdl_paddr ;
    klee_make_symbolic(&pdl_paddr, sizeof(int), "pdl_paddr");
   struct sk_buff *skb ;
...
struct hp100_private {
   ...
   char id[8U] ;
   u_short chip ;
    klee_make_symbolic(&chip, sizeof(short), "chip");
   u_short soft_model ;
    klee_make_symbolic(&soft_model, sizeof(short), "soft_model");
   u_int memory_size ;
    klee_make_symbolic(&memory_size, sizeof(int), "memory_size");
   u_int virt_memory_size ;
    klee_make_symbolic(&virt_memory_size, sizeof(int), "virt_memory_size");
   u_short rx_ratio ;
    klee_make_symbolic(&rx_ratio, sizeof(short), "rx_ratio");
   u_short priority_tx ;
    klee_make_symbolic(&priority_tx, sizeof(short), "priority_tx");
   u_short mode ;
   u_char bus ;
    klee_make_symbolic(&bus, sizeof(char), "bus");
   struct pci_dev *pci_dev ;
   short mem_mapped ;
    klee_make_symbolic(&mem_mapped, sizeof(short), "mem_mapped");
   void *mem_ptr_virt ;
   unsigned long mem_ptr_phys ;
    klee_make_symbolic(&mem_ptr_phys, sizeof(long), "mem_ptr_phys");
   short lan_type ;
    klee_make_symbolic(&lan_type, sizeof(short), "lan_type");
   int hub_status ;
    klee_make_symbolic(&hub_status, sizeof(int), "hub_status");
   u_char mac1_mode ;
    klee_make_symbolic(&mac1_mode, sizeof(char), "mac1_mode");
   u_char mac2_mode ;
    klee_make_symbolic(&mac2_mode, sizeof(char), "mac2_mode");
   ...
   u_long whatever_offset ;
    klee_make_symbolic(&whatever_offset, sizeof(long), "whatever_offset");
   int rxrcommit ;
    klee_make_symbolic(&rxrcommit, sizeof(int), "rxrcommit");
   int txrcommit ;
    klee_make_symbolic(&txrcommit, sizeof(int), "txrcommit");
};
...
{ 
  ...
  unsigned short rev ;
    klee_make_symbolic(&rev, sizeof(short), "rev");
  unsigned char tmp ;
...
{ 
  ...
  u_int chip ;
  u_char uc ;
    klee_make_symbolic(&uc, sizeof(char), "uc");
  u_int memory_size ;
  u_int virt_memory_size ;
  u_short local_mode ;
    klee_make_symbolic(&local_mode, sizeof(short), "local_mode");
  u_short lsw ;
    klee_make_symbolic(&lsw, sizeof(short), "lsw");
  short mem_mapped ;
  unsigned long mem_ptr_phys ;
  void *mem_ptr_virt ;
  struct hp100_private *lp ;
...
{ 
  ...
  int xmit_stop ;
    klee_make_symbolic(&xmit_stop, sizeof(int), "xmit_stop");
  int recv_stop ;
    klee_make_symbolic(&recv_stop, sizeof(int), "recv_stop");
  int pdl_stop ;
    klee_make_symbolic(&pdl_stop, sizeof(int), "pdl_stop");
...
{ 
  ...
  int i ;
  int ok_flag ;
    klee_make_symbolic(&ok_flag, sizeof(int), "ok_flag");
  int ioaddr ;
  struct hp100_private *lp ;
  void *tmp ;
  hp100_ring_t *ringptr ;
...
{ 
  ...
  int ioaddr ;
  int donecount ;
    klee_make_symbolic(&donecount, sizeof(int), "donecount");
  unsigned char tmp___0 ;
...
{ 
  int ioaddr ;
  u_short val_VG ;
    klee_make_symbolic(&val_VG, sizeof(short), "val_VG");
  u_short val_10 ;
    klee_make_symbolic(&val_10, sizeof(short), "val_10");
  struct hp100_private *lp ;
  void *tmp ;
  unsigned char tmp___0 ;
  unsigned char tmp___1 ;
...
{ 
  ...
  unsigned long time ;
  long savelan ;
    klee_make_symbolic(&savelan, sizeof(long), "savelan");
  long newlan ;
    klee_make_symbolic(&newlan, sizeof(long), "newlan");
  unsigned char tmp___0 ;
  int tmp___1 ;
  unsigned char tmp___2 ;
  unsigned char tmp___3 ;
...
{ 
  ...
  unsigned long time ;
  int startst ;
    klee_make_symbolic(&startst, sizeof(int), "startst");
  unsigned char tmp___0 ;
  unsigned char tmp___1 ;
  unsigned char tmp___2 ;
  unsigned char tmp___3 ;
...
{ 
  ...
  int ioaddr ;
  u_short pci_command ;
    klee_make_symbolic(&pci_command, sizeof(short), "pci_command");
  int err ;
  int tmp ;
