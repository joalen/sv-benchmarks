...
{ 
  ...
  int rx_cleaned ;
    klee_make_symbolic(&rx_cleaned, sizeof(int), "rx_cleaned");
  int tx_cleaned ;
...
{ 
  ...
  int err ;
  int completed_segs ;
    klee_make_symbolic(&completed_segs, sizeof(int), "completed_segs");
  int i ;
  int seg_cnt ;
    klee_make_symbolic(&seg_cnt, sizeof(int), "seg_cnt");
  int seg ;
...
{ 
  ...
  u16 value ;
  int max_wait_time ;
    klee_make_symbolic(&max_wait_time, sizeof(int), "max_wait_time");
  u32 tmp ;
  u32 tmp___0 ;
  u32 tmp___1 ;
...
{ 
  ...
  int tmp ;
  int soft_reset ;
    klee_make_symbolic(&soft_reset, sizeof(int), "soft_reset");
  unsigned long hw_flags ;
  int tmp___0 ;
