...
struct netdev_private {
   ...
   unsigned int rx_coalesce ;
    klee_make_symbolic(&rx_coalesce, sizeof(int), "rx_coalesce");
   ...
   unsigned long cur_rx ;
    klee_make_symbolic(&cur_rx, sizeof(long), "cur_rx");
   unsigned long old_rx ;
    klee_make_symbolic(&old_rx, sizeof(long), "old_rx");
   unsigned long cur_tx ;
    klee_make_symbolic(&cur_tx, sizeof(long), "cur_tx");
   unsigned long old_tx ;
    klee_make_symbolic(&old_tx, sizeof(long), "old_tx");
   struct timer_list timer ;
   int wake_polarity ;
    klee_make_symbolic(&wake_polarity, sizeof(int), "wake_polarity");
   char name[256U] ;
   u8 duplex_polarity ;
   u16 mcast_filter[4U] ;
   u16 advertising ;
...
static int copy_thresh  ;
    klee_make_symbolic(&copy_thresh, sizeof(int), "copy_thresh");
...
{ 
  ...
  int phy_found ;
    klee_make_symbolic(&phy_found, sizeof(int), "phy_found");
  void *tmp___0 ;
  int mii_status ;
...
{ 
  ...
  int entry ;
  int tx_use ;
    klee_make_symbolic(&tx_use, sizeof(int), "tx_use");
  unsigned long flag ;
...
{ 
  ...
  void *ioaddr ;
  int frame_id ;
    klee_make_symbolic(&frame_id, sizeof(int), "frame_id");
  int i ;
  unsigned int tmp___0 ;
  unsigned int tmp___1 ;
  unsigned long __ms ;
...
{ 
  ...
  unsigned int stat_reg ;
    klee_make_symbolic(&stat_reg, sizeof(int), "stat_reg");
  unsigned int tmp___0 ;
  unsigned int tmp___1 ;
  unsigned int tmp___2 ;
  unsigned int tmp___3 ;
