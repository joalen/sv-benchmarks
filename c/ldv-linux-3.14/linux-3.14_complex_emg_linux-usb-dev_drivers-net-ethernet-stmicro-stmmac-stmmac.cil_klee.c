...
struct netns_ipv4 {
   ...
   unsigned int tcp_metrics_hash_log ;
    klee_make_symbolic(&tcp_metrics_hash_log, sizeof(int), "tcp_metrics_hash_log");
...
struct net {
   ...
   unsigned int proc_inum ;
    klee_make_symbolic(&proc_inum, sizeof(int), "proc_inum");
...
struct cgroup {
   ...
   int nr_css ;
    klee_make_symbolic(&nr_css, sizeof(int), "nr_css");
   struct list_head sibling ;
   struct list_head children ;
...
struct cgroupfs_root {
   ...
   unsigned long subsys_mask ;
    klee_make_symbolic(&subsys_mask, sizeof(long), "subsys_mask");
   int hierarchy_id ;
    klee_make_symbolic(&hierarchy_id, sizeof(int), "hierarchy_id");
   struct cgroup top_cgroup ;
   int number_of_cgroups ;
    klee_make_symbolic(&number_of_cgroups, sizeof(int), "number_of_cgroups");
...
struct cgroup_subsys {
   ...
   int subsys_id ;
    klee_make_symbolic(&subsys_id, sizeof(int), "subsys_id");
   int disabled ;
...
struct rtc_device {
   ...
   unsigned long irq_data ;
    klee_make_symbolic(&irq_data, sizeof(long), "irq_data");
   spinlock_t irq_lock ;
   ...
   int irq_freq ;
    klee_make_symbolic(&irq_freq, sizeof(int), "irq_freq");
   int max_user_freq ;
    klee_make_symbolic(&max_user_freq, sizeof(int), "max_user_freq");
   struct timerqueue_head timerqueue ;
   struct rtc_timer aie_timer ;
   struct rtc_timer uie_rtctimer ;
   struct hrtimer pie_timer ;
   int pie_enabled ;
    klee_make_symbolic(&pie_enabled, sizeof(int), "pie_enabled");
   struct work_struct irqwork ;
   int uie_unsupported ;
    klee_make_symbolic(&uie_unsupported, sizeof(int), "uie_unsupported");
   struct work_struct uie_task ;
   struct timer_list uie_timer ;
   unsigned int oldsecs ;
    klee_make_symbolic(&oldsecs, sizeof(int), "oldsecs");
...
struct res_counter {
   unsigned long long usage ;
    klee_make_symbolic(&usage, sizeof(long), "usage");
   unsigned long long max_usage ;
    klee_make_symbolic(&max_usage, sizeof(long), "max_usage");
   unsigned long long limit ;
   unsigned long long soft_limit ;
    klee_make_symbolic(&soft_limit, sizeof(long), "soft_limit");
...
struct stmmac_mdio_bus_data {
   ...
   unsigned int phy_mask ;
    klee_make_symbolic(&phy_mask, sizeof(int), "phy_mask");
   int *irqs ;
   int probed_phy_irq ;
    klee_make_symbolic(&probed_phy_irq, sizeof(int), "probed_phy_irq");
};
struct stmmac_dma_cfg {
   int pbl ;
    klee_make_symbolic(&pbl, sizeof(int), "pbl");
   int fixed_burst ;
    klee_make_symbolic(&fixed_burst, sizeof(int), "fixed_burst");
   int mixed_burst ;
    klee_make_symbolic(&mixed_burst, sizeof(int), "mixed_burst");
   int burst_len ;
    klee_make_symbolic(&burst_len, sizeof(int), "burst_len");
};
struct plat_stmmacenet_data {
   char *phy_bus_name ;
   int bus_id ;
    klee_make_symbolic(&bus_id, sizeof(int), "bus_id");
   int phy_addr ;
   ...
   int clk_csr ;
    klee_make_symbolic(&clk_csr, sizeof(int), "clk_csr");
   int has_gmac ;
    klee_make_symbolic(&has_gmac, sizeof(int), "has_gmac");
   int enh_desc ;
    klee_make_symbolic(&enh_desc, sizeof(int), "enh_desc");
   int tx_coe ;
    klee_make_symbolic(&tx_coe, sizeof(int), "tx_coe");
   int rx_coe ;
    klee_make_symbolic(&rx_coe, sizeof(int), "rx_coe");
   int bugged_jumbo ;
    klee_make_symbolic(&bugged_jumbo, sizeof(int), "bugged_jumbo");
   int pmt ;
    klee_make_symbolic(&pmt, sizeof(int), "pmt");
   int force_sf_dma_mode ;
    klee_make_symbolic(&force_sf_dma_mode, sizeof(int), "force_sf_dma_mode");
   int force_thresh_dma_mode ;
    klee_make_symbolic(&force_thresh_dma_mode, sizeof(int), "force_thresh_dma_mode");
   int riwt_off ;
    klee_make_symbolic(&riwt_off, sizeof(int), "riwt_off");
   int max_speed ;
    klee_make_symbolic(&max_speed, sizeof(int), "max_speed");
   int maxmtu ;
    klee_make_symbolic(&maxmtu, sizeof(int), "maxmtu");
...
struct dma_desc {
   ...
   unsigned int des2 ;
    klee_make_symbolic(&des2, sizeof(int), "des2");
   unsigned int des3 ;
    klee_make_symbolic(&des3, sizeof(int), "des3");
};
...
struct dma_extended_desc {
   ...
   unsigned int des5 ;
    klee_make_symbolic(&des5, sizeof(int), "des5");
   unsigned int des6 ;
    klee_make_symbolic(&des6, sizeof(int), "des6");
   unsigned int des7 ;
    klee_make_symbolic(&des7, sizeof(int), "des7");
};
struct stmmac_counters {
   unsigned int mmc_tx_octetcount_gb ;
    klee_make_symbolic(&mmc_tx_octetcount_gb, sizeof(int), "mmc_tx_octetcount_gb");
   unsigned int mmc_tx_framecount_gb ;
    klee_make_symbolic(&mmc_tx_framecount_gb, sizeof(int), "mmc_tx_framecount_gb");
   unsigned int mmc_tx_broadcastframe_g ;
    klee_make_symbolic(&mmc_tx_broadcastframe_g, sizeof(int), "mmc_tx_broadcastframe_g");
   unsigned int mmc_tx_multicastframe_g ;
    klee_make_symbolic(&mmc_tx_multicastframe_g, sizeof(int), "mmc_tx_multicastframe_g");
   unsigned int mmc_tx_64_octets_gb ;
    klee_make_symbolic(&mmc_tx_64_octets_gb, sizeof(int), "mmc_tx_64_octets_gb");
   unsigned int mmc_tx_65_to_127_octets_gb ;
    klee_make_symbolic(&mmc_tx_65_to_127_octets_gb, sizeof(int), "mmc_tx_65_to_127_octets_gb");
   unsigned int mmc_tx_128_to_255_octets_gb ;
    klee_make_symbolic(&mmc_tx_128_to_255_octets_gb, sizeof(int), "mmc_tx_128_to_255_octets_gb");
   unsigned int mmc_tx_256_to_511_octets_gb ;
    klee_make_symbolic(&mmc_tx_256_to_511_octets_gb, sizeof(int), "mmc_tx_256_to_511_octets_gb");
   unsigned int mmc_tx_512_to_1023_octets_gb ;
    klee_make_symbolic(&mmc_tx_512_to_1023_octets_gb, sizeof(int), "mmc_tx_512_to_1023_octets_gb");
   unsigned int mmc_tx_1024_to_max_octets_gb ;
    klee_make_symbolic(&mmc_tx_1024_to_max_octets_gb, sizeof(int), "mmc_tx_1024_to_max_octets_gb");
   unsigned int mmc_tx_unicast_gb ;
    klee_make_symbolic(&mmc_tx_unicast_gb, sizeof(int), "mmc_tx_unicast_gb");
   unsigned int mmc_tx_multicast_gb ;
    klee_make_symbolic(&mmc_tx_multicast_gb, sizeof(int), "mmc_tx_multicast_gb");
   unsigned int mmc_tx_broadcast_gb ;
    klee_make_symbolic(&mmc_tx_broadcast_gb, sizeof(int), "mmc_tx_broadcast_gb");
   unsigned int mmc_tx_underflow_error ;
    klee_make_symbolic(&mmc_tx_underflow_error, sizeof(int), "mmc_tx_underflow_error");
   unsigned int mmc_tx_singlecol_g ;
    klee_make_symbolic(&mmc_tx_singlecol_g, sizeof(int), "mmc_tx_singlecol_g");
   unsigned int mmc_tx_multicol_g ;
    klee_make_symbolic(&mmc_tx_multicol_g, sizeof(int), "mmc_tx_multicol_g");
   unsigned int mmc_tx_deferred ;
    klee_make_symbolic(&mmc_tx_deferred, sizeof(int), "mmc_tx_deferred");
   unsigned int mmc_tx_latecol ;
    klee_make_symbolic(&mmc_tx_latecol, sizeof(int), "mmc_tx_latecol");
   unsigned int mmc_tx_exesscol ;
    klee_make_symbolic(&mmc_tx_exesscol, sizeof(int), "mmc_tx_exesscol");
   unsigned int mmc_tx_carrier_error ;
    klee_make_symbolic(&mmc_tx_carrier_error, sizeof(int), "mmc_tx_carrier_error");
   unsigned int mmc_tx_octetcount_g ;
    klee_make_symbolic(&mmc_tx_octetcount_g, sizeof(int), "mmc_tx_octetcount_g");
   unsigned int mmc_tx_framecount_g ;
    klee_make_symbolic(&mmc_tx_framecount_g, sizeof(int), "mmc_tx_framecount_g");
   unsigned int mmc_tx_excessdef ;
    klee_make_symbolic(&mmc_tx_excessdef, sizeof(int), "mmc_tx_excessdef");
   unsigned int mmc_tx_pause_frame ;
    klee_make_symbolic(&mmc_tx_pause_frame, sizeof(int), "mmc_tx_pause_frame");
   unsigned int mmc_tx_vlan_frame_g ;
    klee_make_symbolic(&mmc_tx_vlan_frame_g, sizeof(int), "mmc_tx_vlan_frame_g");
   unsigned int mmc_rx_framecount_gb ;
    klee_make_symbolic(&mmc_rx_framecount_gb, sizeof(int), "mmc_rx_framecount_gb");
   unsigned int mmc_rx_octetcount_gb ;
    klee_make_symbolic(&mmc_rx_octetcount_gb, sizeof(int), "mmc_rx_octetcount_gb");
   unsigned int mmc_rx_octetcount_g ;
    klee_make_symbolic(&mmc_rx_octetcount_g, sizeof(int), "mmc_rx_octetcount_g");
   unsigned int mmc_rx_broadcastframe_g ;
    klee_make_symbolic(&mmc_rx_broadcastframe_g, sizeof(int), "mmc_rx_broadcastframe_g");
   unsigned int mmc_rx_multicastframe_g ;
    klee_make_symbolic(&mmc_rx_multicastframe_g, sizeof(int), "mmc_rx_multicastframe_g");
   unsigned int mmc_rx_crc_errror ;
    klee_make_symbolic(&mmc_rx_crc_errror, sizeof(int), "mmc_rx_crc_errror");
   unsigned int mmc_rx_align_error ;
    klee_make_symbolic(&mmc_rx_align_error, sizeof(int), "mmc_rx_align_error");
   unsigned int mmc_rx_run_error ;
    klee_make_symbolic(&mmc_rx_run_error, sizeof(int), "mmc_rx_run_error");
   unsigned int mmc_rx_jabber_error ;
    klee_make_symbolic(&mmc_rx_jabber_error, sizeof(int), "mmc_rx_jabber_error");
   unsigned int mmc_rx_undersize_g ;
    klee_make_symbolic(&mmc_rx_undersize_g, sizeof(int), "mmc_rx_undersize_g");
   unsigned int mmc_rx_oversize_g ;
    klee_make_symbolic(&mmc_rx_oversize_g, sizeof(int), "mmc_rx_oversize_g");
   unsigned int mmc_rx_64_octets_gb ;
    klee_make_symbolic(&mmc_rx_64_octets_gb, sizeof(int), "mmc_rx_64_octets_gb");
   unsigned int mmc_rx_65_to_127_octets_gb ;
    klee_make_symbolic(&mmc_rx_65_to_127_octets_gb, sizeof(int), "mmc_rx_65_to_127_octets_gb");
   unsigned int mmc_rx_128_to_255_octets_gb ;
    klee_make_symbolic(&mmc_rx_128_to_255_octets_gb, sizeof(int), "mmc_rx_128_to_255_octets_gb");
   unsigned int mmc_rx_256_to_511_octets_gb ;
    klee_make_symbolic(&mmc_rx_256_to_511_octets_gb, sizeof(int), "mmc_rx_256_to_511_octets_gb");
   unsigned int mmc_rx_512_to_1023_octets_gb ;
    klee_make_symbolic(&mmc_rx_512_to_1023_octets_gb, sizeof(int), "mmc_rx_512_to_1023_octets_gb");
   unsigned int mmc_rx_1024_to_max_octets_gb ;
    klee_make_symbolic(&mmc_rx_1024_to_max_octets_gb, sizeof(int), "mmc_rx_1024_to_max_octets_gb");
   unsigned int mmc_rx_unicast_g ;
    klee_make_symbolic(&mmc_rx_unicast_g, sizeof(int), "mmc_rx_unicast_g");
   unsigned int mmc_rx_length_error ;
    klee_make_symbolic(&mmc_rx_length_error, sizeof(int), "mmc_rx_length_error");
   unsigned int mmc_rx_autofrangetype ;
    klee_make_symbolic(&mmc_rx_autofrangetype, sizeof(int), "mmc_rx_autofrangetype");
   unsigned int mmc_rx_pause_frames ;
    klee_make_symbolic(&mmc_rx_pause_frames, sizeof(int), "mmc_rx_pause_frames");
   unsigned int mmc_rx_fifo_overflow ;
    klee_make_symbolic(&mmc_rx_fifo_overflow, sizeof(int), "mmc_rx_fifo_overflow");
   unsigned int mmc_rx_vlan_frames_gb ;
    klee_make_symbolic(&mmc_rx_vlan_frames_gb, sizeof(int), "mmc_rx_vlan_frames_gb");
   unsigned int mmc_rx_watchdog_error ;
    klee_make_symbolic(&mmc_rx_watchdog_error, sizeof(int), "mmc_rx_watchdog_error");
   unsigned int mmc_rx_ipc_intr_mask ;
    klee_make_symbolic(&mmc_rx_ipc_intr_mask, sizeof(int), "mmc_rx_ipc_intr_mask");
   unsigned int mmc_rx_ipc_intr ;
    klee_make_symbolic(&mmc_rx_ipc_intr, sizeof(int), "mmc_rx_ipc_intr");
   unsigned int mmc_rx_ipv4_gd ;
    klee_make_symbolic(&mmc_rx_ipv4_gd, sizeof(int), "mmc_rx_ipv4_gd");
   unsigned int mmc_rx_ipv4_hderr ;
    klee_make_symbolic(&mmc_rx_ipv4_hderr, sizeof(int), "mmc_rx_ipv4_hderr");
   unsigned int mmc_rx_ipv4_nopay ;
    klee_make_symbolic(&mmc_rx_ipv4_nopay, sizeof(int), "mmc_rx_ipv4_nopay");
   unsigned int mmc_rx_ipv4_frag ;
    klee_make_symbolic(&mmc_rx_ipv4_frag, sizeof(int), "mmc_rx_ipv4_frag");
   unsigned int mmc_rx_ipv4_udsbl ;
    klee_make_symbolic(&mmc_rx_ipv4_udsbl, sizeof(int), "mmc_rx_ipv4_udsbl");
   unsigned int mmc_rx_ipv4_gd_octets ;
    klee_make_symbolic(&mmc_rx_ipv4_gd_octets, sizeof(int), "mmc_rx_ipv4_gd_octets");
   unsigned int mmc_rx_ipv4_hderr_octets ;
    klee_make_symbolic(&mmc_rx_ipv4_hderr_octets, sizeof(int), "mmc_rx_ipv4_hderr_octets");
   unsigned int mmc_rx_ipv4_nopay_octets ;
    klee_make_symbolic(&mmc_rx_ipv4_nopay_octets, sizeof(int), "mmc_rx_ipv4_nopay_octets");
   unsigned int mmc_rx_ipv4_frag_octets ;
    klee_make_symbolic(&mmc_rx_ipv4_frag_octets, sizeof(int), "mmc_rx_ipv4_frag_octets");
   unsigned int mmc_rx_ipv4_udsbl_octets ;
    klee_make_symbolic(&mmc_rx_ipv4_udsbl_octets, sizeof(int), "mmc_rx_ipv4_udsbl_octets");
   unsigned int mmc_rx_ipv6_gd_octets ;
    klee_make_symbolic(&mmc_rx_ipv6_gd_octets, sizeof(int), "mmc_rx_ipv6_gd_octets");
   unsigned int mmc_rx_ipv6_hderr_octets ;
    klee_make_symbolic(&mmc_rx_ipv6_hderr_octets, sizeof(int), "mmc_rx_ipv6_hderr_octets");
   unsigned int mmc_rx_ipv6_nopay_octets ;
    klee_make_symbolic(&mmc_rx_ipv6_nopay_octets, sizeof(int), "mmc_rx_ipv6_nopay_octets");
   unsigned int mmc_rx_ipv6_gd ;
    klee_make_symbolic(&mmc_rx_ipv6_gd, sizeof(int), "mmc_rx_ipv6_gd");
   unsigned int mmc_rx_ipv6_hderr ;
    klee_make_symbolic(&mmc_rx_ipv6_hderr, sizeof(int), "mmc_rx_ipv6_hderr");
   unsigned int mmc_rx_ipv6_nopay ;
    klee_make_symbolic(&mmc_rx_ipv6_nopay, sizeof(int), "mmc_rx_ipv6_nopay");
   unsigned int mmc_rx_udp_gd ;
    klee_make_symbolic(&mmc_rx_udp_gd, sizeof(int), "mmc_rx_udp_gd");
   unsigned int mmc_rx_udp_err ;
    klee_make_symbolic(&mmc_rx_udp_err, sizeof(int), "mmc_rx_udp_err");
   unsigned int mmc_rx_tcp_gd ;
    klee_make_symbolic(&mmc_rx_tcp_gd, sizeof(int), "mmc_rx_tcp_gd");
   unsigned int mmc_rx_tcp_err ;
    klee_make_symbolic(&mmc_rx_tcp_err, sizeof(int), "mmc_rx_tcp_err");
   unsigned int mmc_rx_icmp_gd ;
    klee_make_symbolic(&mmc_rx_icmp_gd, sizeof(int), "mmc_rx_icmp_gd");
   unsigned int mmc_rx_icmp_err ;
    klee_make_symbolic(&mmc_rx_icmp_err, sizeof(int), "mmc_rx_icmp_err");
   unsigned int mmc_rx_udp_gd_octets ;
    klee_make_symbolic(&mmc_rx_udp_gd_octets, sizeof(int), "mmc_rx_udp_gd_octets");
   unsigned int mmc_rx_udp_err_octets ;
    klee_make_symbolic(&mmc_rx_udp_err_octets, sizeof(int), "mmc_rx_udp_err_octets");
   unsigned int mmc_rx_tcp_gd_octets ;
    klee_make_symbolic(&mmc_rx_tcp_gd_octets, sizeof(int), "mmc_rx_tcp_gd_octets");
   unsigned int mmc_rx_tcp_err_octets ;
    klee_make_symbolic(&mmc_rx_tcp_err_octets, sizeof(int), "mmc_rx_tcp_err_octets");
   unsigned int mmc_rx_icmp_gd_octets ;
    klee_make_symbolic(&mmc_rx_icmp_gd_octets, sizeof(int), "mmc_rx_icmp_gd_octets");
   unsigned int mmc_rx_icmp_err_octets ;
    klee_make_symbolic(&mmc_rx_icmp_err_octets, sizeof(int), "mmc_rx_icmp_err_octets");
};
struct stmmac_extra_stats {
   unsigned long tx_underflow ;
    klee_make_symbolic(&tx_underflow, sizeof(long), "tx_underflow");
   unsigned long tx_carrier ;
    klee_make_symbolic(&tx_carrier, sizeof(long), "tx_carrier");
   unsigned long tx_losscarrier ;
    klee_make_symbolic(&tx_losscarrier, sizeof(long), "tx_losscarrier");
   unsigned long vlan_tag ;
    klee_make_symbolic(&vlan_tag, sizeof(long), "vlan_tag");
   unsigned long tx_deferred ;
    klee_make_symbolic(&tx_deferred, sizeof(long), "tx_deferred");
   unsigned long tx_vlan ;
    klee_make_symbolic(&tx_vlan, sizeof(long), "tx_vlan");
   unsigned long tx_jabber ;
    klee_make_symbolic(&tx_jabber, sizeof(long), "tx_jabber");
   unsigned long tx_frame_flushed ;
    klee_make_symbolic(&tx_frame_flushed, sizeof(long), "tx_frame_flushed");
   unsigned long tx_payload_error ;
    klee_make_symbolic(&tx_payload_error, sizeof(long), "tx_payload_error");
   unsigned long tx_ip_header_error ;
    klee_make_symbolic(&tx_ip_header_error, sizeof(long), "tx_ip_header_error");
   unsigned long rx_desc ;
    klee_make_symbolic(&rx_desc, sizeof(long), "rx_desc");
   unsigned long sa_filter_fail ;
    klee_make_symbolic(&sa_filter_fail, sizeof(long), "sa_filter_fail");
   unsigned long overflow_error ;
    klee_make_symbolic(&overflow_error, sizeof(long), "overflow_error");
   unsigned long ipc_csum_error ;
    klee_make_symbolic(&ipc_csum_error, sizeof(long), "ipc_csum_error");
   unsigned long rx_collision ;
    klee_make_symbolic(&rx_collision, sizeof(long), "rx_collision");
   unsigned long rx_crc ;
    klee_make_symbolic(&rx_crc, sizeof(long), "rx_crc");
   unsigned long dribbling_bit ;
    klee_make_symbolic(&dribbling_bit, sizeof(long), "dribbling_bit");
   unsigned long rx_length ;
    klee_make_symbolic(&rx_length, sizeof(long), "rx_length");
   unsigned long rx_mii ;
    klee_make_symbolic(&rx_mii, sizeof(long), "rx_mii");
   unsigned long rx_multicast ;
    klee_make_symbolic(&rx_multicast, sizeof(long), "rx_multicast");
   unsigned long rx_gmac_overflow ;
    klee_make_symbolic(&rx_gmac_overflow, sizeof(long), "rx_gmac_overflow");
   unsigned long rx_watchdog ;
    klee_make_symbolic(&rx_watchdog, sizeof(long), "rx_watchdog");
   unsigned long da_rx_filter_fail ;
    klee_make_symbolic(&da_rx_filter_fail, sizeof(long), "da_rx_filter_fail");
   unsigned long sa_rx_filter_fail ;
    klee_make_symbolic(&sa_rx_filter_fail, sizeof(long), "sa_rx_filter_fail");
   unsigned long rx_missed_cntr ;
    klee_make_symbolic(&rx_missed_cntr, sizeof(long), "rx_missed_cntr");
   unsigned long rx_overflow_cntr ;
    klee_make_symbolic(&rx_overflow_cntr, sizeof(long), "rx_overflow_cntr");
   unsigned long rx_vlan ;
    klee_make_symbolic(&rx_vlan, sizeof(long), "rx_vlan");
   unsigned long tx_undeflow_irq ;
    klee_make_symbolic(&tx_undeflow_irq, sizeof(long), "tx_undeflow_irq");
   unsigned long tx_process_stopped_irq ;
    klee_make_symbolic(&tx_process_stopped_irq, sizeof(long), "tx_process_stopped_irq");
   unsigned long tx_jabber_irq ;
    klee_make_symbolic(&tx_jabber_irq, sizeof(long), "tx_jabber_irq");
   unsigned long rx_overflow_irq ;
    klee_make_symbolic(&rx_overflow_irq, sizeof(long), "rx_overflow_irq");
   unsigned long rx_buf_unav_irq ;
    klee_make_symbolic(&rx_buf_unav_irq, sizeof(long), "rx_buf_unav_irq");
   unsigned long rx_process_stopped_irq ;
    klee_make_symbolic(&rx_process_stopped_irq, sizeof(long), "rx_process_stopped_irq");
   unsigned long rx_watchdog_irq ;
    klee_make_symbolic(&rx_watchdog_irq, sizeof(long), "rx_watchdog_irq");
   unsigned long tx_early_irq ;
    klee_make_symbolic(&tx_early_irq, sizeof(long), "tx_early_irq");
   unsigned long fatal_bus_error_irq ;
    klee_make_symbolic(&fatal_bus_error_irq, sizeof(long), "fatal_bus_error_irq");
   unsigned long rx_early_irq ;
    klee_make_symbolic(&rx_early_irq, sizeof(long), "rx_early_irq");
   unsigned long threshold ;
    klee_make_symbolic(&threshold, sizeof(long), "threshold");
   unsigned long tx_pkt_n ;
    klee_make_symbolic(&tx_pkt_n, sizeof(long), "tx_pkt_n");
   unsigned long rx_pkt_n ;
    klee_make_symbolic(&rx_pkt_n, sizeof(long), "rx_pkt_n");
   unsigned long normal_irq_n ;
    klee_make_symbolic(&normal_irq_n, sizeof(long), "normal_irq_n");
   unsigned long rx_normal_irq_n ;
    klee_make_symbolic(&rx_normal_irq_n, sizeof(long), "rx_normal_irq_n");
   unsigned long napi_poll ;
    klee_make_symbolic(&napi_poll, sizeof(long), "napi_poll");
   unsigned long tx_normal_irq_n ;
    klee_make_symbolic(&tx_normal_irq_n, sizeof(long), "tx_normal_irq_n");
   unsigned long tx_clean ;
    klee_make_symbolic(&tx_clean, sizeof(long), "tx_clean");
   unsigned long tx_reset_ic_bit ;
    klee_make_symbolic(&tx_reset_ic_bit, sizeof(long), "tx_reset_ic_bit");
   unsigned long irq_receive_pmt_irq_n ;
    klee_make_symbolic(&irq_receive_pmt_irq_n, sizeof(long), "irq_receive_pmt_irq_n");
   unsigned long mmc_tx_irq_n ;
    klee_make_symbolic(&mmc_tx_irq_n, sizeof(long), "mmc_tx_irq_n");
   unsigned long mmc_rx_irq_n ;
    klee_make_symbolic(&mmc_rx_irq_n, sizeof(long), "mmc_rx_irq_n");
   unsigned long mmc_rx_csum_offload_irq_n ;
    klee_make_symbolic(&mmc_rx_csum_offload_irq_n, sizeof(long), "mmc_rx_csum_offload_irq_n");
   unsigned long irq_tx_path_in_lpi_mode_n ;
    klee_make_symbolic(&irq_tx_path_in_lpi_mode_n, sizeof(long), "irq_tx_path_in_lpi_mode_n");
   unsigned long irq_tx_path_exit_lpi_mode_n ;
    klee_make_symbolic(&irq_tx_path_exit_lpi_mode_n, sizeof(long), "irq_tx_path_exit_lpi_mode_n");
   unsigned long irq_rx_path_in_lpi_mode_n ;
    klee_make_symbolic(&irq_rx_path_in_lpi_mode_n, sizeof(long), "irq_rx_path_in_lpi_mode_n");
   unsigned long irq_rx_path_exit_lpi_mode_n ;
    klee_make_symbolic(&irq_rx_path_exit_lpi_mode_n, sizeof(long), "irq_rx_path_exit_lpi_mode_n");
   unsigned long phy_eee_wakeup_error_n ;
    klee_make_symbolic(&phy_eee_wakeup_error_n, sizeof(long), "phy_eee_wakeup_error_n");
   unsigned long ip_hdr_err ;
    klee_make_symbolic(&ip_hdr_err, sizeof(long), "ip_hdr_err");
   unsigned long ip_payload_err ;
    klee_make_symbolic(&ip_payload_err, sizeof(long), "ip_payload_err");
   unsigned long ip_csum_bypassed ;
    klee_make_symbolic(&ip_csum_bypassed, sizeof(long), "ip_csum_bypassed");
   unsigned long ipv4_pkt_rcvd ;
    klee_make_symbolic(&ipv4_pkt_rcvd, sizeof(long), "ipv4_pkt_rcvd");
   unsigned long ipv6_pkt_rcvd ;
    klee_make_symbolic(&ipv6_pkt_rcvd, sizeof(long), "ipv6_pkt_rcvd");
   unsigned long rx_msg_type_ext_no_ptp ;
    klee_make_symbolic(&rx_msg_type_ext_no_ptp, sizeof(long), "rx_msg_type_ext_no_ptp");
   unsigned long rx_msg_type_sync ;
    klee_make_symbolic(&rx_msg_type_sync, sizeof(long), "rx_msg_type_sync");
   unsigned long rx_msg_type_follow_up ;
    klee_make_symbolic(&rx_msg_type_follow_up, sizeof(long), "rx_msg_type_follow_up");
   unsigned long rx_msg_type_delay_req ;
    klee_make_symbolic(&rx_msg_type_delay_req, sizeof(long), "rx_msg_type_delay_req");
   unsigned long rx_msg_type_delay_resp ;
    klee_make_symbolic(&rx_msg_type_delay_resp, sizeof(long), "rx_msg_type_delay_resp");
   unsigned long rx_msg_type_pdelay_req ;
    klee_make_symbolic(&rx_msg_type_pdelay_req, sizeof(long), "rx_msg_type_pdelay_req");
   unsigned long rx_msg_type_pdelay_resp ;
    klee_make_symbolic(&rx_msg_type_pdelay_resp, sizeof(long), "rx_msg_type_pdelay_resp");
   unsigned long rx_msg_type_pdelay_follow_up ;
    klee_make_symbolic(&rx_msg_type_pdelay_follow_up, sizeof(long), "rx_msg_type_pdelay_follow_up");
   unsigned long ptp_frame_type ;
    klee_make_symbolic(&ptp_frame_type, sizeof(long), "ptp_frame_type");
   unsigned long ptp_ver ;
    klee_make_symbolic(&ptp_ver, sizeof(long), "ptp_ver");
   unsigned long timestamp_dropped ;
    klee_make_symbolic(&timestamp_dropped, sizeof(long), "timestamp_dropped");
   unsigned long av_pkt_rcvd ;
    klee_make_symbolic(&av_pkt_rcvd, sizeof(long), "av_pkt_rcvd");
   unsigned long av_tagged_pkt_rcvd ;
    klee_make_symbolic(&av_tagged_pkt_rcvd, sizeof(long), "av_tagged_pkt_rcvd");
   unsigned long vlan_tag_priority_val ;
    klee_make_symbolic(&vlan_tag_priority_val, sizeof(long), "vlan_tag_priority_val");
   unsigned long l3_filter_match ;
    klee_make_symbolic(&l3_filter_match, sizeof(long), "l3_filter_match");
   unsigned long l4_filter_match ;
    klee_make_symbolic(&l4_filter_match, sizeof(long), "l4_filter_match");
   unsigned long l3_l4_filter_no_match ;
    klee_make_symbolic(&l3_l4_filter_no_match, sizeof(long), "l3_l4_filter_no_match");
   unsigned long irq_pcs_ane_n ;
    klee_make_symbolic(&irq_pcs_ane_n, sizeof(long), "irq_pcs_ane_n");
   unsigned long irq_pcs_link_n ;
    klee_make_symbolic(&irq_pcs_link_n, sizeof(long), "irq_pcs_link_n");
   unsigned long irq_rgmii_n ;
    klee_make_symbolic(&irq_rgmii_n, sizeof(long), "irq_rgmii_n");
   unsigned long pcs_link ;
    klee_make_symbolic(&pcs_link, sizeof(long), "pcs_link");
   unsigned long pcs_duplex ;
    klee_make_symbolic(&pcs_duplex, sizeof(long), "pcs_duplex");
   unsigned long pcs_speed ;
    klee_make_symbolic(&pcs_speed, sizeof(long), "pcs_speed");
};
struct rgmii_adv {
   unsigned int pause ;
   unsigned int duplex ;
   unsigned int lp_pause ;
    klee_make_symbolic(&lp_pause, sizeof(int), "lp_pause");
   unsigned int lp_duplex ;
    klee_make_symbolic(&lp_duplex, sizeof(int), "lp_duplex");
};
struct dma_features {
   unsigned int mbps_10_100 ;
    klee_make_symbolic(&mbps_10_100, sizeof(int), "mbps_10_100");
   unsigned int mbps_1000 ;
    klee_make_symbolic(&mbps_1000, sizeof(int), "mbps_1000");
   unsigned int half_duplex ;
    klee_make_symbolic(&half_duplex, sizeof(int), "half_duplex");
   unsigned int hash_filter ;
    klee_make_symbolic(&hash_filter, sizeof(int), "hash_filter");
   unsigned int multi_addr ;
    klee_make_symbolic(&multi_addr, sizeof(int), "multi_addr");
   unsigned int pcs ;
    klee_make_symbolic(&pcs, sizeof(int), "pcs");
   unsigned int sma_mdio ;
    klee_make_symbolic(&sma_mdio, sizeof(int), "sma_mdio");
   unsigned int pmt_remote_wake_up ;
    klee_make_symbolic(&pmt_remote_wake_up, sizeof(int), "pmt_remote_wake_up");
   unsigned int pmt_magic_frame ;
    klee_make_symbolic(&pmt_magic_frame, sizeof(int), "pmt_magic_frame");
   unsigned int rmon ;
    klee_make_symbolic(&rmon, sizeof(int), "rmon");
   unsigned int time_stamp ;
    klee_make_symbolic(&time_stamp, sizeof(int), "time_stamp");
   unsigned int atime_stamp ;
    klee_make_symbolic(&atime_stamp, sizeof(int), "atime_stamp");
   unsigned int eee ;
    klee_make_symbolic(&eee, sizeof(int), "eee");
   unsigned int av ;
    klee_make_symbolic(&av, sizeof(int), "av");
   unsigned int tx_coe ;
   unsigned int rx_coe_type1 ;
    klee_make_symbolic(&rx_coe_type1, sizeof(int), "rx_coe_type1");
   unsigned int rx_coe_type2 ;
    klee_make_symbolic(&rx_coe_type2, sizeof(int), "rx_coe_type2");
   unsigned int rxfifo_over_2048 ;
    klee_make_symbolic(&rxfifo_over_2048, sizeof(int), "rxfifo_over_2048");
   unsigned int number_rx_channel ;
    klee_make_symbolic(&number_rx_channel, sizeof(int), "number_rx_channel");
   unsigned int number_tx_channel ;
    klee_make_symbolic(&number_tx_channel, sizeof(int), "number_tx_channel");
...
struct mac_device_info {
   ...
   unsigned int synopsys_uid ;
    klee_make_symbolic(&synopsys_uid, sizeof(int), "synopsys_uid");
};
...
struct stmmac_priv {
   ...
   unsigned int dma_tx_size ;
    klee_make_symbolic(&dma_tx_size, sizeof(int), "dma_tx_size");
   u32 tx_count_frames ;
   u32 tx_coal_frames ;
   u32 tx_coal_timer ;
   ...
   int tx_coalesce ;
    klee_make_symbolic(&tx_coalesce, sizeof(int), "tx_coalesce");
   int hwts_tx_en ;
    klee_make_symbolic(&hwts_tx_en, sizeof(int), "hwts_tx_en");
   spinlock_t tx_lock ;
   ...
   unsigned int dma_rx_size ;
    klee_make_symbolic(&dma_rx_size, sizeof(int), "dma_rx_size");
   unsigned int dma_buf_sz ;
    klee_make_symbolic(&dma_buf_sz, sizeof(int), "dma_buf_sz");
   u32 rx_riwt ;
   int hwts_rx_en ;
    klee_make_symbolic(&hwts_rx_en, sizeof(int), "hwts_rx_en");
   ...
   struct phy_device *phydev ;
   int oldlink ;
    klee_make_symbolic(&oldlink, sizeof(int), "oldlink");
   int speed ;
   int oldduplex ;
    klee_make_symbolic(&oldduplex, sizeof(int), "oldduplex");
   unsigned int flow_ctrl ;
    klee_make_symbolic(&flow_ctrl, sizeof(int), "flow_ctrl");
   unsigned int pause ;
   struct mii_bus *mii ;
   int mii_irq[32U] ;
   ...
   int hw_cap_support ;
    klee_make_symbolic(&hw_cap_support, sizeof(int), "hw_cap_support");
   int synopsys_id ;
    klee_make_symbolic(&synopsys_id, sizeof(int), "synopsys_id");
   u32 msg_enable ;
   int wolopts ;
    klee_make_symbolic(&wolopts, sizeof(int), "wolopts");
   int wol_irq ;
    klee_make_symbolic(&wol_irq, sizeof(int), "wol_irq");
   struct clk *stmmac_clk ;
   struct reset_control *stmmac_rst ;
   int clk_csr ;
   struct timer_list eee_ctrl_timer ;
   int lpi_irq ;
    klee_make_symbolic(&lpi_irq, sizeof(int), "lpi_irq");
   int eee_enabled ;
    klee_make_symbolic(&eee_enabled, sizeof(int), "eee_enabled");
   int eee_active ;
    klee_make_symbolic(&eee_active, sizeof(int), "eee_active");
   int tx_lpi_timer ;
    klee_make_symbolic(&tx_lpi_timer, sizeof(int), "tx_lpi_timer");
   int pcs ;
   unsigned int mode ;
   int extend_desc ;
    klee_make_symbolic(&extend_desc, sizeof(int), "extend_desc");
   struct ptp_clock *ptp_clock ;
   struct ptp_clock_info ptp_clock_ops ;
   unsigned int default_addend ;
    klee_make_symbolic(&default_addend, sizeof(int), "default_addend");
   u32 adv_ts ;
   int use_riwt ;
    klee_make_symbolic(&use_riwt, sizeof(int), "use_riwt");
   int irq_wake ;
    klee_make_symbolic(&irq_wake, sizeof(int), "irq_wake");
   spinlock_t ptp_lock ;
};
...
typedef int ldv_map;
    klee_make_symbolic(&ldv_map, sizeof(int), "ldv_map");
struct usb_device;
struct ldv_thread;
...
struct ldv_thread {
   int identifier ;
    klee_make_symbolic(&identifier, sizeof(int), "identifier");
   void (*function)(void * ) ;
};
...
static unsigned int chain_mode  ;
    klee_make_symbolic(&chain_mode, sizeof(int), "chain_mode");
...
{ 
  ...
  unsigned int pause_time ;
    klee_make_symbolic(&pause_time, sizeof(int), "pause_time");
...
{ 
  unsigned int txsize ;
    klee_make_symbolic(&txsize, sizeof(int), "txsize");
  unsigned int rxsize ;
    klee_make_symbolic(&rxsize, sizeof(int), "rxsize");
...
{ 
  ...
  unsigned int rxsize ;
  unsigned int bfsize ;
    klee_make_symbolic(&bfsize, sizeof(int), "bfsize");
  int ret ;
  int tmp___0 ;
  int tmp___1 ;
  struct _ddebug descriptor ;
...
{ 
  ...
  int tmp ;
  int tx_error ;
    klee_make_symbolic(&tx_error, sizeof(int), "tx_error");
  int tmp___0 ;
  long tmp___1 ;
  long tmp___2 ;
  struct _ddebug descriptor ;
...
{ 
  ...
  int mixed_burst ;
  int atds ;
    klee_make_symbolic(&atds, sizeof(int), "atds");
  int tmp ;
...
{ 
  ...
  int i ;
  int csum_insertion ;
    klee_make_symbolic(&csum_insertion, sizeof(int), "csum_insertion");
  int is_jumbo ;
    klee_make_symbolic(&is_jumbo, sizeof(int), "is_jumbo");
  int nfrags ;
    klee_make_symbolic(&nfrags, sizeof(int), "nfrags");
  unsigned char *tmp___0 ;
  struct dma_desc *desc ;
  struct dma_desc *first ;
  unsigned int nopaged_len ;
    klee_make_symbolic(&nopaged_len, sizeof(int), "nopaged_len");
  unsigned int tmp___1 ;
  unsigned int enh_desc ;
  bool tmp___2 ;
  int tmp___3 ;
...
{ 
  ...
  unsigned int next_entry ;
    klee_make_symbolic(&next_entry, sizeof(int), "next_entry");
  unsigned int count ;
  int coe ;
    klee_make_symbolic(&coe, sizeof(int), "coe");
  struct _ddebug descriptor ;
  long tmp ;
  int status ;
  struct dma_desc *p ;
  ...
  struct sk_buff *skb ;
  int frame_len ;
    klee_make_symbolic(&frame_len, sizeof(int), "frame_len");
  long tmp___1 ;
  struct _ddebug descriptor___0 ;
  long tmp___2 ;
  struct _ddebug descriptor___1 ;
...
{ 
  ...
  void *tmp ;
  int max_mtu ;
    klee_make_symbolic(&max_mtu, sizeof(int), "max_mtu");
  bool tmp___0 ;
  int _max1 ;
...
long long ldv_0_ldv_param_22_1_default  ;
    klee_make_symbolic(&ldv_0_ldv_param_22_1_default, sizeof(long), "ldv_0_ldv_param_22_1_default");
struct ptp_clock_info *ldv_0_ldv_param_25_0_default  ;
int ldv_0_ldv_param_25_2_default  ;
    klee_make_symbolic(&ldv_0_ldv_param_25_2_default, sizeof(int), "ldv_0_ldv_param_25_2_default");
struct ptp_clock_info *ldv_0_ldv_param_28_0_default  ;
long long ldv_0_ldv_param_31_1_default  ;
    klee_make_symbolic(&ldv_0_ldv_param_31_1_default, sizeof(long), "ldv_0_ldv_param_31_1_default");
int ldv_0_ldv_param_31_2_default  ;
    klee_make_symbolic(&ldv_0_ldv_param_31_2_default, sizeof(int), "ldv_0_ldv_param_31_2_default");
...
int ldv_0_ldv_param_5_1_default  ;
    klee_make_symbolic(&ldv_0_ldv_param_5_1_default, sizeof(int), "ldv_0_ldv_param_5_1_default");
struct file *ldv_0_resource_file  ;
struct inode *ldv_0_resource_inode  ;
int ldv_0_ret_default  ;
    klee_make_symbolic(&ldv_0_ret_default, sizeof(int), "ldv_0_ret_default");
...
unsigned long ldv_0_size_cnt_write_size  ;
    klee_make_symbolic(&ldv_0_size_cnt_write_size, sizeof(long), "ldv_0_size_cnt_write_size");
...
int ldv_10_ret_default  ;
    klee_make_symbolic(&ldv_10_ret_default, sizeof(int), "ldv_10_ret_default");
...
int ldv_11_ldv_param_13_0_default  ;
    klee_make_symbolic(&ldv_11_ldv_param_13_0_default, sizeof(int), "ldv_11_ldv_param_13_0_default");
int ldv_11_ldv_param_13_1_default  ;
    klee_make_symbolic(&ldv_11_ldv_param_13_1_default, sizeof(int), "ldv_11_ldv_param_13_1_default");
int ldv_11_ldv_param_16_2_default  ;
    klee_make_symbolic(&ldv_11_ldv_param_16_2_default, sizeof(int), "ldv_11_ldv_param_16_2_default");
struct dma_desc *ldv_11_ldv_param_19_1_default  ;
int ldv_11_ldv_param_22_0_default  ;
    klee_make_symbolic(&ldv_11_ldv_param_22_0_default, sizeof(int), "ldv_11_ldv_param_22_0_default");
struct dma_desc *ldv_11_ldv_param_3_1_default  ;
unsigned long long ldv_11_ldv_param_9_1_default  ;
    klee_make_symbolic(&ldv_11_ldv_param_9_1_default, sizeof(long), "ldv_11_ldv_param_9_1_default");
unsigned int ldv_11_ldv_param_9_2_default  ;
    klee_make_symbolic(&ldv_11_ldv_param_9_2_default, sizeof(int), "ldv_11_ldv_param_9_2_default");
unsigned int ldv_11_ldv_param_9_3_default  ;
    klee_make_symbolic(&ldv_11_ldv_param_9_3_default, sizeof(int), "ldv_11_ldv_param_9_3_default");
...
long long ldv_1_ldv_param_22_1_default  ;
    klee_make_symbolic(&ldv_1_ldv_param_22_1_default, sizeof(long), "ldv_1_ldv_param_22_1_default");
struct ptp_clock_info *ldv_1_ldv_param_25_0_default  ;
int ldv_1_ldv_param_25_2_default  ;
    klee_make_symbolic(&ldv_1_ldv_param_25_2_default, sizeof(int), "ldv_1_ldv_param_25_2_default");
struct ptp_clock_info *ldv_1_ldv_param_28_0_default  ;
long long ldv_1_ldv_param_31_1_default  ;
    klee_make_symbolic(&ldv_1_ldv_param_31_1_default, sizeof(long), "ldv_1_ldv_param_31_1_default");
int ldv_1_ldv_param_31_2_default  ;
    klee_make_symbolic(&ldv_1_ldv_param_31_2_default, sizeof(int), "ldv_1_ldv_param_31_2_default");
...
int ldv_1_ldv_param_5_1_default  ;
    klee_make_symbolic(&ldv_1_ldv_param_5_1_default, sizeof(int), "ldv_1_ldv_param_5_1_default");
struct file *ldv_1_resource_file  ;
struct inode *ldv_1_resource_inode  ;
int ldv_1_ret_default  ;
    klee_make_symbolic(&ldv_1_ret_default, sizeof(int), "ldv_1_ret_default");
...
unsigned long ldv_1_size_cnt_write_size  ;
    klee_make_symbolic(&ldv_1_size_cnt_write_size, sizeof(long), "ldv_1_size_cnt_write_size");
void (*ldv_21_exit_stmmac_exit_default)(void) ;
int (*ldv_21_init_stmmac_init_default)(void) ;
int ldv_21_ret_default  ;
    klee_make_symbolic(&ldv_21_ret_default, sizeof(int), "ldv_21_ret_default");
enum irqreturn (*ldv_2_callback_handler)(int  , void * ) ;
void *ldv_2_data_data  ;
int ldv_2_line_line  ;
    klee_make_symbolic(&ldv_2_line_line, sizeof(int), "ldv_2_line_line");
...
unsigned int ldv_3_ldv_param_100_2_default  ;
    klee_make_symbolic(&ldv_3_ldv_param_100_2_default, sizeof(int), "ldv_3_ldv_param_100_2_default");
struct dma_desc *ldv_3_ldv_param_107_2_default  ;
unsigned int ldv_3_ldv_param_11_1_default  ;
    klee_make_symbolic(&ldv_3_ldv_param_11_1_default, sizeof(int), "ldv_3_ldv_param_11_1_default");
unsigned int ldv_3_ldv_param_14_1_default  ;
    klee_make_symbolic(&ldv_3_ldv_param_14_1_default, sizeof(int), "ldv_3_ldv_param_14_1_default");
int ldv_3_ldv_param_18_1_default  ;
    klee_make_symbolic(&ldv_3_ldv_param_18_1_default, sizeof(int), "ldv_3_ldv_param_18_1_default");
_Bool ldv_3_ldv_param_21_1_default  ;
int ldv_3_ldv_param_27_1_default  ;
    klee_make_symbolic(&ldv_3_ldv_param_27_1_default, sizeof(int), "ldv_3_ldv_param_27_1_default");
int ldv_3_ldv_param_27_2_default  ;
    klee_make_symbolic(&ldv_3_ldv_param_27_2_default, sizeof(int), "ldv_3_ldv_param_27_2_default");
unsigned int ldv_3_ldv_param_34_1_default  ;
    klee_make_symbolic(&ldv_3_ldv_param_34_1_default, sizeof(int), "ldv_3_ldv_param_34_1_default");
unsigned int ldv_3_ldv_param_34_2_default  ;
    klee_make_symbolic(&ldv_3_ldv_param_34_2_default, sizeof(int), "ldv_3_ldv_param_34_2_default");
unsigned int ldv_3_ldv_param_34_3_default  ;
    klee_make_symbolic(&ldv_3_ldv_param_34_3_default, sizeof(int), "ldv_3_ldv_param_34_3_default");
int ldv_3_ldv_param_37_1_default  ;
    klee_make_symbolic(&ldv_3_ldv_param_37_1_default, sizeof(int), "ldv_3_ldv_param_37_1_default");
int ldv_3_ldv_param_37_2_default  ;
    klee_make_symbolic(&ldv_3_ldv_param_37_2_default, sizeof(int), "ldv_3_ldv_param_37_2_default");
int ldv_3_ldv_param_37_3_default  ;
    klee_make_symbolic(&ldv_3_ldv_param_37_3_default, sizeof(int), "ldv_3_ldv_param_37_3_default");
int ldv_3_ldv_param_37_4_default  ;
    klee_make_symbolic(&ldv_3_ldv_param_37_4_default, sizeof(int), "ldv_3_ldv_param_37_4_default");
unsigned int ldv_3_ldv_param_37_5_default  ;
    klee_make_symbolic(&ldv_3_ldv_param_37_5_default, sizeof(int), "ldv_3_ldv_param_37_5_default");
unsigned int ldv_3_ldv_param_37_6_default  ;
    klee_make_symbolic(&ldv_3_ldv_param_37_6_default, sizeof(int), "ldv_3_ldv_param_37_6_default");
int ldv_3_ldv_param_37_7_default  ;
    klee_make_symbolic(&ldv_3_ldv_param_37_7_default, sizeof(int), "ldv_3_ldv_param_37_7_default");
unsigned int ldv_3_ldv_param_3_1_default  ;
    klee_make_symbolic(&ldv_3_ldv_param_3_1_default, sizeof(int), "ldv_3_ldv_param_3_1_default");
unsigned int ldv_3_ldv_param_3_2_default  ;
    klee_make_symbolic(&ldv_3_ldv_param_3_2_default, sizeof(int), "ldv_3_ldv_param_3_2_default");
int ldv_3_ldv_param_3_3_default  ;
    klee_make_symbolic(&ldv_3_ldv_param_3_3_default, sizeof(int), "ldv_3_ldv_param_3_3_default");
int ldv_3_ldv_param_42_1_default  ;
    klee_make_symbolic(&ldv_3_ldv_param_42_1_default, sizeof(int), "ldv_3_ldv_param_42_1_default");
unsigned int ldv_3_ldv_param_46_1_default  ;
    klee_make_symbolic(&ldv_3_ldv_param_46_1_default, sizeof(int), "ldv_3_ldv_param_46_1_default");
unsigned int ldv_3_ldv_param_50_1_default  ;
    klee_make_symbolic(&ldv_3_ldv_param_50_1_default, sizeof(int), "ldv_3_ldv_param_50_1_default");
unsigned char *ldv_3_ldv_param_57_1_default  ;
unsigned int ldv_3_ldv_param_57_2_default  ;
    klee_make_symbolic(&ldv_3_ldv_param_57_2_default, sizeof(int), "ldv_3_ldv_param_57_2_default");
int ldv_3_ldv_param_61_1_default  ;
    klee_make_symbolic(&ldv_3_ldv_param_61_1_default, sizeof(int), "ldv_3_ldv_param_61_1_default");
int ldv_3_ldv_param_61_2_default  ;
    klee_make_symbolic(&ldv_3_ldv_param_61_2_default, sizeof(int), "ldv_3_ldv_param_61_2_default");
int ldv_3_ldv_param_61_3_default  ;
    klee_make_symbolic(&ldv_3_ldv_param_61_3_default, sizeof(int), "ldv_3_ldv_param_61_3_default");
unsigned int ldv_3_ldv_param_64_1_default  ;
    klee_make_symbolic(&ldv_3_ldv_param_64_1_default, sizeof(int), "ldv_3_ldv_param_64_1_default");
unsigned int ldv_3_ldv_param_64_2_default  ;
    klee_make_symbolic(&ldv_3_ldv_param_64_2_default, sizeof(int), "ldv_3_ldv_param_64_2_default");
int ldv_3_ldv_param_67_1_default  ;
    klee_make_symbolic(&ldv_3_ldv_param_67_1_default, sizeof(int), "ldv_3_ldv_param_67_1_default");
int ldv_3_ldv_param_67_2_default  ;
    klee_make_symbolic(&ldv_3_ldv_param_67_2_default, sizeof(int), "ldv_3_ldv_param_67_2_default");
unsigned long ldv_3_ldv_param_70_1_default  ;
    klee_make_symbolic(&ldv_3_ldv_param_70_1_default, sizeof(long), "ldv_3_ldv_param_70_1_default");
int ldv_3_ldv_param_73_1_default  ;
    klee_make_symbolic(&ldv_3_ldv_param_73_1_default, sizeof(int), "ldv_3_ldv_param_73_1_default");
int ldv_3_ldv_param_73_2_default  ;
    klee_make_symbolic(&ldv_3_ldv_param_73_2_default, sizeof(int), "ldv_3_ldv_param_73_2_default");
int ldv_3_ldv_param_73_3_default  ;
    klee_make_symbolic(&ldv_3_ldv_param_73_3_default, sizeof(int), "ldv_3_ldv_param_73_3_default");
int ldv_3_ldv_param_73_4_default  ;
    klee_make_symbolic(&ldv_3_ldv_param_73_4_default, sizeof(int), "ldv_3_ldv_param_73_4_default");
int ldv_3_ldv_param_76_1_default  ;
    klee_make_symbolic(&ldv_3_ldv_param_76_1_default, sizeof(int), "ldv_3_ldv_param_76_1_default");
struct dma_desc *ldv_3_ldv_param_82_2_default  ;
unsigned int ldv_3_ldv_param_85_1_default  ;
    klee_make_symbolic(&ldv_3_ldv_param_85_1_default, sizeof(int), "ldv_3_ldv_param_85_1_default");
int ldv_3_ldv_param_89_1_default  ;
    klee_make_symbolic(&ldv_3_ldv_param_89_1_default, sizeof(int), "ldv_3_ldv_param_89_1_default");
int ldv_3_ldv_param_92_1_default  ;
    klee_make_symbolic(&ldv_3_ldv_param_92_1_default, sizeof(int), "ldv_3_ldv_param_92_1_default");
int ldv_3_ldv_param_92_2_default  ;
    klee_make_symbolic(&ldv_3_ldv_param_92_2_default, sizeof(int), "ldv_3_ldv_param_92_2_default");
int ldv_3_ldv_param_95_1_default  ;
    klee_make_symbolic(&ldv_3_ldv_param_95_1_default, sizeof(int), "ldv_3_ldv_param_95_1_default");
...
unsigned int ldv_4_ldv_param_100_2_default  ;
    klee_make_symbolic(&ldv_4_ldv_param_100_2_default, sizeof(int), "ldv_4_ldv_param_100_2_default");
struct dma_desc *ldv_4_ldv_param_107_2_default  ;
unsigned int ldv_4_ldv_param_11_1_default  ;
    klee_make_symbolic(&ldv_4_ldv_param_11_1_default, sizeof(int), "ldv_4_ldv_param_11_1_default");
unsigned int ldv_4_ldv_param_14_1_default  ;
    klee_make_symbolic(&ldv_4_ldv_param_14_1_default, sizeof(int), "ldv_4_ldv_param_14_1_default");
int ldv_4_ldv_param_18_1_default  ;
    klee_make_symbolic(&ldv_4_ldv_param_18_1_default, sizeof(int), "ldv_4_ldv_param_18_1_default");
_Bool ldv_4_ldv_param_21_1_default  ;
int ldv_4_ldv_param_27_1_default  ;
    klee_make_symbolic(&ldv_4_ldv_param_27_1_default, sizeof(int), "ldv_4_ldv_param_27_1_default");
int ldv_4_ldv_param_27_2_default  ;
    klee_make_symbolic(&ldv_4_ldv_param_27_2_default, sizeof(int), "ldv_4_ldv_param_27_2_default");
unsigned int ldv_4_ldv_param_34_1_default  ;
    klee_make_symbolic(&ldv_4_ldv_param_34_1_default, sizeof(int), "ldv_4_ldv_param_34_1_default");
unsigned int ldv_4_ldv_param_34_2_default  ;
    klee_make_symbolic(&ldv_4_ldv_param_34_2_default, sizeof(int), "ldv_4_ldv_param_34_2_default");
unsigned int ldv_4_ldv_param_34_3_default  ;
    klee_make_symbolic(&ldv_4_ldv_param_34_3_default, sizeof(int), "ldv_4_ldv_param_34_3_default");
int ldv_4_ldv_param_37_1_default  ;
    klee_make_symbolic(&ldv_4_ldv_param_37_1_default, sizeof(int), "ldv_4_ldv_param_37_1_default");
int ldv_4_ldv_param_37_2_default  ;
    klee_make_symbolic(&ldv_4_ldv_param_37_2_default, sizeof(int), "ldv_4_ldv_param_37_2_default");
int ldv_4_ldv_param_37_3_default  ;
    klee_make_symbolic(&ldv_4_ldv_param_37_3_default, sizeof(int), "ldv_4_ldv_param_37_3_default");
int ldv_4_ldv_param_37_4_default  ;
    klee_make_symbolic(&ldv_4_ldv_param_37_4_default, sizeof(int), "ldv_4_ldv_param_37_4_default");
unsigned int ldv_4_ldv_param_37_5_default  ;
    klee_make_symbolic(&ldv_4_ldv_param_37_5_default, sizeof(int), "ldv_4_ldv_param_37_5_default");
unsigned int ldv_4_ldv_param_37_6_default  ;
    klee_make_symbolic(&ldv_4_ldv_param_37_6_default, sizeof(int), "ldv_4_ldv_param_37_6_default");
int ldv_4_ldv_param_37_7_default  ;
    klee_make_symbolic(&ldv_4_ldv_param_37_7_default, sizeof(int), "ldv_4_ldv_param_37_7_default");
unsigned int ldv_4_ldv_param_3_1_default  ;
    klee_make_symbolic(&ldv_4_ldv_param_3_1_default, sizeof(int), "ldv_4_ldv_param_3_1_default");
unsigned int ldv_4_ldv_param_3_2_default  ;
    klee_make_symbolic(&ldv_4_ldv_param_3_2_default, sizeof(int), "ldv_4_ldv_param_3_2_default");
int ldv_4_ldv_param_3_3_default  ;
    klee_make_symbolic(&ldv_4_ldv_param_3_3_default, sizeof(int), "ldv_4_ldv_param_3_3_default");
int ldv_4_ldv_param_42_1_default  ;
    klee_make_symbolic(&ldv_4_ldv_param_42_1_default, sizeof(int), "ldv_4_ldv_param_42_1_default");
unsigned int ldv_4_ldv_param_46_1_default  ;
    klee_make_symbolic(&ldv_4_ldv_param_46_1_default, sizeof(int), "ldv_4_ldv_param_46_1_default");
unsigned int ldv_4_ldv_param_50_1_default  ;
    klee_make_symbolic(&ldv_4_ldv_param_50_1_default, sizeof(int), "ldv_4_ldv_param_50_1_default");
unsigned char *ldv_4_ldv_param_57_1_default  ;
unsigned int ldv_4_ldv_param_57_2_default  ;
    klee_make_symbolic(&ldv_4_ldv_param_57_2_default, sizeof(int), "ldv_4_ldv_param_57_2_default");
int ldv_4_ldv_param_61_1_default  ;
    klee_make_symbolic(&ldv_4_ldv_param_61_1_default, sizeof(int), "ldv_4_ldv_param_61_1_default");
int ldv_4_ldv_param_61_2_default  ;
    klee_make_symbolic(&ldv_4_ldv_param_61_2_default, sizeof(int), "ldv_4_ldv_param_61_2_default");
int ldv_4_ldv_param_61_3_default  ;
    klee_make_symbolic(&ldv_4_ldv_param_61_3_default, sizeof(int), "ldv_4_ldv_param_61_3_default");
unsigned int ldv_4_ldv_param_64_1_default  ;
    klee_make_symbolic(&ldv_4_ldv_param_64_1_default, sizeof(int), "ldv_4_ldv_param_64_1_default");
unsigned int ldv_4_ldv_param_64_2_default  ;
    klee_make_symbolic(&ldv_4_ldv_param_64_2_default, sizeof(int), "ldv_4_ldv_param_64_2_default");
int ldv_4_ldv_param_67_1_default  ;
    klee_make_symbolic(&ldv_4_ldv_param_67_1_default, sizeof(int), "ldv_4_ldv_param_67_1_default");
int ldv_4_ldv_param_67_2_default  ;
    klee_make_symbolic(&ldv_4_ldv_param_67_2_default, sizeof(int), "ldv_4_ldv_param_67_2_default");
unsigned long ldv_4_ldv_param_70_1_default  ;
    klee_make_symbolic(&ldv_4_ldv_param_70_1_default, sizeof(long), "ldv_4_ldv_param_70_1_default");
int ldv_4_ldv_param_73_1_default  ;
    klee_make_symbolic(&ldv_4_ldv_param_73_1_default, sizeof(int), "ldv_4_ldv_param_73_1_default");
int ldv_4_ldv_param_73_2_default  ;
    klee_make_symbolic(&ldv_4_ldv_param_73_2_default, sizeof(int), "ldv_4_ldv_param_73_2_default");
int ldv_4_ldv_param_73_3_default  ;
    klee_make_symbolic(&ldv_4_ldv_param_73_3_default, sizeof(int), "ldv_4_ldv_param_73_3_default");
int ldv_4_ldv_param_73_4_default  ;
    klee_make_symbolic(&ldv_4_ldv_param_73_4_default, sizeof(int), "ldv_4_ldv_param_73_4_default");
int ldv_4_ldv_param_76_1_default  ;
    klee_make_symbolic(&ldv_4_ldv_param_76_1_default, sizeof(int), "ldv_4_ldv_param_76_1_default");
struct dma_desc *ldv_4_ldv_param_82_2_default  ;
unsigned int ldv_4_ldv_param_85_1_default  ;
    klee_make_symbolic(&ldv_4_ldv_param_85_1_default, sizeof(int), "ldv_4_ldv_param_85_1_default");
int ldv_4_ldv_param_89_1_default  ;
    klee_make_symbolic(&ldv_4_ldv_param_89_1_default, sizeof(int), "ldv_4_ldv_param_89_1_default");
int ldv_4_ldv_param_92_1_default  ;
    klee_make_symbolic(&ldv_4_ldv_param_92_1_default, sizeof(int), "ldv_4_ldv_param_92_1_default");
int ldv_4_ldv_param_92_2_default  ;
    klee_make_symbolic(&ldv_4_ldv_param_92_2_default, sizeof(int), "ldv_4_ldv_param_92_2_default");
int ldv_4_ldv_param_95_1_default  ;
    klee_make_symbolic(&ldv_4_ldv_param_95_1_default, sizeof(int), "ldv_4_ldv_param_95_1_default");
...
unsigned int ldv_5_ldv_param_100_2_default  ;
    klee_make_symbolic(&ldv_5_ldv_param_100_2_default, sizeof(int), "ldv_5_ldv_param_100_2_default");
struct dma_desc *ldv_5_ldv_param_107_2_default  ;
unsigned int ldv_5_ldv_param_11_1_default  ;
    klee_make_symbolic(&ldv_5_ldv_param_11_1_default, sizeof(int), "ldv_5_ldv_param_11_1_default");
unsigned int ldv_5_ldv_param_14_1_default  ;
    klee_make_symbolic(&ldv_5_ldv_param_14_1_default, sizeof(int), "ldv_5_ldv_param_14_1_default");
int ldv_5_ldv_param_18_1_default  ;
    klee_make_symbolic(&ldv_5_ldv_param_18_1_default, sizeof(int), "ldv_5_ldv_param_18_1_default");
_Bool ldv_5_ldv_param_21_1_default  ;
int ldv_5_ldv_param_27_1_default  ;
    klee_make_symbolic(&ldv_5_ldv_param_27_1_default, sizeof(int), "ldv_5_ldv_param_27_1_default");
int ldv_5_ldv_param_27_2_default  ;
    klee_make_symbolic(&ldv_5_ldv_param_27_2_default, sizeof(int), "ldv_5_ldv_param_27_2_default");
unsigned int ldv_5_ldv_param_34_1_default  ;
    klee_make_symbolic(&ldv_5_ldv_param_34_1_default, sizeof(int), "ldv_5_ldv_param_34_1_default");
unsigned int ldv_5_ldv_param_34_2_default  ;
    klee_make_symbolic(&ldv_5_ldv_param_34_2_default, sizeof(int), "ldv_5_ldv_param_34_2_default");
unsigned int ldv_5_ldv_param_34_3_default  ;
    klee_make_symbolic(&ldv_5_ldv_param_34_3_default, sizeof(int), "ldv_5_ldv_param_34_3_default");
int ldv_5_ldv_param_37_1_default  ;
    klee_make_symbolic(&ldv_5_ldv_param_37_1_default, sizeof(int), "ldv_5_ldv_param_37_1_default");
int ldv_5_ldv_param_37_2_default  ;
    klee_make_symbolic(&ldv_5_ldv_param_37_2_default, sizeof(int), "ldv_5_ldv_param_37_2_default");
int ldv_5_ldv_param_37_3_default  ;
    klee_make_symbolic(&ldv_5_ldv_param_37_3_default, sizeof(int), "ldv_5_ldv_param_37_3_default");
int ldv_5_ldv_param_37_4_default  ;
    klee_make_symbolic(&ldv_5_ldv_param_37_4_default, sizeof(int), "ldv_5_ldv_param_37_4_default");
unsigned int ldv_5_ldv_param_37_5_default  ;
    klee_make_symbolic(&ldv_5_ldv_param_37_5_default, sizeof(int), "ldv_5_ldv_param_37_5_default");
unsigned int ldv_5_ldv_param_37_6_default  ;
    klee_make_symbolic(&ldv_5_ldv_param_37_6_default, sizeof(int), "ldv_5_ldv_param_37_6_default");
int ldv_5_ldv_param_37_7_default  ;
    klee_make_symbolic(&ldv_5_ldv_param_37_7_default, sizeof(int), "ldv_5_ldv_param_37_7_default");
unsigned int ldv_5_ldv_param_3_1_default  ;
    klee_make_symbolic(&ldv_5_ldv_param_3_1_default, sizeof(int), "ldv_5_ldv_param_3_1_default");
unsigned int ldv_5_ldv_param_3_2_default  ;
    klee_make_symbolic(&ldv_5_ldv_param_3_2_default, sizeof(int), "ldv_5_ldv_param_3_2_default");
int ldv_5_ldv_param_3_3_default  ;
    klee_make_symbolic(&ldv_5_ldv_param_3_3_default, sizeof(int), "ldv_5_ldv_param_3_3_default");
int ldv_5_ldv_param_42_1_default  ;
    klee_make_symbolic(&ldv_5_ldv_param_42_1_default, sizeof(int), "ldv_5_ldv_param_42_1_default");
unsigned int ldv_5_ldv_param_46_1_default  ;
    klee_make_symbolic(&ldv_5_ldv_param_46_1_default, sizeof(int), "ldv_5_ldv_param_46_1_default");
unsigned int ldv_5_ldv_param_50_1_default  ;
    klee_make_symbolic(&ldv_5_ldv_param_50_1_default, sizeof(int), "ldv_5_ldv_param_50_1_default");
unsigned char *ldv_5_ldv_param_57_1_default  ;
unsigned int ldv_5_ldv_param_57_2_default  ;
    klee_make_symbolic(&ldv_5_ldv_param_57_2_default, sizeof(int), "ldv_5_ldv_param_57_2_default");
int ldv_5_ldv_param_61_1_default  ;
    klee_make_symbolic(&ldv_5_ldv_param_61_1_default, sizeof(int), "ldv_5_ldv_param_61_1_default");
int ldv_5_ldv_param_61_2_default  ;
    klee_make_symbolic(&ldv_5_ldv_param_61_2_default, sizeof(int), "ldv_5_ldv_param_61_2_default");
int ldv_5_ldv_param_61_3_default  ;
    klee_make_symbolic(&ldv_5_ldv_param_61_3_default, sizeof(int), "ldv_5_ldv_param_61_3_default");
unsigned int ldv_5_ldv_param_64_1_default  ;
    klee_make_symbolic(&ldv_5_ldv_param_64_1_default, sizeof(int), "ldv_5_ldv_param_64_1_default");
unsigned int ldv_5_ldv_param_64_2_default  ;
    klee_make_symbolic(&ldv_5_ldv_param_64_2_default, sizeof(int), "ldv_5_ldv_param_64_2_default");
int ldv_5_ldv_param_67_1_default  ;
    klee_make_symbolic(&ldv_5_ldv_param_67_1_default, sizeof(int), "ldv_5_ldv_param_67_1_default");
int ldv_5_ldv_param_67_2_default  ;
    klee_make_symbolic(&ldv_5_ldv_param_67_2_default, sizeof(int), "ldv_5_ldv_param_67_2_default");
unsigned long ldv_5_ldv_param_70_1_default  ;
    klee_make_symbolic(&ldv_5_ldv_param_70_1_default, sizeof(long), "ldv_5_ldv_param_70_1_default");
int ldv_5_ldv_param_73_1_default  ;
    klee_make_symbolic(&ldv_5_ldv_param_73_1_default, sizeof(int), "ldv_5_ldv_param_73_1_default");
int ldv_5_ldv_param_73_2_default  ;
    klee_make_symbolic(&ldv_5_ldv_param_73_2_default, sizeof(int), "ldv_5_ldv_param_73_2_default");
int ldv_5_ldv_param_73_3_default  ;
    klee_make_symbolic(&ldv_5_ldv_param_73_3_default, sizeof(int), "ldv_5_ldv_param_73_3_default");
int ldv_5_ldv_param_73_4_default  ;
    klee_make_symbolic(&ldv_5_ldv_param_73_4_default, sizeof(int), "ldv_5_ldv_param_73_4_default");
int ldv_5_ldv_param_76_1_default  ;
    klee_make_symbolic(&ldv_5_ldv_param_76_1_default, sizeof(int), "ldv_5_ldv_param_76_1_default");
struct dma_desc *ldv_5_ldv_param_82_2_default  ;
unsigned int ldv_5_ldv_param_85_1_default  ;
    klee_make_symbolic(&ldv_5_ldv_param_85_1_default, sizeof(int), "ldv_5_ldv_param_85_1_default");
int ldv_5_ldv_param_89_1_default  ;
    klee_make_symbolic(&ldv_5_ldv_param_89_1_default, sizeof(int), "ldv_5_ldv_param_89_1_default");
int ldv_5_ldv_param_92_1_default  ;
    klee_make_symbolic(&ldv_5_ldv_param_92_1_default, sizeof(int), "ldv_5_ldv_param_92_1_default");
int ldv_5_ldv_param_92_2_default  ;
    klee_make_symbolic(&ldv_5_ldv_param_92_2_default, sizeof(int), "ldv_5_ldv_param_92_2_default");
int ldv_5_ldv_param_95_1_default  ;
    klee_make_symbolic(&ldv_5_ldv_param_95_1_default, sizeof(int), "ldv_5_ldv_param_95_1_default");
...
int ldv_6_ldv_param_19_1_default  ;
    klee_make_symbolic(&ldv_6_ldv_param_19_1_default, sizeof(int), "ldv_6_ldv_param_19_1_default");
unsigned int ldv_6_ldv_param_22_1_default  ;
    klee_make_symbolic(&ldv_6_ldv_param_22_1_default, sizeof(int), "ldv_6_ldv_param_22_1_default");
unsigned char *ldv_6_ldv_param_22_2_default  ;
int ldv_6_ldv_param_27_1_default  ;
    klee_make_symbolic(&ldv_6_ldv_param_27_1_default, sizeof(int), "ldv_6_ldv_param_27_1_default");
int ldv_6_ldv_param_30_2_default  ;
    klee_make_symbolic(&ldv_6_ldv_param_30_2_default, sizeof(int), "ldv_6_ldv_param_30_2_default");
unsigned long long ldv_6_ldv_param_33_1_default  ;
    klee_make_symbolic(&ldv_6_ldv_param_33_1_default, sizeof(long), "ldv_6_ldv_param_33_1_default");
unsigned int ldv_6_ldv_param_44_1_default  ;
    klee_make_symbolic(&ldv_6_ldv_param_44_1_default, sizeof(int), "ldv_6_ldv_param_44_1_default");
struct pci_dev *ldv_7_resource_dev  ;
struct pm_message ldv_7_resource_pm_message  ;
int ldv_7_ret_default  ;
    klee_make_symbolic(&ldv_7_ret_default, sizeof(int), "ldv_7_ret_default");
int ldv_8_probed_default  ;
    klee_make_symbolic(&ldv_8_probed_default, sizeof(int), "ldv_8_probed_default");
struct platform_device *ldv_8_resource_platform_device  ;
struct device *ldv_9_device_device  ;
int ldv_statevar_0  ;
    klee_make_symbolic(&ldv_statevar_0, sizeof(int), "ldv_statevar_0");
int ldv_statevar_1  ;
    klee_make_symbolic(&ldv_statevar_1, sizeof(int), "ldv_statevar_1");
int ldv_statevar_10  ;
    klee_make_symbolic(&ldv_statevar_10, sizeof(int), "ldv_statevar_10");
int ldv_statevar_11  ;
    klee_make_symbolic(&ldv_statevar_11, sizeof(int), "ldv_statevar_11");
int ldv_statevar_12  ;
    klee_make_symbolic(&ldv_statevar_12, sizeof(int), "ldv_statevar_12");
int ldv_statevar_2  ;
    klee_make_symbolic(&ldv_statevar_2, sizeof(int), "ldv_statevar_2");
int ldv_statevar_21  ;
    klee_make_symbolic(&ldv_statevar_21, sizeof(int), "ldv_statevar_21");
int ldv_statevar_3  ;
    klee_make_symbolic(&ldv_statevar_3, sizeof(int), "ldv_statevar_3");
int ldv_statevar_4  ;
    klee_make_symbolic(&ldv_statevar_4, sizeof(int), "ldv_statevar_4");
int ldv_statevar_5  ;
    klee_make_symbolic(&ldv_statevar_5, sizeof(int), "ldv_statevar_5");
int ldv_statevar_6  ;
    klee_make_symbolic(&ldv_statevar_6, sizeof(int), "ldv_statevar_6");
int ldv_statevar_7 ;
    klee_make_symbolic(&ldv_statevar_7, sizeof(int), "ldv_statevar_7");
int ldv_statevar_8 ;
    klee_make_symbolic(&ldv_statevar_8, sizeof(int), "ldv_statevar_8");
int ldv_statevar_9 ;
    klee_make_symbolic(&ldv_statevar_9, sizeof(int), "ldv_statevar_9");
...
{ 
  int ldv_15_line_line ;
    klee_make_symbolic(&ldv_15_line_line, sizeof(int), "ldv_15_line_line");
...
{ 
  ...
  int ldv_19_line_line ;
    klee_make_symbolic(&ldv_19_line_line, sizeof(int), "ldv_19_line_line");
...
{ 
  ...
  struct phy_device *phy ;
  int new_pause ;
    klee_make_symbolic(&new_pause, sizeof(int), "new_pause");
  int ret ;
  bool tmp___0 ;
...
{ 
  unsigned long clk ;
    klee_make_symbolic(&clk, sizeof(long), "clk");
  unsigned long tmp ;
...
{ 
  ...
  unsigned int rx_riwt ;
    klee_make_symbolic(&rx_riwt, sizeof(int), "rx_riwt");
...
{ 
  unsigned long curr ;
    klee_make_symbolic(&curr, sizeof(long), "curr");
...
{ 
  ...
  unsigned int mii_address ;
    klee_make_symbolic(&mii_address, sizeof(int), "mii_address");
  unsigned int mii_data ;
    klee_make_symbolic(&mii_data, sizeof(int), "mii_data");
  int data ;
  u16 regValue ;
  int tmp___0 ;
  int tmp___1 ;
...
{ 
  ...
  struct phy_device *phydev ;
  int act ;
    klee_make_symbolic(&act, sizeof(int), "act");
  char irq_num[4U] ;
  char *irq_str ;
  char const   *tmp___0 ;
...
{ 
  ...
  unsigned int tmp ;
  unsigned int bmax ;
    klee_make_symbolic(&bmax, sizeof(int), "bmax");
  unsigned int len ;
  dma_addr_t tmp___0 ;
  dma_addr_t tmp___1 ;
  dma_addr_t tmp___2 ;
...
{ 
  unsigned int hi_addr ;
    klee_make_symbolic(&hi_addr, sizeof(int), "hi_addr");
  unsigned int lo_addr ;
    klee_make_symbolic(&lo_addr, sizeof(int), "lo_addr");
...
{ 
  ...
  unsigned int perfect_addr_number ;
    klee_make_symbolic(&perfect_addr_number, sizeof(int), "perfect_addr_number");
  struct _ddebug descriptor ;
  long tmp ;
  u32 mc_filter[2U] ;
...
{ 
  unsigned int flow ;
    klee_make_symbolic(&flow, sizeof(int), "flow");
  struct _ddebug descriptor ;
  long tmp ;
  struct _ddebug descriptor___0 ;
  long tmp___0 ;
...
{ 
  ...
  unsigned int tmp___4 ;
  int speed_value ;
    klee_make_symbolic(&speed_value, sizeof(int), "speed_value");
  struct _ddebug descriptor ;
  long tmp___5 ;
  struct _ddebug descriptor___0 ;
  long tmp___6 ;
...
{ 
  ...
  unsigned int ove_cntr ;
    klee_make_symbolic(&ove_cntr, sizeof(int), "ove_cntr");
  unsigned int miss_f ;
    klee_make_symbolic(&miss_f, sizeof(int), "miss_f");
  long tmp___0 ;
...
{ 
  int ter ;
    klee_make_symbolic(&ter, sizeof(int), "ter");
...
{ 
  ...
  unsigned int tmp___75 ;
    klee_make_symbolic(&tmp___75, sizeof(int), "tmp___75");
  unsigned int tmp___76 ;
    klee_make_symbolic(&tmp___76, sizeof(int), "tmp___76");
  unsigned int tmp___77 ;
    klee_make_symbolic(&tmp___77, sizeof(int), "tmp___77");
