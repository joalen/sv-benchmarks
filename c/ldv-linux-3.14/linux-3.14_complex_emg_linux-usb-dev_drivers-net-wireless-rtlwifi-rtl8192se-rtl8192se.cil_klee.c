...
{ 
  ...
  long tmpentry_maxpwdb ;
    klee_make_symbolic(&tmpentry_maxpwdb, sizeof(long), "tmpentry_maxpwdb");
  u8 rssi_a ;
  u8 rssi_b ;
  bool tmp ;
...
{ 
  ...
  long txpwr_threshold_lv1 ;
    klee_make_symbolic(&txpwr_threshold_lv1, sizeof(long), "txpwr_threshold_lv1");
  long txpwr_threshold_lv2 ;
    klee_make_symbolic(&txpwr_threshold_lv2, sizeof(long), "txpwr_threshold_lv2");
  int tmp ;
  int tmp___0 ;
  long tmp___1 ;
  long tmp___2 ;
...
{ 
  ...
  u8 cpustatus ;
  short pollingcnt ;
    klee_make_symbolic(&pollingcnt, sizeof(short), "pollingcnt");
  bool rtstatus ;
  int tmp ;
  int tmp___0 ;
  long tmp___1 ;
...
{ 
  ...
  struct rtl_phy *rtlphy ;
  char ant_pwr_diff ;
    klee_make_symbolic(&ant_pwr_diff, sizeof(char), "ant_pwr_diff");
  u32 u4reg_val ;
  int tmp ;
  int tmp___0 ;
  long tmp___1 ;
