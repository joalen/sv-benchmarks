...
struct nic {
   ...
   unsigned int cbs_avail ;
    klee_make_symbolic(&cbs_avail, sizeof(int), "cbs_avail");
...
{ 
  u8 phy_type ;
  int without_mii ;
    klee_make_symbolic(&without_mii, sizeof(int), "without_mii");
...
{ 
  ...
  struct cb *cb ;
  int tx_cleaned ;
    klee_make_symbolic(&tx_cleaned, sizeof(int), "tx_cleaned");
  long tmp ;
  struct cb *tmp___0 ;
  long tmp___1 ;
  bool tmp___2 ;
...
{ 
  ...
  int restart_required ;
    klee_make_symbolic(&restart_required, sizeof(int), "restart_required");
  int err ;
...
unsigned int ldv_1_ldv_param_50_1_default  ;
    klee_make_symbolic(&ldv_1_ldv_param_50_1_default, sizeof(int), "ldv_1_ldv_param_50_1_default");
