...
struct ksz_port_cfg {
   ...
   u32 tx_rate[4U] ;
   int stp_state ;
    klee_make_symbolic(&stp_state, sizeof(int), "stp_state");
};
struct ksz_switch {
...
struct ksz_hw {
   ...
   int dst_ports ;
    klee_make_symbolic(&dst_ports, sizeof(int), "dst_ports");
   int id ;
   int mib_cnt ;
    klee_make_symbolic(&mib_cnt, sizeof(int), "mib_cnt");
   int mib_port_cnt ;
    klee_make_symbolic(&mib_port_cnt, sizeof(int), "mib_port_cnt");
   u32 tx_cfg ;
   u32 rx_cfg ;
   u32 intr_mask ;
   u32 intr_set ;
   uint intr_blocked ;
    klee_make_symbolic(&intr_blocked, sizeof(int), "intr_blocked");
   struct ksz_desc_info rx_desc_info ;
   struct ksz_desc_info tx_desc_info ;
   int tx_int_cnt ;
    klee_make_symbolic(&tx_int_cnt, sizeof(int), "tx_int_cnt");
   int tx_int_mask ;
    klee_make_symbolic(&tx_int_mask, sizeof(int), "tx_int_mask");
   int tx_size ;
   ...
   uint overrides ;
    klee_make_symbolic(&overrides, sizeof(int), "overrides");
   void *parent ;
};
struct ksz_port {
   u8 duplex ;
   ...
   u8 flow_ctrl ;
   int first_port ;
    klee_make_symbolic(&first_port, sizeof(int), "first_port");
   int mib_port_cnt ;
   int port_cnt ;
    klee_make_symbolic(&port_cnt, sizeof(int), "port_cnt");
   u64 counter[4U] ;
   struct ksz_hw *hw ;
...
struct ksz_shared_mem {
   ...
   uint phys ;
    klee_make_symbolic(&phys, sizeof(int), "phys");
   u8 *alloc_virt ;
   u8 *virt ;
};
...
struct dev_info {
   ...
   int skb_index ;
    klee_make_symbolic(&skb_index, sizeof(int), "skb_index");
   int skb_len ;
   ...
   int wol_enable ;
    klee_make_symbolic(&wol_enable, sizeof(int), "wol_enable");
   int wol_support ;
    klee_make_symbolic(&wol_support, sizeof(int), "wol_support");
   unsigned long pme_wait ;
    klee_make_symbolic(&pme_wait, sizeof(long), "pme_wait");
};
struct dev_priv {
   ...
   u32 msg_enable ;
   int media_state ;
    klee_make_symbolic(&media_state, sizeof(int), "media_state");
   int multicast ;
   int promiscuous ;
...
{ 
  uint interrupt___0 ;
    klee_make_symbolic(&interrupt___0, sizeof(int), "interrupt___0");
...
{ 
  int i ;
  int mib ;
    klee_make_symbolic(&mib, sizeof(int), "mib");
  int port ;
...
{ 
  uint int_enable ;
    klee_make_symbolic(&int_enable, sizeof(int), "int_enable");
  struct net_device *dev ;
  struct dev_priv *priv ;
  void *tmp ;
  struct dev_info *hw_priv ;
...
{ 
  ...
  struct ksz_hw *hw ;
  int hw_mtu ;
    klee_make_symbolic(&hw_mtu, sizeof(int), "hw_mtu");
  bool tmp___0 ;
...
{ 
  ...
  int regs_len ;
    klee_make_symbolic(&regs_len, sizeof(int), "regs_len");
...
{ 
  ...
  struct ksz_port *port ;
  int n_stats ;
    klee_make_symbolic(&n_stats, sizeof(int), "n_stats");
  int i ;
  int n ;
...
static int multi_dev  ;
    klee_make_symbolic(&multi_dev, sizeof(int), "multi_dev");
static int fast_aging  ;
    klee_make_symbolic(&fast_aging, sizeof(int), "fast_aging");
...
static int net_device_present  ;
    klee_make_symbolic(&net_device_present, sizeof(int), "net_device_present");
static void get_mac_addr(struct dev_info *hw_priv , u8 *macaddr___0 , int port ) 
{ 
  int i ;
  int j ;
  int got_num ;
    klee_make_symbolic(&got_num, sizeof(int), "got_num");
  int num ;
  int digit ;
    klee_make_symbolic(&digit, sizeof(int), "digit");
  int tmp ;
  int tmp___0 ;
...
{ 
  ...
  unsigned long reg_base ;
    klee_make_symbolic(&reg_base, sizeof(long), "reg_base");
  unsigned long reg_len ;
    klee_make_symbolic(&reg_len, sizeof(long), "reg_len");
  int cnt ;
  int i ;
  int mib_port_count ;
    klee_make_symbolic(&mib_port_count, sizeof(int), "mib_port_count");
  int pi ;
  int port_count ;
...
int ldv_1_ldv_param_28_1_default  ;
    klee_make_symbolic(&ldv_1_ldv_param_28_1_default, sizeof(int), "ldv_1_ldv_param_28_1_default");
...
unsigned long long ldv_1_ldv_param_37_1_default  ;
    klee_make_symbolic(&ldv_1_ldv_param_37_1_default, sizeof(long), "ldv_1_ldv_param_37_1_default");
