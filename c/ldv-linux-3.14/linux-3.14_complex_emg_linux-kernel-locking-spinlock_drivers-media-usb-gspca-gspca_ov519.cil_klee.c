...
struct sd {
   ...
   u8 packet_nr ;
   char bridge ;
    klee_make_symbolic(&bridge, sizeof(char), "bridge");
   char invert_led ;
    klee_make_symbolic(&invert_led, sizeof(char), "invert_led");
   char snapshot_pressed ;
    klee_make_symbolic(&snapshot_pressed, sizeof(char), "snapshot_pressed");
   char snapshot_needs_reset ;
    klee_make_symbolic(&snapshot_needs_reset, sizeof(char), "snapshot_needs_reset");
   u8 sif ;
   u8 stopped ;
   u8 first_frame ;
   u8 frame_rate ;
...
{ 
  u8 bit ;
  int sda ;
    klee_make_symbolic(&sda, sizeof(int), "sda");
...
{ 
  unsigned long hw_bufsize ;
    klee_make_symbolic(&hw_bufsize, sizeof(long), "hw_bufsize");
  unsigned long y0 ;
    klee_make_symbolic(&y0, sizeof(long), "y0");
  unsigned long u0 ;
    klee_make_symbolic(&u0, sizeof(long), "u0");
  unsigned long v0 ;
    klee_make_symbolic(&v0, sizeof(long), "v0");
  unsigned long y1 ;
    klee_make_symbolic(&y1, sizeof(long), "y1");
  unsigned long u1 ;
    klee_make_symbolic(&u1, sizeof(long), "u1");
  unsigned long v1 ;
    klee_make_symbolic(&v1, sizeof(long), "v1");
...
{ 
  int start_cropx ;
    klee_make_symbolic(&start_cropx, sizeof(int), "start_cropx");
  int start_cropy ;
    klee_make_symbolic(&start_cropy, sizeof(int), "start_cropy");
  int x ;
  int y ;
...
{ 
  ...
  int vs_polarity ;
    klee_make_symbolic(&vs_polarity, sizeof(int), "vs_polarity");
  int hs_polarity ;
    klee_make_symbolic(&hs_polarity, sizeof(int), "hs_polarity");
  s32 tmp ;
...
{ 
  ...
  unsigned char val0 ;
    klee_make_symbolic(&val0, sizeof(char), "val0");
  unsigned char val1 ;
    klee_make_symbolic(&val1, sizeof(char), "val1");
  int i ;
  int size ;
  int reg ;
...
{ 
  struct gspca_dev *gspca_dev ;
  int hsegs ;
    klee_make_symbolic(&hsegs, sizeof(int), "hsegs");
  int vsegs ;
    klee_make_symbolic(&vsegs, sizeof(int), "vsegs");
  int packet_size ;
...
{ 
  struct gspca_dev *gspca_dev ;
  int qvga ;
    klee_make_symbolic(&qvga, sizeof(int), "qvga");
  int xstart ;
    klee_make_symbolic(&xstart, sizeof(int), "xstart");
  int xend ;
    klee_make_symbolic(&xend, sizeof(int), "xend");
  int ystart ;
    klee_make_symbolic(&ystart, sizeof(int), "ystart");
  int yend ;
    klee_make_symbolic(&yend, sizeof(int), "yend");
  u8 v ;
  u8 v___0 ;
  int tmp ;
  int tmp___0 ;
...
{ 
  ...
  int hwsbase ;
    klee_make_symbolic(&hwsbase, sizeof(int), "hwsbase");
  int hwebase ;
    klee_make_symbolic(&hwebase, sizeof(int), "hwebase");
  int vwsbase ;
    klee_make_symbolic(&vwsbase, sizeof(int), "vwsbase");
  int vwebase ;
    klee_make_symbolic(&vwebase, sizeof(int), "vwebase");
  int hwscale ;
    klee_make_symbolic(&hwscale, sizeof(int), "hwscale");
  int vwscale ;
    klee_make_symbolic(&vwscale, sizeof(int), "vwscale");
