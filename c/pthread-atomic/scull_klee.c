...
int dev_data;
    klee_make_symbolic(&dev_data, sizeof(int), "dev_data");
int dev_quantum;
    klee_make_symbolic(&dev_quantum, sizeof(int), "dev_quantum");
int dev_qset;
    klee_make_symbolic(&dev_qset, sizeof(int), "dev_qset");
unsigned_long dev_size; 
    klee_make_symbolic(&dev_size, sizeof(long), "dev_size");
int __X__; //variable to test mutual exclusion 
    klee_make_symbolic(&__X__, sizeof(int), "__X__");
