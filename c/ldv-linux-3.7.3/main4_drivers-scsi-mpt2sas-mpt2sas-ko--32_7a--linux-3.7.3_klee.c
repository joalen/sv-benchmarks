...
struct MPT2SAS_ADAPTER {
   ...
   u8 id ;
   int cpu_count ;
    klee_make_symbolic(&cpu_count, sizeof(int), "cpu_count");
   char name[32U] ;
   char tmp_string[64U] ;
   struct pci_dev *pdev ;
   ...
   int logging_level ;
    klee_make_symbolic(&logging_level, sizeof(int), "logging_level");
   int fwfault_debug ;
    klee_make_symbolic(&fwfault_debug, sizeof(int), "fwfault_debug");
   u8 ir_firmware ;
   int bars ;
   ...
   int aen_event_read_flag ;
    klee_make_symbolic(&aen_event_read_flag, sizeof(int), "aen_event_read_flag");
   ...
   int sas_id ;
    klee_make_symbolic(&sas_id, sizeof(int), "sas_id");
   ...
   ulong scsi_lookup_pages ;
    klee_make_symbolic(&scsi_lookup_pages, sizeof(long), "scsi_lookup_pages");
   spinlock_t scsi_lookup_lock ;
   struct list_head free_list ;
   int pending_io_count ;
    klee_make_symbolic(&pending_io_count, sizeof(int), "pending_io_count");
   wait_queue_head_t reset_wq ;
   struct chain_tracker *chain_lookup ;
   struct list_head free_chain_list ;
   struct dma_pool *chain_dma_pool ;
   ulong chain_pages ;
    klee_make_symbolic(&chain_pages, sizeof(long), "chain_pages");
...
struct __anonstruct_dw_213 {
   unsigned short subcode ;
    klee_make_symbolic(&subcode, sizeof(short), "subcode");
   unsigned char code ;
...
struct raid_data {
   ...
   int component_count ;
    klee_make_symbolic(&component_count, sizeof(int), "component_count");
   enum raid_level level ;
   enum raid_state state ;
   int resync ;
    klee_make_symbolic(&resync, sizeof(int), "resync");
};
...
struct sas_expander_device {
   int level ;
   int next_port_id ;
    klee_make_symbolic(&next_port_id, sizeof(int), "next_port_id");
   char vendor_id[9U] ;
   char product_id[17U] ;
   char product_rev[5U] ;
...
static int mpt2sas_fwfault_debug  ;
    klee_make_symbolic(&mpt2sas_fwfault_debug, sizeof(int), "mpt2sas_fwfault_debug");
...
{ 
  struct adapter_reply_queue *reply_q ;
  int cpu_id ;
    klee_make_symbolic(&cpu_id, sizeof(int), "cpu_id");
  int cpu_grouping ;
    klee_make_symbolic(&cpu_grouping, sizeof(int), "cpu_grouping");
  int loop ;
    klee_make_symbolic(&loop, sizeof(int), "loop");
  int grouping ;
    klee_make_symbolic(&grouping, sizeof(int), "grouping");
  int grouping_mod ;
    klee_make_symbolic(&grouping_mod, sizeof(int), "grouping_mod");
  int tmp ;
  struct list_head  const  *__mptr ;
  struct list_head  const  *__mptr___0 ;
  struct list_head  const  *__mptr___1 ;
...
{ 
  ...
  struct mpt2sas_port_facts *pfacts ;
  int mpi_reply_sz ;
    klee_make_symbolic(&mpi_reply_sz, sizeof(int), "mpi_reply_sz");
  int mpi_request_sz ;
    klee_make_symbolic(&mpi_request_sz, sizeof(int), "mpi_request_sz");
  int r ;
...
{ 
  ...
  long reply_post_free ;
    klee_make_symbolic(&reply_post_free, sizeof(long), "reply_post_free");
  u32 reply_post_free_sz ;
  struct list_head  const  *__mptr ;
  struct list_head  const  *__mptr___0 ;
  struct list_head  const  *__mptr___1 ;
...
{ 
  ...
  int cpu_id ;
  int last_cpu_id ;
    klee_make_symbolic(&last_cpu_id, sizeof(int), "last_cpu_id");
  unsigned int tmp ;
  unsigned int tmp___0 ;
  void *tmp___1 ;
  void *tmp___2 ;
...
{ 
  ...
  int i ;
  int config_page_sz ;
    klee_make_symbolic(&config_page_sz, sizeof(int), "config_page_sz");
  u16 ioc_status ;
  int config_num ;
    klee_make_symbolic(&config_num, sizeof(int), "config_num");
  u16 element_type ;
...
static int mpt_ids  ;
    klee_make_symbolic(&mpt_ids, sizeof(int), "mpt_ids");
...
{ 
  ...
  u32 chain_flags ;
  int sges_left ;
    klee_make_symbolic(&sges_left, sizeof(int), "sges_left");
  u32 sges_in_segment ;
  u32 sgl_flags ;
...
{ 
  ...
  unsigned long stripe_sz ;
    klee_make_symbolic(&stripe_sz, sizeof(long), "stripe_sz");
  unsigned long block_sz ;
    klee_make_symbolic(&block_sz, sizeof(long), "block_sz");
  u8 stripe_exp ;
  u8 block_exp ;
  u64 dev_max_lba ;
  u8 tmp ;
...
{ 
  ...
  int i ;
  int reason_code ;
    klee_make_symbolic(&reason_code, sizeof(int), "reason_code");
  u16 handle ;
  raw_spinlock_t *tmp ;
  unsigned long tmp___0 ;
  int tmp___1 ;
...
{ 
  ...
  unsigned long var__scsih_scan_finished_144_p1 ;
    klee_make_symbolic(&var__scsih_scan_finished_144_p1, sizeof(long), "var__scsih_scan_finished_144_p1");
  int var__scsih_change_queue_depth_29_p1 ;
    klee_make_symbolic(&var__scsih_change_queue_depth_29_p1, sizeof(int), "var__scsih_change_queue_depth_29_p1");
  int var__scsih_change_queue_depth_29_p2 ;
    klee_make_symbolic(&var__scsih_change_queue_depth_29_p2, sizeof(int), "var__scsih_change_queue_depth_29_p2");
  int var__scsih_change_queue_type_30_p1 ;
    klee_make_symbolic(&var__scsih_change_queue_type_30_p1, sizeof(int), "var__scsih_change_queue_type_30_p1");
  ...
  int res__scsih_probe_145 ;
    klee_make_symbolic(&res__scsih_probe_145, sizeof(int), "res__scsih_probe_145");
  pm_message_t var__scsih_suspend_146_p1 ;
  struct device *var_group6 ;
  int ldv_s_scsih_driver_pci_driver ;
    klee_make_symbolic(&ldv_s_scsih_driver_pci_driver, sizeof(int), "ldv_s_scsih_driver_pci_driver");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
...
{ 
  struct sas_phy *phy ;
  int phy_index ;
    klee_make_symbolic(&phy_index, sizeof(int), "phy_index");
  int tmp ;
  int tmp___0 ;
...
{ 
  ...
  int discovery_active ;
    klee_make_symbolic(&discovery_active, sizeof(int), "discovery_active");
  raw_spinlock_t *tmp___0 ;
  struct _sas_node *tmp___1 ;
  int tmp___2 ;
  void *tmp___3 ;
...
{ 
  ...
  int var__transport_phy_reset_23_p1 ;
    klee_make_symbolic(&var__transport_phy_reset_23_p1, sizeof(int), "var__transport_phy_reset_23_p1");
  int var__transport_phy_enable_24_p1 ;
    klee_make_symbolic(&var__transport_phy_enable_24_p1, sizeof(int), "var__transport_phy_enable_24_p1");
...
{ 
  ...
  unsigned long request_size ;
    klee_make_symbolic(&request_size, sizeof(long), "request_size");
  unsigned long copy_size ;
    klee_make_symbolic(&copy_size, sizeof(long), "copy_size");
  u16 smid ;
  u16 ioc_status ;
  u8 issue_reset ;
  unsigned long tmp ;
...
{ 
  ...
  unsigned int var__ctl_ioctl_32_p1 ;
    klee_make_symbolic(&var__ctl_ioctl_32_p1, sizeof(int), "var__ctl_ioctl_32_p1");
  unsigned long var__ctl_ioctl_32_p2 ;
    klee_make_symbolic(&var__ctl_ioctl_32_p2, sizeof(long), "var__ctl_ioctl_32_p2");
  struct inode *var_group2 ;
  poll_table *var__ctl_poll_10_p1 ;
  int var__ctl_fasync_8_p0 ;
    klee_make_symbolic(&var__ctl_fasync_8_p0, sizeof(int), "var__ctl_fasync_8_p0");
  int var__ctl_fasync_8_p2 ;
    klee_make_symbolic(&var__ctl_fasync_8_p2, sizeof(int), "var__ctl_fasync_8_p2");
  unsigned int var__ctl_ioctl_compat_33_p1 ;
    klee_make_symbolic(&var__ctl_ioctl_compat_33_p1, sizeof(int), "var__ctl_ioctl_compat_33_p1");
  unsigned long var__ctl_ioctl_compat_33_p2 ;
    klee_make_symbolic(&var__ctl_ioctl_compat_33_p2, sizeof(long), "var__ctl_ioctl_compat_33_p2");
  int ldv_s_ctl_fops_file_operations ;
    klee_make_symbolic(&ldv_s_ctl_fops_file_operations, sizeof(int), "ldv_s_ctl_fops_file_operations");
  int tmp ;
  int tmp___0 ;
...
static int ldv_mutex_reset_in_progress_mutex  ;
    klee_make_symbolic(&ldv_mutex_reset_in_progress_mutex, sizeof(int), "ldv_mutex_reset_in_progress_mutex");
