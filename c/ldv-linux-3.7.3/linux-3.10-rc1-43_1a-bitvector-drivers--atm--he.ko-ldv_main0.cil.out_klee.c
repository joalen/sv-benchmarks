...
struct he_dev {
   ...
   char mac_addr[6U] ;
   int media ;
    klee_make_symbolic(&media, sizeof(int), "media");
   unsigned int vcibits ;
    klee_make_symbolic(&vcibits, sizeof(int), "vcibits");
   unsigned int vpibits ;
    klee_make_symbolic(&vpibits, sizeof(int), "vpibits");
   unsigned int cells_per_row ;
    klee_make_symbolic(&cells_per_row, sizeof(int), "cells_per_row");
   unsigned int bytes_per_row ;
    klee_make_symbolic(&bytes_per_row, sizeof(int), "bytes_per_row");
   unsigned int cells_per_lbuf ;
    klee_make_symbolic(&cells_per_lbuf, sizeof(int), "cells_per_lbuf");
   unsigned int r0_numrows ;
    klee_make_symbolic(&r0_numrows, sizeof(int), "r0_numrows");
   unsigned int r0_startrow ;
    klee_make_symbolic(&r0_startrow, sizeof(int), "r0_startrow");
   unsigned int r0_numbuffs ;
    klee_make_symbolic(&r0_numbuffs, sizeof(int), "r0_numbuffs");
   unsigned int r1_numrows ;
    klee_make_symbolic(&r1_numrows, sizeof(int), "r1_numrows");
   unsigned int r1_startrow ;
    klee_make_symbolic(&r1_startrow, sizeof(int), "r1_startrow");
   unsigned int r1_numbuffs ;
    klee_make_symbolic(&r1_numbuffs, sizeof(int), "r1_numbuffs");
   unsigned int tx_numrows ;
    klee_make_symbolic(&tx_numrows, sizeof(int), "tx_numrows");
   unsigned int tx_startrow ;
    klee_make_symbolic(&tx_startrow, sizeof(int), "tx_startrow");
   unsigned int tx_numbuffs ;
    klee_make_symbolic(&tx_numbuffs, sizeof(int), "tx_numbuffs");
   unsigned int buffer_limit ;
    klee_make_symbolic(&buffer_limit, sizeof(int), "buffer_limit");
   struct he_vcc_table *he_vcc_table ;
   struct he_cs_stper cs_stper[16U] ;
   unsigned int total_bw ;
    klee_make_symbolic(&total_bw, sizeof(int), "total_bw");
   dma_addr_t irq_phys ;
   ...
   int irq_peak ;
    klee_make_symbolic(&irq_peak, sizeof(int), "irq_peak");
   ...
   int rbrq_peak ;
    klee_make_symbolic(&rbrq_peak, sizeof(int), "rbrq_peak");
   struct he_buff **rbpl_virt ;
   unsigned long *rbpl_table ;
   unsigned long rbpl_hint ;
    klee_make_symbolic(&rbpl_hint, sizeof(long), "rbpl_hint");
   ...
   int rbpl_peak ;
    klee_make_symbolic(&rbpl_peak, sizeof(int), "rbpl_peak");
   dma_addr_t tbrq_phys ;
   struct he_tbrq *tbrq_base ;
   struct he_tbrq *tbrq_head ;
   int tbrq_peak ;
    klee_make_symbolic(&tbrq_peak, sizeof(int), "tbrq_peak");
   dma_addr_t hsp_phys ;
   struct he_hsp *hsp ;
...
struct he_vcc {
   ...
   int rc_index ;
    klee_make_symbolic(&rc_index, sizeof(int), "rc_index");
...
{ 
  ...
  unsigned int lbm_offset ;
    klee_make_symbolic(&lbm_offset, sizeof(int), "lbm_offset");
  unsigned int lbufd_index ;
    klee_make_symbolic(&lbufd_index, sizeof(int), "lbufd_index");
  unsigned int lbuf_addr ;
    klee_make_symbolic(&lbuf_addr, sizeof(int), "lbuf_addr");
  unsigned int lbuf_count ;
    klee_make_symbolic(&lbuf_count, sizeof(int), "lbuf_count");
  unsigned int lbufs_per_row ;
    klee_make_symbolic(&lbufs_per_row, sizeof(int), "lbufs_per_row");
  unsigned int lbuf_bufsize ;
    klee_make_symbolic(&lbuf_bufsize, sizeof(int), "lbuf_bufsize");
  unsigned int row_offset ;
    klee_make_symbolic(&row_offset, sizeof(int), "row_offset");
...
{ 
  ...
  unsigned int rate_atmf ;
    klee_make_symbolic(&rate_atmf, sizeof(int), "rate_atmf");
  unsigned int exp ;
  unsigned int man ;
    klee_make_symbolic(&man, sizeof(int), "man");
  unsigned long long rate_cps ;
    klee_make_symbolic(&rate_cps, sizeof(long), "rate_cps");
  int mult ;
    klee_make_symbolic(&mult, sizeof(int), "mult");
  int buf ;
    klee_make_symbolic(&buf, sizeof(int), "buf");
  int buf_limit ;
    klee_make_symbolic(&buf_limit, sizeof(int), "buf_limit");
  void *tmp ;
...
{ 
  ...
  unsigned int lastcid ;
    klee_make_symbolic(&lastcid, sizeof(int), "lastcid");
  struct sk_buff *skb ;
  struct atm_vcc *vcc ;
  ...
  int i ;
  int pdus_assembled ;
    klee_make_symbolic(&pdus_assembled, sizeof(int), "pdus_assembled");
  int updated ;
  struct list_head  const  *__mptr ;
  size_t __len ;
  void *__ret ;
...
{ 
  ...
  int i ;
  int moved ;
    klee_make_symbolic(&moved, sizeof(int), "moved");
  unsigned int tmp ;
...
{ 
  ...
  unsigned int cid ;
  unsigned int rsr0 ;
    klee_make_symbolic(&rsr0, sizeof(int), "rsr0");
  unsigned int rsr1 ;
    klee_make_symbolic(&rsr1, sizeof(int), "rsr1");
  unsigned int rsr4 ;
    klee_make_symbolic(&rsr4, sizeof(int), "rsr4");
  unsigned int tsr0 ;
    klee_make_symbolic(&tsr0, sizeof(int), "tsr0");
  unsigned int tsr0_aal ;
    klee_make_symbolic(&tsr0_aal, sizeof(int), "tsr0_aal");
  unsigned int tsr4 ;
    klee_make_symbolic(&tsr4, sizeof(int), "tsr4");
  unsigned int period ;
  unsigned int reg ;
  unsigned int clock ;
  short vpi ;
  ...
  int pcr_goal ;
    klee_make_symbolic(&pcr_goal, sizeof(int), "pcr_goal");
  unsigned int tmp___0 ;
...
{ 
  ...
  int tx_inuse ;
    klee_make_symbolic(&tx_inuse, sizeof(int), "tx_inuse");
  int timeout ;
  unsigned int tmp___0 ;
  long volatile   __ret ;
  ...
  int timeout___0 ;
    klee_make_symbolic(&timeout___0, sizeof(int), "timeout___0");
...
{ 
  ...
  char *pti_clp ;
  int clp ;
    klee_make_symbolic(&clp, sizeof(int), "clp");
  int pti ;
    klee_make_symbolic(&pti, sizeof(int), "pti");
  dma_addr_t tmp___0 ;
...
{ 
  ...
  int i ;
  long mcc ;
    klee_make_symbolic(&mcc, sizeof(long), "mcc");
  long oec ;
    klee_make_symbolic(&oec, sizeof(long), "oec");
  long dcc ;
    klee_make_symbolic(&dcc, sizeof(long), "dcc");
  long cec ;
    klee_make_symbolic(&cec, sizeof(long), "cec");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
  int tmp___2 ;
...
{ 
  ...
  int res_he_open_23 ;
    klee_make_symbolic(&res_he_open_23, sizeof(int), "res_he_open_23");
  struct atm_dev *var_group2 ;
  unsigned int var_he_ioctl_26_p1 ;
    klee_make_symbolic(&var_he_ioctl_26_p1, sizeof(int), "var_he_ioctl_26_p1");
  void *var_he_ioctl_26_p2 ;
  struct sk_buff *var_group3 ;
  unsigned char var_he_phy_put_27_p1 ;
    klee_make_symbolic(&var_he_phy_put_27_p1, sizeof(char), "var_he_phy_put_27_p1");
  unsigned long var_he_phy_put_27_p2 ;
    klee_make_symbolic(&var_he_phy_put_27_p2, sizeof(long), "var_he_phy_put_27_p2");
  unsigned long var_he_phy_get_28_p1 ;
    klee_make_symbolic(&var_he_phy_get_28_p1, sizeof(long), "var_he_phy_get_28_p1");
  ...
  int res_he_init_one_3 ;
    klee_make_symbolic(&res_he_init_one_3, sizeof(int), "res_he_init_one_3");
  int var_he_irq_handler_21_p0 ;
    klee_make_symbolic(&var_he_irq_handler_21_p0, sizeof(int), "var_he_irq_handler_21_p0");
  void *var_he_irq_handler_21_p1 ;
  int ldv_s_he_ops_atmdev_ops ;
    klee_make_symbolic(&ldv_s_he_ops_atmdev_ops, sizeof(int), "ldv_s_he_ops_atmdev_ops");
  int ldv_s_he_driver_pci_driver ;
    klee_make_symbolic(&ldv_s_he_driver_pci_driver, sizeof(int), "ldv_s_he_driver_pci_driver");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
