...
struct stv090x_internal {
   ...
   u32 dev_ver ;
   int num_used ;
    klee_make_symbolic(&num_used, sizeof(int), "num_used");
};
...
{ 
  ...
  int tmg_lock ;
    klee_make_symbolic(&tmg_lock, sizeof(int), "tmg_lock");
  int i ;
  s32 tmg_cpt ;
  s32 dir ;
  s32 steps ;
...
{ 
  ...
  u8 k_min ;
  int coarse_fail ;
    klee_make_symbolic(&coarse_fail, sizeof(int), "coarse_fail");
  int lock ;
...
{ 
  ...
  s32 car_max ;
  int no_signal ;
    klee_make_symbolic(&no_signal, sizeof(int), "no_signal");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
  int tmp___2 ;
...
{ 
  int no_signal ;
  int zigzag ;
    klee_make_symbolic(&zigzag, sizeof(int), "zigzag");
  int lock ;
  u32 reg ;
  s32 dvbs2_fly_wheel ;
  s32 inc ;
...
{ 
  ...
  int tmp___134 ;
    klee_make_symbolic(&tmp___134, sizeof(int), "tmp___134");
  int tmp___135 ;
...
{ 
  ...
  int lock ;
  int low_sr ;
    klee_make_symbolic(&low_sr, sizeof(int), "low_sr");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
  int tmp___2 ;
...
{ 
  ...
  unsigned long t1_size ;
    klee_make_symbolic(&t1_size, sizeof(long), "t1_size");
  unsigned long t2_size ;
    klee_make_symbolic(&t2_size, sizeof(long), "t2_size");
  u32 reg ;
  int i ;
  int tmp ;
  int tmp___0 ;
...
{ 
  ...
  int ldv_s_stv090x_ops_dvb_frontend_ops ;
    klee_make_symbolic(&ldv_s_stv090x_ops_dvb_frontend_ops, sizeof(int), "ldv_s_stv090x_ops_dvb_frontend_ops");
  int tmp ;
  int tmp___0 ;
...
static int ldv_mutex_demod_lock  ;
    klee_make_symbolic(&ldv_mutex_demod_lock, sizeof(int), "ldv_mutex_demod_lock");
...
static int ldv_mutex_tuner_lock  ;
    klee_make_symbolic(&ldv_mutex_tuner_lock, sizeof(int), "ldv_mutex_tuner_lock");
