...
struct rxd_ops {
   int rxd_size ;
    klee_make_symbolic(&rxd_size, sizeof(int), "rxd_size");
...
struct mwl8k_priv {
   ...
   int fw_mutex_depth ;
    klee_make_symbolic(&fw_mutex_depth, sizeof(int), "fw_mutex_depth");
   ...
   u32 fw_rev ;
   int pending_tx_pkts ;
    klee_make_symbolic(&pending_tx_pkts, sizeof(int), "pending_tx_pkts");
   ...
   unsigned int fw_state ;
    klee_make_symbolic(&fw_state, sizeof(int), "fw_state");
   char *fw_pref ;
   char *fw_alt ;
...
struct mwl8k_vif {
   ...
   struct ieee80211_vif *vif ;
   int macid ;
    klee_make_symbolic(&macid, sizeof(int), "macid");
   u16 seqno ;
...
{ 
  ...
  int may_continue ;
    klee_make_symbolic(&may_continue, sizeof(int), "may_continue");
  int rc ;
  u32 done ;
  u32 prev_block_size ;
  void *tmp ;
...
{ 
  ...
  int hdrlen ;
  int reqd_hdrlen ;
    klee_make_symbolic(&reqd_hdrlen, sizeof(int), "reqd_hdrlen");
  struct mwl8k_dma_data *tr ;
  unsigned int tmp ;
  int tmp___0 ;
  int tmp___1 ;
...
{ 
  ...
  int head_pad ;
    klee_make_symbolic(&head_pad, sizeof(int), "head_pad");
  int tmp ;
...
{ 
  ...
  void *rxd ;
  int nexti ;
    klee_make_symbolic(&nexti, sizeof(int), "nexti");
...
{ 
  ...
  struct mwl8k_tx_queue *txq ;
  int fw_owned ;
    klee_make_symbolic(&fw_owned, sizeof(int), "fw_owned");
  int drv_owned ;
    klee_make_symbolic(&drv_owned, sizeof(int), "drv_owned");
  int unused ;
...
{ 
  ...
  int oldcount ;
    klee_make_symbolic(&oldcount, sizeof(int), "oldcount");
  unsigned long timeout ;
...
{ 
  ...
  u16 qos ;
  int txpriority ;
    klee_make_symbolic(&txpriority, sizeof(int), "txpriority");
  u8 tid ;
  struct mwl8k_ampdu_stream *stream ;
...
{ 
  ...
  int mac_type ;
    klee_make_symbolic(&mac_type, sizeof(int), "mac_type");
  int rc ;
  int tmp ;
  int tmp___0 ;
  void *tmp___1 ;
...
{ 
  ...
  int rc ;
  int keymlen ;
    klee_make_symbolic(&keymlen, sizeof(int), "keymlen");
  u32 action ;
  u8 idx ;
  struct mwl8k_vif *mwl8k_vif ;
  void *tmp ;
...
{ 
  ...
  int var_mwl8k_rxd_8366_ap_refill_14_p2 ;
    klee_make_symbolic(&var_mwl8k_rxd_8366_ap_refill_14_p2, sizeof(int), "var_mwl8k_rxd_8366_ap_refill_14_p2");
  ...
  int var_mwl8k_rxd_sta_refill_17_p2 ;
    klee_make_symbolic(&var_mwl8k_rxd_sta_refill_17_p2, sizeof(int), "var_mwl8k_rxd_sta_refill_17_p2");
  ...
  unsigned int var_mwl8k_configure_filter_113_p1 ;
    klee_make_symbolic(&var_mwl8k_configure_filter_113_p1, sizeof(int), "var_mwl8k_configure_filter_113_p1");
  ...
  int var_mwl8k_get_survey_119_p1 ;
    klee_make_symbolic(&var_mwl8k_get_survey_119_p1, sizeof(int), "var_mwl8k_get_survey_119_p1");
  ...
  int res_mwl8k_probe_129 ;
    klee_make_symbolic(&res_mwl8k_probe_129, sizeof(int), "res_mwl8k_probe_129");
  int var_mwl8k_interrupt_96_p0 ;
    klee_make_symbolic(&var_mwl8k_interrupt_96_p0, sizeof(int), "var_mwl8k_interrupt_96_p0");
  void *var_mwl8k_interrupt_96_p1 ;
  int ldv_s_mwl8k_driver_pci_driver ;
    klee_make_symbolic(&ldv_s_mwl8k_driver_pci_driver, sizeof(int), "ldv_s_mwl8k_driver_pci_driver");
  int tmp ;
  int tmp___0 ;
...
static int ldv_mutex_fw_mutex  ;
    klee_make_symbolic(&ldv_mutex_fw_mutex, sizeof(int), "ldv_mutex_fw_mutex");
