...
{ int s__info_callback  = __VERIFIER_nondet_int();
  ...
  int s__ctx__stats__sess_connect_renegotiate ;
    klee_make_symbolic(&s__ctx__stats__sess_connect_renegotiate, sizeof(int), "s__ctx__stats__sess_connect_renegotiate");
  ...
  unsigned int ag_V ;
    klee_make_symbolic(&ag_V, sizeof(int), "ag_V");
  unsigned int ag_W ;
    klee_make_symbolic(&ag_W, sizeof(int), "ag_W");
  int __retres62 ;
    klee_make_symbolic(&__retres62, sizeof(int), "__retres62");
