...
{ int s__info_callback  = __VERIFIER_nondet_int();
  ...
  int s__init_buf___0 ;
    klee_make_symbolic(&s__init_buf___0, sizeof(int), "s__init_buf___0");
  ...
  int s__ctx__stats__sess_accept_renegotiate ;
    klee_make_symbolic(&s__ctx__stats__sess_accept_renegotiate, sizeof(int), "s__ctx__stats__sess_accept_renegotiate");
  int s__ctx__stats__sess_accept ;
    klee_make_symbolic(&s__ctx__stats__sess_accept, sizeof(int), "s__ctx__stats__sess_accept");
  ...
  int ag_Y ;
    klee_make_symbolic(&ag_Y, sizeof(int), "ag_Y");
  int __retres69 ;
    klee_make_symbolic(&__retres69, sizeof(int), "__retres69");
