...
struct Cell {
    Cell *pnext;
    int pdata;
    klee_make_symbolic(&pdata, sizeof(int), "pdata");
};
...
int collision;
    klee_make_symbolic(&collision, sizeof(int), "collision");
...
int allocated[4];
    klee_make_symbolic(allocated, sizeof(int)*4, "allocated");
...
int PushOpen[2];
    klee_make_symbolic(PushOpen, sizeof(int)*2, "PushOpen");
int PushDone[2];
    klee_make_symbolic(PushDone, sizeof(int)*2, "PushDone");
int PopOpen;
    klee_make_symbolic(&PopOpen, sizeof(int), "PopOpen");
int PopDone[3];
    klee_make_symbolic(PopDone, sizeof(int)*3, "PopDone");
