...
typedef int __int32_t;
    klee_make_symbolic(&__int32_t, sizeof(int), "__int32_t");
typedef unsigned int __uint32_t;
    klee_make_symbolic(&__uint32_t, sizeof(int), "__uint32_t");

typedef union {
  double value;
    klee_make_symbolic(&value, sizeof(double), "value");
  struct {
    __uint32_t lsw;
    __uint32_t msw;
  } parts;
...
double trunc_double(double x) {
  int signbit;
    klee_make_symbolic(&signbit, sizeof(int), "signbit");
  int msw;
    klee_make_symbolic(&msw, sizeof(int), "msw");
  unsigned int lsw;
    klee_make_symbolic(&lsw, sizeof(int), "lsw");
  int exponent_less_1023;
    klee_make_symbolic(&exponent_less_1023, sizeof(int), "exponent_less_1023");
  do {
