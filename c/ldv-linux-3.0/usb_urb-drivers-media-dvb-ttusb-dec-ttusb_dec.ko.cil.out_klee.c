...
struct input_dev {
   ...
   unsigned int hint_events_per_packet ;
    klee_make_symbolic(&hint_events_per_packet, sizeof(int), "hint_events_per_packet");
   unsigned int keycodemax ;
    klee_make_symbolic(&keycodemax, sizeof(int), "keycodemax");
   unsigned int keycodesize ;
    klee_make_symbolic(&keycodesize, sizeof(int), "keycodesize");
   void *keycode ;
   ...
   unsigned int repeat_key ;
    klee_make_symbolic(&repeat_key, sizeof(int), "repeat_key");
   struct timer_list timer ;
   int rep[2] ;
   struct input_mt_slot *mt ;
   int mtsize ;
    klee_make_symbolic(&mtsize, sizeof(int), "mtsize");
   int slot ;
    klee_make_symbolic(&slot, sizeof(int), "slot");
   int trkid ;
    klee_make_symbolic(&trkid, sizeof(int), "trkid");
...
struct ff_device {
   ...
   struct mutex mutex ;
   int max_effects ;
    klee_make_symbolic(&max_effects, sizeof(int), "max_effects");
...
struct dmx_caps {
   __u32 caps ;
   int num_decoders ;
    klee_make_symbolic(&num_decoders, sizeof(int), "num_decoders");
};
...
struct dmx_ts_feed {
   int is_filtering ;
    klee_make_symbolic(&is_filtering, sizeof(int), "is_filtering");
...
struct dmx_section_feed {
   ...
   void *priv ;
   int check_crc ;
    klee_make_symbolic(&check_crc, sizeof(int), "check_crc");
   u32 crc_val ;
   u8 *secbuf ;
   u8 secbuf_base[4284] ;
   u16 secbufp ;
...
struct dmxdev_filter {
   ...
   struct timer_list timer ;
   int todo ;
    klee_make_symbolic(&todo, sizeof(int), "todo");
   u8 secheader[3] ;
};
struct dmxdev {
   ...
   int filternum ;
    klee_make_symbolic(&filternum, sizeof(int), "filternum");
   int capabilities ;
...
struct dvb_demux_filter {
   ...
   int doneq ;
    klee_make_symbolic(&doneq, sizeof(int), "doneq");
...
struct dvb_demux_feed {
   ...
   int ts_type ;
    klee_make_symbolic(&ts_type, sizeof(int), "ts_type");
   enum dmx_ts_pes pes_type ;
   int cc ;
    klee_make_symbolic(&cc, sizeof(int), "cc");
   int pusi_seen ;
    klee_make_symbolic(&pusi_seen, sizeof(int), "pusi_seen");
   u16 peslen ;
   struct list_head list_head ;
   unsigned int index ;
};
struct dvb_demux {
   ...
   int filternum ;
   int feednum ;
    klee_make_symbolic(&feednum, sizeof(int), "feednum");
   ...
   u16 pids[20] ;
   int playing ;
    klee_make_symbolic(&playing, sizeof(int), "playing");
   int recording ;
    klee_make_symbolic(&recording, sizeof(int), "recording");
   struct list_head feed_list ;
   u8 tsbuf[204] ;
   int tsbufp ;
    klee_make_symbolic(&tsbufp, sizeof(int), "tsbufp");
   struct mutex mutex ;
   spinlock_t lock ;
   uint8_t *cnt_storage ;
...
struct in_device {
   ...
   unsigned long mr_v1_seen ;
    klee_make_symbolic(&mr_v1_seen, sizeof(long), "mr_v1_seen");
   unsigned long mr_v2_seen ;
    klee_make_symbolic(&mr_v2_seen, sizeof(long), "mr_v2_seen");
   unsigned long mr_maxdelay ;
    klee_make_symbolic(&mr_maxdelay, sizeof(long), "mr_maxdelay");
   unsigned char mr_qrv ;
    klee_make_symbolic(&mr_qrv, sizeof(char), "mr_qrv");
   unsigned char mr_gq_running ;
    klee_make_symbolic(&mr_gq_running, sizeof(char), "mr_gq_running");
   unsigned char mr_ifc_count ;
    klee_make_symbolic(&mr_ifc_count, sizeof(char), "mr_ifc_count");
...
struct in_ifaddr {
   ...
   unsigned char ifa_scope ;
    klee_make_symbolic(&ifa_scope, sizeof(char), "ifa_scope");
   unsigned char ifa_flags ;
    klee_make_symbolic(&ifa_flags, sizeof(char), "ifa_flags");
   unsigned char ifa_prefixlen ;
    klee_make_symbolic(&ifa_prefixlen, sizeof(char), "ifa_prefixlen");
   char ifa_label[16] ;
};
struct dvb_net {
   struct dvb_device *dvbdev ;
...
struct ttusb_dec {
   ...
   char *firmware_name ;
   int can_playback ;
    klee_make_symbolic(&can_playback, sizeof(int), "can_playback");
   struct dvb_adapter adapter ;
   ...
   unsigned int command_pipe ;
    klee_make_symbolic(&command_pipe, sizeof(int), "command_pipe");
   unsigned int result_pipe ;
    klee_make_symbolic(&result_pipe, sizeof(int), "result_pipe");
   unsigned int in_pipe ;
    klee_make_symbolic(&in_pipe, sizeof(int), "in_pipe");
   unsigned int out_pipe ;
    klee_make_symbolic(&out_pipe, sizeof(int), "out_pipe");
   unsigned int irq_pipe ;
    klee_make_symbolic(&irq_pipe, sizeof(int), "irq_pipe");
   ...
   int iso_stream_count ;
    klee_make_symbolic(&iso_stream_count, sizeof(int), "iso_stream_count");
   struct mutex iso_mutex ;
   u8 packet[6148] ;
   enum ttusb_dec_packet_type packet_type ;
   int packet_state ;
    klee_make_symbolic(&packet_state, sizeof(int), "packet_state");
   int packet_length ;
    klee_make_symbolic(&packet_length, sizeof(int), "packet_length");
   int packet_payload_length ;
    klee_make_symbolic(&packet_payload_length, sizeof(int), "packet_payload_length");
   u16 next_packet_id ;
   int pva_stream_count ;
    klee_make_symbolic(&pva_stream_count, sizeof(int), "pva_stream_count");
   int filter_stream_count ;
    klee_make_symbolic(&filter_stream_count, sizeof(int), "filter_stream_count");
   struct dvb_filter_pes2ts a_pes2ts ;
   struct dvb_filter_pes2ts v_pes2ts ;
   u8 v_pes[6160] ;
   int v_pes_length ;
    klee_make_symbolic(&v_pes_length, sizeof(int), "v_pes_length");
   int v_pes_postbytes ;
    klee_make_symbolic(&v_pes_postbytes, sizeof(int), "v_pes_postbytes");
...
static int output_pva ;
    klee_make_symbolic(&output_pva, sizeof(int), "output_pva");
static int enable_rc ;
    klee_make_symbolic(&enable_rc, sizeof(int), "enable_rc");
...
{ int result ;
  int actual_len ;
    klee_make_symbolic(&actual_len, sizeof(int), "actual_len");
  int i ;
...
{ u8 c[60] ;
  int c_length ;
    klee_make_symbolic(&c_length, sizeof(int), "c_length");
  int result ;
  __be32 tmp___7 ;
  size_t __len ;
  void *__ret ;
...
{ int prebytes ;
    klee_make_symbolic(&prebytes, sizeof(int), "prebytes");
  int postbytes ;
    klee_make_symbolic(&postbytes, sizeof(int), "postbytes");
...
{ u8 *tmp___7 ;
  ...
  u8 *tmp___11 ;
  int remainder ;
    klee_make_symbolic(&remainder, sizeof(int), "remainder");
  size_t __len ;
  void *__ret ;
  size_t __len___0 ;
  void *__ret___0 ;
...
{ int i ;
  ...
  int buffer_offset ;
    klee_make_symbolic(&buffer_offset, sizeof(int), "buffer_offset");
  int frame_offset ;
    klee_make_symbolic(&frame_offset, sizeof(int), "frame_offset");
  struct urb *urb ;
...
{ int i ;
  ...
  int size ;
  int trans_count ;
    klee_make_symbolic(&trans_count, sizeof(int), "trans_count");
  u8 b0[10] ;
  u8 b1[1] ;
  u8 *b ;
  char idstring[21] ;
...
{ int result ;
  unsigned int mode ;
  unsigned int model ;
    klee_make_symbolic(&model, sizeof(int), "model");
  unsigned int version ;
...
static int res_ttusb_dec_probe_38 ;
    klee_make_symbolic(&res_ttusb_dec_probe_38, sizeof(int), "res_ttusb_dec_probe_38");
int main(void)
{ struct usb_interface *var_group1 ;
  struct usb_device_id const *var_ttusb_dec_probe_38_p1 ;
  int tmp___7 ;
  int ldv_s_ttusb_dec_driver_usb_driver ;
    klee_make_symbolic(&ldv_s_ttusb_dec_driver_usb_driver, sizeof(int), "ldv_s_ttusb_dec_driver_usb_driver");
  int tmp___8 ;
  int tmp___9 ;
