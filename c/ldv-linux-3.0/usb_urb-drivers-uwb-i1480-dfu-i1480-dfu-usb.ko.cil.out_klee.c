...
{ int result ;
  unsigned int hdr_cnt ;
    klee_make_symbolic(&hdr_cnt, sizeof(int), "hdr_cnt");
  u32 *data ;
  u32 *data_itr ;
  u32 *data_top ;
  struct fw_hdr *hdr ;
...
{ struct device *dev ;
  ...
  int verif_retry_count ;
    klee_make_symbolic(&verif_retry_count, sizeof(int), "verif_retry_count");
  long tmp ;
  int tmp___0 ;
...
{ int result ;
  int deprecated_name ;
    klee_make_symbolic(&deprecated_name, sizeof(int), "deprecated_name");
...
static int res_i1480_usb_probe_8 ;
    klee_make_symbolic(&res_i1480_usb_probe_8, sizeof(int), "res_i1480_usb_probe_8");
int main(void)
{ struct usb_interface *var_group1 ;
  struct usb_device_id const *var_i1480_usb_probe_8_p1 ;
  int tmp___7 ;
  int ldv_s_i1480_dfu_driver_usb_driver ;
    klee_make_symbolic(&ldv_s_i1480_dfu_driver_usb_driver, sizeof(int), "ldv_s_i1480_dfu_driver_usb_driver");
  int tmp___8 ;
  int tmp___9 ;
