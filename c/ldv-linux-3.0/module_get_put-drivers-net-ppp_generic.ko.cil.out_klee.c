...
struct idr_layer {
   unsigned long bitmap ;
    klee_make_symbolic(&bitmap, sizeof(long), "bitmap");
...
struct ppp_option_data {
   ...
   __u32 length ;
   int transmit ;
    klee_make_symbolic(&transmit, sizeof(int), "transmit");
};
struct ppp_channel;
struct ppp_channel;
struct ppp_channel;
...
struct compressor {
   int compress_proto ;
    klee_make_symbolic(&compress_proto, sizeof(int), "compress_proto");
   ...
   unsigned int comp_extra ;
    klee_make_symbolic(&comp_extra, sizeof(int), "comp_extra");
};
struct iphdr {
   unsigned char ihl : 4 ;
...
struct cstate {
   ...
   int cs_hsize ;
    klee_make_symbolic(&cs_hsize, sizeof(int), "cs_hsize");
};
struct slcompress {
...
struct ppp {
   ...
   spinlock_t wlock ;
   int mru ;
    klee_make_symbolic(&mru, sizeof(int), "mru");
   unsigned int flags ;
   unsigned int xstate ;
    klee_make_symbolic(&xstate, sizeof(int), "xstate");
   unsigned int rstate ;
    klee_make_symbolic(&rstate, sizeof(int), "rstate");
   int debug ;
   ...
   unsigned long last_xmit ;
    klee_make_symbolic(&last_xmit, sizeof(long), "last_xmit");
   unsigned long last_recv ;
    klee_make_symbolic(&last_recv, sizeof(long), "last_recv");
   struct net_device *dev ;
   int closing ;
    klee_make_symbolic(&closing, sizeof(int), "closing");
   int nxchan ;
    klee_make_symbolic(&nxchan, sizeof(int), "nxchan");
   u32 nxseq ;
   int mrru ;
    klee_make_symbolic(&mrru, sizeof(int), "mrru");
   u32 nextseq ;
   u32 minseq ;
   ...
   unsigned int pass_len ;
    klee_make_symbolic(&pass_len, sizeof(int), "pass_len");
   unsigned int active_len ;
    klee_make_symbolic(&active_len, sizeof(int), "active_len");
   struct net *ppp_net ;
};
struct channel {
   struct ppp_file file ;
...
struct ppp_net {
   ...
   int last_channel_index ;
    klee_make_symbolic(&last_channel_index, sizeof(int), "last_channel_index");
...
{ int delta ;
  ...
  int _max2___2 ;
    klee_make_symbolic(&_max2___2, sizeof(int), "_max2___2");
  int tmp___4 ;
...
static int ppp_net_id ;
    klee_make_symbolic(&ppp_net_id, sizeof(int), "ppp_net_id");
...
{ struct ppp_file *pf ;
  ...
  int cflags ;
    klee_make_symbolic(&cflags, sizeof(int), "cflags");
  struct slcompress *vj ;
  void *argp ;
  int *p ;
  struct task_struct *tmp ;
  ...
  int tmp___3 ;
  int __ret_gu___3 ;
    klee_make_symbolic(&__ret_gu___3, sizeof(int), "__ret_gu___3");
  unsigned long __val_gu___3 ;
    klee_make_symbolic(&__val_gu___3, sizeof(long), "__val_gu___3");
  unsigned long tmp___4 ;
  int tmp___5 ;
  struct sock_filter *code ;
  struct sock_filter *code___0 ;
  int __ret_gu___4 ;
    klee_make_symbolic(&__ret_gu___4, sizeof(int), "__ret_gu___4");
  unsigned long __val_gu___4 ;
    klee_make_symbolic(&__val_gu___4, sizeof(long), "__val_gu___4");
...
{ struct ppp *ppp ;
  void *tmp ;
  int npi ;
    klee_make_symbolic(&npi, sizeof(int), "npi");
  int proto ;
...
{ struct sk_buff *new_skb ;
  int len ;
  int new_skb_size ;
    klee_make_symbolic(&new_skb_size, sizeof(int), "new_skb_size");
  int compressor_skb_size ;
    klee_make_symbolic(&compressor_skb_size, sizeof(int), "compressor_skb_size");
  int tmp ;
  int tmp___0 ;
...
{ int len ;
  ...
  int mtu ;
  int flen ;
    klee_make_symbolic(&flen, sizeof(int), "flen");
  int navail ;
    klee_make_symbolic(&navail, sizeof(int), "navail");
  int nfree ;
    klee_make_symbolic(&nfree, sizeof(int), "nfree");
  int nzero ;
    klee_make_symbolic(&nzero, sizeof(int), "nzero");
  int nbigger ;
    klee_make_symbolic(&nbigger, sizeof(int), "nbigger");
  int totspeed ;
    klee_make_symbolic(&totspeed, sizeof(int), "totspeed");
  int totfree ;
    klee_make_symbolic(&totfree, sizeof(int), "totfree");
  unsigned char *p ;
  unsigned char *q ;
  struct list_head *list ;
  struct channel *pch ;
...
{ int proto ;
  ...
  int tmp___0 ;
  int obuff_size ;
    klee_make_symbolic(&obuff_size, sizeof(int), "obuff_size");
...
{ u32 mask ;
  ...
  struct channel *ch ;
  int mphdrlen ;
    klee_make_symbolic(&mphdrlen, sizeof(int), "mphdrlen");
  int tmp ;
  int tmp___0 ;
...
{ u32 seq ;
  ...
  struct sk_buff *skb ;
  int lost ;
    klee_make_symbolic(&lost, sizeof(int), "lost");
  int len ;
  struct sk_buff *tmp2 ;
...
{ struct file *var_group1 ;
  ...
  unsigned int var_ppp_ioctl_9_p1 ;
    klee_make_symbolic(&var_ppp_ioctl_9_p1, sizeof(int), "var_ppp_ioctl_9_p1");
  unsigned long var_ppp_ioctl_9_p2 ;
    klee_make_symbolic(&var_ppp_ioctl_9_p2, sizeof(long), "var_ppp_ioctl_9_p2");
  struct inode *var_group2 ;
  int res_ppp_open_3 ;
    klee_make_symbolic(&res_ppp_open_3, sizeof(int), "res_ppp_open_3");
  ...
  int var_ppp_net_ioctl_15_p2 ;
    klee_make_symbolic(&var_ppp_net_ioctl_15_p2, sizeof(int), "var_ppp_net_ioctl_15_p2");
  int ldv_s_ppp_device_fops_file_operations ;
    klee_make_symbolic(&ldv_s_ppp_device_fops_file_operations, sizeof(int), "ldv_s_ppp_device_fops_file_operations");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
