...
struct catc {
   ...
   unsigned long flags ;
   unsigned int tx_ptr ;
    klee_make_symbolic(&tx_ptr, sizeof(int), "tx_ptr");
   unsigned int tx_idx ;
    klee_make_symbolic(&tx_idx, sizeof(int), "tx_idx");
   unsigned int ctrl_head ;
    klee_make_symbolic(&ctrl_head, sizeof(int), "ctrl_head");
   unsigned int ctrl_tail ;
    klee_make_symbolic(&ctrl_tail, sizeof(int), "ctrl_tail");
   spinlock_t tx_lock ;
   ...
   unsigned long last_stats ;
    klee_make_symbolic(&last_stats, sizeof(long), "last_stats");
   u8 multicast[64] ;
...
{ struct catc *catc ;
  ...
  struct sk_buff *skb ;
  int pkt_len ;
    klee_make_symbolic(&pkt_len, sizeof(int), "pkt_len");
  int pkt_offset ;
...
{ struct catc *catc ;
  ...
  unsigned int hasdata ;
    klee_make_symbolic(&hasdata, sizeof(int), "hasdata");
  unsigned int linksts ;
    klee_make_symbolic(&linksts, sizeof(int), "linksts");
  int res ;
...
{ struct usb_device *usbdev ;
  ...
  int i ;
  int pktsz ;
    klee_make_symbolic(&pktsz, sizeof(int), "pktsz");
  int tmp___8 ;
  void *tmp___9 ;
...
static int res_catc_open_15 ;
    klee_make_symbolic(&res_catc_open_15, sizeof(int), "res_catc_open_15");
static int res_catc_stop_16 ;
    klee_make_symbolic(&res_catc_stop_16, sizeof(int), "res_catc_stop_16");
static int res_catc_probe_17 ;
    klee_make_symbolic(&res_catc_probe_17, sizeof(int), "res_catc_probe_17");
int main(void)
{ struct net_device *var_group1 ;
  ...
  unsigned long var_catc_stats_timer_10_p0 ;
    klee_make_symbolic(&var_catc_stats_timer_10_p0, sizeof(long), "var_catc_stats_timer_10_p0");
  int tmp___7 ;
  int ldv_s_catc_netdev_ops_net_device_ops ;
    klee_make_symbolic(&ldv_s_catc_netdev_ops_net_device_ops, sizeof(int), "ldv_s_catc_netdev_ops_net_device_ops");
  int ldv_s_catc_driver_usb_driver ;
    klee_make_symbolic(&ldv_s_catc_driver_usb_driver, sizeof(int), "ldv_s_catc_driver_usb_driver");
  int tmp___8 ;
  int tmp___9 ;
