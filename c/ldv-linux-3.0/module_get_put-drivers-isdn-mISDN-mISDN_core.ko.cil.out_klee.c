...
struct sockaddr_mISDN {
   sa_family_t family ;
   unsigned char dev ;
    klee_make_symbolic(&dev, sizeof(char), "dev");
   unsigned char channel ;
    klee_make_symbolic(&channel, sizeof(char), "channel");
   unsigned char sapi ;
    klee_make_symbolic(&sapi, sizeof(char), "sapi");
   unsigned char tei ;
    klee_make_symbolic(&tei, sizeof(char), "tei");
};
...
struct channel_req {
   u_int protocol ;
    klee_make_symbolic(&protocol, sizeof(int), "protocol");
...
struct Bprotocol {
   ...
   char *name ;
   u_int Bprotocols ;
    klee_make_symbolic(&Bprotocols, sizeof(int), "Bprotocols");
...
struct mISDNchannel {
   ...
   u_int nr ;
   u_long opt ;
    klee_make_symbolic(&opt, sizeof(long), "opt");
   u_int addr ;
...
struct mISDNdevice {
   ...
   u_int Dprotocols ;
    klee_make_symbolic(&Dprotocols, sizeof(int), "Dprotocols");
   u_int Bprotocols ;
   u_int nrbchan ;
    klee_make_symbolic(&nrbchan, sizeof(int), "nrbchan");
...
struct FsmInst {
   ...
   void *userdata ;
   int userint ;
    klee_make_symbolic(&userint, sizeof(int), "userint");
...
typedef long __kernel_suseconds_t;
    klee_make_symbolic(&__kernel_suseconds_t, sizeof(long), "__kernel_suseconds_t");
struct timeval {
   __kernel_time_t tv_sec ;
...
struct mISDNhead {
   unsigned int prim ;
    klee_make_symbolic(&prim, sizeof(int), "prim");
   unsigned int id ;
};
struct mISDNversion {
   unsigned char major ;
    klee_make_symbolic(&major, sizeof(char), "major");
   unsigned char minor ;
    klee_make_symbolic(&minor, sizeof(char), "minor");
   unsigned short release ;
    klee_make_symbolic(&release, sizeof(short), "release");
};
...
struct mISDN_ctrl_req {
   int op ;
    klee_make_symbolic(&op, sizeof(int), "op");
   int channel ;
   int p1 ;
...
struct mISDN_sock {
   ...
   struct mISDNchannel ch ;
   u_int cmask ;
    klee_make_symbolic(&cmask, sizeof(int), "cmask");
   struct mISDNdevice *dev ;
};
struct mISDNclock;
...
struct mISDNclock {
   ...
   char name[64U] ;
   int pri ;
    klee_make_symbolic(&pri, sizeof(int), "pri");
   clockctl_func_t *ctl ;
   void *priv ;
};
enum hrtimer_restart;
...
struct dchannel {
   ...
   int tx_idx ;
    klee_make_symbolic(&tx_idx, sizeof(int), "tx_idx");
   int debug ;
   int err_crc ;
    klee_make_symbolic(&err_crc, sizeof(int), "err_crc");
   int err_tx ;
    klee_make_symbolic(&err_tx, sizeof(int), "err_tx");
   int err_rx ;
    klee_make_symbolic(&err_rx, sizeof(int), "err_rx");
};
struct bchannel {
   struct mISDNchannel ch ;
   int nr ;
   ...
   struct sk_buff_head rqueue ;
   int rcount ;
    klee_make_symbolic(&rcount, sizeof(int), "rcount");
   int tx_idx ;
   int debug ;
   int err_crc ;
   int err_tx ;
...
struct manager {
   ...
   u_long options ;
    klee_make_symbolic(&options, sizeof(long), "options");
   struct list_head layer2 ;
   rwlock_t lock ;
   ...
   u_int nextid ;
    klee_make_symbolic(&nextid, sizeof(int), "nextid");
   u_int lastid ;
    klee_make_symbolic(&lastid, sizeof(int), "lastid");
};
struct layer2;
struct teimgr {
   int ri ;
   ...
   int rcnt ;
    klee_make_symbolic(&rcnt, sizeof(int), "rcnt");
   struct FsmInst tei_m ;
   struct FsmTimer timer ;
   int tval ;
    klee_make_symbolic(&tval, sizeof(int), "tval");
   int nval ;
    klee_make_symbolic(&nval, sizeof(int), "nval");
   struct layer2 *l2 ;
   struct manager *mgr ;
};
struct laddr {
...
struct layer2 {
   ...
   struct teimgr *tm ;
   u_int vs ;
    klee_make_symbolic(&vs, sizeof(int), "vs");
   u_int va ;
    klee_make_symbolic(&va, sizeof(int), "va");
   u_int vr ;
    klee_make_symbolic(&vr, sizeof(int), "vr");
   int rc ;
    klee_make_symbolic(&rc, sizeof(int), "rc");
   u_int window ;
    klee_make_symbolic(&window, sizeof(int), "window");
   u_int sow ;
    klee_make_symbolic(&sow, sizeof(int), "sow");
   struct FsmInst l2m ;
   struct FsmTimer t200 ;
   struct FsmTimer t203 ;
   int T200 ;
    klee_make_symbolic(&T200, sizeof(int), "T200");
   int N200 ;
    klee_make_symbolic(&N200, sizeof(int), "N200");
   int T203 ;
    klee_make_symbolic(&T203, sizeof(int), "T203");
   u_int next_id ;
    klee_make_symbolic(&next_id, sizeof(int), "next_id");
   u_int down_id ;
    klee_make_symbolic(&down_id, sizeof(int), "down_id");
...
struct mISDNtimerdev {
   ...
   wait_queue_head_t wait ;
   u_int work ;
    klee_make_symbolic(&work, sizeof(int), "work");
   spinlock_t lock ;
};
struct mISDNtimer {
   struct list_head list ;
...
static int iclock_tv_valid ;
    klee_make_symbolic(&iclock_tv_valid, sizeof(int), "iclock_tv_valid");
...
{ u_long flags ;
  ...
  time_t elapsed_sec ;
  int elapsed_8000th ;
    klee_make_symbolic(&elapsed_8000th, sizeof(int), "elapsed_8000th");
  char *tmp ;
  char *tmp___0 ;
...
{ struct mISDNhead *hh ;
  struct mISDNchannel *ch ;
  int lm ;
    klee_make_symbolic(&lm, sizeof(int), "lm");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
  int tmp___2 ;
...
{ struct channel_req rq ;
  ...
  int pmask ;
    klee_make_symbolic(&pmask, sizeof(int), "pmask");
  int err ;
  struct Bprotocol *bp ;
  char const *tmp ;
...
{ u_char *ptr ;
  int crbit ;
    klee_make_symbolic(&crbit, sizeof(int), "crbit");
  int tmp ;
  u_char *tmp___0 ;
  int tmp___1 ;
  u_char *tmp___2 ;
...
{ u_int i ;
  int rsp ;
    klee_make_symbolic(&rsp, sizeof(int), "rsp");
  u_int tmp ;
...
{ u_int headers ;
    klee_make_symbolic(&headers, sizeof(int), "headers");
  u_int tmp ;
  u_char *datap ;
  int rsp ;
  int tmp___0 ;
...
{ u_char PF ;
    klee_make_symbolic(&PF, sizeof(char), "PF");
...
{ int pr ;
    klee_make_symbolic(&pr, sizeof(int), "pr");
  int tmp ;
...
{ struct layer2 *l2 ;
  struct sk_buff *skb ;
  int est ;
    klee_make_symbolic(&est, sizeof(int), "est");
  u_char tmp ;
  __u32 tmp___0 ;
  unsigned int tmp___1 ;
...
{ struct layer2 *l2 ;
  struct sk_buff *skb ;
  int PollFlag ;
    klee_make_symbolic(&PollFlag, sizeof(int), "PollFlag");
  int rsp ;
  int typ ;
    klee_make_symbolic(&typ, sizeof(int), "typ");
  unsigned int nr ;
  int tmp ;
  u_int tmp___0 ;
  int tmp___1 ;
...
{ struct layer2 *l2 ;
  ...
  int i ;
  u_int ns ;
    klee_make_symbolic(&ns, sizeof(int), "ns");
  u_int nr ;
  u_int tmp ;
  int tmp___0 ;
  int tmp___1 ;
...
{ struct layer2 *l2 ;
  u_int info ;
    klee_make_symbolic(&info, sizeof(int), "info");
  __u32 tmp ;
...
{ struct layer2 *l2 ;
  ...
  int rsp ;
  int rnr ;
    klee_make_symbolic(&rnr, sizeof(int), "rnr");
  unsigned int nr ;
  int tmp ;
  u_int tmp___0 ;
  int tmp___1 ;
...
{ u_char *datap ;
  int ret ;
  int psapi ;
    klee_make_symbolic(&psapi, sizeof(int), "psapi");
  int ptei ;
    klee_make_symbolic(&ptei, sizeof(int), "ptei");
  u_int l ;
...
{ int ret ;
  ...
  struct layer2 *nl2 ;
  u_char mt ;
    klee_make_symbolic(&mt, sizeof(char), "mt");
  int tmp ;
  int tmp___0 ;
  struct list_head const *__mptr ;
  struct list_head const *__mptr___0 ;
...
{ struct mISDNtimerdev *dev ;
  int id ;
  int tout ;
    klee_make_symbolic(&tout, sizeof(int), "tout");
  int ret ;
  int __ret_gu ;
  unsigned long __val_gu ;
  int __ret_pu ;
...
{ struct file *var_group1 ;
  ...
  unsigned int var_mISDN_ioctl_7_p1 ;
    klee_make_symbolic(&var_mISDN_ioctl_7_p1, sizeof(int), "var_mISDN_ioctl_7_p1");
  unsigned long var_mISDN_ioctl_7_p2 ;
    klee_make_symbolic(&var_mISDN_ioctl_7_p2, sizeof(long), "var_mISDN_ioctl_7_p2");
  struct inode *var_group2 ;
  int res_mISDN_open_0 ;
    klee_make_symbolic(&res_mISDN_open_0, sizeof(int), "res_mISDN_open_0");
  unsigned long var_dev_expire_timer_4_p0 ;
    klee_make_symbolic(&var_dev_expire_timer_4_p0, sizeof(long), "var_dev_expire_timer_4_p0");
  int ldv_s_mISDN_fops_file_operations ;
    klee_make_symbolic(&ldv_s_mISDN_fops_file_operations, sizeof(int), "ldv_s_mISDN_fops_file_operations");
  int tmp ;
  int tmp___0 ;
