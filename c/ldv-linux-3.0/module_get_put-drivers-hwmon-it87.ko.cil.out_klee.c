...
struct it87_data {
   ...
   char valid ;
    klee_make_symbolic(&valid, sizeof(char), "valid");
   unsigned long last_updated ;
    klee_make_symbolic(&last_updated, sizeof(long), "last_updated");
   u16 in_scaled ;
   u8 in[9U] ;
   u8 in_max[8U] ;
   u8 in_min[8U] ;
...
static unsigned short force_id ;
    klee_make_symbolic(&force_id, sizeof(short), "force_id");
...
static int update_vbat ;
    klee_make_symbolic(&update_vbat, sizeof(int), "update_vbat");
static int fix_pwm_polarity ;
    klee_make_symbolic(&fix_pwm_polarity, sizeof(int), "fix_pwm_polarity");
...
{ long lsb ;
    klee_make_symbolic(&lsb, sizeof(long), "lsb");
  long __divisor ;
    klee_make_symbolic(&__divisor, sizeof(long), "__divisor");
  int tmp ;
...
{ int answer ;
    klee_make_symbolic(&answer, sizeof(int), "answer");
...
{ struct sensor_device_attribute *sensor_attr ;
  ...
  struct it87_data *tmp ;
  int map ;
    klee_make_symbolic(&map, sizeof(int), "map");
  int tmp___0 ;
...
{ struct it87_data *data ;
  ...
  int nr ;
  int point ;
    klee_make_symbolic(&point, sizeof(int), "point");
  int tmp___0 ;
  int tmp___1 ;
...
{ int bitnr ;
    klee_make_symbolic(&bitnr, sizeof(int), "bitnr");
  struct device_attribute const *__mptr ;
  struct it87_data *data ;
  struct it87_data *tmp ;
  int tmp___0 ;
...
{ struct it87_data *data ;
  ...
  int enable_pwm_interface ;
    klee_make_symbolic(&enable_pwm_interface, sizeof(int), "enable_pwm_interface");
  int fan_beep_need_rw ;
    klee_make_symbolic(&fan_beep_need_rw, sizeof(int), "fan_beep_need_rw");
  char const *names[6U] ;
  struct resource *tmp ;
  void *tmp___0 ;
  int tmp___1 ;
...
{ int err ;
  unsigned short isa_address ;
    klee_make_symbolic(&isa_address, sizeof(short), "isa_address");
  struct it87_sio_data sio_data ;
...
{ struct platform_device *var_group1 ;
  int res_it87_probe_61 ;
    klee_make_symbolic(&res_it87_probe_61, sizeof(int), "res_it87_probe_61");
  int ldv_s_it87_driver_platform_driver ;
    klee_make_symbolic(&ldv_s_it87_driver_platform_driver, sizeof(int), "ldv_s_it87_driver_platform_driver");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
