...
struct __anonstruct_mtrr_182 {
   int vram ;
    klee_make_symbolic(&vram, sizeof(int), "vram");
   int vram_valid ;
    klee_make_symbolic(&vram_valid, sizeof(int), "vram_valid");
};
struct aty128fb_par {
   ...
   u32 vram_size ;
   int chip_gen ;
    klee_make_symbolic(&chip_gen, sizeof(int), "chip_gen");
   struct aty128_meminfo const *mem ;
   struct __anonstruct_mtrr_182 mtrr ;
   int blitter_may_be_busy ;
    klee_make_symbolic(&blitter_may_be_busy, sizeof(int), "blitter_may_be_busy");
   int fifo_slots ;
    klee_make_symbolic(&fifo_slots, sizeof(int), "fifo_slots");
   int pm_reg ;
    klee_make_symbolic(&pm_reg, sizeof(int), "pm_reg");
   int crt_on ;
    klee_make_symbolic(&crt_on, sizeof(int), "crt_on");
   int lcd_on ;
    klee_make_symbolic(&lcd_on, sizeof(int), "lcd_on");
   struct pci_dev *pdev ;
   struct fb_info *next ;
   int asleep ;
    klee_make_symbolic(&asleep, sizeof(int), "asleep");
   int lock_blank ;
    klee_make_symbolic(&lock_blank, sizeof(int), "lock_blank");
   u8 red[32U] ;
   u8 green[64U] ;
   u8 blue[32U] ;
...
{ unsigned long timeout ;
  int reset ;
    klee_make_symbolic(&reset, sizeof(int), "reset");
  int tmp ;
...
{ u16 dptr ;
  ...
  unsigned char tmp___5 ;
    klee_make_symbolic(&tmp___5, sizeof(char), "tmp___5");
  unsigned char tmp___6 ;
    klee_make_symbolic(&tmp___6, sizeof(char), "tmp___6");
  unsigned char tmp___7 ;
    klee_make_symbolic(&tmp___7, sizeof(char), "tmp___7");
  unsigned char tmp___8 ;
    klee_make_symbolic(&tmp___8, sizeof(char), "tmp___8");
  unsigned char tmp___9 ;
    klee_make_symbolic(&tmp___9, sizeof(char), "tmp___9");
  unsigned char tmp___10 ;
    klee_make_symbolic(&tmp___10, sizeof(char), "tmp___10");
...
{ unsigned int bios_hdr ;
    klee_make_symbolic(&bios_hdr, sizeof(int), "bios_hdr");
  unsigned int bios_pll ;
    klee_make_symbolic(&bios_pll, sizeof(int), "bios_pll");
  unsigned char tmp ;
  unsigned char tmp___0 ;
  unsigned char tmp___1 ;
  unsigned char tmp___2 ;
  ...
  unsigned char tmp___14 ;
    klee_make_symbolic(&tmp___14, sizeof(char), "tmp___14");
  unsigned char tmp___15 ;
    klee_make_symbolic(&tmp___15, sizeof(char), "tmp___15");
  unsigned char tmp___16 ;
    klee_make_symbolic(&tmp___16, sizeof(char), "tmp___16");
...
{ struct fb_info *info ;
  void *tmp ;
  int atylevel ;
    klee_make_symbolic(&atylevel, sizeof(int), "atylevel");
...
{ unsigned long fb_addr ;
    klee_make_symbolic(&fb_addr, sizeof(long), "fb_addr");
...
{ struct pci_dev *var_group1 ;
  ...
  int res_aty128_probe_48 ;
    klee_make_symbolic(&res_aty128_probe_48, sizeof(int), "res_aty128_probe_48");
  ...
  u_int var_aty128fb_setcolreg_51_p0 ;
    klee_make_symbolic(&var_aty128fb_setcolreg_51_p0, sizeof(int), "var_aty128fb_setcolreg_51_p0");
  u_int var_aty128fb_setcolreg_51_p1 ;
    klee_make_symbolic(&var_aty128fb_setcolreg_51_p1, sizeof(int), "var_aty128fb_setcolreg_51_p1");
  u_int var_aty128fb_setcolreg_51_p2 ;
    klee_make_symbolic(&var_aty128fb_setcolreg_51_p2, sizeof(int), "var_aty128fb_setcolreg_51_p2");
  u_int var_aty128fb_setcolreg_51_p3 ;
    klee_make_symbolic(&var_aty128fb_setcolreg_51_p3, sizeof(int), "var_aty128fb_setcolreg_51_p3");
  u_int var_aty128fb_setcolreg_51_p4 ;
    klee_make_symbolic(&var_aty128fb_setcolreg_51_p4, sizeof(int), "var_aty128fb_setcolreg_51_p4");
  struct fb_info *var_aty128fb_setcolreg_51_p5 ;
  int var_aty128fb_blank_50_p0 ;
    klee_make_symbolic(&var_aty128fb_blank_50_p0, sizeof(int), "var_aty128fb_blank_50_p0");
  u_int var_aty128fb_ioctl_52_p1 ;
    klee_make_symbolic(&var_aty128fb_ioctl_52_p1, sizeof(int), "var_aty128fb_ioctl_52_p1");
  u_long var_aty128fb_ioctl_52_p2 ;
    klee_make_symbolic(&var_aty128fb_ioctl_52_p2, sizeof(long), "var_aty128fb_ioctl_52_p2");
  struct backlight_device *var_group4 ;
  int ldv_s_aty128fb_driver_pci_driver ;
    klee_make_symbolic(&ldv_s_aty128fb_driver_pci_driver, sizeof(int), "ldv_s_aty128fb_driver_pci_driver");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
