...
{ struct kbtab *kbtab ;
  ...
  struct input_dev *dev ;
  int pressure ;
    klee_make_symbolic(&pressure, sizeof(int), "pressure");
  int retval ;
...
static int res_kbtab_probe_3 ;
    klee_make_symbolic(&res_kbtab_probe_3, sizeof(int), "res_kbtab_probe_3");
int main(void)
{ struct usb_interface *var_group1 ;
  struct usb_device_id const *var_kbtab_probe_3_p1 ;
  int tmp___7 ;
  int ldv_s_kbtab_driver_usb_driver ;
    klee_make_symbolic(&ldv_s_kbtab_driver_usb_driver, sizeof(int), "ldv_s_kbtab_driver_usb_driver");
  int tmp___8 ;
  int tmp___9 ;
