...
struct scsi_device {
   ...
   unsigned int device_busy ;
    klee_make_symbolic(&device_busy, sizeof(int), "device_busy");
   spinlock_t list_lock ;
   ...
   unsigned int device_blocked ;
    klee_make_symbolic(&device_blocked, sizeof(int), "device_blocked");
...
struct scsi_target {
   ...
   unsigned int reap_ref ;
    klee_make_symbolic(&reap_ref, sizeof(int), "reap_ref");
   unsigned int channel ;
   unsigned int id ;
   unsigned char create : 1 ;
   unsigned char single_lun : 1 ;
   unsigned int pdt_1f_for_no_lun ;
    klee_make_symbolic(&pdt_1f_for_no_lun, sizeof(int), "pdt_1f_for_no_lun");
   unsigned int target_busy ;
    klee_make_symbolic(&target_busy, sizeof(int), "target_busy");
   unsigned int can_queue ;
    klee_make_symbolic(&can_queue, sizeof(int), "can_queue");
   unsigned int target_blocked ;
    klee_make_symbolic(&target_blocked, sizeof(int), "target_blocked");
...
struct Scsi_Host {
   ...
   unsigned int host_busy ;
    klee_make_symbolic(&host_busy, sizeof(int), "host_busy");
   ...
   unsigned int host_blocked ;
    klee_make_symbolic(&host_blocked, sizeof(int), "host_blocked");
   unsigned int max_host_blocked ;
...
struct __anonstruct_megastat_t_197 {
   int num_ldrv ;
    klee_make_symbolic(&num_ldrv, sizeof(int), "num_ldrv");
   u32 nreads[40U] ;
   u32 nreadblocks[40U] ;
   u32 nwrites[40U] ;
...
struct __anonstruct_adapter_t_198 {
   ...
   int has_64bit_addr ;
    klee_make_symbolic(&has_64bit_addr, sizeof(int), "has_64bit_addr");
   int support_ext_cdb ;
    klee_make_symbolic(&support_ext_cdb, sizeof(int), "support_ext_cdb");
   int boot_ldrv_enabled ;
    klee_make_symbolic(&boot_ldrv_enabled, sizeof(int), "boot_ldrv_enabled");
   int boot_ldrv ;
    klee_make_symbolic(&boot_ldrv, sizeof(int), "boot_ldrv");
   int boot_pdrv_enabled ;
    klee_make_symbolic(&boot_pdrv_enabled, sizeof(int), "boot_pdrv_enabled");
   int boot_pdrv_ch ;
    klee_make_symbolic(&boot_pdrv_ch, sizeof(int), "boot_pdrv_ch");
   int boot_pdrv_tgt ;
    klee_make_symbolic(&boot_pdrv_tgt, sizeof(int), "boot_pdrv_tgt");
   int support_random_del ;
    klee_make_symbolic(&support_random_del, sizeof(int), "support_random_del");
   int read_ldidmap ;
    klee_make_symbolic(&read_ldidmap, sizeof(int), "read_ldidmap");
   atomic_t quiescent ;
   spinlock_t lock ;
   u8 logdrv_chan[9U] ;
   int mega_ch_class ;
    klee_make_symbolic(&mega_ch_class, sizeof(int), "mega_ch_class");
   u8 sglen ;
   ...
   int has_cluster ;
    klee_make_symbolic(&has_cluster, sizeof(int), "has_cluster");
};
typedef struct __anonstruct_adapter_t_198 adapter_t;
struct mega_hbas {
   int is_bios_enabled ;
    klee_make_symbolic(&is_bios_enabled, sizeof(int), "is_bios_enabled");
...
static int hba_count ;
    klee_make_symbolic(&hba_count, sizeof(int), "hba_count");
...
static int trace_level ;
    klee_make_symbolic(&trace_level, sizeof(int), "trace_level");
static int mega_setup_mailbox(adapter_t *adapter )
{ unsigned long align ;
  void *tmp ;
...
{ int tgt ;
    klee_make_symbolic(&tgt, sizeof(int), "tgt");
  int ldrv_num ;
    klee_make_symbolic(&ldrv_num, sizeof(int), "ldrv_num");
...
{ mega_ext_passthru *epthru ;
  ...
  long seg ;
  char islogical ;
    klee_make_symbolic(&islogical, sizeof(char), "islogical");
  int max_ldrv_num ;
    klee_make_symbolic(&max_ldrv_num, sizeof(int), "max_ldrv_num");
  int channel ;
  int target ;
...
{ mega_ext_passthru *epthru ;
  ...
  int islogical ;
  int cmdid ;
    klee_make_symbolic(&cmdid, sizeof(int), "cmdid");
  int i ;
  void *tmp ;
  struct page *tmp___0 ;
  size_t __len ;
...
{ struct scatterlist *sg ;
  Scsi_Cmnd *cmd ;
  int sgcnt ;
    klee_make_symbolic(&sgcnt, sizeof(int), "sgcnt");
  int idx ;
  long tmp ;
  long tmp___0 ;
...
{ adapter_t *adapter ;
  int rval ;
    klee_make_symbolic(&rval, sizeof(int), "rval");
...
{ adapter_t *adapter ;
  unsigned char *bh ;
  int heads ;
    klee_make_symbolic(&heads, sizeof(int), "heads");
  int sectors ;
    klee_make_symbolic(&sectors, sizeof(int), "sectors");
  int cylinders ;
    klee_make_symbolic(&cylinders, sizeof(int), "cylinders");
  int rval ;
...
{ adapter_t *adapter ;
  nitioctl_t uioc ;
  int adapno ;
    klee_make_symbolic(&adapno, sizeof(int), "adapno");
  int rval ;
...
{ struct Scsi_Host *host ;
  ...
  unsigned long mega_baseport ;
    klee_make_symbolic(&mega_baseport, sizeof(long), "mega_baseport");
  unsigned long tbase ;
    klee_make_symbolic(&tbase, sizeof(long), "tbase");
  unsigned long flag ;
...
{ struct file *var_group1 ;
  unsigned int var_megadev_unlocked_ioctl_49_p1 ;
    klee_make_symbolic(&var_megadev_unlocked_ioctl_49_p1, sizeof(int), "var_megadev_unlocked_ioctl_49_p1");
  unsigned long var_megadev_unlocked_ioctl_49_p2 ;
    klee_make_symbolic(&var_megadev_unlocked_ioctl_49_p2, sizeof(long), "var_megadev_unlocked_ioctl_49_p2");
  struct inode *var_group2 ;
  int res_megadev_open_47 ;
    klee_make_symbolic(&res_megadev_open_47, sizeof(int), "res_megadev_open_47");
  ...
  int res_megaraid_probe_one_65 ;
    klee_make_symbolic(&res_megaraid_probe_one_65, sizeof(int), "res_megaraid_probe_one_65");
  int var_megaraid_isr_iomapped_12_p0 ;
    klee_make_symbolic(&var_megaraid_isr_iomapped_12_p0, sizeof(int), "var_megaraid_isr_iomapped_12_p0");
  void *var_megaraid_isr_iomapped_12_p1 ;
  int var_megaraid_isr_memmapped_13_p0 ;
    klee_make_symbolic(&var_megaraid_isr_memmapped_13_p0, sizeof(int), "var_megaraid_isr_memmapped_13_p0");
  void *var_megaraid_isr_memmapped_13_p1 ;
  int ldv_s_megadev_fops_file_operations ;
    klee_make_symbolic(&ldv_s_megadev_fops_file_operations, sizeof(int), "ldv_s_megadev_fops_file_operations");
  int ldv_s_megaraid_pci_driver_pci_driver ;
    klee_make_symbolic(&ldv_s_megaraid_pci_driver_pci_driver, sizeof(int), "ldv_s_megaraid_pci_driver_pci_driver");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
