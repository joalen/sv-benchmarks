...
struct bt_skb_cb {
   ...
   unsigned short channel ;
    klee_make_symbolic(&channel, sizeof(short), "channel");
};
...
struct hci_conn_hash {
   ...
   unsigned int acl_num ;
    klee_make_symbolic(&acl_num, sizeof(int), "acl_num");
   unsigned int sco_num ;
    klee_make_symbolic(&sco_num, sizeof(int), "sco_num");
   unsigned int le_num ;
    klee_make_symbolic(&le_num, sizeof(int), "le_num");
};
struct rfkill;
struct hci_dev {
   struct list_head list ;
   ...
   unsigned int auto_accept_delay ;
    klee_make_symbolic(&auto_accept_delay, sizeof(int), "auto_accept_delay");
   unsigned long quirks ;
    klee_make_symbolic(&quirks, sizeof(long), "quirks");
   atomic_t cmd_cnt ;
   unsigned int acl_cnt ;
    klee_make_symbolic(&acl_cnt, sizeof(int), "acl_cnt");
   unsigned int sco_cnt ;
    klee_make_symbolic(&sco_cnt, sizeof(int), "sco_cnt");
   unsigned int le_cnt ;
    klee_make_symbolic(&le_cnt, sizeof(int), "le_cnt");
   unsigned int acl_mtu ;
    klee_make_symbolic(&acl_mtu, sizeof(int), "acl_mtu");
   unsigned int sco_mtu ;
    klee_make_symbolic(&sco_mtu, sizeof(int), "sco_mtu");
   unsigned int le_mtu ;
    klee_make_symbolic(&le_mtu, sizeof(int), "le_mtu");
   unsigned int acl_pkts ;
    klee_make_symbolic(&acl_pkts, sizeof(int), "acl_pkts");
   unsigned int sco_pkts ;
    klee_make_symbolic(&sco_pkts, sizeof(int), "sco_pkts");
   unsigned int le_pkts ;
    klee_make_symbolic(&le_pkts, sizeof(int), "le_pkts");
   unsigned long acl_last_tx ;
    klee_make_symbolic(&acl_last_tx, sizeof(long), "acl_last_tx");
   unsigned long sco_last_tx ;
    klee_make_symbolic(&sco_last_tx, sizeof(long), "sco_last_tx");
   unsigned long le_last_tx ;
    klee_make_symbolic(&le_last_tx, sizeof(long), "le_last_tx");
...
{ struct file *var_group1 ;
  ...
  int res_btmrvl_open_generic_0 ;
    klee_make_symbolic(&res_btmrvl_open_generic_0, sizeof(int), "res_btmrvl_open_generic_0");
  ...
  int ldv_s_btmrvl_hscfgcmd_fops_file_operations ;
    klee_make_symbolic(&ldv_s_btmrvl_hscfgcmd_fops_file_operations, sizeof(int), "ldv_s_btmrvl_hscfgcmd_fops_file_operations");
  int ldv_s_btmrvl_psmode_fops_file_operations ;
    klee_make_symbolic(&ldv_s_btmrvl_psmode_fops_file_operations, sizeof(int), "ldv_s_btmrvl_psmode_fops_file_operations");
  int ldv_s_btmrvl_pscmd_fops_file_operations ;
    klee_make_symbolic(&ldv_s_btmrvl_pscmd_fops_file_operations, sizeof(int), "ldv_s_btmrvl_pscmd_fops_file_operations");
  int ldv_s_btmrvl_gpiogap_fops_file_operations ;
    klee_make_symbolic(&ldv_s_btmrvl_gpiogap_fops_file_operations, sizeof(int), "ldv_s_btmrvl_gpiogap_fops_file_operations");
  int ldv_s_btmrvl_hscmd_fops_file_operations ;
    klee_make_symbolic(&ldv_s_btmrvl_hscmd_fops_file_operations, sizeof(int), "ldv_s_btmrvl_hscmd_fops_file_operations");
  int ldv_s_btmrvl_hsmode_fops_file_operations ;
    klee_make_symbolic(&ldv_s_btmrvl_hsmode_fops_file_operations, sizeof(int), "ldv_s_btmrvl_hsmode_fops_file_operations");
  int ldv_s_btmrvl_curpsmode_fops_file_operations ;
    klee_make_symbolic(&ldv_s_btmrvl_curpsmode_fops_file_operations, sizeof(int), "ldv_s_btmrvl_curpsmode_fops_file_operations");
  int ldv_s_btmrvl_psstate_fops_file_operations ;
    klee_make_symbolic(&ldv_s_btmrvl_psstate_fops_file_operations, sizeof(int), "ldv_s_btmrvl_psstate_fops_file_operations");
  int ldv_s_btmrvl_hsstate_fops_file_operations ;
    klee_make_symbolic(&ldv_s_btmrvl_hsstate_fops_file_operations, sizeof(int), "ldv_s_btmrvl_hsstate_fops_file_operations");
  int ldv_s_btmrvl_txdnldready_fops_file_operations ;
    klee_make_symbolic(&ldv_s_btmrvl_txdnldready_fops_file_operations, sizeof(int), "ldv_s_btmrvl_txdnldready_fops_file_operations");
  int tmp ;
  int tmp___0 ;
