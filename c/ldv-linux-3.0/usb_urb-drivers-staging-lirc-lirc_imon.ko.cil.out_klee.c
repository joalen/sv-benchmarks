...
struct lirc_buffer {
   ...
   unsigned int chunk_size ;
    klee_make_symbolic(&chunk_size, sizeof(int), "chunk_size");
   unsigned int size ;
   struct kfifo fifo ;
   u8 fifo_initialized ;
};
struct lirc_driver {
   ...
   int sample_rate ;
    klee_make_symbolic(&sample_rate, sizeof(int), "sample_rate");
   __u32 features ;
   unsigned int chunk_size ;
   void *data ;
   int min_timeout ;
    klee_make_symbolic(&min_timeout, sizeof(int), "min_timeout");
   int max_timeout ;
    klee_make_symbolic(&max_timeout, sizeof(int), "max_timeout");
...
struct rx_data {
   int count ;
   int prev_bit ;
    klee_make_symbolic(&prev_bit, sizeof(int), "prev_bit");
   int initial_space ;
    klee_make_symbolic(&initial_space, sizeof(int), "initial_space");
};
struct tx_t {
...
struct imon_context {
   ...
   int display ;
    klee_make_symbolic(&display, sizeof(int), "display");
   int display_isopen ;
    klee_make_symbolic(&display_isopen, sizeof(int), "display_isopen");
   int ir_isopen ;
    klee_make_symbolic(&ir_isopen, sizeof(int), "ir_isopen");
   int dev_present ;
    klee_make_symbolic(&dev_present, sizeof(int), "dev_present");
   struct mutex ctx_lock ;
   wait_queue_head_t remove_ok ;
   int vfd_proto_6p ;
    klee_make_symbolic(&vfd_proto_6p, sizeof(int), "vfd_proto_6p");
...
{ struct usb_interface *interface ;
  ...
  int subminor ;
    klee_make_symbolic(&subminor, sizeof(int), "subminor");
  int retval ;
...
{ int len ;
  ...
  struct device *dev ;
  int octet ;
    klee_make_symbolic(&octet, sizeof(int), "octet");
  int bit ;
    klee_make_symbolic(&bit, sizeof(int), "bit");
  unsigned char mask ;
  int i ;
  int curr_bit ;
    klee_make_symbolic(&curr_bit, sizeof(int), "curr_bit");
...
{ struct imon_context *context ;
  int intfnum ;
    klee_make_symbolic(&intfnum, sizeof(int), "intfnum");
...
{ struct usb_device *usbdev ;
  ...
  int lirc_minor ;
    klee_make_symbolic(&lirc_minor, sizeof(int), "lirc_minor");
  int num_endpts ;
    klee_make_symbolic(&num_endpts, sizeof(int), "num_endpts");
  int retval ;
  int display_ep_found ;
    klee_make_symbolic(&display_ep_found, sizeof(int), "display_ep_found");
  int ir_ep_found ;
    klee_make_symbolic(&ir_ep_found, sizeof(int), "ir_ep_found");
  int alloc_status ;
    klee_make_symbolic(&alloc_status, sizeof(int), "alloc_status");
  int vfd_proto_6p ;
  struct imon_context *context ;
  int i ;
  u16 vendor ;
  ...
  int ep_dir ;
    klee_make_symbolic(&ep_dir, sizeof(int), "ep_dir");
  int ep_type ;
    klee_make_symbolic(&ep_type, sizeof(int), "ep_type");
  long tmp___11 ;
  long tmp___12 ;
...
static int res_imon_probe_13 ;
    klee_make_symbolic(&res_imon_probe_13, sizeof(int), "res_imon_probe_13");
int main(void)
{ struct usb_interface *var_group1 ;
  ...
  int ldv_s_imon_driver_usb_driver ;
    klee_make_symbolic(&ldv_s_imon_driver_usb_driver, sizeof(int), "ldv_s_imon_driver_usb_driver");
  int tmp___8 ;
  int tmp___9 ;
