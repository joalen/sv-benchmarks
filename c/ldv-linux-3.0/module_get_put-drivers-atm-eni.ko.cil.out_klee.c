...
struct __anonstruct_itu_141 {
   unsigned char mode ;
    klee_make_symbolic(&mode, sizeof(char), "mode");
   unsigned char window ;
    klee_make_symbolic(&window, sizeof(char), "window");
};
union __anonunion_l2_140 {
   struct __anonstruct_itu_141 itu ;
   unsigned char user ;
    klee_make_symbolic(&user, sizeof(char), "user");
};
struct __anonstruct_itu_143 {
   unsigned char mode ;
   unsigned char def_size ;
    klee_make_symbolic(&def_size, sizeof(char), "def_size");
   unsigned char window ;
};
struct __anonstruct_h310_144 {
   unsigned char term_type ;
    klee_make_symbolic(&term_type, sizeof(char), "term_type");
   unsigned char fw_mpx_cap ;
    klee_make_symbolic(&fw_mpx_cap, sizeof(char), "fw_mpx_cap");
   unsigned char bw_mpx_cap ;
    klee_make_symbolic(&bw_mpx_cap, sizeof(char), "bw_mpx_cap");
};
struct __anonstruct_tr9577_145 {
   unsigned char ipi ;
    klee_make_symbolic(&ipi, sizeof(char), "ipi");
...
struct atm_blli {
   unsigned char l2_proto ;
    klee_make_symbolic(&l2_proto, sizeof(char), "l2_proto");
   union __anonunion_l2_140 l2 ;
   unsigned char l3_proto ;
    klee_make_symbolic(&l3_proto, sizeof(char), "l3_proto");
   union __anonunion_l3_142 l3 ;
};
struct atm_bhli {
   unsigned char hl_type ;
    klee_make_symbolic(&hl_type, sizeof(char), "hl_type");
   unsigned char hl_length ;
    klee_make_symbolic(&hl_length, sizeof(char), "hl_length");
...
struct atm_trafprm {
   unsigned char traffic_class ;
    klee_make_symbolic(&traffic_class, sizeof(char), "traffic_class");
   int max_pcr ;
    klee_make_symbolic(&max_pcr, sizeof(int), "max_pcr");
   int pcr ;
    klee_make_symbolic(&pcr, sizeof(int), "pcr");
   int min_pcr ;
    klee_make_symbolic(&min_pcr, sizeof(int), "min_pcr");
   int max_cdv ;
    klee_make_symbolic(&max_cdv, sizeof(int), "max_cdv");
   int max_sdu ;
    klee_make_symbolic(&max_sdu, sizeof(int), "max_sdu");
   unsigned int icr ;
    klee_make_symbolic(&icr, sizeof(int), "icr");
   unsigned int tbe ;
    klee_make_symbolic(&tbe, sizeof(int), "tbe");
...
struct atm_qos {
   ...
   unsigned char aal ;
    klee_make_symbolic(&aal, sizeof(char), "aal");
};
struct __anonstruct_sas_addr_147 {
   unsigned char prv[20U] ;
   char pub[13U] ;
   char lij_type ;
    klee_make_symbolic(&lij_type, sizeof(char), "lij_type");
   __u32 lij_id ;
};
struct sockaddr_atmsvc {
   unsigned short sas_family ;
    klee_make_symbolic(&sas_family, sizeof(short), "sas_family");
...
struct atm_cirange {
   signed char vpi_bits ;
    klee_make_symbolic(&vpi_bits, sizeof(char), "vpi_bits");
   signed char vci_bits ;
    klee_make_symbolic(&vci_bits, sizeof(char), "vci_bits");
};
enum ldv_20488 {
    SS_FREE = 0,
    SS_UNCONNECTED = 1,
...
struct skb_shared_info {
   unsigned short nr_frags ;
    klee_make_symbolic(&nr_frags, sizeof(short), "nr_frags");
...
struct linux_binprm {
   ...
   struct mm_struct *mm ;
   unsigned long p ;
    klee_make_symbolic(&p, sizeof(long), "p");
...
struct coredump_params {
   long signr ;
    klee_make_symbolic(&signr, sizeof(long), "signr");
   struct pt_regs *regs ;
   struct file *file ;
   unsigned long limit ;
...
struct neigh_parms {
   ...
   int base_reachable_time ;
    klee_make_symbolic(&base_reachable_time, sizeof(int), "base_reachable_time");
   int retrans_time ;
    klee_make_symbolic(&retrans_time, sizeof(int), "retrans_time");
   int gc_staletime ;
    klee_make_symbolic(&gc_staletime, sizeof(int), "gc_staletime");
   int reachable_time ;
    klee_make_symbolic(&reachable_time, sizeof(int), "reachable_time");
   int delay_probe_time ;
    klee_make_symbolic(&delay_probe_time, sizeof(int), "delay_probe_time");
   int queue_len ;
    klee_make_symbolic(&queue_len, sizeof(int), "queue_len");
   int ucast_probes ;
    klee_make_symbolic(&ucast_probes, sizeof(int), "ucast_probes");
   int app_probes ;
    klee_make_symbolic(&app_probes, sizeof(int), "app_probes");
   int mcast_probes ;
    klee_make_symbolic(&mcast_probes, sizeof(int), "mcast_probes");
   int anycast_delay ;
    klee_make_symbolic(&anycast_delay, sizeof(int), "anycast_delay");
   int proxy_delay ;
    klee_make_symbolic(&proxy_delay, sizeof(int), "proxy_delay");
   int proxy_qlen ;
    klee_make_symbolic(&proxy_qlen, sizeof(int), "proxy_qlen");
   int locktime ;
    klee_make_symbolic(&locktime, sizeof(int), "locktime");
};
...
struct neigh_hash_table {
   ...
   unsigned int hash_mask ;
    klee_make_symbolic(&hash_mask, sizeof(int), "hash_mask");
   __u32 hash_rnd ;
   struct rcu_head rcu ;
};
struct neigh_table {
...
struct sock_common {
   ...
   unsigned char skc_reuse ;
    klee_make_symbolic(&skc_reuse, sizeof(char), "skc_reuse");
...
struct sock {
   ...
   gfp_t sk_allocation ;
   int sk_route_caps ;
    klee_make_symbolic(&sk_route_caps, sizeof(int), "sk_route_caps");
   int sk_route_nocaps ;
    klee_make_symbolic(&sk_route_nocaps, sizeof(int), "sk_route_nocaps");
   int sk_gso_type ;
   ...
   unsigned short sk_ack_backlog ;
    klee_make_symbolic(&sk_ack_backlog, sizeof(short), "sk_ack_backlog");
   unsigned short sk_max_ack_backlog ;
    klee_make_symbolic(&sk_max_ack_backlog, sizeof(short), "sk_max_ack_backlog");
   __u32 sk_priority ;
...
struct atm_vcc {
   ...
   unsigned long flags ;
   short vpi ;
    klee_make_symbolic(&vpi, sizeof(short), "vpi");
   int vci ;
    klee_make_symbolic(&vci, sizeof(int), "vci");
   unsigned long aal_options ;
    klee_make_symbolic(&aal_options, sizeof(long), "aal_options");
   unsigned long atm_options ;
    klee_make_symbolic(&atm_options, sizeof(long), "atm_options");
   struct atm_dev *dev ;
   struct atm_qos qos ;
   struct atm_sap sap ;
   ...
   short itf ;
    klee_make_symbolic(&itf, sizeof(short), "itf");
...
struct atm_dev {
   ...
   char signal ;
    klee_make_symbolic(&signal, sizeof(char), "signal");
   int link_rate ;
    klee_make_symbolic(&link_rate, sizeof(int), "link_rate");
   atomic_t refcnt ;
   spinlock_t lock ;
...
struct eni_tx {
   void *send ;
   int prescaler ;
    klee_make_symbolic(&prescaler, sizeof(int), "prescaler");
   int resolution ;
    klee_make_symbolic(&resolution, sizeof(int), "resolution");
   unsigned long tx_pos ;
    klee_make_symbolic(&tx_pos, sizeof(long), "tx_pos");
   unsigned long words ;
    klee_make_symbolic(&words, sizeof(long), "words");
   int index ;
   int reserved ;
   int shaping ;
    klee_make_symbolic(&shaping, sizeof(int), "shaping");
...
struct eni_vcc {
   ...
   unsigned long words ;
   unsigned long descr ;
    klee_make_symbolic(&descr, sizeof(long), "descr");
   unsigned long rx_pos ;
    klee_make_symbolic(&rx_pos, sizeof(long), "rx_pos");
   struct eni_tx *tx ;
   int rxing ;
    klee_make_symbolic(&rxing, sizeof(int), "rxing");
   int servicing ;
    klee_make_symbolic(&servicing, sizeof(int), "servicing");
   int txing ;
    klee_make_symbolic(&txing, sizeof(int), "txing");
   ktime_t timestamp ;
   struct atm_vcc *next ;
   struct sk_buff *last ;
};
struct eni_dev {
   ...
   int tx_bw ;
    klee_make_symbolic(&tx_bw, sizeof(int), "tx_bw");
   u32 dma[200U] ;
   int tx_mult ;
    klee_make_symbolic(&tx_mult, sizeof(int), "tx_mult");
   u32 serv_read ;
   struct atm_vcc *fast ;
   ...
   int rx_mult ;
    klee_make_symbolic(&rx_mult, sizeof(int), "rx_mult");
   unsigned long lost ;
    klee_make_symbolic(&lost, sizeof(long), "lost");
   unsigned long base_diff ;
    klee_make_symbolic(&base_diff, sizeof(long), "base_diff");
   int free_len ;
    klee_make_symbolic(&free_len, sizeof(int), "free_len");
   struct eni_free *free_list ;
   int free_list_size ;
    klee_make_symbolic(&free_list_size, sizeof(int), "free_list_size");
   struct atm_dev *more ;
   int mem ;
    klee_make_symbolic(&mem, sizeof(int), "mem");
   int asic ;
    klee_make_symbolic(&asic, sizeof(int), "asic");
   unsigned int irq ;
...
struct eni_skb_prv {
   ...
   unsigned long pos ;
    klee_make_symbolic(&pos, sizeof(long), "pos");
   int size ;
   dma_addr_t paddr ;
};
enum enq_res {
...
{ struct eni_free *list ;
  ...
  int order ;
  int best_order ;
    klee_make_symbolic(&best_order, sizeof(int), "best_order");
  int index ;
...
{ struct eni_dev *eni_dev ;
  ...
  dma_addr_t paddr ;
  unsigned long here ;
    klee_make_symbolic(&here, sizeof(long), "here");
  int i ;
  int j ;
  ...
  unsigned long words ;
  unsigned long init ;
    klee_make_symbolic(&init, sizeof(long), "init");
  int tmp___0 ;
  int tmp___1 ;
  int tmp___2 ;
  int tmp___3 ;
...
{ struct eni_vcc *eni_vcc ;
  ...
  unsigned long size ;
  unsigned long eff ;
    klee_make_symbolic(&eff, sizeof(long), "eff");
  unsigned long length ;
  struct sk_buff *skb ;
  unsigned int tmp ;
  unsigned long silence ;
    klee_make_symbolic(&silence, sizeof(long), "silence");
  unsigned int tmp___0 ;
...
{ struct eni_dev *eni_dev ;
  ...
  void *vci_dsc ;
  int first ;
    klee_make_symbolic(&first, sizeof(int), "first");
  unsigned int tmp ;
  unsigned int tmp___0 ;
  int tmp___1 ;
  unsigned int tmp___2 ;
...
{ wait_queue_t wait ;
  ...
  int at_end ;
    klee_make_symbolic(&at_end, sizeof(int), "at_end");
  u32 tmp___10 ;
...
{ struct atm_vcc *vcc ;
  ...
  u32 size ;
  int aal5 ;
    klee_make_symbolic(&aal5, sizeof(int), "aal5");
  int dma_size ;
    klee_make_symbolic(&dma_size, sizeof(int), "dma_size");
  int i ;
  int j ;
  unsigned int tmp ;
  unsigned int tmp___0 ;
...
{ int pre_div[4U] ;
  ...
  int div___0 ;
    klee_make_symbolic(&div___0, sizeof(int), "div___0");
...
{ struct eni_dev *eni_dev ;
  ...
  int ubr ;
    klee_make_symbolic(&ubr, sizeof(int), "ubr");
  int unlimited ;
    klee_make_symbolic(&unlimited, sizeof(int), "unlimited");
  int new_tx ;
    klee_make_symbolic(&new_tx, sizeof(int), "new_tx");
  int pre ;
    klee_make_symbolic(&pre, sizeof(int), "pre");
  int res ;
...
{ struct eni_dev *eni_dev ;
  unsigned char tonga ;
    klee_make_symbolic(&tonga, sizeof(char), "tonga");
  int error ;
  int failed ;
    klee_make_symbolic(&failed, sizeof(int), "failed");
  int pci_error ;
    klee_make_symbolic(&pci_error, sizeof(int), "pci_error");
  int address ;
...
{ struct midway_eprom *eprom ;
  ...
  unsigned long real_base ;
    klee_make_symbolic(&real_base, sizeof(long), "real_base");
  void *base ;
  int error ;
  int i ;
  int last ;
...
{ struct eni_dev *eni_dev ;
  ...
  unsigned long buffer_mem ;
    klee_make_symbolic(&buffer_mem, sizeof(long), "buffer_mem");
  int error ;
  int tmp ;
  int tmp___0 ;
  struct lock_class_key __key ;
...
{ struct eni_dev *eni_dev ;
  ...
  int rate ;
  int rsv ;
    klee_make_symbolic(&rsv, sizeof(int), "rsv");
  int shp ;
    klee_make_symbolic(&shp, sizeof(int), "shp");
  void *dsc ;
  unsigned int tmp ;
...
{ struct hlist_node *node ;
  ...
  struct atm_vcc *vcc ;
  int left ;
    klee_make_symbolic(&left, sizeof(int), "left");
  int i ;
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
...
{ struct atm_vcc *var_group1 ;
  int res_eni_open_41 ;
    klee_make_symbolic(&res_eni_open_41, sizeof(int), "res_eni_open_41");
  struct atm_dev *var_group2 ;
  unsigned int var_eni_ioctl_43_p1 ;
    klee_make_symbolic(&var_eni_ioctl_43_p1, sizeof(int), "var_eni_ioctl_43_p1");
  void *var_eni_ioctl_43_p2 ;
  int var_eni_getsockopt_44_p1 ;
    klee_make_symbolic(&var_eni_getsockopt_44_p1, sizeof(int), "var_eni_getsockopt_44_p1");
  int var_eni_getsockopt_44_p2 ;
    klee_make_symbolic(&var_eni_getsockopt_44_p2, sizeof(int), "var_eni_getsockopt_44_p2");
  void *var_eni_getsockopt_44_p3 ;
  int var_eni_getsockopt_44_p4 ;
    klee_make_symbolic(&var_eni_getsockopt_44_p4, sizeof(int), "var_eni_getsockopt_44_p4");
  int var_eni_setsockopt_45_p1 ;
    klee_make_symbolic(&var_eni_setsockopt_45_p1, sizeof(int), "var_eni_setsockopt_45_p1");
  int var_eni_setsockopt_45_p2 ;
    klee_make_symbolic(&var_eni_setsockopt_45_p2, sizeof(int), "var_eni_setsockopt_45_p2");
  void *var_eni_setsockopt_45_p3 ;
  unsigned int var_eni_setsockopt_45_p4 ;
    klee_make_symbolic(&var_eni_setsockopt_45_p4, sizeof(int), "var_eni_setsockopt_45_p4");
  struct sk_buff *var_group3 ;
  unsigned char var_eni_phy_put_47_p1 ;
    klee_make_symbolic(&var_eni_phy_put_47_p1, sizeof(char), "var_eni_phy_put_47_p1");
  unsigned long var_eni_phy_put_47_p2 ;
    klee_make_symbolic(&var_eni_phy_put_47_p2, sizeof(long), "var_eni_phy_put_47_p2");
  unsigned long var_eni_phy_get_48_p1 ;
    klee_make_symbolic(&var_eni_phy_get_48_p1, sizeof(long), "var_eni_phy_get_48_p1");
  struct atm_qos *var_group4 ;
  int var_eni_change_qos_42_p2 ;
    klee_make_symbolic(&var_eni_change_qos_42_p2, sizeof(int), "var_eni_change_qos_42_p2");
  ...
  int res_eni_init_one_50 ;
    klee_make_symbolic(&res_eni_init_one_50, sizeof(int), "res_eni_init_one_50");
  int var_eni_int_34_p0 ;
    klee_make_symbolic(&var_eni_int_34_p0, sizeof(int), "var_eni_int_34_p0");
  void *var_eni_int_34_p1 ;
  int ldv_s_ops_atmdev_ops ;
    klee_make_symbolic(&ldv_s_ops_atmdev_ops, sizeof(int), "ldv_s_ops_atmdev_ops");
  int ldv_s_eni_driver_pci_driver ;
    klee_make_symbolic(&ldv_s_eni_driver_pci_driver, sizeof(int), "ldv_s_eni_driver_pci_driver");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
