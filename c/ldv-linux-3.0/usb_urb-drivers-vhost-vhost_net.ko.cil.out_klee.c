...
struct pollfd {
   int fd ;
   short events ;
    klee_make_symbolic(&events, sizeof(short), "events");
   short revents ;
...
struct vhost_work {
   ...
   int flushing ;
    klee_make_symbolic(&flushing, sizeof(int), "flushing");
   unsigned int queue_seq ;
    klee_make_symbolic(&queue_seq, sizeof(int), "queue_seq");
   unsigned int done_seq ;
    klee_make_symbolic(&done_seq, sizeof(int), "done_seq");
};
struct vhost_dev;
struct vhost_poll {
   poll_table table ;
...
struct vhost_dev {
   ...
   unsigned int acked_features ;
    klee_make_symbolic(&acked_features, sizeof(int), "acked_features");
   struct vhost_virtqueue *vqs ;
   int nvqs ;
    klee_make_symbolic(&nvqs, sizeof(int), "nvqs");
...
struct sockaddr_ll {
   unsigned short sll_family ;
    klee_make_symbolic(&sll_family, sizeof(short), "sll_family");
   __be16 sll_protocol ;
   int sll_ifindex ;
    klee_make_symbolic(&sll_ifindex, sizeof(int), "sll_ifindex");
   unsigned short sll_hatype ;
    klee_make_symbolic(&sll_hatype, sizeof(short), "sll_hatype");
   unsigned char sll_pkttype ;
    klee_make_symbolic(&sll_pkttype, sizeof(char), "sll_pkttype");
   unsigned char sll_halen ;
    klee_make_symbolic(&sll_halen, sizeof(char), "sll_halen");
...
{ unsigned int acked_features ;
  unsigned int _________p1 ;
    klee_make_symbolic(&_________p1, sizeof(int), "_________p1");
  int tmp___7 ;
...
{ int i ;
  int ok ;
    klee_make_symbolic(&ok, sizeof(int), "ok");
...
{ size_t s ;
  ...
  unsigned long flag___0 ;
    klee_make_symbolic(&flag___0, sizeof(long), "flag___0");
  unsigned long roksum___0 ;
    klee_make_symbolic(&roksum___0, sizeof(long), "roksum___0");
  struct thread_info *tmp___13 ;
  int tmp___14 ;
  long tmp___15 ;
  unsigned long flag___1 ;
    klee_make_symbolic(&flag___1, sizeof(long), "flag___1");
  unsigned long roksum___1 ;
    klee_make_symbolic(&roksum___1, sizeof(long), "roksum___1");
...
{ struct file *eventfp ;
  ...
  long tmp___34 ;
    klee_make_symbolic(&tmp___34, sizeof(long), "tmp___34");
  unsigned long tmp___35 ;
    klee_make_symbolic(&tmp___35, sizeof(long), "tmp___35");
  long tmp___36 ;
    klee_make_symbolic(&tmp___36, sizeof(long), "tmp___36");
  long tmp___37 ;
...
{ unsigned long log ;
    klee_make_symbolic(&log, sizeof(long), "log");
  struct page *page ;
  void *base ;
  int bit ;
...
{ struct vring_desc desc ;
  ...
  unsigned int iov_count ;
    klee_make_symbolic(&iov_count, sizeof(int), "iov_count");
  long tmp___13 ;
  int tmp___14 ;
  long tmp___15 ;
  long tmp___16 ;
...
{ struct vring_used_elem *used ;
  long tmp___7 ;
  int __pu_err ;
    klee_make_symbolic(&__pu_err, sizeof(int), "__pu_err");
  long tmp___8 ;
  int __pu_err___0 ;
    klee_make_symbolic(&__pu_err___0, sizeof(int), "__pu_err___0");
  long tmp___9 ;
  int __pu_err___1 ;
    klee_make_symbolic(&__pu_err___1, sizeof(int), "__pu_err___1");
  long tmp___10 ;
  long tmp___11 ;
...
{ struct vhost_virtqueue *vq ;
  ...
  int err ;
  int wmem ;
    klee_make_symbolic(&wmem, sizeof(int), "wmem");
  size_t hdr_size ;
  struct socket *sock ;
  void *_________p1 ;
  int tmp___7 ;
...
{ unsigned int out ;
  ...
  int seg ;
  int headcount ;
    klee_make_symbolic(&headcount, sizeof(int), "headcount");
  unsigned int d ;
    klee_make_symbolic(&d, sizeof(int), "d");
  int r ;
  int nlogs ;
    klee_make_symbolic(&nlogs, sizeof(int), "nlogs");
  long tmp___7 ;
  int tmp___8 ;
  long tmp___9 ;
  int tmp___10 ;
...
{ struct vhost_virtqueue *vq ;
  ...
  int headcount ;
  int mergeable ;
    klee_make_symbolic(&mergeable, sizeof(int), "mergeable");
  size_t vhost_hlen ;
  size_t sock_hlen ;
  size_t vhost_len ;
  size_t sock_len ;
...
{ struct __anonstruct_uaddr_348 uaddr ;
  int uaddr_len ;
    klee_make_symbolic(&uaddr_len, sizeof(int), "uaddr_len");
  int r ;
  struct socket *sock ;
...
static int res_vhost_net_open_12 ;
    klee_make_symbolic(&res_vhost_net_open_12, sizeof(int), "res_vhost_net_open_12");
int main(void)
{ struct inode *var_group1 ;
  struct file *var_group2 ;
  unsigned int var_vhost_net_ioctl_26_p1 ;
    klee_make_symbolic(&var_vhost_net_ioctl_26_p1, sizeof(int), "var_vhost_net_ioctl_26_p1");
  unsigned long var_vhost_net_ioctl_26_p2 ;
    klee_make_symbolic(&var_vhost_net_ioctl_26_p2, sizeof(long), "var_vhost_net_ioctl_26_p2");
  unsigned int var_vhost_net_compat_ioctl_27_p1 ;
    klee_make_symbolic(&var_vhost_net_compat_ioctl_27_p1, sizeof(int), "var_vhost_net_compat_ioctl_27_p1");
  unsigned long var_vhost_net_compat_ioctl_27_p2 ;
    klee_make_symbolic(&var_vhost_net_compat_ioctl_27_p2, sizeof(long), "var_vhost_net_compat_ioctl_27_p2");
  int tmp___7 ;
  int ldv_s_vhost_net_fops_file_operations ;
    klee_make_symbolic(&ldv_s_vhost_net_fops_file_operations, sizeof(int), "ldv_s_vhost_net_fops_file_operations");
  int tmp___8 ;
  int tmp___9 ;
