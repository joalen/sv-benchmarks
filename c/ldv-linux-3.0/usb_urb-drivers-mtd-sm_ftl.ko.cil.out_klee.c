...
struct mtd_blktrans_dev {
   ...
   unsigned long size ;
   int readonly ;
    klee_make_symbolic(&readonly, sizeof(int), "readonly");
   int open ;
...
struct mtd_blktrans_ops {
   ...
   int part_bits ;
    klee_make_symbolic(&part_bits, sizeof(int), "part_bits");
   int blksize ;
   int blkshift ;
    klee_make_symbolic(&blkshift, sizeof(int), "blkshift");
...
struct sm_ftl {
   ...
   int zone_size ;
    klee_make_symbolic(&zone_size, sizeof(int), "zone_size");
   int zone_count ;
    klee_make_symbolic(&zone_count, sizeof(int), "zone_count");
   int max_lba ;
    klee_make_symbolic(&max_lba, sizeof(int), "max_lba");
   int smallpagenand ;
    klee_make_symbolic(&smallpagenand, sizeof(int), "smallpagenand");
   bool readonly ;
   bool unstable ;
   int cis_block ;
    klee_make_symbolic(&cis_block, sizeof(int), "cis_block");
   int cis_boffset ;
    klee_make_symbolic(&cis_boffset, sizeof(int), "cis_boffset");
   int cis_page_offset ;
    klee_make_symbolic(&cis_page_offset, sizeof(int), "cis_page_offset");
   void *cis_buffer ;
   int cache_block ;
    klee_make_symbolic(&cache_block, sizeof(int), "cache_block");
   int cache_zone ;
    klee_make_symbolic(&cache_zone, sizeof(int), "cache_zone");
   unsigned char *cache_data ;
   unsigned long cache_data_invalid_bitmap ;
    klee_make_symbolic(&cache_data_invalid_bitmap, sizeof(long), "cache_data_invalid_bitmap");
   bool cache_clean ;
...
struct chs_entry {
   unsigned long size ;
   unsigned short cyl ;
    klee_make_symbolic(&cyl, sizeof(short), "cyl");
   unsigned char head ;
    klee_make_symbolic(&head, sizeof(char), "head");
   unsigned char sec ;
    klee_make_symbolic(&sec, sizeof(char), "sec");
};
...
{ struct attribute_group *attr_group ;
  ...
  int vendor_len ;
    klee_make_symbolic(&vendor_len, sizeof(int), "vendor_len");
...
{ uint16_t lba_test ;
  int lba ;
    klee_make_symbolic(&lba, sizeof(int), "lba");
  int tmp___7 ;
  bool tmp___8 ;
...
{ struct mtd_info *mtd ;
  ...
  int try ;
    klee_make_symbolic(&try, sizeof(int), "try");
  int tmp___7 ;
  int tmp___8 ;
  loff_t tmp___9 ;
  bool tmp___10 ;
...
{ struct sm_oob oob ;
  int boffset ;
    klee_make_symbolic(&boffset, sizeof(int), "boffset");
  int retry ;
...
{ int boffset ;
  ...
  int i ;
  int test_lba ;
    klee_make_symbolic(&test_lba, sizeof(int), "test_lba");
  int tmp___7 ;
...
{ int i ;
  int size_in_megs ;
    klee_make_symbolic(&size_in_megs, sizeof(int), "size_in_megs");
...
{ struct sm_oob oob ;
  int block ;
    klee_make_symbolic(&block, sizeof(int), "block");
  int boffset ;
  int block_found ;
    klee_make_symbolic(&block_found, sizeof(int), "block_found");
  int cis_found ;
    klee_make_symbolic(&cis_found, sizeof(int), "cis_found");
  int tmp___7 ;
  int tmp___8 ;
  int tmp___9 ;
  int tmp___10 ;
...
{ struct ftl_zone *zone ;
  ...
  unsigned long __n___0 ;
    klee_make_symbolic(&__n___0, sizeof(long), "__n___0");
  ...
  unsigned long __n___1 ;
    klee_make_symbolic(&__n___1, sizeof(long), "__n___1");
...
{ struct ftl_zone *zone ;
  int sector_num ;
    klee_make_symbolic(&sector_num, sizeof(int), "sector_num");
  uint16_t write_sector ;
  int zone_num ;
    klee_make_symbolic(&zone_num, sizeof(int), "zone_num");
  int block_num ;
    klee_make_symbolic(&block_num, sizeof(int), "block_num");
  long tmp___7 ;
...
{ struct sm_ftl *ftl ;
  ...
  int error ;
  int in_cache ;
    klee_make_symbolic(&in_cache, sizeof(int), "in_cache");
  int zone_num ;
  int block ;
  int boffset ;
  long tmp___7 ;
...
{ struct mtd_blktrans_dev *var_group1 ;
  ...
  unsigned long var_sm_read_28_p1 ;
    klee_make_symbolic(&var_sm_read_28_p1, sizeof(long), "var_sm_read_28_p1");
  char *var_sm_read_28_p2 ;
  unsigned long var_sm_write_29_p1 ;
    klee_make_symbolic(&var_sm_write_29_p1, sizeof(long), "var_sm_write_29_p1");
  char *var_sm_write_29_p2 ;
  int tmp___7 ;
  int ldv_s_sm_ftl_ops_mtd_blktrans_ops ;
    klee_make_symbolic(&ldv_s_sm_ftl_ops_mtd_blktrans_ops, sizeof(int), "ldv_s_sm_ftl_ops_mtd_blktrans_ops");
  int tmp___8 ;
  int tmp___9 ;
