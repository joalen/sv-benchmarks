...
struct loop_device {
   int lo_number ;
    klee_make_symbolic(&lo_number, sizeof(int), "lo_number");
   int lo_refcnt ;
    klee_make_symbolic(&lo_refcnt, sizeof(int), "lo_refcnt");
   loff_t lo_offset ;
   loff_t lo_sizelimit ;
   int lo_flags ;
    klee_make_symbolic(&lo_flags, sizeof(int), "lo_flags");
   ...
   int lo_encrypt_key_size ;
    klee_make_symbolic(&lo_encrypt_key_size, sizeof(int), "lo_encrypt_key_size");
   ...
   unsigned int lo_blocksize ;
    klee_make_symbolic(&lo_blocksize, sizeof(int), "lo_blocksize");
   void *key_data ;
   gfp_t old_gfp_mask ;
   spinlock_t lo_lock ;
   struct bio_list lo_bio_list ;
   int lo_state ;
    klee_make_symbolic(&lo_state, sizeof(int), "lo_state");
...
struct loop_info {
   ...
   unsigned long lo_inode ;
    klee_make_symbolic(&lo_inode, sizeof(long), "lo_inode");
   __kernel_old_dev_t lo_rdevice ;
   int lo_offset ;
    klee_make_symbolic(&lo_offset, sizeof(int), "lo_offset");
   int lo_encrypt_type ;
    klee_make_symbolic(&lo_encrypt_type, sizeof(int), "lo_encrypt_type");
   int lo_encrypt_key_size ;
   int lo_flags ;
   char lo_name[64U] ;
...
struct splice_desc {
   ...
   unsigned int total_len ;
    klee_make_symbolic(&total_len, sizeof(int), "total_len");
   unsigned int flags ;
...
struct lo_read_data {
   ...
   unsigned int offset ;
   int bsize ;
    klee_make_symbolic(&bsize, sizeof(int), "bsize");
};
...
static int max_part ;
    klee_make_symbolic(&max_part, sizeof(int), "max_part");
static int part_shift ;
    klee_make_symbolic(&part_shift, sizeof(int), "part_shift");
...
{ char *raw_buf ;
  ...
  int keysize ;
    klee_make_symbolic(&keysize, sizeof(int), "keysize");
  char *tmp___1 ;
  char *tmp___2 ;
...
{ struct file *file ;
  ...
  unsigned int bv_offs ;
    klee_make_symbolic(&bv_offs, sizeof(int), "bv_offs");
  int len ;
  int ret ;
  ...
  int transfer_result ;
    klee_make_symbolic(&transfer_result, sizeof(int), "transfer_result");
  struct page *page ;
  void *fsdata ;
  long tmp ;
  long tmp___0 ;
...
{ struct lo_read_data cookie ;
  ...
  struct file *file ;
  long retval ;
    klee_make_symbolic(&retval, sizeof(long), "retval");
...
{ struct loop_device *lo ;
  int rw ;
    klee_make_symbolic(&rw, sizeof(int), "rw");
  long tmp ;
  long tmp___0 ;
  long tmp___1 ;
  int tmp___2 ;
...
{ int autoclear ;
    klee_make_symbolic(&autoclear, sizeof(int), "autoclear");
  char *tmp ;
  int tmp___0 ;
...
{ int i ;
  int nr ;
  unsigned long range ;
    klee_make_symbolic(&range, sizeof(long), "range");
  struct loop_device *lo ;
...
{ struct loop_device *var_group1 ;
  int var_transfer_none_0_p1 ;
    klee_make_symbolic(&var_transfer_none_0_p1, sizeof(int), "var_transfer_none_0_p1");
  struct page *var_transfer_none_0_p2 ;
  unsigned int var_transfer_none_0_p3 ;
    klee_make_symbolic(&var_transfer_none_0_p3, sizeof(int), "var_transfer_none_0_p3");
  struct page *var_transfer_none_0_p4 ;
  unsigned int var_transfer_none_0_p5 ;
    klee_make_symbolic(&var_transfer_none_0_p5, sizeof(int), "var_transfer_none_0_p5");
  int var_transfer_none_0_p6 ;
    klee_make_symbolic(&var_transfer_none_0_p6, sizeof(int), "var_transfer_none_0_p6");
  sector_t var_transfer_none_0_p7 ;
  int var_transfer_xor_1_p1 ;
    klee_make_symbolic(&var_transfer_xor_1_p1, sizeof(int), "var_transfer_xor_1_p1");
  struct page *var_transfer_xor_1_p2 ;
  unsigned int var_transfer_xor_1_p3 ;
    klee_make_symbolic(&var_transfer_xor_1_p3, sizeof(int), "var_transfer_xor_1_p3");
  struct page *var_transfer_xor_1_p4 ;
  unsigned int var_transfer_xor_1_p5 ;
    klee_make_symbolic(&var_transfer_xor_1_p5, sizeof(int), "var_transfer_xor_1_p5");
  int var_transfer_xor_1_p6 ;
    klee_make_symbolic(&var_transfer_xor_1_p6, sizeof(int), "var_transfer_xor_1_p6");
  ...
  int res_lo_open_51 ;
    klee_make_symbolic(&res_lo_open_51, sizeof(int), "res_lo_open_51");
  struct gendisk *var_group3 ;
  fmode_t var_lo_release_52_p1 ;
  fmode_t var_lo_ioctl_45_p1 ;
  unsigned int var_lo_ioctl_45_p2 ;
    klee_make_symbolic(&var_lo_ioctl_45_p2, sizeof(int), "var_lo_ioctl_45_p2");
  unsigned long var_lo_ioctl_45_p3 ;
    klee_make_symbolic(&var_lo_ioctl_45_p3, sizeof(long), "var_lo_ioctl_45_p3");
  fmode_t var_lo_compat_ioctl_50_p1 ;
  unsigned int var_lo_compat_ioctl_50_p2 ;
    klee_make_symbolic(&var_lo_compat_ioctl_50_p2, sizeof(int), "var_lo_compat_ioctl_50_p2");
  unsigned long var_lo_compat_ioctl_50_p3 ;
    klee_make_symbolic(&var_lo_compat_ioctl_50_p3, sizeof(long), "var_lo_compat_ioctl_50_p3");
  int ldv_s_lo_fops_block_device_operations ;
    klee_make_symbolic(&ldv_s_lo_fops_block_device_operations, sizeof(int), "ldv_s_lo_fops_block_device_operations");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
