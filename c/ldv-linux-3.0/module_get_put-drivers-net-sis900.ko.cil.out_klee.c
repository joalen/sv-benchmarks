...
struct mii_phy {
   struct mii_phy *next ;
   int phy_addr ;
    klee_make_symbolic(&phy_addr, sizeof(int), "phy_addr");
   u16 phy_id0 ;
   u16 phy_id1 ;
   u16 status ;
   u8 phy_types ;
...
struct sis900_private {
   ...
   unsigned int cur_phy ;
    klee_make_symbolic(&cur_phy, sizeof(int), "cur_phy");
   struct mii_if_info mii_info ;
   struct timer_list timer ;
   u8 autong_complete ;
   u32 msg_enable ;
   unsigned int cur_rx ;
    klee_make_symbolic(&cur_rx, sizeof(int), "cur_rx");
   unsigned int dirty_rx ;
    klee_make_symbolic(&dirty_rx, sizeof(int), "dirty_rx");
   unsigned int cur_tx ;
    klee_make_symbolic(&cur_tx, sizeof(int), "cur_tx");
   unsigned int dirty_tx ;
    klee_make_symbolic(&dirty_tx, sizeof(int), "dirty_tx");
   ...
   unsigned int tx_full ;
    klee_make_symbolic(&tx_full, sizeof(int), "tx_full");
   u8 host_bridge_rev ;
   u8 chipset_rev ;
};
...
{ long ioaddr ;
    klee_make_symbolic(&ioaddr, sizeof(long), "ioaddr");
  u16 signature ;
  int i ;
...
{ long ioaddr ;
  long ee_addr ;
    klee_make_symbolic(&ee_addr, sizeof(long), "ee_addr");
  u32 waittime ;
  int i ;
  size_t __len ;
  void *__ret ;
...
static int mdio_read(struct net_device *net_dev , int phy_id , int location )
{ long mdio_addr ;
    klee_make_symbolic(&mdio_addr, sizeof(long), "mdio_addr");
  int mii_cmd ;
    klee_make_symbolic(&mii_cmd, sizeof(int), "mii_cmd");
  u16 retval ;
  int i ;
  int dataval ;
    klee_make_symbolic(&dataval, sizeof(int), "dataval");
  int tmp ;
  unsigned int tmp___0 ;
...
{ long mdio_addr ;
  ...
  int tmp ;
  int dataval___0 ;
    klee_make_symbolic(&dataval___0, sizeof(int), "dataval___0");
  int tmp___0 ;
...
{ struct sis900_private *sis_priv ;
  ...
  int i ;
  int maxcount ;
    klee_make_symbolic(&maxcount, sizeof(int), "maxcount");
  int tmp___0 ;
  int tmp___1 ;
  int tmp___2 ;
  int tmp___3 ;
...
{ struct net_device *net_dev ;
  ...
  struct mii_phy *mii_phy ;
  int next_tick ;
    klee_make_symbolic(&next_tick, sizeof(int), "next_tick");
  u16 status ;
  int speed ;
...
{ struct sis900_private *sis_priv ;
  ...
  unsigned int index_cur_tx ;
    klee_make_symbolic(&index_cur_tx, sizeof(int), "index_cur_tx");
  unsigned int index_dirty_tx ;
    klee_make_symbolic(&index_dirty_tx, sizeof(int), "index_dirty_tx");
  unsigned int count_dirty_tx ;
    klee_make_symbolic(&count_dirty_tx, sizeof(int), "count_dirty_tx");
...
{ struct net_device *net_dev ;
  ...
  void *tmp ;
  int boguscnt ;
    klee_make_symbolic(&boguscnt, sizeof(int), "boguscnt");
  long ioaddr ;
  u32 status ;
...
{ struct sis900_private *sis_priv ;
  ...
  u32 rx_status ;
  int rx_work_limit ;
    klee_make_symbolic(&rx_work_limit, sizeof(int), "rx_work_limit");
  unsigned int rx_size ;
    klee_make_symbolic(&rx_size, sizeof(int), "rx_size");
...
{ struct sis900_private *sis_priv ;
  void *tmp ;
  int rt ;
    klee_make_symbolic(&rt, sizeof(int), "rt");
...
{ struct sis900_private *sis_priv ;
  void *tmp ;
  long pmctrl_addr ;
    klee_make_symbolic(&pmctrl_addr, sizeof(long), "pmctrl_addr");
  u32 cfgpmcsr ;
  u32 pmctrl_bits ;
...
{ long ioaddr ;
  ...
  int i ;
  int table_entries ;
    klee_make_symbolic(&table_entries, sizeof(int), "table_entries");
  u32 rx_mode ;
...
{ struct net_device *var_group1 ;
  int res_sis900_open_15 ;
    klee_make_symbolic(&res_sis900_open_15, sizeof(int), "res_sis900_open_15");
  int res_sis900_close_30 ;
    klee_make_symbolic(&res_sis900_close_30, sizeof(int), "res_sis900_close_30");
  struct sk_buff *var_group2 ;
  struct ifmap *var_group3 ;
  struct ifreq *var_group4 ;
  int var_mii_ioctl_40_p2 ;
    klee_make_symbolic(&var_mii_ioctl_40_p2, sizeof(int), "var_mii_ioctl_40_p2");
  ...
  int res_sis900_probe_4 ;
    klee_make_symbolic(&res_sis900_probe_4, sizeof(int), "res_sis900_probe_4");
  pm_message_t var_sis900_suspend_46_p1 ;
  int var_sis900_interrupt_27_p0 ;
    klee_make_symbolic(&var_sis900_interrupt_27_p0, sizeof(int), "var_sis900_interrupt_27_p0");
  void *var_sis900_interrupt_27_p1 ;
  unsigned long var_sis900_timer_20_p0 ;
    klee_make_symbolic(&var_sis900_timer_20_p0, sizeof(long), "var_sis900_timer_20_p0");
  int ldv_s_sis900_netdev_ops_net_device_ops ;
    klee_make_symbolic(&ldv_s_sis900_netdev_ops_net_device_ops, sizeof(int), "ldv_s_sis900_netdev_ops_net_device_ops");
  int ldv_s_sis900_pci_driver_pci_driver ;
    klee_make_symbolic(&ldv_s_sis900_pci_driver_pci_driver, sizeof(int), "ldv_s_sis900_pci_driver_pci_driver");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
