...
struct usbdrv_wrap {
   struct device_driver driver ;
   int for_devices ;
    klee_make_symbolic(&for_devices, sizeof(int), "for_devices");
};
struct usb_driver {
   char const *name ;
...
struct urb {
   ...
   unsigned int stream_id ;
    klee_make_symbolic(&stream_id, sizeof(int), "stream_id");
   int status ;
...
struct usbdevfs_hub_portinfo {
   char nports ;
    klee_make_symbolic(&nports, sizeof(char), "nports");
   char port[127U] ;
};
...
struct usb_tt_clear {
   struct list_head clear_list ;
   unsigned int tt ;
    klee_make_symbolic(&tt, sizeof(int), "tt");
   u16 devinfo ;
   struct usb_hcd *hcd ;
   struct usb_host_endpoint *ep ;
};
...
struct usb_hub {
   ...
   int error ;
   int nerrors ;
    klee_make_symbolic(&nerrors, sizeof(int), "nerrors");
   ...
   unsigned int mA_per_port ;
    klee_make_symbolic(&mA_per_port, sizeof(int), "mA_per_port");
...
struct usb_class_driver {
   ...
   int minor_base ;
    klee_make_symbolic(&minor_base, sizeof(int), "minor_base");
};
struct usb_class {
   struct kref kref ;
   struct class *class ;
...
struct poll_table_struct {
   ...
   unsigned long key ;
    klee_make_symbolic(&key, sizeof(long), "key");
};
...
struct usbdevfs_setinterface {
   unsigned int interface ;
    klee_make_symbolic(&interface, sizeof(int), "interface");
   unsigned int altsetting ;
    klee_make_symbolic(&altsetting, sizeof(int), "altsetting");
};
struct usbdevfs_disconnectsignal {
   unsigned int signr ;
    klee_make_symbolic(&signr, sizeof(int), "signr");
   void *context ;
};
...
struct usbdevfs_connectinfo {
   unsigned int devnum ;
   unsigned char slow ;
    klee_make_symbolic(&slow, sizeof(char), "slow");
};
...
struct usbdevfs_urb {
   ...
   unsigned char endpoint ;
    klee_make_symbolic(&endpoint, sizeof(char), "endpoint");
   int status ;
   unsigned int flags ;
   void *buffer ;
   int buffer_length ;
    klee_make_symbolic(&buffer_length, sizeof(int), "buffer_length");
   int actual_length ;
   int start_frame ;
   int number_of_packets ;
   int error_count ;
...
struct usbdevfs_ioctl {
   int ifno ;
    klee_make_symbolic(&ifno, sizeof(int), "ifno");
   int ioctl_code ;
    klee_make_symbolic(&ioctl_code, sizeof(int), "ioctl_code");
   void *data ;
};
...
struct linux_binprm {
   ...
   unsigned long vma_pages ;
    klee_make_symbolic(&vma_pages, sizeof(long), "vma_pages");
   struct mm_struct *mm ;
   unsigned long p ;
   unsigned char cred_prepared : 1 ;
   unsigned char cap_effective : 1 ;
   unsigned int recursion_depth ;
    klee_make_symbolic(&recursion_depth, sizeof(int), "recursion_depth");
   struct file *file ;
   struct cred *cred ;
   int unsafe ;
    klee_make_symbolic(&unsafe, sizeof(int), "unsafe");
   unsigned int per_clear ;
    klee_make_symbolic(&per_clear, sizeof(int), "per_clear");
   int argc ;
    klee_make_symbolic(&argc, sizeof(int), "argc");
   int envc ;
    klee_make_symbolic(&envc, sizeof(int), "envc");
   char const *filename ;
   char const *interp ;
   unsigned int interp_flags ;
    klee_make_symbolic(&interp_flags, sizeof(int), "interp_flags");
   unsigned int interp_data ;
    klee_make_symbolic(&interp_data, sizeof(int), "interp_data");
   unsigned long loader ;
    klee_make_symbolic(&loader, sizeof(long), "loader");
   unsigned long exec ;
    klee_make_symbolic(&exec, sizeof(long), "exec");
};
struct coredump_params {
   ...
   struct file *file ;
   unsigned long limit ;
    klee_make_symbolic(&limit, sizeof(long), "limit");
   unsigned long mm_flags ;
    klee_make_symbolic(&mm_flags, sizeof(long), "mm_flags");
};
struct linux_binfmt {
   struct list_head lh ;
   struct module *module ;
   ...
   unsigned long min_coredump ;
    klee_make_symbolic(&min_coredump, sizeof(long), "min_coredump");
};
struct dev_state {
   struct list_head list ;
   struct usb_device *dev ;
   ...
   unsigned int discsignr ;
    klee_make_symbolic(&discsignr, sizeof(int), "discsignr");
   struct pid *disc_pid ;
   uid_t disc_uid ;
   uid_t disc_euid ;
   void *disccontext ;
   unsigned long ifclaimed ;
    klee_make_symbolic(&ifclaimed, sizeof(long), "ifclaimed");
   u32 secid ;
...
struct async {
   ...
   unsigned int signr ;
   unsigned int ifnum ;
    klee_make_symbolic(&ifnum, sizeof(int), "ifnum");
   void *userbuffer ;
   void *userurb ;
   struct urb *urb ;
   int status ;
...
struct mnt_pcp {
   int mnt_count ;
    klee_make_symbolic(&mnt_count, sizeof(int), "mnt_count");
   int mnt_writers ;
    klee_make_symbolic(&mnt_writers, sizeof(int), "mnt_writers");
};
struct vfsmount {
   ...
   int mnt_flags ;
    klee_make_symbolic(&mnt_flags, sizeof(int), "mnt_flags");
   ...
   struct mnt_namespace *mnt_ns ;
   int mnt_id ;
    klee_make_symbolic(&mnt_id, sizeof(int), "mnt_id");
   int mnt_group_id ;
    klee_make_symbolic(&mnt_group_id, sizeof(int), "mnt_group_id");
   int mnt_expiry_mark ;
    klee_make_symbolic(&mnt_expiry_mark, sizeof(int), "mnt_expiry_mark");
   int mnt_pinned ;
    klee_make_symbolic(&mnt_pinned, sizeof(int), "mnt_pinned");
   int mnt_ghosts ;
    klee_make_symbolic(&mnt_ghosts, sizeof(int), "mnt_ghosts");
};
...
struct open_intent {
   int flags ;
   int create_mode ;
    klee_make_symbolic(&create_mode, sizeof(int), "create_mode");
   struct file *file ;
};
...
struct nameidata {
   ...
   int last_type ;
    klee_make_symbolic(&last_type, sizeof(int), "last_type");
   unsigned int depth ;
...
struct match_token {
   int token ;
    klee_make_symbolic(&token, sizeof(int), "token");
   char const *pattern ;
};
...
static int nousb ;
    klee_make_symbolic(&nousb, sizeof(int), "nousb");
...
{ struct usb_device *dev ;
  ...
  unsigned int root_hub ;
    klee_make_symbolic(&root_hub, sizeof(int), "root_hub");
  void *tmp ;
...
{ unsigned long jiffies_expire ;
    klee_make_symbolic(&jiffies_expire, sizeof(long), "jiffies_expire");
  int tmp ;
...
{ int i ;
  ...
  int size ;
  unsigned int dtype ;
    klee_make_symbolic(&dtype, sizeof(int), "dtype");
  int tmp ;
...
{ struct usb_hub *hub ;
  ...
  unsigned int selector ;
    klee_make_symbolic(&selector, sizeof(int), "selector");
  unsigned int mode ;
...
{ struct usb_hub *hub ;
  ...
  unsigned int i ;
  unsigned long bits ;
    klee_make_symbolic(&bits, sizeof(long), "bits");
...
{ int port1 ;
    klee_make_symbolic(&port1, sizeof(int), "port1");
  unsigned int pgood_delay ;
    klee_make_symbolic(&pgood_delay, sizeof(int), "pgood_delay");
  unsigned int delay ;
...
{ struct usb_hcd *hcd ;
  ...
  unsigned int pipe ;
  int maxp ;
    klee_make_symbolic(&maxp, sizeof(int), "maxp");
  int ret ;
  char *message ;
  void *tmp ;
  void *tmp___0 ;
  ...
  int remaining ;
    klee_make_symbolic(&remaining, sizeof(int), "remaining");
  char *tmp___7 ;
  char *tmp___8 ;
...
static unsigned int highspeed_hubs ;
    klee_make_symbolic(&highspeed_hubs, sizeof(int), "highspeed_hubs");
...
{ unsigned long flags ;
  int wakeup ;
    klee_make_symbolic(&wakeup, sizeof(int), "wakeup");
  raw_spinlock_t *tmp ;
...
static int hub_port_wait_reset(struct usb_hub *hub , int port1 , struct usb_device *udev ,
                               unsigned int delay )
{ int delay_time ;
    klee_make_symbolic(&delay_time, sizeof(int), "delay_time");
  int ret ;
  u16 portstatus ;
  u16 portchange ;
  int tmp ;
...
{ int ret ;
  int total_time ;
    klee_make_symbolic(&total_time, sizeof(int), "total_time");
  int stable_time ;
    klee_make_symbolic(&stable_time, sizeof(int), "stable_time");
  u16 portchange ;
  u16 portstatus ;
  unsigned int connection ;
    klee_make_symbolic(&connection, sizeof(int), "connection");
...
{ struct usb_device *hdev ;
  ...
  unsigned int wHubCharacteristics ;
    klee_make_symbolic(&wHubCharacteristics, sizeof(int), "wHubCharacteristics");
  struct usb_device *udev ;
  int status ;
  int i ;
  char *tmp___0 ;
...
{ struct list_head *tmp ;
  ...
  int ret ;
  int connect_change ;
    klee_make_symbolic(&connect_change, sizeof(int), "connect_change");
  int tmp___0 ;
...
{ int __retval ;
    klee_make_symbolic(&__retval, sizeof(int), "__retval");
  int __ret ;
...
{ int changed ;
  ...
  unsigned int serial_len ;
    klee_make_symbolic(&serial_len, sizeof(int), "serial_len");
  unsigned int len ;
  unsigned int old_length ;
    klee_make_symbolic(&old_length, sizeof(int), "old_length");
  int length ;
  char *buf ;
  int tmp ;
  size_t tmp___0 ;
...
unsigned long usb_hcds_loaded ;
    klee_make_symbolic(&usb_hcds_loaded, sizeof(long), "usb_hcds_loaded");
...
{ struct usb_hcd *hcd ;
  ...
  struct list_head const *__mptr ;
  int is_in ;
    klee_make_symbolic(&is_in, sizeof(int), "is_in");
  char *s ;
  int tmp ;
  char *tmp___0 ;
  int tmp___1 ;
...
int usb_hcd_alloc_bandwidth(struct usb_device *udev , struct usb_host_config *new_config ,
                            struct usb_host_interface *cur_alt , struct usb_host_interface *new_alt )
{ int num_intfs ;
    klee_make_symbolic(&num_intfs, sizeof(int), "num_intfs");
  int i ;
  int j ;
  ...
  int iface_num ;
    klee_make_symbolic(&iface_num, sizeof(int), "iface_num");
...
{ struct usb_hcd *hcd ;
  ...
  int tmp___0 ;
  int is_out ;
    klee_make_symbolic(&is_out, sizeof(int), "is_out");
  int tmp___1 ;
  int is_control ;
    klee_make_symbolic(&is_control, sizeof(int), "is_control");
  int tmp___2 ;
...
{ struct usb_hcd *hcd ;
  ...
  int status ;
  int old_state ;
    klee_make_symbolic(&old_state, sizeof(int), "old_state");
  char *tmp ;
...
int usb_submit_urb(struct urb *urb , gfp_t mem_flags )
{ int xfertype ;
    klee_make_symbolic(&xfertype, sizeof(int), "xfertype");
  int max ;
  struct usb_device *dev ;
  struct usb_host_endpoint *ep ;
  int is_out ;
  ...
  int mult ;
    klee_make_symbolic(&mult, sizeof(int), "mult");
  int mult___0 ;
    klee_make_symbolic(&mult___0, sizeof(int), "mult___0");
  unsigned int orig_flags ;
    klee_make_symbolic(&orig_flags, sizeof(int), "orig_flags");
...
{ struct api_context ctx ;
  unsigned long expire ;
    klee_make_symbolic(&expire, sizeof(long), "expire");
  int retval ;
  long tmp ;
  unsigned long tmp___0 ;
  char *tmp___2 ;
...
{ struct urb *urb ;
  int retv ;
    klee_make_symbolic(&retv, sizeof(int), "retv");
  int length ;
...
{ int i ;
  int urb_flags ;
    klee_make_symbolic(&urb_flags, sizeof(int), "urb_flags");
  int use_sg ;
    klee_make_symbolic(&use_sg, sizeof(int), "use_sg");
  struct lock_class_key __key ;
  void *tmp ;
  struct urb *urb ;
  unsigned int len ;
...
{ int newlength ;
    klee_make_symbolic(&newlength, sizeof(int), "newlength");
  int oldlength ;
    klee_make_symbolic(&oldlength, sizeof(int), "oldlength");
...
{ int result ;
  int endp ;
    klee_make_symbolic(&endp, sizeof(int), "endp");
  unsigned int tmp ;
...
{ struct usb_interface *iface ;
  ...
  int ret ;
  int manual ;
    klee_make_symbolic(&manual, sizeof(int), "manual");
  unsigned int epaddr ;
    klee_make_symbolic(&epaddr, sizeof(int), "epaddr");
  unsigned int pipe ;
  unsigned int tmp___0 ;
  int i ;
  unsigned int tmp___1 ;
...
{ struct usb_interface_assoc_descriptor *retval ;
  struct usb_interface_assoc_descriptor *intf_assoc ;
  int first_intf ;
    klee_make_symbolic(&first_intf, sizeof(int), "first_intf");
  int last_intf ;
    klee_make_symbolic(&last_intf, sizeof(int), "last_intf");
  int i ;
...
{ int i ;
  ...
  int n ;
  int nintf ;
    klee_make_symbolic(&nintf, sizeof(int), "nintf");
  void *tmp___0 ;
  void *tmp___1 ;
  unsigned int tmp___2 ;
  struct usb_interface_cache *intfc ;
...
{ struct usb_dynid *dynid ;
  ...
  u32 idProduct ;
  int fields ;
    klee_make_symbolic(&fields, sizeof(int), "fields");
  int retval ;
  void *tmp ;
...
{ struct usb_ss_ep_comp_descriptor *desc ;
  int max_tx ;
    klee_make_symbolic(&max_tx, sizeof(int), "max_tx");
  int tmp ;
  int tmp___0 ;
  size_t __len ;
  void *__ret ;
...
{ unsigned char *buffer0 ;
  ...
  int asnum ;
    klee_make_symbolic(&asnum, sizeof(int), "asnum");
  struct usb_interface_cache *intfc ;
  struct usb_host_interface *alt ;
  int i ;
  int n ;
  ...
  int retval ;
  int num_ep ;
    klee_make_symbolic(&num_ep, sizeof(int), "num_ep");
  int num_ep_orig ;
    klee_make_symbolic(&num_ep_orig, sizeof(int), "num_ep_orig");
  size_t __len ;
  void *__ret ;
  char const *tmp ;
  void *tmp___0 ;
...
{ struct device *ddev ;
  unsigned char *buffer0 ;
  int cfgno ;
    klee_make_symbolic(&cfgno, sizeof(int), "cfgno");
  int nintf ;
  int nintf_orig ;
    klee_make_symbolic(&nintf_orig, sizeof(int), "nintf_orig");
  int i ;
  int j ;
  int n ;
  struct usb_interface_cache *intfc ;
  ...
  int size2 ;
    klee_make_symbolic(&size2, sizeof(int), "size2");
  struct usb_descriptor_header *header ;
  int len ;
  int retval ;
  u8 inums[32U] ;
  ...
  unsigned int iad_num ;
    klee_make_symbolic(&iad_num, sizeof(int), "iad_num");
  size_t __len ;
  void *__ret ;
  char const *tmp ;
  struct usb_interface_descriptor *d ;
...
{ struct device *ddev ;
  int ncfg ;
    klee_make_symbolic(&ncfg, sizeof(int), "ncfg");
  int result ;
  unsigned int cfgno ;
  unsigned int length ;
...
{ struct inode *var_group1 ;
  ...
  int res_usb_open_0 ;
    klee_make_symbolic(&res_usb_open_0, sizeof(int), "res_usb_open_0");
  int ldv_s_usb_fops_file_operations ;
    klee_make_symbolic(&ldv_s_usb_fops_file_operations, sizeof(int), "ldv_s_usb_fops_file_operations");
  int tmp ;
  int tmp___0 ;
...
{ struct usb_device *udev ;
  struct device const *__mptr ;
  int duration ;
    klee_make_symbolic(&duration, sizeof(int), "duration");
  unsigned int tmp ;
  unsigned int tmp___0 ;
  int tmp___1 ;
...
{ int level_warned ;
    klee_make_symbolic(&level_warned, sizeof(int), "level_warned");
...
{ struct ep_device *ep ;
  struct device const *__mptr ;
  char unit ;
    klee_make_symbolic(&unit, sizeof(char), "unit");
...
extern unsigned long kernel_stack ;
    klee_make_symbolic(&kernel_stack, sizeof(long), "kernel_stack");
__inline static struct thread_info *current_thread_info(void)
{ struct thread_info *ti ;
  unsigned long pfo_ret__ ;
    klee_make_symbolic(&pfo_ret__, sizeof(long), "pfo_ret__");
...
static int usbfs_snoop ;
    klee_make_symbolic(&usbfs_snoop, sizeof(int), "usbfs_snoop");
...
{ struct dev_state *ps ;
  ...
  unsigned int alloclen ;
    klee_make_symbolic(&alloclen, sizeof(int), "alloclen");
  unsigned int _min1 ;
  unsigned int _min2 ;
  unsigned int tmp___1 ;
  int tmp___2 ;
...
{ struct usb_device *dev ;
  ...
  unsigned int tmo ;
    klee_make_symbolic(&tmo, sizeof(int), "tmo");
  unsigned char *tbuf ;
  unsigned int wLength ;
    klee_make_symbolic(&wLength, sizeof(int), "wLength");
  int i ;
  int pipe ;
  int ret ;
  unsigned long tmp ;
  ...
  __u16 tmp___3 ;
  unsigned long flag ;
    klee_make_symbolic(&flag, sizeof(long), "flag");
  unsigned long roksum ;
    klee_make_symbolic(&roksum, sizeof(long), "roksum");
...
{ struct usb_device *dev ;
  ...
  unsigned int tmo ;
  unsigned int len1 ;
    klee_make_symbolic(&len1, sizeof(int), "len1");
  unsigned int pipe ;
  int len2 ;
    klee_make_symbolic(&len2, sizeof(int), "len2");
  unsigned char *tbuf ;
  int i ;
  int ret ;
  unsigned long tmp ;
...
{ int u ;
    klee_make_symbolic(&u, sizeof(int), "u");
  int status ;
  struct usb_host_config *actconfig ;
  int __ret_gu ;
  unsigned long __val_gu ;
...
{ struct usbdevfs_iso_packet_desc *isopkt ;
  ...
  unsigned int u ;
  unsigned int totlen ;
    klee_make_symbolic(&totlen, sizeof(int), "totlen");
  unsigned int isofrmlen ;
    klee_make_symbolic(&isofrmlen, sizeof(int), "isofrmlen");
  int ret ;
  int ifnum ;
  int is_in ;
  int tmp___0 ;
...
{ struct urb *urb ;
  ...
  int __pu_val___0 ;
    klee_make_symbolic(&__pu_val___0, sizeof(int), "__pu_val___0");
  int __ret_pu___1 ;
    klee_make_symbolic(&__ret_pu___1, sizeof(int), "__ret_pu___1");
  int __pu_val___1 ;
    klee_make_symbolic(&__pu_val___1, sizeof(int), "__pu_val___1");
  int __ret_pu___2 ;
    klee_make_symbolic(&__ret_pu___2, sizeof(int), "__ret_pu___2");
  unsigned int __pu_val___2 ;
    klee_make_symbolic(&__pu_val___2, sizeof(int), "__pu_val___2");
  int __ret_pu___3 ;
    klee_make_symbolic(&__ret_pu___3, sizeof(int), "__ret_pu___3");
  unsigned int __pu_val___3 ;
    klee_make_symbolic(&__pu_val___3, sizeof(int), "__pu_val___3");
  int tmp___0 ;
  int __ret_pu___4 ;
    klee_make_symbolic(&__ret_pu___4, sizeof(int), "__ret_pu___4");
  void *__pu_val___4 ;
...
{ struct usbdevfs_bulktransfer *p ;
  ...
  int __ret_gu___0 ;
    klee_make_symbolic(&__ret_gu___0, sizeof(int), "__ret_gu___0");
  unsigned long __val_gu___0 ;
    klee_make_symbolic(&__val_gu___0, sizeof(long), "__val_gu___0");
  int __ret_pu___0 ;
  unsigned int __pu_val___0 ;
  int __ret_gu___1 ;
    klee_make_symbolic(&__ret_gu___1, sizeof(int), "__ret_gu___1");
  unsigned long __val_gu___1 ;
    klee_make_symbolic(&__val_gu___1, sizeof(long), "__val_gu___1");
  int __ret_pu___1 ;
  unsigned int __pu_val___1 ;
  int __ret_gu___2 ;
    klee_make_symbolic(&__ret_gu___2, sizeof(int), "__ret_gu___2");
  unsigned long __val_gu___2 ;
    klee_make_symbolic(&__val_gu___2, sizeof(long), "__val_gu___2");
  int __ret_pu___2 ;
  void *__pu_val___2 ;
  int tmp___0 ;
...
{ __u32 uptr ;
  ...
  long tmp___0 ;
  int __gu_err ;
    klee_make_symbolic(&__gu_err, sizeof(int), "__gu_err");
  unsigned long __gu_val ;
    klee_make_symbolic(&__gu_val, sizeof(long), "__gu_val");
  int tmp___1 ;
  int __gu_err___0 ;
    klee_make_symbolic(&__gu_err___0, sizeof(int), "__gu_err___0");
  unsigned long __gu_val___0 ;
    klee_make_symbolic(&__gu_val___0, sizeof(long), "__gu_val___0");
  int tmp___2 ;
  int __gu_err___1 ;
    klee_make_symbolic(&__gu_err___1, sizeof(int), "__gu_err___1");
  unsigned long __gu_val___1 ;
    klee_make_symbolic(&__gu_val___1, sizeof(long), "__gu_val___1");
  int tmp___3 ;
  int __gu_err___2 ;
    klee_make_symbolic(&__gu_err___2, sizeof(int), "__gu_err___2");
  unsigned long __gu_val___2 ;
    klee_make_symbolic(&__gu_val___2, sizeof(long), "__gu_val___2");
  int tmp___4 ;
  int __gu_err___3 ;
    klee_make_symbolic(&__gu_err___3, sizeof(int), "__gu_err___3");
  unsigned long __gu_val___3 ;
    klee_make_symbolic(&__gu_val___3, sizeof(long), "__gu_val___3");
  int tmp___5 ;
  int __gu_err___4 ;
    klee_make_symbolic(&__gu_err___4, sizeof(int), "__gu_err___4");
  unsigned long __gu_val___4 ;
    klee_make_symbolic(&__gu_val___4, sizeof(long), "__gu_val___4");
  int tmp___6 ;
  int __gu_err___5 ;
    klee_make_symbolic(&__gu_err___5, sizeof(int), "__gu_err___5");
  unsigned long __gu_val___5 ;
    klee_make_symbolic(&__gu_val___5, sizeof(long), "__gu_val___5");
  int tmp___7 ;
  int __gu_err___6 ;
    klee_make_symbolic(&__gu_err___6, sizeof(int), "__gu_err___6");
  unsigned long __gu_val___6 ;
    klee_make_symbolic(&__gu_val___6, sizeof(long), "__gu_val___6");
  int tmp___8 ;
  int __gu_err___7 ;
    klee_make_symbolic(&__gu_err___7, sizeof(int), "__gu_err___7");
  unsigned long __gu_val___7 ;
    klee_make_symbolic(&__gu_val___7, sizeof(long), "__gu_val___7");
  int tmp___9 ;
  int __gu_err___8 ;
    klee_make_symbolic(&__gu_err___8, sizeof(int), "__gu_err___8");
  unsigned long __gu_val___8 ;
    klee_make_symbolic(&__gu_val___8, sizeof(long), "__gu_val___8");
  int tmp___10 ;
  int __gu_err___9 ;
    klee_make_symbolic(&__gu_err___9, sizeof(int), "__gu_err___9");
  unsigned long __gu_val___9 ;
    klee_make_symbolic(&__gu_val___9, sizeof(long), "__gu_val___9");
  int tmp___11 ;
  int __gu_err___10 ;
    klee_make_symbolic(&__gu_err___10, sizeof(int), "__gu_err___10");
  unsigned long __gu_val___10 ;
    klee_make_symbolic(&__gu_val___10, sizeof(long), "__gu_val___10");
  int tmp___12 ;
...
{ unsigned int portnum ;
    klee_make_symbolic(&portnum, sizeof(int), "portnum");
  int rc ;
  int __ret_gu ;
  unsigned long __val_gu ;
  struct task_struct *tmp ;
...
{ int i ;
  int num_configs ;
    klee_make_symbolic(&num_configs, sizeof(int), "num_configs");
  int insufficient_power ;
    klee_make_symbolic(&insufficient_power, sizeof(int), "insufficient_power");
...
{ int ix ;
    klee_make_symbolic(&ix, sizeof(int), "ix");
...
{ char dir ;
    klee_make_symbolic(&dir, sizeof(char), "dir");
  char unit ;
  char *type ;
  unsigned int interval ;
  unsigned int bandwidth ;
    klee_make_symbolic(&bandwidth, sizeof(int), "bandwidth");
  int tmp___0 ;
  int tmp___1 ;
  unsigned int tmp___2 ;
  int tmp___3 ;
...
{ int chix ;
    klee_make_symbolic(&chix, sizeof(int), "chix");
  int ret ;
  int cnt ;
    klee_make_symbolic(&cnt, sizeof(int), "cnt");
  int parent_devnum ;
    klee_make_symbolic(&parent_devnum, sizeof(int), "parent_devnum");
  char *pages_start ;
  char *data_end ;
  char *speed ;
  unsigned int length ;
...
{ struct hc_driver *driver ;
  ...
  int region ;
    klee_make_symbolic(&region, sizeof(int), "region");
...
static int usbfs_mount_count ;
    klee_make_symbolic(&usbfs_mount_count, sizeof(int), "usbfs_mount_count");
static int ignore_mount = 0;
static struct dentry *devices_usbfs_dentry ;
static int num_buses ;
    klee_make_symbolic(&num_buses, sizeof(int), "num_buses");
static uid_t devuid ;
static uid_t busuid ;
...
{ char *p ;
  int option ;
    klee_make_symbolic(&option, sizeof(int), "option");
  substring_t args[3U] ;
  int token ;
  int tmp ;
  int tmp___0 ;
...
{ char name[8U] ;
  int i ;
  int i_size ;
    klee_make_symbolic(&i_size, sizeof(int), "i_size");
  struct usb_config_descriptor *config ;
