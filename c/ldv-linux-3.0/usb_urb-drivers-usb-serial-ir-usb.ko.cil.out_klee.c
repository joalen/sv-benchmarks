...
{ unsigned char *buf ;
  ...
  unsigned long __flags ;
    klee_make_symbolic(&__flags, sizeof(long), "__flags");
  unsigned int __ret ;
  ...
  unsigned char *__buf ;
  unsigned long __n ;
    klee_make_symbolic(&__n, sizeof(long), "__n");
  size_t __recsize ;
...
{ struct urb *urb ;
  ...
  speed_t baud ;
  int ir_baud___0 ;
    klee_make_symbolic(&ir_baud___0, sizeof(int), "ir_baud___0");
  void *tmp___7 ;
  unsigned int tmp___8 ;
...
static int res_ir_open_4 ;
    klee_make_symbolic(&res_ir_open_4, sizeof(int), "res_ir_open_4");
int main(void)
{ struct tty_struct *var_group1 ;
  ...
  int ldv_s_ir_device_usb_serial_driver ;
    klee_make_symbolic(&ldv_s_ir_device_usb_serial_driver, sizeof(int), "ldv_s_ir_device_usb_serial_driver");
  int tmp___8 ;
  int tmp___9 ;
