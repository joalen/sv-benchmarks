...
struct reply_t {
   int resp_code ;
    klee_make_symbolic(&resp_code, sizeof(int), "resp_code");
   int min_ConState ;
    klee_make_symbolic(&min_ConState, sizeof(int), "min_ConState");
   int max_ConState ;
    klee_make_symbolic(&max_ConState, sizeof(int), "max_ConState");
   int parameter ;
    klee_make_symbolic(&parameter, sizeof(int), "parameter");
   int new_ConState ;
    klee_make_symbolic(&new_ConState, sizeof(int), "new_ConState");
   int timeout ;
   int action[3U] ;
   char *command ;
};
...
struct inbuf_t {
   struct cardstate *cs ;
   int inputstate ;
    klee_make_symbolic(&inputstate, sizeof(int), "inputstate");
   int head ;
...
struct isowbuf_t {
   int read ;
   int nextread ;
    klee_make_symbolic(&nextread, sizeof(int), "nextread");
   int write ;
    klee_make_symbolic(&write, sizeof(int), "write");
   atomic_t writesem ;
   int wbits ;
    klee_make_symbolic(&wbits, sizeof(int), "wbits");
   unsigned char data[4112U] ;
   unsigned char idle ;
    klee_make_symbolic(&idle, sizeof(char), "idle");
};
struct urb;
...
struct at_state_t {
   struct list_head list ;
   int waiting ;
    klee_make_symbolic(&waiting, sizeof(int), "waiting");
   int getstring ;
    klee_make_symbolic(&getstring, sizeof(int), "getstring");
   unsigned int timer_index ;
    klee_make_symbolic(&timer_index, sizeof(int), "timer_index");
   unsigned long timer_expires ;
   int timer_active ;
    klee_make_symbolic(&timer_active, sizeof(int), "timer_active");
   unsigned int ConState ;
    klee_make_symbolic(&ConState, sizeof(int), "ConState");
   struct reply_t *replystruct ;
   int cid ;
    klee_make_symbolic(&cid, sizeof(int), "cid");
   int int_var[3U] ;
   char *str_var[5U] ;
   unsigned int pending_commands ;
    klee_make_symbolic(&pending_commands, sizeof(int), "pending_commands");
   unsigned int seq_index ;
    klee_make_symbolic(&seq_index, sizeof(int), "seq_index");
   struct cardstate *cs ;
   struct bc_state *bcs ;
};
struct event_t {
...
struct bc_state {
   ...
   int corrupted ;
    klee_make_symbolic(&corrupted, sizeof(int), "corrupted");
   int trans_down ;
    klee_make_symbolic(&trans_down, sizeof(int), "trans_down");
   int trans_up ;
    klee_make_symbolic(&trans_up, sizeof(int), "trans_up");
   struct at_state_t at_state ;
   unsigned int rx_bufsize ;
    klee_make_symbolic(&rx_bufsize, sizeof(int), "rx_bufsize");
   ...
   unsigned int chstate ;
    klee_make_symbolic(&chstate, sizeof(int), "chstate");
   int ignore ;
    klee_make_symbolic(&ignore, sizeof(int), "ignore");
   unsigned int proto2 ;
    klee_make_symbolic(&proto2, sizeof(int), "proto2");
   char *commands[7U] ;
   int emptycount ;
    klee_make_symbolic(&emptycount, sizeof(int), "emptycount");
   int busy ;
    klee_make_symbolic(&busy, sizeof(int), "busy");
   int use_count ;
    klee_make_symbolic(&use_count, sizeof(int), "use_count");
   union __anonunion_hw_193 hw ;
   void *ap ;
   int apconnstate ;
    klee_make_symbolic(&apconnstate, sizeof(int), "apconnstate");
   spinlock_t aplock ;
};
struct cmdbuf_t;
...
struct cardstate {
   ...
   unsigned int minor_index ;
    klee_make_symbolic(&minor_index, sizeof(int), "minor_index");
   struct device *dev ;
   ...
   int mode ;
   int mstate ;
    klee_make_symbolic(&mstate, sizeof(int), "mstate");
   int cmd_result ;
    klee_make_symbolic(&cmd_result, sizeof(int), "cmd_result");
   int channels ;
    klee_make_symbolic(&channels, sizeof(int), "channels");
   struct bc_state *bcs ;
   int onechannel ;
    klee_make_symbolic(&onechannel, sizeof(int), "onechannel");
   spinlock_t lock ;
   struct at_state_t at_state ;
   ...
   spinlock_t cmdlock ;
   unsigned int curlen ;
    klee_make_symbolic(&curlen, sizeof(int), "curlen");
   unsigned int cmdbytes ;
    klee_make_symbolic(&cmdbytes, sizeof(int), "cmdbytes");
   unsigned int open_count ;
    klee_make_symbolic(&open_count, sizeof(int), "open_count");
   struct tty_struct *tty ;
   struct tasklet_struct if_wake_tasklet ;
   unsigned int control_state ;
    klee_make_symbolic(&control_state, sizeof(int), "control_state");
   unsigned int fwver[4U] ;
   int gotfwver ;
    klee_make_symbolic(&gotfwver, sizeof(int), "gotfwver");
   unsigned int running ;
   unsigned int connected ;
    klee_make_symbolic(&connected, sizeof(int), "connected");
   unsigned int isdn_up ;
    klee_make_symbolic(&isdn_up, sizeof(int), "isdn_up");
   unsigned int cidmode ;
    klee_make_symbolic(&cidmode, sizeof(int), "cidmode");
   int myid ;
    klee_make_symbolic(&myid, sizeof(int), "myid");
   void *iif ;
   unsigned short hw_hdr_len ;
    klee_make_symbolic(&hw_hdr_len, sizeof(short), "hw_hdr_len");
   struct reply_t *tabnocid ;
   struct reply_t *tabcid ;
   int cs_init ;
    klee_make_symbolic(&cs_init, sizeof(int), "cs_init");
   int ignoreframes ;
    klee_make_symbolic(&ignoreframes, sizeof(int), "ignoreframes");
   struct mutex mutex ;
   struct timer_list timer ;
   int retry_count ;
    klee_make_symbolic(&retry_count, sizeof(int), "retry_count");
   int dle ;
    klee_make_symbolic(&dle, sizeof(int), "dle");
   int cur_at_seq ;
    klee_make_symbolic(&cur_at_seq, sizeof(int), "cur_at_seq");
   int curchannel ;
    klee_make_symbolic(&curchannel, sizeof(int), "curchannel");
   int commands_pending ;
    klee_make_symbolic(&commands_pending, sizeof(int), "commands_pending");
   struct tasklet_struct event_tasklet ;
   struct tasklet_struct write_tasklet ;
   struct event_t events[64U] ;
   unsigned int ev_tail ;
    klee_make_symbolic(&ev_tail, sizeof(int), "ev_tail");
   unsigned int ev_head ;
    klee_make_symbolic(&ev_head, sizeof(int), "ev_head");
   spinlock_t ev_lock ;
   unsigned char respdata[512U] ;
   unsigned int cbytes ;
    klee_make_symbolic(&cbytes, sizeof(int), "cbytes");
...
struct gigaset_driver {
   ...
   unsigned int have_tty ;
    klee_make_symbolic(&have_tty, sizeof(int), "have_tty");
   unsigned int minor ;
...
struct bas_bc_state {
   ...
   unsigned int numsub ;
    klee_make_symbolic(&numsub, sizeof(int), "numsub");
   ...
   int isoinstatus ;
    klee_make_symbolic(&isoinstatus, sizeof(int), "isoinstatus");
   int loststatus ;
    klee_make_symbolic(&loststatus, sizeof(int), "loststatus");
   unsigned int isoinlost ;
    klee_make_symbolic(&isoinlost, sizeof(int), "isoinlost");
   unsigned int seqlen ;
    klee_make_symbolic(&seqlen, sizeof(int), "seqlen");
   unsigned int inbyte ;
    klee_make_symbolic(&inbyte, sizeof(int), "inbyte");
   unsigned int inbits ;
    klee_make_symbolic(&inbits, sizeof(int), "inbits");
   unsigned int goodbytes ;
    klee_make_symbolic(&goodbytes, sizeof(int), "goodbytes");
   unsigned int alignerrs ;
    klee_make_symbolic(&alignerrs, sizeof(int), "alignerrs");
   unsigned int fcserrs ;
    klee_make_symbolic(&fcserrs, sizeof(int), "fcserrs");
   unsigned int frameerrs ;
    klee_make_symbolic(&frameerrs, sizeof(int), "frameerrs");
   unsigned int giants ;
    klee_make_symbolic(&giants, sizeof(int), "giants");
   unsigned int runts ;
    klee_make_symbolic(&runts, sizeof(int), "runts");
   unsigned int aborts ;
    klee_make_symbolic(&aborts, sizeof(int), "aborts");
   unsigned int shared0s ;
    klee_make_symbolic(&shared0s, sizeof(int), "shared0s");
   unsigned int stolen0s ;
    klee_make_symbolic(&stolen0s, sizeof(int), "stolen0s");
...
struct capiloaddatapart {
   int user ;
    klee_make_symbolic(&user, sizeof(int), "user");
   int len ;
   unsigned char *data ;
};
...
struct capicardparams {
   ...
   unsigned int irq ;
   int cardtype ;
    klee_make_symbolic(&cardtype, sizeof(int), "cardtype");
   int cardnr ;
    klee_make_symbolic(&cardnr, sizeof(int), "cardnr");
   unsigned int membase ;
    klee_make_symbolic(&membase, sizeof(int), "membase");
};
...
struct capi_ctr {
   ...
   unsigned long nrecvctlpkt ;
    klee_make_symbolic(&nrecvctlpkt, sizeof(long), "nrecvctlpkt");
   unsigned long nrecvdatapkt ;
    klee_make_symbolic(&nrecvdatapkt, sizeof(long), "nrecvdatapkt");
   unsigned long nsentctlpkt ;
    klee_make_symbolic(&nsentctlpkt, sizeof(long), "nsentctlpkt");
   unsigned long nsentdatapkt ;
    klee_make_symbolic(&nsentdatapkt, sizeof(long), "nsentdatapkt");
   int cnr ;
    klee_make_symbolic(&cnr, sizeof(int), "cnr");
   unsigned short state ;
   int blocked ;
   int traceflag ;
    klee_make_symbolic(&traceflag, sizeof(int), "traceflag");
...
int gigaset_debuglevel ;
    klee_make_symbolic(&gigaset_debuglevel, sizeof(int), "gigaset_debuglevel");
...
{ unsigned int n ;
  ...
  unsigned int bytesleft ;
    klee_make_symbolic(&bytesleft, sizeof(int), "bytesleft");
  long tmp ;
  long tmp___0 ;
  size_t __len ;
  void *__ret ;
...
{ struct cardstate *cs ;
  ...
  int int_arg ;
    klee_make_symbolic(&int_arg, sizeof(int), "int_arg");
...
{ struct cardstate *cs ;
  unsigned int iflag ;
    klee_make_symbolic(&iflag, sizeof(int), "iflag");
  unsigned int cflag ;
    klee_make_symbolic(&cflag, sizeof(int), "cflag");
  unsigned int old_cflag ;
    klee_make_symbolic(&old_cflag, sizeof(int), "old_cflag");
  unsigned int control_state ;
...
{ struct tty_struct *var_group1 ;
  ...
  int res_if_open_2 ;
    klee_make_symbolic(&res_if_open_2, sizeof(int), "res_if_open_2");
  unsigned int var_if_ioctl_4_p1 ;
    klee_make_symbolic(&var_if_ioctl_4_p1, sizeof(int), "var_if_ioctl_4_p1");
  unsigned long var_if_ioctl_4_p2 ;
    klee_make_symbolic(&var_if_ioctl_4_p2, sizeof(long), "var_if_ioctl_4_p2");
  unsigned char const *var_if_write_7_p1 ;
  int var_if_write_7_p2 ;
    klee_make_symbolic(&var_if_write_7_p2, sizeof(int), "var_if_write_7_p2");
  struct ktermios *var_group3 ;
  unsigned int var_if_tiocmset_6_p1 ;
    klee_make_symbolic(&var_if_tiocmset_6_p1, sizeof(int), "var_if_tiocmset_6_p1");
  unsigned int var_if_tiocmset_6_p2 ;
    klee_make_symbolic(&var_if_tiocmset_6_p2, sizeof(int), "var_if_tiocmset_6_p2");
  int ldv_s_if_ops_tty_operations ;
    klee_make_symbolic(&ldv_s_if_ops_tty_operations, sizeof(int), "ldv_s_if_ops_tty_operations");
  int tmp ;
  int tmp___0 ;
...
{ unsigned char *argv[11U] ;
  int params ;
    klee_make_symbolic(&params, sizeof(int), "params");
  int i ;
  int j ;
  ...
  int curarg ;
    klee_make_symbolic(&curarg, sizeof(int), "curarg");
  unsigned long flags ;
  unsigned int next ;
  unsigned int tail ;
  unsigned int head ;
  ...
  int resp_code ;
  int param_type ;
    klee_make_symbolic(&param_type, sizeof(int), "param_type");
  int abort ;
    klee_make_symbolic(&abort, sizeof(int), "abort");
  size_t len ;
  int cid ;
  int rawstring ;
    klee_make_symbolic(&rawstring, sizeof(int), "rawstring");
  long tmp ;
  int tmp___0 ;
  int tmp___1 ;
  long tmp___2 ;
...
{ struct bc_state *bcs ;
  ...
  struct reply_t *rep ;
  int rcode ;
    klee_make_symbolic(&rcode, sizeof(int), "rcode");
  int genresp ;
    klee_make_symbolic(&genresp, sizeof(int), "genresp");
  int resp_code ;
  int sendcid ;
    klee_make_symbolic(&sendcid, sizeof(int), "sendcid");
  struct at_state_t *at_state ;
  int index ;
  int curact ;
    klee_make_symbolic(&curact, sizeof(int), "curact");
  unsigned long flags ;
  long tmp ;
  long tmp___0 ;
  int tmp___1 ;
...
{ struct event_t *ev ;
  ...
  int i ;
  int check_flags ;
    klee_make_symbolic(&check_flags, sizeof(int), "check_flags");
  int was_busy ;
    klee_make_symbolic(&was_busy, sizeof(int), "was_busy");
  unsigned long flags ;
  raw_spinlock_t *tmp ;
  raw_spinlock_t *tmp___0 ;
  raw_spinlock_t *tmp___1 ;
...
{ unsigned char *src ;
  ...
  unsigned int procbytes ;
    klee_make_symbolic(&procbytes, sizeof(int), "procbytes");
  unsigned char c ;
  unsigned char *tmp ;
...
{ struct cardstate *cs ;
  unsigned int numbytes ;
    klee_make_symbolic(&numbytes, sizeof(int), "numbytes");
  unsigned int procbytes ;
  long tmp ;
  int tmp___0 ;
  long tmp___1 ;
...
{ struct sk_buff *hdlc_skb ;
  ...
  unsigned int stuf_cnt ;
    klee_make_symbolic(&stuf_cnt, sizeof(int), "stuf_cnt");
  int tmp ;
  unsigned char *tmp___0 ;
  int tmp___1 ;
  size_t __len ;
...
{ int __i ;
    klee_make_symbolic(&__i, sizeof(int), "__i");
...
{ struct cardstate *cs ;
  ...
  unsigned int msgsize ;
    klee_make_symbolic(&msgsize, sizeof(int), "msgsize");
  unsigned long flags ;
  int i ;
  int tmp ;
  int tmp___0 ;
...
{ struct cardstate *cs ;
  ...
  unsigned long flags ;
  int prevconnstate ;
    klee_make_symbolic(&prevconnstate, sizeof(int), "prevconnstate");
  raw_spinlock_t *tmp ;
...
{ struct cardstate *cs ;
  ...
  int l ;
  int lbc ;
    klee_make_symbolic(&lbc, sizeof(int), "lbc");
  int lhlc ;
    klee_make_symbolic(&lhlc, sizeof(int), "lhlc");
  u16 info ;
  raw_spinlock_t *tmp ;
  void *tmp___0 ;
  u8 *tmp___1 ;
...
static unsigned long ignored_msg_dump_time ;
    klee_make_symbolic(&ignored_msg_dump_time, sizeof(long), "ignored_msg_dump_time");
