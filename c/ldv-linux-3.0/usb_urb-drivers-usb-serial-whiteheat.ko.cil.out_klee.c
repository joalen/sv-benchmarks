...
struct serial_struct {
   ...
   int flags ;
   int xmit_fifo_size ;
    klee_make_symbolic(&xmit_fifo_size, sizeof(int), "xmit_fifo_size");
   int custom_divisor ;
    klee_make_symbolic(&custom_divisor, sizeof(int), "custom_divisor");
   int baud_base ;
    klee_make_symbolic(&baud_base, sizeof(int), "baud_base");
   unsigned short close_delay ;
   char io_type ;
    klee_make_symbolic(&io_type, sizeof(char), "io_type");
   char reserved_char[1] ;
   int hub6 ;
    klee_make_symbolic(&hub6, sizeof(int), "hub6");
   unsigned short closing_wait ;
   unsigned short closing_wait2 ;
    klee_make_symbolic(&closing_wait2, sizeof(short), "closing_wait2");
   unsigned char *iomem_base ;
   unsigned short iomem_reg_shift ;
    klee_make_symbolic(&iomem_reg_shift, sizeof(short), "iomem_reg_shift");
   unsigned int port_high ;
    klee_make_symbolic(&port_high, sizeof(int), "port_high");
   unsigned long iomap_base ;
    klee_make_symbolic(&iomap_base, sizeof(long), "iomap_base");
};
struct serial_icounter_struct {
   int cts ;
...
struct usb_serial_port {
   ...
   int interrupt_out_size ;
    klee_make_symbolic(&interrupt_out_size, sizeof(int), "interrupt_out_size");
   struct urb *interrupt_out_urb ;
   __u8 interrupt_out_endpointAddress ;
   unsigned char *bulk_in_buffer ;
   int bulk_in_size ;
    klee_make_symbolic(&bulk_in_size, sizeof(int), "bulk_in_size");
   struct urb *read_urb ;
   __u8 bulk_in_endpointAddress ;
   unsigned char *bulk_out_buffer ;
   int bulk_out_size ;
    klee_make_symbolic(&bulk_out_size, sizeof(int), "bulk_out_size");
   struct urb *write_urb ;
   struct kfifo write_fifo ;
   int write_urb_busy ;
    klee_make_symbolic(&write_urb_busy, sizeof(int), "write_urb_busy");
   unsigned char *bulk_out_buffers[2] ;
   struct urb *write_urbs[2] ;
   unsigned long write_urbs_free ;
    klee_make_symbolic(&write_urbs_free, sizeof(long), "write_urbs_free");
   __u8 bulk_out_endpointAddress ;
   int tx_bytes ;
    klee_make_symbolic(&tx_bytes, sizeof(int), "tx_bytes");
   unsigned long flags ;
   wait_queue_head_t write_wait ;
   struct work_struct work ;
   char throttled ;
    klee_make_symbolic(&throttled, sizeof(char), "throttled");
   char throttle_req ;
    klee_make_symbolic(&throttle_req, sizeof(char), "throttle_req");
   unsigned long sysrq ;
    klee_make_symbolic(&sysrq, sizeof(long), "sysrq");
   struct device dev ;
...
struct usb_serial {
   ...
   unsigned char num_ports ;
    klee_make_symbolic(&num_ports, sizeof(char), "num_ports");
   unsigned char num_port_pointers ;
    klee_make_symbolic(&num_port_pointers, sizeof(char), "num_port_pointers");
   char num_interrupt_in ;
    klee_make_symbolic(&num_interrupt_in, sizeof(char), "num_interrupt_in");
   char num_interrupt_out ;
    klee_make_symbolic(&num_interrupt_out, sizeof(char), "num_interrupt_out");
   char num_bulk_in ;
    klee_make_symbolic(&num_bulk_in, sizeof(char), "num_bulk_in");
   char num_bulk_out ;
    klee_make_symbolic(&num_bulk_out, sizeof(char), "num_bulk_out");
...
static int whiteheat_firmware_download(struct usb_serial *serial , struct usb_device_id const *id )
{ int response ;
    klee_make_symbolic(&response, sizeof(int), "response");
  int ret ;
...
{ struct usb_serial_port *command_port ;
  ...
  int ret ;
  int alen ;
    klee_make_symbolic(&alen, sizeof(int), "alen");
  __u8 *command ;
  __u8 *result ;
  int i ;
  int j ;
...
{ struct usb_serial *serial ;
  ...
  int sent ;
    klee_make_symbolic(&sent, sizeof(int), "sent");
  unsigned long flags ;
  struct list_head *tmp___8 ;
...
{ struct usb_serial_port *port ;
  ...
  struct list_head *tmp___8 ;
  int room ;
    klee_make_symbolic(&room, sizeof(int), "room");
  unsigned long flags ;
  raw_spinlock_t *tmp___9 ;
...
{ struct usb_serial_port *port ;
  ...
  unsigned int modem_signals ;
    klee_make_symbolic(&modem_signals, sizeof(int), "modem_signals");
...
{ struct usb_serial_port *port ;
  ...
  int actually_throttled ;
    klee_make_symbolic(&actually_throttled, sizeof(int), "actually_throttled");
...
static int res_whiteheat_firmware_download_0 ;
    klee_make_symbolic(&res_whiteheat_firmware_download_0, sizeof(int), "res_whiteheat_firmware_download_0");
static int res_whiteheat_open_4 ;
    klee_make_symbolic(&res_whiteheat_open_4, sizeof(int), "res_whiteheat_open_4");
int main(void)
{ struct usb_serial *var_group1 ;
  ...
  int var_whiteheat_write_6_p3 ;
    klee_make_symbolic(&var_whiteheat_write_6_p3, sizeof(int), "var_whiteheat_write_6_p3");
  unsigned int var_whiteheat_ioctl_10_p1 ;
    klee_make_symbolic(&var_whiteheat_ioctl_10_p1, sizeof(int), "var_whiteheat_ioctl_10_p1");
  unsigned long var_whiteheat_ioctl_10_p2 ;
    klee_make_symbolic(&var_whiteheat_ioctl_10_p2, sizeof(long), "var_whiteheat_ioctl_10_p2");
  struct ktermios *var_whiteheat_set_termios_11_p2 ;
  int var_whiteheat_break_ctl_12_p1 ;
    klee_make_symbolic(&var_whiteheat_break_ctl_12_p1, sizeof(int), "var_whiteheat_break_ctl_12_p1");
  unsigned int var_whiteheat_tiocmset_9_p1 ;
    klee_make_symbolic(&var_whiteheat_tiocmset_9_p1, sizeof(int), "var_whiteheat_tiocmset_9_p1");
  unsigned int var_whiteheat_tiocmset_9_p2 ;
    klee_make_symbolic(&var_whiteheat_tiocmset_9_p2, sizeof(int), "var_whiteheat_tiocmset_9_p2");
  struct urb *var_group4 ;
  int tmp___7 ;
  int ldv_s_whiteheat_fake_device_usb_serial_driver ;
    klee_make_symbolic(&ldv_s_whiteheat_fake_device_usb_serial_driver, sizeof(int), "ldv_s_whiteheat_fake_device_usb_serial_driver");
  int ldv_s_whiteheat_device_usb_serial_driver ;
    klee_make_symbolic(&ldv_s_whiteheat_device_usb_serial_driver, sizeof(int), "ldv_s_whiteheat_device_usb_serial_driver");
  int tmp___8 ;
  int tmp___9 ;
