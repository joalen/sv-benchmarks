...
struct can_priv {
   ...
   int restart_ms ;
    klee_make_symbolic(&restart_ms, sizeof(int), "restart_ms");
   ...
   unsigned int echo_skb_max ;
    klee_make_symbolic(&echo_skb_max, sizeof(int), "echo_skb_max");
...
struct ems_usb {
   struct can_priv can ;
   int open_time ;
    klee_make_symbolic(&open_time, sizeof(int), "open_time");
...
static int res_ems_usb_open_10 ;
    klee_make_symbolic(&res_ems_usb_open_10, sizeof(int), "res_ems_usb_open_10");
static int res_ems_usb_close_12 ;
    klee_make_symbolic(&res_ems_usb_close_12, sizeof(int), "res_ems_usb_close_12");
static int res_ems_usb_probe_16 ;
    klee_make_symbolic(&res_ems_usb_probe_16, sizeof(int), "res_ems_usb_probe_16");
int main(void)
{ struct net_device *var_group1 ;
  ...
  int ldv_s_ems_usb_netdev_ops_net_device_ops ;
    klee_make_symbolic(&ldv_s_ems_usb_netdev_ops_net_device_ops, sizeof(int), "ldv_s_ems_usb_netdev_ops_net_device_ops");
  int ldv_s_ems_usb_driver_usb_driver ;
    klee_make_symbolic(&ldv_s_ems_usb_driver_usb_driver, sizeof(int), "ldv_s_ems_usb_driver_usb_driver");
  int tmp___8 ;
  int tmp___9 ;
