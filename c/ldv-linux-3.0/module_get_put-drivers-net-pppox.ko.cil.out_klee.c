...
struct sockaddr_pppox {
   ...
   unsigned int sa_protocol ;
    klee_make_symbolic(&sa_protocol, sizeof(int), "sa_protocol");
...
struct pptp_opt {
   ...
   u32 seq_recv ;
   int ppp_flags ;
    klee_make_symbolic(&ppp_flags, sizeof(int), "ppp_flags");
};
struct linux_binprm {
   char buf[128U] ;
...
{ struct net *var_group1 ;
  ...
  int var_pppox_create_4_p2 ;
    klee_make_symbolic(&var_pppox_create_4_p2, sizeof(int), "var_pppox_create_4_p2");
  int var_pppox_create_4_p3 ;
    klee_make_symbolic(&var_pppox_create_4_p3, sizeof(int), "var_pppox_create_4_p3");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
