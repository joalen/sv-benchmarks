...
struct fstioc_info {
   ...
   unsigned int smcFirmwareVersion ;
    klee_make_symbolic(&smcFirmwareVersion, sizeof(int), "smcFirmwareVersion");
   unsigned long kernelVersion ;
    klee_make_symbolic(&kernelVersion, sizeof(long), "kernelVersion");
   unsigned short lineInterface ;
    klee_make_symbolic(&lineInterface, sizeof(short), "lineInterface");
   unsigned char proto ;
    klee_make_symbolic(&proto, sizeof(char), "proto");
   unsigned char internalClock ;
    klee_make_symbolic(&internalClock, sizeof(char), "internalClock");
   unsigned int lineSpeed ;
    klee_make_symbolic(&lineSpeed, sizeof(int), "lineSpeed");
   unsigned int v24IpSts ;
    klee_make_symbolic(&v24IpSts, sizeof(int), "v24IpSts");
   unsigned int v24OpSts ;
    klee_make_symbolic(&v24OpSts, sizeof(int), "v24OpSts");
   unsigned short clockStatus ;
    klee_make_symbolic(&clockStatus, sizeof(short), "clockStatus");
   unsigned short cableStatus ;
    klee_make_symbolic(&cableStatus, sizeof(short), "cableStatus");
   unsigned short cardMode ;
    klee_make_symbolic(&cardMode, sizeof(short), "cardMode");
   unsigned short debug ;
    klee_make_symbolic(&debug, sizeof(short), "debug");
   unsigned char transparentMode ;
    klee_make_symbolic(&transparentMode, sizeof(char), "transparentMode");
   unsigned char invertClock ;
    klee_make_symbolic(&invertClock, sizeof(char), "invertClock");
   unsigned char startingSlot ;
    klee_make_symbolic(&startingSlot, sizeof(char), "startingSlot");
   unsigned char clockSource ;
    klee_make_symbolic(&clockSource, sizeof(char), "clockSource");
   unsigned char framing ;
    klee_make_symbolic(&framing, sizeof(char), "framing");
   unsigned char structure ;
    klee_make_symbolic(&structure, sizeof(char), "structure");
   unsigned char interface ;
    klee_make_symbolic(&interface, sizeof(char), "interface");
   unsigned char coding ;
    klee_make_symbolic(&coding, sizeof(char), "coding");
   unsigned char lineBuildOut ;
    klee_make_symbolic(&lineBuildOut, sizeof(char), "lineBuildOut");
   unsigned char equalizer ;
    klee_make_symbolic(&equalizer, sizeof(char), "equalizer");
   unsigned char loopMode ;
    klee_make_symbolic(&loopMode, sizeof(char), "loopMode");
   unsigned char range ;
    klee_make_symbolic(&range, sizeof(char), "range");
   unsigned char txBufferMode ;
    klee_make_symbolic(&txBufferMode, sizeof(char), "txBufferMode");
   unsigned char rxBufferMode ;
    klee_make_symbolic(&rxBufferMode, sizeof(char), "rxBufferMode");
   unsigned char losThreshold ;
    klee_make_symbolic(&losThreshold, sizeof(char), "losThreshold");
   unsigned char idleCode ;
    klee_make_symbolic(&idleCode, sizeof(char), "idleCode");
   unsigned int receiveBufferDelay ;
    klee_make_symbolic(&receiveBufferDelay, sizeof(int), "receiveBufferDelay");
   unsigned int framingErrorCount ;
    klee_make_symbolic(&framingErrorCount, sizeof(int), "framingErrorCount");
   unsigned int codeViolationCount ;
    klee_make_symbolic(&codeViolationCount, sizeof(int), "codeViolationCount");
   unsigned int crcErrorCount ;
    klee_make_symbolic(&crcErrorCount, sizeof(int), "crcErrorCount");
   int lineAttenuation ;
    klee_make_symbolic(&lineAttenuation, sizeof(int), "lineAttenuation");
   unsigned short lossOfSignal ;
    klee_make_symbolic(&lossOfSignal, sizeof(short), "lossOfSignal");
   unsigned short receiveRemoteAlarm ;
    klee_make_symbolic(&receiveRemoteAlarm, sizeof(short), "receiveRemoteAlarm");
   unsigned short alarmIndicationSignal ;
    klee_make_symbolic(&alarmIndicationSignal, sizeof(short), "alarmIndicationSignal");
};
...
struct fst_port_info {
   ...
   int index ;
   int hwif ;
    klee_make_symbolic(&hwif, sizeof(int), "hwif");
   int run ;
    klee_make_symbolic(&run, sizeof(int), "run");
   int mode ;
   int rxpos ;
    klee_make_symbolic(&rxpos, sizeof(int), "rxpos");
   int txpos ;
    klee_make_symbolic(&txpos, sizeof(int), "txpos");
   int txipos ;
    klee_make_symbolic(&txipos, sizeof(int), "txipos");
   int start ;
   int txqs ;
    klee_make_symbolic(&txqs, sizeof(int), "txqs");
   int txqe ;
    klee_make_symbolic(&txqe, sizeof(int), "txqe");
   struct sk_buff *txq[16U] ;
   int rxqdepth ;
    klee_make_symbolic(&rxqdepth, sizeof(int), "rxqdepth");
};
struct fst_card_info {
   char *mem ;
   char *ctlmem ;
   unsigned int phys_mem ;
    klee_make_symbolic(&phys_mem, sizeof(int), "phys_mem");
   unsigned int phys_ctlmem ;
    klee_make_symbolic(&phys_ctlmem, sizeof(int), "phys_ctlmem");
   unsigned int irq ;
   unsigned int nports ;
   unsigned int type ;
   unsigned int state ;
   ...
   unsigned short pci_conf ;
    klee_make_symbolic(&pci_conf, sizeof(short), "pci_conf");
   struct fst_port_info ports[4U] ;
   struct pci_dev *device ;
   int card_no ;
    klee_make_symbolic(&card_no, sizeof(int), "card_no");
   int family ;
   int dmarx_in_progress ;
    klee_make_symbolic(&dmarx_in_progress, sizeof(int), "dmarx_in_progress");
   int dmatx_in_progress ;
    klee_make_symbolic(&dmatx_in_progress, sizeof(int), "dmatx_in_progress");
   unsigned long int_count ;
    klee_make_symbolic(&int_count, sizeof(long), "int_count");
   unsigned long int_time_ave ;
    klee_make_symbolic(&int_time_ave, sizeof(long), "int_time_ave");
   ...
   int dma_len_rx ;
    klee_make_symbolic(&dma_len_rx, sizeof(int), "dma_len_rx");
   int dma_len_tx ;
    klee_make_symbolic(&dma_len_tx, sizeof(int), "dma_len_tx");
   int dma_txpos ;
    klee_make_symbolic(&dma_txpos, sizeof(int), "dma_txpos");
   int dma_rxpos ;
    klee_make_symbolic(&dma_rxpos, sizeof(int), "dma_rxpos");
};
...
{ unsigned char interrupt_line_register ;
    klee_make_symbolic(&interrupt_line_register, sizeof(char), "interrupt_line_register");
  unsigned long j ;
    klee_make_symbolic(&j, sizeof(long), "j");
  unsigned int regval ;
    klee_make_symbolic(&regval, sizeof(int), "regval");
  int tmp ;
  int tmp___0 ;
...
{ struct net_device *dev ;
  int pi ;
    klee_make_symbolic(&pi, sizeof(int), "pi");
  int rx_status ;
    klee_make_symbolic(&rx_status, sizeof(int), "rx_status");
  size_t __len ;
  void *__ret ;
...
{ struct fst_card_info *card ;
  unsigned short mbval ;
    klee_make_symbolic(&mbval, sizeof(short), "mbval");
  unsigned long flags ;
  int safety ;
...
{ int signals ;
    klee_make_symbolic(&signals, sizeof(int), "signals");
  unsigned int tmp ;
  int tmp___0 ;
  int tmp___1 ;
  int tmp___2 ;
...
{ unsigned char dmabits ;
    klee_make_symbolic(&dmabits, sizeof(char), "dmabits");
  int pi ;
  int rxp ;
    klee_make_symbolic(&rxp, sizeof(int), "rxp");
  int rx_status ;
  unsigned short len ;
  struct sk_buff *skb ;
  struct net_device *dev ;
...
{ struct fst_port_info *port ;
  int pi ;
  int txq_length ;
    klee_make_symbolic(&txq_length, sizeof(int), "txq_length");
  struct sk_buff *skb ;
  unsigned long flags ;
  struct net_device *dev ;
  raw_spinlock_t *tmp ;
...
{ struct fst_port_info *port ;
  int pi ;
  int rx_count ;
    klee_make_symbolic(&rx_count, sizeof(int), "rx_count");
  unsigned char tmp ;
...
{ struct fst_card_info *card ;
  struct fst_port_info *port ;
  int rdidx ;
    klee_make_symbolic(&rdidx, sizeof(int), "rdidx");
  int wridx ;
    klee_make_symbolic(&wridx, sizeof(int), "wridx");
  int event ;
  unsigned int dma_intcsr ;
    klee_make_symbolic(&dma_intcsr, sizeof(int), "dma_intcsr");
  unsigned int do_card_interrupt ;
    klee_make_symbolic(&do_card_interrupt, sizeof(int), "do_card_interrupt");
  unsigned int int_retry_count ;
    klee_make_symbolic(&int_retry_count, sizeof(int), "int_retry_count");
  unsigned char tmp ;
  unsigned char tmp___0 ;
  unsigned char tmp___1 ;
...
{ int err ;
  ...
  unsigned char my_framing ;
    klee_make_symbolic(&my_framing, sizeof(char), "my_framing");
...
{ struct fst_port_info *port ;
  ...
  unsigned char tx_dma_done ;
    klee_make_symbolic(&tx_dma_done, sizeof(char), "tx_dma_done");
  unsigned char rx_dma_done ;
    klee_make_symbolic(&rx_dma_done, sizeof(char), "rx_dma_done");
  struct hdlc_device *tmp ;
...
{ int no_of_cards_added ;
    klee_make_symbolic(&no_of_cards_added, sizeof(int), "no_of_cards_added");
  struct fst_card_info *card ;
  int err ;
  int i ;
  bool __print_once ;
...
{ struct net_device *var_group1 ;
  int res_fst_open_36 ;
    klee_make_symbolic(&res_fst_open_36, sizeof(int), "res_fst_open_36");
  int res_fst_close_37 ;
    klee_make_symbolic(&res_fst_close_37, sizeof(int), "res_fst_close_37");
  struct ifreq *var_group2 ;
  int var_fst_ioctl_33_p2 ;
    klee_make_symbolic(&var_fst_ioctl_33_p2, sizeof(int), "var_fst_ioctl_33_p2");
  struct pci_dev *var_group3 ;
  struct pci_device_id const *var_fst_add_one_42_p1 ;
  int res_fst_add_one_42 ;
    klee_make_symbolic(&res_fst_add_one_42, sizeof(int), "res_fst_add_one_42");
  int var_fst_intr_27_p0 ;
    klee_make_symbolic(&var_fst_intr_27_p0, sizeof(int), "var_fst_intr_27_p0");
  void *var_fst_intr_27_p1 ;
  int ldv_s_fst_ops_net_device_ops ;
    klee_make_symbolic(&ldv_s_fst_ops_net_device_ops, sizeof(int), "ldv_s_fst_ops_net_device_ops");
  int ldv_s_fst_driver_pci_driver ;
    klee_make_symbolic(&ldv_s_fst_driver_pci_driver, sizeof(int), "ldv_s_fst_driver_pci_driver");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
