...
struct iowarrior {
   ...
   unsigned char serial_number ;
    klee_make_symbolic(&serial_number, sizeof(char), "serial_number");
   ...
   int present ;
    klee_make_symbolic(&present, sizeof(int), "present");
   int opened ;
    klee_make_symbolic(&opened, sizeof(int), "opened");
   char chip_serial[9] ;
   int report_size ;
...
{ struct iowarrior *dev ;
  int intr_idx ;
    klee_make_symbolic(&intr_idx, sizeof(int), "intr_idx");
  int read_idx ;
    klee_make_symbolic(&read_idx, sizeof(int), "read_idx");
  int aux_idx ;
    klee_make_symbolic(&aux_idx, sizeof(int), "aux_idx");
  int offset ;
  int status ;
  int retval ;
...
{ struct iowarrior *dev ;
  ...
  int retval ;
  int io_res ;
    klee_make_symbolic(&io_res, sizeof(int), "io_res");
  void *tmp___7 ;
  unsigned long tmp___8 ;
...
static int res_iowarrior_open_9 ;
    klee_make_symbolic(&res_iowarrior_open_9, sizeof(int), "res_iowarrior_open_9");
static int res_iowarrior_probe_13 ;
    klee_make_symbolic(&res_iowarrior_probe_13, sizeof(int), "res_iowarrior_probe_13");
int main(void)
{ struct file *var_group1 ;
  ...
  unsigned int var_iowarrior_ioctl_8_p1 ;
    klee_make_symbolic(&var_iowarrior_ioctl_8_p1, sizeof(int), "var_iowarrior_ioctl_8_p1");
  unsigned long var_iowarrior_ioctl_8_p2 ;
    klee_make_symbolic(&var_iowarrior_ioctl_8_p2, sizeof(long), "var_iowarrior_ioctl_8_p2");
  ...
  int ldv_s_iowarrior_fops_file_operations ;
    klee_make_symbolic(&ldv_s_iowarrior_fops_file_operations, sizeof(int), "ldv_s_iowarrior_fops_file_operations");
  int ldv_s_iowarrior_driver_usb_driver ;
    klee_make_symbolic(&ldv_s_iowarrior_driver_usb_driver, sizeof(int), "ldv_s_iowarrior_driver_usb_driver");
  int tmp___8 ;
  int tmp___9 ;
