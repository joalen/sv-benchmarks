...
struct __anonstruct_bits_195 {
   unsigned char sa6 ;
    klee_make_symbolic(&sa6, sizeof(char), "sa6");
   unsigned char sa5 ;
    klee_make_symbolic(&sa5, sizeof(char), "sa5");
   unsigned char sa4 ;
    klee_make_symbolic(&sa4, sizeof(char), "sa4");
   unsigned char sa3 ;
    klee_make_symbolic(&sa3, sizeof(char), "sa3");
};
...
struct __anonstruct_bits_196 {
   unsigned char sa2 ;
    klee_make_symbolic(&sa2, sizeof(char), "sa2");
   unsigned char sa1 ;
    klee_make_symbolic(&sa1, sizeof(char), "sa1");
...
struct __anonstruct_bits_197 {
   unsigned char addr1_6 ;
    klee_make_symbolic(&addr1_6, sizeof(char), "addr1_6");
   unsigned char addr1_5 ;
    klee_make_symbolic(&addr1_5, sizeof(char), "addr1_5");
   unsigned char addr1_4 ;
    klee_make_symbolic(&addr1_4, sizeof(char), "addr1_4");
   unsigned char addr1_3 ;
    klee_make_symbolic(&addr1_3, sizeof(char), "addr1_3");
};
...
struct __anonstruct_bits_198 {
   unsigned char addr2_6 ;
    klee_make_symbolic(&addr2_6, sizeof(char), "addr2_6");
   unsigned char addr2_5 ;
    klee_make_symbolic(&addr2_5, sizeof(char), "addr2_5");
   unsigned char addr2_4 ;
    klee_make_symbolic(&addr2_4, sizeof(char), "addr2_4");
   unsigned char addr2_3 ;
    klee_make_symbolic(&addr2_3, sizeof(char), "addr2_3");
};
...
struct __anonstruct_bits_199 {
   unsigned char addr1_2 ;
    klee_make_symbolic(&addr1_2, sizeof(char), "addr1_2");
   unsigned char addr1_1 ;
    klee_make_symbolic(&addr1_1, sizeof(char), "addr1_1");
   unsigned char addr2_2 ;
    klee_make_symbolic(&addr2_2, sizeof(char), "addr2_2");
   unsigned char addr2_1 ;
    klee_make_symbolic(&addr2_1, sizeof(char), "addr2_1");
};
...
struct __anonstruct_bits_200 {
   unsigned char Octet3 ;
    klee_make_symbolic(&Octet3, sizeof(char), "Octet3");
   unsigned char Octet4 ;
    klee_make_symbolic(&Octet4, sizeof(char), "Octet4");
   unsigned char Octet5 ;
    klee_make_symbolic(&Octet5, sizeof(char), "Octet5");
   unsigned char Octet6 ;
    klee_make_symbolic(&Octet6, sizeof(char), "Octet6");
};
...
struct __anonstruct_bits_201 {
   ...
   unsigned char Octet1 ;
    klee_make_symbolic(&Octet1, sizeof(char), "Octet1");
   unsigned char Octet2 ;
    klee_make_symbolic(&Octet2, sizeof(char), "Octet2");
};
...
struct tx_ring {
   ...
   int since_irq ;
    klee_make_symbolic(&since_irq, sizeof(int), "since_irq");
};
...
{ struct pci_dev *pdev ;
  ...
  int i2c_wack ;
    klee_make_symbolic(&i2c_wack, sizeof(int), "i2c_wack");
  int writeok ;
    klee_make_symbolic(&writeok, sizeof(int), "writeok");
  u32 status ;
  u32 val ;
  int tmp ;
  int tmp___0 ;
...
{ struct pci_dev *pdev ;
  ...
  int tmp ;
  int write_failed ;
    klee_make_symbolic(&write_failed, sizeof(int), "write_failed");
  int i ;
  u8 eedata[4U] ;
  int tmp___0 ;
...
void ConfigFlowControl(struct et131x_adapter *etdev )
{ char remote_pause ;
    klee_make_symbolic(&remote_pause, sizeof(char), "remote_pause");
  char remote_async_pause ;
    klee_make_symbolic(&remote_async_pause, sizeof(char), "remote_async_pause");
...
int et131x_tx_dma_memory_alloc(struct et131x_adapter *adapter )
{ int desc_size ;
    klee_make_symbolic(&desc_size, sizeof(int), "desc_size");
  struct tx_ring *tx_ring ;
  void *tmp ;
  void *tmp___0 ;
  void *tmp___1 ;
...
{ struct pci_dev *var_group1 ;
  ...
  int res_et131x_pci_setup_11 ;
    klee_make_symbolic(&res_et131x_pci_setup_11, sizeof(int), "res_et131x_pci_setup_11");
  unsigned long var_et131x_error_timer_handler_2_p0 ;
    klee_make_symbolic(&var_et131x_error_timer_handler_2_p0, sizeof(long), "var_et131x_error_timer_handler_2_p0");
  int ldv_s_et131x_driver_pci_driver ;
    klee_make_symbolic(&ldv_s_et131x_driver_pci_driver, sizeof(int), "ldv_s_et131x_driver_pci_driver");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
