...
struct bio {
   ...
   unsigned short bi_idx ;
    klee_make_symbolic(&bi_idx, sizeof(short), "bi_idx");
   ...
   unsigned int bi_max_vecs ;
    klee_make_symbolic(&bi_max_vecs, sizeof(int), "bi_max_vecs");
   unsigned int bi_comp_cpu ;
    klee_make_symbolic(&bi_comp_cpu, sizeof(int), "bi_comp_cpu");
   atomic_t bi_cnt ;
...
struct writeback_control {
   ...
   unsigned long wb_start ;
    klee_make_symbolic(&wb_start, sizeof(long), "wb_start");
   long nr_to_write ;
    klee_make_symbolic(&nr_to_write, sizeof(long), "nr_to_write");
   long pages_skipped ;
    klee_make_symbolic(&pages_skipped, sizeof(long), "pages_skipped");
   loff_t range_start ;
   loff_t range_end ;
...
struct bdi_writeback {
   ...
   unsigned long last_active ;
    klee_make_symbolic(&last_active, sizeof(long), "last_active");
   struct task_struct *task ;
...
struct io_context {
   ...
   unsigned short ioprio_changed ;
    klee_make_symbolic(&ioprio_changed, sizeof(short), "ioprio_changed");
   unsigned short cgroup_changed ;
    klee_make_symbolic(&cgroup_changed, sizeof(short), "cgroup_changed");
...
struct request_list {
   ...
   int starved[2U] ;
   int elvpriv ;
    klee_make_symbolic(&elvpriv, sizeof(int), "elvpriv");
   mempool_t *rq_pool ;
...
struct request {
   ...
   unsigned int cmd_flags ;
    klee_make_symbolic(&cmd_flags, sizeof(int), "cmd_flags");
...
struct request_queue {
   ...
   unsigned long flush_pending_since ;
    klee_make_symbolic(&flush_pending_since, sizeof(long), "flush_pending_since");
...
struct blk_plug {
   ...
   unsigned int should_sort ;
    klee_make_symbolic(&should_sort, sizeof(int), "should_sort");
};
struct blk_integrity_exchg {
   ...
   unsigned short sector_size ;
    klee_make_symbolic(&sector_size, sizeof(short), "sector_size");
...
struct packet_command {
   ...
   unsigned char data_direction ;
    klee_make_symbolic(&data_direction, sizeof(char), "data_direction");
   int quiet ;
    klee_make_symbolic(&quiet, sizeof(int), "quiet");
   int timeout ;
   void *reserved[1U] ;
};
...
struct packet_stats {
   unsigned long pkt_started ;
    klee_make_symbolic(&pkt_started, sizeof(long), "pkt_started");
   unsigned long pkt_ended ;
    klee_make_symbolic(&pkt_ended, sizeof(long), "pkt_ended");
   unsigned long secs_w ;
    klee_make_symbolic(&secs_w, sizeof(long), "secs_w");
   unsigned long secs_rg ;
    klee_make_symbolic(&secs_rg, sizeof(long), "secs_rg");
   unsigned long secs_r ;
    klee_make_symbolic(&secs_r, sizeof(long), "secs_r");
};
struct packet_cdrw {
...
struct packet_iosched {
   atomic_t attention ;
   int writing ;
    klee_make_symbolic(&writing, sizeof(int), "writing");
   spinlock_t lock ;
   struct bio_list read_queue ;
   struct bio_list write_queue ;
   sector_t last_write ;
   int successive_reads ;
    klee_make_symbolic(&successive_reads, sizeof(int), "successive_reads");
};
...
struct packet_data {
   ...
   int write_size ;
    klee_make_symbolic(&write_size, sizeof(int), "write_size");
   struct bio *w_bio ;
   sector_t sector ;
   int frames ;
    klee_make_symbolic(&frames, sizeof(int), "frames");
   enum packet_data_state state ;
   atomic_t run_sm ;
   long sleep_time ;
    klee_make_symbolic(&sleep_time, sizeof(long), "sleep_time");
   atomic_t io_wait ;
   atomic_t io_errors ;
   struct bio *r_bios[128U] ;
   struct page *pages[64U] ;
   int cache_valid ;
    klee_make_symbolic(&cache_valid, sizeof(int), "cache_valid");
   int id ;
...
struct pktcdvd_device {
   ...
   int write_speed ;
    klee_make_symbolic(&write_speed, sizeof(int), "write_speed");
   int read_speed ;
    klee_make_symbolic(&read_speed, sizeof(int), "read_speed");
   ...
   int bio_queue_size ;
    klee_make_symbolic(&bio_queue_size, sizeof(int), "bio_queue_size");
   ...
   int write_congestion_off ;
    klee_make_symbolic(&write_congestion_off, sizeof(int), "write_congestion_off");
   int write_congestion_on ;
    klee_make_symbolic(&write_congestion_on, sizeof(int), "write_congestion_on");
   struct device *dev ;
...
static int pktdev_major ;
    klee_make_symbolic(&pktdev_major, sizeof(int), "pktdev_major");
...
{ int tmp ;
  struct bio *bio ;
  int reads_queued ;
    klee_make_symbolic(&reads_queued, sizeof(int), "reads_queued");
  int writes_queued ;
    klee_make_symbolic(&writes_queued, sizeof(int), "writes_queued");
  int tmp___0 ;
  int tmp___1 ;
  int need_write_seek ;
    klee_make_symbolic(&need_write_seek, sizeof(int), "need_write_seek");
  int tmp___2 ;
  int tmp___3 ;
...
{ unsigned int copy_size ;
    klee_make_symbolic(&copy_size, sizeof(int), "copy_size");
...
{ int f ;
  ...
  int offs ;
    klee_make_symbolic(&offs, sizeof(int), "offs");
  void *vfrom ;
  void *tmp ;
  void *vto ;
  void *tmp___0 ;
...
{ int frames_read ;
    klee_make_symbolic(&frames_read, sizeof(int), "frames_read");
  struct bio *bio ;
  int f ;
  char written[128U] ;
  int tmp ;
  long tmp___0 ;
  int first_frame ;
    klee_make_symbolic(&first_frame, sizeof(int), "first_frame");
  int num_frames ;
    klee_make_symbolic(&num_frames, sizeof(int), "num_frames");
  long tmp___1 ;
  long tmp___2 ;
  struct bio_vec *vec ;
  int p ;
...
{ struct bio *bio ;
  int f ;
  int frames_write ;
    klee_make_symbolic(&frames_write, sizeof(int), "frames_write");
  struct bio_vec *bvec ;
  int segment ;
    klee_make_symbolic(&segment, sizeof(int), "segment");
  int src_offs ;
    klee_make_symbolic(&src_offs, sizeof(int), "src_offs");
  int first_frame ;
  int num_frames ;
  long tmp ;
  long tmp___0 ;
...
{ int uptodate ;
    klee_make_symbolic(&uptodate, sizeof(int), "uptodate");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
  int tmp___2 ;
...
{ struct pktcdvd_device *pd ;
  struct packet_data *pkt ;
  long min_sleep_time ;
    klee_make_symbolic(&min_sleep_time, sizeof(long), "min_sleep_time");
  long residue ;
    klee_make_symbolic(&residue, sizeof(long), "residue");
  struct task_struct *tmp ;
  wait_queue_t wait ;
...
{ struct packet_command cgc ;
  ...
  int ret ;
  int track ;
    klee_make_symbolic(&track, sizeof(int), "track");
  int tmp ;
  int tmp___0 ;
  __u32 tmp___1 ;
  __u32 tmp___2 ;
...
{ struct packet_command cgc ;
  ...
  int offset ;
  int num_spdb ;
    klee_make_symbolic(&num_spdb, sizeof(int), "num_spdb");
...
{ struct packet_command cgc ;
  ...
  unsigned int size ;
  unsigned int st ;
    klee_make_symbolic(&st, sizeof(int), "st");
  unsigned int sp ;
  int ret ;
...
{ int ret ;
  ...
  unsigned int media_write_speed ;
    klee_make_symbolic(&media_write_speed, sizeof(int), "media_write_speed");
...
{ int ret ;
  long lba ;
    klee_make_symbolic(&lba, sizeof(long), "lba");
  struct request_queue *q ;
  int tmp ;
...
{ struct pktcdvd_device *pd ;
  ...
  struct packet_data *pkt ;
  int was_empty ;
    klee_make_symbolic(&was_empty, sizeof(int), "was_empty");
  int blocked_bio ;
    klee_make_symbolic(&blocked_bio, sizeof(int), "blocked_bio");
  struct pkt_rb_node *node ;
  char const *tmp ;
  ...
  sector_t last_zone ;
  int first_sectors ;
    klee_make_symbolic(&first_sectors, sizeof(int), "first_sectors");
  long tmp___3 ;
  long tmp___4 ;
  struct list_head const *__mptr ;
  struct list_head const *__mptr___0 ;
...
{ struct pktcdvd_device *pd ;
  ...
  int remaining2 ;
    klee_make_symbolic(&remaining2, sizeof(int), "remaining2");
  int _max1 ;
  int _max2 ;
  int tmp ;
  long tmp___0 ;
...
{ struct kobject *var_group1 ;
  ...
  int res_pkt_debugfs_fops_open_15 ;
    klee_make_symbolic(&res_pkt_debugfs_fops_open_15, sizeof(int), "res_pkt_debugfs_fops_open_15");
  int res_pkt_seq_open_80 ;
    klee_make_symbolic(&res_pkt_seq_open_80, sizeof(int), "res_pkt_seq_open_80");
  struct block_device *var_group5 ;
  fmode_t var_pkt_open_73_p1 ;
  int res_pkt_open_73 ;
    klee_make_symbolic(&res_pkt_open_73, sizeof(int), "res_pkt_open_73");
  struct gendisk *var_group6 ;
  fmode_t var_pkt_close_74_p1 ;
  fmode_t var_pkt_ioctl_82_p1 ;
  unsigned int var_pkt_ioctl_82_p2 ;
    klee_make_symbolic(&var_pkt_ioctl_82_p2, sizeof(int), "var_pkt_ioctl_82_p2");
  unsigned long var_pkt_ioctl_82_p3 ;
    klee_make_symbolic(&var_pkt_ioctl_82_p3, sizeof(long), "var_pkt_ioctl_82_p3");
  unsigned int var_pkt_check_events_83_p1 ;
    klee_make_symbolic(&var_pkt_check_events_83_p1, sizeof(int), "var_pkt_check_events_83_p1");
  unsigned int var_pkt_ctl_ioctl_88_p1 ;
    klee_make_symbolic(&var_pkt_ctl_ioctl_88_p1, sizeof(int), "var_pkt_ctl_ioctl_88_p1");
  unsigned long var_pkt_ctl_ioctl_88_p2 ;
    klee_make_symbolic(&var_pkt_ctl_ioctl_88_p2, sizeof(long), "var_pkt_ctl_ioctl_88_p2");
  unsigned int var_pkt_ctl_compat_ioctl_89_p1 ;
    klee_make_symbolic(&var_pkt_ctl_compat_ioctl_89_p1, sizeof(int), "var_pkt_ctl_compat_ioctl_89_p1");
  unsigned long var_pkt_ctl_compat_ioctl_89_p2 ;
    klee_make_symbolic(&var_pkt_ctl_compat_ioctl_89_p2, sizeof(long), "var_pkt_ctl_compat_ioctl_89_p2");
  int ldv_s_kobj_pkt_type_stat_kobj_type ;
    klee_make_symbolic(&ldv_s_kobj_pkt_type_stat_kobj_type, sizeof(int), "ldv_s_kobj_pkt_type_stat_kobj_type");
  int ldv_s_kobj_pkt_type_wqueue_kobj_type ;
    klee_make_symbolic(&ldv_s_kobj_pkt_type_wqueue_kobj_type, sizeof(int), "ldv_s_kobj_pkt_type_wqueue_kobj_type");
  int ldv_s_debug_fops_file_operations ;
    klee_make_symbolic(&ldv_s_debug_fops_file_operations, sizeof(int), "ldv_s_debug_fops_file_operations");
  int ldv_s_pkt_proc_fops_file_operations ;
    klee_make_symbolic(&ldv_s_pkt_proc_fops_file_operations, sizeof(int), "ldv_s_pkt_proc_fops_file_operations");
  int ldv_s_pktcdvd_ops_block_device_operations ;
    klee_make_symbolic(&ldv_s_pktcdvd_ops_block_device_operations, sizeof(int), "ldv_s_pktcdvd_ops_block_device_operations");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
