...
struct v4l2_jpegcompression {
   ...
   int APPn ;
    klee_make_symbolic(&APPn, sizeof(int), "APPn");
   int APP_len ;
    klee_make_symbolic(&APP_len, sizeof(int), "APP_len");
   char APP_data[60] ;
   int COM_len ;
    klee_make_symbolic(&COM_len, sizeof(int), "COM_len");
   char COM_data[60] ;
   __u32 jpeg_markers ;
};
...
union __anonunion_m_226 {
   ...
   unsigned long userptr ;
    klee_make_symbolic(&userptr, sizeof(long), "userptr");
};
struct v4l2_plane {
   __u32 bytesused ;
   __u32 length ;
...
union __anonunion____missing_field_name_257 {
   ...
   int dvb ;
    klee_make_symbolic(&dvb, sizeof(int), "dvb");
};
struct media_entity {
   struct list_head list ;
   ...
   int stream_count ;
    klee_make_symbolic(&stream_count, sizeof(int), "stream_count");
   int use_count ;
...
struct video_device {
   ...
   char name[32] ;
   int vfl_type ;
    klee_make_symbolic(&vfl_type, sizeof(int), "vfl_type");
   int minor ;
   u16 num ;
   unsigned long flags ;
   int index ;
...
struct v4l2_priv_tun_config {
   int tuner ;
    klee_make_symbolic(&tuner, sizeof(int), "tuner");
   void *priv ;
};
struct v4l2_events;
struct v4l2_fh {
...
struct v4l2_subdev_ir_parameters {
   unsigned int bytes_per_data_element ;
    klee_make_symbolic(&bytes_per_data_element, sizeof(int), "bytes_per_data_element");
   ...
   unsigned int carrier_freq ;
    klee_make_symbolic(&carrier_freq, sizeof(int), "carrier_freq");
   unsigned int duty_cycle ;
    klee_make_symbolic(&duty_cycle, sizeof(int), "duty_cycle");
   bool invert_level ;
   bool invert_carrier_sense ;
   u32 noise_filter_min_width ;
   unsigned int carrier_range_lower ;
    klee_make_symbolic(&carrier_range_lower, sizeof(int), "carrier_range_lower");
   unsigned int carrier_range_upper ;
    klee_make_symbolic(&carrier_range_upper, sizeof(int), "carrier_range_upper");
   u32 resolution ;
};
...
struct v4l2_subdev {
   ...
   unsigned int nevents ;
    klee_make_symbolic(&nevents, sizeof(int), "nevents");
};
struct v4l2_subdev_fh {
   struct v4l2_fh vfh ;
...
struct v4l2_ctrl {
   ...
   unsigned int ncontrols ;
    klee_make_symbolic(&ncontrols, sizeof(int), "ncontrols");
   unsigned int done : 1 ;
...
struct msp_state {
   ...
   int rev1 ;
    klee_make_symbolic(&rev1, sizeof(int), "rev1");
   int rev2 ;
    klee_make_symbolic(&rev2, sizeof(int), "rev2");
   int ident ;
    klee_make_symbolic(&ident, sizeof(int), "ident");
   u8 has_nicam ;
   u8 has_radio ;
   u8 has_headphones ;
   u8 has_ntsc_jp_d_k3 ;
   ...
   u8 force_btsc ;
   int radio ;
    klee_make_symbolic(&radio, sizeof(int), "radio");
   int opmode ;
    klee_make_symbolic(&opmode, sizeof(int), "opmode");
   int std ;
    klee_make_symbolic(&std, sizeof(int), "std");
   int mode ;
   v4l2_std_id v4l2_std ;
   int nicam_on ;
    klee_make_symbolic(&nicam_on, sizeof(int), "nicam_on");
   int acb ;
    klee_make_symbolic(&acb, sizeof(int), "acb");
   int in_scart ;
    klee_make_symbolic(&in_scart, sizeof(int), "in_scart");
   int i2s_mode ;
    klee_make_symbolic(&i2s_mode, sizeof(int), "i2s_mode");
   int main ;
    klee_make_symbolic(&main, sizeof(int), "main");
   int second ;
    klee_make_symbolic(&second, sizeof(int), "second");
   int input ;
   ...
   int rxsubchans ;
    klee_make_symbolic(&rxsubchans, sizeof(int), "rxsubchans");
   struct __anonstruct____missing_field_name_265 __annonCompField52 ;
   int scan_in_progress ;
    klee_make_symbolic(&scan_in_progress, sizeof(int), "scan_in_progress");
...
struct reclaim_state {
   unsigned long reclaimed_slab ;
    klee_make_symbolic(&reclaimed_slab, sizeof(long), "reclaimed_slab");
};
struct vm_fault {
   unsigned int flags ;
   unsigned long pgoff ;
...
struct msp3400c_init_data_dem {
   ...
   int fir2[6] ;
   int cdo1 ;
    klee_make_symbolic(&cdo1, sizeof(int), "cdo1");
   int cdo2 ;
    klee_make_symbolic(&cdo2, sizeof(int), "cdo2");
   int ad_cv ;
    klee_make_symbolic(&ad_cv, sizeof(int), "ad_cv");
   int mode_reg ;
    klee_make_symbolic(&mode_reg, sizeof(int), "mode_reg");
   int dsp_src ;
    klee_make_symbolic(&dsp_src, sizeof(int), "dsp_src");
   int dsp_matrix ;
    klee_make_symbolic(&dsp_matrix, sizeof(int), "dsp_matrix");
};
struct msp3400c_carrier_detect {
   int cdo ;
    klee_make_symbolic(&cdo, sizeof(int), "cdo");
   char *name ;
};
...
int msp_debug ;
    klee_make_symbolic(&msp_debug, sizeof(int), "msp_debug");
int msp_once ;
    klee_make_symbolic(&msp_once, sizeof(int), "msp_once");
int msp_amsound ;
    klee_make_symbolic(&msp_amsound, sizeof(int), "msp_amsound");
int msp_standard ;
    klee_make_symbolic(&msp_standard, sizeof(int), "msp_standard");
int msp_dolby ;
    klee_make_symbolic(&msp_dolby, sizeof(int), "msp_dolby");
int msp_stereo_thresh ;
    klee_make_symbolic(&msp_stereo_thresh, sizeof(int), "msp_stereo_thresh");
...
{ struct msp_state *state ;
  ...
  int reallymuted ;
    klee_make_symbolic(&reallymuted, sizeof(int), "reallymuted");
  char const *tmp___9 ;
  char const *tmp___10 ;
  int tmp___11 ;
  int tmp___12 ;
...
{ struct msp_state *state ;
  ...
  void *tmp___8 ;
  int update ;
    klee_make_symbolic(&update, sizeof(int), "update");
  int tmp___9 ;
...
{ struct msp_state *state ;
  ...
  int tuner ;
  int sc_in ;
    klee_make_symbolic(&sc_in, sizeof(int), "sc_in");
  int sc1_out ;
    klee_make_symbolic(&sc1_out, sizeof(int), "sc1_out");
  int sc2_out ;
    klee_make_symbolic(&sc2_out, sizeof(int), "sc2_out");
  u16 val ;
  u16 reg ;
  int i ;
    klee_make_symbolic(&i, sizeof(int), "i");
  int extern_input ;
    klee_make_symbolic(&extern_input, sizeof(int), "extern_input");
  int tmp___9 ;
...
{ struct msp_state *state ;
  ...
  int msp_hard ;
    klee_make_symbolic(&msp_hard, sizeof(int), "msp_hard");
  int msp_family ;
    klee_make_symbolic(&msp_family, sizeof(int), "msp_family");
  int msp_revision ;
    klee_make_symbolic(&msp_revision, sizeof(int), "msp_revision");
  int msp_product ;
    klee_make_symbolic(&msp_product, sizeof(int), "msp_product");
  int msp_prod_hi ;
    klee_make_symbolic(&msp_prod_hi, sizeof(int), "msp_prod_hi");
  int msp_prod_lo ;
    klee_make_symbolic(&msp_prod_lo, sizeof(int), "msp_prod_lo");
  int msp_rom ;
    klee_make_symbolic(&msp_rom, sizeof(int), "msp_rom");
  int tmp___7 ;
  int tmp___8 ;
  void *tmp___9 ;
  int tmp___10 ;
...
static int res_msp_probe_23 ;
    klee_make_symbolic(&res_msp_probe_23, sizeof(int), "res_msp_probe_23");
int main(void)
{ struct v4l2_ctrl *var_group1 ;
  ...
  int ldv_s_msp_driver_i2c_driver ;
    klee_make_symbolic(&ldv_s_msp_driver_i2c_driver, sizeof(int), "ldv_s_msp_driver_i2c_driver");
  int tmp___8 ;
  int tmp___9 ;
...
{ struct msp_state *state ;
  ...
  char const *tmp___9 ;
  int src ;
    klee_make_symbolic(&src, sizeof(int), "src");
  int audmode ;
  int tmp___10 ;
  int tmp___11 ;
  int tmp___12 ;
...
{ struct msp_state *state ;
  ...
  int rxsubchans ;
  int newnicam ;
    klee_make_symbolic(&newnicam, sizeof(int), "newnicam");
  int update ;
  int tmp___9 ;
  int tmp___10 ;
  int tmp___11 ;
...
{ struct i2c_client *client ;
  ...
  int count ;
  int max1 ;
    klee_make_symbolic(&max1, sizeof(int), "max1");
  int max2 ;
    klee_make_symbolic(&max2, sizeof(int), "max2");
  int val1 ;
...
{ struct msp_state *state ;
  ...
  struct msp_state *tmp___8 ;
  int source ;
    klee_make_symbolic(&source, sizeof(int), "source");
  int matrix ;
    klee_make_symbolic(&matrix, sizeof(int), "matrix");
  int tmp___9 ;
...
{ struct msp_state *state ;
  ...
  int tuner ;
  int modus ;
    klee_make_symbolic(&modus, sizeof(int), "modus");
  int tmp___9 ;
...
{ struct msp_state *state ;
  ...
  int tmp___9 ;
  int is_bilingual ;
    klee_make_symbolic(&is_bilingual, sizeof(int), "is_bilingual");
  int is_stereo ;
    klee_make_symbolic(&is_stereo, sizeof(int), "is_stereo");
  int oldrx ;
    klee_make_symbolic(&oldrx, sizeof(int), "oldrx");
  int tmp___10 ;
