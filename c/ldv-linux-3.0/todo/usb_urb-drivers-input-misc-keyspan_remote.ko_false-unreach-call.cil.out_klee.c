...
struct bit_tester {
   ...
   int bits_left ;
    klee_make_symbolic(&bits_left, sizeof(int), "bits_left");
   u8 buffer[32] ;
};
...
struct usb_keyspan {
   ...
   int stage ;
    klee_make_symbolic(&stage, sizeof(int), "stage");
   int toggle ;
    klee_make_symbolic(&toggle, sizeof(int), "toggle");
};
...
static int res_keyspan_probe_9 ;
    klee_make_symbolic(&res_keyspan_probe_9, sizeof(int), "res_keyspan_probe_9");
int main(void)
{ struct usb_interface *var_group1 ;
  struct usb_device_id const *var_keyspan_probe_9_p1 ;
  int tmp___7 ;
  int ldv_s_keyspan_driver_usb_driver ;
    klee_make_symbolic(&ldv_s_keyspan_driver_usb_driver, sizeof(int), "ldv_s_keyspan_driver_usb_driver");
  int tmp___8 ;
  int tmp___9 ;
