...
struct hid_collection {
   ...
   unsigned int usage ;
    klee_make_symbolic(&usage, sizeof(int), "usage");
   unsigned int level ;
};
struct hid_usage {
   unsigned int hid ;
    klee_make_symbolic(&hid, sizeof(int), "hid");
   unsigned int collection_index ;
    klee_make_symbolic(&collection_index, sizeof(int), "collection_index");
   __u16 code ;
   __u8 type ;
   __s8 hat_min ;
   __s8 hat_max ;
...
struct hid_field {
   unsigned int physical ;
    klee_make_symbolic(&physical, sizeof(int), "physical");
   unsigned int logical ;
    klee_make_symbolic(&logical, sizeof(int), "logical");
   unsigned int application ;
    klee_make_symbolic(&application, sizeof(int), "application");
   struct hid_usage *usage ;
   unsigned int maxusage ;
    klee_make_symbolic(&maxusage, sizeof(int), "maxusage");
   unsigned int flags ;
   unsigned int report_offset ;
    klee_make_symbolic(&report_offset, sizeof(int), "report_offset");
   unsigned int report_size ;
    klee_make_symbolic(&report_size, sizeof(int), "report_size");
   unsigned int report_count ;
    klee_make_symbolic(&report_count, sizeof(int), "report_count");
   unsigned int report_type ;
    klee_make_symbolic(&report_type, sizeof(int), "report_type");
   __s32 *value ;
...
struct hid_report {
   ...
   unsigned int maxfield ;
    klee_make_symbolic(&maxfield, sizeof(int), "maxfield");
   unsigned int size ;
   struct hid_device *device ;
};
struct hid_report_enum {
   unsigned int numbered ;
    klee_make_symbolic(&numbered, sizeof(int), "numbered");
...
struct hid_device {
   __u8 *rdesc ;
   unsigned int rsize ;
    klee_make_symbolic(&rsize, sizeof(int), "rsize");
   struct hid_collection *collection ;
   unsigned int collection_size ;
    klee_make_symbolic(&collection_size, sizeof(int), "collection_size");
   unsigned int maxcollection ;
    klee_make_symbolic(&maxcollection, sizeof(int), "maxcollection");
   unsigned int maxapplication ;
    klee_make_symbolic(&maxapplication, sizeof(int), "maxapplication");
   __u16 bus ;
   __u32 vendor ;
   __u32 product ;
   __u32 version ;
   ...
   unsigned int country ;
    klee_make_symbolic(&country, sizeof(int), "country");
   ...
   unsigned int quirks ;
    klee_make_symbolic(&quirks, sizeof(int), "quirks");
...
struct __anonstruct_touches_166 {
   short x ;
   short y ;
    klee_make_symbolic(&y, sizeof(short), "y");
   short scroll_x ;
    klee_make_symbolic(&scroll_x, sizeof(short), "scroll_x");
   short scroll_y ;
    klee_make_symbolic(&scroll_y, sizeof(short), "scroll_y");
   u8 size ;
};
struct magicmouse_sc {
   ...
   int ntouches ;
    klee_make_symbolic(&ntouches, sizeof(int), "ntouches");
   int scroll_accel ;
    klee_make_symbolic(&scroll_accel, sizeof(int), "scroll_accel");
   unsigned long scroll_jiffies ;
    klee_make_symbolic(&scroll_jiffies, sizeof(long), "scroll_jiffies");
   struct __anonstruct_touches_166 touches[16U] ;
   int tracking_ids[16U] ;
   int single_touch_id ;
    klee_make_symbolic(&single_touch_id, sizeof(int), "single_touch_id");
};
...
{ int touch ;
    klee_make_symbolic(&touch, sizeof(int), "touch");
  int ii ;
...
{ int last_state ;
    klee_make_symbolic(&last_state, sizeof(int), "last_state");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
  int id ;
...
{ struct input_dev *input ;
  ...
  int size ;
  int orientation ;
    klee_make_symbolic(&orientation, sizeof(int), "orientation");
  int touch_major ;
    klee_make_symbolic(&touch_major, sizeof(int), "touch_major");
  int touch_minor ;
    klee_make_symbolic(&touch_minor, sizeof(int), "touch_minor");
  int state ;
  int down___0 ;
    klee_make_symbolic(&down___0, sizeof(int), "down___0");
  unsigned long now ;
    klee_make_symbolic(&now, sizeof(long), "now");
  int step_x ;
    klee_make_symbolic(&step_x, sizeof(int), "step_x");
  int step_y ;
    klee_make_symbolic(&step_y, sizeof(int), "step_y");
  int __max1 ;
...
{ struct magicmouse_sc *msc ;
  ...
  int ii ;
  int clicks ;
    klee_make_symbolic(&clicks, sizeof(int), "clicks");
  int npoints ;
    klee_make_symbolic(&npoints, sizeof(int), "npoints");
...
{ struct hid_device *var_group1 ;
  ...
  int res_magicmouse_probe_7 ;
    klee_make_symbolic(&res_magicmouse_probe_7, sizeof(int), "res_magicmouse_probe_7");
  struct hid_report *var_group2 ;
  u8 *var_magicmouse_raw_event_4_p2 ;
  int var_magicmouse_raw_event_4_p3 ;
    klee_make_symbolic(&var_magicmouse_raw_event_4_p3, sizeof(int), "var_magicmouse_raw_event_4_p3");
  ...
  int ldv_s_magicmouse_driver_hid_driver ;
    klee_make_symbolic(&ldv_s_magicmouse_driver_hid_driver, sizeof(int), "ldv_s_magicmouse_driver_hid_driver");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
