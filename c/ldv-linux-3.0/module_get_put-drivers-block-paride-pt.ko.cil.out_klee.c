...
struct mtop {
   short mt_op ;
    klee_make_symbolic(&mt_op, sizeof(short), "mt_op");
   int mt_count ;
    klee_make_symbolic(&mt_count, sizeof(int), "mt_count");
};
struct klist_node;
struct klist_node;
struct klist_node;
...
struct pt_unit {
   ...
   int flags ;
   int last_sense ;
    klee_make_symbolic(&last_sense, sizeof(int), "last_sense");
   int drive ;
    klee_make_symbolic(&drive, sizeof(int), "drive");
   atomic_t available ;
   int bs ;
    klee_make_symbolic(&bs, sizeof(int), "bs");
   int capacity ;
    klee_make_symbolic(&capacity, sizeof(int), "capacity");
   int present ;
...
{ struct pi_adapter *pi ;
  ...
  int k ;
  int flg ;
    klee_make_symbolic(&flg, sizeof(int), "flg");
  int expect[5U] ;
  u8 tmp ;
  int tmp___0 ;
  int tmp___1 ;
...
static int pt_identify(struct pt_unit *tape )
{ int dt ;
    klee_make_symbolic(&dt, sizeof(int), "dt");
  int s ;
  char *ms[2U] ;
  char mf[10U] ;
  char id[18U] ;
...
{ struct pt_unit *tape ;
  int specified ;
    klee_make_symbolic(&specified, sizeof(int), "specified");
  int found ;
...
{ struct file *var_group1 ;
  ...
  unsigned int var_pt_ioctl_22_p1 ;
    klee_make_symbolic(&var_pt_ioctl_22_p1, sizeof(int), "var_pt_ioctl_22_p1");
  unsigned long var_pt_ioctl_22_p2 ;
    klee_make_symbolic(&var_pt_ioctl_22_p2, sizeof(long), "var_pt_ioctl_22_p2");
  struct inode *var_group2 ;
  int res_pt_open_21 ;
    klee_make_symbolic(&res_pt_open_21, sizeof(int), "res_pt_open_21");
  int ldv_s_pt_fops_file_operations ;
    klee_make_symbolic(&ldv_s_pt_fops_file_operations, sizeof(int), "ldv_s_pt_fops_file_operations");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
