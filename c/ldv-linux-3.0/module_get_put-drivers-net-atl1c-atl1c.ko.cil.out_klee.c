...
struct _ddebug {
   ...
   char enabled ;
    klee_make_symbolic(&enabled, sizeof(char), "enabled");
};
struct bug_entry {
   int bug_addr_disp ;
...
struct mii_if_info {
   int phy_id ;
    klee_make_symbolic(&phy_id, sizeof(int), "phy_id");
   int advertising ;
    klee_make_symbolic(&advertising, sizeof(int), "advertising");
   int phy_id_mask ;
    klee_make_symbolic(&phy_id_mask, sizeof(int), "phy_id_mask");
   int reg_num_mask ;
    klee_make_symbolic(&reg_num_mask, sizeof(int), "reg_num_mask");
...
struct vlan_group {
   ...
   unsigned int nr_vlans ;
    klee_make_symbolic(&nr_vlans, sizeof(int), "nr_vlans");
...
struct atl1c_hw_stats {
   unsigned long rx_ok ;
    klee_make_symbolic(&rx_ok, sizeof(long), "rx_ok");
   unsigned long rx_bcast ;
    klee_make_symbolic(&rx_bcast, sizeof(long), "rx_bcast");
   unsigned long rx_mcast ;
    klee_make_symbolic(&rx_mcast, sizeof(long), "rx_mcast");
   unsigned long rx_pause ;
    klee_make_symbolic(&rx_pause, sizeof(long), "rx_pause");
   unsigned long rx_ctrl ;
    klee_make_symbolic(&rx_ctrl, sizeof(long), "rx_ctrl");
   unsigned long rx_fcs_err ;
    klee_make_symbolic(&rx_fcs_err, sizeof(long), "rx_fcs_err");
   unsigned long rx_len_err ;
    klee_make_symbolic(&rx_len_err, sizeof(long), "rx_len_err");
   unsigned long rx_byte_cnt ;
    klee_make_symbolic(&rx_byte_cnt, sizeof(long), "rx_byte_cnt");
   unsigned long rx_runt ;
    klee_make_symbolic(&rx_runt, sizeof(long), "rx_runt");
   unsigned long rx_frag ;
    klee_make_symbolic(&rx_frag, sizeof(long), "rx_frag");
   unsigned long rx_sz_64 ;
    klee_make_symbolic(&rx_sz_64, sizeof(long), "rx_sz_64");
   unsigned long rx_sz_65_127 ;
    klee_make_symbolic(&rx_sz_65_127, sizeof(long), "rx_sz_65_127");
   unsigned long rx_sz_128_255 ;
    klee_make_symbolic(&rx_sz_128_255, sizeof(long), "rx_sz_128_255");
   unsigned long rx_sz_256_511 ;
    klee_make_symbolic(&rx_sz_256_511, sizeof(long), "rx_sz_256_511");
   unsigned long rx_sz_512_1023 ;
    klee_make_symbolic(&rx_sz_512_1023, sizeof(long), "rx_sz_512_1023");
   unsigned long rx_sz_1024_1518 ;
    klee_make_symbolic(&rx_sz_1024_1518, sizeof(long), "rx_sz_1024_1518");
   unsigned long rx_sz_1519_max ;
    klee_make_symbolic(&rx_sz_1519_max, sizeof(long), "rx_sz_1519_max");
   unsigned long rx_sz_ov ;
    klee_make_symbolic(&rx_sz_ov, sizeof(long), "rx_sz_ov");
   unsigned long rx_rxf_ov ;
    klee_make_symbolic(&rx_rxf_ov, sizeof(long), "rx_rxf_ov");
   unsigned long rx_rrd_ov ;
    klee_make_symbolic(&rx_rrd_ov, sizeof(long), "rx_rrd_ov");
   unsigned long rx_align_err ;
    klee_make_symbolic(&rx_align_err, sizeof(long), "rx_align_err");
   unsigned long rx_bcast_byte_cnt ;
    klee_make_symbolic(&rx_bcast_byte_cnt, sizeof(long), "rx_bcast_byte_cnt");
   unsigned long rx_mcast_byte_cnt ;
    klee_make_symbolic(&rx_mcast_byte_cnt, sizeof(long), "rx_mcast_byte_cnt");
   unsigned long rx_err_addr ;
    klee_make_symbolic(&rx_err_addr, sizeof(long), "rx_err_addr");
   unsigned long tx_ok ;
    klee_make_symbolic(&tx_ok, sizeof(long), "tx_ok");
   unsigned long tx_bcast ;
    klee_make_symbolic(&tx_bcast, sizeof(long), "tx_bcast");
   unsigned long tx_mcast ;
    klee_make_symbolic(&tx_mcast, sizeof(long), "tx_mcast");
   unsigned long tx_pause ;
    klee_make_symbolic(&tx_pause, sizeof(long), "tx_pause");
   unsigned long tx_exc_defer ;
    klee_make_symbolic(&tx_exc_defer, sizeof(long), "tx_exc_defer");
   unsigned long tx_ctrl ;
    klee_make_symbolic(&tx_ctrl, sizeof(long), "tx_ctrl");
   unsigned long tx_defer ;
    klee_make_symbolic(&tx_defer, sizeof(long), "tx_defer");
   unsigned long tx_byte_cnt ;
    klee_make_symbolic(&tx_byte_cnt, sizeof(long), "tx_byte_cnt");
   unsigned long tx_sz_64 ;
    klee_make_symbolic(&tx_sz_64, sizeof(long), "tx_sz_64");
   unsigned long tx_sz_65_127 ;
    klee_make_symbolic(&tx_sz_65_127, sizeof(long), "tx_sz_65_127");
   unsigned long tx_sz_128_255 ;
    klee_make_symbolic(&tx_sz_128_255, sizeof(long), "tx_sz_128_255");
   unsigned long tx_sz_256_511 ;
    klee_make_symbolic(&tx_sz_256_511, sizeof(long), "tx_sz_256_511");
   unsigned long tx_sz_512_1023 ;
    klee_make_symbolic(&tx_sz_512_1023, sizeof(long), "tx_sz_512_1023");
   unsigned long tx_sz_1024_1518 ;
    klee_make_symbolic(&tx_sz_1024_1518, sizeof(long), "tx_sz_1024_1518");
   unsigned long tx_sz_1519_max ;
    klee_make_symbolic(&tx_sz_1519_max, sizeof(long), "tx_sz_1519_max");
   unsigned long tx_1_col ;
    klee_make_symbolic(&tx_1_col, sizeof(long), "tx_1_col");
   unsigned long tx_2_col ;
    klee_make_symbolic(&tx_2_col, sizeof(long), "tx_2_col");
   unsigned long tx_late_col ;
    klee_make_symbolic(&tx_late_col, sizeof(long), "tx_late_col");
   unsigned long tx_abort_col ;
    klee_make_symbolic(&tx_abort_col, sizeof(long), "tx_abort_col");
   unsigned long tx_underrun ;
    klee_make_symbolic(&tx_underrun, sizeof(long), "tx_underrun");
   unsigned long tx_rd_eop ;
    klee_make_symbolic(&tx_rd_eop, sizeof(long), "tx_rd_eop");
   unsigned long tx_len_err ;
    klee_make_symbolic(&tx_len_err, sizeof(long), "tx_len_err");
   unsigned long tx_trunc ;
    klee_make_symbolic(&tx_trunc, sizeof(long), "tx_trunc");
   unsigned long tx_bcast_byte ;
    klee_make_symbolic(&tx_bcast_byte, sizeof(long), "tx_bcast_byte");
   unsigned long tx_mcast_byte ;
    klee_make_symbolic(&tx_mcast_byte, sizeof(long), "tx_mcast_byte");
};
struct atl1c_hw {
   u8 *hw_addr ;
...
struct atl1c_adapter {
   ...
   unsigned long work_event ;
    klee_make_symbolic(&work_event, sizeof(long), "work_event");
   u32 msg_enable ;
   bool have_msi ;
   u32 wol ;
   u16 link_speed ;
...
{ struct atl1c_adapter *adapter ;
  void *tmp ;
  int old_mtu ;
    klee_make_symbolic(&old_mtu, sizeof(int), "old_mtu");
  int max_frame ;
...
{ struct pci_dev *pdev ;
  ...
  int count ;
  int rx_desc_count ;
    klee_make_symbolic(&rx_desc_count, sizeof(int), "rx_desc_count");
  u32 offset ;
  u16 tmp ;
  void *tmp___0 ;
  long tmp___1 ;
...
{ struct net_device *netdev ;
  ...
  struct atl1c_hw *hw ;
  int max_ints ;
    klee_make_symbolic(&max_ints, sizeof(int), "max_ints");
  int handled ;
    klee_make_symbolic(&handled, sizeof(int), "handled");
  u32 status ;
  u32 reg_data ;
  long tmp___0 ;
  int tmp___1 ;
...
{ struct atl1c_adapter *adapter ;
  ...
  int work_done ;
    klee_make_symbolic(&work_done, sizeof(int), "work_done");
  int tmp ;
...
{ struct pci_dev *pdev ;
  ...
  unsigned short offload_type ;
    klee_make_symbolic(&offload_type, sizeof(short), "offload_type");
  int err ;
  long tmp ;
  int tmp___0 ;
...
{ struct net_device *netdev ;
  struct atl1c_adapter *adapter ;
  int cards_found ;
    klee_make_symbolic(&cards_found, sizeof(int), "cards_found");
  int err ;
  int tmp ;
  int tmp___0 ;
  void *tmp___1 ;
...
{ struct atl1c_adapter *adapter ;
  ...
  void *tmp___31 ;
  long tmp___32 ;
    klee_make_symbolic(&tmp___32, sizeof(long), "tmp___32");
  void *tmp___33 ;
  void *tmp___34 ;
  long tmp___35 ;
  ...
  void *tmp___37 ;
  long tmp___38 ;
    klee_make_symbolic(&tmp___38, sizeof(long), "tmp___38");
  void *tmp___39 ;
  void *tmp___40 ;
  long tmp___41 ;
  ...
  void *tmp___43 ;
  long tmp___44 ;
    klee_make_symbolic(&tmp___44, sizeof(long), "tmp___44");
  void *tmp___45 ;
  void *tmp___46 ;
  long tmp___47 ;
  ...
  void *tmp___52 ;
  long tmp___53 ;
    klee_make_symbolic(&tmp___53, sizeof(long), "tmp___53");
  void *tmp___54 ;
  void *tmp___55 ;
  long tmp___56 ;
    klee_make_symbolic(&tmp___56, sizeof(long), "tmp___56");
  void *tmp___57 ;
  void *tmp___58 ;
  long tmp___59 ;
    klee_make_symbolic(&tmp___59, sizeof(long), "tmp___59");
  void *tmp___60 ;
  void *tmp___61 ;
  long tmp___62 ;
    klee_make_symbolic(&tmp___62, sizeof(long), "tmp___62");
  void *tmp___63 ;
  void *tmp___64 ;
  long tmp___65 ;
    klee_make_symbolic(&tmp___65, sizeof(long), "tmp___65");
  void *tmp___66 ;
  void *tmp___67 ;
  long tmp___68 ;
    klee_make_symbolic(&tmp___68, sizeof(long), "tmp___68");
...
{ struct atl1c_adapter *adapter ;
  ...
  u32 *eeprom_buff ;
  int first_dword ;
    klee_make_symbolic(&first_dword, sizeof(int), "first_dword");
  int last_dword ;
    klee_make_symbolic(&last_dword, sizeof(int), "last_dword");
  int ret_val ;
  int i ;
  int tmp___0 ;
  void *tmp___1 ;
