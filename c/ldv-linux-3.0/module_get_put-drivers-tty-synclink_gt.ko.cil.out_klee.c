...
typedef unsigned long __kernel_nlink_t;
    klee_make_symbolic(&__kernel_nlink_t, sizeof(long), "__kernel_nlink_t");
typedef long __kernel_off_t;
    klee_make_symbolic(&__kernel_off_t, sizeof(long), "__kernel_off_t");
...
typedef unsigned long __kernel_size_t;
    klee_make_symbolic(&__kernel_size_t, sizeof(long), "__kernel_size_t");
typedef long __kernel_ssize_t;
    klee_make_symbolic(&__kernel_ssize_t, sizeof(long), "__kernel_ssize_t");
typedef long __kernel_time_t;
    klee_make_symbolic(&__kernel_time_t, sizeof(long), "__kernel_time_t");
typedef long __kernel_clock_t;
    klee_make_symbolic(&__kernel_clock_t, sizeof(long), "__kernel_clock_t");
...
struct thread_struct {
   ...
   unsigned long trap_no ;
    klee_make_symbolic(&trap_no, sizeof(long), "trap_no");
...
struct thread_info {
   ...
   int uaccess_err ;
    klee_make_symbolic(&uaccess_err, sizeof(int), "uaccess_err");
};
struct arch_spinlock {
   unsigned int slock ;
...
struct module_ref {
   unsigned int incs ;
    klee_make_symbolic(&incs, sizeof(int), "incs");
   unsigned int decs ;
    klee_make_symbolic(&decs, sizeof(int), "decs");
};
...
struct task_struct {
   ...
   unsigned int group_stop ;
    klee_make_symbolic(&group_stop, sizeof(int), "group_stop");
   ...
   int mems_allowed_change_disable ;
    klee_make_symbolic(&mems_allowed_change_disable, sizeof(int), "mems_allowed_change_disable");
...
struct pci_bus {
   ...
   unsigned char secondary ;
    klee_make_symbolic(&secondary, sizeof(char), "secondary");
   unsigned char subordinate ;
    klee_make_symbolic(&subordinate, sizeof(char), "subordinate");
...
struct inode {
   ...
   unsigned int i_nlink ;
    klee_make_symbolic(&i_nlink, sizeof(int), "i_nlink");
   dev_t i_rdev ;
...
struct file_lock {
   ...
   unsigned char fl_flags ;
    klee_make_symbolic(&fl_flags, sizeof(char), "fl_flags");
...
struct tty_driver {
   ...
   int minor_num ;
    klee_make_symbolic(&minor_num, sizeof(int), "minor_num");
   int num ;
...
struct tty_buffer {
   ...
   int read ;
    klee_make_symbolic(&read, sizeof(int), "read");
...
struct tty_struct {
   ...
   unsigned int column ;
    klee_make_symbolic(&column, sizeof(int), "column");
   ...
   unsigned long overrun_time ;
    klee_make_symbolic(&overrun_time, sizeof(long), "overrun_time");
   int num_overrun ;
    klee_make_symbolic(&num_overrun, sizeof(int), "num_overrun");
   unsigned long process_char_map[4U] ;
   char *read_buf ;
   int read_head ;
    klee_make_symbolic(&read_head, sizeof(int), "read_head");
   int read_tail ;
    klee_make_symbolic(&read_tail, sizeof(int), "read_tail");
   int read_cnt ;
    klee_make_symbolic(&read_cnt, sizeof(int), "read_cnt");
   unsigned long read_flags[64U] ;
   unsigned char *echo_buf ;
   unsigned int echo_pos ;
    klee_make_symbolic(&echo_pos, sizeof(int), "echo_pos");
   unsigned int echo_cnt ;
    klee_make_symbolic(&echo_cnt, sizeof(int), "echo_cnt");
   int canon_data ;
    klee_make_symbolic(&canon_data, sizeof(int), "canon_data");
   unsigned long canon_head ;
    klee_make_symbolic(&canon_head, sizeof(long), "canon_head");
   unsigned int canon_column ;
    klee_make_symbolic(&canon_column, sizeof(int), "canon_column");
...
typedef unsigned short sa_family_t;
    klee_make_symbolic(&sa_family_t, sizeof(short), "sa_family_t");
struct sockaddr {
...
struct pm_qos_request_list {
   ...
   int pm_qos_class ;
    klee_make_symbolic(&pm_qos_class, sizeof(int), "pm_qos_class");
};
...
struct netns_frags {
   int nqueues ;
    klee_make_symbolic(&nqueues, sizeof(int), "nqueues");
   atomic_t mem ;
...
struct netns_ipv4 {
   ...
   int sysctl_rt_cache_rebuild_count ;
    klee_make_symbolic(&sysctl_rt_cache_rebuild_count, sizeof(int), "sysctl_rt_cache_rebuild_count");
   int current_rt_cache_rebuild_count ;
    klee_make_symbolic(&current_rt_cache_rebuild_count, sizeof(int), "current_rt_cache_rebuild_count");
...
struct dst_ops {
   unsigned short family ;
    klee_make_symbolic(&family, sizeof(short), "family");
   __be16 protocol ;
...
struct proc_dir_entry {
   ...
   unsigned int namelen ;
    klee_make_symbolic(&namelen, sizeof(int), "namelen");
   char const *name ;
   mode_t mode ;
   nlink_t nlink ;
   uid_t uid ;
...
struct netns_ct {
   ...
   unsigned int sysctl_events_retry_timeout ;
    klee_make_symbolic(&sysctl_events_retry_timeout, sizeof(int), "sysctl_events_retry_timeout");
   int sysctl_acct ;
...
struct net_device {
   ...
   int iflink ;
    klee_make_symbolic(&iflink, sizeof(int), "iflink");
   ...
   int uc_promisc ;
    klee_make_symbolic(&uc_promisc, sizeof(int), "uc_promisc");
...
struct hdlc_device {
   ...
   int carrier ;
    klee_make_symbolic(&carrier, sizeof(int), "carrier");
   int open ;
    klee_make_symbolic(&open, sizeof(int), "open");
...
struct _MGSL_PARAMS {
   ...
   unsigned long clock_speed ;
    klee_make_symbolic(&clock_speed, sizeof(long), "clock_speed");
   unsigned char addr_filter ;
    klee_make_symbolic(&addr_filter, sizeof(char), "addr_filter");
   unsigned short crc_type ;
    klee_make_symbolic(&crc_type, sizeof(short), "crc_type");
   unsigned char preamble_length ;
    klee_make_symbolic(&preamble_length, sizeof(char), "preamble_length");
   unsigned char preamble ;
    klee_make_symbolic(&preamble, sizeof(char), "preamble");
   unsigned long data_rate ;
    klee_make_symbolic(&data_rate, sizeof(long), "data_rate");
   unsigned char data_bits ;
    klee_make_symbolic(&data_bits, sizeof(char), "data_bits");
   unsigned char stop_bits ;
    klee_make_symbolic(&stop_bits, sizeof(char), "stop_bits");
...
struct slgt_desc {
   ...
   char *buf ;
   unsigned int pdesc ;
    klee_make_symbolic(&pdesc, sizeof(int), "pdesc");
   dma_addr_t buf_dma_addr ;
   unsigned short buf_count ;
    klee_make_symbolic(&buf_count, sizeof(short), "buf_count");
};
struct _input_signal_events {
   int ri_up ;
    klee_make_symbolic(&ri_up, sizeof(int), "ri_up");
   int ri_down ;
    klee_make_symbolic(&ri_down, sizeof(int), "ri_down");
   int dsr_up ;
    klee_make_symbolic(&dsr_up, sizeof(int), "dsr_up");
   int dsr_down ;
    klee_make_symbolic(&dsr_down, sizeof(int), "dsr_down");
   int dcd_up ;
    klee_make_symbolic(&dcd_up, sizeof(int), "dcd_up");
   int dcd_down ;
    klee_make_symbolic(&dcd_down, sizeof(int), "dcd_down");
   int cts_up ;
    klee_make_symbolic(&cts_up, sizeof(int), "cts_up");
   int cts_down ;
    klee_make_symbolic(&cts_down, sizeof(int), "cts_down");
};
struct slgt_info {
   void *if_ptr ;
   struct tty_port port ;
   ...
   struct pci_dev *pdev ;
   int port_count ;
    klee_make_symbolic(&port_count, sizeof(int), "port_count");
   int adapter_num ;
    klee_make_symbolic(&adapter_num, sizeof(int), "adapter_num");
   int port_num ;
   ...
   int timeout ;
   int x_char ;
    klee_make_symbolic(&x_char, sizeof(int), "x_char");
   unsigned int read_status_mask ;
    klee_make_symbolic(&read_status_mask, sizeof(int), "read_status_mask");
   unsigned int ignore_status_mask ;
    klee_make_symbolic(&ignore_status_mask, sizeof(int), "ignore_status_mask");
   wait_queue_head_t status_event_wait_q ;
   wait_queue_head_t event_wait_q ;
   struct timer_list tx_timer ;
   struct timer_list rx_timer ;
   unsigned int gpio_present ;
    klee_make_symbolic(&gpio_present, sizeof(int), "gpio_present");
   ...
   bool bh_running ;
   int isr_overflow ;
    klee_make_symbolic(&isr_overflow, sizeof(int), "isr_overflow");
   bool irq_requested ;
   bool irq_occurred ;
   unsigned int bus_type ;
    klee_make_symbolic(&bus_type, sizeof(int), "bus_type");
   ...
   unsigned int rbuf_fill_level ;
    klee_make_symbolic(&rbuf_fill_level, sizeof(int), "rbuf_fill_level");
   unsigned int rx_pio ;
    klee_make_symbolic(&rx_pio, sizeof(int), "rx_pio");
   unsigned int if_mode ;
    klee_make_symbolic(&if_mode, sizeof(int), "if_mode");
   unsigned int base_clock ;
    klee_make_symbolic(&base_clock, sizeof(int), "base_clock");
   unsigned int xsync ;
    klee_make_symbolic(&xsync, sizeof(int), "xsync");
   unsigned int xctrl ;
    klee_make_symbolic(&xctrl, sizeof(int), "xctrl");
   bool rx_enabled ;
   bool rx_restart ;
   bool tx_enabled ;
   bool tx_active ;
   unsigned char signals ;
    klee_make_symbolic(&signals, sizeof(char), "signals");
   int init_error ;
    klee_make_symbolic(&init_error, sizeof(int), "init_error");
   unsigned char *tx_buf ;
   int tx_count ;
    klee_make_symbolic(&tx_count, sizeof(int), "tx_count");
   char flag_buf[4096U] ;
   char char_buf[4096U] ;
   bool drop_rts_on_tx_done ;
   struct _input_signal_events input_signal_events ;
   int dcd_chkcount ;
    klee_make_symbolic(&dcd_chkcount, sizeof(int), "dcd_chkcount");
   int cts_chkcount ;
    klee_make_symbolic(&cts_chkcount, sizeof(int), "cts_chkcount");
   int dsr_chkcount ;
    klee_make_symbolic(&dsr_chkcount, sizeof(int), "dsr_chkcount");
   int ri_chkcount ;
    klee_make_symbolic(&ri_chkcount, sizeof(int), "ri_chkcount");
   char *bufs ;
   dma_addr_t bufs_dma_addr ;
   unsigned int rbuf_count ;
    klee_make_symbolic(&rbuf_count, sizeof(int), "rbuf_count");
   struct slgt_desc *rbufs ;
   unsigned int rbuf_current ;
    klee_make_symbolic(&rbuf_current, sizeof(int), "rbuf_current");
   unsigned int rbuf_index ;
    klee_make_symbolic(&rbuf_index, sizeof(int), "rbuf_index");
   unsigned int rbuf_fill_index ;
    klee_make_symbolic(&rbuf_fill_index, sizeof(int), "rbuf_fill_index");
   unsigned short rbuf_fill_count ;
    klee_make_symbolic(&rbuf_fill_count, sizeof(short), "rbuf_fill_count");
   unsigned int tbuf_count ;
    klee_make_symbolic(&tbuf_count, sizeof(int), "tbuf_count");
   struct slgt_desc *tbufs ;
   unsigned int tbuf_current ;
    klee_make_symbolic(&tbuf_current, sizeof(int), "tbuf_current");
   unsigned int tbuf_start ;
    klee_make_symbolic(&tbuf_start, sizeof(int), "tbuf_start");
   unsigned char *tmp_rbuf ;
   unsigned int tmp_rbuf_count ;
    klee_make_symbolic(&tmp_rbuf_count, sizeof(int), "tmp_rbuf_count");
   int netcount ;
    klee_make_symbolic(&netcount, sizeof(int), "netcount");
   spinlock_t netlock ;
...
static int slgt_device_count ;
    klee_make_symbolic(&slgt_device_count, sizeof(int), "slgt_device_count");
static int ttymajor ;
    klee_make_symbolic(&ttymajor, sizeof(int), "ttymajor");
static int debug_level ;
    klee_make_symbolic(&debug_level, sizeof(int), "debug_level");
...
{ int i ;
  ...
  int linecount ;
    klee_make_symbolic(&linecount, sizeof(int), "linecount");
...
{ struct slgt_info *info ;
  unsigned long orig_jiffies ;
    klee_make_symbolic(&orig_jiffies, sizeof(long), "orig_jiffies");
  unsigned long char_time ;
    klee_make_symbolic(&char_time, sizeof(long), "char_time");
  int tmp ;
  unsigned long __min1 ;
    klee_make_symbolic(&__min1, sizeof(long), "__min1");
  unsigned long __min2 ;
    klee_make_symbolic(&__min2, sizeof(long), "__min2");
  unsigned long tmp___0 ;
...
{ struct slgt_info *info ;
  ...
  unsigned char new_encoding ;
    klee_make_symbolic(&new_encoding, sizeof(char), "new_encoding");
  unsigned short new_crctype ;
    klee_make_symbolic(&new_crctype, sizeof(short), "new_crctype");
...
{ struct tty_struct *tty ;
  ...
  int count ;
  int chars ;
    klee_make_symbolic(&chars, sizeof(int), "chars");
  int stat ;
    klee_make_symbolic(&stat, sizeof(int), "stat");
  unsigned char ch ;
    klee_make_symbolic(&ch, sizeof(char), "ch");
...
{ unsigned int count ;
  unsigned int i ;
  unsigned short reg ;
    klee_make_symbolic(&reg, sizeof(short), "reg");
  unsigned int tmp ;
  unsigned int tmp___0 ;
  __u16 tmp___1 ;
...
{ __u16 tmp ;
  unsigned short val ;
    klee_make_symbolic(&val, sizeof(short), "val");
  __u16 tmp___0 ;
  bool tmp___1 ;
...
{ struct slgt_info *info ;
  unsigned int gsr ;
    klee_make_symbolic(&gsr, sizeof(int), "gsr");
  unsigned int i ;
  __u32 tmp ;
  unsigned int state ;
  unsigned int changed ;
    klee_make_symbolic(&changed, sizeof(int), "changed");
...
static void change_params(struct slgt_info *info )
{ unsigned int cflag ;
    klee_make_symbolic(&cflag, sizeof(int), "cflag");
  int bits_per_char ;
    klee_make_symbolic(&bits_per_char, sizeof(int), "bits_per_char");
  speed_t tmp ;
...
{ wait_queue_t wait ;
  ...
  unsigned long flags ;
  int cd ;
    klee_make_symbolic(&cd, sizeof(int), "cd");
  struct tty_port *port ;
  raw_spinlock_t *tmp___0 ;
  int tmp___1 ;
  long volatile __x ;
...
{ unsigned int i ;
  unsigned int pbufs ;
    klee_make_symbolic(&pbufs, sizeof(int), "pbufs");
  void *tmp ;
...
{ unsigned long reg_addr ;
    klee_make_symbolic(&reg_addr, sizeof(long), "reg_addr");
  unsigned char tmp ;
...
static void set_rate(struct slgt_info *info , u32 rate )
{ unsigned int div ;
    klee_make_symbolic(&div, sizeof(int), "div");
  unsigned int osc ;
    klee_make_symbolic(&osc, sizeof(int), "osc");
...
{ unsigned char val ;
  unsigned short tcr ;
    klee_make_symbolic(&tcr, sizeof(short), "tcr");
...
{ unsigned int start ;
  ...
  unsigned int framesize ;
    klee_make_symbolic(&framesize, sizeof(int), "framesize");
  unsigned long flags ;
  struct tty_struct *tty ;
  unsigned char addr_field ;
    klee_make_symbolic(&addr_field, sizeof(char), "addr_field");
  unsigned int crc_size ;
    klee_make_symbolic(&crc_size, sizeof(int), "crc_size");
  raw_spinlock_t *tmp ;
  int __min1 ;
  int __min2 ;
  int tmp___0 ;
  int copy_count ;
    klee_make_symbolic(&copy_count, sizeof(int), "copy_count");
  int i ;
  unsigned char *p ;
  int partial_count ;
    klee_make_symbolic(&partial_count, sizeof(int), "partial_count");
  int __min1___0 ;
...
{ unsigned int total_count ;
    klee_make_symbolic(&total_count, sizeof(int), "total_count");
  unsigned int i ;
  unsigned int reg_value ;
    klee_make_symbolic(&reg_value, sizeof(int), "reg_value");
  unsigned int count ;
  unsigned int active_buf_count ;
    klee_make_symbolic(&active_buf_count, sizeof(int), "active_buf_count");
...
{ struct pci_dev *var_group1 ;
  ...
  int res_init_one_102 ;
    klee_make_symbolic(&res_init_one_102, sizeof(int), "res_init_one_102");
  struct inode *var_group2 ;
  struct file *var_group3 ;
  int res_synclink_gt_proc_open_26 ;
    klee_make_symbolic(&res_synclink_gt_proc_open_26, sizeof(int), "res_synclink_gt_proc_open_26");
  struct net_device *var_group4 ;
  int res_hdlcdev_open_33 ;
    klee_make_symbolic(&res_hdlcdev_open_33, sizeof(int), "res_hdlcdev_open_33");
  int res_hdlcdev_close_34 ;
    klee_make_symbolic(&res_hdlcdev_close_34, sizeof(int), "res_hdlcdev_close_34");
  struct ifreq *var_group5 ;
  int var_hdlcdev_ioctl_35_p2 ;
    klee_make_symbolic(&var_hdlcdev_ioctl_35_p2, sizeof(int), "var_hdlcdev_ioctl_35_p2");
  struct tty_port *var_group6 ;
  int var_dtr_rts_87_p1 ;
    klee_make_symbolic(&var_dtr_rts_87_p1, sizeof(int), "var_dtr_rts_87_p1");
  struct tty_struct *var_group7 ;
  int res_open_5 ;
    klee_make_symbolic(&res_open_5, sizeof(int), "res_open_5");
  unsigned char const *var_write_10_p1 ;
  int var_write_10_p2 ;
    klee_make_symbolic(&var_write_10_p2, sizeof(int), "var_write_10_p2");
  unsigned char var_put_char_11_p1 ;
    klee_make_symbolic(&var_put_char_11_p1, sizeof(char), "var_put_char_11_p1");
  unsigned int var_ioctl_19_p1 ;
    klee_make_symbolic(&var_ioctl_19_p1, sizeof(int), "var_ioctl_19_p1");
  unsigned long var_ioctl_19_p2 ;
    klee_make_symbolic(&var_ioctl_19_p2, sizeof(long), "var_ioctl_19_p2");
  unsigned int var_slgt_compat_ioctl_23_p1 ;
    klee_make_symbolic(&var_slgt_compat_ioctl_23_p1, sizeof(int), "var_slgt_compat_ioctl_23_p1");
  unsigned long var_slgt_compat_ioctl_23_p2 ;
    klee_make_symbolic(&var_slgt_compat_ioctl_23_p2, sizeof(long), "var_slgt_compat_ioctl_23_p2");
  char var_send_xchar_12_p1 ;
    klee_make_symbolic(&var_send_xchar_12_p1, sizeof(char), "var_send_xchar_12_p1");
  int var_set_break_30_p1 ;
    klee_make_symbolic(&var_set_break_30_p1, sizeof(int), "var_set_break_30_p1");
  int var_wait_until_sent_13_p1 ;
    klee_make_symbolic(&var_wait_until_sent_13_p1, sizeof(int), "var_wait_until_sent_13_p1");
  struct ktermios *var_group8 ;
  unsigned int var_tiocmset_85_p1 ;
    klee_make_symbolic(&var_tiocmset_85_p1, sizeof(int), "var_tiocmset_85_p1");
  unsigned int var_tiocmset_85_p2 ;
    klee_make_symbolic(&var_tiocmset_85_p2, sizeof(int), "var_tiocmset_85_p2");
  struct serial_icounter_struct *var_group9 ;
  int var_slgt_interrupt_56_p0 ;
    klee_make_symbolic(&var_slgt_interrupt_56_p0, sizeof(int), "var_slgt_interrupt_56_p0");
  void *var_slgt_interrupt_56_p1 ;
  int ldv_s_pci_driver_pci_driver ;
    klee_make_symbolic(&ldv_s_pci_driver_pci_driver, sizeof(int), "ldv_s_pci_driver_pci_driver");
  int ldv_s_synclink_gt_proc_fops_file_operations ;
    klee_make_symbolic(&ldv_s_synclink_gt_proc_fops_file_operations, sizeof(int), "ldv_s_synclink_gt_proc_fops_file_operations");
  int ldv_s_hdlcdev_ops_net_device_ops ;
    klee_make_symbolic(&ldv_s_hdlcdev_ops_net_device_ops, sizeof(int), "ldv_s_hdlcdev_ops_net_device_ops");
  int ldv_s_ops_tty_operations ;
    klee_make_symbolic(&ldv_s_ops_tty_operations, sizeof(int), "ldv_s_ops_tty_operations");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
