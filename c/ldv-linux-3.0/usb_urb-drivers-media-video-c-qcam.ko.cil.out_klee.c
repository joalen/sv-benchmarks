...
struct pc_parport_state {
   unsigned int ctr ;
    klee_make_symbolic(&ctr, sizeof(int), "ctr");
   unsigned int ecr ;
    klee_make_symbolic(&ecr, sizeof(int), "ecr");
};
struct ax_parport_state {
   unsigned int ctr ;
   unsigned int ecr ;
   unsigned int dcsr ;
    klee_make_symbolic(&dcsr, sizeof(int), "dcsr");
};
struct amiga_parport_state {
   unsigned char data ;
   unsigned char datadir ;
    klee_make_symbolic(&datadir, sizeof(char), "datadir");
   unsigned char status ;
    klee_make_symbolic(&status, sizeof(char), "status");
   unsigned char statusdir ;
    klee_make_symbolic(&statusdir, sizeof(char), "statusdir");
};
struct ax88796_parport_state {
   unsigned char cpr ;
    klee_make_symbolic(&cpr, sizeof(char), "cpr");
};
struct ip32_parport_state {
   unsigned int dcr ;
    klee_make_symbolic(&dcr, sizeof(int), "dcr");
   unsigned int ecr ;
};
...
struct pardevice {
   ...
   struct parport *port ;
   int daisy ;
    klee_make_symbolic(&daisy, sizeof(int), "daisy");
   int (*preempt)(void * ) ;
   void (*wakeup)(void * ) ;
   void *private ;
   void (*irq_func)(void * ) ;
   ...
   unsigned long timeslice ;
    klee_make_symbolic(&timeslice, sizeof(long), "timeslice");
   long volatile timeout ;
   unsigned long waiting ;
    klee_make_symbolic(&waiting, sizeof(long), "waiting");
...
struct parport {
   ...
   unsigned long base_hi ;
    klee_make_symbolic(&base_hi, sizeof(long), "base_hi");
   unsigned int size ;
   char const *name ;
   unsigned int modes ;
   ...
   int dma ;
    klee_make_symbolic(&dma, sizeof(int), "dma");
   int muxport ;
    klee_make_symbolic(&muxport, sizeof(int), "muxport");
   int portnum ;
   ...
   int daisy ;
   int muxsel ;
    klee_make_symbolic(&muxsel, sizeof(int), "muxsel");
   ...
   void *private_data ;
   int number ;
    klee_make_symbolic(&number, sizeof(int), "number");
   ...
   unsigned long devflags ;
    klee_make_symbolic(&devflags, sizeof(long), "devflags");
...
struct qcam {
   ...
   int height ;
   int ccd_width ;
    klee_make_symbolic(&ccd_width, sizeof(int), "ccd_width");
   int ccd_height ;
    klee_make_symbolic(&ccd_height, sizeof(int), "ccd_height");
   int mode ;
   int contrast ;
    klee_make_symbolic(&contrast, sizeof(int), "contrast");
   int brightness ;
    klee_make_symbolic(&brightness, sizeof(int), "brightness");
   int whitebal ;
    klee_make_symbolic(&whitebal, sizeof(int), "whitebal");
   int top ;
    klee_make_symbolic(&top, sizeof(int), "top");
   int left ;
    klee_make_symbolic(&left, sizeof(int), "left");
   unsigned int bidirectional ;
    klee_make_symbolic(&bidirectional, sizeof(int), "bidirectional");
   struct mutex lock ;
};
...
static int force_rgb ;
    klee_make_symbolic(&force_rgb, sizeof(int), "force_rgb");
...
static unsigned int num_cams ;
    klee_make_symbolic(&num_cams, sizeof(int), "num_cams");
...
{ struct v4l2_device *v4l2_dev ;
  unsigned long oldjiffies ;
    klee_make_symbolic(&oldjiffies, sizeof(long), "oldjiffies");
  unsigned int i ;
...
{ unsigned int idata ;
    klee_make_symbolic(&idata, sizeof(int), "idata");
  unsigned int tmp___7 ;
...
{ unsigned int stat ;
  ...
  unsigned int ostat ;
    klee_make_symbolic(&ostat, sizeof(int), "ostat");
  unsigned int i ;
  unsigned int count ;
  int tmp___7 ;
  unsigned char tmp___8 ;
...
{ unsigned int bytes ;
  ...
  unsigned int lo1 ;
    klee_make_symbolic(&lo1, sizeof(int), "lo1");
  unsigned int hi1 ;
    klee_make_symbolic(&hi1, sizeof(int), "hi1");
  unsigned int lo2 ;
    klee_make_symbolic(&lo2, sizeof(int), "lo2");
  unsigned int hi2 ;
    klee_make_symbolic(&hi2, sizeof(int), "hi2");
  unsigned char r ;
    klee_make_symbolic(&r, sizeof(char), "r");
  unsigned char g ;
    klee_make_symbolic(&g, sizeof(char), "g");
  unsigned char b ;
  unsigned int tmp___7 ;
  unsigned char tmp___8 ;
  unsigned char tmp___9 ;
  ...
  unsigned char rgb[3] ;
  unsigned int hi ;
    klee_make_symbolic(&hi, sizeof(int), "hi");
  unsigned int lo ;
    klee_make_symbolic(&lo, sizeof(int), "lo");
  unsigned int tmp___19 ;
    klee_make_symbolic(&tmp___19, sizeof(int), "tmp___19");
  unsigned char tmp___20 ;
    klee_make_symbolic(&tmp___20, sizeof(char), "tmp___20");
  unsigned int tmp___21 ;
    klee_make_symbolic(&tmp___21, sizeof(int), "tmp___21");
  unsigned char tmp___22 ;
    klee_make_symbolic(&tmp___22, sizeof(char), "tmp___22");
...
{ struct v4l2_device *v4l2_dev ;
  unsigned int lines ;
    klee_make_symbolic(&lines, sizeof(int), "lines");
  unsigned int pixelsperline ;
    klee_make_symbolic(&pixelsperline, sizeof(int), "pixelsperline");
  unsigned int bitsperxfer ;
    klee_make_symbolic(&bitsperxfer, sizeof(int), "bitsperxfer");
  unsigned int is_bi_dir ;
    klee_make_symbolic(&is_bi_dir, sizeof(int), "is_bi_dir");
  size_t wantlen ;
  size_t outptr ;
  char tmpbuf[150] ;
  unsigned long flag ;
  ...
  unsigned int tmp___21 ;
  int l___0 ;
    klee_make_symbolic(&l___0, sizeof(int), "l___0");
...
{ struct file *var_group1 ;
  ...
  unsigned int var_qcam_s_input_17_p2 ;
    klee_make_symbolic(&var_qcam_s_input_17_p2, sizeof(int), "var_qcam_s_input_17_p2");
