...
struct ipmi_addr {
   int addr_type ;
    klee_make_symbolic(&addr_type, sizeof(int), "addr_type");
   short channel ;
...
struct ipmi_system_interface_addr {
   ...
   short channel ;
   unsigned char lun ;
    klee_make_symbolic(&lun, sizeof(char), "lun");
};
struct kernel_ipmi_msg {
   unsigned char netfn ;
    klee_make_symbolic(&netfn, sizeof(char), "netfn");
   unsigned char cmd ;
    klee_make_symbolic(&cmd, sizeof(char), "cmd");
   unsigned short data_len ;
    klee_make_symbolic(&data_len, sizeof(short), "data_len");
   unsigned char *data ;
};
struct klist_node;
struct klist_node;
...
struct ipmi_recv_msg {
   struct list_head link ;
   int recv_type ;
    klee_make_symbolic(&recv_type, sizeof(int), "recv_type");
   ipmi_user_t user ;
   struct ipmi_addr addr ;
   long msgid ;
    klee_make_symbolic(&msgid, sizeof(long), "msgid");
...
struct ipmi_smi_msg {
   ...
   int rsp_size ;
    klee_make_symbolic(&rsp_size, sizeof(int), "rsp_size");
...
struct die_args {
   ...
   int trapnr ;
    klee_make_symbolic(&trapnr, sizeof(int), "trapnr");
   int signr ;
...
static int watchdog_ifnum ;
    klee_make_symbolic(&watchdog_ifnum, sizeof(int), "watchdog_ifnum");
static int timeout = 10;
static int pretimeout ;
    klee_make_symbolic(&pretimeout, sizeof(int), "pretimeout");
...
static char data_to_read ;
    klee_make_symbolic(&data_to_read, sizeof(char), "data_to_read");
...
static char pretimeout_since_last_heartbeat ;
    klee_make_symbolic(&pretimeout_since_last_heartbeat, sizeof(char), "pretimeout_since_last_heartbeat");
static char expect_close ;
    klee_make_symbolic(&expect_close, sizeof(char), "expect_close");
static int ifnum_to_use = -1;
static int ipmi_set_timeout(int do_heartbeat ) ;
static void ipmi_register_watchdog(int ipmi_intf ) ;
static void ipmi_unregister_watchdog(int ipmi_intf ) ;
static int start_now ;
    klee_make_symbolic(&start_now, sizeof(int), "start_now");
...
static int ipmi_ignore_heartbeat ;
    klee_make_symbolic(&ipmi_ignore_heartbeat, sizeof(int), "ipmi_ignore_heartbeat");
static unsigned long ipmi_wdog_open ;
    klee_make_symbolic(&ipmi_wdog_open, sizeof(long), "ipmi_wdog_open");
static int ipmi_start_timer_on_heartbeat ;
    klee_make_symbolic(&ipmi_start_timer_on_heartbeat, sizeof(int), "ipmi_start_timer_on_heartbeat");
static unsigned char ipmi_version_major ;
    klee_make_symbolic(&ipmi_version_major, sizeof(char), "ipmi_version_major");
static unsigned char ipmi_version_minor ;
    klee_make_symbolic(&ipmi_version_minor, sizeof(char), "ipmi_version_minor");
static atomic_t preop_panic_excl = {-1};
static int testing_nmi ;
    klee_make_symbolic(&testing_nmi, sizeof(int), "testing_nmi");
static int nmi_handler_registered ;
    klee_make_symbolic(&nmi_handler_registered, sizeof(int), "nmi_handler_registered");
...
{ struct kernel_ipmi_msg msg ;
  ...
  int hbnow ;
    klee_make_symbolic(&hbnow, sizeof(int), "hbnow");
...
static int ipmi_set_timeout(int do_heartbeat )
{ int send_heartbeat_now ;
    klee_make_symbolic(&send_heartbeat_now, sizeof(int), "send_heartbeat_now");
  int rv ;
...
{ int rv ;
  int old_pretimeout ;
    klee_make_symbolic(&old_pretimeout, sizeof(int), "old_pretimeout");
  int old_timeout ;
    klee_make_symbolic(&old_timeout, sizeof(int), "old_timeout");
  int old_preop_val ;
    klee_make_symbolic(&old_preop_val, sizeof(int), "old_preop_val");
...
{ int reboot_event_handled ;
    klee_make_symbolic(&reboot_event_handled, sizeof(int), "reboot_event_handled");
...
{ int panic_event_handled ;
    klee_make_symbolic(&panic_event_handled, sizeof(int), "panic_event_handled");
...
static void check_parms(void)
{ int do_nmi ;
    klee_make_symbolic(&do_nmi, sizeof(int), "do_nmi");
  int rv ;
...
{ char const *var_set_param_timeout_0_p0 ;
  ...
  unsigned int var_ipmi_unlocked_ioctl_16_p1 ;
    klee_make_symbolic(&var_ipmi_unlocked_ioctl_16_p1, sizeof(int), "var_ipmi_unlocked_ioctl_16_p1");
  unsigned long var_ipmi_unlocked_ioctl_16_p2 ;
    klee_make_symbolic(&var_ipmi_unlocked_ioctl_16_p2, sizeof(long), "var_ipmi_unlocked_ioctl_16_p2");
  struct inode *var_group4 ;
  int res_ipmi_open_19 ;
    klee_make_symbolic(&res_ipmi_open_19, sizeof(int), "res_ipmi_open_19");
  int var_ipmi_fasync_21_p0 ;
    klee_make_symbolic(&var_ipmi_fasync_21_p0, sizeof(int), "var_ipmi_fasync_21_p0");
  int var_ipmi_fasync_21_p2 ;
    klee_make_symbolic(&var_ipmi_fasync_21_p2, sizeof(int), "var_ipmi_fasync_21_p2");
  ...
  unsigned long var_ipmi_nmi_27_p1 ;
    klee_make_symbolic(&var_ipmi_nmi_27_p1, sizeof(long), "var_ipmi_nmi_27_p1");
  void *var_ipmi_nmi_27_p2 ;
  unsigned long var_wdog_reboot_handler_28_p1 ;
    klee_make_symbolic(&var_wdog_reboot_handler_28_p1, sizeof(long), "var_wdog_reboot_handler_28_p1");
  void *var_wdog_reboot_handler_28_p2 ;
  unsigned long var_wdog_panic_handler_29_p1 ;
    klee_make_symbolic(&var_wdog_panic_handler_29_p1, sizeof(long), "var_wdog_panic_handler_29_p1");
  void *var_wdog_panic_handler_29_p2 ;
  int var_ipmi_new_smi_30_p0 ;
    klee_make_symbolic(&var_ipmi_new_smi_30_p0, sizeof(int), "var_ipmi_new_smi_30_p0");
  struct device *var_group6 ;
  int var_ipmi_smi_gone_31_p0 ;
    klee_make_symbolic(&var_ipmi_smi_gone_31_p0, sizeof(int), "var_ipmi_smi_gone_31_p0");
  int ldv_s_ipmi_wdog_fops_file_operations ;
    klee_make_symbolic(&ldv_s_ipmi_wdog_fops_file_operations, sizeof(int), "ldv_s_ipmi_wdog_fops_file_operations");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
