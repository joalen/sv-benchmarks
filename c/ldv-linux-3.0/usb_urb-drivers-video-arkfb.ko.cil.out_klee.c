...
struct vgastate {
   ...
   unsigned long membase ;
    klee_make_symbolic(&membase, sizeof(long), "membase");
   __u32 memsize ;
   __u32 flags ;
   __u32 depth ;
   __u32 num_attr ;
...
struct arkfb_info {
   int mclk_freq ;
    klee_make_symbolic(&mclk_freq, sizeof(int), "mclk_freq");
   int mtrr_reg ;
    klee_make_symbolic(&mtrr_reg, sizeof(int), "mtrr_reg");
   struct dac_info *dac ;
...
static int res_ark_pci_probe_30 ;
    klee_make_symbolic(&res_ark_pci_probe_30, sizeof(int), "res_ark_pci_probe_30");
int main(void)
{ struct fb_info *var_group1 ;
  ...
  int var_ics5342_set_mode_16_p1 ;
    klee_make_symbolic(&var_ics5342_set_mode_16_p1, sizeof(int), "var_ics5342_set_mode_16_p1");
  int var_ics5342_set_freq_17_p1 ;
    klee_make_symbolic(&var_ics5342_set_freq_17_p1, sizeof(int), "var_ics5342_set_freq_17_p1");
  u32 var_ics5342_set_freq_17_p2 ;
  int var_arkfb_open_23_p1 ;
    klee_make_symbolic(&var_arkfb_open_23_p1, sizeof(int), "var_arkfb_open_23_p1");
  int var_arkfb_release_24_p1 ;
    klee_make_symbolic(&var_arkfb_release_24_p1, sizeof(int), "var_arkfb_release_24_p1");
  struct fb_var_screeninfo *var_group5 ;
  u_int var_arkfb_setcolreg_27_p0 ;
    klee_make_symbolic(&var_arkfb_setcolreg_27_p0, sizeof(int), "var_arkfb_setcolreg_27_p0");
  u_int var_arkfb_setcolreg_27_p1 ;
    klee_make_symbolic(&var_arkfb_setcolreg_27_p1, sizeof(int), "var_arkfb_setcolreg_27_p1");
  u_int var_arkfb_setcolreg_27_p2 ;
    klee_make_symbolic(&var_arkfb_setcolreg_27_p2, sizeof(int), "var_arkfb_setcolreg_27_p2");
  u_int var_arkfb_setcolreg_27_p3 ;
    klee_make_symbolic(&var_arkfb_setcolreg_27_p3, sizeof(int), "var_arkfb_setcolreg_27_p3");
  u_int var_arkfb_setcolreg_27_p4 ;
    klee_make_symbolic(&var_arkfb_setcolreg_27_p4, sizeof(int), "var_arkfb_setcolreg_27_p4");
  struct fb_info *var_arkfb_setcolreg_27_p5 ;
  int var_arkfb_blank_28_p0 ;
    klee_make_symbolic(&var_arkfb_blank_28_p0, sizeof(int), "var_arkfb_blank_28_p0");
  ...
  int ldv_s_arkfb_pci_driver_pci_driver ;
    klee_make_symbolic(&ldv_s_arkfb_pci_driver_pci_driver, sizeof(int), "ldv_s_arkfb_pci_driver_pci_driver");
  int tmp___8 ;
  int tmp___9 ;
