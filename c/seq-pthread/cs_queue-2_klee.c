...
unsigned int __CS_StmtCount;
    klee_make_symbolic(&__CS_StmtCount, sizeof(int), "__CS_StmtCount");
unsigned int __CS_SwitchDone;
    klee_make_symbolic(&__CS_SwitchDone, sizeof(int), "__CS_SwitchDone");
*/
...
{
	int element[20];
    klee_make_symbolic(element, sizeof(int)*20, "element");
	int head;
