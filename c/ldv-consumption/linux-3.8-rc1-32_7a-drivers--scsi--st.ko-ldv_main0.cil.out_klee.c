...
static int buffer_kbs  ;
    klee_make_symbolic(&buffer_kbs, sizeof(int), "buffer_kbs");
static int max_sg_segs  ;
    klee_make_symbolic(&max_sg_segs, sizeof(int), "max_sg_segs");
...
static int modes_defined  ;
    klee_make_symbolic(&modes_defined, sizeof(int), "modes_defined");
...
{ 
  int set_it ;
    klee_make_symbolic(&set_it, sizeof(int), "set_it");
  unsigned long arg ;
...
{ 
  int attentions ;
    klee_make_symbolic(&attentions, sizeof(int), "attentions");
  int waits ;
    klee_make_symbolic(&waits, sizeof(int), "waits");
  int max_wait ;
    klee_make_symbolic(&max_wait, sizeof(int), "max_wait");
  int scode ;
    klee_make_symbolic(&scode, sizeof(int), "scode");
  int retval ;
  int new_session ;
...
{ 
  ...
  int new_session ;
  int do_wait ;
    klee_make_symbolic(&do_wait, sizeof(int), "do_wait");
  unsigned char cmd[16U] ;
  unsigned char saved_cleaning ;
    klee_make_symbolic(&saved_cleaning, sizeof(char), "saved_cleaning");
  unsigned short st_flags ;
    klee_make_symbolic(&st_flags, sizeof(short), "st_flags");
  struct st_request *SRpnt ;
...
{ 
  ...
  int retval ;
  int resumed ;
    klee_make_symbolic(&resumed, sizeof(int), "resumed");
  struct scsi_tape *STp ;
  struct st_partstat *STps ;
  int dev ;
...
{ 
  ...
  ssize_t retval ;
  int undone ;
    klee_make_symbolic(&undone, sizeof(int), "undone");
  int retry_eot ;
    klee_make_symbolic(&retry_eot, sizeof(int), "retry_eot");
  int scode ;
  int async_write ;
    klee_make_symbolic(&async_write, sizeof(int), "async_write");
  unsigned char cmd[16U] ;
  char const   *b_point ;
  struct st_request *SRpnt ;
  struct scsi_tape *STp ;
...
{ 
  int pgo ;
    klee_make_symbolic(&pgo, sizeof(int), "pgo");
  unsigned char cmd[16U] ;
  struct st_request *SRpnt ;
  int timeout ;
...
{ 
  int retval ;
  int mpoffs ;
    klee_make_symbolic(&mpoffs, sizeof(int), "mpoffs");
  unsigned char *b_data ;
...
{ 
  ...
  int pgo ;
  int psd_cnt ;
    klee_make_symbolic(&psd_cnt, sizeof(int), "psd_cnt");
  int psdo ;
    klee_make_symbolic(&psdo, sizeof(int), "psdo");
  unsigned char *bp ;
...
{ 
  ...
  int bt ;
    klee_make_symbolic(&bt, sizeof(int), "bt");
  int retval ;
  unsigned int blk ;
  struct scsi_tape *STp ;
  struct st_modedef *STm ;
...
{ 
  int src_seg ;
    klee_make_symbolic(&src_seg, sizeof(int), "src_seg");
  int dst_seg ;
    klee_make_symbolic(&dst_seg, sizeof(int), "dst_seg");
  int src_offset ;
...
{ 
  int mode ;
  int rew ;
    klee_make_symbolic(&rew, sizeof(int), "rew");
  struct st_modedef *STm ;
...
{ 
  ...
  int res_st_probe_57 ;
    klee_make_symbolic(&res_st_probe_57, sizeof(int), "res_st_probe_57");
  ...
  unsigned int var_st_ioctl_43_p1 ;
    klee_make_symbolic(&var_st_ioctl_43_p1, sizeof(int), "var_st_ioctl_43_p1");
  unsigned long var_st_ioctl_43_p2 ;
    klee_make_symbolic(&var_st_ioctl_43_p2, sizeof(long), "var_st_ioctl_43_p2");
  unsigned int var_st_compat_ioctl_44_p1 ;
    klee_make_symbolic(&var_st_compat_ioctl_44_p1, sizeof(int), "var_st_compat_ioctl_44_p1");
  unsigned long var_st_compat_ioctl_44_p2 ;
    klee_make_symbolic(&var_st_compat_ioctl_44_p2, sizeof(long), "var_st_compat_ioctl_44_p2");
  struct inode *var_group3 ;
  int res_st_open_20 ;
    klee_make_symbolic(&res_st_open_20, sizeof(int), "res_st_open_20");
  fl_owner_t var_st_flush_21_p1 ;
  int ldv_s_st_template_scsi_driver ;
    klee_make_symbolic(&ldv_s_st_template_scsi_driver, sizeof(int), "ldv_s_st_template_scsi_driver");
  int ldv_s_st_fops_file_operations ;
    klee_make_symbolic(&ldv_s_st_fops_file_operations, sizeof(int), "ldv_s_st_fops_file_operations");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
...
static int ldv_mutex_lock_of_scsi_tape  ;
    klee_make_symbolic(&ldv_mutex_lock_of_scsi_tape, sizeof(int), "ldv_mutex_lock_of_scsi_tape");
int ldv_mutex_lock_interruptible_lock_of_scsi_tape(struct mutex *lock ) 
{ 
  int nondetermined ;
...
static int ldv_mutex_st_ref_mutex  ;
    klee_make_symbolic(&ldv_mutex_st_ref_mutex, sizeof(int), "ldv_mutex_st_ref_mutex");
