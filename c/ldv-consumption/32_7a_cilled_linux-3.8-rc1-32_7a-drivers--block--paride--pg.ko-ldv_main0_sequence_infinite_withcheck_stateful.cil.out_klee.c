...
struct pg_read_hdr {
   char magic ;
   char scsi ;
    klee_make_symbolic(&scsi, sizeof(char), "scsi");
   int dlen ;
   int duration ;
...
struct pg {
   ...
   unsigned long access ;
    klee_make_symbolic(&access, sizeof(long), "access");
   int present ;
...
static int pg_drive_count  ;
    klee_make_symbolic(&pg_drive_count, sizeof(int), "pg_drive_count");
...
{ 
  ...
  int res_pg_open_14 ;
    klee_make_symbolic(&res_pg_open_14, sizeof(int), "res_pg_open_14");
  int ldv_s_pg_fops_file_operations ;
    klee_make_symbolic(&ldv_s_pg_fops_file_operations, sizeof(int), "ldv_s_pg_fops_file_operations");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
...
static int ldv_mutex_pg_mutex  ;
    klee_make_symbolic(&ldv_mutex_pg_mutex, sizeof(int), "ldv_mutex_pg_mutex");
