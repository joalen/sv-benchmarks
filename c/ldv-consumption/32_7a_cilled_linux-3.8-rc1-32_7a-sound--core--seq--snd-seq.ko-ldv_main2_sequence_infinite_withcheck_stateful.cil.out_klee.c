...
struct snd_timer_id {
   ...
   int dev_sclass ;
    klee_make_symbolic(&dev_sclass, sizeof(int), "dev_sclass");
   int card ;
    klee_make_symbolic(&card, sizeof(int), "card");
   int device ;
...
struct snd_seq_ev_note {
   ...
   unsigned char note ;
    klee_make_symbolic(&note, sizeof(char), "note");
...
struct snd_seq_ev_queue_control {
   unsigned char queue ;
    klee_make_symbolic(&queue, sizeof(char), "queue");
...
struct snd_seq_system_info {
   ...
   int clients ;
    klee_make_symbolic(&clients, sizeof(int), "clients");
   int ports ;
    klee_make_symbolic(&ports, sizeof(int), "ports");
   int channels ;
    klee_make_symbolic(&channels, sizeof(int), "channels");
   int cur_clients ;
    klee_make_symbolic(&cur_clients, sizeof(int), "cur_clients");
   int cur_queues ;
    klee_make_symbolic(&cur_queues, sizeof(int), "cur_queues");
   char reserved[24U] ;
};
struct snd_seq_running_info {
   unsigned char client ;
   unsigned char big_endian ;
    klee_make_symbolic(&big_endian, sizeof(char), "big_endian");
   unsigned char cpu_mode ;
    klee_make_symbolic(&cpu_mode, sizeof(char), "cpu_mode");
   unsigned char pad ;
...
struct snd_seq_query_subs {
   ...
   int index ;
   int num_subs ;
    klee_make_symbolic(&num_subs, sizeof(int), "num_subs");
   struct snd_seq_addr addr ;
   unsigned char queue ;
   unsigned int flags ;
   char reserved[64U] ;
...
struct snd_seq_port_callback {
   ...
   unsigned int callback_all ;
    klee_make_symbolic(&callback_all, sizeof(int), "callback_all");
};
struct pollfd {
   int fd ;
...
struct snd_seq_pool {
   ...
   int total_elements ;
    klee_make_symbolic(&total_elements, sizeof(int), "total_elements");
   atomic_t counter ;
   int size ;
   int room ;
   ...
   int max_used ;
    klee_make_symbolic(&max_used, sizeof(int), "max_used");
   int event_alloc_nopool ;
    klee_make_symbolic(&event_alloc_nopool, sizeof(int), "event_alloc_nopool");
   int event_alloc_failures ;
    klee_make_symbolic(&event_alloc_failures, sizeof(int), "event_alloc_failures");
   int event_alloc_success ;
    klee_make_symbolic(&event_alloc_success, sizeof(int), "event_alloc_success");
...
struct snd_seq_fifo {
   ...
   int cells ;
    klee_make_symbolic(&cells, sizeof(int), "cells");
   spinlock_t lock ;
...
struct snd_seq_user_client {
   ...
   int fifo_pool_size ;
    klee_make_symbolic(&fifo_pool_size, sizeof(int), "fifo_pool_size");
};
...
struct snd_seq_client {
   ...
   int convert32 ;
    klee_make_symbolic(&convert32, sizeof(int), "convert32");
   struct snd_seq_pool *pool ;
...
struct snd_seq_usage {
   ...
   int peak ;
    klee_make_symbolic(&peak, sizeof(int), "peak");
};
...
struct snd_timer_hardware {
   ...
   unsigned long resolution_min ;
    klee_make_symbolic(&resolution_min, sizeof(long), "resolution_min");
   unsigned long resolution_max ;
    klee_make_symbolic(&resolution_max, sizeof(long), "resolution_max");
   unsigned long ticks ;
    klee_make_symbolic(&ticks, sizeof(long), "ticks");
...
struct snd_timer {
   int tmr_class ;
    klee_make_symbolic(&tmr_class, sizeof(int), "tmr_class");
   struct snd_card *card ;
   struct module *module ;
   int tmr_device ;
    klee_make_symbolic(&tmr_device, sizeof(int), "tmr_device");
   int tmr_subdevice ;
    klee_make_symbolic(&tmr_subdevice, sizeof(int), "tmr_subdevice");
   char id[64U] ;
   char name[80U] ;
   unsigned int flags ;
   int running ;
   unsigned long sticks ;
    klee_make_symbolic(&sticks, sizeof(long), "sticks");
   void *private_data ;
...
struct snd_timer_instance {
   ...
   unsigned long cticks ;
    klee_make_symbolic(&cticks, sizeof(long), "cticks");
   unsigned long pticks ;
    klee_make_symbolic(&pticks, sizeof(long), "pticks");
   unsigned long resolution ;
   unsigned long lost ;
    klee_make_symbolic(&lost, sizeof(long), "lost");
   int slave_class ;
    klee_make_symbolic(&slave_class, sizeof(int), "slave_class");
...
struct snd_seq_timer_tick {
   ...
   unsigned long fraction ;
    klee_make_symbolic(&fraction, sizeof(long), "fraction");
};
struct snd_seq_timer {
   ...
   int tick_updated ;
    klee_make_symbolic(&tick_updated, sizeof(int), "tick_updated");
   int type ;
   struct snd_timer_id alsa_id ;
   struct snd_timer_instance *timeri ;
   unsigned int ticks ;
   unsigned long preferred_resolution ;
    klee_make_symbolic(&preferred_resolution, sizeof(long), "preferred_resolution");
   unsigned int skew ;
    klee_make_symbolic(&skew, sizeof(int), "skew");
   unsigned int skew_base ;
...
int seq_default_timer_class ;
    klee_make_symbolic(&seq_default_timer_class, sizeof(int), "seq_default_timer_class");
int seq_default_timer_sclass ;
    klee_make_symbolic(&seq_default_timer_sclass, sizeof(int), "seq_default_timer_sclass");
int seq_default_timer_card ;
    klee_make_symbolic(&seq_default_timer_card, sizeof(int), "seq_default_timer_card");
int seq_default_timer_device ;
    klee_make_symbolic(&seq_default_timer_device, sizeof(int), "seq_default_timer_device");
int seq_default_timer_subdevice ;
    klee_make_symbolic(&seq_default_timer_subdevice, sizeof(int), "seq_default_timer_subdevice");
int seq_default_timer_resolution ;
    klee_make_symbolic(&seq_default_timer_resolution, sizeof(int), "seq_default_timer_resolution");
...
extern int snd_ecards_limit ;
    klee_make_symbolic(&snd_ecards_limit, sizeof(int), "snd_ecards_limit");
...
{ 
  ...
  int nonblock ;
    klee_make_symbolic(&nonblock, sizeof(int), "nonblock");
...
{ 
  ...
  int result ;
  int direct ;
    klee_make_symbolic(&direct, sizeof(int), "direct");
  int tmp ;
...
{ 
  ...
  int err ;
  int num_ev ;
    klee_make_symbolic(&num_ev, sizeof(int), "num_ev");
...
{ 
  ...
  int tmp___5 ;
  int extlen ;
    klee_make_symbolic(&extlen, sizeof(int), "extlen");
  void *ptr ;
  void *tmp___6 ;
...
{ 
  ...
  int res_snd_seq_open_12 ;
    klee_make_symbolic(&res_snd_seq_open_12, sizeof(int), "res_snd_seq_open_12");
  poll_table *var_snd_seq_poll_29_p1 ;
  unsigned int var_snd_seq_ioctl_64_p1 ;
    klee_make_symbolic(&var_snd_seq_ioctl_64_p1, sizeof(int), "var_snd_seq_ioctl_64_p1");
  unsigned long var_snd_seq_ioctl_64_p2 ;
    klee_make_symbolic(&var_snd_seq_ioctl_64_p2, sizeof(long), "var_snd_seq_ioctl_64_p2");
  int ldv_s_snd_seq_f_ops_file_operations ;
    klee_make_symbolic(&ldv_s_snd_seq_f_ops_file_operations, sizeof(int), "ldv_s_snd_seq_f_ops_file_operations");
  int tmp ;
  int tmp___0 ;
...
{ 
  int ncells ;
    klee_make_symbolic(&ncells, sizeof(int), "ncells");
  int err ;
  unsigned int extlen ;
  struct snd_seq_event_cell *cell ;
  int len ;
  int is_chained ;
    klee_make_symbolic(&is_chained, sizeof(int), "is_chained");
  int is_usrptr ;
    klee_make_symbolic(&is_usrptr, sizeof(int), "is_usrptr");
...
{ 
  unsigned long flags ;
  int access_ok ;
    klee_make_symbolic(&access_ok, sizeof(int), "access_ok");
  raw_spinlock_t *tmp ;
...
{ 
  int i ;
  int bpm ;
    klee_make_symbolic(&bpm, sizeof(int), "bpm");
  struct snd_seq_queue *q ;
  struct snd_seq_timer *tmr ;
  int tmp ;
  int tmp___0 ;
...
{ 
  ...
  int count ;
  int prior ;
    klee_make_symbolic(&prior, sizeof(int), "prior");
  int __ret_warn_on ;
  long tmp ;
  long tmp___0 ;
  raw_spinlock_t *tmp___1 ;
...
{ 
  int oldsysclient ;
    klee_make_symbolic(&oldsysclient, sizeof(int), "oldsysclient");
...
{ 
  ...
  int err ;
  int src_called ;
    klee_make_symbolic(&src_called, sizeof(int), "src_called");
  unsigned long flags ;
  int exclusive ;
...
static int ldv_mutex_ports_mutex  ;
    klee_make_symbolic(&ldv_mutex_ports_mutex, sizeof(int), "ldv_mutex_ports_mutex");
...
static int ldv_mutex_power_lock  ;
    klee_make_symbolic(&ldv_mutex_power_lock, sizeof(int), "ldv_mutex_power_lock");
...
static int ldv_mutex_register_mutex  ;
    klee_make_symbolic(&ldv_mutex_register_mutex, sizeof(int), "ldv_mutex_register_mutex");
int ldv_mutex_lock_interruptible_register_mutex(struct mutex *lock ) 
{ 
  int nondetermined ;
...
static int ldv_mutex_timer_mutex  ;
    klee_make_symbolic(&ldv_mutex_timer_mutex, sizeof(int), "ldv_mutex_timer_mutex");
int ldv_mutex_lock_interruptible_timer_mutex(struct mutex *lock ) 
{ 
  int nondetermined ;
