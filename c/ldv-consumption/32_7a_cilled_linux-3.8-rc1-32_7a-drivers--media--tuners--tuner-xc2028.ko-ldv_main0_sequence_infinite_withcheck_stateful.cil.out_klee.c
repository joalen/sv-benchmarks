...
struct firmware_properties {
   ...
   unsigned int scode_table ;
   int scode_nr ;
    klee_make_symbolic(&scode_nr, sizeof(int), "scode_nr");
};
enum xc2028_state {
...
struct xc2028_data {
   ...
   int firm_size ;
    klee_make_symbolic(&firm_size, sizeof(int), "firm_size");
   __u16 firm_version ;
   __u16 hwmodel ;
   __u16 hwvers ;
   struct xc2028_ctrl ctrl ;
...
static int no_poweroff  ;
    klee_make_symbolic(&no_poweroff, sizeof(int), "no_poweroff");
...
{ 
  ...
  int _rc ;
    klee_make_symbolic(&_rc, sizeof(int), "_rc");
  int tmp___1 ;
...
{ 
  ...
  int n_array ;
    klee_make_symbolic(&n_array, sizeof(int), "n_array");
  char name[33U] ;
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
...
{ 
  ...
  int i ;
  int best_i ;
    klee_make_symbolic(&best_i, sizeof(int), "best_i");
  int best_nr_matches ;
    klee_make_symbolic(&best_nr_matches, sizeof(int), "best_nr_matches");
  unsigned int type_mask ;
    klee_make_symbolic(&type_mask, sizeof(int), "type_mask");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
  int tmp___2 ;
...
{ 
  ...
  u8 _val___0[4U] ;
  int _rc___0 ;
    klee_make_symbolic(&_rc___0, sizeof(int), "_rc___0");
  int tmp___5 ;
  int tmp___6 ;
  int _rc___1 ;
    klee_make_symbolic(&_rc___1, sizeof(int), "_rc___1");
  int tmp___7 ;
  int tmp___8 ;
  u8 _val___1[2U] ;
  int _rc___2 ;
    klee_make_symbolic(&_rc___2, sizeof(int), "_rc___2");
  int tmp___9 ;
  int tmp___10 ;
...
{ 
  ...
  int ldv_s_xc2028_dvb_tuner_ops_dvb_tuner_ops ;
    klee_make_symbolic(&ldv_s_xc2028_dvb_tuner_ops_dvb_tuner_ops, sizeof(int), "ldv_s_xc2028_dvb_tuner_ops_dvb_tuner_ops");
  int tmp ;
  int tmp___0 ;
...
static int ldv_mutex_xc2028_list_mutex  ;
    klee_make_symbolic(&ldv_mutex_xc2028_list_mutex, sizeof(int), "ldv_mutex_xc2028_list_mutex");
