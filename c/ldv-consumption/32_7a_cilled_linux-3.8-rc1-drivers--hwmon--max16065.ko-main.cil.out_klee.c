...
struct max16065_data {
   ...
   int num_adc ;
    klee_make_symbolic(&num_adc, sizeof(int), "num_adc");
   bool have_current ;
   int curr_gain ;
    klee_make_symbolic(&curr_gain, sizeof(int), "curr_gain");
   int limit[3U][12U] ;
   int range[13U] ;
   int adc[13U] ;
   int curr_sense ;
    klee_make_symbolic(&curr_sense, sizeof(int), "curr_sense");
   int fault[2U] ;
};
...
{ struct sensor_device_attribute *attr ;
  ...
  struct max16065_data *tmp ;
  int adc ;
    klee_make_symbolic(&adc, sizeof(int), "adc");
  long tmp___0 ;
  int tmp___1 ;
  int tmp___2 ;
...
static int ldv_mutex_update_lock_of_max16065_data  ;
    klee_make_symbolic(&ldv_mutex_update_lock_of_max16065_data, sizeof(int), "ldv_mutex_update_lock_of_max16065_data");
