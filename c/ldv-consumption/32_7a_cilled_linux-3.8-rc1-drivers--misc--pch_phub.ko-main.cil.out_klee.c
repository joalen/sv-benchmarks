...
struct pch_phub_reg {
   ...
   int ioh_type ;
    klee_make_symbolic(&ioh_type, sizeof(int), "ioh_type");
   struct pci_dev *pdev ;
};
...
{ void *mem_addr ;
  ...
  unsigned int word_data ;
    klee_make_symbolic(&word_data, sizeof(int), "word_data");
  unsigned int pos ;
...
{ unsigned int mem_addr ;
    klee_make_symbolic(&mem_addr, sizeof(int), "mem_addr");
...
{ unsigned int rom_signature ;
    klee_make_symbolic(&rom_signature, sizeof(int), "rom_signature");
  unsigned char rom_length ;
    klee_make_symbolic(&rom_length, sizeof(char), "rom_length");
  unsigned int tmp ;
  unsigned int addr_offset ;
    klee_make_symbolic(&addr_offset, sizeof(int), "addr_offset");
  unsigned int orom_size ;
    klee_make_symbolic(&orom_size, sizeof(int), "orom_size");
  int ret ;
...
static int ldv_mutex_pch_phub_mutex  ;
    klee_make_symbolic(&ldv_mutex_pch_phub_mutex, sizeof(int), "ldv_mutex_pch_phub_mutex");
int ldv_mutex_lock_interruptible_pch_phub_mutex(struct mutex *lock ) 
{ int nondetermined ;
