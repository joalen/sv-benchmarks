...
struct waiter {
   ...
   struct task_struct *task ;
   int wants_write ;
    klee_make_symbolic(&wants_write, sizeof(int), "wants_write");
};
struct buffer_aux {
   struct dm_block_validator *validator ;
   struct block_lock lock ;
   int write_locked ;
    klee_make_symbolic(&write_locked, sizeof(int), "write_locked");
};
struct dm_block_manager {
...
struct dm_btree_info {
   ...
   unsigned int levels ;
    klee_make_symbolic(&levels, sizeof(int), "levels");
...
struct sm_metadata {
   ...
   unsigned int recursion_count ;
    klee_make_symbolic(&recursion_count, sizeof(int), "recursion_count");
   unsigned int allocated_this_transaction ;
    klee_make_symbolic(&allocated_this_transaction, sizeof(int), "allocated_this_transaction");
   unsigned int nr_uncommitted ;
    klee_make_symbolic(&nr_uncommitted, sizeof(int), "nr_uncommitted");
...
struct dm_transaction_manager {
   int is_clone ;
    klee_make_symbolic(&is_clone, sizeof(int), "is_clone");
...
struct frame {
   ...
   unsigned int nr_children ;
    klee_make_symbolic(&nr_children, sizeof(int), "nr_children");
   unsigned int current_child ;
    klee_make_symbolic(&current_child, sizeof(int), "current_child");
};
struct del_stack {
   struct dm_transaction_manager *tm ;
   int top ;
...
{ 
  ...
  unsigned int old_blocks ;
    klee_make_symbolic(&old_blocks, sizeof(int), "old_blocks");
  unsigned int blocks ;
  sector_t _r ;
  int _res ;
...
{ 
  ...
  unsigned int adjustment ;
    klee_make_symbolic(&adjustment, sizeof(int), "adjustment");
  struct block_op *op ;
...
{ 
  unsigned int BIG_PRIME ;
    klee_make_symbolic(&BIG_PRIME, sizeof(int), "BIG_PRIME");
...
{ 
  ...
  unsigned int last_level ;
    klee_make_symbolic(&last_level, sizeof(int), "last_level");
  int r ;
  uint64_t rkey ;
...
{ 
  ...
  unsigned int nr_left ;
    klee_make_symbolic(&nr_left, sizeof(int), "nr_left");
  unsigned int nr_right ;
    klee_make_symbolic(&nr_right, sizeof(int), "nr_right");
...
{ 
  int r ;
  int need_insert ;
    klee_make_symbolic(&need_insert, sizeof(int), "need_insert");
  unsigned int level ;
  unsigned int index ;
  unsigned int last_level ;
  dm_block_t block ;
...
{ 
  ...
  unsigned int nr_to_copy ;
    klee_make_symbolic(&nr_to_copy, sizeof(int), "nr_to_copy");
  uint32_t value_size ;
  long tmp ;
  __le64 *tmp___0 ;
  __le64 *tmp___1 ;
...
{ 
  ...
  unsigned int target_left ;
    klee_make_symbolic(&target_left, sizeof(int), "target_left");
  __le64 *tmp___1 ;
...
{ 
  ...
  int has_left_sibling ;
    klee_make_symbolic(&has_left_sibling, sizeof(int), "has_left_sibling");
  int has_right_sibling ;
    klee_make_symbolic(&has_right_sibling, sizeof(int), "has_right_sibling");
