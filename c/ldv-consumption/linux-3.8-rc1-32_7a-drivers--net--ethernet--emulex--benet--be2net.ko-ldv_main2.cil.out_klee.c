...
struct flash_comp {
   ...
   int optype ;
    klee_make_symbolic(&optype, sizeof(int), "optype");
   int size ;
   int img_type ;
    klee_make_symbolic(&img_type, sizeof(int), "img_type");
};
struct image_hdr {
   u32 imageid ;
   u32 imageoffset ;
...
struct be_tx_stats {
   ...
   u64 tx_compl ;
   ulong tx_jiffies ;
    klee_make_symbolic(&tx_jiffies, sizeof(long), "tx_jiffies");
   u32 tx_stops ;
...
struct be_rx_stats {
   ...
   u64 rx_pkts_prev ;
   ulong rx_jiffies ;
    klee_make_symbolic(&rx_jiffies, sizeof(long), "rx_jiffies");
...
struct be_vf_cfg {
   ...
   int if_handle ;
    klee_make_symbolic(&if_handle, sizeof(int), "if_handle");
   int pmac_id ;
    klee_make_symbolic(&pmac_id, sizeof(int), "pmac_id");
   u16 def_vid ;
   u16 vlan_tag ;
   u32 tx_rate ;
};
...
struct be_adapter {
   ...
   int be_get_temp_freq ;
    klee_make_symbolic(&be_get_temp_freq, sizeof(int), "be_get_temp_freq");
   u16 max_mcast_mac ;
   u16 max_tx_queues ;
   u16 max_rss_queues ;
   u16 max_rx_queues ;
...
typedef int ldv_func_ret_type___32;
    klee_make_symbolic(&ldv_func_ret_type___32, sizeof(int), "ldv_func_ret_type___32");
typedef int ldv_func_ret_type___34;
    klee_make_symbolic(&ldv_func_ret_type___34, sizeof(int), "ldv_func_ret_type___34");
...
struct __anonstruct_msix_263 {
   int num_vectors ;
    klee_make_symbolic(&num_vectors, sizeof(int), "num_vectors");
   int start_vector ;
    klee_make_symbolic(&start_vector, sizeof(int), "start_vector");
   u32 vector_list[16U] ;
};
struct be_dev_info {
   u8 *db ;
...
{ 
  ...
  struct pci_dev *pdev ;
  int vfs ;
    klee_make_symbolic(&vfs, sizeof(int), "vfs");
  int assigned_vfs ;
    klee_make_symbolic(&assigned_vfs, sizeof(int), "assigned_vfs");
  int pos ;
...
{ 
  ...
  u16 _min1___0 ;
  ushort _min2___0 ;
    klee_make_symbolic(&_min2___0, sizeof(short), "_min2___0");
...
{ 
  ...
  struct be_adapter *adapter ;
  int flush_wait ;
    klee_make_symbolic(&flush_wait, sizeof(int), "flush_wait");
  u16 tail ;
  int tmp ;
  bool tmp___0 ;
  unsigned long __ms ;
...
{ 
  ...
  int i ;
  int pending_txqs ;
    klee_make_symbolic(&pending_txqs, sizeof(int), "pending_txqs");
  u32 tmp ;
  u32 tmp___0 ;
  u16 tmp___1 ;
  int tmp___2 ;
...
{ 
  ...
  struct be_adapter *adapter ;
  int num_evts ;
    klee_make_symbolic(&num_evts, sizeof(int), "num_evts");
  bool tmp ;
  u16 tmp___0 ;
...
{ 
  struct be_eth_tx_compl *txcp ;
  int num_wrbs ;
    klee_make_symbolic(&num_wrbs, sizeof(int), "num_wrbs");
  int work_done ;
...
{ 
  ...
  int status ;
  int num_vec ;
    klee_make_symbolic(&num_vec, sizeof(int), "num_vec");
  int num_roce_vec ;
    klee_make_symbolic(&num_roce_vec, sizeof(int), "num_roce_vec");
  struct device *dev ;
  uint _min1 ;
  uint tmp ;
  unsigned int _min2 ;
...
{ 
  ...
  int status ;
  int old_vfs ;
    klee_make_symbolic(&old_vfs, sizeof(int), "old_vfs");
  int vf ;
  struct device *dev ;
  u16 __min1 ;
  u16 __min2 ;
...
{ 
  ...
  int i ;
  int filehdr_size ;
    klee_make_symbolic(&filehdr_size, sizeof(int), "filehdr_size");
  int img_hdrs_size ;
    klee_make_symbolic(&img_hdrs_size, sizeof(int), "img_hdrs_size");
  u8 const   *p ;
  struct flash_comp  const  *pflashcomp ;
  int num_comp ;
    klee_make_symbolic(&num_comp, sizeof(int), "num_comp");
  int redboot ;
    klee_make_symbolic(&redboot, sizeof(int), "redboot");
  struct flash_section_info *fsec ;
...
{ 
  ...
  int filehdr_size ;
  int img_offset ;
    klee_make_symbolic(&img_offset, sizeof(int), "img_offset");
  int img_size ;
    klee_make_symbolic(&img_size, sizeof(int), "img_size");
  int img_optype ;
    klee_make_symbolic(&img_optype, sizeof(int), "img_optype");
  int redboot ;
  int img_hdrs_size ;
  u8 const   *p ;
  struct flash_section_info *fsec ;
...
{ 
  ...
  int i ;
  int num_imgs ;
    klee_make_symbolic(&num_imgs, sizeof(int), "num_imgs");
  int ufi_type ;
    klee_make_symbolic(&ufi_type, sizeof(int), "ufi_type");
...
{ 
  ...
  struct net_device *netdev ;
  char port_name ;
    klee_make_symbolic(&port_name, sizeof(char), "port_name");
  void *tmp ;
  bool tmp___0 ;
  struct lock_class_key __key ;
...
{ 
  ...
  int res_be_open_88 ;
    klee_make_symbolic(&res_be_open_88, sizeof(int), "res_be_open_88");
  int res_be_close_86 ;
    klee_make_symbolic(&res_be_close_86, sizeof(int), "res_be_close_86");
  struct sk_buff *var_group2 ;
  void *var_be_mac_addr_set_9_p1 ;
  int var_be_change_mtu_32_p1 ;
    klee_make_symbolic(&var_be_change_mtu_32_p1, sizeof(int), "var_be_change_mtu_32_p1");
  ...
  int var_be_set_vf_mac_37_p1 ;
    klee_make_symbolic(&var_be_set_vf_mac_37_p1, sizeof(int), "var_be_set_vf_mac_37_p1");
  u8 *var_be_set_vf_mac_37_p2 ;
  int var_be_set_vf_vlan_39_p1 ;
    klee_make_symbolic(&var_be_set_vf_vlan_39_p1, sizeof(int), "var_be_set_vf_vlan_39_p1");
  u16 var_be_set_vf_vlan_39_p2 ;
  u8 var_be_set_vf_vlan_39_p3 ;
  int var_be_set_vf_tx_rate_40_p1 ;
    klee_make_symbolic(&var_be_set_vf_tx_rate_40_p1, sizeof(int), "var_be_set_vf_tx_rate_40_p1");
  int var_be_set_vf_tx_rate_40_p2 ;
    klee_make_symbolic(&var_be_set_vf_tx_rate_40_p2, sizeof(int), "var_be_set_vf_tx_rate_40_p2");
  int var_be_get_vf_config_38_p1 ;
    klee_make_symbolic(&var_be_get_vf_config_38_p1, sizeof(int), "var_be_get_vf_config_38_p1");
  ...
  int res_be_probe_135 ;
    klee_make_symbolic(&res_be_probe_135, sizeof(int), "res_be_probe_135");
  pm_message_t var_be_suspend_136_p1 ;
  int var_be_intx_71_p0 ;
    klee_make_symbolic(&var_be_intx_71_p0, sizeof(int), "var_be_intx_71_p0");
  void *var_be_intx_71_p1 ;
  int var_be_msix_72_p0 ;
    klee_make_symbolic(&var_be_msix_72_p0, sizeof(int), "var_be_msix_72_p0");
  void *var_be_msix_72_p1 ;
  int ldv_s_be_netdev_ops_net_device_ops ;
    klee_make_symbolic(&ldv_s_be_netdev_ops_net_device_ops, sizeof(int), "ldv_s_be_netdev_ops_net_device_ops");
  int ldv_s_be_driver_pci_driver ;
    klee_make_symbolic(&ldv_s_be_driver_pci_driver, sizeof(int), "ldv_s_be_driver_pci_driver");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
...
{ 
  ...
  int status ;
  int mac_count ;
    klee_make_symbolic(&mac_count, sizeof(int), "mac_count");
...
{ 
  ...
  int var_be_get_sset_count_9_p1 ;
    klee_make_symbolic(&var_be_get_sset_count_9_p1, sizeof(int), "var_be_get_sset_count_9_p1");
...
static int ldv_mutex_be_adapter_list_lock  ;
    klee_make_symbolic(&ldv_mutex_be_adapter_list_lock, sizeof(int), "ldv_mutex_be_adapter_list_lock");
...
static int ldv_mutex_mbox_lock_of_be_adapter  ;
    klee_make_symbolic(&ldv_mutex_mbox_lock_of_be_adapter, sizeof(int), "ldv_mutex_mbox_lock_of_be_adapter");
int ldv_mutex_lock_interruptible_mbox_lock_of_be_adapter(struct mutex *lock ) 
{ 
  int nondetermined ;
