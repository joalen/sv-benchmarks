...
static int flicker_mode  ;
    klee_make_symbolic(&flicker_mode, sizeof(int), "flicker_mode");
...
{ u8 tmp_reg ;
  int retval ;
  int target_kb ;
    klee_make_symbolic(&target_kb, sizeof(int), "target_kb");
  int i ;
  struct cpia2_command cmd ;
  unsigned long tmp ;
...
static int ldv_mutex_v4l2_lock_of_camera_data  ;
    klee_make_symbolic(&ldv_mutex_v4l2_lock_of_camera_data, sizeof(int), "ldv_mutex_v4l2_lock_of_camera_data");
int ldv_mutex_lock_interruptible_v4l2_lock_of_camera_data(struct mutex *lock ) 
{ int nondetermined ;
