...
struct __anonstruct_ether_229 {
   ...
   int tx_free_cnt ;
    klee_make_symbolic(&tx_free_cnt, sizeof(int), "tx_free_cnt");
   spinlock_t tx_lock ;
};
struct channel {
   struct pci_dev *pdev ;
   ...
   int leds ;
    klee_make_symbolic(&leds, sizeof(int), "leds");
...
struct card {
   ...
   unsigned long bootrom_addr ;
    klee_make_symbolic(&bootrom_addr, sizeof(long), "bootrom_addr");
   struct timer_list timer ;
...
{ struct card *card ;
  ...
  int blinker ;
    klee_make_symbolic(&blinker, sizeof(int), "blinker");
  int tmp ;
...
{ struct channel *sc ;
  int cmd_2t3e3 ;
    klee_make_symbolic(&cmd_2t3e3, sizeof(int), "cmd_2t3e3");
  int len ;
  int rlen ;
...
void dc_stop(struct channel *sc ) 
{ int wcnt ;
    klee_make_symbolic(&wcnt, sizeof(int), "wcnt");
