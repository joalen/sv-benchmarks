...
{ 
  ...
  struct i2o_controller *tmp ;
  int num_controllers ;
    klee_make_symbolic(&num_controllers, sizeof(int), "num_controllers");
  u32 change_ind ;
  int count ;
...
{ 
  ...
  int res_i2o_pci_probe_5 ;
    klee_make_symbolic(&res_i2o_pci_probe_5, sizeof(int), "res_i2o_pci_probe_5");
  int var_i2o_pci_interrupt_2_p0 ;
    klee_make_symbolic(&var_i2o_pci_interrupt_2_p0, sizeof(int), "var_i2o_pci_interrupt_2_p0");
  void *var_i2o_pci_interrupt_2_p1 ;
  int ldv_s_i2o_pci_driver_pci_driver ;
    klee_make_symbolic(&ldv_s_i2o_pci_driver_pci_driver, sizeof(int), "ldv_s_i2o_pci_driver_pci_driver");
  int tmp ;
  int tmp___0 ;
...
{ 
  ...
  int res_i2o_exec_probe_6 ;
    klee_make_symbolic(&res_i2o_exec_probe_6, sizeof(int), "res_i2o_exec_probe_6");
  int ldv_s_i2o_exec_driver_i2o_driver ;
    klee_make_symbolic(&ldv_s_i2o_exec_driver_i2o_driver, sizeof(int), "ldv_s_i2o_exec_driver_i2o_driver");
  int tmp ;
  int tmp___0 ;
...
{ 
  ...
  struct device  const  *__mptr ;
  int dma_64 ;
    klee_make_symbolic(&dma_64, sizeof(int), "dma_64");
  int tmp ;
  int tmp___0 ;
...
static int ldv_mutex_lct_lock  ;
    klee_make_symbolic(&ldv_mutex_lct_lock, sizeof(int), "ldv_mutex_lct_lock");
...
static int ldv_mutex_mem_lock  ;
    klee_make_symbolic(&ldv_mutex_mem_lock, sizeof(int), "ldv_mutex_mem_lock");
