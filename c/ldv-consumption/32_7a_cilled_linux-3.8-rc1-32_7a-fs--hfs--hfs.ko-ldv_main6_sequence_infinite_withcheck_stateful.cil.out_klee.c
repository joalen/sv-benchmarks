...
struct hfs_sb_info {
   ...
   u32 alloc_blksz ;
   int s_quiet ;
    klee_make_symbolic(&s_quiet, sizeof(int), "s_quiet");
   __be32 s_type ;
   __be32 s_creator ;
   ...
   int part ;
    klee_make_symbolic(&part, sizeof(int), "part");
   ...
   u16 blockoffset ;
   int fs_div ;
    klee_make_symbolic(&fs_div, sizeof(int), "fs_div");
   struct super_block *sb ;
   int work_queued ;
    klee_make_symbolic(&work_queued, sizeof(int), "work_queued");
...
struct hfs_btree {
   ...
   unsigned int node_size ;
    klee_make_symbolic(&node_size, sizeof(int), "node_size");
   unsigned int node_size_shift ;
    klee_make_symbolic(&node_size_shift, sizeof(int), "node_size_shift");
   ...
   unsigned int pages_per_bnode ;
    klee_make_symbolic(&pages_per_bnode, sizeof(int), "pages_per_bnode");
   spinlock_t hash_lock ;
   struct hfs_bnode *node_hash[256U] ;
   int node_hash_cnt ;
    klee_make_symbolic(&node_hash_cnt, sizeof(int), "node_hash_cnt");
};
struct hfs_bnode {
...
struct hfs_find_data {
   ...
   int record ;
    klee_make_symbolic(&record, sizeof(int), "record");
   int keyoffset ;
    klee_make_symbolic(&keyoffset, sizeof(int), "keyoffset");
   int keylength ;
    klee_make_symbolic(&keylength, sizeof(int), "keylength");
   int entryoffset ;
    klee_make_symbolic(&entryoffset, sizeof(int), "entryoffset");
   int entrylength ;
    klee_make_symbolic(&entrylength, sizeof(int), "entrylength");
};
...
struct hfs_inode_info {
   ...
   unsigned int flags ;
   int tz_secondswest ;
    klee_make_symbolic(&tz_secondswest, sizeof(int), "tz_secondswest");
...
struct hfs_finfo {
   ...
   struct hfs_point fdLocation ;
    klee_make_symbolic(&fdLocation, sizeof(int), "fdLocation");
   __be16 fdFldr ;
};
struct hfs_fxinfo {
   __be16 fdIconID ;
...
struct hfs_dinfo {
   ...
   struct hfs_point frLocation ;
    klee_make_symbolic(&frLocation, sizeof(int), "frLocation");
   __be16 frView ;
};
struct hfs_dxinfo {
   struct hfs_point frScroll ;
    klee_make_symbolic(&frScroll, sizeof(int), "frScroll");
   __be32 frOpenChain ;
   __be16 frUnused ;
   __be16 frComment ;
   __be32 frPutAway ;
...
{ 
  int cmpval ;
    klee_make_symbolic(&cmpval, sizeof(int), "cmpval");
  u16 off ;
  u16 len ;
  u16 keylen ;
  int rec ;
    klee_make_symbolic(&rec, sizeof(int), "rec");
  int b ;
  int e ;
...
{ 
  ...
  int key_off ;
    klee_make_symbolic(&key_off, sizeof(int), "key_off");
  __u16 tmp___2 ;
  u16 tmp___3 ;
  int tmp___4 ;
...
{ 
  ...
  int i ;
  int rec_off ;
    klee_make_symbolic(&rec_off, sizeof(int), "rec_off");
  int off ;
  int next_off ;
    klee_make_symbolic(&next_off, sizeof(int), "next_off");
  int entry_size ;
    klee_make_symbolic(&entry_size, sizeof(int), "entry_size");
  int key_size ;
    klee_make_symbolic(&key_size, sizeof(int), "key_size");
  int tmp ;
  wait_queue_t __wait ;
...
{ 
  ...
  int end_off ;
    klee_make_symbolic(&end_off, sizeof(int), "end_off");
  int idx_rec_off ;
    klee_make_symbolic(&idx_rec_off, sizeof(int), "idx_rec_off");
  int data_rec_off ;
    klee_make_symbolic(&data_rec_off, sizeof(int), "data_rec_off");
  int end_rec_off ;
    klee_make_symbolic(&end_rec_off, sizeof(int), "end_rec_off");
  __be32 cnid ;
  long tmp ;
  long tmp___0 ;
  u16 tmp___1 ;
...
{ 
  ...
  int new_rec_off ;
    klee_make_symbolic(&new_rec_off, sizeof(int), "new_rec_off");
  int new_off ;
    klee_make_symbolic(&new_off, sizeof(int), "new_off");
  int old_rec_off ;
    klee_make_symbolic(&old_rec_off, sizeof(int), "old_rec_off");
  int data_start ;
    klee_make_symbolic(&data_start, sizeof(int), "data_start");
  int data_end ;
    klee_make_symbolic(&data_end, sizeof(int), "data_end");
  int size ;
  long tmp ;
  long tmp___0 ;
  u16 tmp___1 ;
...
{ 
  ...
  struct hfs_bnode *parent ;
  int newkeylen ;
    klee_make_symbolic(&newkeylen, sizeof(int), "newkeylen");
  int diff ;
  ...
  int end_rec_off ;
  int start_off ;
    klee_make_symbolic(&start_off, sizeof(int), "start_off");
  int end_off ;
  long tmp ;
  long tmp___0 ;
  u8 tmp___1 ;
...
{ 
  ...
  unsigned int var_hfs_lookup_0_p2 ;
    klee_make_symbolic(&var_hfs_lookup_0_p2, sizeof(int), "var_hfs_lookup_0_p2");
  ...
  int ldv_s_hfs_dir_operations_file_operations ;
    klee_make_symbolic(&ldv_s_hfs_dir_operations_file_operations, sizeof(int), "ldv_s_hfs_dir_operations_file_operations");
  int tmp ;
  int tmp___0 ;
...
{ 
  ...
  struct page *page ;
  int res___0 ;
    klee_make_symbolic(&res___0, sizeof(int), "res___0");
  struct inode  const  *__mptr___0 ;
  struct inode  const  *__mptr___1 ;
  struct inode  const  *__mptr___2 ;
  struct inode  const  *__mptr___3 ;
...
{ 
  ...
  unsigned int var_hfs_write_begin_3_p3 ;
    klee_make_symbolic(&var_hfs_write_begin_3_p3, sizeof(int), "var_hfs_write_begin_3_p3");
  unsigned int var_hfs_write_begin_3_p4 ;
    klee_make_symbolic(&var_hfs_write_begin_3_p4, sizeof(int), "var_hfs_write_begin_3_p4");
  ...
  int var_hfs_direct_IO_6_p0 ;
    klee_make_symbolic(&var_hfs_direct_IO_6_p0, sizeof(int), "var_hfs_direct_IO_6_p0");
  ...
  unsigned long var_hfs_direct_IO_6_p4 ;
    klee_make_symbolic(&var_hfs_direct_IO_6_p4, sizeof(long), "var_hfs_direct_IO_6_p4");
  loff_t var_hfs_file_fsync_21_p1 ;
  loff_t var_hfs_file_fsync_21_p2 ;
  int var_hfs_file_fsync_21_p3 ;
    klee_make_symbolic(&var_hfs_file_fsync_21_p3, sizeof(int), "var_hfs_file_fsync_21_p3");
  struct inode *var_group6 ;
  int res_hfs_file_open_18 ;
    klee_make_symbolic(&res_hfs_file_open_18, sizeof(int), "res_hfs_file_open_18");
  struct dentry *var_group7 ;
  unsigned int var_hfs_file_lookup_16_p2 ;
    klee_make_symbolic(&var_hfs_file_lookup_16_p2, sizeof(int), "var_hfs_file_lookup_16_p2");
  struct iattr *var_group8 ;
  int ldv_s_hfs_file_operations_file_operations ;
    klee_make_symbolic(&ldv_s_hfs_file_operations_file_operations, sizeof(int), "ldv_s_hfs_file_operations_file_operations");
  int tmp ;
  int tmp___0 ;
...
{ 
  ...
  loff_t __start___0 ;
  int __offset___0 ;
    klee_make_symbolic(&__offset___0, sizeof(int), "__offset___0");
  long tmp___5 ;
  __u16 tmp___6 ;
  __u32 tmp___7 ;
  __u16 tmp___8 ;
  ...
  loff_t __start___1 ;
  int __offset___1 ;
    klee_make_symbolic(&__offset___1, sizeof(int), "__offset___1");
  long tmp___15 ;
...
extern int overflowgid ;
    klee_make_symbolic(&overflowgid, sizeof(int), "overflowgid");
...
extern unsigned int dirty_writeback_interval ;
    klee_make_symbolic(&dirty_writeback_interval, sizeof(int), "dirty_writeback_interval");
...
{ 
  ...
  int var_hfs_sync_fs_0_p1 ;
    klee_make_symbolic(&var_hfs_sync_fs_0_p1, sizeof(int), "var_hfs_sync_fs_0_p1");
  struct dentry *var_group3 ;
  ...
  int var_hfs_mount_13_p1 ;
    klee_make_symbolic(&var_hfs_mount_13_p1, sizeof(int), "var_hfs_mount_13_p1");
...
{ 
  ...
  unsigned int var_hfs_revalidate_dentry_0_p1 ;
    klee_make_symbolic(&var_hfs_revalidate_dentry_0_p1, sizeof(int), "var_hfs_revalidate_dentry_0_p1");
  int tmp ;
  int tmp___0 ;
...
{ 
  ...
  char *dst ;
  int srclen ;
    klee_make_symbolic(&srclen, sizeof(int), "srclen");
  int dstlen ;
    klee_make_symbolic(&dstlen, sizeof(int), "dstlen");
  int size ;
  wchar_t ch ;
  char const   *tmp ;
  char ch___0 ;
    klee_make_symbolic(&ch___0, sizeof(char), "ch___0");
  char *tmp___0 ;
  char const   *tmp___1 ;
...
static int ldv_mutex_bitmap_lock  ;
    klee_make_symbolic(&ldv_mutex_bitmap_lock, sizeof(int), "ldv_mutex_bitmap_lock");
...
static int ldv_mutex_extents_lock  ;
    klee_make_symbolic(&ldv_mutex_extents_lock, sizeof(int), "ldv_mutex_extents_lock");
...
static int ldv_mutex_tree_lock  ;
    klee_make_symbolic(&ldv_mutex_tree_lock, sizeof(int), "ldv_mutex_tree_lock");
