...
struct xhci_bus_state {
   ...
   unsigned long resuming_ports ;
    klee_make_symbolic(&resuming_ports, sizeof(long), "resuming_ports");
};
struct xhci_hcd {
   ...
   int zombie ;
    klee_make_symbolic(&zombie, sizeof(int), "zombie");
...
{ 
  int ret ;
  int timeleft ;
    klee_make_symbolic(&timeleft, sizeof(int), "timeleft");
  unsigned long flags ;
  struct xhci_container_ctx *in_ctx ;
  struct completion *cmd_completion ;
  u32 *cmd_status ;
...
{ 
  unsigned long var_compliance_mode_recovery_15_p0 ;
    klee_make_symbolic(&var_compliance_mode_recovery_15_p0, sizeof(long), "var_compliance_mode_recovery_15_p0");
  unsigned long var_xhci_event_ring_work_20_p0 ;
    klee_make_symbolic(&var_xhci_event_ring_work_20_p0, sizeof(long), "var_xhci_event_ring_work_20_p0");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
...
{ 
  ...
  int trb_size ;
    klee_make_symbolic(&trb_size, sizeof(int), "trb_size");
  struct usb_hcd *tmp ;
  struct usb_hcd *tmp___0 ;
...
{ 
  ...
  unsigned int faked_port_num ;
    klee_make_symbolic(&faked_port_num, sizeof(int), "faked_port_num");
  int i ;
  u8 port_speed ;
...
{ 
  int cur_trb_is_good ;
    klee_make_symbolic(&cur_trb_is_good, sizeof(int), "cur_trb_is_good");
...
{ 
  ...
  int res_xhci_pci_probe_3 ;
    klee_make_symbolic(&res_xhci_pci_probe_3, sizeof(int), "res_xhci_pci_probe_3");
  int ldv_s_xhci_pci_driver_pci_driver ;
    klee_make_symbolic(&ldv_s_xhci_pci_driver_pci_driver, sizeof(int), "ldv_s_xhci_pci_driver_pci_driver");
  int tmp ;
  int tmp___0 ;
...
{ 
  ...
  int res_xhci_plat_probe_2 ;
    klee_make_symbolic(&res_xhci_plat_probe_2, sizeof(int), "res_xhci_plat_probe_2");
  int ldv_s_usb_xhci_driver_platform_driver ;
    klee_make_symbolic(&ldv_s_usb_xhci_driver_platform_driver, sizeof(int), "ldv_s_usb_xhci_driver_platform_driver");
  int tmp ;
  int tmp___0 ;
