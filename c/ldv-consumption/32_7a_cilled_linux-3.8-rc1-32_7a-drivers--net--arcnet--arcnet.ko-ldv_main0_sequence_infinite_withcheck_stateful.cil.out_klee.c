...
{ 
  ...
  int count ;
  int newmtu ;
    klee_make_symbolic(&newmtu, sizeof(int), "newmtu");
  int error ;
  bool tmp___0 ;
  int tmp___1 ;
  int tmp___2 ;
...
{ 
  ...
  struct ArcProto *proto ;
  int txbuf ;
    klee_make_symbolic(&txbuf, sizeof(int), "txbuf");
  unsigned long flags ;
  int freeskb ;
    klee_make_symbolic(&freeskb, sizeof(int), "freeskb");
  int retval ;
...
{ 
  ...
  struct arcnet_local *lp ;
  int recbuf ;
    klee_make_symbolic(&recbuf, sizeof(int), "recbuf");
  int status ;
  int diagstatus ;
    klee_make_symbolic(&diagstatus, sizeof(int), "diagstatus");
  int didsomething ;
    klee_make_symbolic(&didsomething, sizeof(int), "didsomething");
  int boguscount ;
  ...
  int tmp___3 ;
  int ackstatus ;
    klee_make_symbolic(&ackstatus, sizeof(int), "ackstatus");
  int txbuf ;
  int tmp___5 ;
  int tmp___6 ;
...
{ 
  ...
  int var_null_rx_19_p1 ;
    klee_make_symbolic(&var_null_rx_19_p1, sizeof(int), "var_null_rx_19_p1");
  struct archdr *var_null_rx_19_p2 ;
  int var_null_rx_19_p3 ;
    klee_make_symbolic(&var_null_rx_19_p3, sizeof(int), "var_null_rx_19_p3");
  struct sk_buff *var_group2 ;
  unsigned int var_null_build_header_20_p2 ;
    klee_make_symbolic(&var_null_build_header_20_p2, sizeof(int), "var_null_build_header_20_p2");
  uint8_t var_null_build_header_20_p3 ;
  struct archdr *var_group3 ;
  int var_null_prepare_tx_21_p2 ;
    klee_make_symbolic(&var_null_prepare_tx_21_p2, sizeof(int), "var_null_prepare_tx_21_p2");
  int var_null_prepare_tx_21_p3 ;
    klee_make_symbolic(&var_null_prepare_tx_21_p3, sizeof(int), "var_null_prepare_tx_21_p3");
  unsigned int var_arcnet_header_12_p2 ;
    klee_make_symbolic(&var_arcnet_header_12_p2, sizeof(int), "var_arcnet_header_12_p2");
  void const   *var_arcnet_header_12_p3 ;
  void const   *var_arcnet_header_12_p4 ;
  unsigned int var_arcnet_header_12_p5 ;
    klee_make_symbolic(&var_arcnet_header_12_p5, sizeof(int), "var_arcnet_header_12_p5");
  int res_arcnet_open_10 ;
    klee_make_symbolic(&res_arcnet_open_10, sizeof(int), "res_arcnet_open_10");
  int res_arcnet_close_11 ;
    klee_make_symbolic(&res_arcnet_close_11, sizeof(int), "res_arcnet_close_11");
  int var_arcnet_interrupt_17_p0 ;
    klee_make_symbolic(&var_arcnet_interrupt_17_p0, sizeof(int), "var_arcnet_interrupt_17_p0");
  void *var_arcnet_interrupt_17_p1 ;
  int ldv_s_arcnet_netdev_ops_net_device_ops ;
    klee_make_symbolic(&ldv_s_arcnet_netdev_ops_net_device_ops, sizeof(int), "ldv_s_arcnet_netdev_ops_net_device_ops");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
