...
struct _MPT_MGMT {
   ...
   u8 status ;
   int completion_code ;
    klee_make_symbolic(&completion_code, sizeof(int), "completion_code");
   u32 msg_context ;
};
...
struct _SpiCfgData {
   ...
   int IocPg4Sz ;
    klee_make_symbolic(&IocPg4Sz, sizeof(int), "IocPg4Sz");
   u8 minSyncFactor ;
   u8 maxSyncOffset ;
   u8 maxBusWidth ;
   u8 busType ;
...
struct __anonstruct_fc_port_page1_231 {
   ...
   dma_addr_t dma ;
   int pg_sz ;
    klee_make_symbolic(&pg_sz, sizeof(int), "pg_sz");
};
struct _FcCfgData {
...
struct _MPT_ADAPTER {
   ...
   int number_of_buses ;
    klee_make_symbolic(&number_of_buses, sizeof(int), "number_of_buses");
   int devices_per_bus ;
    klee_make_symbolic(&devices_per_bus, sizeof(int), "devices_per_bus");
   int alloc_total ;
    klee_make_symbolic(&alloc_total, sizeof(int), "alloc_total");
   u32 last_state ;
   int active ;
   ...
   int reply_depth ;
    klee_make_symbolic(&reply_depth, sizeof(int), "reply_depth");
   int reply_sz ;
    klee_make_symbolic(&reply_sz, sizeof(int), "reply_sz");
   int num_chain ;
    klee_make_symbolic(&num_chain, sizeof(int), "num_chain");
   ...
   int req_depth ;
    klee_make_symbolic(&req_depth, sizeof(int), "req_depth");
   int req_sz ;
    klee_make_symbolic(&req_sz, sizeof(int), "req_sz");
   ...
   int msi_enable ;
    klee_make_symbolic(&msi_enable, sizeof(int), "msi_enable");
   u8 *memmap ;
   struct Scsi_Host *sh ;
   SpiCfgData spi_data ;
   ...
   u32 biosVersion ;
   int eventTypes ;
    klee_make_symbolic(&eventTypes, sizeof(int), "eventTypes");
   int eventContext ;
    klee_make_symbolic(&eventContext, sizeof(int), "eventContext");
   int eventLogSize ;
    klee_make_symbolic(&eventLogSize, sizeof(int), "eventLogSize");
   struct _mpt_ioctl_events *events ;
   u8 *cached_fw ;
   dma_addr_t cached_fw_dma ;
   int hs_reply_idx ;
    klee_make_symbolic(&hs_reply_idx, sizeof(int), "hs_reply_idx");
   u32 pad0 ;
   ...
   int errata_flag_1064 ;
    klee_make_symbolic(&errata_flag_1064, sizeof(int), "errata_flag_1064");
   ...
   int sas_index ;
    klee_make_symbolic(&sas_index, sizeof(int), "sas_index");
   MPT_MGMT sas_mgmt ;
   ...
   int taskmgmt_in_progress ;
    klee_make_symbolic(&taskmgmt_in_progress, sizeof(int), "taskmgmt_in_progress");
   ...
   unsigned long hard_resets ;
    klee_make_symbolic(&hard_resets, sizeof(long), "hard_resets");
   unsigned long soft_resets ;
    klee_make_symbolic(&soft_resets, sizeof(long), "soft_resets");
   unsigned long timeouts ;
    klee_make_symbolic(&timeouts, sizeof(long), "timeouts");
...
struct mptsas_target_reset_event {
   ...
   unsigned long time_count ;
    klee_make_symbolic(&time_count, sizeof(long), "time_count");
};
...
typedef int ldv_func_ret_type___37;
    klee_make_symbolic(&ldv_func_ret_type___37, sizeof(int), "ldv_func_ret_type___37");
...
static int mpt_pt_clear  ;
    klee_make_symbolic(&mpt_pt_clear, sizeof(int), "mpt_pt_clear");
...
{ 
  ...
  int flagsLength ;
    klee_make_symbolic(&flagsLength, sizeof(int), "flagsLength");
  unsigned long timeleft ;
  char *psge ;
...
{ 
  ...
  int channel ;
  int fw_id ;
    klee_make_symbolic(&fw_id, sizeof(int), "fw_id");
  int fw_channel ;
    klee_make_symbolic(&fw_channel, sizeof(int), "fw_channel");
  u16 current_depth ;
  struct list_head  const  *__mptr ;
  struct list_head  const  *__mptr___0 ;
  struct list_head  const  *__mptr___1 ;
...
{ 
  ...
  u8 issue_reset ;
  int task_context ;
    klee_make_symbolic(&task_context, sizeof(int), "task_context");
  u8 channel ;
  u8 id ;
  int lun ;
...
{ 
  ...
  int sz ;
  int event_data_sz ;
    klee_make_symbolic(&event_data_sz, sizeof(int), "event_data_sz");
  struct fw_event_work *fw_event ;
  unsigned long delay ;
...
{ 
  ...
  int ii ;
  int numSGE ;
    klee_make_symbolic(&numSGE, sizeof(int), "numSGE");
  int scale ;
    klee_make_symbolic(&scale, sizeof(int), "scale");
  int ioc_cap ;
    klee_make_symbolic(&ioc_cap, sizeof(int), "ioc_cap");
  int error ;
  int r ;
...
{ 
  ...
  int var_mptsas_phy_reset_52_p1 ;
    klee_make_symbolic(&var_mptsas_phy_reset_52_p1, sizeof(int), "var_mptsas_phy_reset_52_p1");
  ...
  int res_mptsas_probe_91 ;
    klee_make_symbolic(&res_mptsas_probe_91, sizeof(int), "res_mptsas_probe_91");
  int ldv_s_mptsas_driver_pci_driver ;
    klee_make_symbolic(&ldv_s_mptsas_driver_pci_driver, sizeof(int), "ldv_s_mptsas_driver_pci_driver");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
...
static int ldv_mutex_sas_device_info_mutex  ;
    klee_make_symbolic(&ldv_mutex_sas_device_info_mutex, sizeof(int), "ldv_mutex_sas_device_info_mutex");
...
static int ldv_mutex_sas_topology_mutex  ;
    klee_make_symbolic(&ldv_mutex_sas_topology_mutex, sizeof(int), "ldv_mutex_sas_topology_mutex");
