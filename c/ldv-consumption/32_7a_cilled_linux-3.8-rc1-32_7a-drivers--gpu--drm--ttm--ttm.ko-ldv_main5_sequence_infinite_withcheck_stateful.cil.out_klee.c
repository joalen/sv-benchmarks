...
struct agp_memory {
   ...
   int num_scratch_pages ;
    klee_make_symbolic(&num_scratch_pages, sizeof(int), "num_scratch_pages");
   off_t pg_start ;
   u32 type ;
   u32 physical ;
   bool is_bound ;
...
struct ttm_page_pool {
   ...
   unsigned long nfrees ;
    klee_make_symbolic(&nfrees, sizeof(long), "nfrees");
   unsigned long nrefills ;
    klee_make_symbolic(&nrefills, sizeof(long), "nrefills");
};
...
struct dma_pool {
   ...
   unsigned int npages_free ;
    klee_make_symbolic(&npages_free, sizeof(int), "npages_free");
   unsigned int npages_in_use ;
    klee_make_symbolic(&npages_in_use, sizeof(int), "npages_in_use");
   unsigned long nfrees ;
   unsigned long nrefills ;
   gfp_t gfp_flags ;
   char name[13U] ;
...
struct ttm_pool_manager___0 {
   ...
   struct ttm_pool_opts options ;
   unsigned int npools ;
    klee_make_symbolic(&npools, sizeof(int), "npools");
   struct shrinker mm_shrink ;
   struct kobject kobj ;
};
...
{ 
  ...
  int cached ;
    klee_make_symbolic(&cached, sizeof(int), "cached");
  unsigned int i ;
...
{ 
  ...
  unsigned long cur_offset ;
    klee_make_symbolic(&cur_offset, sizeof(long), "cur_offset");
...
{ 
  ...
  unsigned long add ;
    klee_make_symbolic(&add, sizeof(long), "add");
  int dir ;
...
{ 
  ...
  unsigned long page_offset ;
    klee_make_symbolic(&page_offset, sizeof(long), "page_offset");
  unsigned long page_last ;
    klee_make_symbolic(&page_last, sizeof(long), "page_last");
  unsigned long pfn ;
...
{ 
  ...
  unsigned long dev_offset ;
    klee_make_symbolic(&dev_offset, sizeof(long), "dev_offset");
  unsigned long kmap_offset ;
    klee_make_symbolic(&kmap_offset, sizeof(long), "kmap_offset");
  unsigned long kmap_end ;
    klee_make_symbolic(&kmap_end, sizeof(long), "kmap_end");
...
{ 
  ...
  int ldv_s_ttm_bo_vm_ops_vm_operations_struct ;
    klee_make_symbolic(&ldv_s_ttm_bo_vm_ops_vm_operations_struct, sizeof(int), "ldv_s_ttm_bo_vm_ops_vm_operations_struct");
  int tmp ;
  int tmp___0 ;
...
{ 
  int pool_index ;
    klee_make_symbolic(&pool_index, sizeof(int), "pool_index");
...
{ 
  ...
  unsigned int freed_pages ;
    klee_make_symbolic(&freed_pages, sizeof(int), "freed_pages");
  unsigned int npages_to_free ;
    klee_make_symbolic(&npages_to_free, sizeof(int), "npages_to_free");
  void *tmp ;
...
{ 
  ...
  unsigned int pool_offset ;
    klee_make_symbolic(&pool_offset, sizeof(int), "pool_offset");
  int tmp ;
  struct ttm_page_pool *pool ;
  int shrink_pages ;
    klee_make_symbolic(&shrink_pages, sizeof(int), "shrink_pages");
...
{ 
  ...
  unsigned int i ;
  unsigned int cpages ;
    klee_make_symbolic(&cpages, sizeof(int), "cpages");
  unsigned int max_cpages ;
    klee_make_symbolic(&max_cpages, sizeof(int), "max_cpages");
  unsigned int _min1 ;
...
static int ldv_mutex_device_list_mutex  ;
    klee_make_symbolic(&ldv_mutex_device_list_mutex, sizeof(int), "ldv_mutex_device_list_mutex");
...
static int ldv_mutex_io_reserve_mutex  ;
    klee_make_symbolic(&ldv_mutex_io_reserve_mutex, sizeof(int), "ldv_mutex_io_reserve_mutex");
int ldv_mutex_lock_interruptible_io_reserve_mutex(struct mutex *lock ) 
{ 
  int nondetermined ;
