...
struct resize {
   ...
   unsigned int old_nr_full_blocks ;
    klee_make_symbolic(&old_nr_full_blocks, sizeof(int), "old_nr_full_blocks");
   unsigned int new_nr_full_blocks ;
    klee_make_symbolic(&new_nr_full_blocks, sizeof(int), "new_nr_full_blocks");
   unsigned int old_nr_entries_in_last_block ;
    klee_make_symbolic(&old_nr_entries_in_last_block, sizeof(int), "old_nr_entries_in_last_block");
   unsigned int new_nr_entries_in_last_block ;
    klee_make_symbolic(&new_nr_entries_in_last_block, sizeof(int), "new_nr_entries_in_last_block");
   void const   *value ;
};
struct walk_info {
   struct dm_array_info *info ;
