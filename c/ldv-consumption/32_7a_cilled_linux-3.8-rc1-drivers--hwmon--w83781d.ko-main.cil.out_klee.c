...
struct w83781d_data {
   ...
   char const   *name ;
   int isa_addr ;
    klee_make_symbolic(&isa_addr, sizeof(int), "isa_addr");
...
{ int i ;
  ...
  enum chips kind ;
  int num_sc ;
    klee_make_symbolic(&num_sc, sizeof(int), "num_sc");
...
static int ldv_mutex_lock_of_w83781d_data  ;
    klee_make_symbolic(&ldv_mutex_lock_of_w83781d_data, sizeof(int), "ldv_mutex_lock_of_w83781d_data");
...
static int ldv_mutex_update_lock_of_w83781d_data  ;
    klee_make_symbolic(&ldv_mutex_update_lock_of_w83781d_data, sizeof(int), "ldv_mutex_update_lock_of_w83781d_data");
