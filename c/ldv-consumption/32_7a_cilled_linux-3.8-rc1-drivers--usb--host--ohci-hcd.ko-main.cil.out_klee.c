...
struct ohci_hcd {
   ...
   unsigned int eds_scheduled ;
    klee_make_symbolic(&eds_scheduled, sizeof(int), "eds_scheduled");
   struct ed *ed_to_check ;
   unsigned int zf_delay ;
    klee_make_symbolic(&zf_delay, sizeof(int), "zf_delay");
...
{ struct usb_hcd *hcd ;
  ...
  int status ;
  int autostopped ;
    klee_make_symbolic(&autostopped, sizeof(int), "autostopped");
  struct _ddebug descriptor ;
...
static int ohci_root_hub_state_changes(struct ohci_hcd *ohci , int changed , int any_connected ,
                                       int rhsc_status ) 
{ int poll_rh ;
    klee_make_symbolic(&poll_rh, sizeof(int), "poll_rh");
  int rhsc_enable ;
    klee_make_symbolic(&rhsc_enable, sizeof(int), "rhsc_enable");
  unsigned int tmp ;
...
{ struct ohci_hcd *ohci ;
  ...
  int length ;
  int any_connected ;
    klee_make_symbolic(&any_connected, sizeof(int), "any_connected");
  int rhsc_status ;
    klee_make_symbolic(&rhsc_status, sizeof(int), "rhsc_status");
  unsigned long flags ;
...
{ __hc32 *portstat ;
  ...
  u16 reset_done ;
  int limit_1 ;
    klee_make_symbolic(&limit_1, sizeof(int), "limit_1");
  int limit_2 ;
    klee_make_symbolic(&limit_2, sizeof(int), "limit_2");
  struct _ddebug descriptor ;
  struct usb_hcd *tmp___0 ;
  long tmp___1 ;
...
static void ohci_dump_intr_mask(struct ohci_hcd *ohci , char *label , u32 mask , char **next ,
                                unsigned int *size ) 
{ unsigned int s_len ;
    klee_make_symbolic(&s_len, sizeof(int), "s_len");
  char *tmp ;
  char *tmp___0 ;
  char *tmp___1 ;
  char *tmp___2 ;
...
{ struct ohci_regs *regs ;
  ...
  unsigned int s_len___0 ;
    klee_make_symbolic(&s_len___0, sizeof(int), "s_len___0");
  char *tmp___7 ;
  char *tmp___8 ;
  char *tmp___9 ;
  char *tmp___10 ;
  ...
  unsigned int s_len___1 ;
    klee_make_symbolic(&s_len___1, sizeof(int), "s_len___1");
  char *tmp___26 ;
  char *tmp___27 ;
  char *tmp___28 ;
  char *tmp___29 ;
...
{ u32 temp ;
  ...
  unsigned int s_len___2 ;
    klee_make_symbolic(&s_len___2, sizeof(int), "s_len___2");
  char *tmp___30 ;
  char *tmp___31 ;
  char *tmp___32 ;
  char *tmp___33 ;
...
{ struct td *td ;
  ...
  int is_iso ;
    klee_make_symbolic(&is_iso, sizeof(int), "is_iso");
  int hash ;
...
{ struct urb_priv *urb_priv ;
  ...
  int is_out ;
  int periodic ;
    klee_make_symbolic(&periodic, sizeof(int), "periodic");
  __hc32 tmp ;
  struct usb_hcd *tmp___0 ;
  int tmp___1 ;
  struct usb_hcd *tmp___2 ;
...
{ struct ohci_hcd *ohci ;
  ...
  struct ohci_regs *regs ;
  int ints ;
    klee_make_symbolic(&ints, sizeof(int), "ints");
...
static int ldv_mutex_mutex_of_debug_buffer  ;
    klee_make_symbolic(&ldv_mutex_mutex_of_debug_buffer, sizeof(int), "ldv_mutex_mutex_of_debug_buffer");
