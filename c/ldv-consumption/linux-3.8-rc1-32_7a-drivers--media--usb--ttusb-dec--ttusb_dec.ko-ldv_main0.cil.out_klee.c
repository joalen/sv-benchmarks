...
static int ldv_mutex_iso_mutex_of_ttusb_dec  ;
    klee_make_symbolic(&ldv_mutex_iso_mutex_of_ttusb_dec, sizeof(int), "ldv_mutex_iso_mutex_of_ttusb_dec");
int ldv_mutex_lock_interruptible_iso_mutex_of_ttusb_dec(struct mutex *lock ) 
{ 
  int nondetermined ;
...
static int ldv_mutex_usb_mutex_of_ttusb_dec  ;
    klee_make_symbolic(&ldv_mutex_usb_mutex_of_ttusb_dec, sizeof(int), "ldv_mutex_usb_mutex_of_ttusb_dec");
int ldv_mutex_lock_interruptible_usb_mutex_of_ttusb_dec(struct mutex *lock ) 
{ 
  int nondetermined ;
