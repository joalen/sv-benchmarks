...
struct t3c_data {
   ...
   unsigned int tx_max_chunk ;
    klee_make_symbolic(&tx_max_chunk, sizeof(int), "tx_max_chunk");
   unsigned int max_wrs ;
    klee_make_symbolic(&max_wrs, sizeof(int), "max_wrs");
   unsigned int nmtus ;
    klee_make_symbolic(&nmtus, sizeof(int), "nmtus");
   ...
   unsigned int release_list_incomplete ;
    klee_make_symbolic(&release_list_incomplete, sizeof(int), "release_list_incomplete");
};
...
struct rdma_info {
   unsigned int tpt_base ;
    klee_make_symbolic(&tpt_base, sizeof(int), "tpt_base");
   unsigned int tpt_top ;
    klee_make_symbolic(&tpt_top, sizeof(int), "tpt_top");
   unsigned int pbl_base ;
    klee_make_symbolic(&pbl_base, sizeof(int), "pbl_base");
   unsigned int pbl_top ;
    klee_make_symbolic(&pbl_top, sizeof(int), "pbl_top");
   unsigned int rqt_base ;
    klee_make_symbolic(&rqt_base, sizeof(int), "rqt_base");
   unsigned int rqt_top ;
    klee_make_symbolic(&rqt_top, sizeof(int), "rqt_top");
   unsigned int udbell_len ;
    klee_make_symbolic(&udbell_len, sizeof(int), "udbell_len");
   unsigned long udbell_physbase ;
    klee_make_symbolic(&udbell_physbase, sizeof(long), "udbell_physbase");
   void *kdb_addr ;
   struct pci_dev *pdev ;
};
...
struct cxio_rdev {
   ...
   unsigned long qpshift ;
    klee_make_symbolic(&qpshift, sizeof(long), "qpshift");
   u32 qpnr ;
   u32 qpmask ;
...
struct iwch_ep_common {
   ...
   wait_queue_head_t waitq ;
   int rpl_done ;
    klee_make_symbolic(&rpl_done, sizeof(int), "rpl_done");
   int rpl_err ;
    klee_make_symbolic(&rpl_err, sizeof(int), "rpl_err");
   unsigned long flags ;
};
...
struct rdma_cq_setup {
   ...
   unsigned int credit_thres ;
    klee_make_symbolic(&credit_thres, sizeof(int), "credit_thres");
   unsigned int ovfl_mode ;
    klee_make_symbolic(&ovfl_mode, sizeof(int), "ovfl_mode");
};
enum tpt_mem_type {
    TPT_NON_SHARED_MR = 0,
    TPT_SHARED_MR = 1,
...
int peer2peer ;
    klee_make_symbolic(&peer2peer, sizeof(int), "peer2peer");
...
{ struct iwch_ep *ep ;
  ...
  unsigned long flags ;
  int post_zb ;
    klee_make_symbolic(&post_zb, sizeof(int), "post_zb");
  struct _ddebug descriptor ;
  long tmp___1 ;
  struct _ddebug descriptor___0 ;
  enum iwch_ep_state tmp___2 ;
...
{ int err ;
  ...
  struct t3_swsq *sqp ;
  int wr_cnt ;
    klee_make_symbolic(&wr_cnt, sizeof(int), "wr_cnt");
  raw_spinlock_t *tmp ;
  struct _ddebug descriptor ;
  long tmp___0 ;
...
{ int ret ;
  int newid ;
    klee_make_symbolic(&newid, sizeof(int), "newid");
  int tmp ;
  long tmp___0 ;
...
{ struct iwch_dev *rhp ;
  ...
  int wqsize ;
    klee_make_symbolic(&wqsize, sizeof(int), "wqsize");
  int sqsize ;
...
{ struct ethtool_drvinfo info ;
  ...
  char *next ;
  unsigned int fw_maj ;
    klee_make_symbolic(&fw_maj, sizeof(int), "fw_maj");
  unsigned int fw_min ;
    klee_make_symbolic(&fw_min, sizeof(int), "fw_min");
  unsigned int fw_mic ;
    klee_make_symbolic(&fw_mic, sizeof(int), "fw_mic");
...
{ struct cxio_rdev *rdev ;
  ...
  u32 portnum ;
  int dispatch ;
    klee_make_symbolic(&dispatch, sizeof(int), "dispatch");
  unsigned long delay ;
...
int ldv_retval_iwch_init_module  ;
    klee_make_symbolic(&ldv_retval_iwch_init_module, sizeof(int), "ldv_retval_iwch_init_module");
...
{ u32 i ;
  ...
  unsigned long __n___2 ;
    klee_make_symbolic(&__n___2, sizeof(long), "__n___2");
  ...
  unsigned long __n___3 ;
    klee_make_symbolic(&__n___3, sizeof(long), "__n___3");
...
static int ldv_mutex_dev_mutex  ;
    klee_make_symbolic(&ldv_mutex_dev_mutex, sizeof(int), "ldv_mutex_dev_mutex");
...
static int ldv_mutex_lock_of_cxio_hal_ctrl_qp  ;
    klee_make_symbolic(&ldv_mutex_lock_of_cxio_hal_ctrl_qp, sizeof(int), "ldv_mutex_lock_of_cxio_hal_ctrl_qp");
...
static int ldv_mutex_lock_of_cxio_ucontext  ;
    klee_make_symbolic(&ldv_mutex_lock_of_cxio_ucontext, sizeof(int), "ldv_mutex_lock_of_cxio_ucontext");
