...
static unsigned int xpc_die_disconnecting  ;
    klee_make_symbolic(&xpc_die_disconnecting, sizeof(int), "xpc_die_disconnecting");
...
static int ldv_mutex_cached_activate_gru_mq_desc_mutex  ;
    klee_make_symbolic(&ldv_mutex_cached_activate_gru_mq_desc_mutex, sizeof(int), "ldv_mutex_cached_activate_gru_mq_desc_mutex");
