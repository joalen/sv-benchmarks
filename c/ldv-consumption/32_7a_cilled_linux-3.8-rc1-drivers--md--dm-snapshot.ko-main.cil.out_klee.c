...
struct dm_target {
   ...
   unsigned int num_flush_requests ;
    klee_make_symbolic(&num_flush_requests, sizeof(int), "num_flush_requests");
   unsigned int num_discard_requests ;
    klee_make_symbolic(&num_discard_requests, sizeof(int), "num_discard_requests");
   unsigned int num_write_same_requests ;
    klee_make_symbolic(&num_write_same_requests, sizeof(int), "num_write_same_requests");
...
struct dm_target_io {
   ...
   unsigned int target_request_nr ;
    klee_make_symbolic(&target_request_nr, sizeof(int), "target_request_nr");
   struct bio clone ;
};
...
struct dm_exception_store {
   ...
   unsigned int chunk_mask ;
    klee_make_symbolic(&chunk_mask, sizeof(int), "chunk_mask");
   unsigned int chunk_shift ;
    klee_make_symbolic(&chunk_shift, sizeof(int), "chunk_shift");
   void *context ;
};
...
struct dm_snapshot {
   ...
   int num_merging_chunks ;
    klee_make_symbolic(&num_merging_chunks, sizeof(int), "num_merging_chunks");
   int merge_failed ;
    klee_make_symbolic(&merge_failed, sizeof(int), "merge_failed");
...
{ unsigned long mem ;
    klee_make_symbolic(&mem, sizeof(long), "mem");
...
{ int i ;
  int linear_chunks ;
    klee_make_symbolic(&linear_chunks, sizeof(int), "linear_chunks");
  chunk_t old_chunk ;
  chunk_t new_chunk ;
...
{ struct dm_snapshot *s ;
  ...
  unsigned int args_used ;
    klee_make_symbolic(&args_used, sizeof(int), "args_used");
  unsigned int num_flush_requests ;
  fmode_t origin_mode ;
  void *tmp ;
  fmode_t tmp___0 ;
...
static int origin_write_extent(struct dm_snapshot *merging_snap , sector_t sector ,
                               unsigned int size ) 
{ int must_wait ;
    klee_make_symbolic(&must_wait, sizeof(int), "must_wait");
  sector_t n ;
  struct origin *o ;
  int tmp ;
...
int ldv_retval_origin_ctr  ;
    klee_make_symbolic(&ldv_retval_origin_ctr, sizeof(int), "ldv_retval_origin_ctr");
void *ldvarg24  ;
...
int ldv_retval_snapshot_preresume  ;
    klee_make_symbolic(&ldv_retval_snapshot_preresume, sizeof(int), "ldv_retval_snapshot_preresume");
...
int ldv_retval_snapshot_ctr  ;
    klee_make_symbolic(&ldv_retval_snapshot_ctr, sizeof(int), "ldv_retval_snapshot_ctr");
int ldv_retval_dm_snapshot_init  ;
    klee_make_symbolic(&ldv_retval_dm_snapshot_init, sizeof(int), "ldv_retval_dm_snapshot_init");
int ldv_retval_ldv_origin_target_preresume  ;
    klee_make_symbolic(&ldv_retval_ldv_origin_target_preresume, sizeof(int), "ldv_retval_ldv_origin_target_preresume");
...
{ int r ;
  ...
  char persistent ;
    klee_make_symbolic(&persistent, sizeof(char), "persistent");
  void *tmp ;
...
{ int r ;
  ...
  int chunk_size_supplied ;
    klee_make_symbolic(&chunk_size_supplied, sizeof(int), "chunk_size_supplied");
  char *chunk_err ;
  int _max1 ;
...
{ int r ;
  int new_snapshot ;
    klee_make_symbolic(&new_snapshot, sizeof(int), "new_snapshot");
  struct pstore *ps ;
  struct pstore *tmp ;
  void *tmp___0 ;
...
{ struct pstore *ps ;
  ...
  struct core_exception ce ;
  int nr_consecutive ;
    klee_make_symbolic(&nr_consecutive, sizeof(int), "nr_consecutive");
  int r ;
