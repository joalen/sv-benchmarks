...
struct ideapad_private {
   ...
   struct dentry *debug ;
   unsigned long cfg ;
    klee_make_symbolic(&cfg, sizeof(long), "cfg");
};
struct ideapad_rfk_data {
   char *name ;
   int cfgbit ;
    klee_make_symbolic(&cfgbit, sizeof(int), "cfgbit");
   int opcode ;
...
{ unsigned long hw_blocked ;
    klee_make_symbolic(&hw_blocked, sizeof(long), "hw_blocked");
  int i ;
...
{ struct ideapad_private *priv ;
  ...
  unsigned long sw_blocked ;
    klee_make_symbolic(&sw_blocked, sizeof(long), "sw_blocked");
  int tmp___0 ;
...
{ unsigned long long_pressed ;
    klee_make_symbolic(&long_pressed, sizeof(long), "long_pressed");
  int tmp ;
...
{ struct ideapad_private *priv ;
  ...
  acpi_handle handle ;
  unsigned long vpc1 ;
    klee_make_symbolic(&vpc1, sizeof(long), "vpc1");
  unsigned long vpc2 ;
    klee_make_symbolic(&vpc2, sizeof(long), "vpc2");
  unsigned long vpc_bit ;
    klee_make_symbolic(&vpc_bit, sizeof(long), "vpc_bit");
  int tmp___0 ;
  int tmp___1 ;
  int tmp___2 ;
