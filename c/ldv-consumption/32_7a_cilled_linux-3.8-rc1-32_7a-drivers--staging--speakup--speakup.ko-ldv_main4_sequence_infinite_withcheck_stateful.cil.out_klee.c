...
struct spk_highlight_color_track {
   ...
   u_long ry[8U] ;
   ulong cy ;
    klee_make_symbolic(&cy, sizeof(long), "cy");
};
struct st_spk_t {
   u_long reading_x ;
    klee_make_symbolic(&reading_x, sizeof(long), "reading_x");
   u_long cursor_x ;
    klee_make_symbolic(&cursor_x, sizeof(long), "cursor_x");
   u_long reading_y ;
    klee_make_symbolic(&reading_y, sizeof(long), "reading_y");
   u_long cursor_y ;
    klee_make_symbolic(&cursor_y, sizeof(long), "cursor_y");
   u_long reading_pos ;
    klee_make_symbolic(&reading_pos, sizeof(long), "reading_pos");
   u_long cursor_pos ;
    klee_make_symbolic(&cursor_pos, sizeof(long), "cursor_pos");
   u_long go_x ;
    klee_make_symbolic(&go_x, sizeof(long), "go_x");
   u_long go_pos ;
    klee_make_symbolic(&go_pos, sizeof(long), "go_pos");
   u_long w_top ;
    klee_make_symbolic(&w_top, sizeof(long), "w_top");
   u_long w_bottom ;
    klee_make_symbolic(&w_bottom, sizeof(long), "w_bottom");
   u_long w_left ;
    klee_make_symbolic(&w_left, sizeof(long), "w_left");
   u_long w_right ;
    klee_make_symbolic(&w_right, sizeof(long), "w_right");
   u_char w_start ;
    klee_make_symbolic(&w_start, sizeof(char), "w_start");
   u_char w_enabled ;
    klee_make_symbolic(&w_enabled, sizeof(char), "w_enabled");
   u_char reading_attr ;
    klee_make_symbolic(&reading_attr, sizeof(char), "reading_attr");
   u_char old_attr ;
    klee_make_symbolic(&old_attr, sizeof(char), "old_attr");
   char parked ;
    klee_make_symbolic(&parked, sizeof(char), "parked");
   char shut_up ;
    klee_make_symbolic(&shut_up, sizeof(char), "shut_up");
   struct spk_highlight_color_track ht ;
   int tty_stopped ;
    klee_make_symbolic(&tty_stopped, sizeof(int), "tty_stopped");
};
...
struct num_var_t {
   char *synth_fmt ;
   int default_val ;
    klee_make_symbolic(&default_val, sizeof(int), "default_val");
   int low ;
   ...
   short multiplier ;
    klee_make_symbolic(&multiplier, sizeof(short), "multiplier");
   char *out_str ;
   int value ;
};
struct string_var_t {
...
struct synth_indexing {
   ...
   unsigned char lowindex ;
    klee_make_symbolic(&lowindex, sizeof(char), "lowindex");
   unsigned char highindex ;
    klee_make_symbolic(&highindex, sizeof(char), "highindex");
   unsigned char currindex ;
    klee_make_symbolic(&currindex, sizeof(char), "currindex");
};
struct spk_synth {
   char const   *name ;
   char const   *version ;
   ...
   char const   *init ;
   char procspeech ;
    klee_make_symbolic(&procspeech, sizeof(char), "procspeech");
   char clear ;
    klee_make_symbolic(&clear, sizeof(char), "clear");
   int delay ;
    klee_make_symbolic(&delay, sizeof(int), "delay");
   int trigger ;
    klee_make_symbolic(&trigger, sizeof(int), "trigger");
   int jiffies ;
    klee_make_symbolic(&jiffies, sizeof(int), "jiffies");
   int full ;
    klee_make_symbolic(&full, sizeof(int), "full");
   int ser ;
    klee_make_symbolic(&ser, sizeof(int), "ser");
   short flags ;
   short startup ;
    klee_make_symbolic(&startup, sizeof(short), "startup");
   int const   checkval ;
   struct var_t *vars ;
   int *default_pitch ;
   int *default_vol ;
   ...
   int alive ;
    klee_make_symbolic(&alive, sizeof(int), "alive");
...
struct speakup_info_t {
   spinlock_t spinlock ;
   int port_tts ;
    klee_make_symbolic(&port_tts, sizeof(int), "port_tts");
   int flushing ;
...
struct keyboard_notifier_param {
   struct vc_data *vc ;
   int down ;
    klee_make_symbolic(&down, sizeof(int), "down");
   int shift ;
    klee_make_symbolic(&shift, sizeof(int), "shift");
   int ledstate ;
    klee_make_symbolic(&ledstate, sizeof(int), "ledstate");
   unsigned int value ;
};
struct st_bits_data {
   char *name ;
   char *value ;
   short mask ;
    klee_make_symbolic(&mask, sizeof(short), "mask");
};
struct bleep {
   short freq ;
    klee_make_symbolic(&freq, sizeof(short), "freq");
...
struct old_serial_port {
   unsigned int uart ;
    klee_make_symbolic(&uart, sizeof(int), "uart");
...
{ 
  int bytesFree ;
    klee_make_symbolic(&bytesFree, sizeof(int), "bytesFree");
...
static int misc_registered  ;
    klee_make_symbolic(&misc_registered, sizeof(int), "misc_registered");
static int dev_opened  ;
    klee_make_symbolic(&dev_opened, sizeof(int), "dev_opened");
...
{ 
  ...
  int res_speakup_file_open_2 ;
    klee_make_symbolic(&res_speakup_file_open_2, sizeof(int), "res_speakup_file_open_2");
  int ldv_s_synth_fops_file_operations ;
    klee_make_symbolic(&ldv_s_synth_fops_file_operations, sizeof(int), "ldv_s_synth_fops_file_operations");
  int tmp ;
  int tmp___0 ;
...
{ 
  int same ;
    klee_make_symbolic(&same, sizeof(int), "same");
  char *end1 ;
  char *tmp ;
  char *end2 ;
  char *tmp___0 ;
...
{ 
  ...
  int still_comparing ;
    klee_make_symbolic(&still_comparing, sizeof(int), "still_comparing");
  char *template_ptr ;
  char *user_ptr ;
...
char __pcpu_scope_reporting_keystroke  ;
    klee_make_symbolic(&__pcpu_scope_reporting_keystroke, sizeof(char), "__pcpu_scope_reporting_keystroke");
char __pcpu_unique_reporting_keystroke  ;
    klee_make_symbolic(&__pcpu_unique_reporting_keystroke, sizeof(char), "__pcpu_unique_reporting_keystroke");
...
extern int fg_console ;
    klee_make_symbolic(&fg_console, sizeof(int), "fg_console");
...
unsigned short xs ;
    klee_make_symbolic(&xs, sizeof(short), "xs");
unsigned short ys ;
    klee_make_symbolic(&ys, sizeof(short), "ys");
unsigned short xe ;
    klee_make_symbolic(&xe, sizeof(short), "xe");
unsigned short ye ;
    klee_make_symbolic(&ye, sizeof(short), "ye");
...
int no_intr  ;
    klee_make_symbolic(&no_intr, sizeof(int), "no_intr");
int say_ctrl  ;
    klee_make_symbolic(&say_ctrl, sizeof(int), "say_ctrl");
int say_word_ctl  ;
    klee_make_symbolic(&say_word_ctl, sizeof(int), "say_word_ctl");
int punc_level  ;
    klee_make_symbolic(&punc_level, sizeof(int), "punc_level");
int reading_punc  ;
    klee_make_symbolic(&reading_punc, sizeof(int), "reading_punc");
int attrib_bleep  ;
    klee_make_symbolic(&attrib_bleep, sizeof(int), "attrib_bleep");
int bleeps  ;
    klee_make_symbolic(&bleeps, sizeof(int), "bleeps");
int bleep_time ;
    klee_make_symbolic(&bleep_time, sizeof(int), "bleep_time");
int bell_pos  ;
    klee_make_symbolic(&bell_pos, sizeof(int), "bell_pos");
int spell_delay  ;
    klee_make_symbolic(&spell_delay, sizeof(int), "spell_delay");
int key_echo  ;
    klee_make_symbolic(&key_echo, sizeof(int), "key_echo");
short punc_mask  ;
    klee_make_symbolic(&punc_mask, sizeof(short), "punc_mask");
short pitch_shift  ;
    klee_make_symbolic(&pitch_shift, sizeof(short), "pitch_shift");
short synth_flags  ;
    klee_make_symbolic(&synth_flags, sizeof(short), "synth_flags");
bool quiet_boot ;
char *synth_name  ;
...
static char mark_cut_flag  ;
    klee_make_symbolic(&mark_cut_flag, sizeof(char), "mark_cut_flag");
u_char *shift_table  ;
u_char const   key_defaults[446U]  = 
  {      119U,      62U,      6U,      0U, 
        16U,      20U,      17U,      32U, 
...
static int spk_keydown  ;
    klee_make_symbolic(&spk_keydown, sizeof(int), "spk_keydown");
static u_char spk_lastkey  ;
    klee_make_symbolic(&spk_lastkey, sizeof(char), "spk_lastkey");
static u_char spk_close_press  ;
    klee_make_symbolic(&spk_close_press, sizeof(char), "spk_close_press");
static u_char keymap_flags  ;
    klee_make_symbolic(&keymap_flags, sizeof(char), "keymap_flags");
static u_char last_keycode  ;
    klee_make_symbolic(&last_keycode, sizeof(char), "last_keycode");
static u_char this_speakup_key  ;
    klee_make_symbolic(&this_speakup_key, sizeof(char), "this_speakup_key");
static u_long last_spk_jiffy  ;
    klee_make_symbolic(&last_spk_jiffy, sizeof(long), "last_spk_jiffy");
...
{ 
  int fg ;
    klee_make_symbolic(&fg, sizeof(int), "fg");
  int bg ;
    klee_make_symbolic(&bg, sizeof(int), "bg");
  char *tmp ;
  char *tmp___0 ;
  char *tmp___1 ;
  char *tmp___2 ;
...
{ 
  ...
  u_long tmpx ;
    klee_make_symbolic(&tmpx, sizeof(long), "tmpx");
  u_long tmp_pos ;
    klee_make_symbolic(&tmp_pos, sizeof(long), "tmp_pos");
  char ch ;
  u_short attr_ch ;
    klee_make_symbolic(&attr_ch, sizeof(short), "attr_ch");
  u_char temp ;
...
{ 
  ...
  u_short saved_punc_mask ;
    klee_make_symbolic(&saved_punc_mask, sizeof(short), "saved_punc_mask");
  u_long tmp___0 ;
...
{ 
  ...
  char ch ;
  u_short edge_said ;
    klee_make_symbolic(&edge_said, sizeof(short), "edge_said");
  u_short last_state ;
    klee_make_symbolic(&last_state, sizeof(short), "last_state");
  u_short state ;
  u16 tmp ;
...
{ 
  ...
  int i ;
  u_char tmp2 ;
    klee_make_symbolic(&tmp2, sizeof(char), "tmp2");
  u16 tmp___0 ;
...
static int currsentence  ;
    klee_make_symbolic(&currsentence, sizeof(int), "currsentence");
static int numsentences[2U]  ;
static char *sentbufend[2U]  ;
static char *sentmarks[2U][10U]  ;
static int currbuf  ;
    klee_make_symbolic(&currbuf, sizeof(int), "currbuf");
static int bn  ;
    klee_make_symbolic(&bn, sizeof(int), "bn");
...
{ 
  ...
  int i ;
  int bn___0 ;
    klee_make_symbolic(&bn___0, sizeof(int), "bn___0");
  u_char tmp ;
  u16 tmp___0 ;
...
{ 
  ...
  u_long end ;
  u_long from ;
    klee_make_symbolic(&from, sizeof(long), "from");
  u_long to ;
...
{ 
  int rep_count ;
    klee_make_symbolic(&rep_count, sizeof(int), "rep_count");
  u_char ch ;
  u_char old_ch ;
    klee_make_symbolic(&old_ch, sizeof(char), "old_ch");
  u_short char_type ;
    klee_make_symbolic(&char_type, sizeof(short), "char_type");
  u_short last_type ;
    klee_make_symbolic(&last_type, sizeof(short), "last_type");
  int in_count ;
...
{ 
  int i ;
  int states ;
    klee_make_symbolic(&states, sizeof(int), "states");
  int key_data_len ;
    klee_make_symbolic(&key_data_len, sizeof(int), "key_data_len");
  u_char const   *cp ;
  u_char *cp1 ;
  u_char ch ;
  u_char version ;
  u_char num_keys ;
    klee_make_symbolic(&num_keys, sizeof(char), "num_keys");
  u_char const   *tmp ;
  size_t __len ;
  void *__ret ;
  u_char *tmp___0 ;
...
{ 
  short mask ;
  short ch_type ;
    klee_make_symbolic(&ch_type, sizeof(short), "ch_type");
  char *tmp ;
  char *tmp___0 ;
  char *tmp___1 ;
  char *tmp___2 ;
...
static u_char is_cursor  ;
    klee_make_symbolic(&is_cursor, sizeof(char), "is_cursor");
static u_long old_cursor_pos  ;
    klee_make_symbolic(&old_cursor_pos, sizeof(long), "old_cursor_pos");
static u_long old_cursor_x  ;
    klee_make_symbolic(&old_cursor_x, sizeof(long), "old_cursor_x");
static u_long old_cursor_y  ;
    klee_make_symbolic(&old_cursor_y, sizeof(long), "old_cursor_y");
static int cursor_con  ;
    klee_make_symbolic(&cursor_con, sizeof(int), "cursor_con");
static void reset_highlight_buffers(struct vc_data *vc ) ;
static int read_all_key  ;
    klee_make_symbolic(&read_all_key, sizeof(int), "read_all_key");
...
{ 
  int indcount ;
    klee_make_symbolic(&indcount, sizeof(int), "indcount");
  int sentcount ;
    klee_make_symbolic(&sentcount, sizeof(int), "sentcount");
  int rv ;
...
{ 
  int hc ;
    klee_make_symbolic(&hc, sizeof(int), "hc");
  int d ;
  int vc_num ;
  int tmp ;
  u_long tmp___0 ;
...
{ 
  unsigned long flags ;
  int on_off ;
    klee_make_symbolic(&on_off, sizeof(int), "on_off");
  char *label ;
  raw_spinlock_t *tmp ;
  char *tmp___0 ;
...
{ 
  ...
  char *pn ;
  int var_id ;
    klee_make_symbolic(&var_id, sizeof(int), "var_id");
  int how ;
    klee_make_symbolic(&how, sizeof(int), "how");
  int tmp ;
  char *tmp___0 ;
...
static u_char key_speakup  ;
    klee_make_symbolic(&key_speakup, sizeof(char), "key_speakup");
static u_char spk_key_locked  ;
    klee_make_symbolic(&spk_key_locked, sizeof(char), "spk_key_locked");
...
{ 
  unsigned long flags ;
  int kh ;
    klee_make_symbolic(&kh, sizeof(int), "kh");
  u_char *key_info ;
  u_char type ;
  u_char value ;
  u_char new_key ;
    klee_make_symbolic(&new_key, sizeof(char), "new_key");
  u_char shift_info ;
    klee_make_symbolic(&shift_info, sizeof(char), "shift_info");
  u_char offset ;
  int ret ;
  raw_spinlock_t *tmp ;
  int tmp___0 ;
...
{ 
  ...
  struct vc_data *vc ;
  int up___0 ;
    klee_make_symbolic(&up___0, sizeof(int), "up___0");
  int ret ;
  int keycode ;
    klee_make_symbolic(&keycode, sizeof(int), "keycode");
  bool tmp ;
  int tmp___0 ;
  unsigned char type ;
  unsigned char val ;
...
{ 
  ...
  unsigned long var_keyboard_notifier_call_84_p1 ;
    klee_make_symbolic(&var_keyboard_notifier_call_84_p1, sizeof(long), "var_keyboard_notifier_call_84_p1");
  void *var_keyboard_notifier_call_84_p2 ;
  unsigned long var_vt_notifier_call_85_p1 ;
    klee_make_symbolic(&var_vt_notifier_call_85_p1, sizeof(long), "var_vt_notifier_call_85_p1");
...
static int cur_item  ;
    klee_make_symbolic(&cur_item, sizeof(int), "cur_item");
static int nstates  ;
    klee_make_symbolic(&nstates, sizeof(int), "nstates");
...
{ 
  ...
  u_char ch ;
  u_char ch1 ;
    klee_make_symbolic(&ch1, sizeof(char), "ch1");
  u_short *p_key ;
  u_short key ;
    klee_make_symbolic(&key, sizeof(short), "key");
  int i ;
  int offset ;
  u_char *tmp ;
  u_char *tmp___0 ;
...
{ 
  ...
  int i ;
  int num_funcs ;
    klee_make_symbolic(&num_funcs, sizeof(int), "num_funcs");
  char *cur_funcname ;
  char *tmp ;
...
{ 
  ...
  char *name ;
  u_char func ;
    klee_make_symbolic(&func, sizeof(char), "func");
  u_char *kp ;
  u_short *p_keys ;
  u_short val ;
  char *tmp ;
...
{ 
  ...
  unsigned long index ;
  int charclass ;
    klee_make_symbolic(&charclass, sizeof(int), "charclass");
  int received ;
    klee_make_symbolic(&received, sizeof(int), "received");
  int used ;
  int rejected ;
    klee_make_symbolic(&rejected, sizeof(int), "rejected");
  int reset ;
    klee_make_symbolic(&reset, sizeof(int), "reset");
  int do_characters ;
    klee_make_symbolic(&do_characters, sizeof(int), "do_characters");
  int tmp ;
  size_t desc_length ;
  int i ;
  raw_spinlock_t *tmp___0 ;
...
{ 
  ...
  int num_keys ;
  int nstates___0 ;
    klee_make_symbolic(&nstates___0, sizeof(int), "nstates___0");
  u_char *cp1 ;
  u_char ch ;
  unsigned long flags ;
  raw_spinlock_t *tmp ;
...
{ 
  ...
  char ch ;
  char shut ;
    klee_make_symbolic(&shut, sizeof(char), "shut");
  unsigned long flags ;
  size_t tmp ;
  raw_spinlock_t *tmp___0 ;
...
static int sel_end  ;
    klee_make_symbolic(&sel_end, sizeof(int), "sel_end");
static int sel_buffer_lth  ;
    klee_make_symbolic(&sel_buffer_lth, sizeof(int), "sel_buffer_lth");
...
{ 
  int new_sel_start ;
    klee_make_symbolic(&new_sel_start, sizeof(int), "new_sel_start");
  int new_sel_end ;
    klee_make_symbolic(&new_sel_end, sizeof(int), "new_sel_end");
  char *bp ;
  char *obp ;
  int i ;
  int ps ;
  ...
  int pe ;
    klee_make_symbolic(&pe, sizeof(int), "pe");
  struct vc_data *vc ;
  int tmp ;
...
{ 
  struct vc_data *vc ;
  int pasted ;
    klee_make_symbolic(&pasted, sizeof(int), "pasted");
  int count ;
  wait_queue_t wait ;
...
static int timeouts  ;
    klee_make_symbolic(&timeouts, sizeof(int), "timeouts");
struct old_serial_port  const  *spk_serial_init(int index ) 
{ 
  int baud ;
...
{ 
  int tmout ;
    klee_make_symbolic(&tmout, sizeof(int), "tmout");
  unsigned char tmp ;
  unsigned char tmp___0 ;
...
static int module_status  ;
    klee_make_symbolic(&module_status, sizeof(int), "module_status");
...
{ 
  ...
  unsigned long jiff_max ;
    klee_make_symbolic(&jiff_max, sizeof(long), "jiff_max");
  struct var_t *delay_time ;
  struct var_t *full_time ;
  struct var_t *jiffy_delta ;
  int jiffy_delta_val ;
    klee_make_symbolic(&jiffy_delta_val, sizeof(int), "jiffy_delta_val");
  int delay_time_val ;
    klee_make_symbolic(&delay_time_val, sizeof(int), "delay_time_val");
  int full_time_val ;
    klee_make_symbolic(&full_time_val, sizeof(int), "full_time_val");
  raw_spinlock_t *tmp ;
  raw_spinlock_t *tmp___0 ;
  int tmp___1 ;
  char tmp___2 ;
...
static int index_count  ;
    klee_make_symbolic(&index_count, sizeof(int), "index_count");
static int sentence_count  ;
    klee_make_symbolic(&sentence_count, sizeof(int), "sentence_count");
void reset_index_count(int sc ) 
{ 
  int first ;
...
{ 
  unsigned long flags ;
  int should_break ;
    klee_make_symbolic(&should_break, sizeof(int), "should_break");
...
static int ldv_mutex_spk_mutex  ;
    klee_make_symbolic(&ldv_mutex_spk_mutex, sizeof(int), "ldv_mutex_spk_mutex");
