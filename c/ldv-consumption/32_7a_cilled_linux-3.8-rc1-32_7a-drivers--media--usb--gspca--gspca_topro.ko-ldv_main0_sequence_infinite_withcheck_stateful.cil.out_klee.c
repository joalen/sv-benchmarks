...
{ 
  ...
  int count ;
  int actual_count ;
    klee_make_symbolic(&actual_count, sizeof(int), "actual_count");
  int ret ;
  size_t __len ;
  void *__ret ;
  unsigned int tmp ;
...
{ 
  ...
  int sensor ;
    klee_make_symbolic(&sensor, sizeof(int), "sensor");
...
{ 
  ...
  int expo ;
    klee_make_symbolic(&expo, sizeof(int), "expo");
  unsigned int tmp ;
  unsigned int tmp___0 ;
  int new_expo ;
    klee_make_symbolic(&new_expo, sizeof(int), "new_expo");
  s32 tmp___1 ;
...
{ 
  ...
  int var_sd_pkt_scan_34_p2 ;
    klee_make_symbolic(&var_sd_pkt_scan_34_p2, sizeof(int), "var_sd_pkt_scan_34_p2");
  ...
  int res_sd_probe_42 ;
    klee_make_symbolic(&res_sd_probe_42, sizeof(int), "res_sd_probe_42");
