...
struct read_regs_int {
   ...
   unsigned int req_count ;
    klee_make_symbolic(&req_count, sizeof(int), "req_count");
   u8 buffer[64U] ;
   int length ;
   __le16 cr_int_addr ;
};
...
struct zd_usb_interrupt {
   struct read_regs_int read_regs ;
    klee_make_symbolic(&read_regs, sizeof(int), "read_regs");
   spinlock_t lock ;
   struct urb *urb ;
   void *buffer ;
...
struct zd_usb_rx {
   ...
   unsigned int fragment_length ;
    klee_make_symbolic(&fragment_length, sizeof(int), "fragment_length");
   unsigned int usb_packet_size ;
    klee_make_symbolic(&usb_packet_size, sizeof(int), "usb_packet_size");
   struct urb **urbs ;
   int urbs_count ;
    klee_make_symbolic(&urbs_count, sizeof(int), "urbs_count");
};
struct zd_usb_tx {
   atomic_t enabled ;
   spinlock_t lock ;
   ...
   int submitted_urbs ;
    klee_make_symbolic(&submitted_urbs, sizeof(int), "submitted_urbs");
...
struct zd_usb {
   ...
   int cmd_error ;
    klee_make_symbolic(&cmd_error, sizeof(int), "cmd_error");
   u8 req_buf[64U] ;
...
{ 
  ...
  unsigned int count16 ;
    klee_make_symbolic(&count16, sizeof(int), "count16");
  long tmp ;
  long tmp___0 ;
  int j ;
...
{ 
  ...
  int beacon_interval ;
  int beacon_period ;
    klee_make_symbolic(&beacon_period, sizeof(int), "beacon_period");
  u8 channel ;
...
{ 
  ...
  int first_idx ;
  int final_idx ;
    klee_make_symbolic(&final_idx, sizeof(int), "final_idx");
  struct tx_retry_rate  const  *retries ;
  u8 final_rate ;
  bool tmp___2 ;
  int tmp___3 ;
...
{ 
  ...
  int num_cmds ;
    klee_make_symbolic(&num_cmds, sizeof(int), "num_cmds");
  int req_pos ;
    klee_make_symbolic(&req_pos, sizeof(int), "req_pos");
  u32 tmp___0 ;
  u32 j ;
  u32 full_len ;
  ...
  unsigned long message_jiffies ;
    klee_make_symbolic(&message_jiffies, sizeof(long), "message_jiffies");
...
{ 
  ...
  struct sk_buff *skb ;
  int bad_frame ;
    klee_make_symbolic(&bad_frame, sizeof(int), "bad_frame");
  __le16 fc ;
  int need_padding ;
    klee_make_symbolic(&need_padding, sizeof(int), "need_padding");
  int i ;
  u8 rate ;
  u8 tmp___0 ;
  int tmp___1 ;
...
{ 
  ...
  struct zd_chip *chip ;
  int is_associated ;
    klee_make_symbolic(&is_associated, sizeof(int), "is_associated");
  int r ;
  int tmp ;
...
{ 
  ...
  unsigned int var_zd_op_configure_filter_30_p1 ;
    klee_make_symbolic(&var_zd_op_configure_filter_30_p1, sizeof(int), "var_zd_op_configure_filter_30_p1");
...
{ 
  ...
  int r ;
  int found_config ;
    klee_make_symbolic(&found_config, sizeof(int), "found_config");
  u16 intr_status ;
  struct zd_chip *chip ;
  struct zd_chip *tmp ;
...
{ 
  ...
  int i ;
  int req_len ;
    klee_make_symbolic(&req_len, sizeof(int), "req_len");
  int actual_req_len ;
    klee_make_symbolic(&actual_req_len, sizeof(int), "actual_req_len");
  int try_count ;
...
{ 
  ...
  int res_probe_48 ;
    klee_make_symbolic(&res_probe_48, sizeof(int), "res_probe_48");
  int ldv_s_driver_usb_driver ;
    klee_make_symbolic(&ldv_s_driver_usb_driver, sizeof(int), "ldv_s_driver_usb_driver");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
...
static int ldv_mutex_setup_mutex  ;
    klee_make_symbolic(&ldv_mutex_setup_mutex, sizeof(int), "ldv_mutex_setup_mutex");
