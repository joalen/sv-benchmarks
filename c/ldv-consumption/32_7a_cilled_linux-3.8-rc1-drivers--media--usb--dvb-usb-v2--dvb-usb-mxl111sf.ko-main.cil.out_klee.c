...
{ struct dvb_usb_device *d ;
  ...
  int pr_err ;
    klee_make_symbolic(&pr_err, sizeof(int), "pr_err");
  struct _ddebug descriptor ;
  long tmp ;
  int tmp___0 ;
...
int ldv_retval_mxl111sf_init  ;
    klee_make_symbolic(&ldv_retval_mxl111sf_init, sizeof(int), "ldv_retval_mxl111sf_init");
...
int ldv_retval_mxl111sf_usb_driver_init  ;
    klee_make_symbolic(&ldv_retval_mxl111sf_usb_driver_init, sizeof(int), "ldv_retval_mxl111sf_usb_driver_init");
u8 ldvarg24  ;
...
static int ldv_mutex_fe_lock_of_mxl111sf_state  ;
    klee_make_symbolic(&ldv_mutex_fe_lock_of_mxl111sf_state, sizeof(int), "ldv_mutex_fe_lock_of_mxl111sf_state");
...
static int ldv_mutex_i2c_mutex_of_dvb_usb_device  ;
    klee_make_symbolic(&ldv_mutex_i2c_mutex_of_dvb_usb_device, sizeof(int), "ldv_mutex_i2c_mutex_of_dvb_usb_device");
int ldv_mutex_lock_interruptible_i2c_mutex_of_dvb_usb_device(struct mutex *lock ) 
{ int nondetermined ;
