...
struct __anonstruct_drv_info_t_209 {
   ...
   unsigned int nr_blks ;
    klee_make_symbolic(&nr_blks, sizeof(int), "nr_blks");
...
struct ctlr_info {
   ...
   char firm_rev[4U] ;
   int ctlr_sig ;
    klee_make_symbolic(&ctlr_sig, sizeof(int), "ctlr_sig");
   int log_drives ;
    klee_make_symbolic(&log_drives, sizeof(int), "log_drives");
   int phys_drives ;
    klee_make_symbolic(&phys_drives, sizeof(int), "phys_drives");
   ...
   unsigned long io_mem_addr ;
    klee_make_symbolic(&io_mem_addr, sizeof(long), "io_mem_addr");
   unsigned long io_mem_length ;
    klee_make_symbolic(&io_mem_length, sizeof(long), "io_mem_length");
   int intr ;
   ...
   unsigned int misc_tflags ;
    klee_make_symbolic(&misc_tflags, sizeof(int), "misc_tflags");
};
...
static int nr_ctlr  ;
    klee_make_symbolic(&nr_ctlr, sizeof(int), "nr_ctlr");
...
{ int num_cntlrs_reg ;
    klee_make_symbolic(&num_cntlrs_reg, sizeof(int), "num_cntlrs_reg");
  int i ;
  int rc ;
...
{ ushort vendor_id ;
  ...
  unchar cache_line_size ;
    klee_make_symbolic(&cache_line_size, sizeof(char), "cache_line_size");
  unchar latency_timer ;
    klee_make_symbolic(&latency_timer, sizeof(char), "latency_timer");
  unchar irq ;
  unchar revision ;
...
{ int i ;
  ...
  int ctlr ;
  int num_ctlr ;
    klee_make_symbolic(&num_ctlr, sizeof(int), "num_ctlr");
  struct resource *tmp ;
...
{ ctlr_info_t *h ;
  cmdlist_t *c ;
  unsigned long istat ;
    klee_make_symbolic(&istat, sizeof(long), "istat");
  unsigned long flags ;
  __u32 a ;
  __u32 a1 ;
  raw_spinlock_t *tmp ;
...
{ id_log_drv_t *id_ldrive ;
  ...
  unsigned int log_unit ;
    klee_make_symbolic(&log_unit, sizeof(int), "log_unit");
  unsigned int log_index ;
    klee_make_symbolic(&log_index, sizeof(int), "log_index");
  int ret_code ;
  int size ;
  drv_info_t *drv ;
  ctlr_info_t *info_p ;
...
static int ldv_mutex_cpqarray_mutex  ;
    klee_make_symbolic(&ldv_mutex_cpqarray_mutex, sizeof(int), "ldv_mutex_cpqarray_mutex");
