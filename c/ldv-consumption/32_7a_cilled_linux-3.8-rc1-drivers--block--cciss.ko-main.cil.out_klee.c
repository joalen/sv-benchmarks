...
unsigned long ldvarg44  ;
    klee_make_symbolic(&ldvarg44, sizeof(long), "ldvarg44");
...
unsigned long ldvarg71  ;
    klee_make_symbolic(&ldvarg71, sizeof(long), "ldvarg71");
...
static int ldv_mutex_busy_shutting_down_of_ctlr_info  ;
    klee_make_symbolic(&ldv_mutex_busy_shutting_down_of_ctlr_info, sizeof(int), "ldv_mutex_busy_shutting_down_of_ctlr_info");
