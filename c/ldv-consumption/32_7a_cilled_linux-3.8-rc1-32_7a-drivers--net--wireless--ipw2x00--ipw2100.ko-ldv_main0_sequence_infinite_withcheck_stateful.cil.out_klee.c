...
struct libipw_stats {
   ...
   unsigned int rx_discards_undecryptable ;
    klee_make_symbolic(&rx_discards_undecryptable, sizeof(int), "rx_discards_undecryptable");
...
struct libipw_network {
   ...
   unsigned long last_scanned ;
    klee_make_symbolic(&last_scanned, sizeof(long), "last_scanned");
   u8 mode ;
   u32 flags ;
   u32 last_associate ;
   u32 time_stamp[2U] ;
...
struct libipw_device {
   ...
   int scans ;
    klee_make_symbolic(&scans, sizeof(int), "scans");
   int scan_age ;
    klee_make_symbolic(&scan_age, sizeof(int), "scan_age");
   int iw_mode ;
    klee_make_symbolic(&iw_mode, sizeof(int), "iw_mode");
   struct iw_spy_data spy_data ;
   spinlock_t lock ;
   int tx_headroom ;
    klee_make_symbolic(&tx_headroom, sizeof(int), "tx_headroom");
   u32 config ;
   int open_wep ;
   ...
   int host_encrypt_msdu ;
    klee_make_symbolic(&host_encrypt_msdu, sizeof(int), "host_encrypt_msdu");
   int host_decrypt ;
    klee_make_symbolic(&host_decrypt, sizeof(int), "host_decrypt");
   int host_mc_decrypt ;
    klee_make_symbolic(&host_mc_decrypt, sizeof(int), "host_mc_decrypt");
   int host_strip_iv_icv ;
    klee_make_symbolic(&host_strip_iv_icv, sizeof(int), "host_strip_iv_icv");
   int host_open_frag ;
    klee_make_symbolic(&host_open_frag, sizeof(int), "host_open_frag");
   int ieee802_1x ;
    klee_make_symbolic(&ieee802_1x, sizeof(int), "ieee802_1x");
   int wpa_enabled ;
    klee_make_symbolic(&wpa_enabled, sizeof(int), "wpa_enabled");
   ...
   int mode ;
   int modulation ;
    klee_make_symbolic(&modulation, sizeof(int), "modulation");
   int freq_band ;
    klee_make_symbolic(&freq_band, sizeof(int), "freq_band");
   int abg_true ;
    klee_make_symbolic(&abg_true, sizeof(int), "abg_true");
   int perfect_rssi ;
    klee_make_symbolic(&perfect_rssi, sizeof(int), "perfect_rssi");
   int worst_rssi ;
    klee_make_symbolic(&worst_rssi, sizeof(int), "worst_rssi");
   u16 prev_seq_ctl ;
...
struct ipw2100_tx_packet {
   ...
   int jiffy_start ;
    klee_make_symbolic(&jiffy_start, sizeof(int), "jiffy_start");
   struct list_head list ;
};
struct ipw2100_rx;
struct ipw2100_rx_packet {
...
struct ipw2100_priv {
   void *ioaddr ;
   int stop_hang_check ;
    klee_make_symbolic(&stop_hang_check, sizeof(int), "stop_hang_check");
   int stop_rf_kill ;
    klee_make_symbolic(&stop_rf_kill, sizeof(int), "stop_rf_kill");
   struct libipw_device *ieee ;
   unsigned long status ;
    klee_make_symbolic(&status, sizeof(long), "status");
   unsigned long config ;
    klee_make_symbolic(&config, sizeof(long), "config");
   unsigned long capability ;
    klee_make_symbolic(&capability, sizeof(long), "capability");
   int resets ;
    klee_make_symbolic(&resets, sizeof(int), "resets");
   int reset_backoff ;
    klee_make_symbolic(&reset_backoff, sizeof(int), "reset_backoff");
   u8 essid[32U] ;
   u8 essid_len ;
   u8 bssid[6U] ;
   u8 channel ;
   int last_mode ;
    klee_make_symbolic(&last_mode, sizeof(int), "last_mode");
   ...
   u32 fatal_index ;
   int eeprom_version ;
    klee_make_symbolic(&eeprom_version, sizeof(int), "eeprom_version");
   int firmware_version ;
    klee_make_symbolic(&firmware_version, sizeof(int), "firmware_version");
   unsigned long hw_features ;
    klee_make_symbolic(&hw_features, sizeof(long), "hw_features");
   int hangs ;
    klee_make_symbolic(&hangs, sizeof(int), "hangs");
   u32 last_rtc ;
   int dump_raw ;
    klee_make_symbolic(&dump_raw, sizeof(int), "dump_raw");
   u8 *snapshot[48U] ;
   ...
   int messages_sent ;
    klee_make_symbolic(&messages_sent, sizeof(int), "messages_sent");
   int short_retry_limit ;
    klee_make_symbolic(&short_retry_limit, sizeof(int), "short_retry_limit");
   int long_retry_limit ;
    klee_make_symbolic(&long_retry_limit, sizeof(int), "long_retry_limit");
   u32 rts_threshold ;
   u32 frag_threshold ;
   int in_isr ;
    klee_make_symbolic(&in_isr, sizeof(int), "in_isr");
   u32 tx_rates ;
   int tx_power ;
    klee_make_symbolic(&tx_power, sizeof(int), "tx_power");
   u32 beacon_interval ;
   char nick[33U] ;
   ...
   int user_requested_scan ;
    klee_make_symbolic(&user_requested_scan, sizeof(int), "user_requested_scan");
   unsigned long suspend_at ;
    klee_make_symbolic(&suspend_at, sizeof(long), "suspend_at");
   unsigned long suspend_time ;
    klee_make_symbolic(&suspend_time, sizeof(long), "suspend_time");
   u32 interrupts ;
   int tx_interrupts ;
    klee_make_symbolic(&tx_interrupts, sizeof(int), "tx_interrupts");
   int rx_interrupts ;
    klee_make_symbolic(&rx_interrupts, sizeof(int), "rx_interrupts");
   int inta_other ;
    klee_make_symbolic(&inta_other, sizeof(int), "inta_other");
   spinlock_t low_lock ;
...
struct ipw2100_fw_header {
   ...
   unsigned int uc_size ;
    klee_make_symbolic(&uc_size, sizeof(int), "uc_size");
};
...
{ 
  ...
  int associated ;
    klee_make_symbolic(&associated, sizeof(int), "associated");
  raw_spinlock_t *tmp ;
  int tmp___0 ;
...
{ 
  ...
  unsigned int essid_len ;
    klee_make_symbolic(&essid_len, sizeof(int), "essid_len");
  char essid[32U] ;
  u32 txrate ;
  u32 chan ;
  char *txratename ;
...
{ 
  ...
  int descriptors_used ;
    klee_make_symbolic(&descriptors_used, sizeof(int), "descriptors_used");
  int e ;
...
{ 
  ...
  struct net_device *dev ;
  unsigned long loop ;
    klee_make_symbolic(&loop, sizeof(long), "loop");
  int len ;
  u32 buffer[4U] ;
  int i ;
  char line[81U] ;
...
{ 
  ...
  int err ;
  int auth_mode ;
    klee_make_symbolic(&auth_mode, sizeof(int), "auth_mode");
  int sec_level ;
    klee_make_symbolic(&sec_level, sizeof(int), "sec_level");
  int use_group ;
    klee_make_symbolic(&use_group, sizeof(int), "use_group");
...
{ 
  ...
  int i ;
  int force_update ;
    klee_make_symbolic(&force_update, sizeof(int), "force_update");
  size_t __len ;
  void *__ret ;
  struct thread_info *tmp___0 ;
...
{ 
  int err ;
  int batch_mode ;
    klee_make_symbolic(&batch_mode, sizeof(int), "batch_mode");
  u8 *bssid ;
  struct thread_info *tmp ;
  struct thread_info *tmp___0 ;
  struct thread_info *tmp___1 ;
...
{ 
  int rssi_qual ;
    klee_make_symbolic(&rssi_qual, sizeof(int), "rssi_qual");
  int tx_qual ;
    klee_make_symbolic(&tx_qual, sizeof(int), "tx_qual");
  int beacon_qual ;
    klee_make_symbolic(&beacon_qual, sizeof(int), "beacon_qual");
  int quality ;
...
{ 
  ...
  unsigned int firmware_data_left ;
    klee_make_symbolic(&firmware_data_left, sizeof(int), "firmware_data_left");
...
{ 
  ...
  unsigned int microcode_data_left ;
    klee_make_symbolic(&microcode_data_left, sizeof(int), "microcode_data_left");
  void *reg ;
...
{ 
  ...
  int res_ipw2100_open_138 ;
    klee_make_symbolic(&res_ipw2100_open_138, sizeof(int), "res_ipw2100_open_138");
  int res_ipw2100_close_139 ;
    klee_make_symbolic(&res_ipw2100_close_139, sizeof(int), "res_ipw2100_close_139");
  ...
  int res_ipw2100_pci_init_one_149 ;
    klee_make_symbolic(&res_ipw2100_pci_init_one_149, sizeof(int), "res_ipw2100_pci_init_one_149");
  pm_message_t var_ipw2100_suspend_151_p1 ;
  int var_ipw2100_interrupt_71_p0 ;
    klee_make_symbolic(&var_ipw2100_interrupt_71_p0, sizeof(int), "var_ipw2100_interrupt_71_p0");
  void *var_ipw2100_interrupt_71_p1 ;
  int ldv_s_ipw2100_netdev_ops_net_device_ops ;
    klee_make_symbolic(&ldv_s_ipw2100_netdev_ops_net_device_ops, sizeof(int), "ldv_s_ipw2100_netdev_ops_net_device_ops");
  int ldv_s_ipw2100_pci_driver_pci_driver ;
    klee_make_symbolic(&ldv_s_ipw2100_pci_driver_pci_driver, sizeof(int), "ldv_s_ipw2100_pci_driver_pci_driver");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
...
static int ldv_mutex_action_mutex  ;
    klee_make_symbolic(&ldv_mutex_action_mutex, sizeof(int), "ldv_mutex_action_mutex");
...
static int ldv_mutex_adapter_mutex  ;
    klee_make_symbolic(&ldv_mutex_adapter_mutex, sizeof(int), "ldv_mutex_adapter_mutex");
