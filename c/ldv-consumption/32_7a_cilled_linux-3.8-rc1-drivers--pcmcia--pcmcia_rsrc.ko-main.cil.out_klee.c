...
{ struct socket_data *s_data ;
  ...
  unsigned int info1 ;
    klee_make_symbolic(&info1, sizeof(int), "info1");
  unsigned int info2 ;
    klee_make_symbolic(&info2, sizeof(int), "info2");
  int ret ;
  int tmp ;
  struct _ddebug descriptor ;
  long tmp___0 ;
...
{ struct socket_data *s_data ;
  ...
  u_long bad ;
    klee_make_symbolic(&bad, sizeof(long), "bad");
  u_long fail ;
    klee_make_symbolic(&fail, sizeof(long), "fail");
  u_long step ;
...
{ struct resource_map *m ;
  ...
  struct socket_data *s_data ;
  unsigned long ok ;
    klee_make_symbolic(&ok, sizeof(long), "ok");
  int tmp ;
...
{ struct pcmcia_align_data *data ;
  ...
  unsigned long map_start ;
    klee_make_symbolic(&map_start, sizeof(long), "map_start");
  unsigned long map_end ;
    klee_make_symbolic(&map_end, sizeof(long), "map_end");
...
static int ldv_mutex_ops_mutex_of_pcmcia_socket  ;
    klee_make_symbolic(&ldv_mutex_ops_mutex_of_pcmcia_socket, sizeof(int), "ldv_mutex_ops_mutex_of_pcmcia_socket");
