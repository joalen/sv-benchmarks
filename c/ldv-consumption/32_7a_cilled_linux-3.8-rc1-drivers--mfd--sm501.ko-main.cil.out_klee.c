...
struct i2c_gpio_platform_data {
   unsigned int sda_pin ;
    klee_make_symbolic(&sda_pin, sizeof(int), "sda_pin");
   unsigned int scl_pin ;
    klee_make_symbolic(&scl_pin, sizeof(int), "scl_pin");
   int udelay ;
...
struct sm501_platdata_fbsub {
   ...
   unsigned int def_bpp ;
    klee_make_symbolic(&def_bpp, sizeof(int), "def_bpp");
   unsigned long max_mem ;
    klee_make_symbolic(&max_mem, sizeof(long), "max_mem");
   unsigned int flags ;
};
...
struct sm501_platdata_gpio_i2c {
   ...
   unsigned int pin_sda ;
    klee_make_symbolic(&pin_sda, sizeof(int), "pin_sda");
   unsigned int pin_scl ;
    klee_make_symbolic(&pin_scl, sizeof(int), "pin_scl");
   int udelay ;
   int timeout ;
};
struct sm501_reg_init {
   unsigned long set ;
    klee_make_symbolic(&set, sizeof(long), "set");
   unsigned long mask ;
...
struct sm501_initdata {
   ...
   unsigned long devices ;
    klee_make_symbolic(&devices, sizeof(long), "devices");
   unsigned long mclk ;
    klee_make_symbolic(&mclk, sizeof(long), "mclk");
   unsigned long m1xclk ;
    klee_make_symbolic(&m1xclk, sizeof(long), "m1xclk");
};
...
struct sm501_platdata {
   ...
   unsigned int gpio_i2c_nr ;
    klee_make_symbolic(&gpio_i2c_nr, sizeof(int), "gpio_i2c_nr");
};
struct exception_table_entry {
   int insn ;
...
struct sm501_devdata {
   ...
   unsigned long pm_misc ;
    klee_make_symbolic(&pm_misc, sizeof(long), "pm_misc");
   int unit_power[20U] ;
   unsigned int pdev_id ;
    klee_make_symbolic(&pdev_id, sizeof(int), "pdev_id");
   unsigned int irq ;
   void *regs ;
   unsigned int rev ;
...
{ struct sm501_devdata *sm ;
  void *tmp ;
  unsigned long misc ;
    klee_make_symbolic(&misc, sizeof(long), "misc");
  unsigned long save ;
...
{ struct sm501_devdata *sm ;
  ...
  unsigned long mode ;
  unsigned long gate ;
    klee_make_symbolic(&gate, sizeof(long), "gate");
  unsigned long clock ;
...
{ unsigned long mclk ;
  ...
  unsigned int k ;
  long best_diff ;
    klee_make_symbolic(&best_diff, sizeof(long), "best_diff");
  int tmp ;
...
{ struct sm501_devdata *sm ;
  ...
  unsigned int pll_reg ;
    klee_make_symbolic(&pll_reg, sizeof(int), "pll_reg");
  unsigned long sm501_freq ;
    klee_make_symbolic(&sm501_freq, sizeof(long), "sm501_freq");
...
{ unsigned long ctrl ;
    klee_make_symbolic(&ctrl, sizeof(long), "ctrl");
...
{ struct sm501_gpio_chip *smchip ;
  ...
  unsigned long save ;
  unsigned long ddr ;
    klee_make_symbolic(&ddr, sizeof(long), "ddr");
  struct _ddebug descriptor ;
  struct sm501_devdata *tmp___0 ;
  long tmp___1 ;
  raw_spinlock_t *tmp___2 ;
...
{ unsigned long pwrmode ;
    klee_make_symbolic(&pwrmode, sizeof(long), "pwrmode");
  unsigned int tmp ;
  unsigned long msrc ;
    klee_make_symbolic(&msrc, sizeof(long), "msrc");
  unsigned long m1src ;
    klee_make_symbolic(&m1src, sizeof(long), "m1src");
...
{ struct sm501_initdata *idata ;
  ...
  unsigned long dramctrl ;
    klee_make_symbolic(&dramctrl, sizeof(long), "dramctrl");
  unsigned long devid ;
    klee_make_symbolic(&devid, sizeof(long), "devid");
  int ret ;
  struct lock_class_key __key ;
...
static int ldv_mutex_clock_lock_of_sm501_devdata  ;
    klee_make_symbolic(&ldv_mutex_clock_lock_of_sm501_devdata, sizeof(int), "ldv_mutex_clock_lock_of_sm501_devdata");
