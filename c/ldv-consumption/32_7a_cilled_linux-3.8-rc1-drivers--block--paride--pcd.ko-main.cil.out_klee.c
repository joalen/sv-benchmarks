...
struct cdrom_device_info {
   ...
   unsigned int vfs_events ;
    klee_make_symbolic(&vfs_events, sizeof(int), "vfs_events");
   unsigned int ioctl_events ;
    klee_make_symbolic(&ioctl_events, sizeof(int), "ioctl_events");
   int use_count ;
   ...
   int cdda_method ;
    klee_make_symbolic(&cdda_method, sizeof(int), "cdda_method");
   __u8 last_sense ;
   __u8 media_written ;
   unsigned short mmc3_profile ;
    klee_make_symbolic(&mmc3_profile, sizeof(short), "mmc3_profile");
   int for_data ;
    klee_make_symbolic(&for_data, sizeof(int), "for_data");
   int (*exit)(struct cdrom_device_info * ) ;
   int mrw_mode_page ;
    klee_make_symbolic(&mrw_mode_page, sizeof(int), "mrw_mode_page");
};
struct cdrom_device_ops {
   ...
   int n_minors ;
    klee_make_symbolic(&n_minors, sizeof(int), "n_minors");
...
static int pcd_drive_count  ;
    klee_make_symbolic(&pcd_drive_count, sizeof(int), "pcd_drive_count");
...
static int pcd_retries  ;
    klee_make_symbolic(&pcd_retries, sizeof(int), "pcd_retries");
static int pcd_busy  ;
    klee_make_symbolic(&pcd_busy, sizeof(int), "pcd_busy");
static int pcd_sector  ;
    klee_make_symbolic(&pcd_sector, sizeof(int), "pcd_sector");
static int pcd_count  ;
    klee_make_symbolic(&pcd_count, sizeof(int), "pcd_count");
static char *pcd_buf  ;
...
static int ldv_mutex_pcd_mutex  ;
    klee_make_symbolic(&ldv_mutex_pcd_mutex, sizeof(int), "ldv_mutex_pcd_mutex");
