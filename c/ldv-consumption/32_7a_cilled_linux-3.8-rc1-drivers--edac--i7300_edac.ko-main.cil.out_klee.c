...
struct dimm_info {
   ...
   u32 nr_pages ;
   unsigned int csrow ;
    klee_make_symbolic(&csrow, sizeof(int), "csrow");
   unsigned int cschannel ;
    klee_make_symbolic(&cschannel, sizeof(int), "cschannel");
};
struct csrow_info;
struct rank_info {
   int chan_idx ;
...
struct csrow_info {
   ...
   unsigned long first_page ;
    klee_make_symbolic(&first_page, sizeof(long), "first_page");
   unsigned long last_page ;
    klee_make_symbolic(&last_page, sizeof(long), "last_page");
   unsigned long page_mask ;
    klee_make_symbolic(&page_mask, sizeof(long), "page_mask");
   int csrow_idx ;
    klee_make_symbolic(&csrow_idx, sizeof(int), "csrow_idx");
   u32 ue_count ;
   u32 ce_count ;
   u32 nr_pages ;
   struct mem_ctl_info *mci ;
...
struct mem_ctl_info {
   ...
   unsigned long mtype_cap ;
    klee_make_symbolic(&mtype_cap, sizeof(long), "mtype_cap");
   unsigned long edac_ctl_cap ;
    klee_make_symbolic(&edac_ctl_cap, sizeof(long), "edac_ctl_cap");
   unsigned long edac_cap ;
    klee_make_symbolic(&edac_cap, sizeof(long), "edac_cap");
   unsigned long scrub_cap ;
    klee_make_symbolic(&scrub_cap, sizeof(long), "scrub_cap");
   ...
   int mc_idx ;
    klee_make_symbolic(&mc_idx, sizeof(int), "mc_idx");
   struct csrow_info **csrows ;
   unsigned int nr_csrows ;
    klee_make_symbolic(&nr_csrows, sizeof(int), "nr_csrows");
   unsigned int num_cschannel ;
    klee_make_symbolic(&num_cschannel, sizeof(int), "num_cschannel");
   unsigned int n_layers ;
    klee_make_symbolic(&n_layers, sizeof(int), "n_layers");
   struct edac_mc_layer *layers ;
   bool mem_is_per_rank ;
   unsigned int tot_dimms ;
    klee_make_symbolic(&tot_dimms, sizeof(int), "tot_dimms");
   ...
   int op_state ;
    klee_make_symbolic(&op_state, sizeof(int), "op_state");
...
struct edac_pci_ctl_info {
   struct list_head link ;
   int pci_idx ;
    klee_make_symbolic(&pci_idx, sizeof(int), "pci_idx");
...
struct i7300_dimm_info {
   int megabytes ;
    klee_make_symbolic(&megabytes, sizeof(int), "megabytes");
};
struct i7300_pvt {
...
extern int edac_op_state ;
    klee_make_symbolic(&edac_op_state, sizeof(int), "edac_op_state");
...
extern int edac_debug_level ;
    klee_make_symbolic(&edac_debug_level, sizeof(int), "edac_debug_level");
...
{ struct i7300_pvt *pvt ;
  ...
  unsigned int rank ;
    klee_make_symbolic(&rank, sizeof(int), "rank");
  unsigned int cas ;
    klee_make_symbolic(&cas, sizeof(int), "cas");
  unsigned int ras ;
    klee_make_symbolic(&ras, sizeof(int), "ras");
  u32 syndrome ;
  unsigned long errors ;
  char const   *specific ;
  bool is_wr ;
...
static int decode_mtr(struct i7300_pvt *pvt , int slot , int ch , int branch , struct i7300_dimm_info *dinfo ,
                      struct dimm_info *dimm ) 
{ int mtr ;
    klee_make_symbolic(&mtr, sizeof(int), "mtr");
  int ans ;
    klee_make_symbolic(&ans, sizeof(int), "ans");
  int addrBits ;
    klee_make_symbolic(&addrBits, sizeof(int), "addrBits");
  int channel ;
  char *tmp ;
  int tmp___0 ;
...
{ struct i7300_pvt *pvt ;
  ...
  int ___i ;
    klee_make_symbolic(&___i, sizeof(int), "___i");
  int __i ;
