...
struct rx_desc_92d {
   ...
   unsigned short iv0 ;
    klee_make_symbolic(&iv0, sizeof(short), "iv0");
   u32 iv1 ;
   u32 tsfl ;
   u32 bufferaddress ;
   u32 bufferaddress64 ;
...
{ struct rtl_priv *rtlpriv ;
  ...
  long temp_cck ;
  long val_x ;
    klee_make_symbolic(&val_x, sizeof(long), "val_x");
  long value32 ;
    klee_make_symbolic(&value32, sizeof(long), "value32");
  long val_y ;
    klee_make_symbolic(&val_y, sizeof(long), "val_y");
  long ele_c ;
...
{ struct rtl_priv *rtlpriv ;
  ...
  long val_y ;
  long tx1_c ;
    klee_make_symbolic(&tx1_c, sizeof(long), "tx1_c");
  char *tmp ;
  long tmp___0 ;
  u32 tmp___1 ;
  long tmp___2 ;
...
{ struct rtl_priv *rtlpriv ;
  ...
  bool pathb_ok ;
  long rege94 ;
    klee_make_symbolic(&rege94, sizeof(long), "rege94");
  long rege9c ;
    klee_make_symbolic(&rege9c, sizeof(long), "rege9c");
  long regea4 ;
    klee_make_symbolic(&regea4, sizeof(long), "regea4");
  long regeac ;
    klee_make_symbolic(&regeac, sizeof(long), "regeac");
  long regeb4 ;
    klee_make_symbolic(&regeb4, sizeof(long), "regeb4");
  long regebc ;
    klee_make_symbolic(&regebc, sizeof(long), "regebc");
  long regec4 ;
    klee_make_symbolic(&regec4, sizeof(long), "regec4");
  long regecc ;
    klee_make_symbolic(&regecc, sizeof(long), "regecc");
  long regtmp ;
    klee_make_symbolic(&regtmp, sizeof(long), "regtmp");
  bool is12simular ;
  bool is13simular ;
  bool is23simular ;
  unsigned long flag ;
...
{ char ret_val ;
    klee_make_symbolic(&ret_val, sizeof(char), "ret_val");
...
{ long signal_power ;
    klee_make_symbolic(&signal_power, sizeof(long), "signal_power");
...
{ long retsig ;
    klee_make_symbolic(&retsig, sizeof(long), "retsig");
...
{ struct rtl_priv *rtlpriv ;
  int weighting ;
    klee_make_symbolic(&weighting, sizeof(int), "weighting");
