...
struct ins_format1 {
   unsigned char immediate ;
    klee_make_symbolic(&immediate, sizeof(char), "immediate");
...
struct ins_format2 {
   unsigned char shift_control ;
    klee_make_symbolic(&shift_control, sizeof(char), "shift_control");
   unsigned short source : 9 ;
   unsigned short destination : 9 ;
   unsigned char ret : 1 ;
   unsigned char opcode : 4 ;
...
union ins_formats {
   ...
   unsigned int integer ;
    klee_make_symbolic(&integer, sizeof(int), "integer");
};
...
struct seeprom_config {
   ...
   unsigned short bios_control ;
    klee_make_symbolic(&bios_control, sizeof(short), "bios_control");
   unsigned short adapter_control ;
    klee_make_symbolic(&adapter_control, sizeof(short), "adapter_control");
   unsigned short brtime_id ;
    klee_make_symbolic(&brtime_id, sizeof(short), "brtime_id");
   unsigned short max_targets ;
    klee_make_symbolic(&max_targets, sizeof(short), "max_targets");
...
struct aic7xxx_hwscb {
   ...
   unsigned char target_channel_lun ;
    klee_make_symbolic(&target_channel_lun, sizeof(char), "target_channel_lun");
   unsigned char target_status ;
    klee_make_symbolic(&target_status, sizeof(char), "target_status");
   unsigned char SG_segment_count ;
    klee_make_symbolic(&SG_segment_count, sizeof(char), "SG_segment_count");
   unsigned int SG_list_pointer ;
    klee_make_symbolic(&SG_list_pointer, sizeof(int), "SG_list_pointer");
   unsigned char residual_SG_segment_count ;
    klee_make_symbolic(&residual_SG_segment_count, sizeof(char), "residual_SG_segment_count");
   unsigned char residual_data_count[3U] ;
   unsigned int data_pointer ;
    klee_make_symbolic(&data_pointer, sizeof(int), "data_pointer");
   unsigned int data_count ;
    klee_make_symbolic(&data_count, sizeof(int), "data_count");
   unsigned int SCSI_cmd_pointer ;
    klee_make_symbolic(&SCSI_cmd_pointer, sizeof(int), "SCSI_cmd_pointer");
   unsigned char SCSI_cmd_length ;
    klee_make_symbolic(&SCSI_cmd_length, sizeof(char), "SCSI_cmd_length");
   unsigned char tag ;
   unsigned char next ;
    klee_make_symbolic(&next, sizeof(char), "next");
   unsigned char prev ;
    klee_make_symbolic(&prev, sizeof(char), "prev");
   unsigned int pad ;
    klee_make_symbolic(&pad, sizeof(int), "pad");
};
enum ldv_24922 {
    SCB_FREE = 0,
    SCB_DTR_SCB = 1,
...
struct aic7xxx_scb_dma {
   unsigned long dma_offset ;
    klee_make_symbolic(&dma_offset, sizeof(long), "dma_offset");
   dma_addr_t dma_address ;
...
struct aic7xxx_scb {
   ...
   unsigned char tag_action ;
    klee_make_symbolic(&tag_action, sizeof(char), "tag_action");
   unsigned char sg_count ;
    klee_make_symbolic(&sg_count, sizeof(char), "sg_count");
   unsigned char *sense_cmd ;
   unsigned char *cmnd ;
   unsigned int sg_length ;
    klee_make_symbolic(&sg_length, sizeof(int), "sg_length");
   void *kmalloc_ptr ;
...
struct __anonstruct_hard_error_191 {
   unsigned char errno ;
    klee_make_symbolic(&errno, sizeof(char), "errno");
   char const   *errmesg ;
};
struct __anonstruct_scb_data_type_192 {
   ...
   unsigned char numscbs ;
    klee_make_symbolic(&numscbs, sizeof(char), "numscbs");
   unsigned char maxhscbs ;
    klee_make_symbolic(&maxhscbs, sizeof(char), "maxhscbs");
   unsigned char maxscbs ;
    klee_make_symbolic(&maxscbs, sizeof(char), "maxscbs");
   dma_addr_t hscbs_dma ;
   unsigned int hscbs_dma_len ;
    klee_make_symbolic(&hscbs_dma_len, sizeof(int), "hscbs_dma_len");
...
struct aic_dev_data {
   ...
   unsigned short max_q_depth ;
    klee_make_symbolic(&max_q_depth, sizeof(short), "max_q_depth");
   unsigned char volatile   active_cmds ;
   long w_total ;
    klee_make_symbolic(&w_total, sizeof(long), "w_total");
   long r_total ;
    klee_make_symbolic(&r_total, sizeof(long), "r_total");
   long barrier_total ;
    klee_make_symbolic(&barrier_total, sizeof(long), "barrier_total");
   long ordered_total ;
    klee_make_symbolic(&ordered_total, sizeof(long), "ordered_total");
   long w_bins[6U] ;
   long r_bins[6U] ;
   transinfo_type cur ;
   transinfo_type goal ;
...
struct aic7xxx_host {
   ...
   unsigned long isr_count ;
    klee_make_symbolic(&isr_count, sizeof(long), "isr_count");
   unsigned long spurious_int ;
    klee_make_symbolic(&spurious_int, sizeof(long), "spurious_int");
   scb_data_type *scb_data ;
   struct aic7xxx_cmd_queue completeq ;
   scb_queue_type volatile   waiting_scbs ;
   unsigned char unpause ;
    klee_make_symbolic(&unpause, sizeof(char), "unpause");
   unsigned char pause ;
    klee_make_symbolic(&pause, sizeof(char), "pause");
   ...
   unsigned short ultraenb ;
    klee_make_symbolic(&ultraenb, sizeof(short), "ultraenb");
   unsigned short discenable ;
    klee_make_symbolic(&discenable, sizeof(short), "discenable");
   ...
   unsigned char msg_index ;
    klee_make_symbolic(&msg_index, sizeof(char), "msg_index");
   unsigned int irq ;
   int instance ;
   ...
   int scsi_id_b ;
    klee_make_symbolic(&scsi_id_b, sizeof(int), "scsi_id_b");
   unsigned int bios_address ;
    klee_make_symbolic(&bios_address, sizeof(int), "bios_address");
   int board_name_index ;
    klee_make_symbolic(&board_name_index, sizeof(int), "board_name_index");
   unsigned short bios_control ;
   unsigned short adapter_control ;
   struct pci_dev *pdev ;
   ...
   unsigned char pci_device_fn ;
    klee_make_symbolic(&pci_device_fn, sizeof(char), "pci_device_fn");
   struct seeprom_config sc ;
   unsigned short sc_type ;
    klee_make_symbolic(&sc_type, sizeof(short), "sc_type");
   unsigned short sc_size ;
    klee_make_symbolic(&sc_size, sizeof(short), "sc_size");
   struct aic7xxx_host *next ;
   struct Scsi_Host *host ;
   struct list_head aic_devs ;
   int host_no ;
   unsigned long mbase ;
    klee_make_symbolic(&mbase, sizeof(long), "mbase");
   ahc_chip chip ;
   ahc_bugs bugs ;
   dma_addr_t fifo_dma ;
};
struct aic7xxx_syncrate {
   int sxfr_ultra2 ;
    klee_make_symbolic(&sxfr_ultra2, sizeof(int), "sxfr_ultra2");
   int sxfr ;
    klee_make_symbolic(&sxfr, sizeof(int), "sxfr");
   unsigned char period ;
   char const   *rate[2U] ;
};
...
struct __anonstruct_aic_pdevs_203 {
   ...
   unsigned short device_id ;
    klee_make_symbolic(&device_id, sizeof(short), "device_id");
   ahc_chip chip ;
   ahc_flag_type flags ;
   ahc_feature features ;
   int board_name_index ;
   unsigned short seeprom_size ;
    klee_make_symbolic(&seeprom_size, sizeof(short), "seeprom_size");
   unsigned short seeprom_type ;
    klee_make_symbolic(&seeprom_type, sizeof(short), "seeprom_type");
};
struct register_ranges {
   int num_ranges ;
    klee_make_symbolic(&num_ranges, sizeof(int), "num_ranges");
   int range_val[32U] ;
};
...
{ 
  ...
  int num_patches ;
    klee_make_symbolic(&num_patches, sizeof(int), "num_patches");
  int tmp ;
...
{ 
  ...
  struct sequencer_patch *cur_patch ;
  int address_offset ;
    klee_make_symbolic(&address_offset, sizeof(int), "address_offset");
  unsigned int address ;
  int skip_addr ;
    klee_make_symbolic(&skip_addr, sizeof(int), "skip_addr");
  int i ;
  int end_addr ;
...
{ 
  unsigned int maxoffset ;
    klee_make_symbolic(&maxoffset, sizeof(int), "maxoffset");
  unsigned int _min1 ;
...
{ 
  unsigned char tindex ;
    klee_make_symbolic(&tindex, sizeof(char), "tindex");
  unsigned short target_mask ;
    klee_make_symbolic(&target_mask, sizeof(short), "target_mask");
  unsigned char lun ;
  unsigned char old_options ;
    klee_make_symbolic(&old_options, sizeof(char), "old_options");
  unsigned int old_period ;
    klee_make_symbolic(&old_period, sizeof(int), "old_period");
  unsigned int old_offset ;
    klee_make_symbolic(&old_offset, sizeof(int), "old_offset");
  unsigned char tmp ;
  unsigned int scsirate ;
    klee_make_symbolic(&scsirate, sizeof(int), "scsirate");
  unsigned char tmp___0 ;
  unsigned char sxfrctl0 ;
    klee_make_symbolic(&sxfrctl0, sizeof(char), "sxfrctl0");
  int rate_mod ;
    klee_make_symbolic(&rate_mod, sizeof(int), "rate_mod");
...
{ 
  ...
  unsigned int old_width ;
    klee_make_symbolic(&old_width, sizeof(int), "old_width");
...
{ 
  int targ ;
    klee_make_symbolic(&targ, sizeof(int), "targ");
  int chan ;
    klee_make_symbolic(&chan, sizeof(int), "chan");
  int slun ;
    klee_make_symbolic(&slun, sizeof(int), "slun");
  int match ;
...
{ 
  unsigned char busy_scbid ;
    klee_make_symbolic(&busy_scbid, sizeof(char), "busy_scbid");
...
{ 
  unsigned char saved_scbptr ;
    klee_make_symbolic(&saved_scbptr, sizeof(char), "saved_scbptr");
  unsigned char curindex ;
    klee_make_symbolic(&curindex, sizeof(char), "curindex");
  unsigned char tmp ;
...
{ 
  struct aic7xxx_scb *scbp ;
  int scb_size ;
    klee_make_symbolic(&scb_size, sizeof(int), "scb_size");
  int i ;
  int step ;
    klee_make_symbolic(&step, sizeof(int), "step");
  unsigned long scb_count ;
    klee_make_symbolic(&scb_count, sizeof(long), "scb_count");
...
{ 
  ...
  unsigned short mask ;
  int message_error ;
    klee_make_symbolic(&message_error, sizeof(int), "message_error");
  unsigned char tmp ;
  unsigned char tmp___0 ;
  unsigned char tmp___1 ;
  unsigned char tmp___2 ;
...
{ 
  unsigned char curscb ;
    klee_make_symbolic(&curscb, sizeof(char), "curscb");
  unsigned char next ;
...
{ 
  ...
  unsigned char qinpos ;
    klee_make_symbolic(&qinpos, sizeof(char), "qinpos");
  unsigned char qintail ;
    klee_make_symbolic(&qintail, sizeof(char), "qintail");
  struct aic7xxx_scb *scbp ;
  unsigned char tmp ;
...
{ 
  ...
  unsigned char active_scb ;
    klee_make_symbolic(&active_scb, sizeof(char), "active_scb");
  unsigned char tcl ;
    klee_make_symbolic(&tcl, sizeof(char), "tcl");
  unsigned char scb_tag ;
    klee_make_symbolic(&scb_tag, sizeof(char), "scb_tag");
  int i ;
  int init_lists ;
    klee_make_symbolic(&init_lists, sizeof(int), "init_lists");
  struct aic_dev_data *aic_dev ;
  unsigned char tmp ;
  unsigned char tmp___0 ;
  unsigned char tmp___1 ;
  ...
  unsigned char scb_index ;
    klee_make_symbolic(&scb_index, sizeof(char), "scb_index");
  ...
  unsigned char next___0 ;
    klee_make_symbolic(&next___0, sizeof(char), "next___0");
  unsigned char prev___0 ;
    klee_make_symbolic(&prev___0, sizeof(char), "prev___0");
  unsigned char scb_index___0 ;
    klee_make_symbolic(&scb_index___0, sizeof(char), "scb_index___0");
  int tmp___14 ;
    klee_make_symbolic(&tmp___14, sizeof(int), "tmp___14");
  unsigned char next___1 ;
    klee_make_symbolic(&next___1, sizeof(char), "next___1");
  unsigned char tmp___15 ;
    klee_make_symbolic(&tmp___15, sizeof(char), "tmp___15");
  unsigned char scbid ;
    klee_make_symbolic(&scbid, sizeof(char), "scbid");
  int tmp___16 ;
...
{ 
  unsigned long offset_min ;
    klee_make_symbolic(&offset_min, sizeof(long), "offset_min");
  unsigned long offset_max ;
    klee_make_symbolic(&offset_max, sizeof(long), "offset_max");
  unsigned char sblkctl ;
    klee_make_symbolic(&sblkctl, sizeof(char), "sblkctl");
  int cur_channel ;
    klee_make_symbolic(&cur_channel, sizeof(int), "cur_channel");
  unsigned char tmp ;
  unsigned char tmp___0 ;
  unsigned char tmp___1 ;
  unsigned char tmp___2 ;
...
{ 
  unsigned char status1 ;
    klee_make_symbolic(&status1, sizeof(char), "status1");
...
{ 
  ...
  unsigned char queue_flag ;
    klee_make_symbolic(&queue_flag, sizeof(char), "queue_flag");
  char channel ;
  int result ;
  unsigned char tmp ;
  unsigned char tmp___0 ;
  ...
  unsigned char last_msg ;
    klee_make_symbolic(&last_msg, sizeof(char), "last_msg");
  unsigned char tmp___13 ;
  unsigned char i ;
  struct aic7xxx_scb *scbp ;
  int old_verbose ;
    klee_make_symbolic(&old_verbose, sizeof(int), "old_verbose");
  ...
  unsigned char tmp___25 ;
    klee_make_symbolic(&tmp___25, sizeof(char), "tmp___25");
  struct aic7xxx_scb *next_scbp ;
  struct aic7xxx_scb *prev_scbp ;
  unsigned char active_hscb ;
    klee_make_symbolic(&active_hscb, sizeof(char), "active_hscb");
  unsigned char next_hscb ;
    klee_make_symbolic(&next_hscb, sizeof(char), "next_hscb");
  unsigned char prev_hscb ;
    klee_make_symbolic(&prev_hscb, sizeof(char), "prev_hscb");
  unsigned char scb_index___1 ;
    klee_make_symbolic(&scb_index___1, sizeof(char), "scb_index___1");
  int tmp___26 ;
  ...
  unsigned char scb_index___2 ;
    klee_make_symbolic(&scb_index___2, sizeof(char), "scb_index___2");
  unsigned char msg_out ;
    klee_make_symbolic(&msg_out, sizeof(char), "msg_out");
  ...
  unsigned char tmp___34 ;
    klee_make_symbolic(&tmp___34, sizeof(char), "tmp___34");
  unsigned int max_sync ;
    klee_make_symbolic(&max_sync, sizeof(int), "max_sync");
  unsigned int period ;
  unsigned char options ;
  unsigned char tmp___35 ;
    klee_make_symbolic(&tmp___35, sizeof(char), "tmp___35");
  unsigned char tmp___36 ;
    klee_make_symbolic(&tmp___36, sizeof(char), "tmp___36");
  unsigned char tmp___37 ;
    klee_make_symbolic(&tmp___37, sizeof(char), "tmp___37");
  unsigned char scb_index___3 ;
    klee_make_symbolic(&scb_index___3, sizeof(char), "scb_index___3");
  unsigned char tmp___38 ;
    klee_make_symbolic(&tmp___38, sizeof(char), "tmp___38");
  unsigned char lastphase ;
    klee_make_symbolic(&lastphase, sizeof(char), "lastphase");
  unsigned char tmp___39 ;
    klee_make_symbolic(&tmp___39, sizeof(char), "tmp___39");
  unsigned int i___0 ;
  unsigned char tmp___40 ;
    klee_make_symbolic(&tmp___40, sizeof(char), "tmp___40");
  unsigned char resid_sgcnt ;
    klee_make_symbolic(&resid_sgcnt, sizeof(char), "resid_sgcnt");
  unsigned char index ;
  unsigned char scb_index___4 ;
    klee_make_symbolic(&scb_index___4, sizeof(char), "scb_index___4");
  unsigned char tmp___41 ;
    klee_make_symbolic(&tmp___41, sizeof(char), "tmp___41");
  unsigned int cur_addr ;
    klee_make_symbolic(&cur_addr, sizeof(int), "cur_addr");
  unsigned int resid_dcnt ;
    klee_make_symbolic(&resid_dcnt, sizeof(int), "resid_dcnt");
  unsigned int native_addr ;
    klee_make_symbolic(&native_addr, sizeof(int), "native_addr");
  unsigned int native_length ;
    klee_make_symbolic(&native_length, sizeof(int), "native_length");
  unsigned int sg_addr ;
    klee_make_symbolic(&sg_addr, sizeof(int), "sg_addr");
  int i___1 ;
    klee_make_symbolic(&i___1, sizeof(int), "i___1");
  unsigned char tmp___42 ;
    klee_make_symbolic(&tmp___42, sizeof(char), "tmp___42");
  unsigned char tmp___43 ;
    klee_make_symbolic(&tmp___43, sizeof(char), "tmp___43");
  unsigned char tmp___44 ;
    klee_make_symbolic(&tmp___44, sizeof(char), "tmp___44");
  unsigned char tmp___45 ;
    klee_make_symbolic(&tmp___45, sizeof(char), "tmp___45");
  unsigned char tmp___46 ;
    klee_make_symbolic(&tmp___46, sizeof(char), "tmp___46");
  unsigned char tmp___47 ;
    klee_make_symbolic(&tmp___47, sizeof(char), "tmp___47");
  unsigned char tmp___48 ;
    klee_make_symbolic(&tmp___48, sizeof(char), "tmp___48");
  unsigned char tmp___49 ;
    klee_make_symbolic(&tmp___49, sizeof(char), "tmp___49");
  unsigned char tmp___50 ;
    klee_make_symbolic(&tmp___50, sizeof(char), "tmp___50");
  unsigned char tmp___51 ;
    klee_make_symbolic(&tmp___51, sizeof(char), "tmp___51");
  unsigned char tmp___52 ;
    klee_make_symbolic(&tmp___52, sizeof(char), "tmp___52");
  unsigned char tmp___53 ;
    klee_make_symbolic(&tmp___53, sizeof(char), "tmp___53");
  unsigned char tmp___54 ;
    klee_make_symbolic(&tmp___54, sizeof(char), "tmp___54");
  unsigned char tmp___55 ;
    klee_make_symbolic(&tmp___55, sizeof(char), "tmp___55");
  int tmp___56 ;
    klee_make_symbolic(&tmp___56, sizeof(int), "tmp___56");
  unsigned char scb_index___5 ;
    klee_make_symbolic(&scb_index___5, sizeof(char), "scb_index___5");
  unsigned char tmp___57 ;
    klee_make_symbolic(&tmp___57, sizeof(char), "tmp___57");
  int sg_addr___0 ;
    klee_make_symbolic(&sg_addr___0, sizeof(int), "sg_addr___0");
  int sg_length ;
  unsigned char tmp___58 ;
    klee_make_symbolic(&tmp___58, sizeof(char), "tmp___58");
  unsigned char tmp___59 ;
    klee_make_symbolic(&tmp___59, sizeof(char), "tmp___59");
  unsigned char tmp___60 ;
    klee_make_symbolic(&tmp___60, sizeof(char), "tmp___60");
  unsigned char tmp___61 ;
    klee_make_symbolic(&tmp___61, sizeof(char), "tmp___61");
  unsigned char tmp___62 ;
    klee_make_symbolic(&tmp___62, sizeof(char), "tmp___62");
  unsigned char tmp___63 ;
    klee_make_symbolic(&tmp___63, sizeof(char), "tmp___63");
  unsigned char tmp___64 ;
    klee_make_symbolic(&tmp___64, sizeof(char), "tmp___64");
  unsigned char tmp___65 ;
    klee_make_symbolic(&tmp___65, sizeof(char), "tmp___65");
  unsigned char tmp___66 ;
    klee_make_symbolic(&tmp___66, sizeof(char), "tmp___66");
  unsigned char tmp___67 ;
    klee_make_symbolic(&tmp___67, sizeof(char), "tmp___67");
  unsigned char tmp___68 ;
    klee_make_symbolic(&tmp___68, sizeof(char), "tmp___68");
  unsigned char tmp___69 ;
    klee_make_symbolic(&tmp___69, sizeof(char), "tmp___69");
  unsigned char tmp___70 ;
    klee_make_symbolic(&tmp___70, sizeof(char), "tmp___70");
  unsigned char tmp___71 ;
    klee_make_symbolic(&tmp___71, sizeof(char), "tmp___71");
  unsigned char tmp___72 ;
    klee_make_symbolic(&tmp___72, sizeof(char), "tmp___72");
  unsigned char tmp___73 ;
    klee_make_symbolic(&tmp___73, sizeof(char), "tmp___73");
  unsigned char tmp___74 ;
    klee_make_symbolic(&tmp___74, sizeof(char), "tmp___74");
  unsigned char tmp___75 ;
    klee_make_symbolic(&tmp___75, sizeof(char), "tmp___75");
  unsigned char tmp___76 ;
    klee_make_symbolic(&tmp___76, sizeof(char), "tmp___76");
  unsigned char tmp___77 ;
    klee_make_symbolic(&tmp___77, sizeof(char), "tmp___77");
  unsigned char tmp___78 ;
    klee_make_symbolic(&tmp___78, sizeof(char), "tmp___78");
  unsigned char tmp___79 ;
    klee_make_symbolic(&tmp___79, sizeof(char), "tmp___79");
  unsigned char tmp___80 ;
    klee_make_symbolic(&tmp___80, sizeof(char), "tmp___80");
  unsigned char tmp___81 ;
    klee_make_symbolic(&tmp___81, sizeof(char), "tmp___81");
  unsigned char tmp___82 ;
    klee_make_symbolic(&tmp___82, sizeof(char), "tmp___82");
  unsigned char tmp___83 ;
    klee_make_symbolic(&tmp___83, sizeof(char), "tmp___83");
...
{ 
  int reject ;
    klee_make_symbolic(&reject, sizeof(int), "reject");
  int reply ;
    klee_make_symbolic(&reply, sizeof(int), "reply");
  int done ;
  unsigned char target_scsirate ;
    klee_make_symbolic(&target_scsirate, sizeof(char), "target_scsirate");
  unsigned char tindex ;
  unsigned short target_mask ;
  unsigned char target ;
  ...
  unsigned char new_bus_width ;
    klee_make_symbolic(&new_bus_width, sizeof(char), "new_bus_width");
  unsigned char trans_options ;
    klee_make_symbolic(&trans_options, sizeof(char), "trans_options");
  unsigned char new_trans_options ;
    klee_make_symbolic(&new_trans_options, sizeof(char), "new_trans_options");
  unsigned int period ;
  unsigned int new_period ;
    klee_make_symbolic(&new_period, sizeof(int), "new_period");
  unsigned int offset ;
  unsigned int new_offset ;
    klee_make_symbolic(&new_offset, sizeof(int), "new_offset");
  unsigned int maxsync ;
    klee_make_symbolic(&maxsync, sizeof(int), "maxsync");
  struct aic7xxx_syncrate *syncrate ;
  struct aic_dev_data *aic_dev ;
  unsigned char tmp ;
  unsigned char tmp___0 ;
...
{ 
  unsigned char lastbyte ;
    klee_make_symbolic(&lastbyte, sizeof(char), "lastbyte");
  unsigned char phasemis ;
    klee_make_symbolic(&phasemis, sizeof(char), "phasemis");
  int done ;
  unsigned char tmp ;
  unsigned char tmp___0 ;
  unsigned char tmp___1 ;
...
{ 
  ...
  unsigned char saved_tcl ;
    klee_make_symbolic(&saved_tcl, sizeof(char), "saved_tcl");
  unsigned char tmp___1 ;
  unsigned char target ;
  int channel___0 ;
    klee_make_symbolic(&channel___0, sizeof(int), "channel___0");
  int printerror ;
    klee_make_symbolic(&printerror, sizeof(int), "printerror");
  unsigned char tmp___2 ;
  unsigned char tmp___3 ;
  ...
  unsigned char scbptr ;
    klee_make_symbolic(&scbptr, sizeof(char), "scbptr");
  unsigned char nextscb ;
    klee_make_symbolic(&nextscb, sizeof(char), "nextscb");
  struct scsi_cmnd *cmd ;
  unsigned char tmp___7 ;
  unsigned char tmp___8 ;
  unsigned char tmp___9 ;
  ...
  unsigned char mesg_out ;
    klee_make_symbolic(&mesg_out, sizeof(char), "mesg_out");
  unsigned char lastphase___0 ;
    klee_make_symbolic(&lastphase___0, sizeof(char), "lastphase___0");
  unsigned char tmp___19 ;
  unsigned char sstat2 ;
    klee_make_symbolic(&sstat2, sizeof(char), "sstat2");
  unsigned char tmp___20 ;
  unsigned char tmp___21 ;
  unsigned char tmp___22 ;
  unsigned char tmp___23 ;
...
{ 
  ...
  unsigned char intstat ;
    klee_make_symbolic(&intstat, sizeof(char), "intstat");
  unsigned char tmp ;
  int i ;
  unsigned char errno ;
  unsigned char tmp___0 ;
...
{ 
  unsigned long cpu_flags ;
    klee_make_symbolic(&cpu_flags, sizeof(long), "cpu_flags");
  struct aic7xxx_host *p ;
  raw_spinlock_t *tmp ;
  unsigned char tmp___0 ;
...
{ 
  int tag_enabled ;
    klee_make_symbolic(&tag_enabled, sizeof(int), "tag_enabled");
  struct aic_dev_data *aic_dev ;
  unsigned char tindex ;
  int print_warning ;
    klee_make_symbolic(&print_warning, sizeof(int), "print_warning");
...
{ 
  ...
  struct aic_dev_data *aic_dev ;
  int scbnum ;
    klee_make_symbolic(&scbnum, sizeof(int), "scbnum");
  int tmp ;
  struct list_head  const  *__mptr ;
  struct list_head  const  *__mptr___0 ;
  int tmp___0 ;
...
{ 
  ...
  unsigned char tmp___0 ;
  int limit___0 ;
    klee_make_symbolic(&limit___0, sizeof(int), "limit___0");
  unsigned char tmp___1 ;
  int limit___1 ;
    klee_make_symbolic(&limit___1, sizeof(int), "limit___1");
  unsigned char tmp___2 ;
  int limit___2 ;
    klee_make_symbolic(&limit___2, sizeof(int), "limit___2");
  unsigned char tmp___3 ;
  int limit___3 ;
    klee_make_symbolic(&limit___3, sizeof(int), "limit___3");
  unsigned char tmp___4 ;
  int limit___4 ;
    klee_make_symbolic(&limit___4, sizeof(int), "limit___4");
  unsigned char tmp___5 ;
  unsigned char tmp___6 ;
  int limit___5 ;
    klee_make_symbolic(&limit___5, sizeof(int), "limit___5");
  unsigned char tmp___7 ;
  int limit___6 ;
    klee_make_symbolic(&limit___6, sizeof(int), "limit___6");
  unsigned char tmp___8 ;
  int limit___7 ;
    klee_make_symbolic(&limit___7, sizeof(int), "limit___7");
  unsigned char tmp___9 ;
  int limit___8 ;
    klee_make_symbolic(&limit___8, sizeof(int), "limit___8");
  unsigned char tmp___10 ;
...
{ 
  unsigned char brdctl ;
    klee_make_symbolic(&brdctl, sizeof(char), "brdctl");
  unsigned char value ;
  int limit ;
  unsigned char tmp ;
  int limit___0 ;
...
{ 
  int internal50_present ;
    klee_make_symbolic(&internal50_present, sizeof(int), "internal50_present");
  int internal68_present ;
    klee_make_symbolic(&internal68_present, sizeof(int), "internal68_present");
  int external_present ;
    klee_make_symbolic(&external_present, sizeof(int), "external_present");
  int eprom_present ;
    klee_make_symbolic(&eprom_present, sizeof(int), "eprom_present");
  int enableSE_low ;
    klee_make_symbolic(&enableSE_low, sizeof(int), "enableSE_low");
  int enableSE_high ;
    klee_make_symbolic(&enableSE_high, sizeof(int), "enableSE_high");
  int enableLVD_low ;
    klee_make_symbolic(&enableLVD_low, sizeof(int), "enableLVD_low");
  int enableLVD_high ;
    klee_make_symbolic(&enableLVD_high, sizeof(int), "enableLVD_high");
  unsigned char brddat ;
    klee_make_symbolic(&brddat, sizeof(char), "brddat");
  unsigned char max_target ;
    klee_make_symbolic(&max_target, sizeof(char), "max_target");
  unsigned char sxfrctl1 ;
    klee_make_symbolic(&sxfrctl1, sizeof(char), "sxfrctl1");
  unsigned char tmp ;
  int tmp___0 ;
...
{ 
  ...
  int found ;
  unsigned char term ;
    klee_make_symbolic(&term, sizeof(char), "term");
  unsigned char scsi_conf ;
    klee_make_symbolic(&scsi_conf, sizeof(char), "scsi_conf");
  struct Scsi_Host *host ;
  char *channel ;
  unsigned char devconfig ;
    klee_make_symbolic(&devconfig, sizeof(char), "devconfig");
  unsigned char term_override ;
    klee_make_symbolic(&term_override, sizeof(char), "term_override");
  unsigned char tmp ;
  unsigned char tmp___0 ;
  unsigned char tmp___1 ;
  unsigned char tmp___2 ;
  ...
  unsigned int hscb_physaddr ;
    klee_make_symbolic(&hscb_physaddr, sizeof(int), "hscb_physaddr");
  void *tmp___4 ;
  void *tmp___5 ;
  unsigned char tmp___6 ;
  unsigned char tmp___7 ;
...
{ 
  int have_seeprom ;
    klee_make_symbolic(&have_seeprom, sizeof(int), "have_seeprom");
  int i ;
  int max_targets ;
  int mask ;
  unsigned char scsirate ;
...
{ 
  unsigned short tmp_word ;
    klee_make_symbolic(&tmp_word, sizeof(short), "tmp_word");
  unsigned char tmp ;
  unsigned char tmp___0 ;
...
{ 
  ...
  unsigned short command ;
    klee_make_symbolic(&command, sizeof(short), "command");
  unsigned int devconfig ;
  unsigned int i ;
  unsigned int oldverbose ;
    klee_make_symbolic(&oldverbose, sizeof(int), "oldverbose");
  struct pci_dev *pdev ;
  int tmp ;
  int tmp___0 ;
  void *tmp___1 ;
...
{ 
  ...
  unsigned char hscb_index ;
    klee_make_symbolic(&hscb_index, sizeof(char), "hscb_index");
  int disconnected ;
    klee_make_symbolic(&disconnected, sizeof(int), "disconnected");
  struct aic_dev_data *aic_dev ;
  unsigned char tmp ;
  unsigned char tmp___0 ;
  unsigned char tmp___1 ;
  ...
  unsigned char scb_control ;
    klee_make_symbolic(&scb_control, sizeof(char), "scb_control");
...
{ 
  ...
  unsigned char saved_hscbptr ;
    klee_make_symbolic(&saved_hscbptr, sizeof(char), "saved_hscbptr");
  unsigned char hscbptr ;
    klee_make_symbolic(&hscbptr, sizeof(char), "hscbptr");
  unsigned char scb_control ;
  struct aic_dev_data *aic_dev ;
  unsigned char tmp ;
  unsigned char tmp___0 ;
...
{ 
  ...
  int var_do_aic7xxx_isr_54_p0 ;
    klee_make_symbolic(&var_do_aic7xxx_isr_54_p0, sizeof(int), "var_do_aic7xxx_isr_54_p0");
  void *var_do_aic7xxx_isr_54_p1 ;
  int ldv_s_driver_template_scsi_host_template ;
    klee_make_symbolic(&ldv_s_driver_template_scsi_host_template, sizeof(int), "ldv_s_driver_template_scsi_host_template");
  int tmp ;
  int tmp___0 ;
