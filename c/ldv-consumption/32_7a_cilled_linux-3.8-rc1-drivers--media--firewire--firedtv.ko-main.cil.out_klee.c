...
struct firedtv_tuner_status {
   unsigned char active_system ;
    klee_make_symbolic(&active_system, sizeof(char), "active_system");
   ...
   unsigned char signal_strength ;
    klee_make_symbolic(&signal_strength, sizeof(char), "signal_strength");
   unsigned char raster_frequency : 2 ;
   unsigned int rf_frequency : 22 ;
   unsigned char man_dep_info_length ;
    klee_make_symbolic(&man_dep_info_length, sizeof(char), "man_dep_info_length");
   ...
   unsigned short carrier_noise_ratio ;
    klee_make_symbolic(&carrier_noise_ratio, sizeof(short), "carrier_noise_ratio");
   unsigned char power_supply_voltage ;
    klee_make_symbolic(&power_supply_voltage, sizeof(char), "power_supply_voltage");
   unsigned char antenna_voltage ;
    klee_make_symbolic(&antenna_voltage, sizeof(char), "antenna_voltage");
   unsigned char firewire_bus_voltage ;
    klee_make_symbolic(&firewire_bus_voltage, sizeof(char), "firewire_bus_voltage");
...
struct firedtv {
   ...
   int ca_last_command ;
    klee_make_symbolic(&ca_last_command, sizeof(int), "ca_last_command");
   int ca_time_interval ;
    klee_make_symbolic(&ca_time_interval, sizeof(int), "ca_time_interval");
   ...
   char subunit ;
    klee_make_symbolic(&subunit, sizeof(char), "subunit");
   char isochannel ;
    klee_make_symbolic(&isochannel, sizeof(char), "isochannel");
   struct fdtv_ir_context *ir_context ;
   fe_sec_voltage_t voltage ;
   fe_sec_tone_mode_t tone ;
   struct mutex demux_mutex ;
   unsigned long channel_active ;
    klee_make_symbolic(&channel_active, sizeof(long), "channel_active");
   u16 channel_pid[16U] ;
   int avc_data_length ;
    klee_make_symbolic(&avc_data_length, sizeof(int), "avc_data_length");
   u8 avc_data[512U] ;
};
...
struct fdtv_ir_context {
   ...
   int interrupt_packet ;
    klee_make_symbolic(&interrupt_packet, sizeof(int), "interrupt_packet");
   int current_packet ;
    klee_make_symbolic(&current_packet, sizeof(int), "current_packet");
   char *pages[16U] ;
};
struct input_id {
   __u16 bustype ;
...
static int avc_debug  ;
    klee_make_symbolic(&avc_debug, sizeof(int), "avc_debug");
static unsigned int num_fake_ca_system_ids  ;
    klee_make_symbolic(&num_fake_ca_system_ids, sizeof(int), "num_fake_ca_system_ids");
...
{ unsigned int subunit_type ;
    klee_make_symbolic(&subunit_type, sizeof(int), "subunit_type");
  unsigned int subunit_id ;
    klee_make_symbolic(&subunit_id, sizeof(int), "subunit_id");
  unsigned int opcode ;
...
{ struct avc_command_frame *c ;
  struct avc_response_frame *r ;
  int list_management ;
    klee_make_symbolic(&list_management, sizeof(int), "list_management");
  int program_info_length ;
    klee_make_symbolic(&program_info_length, sizeof(int), "program_info_length");
  int pmt_cmd_id ;
    klee_make_symbolic(&pmt_cmd_id, sizeof(int), "pmt_cmd_id");
  int read_pos ;
    klee_make_symbolic(&read_pos, sizeof(int), "read_pos");
  int write_pos ;
    klee_make_symbolic(&write_pos, sizeof(int), "write_pos");
  int es_info_length ;
    klee_make_symbolic(&es_info_length, sizeof(int), "es_info_length");
  int crc32_csum ;
    klee_make_symbolic(&crc32_csum, sizeof(int), "crc32_csum");
  int ret ;
  long tmp ;
  int tmp___0 ;
  size_t __len ;
...
{ struct ca_msg *msg ;
  int data_pos ;
    klee_make_symbolic(&data_pos, sizeof(int), "data_pos");
  int data_length ;
...
{ struct firedtv *fdtv ;
  int pidc ;
    klee_make_symbolic(&pidc, sizeof(int), "pidc");
  int c ;
  int ret ;
  u16 pids[16U] ;
  int tmp ;
...
{ struct firedtv *f ;
  ...
  unsigned long flags ;
  int su ;
    klee_make_symbolic(&su, sizeof(int), "su");
  raw_spinlock_t *tmp ;
...
static int ldv_mutex_avc_mutex_of_firedtv  ;
    klee_make_symbolic(&ldv_mutex_avc_mutex_of_firedtv, sizeof(int), "ldv_mutex_avc_mutex_of_firedtv");
...
static int ldv_mutex_demux_mutex_of_firedtv  ;
    klee_make_symbolic(&ldv_mutex_demux_mutex_of_firedtv, sizeof(int), "ldv_mutex_demux_mutex_of_firedtv");
int ldv_mutex_lock_interruptible_demux_mutex_of_firedtv(struct mutex *lock ) 
{ int nondetermined ;
