...
struct cx18_av_state {
   ...
   u32 rev ;
   int is_initialized ;
    klee_make_symbolic(&is_initialized, sizeof(int), "is_initialized");
   int slicer_line_delay ;
    klee_make_symbolic(&slicer_line_delay, sizeof(int), "slicer_line_delay");
   int slicer_line_offset ;
    klee_make_symbolic(&slicer_line_offset, sizeof(int), "slicer_line_offset");
};
enum cx2341x_port {
...
struct cx18_mdl {
   ...
   unsigned long m_flags ;
    klee_make_symbolic(&m_flags, sizeof(long), "m_flags");
...
struct cx18_stream {
   ...
   unsigned int mdl_base_idx ;
    klee_make_symbolic(&mdl_base_idx, sizeof(int), "mdl_base_idx");
   u32 id ;
   unsigned long s_flags ;
   int dma ;
...
struct vbi_info {
   ...
   u32 frame ;
   int insert_mpeg ;
    klee_make_symbolic(&insert_mpeg, sizeof(int), "insert_mpeg");
...
struct cx18_i2c_algo_callback_data {
   struct cx18 *cx ;
   int bus_index ;
    klee_make_symbolic(&bus_index, sizeof(int), "bus_index");
};
...
struct cx18 {
   ...
   unsigned int free_mdl_idx ;
    klee_make_symbolic(&free_mdl_idx, sizeof(int), "free_mdl_idx");
   struct cx18_scb *scb ;
   ...
   unsigned long dualwatch_jiffies ;
    klee_make_symbolic(&dualwatch_jiffies, sizeof(long), "dualwatch_jiffies");
   ...
   int search_pack_header ;
    klee_make_symbolic(&search_pack_header, sizeof(int), "search_pack_header");
   int open_id ;
    klee_make_symbolic(&open_id, sizeof(int), "open_id");
...
struct cx18_gpio_i2c_slave_reset {
   ...
   u32 active_hi_mask ;
   int msecs_asserted ;
    klee_make_symbolic(&msecs_asserted, sizeof(int), "msecs_asserted");
   int msecs_recovery ;
    klee_make_symbolic(&msecs_recovery, sizeof(int), "msecs_recovery");
   u32 ir_reset_mask ;
};
...
struct __anonstruct_cx18_stream_info_284 {
   ...
   int vfl_type ;
   int num_offset ;
    klee_make_symbolic(&num_offset, sizeof(int), "num_offset");
   int dma ;
};
struct __wait_queue;
...
int cx18_debug  ;
    klee_make_symbolic(&cx18_debug, sizeof(int), "cx18_debug");
...
int cx18_first_minor  ;
    klee_make_symbolic(&cx18_first_minor, sizeof(int), "cx18_first_minor");
...
{ long timeout ;
  unsigned long tmp ;
  int sig ;
    klee_make_symbolic(&sig, sizeof(int), "sig");
  long volatile   __ret ;
  long tmp___0 ;
...
{ u16 cmd ;
  unsigned char pci_latency ;
    klee_make_symbolic(&pci_latency, sizeof(char), "pci_latency");
  int tmp ;
  int tmp___0 ;
...
int cx18_init_on_first_open(struct cx18 *cx ) 
{ int video_input ;
    klee_make_symbolic(&video_input, sizeof(int), "video_input");
  int fw_retry_count ;
    klee_make_symbolic(&fw_retry_count, sizeof(int), "fw_retry_count");
...
{ struct cx18 *cx ;
  ...
  struct cx18_buffer *buf ;
  int mdl_id ;
    klee_make_symbolic(&mdl_id, sizeof(int), "mdl_id");
  int i ;
...
{ struct cx18 *cx ;
  int raw ;
    klee_make_symbolic(&raw, sizeof(int), "raw");
  int tmp ;
  u32 data[16U] ;
  int lines ;
...
{ u32 data[6U] ;
  struct cx18 *cx ;
  int captype ;
    klee_make_symbolic(&captype, sizeof(int), "captype");
...
{ struct cx18 *cx ;
  ...
  unsigned int tmp ;
  int stuffing ;
    klee_make_symbolic(&stuffing, sizeof(int), "stuffing");
  int i ;
  void *tmp___0 ;
  int tmp___1 ;
  int tmp___2 ;
...
{ struct cx18 *cx ;
  size_t tot_written ;
  int single_frame ;
    klee_make_symbolic(&single_frame, sizeof(int), "single_frame");
  int tmp ;
  int tmp___0 ;
  struct cx18_mdl *mdl ;
  int rc ;
...
{ struct cx18_open_id *id ;
  ...
  int tmp___1 ;
  int videobuf_poll ;
    klee_make_symbolic(&videobuf_poll, sizeof(int), "videobuf_poll");
  unsigned int tmp___2 ;
  int tmp___3 ;
...
{ struct cx18_open_id *id ;
  ...
  int min_h ;
    klee_make_symbolic(&min_h, sizeof(int), "min_h");
  int _min1 ;
...
{ struct cx18 *cx ;
  struct cx2341x_handler  const  *__mptr ;
  int is_mpeg1 ;
    klee_make_symbolic(&is_mpeg1, sizeof(int), "is_mpeg1");
...
{ struct cx18_mailbox *mb ;
  ...
  struct cx18_in_work_order *order ;
  int submit ;
    klee_make_symbolic(&submit, sizeof(int), "submit");
  int i ;
...
{ int line ;
  ...
  int sd ;
    klee_make_symbolic(&sd, sizeof(int), "sd");
  int idx ;
  u8 *dst ;
...
void cx18_video_set_io(struct cx18 *cx ) 
{ int inp ;
    klee_make_symbolic(&inp, sizeof(int), "inp");
...
{ struct cx18_av_state *state ;
  ...
  void *tmp___0 ;
  int default_volume ;
    klee_make_symbolic(&default_volume, sizeof(int), "default_volume");
  u32 v ;
  u32 tmp___1 ;
  u32 tmp___2 ;
  u32 tmp___3 ;
...
{ struct cx18_av_state *state ;
  ...
  v4l2_std_id std ;
  int src_decimation ;
    klee_make_symbolic(&src_decimation, sizeof(int), "src_decimation");
  int hblank ;
    klee_make_symbolic(&hblank, sizeof(int), "hblank");
  int hactive ;
    klee_make_symbolic(&hactive, sizeof(int), "hactive");
  int burst ;
    klee_make_symbolic(&burst, sizeof(int), "burst");
  int vblank ;
    klee_make_symbolic(&vblank, sizeof(int), "vblank");
  int vactive ;
    klee_make_symbolic(&vactive, sizeof(int), "vactive");
  int sc ;
    klee_make_symbolic(&sc, sizeof(int), "sc");
  int vblank656 ;
    klee_make_symbolic(&vblank656, sizeof(int), "vblank656");
  int luma_lpf ;
    klee_make_symbolic(&luma_lpf, sizeof(int), "luma_lpf");
  int uv_lpf ;
    klee_make_symbolic(&uv_lpf, sizeof(int), "uv_lpf");
  int comb ;
    klee_make_symbolic(&comb, sizeof(int), "comb");
  u32 pll_int ;
  u32 pll_frac ;
  u32 pll_post ;
  u8 tmp ;
...
{ struct cx18_av_state *state ;
  ...
  int i ;
  int luma ;
    klee_make_symbolic(&luma, sizeof(int), "luma");
  int r_chroma ;
    klee_make_symbolic(&r_chroma, sizeof(int), "r_chroma");
  int b_chroma ;
    klee_make_symbolic(&b_chroma, sizeof(int), "b_chroma");
  int luma___0 ;
    klee_make_symbolic(&luma___0, sizeof(int), "luma___0");
  int chroma ;
...
{ struct cx18_av_state *state ;
  ...
  void *tmp___0 ;
  int HSC ;
    klee_make_symbolic(&HSC, sizeof(int), "HSC");
  int VSC ;
    klee_make_symbolic(&VSC, sizeof(int), "VSC");
  int Vsrc ;
    klee_make_symbolic(&Vsrc, sizeof(int), "Vsrc");
  int Hsrc ;
    klee_make_symbolic(&Hsrc, sizeof(int), "Hsrc");
  int filter ;
    klee_make_symbolic(&filter, sizeof(int), "filter");
  int Vlines ;
    klee_make_symbolic(&Vlines, sizeof(int), "Vlines");
  int is_50Hz ;
    klee_make_symbolic(&is_50Hz, sizeof(int), "is_50Hz");
  u8 tmp___1 ;
  u8 tmp___2 ;
  u8 tmp___3 ;
  u8 tmp___4 ;
...
{ char const   *fmt_strs[16U] ;
  ...
  u8 tmp___1 ;
  int vid_input ;
    klee_make_symbolic(&vid_input, sizeof(int), "vid_input");
  char *tmp___2 ;
  char const   *tmp___3 ;
...
{ struct cx18_av_state *state ;
  ...
  u8 tmp___5 ;
  int aud_input ;
    klee_make_symbolic(&aud_input, sizeof(int), "aud_input");
  char *p ;
  char *tmp___6 ;
  char *tmp___7 ;
...
{ int bal ;
    klee_make_symbolic(&bal, sizeof(int), "bal");
...
{ struct v4l2_subdev *sd ;
  ...
  int i ;
  int retries1 ;
    klee_make_symbolic(&retries1, sizeof(int), "retries1");
  int tmp ;
  u32 dl_control ;
  u32 value ;
  int retries2 ;
    klee_make_symbolic(&retries2, sizeof(int), "retries2");
  int unrec_err ;
    klee_make_symbolic(&unrec_err, sizeof(int), "unrec_err");
  int tmp___0 ;
...
{ struct cx18 *cx ;
  ...
  u16 lcr2vbi[16U] ;
  int is_pal ;
    klee_make_symbolic(&is_pal, sizeof(int), "is_pal");
  int i ;
  u8 tmp___0 ;
  u8 v ;
  u8 tmp___1 ;
...
{ struct cx18 *cx ;
  ...
  u8 *p ;
  int did ;
    klee_make_symbolic(&did, sizeof(int), "did");
  int sdid ;
    klee_make_symbolic(&sdid, sizeof(int), "sdid");
  int l ;
  int err ;
  u32 tmp___0 ;
  int tmp___1 ;
...
static int ldv_mutex_feedlock_of_cx18_dvb  ;
    klee_make_symbolic(&ldv_mutex_feedlock_of_cx18_dvb, sizeof(int), "ldv_mutex_feedlock_of_cx18_dvb");
...
static int ldv_mutex_gpio_lock_of_cx18  ;
    klee_make_symbolic(&ldv_mutex_gpio_lock_of_cx18, sizeof(int), "ldv_mutex_gpio_lock_of_cx18");
...
static int ldv_mutex_mb_lock  ;
    klee_make_symbolic(&ldv_mutex_mb_lock, sizeof(int), "ldv_mutex_mb_lock");
...
static int ldv_mutex_serialize_lock_of_cx18  ;
    klee_make_symbolic(&ldv_mutex_serialize_lock_of_cx18, sizeof(int), "ldv_mutex_serialize_lock_of_cx18");
