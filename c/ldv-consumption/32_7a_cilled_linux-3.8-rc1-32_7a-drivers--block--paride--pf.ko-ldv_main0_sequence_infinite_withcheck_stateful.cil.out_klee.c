...
{ 
  ...
  int res_pf_open_1 ;
    klee_make_symbolic(&res_pf_open_1, sizeof(int), "res_pf_open_1");
  struct gendisk *var_group2 ;
  fmode_t var_pf_release_4_p1 ;
  fmode_t var_pf_ioctl_3_p1 ;
  unsigned int var_pf_ioctl_3_p2 ;
    klee_make_symbolic(&var_pf_ioctl_3_p2, sizeof(int), "var_pf_ioctl_3_p2");
  unsigned long var_pf_ioctl_3_p3 ;
    klee_make_symbolic(&var_pf_ioctl_3_p3, sizeof(long), "var_pf_ioctl_3_p3");
  struct hd_geometry *var_group3 ;
  unsigned int var_pf_check_events_5_p1 ;
    klee_make_symbolic(&var_pf_check_events_5_p1, sizeof(int), "var_pf_check_events_5_p1");
  int ldv_s_pf_fops_block_device_operations ;
    klee_make_symbolic(&ldv_s_pf_fops_block_device_operations, sizeof(int), "ldv_s_pf_fops_block_device_operations");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
...
static int ldv_mutex_pf_mutex  ;
    klee_make_symbolic(&ldv_mutex_pf_mutex, sizeof(int), "ldv_mutex_pf_mutex");
