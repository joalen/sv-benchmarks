...
struct r8a66597_pipe_info {
   unsigned long timer_interval ;
    klee_make_symbolic(&timer_interval, sizeof(long), "timer_interval");
   u16 pipenum ;
   u16 address ;
   u16 epnum ;
   u16 maxpacket ;
...
struct r8a66597_pipe {
   ...
   unsigned long fifoaddr ;
    klee_make_symbolic(&fifoaddr, sizeof(long), "fifoaddr");
   unsigned long fifosel ;
    klee_make_symbolic(&fifosel, sizeof(long), "fifosel");
   unsigned long fifoctr ;
    klee_make_symbolic(&fifoctr, sizeof(long), "fifoctr");
   unsigned long pipectr ;
    klee_make_symbolic(&pipectr, sizeof(long), "pipectr");
   unsigned long pipetre ;
    klee_make_symbolic(&pipetre, sizeof(long), "pipetre");
   unsigned long pipetrn ;
    klee_make_symbolic(&pipetrn, sizeof(long), "pipetrn");
};
struct r8a66597_td {
   ...
   u16 pipenum ;
   int iso_cnt ;
    klee_make_symbolic(&iso_cnt, sizeof(int), "iso_cnt");
   u16 address ;
   u16 maxpacket ;
...
struct r8a66597_device {
   ...
   unsigned short ep_in_toggle ;
    klee_make_symbolic(&ep_in_toggle, sizeof(short), "ep_in_toggle");
   unsigned short ep_out_toggle ;
    klee_make_symbolic(&ep_out_toggle, sizeof(short), "ep_out_toggle");
   unsigned char pipe_cnt[10U] ;
   unsigned char dma_map ;
    klee_make_symbolic(&dma_map, sizeof(char), "dma_map");
   enum usb_device_state state ;
   struct usb_device *udev ;
   int usb_address ;
    klee_make_symbolic(&usb_address, sizeof(int), "usb_address");
...
struct r8a66597_root_hub {
   ...
   u16 old_syssts ;
   int scount ;
    klee_make_symbolic(&scount, sizeof(int), "scount");
...
struct r8a66597 {
   ...
   unsigned short address_map ;
    klee_make_symbolic(&address_map, sizeof(short), "address_map");
   unsigned short timeout_map ;
    klee_make_symbolic(&timeout_map, sizeof(short), "timeout_map");
   unsigned short interval_map ;
    klee_make_symbolic(&interval_map, sizeof(short), "interval_map");
   unsigned char pipe_cnt[10U] ;
   unsigned char dma_map ;
   unsigned int max_root_hub ;
    klee_make_symbolic(&max_root_hub, sizeof(int), "max_root_hub");
...
{ 
  unsigned long dvstctr_reg ;
    klee_make_symbolic(&dvstctr_reg, sizeof(long), "dvstctr_reg");
  unsigned long tmp ;
  u16 tmp___0 ;
...
{ 
  ...
  unsigned long devadd_reg ;
    klee_make_symbolic(&devadd_reg, sizeof(long), "devadd_reg");
...
{ 
  unsigned short mbw ;
    klee_make_symbolic(&mbw, sizeof(short), "mbw");
  unsigned short tmp ;
...
{ 
  int check_ep0 ;
    klee_make_symbolic(&check_ep0, sizeof(int), "check_ep0");
  u16 pipenum ;
  struct _ddebug descriptor ;
  long tmp ;
...
{ 
  ...
  unsigned long setup_addr ;
    klee_make_symbolic(&setup_addr, sizeof(long), "setup_addr");
...
{ 
  u16 tmp ;
  int rcv_len ;
    klee_make_symbolic(&rcv_len, sizeof(int), "rcv_len");
  int bufsize ;
    klee_make_symbolic(&bufsize, sizeof(int), "bufsize");
  int urb_len ;
    klee_make_symbolic(&urb_len, sizeof(int), "urb_len");
  int size ;
  u16 *buf ;
  struct r8a66597_td *td ;
  ...
  struct urb *urb ;
  int finish ;
    klee_make_symbolic(&finish, sizeof(int), "finish");
  int status ;
  long tmp___1 ;
  long tmp___2 ;
  int _min1 ;
...
{ 
  ...
  unsigned long irq_trigger ;
    klee_make_symbolic(&irq_trigger, sizeof(long), "irq_trigger");
  int tmp ;
...
{ 
  ...
  int var_r8a66597_urb_dequeue_81_p2 ;
    klee_make_symbolic(&var_r8a66597_urb_dequeue_81_p2, sizeof(int), "var_r8a66597_urb_dequeue_81_p2");
  ...
  int res_r8a66597_probe_96 ;
    klee_make_symbolic(&res_r8a66597_probe_96, sizeof(int), "res_r8a66597_probe_96");
  unsigned long var_r8a66597_timer_74_p0 ;
    klee_make_symbolic(&var_r8a66597_timer_74_p0, sizeof(long), "var_r8a66597_timer_74_p0");
  unsigned long var_r8a66597_td_timer_73_p0 ;
    klee_make_symbolic(&var_r8a66597_td_timer_73_p0, sizeof(long), "var_r8a66597_td_timer_73_p0");
  int ldv_s_r8a66597_driver_platform_driver ;
    klee_make_symbolic(&ldv_s_r8a66597_driver_platform_driver, sizeof(int), "ldv_s_r8a66597_driver_platform_driver");
  int tmp ;
  int tmp___0 ;
