...
{ struct sensor_device_attribute *sensor_attr ;
  ...
  struct w83792d_data *tmp ;
  long pwm_enable_tmp ;
    klee_make_symbolic(&pwm_enable_tmp, sizeof(long), "pwm_enable_tmp");
  int tmp___0 ;
...
static int ldv_mutex_update_lock_of_w83792d_data  ;
    klee_make_symbolic(&ldv_mutex_update_lock_of_w83792d_data, sizeof(int), "ldv_mutex_update_lock_of_w83792d_data");
