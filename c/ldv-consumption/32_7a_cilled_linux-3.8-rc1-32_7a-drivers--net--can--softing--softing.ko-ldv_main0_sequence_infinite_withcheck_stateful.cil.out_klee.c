...
{ 
  ...
  int res_softing_netdev_open_9 ;
    klee_make_symbolic(&res_softing_netdev_open_9, sizeof(int), "res_softing_netdev_open_9");
  int res_softing_netdev_stop_10 ;
    klee_make_symbolic(&res_softing_netdev_stop_10, sizeof(int), "res_softing_netdev_stop_10");
  struct sk_buff *var_group2 ;
  struct platform_device *var_group3 ;
  int res_softing_pdev_probe_23 ;
    klee_make_symbolic(&res_softing_pdev_probe_23, sizeof(int), "res_softing_pdev_probe_23");
  int var_softing_irq_thread_6_p0 ;
    klee_make_symbolic(&var_softing_irq_thread_6_p0, sizeof(int), "var_softing_irq_thread_6_p0");
  void *var_softing_irq_thread_6_p1 ;
  int var_softing_irq_v1_8_p0 ;
    klee_make_symbolic(&var_softing_irq_v1_8_p0, sizeof(int), "var_softing_irq_v1_8_p0");
  void *var_softing_irq_v1_8_p1 ;
  int var_softing_irq_v2_7_p0 ;
    klee_make_symbolic(&var_softing_irq_v2_7_p0, sizeof(int), "var_softing_irq_v2_7_p0");
  void *var_softing_irq_v2_7_p1 ;
  int ldv_s_softing_netdev_ops_net_device_ops ;
    klee_make_symbolic(&ldv_s_softing_netdev_ops_net_device_ops, sizeof(int), "ldv_s_softing_netdev_ops_net_device_ops");
  int ldv_s_softing_driver_platform_driver ;
    klee_make_symbolic(&ldv_s_softing_driver_platform_driver, sizeof(int), "ldv_s_softing_driver_platform_driver");
  int tmp ;
  int tmp___0 ;
