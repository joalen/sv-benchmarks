...
{ 
  ...
  int res_applesmc_probe_22 ;
    klee_make_symbolic(&res_applesmc_probe_22, sizeof(int), "res_applesmc_probe_22");
  ...
  int ldv_s_applesmc_driver_platform_driver ;
    klee_make_symbolic(&ldv_s_applesmc_driver_platform_driver, sizeof(int), "ldv_s_applesmc_driver_platform_driver");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
