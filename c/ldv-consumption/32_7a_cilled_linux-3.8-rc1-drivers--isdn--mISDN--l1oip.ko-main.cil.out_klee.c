...
struct bchannel {
   ...
   unsigned short init_maxlen ;
    klee_make_symbolic(&init_maxlen, sizeof(short), "init_maxlen");
   unsigned short next_maxlen ;
    klee_make_symbolic(&next_maxlen, sizeof(short), "next_maxlen");
   unsigned short minlen ;
    klee_make_symbolic(&minlen, sizeof(short), "minlen");
   unsigned short init_minlen ;
    klee_make_symbolic(&init_minlen, sizeof(short), "init_minlen");
   unsigned short next_minlen ;
    klee_make_symbolic(&next_minlen, sizeof(short), "next_minlen");
   ...
   int err_rx ;
   int dropcnt ;
    klee_make_symbolic(&dropcnt, sizeof(int), "dropcnt");
};
struct dsp_features {
   int hfc_id ;
...
struct l1oip {
   ...
   int d_idx ;
    klee_make_symbolic(&d_idx, sizeof(int), "d_idx");
   int b_num ;
    klee_make_symbolic(&b_num, sizeof(int), "b_num");
   u32 id ;
   int ondemand ;
    klee_make_symbolic(&ondemand, sizeof(int), "ondemand");
   int bundle ;
    klee_make_symbolic(&bundle, sizeof(int), "bundle");
   int codec ;
   ...
   int timeout_on ;
    klee_make_symbolic(&timeout_on, sizeof(int), "timeout_on");
   struct work_struct workq ;
...
static int l1oip_cnt  ;
    klee_make_symbolic(&l1oip_cnt, sizeof(int), "l1oip_cnt");
...
{ u32 packet_id ;
  ...
  int len_start ;
    klee_make_symbolic(&len_start, sizeof(int), "len_start");
  struct dchannel *dch ;
  u8 *tmp ;
  u8 *tmp___0 ;
  u8 *tmp___1 ;
...
{ struct l1oip *hc ;
  ...
  size_t recvbuf_size ;
  int recvlen ;
    klee_make_symbolic(&recvlen, sizeof(int), "recvlen");
  struct socket *socket ;
...
{ int i1 ;
  ...
  int c ;
  int sample ;
    klee_make_symbolic(&sample, sizeof(int), "sample");
  void *tmp ;
  void *tmp___0 ;
