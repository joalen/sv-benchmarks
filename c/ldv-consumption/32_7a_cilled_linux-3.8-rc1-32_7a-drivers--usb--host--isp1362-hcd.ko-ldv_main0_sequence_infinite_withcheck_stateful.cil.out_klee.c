...
struct isp1362_ep {
   ...
   s16 ptd_offset ;
   int ptd_index ;
    klee_make_symbolic(&ptd_index, sizeof(int), "ptd_index");
   int num_ptds ;
    klee_make_symbolic(&num_ptds, sizeof(int), "num_ptds");
   void *data ;
   ...
   int num_req ;
    klee_make_symbolic(&num_req, sizeof(int), "num_req");
};
struct isp1362_ep_queue {
   struct list_head active ;
   atomic_t finishing ;
   unsigned long buf_map ;
    klee_make_symbolic(&buf_map, sizeof(long), "buf_map");
   unsigned long skip_map ;
    klee_make_symbolic(&skip_map, sizeof(long), "skip_map");
   int free_ptd ;
    klee_make_symbolic(&free_ptd, sizeof(int), "free_ptd");
   u16 buf_start ;
   u16 buf_size ;
   u16 blk_size ;
   u8 buf_count ;
...
struct isp1362_hcd {
   ...
   int req_serial ;
    klee_make_symbolic(&req_serial, sizeof(int), "req_serial");
};
struct seq_file {
   char *buf ;
   size_t size ;
...
{ 
  int ptd_offset ;
    klee_make_symbolic(&ptd_offset, sizeof(int), "ptd_offset");
  int num_ptds ;
  int found ;
...
{ 
  ...
  struct ptd *ptd ;
  int short_ok ;
    klee_make_symbolic(&short_ok, sizeof(int), "short_ok");
  u16 len ;
  int urbstat ;
    klee_make_symbolic(&urbstat, sizeof(int), "urbstat");
  u8 cc ;
  struct _ddebug descriptor ;
  long tmp___1 ;
  struct _ddebug descriptor___0 ;
...
{ 
  int ptd_count ;
    klee_make_symbolic(&ptd_count, sizeof(int), "ptd_count");
  struct isp1362_ep_queue *epq ;
  struct isp1362_ep *ep ;
  int defer ;
    klee_make_symbolic(&defer, sizeof(int), "defer");
  struct _ddebug descriptor ;
  long tmp ;
  int tmp___0 ;
...
{ 
  ...
  struct list_head  const  *__mptr___1 ;
  int last_count ;
    klee_make_symbolic(&last_count, sizeof(int), "last_count");
  struct _ddebug descriptor___2 ;
  long tmp___6 ;
...
{ 
  int ptd_count ;
  int flip ;
    klee_make_symbolic(&flip, sizeof(int), "flip");
  struct isp1362_ep_queue *epq ;
  int ptd_offset ;
  struct isp1362_ep *ep ;
  struct isp1362_ep *tmp ;
...
{ 
  ...
  int __ret_warn_on___5 ;
    klee_make_symbolic(&__ret_warn_on___5, sizeof(int), "__ret_warn_on___5");
  long tmp___30 ;
  ...
  int __ret_warn_on___6 ;
    klee_make_symbolic(&__ret_warn_on___6, sizeof(int), "__ret_warn_on___6");
  long tmp___37 ;
...
{ 
  ...
  unsigned long flags ;
  int clkrdy ;
    klee_make_symbolic(&clkrdy, sizeof(int), "clkrdy");
  struct _ddebug descriptor ;
  long tmp___0 ;
  unsigned long tmp___1 ;
  raw_spinlock_t *tmp___2 ;
...
{ 
  ...
  int res_proc_isp1362_open_40 ;
    klee_make_symbolic(&res_proc_isp1362_open_40, sizeof(int), "res_proc_isp1362_open_40");
  struct usb_hcd *var_group3 ;
  struct urb *var_group4 ;
  gfp_t var_isp1362_urb_enqueue_24_p2 ;
  int var_isp1362_urb_dequeue_25_p2 ;
    klee_make_symbolic(&var_isp1362_urb_dequeue_25_p2, sizeof(int), "var_isp1362_urb_dequeue_25_p2");
  ...
  int res_isp1362_probe_51 ;
    klee_make_symbolic(&res_isp1362_probe_51, sizeof(int), "res_isp1362_probe_51");
  pm_message_t var_isp1362_suspend_52_p1 ;
  int ldv_s_proc_ops_file_operations ;
    klee_make_symbolic(&ldv_s_proc_ops_file_operations, sizeof(int), "ldv_s_proc_ops_file_operations");
  int ldv_s_isp1362_driver_platform_driver ;
    klee_make_symbolic(&ldv_s_isp1362_driver_platform_driver, sizeof(int), "ldv_s_isp1362_driver_platform_driver");
  int tmp ;
  int tmp___0 ;
