...
struct znet_private {
   int rx_dma ;
    klee_make_symbolic(&rx_dma, sizeof(int), "rx_dma");
   int tx_dma ;
    klee_make_symbolic(&tx_dma, sizeof(int), "tx_dma");
   spinlock_t lock ;
   short sia_base ;
    klee_make_symbolic(&sia_base, sizeof(short), "sia_base");
   short sia_size ;
    klee_make_symbolic(&sia_size, sizeof(short), "sia_size");
   short io_size ;
    klee_make_symbolic(&io_size, sizeof(short), "io_size");
   ...
   ushort *tx_end ;
   ushort tx_buf_len ;
    klee_make_symbolic(&tx_buf_len, sizeof(short), "tx_buf_len");
};
struct netidblk {
   char magic[8U] ;
   unsigned char netid[8U] ;
   char nettype ;
    klee_make_symbolic(&nettype, sizeof(char), "nettype");
   char globalopt ;
    klee_make_symbolic(&globalopt, sizeof(char), "globalopt");
   char vendor[8U] ;
   char product[8U] ;
   char irq1 ;
    klee_make_symbolic(&irq1, sizeof(char), "irq1");
   char irq2 ;
    klee_make_symbolic(&irq2, sizeof(char), "irq2");
   char dma1 ;
    klee_make_symbolic(&dma1, sizeof(char), "dma1");
   char dma2 ;
    klee_make_symbolic(&dma2, sizeof(char), "dma2");
   short dma_mem_misc[8U] ;
   short iobase1 ;
    klee_make_symbolic(&iobase1, sizeof(short), "iobase1");
   short iosize1 ;
    klee_make_symbolic(&iosize1, sizeof(short), "iosize1");
   short iobase2 ;
    klee_make_symbolic(&iobase2, sizeof(short), "iobase2");
   short iosize2 ;
    klee_make_symbolic(&iosize2, sizeof(short), "iosize2");
   char driver_options ;
    klee_make_symbolic(&driver_options, sizeof(char), "driver_options");
   char pad ;
...
{ 
  ...
  ushort event ;
  ushort tx_status ;
    klee_make_symbolic(&tx_status, sizeof(short), "tx_status");
  ushort rx_offset ;
    klee_make_symbolic(&rx_offset, sizeof(short), "rx_offset");
  ushort state ;
  unsigned char tmp ;
  unsigned char tmp___0 ;
...
{ 
  ...
  ushort *tx_link ;
  ushort rnd_len ;
    klee_make_symbolic(&rnd_len, sizeof(short), "rnd_len");
  ushort *tmp___4 ;
  int semi_cnt ;
    klee_make_symbolic(&semi_cnt, sizeof(int), "semi_cnt");
  size_t __len ;
  void *__ret ;
  size_t __len___0 ;
  void *__ret___0 ;
...
{ 
  ...
  ushort rx_ptr ;
    klee_make_symbolic(&rx_ptr, sizeof(short), "rx_ptr");
  ushort running ;
  unsigned char tmp___1 ;
  int tx_status ;
  unsigned short tmp___2 ;
...
{ 
  ...
  short next_frame_end_offset ;
    klee_make_symbolic(&next_frame_end_offset, sizeof(short), "next_frame_end_offset");
  short *cur_frame_end ;
  short cur_frame_end_offset ;
    klee_make_symbolic(&cur_frame_end_offset, sizeof(short), "cur_frame_end_offset");
  unsigned short tmp___0 ;
  unsigned short hi_cnt ;
    klee_make_symbolic(&hi_cnt, sizeof(short), "hi_cnt");
  unsigned short lo_cnt ;
    klee_make_symbolic(&lo_cnt, sizeof(short), "lo_cnt");
  unsigned short hi_status ;
    klee_make_symbolic(&hi_status, sizeof(short), "hi_status");
  unsigned short lo_status ;
    klee_make_symbolic(&lo_status, sizeof(short), "lo_status");
  int count ;
  int status ;
  size_t __len ;
  void *__ret ;
  ...
  ushort *this_rfp_ptr ;
  int status___0 ;
    klee_make_symbolic(&status___0, sizeof(int), "status___0");
  int pkt_len ;
...
{ 
  ...
  unsigned long flags ;
  short dma_port ;
    klee_make_symbolic(&dma_port, sizeof(short), "dma_port");
  unsigned int addr ;
    klee_make_symbolic(&addr, sizeof(int), "addr");
  unsigned char tmp___1 ;
  short residue ;
    klee_make_symbolic(&residue, sizeof(short), "residue");
  unsigned char tmp___2 ;
  int tmp___3 ;
...
{ 
  ...
  int res_znet_open_5 ;
    klee_make_symbolic(&res_znet_open_5, sizeof(int), "res_znet_open_5");
  int res_znet_close_10 ;
    klee_make_symbolic(&res_znet_close_10, sizeof(int), "res_znet_close_10");
  struct sk_buff *var_group2 ;
  int var_znet_interrupt_8_p0 ;
    klee_make_symbolic(&var_znet_interrupt_8_p0, sizeof(int), "var_znet_interrupt_8_p0");
  void *var_znet_interrupt_8_p1 ;
  int ldv_s_znet_netdev_ops_net_device_ops ;
    klee_make_symbolic(&ldv_s_znet_netdev_ops_net_device_ops, sizeof(int), "ldv_s_znet_netdev_ops_net_device_ops");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
