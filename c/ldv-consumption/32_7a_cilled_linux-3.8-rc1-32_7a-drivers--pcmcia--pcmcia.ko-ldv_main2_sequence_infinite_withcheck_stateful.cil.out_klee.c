...
struct cistpl_jedec_t {
   u_char nid ;
    klee_make_symbolic(&nid, sizeof(char), "nid");
...
{ 
  ...
  unsigned int no_funcs ;
    klee_make_symbolic(&no_funcs, sizeof(int), "no_funcs");
  unsigned int i ;
  unsigned int no_chains ;
    klee_make_symbolic(&no_chains, sizeof(int), "no_chains");
  int ret ;
  struct _ddebug descriptor ;
  long tmp ;
  struct _ddebug descriptor___0 ;
...
{ 
  int has_pfc ;
    klee_make_symbolic(&has_pfc, sizeof(int), "has_pfc");
  int old_funcs ;
    klee_make_symbolic(&old_funcs, sizeof(int), "old_funcs");
  int new_funcs ;
    klee_make_symbolic(&new_funcs, sizeof(int), "new_funcs");
  cistpl_longlink_mfc_t mfc ;
  int tmp ;
  int tmp___0 ;
...
{ 
  ...
  int res_pcmcia_device_probe_11 ;
    klee_make_symbolic(&res_pcmcia_device_probe_11, sizeof(int), "res_pcmcia_device_probe_11");
  pm_message_t var_pcmcia_dev_suspend_31_p1 ;
  int ldv_s_pcmcia_bus_callback_pcmcia_callback ;
    klee_make_symbolic(&ldv_s_pcmcia_bus_callback_pcmcia_callback, sizeof(int), "ldv_s_pcmcia_bus_callback_pcmcia_callback");
  int ldv_s_pcmcia_bus_type_bus_type ;
    klee_make_symbolic(&ldv_s_pcmcia_bus_type_bus_type, sizeof(int), "ldv_s_pcmcia_bus_type_bus_type");
  int tmp ;
  int tmp___0 ;
...
int pcmcia_write_cis_mem(struct pcmcia_socket *s , int attr , u_int addr , u_int len ,
                         void *ptr ) ;
static int io_speed  ;
    klee_make_symbolic(&io_speed, sizeof(int), "io_speed");
int pcmcia_validate_mem(struct pcmcia_socket *s ) 
{ 
  int tmp ;
...
{ 
  ...
  unsigned char ext_status ;
    klee_make_symbolic(&ext_status, sizeof(char), "ext_status");
  unsigned char option ;
    klee_make_symbolic(&option, sizeof(char), "option");
  unsigned int flags ;
  struct _ddebug descriptor ;
  long tmp ;
  int tmp___0 ;
...
static int cis_width  ;
    klee_make_symbolic(&cis_width, sizeof(int), "cis_width");
void release_cis_mem(struct pcmcia_socket *s ) 
{ 
...
{ 
  ...
  u_int card_offset ;
    klee_make_symbolic(&card_offset, sizeof(int), "card_offset");
  u_int flags___0 ;
...
{ 
  int i ;
  u_char scale ;
    klee_make_symbolic(&scale, sizeof(char), "scale");
  u_char *p ;
  u_char *q ;
...
{ 
  ...
  int lsz ;
    klee_make_symbolic(&lsz, sizeof(int), "lsz");
...
{ 
  ...
  int j ;
  int asz ;
    klee_make_symbolic(&asz, sizeof(int), "asz");
  int lsz ;
  int has_ha ;
    klee_make_symbolic(&has_ha, sizeof(int), "has_ha");
  u_int len ;
  u_int ca ;
    klee_make_symbolic(&ca, sizeof(int), "ca");
  u_int ha ;
...
{ 
  ...
  int reserved ;
  int dev_ok ;
    klee_make_symbolic(&dev_ok, sizeof(int), "dev_ok");
  int ident_ok ;
    klee_make_symbolic(&ident_ok, sizeof(int), "ident_ok");
  int __ret_warn_on ;
  long tmp ;
  void *tmp___0 ;
  void *tmp___1 ;
...
{ 
  ...
  struct pcmcia_socket *s ;
  unsigned int chains ;
    klee_make_symbolic(&chains, sizeof(int), "chains");
  struct device  const  *__mptr ;
...
static int ldv_mutex_ops_mutex  ;
    klee_make_symbolic(&ldv_mutex_ops_mutex, sizeof(int), "ldv_mutex_ops_mutex");
...
static int ldv_mutex_skt_mutex  ;
    klee_make_symbolic(&ldv_mutex_skt_mutex, sizeof(int), "ldv_mutex_skt_mutex");
