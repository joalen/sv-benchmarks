...
struct rx_header {
   ...
   ushort rx_count ;
    klee_make_symbolic(&rx_count, sizeof(short), "rx_count");
   ushort rx_status ;
    klee_make_symbolic(&rx_status, sizeof(short), "rx_status");
   ushort cur_addr ;
    klee_make_symbolic(&cur_addr, sizeof(short), "cur_addr");
};
struct net_local {
   spinlock_t lock ;
   ...
   int saved_tx_size ;
    klee_make_symbolic(&saved_tx_size, sizeof(int), "saved_tx_size");
   unsigned char tx_unit_busy : 1 ;
   unsigned char re_tx ;
    klee_make_symbolic(&re_tx, sizeof(char), "re_tx");
   unsigned char addr_mode ;
    klee_make_symbolic(&addr_mode, sizeof(char), "addr_mode");
   unsigned char pac_cnt_in_tx_buf ;
    klee_make_symbolic(&pac_cnt_in_tx_buf, sizeof(char), "pac_cnt_in_tx_buf");
};
...
{ 
  unsigned char _v ;
    klee_make_symbolic(&_v, sizeof(char), "_v");
...
{ 
  unsigned char low_nib ;
    klee_make_symbolic(&low_nib, sizeof(char), "low_nib");
  unsigned char tmp ;
...
{ 
  unsigned char outval ;
    klee_make_symbolic(&outval, sizeof(char), "outval");
...
{ 
  ...
  struct net_local *lp ;
  int saved_ctrl_reg ;
    klee_make_symbolic(&saved_ctrl_reg, sizeof(int), "saved_ctrl_reg");
  int status ;
...
{ 
  unsigned int eedata_out ;
    klee_make_symbolic(&eedata_out, sizeof(int), "eedata_out");
  int num_bits ;
...
{ 
  ...
  unsigned char outbyte ;
    klee_make_symbolic(&outbyte, sizeof(char), "outbyte");
  unsigned char *tmp___0 ;
  unsigned char *tmp___1 ;
...
{ 
  ...
  long ioaddr ;
  int num_tx_since_rx ;
    klee_make_symbolic(&num_tx_since_rx, sizeof(int), "num_tx_since_rx");
  int boguscount ;
  ...
  unsigned char tmp___0 ;
  int read_status ;
    klee_make_symbolic(&read_status, sizeof(int), "read_status");
  unsigned char tmp___1 ;
  unsigned char tmp___2 ;
  int i ;
...
{ 
  ...
  int res_net_open_4 ;
    klee_make_symbolic(&res_net_open_4, sizeof(int), "res_net_open_4");
  int res_net_close_14 ;
    klee_make_symbolic(&res_net_close_14, sizeof(int), "res_net_close_14");
  struct sk_buff *var_group2 ;
  int var_atp_interrupt_10_p0 ;
    klee_make_symbolic(&var_atp_interrupt_10_p0, sizeof(int), "var_atp_interrupt_10_p0");
  void *var_atp_interrupt_10_p1 ;
  unsigned long var_atp_timed_checker_11_p0 ;
    klee_make_symbolic(&var_atp_timed_checker_11_p0, sizeof(long), "var_atp_timed_checker_11_p0");
  int ldv_s_atp_netdev_ops_net_device_ops ;
    klee_make_symbolic(&ldv_s_atp_netdev_ops_net_device_ops, sizeof(int), "ldv_s_atp_netdev_ops_net_device_ops");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
