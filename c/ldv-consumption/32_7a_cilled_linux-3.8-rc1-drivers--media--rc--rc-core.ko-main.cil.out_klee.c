...
struct rc5_dec {
   ...
   unsigned int wanted_bits ;
    klee_make_symbolic(&wanted_bits, sizeof(int), "wanted_bits");
};
struct rc6_dec {
   int state ;
   u8 header ;
...
struct lirc_codec {
   ...
   int carrier_low ;
    klee_make_symbolic(&carrier_low, sizeof(int), "carrier_low");
   ktime_t gap_start ;
   u64 gap_duration ;
   bool gap ;
...
int rc_core_debug  ;
    klee_make_symbolic(&rc_core_debug, sizeof(int), "rc_core_debug");
...
{ unsigned int oldalloc ;
    klee_make_symbolic(&oldalloc, sizeof(int), "oldalloc");
  unsigned int newalloc ;
    klee_make_symbolic(&newalloc, sizeof(int), "newalloc");
...
{ int old_keycode ;
    klee_make_symbolic(&old_keycode, sizeof(int), "old_keycode");
  int i ;
...
static int ldv_mutex_ir_raw_handler_lock  ;
    klee_make_symbolic(&ldv_mutex_ir_raw_handler_lock, sizeof(int), "ldv_mutex_ir_raw_handler_lock");
...
static int ldv_mutex_lock_of_rc_dev  ;
    klee_make_symbolic(&ldv_mutex_lock_of_rc_dev, sizeof(int), "ldv_mutex_lock_of_rc_dev");
