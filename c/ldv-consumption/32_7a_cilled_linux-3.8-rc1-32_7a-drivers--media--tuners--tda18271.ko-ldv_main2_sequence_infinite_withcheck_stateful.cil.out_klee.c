...
int tda18271_debug ;
    klee_make_symbolic(&tda18271_debug, sizeof(int), "tda18271_debug");
...
{ 
  ...
  unsigned char *regs ;
  int r_cp ;
    klee_make_symbolic(&r_cp, sizeof(int), "r_cp");
  int tmp ;
...
{ 
  ...
  unsigned char *regs ;
  int tm ;
    klee_make_symbolic(&tm, sizeof(int), "tm");
...
{ 
  ...
  unsigned char *regs ;
  int sgn ;
    klee_make_symbolic(&sgn, sizeof(int), "sgn");
  int bcal ;
    klee_make_symbolic(&bcal, sizeof(int), "bcal");
  int count ;
  int wait ;
...
{ 
  ...
  int bcal ;
  int rf ;
    klee_make_symbolic(&rf, sizeof(int), "rf");
  int i ;
  s32 divisor ;
  s32 dividend ;
  u32 rf_default[3U] ;
...
{ 
  ...
  int ldv_s_tda18271_tuner_ops_dvb_tuner_ops ;
    klee_make_symbolic(&ldv_s_tda18271_tuner_ops_dvb_tuner_ops, sizeof(int), "ldv_s_tda18271_tuner_ops_dvb_tuner_ops");
  int tmp ;
  int tmp___0 ;
...
static int ldv_mutex_tda18271_list_mutex  ;
    klee_make_symbolic(&ldv_mutex_tda18271_list_mutex, sizeof(int), "ldv_mutex_tda18271_list_mutex");
