...
{ 
  ...
  u32 mc2 ;
  int trial ;
    klee_make_symbolic(&trial, sizeof(int), "trial");
  unsigned long timeout ;
  struct _ddebug descriptor ;
  unsigned int tmp ;
  long tmp___0 ;
...
{ 
  ...
  int short_delay ;
    klee_make_symbolic(&short_delay, sizeof(int), "short_delay");
  int tmp ;
  struct _ddebug descriptor ;
  long tmp___0 ;
  struct _ddebug descriptor___0 ;
...
{ 
  ...
  int var_saa7146_i2c_xfer_7_p2 ;
    klee_make_symbolic(&var_saa7146_i2c_xfer_7_p2, sizeof(int), "var_saa7146_i2c_xfer_7_p2");
...
static int saa7146_num  ;
    klee_make_symbolic(&saa7146_num, sizeof(int), "saa7146_num");
void saa7146_setgpio(struct saa7146_dev *dev , int port , u32 data ) 
{ 
  u32 value ;
  long tmp ;
...
{ 
  unsigned long loops ;
    klee_make_symbolic(&loops, sizeof(long), "loops");
  unsigned int tmp ;
...
static int ldv_mutex_i2c_lock_of_saa7146_dev  ;
    klee_make_symbolic(&ldv_mutex_i2c_lock_of_saa7146_dev, sizeof(int), "ldv_mutex_i2c_lock_of_saa7146_dev");
int ldv_mutex_lock_interruptible_i2c_lock_of_saa7146_dev(struct mutex *lock ) 
{ 
  int nondetermined ;
