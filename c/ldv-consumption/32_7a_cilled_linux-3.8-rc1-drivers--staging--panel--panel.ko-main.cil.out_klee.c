...
struct __anonstruct_std_181 {
   ...
   int press_data ;
    klee_make_symbolic(&press_data, sizeof(int), "press_data");
   int release_data ;
    klee_make_symbolic(&release_data, sizeof(int), "release_data");
};
...
struct __anonstruct_bits_183 {
   ...
   unsigned char rs ;
    klee_make_symbolic(&rs, sizeof(char), "rs");
   unsigned char rw ;
    klee_make_symbolic(&rw, sizeof(char), "rw");
   unsigned char bl ;
    klee_make_symbolic(&bl, sizeof(char), "bl");
   unsigned char cl ;
    klee_make_symbolic(&cl, sizeof(char), "cl");
   unsigned char da ;
    klee_make_symbolic(&da, sizeof(char), "da");
};
...
static char inputs_stable  ;
    klee_make_symbolic(&inputs_stable, sizeof(char), "inputs_stable");
static char keypad_buffer[64U]  ;
static int keypad_buflen  ;
    klee_make_symbolic(&keypad_buflen, sizeof(int), "keypad_buflen");
static int keypad_start  ;
    klee_make_symbolic(&keypad_start, sizeof(int), "keypad_start");
static char keypressed  ;
    klee_make_symbolic(&keypressed, sizeof(char), "keypressed");
static wait_queue_head_t keypad_read_wait  ;
static unsigned long lcd_flags  ;
    klee_make_symbolic(&lcd_flags, sizeof(long), "lcd_flags");
static unsigned long lcd_addr_x  ;
    klee_make_symbolic(&lcd_addr_x, sizeof(long), "lcd_addr_x");
static unsigned long lcd_addr_y  ;
    klee_make_symbolic(&lcd_addr_y, sizeof(long), "lcd_addr_y");
static char lcd_escape[25U]  ;
static int lcd_escape_len  =    -1;
static unsigned char lcd_bits[2U][6U][3U]  ;
static int keypad_open_cnt  ;
    klee_make_symbolic(&keypad_open_cnt, sizeof(int), "keypad_open_cnt");
static int lcd_open_cnt  ;
    klee_make_symbolic(&lcd_open_cnt, sizeof(int), "lcd_open_cnt");
static struct pardevice *pprt  ;
static int lcd_initialized  ;
    klee_make_symbolic(&lcd_initialized, sizeof(int), "lcd_initialized");
static int keypad_initialized  ;
    klee_make_symbolic(&keypad_initialized, sizeof(int), "keypad_initialized");
static int light_tempo  ;
    klee_make_symbolic(&light_tempo, sizeof(int), "light_tempo");
static char lcd_must_clear  ;
    klee_make_symbolic(&lcd_must_clear, sizeof(char), "lcd_must_clear");
static char lcd_left_shift  ;
    klee_make_symbolic(&lcd_left_shift, sizeof(char), "lcd_left_shift");
static char init_in_progress  ;
    klee_make_symbolic(&init_in_progress, sizeof(char), "init_in_progress");
...
{ int d_bit ;
    klee_make_symbolic(&d_bit, sizeof(int), "d_bit");
  int c_bit ;
    klee_make_symbolic(&c_bit, sizeof(int), "c_bit");
  int inv ;
    klee_make_symbolic(&inv, sizeof(int), "inv");
  unsigned char tmp ;
...
{ int processed ;
  ...
  char *esc ;
  int oldflags ;
    klee_make_symbolic(&oldflags, sizeof(int), "oldflags");
  int x ;
  unsigned char cgbytes[8U] ;
  unsigned char cgaddr ;
    klee_make_symbolic(&cgaddr, sizeof(char), "cgaddr");
  int cgoffset ;
    klee_make_symbolic(&cgoffset, sizeof(int), "cgoffset");
  int shift ;
...
{ int bit ;
  int bitval ;
    klee_make_symbolic(&bitval, sizeof(int), "bitval");
  char oldval ;
    klee_make_symbolic(&oldval, sizeof(char), "oldval");
  char bitmask ;
    klee_make_symbolic(&bitmask, sizeof(char), "bitmask");
  char gndmask ;
    klee_make_symbolic(&gndmask, sizeof(char), "gndmask");
  unsigned char tmp ;
  unsigned char tmp___0 ;
  unsigned char tmp___1 ;
  unsigned char tmp___2 ;
...
{ char sigtab[10U] ;
  char im ;
    klee_make_symbolic(&im, sizeof(char), "im");
  char om ;
    klee_make_symbolic(&om, sizeof(char), "om");
  pmask_t m ;
  pmask_t v ;
  int in ;
...
{ int keynum ;
    klee_make_symbolic(&keynum, sizeof(int), "keynum");
  struct lock_class_key __key ;
