...
typedef int SVGA3dTextureStateName;
    klee_make_symbolic(&SVGA3dTextureStateName, sizeof(int), "SVGA3dTextureStateName");
typedef int SVGA3dTextureFilter;
    klee_make_symbolic(&SVGA3dTextureFilter, sizeof(int), "SVGA3dTextureFilter");
enum ldv_9146 {
...
typedef int SVGA3dStretchBltMode;
    klee_make_symbolic(&SVGA3dStretchBltMode, sizeof(int), "SVGA3dStretchBltMode");
enum ldv_9172 {
...
typedef int SVGA3dTransferType;
    klee_make_symbolic(&SVGA3dTransferType, sizeof(int), "SVGA3dTransferType");
...
struct swap_info_struct {
   ...
   signed char type ;
   signed char next ;
    klee_make_symbolic(&next, sizeof(char), "next");
   unsigned int max ;
   ...
   unsigned int lowest_alloc ;
    klee_make_symbolic(&lowest_alloc, sizeof(int), "lowest_alloc");
   unsigned int highest_alloc ;
    klee_make_symbolic(&highest_alloc, sizeof(int), "highest_alloc");
...
struct vmw_resource {
   ...
   unsigned long backup_size ;
    klee_make_symbolic(&backup_size, sizeof(long), "backup_size");
   bool res_dirty ;
   bool backup_dirty ;
   struct vmw_dma_buffer *backup ;
   unsigned long backup_offset ;
    klee_make_symbolic(&backup_offset, sizeof(long), "backup_offset");
...
struct vmw_resource_val_node {
   ...
   unsigned long new_backup_offset ;
    klee_make_symbolic(&new_backup_offset, sizeof(long), "new_backup_offset");
   bool first_usage ;
...
struct ttm_bo_kmap_obj {
   ...
   struct page *page ;
   int bo_kmap_type ;
    klee_make_symbolic(&bo_kmap_type, sizeof(int), "bo_kmap_type");
   struct ttm_buffer_object *bo ;
};
