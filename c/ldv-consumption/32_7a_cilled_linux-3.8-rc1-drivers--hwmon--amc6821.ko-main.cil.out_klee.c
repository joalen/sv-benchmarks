...
static unsigned short const   normal_i2c[10U]  = 
  {      24U,      25U,      26U,      44U, 
        ...
        78U,      65534U};
static int pwminv  ;
    klee_make_symbolic(&pwminv, sizeof(int), "pwminv");
static int init  =    1;
...
{ struct i2c_client *client ;
  ...
  u8 reg ;
  int dpwm ;
    klee_make_symbolic(&dpwm, sizeof(int), "dpwm");
  long val ;
  int ret ;
  int tmp___0 ;
  struct _ddebug descriptor ;
...
{ struct i2c_adapter *adapter ;
  ...
  int comp_id ;
    klee_make_symbolic(&comp_id, sizeof(int), "comp_id");
  struct _ddebug descriptor ;
  long tmp ;
  struct _ddebug descriptor___0 ;
  long tmp___0 ;
...
static int ldv_mutex_update_lock_of_amc6821_data  ;
    klee_make_symbolic(&ldv_mutex_update_lock_of_amc6821_data, sizeof(int), "ldv_mutex_update_lock_of_amc6821_data");
