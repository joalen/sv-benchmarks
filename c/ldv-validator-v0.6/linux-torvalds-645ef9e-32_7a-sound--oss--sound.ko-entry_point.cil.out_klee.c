...
{ 
  ...
  unsigned long ldvarg36 ;
    klee_make_symbolic(&ldvarg36, sizeof(long), "ldvarg36");
...
{ 
  unsigned long ldvarg12 ;
    klee_make_symbolic(&ldvarg12, sizeof(long), "ldvarg12");
  unsigned long tmp ;
  int tmp___0 ;
...
{ 
  ...
  int tmp ;
  long ldvarg34 ;
    klee_make_symbolic(&ldvarg34, sizeof(long), "ldvarg34");
...
{ 
  ...
  unsigned int tmp___6 ;
  long ldvarg23 ;
    klee_make_symbolic(&ldvarg23, sizeof(long), "ldvarg23");
  int ldvarg20 ;
...
static int ldv_mutex_soundcard_mutex  ;
    klee_make_symbolic(&ldv_mutex_soundcard_mutex, sizeof(int), "ldv_mutex_soundcard_mutex");
