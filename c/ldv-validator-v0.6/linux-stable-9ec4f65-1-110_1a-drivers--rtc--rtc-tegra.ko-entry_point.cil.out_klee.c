...
struct tegra_rtc_info {
   ...
   void *rtc_base ;
   int tegra_rtc_irq ;
    klee_make_symbolic(&tegra_rtc_irq, sizeof(int), "tegra_rtc_irq");
...
{ 
  ...
  unsigned long msec ;
    klee_make_symbolic(&msec, sizeof(long), "msec");
  unsigned long sl_irq_flags ;
    klee_make_symbolic(&sl_irq_flags, sizeof(long), "sl_irq_flags");
  u32 __v ;
  u32 __v___0 ;
  u32 __v___1 ;
  u32 __v___2 ;
