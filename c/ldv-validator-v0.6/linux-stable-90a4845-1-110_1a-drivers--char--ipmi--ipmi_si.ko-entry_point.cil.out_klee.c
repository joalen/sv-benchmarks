...
struct si_sm_io {
   ...
   void *addr ;
   int regspacing ;
    klee_make_symbolic(&regspacing, sizeof(int), "regspacing");
   int regsize ;
    klee_make_symbolic(&regsize, sizeof(int), "regsize");
   int regshift ;
    klee_make_symbolic(&regshift, sizeof(int), "regshift");
   int addr_type ;
    klee_make_symbolic(&addr_type, sizeof(int), "addr_type");
   long addr_data ;
    klee_make_symbolic(&addr_data, sizeof(long), "addr_data");
};
enum si_sm_result {
...
struct pnp_card {
   ...
   unsigned char pnpver ;
    klee_make_symbolic(&pnpver, sizeof(char), "pnpver");
   unsigned char productver ;
    klee_make_symbolic(&productver, sizeof(char), "productver");
   unsigned int serial ;
...
struct pnp_dev {
   ...
   unsigned int num_dependent_sets ;
    klee_make_symbolic(&num_dependent_sets, sizeof(int), "num_dependent_sets");
   struct list_head resources ;
...
struct smi_info {
   ...
   unsigned int io_size ;
    klee_make_symbolic(&io_size, sizeof(int), "io_size");
   enum ipmi_addr_src addr_source ;
   void (*addr_source_cleanup)(struct smi_info * ) ;
   void *addr_source_data ;
   int (*oem_data_avail_handler)(struct smi_info * ) ;
   unsigned char msg_flags ;
    klee_make_symbolic(&msg_flags, sizeof(char), "msg_flags");
   char has_event_buffer ;
    klee_make_symbolic(&has_event_buffer, sizeof(char), "has_event_buffer");
   atomic_t req_events ;
   ...
   unsigned int spacing ;
    klee_make_symbolic(&spacing, sizeof(int), "spacing");
   int irq ;
   struct timer_list si_timer ;
   unsigned long last_timeout_jiffies ;
    klee_make_symbolic(&last_timeout_jiffies, sizeof(long), "last_timeout_jiffies");
   atomic_t stop_operation ;
   int interrupt_disabled ;
    klee_make_symbolic(&interrupt_disabled, sizeof(int), "interrupt_disabled");
   struct ipmi_device_id device_id ;
   struct device *dev ;
   struct platform_device *pdev ;
   int dev_registered ;
    klee_make_symbolic(&dev_registered, sizeof(int), "dev_registered");
...
struct acpi_device_wakeup {
   ...
   int run_wake_count ;
    klee_make_symbolic(&run_wake_count, sizeof(int), "run_wake_count");
};
struct acpi_device {
   int device_type ;
...
struct si_sm_data {
   ...
   int write_pos ;
    klee_make_symbolic(&write_pos, sizeof(int), "write_pos");
   int write_count ;
    klee_make_symbolic(&write_count, sizeof(int), "write_count");
   int orig_write_count ;
    klee_make_symbolic(&orig_write_count, sizeof(int), "orig_write_count");
   unsigned char read_data[272U] ;
   int read_pos ;
    klee_make_symbolic(&read_pos, sizeof(int), "read_pos");
   int truncated ;
    klee_make_symbolic(&truncated, sizeof(int), "truncated");
   unsigned int error_retries ;
    klee_make_symbolic(&error_retries, sizeof(int), "error_retries");
   long ibf_timeout ;
    klee_make_symbolic(&ibf_timeout, sizeof(long), "ibf_timeout");
   long obf_timeout ;
    klee_make_symbolic(&obf_timeout, sizeof(long), "obf_timeout");
   unsigned long error0_timeout ;
    klee_make_symbolic(&error0_timeout, sizeof(long), "error0_timeout");
};
...
struct si_sm_data___0 {
   ...
   unsigned int error_retries ;
   long smic_timeout ;
    klee_make_symbolic(&smic_timeout, sizeof(long), "smic_timeout");
};
...
struct si_sm_data___1 {
   ...
   int error_retries ;
   int nonzero_status ;
    klee_make_symbolic(&nonzero_status, sizeof(int), "nonzero_status");
   enum bt_states complete ;
   int BT_CAP_outreqs ;
    klee_make_symbolic(&BT_CAP_outreqs, sizeof(int), "BT_CAP_outreqs");
   long BT_CAP_req2rsp ;
    klee_make_symbolic(&BT_CAP_req2rsp, sizeof(long), "BT_CAP_req2rsp");
   int BT_CAP_retries ;
    klee_make_symbolic(&BT_CAP_retries, sizeof(int), "BT_CAP_retries");
};
...
static int num_force_kipmid  ;
    klee_make_symbolic(&num_force_kipmid, sizeof(int), "num_force_kipmid");
static int pci_registered  ;
    klee_make_symbolic(&pci_registered, sizeof(int), "pci_registered");
static int pnp_registered  ;
    klee_make_symbolic(&pnp_registered, sizeof(int), "pnp_registered");
static unsigned int kipmid_max_busy_us[4U]  ;
static int num_max_busy_us  ;
    klee_make_symbolic(&num_max_busy_us, sizeof(int), "num_max_busy_us");
...
{ 
  unsigned int max_busy_us ;
    klee_make_symbolic(&max_busy_us, sizeof(int), "max_busy_us");
  struct timespec now ;
  int tmp ;
  long tmp___0 ;
  int tmp___1 ;
...
{ 
  ...
  int busy_wait ;
    klee_make_symbolic(&busy_wait, sizeof(int), "busy_wait");
  int tmp___0 ;
...
{ 
  ...
  unsigned long jiffies_now ;
    klee_make_symbolic(&jiffies_now, sizeof(long), "jiffies_now");
  long time_diff ;
    klee_make_symbolic(&time_diff, sizeof(long), "time_diff");
  long timeout ;
...
static int smi_num  ;
    klee_make_symbolic(&smi_num, sizeof(int), "smi_num");
...
{ 
  unsigned long addr ;
  int mapsize ;
    klee_make_symbolic(&mapsize, sizeof(int), "mapsize");
...
{ 
  ...
  int addr_space ;
    klee_make_symbolic(&addr_space, sizeof(int), "addr_space");
  unsigned long addr ;
  int regspacing ;
  int regsize ;
  int regshift ;
  int irq ;
  int ipmb ;
    klee_make_symbolic(&ipmb, sizeof(int), "ipmb");
  int ival ;
    klee_make_symbolic(&ival, sizeof(int), "ival");
  int len ;
...
static int acpi_failure  ;
    klee_make_symbolic(&acpi_failure, sizeof(int), "acpi_failure");
...
{ 
  int rv ;
  int class_type ;
    klee_make_symbolic(&class_type, sizeof(int), "class_type");
  struct smi_info *info ;
  void *tmp ;
  int tmp___0 ;
...
{ 
  ...
  unsigned long resp_len ;
    klee_make_symbolic(&resp_len, sizeof(long), "resp_len");
  int rv ;
  void *tmp ;
  int tmp___0 ;
...
static int kcs_debug  ;
    klee_make_symbolic(&kcs_debug, sizeof(int), "kcs_debug");
...
static int bt_debug  ;
    klee_make_symbolic(&bt_debug, sizeof(int), "bt_debug");
...
{ 
  int i ;
  int msg_len ;
    klee_make_symbolic(&msg_len, sizeof(int), "msg_len");
  size_t __len ;
  void *__ret ;
