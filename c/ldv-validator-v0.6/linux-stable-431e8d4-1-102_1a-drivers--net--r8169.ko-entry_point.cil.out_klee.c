...
struct napi_struct {
   ...
   unsigned long state ;
   int weight ;
    klee_make_symbolic(&weight, sizeof(int), "weight");
...
struct net_device {
   ...
   unsigned short priv_flags ;
    klee_make_symbolic(&priv_flags, sizeof(short), "priv_flags");
...
struct linux_binfmt {
   ...
   int hasvdso ;
    klee_make_symbolic(&hasvdso, sizeof(int), "hasvdso");
};
struct siginfo;
...
struct rtl8169_private {
   ...
   int mac_version ;
    klee_make_symbolic(&mac_version, sizeof(int), "mac_version");
   u32 cur_rx ;
   u32 cur_tx ;
   u32 dirty_rx ;
   u32 dirty_tx ;
   ...
   int phy_1000_ctrl_reg ;
    klee_make_symbolic(&phy_1000_ctrl_reg, sizeof(int), "phy_1000_ctrl_reg");
   ...
   int pcie_cap ;
    klee_make_symbolic(&pcie_cap, sizeof(int), "pcie_cap");
...
static int use_dac  ;
    klee_make_symbolic(&use_dac, sizeof(int), "use_dac");
...
{ 
  ...
  void *ioaddr ;
  int giga_ctrl ;
    klee_make_symbolic(&giga_ctrl, sizeof(int), "giga_ctrl");
  int bmcr ;
    klee_make_symbolic(&bmcr, sizeof(int), "bmcr");
  int auto_nego ;
    klee_make_symbolic(&auto_nego, sizeof(int), "auto_nego");
  char const   *tmp___0 ;
  char const   *tmp___1 ;
  char const   *tmp___2 ;
...
{ 
  unsigned int msi ;
    klee_make_symbolic(&msi, sizeof(int), "msi");
  u8 cfg2 ;
  unsigned char tmp ;
  char const   *tmp___0 ;
  char const   *tmp___1 ;
...
{ 
  ...
  unsigned short tmp___44 ;
    klee_make_symbolic(&tmp___44, sizeof(short), "tmp___44");
  bool tmp___45 ;
...
{ 
  ...
  unsigned int cur_frag ;
    klee_make_symbolic(&cur_frag, sizeof(int), "cur_frag");
  unsigned int entry ;
  struct TxDesc *txd ;
  skb_frag_t *frag ;
  dma_addr_t mapping ;
...
{ 
  ...
  unsigned int tx_left ;
    klee_make_symbolic(&tx_left, sizeof(int), "tx_left");
  unsigned int entry ;
  struct ring_info *tx_skb ;
  u32 len ;
  u32 status ;
...
{ 
  ...
  unsigned int rx_left ;
    klee_make_symbolic(&rx_left, sizeof(int), "rx_left");
  unsigned int delta ;
...
{ 
  ...
  unsigned int intrmask ;
    klee_make_symbolic(&intrmask, sizeof(int), "intrmask");
  unsigned short tmp___0 ;
