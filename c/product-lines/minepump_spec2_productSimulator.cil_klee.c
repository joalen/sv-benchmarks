...
int __SELECTED_FEATURE_highWaterSensor  ;
    klee_make_symbolic(&__SELECTED_FEATURE_highWaterSensor, sizeof(int), "__SELECTED_FEATURE_highWaterSensor");
int __SELECTED_FEATURE_lowWaterSensor  ;
    klee_make_symbolic(&__SELECTED_FEATURE_lowWaterSensor, sizeof(int), "__SELECTED_FEATURE_lowWaterSensor");
int __SELECTED_FEATURE_methaneQuery  ;
    klee_make_symbolic(&__SELECTED_FEATURE_methaneQuery, sizeof(int), "__SELECTED_FEATURE_methaneQuery");
int __SELECTED_FEATURE_methaneAlarm  ;
    klee_make_symbolic(&__SELECTED_FEATURE_methaneAlarm, sizeof(int), "__SELECTED_FEATURE_methaneAlarm");
int __SELECTED_FEATURE_stopCommand  ;
    klee_make_symbolic(&__SELECTED_FEATURE_stopCommand, sizeof(int), "__SELECTED_FEATURE_stopCommand");
int __SELECTED_FEATURE_startCommand  ;
    klee_make_symbolic(&__SELECTED_FEATURE_startCommand, sizeof(int), "__SELECTED_FEATURE_startCommand");
...
int methAndRunningLastTime  ;
    klee_make_symbolic(&methAndRunningLastTime, sizeof(int), "methAndRunningLastTime");
void __utac_acc__Specification2_spec__1(void) 
{ 
