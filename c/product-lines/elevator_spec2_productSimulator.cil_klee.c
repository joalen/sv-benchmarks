...
int floorButtons_spc2_0  ;
    klee_make_symbolic(&floorButtons_spc2_0, sizeof(int), "floorButtons_spc2_0");
int floorButtons_spc2_1  ;
    klee_make_symbolic(&floorButtons_spc2_1, sizeof(int), "floorButtons_spc2_1");
int floorButtons_spc2_2  ;
    klee_make_symbolic(&floorButtons_spc2_2, sizeof(int), "floorButtons_spc2_2");
int floorButtons_spc2_3  ;
    klee_make_symbolic(&floorButtons_spc2_3, sizeof(int), "floorButtons_spc2_3");
int floorButtons_spc2_4  ;
    klee_make_symbolic(&floorButtons_spc2_4, sizeof(int), "floorButtons_spc2_4");
