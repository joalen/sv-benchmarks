...
int __SELECTED_FEATURE_Keys  ;
    klee_make_symbolic(&__SELECTED_FEATURE_Keys, sizeof(int), "__SELECTED_FEATURE_Keys");
int __SELECTED_FEATURE_Encrypt  ;
    klee_make_symbolic(&__SELECTED_FEATURE_Encrypt, sizeof(int), "__SELECTED_FEATURE_Encrypt");
int __SELECTED_FEATURE_AutoResponder  ;
    klee_make_symbolic(&__SELECTED_FEATURE_AutoResponder, sizeof(int), "__SELECTED_FEATURE_AutoResponder");
int __SELECTED_FEATURE_AddressBook  ;
    klee_make_symbolic(&__SELECTED_FEATURE_AddressBook, sizeof(int), "__SELECTED_FEATURE_AddressBook");
int __SELECTED_FEATURE_Sign  ;
    klee_make_symbolic(&__SELECTED_FEATURE_Sign, sizeof(int), "__SELECTED_FEATURE_Sign");
int __SELECTED_FEATURE_Forward  ;
    klee_make_symbolic(&__SELECTED_FEATURE_Forward, sizeof(int), "__SELECTED_FEATURE_Forward");
int __SELECTED_FEATURE_Verify  ;
    klee_make_symbolic(&__SELECTED_FEATURE_Verify, sizeof(int), "__SELECTED_FEATURE_Verify");
int __SELECTED_FEATURE_Decrypt  ;
    klee_make_symbolic(&__SELECTED_FEATURE_Decrypt, sizeof(int), "__SELECTED_FEATURE_Decrypt");
...
int __GUIDSL_NON_TERMINAL_main  ;
    klee_make_symbolic(&__GUIDSL_NON_TERMINAL_main, sizeof(int), "__GUIDSL_NON_TERMINAL_main");
...
int rjh  ;
    klee_make_symbolic(&rjh, sizeof(int), "rjh");
int chuck  ;
    klee_make_symbolic(&chuck, sizeof(int), "chuck");
...
int __ste_email_isSignatureVerified0  ;
    klee_make_symbolic(&__ste_email_isSignatureVerified0, sizeof(int), "__ste_email_isSignatureVerified0");
int __ste_email_isSignatureVerified1  ;
    klee_make_symbolic(&__ste_email_isSignatureVerified1, sizeof(int), "__ste_email_isSignatureVerified1");
int isVerified(int handle ) 
{ int retValue_acc ;
...
void test(void) 
{ int op1 ;
    klee_make_symbolic(&op1, sizeof(int), "op1");
  int op2 ;
    klee_make_symbolic(&op2, sizeof(int), "op2");
  int op3 ;
    klee_make_symbolic(&op3, sizeof(int), "op3");
  int op4 ;
    klee_make_symbolic(&op4, sizeof(int), "op4");
  int op5 ;
    klee_make_symbolic(&op5, sizeof(int), "op5");
  int op6 ;
    klee_make_symbolic(&op6, sizeof(int), "op6");
  int op7 ;
    klee_make_symbolic(&op7, sizeof(int), "op7");
  int op8 ;
    klee_make_symbolic(&op8, sizeof(int), "op8");
  int op9 ;
    klee_make_symbolic(&op9, sizeof(int), "op9");
  int op10 ;
    klee_make_symbolic(&op10, sizeof(int), "op10");
  int op11 ;
    klee_make_symbolic(&op11, sizeof(int), "op11");
  int splverifierCounter ;
    klee_make_symbolic(&splverifierCounter, sizeof(int), "splverifierCounter");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
  int tmp___2 ;
...
int queue_empty  =    1;
int queued_message  ;
    klee_make_symbolic(&queued_message, sizeof(int), "queued_message");
int queued_client  ;
    klee_make_symbolic(&queued_client, sizeof(int), "queued_client");
void mail(int client , int msg ) 
...
{ int receiver ;
    klee_make_symbolic(&receiver, sizeof(int), "receiver");
  int tmp ;
  int pubkey ;
    klee_make_symbolic(&pubkey, sizeof(int), "pubkey");
  int tmp___0 ;
...
{ int fwreceiver ;
    klee_make_symbolic(&fwreceiver, sizeof(int), "fwreceiver");
  int tmp ;
...
{ int __utac__ad__arg1 ;
  int __utac__ad__arg2 ;
    klee_make_symbolic(&__utac__ad__arg2, sizeof(int), "__utac__ad__arg2");
  int privkey ;
    klee_make_symbolic(&privkey, sizeof(int), "privkey");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
  int tmp___2 ;
...
{ int retValue_acc ;
  int client ;
    klee_make_symbolic(&client, sizeof(int), "client");
  int tmp ;
...
void sendEmail(int sender , int receiver ) 
{ int email ;
    klee_make_symbolic(&email, sizeof(int), "email");
  int tmp ;
...
void autoRespond(int client , int msg ) 
{ int sender ;
    klee_make_symbolic(&sender, sizeof(int), "sender");
  int tmp ;
