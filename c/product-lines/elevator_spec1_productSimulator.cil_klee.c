...
struct JoinPoint {
   ...
   void **args ;
   int argsCount ;
    klee_make_symbolic(&argsCount, sizeof(int), "argsCount");
   char const   **argsType ;
...
struct __UTAC__EXCEPTION {
   ...
   unsigned long long prtValue ;
    klee_make_symbolic(&prtValue, sizeof(long), "prtValue");
   int pops ;
    klee_make_symbolic(&pops, sizeof(int), "pops");
...
int __SELECTED_FEATURE_base  ;
    klee_make_symbolic(&__SELECTED_FEATURE_base, sizeof(int), "__SELECTED_FEATURE_base");
int __SELECTED_FEATURE_weight  ;
    klee_make_symbolic(&__SELECTED_FEATURE_weight, sizeof(int), "__SELECTED_FEATURE_weight");
int __SELECTED_FEATURE_empty  ;
    klee_make_symbolic(&__SELECTED_FEATURE_empty, sizeof(int), "__SELECTED_FEATURE_empty");
int __SELECTED_FEATURE_twothirdsfull  ;
    klee_make_symbolic(&__SELECTED_FEATURE_twothirdsfull, sizeof(int), "__SELECTED_FEATURE_twothirdsfull");
int __SELECTED_FEATURE_executivefloor  ;
    klee_make_symbolic(&__SELECTED_FEATURE_executivefloor, sizeof(int), "__SELECTED_FEATURE_executivefloor");
int __SELECTED_FEATURE_overloaded  ;
    klee_make_symbolic(&__SELECTED_FEATURE_overloaded, sizeof(int), "__SELECTED_FEATURE_overloaded");
int __GUIDSL_ROOT_PRODUCTION  ;
    klee_make_symbolic(&__GUIDSL_ROOT_PRODUCTION, sizeof(int), "__GUIDSL_ROOT_PRODUCTION");
int select_one(void) ;
...
int select_one(void) 
{ int retValue_acc ;
    klee_make_symbolic(&retValue_acc, sizeof(int), "retValue_acc");
...
int landingButtons_spc1_0  ;
    klee_make_symbolic(&landingButtons_spc1_0, sizeof(int), "landingButtons_spc1_0");
int landingButtons_spc1_1  ;
    klee_make_symbolic(&landingButtons_spc1_1, sizeof(int), "landingButtons_spc1_1");
int landingButtons_spc1_2  ;
    klee_make_symbolic(&landingButtons_spc1_2, sizeof(int), "landingButtons_spc1_2");
int landingButtons_spc1_3  ;
    klee_make_symbolic(&landingButtons_spc1_3, sizeof(int), "landingButtons_spc1_3");
int landingButtons_spc1_4  ;
    klee_make_symbolic(&landingButtons_spc1_4, sizeof(int), "landingButtons_spc1_4");
...
int calls_0  ;
    klee_make_symbolic(&calls_0, sizeof(int), "calls_0");
int calls_1  ;
    klee_make_symbolic(&calls_1, sizeof(int), "calls_1");
int calls_2  ;
    klee_make_symbolic(&calls_2, sizeof(int), "calls_2");
int calls_3  ;
    klee_make_symbolic(&calls_3, sizeof(int), "calls_3");
int calls_4  ;
    klee_make_symbolic(&calls_4, sizeof(int), "calls_4");
int personOnFloor_0_0  ;
    klee_make_symbolic(&personOnFloor_0_0, sizeof(int), "personOnFloor_0_0");
int personOnFloor_0_1  ;
    klee_make_symbolic(&personOnFloor_0_1, sizeof(int), "personOnFloor_0_1");
int personOnFloor_0_2  ;
    klee_make_symbolic(&personOnFloor_0_2, sizeof(int), "personOnFloor_0_2");
int personOnFloor_0_3  ;
    klee_make_symbolic(&personOnFloor_0_3, sizeof(int), "personOnFloor_0_3");
int personOnFloor_0_4  ;
    klee_make_symbolic(&personOnFloor_0_4, sizeof(int), "personOnFloor_0_4");
int personOnFloor_1_0  ;
    klee_make_symbolic(&personOnFloor_1_0, sizeof(int), "personOnFloor_1_0");
int personOnFloor_1_1  ;
    klee_make_symbolic(&personOnFloor_1_1, sizeof(int), "personOnFloor_1_1");
int personOnFloor_1_2  ;
    klee_make_symbolic(&personOnFloor_1_2, sizeof(int), "personOnFloor_1_2");
int personOnFloor_1_3  ;
    klee_make_symbolic(&personOnFloor_1_3, sizeof(int), "personOnFloor_1_3");
int personOnFloor_1_4  ;
    klee_make_symbolic(&personOnFloor_1_4, sizeof(int), "personOnFloor_1_4");
int personOnFloor_2_0  ;
    klee_make_symbolic(&personOnFloor_2_0, sizeof(int), "personOnFloor_2_0");
int personOnFloor_2_1  ;
    klee_make_symbolic(&personOnFloor_2_1, sizeof(int), "personOnFloor_2_1");
int personOnFloor_2_2  ;
    klee_make_symbolic(&personOnFloor_2_2, sizeof(int), "personOnFloor_2_2");
int personOnFloor_2_3  ;
    klee_make_symbolic(&personOnFloor_2_3, sizeof(int), "personOnFloor_2_3");
int personOnFloor_2_4  ;
    klee_make_symbolic(&personOnFloor_2_4, sizeof(int), "personOnFloor_2_4");
int personOnFloor_3_0  ;
    klee_make_symbolic(&personOnFloor_3_0, sizeof(int), "personOnFloor_3_0");
int personOnFloor_3_1  ;
    klee_make_symbolic(&personOnFloor_3_1, sizeof(int), "personOnFloor_3_1");
int personOnFloor_3_2  ;
    klee_make_symbolic(&personOnFloor_3_2, sizeof(int), "personOnFloor_3_2");
int personOnFloor_3_3  ;
    klee_make_symbolic(&personOnFloor_3_3, sizeof(int), "personOnFloor_3_3");
int personOnFloor_3_4  ;
    klee_make_symbolic(&personOnFloor_3_4, sizeof(int), "personOnFloor_3_4");
int personOnFloor_4_0  ;
    klee_make_symbolic(&personOnFloor_4_0, sizeof(int), "personOnFloor_4_0");
int personOnFloor_4_1  ;
    klee_make_symbolic(&personOnFloor_4_1, sizeof(int), "personOnFloor_4_1");
int personOnFloor_4_2  ;
    klee_make_symbolic(&personOnFloor_4_2, sizeof(int), "personOnFloor_4_2");
int personOnFloor_4_3  ;
    klee_make_symbolic(&personOnFloor_4_3, sizeof(int), "personOnFloor_4_3");
int personOnFloor_4_4  ;
    klee_make_symbolic(&personOnFloor_4_4, sizeof(int), "personOnFloor_4_4");
int personOnFloor_5_0  ;
    klee_make_symbolic(&personOnFloor_5_0, sizeof(int), "personOnFloor_5_0");
int personOnFloor_5_1  ;
    klee_make_symbolic(&personOnFloor_5_1, sizeof(int), "personOnFloor_5_1");
int personOnFloor_5_2  ;
    klee_make_symbolic(&personOnFloor_5_2, sizeof(int), "personOnFloor_5_2");
int personOnFloor_5_3  ;
    klee_make_symbolic(&personOnFloor_5_3, sizeof(int), "personOnFloor_5_3");
int personOnFloor_5_4  ;
    klee_make_symbolic(&personOnFloor_5_4, sizeof(int), "personOnFloor_5_4");
void initFloors(void) 
{ 
...
{ int __utac__ad__arg1 ;
    klee_make_symbolic(&__utac__ad__arg1, sizeof(int), "__utac__ad__arg1");
...
int persons_0  ;
    klee_make_symbolic(&persons_0, sizeof(int), "persons_0");
int persons_1  ;
    klee_make_symbolic(&persons_1, sizeof(int), "persons_1");
int persons_2  ;
    klee_make_symbolic(&persons_2, sizeof(int), "persons_2");
int persons_3  ;
    klee_make_symbolic(&persons_3, sizeof(int), "persons_3");
int persons_4  ;
    klee_make_symbolic(&persons_4, sizeof(int), "persons_4");
int persons_5  ;
    klee_make_symbolic(&persons_5, sizeof(int), "persons_5");
int doorState  =    1;
int floorButtons_0  ;
    klee_make_symbolic(&floorButtons_0, sizeof(int), "floorButtons_0");
int floorButtons_1  ;
    klee_make_symbolic(&floorButtons_1, sizeof(int), "floorButtons_1");
int floorButtons_2  ;
    klee_make_symbolic(&floorButtons_2, sizeof(int), "floorButtons_2");
int floorButtons_3  ;
    klee_make_symbolic(&floorButtons_3, sizeof(int), "floorButtons_3");
int floorButtons_4  ;
    klee_make_symbolic(&floorButtons_4, sizeof(int), "floorButtons_4");
void initTopDown(void) 
{ 
...
{ int retValue_acc ;
  int overload ;
    klee_make_symbolic(&overload, sizeof(int), "overload");
  int buttonPressed ;
    klee_make_symbolic(&buttonPressed, sizeof(int), "buttonPressed");
  int tmp ;
  int __cil_tmp8 ;
  int __cil_tmp9 ;
...
{ int maxLength ;
    klee_make_symbolic(&maxLength, sizeof(int), "maxLength");
  int tmp ;
  int counter ;
