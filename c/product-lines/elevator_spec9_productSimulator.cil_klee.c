...
int floorButtons_spc9_0  ;
    klee_make_symbolic(&floorButtons_spc9_0, sizeof(int), "floorButtons_spc9_0");
int floorButtons_spc9_1  ;
    klee_make_symbolic(&floorButtons_spc9_1, sizeof(int), "floorButtons_spc9_1");
int floorButtons_spc9_2  ;
    klee_make_symbolic(&floorButtons_spc9_2, sizeof(int), "floorButtons_spc9_2");
int floorButtons_spc9_3  ;
    klee_make_symbolic(&floorButtons_spc9_3, sizeof(int), "floorButtons_spc9_3");
int floorButtons_spc9_4  ;
    klee_make_symbolic(&floorButtons_spc9_4, sizeof(int), "floorButtons_spc9_4");
void __utac_acc__Specification9_spec__1(void) 
{ 
