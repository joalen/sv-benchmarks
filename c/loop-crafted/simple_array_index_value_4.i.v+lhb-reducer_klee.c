...
int main();
int __tmp_155_0;
    klee_make_symbolic(&__tmp_155_0, sizeof(int), "__tmp_155_0");
int __return_136;
    klee_make_symbolic(&__return_136, sizeof(int), "__return_136");
 int main()
 {
 unsigned int main__array[100000];
    klee_make_symbolic(main__array, sizeof(int)*100000, "main__array");
