...
int main();
int __tmp_259_0;
    klee_make_symbolic(&__tmp_259_0, sizeof(int), "__tmp_259_0");
int __return_305;
    klee_make_symbolic(&__return_305, sizeof(int), "__return_305");
int __tmp_383_0;
    klee_make_symbolic(&__tmp_383_0, sizeof(int), "__tmp_383_0");
 int main()
 {
