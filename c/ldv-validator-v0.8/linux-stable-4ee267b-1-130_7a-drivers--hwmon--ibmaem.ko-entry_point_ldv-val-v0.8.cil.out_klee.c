...
struct aem_ipmi_data {
   ...
   long tx_msgid ;
    klee_make_symbolic(&tx_msgid, sizeof(long), "tx_msgid");
   void *rx_msg_data ;
   unsigned short rx_msg_len ;
    klee_make_symbolic(&rx_msg_len, sizeof(short), "rx_msg_len");
   unsigned char rx_result ;
    klee_make_symbolic(&rx_result, sizeof(char), "rx_result");
   int rx_recv_type ;
    klee_make_symbolic(&rx_recv_type, sizeof(int), "rx_recv_type");
...
{ 
  unsigned short rx_len ;
    klee_make_symbolic(&rx_len, sizeof(short), "rx_len");
...
{ 
  ...
  u64 time ;
  long leftover ;
    klee_make_symbolic(&leftover, sizeof(long), "leftover");
  struct timespec b ;
  struct timespec a ;
  unsigned long tmp___0 ;
  s64 tmp___1 ;
