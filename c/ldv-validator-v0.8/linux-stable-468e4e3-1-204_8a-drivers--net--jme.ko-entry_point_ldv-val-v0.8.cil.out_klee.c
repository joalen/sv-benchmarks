...
struct dynpcc_info {
   unsigned long last_bytes ;
    klee_make_symbolic(&last_bytes, sizeof(long), "last_bytes");
   unsigned long last_pkts ;
    klee_make_symbolic(&last_pkts, sizeof(long), "last_pkts");
   unsigned long intr_cnt ;
    klee_make_symbolic(&intr_cnt, sizeof(long), "intr_cnt");
   unsigned char cur ;
    klee_make_symbolic(&cur, sizeof(char), "cur");
   unsigned char attempt ;
    klee_make_symbolic(&attempt, sizeof(char), "attempt");
   unsigned char cnt ;
...
struct jme_buffer_info {
   ...
   int len ;
   int nr_desc ;
    klee_make_symbolic(&nr_desc, sizeof(int), "nr_desc");
   unsigned long start_xmit ;
    klee_make_symbolic(&start_xmit, sizeof(long), "start_xmit");
};
struct jme_ring {
   void *alloc ;
   void *desc ;
...
struct jme_adapter {
   ...
   unsigned int fpgaver ;
    klee_make_symbolic(&fpgaver, sizeof(int), "fpgaver");
   u8 chiprev ;
   u8 chip_main_rev ;
   u8 chip_sub_rev ;
   u8 pcirev ;
...
{ 
  ...
  int again ;
    klee_make_symbolic(&again, sizeof(int), "again");
  u32 tmp___0 ;
  u32 tmp___1 ;
  u32 tmp___2 ;
  int tmp___3 ;
...
{ 
  ...
  int desccnt ;
    klee_make_symbolic(&desccnt, sizeof(int), "desccnt");
  int mask ;
  int tmp ;
  long tmp___0 ;
  int tmp___1 ;
...
{ 
  ...
  int nr_alloc ;
    klee_make_symbolic(&nr_alloc, sizeof(int), "nr_alloc");
  int mask ;
  unsigned char *tmp ;
  int tmp___0 ;
  long tmp___1 ;
...
{ 
  ...
  int rc ;
  int fdc ;
    klee_make_symbolic(&fdc, sizeof(int), "fdc");
  __u32 tmp___0 ;
...
{ 
  ...
  unsigned int duplex_chg ;
    klee_make_symbolic(&duplex_chg, sizeof(int), "duplex_chg");
  u16 val ;
