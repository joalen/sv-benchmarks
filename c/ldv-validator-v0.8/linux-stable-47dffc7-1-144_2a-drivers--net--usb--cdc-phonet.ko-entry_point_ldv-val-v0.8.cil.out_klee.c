...
struct usbpn_dev {
   ...
   unsigned int tx_pipe ;
    klee_make_symbolic(&tx_pipe, sizeof(int), "tx_pipe");
   unsigned int rx_pipe ;
    klee_make_symbolic(&rx_pipe, sizeof(int), "rx_pipe");
   u8 active_setting ;
   u8 disconnected ;
   unsigned int tx_queue ;
    klee_make_symbolic(&tx_queue, sizeof(int), "tx_queue");
   spinlock_t tx_lock ;
   spinlock_t rx_lock ;
...
{ 
  ...
  u8 *data ;
  int phonet ;
    klee_make_symbolic(&phonet, sizeof(int), "phonet");
  int len ;
  int err ;
  u8 dlen ;
  void *tmp___0 ;
