...
union double_int {
  double d;
    klee_make_symbolic(&d, sizeof(double), "d");
  int i;
...
int main();
double __return_104;
    klee_make_symbolic(&__return_104, sizeof(double), "__return_104");
 int main()
 {
 double main__a;
 double main__r;
 ...
 __tmp_1 = main__a;
 double inv__A;
    klee_make_symbolic(&inv__A, sizeof(double), "inv__A");
 inv__A = __tmp_1;
 double inv__xi;
    klee_make_symbolic(&inv__xi, sizeof(double), "inv__xi");
 double inv__xsi;
    klee_make_symbolic(&inv__xsi, sizeof(double), "inv__xsi");
 double inv__temp;
    klee_make_symbolic(&inv__temp, sizeof(double), "inv__temp");
 signed int inv__cond;
    klee_make_symbolic(&inv__cond, sizeof(int), "inv__cond");
 signed int inv__exp;
    klee_make_symbolic(&inv__exp, sizeof(int), "inv__exp");
 union double_int inv__A_u;
    klee_make_symbolic(&inv__A_u, sizeof(int), "inv__A_u");
 union double_int inv__xi_u;
    klee_make_symbolic(&inv__xi_u, sizeof(int), "inv__xi_u");
 inv__A_u.d = inv__A;
 ...
 int inv____CPAchecker_TMP_0;
    klee_make_symbolic(&inv____CPAchecker_TMP_0, sizeof(int), "inv____CPAchecker_TMP_0");
