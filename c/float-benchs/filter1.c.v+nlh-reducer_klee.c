...
int main();
int __tmp_129_0;
    klee_make_symbolic(&__tmp_129_0, sizeof(int), "__tmp_129_0");
int __tmp_129_1;
    klee_make_symbolic(&__tmp_129_1, sizeof(int), "__tmp_129_1");
int __tmp_129_2;
    klee_make_symbolic(&__tmp_129_2, sizeof(int), "__tmp_129_2");
int __tmp_112_0;
    klee_make_symbolic(&__tmp_112_0, sizeof(int), "__tmp_112_0");
int __return_134;
    klee_make_symbolic(&__return_134, sizeof(int), "__return_134");
 int main()
 {
 double main__E0;
 double main__E1;
    klee_make_symbolic(&main__E1, sizeof(double), "main__E1");
 double main__S;
    klee_make_symbolic(&main__S, sizeof(double), "main__S");
 int main__i;
