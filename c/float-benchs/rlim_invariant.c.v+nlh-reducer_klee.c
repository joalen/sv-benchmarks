...
int main();
int __tmp_160_0;
    klee_make_symbolic(&__tmp_160_0, sizeof(int), "__tmp_160_0");
int __tmp_160_1;
    klee_make_symbolic(&__tmp_160_1, sizeof(int), "__tmp_160_1");
int __tmp_160_2;
    klee_make_symbolic(&__tmp_160_2, sizeof(int), "__tmp_160_2");
int __tmp_142_0;
    klee_make_symbolic(&__tmp_142_0, sizeof(int), "__tmp_142_0");
int __tmp_142_1;
    klee_make_symbolic(&__tmp_142_1, sizeof(int), "__tmp_142_1");
int __tmp_136_0;
    klee_make_symbolic(&__tmp_136_0, sizeof(int), "__tmp_136_0");
int __return_165;
    klee_make_symbolic(&__return_165, sizeof(int), "__return_165");
 int main()
 {
 float main__X;
 float main__Y;
 ...
 float main__S;
    klee_make_symbolic(&main__S, sizeof(float), "main__S");
 float main__R;
