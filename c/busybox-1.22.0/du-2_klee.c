...
struct globals
{
  ...
  unsigned long int disp_hr;
    klee_make_symbolic(&disp_hr, sizeof(int), "disp_hr");
  // max_print_depth
  signed int max_print_depth;
    klee_make_symbolic(&max_print_depth, sizeof(int), "max_print_depth");
  // status
  _Bool status;
  // slink_depth
  signed int slink_depth;
    klee_make_symbolic(&slink_depth, sizeof(int), "slink_depth");
  // du_depth
  signed int du_depth;
    klee_make_symbolic(&du_depth, sizeof(int), "du_depth");
  // dir_dev
  unsigned long int dir_dev;
    klee_make_symbolic(&dir_dev, sizeof(int), "dir_dev");
};
...
signed int __main(signed int argc, char **argv)
{
  ...
  signed int slink_depth_save;
    klee_make_symbolic(&slink_depth_save, sizeof(int), "slink_depth_save");
  unsigned int opt;
