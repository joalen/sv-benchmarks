...
struct dnode
{
  ...
  signed char fname_allocated;
    klee_make_symbolic(&fname_allocated, sizeof(char), "fname_allocated");
  // dn_mode_lstat
  unsigned int dn_mode_lstat;
    klee_make_symbolic(&dn_mode_lstat, sizeof(int), "dn_mode_lstat");
  // dn_mode_stat
  unsigned int dn_mode_stat;
    klee_make_symbolic(&dn_mode_stat, sizeof(int), "dn_mode_stat");
  // dn_mode
  unsigned int dn_mode;
    klee_make_symbolic(&dn_mode, sizeof(int), "dn_mode");
  // dn_size
  signed long int dn_size;
    klee_make_symbolic(&dn_size, sizeof(int), "dn_size");
  // dn_atime
  signed long int dn_atime;
    klee_make_symbolic(&dn_atime, sizeof(int), "dn_atime");
  // dn_mtime
  signed long int dn_mtime;
    klee_make_symbolic(&dn_mtime, sizeof(int), "dn_mtime");
  // dn_ctime
  signed long int dn_ctime;
    klee_make_symbolic(&dn_ctime, sizeof(int), "dn_ctime");
  // dn_ino
  unsigned long int dn_ino;
    klee_make_symbolic(&dn_ino, sizeof(int), "dn_ino");
  // dn_blocks
  signed long int dn_blocks;
    klee_make_symbolic(&dn_blocks, sizeof(int), "dn_blocks");
  // dn_nlink
  unsigned long int dn_nlink;
    klee_make_symbolic(&dn_nlink, sizeof(int), "dn_nlink");
  // dn_uid
  unsigned int dn_uid;
    klee_make_symbolic(&dn_uid, sizeof(int), "dn_uid");
  // dn_gid
  unsigned int dn_gid;
    klee_make_symbolic(&dn_gid, sizeof(int), "dn_gid");
  // dn_rdev_maj
  signed int dn_rdev_maj;
    klee_make_symbolic(&dn_rdev_maj, sizeof(int), "dn_rdev_maj");
  // dn_rdev_min
  signed int dn_rdev_min;
    klee_make_symbolic(&dn_rdev_min, sizeof(int), "dn_rdev_min");
};
...
struct globals
{
  ...
  signed char show_color;
    klee_make_symbolic(&show_color, sizeof(char), "show_color");
  // exit_code
  signed char exit_code;
    klee_make_symbolic(&exit_code, sizeof(char), "exit_code");
  // all_fmt
  unsigned int all_fmt;
    klee_make_symbolic(&all_fmt, sizeof(int), "all_fmt");
  // terminal_width
  unsigned int terminal_width;
    klee_make_symbolic(&terminal_width, sizeof(int), "terminal_width");
  // current_time_t
  signed long int current_time_t;
    klee_make_symbolic(&current_time_t, sizeof(int), "current_time_t");
};
...
struct libbb_anonymous$0
{
  ...
  unsigned char opt_char;
    klee_make_symbolic(&opt_char, sizeof(char), "opt_char");
  // param_type
  signed char param_type;
    klee_make_symbolic(&param_type, sizeof(char), "param_type");
  // switch_on
  unsigned int switch_on;
    klee_make_symbolic(&switch_on, sizeof(int), "switch_on");
  // switch_off
  unsigned int switch_off;
    klee_make_symbolic(&switch_off, sizeof(int), "switch_off");
  // incongruously
  unsigned int incongruously;
    klee_make_symbolic(&incongruously, sizeof(int), "incongruously");
  // requires
  unsigned int requires;
    klee_make_symbolic(&requires, sizeof(int), "requires");
  // optarg
  void **optarg;
  // counter
  signed int *counter;
...
struct uni_stat_t
{
  ...
  unsigned int byte_count;
    klee_make_symbolic(&byte_count, sizeof(int), "byte_count");
  // unicode_count
  unsigned int unicode_count;
    klee_make_symbolic(&unicode_count, sizeof(int), "unicode_count");
  // unicode_width
  unsigned int unicode_width;
    klee_make_symbolic(&unicode_width, sizeof(int), "unicode_width");
};
...
static signed int bb_errno_location;
    klee_make_symbolic(&bb_errno_location, sizeof(int), "bb_errno_location");
...
static signed int die_sleep;
    klee_make_symbolic(&die_sleep, sizeof(int), "die_sleep");
...
static unsigned int option_mask32;
    klee_make_symbolic(&option_mask32, sizeof(int), "option_mask32");
...
static unsigned char unicode_status;
    klee_make_symbolic(&unicode_status, sizeof(char), "unicode_status");
// file libbb/procps.c line 25
...
static void bb_verror_msg(const char *s, va_list p, const char *strerr)
{
  ...
  signed int applet_len;
    klee_make_symbolic(&applet_len, sizeof(int), "applet_len");
  unsigned int strerr_len;
    klee_make_symbolic(&strerr_len, sizeof(int), "strerr_len");
  signed int msgeol_len;
    klee_make_symbolic(&msgeol_len, sizeof(int), "msgeol_len");
  signed int used;
...
{
  unsigned int dirs;
    klee_make_symbolic(&dirs, sizeof(int), "dirs");
  unsigned int all;
    klee_make_symbolic(&all, sizeof(int), "all");
  if(dn == ((struct dnode **)NULL))
...
static void display_files(struct dnode **dn, unsigned int nfiles)
{
  unsigned int i;
  unsigned int ncols;
    klee_make_symbolic(&ncols, sizeof(int), "ncols");
  unsigned int nrows;
    klee_make_symbolic(&nrows, sizeof(int), "nrows");
  unsigned int row;
    klee_make_symbolic(&row, sizeof(int), "row");
  unsigned int nc;
    klee_make_symbolic(&nc, sizeof(int), "nc");
  unsigned int column;
    klee_make_symbolic(&column, sizeof(int), "column");
  unsigned int nexttab;
    klee_make_symbolic(&nexttab, sizeof(int), "nexttab");
...
static unsigned int display_single(struct dnode *dn)
{
  ...
  struct stat statbuf;
  char append;
    klee_make_symbolic(&append, sizeof(char), "append");
  ...
  if(!((768u & ((struct globals *)&bb_common_bufsiz1)->all_fmt) == 0u))
  {
    ...
    klee_make_symbolic(&ttime, sizeof(int), "ttime");
...
static unsigned int getopt32(char **argv, const char *applet_opts, ...)
{
  ...
  char first_char;
    klee_make_symbolic(&first_char, sizeof(char), "first_char");
  signed int c;
...
signed int __main(signed int argc, char **argv)
{
  ...
  struct dnode *cur;
  unsigned int opt;
    klee_make_symbolic(&opt, sizeof(int), "opt");
  unsigned int nfiles;
    klee_make_symbolic(&nfiles, sizeof(int), "nfiles");
  unsigned int dnfiles;
    klee_make_symbolic(&dnfiles, sizeof(int), "dnfiles");
  unsigned int dndirs;
    klee_make_symbolic(&dndirs, sizeof(int), "dndirs");
  unsigned int i;
  ...
  if((_Bool)0)
  {
    ...
    klee_make_symbolic(&__s1_len, sizeof(int), "__s1_len");
          unsigned long int __s2_len;
    klee_make_symbolic(&__s2_len, sizeof(int), "__s2_len");
          if((_Bool)1)
          {
          ...
          if(!(tmp_if_expr$2 == (_Bool)0))
          {
            ...
            signed int __result;
    klee_make_symbolic(&__result, sizeof(int), "__result");
...
{
  unsigned int frac;
    klee_make_symbolic(&frac, sizeof(int), "frac");
  const char *u;
  const char *fmt;
  if(val == 0ul)
    return "0";
...
static const char * printable_string(struct uni_stat_t *stats, const char *str)
{
  ...
  static unsigned int cur_saved;
    klee_make_symbolic(&cur_saved, sizeof(int), "cur_saved");
...
{
  unsigned int dncnt;
    klee_make_symbolic(&dncnt, sizeof(int), "dncnt");
  unsigned int d;
...
static char * unicode_conv_to_printable2(struct uni_stat_t *stats, const char *src, unsigned int width, signed int flags)
{
  ...
  unsigned int dst_len;
    klee_make_symbolic(&dst_len, sizeof(int), "dst_len");
  unsigned int uni_count;
    klee_make_symbolic(&uni_count, sizeof(int), "uni_count");
  unsigned int uni_width;
    klee_make_symbolic(&uni_width, sizeof(int), "uni_width");
  char *tmp_post$2;
  char *tmp_post$3;
  ...
  while((_Bool)1)
  {
    ...
    signed int wc;
    klee_make_symbolic(&wc, sizeof(int), "wc");
...
static unsigned int xstrtou_range_sfx(const char *numstr, signed int base, unsigned int lower, unsigned int upper, struct suffix_mult *suffixes)
{
  ...
  signed int old_errno;
    klee_make_symbolic(&old_errno, sizeof(int), "old_errno");
  char *e;
  _Bool tmp_if_expr$1;
