...
struct tspec
{
  // fmt
  signed int fmt;
    klee_make_symbolic(&fmt, sizeof(int), "fmt");
  // size
  signed int size;
  ...
  signed int hexl_mode_trailer;
    klee_make_symbolic(&hexl_mode_trailer, sizeof(int), "hexl_mode_trailer");
  // field_width
  signed int field_width;
    klee_make_symbolic(&field_width, sizeof(int), "field_width");
};
...
static unsigned long int n_specs;
    klee_make_symbolic(&n_specs, sizeof(int), "n_specs");
...
static signed long int pseudo_offset;
    klee_make_symbolic(&pseudo_offset, sizeof(int), "pseudo_offset");
// file coreutils/od_bloaty.c line 183
static struct tspec *spec;
// file coreutils/od_bloaty.c line 179
static unsigned int string_min;
    klee_make_symbolic(&string_min, sizeof(int), "string_min");
...
static const char * decode_one_format(const char *s_orig, const char *s, struct tspec *tspec)
{
  signed int size_spec;
    klee_make_symbolic(&size_spec, sizeof(int), "size_spec");
  unsigned int size;
  signed int fmt;
  const char *p;
  char *end;
...
static void dump(signed long int current_offset, signed long int end_offset)
{
  ...
  unsigned long int n_bytes_read;
    klee_make_symbolic(&n_bytes_read, sizeof(int), "n_bytes_read");
  ...
  if(!((2u & option_mask32) == 0u))
    ...
    klee_make_symbolic(&n_needed, sizeof(int), "n_needed");
  ...
  {
    signed int l_c_m;
    klee_make_symbolic(&l_c_m, sizeof(int), "l_c_m");
    unsigned long int bytes_to_write;
    klee_make_symbolic(&bytes_to_write, sizeof(int), "bytes_to_write");
    l_c_m=get_lcm();
...
static void dump_strings(signed long int address, signed long int end_offset)
{
  ...
  {
    unsigned long int i;
    klee_make_symbolic(&i, sizeof(long), "i");
    signed int c;
    do
    {
...
signed int __main(signed int argc, char **argv)
{
  ...
  if(!((262144u & opt) == 0u))
  {
    ...
    if(!(*argv == ((char *)NULL)))
    {
      ...
      signed long int o1;
    klee_make_symbolic(&o1, sizeof(int), "o1");
      signed long int o2;
    klee_make_symbolic(&o2, sizeof(int), "o2");
...
static signed int parse_old_offset(const char *s, signed long int *offset)
{
  char *p;
  signed int radix;
    klee_make_symbolic(&radix, sizeof(int), "radix");
...
static void print_named_ascii(unsigned long int n_bytes, const char *block, const char *unused_fmt_string)
{
  ...
  do
  {
    ...
    klee_make_symbolic(&masked_c, sizeof(int), "masked_c");
    tmp_post$2 = block;
    block = block + 1l;
...
static void read_block(unsigned long int n, char *block, unsigned long int *n_bytes_in_buffer)
{
  ...
  *n_bytes_in_buffer = (unsigned long int)0;
  ...
  while(!(in_stream == ((struct _IO_FILE *)NULL)))
  {
    ...
    klee_make_symbolic(&n_read, sizeof(int), "n_read");
...
static void write_block(signed long int current_offset, unsigned long int n_bytes, const char *prev_block, const char *curr_block)
{
  ...
  else
  {
    ...
    klee_make_symbolic(&datum_width, sizeof(int), "datum_width");
        if((signed long int)(spec + (signed long int)i)->size >= 0l)
          (void)0;
    ...
    klee_make_symbolic(&blank_fields, sizeof(int), "blank_fields");
