...
struct control_info
{
  ...
  const unsigned char saneval;
    klee_make_symbolic(&saneval, sizeof(char), "saneval");
  // offset
  const unsigned char offset;
    klee_make_symbolic(&offset, sizeof(char), "offset");
};
...
struct globals
{
  ...
  unsigned int max_col;
    klee_make_symbolic(&max_col, sizeof(int), "max_col");
  // current_col
  unsigned int current_col;
    klee_make_symbolic(&current_col, sizeof(int), "current_col");
  // buf
  char buf[10l];
};
...
static void display_speed(struct termios *mode, signed int fancy)
{
  ...
  unsigned long int ispeed;
    klee_make_symbolic(&ispeed, sizeof(int), "ispeed");
  unsigned long int ospeed;
    klee_make_symbolic(&ospeed, sizeof(int), "ospeed");
...
{
  unsigned int baud;
    klee_make_symbolic(&baud, sizeof(int), "baud");
...
signed int __main(signed int argc, char **argv)
{
  ...
  signed int stty_state;
    klee_make_symbolic(&stty_state, sizeof(int), "stty_state");
  signed int k;
