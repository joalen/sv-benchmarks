...
unsigned int  Id_MCDC_104;
    klee_make_symbolic(&Id_MCDC_104, sizeof(int), "Id_MCDC_104");
UINT16 Id_MCDC_105;
UINT16 Id_MCDC_106;
...
{
int  Id_MCDC_141;
    klee_make_symbolic(&Id_MCDC_141, sizeof(int), "Id_MCDC_141");
void * Id_MCDC_142;
Id_MCDC_99();
return ;
}
...
void * Id_MCDC_148;
int  Id_MCDC_149;
    klee_make_symbolic(&Id_MCDC_149, sizeof(int), "Id_MCDC_149");
int  Id_MCDC_150;
    klee_make_symbolic(&Id_MCDC_150, sizeof(int), "Id_MCDC_150");
int  Id_MCDC_151;
    klee_make_symbolic(&Id_MCDC_151, sizeof(int), "Id_MCDC_151");
int  Id_MCDC_152;
    klee_make_symbolic(&Id_MCDC_152, sizeof(int), "Id_MCDC_152");
int  Id_MCDC_153;
    klee_make_symbolic(&Id_MCDC_153, sizeof(int), "Id_MCDC_153");
int  Id_MCDC_154;
    klee_make_symbolic(&Id_MCDC_154, sizeof(int), "Id_MCDC_154");
int  Id_MCDC_155;
    klee_make_symbolic(&Id_MCDC_155, sizeof(int), "Id_MCDC_155");
short  Id_MCDC_156;
    klee_make_symbolic(&Id_MCDC_156, sizeof(short), "Id_MCDC_156");
short  Id_MCDC_157;
    klee_make_symbolic(&Id_MCDC_157, sizeof(short), "Id_MCDC_157");
FILE* Id_MCDC_158;
unsigned short  Id_MCDC_159;
    klee_make_symbolic(&Id_MCDC_159, sizeof(short), "Id_MCDC_159");
unsigned short  Id_MCDC_160;
    klee_make_symbolic(&Id_MCDC_160, sizeof(short), "Id_MCDC_160");
unsigned short  Id_MCDC_161=0;
unsigned short  Id_MCDC_162=0;
char  Id_MCDC_163;
    klee_make_symbolic(&Id_MCDC_163, sizeof(char), "Id_MCDC_163");
char  Id_MCDC_164;
    klee_make_symbolic(&Id_MCDC_164, sizeof(char), "Id_MCDC_164");
