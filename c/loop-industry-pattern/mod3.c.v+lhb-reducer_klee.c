...
int main();
int __tmp_112_0;
    klee_make_symbolic(&__tmp_112_0, sizeof(int), "__tmp_112_0");
int __tmp_94_0;
    klee_make_symbolic(&__tmp_94_0, sizeof(int), "__tmp_94_0");
int __tmp_93_0;
    klee_make_symbolic(&__tmp_93_0, sizeof(int), "__tmp_93_0");
int __tmp_88_0;
    klee_make_symbolic(&__tmp_88_0, sizeof(int), "__tmp_88_0");
int __tmp_88_1;
    klee_make_symbolic(&__tmp_88_1, sizeof(int), "__tmp_88_1");
int __tmp_91_0;
    klee_make_symbolic(&__tmp_91_0, sizeof(int), "__tmp_91_0");
int __tmp_91_1;
    klee_make_symbolic(&__tmp_91_1, sizeof(int), "__tmp_91_1");
int __return_121;
    klee_make_symbolic(&__return_121, sizeof(int), "__return_121");
 int main()
 {
 unsigned int main__x;
    klee_make_symbolic(&main__x, sizeof(int), "main__x");
