...
struct _IO_FILE{
int  Id_MCDC_2;
    klee_make_symbolic(&Id_MCDC_2, sizeof(int), "Id_MCDC_2");
char * Id_MCDC_3;
char * Id_MCDC_4;
char * Id_MCDC_5;
char * Id_MCDC_6;
...
int  Id_MCDC_16;
    klee_make_symbolic(&Id_MCDC_16, sizeof(int), "Id_MCDC_16");
int  Id_MCDC_17;
    klee_make_symbolic(&Id_MCDC_17, sizeof(int), "Id_MCDC_17");
__off_t Id_MCDC_18;
unsigned short  Id_MCDC_19;
    klee_make_symbolic(&Id_MCDC_19, sizeof(short), "Id_MCDC_19");
signed char  Id_MCDC_20;
    klee_make_symbolic(&Id_MCDC_20, sizeof(char), "Id_MCDC_20");
char  Id_MCDC_21 [1];
...
size_t Id_MCDC_28;
int  Id_MCDC_29;
    klee_make_symbolic(&Id_MCDC_29, sizeof(int), "Id_MCDC_29");
char  Id_MCDC_30 [40];
} ;
...
typedef unsigned char  BYTE;
    klee_make_symbolic(&BYTE, sizeof(char), "BYTE");
struct Od_Index{
UINT16 Id_MCDC_86;
BYTE Id_MCDC_87;
BYTE Id_MCDC_88;
...
unsigned int  Id_MCDC_122;
    klee_make_symbolic(&Id_MCDC_122, sizeof(int), "Id_MCDC_122");
UINT16 Id_MCDC_123;
UINT16 Id_MCDC_124;
...
{
int  Id_MCDC_159;
    klee_make_symbolic(&Id_MCDC_159, sizeof(int), "Id_MCDC_159");
void * Id_MCDC_160;
Id_MCDC_117();
return ;
}
...
void * Id_MCDC_166;
int  Id_MCDC_167;
    klee_make_symbolic(&Id_MCDC_167, sizeof(int), "Id_MCDC_167");
int  Id_MCDC_168;
    klee_make_symbolic(&Id_MCDC_168, sizeof(int), "Id_MCDC_168");
int  Id_MCDC_169;
    klee_make_symbolic(&Id_MCDC_169, sizeof(int), "Id_MCDC_169");
int  Id_MCDC_170;
    klee_make_symbolic(&Id_MCDC_170, sizeof(int), "Id_MCDC_170");
int  Id_MCDC_171;
    klee_make_symbolic(&Id_MCDC_171, sizeof(int), "Id_MCDC_171");
int  Id_MCDC_172;
    klee_make_symbolic(&Id_MCDC_172, sizeof(int), "Id_MCDC_172");
int  Id_MCDC_173;
    klee_make_symbolic(&Id_MCDC_173, sizeof(int), "Id_MCDC_173");
short  Id_MCDC_174;
    klee_make_symbolic(&Id_MCDC_174, sizeof(short), "Id_MCDC_174");
short  Id_MCDC_175;
    klee_make_symbolic(&Id_MCDC_175, sizeof(short), "Id_MCDC_175");
FILE* Id_MCDC_176;
unsigned short  Id_MCDC_177;
    klee_make_symbolic(&Id_MCDC_177, sizeof(short), "Id_MCDC_177");
unsigned short  Id_MCDC_178;
    klee_make_symbolic(&Id_MCDC_178, sizeof(short), "Id_MCDC_178");
unsigned short  Id_MCDC_179=0;
unsigned short  Id_MCDC_180=0;
char  Id_MCDC_181;
    klee_make_symbolic(&Id_MCDC_181, sizeof(char), "Id_MCDC_181");
char  Id_MCDC_182;
    klee_make_symbolic(&Id_MCDC_182, sizeof(char), "Id_MCDC_182");
