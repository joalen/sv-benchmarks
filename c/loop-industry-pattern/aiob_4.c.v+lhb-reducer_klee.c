...
void reach_error() { __assert_fail("0", "aiob_4.c.v+lhb-reducer.c", 4, "reach_error"); }
...
struct _IO_FILE {
  int Id_MCDC_0;
    klee_make_symbolic(&Id_MCDC_0, sizeof(int), "Id_MCDC_0");
  char *Id_MCDC_1;
  char *Id_MCDC_2;
  char *Id_MCDC_3;
  char *Id_MCDC_4;
  ...
  int Id_MCDC_14;
    klee_make_symbolic(&Id_MCDC_14, sizeof(int), "Id_MCDC_14");
  int Id_MCDC_15;
    klee_make_symbolic(&Id_MCDC_15, sizeof(int), "Id_MCDC_15");
  __off_t Id_MCDC_16;
  unsigned short Id_MCDC_17;
    klee_make_symbolic(&Id_MCDC_17, sizeof(short), "Id_MCDC_17");
  signed char Id_MCDC_18;
    klee_make_symbolic(&Id_MCDC_18, sizeof(char), "Id_MCDC_18");
  char Id_MCDC_19[1];
    klee_make_symbolic(Id_MCDC_19, sizeof(char)*1, "Id_MCDC_19");
  ...
  size_t Id_MCDC_26;
  int Id_MCDC_27;
    klee_make_symbolic(&Id_MCDC_27, sizeof(int), "Id_MCDC_27");
  char Id_MCDC_28[40];
    klee_make_symbolic(Id_MCDC_28, sizeof(char)*40, "Id_MCDC_28");
} ;
...
typedef unsigned long long UINT64;
    klee_make_symbolic(&UINT64, sizeof(long), "UINT64");
typedef char INT8;
    klee_make_symbolic(&INT8, sizeof(char), "INT8");
typedef char CHAR;
    klee_make_symbolic(&CHAR, sizeof(char), "CHAR");
typedef char *STRING;
typedef short INT16;
    klee_make_symbolic(&INT16, sizeof(short), "INT16");
struct DeviceControl {
  INT8 *Id_MCDC_29;
  UINT16 *Id_MCDC_30;
  UINT16 *Id_MCDC_31;
...
typedef int INT32;
    klee_make_symbolic(&INT32, sizeof(int), "INT32");
struct PCMode {
  INT16 *Id_MCDC_38;
  INT32 *Id_MCDC_39;
  INT32 *Id_MCDC_40;
...
typedef long INT64;
    klee_make_symbolic(&INT64, sizeof(long), "INT64");
typedef float REAL32;
    klee_make_symbolic(&REAL32, sizeof(float), "REAL32");
...
UINT32 __tmp_1075_0;
int __tmp_1075_1;
    klee_make_symbolic(&__tmp_1075_1, sizeof(int), "__tmp_1075_1");
const UINT32 *__tmp_1075_2;
 ...
 int main__Id_MCDC_103;
    klee_make_symbolic(&main__Id_MCDC_103, sizeof(int), "main__Id_MCDC_103");
 int main__Id_MCDC_104;
    klee_make_symbolic(&main__Id_MCDC_104, sizeof(int), "main__Id_MCDC_104");
 int main__Id_MCDC_105;
    klee_make_symbolic(&main__Id_MCDC_105, sizeof(int), "main__Id_MCDC_105");
 int main__Id_MCDC_106;
    klee_make_symbolic(&main__Id_MCDC_106, sizeof(int), "main__Id_MCDC_106");
 int main__Id_MCDC_107;
    klee_make_symbolic(&main__Id_MCDC_107, sizeof(int), "main__Id_MCDC_107");
 int main__Id_MCDC_108;
    klee_make_symbolic(&main__Id_MCDC_108, sizeof(int), "main__Id_MCDC_108");
 int main__Id_MCDC_109;
    klee_make_symbolic(&main__Id_MCDC_109, sizeof(int), "main__Id_MCDC_109");
 short main__Id_MCDC_110;
    klee_make_symbolic(&main__Id_MCDC_110, sizeof(short), "main__Id_MCDC_110");
 short main__Id_MCDC_111;
    klee_make_symbolic(&main__Id_MCDC_111, sizeof(short), "main__Id_MCDC_111");
 FILE *main__Id_MCDC_112;
 unsigned short main__Id_MCDC_113;
    klee_make_symbolic(&main__Id_MCDC_113, sizeof(short), "main__Id_MCDC_113");
 unsigned short main__Id_MCDC_114;
    klee_make_symbolic(&main__Id_MCDC_114, sizeof(short), "main__Id_MCDC_114");
 unsigned short main__Id_MCDC_115 = 0;
 unsigned short main__Id_MCDC_116 = 0;
 char main__Id_MCDC_117;
    klee_make_symbolic(&main__Id_MCDC_117, sizeof(char), "main__Id_MCDC_117");
 char main__Id_MCDC_118;
    klee_make_symbolic(&main__Id_MCDC_118, sizeof(char), "main__Id_MCDC_118");
 ...
 int Id_MCDC_89____CPAchecker_TMP_1;
    klee_make_symbolic(&Id_MCDC_89____CPAchecker_TMP_1, sizeof(int), "Id_MCDC_89____CPAchecker_TMP_1");
 if (Id_MCDC_93 >= 0)
 {
 if (Id_MCDC_93 < 42)
 {
 ...
 int __VERIFIER_assert__Id_MCDC_92;
    klee_make_symbolic(&__VERIFIER_assert__Id_MCDC_92, sizeof(int), "__VERIFIER_assert__Id_MCDC_92");
