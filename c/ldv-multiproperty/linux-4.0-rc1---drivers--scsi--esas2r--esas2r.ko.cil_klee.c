...
struct __anonstruct____missing_field_name_260 {
   ...
   u8 temp_state ;
   short temp_value ;
    klee_make_symbolic(&temp_value, sizeof(short), "temp_value");
   short temp_lower_lim ;
    klee_make_symbolic(&temp_lower_lim, sizeof(short), "temp_lower_lim");
   short temp_upper_lim ;
    klee_make_symbolic(&temp_upper_lim, sizeof(short), "temp_upper_lim");
   char temp_desc[32U] ;
   u8 reserved2[20U] ;
};
...
struct esas2r_sg_context {
   ...
   u8 *exp_offset ;
   int num_sgel ;
    klee_make_symbolic(&num_sgel, sizeof(int), "num_sgel");
   int sgel_count ;
    klee_make_symbolic(&sgel_count, sizeof(int), "sgel_count");
};
...
struct esas2r_firmware {
   ...
   u64 phys ;
   int orig_len ;
    klee_make_symbolic(&orig_len, sizeof(int), "orig_len");
   void *header_buff ;
...
struct esas2r_adapter {
   ...
   int nvram_command_done ;
    klee_make_symbolic(&nvram_command_done, sizeof(int), "nvram_command_done");
   wait_queue_head_t fm_api_waiter ;
   int fm_api_command_done ;
    klee_make_symbolic(&fm_api_command_done, sizeof(int), "fm_api_command_done");
   wait_queue_head_t vda_waiter ;
   int vda_command_done ;
    klee_make_symbolic(&vda_command_done, sizeof(int), "vda_command_done");
   u8 *vda_buffer ;
   u64 ppvda_buffer ;
   wait_queue_head_t fs_api_waiter ;
   int fs_api_command_done ;
    klee_make_symbolic(&fs_api_command_done, sizeof(int), "fs_api_command_done");
   u64 ppfs_api_buffer ;
   u8 *fs_api_buffer ;
   u32 fs_api_buffer_size ;
   wait_queue_head_t buffered_ioctl_waiter ;
   int buffered_ioctl_done ;
    klee_make_symbolic(&buffered_ioctl_done, sizeof(int), "buffered_ioctl_done");
   int uncached_size ;
    klee_make_symbolic(&uncached_size, sizeof(int), "uncached_size");
   ...
   int num_vrqs ;
    klee_make_symbolic(&num_vrqs, sizeof(int), "num_vrqs");
...
struct atto_vda_adapter_info {
   ...
   u8 reserved ;
   short utc_offset ;
    klee_make_symbolic(&utc_offset, sizeof(short), "utc_offset");
   u32 utc_time ;
   u32 features ;
   u32 valid_features ;
...
struct atto_csmi_pc_ctrl {
   ...
   signed char tx_amplitude ;
    klee_make_symbolic(&tx_amplitude, sizeof(char), "tx_amplitude");
   signed char tx_preemphasis ;
    klee_make_symbolic(&tx_preemphasis, sizeof(char), "tx_preemphasis");
   signed char tx_slew_rate ;
    klee_make_symbolic(&tx_slew_rate, sizeof(char), "tx_slew_rate");
   signed char tx_reserved[13U] ;
   u8 tx_vendor_unique[64U] ;
   u32 rx_flags ;
   signed char rx_threshold ;
    klee_make_symbolic(&rx_threshold, sizeof(char), "rx_threshold");
   signed char rx_equalization_gain ;
    klee_make_symbolic(&rx_equalization_gain, sizeof(char), "rx_equalization_gain");
...
int sgl_page_size ;
    klee_make_symbolic(&sgl_page_size, sizeof(int), "sgl_page_size");
int num_sg_lists ;
    klee_make_symbolic(&num_sg_lists, sizeof(int), "num_sg_lists");
int num_requests ;
    klee_make_symbolic(&num_requests, sizeof(int), "num_requests");
int num_ae_requests ;
    klee_make_symbolic(&num_ae_requests, sizeof(int), "num_ae_requests");
int interrupt_mode ;
...
{ 
  int unalign ;
    klee_make_symbolic(&unalign, sizeof(int), "unalign");
...
{ 
  ...
  struct esas2r_adapter *a ;
  int rez ;
    klee_make_symbolic(&rez, sizeof(int), "rez");
  int tmp___0 ;
  bool tmp___1 ;
  int tmp___2 ;
  int tmp___3 ;
...
{ 
  int pcie_cap_reg ;
    klee_make_symbolic(&pcie_cap_reg, sizeof(int), "pcie_cap_reg");
  u16 devcontrol ;
...
{ 
  int startreqs ;
    klee_make_symbolic(&startreqs, sizeof(int), "startreqs");
  struct esas2r_request *rq ;
  unsigned long flags ;
  int tmp ;
  int tmp___0 ;
...
{ 
  ...
  int tmp ;
  int size___0 ;
    klee_make_symbolic(&size___0, sizeof(int), "size___0");
  int _min1 ;
...
int esas2r_max_sectors ;
    klee_make_symbolic(&esas2r_max_sectors, sizeof(int), "esas2r_max_sectors");
int sg_tablesize ;
...
static int found_adapters  ;
    klee_make_symbolic(&found_adapters, sizeof(int), "found_adapters");
...
static int esas2r_proc_major  ;
    klee_make_symbolic(&esas2r_proc_major, sizeof(int), "esas2r_proc_major");
long esas2r_proc_ioctl(struct file *fp , unsigned int cmd , unsigned long arg ) 
{ 
  int tmp ;
...
{ 
  ...
  struct esas2r_target *t ;
  int dev_count ;
    klee_make_symbolic(&dev_count, sizeof(int), "dev_count");
  char const   *tmp ;
...
{ 
  ...
  unsigned int ldv_0_ldv_param_22_1_default ;
    klee_make_symbolic(&ldv_0_ldv_param_22_1_default, sizeof(int), "ldv_0_ldv_param_22_1_default");
...
{ 
  ...
  int ldv_3_ldv_param_23_1_default ;
    klee_make_symbolic(&ldv_3_ldv_param_23_1_default, sizeof(int), "ldv_3_ldv_param_23_1_default");
  struct seq_file *ldv_3_ldv_param_27_0_default ;
  int ldv_3_ldv_param_4_1_default ;
    klee_make_symbolic(&ldv_3_ldv_param_4_1_default, sizeof(int), "ldv_3_ldv_param_4_1_default");
...
{ 
  ...
  long long ldv_4_ldv_param_9_4_default ;
    klee_make_symbolic(&ldv_4_ldv_param_9_4_default, sizeof(long), "ldv_4_ldv_param_9_4_default");
  unsigned long ldv_4_ldv_param_9_5_default ;
    klee_make_symbolic(&ldv_4_ldv_param_9_5_default, sizeof(long), "ldv_4_ldv_param_9_5_default");
  void *tmp ;
  void *tmp___0 ;
  int tmp___1 ;
  int tmp___2 ;
...
{ 
  ...
  long long ldv_5_ldv_param_9_4_default ;
    klee_make_symbolic(&ldv_5_ldv_param_9_4_default, sizeof(long), "ldv_5_ldv_param_9_4_default");
  unsigned long ldv_5_ldv_param_9_5_default ;
    klee_make_symbolic(&ldv_5_ldv_param_9_5_default, sizeof(long), "ldv_5_ldv_param_9_5_default");
  void *tmp ;
  void *tmp___0 ;
  int tmp___1 ;
  int tmp___2 ;
...
{ 
  ...
  long long ldv_6_ldv_param_3_4_default ;
    klee_make_symbolic(&ldv_6_ldv_param_3_4_default, sizeof(long), "ldv_6_ldv_param_3_4_default");
  unsigned long ldv_6_ldv_param_3_5_default ;
    klee_make_symbolic(&ldv_6_ldv_param_3_5_default, sizeof(long), "ldv_6_ldv_param_3_5_default");
  char *ldv_6_ldv_param_9_3_default ;
  long long ldv_6_ldv_param_9_4_default ;
    klee_make_symbolic(&ldv_6_ldv_param_9_4_default, sizeof(long), "ldv_6_ldv_param_9_4_default");
  unsigned long ldv_6_ldv_param_9_5_default ;
    klee_make_symbolic(&ldv_6_ldv_param_9_5_default, sizeof(long), "ldv_6_ldv_param_9_5_default");
  void *tmp ;
  void *tmp___0 ;
  int tmp___1 ;
  int tmp___2 ;
...
{ 
  ...
  long long ldv_7_ldv_param_3_4_default ;
    klee_make_symbolic(&ldv_7_ldv_param_3_4_default, sizeof(long), "ldv_7_ldv_param_3_4_default");
  unsigned long ldv_7_ldv_param_3_5_default ;
    klee_make_symbolic(&ldv_7_ldv_param_3_5_default, sizeof(long), "ldv_7_ldv_param_3_5_default");
  char *ldv_7_ldv_param_9_3_default ;
  long long ldv_7_ldv_param_9_4_default ;
    klee_make_symbolic(&ldv_7_ldv_param_9_4_default, sizeof(long), "ldv_7_ldv_param_9_4_default");
  unsigned long ldv_7_ldv_param_9_5_default ;
    klee_make_symbolic(&ldv_7_ldv_param_9_5_default, sizeof(long), "ldv_7_ldv_param_9_5_default");
  void *tmp ;
  void *tmp___0 ;
  int tmp___1 ;
  int tmp___2 ;
...
{ 
  ...
  long long ldv_8_ldv_param_3_4_default ;
    klee_make_symbolic(&ldv_8_ldv_param_3_4_default, sizeof(long), "ldv_8_ldv_param_3_4_default");
  unsigned long ldv_8_ldv_param_3_5_default ;
    klee_make_symbolic(&ldv_8_ldv_param_3_5_default, sizeof(long), "ldv_8_ldv_param_3_5_default");
  char *ldv_8_ldv_param_9_3_default ;
  long long ldv_8_ldv_param_9_4_default ;
    klee_make_symbolic(&ldv_8_ldv_param_9_4_default, sizeof(long), "ldv_8_ldv_param_9_4_default");
  unsigned long ldv_8_ldv_param_9_5_default ;
    klee_make_symbolic(&ldv_8_ldv_param_9_5_default, sizeof(long), "ldv_8_ldv_param_9_5_default");
  void *tmp ;
  void *tmp___0 ;
  int tmp___1 ;
  int tmp___2 ;
...
{ 
  ...
  long long ldv_9_ldv_param_3_4_default ;
    klee_make_symbolic(&ldv_9_ldv_param_3_4_default, sizeof(long), "ldv_9_ldv_param_3_4_default");
  unsigned long ldv_9_ldv_param_3_5_default ;
    klee_make_symbolic(&ldv_9_ldv_param_3_5_default, sizeof(long), "ldv_9_ldv_param_3_5_default");
  char *ldv_9_ldv_param_9_3_default ;
  long long ldv_9_ldv_param_9_4_default ;
    klee_make_symbolic(&ldv_9_ldv_param_9_4_default, sizeof(long), "ldv_9_ldv_param_9_4_default");
  unsigned long ldv_9_ldv_param_9_5_default ;
    klee_make_symbolic(&ldv_9_ldv_param_9_5_default, sizeof(long), "ldv_9_ldv_param_9_5_default");
  void *tmp ;
  void *tmp___0 ;
  int tmp___1 ;
  int tmp___2 ;
