...
struct snd_seq_addr {
   unsigned char client ;
    klee_make_symbolic(&client, sizeof(char), "client");
   unsigned char port ;
    klee_make_symbolic(&port, sizeof(char), "port");
};
struct snd_seq_oss_arg {
   int app_index ;
    klee_make_symbolic(&app_index, sizeof(int), "app_index");
   int file_mode ;
    klee_make_symbolic(&file_mode, sizeof(int), "file_mode");
   int seq_mode ;
    klee_make_symbolic(&seq_mode, sizeof(int), "seq_mode");
   struct snd_seq_addr addr ;
   void *private_data ;
   int event_passing ;
    klee_make_symbolic(&event_passing, sizeof(int), "event_passing");
};
struct snd_seq_device {
   ...
   char name[80U] ;
   int argsize ;
    klee_make_symbolic(&argsize, sizeof(int), "argsize");
   void *driver_data ;
   int status ;
...
struct seq_oss_chinfo {
   ...
   int vel ;
    klee_make_symbolic(&vel, sizeof(int), "vel");
};
...
struct seq_oss_synthinfo {
   ...
   int is_midi ;
    klee_make_symbolic(&is_midi, sizeof(int), "is_midi");
   int midi_mapped ;
    klee_make_symbolic(&midi_mapped, sizeof(int), "midi_mapped");
};
...
struct seq_oss_devinfo {
   int index ;
   int cseq ;
    klee_make_symbolic(&cseq, sizeof(int), "cseq");
   int port ;
   int queue ;
   ...
   int synth_opened ;
    klee_make_symbolic(&synth_opened, sizeof(int), "synth_opened");
...
typedef unsigned char snd_seq_event_type_t;
    klee_make_symbolic(&snd_seq_event_type_t, sizeof(char), "snd_seq_event_type_t");
...
struct snd_seq_ev_note {
   ...
   unsigned char velocity ;
    klee_make_symbolic(&velocity, sizeof(char), "velocity");
   unsigned char off_velocity ;
    klee_make_symbolic(&off_velocity, sizeof(char), "off_velocity");
...
struct snd_seq_ev_ctrl {
   ...
   unsigned char unused2 ;
    klee_make_symbolic(&unused2, sizeof(char), "unused2");
   unsigned char unused3 ;
    klee_make_symbolic(&unused3, sizeof(char), "unused3");
   unsigned int param ;
...
typedef unsigned int snd_seq_tick_time_t;
    klee_make_symbolic(&snd_seq_tick_time_t, sizeof(int), "snd_seq_tick_time_t");
...
struct snd_seq_event {
   ...
   unsigned char flags ;
   char tag ;
    klee_make_symbolic(&tag, sizeof(char), "tag");
   unsigned char queue ;
   union snd_seq_timestamp time ;
...
struct snd_seq_port_info {
   ...
   int midi_channels ;
    klee_make_symbolic(&midi_channels, sizeof(int), "midi_channels");
   int midi_voices ;
    klee_make_symbolic(&midi_voices, sizeof(int), "midi_voices");
   int synth_voices ;
    klee_make_symbolic(&synth_voices, sizeof(int), "synth_voices");
   int read_use ;
    klee_make_symbolic(&read_use, sizeof(int), "read_use");
   int write_use ;
    klee_make_symbolic(&write_use, sizeof(int), "write_use");
   void *kernel ;
   unsigned int flags ;
   unsigned char time_queue ;
    klee_make_symbolic(&time_queue, sizeof(char), "time_queue");
   char reserved[59U] ;
};
struct snd_seq_queue_info {
   int queue ;
   int owner ;
    klee_make_symbolic(&owner, sizeof(int), "owner");
...
struct snd_seq_port_subscribe {
   ...
   struct snd_seq_addr dest ;
   unsigned int voices ;
    klee_make_symbolic(&voices, sizeof(int), "voices");
   unsigned int flags ;
   unsigned char queue ;
   unsigned char pad[3U] ;
   char reserved[64U] ;
...
typedef unsigned int reltime_t;
    klee_make_symbolic(&reltime_t, sizeof(int), "reltime_t");
typedef unsigned int abstime_t;
    klee_make_symbolic(&abstime_t, sizeof(int), "abstime_t");
struct seq_oss_writeq {
   struct seq_oss_devinfo *dp ;
   int maxlen ;
   abstime_t sync_time ;
   int sync_event_put ;
    klee_make_symbolic(&sync_event_put, sizeof(int), "sync_event_put");
...
struct seq_oss_readq {
   ...
   unsigned long input_time ;
    klee_make_symbolic(&input_time, sizeof(long), "input_time");
...
struct seq_oss_timer {
   ...
   reltime_t cur_tick ;
   int realtime ;
    klee_make_symbolic(&realtime, sizeof(int), "realtime");
   int running ;
   int tempo ;
    klee_make_symbolic(&tempo, sizeof(int), "tempo");
   int ppq ;
    klee_make_symbolic(&ppq, sizeof(int), "ppq");
   int oss_tempo ;
    klee_make_symbolic(&oss_tempo, sizeof(int), "oss_tempo");
   int oss_timebase ;
    klee_make_symbolic(&oss_timebase, sizeof(int), "oss_timebase");
};
struct evrec_short {
   unsigned char code ;
    klee_make_symbolic(&code, sizeof(char), "code");
   unsigned char parm1 ;
    klee_make_symbolic(&parm1, sizeof(char), "parm1");
   unsigned char dev ;
    klee_make_symbolic(&dev, sizeof(char), "dev");
   unsigned char parm2 ;
    klee_make_symbolic(&parm2, sizeof(char), "parm2");
};
struct evrec_note {
   unsigned char code ;
   unsigned char chn ;
    klee_make_symbolic(&chn, sizeof(char), "chn");
   unsigned char note ;
   unsigned char vel ;
};
struct evrec_timer {
   ...
   unsigned char dummy1 ;
    klee_make_symbolic(&dummy1, sizeof(char), "dummy1");
   unsigned char dummy2 ;
    klee_make_symbolic(&dummy2, sizeof(char), "dummy2");
   unsigned int time ;
};
struct evrec_extended {
   ...
   unsigned char p2 ;
    klee_make_symbolic(&p2, sizeof(char), "p2");
   unsigned char p3 ;
    klee_make_symbolic(&p3, sizeof(char), "p3");
   unsigned char p4 ;
    klee_make_symbolic(&p4, sizeof(char), "p4");
};
struct evrec_long {
   unsigned char code ;
   unsigned char dev ;
...
struct evrec_voice {
   ...
   unsigned char note ;
   unsigned char parm ;
    klee_make_symbolic(&parm, sizeof(char), "parm");
   unsigned short dummy ;
    klee_make_symbolic(&dummy, sizeof(short), "dummy");
};
struct evrec_sysex {
   unsigned char code ;
   unsigned char dev ;
...
union evrec {
   ...
   unsigned int echo ;
    klee_make_symbolic(&echo, sizeof(int), "echo");
   unsigned char c[8U] ;
};
struct snd_seq_queue_tempo {
   ...
   unsigned int skew_value ;
    klee_make_symbolic(&skew_value, sizeof(int), "skew_value");
   unsigned int skew_base ;
    klee_make_symbolic(&skew_base, sizeof(int), "skew_base");
   char reserved[24U] ;
};
struct exec_domain;
struct map_segment;
...
struct snd_seq_oss_reg {
   ...
   int nvoices ;
    klee_make_symbolic(&nvoices, sizeof(int), "nvoices");
...
struct seq_oss_synth {
   int seq_device ;
    klee_make_symbolic(&seq_device, sizeof(int), "seq_device");
   int synth_type ;
   int synth_subtype ;
   int nr_voices ;
   char name[30U] ;
...
typedef int snd_seq_client_type_t;
    klee_make_symbolic(&snd_seq_client_type_t, sizeof(int), "snd_seq_client_type_t");
struct snd_seq_client_info {
   ...
   int event_lost ;
    klee_make_symbolic(&event_lost, sizeof(int), "event_lost");
   char reserved[64U] ;
};
struct snd_midi_event {
   ...
   unsigned char lastcmd ;
    klee_make_symbolic(&lastcmd, sizeof(char), "lastcmd");
   unsigned char nostat ;
    klee_make_symbolic(&nostat, sizeof(char), "nostat");
   int bufsize ;
...
struct snd_seq_client_pool {
   int client ;
   int output_pool ;
    klee_make_symbolic(&output_pool, sizeof(int), "output_pool");
   int input_pool ;
    klee_make_symbolic(&input_pool, sizeof(int), "input_pool");
   int output_room ;
    klee_make_symbolic(&output_room, sizeof(int), "output_room");
   int output_free ;
    klee_make_symbolic(&output_free, sizeof(int), "output_free");
   int input_free ;
    klee_make_symbolic(&input_free, sizeof(int), "input_free");
   char reserved[64U] ;
};
struct snd_seq_remove_events {
   unsigned int remove_mode ;
    klee_make_symbolic(&remove_mode, sizeof(int), "remove_mode");
   union snd_seq_timestamp time ;
   unsigned char queue ;
   struct snd_seq_addr dest ;
   unsigned char channel ;
...
{ 
  ...
  unsigned int ldv_0_ldv_param_29_1_default ;
    klee_make_symbolic(&ldv_0_ldv_param_29_1_default, sizeof(int), "ldv_0_ldv_param_29_1_default");
...
static int num_clients  ;
    klee_make_symbolic(&num_clients, sizeof(int), "num_clients");
...
static int max_synth_devs  ;
    klee_make_symbolic(&max_synth_devs, sizeof(int), "max_synth_devs");
...
{ 
  int i ;
  int send ;
    klee_make_symbolic(&send, sizeof(int), "send");
  unsigned char *dest ;
  struct seq_oss_synth_sysex *sysex ;
  int tmp ;
  void *tmp___0 ;
...
static int max_midi_devs  ;
    klee_make_symbolic(&max_midi_devs, sizeof(int), "max_midi_devs");
...
{ 
  int perm ;
    klee_make_symbolic(&perm, sizeof(int), "perm");
  struct seq_oss_midi *mdev ;
  struct snd_seq_port_subscribe subs ;
  int tmp ;
  int tmp___0 ;
