...
struct buffer_head {
   unsigned long b_state ;
    klee_make_symbolic(&b_state, sizeof(long), "b_state");
...
struct meta_entry {
   ...
   unsigned int index_block ;
    klee_make_symbolic(&index_block, sizeof(int), "index_block");
   unsigned short offset ;
    klee_make_symbolic(&offset, sizeof(short), "offset");
   unsigned short pad ;
    klee_make_symbolic(&pad, sizeof(short), "pad");
};
struct meta_index {
   unsigned int inode_number ;
    klee_make_symbolic(&inode_number, sizeof(int), "inode_number");
   unsigned int offset ;
   unsigned short entries ;
    klee_make_symbolic(&entries, sizeof(short), "entries");
   unsigned short skip ;
   unsigned short locked ;
    klee_make_symbolic(&locked, sizeof(short), "locked");
   unsigned short pad ;
...
struct squashfs_cache {
   ...
   int entries ;
   int curr_blk ;
    klee_make_symbolic(&curr_blk, sizeof(int), "curr_blk");
   int next_blk ;
    klee_make_symbolic(&next_blk, sizeof(int), "next_blk");
   int num_waiters ;
    klee_make_symbolic(&num_waiters, sizeof(int), "num_waiters");
   int unused ;
...
struct squashfs_sb_info {
   ...
   int devblksize ;
    klee_make_symbolic(&devblksize, sizeof(int), "devblksize");
   int devblksize_log2 ;
    klee_make_symbolic(&devblksize_log2, sizeof(int), "devblksize_log2");
   struct squashfs_cache *block_cache ;
   struct squashfs_cache *fragment_cache ;
   struct squashfs_cache *read_page ;
   int next_meta_index ;
    klee_make_symbolic(&next_meta_index, sizeof(int), "next_meta_index");
   __le64 *id_table ;
   ...
   unsigned short block_log ;
    klee_make_symbolic(&block_log, sizeof(short), "block_log");
   long long bytes_used ;
    klee_make_symbolic(&bytes_used, sizeof(long), "bytes_used");
   unsigned int inodes ;
    klee_make_symbolic(&inodes, sizeof(int), "inodes");
   int xattr_ids ;
    klee_make_symbolic(&xattr_ids, sizeof(int), "xattr_ids");
};
struct squashfs_decompressor {
   ...
   char *name ;
   int supported ;
    klee_make_symbolic(&supported, sizeof(int), "supported");
};
struct squashfs_page_actor {
   void **page ;
   int pages ;
   int length ;
   int next_page ;
    klee_make_symbolic(&next_page, sizeof(int), "next_page");
};
struct __wait_queue;
...
struct __anonstruct____missing_field_name_215 {
   ...
   int fragment_offset ;
    klee_make_symbolic(&fragment_offset, sizeof(int), "fragment_offset");
   u64 block_list_start ;
};
struct __anonstruct____missing_field_name_216 {
   u64 dir_idx_start ;
   int dir_idx_offset ;
    klee_make_symbolic(&dir_idx_offset, sizeof(int), "dir_idx_offset");
   int dir_idx_cnt ;
    klee_make_symbolic(&dir_idx_cnt, sizeof(int), "dir_idx_cnt");
   int parent ;
...
struct squashfs_inode_info {
   ...
   unsigned int xattr_size ;
    klee_make_symbolic(&xattr_size, sizeof(int), "xattr_size");
   int xattr_count ;
    klee_make_symbolic(&xattr_count, sizeof(int), "xattr_count");
...
struct comp_opts {
   int dict_size ;
    klee_make_symbolic(&dict_size, sizeof(int), "dict_size");
};
enum hrtimer_restart;
...
struct z_stream_s {
   ...
   void *workspace ;
   int data_type ;
    klee_make_symbolic(&data_type, sizeof(int), "data_type");
   uLong adler ;
   uLong reserved ;
};
...
{ 
  ...
  int compressed ;
    klee_make_symbolic(&compressed, sizeof(int), "compressed");
  int b ;
  int k ;
  ...
  int pg_offset ;
    klee_make_symbolic(&pg_offset, sizeof(int), "pg_offset");
  void *data ;
  void *tmp___3 ;
  int _min1 ;
...
{ 
  ...
  unsigned int dir_count ;
    klee_make_symbolic(&dir_count, sizeof(int), "dir_count");
  unsigned int size ;
  unsigned int type ;
...
{ 
  ...
  long long ldv_0_ldv_param_20_1_default ;
    klee_make_symbolic(&ldv_0_ldv_param_20_1_default, sizeof(long), "ldv_0_ldv_param_20_1_default");
  int ldv_0_ldv_param_20_2_default ;
    klee_make_symbolic(&ldv_0_ldv_param_20_2_default, sizeof(int), "ldv_0_ldv_param_20_2_default");
...
{ 
  struct squashfs_sb_info *msblk ;
  int blk ;
    klee_make_symbolic(&blk, sizeof(int), "blk");
  int offset ;
  u64 start ;
  __le64 ino ;
  int err ;
...
{ 
  ...
  unsigned int parent_ino___0 ;
    klee_make_symbolic(&parent_ino___0, sizeof(int), "parent_ino___0");
...
{ 
  ...
  struct squashfs_inode_info *tmp___1 ;
  int cur_offset ;
    klee_make_symbolic(&cur_offset, sizeof(int), "cur_offset");
...
{ 
  u64 start ;
  long long blks ;
    klee_make_symbolic(&blks, sizeof(long), "blks");
  int offset ;
  __le32 size ;
  int res ;
  int tmp ;
...
{ 
  ...
  int index ;
  int file_end ;
    klee_make_symbolic(&file_end, sizeof(int), "file_end");
  loff_t tmp ;
  int res ;
  void *pageaddr ;
  struct _ddebug descriptor ;
...
{ 
  ...
  int xattr_id ;
    klee_make_symbolic(&xattr_id, sizeof(int), "xattr_id");
  struct _ddebug descriptor ;
  long tmp ;
  unsigned int frag_offset ;
    klee_make_symbolic(&frag_offset, sizeof(int), "frag_offset");
  unsigned int frag ;
    klee_make_symbolic(&frag, sizeof(int), "frag");
  int frag_size ;
    klee_make_symbolic(&frag_size, sizeof(int), "frag_size");
  u64 frag_blk ;
  ...
  unsigned int frag_offset___0 ;
    klee_make_symbolic(&frag_offset___0, sizeof(int), "frag_offset___0");
  unsigned int frag___0 ;
    klee_make_symbolic(&frag___0, sizeof(int), "frag___0");
  int frag_size___0 ;
    klee_make_symbolic(&frag_size___0, sizeof(int), "frag_size___0");
  u64 frag_blk___0 ;
  ...
  unsigned int rdev ;
    klee_make_symbolic(&rdev, sizeof(int), "rdev");
  dev_t tmp___33 ;
  ...
  unsigned int rdev___0 ;
    klee_make_symbolic(&rdev___0, sizeof(int), "rdev___0");
  dev_t tmp___35 ;
...
{ 
  ...
  unsigned int ino_num ;
    klee_make_symbolic(&ino_num, sizeof(int), "ino_num");
  long long ino ;
  struct _ddebug descriptor___0 ;
  long tmp___7 ;
  int tmp___8 ;
...
{ 
  ...
  long long root_inode ;
    klee_make_symbolic(&root_inode, sizeof(long), "root_inode");
  unsigned short flags ;
...
{ 
  ...
  int ldv_4_ldv_param_9_2_default ;
    klee_make_symbolic(&ldv_4_ldv_param_9_2_default, sizeof(int), "ldv_4_ldv_param_9_2_default");
  int ldv_4_ldv_param_9_3_default ;
    klee_make_symbolic(&ldv_4_ldv_param_9_3_default, sizeof(int), "ldv_4_ldv_param_9_3_default");
  int tmp ;
  int tmp___0 ;
...
{ 
  ...
  unsigned long ldv_5_ldv_param_10_2_default ;
    klee_make_symbolic(&ldv_5_ldv_param_10_2_default, sizeof(long), "ldv_5_ldv_param_10_2_default");
  unsigned int ldv_5_ldv_param_13_2_default ;
    klee_make_symbolic(&ldv_5_ldv_param_13_2_default, sizeof(int), "ldv_5_ldv_param_13_2_default");
  char *ldv_5_ldv_param_17_1_default ;
  int ldv_5_ldv_param_17_2_default ;
    klee_make_symbolic(&ldv_5_ldv_param_17_2_default, sizeof(int), "ldv_5_ldv_param_17_2_default");
  char *ldv_5_ldv_param_7_1_default ;
  unsigned long ldv_5_ldv_param_7_3_default ;
    klee_make_symbolic(&ldv_5_ldv_param_7_3_default, sizeof(long), "ldv_5_ldv_param_7_3_default");
  int tmp ;
  void *tmp___0 ;
  void *tmp___1 ;
  void *tmp___2 ;
...
{ 
  ...
  int ldv_6_ldv_param_9_4_default ;
    klee_make_symbolic(&ldv_6_ldv_param_9_4_default, sizeof(int), "ldv_6_ldv_param_9_4_default");
  int ldv_6_ldv_param_9_5_default ;
    klee_make_symbolic(&ldv_6_ldv_param_9_5_default, sizeof(int), "ldv_6_ldv_param_9_5_default");
  int tmp ;
  void *tmp___0 ;
  int tmp___1 ;
...
{ 
  ...
  int ldv_7_ldv_param_9_4_default ;
    klee_make_symbolic(&ldv_7_ldv_param_9_4_default, sizeof(int), "ldv_7_ldv_param_9_4_default");
  int ldv_7_ldv_param_9_5_default ;
    klee_make_symbolic(&ldv_7_ldv_param_9_5_default, sizeof(int), "ldv_7_ldv_param_9_5_default");
  int tmp ;
  void *tmp___0 ;
  int tmp___1 ;
...
{ 
  ...
  int ldv_8_ldv_param_3_2_default ;
    klee_make_symbolic(&ldv_8_ldv_param_3_2_default, sizeof(int), "ldv_8_ldv_param_3_2_default");
  struct buffer_head **ldv_8_ldv_param_9_2_default ;
  int ldv_8_ldv_param_9_3_default ;
    klee_make_symbolic(&ldv_8_ldv_param_9_3_default, sizeof(int), "ldv_8_ldv_param_9_3_default");
  int ldv_8_ldv_param_9_4_default ;
    klee_make_symbolic(&ldv_8_ldv_param_9_4_default, sizeof(int), "ldv_8_ldv_param_9_4_default");
  int ldv_8_ldv_param_9_5_default ;
    klee_make_symbolic(&ldv_8_ldv_param_9_5_default, sizeof(int), "ldv_8_ldv_param_9_5_default");
  int tmp ;
  void *tmp___0 ;
  int tmp___1 ;
...
{ 
  ...
  int ldv_9_ldv_param_3_2_default ;
    klee_make_symbolic(&ldv_9_ldv_param_3_2_default, sizeof(int), "ldv_9_ldv_param_3_2_default");
  struct buffer_head **ldv_9_ldv_param_9_2_default ;
  int ldv_9_ldv_param_9_3_default ;
    klee_make_symbolic(&ldv_9_ldv_param_9_3_default, sizeof(int), "ldv_9_ldv_param_9_3_default");
  int ldv_9_ldv_param_9_4_default ;
    klee_make_symbolic(&ldv_9_ldv_param_9_4_default, sizeof(int), "ldv_9_ldv_param_9_4_default");
  int ldv_9_ldv_param_9_5_default ;
    klee_make_symbolic(&ldv_9_ldv_param_9_5_default, sizeof(int), "ldv_9_ldv_param_9_5_default");
  int tmp ;
  void *tmp___0 ;
  int tmp___1 ;
...
{ 
  ...
  int ldv_10_ldv_param_9_1_default ;
    klee_make_symbolic(&ldv_10_ldv_param_9_1_default, sizeof(int), "ldv_10_ldv_param_9_1_default");
...
{ 
  ...
  unsigned long ldv_11_ldv_param_3_3_default ;
    klee_make_symbolic(&ldv_11_ldv_param_3_3_default, sizeof(long), "ldv_11_ldv_param_3_3_default");
  int ldv_11_ldv_param_3_4_default ;
    klee_make_symbolic(&ldv_11_ldv_param_3_4_default, sizeof(int), "ldv_11_ldv_param_3_4_default");
  ...
  unsigned long ldv_11_ldv_param_9_4_default ;
    klee_make_symbolic(&ldv_11_ldv_param_9_4_default, sizeof(long), "ldv_11_ldv_param_9_4_default");
  int ldv_11_ldv_param_9_5_default ;
    klee_make_symbolic(&ldv_11_ldv_param_9_5_default, sizeof(int), "ldv_11_ldv_param_9_5_default");
  void *tmp ;
  void *tmp___0 ;
  void *tmp___1 ;
  int tmp___2 ;
...
{ 
  ...
  unsigned long ldv_12_ldv_param_3_3_default ;
    klee_make_symbolic(&ldv_12_ldv_param_3_3_default, sizeof(long), "ldv_12_ldv_param_3_3_default");
  int ldv_12_ldv_param_3_4_default ;
    klee_make_symbolic(&ldv_12_ldv_param_3_4_default, sizeof(int), "ldv_12_ldv_param_3_4_default");
  char *ldv_12_ldv_param_9_1_default ;
  unsigned long ldv_12_ldv_param_9_2_default ;
    klee_make_symbolic(&ldv_12_ldv_param_9_2_default, sizeof(long), "ldv_12_ldv_param_9_2_default");
  char *ldv_12_ldv_param_9_3_default ;
  unsigned long ldv_12_ldv_param_9_4_default ;
    klee_make_symbolic(&ldv_12_ldv_param_9_4_default, sizeof(long), "ldv_12_ldv_param_9_4_default");
  int ldv_12_ldv_param_9_5_default ;
    klee_make_symbolic(&ldv_12_ldv_param_9_5_default, sizeof(int), "ldv_12_ldv_param_9_5_default");
  void *tmp ;
  void *tmp___0 ;
  void *tmp___1 ;
  int tmp___2 ;
...
{ 
  ...
  unsigned long ldv_13_ldv_param_3_3_default ;
    klee_make_symbolic(&ldv_13_ldv_param_3_3_default, sizeof(long), "ldv_13_ldv_param_3_3_default");
  int ldv_13_ldv_param_3_4_default ;
    klee_make_symbolic(&ldv_13_ldv_param_3_4_default, sizeof(int), "ldv_13_ldv_param_3_4_default");
  char *ldv_13_ldv_param_9_1_default ;
  unsigned long ldv_13_ldv_param_9_2_default ;
    klee_make_symbolic(&ldv_13_ldv_param_9_2_default, sizeof(long), "ldv_13_ldv_param_9_2_default");
  char *ldv_13_ldv_param_9_3_default ;
  unsigned long ldv_13_ldv_param_9_4_default ;
    klee_make_symbolic(&ldv_13_ldv_param_9_4_default, sizeof(long), "ldv_13_ldv_param_9_4_default");
  int ldv_13_ldv_param_9_5_default ;
    klee_make_symbolic(&ldv_13_ldv_param_9_5_default, sizeof(int), "ldv_13_ldv_param_9_5_default");
  void *tmp ;
  void *tmp___0 ;
  void *tmp___1 ;
  int tmp___2 ;
...
{ 
  ...
  int name_size ;
    klee_make_symbolic(&name_size, sizeof(int), "name_size");
  int prefix_size ;
    klee_make_symbolic(&prefix_size, sizeof(int), "prefix_size");
  size_t tmp___2 ;
  int tmp___3 ;
...
{ 
  ...
  struct squashfs_inode_info *tmp___1 ;
  int name_len ;
    klee_make_symbolic(&name_len, sizeof(int), "name_len");
  size_t tmp___2 ;
  int err ;
  int vsize ;
    klee_make_symbolic(&vsize, sizeof(int), "vsize");
  char *target ;
  void *tmp___3 ;
  struct squashfs_xattr_entry entry ;
  struct squashfs_xattr_val val ;
...
{ 
  int zlib_err ;
    klee_make_symbolic(&zlib_err, sizeof(int), "zlib_err");
  int zlib_init___0 ;
    klee_make_symbolic(&zlib_init___0, sizeof(int), "zlib_init___0");
  int k ;
  z_stream *stream ;
  void *tmp ;
  int avail ;
