...
struct fw_card {
   ...
   int current_tlabel ;
    klee_make_symbolic(&current_tlabel, sizeof(int), "current_tlabel");
   u64 tlabel_mask ;
   ...
   unsigned int split_timeout_cycles ;
    klee_make_symbolic(&split_timeout_cycles, sizeof(int), "split_timeout_cycles");
   unsigned int split_timeout_jiffies ;
    klee_make_symbolic(&split_timeout_jiffies, sizeof(int), "split_timeout_jiffies");
   unsigned long long guid ;
    klee_make_symbolic(&guid, sizeof(long), "guid");
   unsigned int max_receive ;
    klee_make_symbolic(&max_receive, sizeof(int), "max_receive");
   int link_speed ;
    klee_make_symbolic(&link_speed, sizeof(int), "link_speed");
   int config_rom_generation ;
    klee_make_symbolic(&config_rom_generation, sizeof(int), "config_rom_generation");
   spinlock_t lock ;
   ...
   u8 color ;
   int gap_count ;
    klee_make_symbolic(&gap_count, sizeof(int), "gap_count");
   ...
   int bm_retries ;
    klee_make_symbolic(&bm_retries, sizeof(int), "bm_retries");
   int bm_generation ;
    klee_make_symbolic(&bm_generation, sizeof(int), "bm_generation");
   int bm_node_id ;
    klee_make_symbolic(&bm_node_id, sizeof(int), "bm_node_id");
   bool bm_abdicate ;
...
struct fw_device {
   ...
   int config_rom_retries ;
    klee_make_symbolic(&config_rom_retries, sizeof(int), "config_rom_retries");
...
struct fw_packet {
   ...
   int ack ;
    klee_make_symbolic(&ack, sizeof(int), "ack");
   struct list_head link ;
   void *driver_data ;
};
...
struct fw_iso_packet {
   ...
   unsigned char header_length ;
    klee_make_symbolic(&header_length, sizeof(char), "header_length");
   u32 header[0U] ;
};
struct fw_iso_buffer {
   ...
   int page_count_mapped ;
    klee_make_symbolic(&page_count_mapped, sizeof(int), "page_count_mapped");
};
...
struct fw_transaction {
   int node_id ;
   int tlabel ;
    klee_make_symbolic(&tlabel, sizeof(int), "tlabel");
   struct list_head link ;
   struct fw_card *card ;
...
static int descriptor_count  ;
    klee_make_symbolic(&descriptor_count, sizeof(int), "descriptor_count");
...
{ 
  ...
  struct fw_node *root_node ;
  int root_id ;
    klee_make_symbolic(&root_id, sizeof(int), "root_id");
  int new_root_id ;
    klee_make_symbolic(&new_root_id, sizeof(int), "new_root_id");
  int irm_id ;
    klee_make_symbolic(&irm_id, sizeof(int), "irm_id");
  int bm_id ;
    klee_make_symbolic(&bm_id, sizeof(int), "bm_id");
  int local_id ;
    klee_make_symbolic(&local_id, sizeof(int), "local_id");
  int gap_count ;
  int generation ;
  int grace ;
    klee_make_symbolic(&grace, sizeof(int), "grace");
  int rcode ;
  bool do_reset ;
...
{ 
  ...
  unsigned long buffer_end ;
    klee_make_symbolic(&buffer_end, sizeof(long), "buffer_end");
  unsigned long transmit_header_bytes ;
    klee_make_symbolic(&transmit_header_bytes, sizeof(long), "transmit_header_bytes");
  u32 control ;
  int count ;
...
int fw_cdev_major  ;
    klee_make_symbolic(&fw_cdev_major, sizeof(int), "fw_cdev_major");
...
{ 
  ...
  int last_key ;
    klee_make_symbolic(&last_key, sizeof(int), "last_key");
  int key ;
...
{ 
  unsigned int quadlets ;
    klee_make_symbolic(&quadlets, sizeof(int), "quadlets");
  unsigned int i ;
  char c ;
...
{ 
  ...
  int value ;
  int specifier_id ;
    klee_make_symbolic(&specifier_id, sizeof(int), "specifier_id");
  int version ;
  int tmp ;
  int tmp___0 ;
...
{ 
  unsigned long uaddr ;
    klee_make_symbolic(&uaddr, sizeof(long), "uaddr");
  int i ;
  int err ;
...
{ 
  int depths[2U] ;
  int max_child_hops ;
    klee_make_symbolic(&max_child_hops, sizeof(int), "max_child_hops");
  int i ;
  int _max1 ;
...
{ 
  ...
  int child_port_count ;
    klee_make_symbolic(&child_port_count, sizeof(int), "child_port_count");
  int phy_id ;
    klee_make_symbolic(&phy_id, sizeof(int), "phy_id");
  int parent_count ;
    klee_make_symbolic(&parent_count, sizeof(int), "parent_count");
  int stack_depth ;
    klee_make_symbolic(&stack_depth, sizeof(int), "stack_depth");
  int gap_count ;
  bool beta_repeaters_present ;
  int tmp ;
...
{ 
  int b_path ;
    klee_make_symbolic(&b_path, sizeof(int), "b_path");
...
{ 
  int node_count ;
    klee_make_symbolic(&node_count, sizeof(int), "node_count");
  __be32 *map ;
  __be32 *tmp ;
  __u32 tmp___0 ;
  __be32 *tmp___1 ;
...
{ 
  int ext_tcode ;
    klee_make_symbolic(&ext_tcode, sizeof(int), "ext_tcode");
  int __ret_warn_on ;
  long tmp ;
...
{ 
  int tcode ;
    klee_make_symbolic(&tcode, sizeof(int), "tcode");
  int ext_tcode ;
  int data_length ;
    klee_make_symbolic(&data_length, sizeof(int), "data_length");
  int __ret_warn_on ;
  long tmp ;
...
{ 
  ...
  int tlabel ;
  int extended_tcode ;
    klee_make_symbolic(&extended_tcode, sizeof(int), "extended_tcode");
  int source ;
    klee_make_symbolic(&source, sizeof(int), "source");
  int destination ;
    klee_make_symbolic(&destination, sizeof(int), "destination");
  int __ret_warn_on ;
  long tmp ;
...
{ 
  unsigned int cycles ;
    klee_make_symbolic(&cycles, sizeof(int), "cycles");
  u32 timestamp ;
...
{ 
  ...
  u32 length ;
  int request_tcode ;
    klee_make_symbolic(&request_tcode, sizeof(int), "request_tcode");
  void *tmp ;
...
{ 
  ...
  int ldv_2_probed_default ;
    klee_make_symbolic(&ldv_2_probed_default, sizeof(int), "ldv_2_probed_default");
  void *tmp ;
  int tmp___0 ;
  int tmp___1 ;
  int tmp___2 ;
...
{ 
  ...
  unsigned long ldv_6_ldv_param_9_3_default ;
    klee_make_symbolic(&ldv_6_ldv_param_9_3_default, sizeof(long), "ldv_6_ldv_param_9_3_default");
  void *tmp ;
  void *tmp___0 ;
  int tmp___1 ;
  int tmp___2 ;
...
{ 
  ...
  unsigned long ldv_7_ldv_param_9_3_default ;
    klee_make_symbolic(&ldv_7_ldv_param_9_3_default, sizeof(long), "ldv_7_ldv_param_9_3_default");
  void *tmp ;
  void *tmp___0 ;
  int tmp___1 ;
  int tmp___2 ;
...
{ 
  ...
  unsigned long ldv_8_ldv_param_9_3_default ;
    klee_make_symbolic(&ldv_8_ldv_param_9_3_default, sizeof(long), "ldv_8_ldv_param_9_3_default");
  void *tmp ;
  void *tmp___0 ;
  int tmp___1 ;
  int tmp___2 ;
...
{ 
  ...
  unsigned long ldv_9_ldv_param_9_3_default ;
    klee_make_symbolic(&ldv_9_ldv_param_9_3_default, sizeof(long), "ldv_9_ldv_param_9_3_default");
  void *tmp ;
  void *tmp___0 ;
  int tmp___1 ;
  int tmp___2 ;
...
{ 
  ...
  int ldv_12_ldv_param_3_2_default ;
    klee_make_symbolic(&ldv_12_ldv_param_3_2_default, sizeof(int), "ldv_12_ldv_param_3_2_default");
  int ldv_12_ldv_param_3_3_default ;
    klee_make_symbolic(&ldv_12_ldv_param_3_3_default, sizeof(int), "ldv_12_ldv_param_3_3_default");
  ...
  int ldv_12_ldv_param_3_5_default ;
    klee_make_symbolic(&ldv_12_ldv_param_3_5_default, sizeof(int), "ldv_12_ldv_param_3_5_default");
  unsigned long long ldv_12_ldv_param_3_6_default ;
    klee_make_symbolic(&ldv_12_ldv_param_3_6_default, sizeof(long), "ldv_12_ldv_param_3_6_default");
  void *ldv_12_ldv_param_3_7_default ;
  unsigned long ldv_12_ldv_param_3_8_default ;
    klee_make_symbolic(&ldv_12_ldv_param_3_8_default, sizeof(long), "ldv_12_ldv_param_3_8_default");
...
{ 
  ...
  int ldv_13_ldv_param_3_2_default ;
    klee_make_symbolic(&ldv_13_ldv_param_3_2_default, sizeof(int), "ldv_13_ldv_param_3_2_default");
  int ldv_13_ldv_param_3_3_default ;
    klee_make_symbolic(&ldv_13_ldv_param_3_3_default, sizeof(int), "ldv_13_ldv_param_3_3_default");
  ...
  int ldv_13_ldv_param_3_5_default ;
    klee_make_symbolic(&ldv_13_ldv_param_3_5_default, sizeof(int), "ldv_13_ldv_param_3_5_default");
  unsigned long long ldv_13_ldv_param_3_6_default ;
    klee_make_symbolic(&ldv_13_ldv_param_3_6_default, sizeof(long), "ldv_13_ldv_param_3_6_default");
  void *ldv_13_ldv_param_3_7_default ;
  unsigned long ldv_13_ldv_param_3_8_default ;
    klee_make_symbolic(&ldv_13_ldv_param_3_8_default, sizeof(long), "ldv_13_ldv_param_3_8_default");
...
{ 
  ...
  int ldv_14_ldv_param_3_2_default ;
    klee_make_symbolic(&ldv_14_ldv_param_3_2_default, sizeof(int), "ldv_14_ldv_param_3_2_default");
  int ldv_14_ldv_param_3_3_default ;
    klee_make_symbolic(&ldv_14_ldv_param_3_3_default, sizeof(int), "ldv_14_ldv_param_3_3_default");
  int ldv_14_ldv_param_3_4_default ;
    klee_make_symbolic(&ldv_14_ldv_param_3_4_default, sizeof(int), "ldv_14_ldv_param_3_4_default");
  ...
  unsigned long long ldv_14_ldv_param_3_6_default ;
    klee_make_symbolic(&ldv_14_ldv_param_3_6_default, sizeof(long), "ldv_14_ldv_param_3_6_default");
  void *ldv_14_ldv_param_3_7_default ;
  unsigned long ldv_14_ldv_param_3_8_default ;
    klee_make_symbolic(&ldv_14_ldv_param_3_8_default, sizeof(long), "ldv_14_ldv_param_3_8_default");
...
{ 
  ...
  int ldv_15_ldv_param_10_1_default ;
    klee_make_symbolic(&ldv_15_ldv_param_10_1_default, sizeof(int), "ldv_15_ldv_param_10_1_default");
  int ldv_15_ldv_param_10_2_default ;
    klee_make_symbolic(&ldv_15_ldv_param_10_2_default, sizeof(int), "ldv_15_ldv_param_10_2_default");
  unsigned long ldv_15_ldv_param_15_3_default ;
    klee_make_symbolic(&ldv_15_ldv_param_15_3_default, sizeof(long), "ldv_15_ldv_param_15_3_default");
  int ldv_15_ldv_param_18_1_default ;
    klee_make_symbolic(&ldv_15_ldv_param_18_1_default, sizeof(int), "ldv_15_ldv_param_18_1_default");
  unsigned long long *ldv_15_ldv_param_23_1_default ;
  int ldv_15_ldv_param_26_1_default ;
    klee_make_symbolic(&ldv_15_ldv_param_26_1_default, sizeof(int), "ldv_15_ldv_param_26_1_default");
  unsigned int ldv_15_ldv_param_26_2_default ;
    klee_make_symbolic(&ldv_15_ldv_param_26_2_default, sizeof(int), "ldv_15_ldv_param_26_2_default");
  unsigned int ldv_15_ldv_param_26_3_default ;
    klee_make_symbolic(&ldv_15_ldv_param_26_3_default, sizeof(int), "ldv_15_ldv_param_26_3_default");
  int ldv_15_ldv_param_29_1_default ;
    klee_make_symbolic(&ldv_15_ldv_param_29_1_default, sizeof(int), "ldv_15_ldv_param_29_1_default");
  int ldv_15_ldv_param_29_2_default ;
    klee_make_symbolic(&ldv_15_ldv_param_29_2_default, sizeof(int), "ldv_15_ldv_param_29_2_default");
  int ldv_15_ldv_param_29_3_default ;
    klee_make_symbolic(&ldv_15_ldv_param_29_3_default, sizeof(int), "ldv_15_ldv_param_29_3_default");
  int ldv_15_ldv_param_3_1_default ;
    klee_make_symbolic(&ldv_15_ldv_param_3_1_default, sizeof(int), "ldv_15_ldv_param_3_1_default");
  int ldv_15_ldv_param_3_2_default ;
    klee_make_symbolic(&ldv_15_ldv_param_3_2_default, sizeof(int), "ldv_15_ldv_param_3_2_default");
  unsigned long ldv_15_ldv_param_3_3_default ;
    klee_make_symbolic(&ldv_15_ldv_param_3_3_default, sizeof(long), "ldv_15_ldv_param_3_3_default");
  int tmp ;
  void *tmp___0 ;
  int tmp___1 ;
...
{ 
  ...
  int ldv_16_ldv_param_3_2_default ;
    klee_make_symbolic(&ldv_16_ldv_param_3_2_default, sizeof(int), "ldv_16_ldv_param_3_2_default");
  int tmp ;
