...
struct amd8111e_link_config {
   unsigned long orig_phy_option ;
    klee_make_symbolic(&orig_phy_option, sizeof(long), "orig_phy_option");
   u16 speed ;
   u8 duplex ;
   u8 autoneg ;
   u8 reserved ;
...
struct amd8111e_coalesce_conf {
   unsigned int rx_timeout ;
    klee_make_symbolic(&rx_timeout, sizeof(int), "rx_timeout");
   unsigned int rx_event_count ;
    klee_make_symbolic(&rx_event_count, sizeof(int), "rx_event_count");
   unsigned long rx_packets ;
   unsigned long rx_prev_packets ;
    klee_make_symbolic(&rx_prev_packets, sizeof(long), "rx_prev_packets");
   unsigned long rx_bytes ;
   unsigned long rx_prev_bytes ;
    klee_make_symbolic(&rx_prev_bytes, sizeof(long), "rx_prev_bytes");
   unsigned int rx_coal_type ;
    klee_make_symbolic(&rx_coal_type, sizeof(int), "rx_coal_type");
   unsigned int tx_timeout ;
    klee_make_symbolic(&tx_timeout, sizeof(int), "tx_timeout");
   unsigned int tx_event_count ;
    klee_make_symbolic(&tx_event_count, sizeof(int), "tx_event_count");
   unsigned long tx_packets ;
   unsigned long tx_prev_packets ;
    klee_make_symbolic(&tx_prev_packets, sizeof(long), "tx_prev_packets");
   unsigned long tx_bytes ;
   unsigned long tx_prev_bytes ;
    klee_make_symbolic(&tx_prev_bytes, sizeof(long), "tx_prev_bytes");
   unsigned int tx_coal_type ;
    klee_make_symbolic(&tx_coal_type, sizeof(int), "tx_coal_type");
};
struct ipg_info {
   unsigned int ipg_state ;
    klee_make_symbolic(&ipg_state, sizeof(int), "ipg_state");
   unsigned int ipg ;
    klee_make_symbolic(&ipg, sizeof(int), "ipg");
   unsigned int current_ipg ;
    klee_make_symbolic(&current_ipg, sizeof(int), "current_ipg");
   unsigned int col_cnt ;
    klee_make_symbolic(&col_cnt, sizeof(int), "col_cnt");
   unsigned int diff_col_cnt ;
    klee_make_symbolic(&diff_col_cnt, sizeof(int), "diff_col_cnt");
   unsigned int timer_tick ;
    klee_make_symbolic(&timer_tick, sizeof(int), "timer_tick");
   unsigned int prev_ipg ;
    klee_make_symbolic(&prev_ipg, sizeof(int), "prev_ipg");
...
struct amd8111e_priv {
   ...
   unsigned long rx_idx ;
    klee_make_symbolic(&rx_idx, sizeof(long), "rx_idx");
   unsigned long tx_idx ;
    klee_make_symbolic(&tx_idx, sizeof(long), "tx_idx");
   unsigned long tx_complete_idx ;
    klee_make_symbolic(&tx_complete_idx, sizeof(long), "tx_complete_idx");
   unsigned long tx_ring_complete_idx ;
    klee_make_symbolic(&tx_ring_complete_idx, sizeof(long), "tx_ring_complete_idx");
   unsigned long tx_ring_idx ;
    klee_make_symbolic(&tx_ring_idx, sizeof(long), "tx_ring_idx");
   unsigned int rx_buff_len ;
    klee_make_symbolic(&rx_buff_len, sizeof(int), "rx_buff_len");
   int options ;
    klee_make_symbolic(&options, sizeof(int), "options");
   unsigned long ext_phy_option ;
    klee_make_symbolic(&ext_phy_option, sizeof(long), "ext_phy_option");
   int ext_phy_addr ;
    klee_make_symbolic(&ext_phy_addr, sizeof(int), "ext_phy_addr");
   u32 ext_phy_id ;
   ...
   int mii ;
    klee_make_symbolic(&mii, sizeof(int), "mii");
   struct mii_if_info mii_if ;
   char opened ;
    klee_make_symbolic(&opened, sizeof(char), "opened");
   unsigned int drv_rx_errors ;
    klee_make_symbolic(&drv_rx_errors, sizeof(int), "drv_rx_errors");
...
static unsigned int chip_version  ;
    klee_make_symbolic(&chip_version, sizeof(int), "chip_version");
...
{ 
  ...
  unsigned int repeat ;
    klee_make_symbolic(&repeat, sizeof(int), "repeat");
...
{ 
  ...
  int min_pkt_len ;
    klee_make_symbolic(&min_pkt_len, sizeof(int), "min_pkt_len");
  int status ;
  unsigned int intr0 ;
    klee_make_symbolic(&intr0, sizeof(int), "intr0");
  int num_rx_pkt ;
    klee_make_symbolic(&num_rx_pkt, sizeof(int), "num_rx_pkt");
  short pkt_len ;
    klee_make_symbolic(&pkt_len, sizeof(short), "pkt_len");
  short vtag ;
    klee_make_symbolic(&vtag, sizeof(short), "vtag");
  int rx_pkt_limit ;
    klee_make_symbolic(&rx_pkt_limit, sizeof(int), "rx_pkt_limit");
  unsigned long flags ;
  u16 vlan_tag ;
...
{ 
  ...
  struct amd8111e_coalesce_conf *coal_conf ;
  int tx_pkt_rate ;
    klee_make_symbolic(&tx_pkt_rate, sizeof(int), "tx_pkt_rate");
  int rx_pkt_rate ;
    klee_make_symbolic(&rx_pkt_rate, sizeof(int), "rx_pkt_rate");
  int tx_data_rate ;
    klee_make_symbolic(&tx_data_rate, sizeof(int), "tx_data_rate");
  int rx_data_rate ;
    klee_make_symbolic(&rx_data_rate, sizeof(int), "rx_data_rate");
  int rx_pkt_size ;
    klee_make_symbolic(&rx_pkt_size, sizeof(int), "rx_pkt_size");
  int tx_pkt_size ;
    klee_make_symbolic(&tx_pkt_size, sizeof(int), "tx_pkt_size");
...
{ 
  ...
  unsigned int intren0 ;
    klee_make_symbolic(&intren0, sizeof(int), "intren0");
...
{ 
  ...
  unsigned int prev_col_cnt ;
    klee_make_symbolic(&prev_col_cnt, sizeof(int), "prev_col_cnt");
  unsigned int total_col_cnt ;
    klee_make_symbolic(&total_col_cnt, sizeof(int), "total_col_cnt");
  unsigned int tmp_ipg ;
    klee_make_symbolic(&tmp_ipg, sizeof(int), "tmp_ipg");
  unsigned int tmp___0 ;
  int tmp___1 ;
...
{ 
  ...
  unsigned long reg_len ;
    klee_make_symbolic(&reg_len, sizeof(long), "reg_len");
  struct amd8111e_priv *lp ;
  struct net_device *dev ;
  int tmp ;
  void *tmp___0 ;
...
{ 
  ...
  int ldv_1_ldv_param_12_1_default ;
    klee_make_symbolic(&ldv_1_ldv_param_12_1_default, sizeof(int), "ldv_1_ldv_param_12_1_default");
  int ldv_1_ldv_param_15_2_default ;
    klee_make_symbolic(&ldv_1_ldv_param_15_2_default, sizeof(int), "ldv_1_ldv_param_15_2_default");
