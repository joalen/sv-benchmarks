...
{ 
  ...
  int error ;
  int retry_cnt ;
    klee_make_symbolic(&retry_cnt, sizeof(int), "retry_cnt");
  u8 cmd[4U] ;
  u8 resp[4U] ;
...
{ 
  ...
  int n_fw_pages ;
    klee_make_symbolic(&n_fw_pages, sizeof(int), "n_fw_pages");
  int error ;
  struct _ddebug descriptor ;
  long tmp ;
...
{ 
  ...
  unsigned int n_fingers ;
    klee_make_symbolic(&n_fingers, sizeof(int), "n_fingers");
  u16 finger_state ;
  int i ;
...
{ 
  ...
  int report_len ;
    klee_make_symbolic(&report_len, sizeof(int), "report_len");
  int i ;
  int len ;
  struct _ddebug descriptor ;
  long tmp ;
...
{ 
  ...
  unsigned int fmt_size ;
    klee_make_symbolic(&fmt_size, sizeof(int), "fmt_size");
  unsigned int val ;
