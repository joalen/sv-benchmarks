...
struct rchan_buf {
   ...
   unsigned int page_count ;
    klee_make_symbolic(&page_count, sizeof(int), "page_count");
   unsigned int finalized ;
    klee_make_symbolic(&finalized, sizeof(int), "finalized");
   size_t *padding ;
   size_t prev_padding ;
...
struct rchan {
   ...
   int is_global ;
    klee_make_symbolic(&is_global, sizeof(int), "is_global");
   struct list_head list ;
   struct dentry *parent ;
   int has_base_filename ;
    klee_make_symbolic(&has_base_filename, sizeof(int), "has_base_filename");
...
struct blk_trace {
   int trace_state ;
    klee_make_symbolic(&trace_state, sizeof(int), "trace_state");
   struct rchan *rchan ;
...
struct badblocks {
   int count ;
   int unacked_exist ;
    klee_make_symbolic(&unacked_exist, sizeof(int), "unacked_exist");
   int shift ;
...
struct md_rdev {
   ...
   struct mddev *mddev ;
   int last_events ;
    klee_make_symbolic(&last_events, sizeof(int), "last_events");
   struct block_device *meta_bdev ;
   struct block_device *bdev ;
   struct page *sb_page ;
   struct page *bb_page ;
   int sb_loaded ;
    klee_make_symbolic(&sb_loaded, sizeof(int), "sb_loaded");
   __u64 sb_events ;
   sector_t data_offset ;
   sector_t new_data_offset ;
   sector_t sb_start ;
   int sb_size ;
    klee_make_symbolic(&sb_size, sizeof(int), "sb_size");
   int preferred_minor ;
    klee_make_symbolic(&preferred_minor, sizeof(int), "preferred_minor");
   struct kobject kobj ;
   unsigned long flags ;
   wait_queue_head_t blocked_wait ;
   int desc_nr ;
    klee_make_symbolic(&desc_nr, sizeof(int), "desc_nr");
   int raid_disk ;
    klee_make_symbolic(&raid_disk, sizeof(int), "raid_disk");
   int new_raid_disk ;
    klee_make_symbolic(&new_raid_disk, sizeof(int), "new_raid_disk");
   int saved_raid_disk ;
    klee_make_symbolic(&saved_raid_disk, sizeof(int), "saved_raid_disk");
...
struct __anonstruct_bitmap_info_253 {
   ...
   loff_t offset ;
   unsigned long space ;
    klee_make_symbolic(&space, sizeof(long), "space");
   loff_t default_offset ;
   unsigned long default_space ;
    klee_make_symbolic(&default_space, sizeof(long), "default_space");
   struct mutex mutex ;
   unsigned long chunksize ;
    klee_make_symbolic(&chunksize, sizeof(long), "chunksize");
   unsigned long daemon_sleep ;
    klee_make_symbolic(&daemon_sleep, sizeof(long), "daemon_sleep");
   unsigned long max_write_behind ;
    klee_make_symbolic(&max_write_behind, sizeof(long), "max_write_behind");
   int external ;
    klee_make_symbolic(&external, sizeof(int), "external");
};
struct mddev {
   void *private ;
   ...
   dev_t unit ;
   int md_minor ;
    klee_make_symbolic(&md_minor, sizeof(int), "md_minor");
   ...
   atomic_t active_io ;
   int ro ;
    klee_make_symbolic(&ro, sizeof(int), "ro");
   int sysfs_active ;
    klee_make_symbolic(&sysfs_active, sizeof(int), "sysfs_active");
   int ready ;
    klee_make_symbolic(&ready, sizeof(int), "ready");
   struct gendisk *gendisk ;
   struct kobject kobj ;
   int hold_active ;
    klee_make_symbolic(&hold_active, sizeof(int), "hold_active");
   int major_version ;
    klee_make_symbolic(&major_version, sizeof(int), "major_version");
   int minor_version ;
    klee_make_symbolic(&minor_version, sizeof(int), "minor_version");
   int patch_version ;
    klee_make_symbolic(&patch_version, sizeof(int), "patch_version");
   int persistent ;
    klee_make_symbolic(&persistent, sizeof(int), "persistent");
   int external ;
   ...
   int level ;
   int layout ;
    klee_make_symbolic(&layout, sizeof(int), "layout");
   char clevel[16U] ;
   int raid_disks ;
    klee_make_symbolic(&raid_disks, sizeof(int), "raid_disks");
   int max_disks ;
    klee_make_symbolic(&max_disks, sizeof(int), "max_disks");
   sector_t dev_sectors ;
   sector_t array_sectors ;
   int external_size ;
    klee_make_symbolic(&external_size, sizeof(int), "external_size");
   __u64 events ;
   int can_decrease_events ;
    klee_make_symbolic(&can_decrease_events, sizeof(int), "can_decrease_events");
   char uuid[16U] ;
   sector_t reshape_position ;
   int delta_disks ;
    klee_make_symbolic(&delta_disks, sizeof(int), "delta_disks");
   int new_level ;
    klee_make_symbolic(&new_level, sizeof(int), "new_level");
   int new_layout ;
    klee_make_symbolic(&new_layout, sizeof(int), "new_layout");
   int new_chunk_sectors ;
    klee_make_symbolic(&new_chunk_sectors, sizeof(int), "new_chunk_sectors");
   int reshape_backwards ;
    klee_make_symbolic(&reshape_backwards, sizeof(int), "reshape_backwards");
   ...
   unsigned long resync_mark ;
    klee_make_symbolic(&resync_mark, sizeof(long), "resync_mark");
   ...
   sector_t suspend_hi ;
   int sync_speed_min ;
    klee_make_symbolic(&sync_speed_min, sizeof(int), "sync_speed_min");
   int sync_speed_max ;
    klee_make_symbolic(&sync_speed_max, sizeof(int), "sync_speed_max");
   int parallel_resync ;
    klee_make_symbolic(&parallel_resync, sizeof(int), "parallel_resync");
   int ok_start_degraded ;
    klee_make_symbolic(&ok_start_degraded, sizeof(int), "ok_start_degraded");
   unsigned long recovery ;
    klee_make_symbolic(&recovery, sizeof(long), "recovery");
   int recovery_disabled ;
    klee_make_symbolic(&recovery_disabled, sizeof(int), "recovery_disabled");
   int in_sync ;
    klee_make_symbolic(&in_sync, sizeof(int), "in_sync");
   ...
   int changed ;
   int degraded ;
    klee_make_symbolic(&degraded, sizeof(int), "degraded");
   int merge_check_needed ;
    klee_make_symbolic(&merge_check_needed, sizeof(int), "merge_check_needed");
   ...
   unsigned int safemode ;
    klee_make_symbolic(&safemode, sizeof(int), "safemode");
   unsigned int safemode_delay ;
    klee_make_symbolic(&safemode_delay, sizeof(int), "safemode_delay");
...
struct stripe_operations {
   ...
   int target2 ;
    klee_make_symbolic(&target2, sizeof(int), "target2");
...
struct stripe_head {
   ...
   short generation ;
    klee_make_symbolic(&generation, sizeof(short), "generation");
   sector_t sector ;
   short pd_idx ;
    klee_make_symbolic(&pd_idx, sizeof(short), "pd_idx");
   short qd_idx ;
    klee_make_symbolic(&qd_idx, sizeof(short), "qd_idx");
   short ddf_layout ;
    klee_make_symbolic(&ddf_layout, sizeof(short), "ddf_layout");
   short hash_lock_index ;
    klee_make_symbolic(&hash_lock_index, sizeof(short), "hash_lock_index");
   unsigned long state ;
   atomic_t count ;
   int bm_seq ;
    klee_make_symbolic(&bm_seq, sizeof(int), "bm_seq");
   int disks ;
    klee_make_symbolic(&disks, sizeof(int), "disks");
...
struct stripe_head_state {
   int syncing ;
    klee_make_symbolic(&syncing, sizeof(int), "syncing");
   int expanding ;
    klee_make_symbolic(&expanding, sizeof(int), "expanding");
   int expanded ;
    klee_make_symbolic(&expanded, sizeof(int), "expanded");
   int replacing ;
    klee_make_symbolic(&replacing, sizeof(int), "replacing");
   int locked ;
   ...
   int written ;
    klee_make_symbolic(&written, sizeof(int), "written");
   int to_fill ;
    klee_make_symbolic(&to_fill, sizeof(int), "to_fill");
   int compute ;
    klee_make_symbolic(&compute, sizeof(int), "compute");
   int req_compute ;
    klee_make_symbolic(&req_compute, sizeof(int), "req_compute");
   int non_overwrite ;
    klee_make_symbolic(&non_overwrite, sizeof(int), "non_overwrite");
   int failed_num[2U] ;
   int p_failed ;
    klee_make_symbolic(&p_failed, sizeof(int), "p_failed");
   int q_failed ;
    klee_make_symbolic(&q_failed, sizeof(int), "q_failed");
   int dec_preread_active ;
    klee_make_symbolic(&dec_preread_active, sizeof(int), "dec_preread_active");
   unsigned long ops_request ;
    klee_make_symbolic(&ops_request, sizeof(long), "ops_request");
   struct bio *return_bi ;
   struct md_rdev *blocked_rdev ;
   int handle_bad_blocks ;
    klee_make_symbolic(&handle_bad_blocks, sizeof(int), "handle_bad_blocks");
};
struct disk_info {
   struct md_rdev *rdev ;
...
struct r5worker_group {
   ...
   int stripes_cnt ;
    klee_make_symbolic(&stripes_cnt, sizeof(int), "stripes_cnt");
};
struct raid5_percpu {
...
struct r5conf {
   ...
   int level ;
   int algorithm ;
    klee_make_symbolic(&algorithm, sizeof(int), "algorithm");
   int max_degraded ;
    klee_make_symbolic(&max_degraded, sizeof(int), "max_degraded");
   int raid_disks ;
   int max_nr_stripes ;
    klee_make_symbolic(&max_nr_stripes, sizeof(int), "max_nr_stripes");
   sector_t reshape_progress ;
   sector_t reshape_safe ;
   int previous_raid_disks ;
    klee_make_symbolic(&previous_raid_disks, sizeof(int), "previous_raid_disks");
   int prev_chunk_sectors ;
    klee_make_symbolic(&prev_chunk_sectors, sizeof(int), "prev_chunk_sectors");
   int prev_algo ;
    klee_make_symbolic(&prev_algo, sizeof(int), "prev_algo");
   short generation ;
   seqcount_t gen_lock ;
   unsigned long reshape_checkpoint ;
    klee_make_symbolic(&reshape_checkpoint, sizeof(long), "reshape_checkpoint");
   long long min_offset_diff ;
    klee_make_symbolic(&min_offset_diff, sizeof(long), "min_offset_diff");
   struct list_head handle_list ;
   ...
   int bypass_count ;
    klee_make_symbolic(&bypass_count, sizeof(int), "bypass_count");
   int bypass_threshold ;
    klee_make_symbolic(&bypass_threshold, sizeof(int), "bypass_threshold");
   int skip_copy ;
    klee_make_symbolic(&skip_copy, sizeof(int), "skip_copy");
   struct list_head *last_hold ;
   atomic_t reshape_stripes ;
   int active_name ;
    klee_make_symbolic(&active_name, sizeof(int), "active_name");
   char cache_name[2U][32U] ;
   struct kmem_cache *slab_cache ;
   int seq_flush ;
    klee_make_symbolic(&seq_flush, sizeof(int), "seq_flush");
   int seq_write ;
    klee_make_symbolic(&seq_write, sizeof(int), "seq_write");
   int quiesce ;
    klee_make_symbolic(&quiesce, sizeof(int), "quiesce");
   int fullsync ;
    klee_make_symbolic(&fullsync, sizeof(int), "fullsync");
   int recovery_disabled ;
   ...
   int inactive_blocked ;
    klee_make_symbolic(&inactive_blocked, sizeof(int), "inactive_blocked");
   int pool_size ;
    klee_make_symbolic(&pool_size, sizeof(int), "pool_size");
   ...
   int group_cnt ;
    klee_make_symbolic(&group_cnt, sizeof(int), "group_cnt");
   int worker_cnt_per_group ;
    klee_make_symbolic(&worker_cnt_per_group, sizeof(int), "worker_cnt_per_group");
};
struct strip_zone {
   sector_t zone_end ;
   sector_t dev_start ;
   int nb_dev ;
    klee_make_symbolic(&nb_dev, sizeof(int), "nb_dev");
};
struct r0conf {
   struct strip_zone *strip_zone ;
   struct md_rdev **devlist ;
   int nr_strip_zones ;
    klee_make_symbolic(&nr_strip_zones, sizeof(int), "nr_strip_zones");
   int has_merge_bvec ;
    klee_make_symbolic(&has_merge_bvec, sizeof(int), "has_merge_bvec");
};
struct bitmap_page {
   char *map ;
...
struct bitmap_counts {
   ...
   unsigned long missing_pages ;
    klee_make_symbolic(&missing_pages, sizeof(long), "missing_pages");
   unsigned long chunkshift ;
    klee_make_symbolic(&chunkshift, sizeof(long), "chunkshift");
   unsigned long chunks ;
    klee_make_symbolic(&chunks, sizeof(long), "chunks");
};
struct bitmap_storage {
   ...
   unsigned long file_pages ;
    klee_make_symbolic(&file_pages, sizeof(long), "file_pages");
   unsigned long bytes ;
    klee_make_symbolic(&bytes, sizeof(long), "bytes");
};
struct bitmap {
   ...
   int need_sync ;
    klee_make_symbolic(&need_sync, sizeof(int), "need_sync");
   struct bitmap_storage storage ;
   unsigned long flags ;
   int allclean ;
    klee_make_symbolic(&allclean, sizeof(int), "allclean");
   atomic_t behind_writes ;
   unsigned long behind_writes_used ;
    klee_make_symbolic(&behind_writes_used, sizeof(long), "behind_writes_used");
   unsigned long daemon_lastrun ;
    klee_make_symbolic(&daemon_lastrun, sizeof(long), "daemon_lastrun");
   unsigned long last_end_sync ;
    klee_make_symbolic(&last_end_sync, sizeof(long), "last_end_sync");
   atomic_t pending_writes ;
...
extern struct tracepoint __tracepoint_block_bio_complete ;
    klee_make_symbolic(&__tracepoint_block_bio_complete, sizeof(int), "__tracepoint_block_bio_complete");
...
extern struct tracepoint __tracepoint_block_unplug ;
    klee_make_symbolic(&__tracepoint_block_unplug, sizeof(int), "__tracepoint_block_unplug");
...
extern struct tracepoint __tracepoint_block_bio_remap ;
    klee_make_symbolic(&__tracepoint_block_bio_remap, sizeof(int), "__tracepoint_block_bio_remap");
...
{ 
  int faulty ;
    klee_make_symbolic(&faulty, sizeof(int), "faulty");
  int tmp ;
  int tmp___0 ;
...
{ 
  ...
  struct r5worker_group *group ;
  int thread_cnt ;
    klee_make_symbolic(&thread_cnt, sizeof(int), "thread_cnt");
  int i ;
  int cpu ;
  unsigned int tmp ;
...
{ 
  int degraded ;
  int degraded2 ;
    klee_make_symbolic(&degraded2, sizeof(int), "degraded2");
  int i ;
  struct md_rdev *rdev ;
...
{ 
  ...
  int replace_only ;
    klee_make_symbolic(&replace_only, sizeof(int), "replace_only");
  struct bio *bi ;
  struct bio *rbi ;
  struct md_rdev *rdev ;
  ...
  sector_t first_bad ;
  int bad_sectors ;
    klee_make_symbolic(&bad_sectors, sizeof(int), "bad_sectors");
  int bad ;
    klee_make_symbolic(&bad, sizeof(int), "bad");
  int tmp___12 ;
  int tmp___13 ;
  struct _ddebug descriptor ;
  long tmp___14 ;
...
{ 
  ...
  int len ;
  int clen ;
    klee_make_symbolic(&clen, sizeof(int), "clen");
  int b_offset ;
    klee_make_symbolic(&b_offset, sizeof(int), "b_offset");
...
{ 
  int disks ;
  int syndrome_disks ;
    klee_make_symbolic(&syndrome_disks, sizeof(int), "syndrome_disks");
  int d0_idx ;
    klee_make_symbolic(&d0_idx, sizeof(int), "d0_idx");
  int tmp ;
  int count ;
  int i ;
  int slot ;
...
{ 
  ...
  int tmp ;
  int faila ;
    klee_make_symbolic(&faila, sizeof(int), "faila");
  int failb ;
    klee_make_symbolic(&failb, sizeof(int), "failb");
  int target ;
  int target2 ;
  struct r5dev *tgt ;
  struct r5dev *tgt2 ;
  ...
  long tmp___7 ;
  int __tmp ;
    klee_make_symbolic(&__tmp, sizeof(int), "__tmp");
  struct _ddebug descriptor___0 ;
  long tmp___8 ;
  addr_conv_t *tmp___9 ;
  ...
  struct page *dest ;
  int data_target ;
    klee_make_symbolic(&data_target, sizeof(int), "data_target");
  int qd_idx ;
  int tmp___11 ;
  int tmp___12 ;
...
{ 
  ...
  struct page *xor_dest ;
  int prexor ;
    klee_make_symbolic(&prexor, sizeof(int), "prexor");
  unsigned long flags ;
  struct _ddebug descriptor ;
  long tmp ;
  int tmp___0 ;
...
{ 
  int overlap_clear ;
    klee_make_symbolic(&overlap_clear, sizeof(int), "overlap_clear");
  int i ;
  int disks ;
  struct dma_async_tx_descriptor *tx ;
  struct r5conf *conf ;
...
{ 
  ...
  int devs ;
    klee_make_symbolic(&devs, sizeof(int), "devs");
  int _max1 ;
...
{ 
  ...
  int set_bad ;
    klee_make_symbolic(&set_bad, sizeof(int), "set_bad");
...
{ 
  ...
  unsigned int chunk_offset ;
    klee_make_symbolic(&chunk_offset, sizeof(int), "chunk_offset");
  int pd_idx ;
  int qd_idx ;
  int ddf_layout ;
  sector_t new_sector ;
  ...
  int sectors_per_chunk ;
    klee_make_symbolic(&sectors_per_chunk, sizeof(int), "sectors_per_chunk");
  int raid_disks ;
  int data_disks ;
    klee_make_symbolic(&data_disks, sizeof(int), "data_disks");
  int _res ;
    klee_make_symbolic(&_res, sizeof(int), "_res");
  int _res___0 ;
    klee_make_symbolic(&_res___0, sizeof(int), "_res___0");
  int _res___1 ;
    klee_make_symbolic(&_res___1, sizeof(int), "_res___1");
  int _res___2 ;
    klee_make_symbolic(&_res___2, sizeof(int), "_res___2");
  int _res___3 ;
    klee_make_symbolic(&_res___3, sizeof(int), "_res___3");
  int _res___4 ;
    klee_make_symbolic(&_res___4, sizeof(int), "_res___4");
  int _res___5 ;
    klee_make_symbolic(&_res___5, sizeof(int), "_res___5");
  int _res___6 ;
    klee_make_symbolic(&_res___6, sizeof(int), "_res___6");
  int _res___7 ;
    klee_make_symbolic(&_res___7, sizeof(int), "_res___7");
  int _res___8 ;
    klee_make_symbolic(&_res___8, sizeof(int), "_res___8");
  int _res___9 ;
    klee_make_symbolic(&_res___9, sizeof(int), "_res___9");
  int _res___10 ;
    klee_make_symbolic(&_res___10, sizeof(int), "_res___10");
  int _res___11 ;
    klee_make_symbolic(&_res___11, sizeof(int), "_res___11");
  int _res___12 ;
    klee_make_symbolic(&_res___12, sizeof(int), "_res___12");
  int _res___13 ;
    klee_make_symbolic(&_res___13, sizeof(int), "_res___13");
  int _res___14 ;
    klee_make_symbolic(&_res___14, sizeof(int), "_res___14");
  int _res___15 ;
    klee_make_symbolic(&_res___15, sizeof(int), "_res___15");
...
{ 
  ...
  sector_t chunk_number ;
  int dummy1 ;
    klee_make_symbolic(&dummy1, sizeof(int), "dummy1");
  int dd_idx ;
    klee_make_symbolic(&dd_idx, sizeof(int), "dd_idx");
  sector_t r_sector ;
...
{ 
  ...
  struct r5conf *conf ;
  int firstwrite ;
    klee_make_symbolic(&firstwrite, sizeof(int), "firstwrite");
  struct _ddebug descriptor ;
  long tmp ;
  long tmp___0 ;
  long tmp___1 ;
...
{ 
  ...
  struct bio *bi ;
  int bitmap_end ;
    klee_make_symbolic(&bitmap_end, sizeof(int), "bitmap_end");
  struct md_rdev *rdev ;
  struct md_rdev *________p1 ;
  struct md_rdev *_________p1 ;
  struct md_rdev *__var ;
...
{ 
  ...
  long tmp___3 ;
  int other ;
    klee_make_symbolic(&other, sizeof(int), "other");
  int tmp___4 ;
  int tmp___5 ;
  long tmp___6 ;
  struct _ddebug descriptor___0 ;
...
{ 
  ...
  struct r5dev *dev ;
  int discard_pending ;
    klee_make_symbolic(&discard_pending, sizeof(int), "discard_pending");
  struct bio *wbi ;
  struct bio *wbi2 ;
  struct _ddebug descriptor ;
  long tmp ;
...
{ 
  int rmw ;
    klee_make_symbolic(&rmw, sizeof(int), "rmw");
  int rcw ;
    klee_make_symbolic(&rcw, sizeof(int), "rcw");
  int i ;
  sector_t recovery_cp ;
  struct _ddebug descriptor ;
  long tmp ;
  ...
  int tmp___18 ;
  int qread ;
    klee_make_symbolic(&qread, sizeof(int), "qread");
  struct r5dev *dev___1 ;
...
{ 
  ...
  int i ;
  int do_recovery ;
    klee_make_symbolic(&do_recovery, sizeof(int), "do_recovery");
  struct md_rdev *rdev ;
  sector_t first_bad ;
  int bad_sectors ;
  int is_bad ;
    klee_make_symbolic(&is_bad, sizeof(int), "is_bad");
  struct _ddebug descriptor ;
  long tmp ;
  int tmp___0 ;
  int tmp___1 ;
...
{ 
  ...
  long tmp___51 ;
    klee_make_symbolic(&tmp___51, sizeof(long), "tmp___51");
  struct md_rdev *rdev ;
  struct r5dev *dev___1 ;
  int tmp___52 ;
...
{ 
  ...
  unsigned int bio_sectors ;
    klee_make_symbolic(&bio_sectors, sizeof(int), "bio_sectors");
...
{ 
  ...
  int stripe_sectors ;
    klee_make_symbolic(&stripe_sectors, sizeof(int), "stripe_sectors");
  int _res ;
  wait_queue_t w ;
...
{ 
  ...
  long tmp___2 ;
  int previous ;
    klee_make_symbolic(&previous, sizeof(int), "previous");
  int seq ;
  ...
  long tmp___5 ;
  int must_retry ;
    klee_make_symbolic(&must_retry, sizeof(int), "must_retry");
  long tmp___6 ;
  int tmp___7 ;
...
{ 
  ...
  int data_disks ;
  int new_data_disks ;
    klee_make_symbolic(&new_data_disks, sizeof(int), "new_data_disks");
  int i ;
  int dd_idx ;
  sector_t writepos ;
  sector_t readpos ;
  ...
  int reshape_sectors ;
    klee_make_symbolic(&reshape_sectors, sizeof(int), "reshape_sectors");
  ...
  int j ;
  int skipped_disk ;
    klee_make_symbolic(&skipped_disk, sizeof(int), "skipped_disk");
  sector_t s ;
  sector_t tmp___14 ;
  void *tmp___15 ;
  int tmp___16 ;
...
{ 
  ...
  int still_degraded ;
    klee_make_symbolic(&still_degraded, sizeof(int), "still_degraded");
  int i ;
  int tmp ;
  wait_queue_t __wait ;
  long __ret ;
...
{ 
  ...
  sector_t last_sector ;
  int scnt ;
    klee_make_symbolic(&scnt, sizeof(int), "scnt");
  int remaining ;
  int handled ;
...
{ 
  ...
  int batch_size ;
  int released ;
    klee_make_symbolic(&released, sizeof(int), "released");
  struct _ddebug descriptor___0 ;
  long tmp___0 ;
  struct _ddebug descriptor___1 ;
  long tmp___1 ;
...
{ 
  struct r5conf *conf ;
  int working_disks ;
    klee_make_symbolic(&working_disks, sizeof(int), "working_disks");
  int dirty_parity_disks ;
    klee_make_symbolic(&dirty_parity_disks, sizeof(int), "dirty_parity_disks");
  struct md_rdev *rdev ;
  ...
  sector_t here_old ;
  int old_disks ;
    klee_make_symbolic(&old_disks, sizeof(int), "old_disks");
  int max_degraded ;
  char *tmp___0 ;
  char *tmp___1 ;
  int _res ;
  ...
  int data_disks ;
  int stripe ;
    klee_make_symbolic(&stripe, sizeof(int), "stripe");
  struct list_head  const  *__mptr___1 ;
...
{ 
  ...
  struct md_rdev *rdev ;
  int spares ;
    klee_make_symbolic(&spares, sizeof(int), "spares");
  unsigned long flags ;
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
...
{ 
  int chunksect ;
    klee_make_symbolic(&chunksect, sizeof(int), "chunksect");
  void *tmp ;
  void *tmp___0 ;
  struct r5conf *tmp___1 ;
...
{ 
  struct r5conf *conf ;
  int new_chunk ;
    klee_make_symbolic(&new_chunk, sizeof(int), "new_chunk");
  int tmp ;
  bool tmp___0 ;
  int tmp___1 ;
  int tmp___2 ;
...
{ 
  ...
  int ldv_0_ldv_param_17_1_default ;
    klee_make_symbolic(&ldv_0_ldv_param_17_1_default, sizeof(int), "ldv_0_ldv_param_17_1_default");
  ...
  unsigned long ldv_0_ldv_param_29_1_default ;
    klee_make_symbolic(&ldv_0_ldv_param_29_1_default, sizeof(long), "ldv_0_ldv_param_29_1_default");
  unsigned long ldv_0_ldv_param_32_1_default ;
    klee_make_symbolic(&ldv_0_ldv_param_32_1_default, sizeof(long), "ldv_0_ldv_param_32_1_default");
  int ldv_0_ldv_param_32_2_default ;
    klee_make_symbolic(&ldv_0_ldv_param_32_2_default, sizeof(int), "ldv_0_ldv_param_32_2_default");
  unsigned long ldv_0_ldv_param_38_1_default ;
    klee_make_symbolic(&ldv_0_ldv_param_38_1_default, sizeof(long), "ldv_0_ldv_param_38_1_default");
  int *ldv_0_ldv_param_38_2_default ;
  int ldv_0_ldv_param_38_3_default ;
    klee_make_symbolic(&ldv_0_ldv_param_38_3_default, sizeof(int), "ldv_0_ldv_param_38_3_default");
...
{ 
  ...
  int ldv_1_ldv_param_17_1_default ;
    klee_make_symbolic(&ldv_1_ldv_param_17_1_default, sizeof(int), "ldv_1_ldv_param_17_1_default");
  ...
  unsigned long ldv_1_ldv_param_29_1_default ;
    klee_make_symbolic(&ldv_1_ldv_param_29_1_default, sizeof(long), "ldv_1_ldv_param_29_1_default");
  unsigned long ldv_1_ldv_param_32_1_default ;
    klee_make_symbolic(&ldv_1_ldv_param_32_1_default, sizeof(long), "ldv_1_ldv_param_32_1_default");
  int ldv_1_ldv_param_32_2_default ;
    klee_make_symbolic(&ldv_1_ldv_param_32_2_default, sizeof(int), "ldv_1_ldv_param_32_2_default");
  unsigned long ldv_1_ldv_param_38_1_default ;
    klee_make_symbolic(&ldv_1_ldv_param_38_1_default, sizeof(long), "ldv_1_ldv_param_38_1_default");
  int *ldv_1_ldv_param_38_2_default ;
  int ldv_1_ldv_param_38_3_default ;
    klee_make_symbolic(&ldv_1_ldv_param_38_3_default, sizeof(int), "ldv_1_ldv_param_38_3_default");
...
{ 
  ...
  int ldv_2_ldv_param_17_1_default ;
    klee_make_symbolic(&ldv_2_ldv_param_17_1_default, sizeof(int), "ldv_2_ldv_param_17_1_default");
  ...
  unsigned long ldv_2_ldv_param_29_1_default ;
    klee_make_symbolic(&ldv_2_ldv_param_29_1_default, sizeof(long), "ldv_2_ldv_param_29_1_default");
  unsigned long ldv_2_ldv_param_32_1_default ;
    klee_make_symbolic(&ldv_2_ldv_param_32_1_default, sizeof(long), "ldv_2_ldv_param_32_1_default");
  int ldv_2_ldv_param_32_2_default ;
    klee_make_symbolic(&ldv_2_ldv_param_32_2_default, sizeof(int), "ldv_2_ldv_param_32_2_default");
  unsigned long ldv_2_ldv_param_38_1_default ;
    klee_make_symbolic(&ldv_2_ldv_param_38_1_default, sizeof(long), "ldv_2_ldv_param_38_1_default");
  int *ldv_2_ldv_param_38_2_default ;
  int ldv_2_ldv_param_38_3_default ;
    klee_make_symbolic(&ldv_2_ldv_param_38_3_default, sizeof(int), "ldv_2_ldv_param_38_3_default");
...
{ 
  ...
  unsigned long ldv_7_ldv_param_9_2_default ;
    klee_make_symbolic(&ldv_7_ldv_param_9_2_default, sizeof(long), "ldv_7_ldv_param_9_2_default");
  struct ldv_struct_dummy_resourceless_instance_3 *data ;
  void *tmp ;
  void *tmp___0 ;
  int tmp___1 ;
