...
struct mmc_test_area {
   unsigned long max_sz ;
    klee_make_symbolic(&max_sz, sizeof(long), "max_sz");
   unsigned int dev_addr ;
    klee_make_symbolic(&dev_addr, sizeof(int), "dev_addr");
   unsigned int max_tfr ;
    klee_make_symbolic(&max_tfr, sizeof(int), "max_tfr");
   unsigned int max_segs ;
   unsigned int max_seg_sz ;
    klee_make_symbolic(&max_seg_sz, sizeof(int), "max_seg_sz");
   unsigned int blocks ;
   unsigned int sg_len ;
...
struct mmc_test_transfer_result {
   ...
   unsigned int iops ;
    klee_make_symbolic(&iops, sizeof(int), "iops");
};
struct mmc_test_general_result {
   struct list_head link ;
   struct mmc_card *card ;
   int testcase ;
    klee_make_symbolic(&testcase, sizeof(int), "testcase");
   int result ;
...
{ 
  unsigned long max_page_cnt ;
    klee_make_symbolic(&max_page_cnt, sizeof(long), "max_page_cnt");
  unsigned long min_page_cnt ;
    klee_make_symbolic(&min_page_cnt, sizeof(long), "min_page_cnt");
  unsigned long max_seg_page_cnt ;
    klee_make_symbolic(&max_seg_page_cnt, sizeof(long), "max_seg_page_cnt");
  unsigned long page_cnt ;
    klee_make_symbolic(&page_cnt, sizeof(long), "page_cnt");
  unsigned long limit ;
...
{ 
  ...
  unsigned long sz ;
    klee_make_symbolic(&sz, sizeof(long), "sz");
  unsigned long len ;
...
{ 
  ...
  unsigned long min_sz ;
    klee_make_symbolic(&min_sz, sizeof(long), "min_sz");
  unsigned long sz ;
  int ret ;
  void *tmp ;
...
{ 
  ...
  unsigned int rnd_addr ;
    klee_make_symbolic(&rnd_addr, sizeof(int), "rnd_addr");
  unsigned int range1 ;
    klee_make_symbolic(&range1, sizeof(int), "range1");
  unsigned int range2 ;
    klee_make_symbolic(&range2, sizeof(int), "range2");
  unsigned int last_ea ;
    klee_make_symbolic(&last_ea, sizeof(int), "last_ea");
  unsigned int ea ;
    klee_make_symbolic(&ea, sizeof(int), "ea");
  unsigned int ssz ;
    klee_make_symbolic(&ssz, sizeof(int), "ssz");
  struct timespec ts1 ;
  struct timespec ts2 ;
  struct timespec ts ;
  int ret ;
