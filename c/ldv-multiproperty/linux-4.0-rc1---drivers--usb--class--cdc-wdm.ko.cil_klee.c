...
struct wdm_device {
   ...
   __le16 inum ;
   int reslength ;
    klee_make_symbolic(&reslength, sizeof(int), "reslength");
   int length ;
   int read ;
   ...
   int werr ;
    klee_make_symbolic(&werr, sizeof(int), "werr");
   int rerr ;
    klee_make_symbolic(&rerr, sizeof(int), "rerr");
   int resp_count ;
    klee_make_symbolic(&resp_count, sizeof(int), "resp_count");
...
{ 
  ...
  int responding ;
    klee_make_symbolic(&responding, sizeof(int), "responding");
  int status ;
  struct wdm_device *desc ;
...
{ 
  int rv ;
  int cntr ;
    klee_make_symbolic(&cntr, sizeof(int), "cntr");
  int i ;
