...
struct janz_platform_data {
   unsigned int modno ;
    klee_make_symbolic(&modno, sizeof(int), "modno");
};
...
struct ican3_dev {
   ...
   unsigned int iftype ;
    klee_make_symbolic(&iftype, sizeof(int), "iftype");
   struct sk_buff_head echoq ;
   spinlock_t lock ;
   unsigned int rx_int ;
    klee_make_symbolic(&rx_int, sizeof(int), "rx_int");
   unsigned int rx_num ;
    klee_make_symbolic(&rx_num, sizeof(int), "rx_num");
   unsigned int tx_num ;
    klee_make_symbolic(&tx_num, sizeof(int), "tx_num");
   unsigned int fastrx_start ;
    klee_make_symbolic(&fastrx_start, sizeof(int), "fastrx_start");
   unsigned int fastrx_num ;
    klee_make_symbolic(&fastrx_num, sizeof(int), "fastrx_num");
   unsigned int fasttx_start ;
    klee_make_symbolic(&fasttx_start, sizeof(int), "fasttx_start");
   unsigned int fasttx_num ;
    klee_make_symbolic(&fasttx_num, sizeof(int), "fasttx_num");
   unsigned int free_page ;
    klee_make_symbolic(&free_page, sizeof(int), "free_page");
};
struct ican3_msg {
   u8 control ;
   u8 spec ;
...
{ 
  ...
  unsigned int mbox_page ;
    klee_make_symbolic(&mbox_page, sizeof(int), "mbox_page");
  u8 locl ;
  u8 peer ;
  u8 xord ;
  unsigned int tmp ;
