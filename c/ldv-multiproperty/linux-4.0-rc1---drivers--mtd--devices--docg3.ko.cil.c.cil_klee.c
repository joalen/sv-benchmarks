...
struct mtd_part_parser_data {
   unsigned long origin ;
    klee_make_symbolic(&origin, sizeof(long), "origin");
   struct device_node *of_node ;
};
struct gf_poly;
struct bch_control {
   ...
   unsigned int ecc_bits ;
    klee_make_symbolic(&ecc_bits, sizeof(int), "ecc_bits");
   unsigned int ecc_bytes ;
    klee_make_symbolic(&ecc_bytes, sizeof(int), "ecc_bytes");
   uint16_t *a_pow_tab ;
   uint16_t *a_log_tab ;
   uint32_t *mod8_tab ;
   uint32_t *ecc_buf ;
...
struct docg3 {
   ...
   int max_block ;
    klee_make_symbolic(&max_block, sizeof(int), "max_block");
   u8 *bbt ;
   loff_t oob_write_ofs ;
   int oob_autoecc ;
    klee_make_symbolic(&oob_autoecc, sizeof(int), "oob_autoecc");
...
struct tracepoint __tracepoint_docg3_io ;
    klee_make_symbolic(&__tracepoint_docg3_io, sizeof(int), "__tracepoint_docg3_io");
...
static unsigned int reliable_mode  ;
    klee_make_symbolic(&reliable_mode, sizeof(int), "reliable_mode");
...
{ 
  int maxWaitCycles ;
    klee_make_symbolic(&maxWaitCycles, sizeof(int), "maxWaitCycles");
  int tmp ;
  int tmp___0 ;
...
{ 
  int i ;
  int cdr ;
    klee_make_symbolic(&cdr, sizeof(int), "cdr");
  int len4 ;
    klee_make_symbolic(&len4, sizeof(int), "len4");
  u16 data16 ;
  u16 *dst16 ;
  u8 data8 ;
  u8 *dst8 ;
...
{ 
  int fctrl ;
    klee_make_symbolic(&fctrl, sizeof(int), "fctrl");
  struct _ddebug descriptor ;
  long tmp ;
...
{ 
  ...
  int i ;
  int numerrs ;
    klee_make_symbolic(&numerrs, sizeof(int), "numerrs");
  u8 __x ;
  u8 tmp ;
  long tmp___0 ;
  struct _ddebug descriptor ;
...
{ 
  int wear_area ;
    klee_make_symbolic(&wear_area, sizeof(int), "wear_area");
  int ret ;
  struct _ddebug descriptor ;
  long tmp ;
...
{ 
  uint sector ;
  uint pages_biblock ;
    klee_make_symbolic(&pages_biblock, sizeof(int), "pages_biblock");
...
{ 
  struct docg3 *docg3 ;
  int block0 ;
    klee_make_symbolic(&block0, sizeof(int), "block0");
  int block1 ;
  ...
  u8 eccconf1 ;
  int max_bitflips ;
    klee_make_symbolic(&max_bitflips, sizeof(int), "max_bitflips");
  struct _ddebug descriptor ;
  long tmp ;
  size_t __min1 ;
  size_t __min2 ;
...
{ 
  ...
  int ret ;
  int nbpages ;
    klee_make_symbolic(&nbpages, sizeof(int), "nbpages");
  int page ;
  u_char *buf ;
...
{ 
  ...
  int ofs ;
  int is_good ;
    klee_make_symbolic(&is_good, sizeof(int), "is_good");
  struct _ddebug descriptor ;
  long tmp ;
...
{ 
  int autoecc ;
    klee_make_symbolic(&autoecc, sizeof(int), "autoecc");
...
{ 
  int ooblen ;
    klee_make_symbolic(&ooblen, sizeof(int), "ooblen");
  int autoecc ;
...
{ 
  ...
  int autoecc ;
  int oobdelta ;
    klee_make_symbolic(&oobdelta, sizeof(int), "oobdelta");
  u8 *oobbuf ;
  u8 *buf ;
  size_t len ;
  size_t ooblen ;
...
{ 
  int floor ;
    klee_make_symbolic(&floor, sizeof(int), "floor");
...
{ 
  ...
  struct docg3 *tmp ;
  int dps0 ;
    klee_make_symbolic(&dps0, sizeof(int), "dps0");
  int tmp___0 ;
...
{ 
  ...
  struct docg3 *tmp ;
  int dps1 ;
    klee_make_symbolic(&dps1, sizeof(int), "dps1");
  int tmp___0 ;
...
{ 
  struct docg3 *docg3 ;
  int pctrl ;
    klee_make_symbolic(&pctrl, sizeof(int), "pctrl");
  int mode ;
...
{ 
  struct docg3 *docg3 ;
  int protect ;
    klee_make_symbolic(&protect, sizeof(int), "protect");
  int dps0 ;
  int dps0_low ;
    klee_make_symbolic(&dps0_low, sizeof(int), "dps0_low");
  int dps0_high ;
    klee_make_symbolic(&dps0_high, sizeof(int), "dps0_high");
  int dps1 ;
  int dps1_low ;
    klee_make_symbolic(&dps1_low, sizeof(int), "dps1_low");
  int dps1_high ;
    klee_make_symbolic(&dps1_high, sizeof(int), "dps1_high");
...
{ 
  int ret ;
  int bbt_nbpages ;
    klee_make_symbolic(&bbt_nbpages, sizeof(int), "bbt_nbpages");
  u16 chip_id ;
  u16 chip_id_inv ;
  struct docg3 *docg3 ;
  struct mtd_info *mtd ;
...
{ 
  ...
  int ldv_4_probed_default ;
    klee_make_symbolic(&ldv_4_probed_default, sizeof(int), "ldv_4_probed_default");
...
{ 
  ...
  int ldv_5_probed_default ;
    klee_make_symbolic(&ldv_5_probed_default, sizeof(int), "ldv_5_probed_default");
...
{ 
  ...
  int ldv_9_ldv_param_9_1_default ;
    klee_make_symbolic(&ldv_9_ldv_param_9_1_default, sizeof(int), "ldv_9_ldv_param_9_1_default");
  int tmp ;
