...
struct kaweth_device {
   ...
   int suspend_lowmem_rx ;
    klee_make_symbolic(&suspend_lowmem_rx, sizeof(int), "suspend_lowmem_rx");
   int suspend_lowmem_ctrl ;
    klee_make_symbolic(&suspend_lowmem_ctrl, sizeof(int), "suspend_lowmem_ctrl");
   int linkstate ;
...
{ 
  ...
  int act_state ;
    klee_make_symbolic(&act_state, sizeof(int), "act_state");
  int status ;
...
{ 
  ...
  int count ;
  int count2 ;
    klee_make_symbolic(&count2, sizeof(int), "count2");
  __u16 pkt_len ;
  __u16 tmp ;
  struct sk_buff *skb ;
  struct _ddebug descriptor ;
