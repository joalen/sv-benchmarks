...
struct irctl {
   ...
   long jiffies_to_wait ;
    klee_make_symbolic(&jiffies_to_wait, sizeof(long), "jiffies_to_wait");
};
...
{ 
  ...
  int got_data ;
    klee_make_symbolic(&got_data, sizeof(int), "got_data");
...
{ 
  ...
  int minor ;
  int bytes_in_key ;
    klee_make_symbolic(&bytes_in_key, sizeof(int), "bytes_in_key");
  unsigned int chunk_size ;
  unsigned int buffer_size ;
  int err ;
