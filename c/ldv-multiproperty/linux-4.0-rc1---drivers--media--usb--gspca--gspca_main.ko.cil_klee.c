...
struct __anonstruct____missing_field_name_258 {
   ...
   int exp_too_low_cnt ;
    klee_make_symbolic(&exp_too_low_cnt, sizeof(int), "exp_too_low_cnt");
   int exp_too_high_cnt ;
    klee_make_symbolic(&exp_too_high_cnt, sizeof(int), "exp_too_high_cnt");
};
struct gspca_dev {
   struct video_device vdev ;
   ...
   __u8 alt ;
   int xfer_ep ;
    klee_make_symbolic(&xfer_ep, sizeof(int), "xfer_ep");
   u8 audio ;
};
struct input_id {
   __u16 bustype ;
...
int gspca_debug  ;
    klee_make_symbolic(&gspca_debug, sizeof(int), "gspca_debug");
...
{ 
  struct gspca_frame *frame ;
  unsigned int frsz ;
    klee_make_symbolic(&frsz, sizeof(int), "frsz");
  int i ;
  void *tmp ;
...
{ 
  ...
  int j ;
  int nbalt ;
    klee_make_symbolic(&nbalt, sizeof(int), "nbalt");
  int psize ;
...
{ 
  ...
  int nurbs ;
    klee_make_symbolic(&nurbs, sizeof(int), "nurbs");
  int i ;
  int psize ;
  int npkt ;
    klee_make_symbolic(&npkt, sizeof(int), "npkt");
  int bsize ;
...
{ 
  ...
  int ret ;
  int xfer ;
    klee_make_symbolic(&xfer, sizeof(int), "xfer");
  int alt ;
...
{ 
  int modeU ;
    klee_make_symbolic(&modeU, sizeof(int), "modeU");
  int modeD ;
    klee_make_symbolic(&modeD, sizeof(int), "modeD");
...
{ 
  ...
  unsigned long ldv_1_ldv_param_19_2_default ;
    klee_make_symbolic(&ldv_1_ldv_param_19_2_default, sizeof(long), "ldv_1_ldv_param_19_2_default");
  long long *ldv_1_ldv_param_19_3_default ;
  unsigned int ldv_1_ldv_param_22_1_default ;
    klee_make_symbolic(&ldv_1_ldv_param_22_1_default, sizeof(int), "ldv_1_ldv_param_22_1_default");
  ...
  unsigned int ldv_1_ldv_param_43_2_default ;
    klee_make_symbolic(&ldv_1_ldv_param_43_2_default, sizeof(int), "ldv_1_ldv_param_43_2_default");
