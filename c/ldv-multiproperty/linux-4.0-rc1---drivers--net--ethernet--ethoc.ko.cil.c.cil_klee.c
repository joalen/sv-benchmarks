...
void reach_error() { __assert_fail("0", "linux-4.0-rc1---drivers--net--ethernet--ethoc.ko.cil.c.cil.c", 5, "reach_error"); }
...
struct ethoc {
   ...
   void *membase ;
   int dma_alloc ;
    klee_make_symbolic(&dma_alloc, sizeof(int), "dma_alloc");
   resource_size_t io_region_size ;
   unsigned int num_bd ;
    klee_make_symbolic(&num_bd, sizeof(int), "num_bd");
   unsigned int num_tx ;
    klee_make_symbolic(&num_tx, sizeof(int), "num_tx");
   unsigned int cur_tx ;
    klee_make_symbolic(&cur_tx, sizeof(int), "cur_tx");
   unsigned int dty_tx ;
    klee_make_symbolic(&dty_tx, sizeof(int), "dty_tx");
   unsigned int num_rx ;
    klee_make_symbolic(&num_rx, sizeof(int), "num_rx");
   unsigned int cur_rx ;
...
{ 
  ...
  int rx_work_done ;
    klee_make_symbolic(&rx_work_done, sizeof(int), "rx_work_done");
  int tx_work_done ;
    klee_make_symbolic(&tx_work_done, sizeof(int), "tx_work_done");
...
{ 
  ...
  unsigned long tmp___73 ;
    klee_make_symbolic(&tmp___73, sizeof(long), "tmp___73");
  struct _ddebug descriptor ;
  long tmp___74 ;
