...
struct vme_lm_resource {
   ...
   int number ;
   int monitors ;
    klee_make_symbolic(&monitors, sizeof(int), "monitors");
};
struct vme_callback {
...
struct ca91cx42_dma_descriptor {
   ...
   unsigned int dtbc ;
    klee_make_symbolic(&dtbc, sizeof(int), "dtbc");
   unsigned int dla ;
    klee_make_symbolic(&dla, sizeof(int), "dla");
   unsigned int res1 ;
    klee_make_symbolic(&res1, sizeof(int), "res1");
   unsigned int dva ;
    klee_make_symbolic(&dva, sizeof(int), "dva");
   unsigned int res2 ;
    klee_make_symbolic(&res2, sizeof(int), "res2");
   unsigned int dcpp ;
    klee_make_symbolic(&dcpp, sizeof(int), "dcpp");
   unsigned int res3 ;
...
static int geoid  ;
    klee_make_symbolic(&geoid, sizeof(int), "geoid");
...
{ 
  ...
  unsigned int temp_ctl ;
    klee_make_symbolic(&temp_ctl, sizeof(int), "temp_ctl");
  unsigned int vme_bound ;
    klee_make_symbolic(&vme_bound, sizeof(int), "vme_bound");
  unsigned int pci_offset ;
    klee_make_symbolic(&pci_offset, sizeof(int), "pci_offset");
  struct vme_bridge *ca91cx42_bridge ;
  struct ca91cx42_driver *bridge ;
...
{ 
  unsigned long long existing_size ;
    klee_make_symbolic(&existing_size, sizeof(long), "existing_size");
  int retval ;
...
{ 
  ...
  unsigned long long pci_bound ;
    klee_make_symbolic(&pci_bound, sizeof(long), "pci_bound");
  unsigned long long vme_offset ;
    klee_make_symbolic(&vme_offset, sizeof(long), "vme_offset");
  unsigned long long pci_base ;
    klee_make_symbolic(&pci_base, sizeof(long), "pci_base");
  struct vme_bridge *ca91cx42_bridge ;
  struct ca91cx42_driver *bridge ;
...
{ 
  ...
  unsigned int count32 ;
    klee_make_symbolic(&count32, sizeof(int), "count32");
  unsigned int tmp ;
  unsigned int tmp___0 ;
  unsigned int tmp___1 ;
...
{ 
  unsigned int crcsr_addr ;
    klee_make_symbolic(&crcsr_addr, sizeof(int), "crcsr_addr");
  int tmp ;
  int slot ;
