...
struct nf_hook_ops {
   ...
   unsigned int hooknum ;
    klee_make_symbolic(&hooknum, sizeof(int), "hooknum");
   int priority ;
};
struct nlattr;
struct nf_logger;
...
struct nft_cmp_fast_expr {
   u32 data ;
   unsigned char sreg ;
    klee_make_symbolic(&sreg, sizeof(char), "sreg");
   u8 len ;
};
struct nft_expr_ops;
struct nft_payload {
   unsigned char base ;
    klee_make_symbolic(&base, sizeof(char), "base");
   u8 offset ;
   u8 len ;
   unsigned char dreg ;
    klee_make_symbolic(&dreg, sizeof(char), "dreg");
};
struct xt_match;
struct xt_target;
...
struct xt_action_param {
   ...
   int fragoff ;
    klee_make_symbolic(&fragoff, sizeof(int), "fragoff");
   unsigned int thoff ;
    klee_make_symbolic(&thoff, sizeof(int), "thoff");
   unsigned int hooknum ;
   u_int8_t family ;
   bool hotdrop ;
};
struct xt_mtchk_param {
   ...
   unsigned int hook_mask ;
    klee_make_symbolic(&hook_mask, sizeof(int), "hook_mask");
   u_int8_t family ;
};
...
struct xt_match {
   ...
   unsigned int matchsize ;
    klee_make_symbolic(&matchsize, sizeof(int), "matchsize");
   unsigned int compatsize ;
    klee_make_symbolic(&compatsize, sizeof(int), "compatsize");
   unsigned int hooks ;
    klee_make_symbolic(&hooks, sizeof(int), "hooks");
...
struct xt_target {
   ...
   unsigned int targetsize ;
    klee_make_symbolic(&targetsize, sizeof(int), "targetsize");
   unsigned int compatsize ;
   unsigned int hooks ;
   unsigned short proto ;
   unsigned short family ;
...
struct xt_table {
   ...
   unsigned int valid_hooks ;
    klee_make_symbolic(&valid_hooks, sizeof(int), "valid_hooks");
...
struct xt_table_info {
   ...
   unsigned int initial_entries ;
    klee_make_symbolic(&initial_entries, sizeof(int), "initial_entries");
   unsigned int hook_entry[5U] ;
   unsigned int underflow[5U] ;
   unsigned int stacksize ;
    klee_make_symbolic(&stacksize, sizeof(int), "stacksize");
...
struct nft_rule {
   ...
   unsigned char ulen ;
    klee_make_symbolic(&ulen, sizeof(char), "ulen");
   unsigned char data[] ;
};
struct nft_stats;
struct nft_chain {
...
struct nft_af_info {
   ...
   int family ;
   unsigned int nhooks ;
    klee_make_symbolic(&nhooks, sizeof(int), "nhooks");
   struct module *owner ;
   struct list_head tables ;
   unsigned int nops ;
    klee_make_symbolic(&nops, sizeof(int), "nops");
...
struct nft_jumpstack {
   ...
   int rulenum ;
    klee_make_symbolic(&rulenum, sizeof(int), "rulenum");
};
enum nft_trace {
    NFT_TRACE_RULE = 0,
    NFT_TRACE_RETURN = 1,
...
struct nft_trans {
   struct list_head list ;
   int msg_type ;
    klee_make_symbolic(&msg_type, sizeof(int), "msg_type");
   struct nft_ctx ctx ;
   char data[0U] ;
};
...
{ 
  ...
  unsigned int stackptr ;
    klee_make_symbolic(&stackptr, sizeof(int), "stackptr");
  struct nft_jumpstack jumpstack[16U] ;
  struct nft_stats *stats ;
  int rulenum ;
  unsigned int gencursor ;
    klee_make_symbolic(&gencursor, sizeof(int), "gencursor");
  u8 __var ;
...
{ 
  ...
  unsigned int s_idx ;
    klee_make_symbolic(&s_idx, sizeof(int), "s_idx");
  struct net *net ;
  struct net *tmp___0 ;
  int family ;
  struct list_head *__ptr ;
...
{ 
  ...
  struct net *tmp ;
  int cur_family ;
    klee_make_symbolic(&cur_family, sizeof(int), "cur_family");
  struct nft_ctx *ctx ;
