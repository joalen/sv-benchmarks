...
struct applesmc_registers {
   ...
   unsigned int key_count ;
    klee_make_symbolic(&key_count, sizeof(int), "key_count");
   unsigned int fan_count ;
    klee_make_symbolic(&fan_count, sizeof(int), "fan_count");
   unsigned int temp_count ;
    klee_make_symbolic(&temp_count, sizeof(int), "temp_count");
   unsigned int temp_begin ;
    klee_make_symbolic(&temp_begin, sizeof(int), "temp_begin");
   unsigned int temp_end ;
    klee_make_symbolic(&temp_end, sizeof(int), "temp_end");
   unsigned int index_count ;
    klee_make_symbolic(&index_count, sizeof(int), "index_count");
   int num_light_sensors ;
    klee_make_symbolic(&num_light_sensors, sizeof(int), "num_light_sensors");
...
static unsigned int key_at_index  ;
    klee_make_symbolic(&key_at_index, sizeof(int), "key_at_index");
static struct workqueue_struct *applesmc_led_wq  ;
static int wait_read(void) 
{ 
  u8 status ;
  int us ;
    klee_make_symbolic(&us, sizeof(int), "us");
...
{ 
  unsigned long newkey ;
    klee_make_symbolic(&newkey, sizeof(long), "newkey");
  int tmp ;
