...
struct zoran_sync {
   unsigned long frame ;
    klee_make_symbolic(&frame, sizeof(long), "frame");
...
struct zoran_format {
   ...
   __u32 fourcc ;
   int colorspace ;
    klee_make_symbolic(&colorspace, sizeof(int), "colorspace");
   int depth ;
   __u32 flags ;
   __u32 vfespfr ;
};
struct zoran_overlay_settings {
   int is_set ;
    klee_make_symbolic(&is_set, sizeof(int), "is_set");
   int x ;
   int y ;
   ...
   int height ;
   int clipcount ;
    klee_make_symbolic(&clipcount, sizeof(int), "clipcount");
...
struct zoran_jpg_settings {
   int decimation ;
    klee_make_symbolic(&decimation, sizeof(int), "decimation");
   int HorDcm ;
    klee_make_symbolic(&HorDcm, sizeof(int), "HorDcm");
   int VerDcm ;
    klee_make_symbolic(&VerDcm, sizeof(int), "VerDcm");
   int TmpDcm ;
    klee_make_symbolic(&TmpDcm, sizeof(int), "TmpDcm");
   int field_per_buff ;
    klee_make_symbolic(&field_per_buff, sizeof(int), "field_per_buff");
   int odd_even ;
    klee_make_symbolic(&odd_even, sizeof(int), "odd_even");
   int img_x ;
    klee_make_symbolic(&img_x, sizeof(int), "img_x");
   int img_y ;
    klee_make_symbolic(&img_y, sizeof(int), "img_y");
   int img_width ;
    klee_make_symbolic(&img_width, sizeof(int), "img_width");
   int img_height ;
    klee_make_symbolic(&img_height, sizeof(int), "img_height");
...
struct __anonstruct_v4l_238 {
   ...
   unsigned long fbuffer_phys ;
    klee_make_symbolic(&fbuffer_phys, sizeof(long), "fbuffer_phys");
   unsigned long fbuffer_bus ;
    klee_make_symbolic(&fbuffer_bus, sizeof(long), "fbuffer_bus");
};
...
struct zoran {
   ...
   unsigned short id ;
    klee_make_symbolic(&id, sizeof(short), "id");
   char name[32U] ;
   ...
   void *vbuf_base ;
   int vbuf_height ;
    klee_make_symbolic(&vbuf_height, sizeof(int), "vbuf_height");
   int vbuf_width ;
    klee_make_symbolic(&vbuf_width, sizeof(int), "vbuf_width");
   int vbuf_depth ;
    klee_make_symbolic(&vbuf_depth, sizeof(int), "vbuf_depth");
   int vbuf_bytesperline ;
    klee_make_symbolic(&vbuf_bytesperline, sizeof(int), "vbuf_bytesperline");
   struct zoran_overlay_settings overlay_settings ;
   u32 *overlay_mask ;
   enum zoran_lock_activity overlay_active ;
   wait_queue_head_t v4l_capq ;
   int v4l_overlay_active ;
    klee_make_symbolic(&v4l_overlay_active, sizeof(int), "v4l_overlay_active");
   int v4l_memgrab_active ;
    klee_make_symbolic(&v4l_memgrab_active, sizeof(int), "v4l_memgrab_active");
   int v4l_grab_frame ;
    klee_make_symbolic(&v4l_grab_frame, sizeof(int), "v4l_grab_frame");
   unsigned long v4l_grab_seq ;
    klee_make_symbolic(&v4l_grab_seq, sizeof(long), "v4l_grab_seq");
   struct zoran_v4l_settings v4l_settings ;
   unsigned long v4l_pend_head ;
    klee_make_symbolic(&v4l_pend_head, sizeof(long), "v4l_pend_head");
   unsigned long v4l_pend_tail ;
    klee_make_symbolic(&v4l_pend_tail, sizeof(long), "v4l_pend_tail");
   unsigned long v4l_sync_tail ;
    klee_make_symbolic(&v4l_sync_tail, sizeof(long), "v4l_sync_tail");
   int v4l_pend[32U] ;
   ...
   unsigned long jpg_que_head ;
    klee_make_symbolic(&jpg_que_head, sizeof(long), "jpg_que_head");
   unsigned long jpg_dma_head ;
    klee_make_symbolic(&jpg_dma_head, sizeof(long), "jpg_dma_head");
   unsigned long jpg_dma_tail ;
    klee_make_symbolic(&jpg_dma_tail, sizeof(long), "jpg_dma_tail");
   unsigned long jpg_que_tail ;
    klee_make_symbolic(&jpg_que_tail, sizeof(long), "jpg_que_tail");
   unsigned long jpg_seq_num ;
    klee_make_symbolic(&jpg_seq_num, sizeof(long), "jpg_seq_num");
   unsigned long jpg_err_seq ;
    klee_make_symbolic(&jpg_err_seq, sizeof(long), "jpg_err_seq");
   unsigned long jpg_err_shift ;
    klee_make_symbolic(&jpg_err_shift, sizeof(long), "jpg_err_shift");
   unsigned long jpg_queued_num ;
    klee_make_symbolic(&jpg_queued_num, sizeof(long), "jpg_queued_num");
   __le32 *stat_com ;
   int jpg_pend[256U] ;
   struct zoran_buffer_col jpg_buffers ;
   struct proc_dir_entry *zoran_proc ;
   int testing ;
    klee_make_symbolic(&testing, sizeof(int), "testing");
   int jpeg_error ;
    klee_make_symbolic(&jpeg_error, sizeof(int), "jpeg_error");
   int intr_counter_GIRQ1 ;
    klee_make_symbolic(&intr_counter_GIRQ1, sizeof(int), "intr_counter_GIRQ1");
   int intr_counter_GIRQ0 ;
    klee_make_symbolic(&intr_counter_GIRQ0, sizeof(int), "intr_counter_GIRQ0");
   int intr_counter_CodRepIRQ ;
    klee_make_symbolic(&intr_counter_CodRepIRQ, sizeof(int), "intr_counter_CodRepIRQ");
   int intr_counter_JPEGRepIRQ ;
    klee_make_symbolic(&intr_counter_JPEGRepIRQ, sizeof(int), "intr_counter_JPEGRepIRQ");
   int field_counter ;
    klee_make_symbolic(&field_counter, sizeof(int), "field_counter");
   int IRQ1_in ;
    klee_make_symbolic(&IRQ1_in, sizeof(int), "IRQ1_in");
   int IRQ1_out ;
    klee_make_symbolic(&IRQ1_out, sizeof(int), "IRQ1_out");
   int JPEG_in ;
    klee_make_symbolic(&JPEG_in, sizeof(int), "JPEG_in");
   int JPEG_out ;
    klee_make_symbolic(&JPEG_out, sizeof(int), "JPEG_out");
   int JPEG_0 ;
    klee_make_symbolic(&JPEG_0, sizeof(int), "JPEG_0");
   int JPEG_1 ;
    klee_make_symbolic(&JPEG_1, sizeof(int), "JPEG_1");
   int END_event_missed ;
    klee_make_symbolic(&END_event_missed, sizeof(int), "END_event_missed");
   int JPEG_missed ;
    klee_make_symbolic(&JPEG_missed, sizeof(int), "JPEG_missed");
   int JPEG_error ;
    klee_make_symbolic(&JPEG_error, sizeof(int), "JPEG_error");
   int num_errors ;
    klee_make_symbolic(&num_errors, sizeof(int), "num_errors");
   int JPEG_max_missed ;
    klee_make_symbolic(&JPEG_max_missed, sizeof(int), "JPEG_max_missed");
   int JPEG_min_missed ;
    klee_make_symbolic(&JPEG_min_missed, sizeof(int), "JPEG_min_missed");
   u32 last_isr ;
   unsigned long frame_num ;
    klee_make_symbolic(&frame_num, sizeof(long), "frame_num");
...
struct procfs_params_zr36067 {
   ...
   u32 mask ;
   short bit ;
    klee_make_symbolic(&bit, sizeof(short), "bit");
};
struct exec_domain;
struct map_segment;
struct exec_domain {
...
int zr36067_debug ;
    klee_make_symbolic(&zr36067_debug, sizeof(int), "zr36067_debug");
...
{ 
  ...
  int reg0 ;
    klee_make_symbolic(&reg0, sizeof(int), "reg0");
  int reg ;
  int val ;
...
extern int pci_pci_problems ;
    klee_make_symbolic(&pci_pci_problems, sizeof(int), "pci_pci_problems");
...
{ 
  ...
  int change[8U][3U] ;
  unsigned long t0 ;
    klee_make_symbolic(&t0, sizeof(long), "t0");
  unsigned long t1 ;
...
{ 
  struct tvnorm *tvn ;
  unsigned int HStart ;
    klee_make_symbolic(&HStart, sizeof(int), "HStart");
  unsigned int HEnd ;
    klee_make_symbolic(&HEnd, sizeof(int), "HEnd");
  unsigned int VStart ;
    klee_make_symbolic(&VStart, sizeof(int), "VStart");
  unsigned int VEnd ;
    klee_make_symbolic(&VEnd, sizeof(int), "VEnd");
  unsigned int DispMode ;
    klee_make_symbolic(&DispMode, sizeof(int), "DispMode");
  unsigned int VidWinWid ;
    klee_make_symbolic(&VidWinWid, sizeof(int), "VidWinWid");
  unsigned int VidWinHt ;
    klee_make_symbolic(&VidWinHt, sizeof(int), "VidWinHt");
  unsigned int hcrop1 ;
    klee_make_symbolic(&hcrop1, sizeof(int), "hcrop1");
  unsigned int hcrop2 ;
    klee_make_symbolic(&hcrop2, sizeof(int), "hcrop2");
  unsigned int vcrop1 ;
    klee_make_symbolic(&vcrop1, sizeof(int), "vcrop1");
  unsigned int vcrop2 ;
    klee_make_symbolic(&vcrop2, sizeof(int), "vcrop2");
  unsigned int Wa ;
    klee_make_symbolic(&Wa, sizeof(int), "Wa");
  unsigned int We ;
    klee_make_symbolic(&We, sizeof(int), "We");
  unsigned int Ha ;
    klee_make_symbolic(&Ha, sizeof(int), "Ha");
  unsigned int He ;
    klee_make_symbolic(&He, sizeof(int), "He");
  unsigned int X ;
  ...
  unsigned int mask_line_size ;
    klee_make_symbolic(&mask_line_size, sizeof(int), "mask_line_size");
  phys_addr_t tmp ;
  phys_addr_t tmp___0 ;
...
{ 
  int res ;
  int noerr ;
    klee_make_symbolic(&noerr, sizeof(int), "noerr");
...
{ 
  ...
  int field_size ;
    klee_make_symbolic(&field_size, sizeof(int), "field_size");
...
{ 
  ...
  int i ;
  int max_stat_com ;
    klee_make_symbolic(&max_stat_com, sizeof(int), "max_stat_com");
...
{ 
  ...
  unsigned int seq ;
  unsigned int dif ;
    klee_make_symbolic(&dif, sizeof(int), "dif");
...
{ 
  ...
  int j ;
  int j___0 ;
    klee_make_symbolic(&j___0, sizeof(int), "j___0");
  __le32 bus_addr[4U] ;
...
int v4l_nbufs ;
    klee_make_symbolic(&v4l_nbufs, sizeof(int), "v4l_nbufs");
int v4l_bufsize ;
    klee_make_symbolic(&v4l_bufsize, sizeof(int), "v4l_bufsize");
int jpg_nbufs ;
    klee_make_symbolic(&jpg_nbufs, sizeof(int), "jpg_nbufs");
int jpg_bufsize ;
    klee_make_symbolic(&jpg_bufsize, sizeof(int), "jpg_bufsize");
int pass_through ;
    klee_make_symbolic(&pass_through, sizeof(int), "pass_through");
...
{ 
  ...
  int frame ;
  int isr ;
    klee_make_symbolic(&isr, sizeof(int), "isr");
  unsigned int tmp ;
  long __ret ;
  wait_queue_t __wait ;
  long __ret___0 ;
...
{ 
  ...
  int res ;
  int first_open ;
    klee_make_symbolic(&first_open, sizeof(int), "first_open");
  struct task_struct *tmp___0 ;
  pid_t tmp___1 ;
...
{ 
  ...
  int on ;
    klee_make_symbolic(&on, sizeof(int), "on");
  int end ;
...
{ 
  ...
  int res ;
  int codec_mode ;
    klee_make_symbolic(&codec_mode, sizeof(int), "codec_mode");
  int buf_type ;
    klee_make_symbolic(&buf_type, sizeof(int), "buf_type");
...
{ 
  ...
  unsigned long start ;
  unsigned long todo ;
    klee_make_symbolic(&todo, sizeof(long), "todo");
  unsigned long pos ;
    klee_make_symbolic(&pos, sizeof(long), "pos");
  unsigned long fraglen ;
    klee_make_symbolic(&fraglen, sizeof(long), "fraglen");
  int first ;
...
long long ldv_5_ldv_param_18_1_default ;
    klee_make_symbolic(&ldv_5_ldv_param_18_1_default, sizeof(long), "ldv_5_ldv_param_18_1_default");
...
unsigned long ldv_5_ldv_param_23_2_default ;
    klee_make_symbolic(&ldv_5_ldv_param_23_2_default, sizeof(long), "ldv_5_ldv_param_23_2_default");
...
unsigned long ldv_5_ldv_param_26_2_default ;
    klee_make_symbolic(&ldv_5_ldv_param_26_2_default, sizeof(long), "ldv_5_ldv_param_26_2_default");
...
unsigned int ldv_5_ldv_param_52_2_default ;
    klee_make_symbolic(&ldv_5_ldv_param_52_2_default, sizeof(int), "ldv_5_ldv_param_52_2_default");
unsigned int ldv_5_ldv_param_66_2_default ;
    klee_make_symbolic(&ldv_5_ldv_param_66_2_default, sizeof(int), "ldv_5_ldv_param_66_2_default");
unsigned int ldv_5_ldv_param_70_2_default ;
    klee_make_symbolic(&ldv_5_ldv_param_70_2_default, sizeof(int), "ldv_5_ldv_param_70_2_default");
unsigned long long ldv_5_ldv_param_73_2_default ;
    klee_make_symbolic(&ldv_5_ldv_param_73_2_default, sizeof(long), "ldv_5_ldv_param_73_2_default");
char *ldv_5_ldv_param_81_1_default ;
unsigned long ldv_5_ldv_param_81_2_default ;
    klee_make_symbolic(&ldv_5_ldv_param_81_2_default, sizeof(long), "ldv_5_ldv_param_81_2_default");
...
long long ldv_6_ldv_param_18_1_default ;
    klee_make_symbolic(&ldv_6_ldv_param_18_1_default, sizeof(long), "ldv_6_ldv_param_18_1_default");
...
unsigned long ldv_6_ldv_param_23_2_default ;
    klee_make_symbolic(&ldv_6_ldv_param_23_2_default, sizeof(long), "ldv_6_ldv_param_23_2_default");
long long *ldv_6_ldv_param_23_3_default ;
unsigned int ldv_6_ldv_param_26_1_default ;
    klee_make_symbolic(&ldv_6_ldv_param_26_1_default, sizeof(int), "ldv_6_ldv_param_26_1_default");
unsigned long ldv_6_ldv_param_26_2_default ;
    klee_make_symbolic(&ldv_6_ldv_param_26_2_default, sizeof(long), "ldv_6_ldv_param_26_2_default");
...
unsigned int ldv_6_ldv_param_52_2_default ;
    klee_make_symbolic(&ldv_6_ldv_param_52_2_default, sizeof(int), "ldv_6_ldv_param_52_2_default");
unsigned int ldv_6_ldv_param_66_2_default ;
    klee_make_symbolic(&ldv_6_ldv_param_66_2_default, sizeof(int), "ldv_6_ldv_param_66_2_default");
unsigned int ldv_6_ldv_param_70_2_default ;
    klee_make_symbolic(&ldv_6_ldv_param_70_2_default, sizeof(int), "ldv_6_ldv_param_70_2_default");
unsigned long long ldv_6_ldv_param_73_2_default ;
    klee_make_symbolic(&ldv_6_ldv_param_73_2_default, sizeof(long), "ldv_6_ldv_param_73_2_default");
char *ldv_6_ldv_param_81_1_default ;
unsigned long ldv_6_ldv_param_81_2_default ;
    klee_make_symbolic(&ldv_6_ldv_param_81_2_default, sizeof(long), "ldv_6_ldv_param_81_2_default");
...
long long ldv_7_ldv_param_18_1_default ;
    klee_make_symbolic(&ldv_7_ldv_param_18_1_default, sizeof(long), "ldv_7_ldv_param_18_1_default");
...
unsigned long ldv_7_ldv_param_23_2_default ;
    klee_make_symbolic(&ldv_7_ldv_param_23_2_default, sizeof(long), "ldv_7_ldv_param_23_2_default");
long long *ldv_7_ldv_param_23_3_default ;
unsigned int ldv_7_ldv_param_26_1_default ;
    klee_make_symbolic(&ldv_7_ldv_param_26_1_default, sizeof(int), "ldv_7_ldv_param_26_1_default");
unsigned long ldv_7_ldv_param_26_2_default ;
    klee_make_symbolic(&ldv_7_ldv_param_26_2_default, sizeof(long), "ldv_7_ldv_param_26_2_default");
...
unsigned int ldv_7_ldv_param_52_2_default ;
    klee_make_symbolic(&ldv_7_ldv_param_52_2_default, sizeof(int), "ldv_7_ldv_param_52_2_default");
unsigned int ldv_7_ldv_param_66_2_default ;
    klee_make_symbolic(&ldv_7_ldv_param_66_2_default, sizeof(int), "ldv_7_ldv_param_66_2_default");
unsigned int ldv_7_ldv_param_70_2_default ;
    klee_make_symbolic(&ldv_7_ldv_param_70_2_default, sizeof(int), "ldv_7_ldv_param_70_2_default");
unsigned long long ldv_7_ldv_param_73_2_default ;
    klee_make_symbolic(&ldv_7_ldv_param_73_2_default, sizeof(long), "ldv_7_ldv_param_73_2_default");
char *ldv_7_ldv_param_81_1_default ;
unsigned long ldv_7_ldv_param_81_2_default ;
    klee_make_symbolic(&ldv_7_ldv_param_81_2_default, sizeof(long), "ldv_7_ldv_param_81_2_default");
...
long long ldv_8_ldv_param_18_1_default ;
    klee_make_symbolic(&ldv_8_ldv_param_18_1_default, sizeof(long), "ldv_8_ldv_param_18_1_default");
int ldv_8_ldv_param_18_2_default ;
    klee_make_symbolic(&ldv_8_ldv_param_18_2_default, sizeof(int), "ldv_8_ldv_param_18_2_default");
char *ldv_8_ldv_param_23_1_default ;
unsigned long ldv_8_ldv_param_23_2_default ;
    klee_make_symbolic(&ldv_8_ldv_param_23_2_default, sizeof(long), "ldv_8_ldv_param_23_2_default");
long long *ldv_8_ldv_param_23_3_default ;
unsigned int ldv_8_ldv_param_26_1_default ;
    klee_make_symbolic(&ldv_8_ldv_param_26_1_default, sizeof(int), "ldv_8_ldv_param_26_1_default");
unsigned long ldv_8_ldv_param_26_2_default ;
    klee_make_symbolic(&ldv_8_ldv_param_26_2_default, sizeof(long), "ldv_8_ldv_param_26_2_default");
...
unsigned int ldv_8_ldv_param_52_2_default ;
    klee_make_symbolic(&ldv_8_ldv_param_52_2_default, sizeof(int), "ldv_8_ldv_param_52_2_default");
unsigned int ldv_8_ldv_param_66_2_default ;
    klee_make_symbolic(&ldv_8_ldv_param_66_2_default, sizeof(int), "ldv_8_ldv_param_66_2_default");
unsigned int ldv_8_ldv_param_70_2_default ;
    klee_make_symbolic(&ldv_8_ldv_param_70_2_default, sizeof(int), "ldv_8_ldv_param_70_2_default");
unsigned long long ldv_8_ldv_param_73_2_default ;
    klee_make_symbolic(&ldv_8_ldv_param_73_2_default, sizeof(long), "ldv_8_ldv_param_73_2_default");
char *ldv_8_ldv_param_81_1_default ;
unsigned long ldv_8_ldv_param_81_2_default ;
    klee_make_symbolic(&ldv_8_ldv_param_81_2_default, sizeof(long), "ldv_8_ldv_param_81_2_default");
...
long long ldv_9_ldv_param_18_1_default ;
    klee_make_symbolic(&ldv_9_ldv_param_18_1_default, sizeof(long), "ldv_9_ldv_param_18_1_default");
int ldv_9_ldv_param_18_2_default ;
    klee_make_symbolic(&ldv_9_ldv_param_18_2_default, sizeof(int), "ldv_9_ldv_param_18_2_default");
char *ldv_9_ldv_param_23_1_default ;
unsigned long ldv_9_ldv_param_23_2_default ;
    klee_make_symbolic(&ldv_9_ldv_param_23_2_default, sizeof(long), "ldv_9_ldv_param_23_2_default");
long long *ldv_9_ldv_param_23_3_default ;
unsigned int ldv_9_ldv_param_26_1_default ;
    klee_make_symbolic(&ldv_9_ldv_param_26_1_default, sizeof(int), "ldv_9_ldv_param_26_1_default");
unsigned long ldv_9_ldv_param_26_2_default ;
    klee_make_symbolic(&ldv_9_ldv_param_26_2_default, sizeof(long), "ldv_9_ldv_param_26_2_default");
...
unsigned int ldv_9_ldv_param_52_2_default ;
    klee_make_symbolic(&ldv_9_ldv_param_52_2_default, sizeof(int), "ldv_9_ldv_param_52_2_default");
unsigned int ldv_9_ldv_param_66_2_default ;
    klee_make_symbolic(&ldv_9_ldv_param_66_2_default, sizeof(int), "ldv_9_ldv_param_66_2_default");
unsigned int ldv_9_ldv_param_70_2_default ;
    klee_make_symbolic(&ldv_9_ldv_param_70_2_default, sizeof(int), "ldv_9_ldv_param_70_2_default");
unsigned long long ldv_9_ldv_param_73_2_default ;
    klee_make_symbolic(&ldv_9_ldv_param_73_2_default, sizeof(long), "ldv_9_ldv_param_73_2_default");
char *ldv_9_ldv_param_81_1_default ;
unsigned long ldv_9_ldv_param_81_2_default ;
    klee_make_symbolic(&ldv_9_ldv_param_81_2_default, sizeof(long), "ldv_9_ldv_param_81_2_default");
...
static unsigned long vidmem  ;
    klee_make_symbolic(&vidmem, sizeof(long), "vidmem");
static unsigned int default_input  ;
    klee_make_symbolic(&default_input, sizeof(int), "default_input");
static int default_mux  =    1;
static int default_norm  ;
    klee_make_symbolic(&default_norm, sizeof(int), "default_norm");
...
static unsigned int zoran_num  ;
    klee_make_symbolic(&zoran_num, sizeof(int), "zoran_num");
...
{ 
  int mux ;
    klee_make_symbolic(&mux, sizeof(int), "mux");
...
{ 
  ...
  int err0 ;
    klee_make_symbolic(&err0, sizeof(int), "err0");
  int __val ;
  ...
  int __val___1 ;
    klee_make_symbolic(&__val___1, sizeof(int), "__val___1");
  int __min___1 ;
    klee_make_symbolic(&__min___1, sizeof(int), "__min___1");
  int __max___1 ;
    klee_make_symbolic(&__max___1, sizeof(int), "__max___1");
  int __val___2 ;
    klee_make_symbolic(&__val___2, sizeof(int), "__val___2");
  int __min___2 ;
    klee_make_symbolic(&__min___2, sizeof(int), "__min___2");
  int __max___2 ;
    klee_make_symbolic(&__max___2, sizeof(int), "__max___2");
  int __val___3 ;
    klee_make_symbolic(&__val___3, sizeof(int), "__val___3");
  int __min___3 ;
    klee_make_symbolic(&__min___3, sizeof(int), "__min___3");
  int __max___3 ;
    klee_make_symbolic(&__max___3, sizeof(int), "__max___3");
  int __val___4 ;
    klee_make_symbolic(&__val___4, sizeof(int), "__val___4");
  int __min___4 ;
    klee_make_symbolic(&__min___4, sizeof(int), "__min___4");
  int __max___4 ;
    klee_make_symbolic(&__max___4, sizeof(int), "__max___4");
...
{ 
  ...
  unsigned char need_latency ;
    klee_make_symbolic(&need_latency, sizeof(char), "need_latency");
  struct zoran *zr ;
  int result ;
  ...
  int card_num ;
    klee_make_symbolic(&card_num, sizeof(int), "card_num");
  char *codec_name ;
  char *vfe_name ;
  unsigned int nr ;
  unsigned int tmp ;
