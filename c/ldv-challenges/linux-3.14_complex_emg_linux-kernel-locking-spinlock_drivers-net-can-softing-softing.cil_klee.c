...
struct softing_platform_data {
   unsigned int manf ;
    klee_make_symbolic(&manf, sizeof(int), "manf");
   unsigned int prod ;
    klee_make_symbolic(&prod, sizeof(int), "prod");
   int generation ;
    klee_make_symbolic(&generation, sizeof(int), "generation");
   int nbus ;
    klee_make_symbolic(&nbus, sizeof(int), "nbus");
   unsigned int freq ;
    klee_make_symbolic(&freq, sizeof(int), "freq");
   unsigned int max_brp ;
    klee_make_symbolic(&max_brp, sizeof(int), "max_brp");
   unsigned int max_sjw ;
    klee_make_symbolic(&max_sjw, sizeof(int), "max_sjw");
   unsigned long dpram_size ;
    klee_make_symbolic(&dpram_size, sizeof(long), "dpram_size");
   char const   *name ;
...
struct __anonstruct_tx_251 {
   ...
   int echo_put ;
    klee_make_symbolic(&echo_put, sizeof(int), "echo_put");
   int echo_get ;
    klee_make_symbolic(&echo_get, sizeof(int), "echo_get");
};
struct softing_priv {
   struct can_priv can ;
...
struct __anonstruct_irq_253 {
   ...
   int svc_count ;
    klee_make_symbolic(&svc_count, sizeof(int), "svc_count");
   unsigned int dpram_position ;
    klee_make_symbolic(&dpram_position, sizeof(int), "dpram_position");
};
struct __anonstruct_tx_254 {
   int pending ;
   int last_bus ;
    klee_make_symbolic(&last_bus, sizeof(int), "last_bus");
};
...
struct softing {
   ...
   unsigned long dpram_phys ;
    klee_make_symbolic(&dpram_phys, sizeof(long), "dpram_phys");
   unsigned long dpram_size ;
...
{ 
  ...
  int lost_msg ;
    klee_make_symbolic(&lost_msg, sizeof(int), "lost_msg");
  uint8_t fifo_rd ;
  uint8_t fifo_wr ;
  uint8_t cmd ;
  uint8_t *ptr ;
...
{ 
  int fw_up ;
    klee_make_symbolic(&fw_up, sizeof(int), "fw_up");
  int tmp ;
...
{ 
  ...
  int ldv_18_line_line ;
    klee_make_symbolic(&ldv_18_line_line, sizeof(int), "ldv_18_line_line");
...
{ 
  ...
  unsigned int rx_sum ;
    klee_make_symbolic(&rx_sum, sizeof(int), "rx_sum");
  int8_t type_end ;
...
{ 
  ...
  int bus_bitmask_start ;
    klee_make_symbolic(&bus_bitmask_start, sizeof(int), "bus_bitmask_start");
  int j ;
  int error_reporting ;
    klee_make_symbolic(&error_reporting, sizeof(int), "error_reporting");
  struct can_frame msg ;
