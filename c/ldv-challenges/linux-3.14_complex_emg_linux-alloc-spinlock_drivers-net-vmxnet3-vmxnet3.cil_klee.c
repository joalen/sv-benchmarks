...
struct vmxnet3_tx_queue {
   ...
   bool stopped ;
   int num_stop ;
    klee_make_symbolic(&num_stop, sizeof(int), "num_stop");
   int qid ;
...
struct vmxnet3_adapter {
   ...
   unsigned int skb_buf_size ;
    klee_make_symbolic(&skb_buf_size, sizeof(int), "skb_buf_size");
   int rx_buf_per_pkt ;
    klee_make_symbolic(&rx_buf_per_pkt, sizeof(int), "rx_buf_per_pkt");
   ...
   unsigned long state ;
   int share_intr ;
    klee_make_symbolic(&share_intr, sizeof(int), "share_intr");
...
{ 
  int num_allocated ;
    klee_make_symbolic(&num_allocated, sizeof(int), "num_allocated");
...
{ 
  ...
  unsigned long buf_offset ;
    klee_make_symbolic(&buf_offset, sizeof(long), "buf_offset");
  int i ;
  union Vmxnet3_GenericDesc *gdesc ;
  struct vmxnet3_tx_buf_info *tbi ;
  unsigned int tmp ;
...
{ 
  ...
  int num_to_alloc ;
    klee_make_symbolic(&num_to_alloc, sizeof(int), "num_to_alloc");
  struct Vmxnet3_RxDesc *rxd ;
  u32 idx ;
  u32 ring_idx ;
  struct vmxnet3_cmd_ring *ring ;
...
{ 
  int rcd_done ;
    klee_make_symbolic(&rcd_done, sizeof(int), "rcd_done");
  int i ;
  long tmp ;
  int tmp___0 ;
...
{ 
  ...
  int rxd_done ;
    klee_make_symbolic(&rxd_done, sizeof(int), "rxd_done");
...
{ 
  ...
  unsigned long tmp___139 ;
    klee_make_symbolic(&tmp___139, sizeof(long), "tmp___139");
  int _max1 ;
  ...
  struct _ddebug descriptor ;
  long tmp___145 ;
    klee_make_symbolic(&tmp___145, sizeof(long), "tmp___145");
...
unsigned int ldv_4_ldv_param_25_1_default  ;
    klee_make_symbolic(&ldv_4_ldv_param_25_1_default, sizeof(int), "ldv_4_ldv_param_25_1_default");
