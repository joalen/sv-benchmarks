...
extern unsigned int saa7146_debug ;
    klee_make_symbolic(&saa7146_debug, sizeof(int), "saa7146_debug");
...
unsigned long long ldv_2_ldv_param_33_2_default  ;
    klee_make_symbolic(&ldv_2_ldv_param_33_2_default, sizeof(long), "ldv_2_ldv_param_33_2_default");
...
unsigned long ldv_6_ldv_param_29_2_default  ;
    klee_make_symbolic(&ldv_6_ldv_param_29_2_default, sizeof(long), "ldv_6_ldv_param_29_2_default");
...
{ 
  ...
  int p ;
  int m1 ;
    klee_make_symbolic(&m1, sizeof(int), "m1");
  int m2 ;
    klee_make_symbolic(&m2, sizeof(int), "m2");
  int m3 ;
    klee_make_symbolic(&m3, sizeof(int), "m3");
  int o1 ;
...
{ 
  ...
  unsigned int resource ;
    klee_make_symbolic(&resource, sizeof(int), "resource");
  int ret ;
  int err ;
  struct _ddebug descriptor ;
  long tmp ;
...
{ 
  ...
  int calc_bpl ;
    klee_make_symbolic(&calc_bpl, sizeof(int), "calc_bpl");
  struct _ddebug descriptor ;
  long tmp ;
  struct _ddebug descriptor___0 ;
  long tmp___0 ;
...
{ 
  int hyo ;
    klee_make_symbolic(&hyo, sizeof(int), "hyo");
  int hxo ;
    klee_make_symbolic(&hxo, sizeof(int), "hxo");
...
{ 
  int lpi ;
    klee_make_symbolic(&lpi, sizeof(int), "lpi");
  u32 yacm ;
  u32 ysci ;
  u32 yacl ;
  u32 ypo ;
...
{ 
  ...
  u32 pixel_list[32U] ;
  int numdwords ;
    klee_make_symbolic(&numdwords, sizeof(int), "numdwords");
  int i ;
  int j ;
  int cnt_line ;
    klee_make_symbolic(&cnt_line, sizeof(int), "cnt_line");
  int cnt_pixel ;
    klee_make_symbolic(&cnt_pixel, sizeof(int), "cnt_pixel");
  int x[32U] ;
  int y[32U] ;
  int w[32U] ;
  int h[32U] ;
...
{ 
  ...
  int b_depth ;
    klee_make_symbolic(&b_depth, sizeof(int), "b_depth");
  int b_bpl ;
    klee_make_symbolic(&b_bpl, sizeof(int), "b_bpl");
  u32 base ;
...
{ 
  int where ;
    klee_make_symbolic(&where, sizeof(int), "where");
...
{ 
  ...
  unsigned long e_wait ;
    klee_make_symbolic(&e_wait, sizeof(long), "e_wait");
  unsigned long o_wait ;
    klee_make_symbolic(&o_wait, sizeof(long), "o_wait");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
  int tmp___2 ;
...
{ 
  ...
  int llength ;
    klee_make_symbolic(&llength, sizeof(int), "llength");
  int size ;
  struct _ddebug descriptor ;
  long tmp ;
  struct _ddebug descriptor___0 ;
