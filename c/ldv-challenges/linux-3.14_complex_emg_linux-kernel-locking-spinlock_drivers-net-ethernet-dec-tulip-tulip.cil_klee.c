...
struct tulip_private {
   ...
   int mit_on ;
    klee_make_symbolic(&mit_on, sizeof(int), "mit_on");
   ...
   unsigned int csr6 ;
    klee_make_symbolic(&csr6, sizeof(int), "csr6");
   ...
   signed char phys[4U] ;
   signed char mii_cnt ;
    klee_make_symbolic(&mii_cnt, sizeof(char), "mii_cnt");
   struct mediatable *mtable ;
   int cur_index ;
    klee_make_symbolic(&cur_index, sizeof(int), "cur_index");
   int saved_if_port ;
    klee_make_symbolic(&saved_if_port, sizeof(int), "saved_if_port");
   struct pci_dev *pdev ;
   int ttimer ;
    klee_make_symbolic(&ttimer, sizeof(int), "ttimer");
   int susp_rx ;
    klee_make_symbolic(&susp_rx, sizeof(int), "susp_rx");
   unsigned long nir ;
    klee_make_symbolic(&nir, sizeof(long), "nir");
   void *base_addr ;
   int csr12_shadow ;
    klee_make_symbolic(&csr12_shadow, sizeof(int), "csr12_shadow");
   int pad0 ;
...
struct eeprom_fixup {
   char *name ;
   unsigned char addr0 ;
    klee_make_symbolic(&addr0, sizeof(char), "addr0");
   unsigned char addr1 ;
    klee_make_symbolic(&addr1, sizeof(char), "addr1");
   unsigned char addr2 ;
    klee_make_symbolic(&addr2, sizeof(char), "addr2");
   u16 newtable[32U] ;
};
struct _ddebug {
   char const   *modname ;
...
struct tulip_chip_table {
   ...
   int valid_intrs ;
    klee_make_symbolic(&valid_intrs, sizeof(int), "valid_intrs");
   int flags ;
...
int tulip_debug ;
    klee_make_symbolic(&tulip_debug, sizeof(int), "tulip_debug");
...
{ 
  ...
  int controller_index ;
    klee_make_symbolic(&controller_index, sizeof(int), "controller_index");
  ...
  unsigned char csr12dir ;
    klee_make_symbolic(&csr12dir, sizeof(char), "csr12dir");
  int count ;
  int new_advertise ;
    klee_make_symbolic(&new_advertise, sizeof(int), "new_advertise");
  struct mediatable *mtable ;
  u16 media ;
  u16 tmp___0 ;
  ...
  int gpr_len ;
    klee_make_symbolic(&gpr_len, sizeof(int), "gpr_len");
  int reset_len ;
    klee_make_symbolic(&reset_len, sizeof(int), "reset_len");
  u16 tmp___8 ;
  u32 base15 ;
  u16 tmp___9 ;
  u16 tmp___10 ;
...
unsigned int tulip_max_interrupt_work  ;
    klee_make_symbolic(&tulip_max_interrupt_work, sizeof(int), "tulip_max_interrupt_work");
int tulip_rx_copybreak  ;
    klee_make_symbolic(&tulip_rx_copybreak, sizeof(int), "tulip_rx_copybreak");
...
{ 
  ...
  int refilled ;
    klee_make_symbolic(&refilled, sizeof(int), "refilled");
  struct sk_buff *skb ;
  dma_addr_t mapping ;
...
{ 
  ...
  int oi ;
    klee_make_symbolic(&oi, sizeof(int), "oi");
  int maxrx ;
    klee_make_symbolic(&maxrx, sizeof(int), "maxrx");
  int maxtx ;
    klee_make_symbolic(&maxtx, sizeof(int), "maxtx");
  int maxoi ;
    klee_make_symbolic(&maxoi, sizeof(int), "maxoi");
  int rxd ;
    klee_make_symbolic(&rxd, sizeof(int), "rxd");
  unsigned int work_count ;
    klee_make_symbolic(&work_count, sizeof(int), "work_count");
...
{ 
  ...
  long tmp___4 ;
  int phy_num ;
    klee_make_symbolic(&phy_num, sizeof(int), "phy_num");
  int init_length ;
    klee_make_symbolic(&init_length, sizeof(int), "init_length");
  u16 *misc_info ;
  u16 tmp_info ;
  u16 *init_sequence ;
  u16 *reset_sequence ;
  int reset_length ;
    klee_make_symbolic(&reset_length, sizeof(int), "reset_length");
  int timeout ;
  u16 tmp___5 ;
  int tmp___6 ;
  int tmp___7 ;
  ...
  int reset_length___0 ;
    klee_make_symbolic(&reset_length___0, sizeof(int), "reset_length___0");
  int timeout___0 ;
...
{ 
  ...
  unsigned int negotiated ;
    klee_make_symbolic(&negotiated, sizeof(int), "negotiated");
  unsigned int new_csr6 ;
    klee_make_symbolic(&new_csr6, sizeof(int), "new_csr6");
  int tmp___0 ;
  int tmp___1 ;
  int new_bmsr ;
    klee_make_symbolic(&new_bmsr, sizeof(int), "new_bmsr");
  int tmp___2 ;
...
{ 
  ...
  void *tmp ;
  int phyn ;
    klee_make_symbolic(&phyn, sizeof(int), "phyn");
  int phy_idx ;
    klee_make_symbolic(&phy_idx, sizeof(int), "phy_idx");
  int mii_reg0 ;
    klee_make_symbolic(&mii_reg0, sizeof(int), "mii_reg0");
  int mii_advert ;
    klee_make_symbolic(&mii_advert, sizeof(int), "mii_advert");
  unsigned int to_advert ;
    klee_make_symbolic(&to_advert, sizeof(int), "to_advert");
  unsigned int new_bmcr ;
    klee_make_symbolic(&new_bmcr, sizeof(int), "new_bmcr");
  unsigned int ane_switch ;
    klee_make_symbolic(&ane_switch, sizeof(int), "ane_switch");
  int phy ;
    klee_make_symbolic(&phy, sizeof(int), "phy");
  int mii_status ;
    klee_make_symbolic(&mii_status, sizeof(int), "mii_status");
  int tmp___0 ;
  unsigned int tmpadv ;
    klee_make_symbolic(&tmpadv, sizeof(int), "tmpadv");
  int tmp___1 ;
  u16 tmp___2 ;
  int tmp___3 ;
  struct _ddebug descriptor ;
...
{ 
  ...
  u16 *tmp___10 ;
  int looking_for ;
    klee_make_symbolic(&looking_for, sizeof(int), "looking_for");
  int looking_for___0 ;
    klee_make_symbolic(&looking_for___0, sizeof(int), "looking_for___0");
  int tmp___11 ;
...
{ 
  ...
  int phy ;
  unsigned int regnum ;
    klee_make_symbolic(&regnum, sizeof(int), "regnum");
  int csr12 ;
    klee_make_symbolic(&csr12, sizeof(int), "csr12");
  unsigned int tmp___1 ;
  int csr14 ;
    klee_make_symbolic(&csr14, sizeof(int), "csr14");
  unsigned int tmp___2 ;
  unsigned int tmp___3 ;
  int tmp___4 ;
  u16 value ;
...
{ 
  ...
  u32 mc_filter[2U] ;
  int filterbit ;
    klee_make_symbolic(&filterbit, sizeof(int), "filterbit");
  struct list_head  const  *__mptr ;
  u32 tmp___1 ;
  u32 tmp___2 ;
  u32 tmp___3 ;
...
{ 
  ...
  int last_irq ;
    klee_make_symbolic(&last_irq, sizeof(int), "last_irq");
  int multiport_cnt ;
    klee_make_symbolic(&multiport_cnt, sizeof(int), "multiport_cnt");
  int i ;
  int irq ;
  unsigned short sum ;
  ...
  void *ioaddr ;
  int board_idx ;
    klee_make_symbolic(&board_idx, sizeof(int), "board_idx");
  int chip_idx ;
    klee_make_symbolic(&chip_idx, sizeof(int), "chip_idx");
  char const   *chip_name ;
  unsigned int eeprom_missing ;
    klee_make_symbolic(&eeprom_missing, sizeof(int), "eeprom_missing");
  unsigned int force_csr0 ;
    klee_make_symbolic(&force_csr0, sizeof(int), "force_csr0");
  int tmp ;
  int tmp___0 ;
  char const   *tmp___1 ;
  int tmp___2 ;
  ...
  unsigned int tmp___7 ;
  int sa_offset ;
    klee_make_symbolic(&sa_offset, sizeof(int), "sa_offset");
  int ee_addr_size ;
    klee_make_symbolic(&ee_addr_size, sizeof(int), "ee_addr_size");
  int tmp___8 ;
  int ee_max_addr ;
    klee_make_symbolic(&ee_max_addr, sizeof(int), "ee_max_addr");
  u16 data ;
  int tmp___9 ;
  char tmp___10 ;
  u16 media2advert[7U] ;
...
int ldv_1_ldv_param_11_2_default  ;
    klee_make_symbolic(&ldv_1_ldv_param_11_2_default, sizeof(int), "ldv_1_ldv_param_11_2_default");
...
unsigned long ldv_3_ldv_param_7_0_default  ;
    klee_make_symbolic(&ldv_3_ldv_param_7_0_default, sizeof(long), "ldv_3_ldv_param_7_0_default");
...
unsigned long ldv_4_ldv_param_7_0_default  ;
    klee_make_symbolic(&ldv_4_ldv_param_7_0_default, sizeof(long), "ldv_4_ldv_param_7_0_default");
...
unsigned long ldv_5_ldv_param_7_0_default  ;
    klee_make_symbolic(&ldv_5_ldv_param_7_0_default, sizeof(long), "ldv_5_ldv_param_7_0_default");
...
unsigned long ldv_6_ldv_param_7_0_default  ;
    klee_make_symbolic(&ldv_6_ldv_param_7_0_default, sizeof(long), "ldv_6_ldv_param_7_0_default");
...
unsigned long ldv_7_ldv_param_7_0_default  ;
    klee_make_symbolic(&ldv_7_ldv_param_7_0_default, sizeof(long), "ldv_7_ldv_param_7_0_default");
...
{ 
  ...
  unsigned int tmp___1 ;
  int setup_done ;
    klee_make_symbolic(&setup_done, sizeof(int), "setup_done");
  int negotiated ;
  int i ;
  int startup ;
    klee_make_symbolic(&startup, sizeof(int), "startup");
  struct _ddebug descriptor ;
  unsigned int tmp___2 ;
  unsigned int tmp___3 ;
  long tmp___4 ;
