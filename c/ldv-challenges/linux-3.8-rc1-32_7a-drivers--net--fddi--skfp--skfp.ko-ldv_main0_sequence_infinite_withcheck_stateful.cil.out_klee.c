...
struct cgroupfs_root {
   ...
   unsigned long actual_subsys_mask ;
    klee_make_symbolic(&actual_subsys_mask, sizeof(long), "actual_subsys_mask");
...
struct smt_timer {
   ...
   struct s_smc *tm_smc ;
   u_long tm_delta ;
    klee_make_symbolic(&tm_delta, sizeof(long), "tm_delta");
   u_long tm_token ;
    klee_make_symbolic(&tm_token, sizeof(long), "tm_token");
   u_short tm_active ;
    klee_make_symbolic(&tm_active, sizeof(short), "tm_active");
   u_short tm_pad ;
    klee_make_symbolic(&tm_pad, sizeof(short), "tm_pad");
};
struct mac_parameter {
   u_long t_neg ;
    klee_make_symbolic(&t_neg, sizeof(long), "t_neg");
   u_long t_pri ;
    klee_make_symbolic(&t_pri, sizeof(long), "t_pri");
};
struct mac_counter {
   u_long mac_nobuf_counter ;
    klee_make_symbolic(&mac_nobuf_counter, sizeof(long), "mac_nobuf_counter");
   u_long mac_r_restart_counter ;
    klee_make_symbolic(&mac_r_restart_counter, sizeof(long), "mac_r_restart_counter");
};
struct lem_counter {
   u_short lem_float_ber ;
    klee_make_symbolic(&lem_float_ber, sizeof(short), "lem_float_ber");
   u_long lem_errors ;
    klee_make_symbolic(&lem_errors, sizeof(long), "lem_errors");
   u_short lem_on ;
    klee_make_symbolic(&lem_on, sizeof(short), "lem_on");
};
struct s_plc {
   u_short p_state ;
    klee_make_symbolic(&p_state, sizeof(short), "p_state");
   u_short p_bits ;
    klee_make_symbolic(&p_bits, sizeof(short), "p_bits");
   u_short p_start ;
    klee_make_symbolic(&p_start, sizeof(short), "p_start");
   u_short p_pad ;
    klee_make_symbolic(&p_pad, sizeof(short), "p_pad");
   u_long soft_err ;
    klee_make_symbolic(&soft_err, sizeof(long), "soft_err");
   u_long parity_err ;
    klee_make_symbolic(&parity_err, sizeof(long), "parity_err");
   u_long ebuf_err ;
    klee_make_symbolic(&ebuf_err, sizeof(long), "ebuf_err");
   u_long ebuf_cont ;
    klee_make_symbolic(&ebuf_cont, sizeof(long), "ebuf_cont");
   u_long phyinv ;
    klee_make_symbolic(&phyinv, sizeof(long), "phyinv");
   u_long vsym_ctr ;
    klee_make_symbolic(&vsym_ctr, sizeof(long), "vsym_ctr");
   u_long mini_ctr ;
    klee_make_symbolic(&mini_ctr, sizeof(long), "mini_ctr");
   u_long tpc_exp ;
    klee_make_symbolic(&tpc_exp, sizeof(long), "tpc_exp");
   u_long np_err ;
    klee_make_symbolic(&np_err, sizeof(long), "np_err");
   u_long b_pcs ;
    klee_make_symbolic(&b_pcs, sizeof(long), "b_pcs");
   u_long b_tpc ;
    klee_make_symbolic(&b_tpc, sizeof(long), "b_tpc");
   u_long b_tne ;
    klee_make_symbolic(&b_tne, sizeof(long), "b_tne");
   u_long b_qls ;
    klee_make_symbolic(&b_qls, sizeof(long), "b_qls");
   u_long b_ils ;
    klee_make_symbolic(&b_ils, sizeof(long), "b_ils");
   u_long b_hls ;
    klee_make_symbolic(&b_hls, sizeof(long), "b_hls");
};
struct s_mbuf {
   struct s_mbuf *m_next ;
   short m_off ;
    klee_make_symbolic(&m_off, sizeof(short), "m_off");
   u_int m_len ;
    klee_make_symbolic(&m_len, sizeof(int), "m_len");
   int sm_use_count ;
    klee_make_symbolic(&sm_use_count, sizeof(int), "sm_use_count");
   char m_data[4504U] ;
};
...
typedef u_long Timer_2;
    klee_make_symbolic(&Timer_2, sizeof(long), "Timer_2");
typedef u_long Timer;
    klee_make_symbolic(&Timer, sizeof(long), "Timer");
typedef u_short ResId;
    klee_make_symbolic(&ResId, sizeof(short), "ResId");
typedef u_short SMTEnum;
    klee_make_symbolic(&SMTEnum, sizeof(short), "SMTEnum");
typedef u_char SMTFlag;
    klee_make_symbolic(&SMTFlag, sizeof(char), "SMTFlag");
...
struct fddi_mib_m {
   u_short fddiMACFrameStatusFunctions ;
    klee_make_symbolic(&fddiMACFrameStatusFunctions, sizeof(short), "fddiMACFrameStatusFunctions");
   Timer_2 fddiMACT_MaxCapabilitiy ;
   Timer_2 fddiMACTVXCapabilitiy ;
   u_char fddiMACMultiple_N ;
    klee_make_symbolic(&fddiMACMultiple_N, sizeof(char), "fddiMACMultiple_N");
   u_char fddiMACMultiple_P ;
    klee_make_symbolic(&fddiMACMultiple_P, sizeof(char), "fddiMACMultiple_P");
   u_char fddiMACDuplicateAddressCond ;
    klee_make_symbolic(&fddiMACDuplicateAddressCond, sizeof(char), "fddiMACDuplicateAddressCond");
   u_char fddiMACAvailablePaths ;
    klee_make_symbolic(&fddiMACAvailablePaths, sizeof(char), "fddiMACAvailablePaths");
   u_short fddiMACCurrentPath ;
    klee_make_symbolic(&fddiMACCurrentPath, sizeof(short), "fddiMACCurrentPath");
   ...
   u_short fddiMACRequestedPaths ;
    klee_make_symbolic(&fddiMACRequestedPaths, sizeof(short), "fddiMACRequestedPaths");
   ...
   u_short fddiMACFrameErrorThreshold ;
    klee_make_symbolic(&fddiMACFrameErrorThreshold, sizeof(short), "fddiMACFrameErrorThreshold");
   u_short fddiMACFrameErrorRatio ;
    klee_make_symbolic(&fddiMACFrameErrorRatio, sizeof(short), "fddiMACFrameErrorRatio");
   u_short fddiMACNotCopiedThreshold ;
    klee_make_symbolic(&fddiMACNotCopiedThreshold, sizeof(short), "fddiMACNotCopiedThreshold");
   u_short fddiMACNotCopiedRatio ;
    klee_make_symbolic(&fddiMACNotCopiedRatio, sizeof(short), "fddiMACNotCopiedRatio");
...
struct fddi_mib_a {
   ...
   u_long fddiPATHSbaPayload ;
    klee_make_symbolic(&fddiPATHSbaPayload, sizeof(long), "fddiPATHSbaPayload");
   u_long fddiPATHSbaOverhead ;
    klee_make_symbolic(&fddiPATHSbaOverhead, sizeof(long), "fddiPATHSbaOverhead");
   Timer fddiPATHT_Rmode ;
   u_long fddiPATHSbaAvailable ;
    klee_make_symbolic(&fddiPATHSbaAvailable, sizeof(long), "fddiPATHSbaAvailable");
...
struct __anonstruct_fddiPORTMacIndicated_229 {
   u_char T_val ;
    klee_make_symbolic(&T_val, sizeof(char), "T_val");
   u_char R_val ;
    klee_make_symbolic(&R_val, sizeof(char), "R_val");
};
struct fddi_mib_p {
   SMTEnum fddiPORTMy_Type ;
   SMTEnum fddiPORTNeighborType ;
   u_char fddiPORTConnectionPolicies ;
    klee_make_symbolic(&fddiPORTConnectionPolicies, sizeof(char), "fddiPORTConnectionPolicies");
   ...
   u_short fddiPORTMACPlacement ;
    klee_make_symbolic(&fddiPORTMACPlacement, sizeof(short), "fddiPORTMACPlacement");
   u_char fddiPORTAvailablePaths ;
    klee_make_symbolic(&fddiPORTAvailablePaths, sizeof(char), "fddiPORTAvailablePaths");
   u_char fddiPORTConnectionCapabilities ;
    klee_make_symbolic(&fddiPORTConnectionCapabilities, sizeof(char), "fddiPORTConnectionCapabilities");
   SMTEnum fddiPORTPMDClass ;
   ResId fddiPORTIndex ;
   SMTEnum fddiPORTMaint_LS ;
   SMTEnum fddiPORTPC_LS ;
   u_char fddiPORTBS_Flag ;
    klee_make_symbolic(&fddiPORTBS_Flag, sizeof(char), "fddiPORTBS_Flag");
   ...
   u_char fddiPORTLer_Estimate ;
    klee_make_symbolic(&fddiPORTLer_Estimate, sizeof(char), "fddiPORTLer_Estimate");
   u_char fddiPORTLer_Cutoff ;
    klee_make_symbolic(&fddiPORTLer_Cutoff, sizeof(char), "fddiPORTLer_Cutoff");
   u_char fddiPORTLer_Alarm ;
    klee_make_symbolic(&fddiPORTLer_Alarm, sizeof(char), "fddiPORTLer_Alarm");
   ...
   u_char fddiPORTLerFlag ;
    klee_make_symbolic(&fddiPORTLerFlag, sizeof(char), "fddiPORTLerFlag");
   u_char fddiPORTMultiple_U ;
    klee_make_symbolic(&fddiPORTMultiple_U, sizeof(char), "fddiPORTMultiple_U");
   u_char fddiPORTMultiple_P ;
    klee_make_symbolic(&fddiPORTMultiple_P, sizeof(char), "fddiPORTMultiple_P");
   u_char fddiPORTEB_Condition ;
    klee_make_symbolic(&fddiPORTEB_Condition, sizeof(char), "fddiPORTEB_Condition");
};
...
struct fddi_mib {
   ...
   u_long fddiESSPayload ;
    klee_make_symbolic(&fddiESSPayload, sizeof(long), "fddiESSPayload");
   u_long fddiESSOverhead ;
    klee_make_symbolic(&fddiESSOverhead, sizeof(long), "fddiESSOverhead");
   u_long fddiESSMaxTNeg ;
    klee_make_symbolic(&fddiESSMaxTNeg, sizeof(long), "fddiESSMaxTNeg");
   u_long fddiESSMinSegmentSize ;
    klee_make_symbolic(&fddiESSMinSegmentSize, sizeof(long), "fddiESSMinSegmentSize");
   u_long fddiESSCategory ;
    klee_make_symbolic(&fddiESSCategory, sizeof(long), "fddiESSCategory");
   short fddiESSSynchTxMode ;
    klee_make_symbolic(&fddiESSSynchTxMode, sizeof(short), "fddiESSSynchTxMode");
   struct smt_sid fddiSMTStationId ;
   u_short fddiSMTOpVersionId ;
    klee_make_symbolic(&fddiSMTOpVersionId, sizeof(short), "fddiSMTOpVersionId");
   u_short fddiSMTHiVersionId ;
    klee_make_symbolic(&fddiSMTHiVersionId, sizeof(short), "fddiSMTHiVersionId");
   u_short fddiSMTLoVersionId ;
    klee_make_symbolic(&fddiSMTLoVersionId, sizeof(short), "fddiSMTLoVersionId");
   u_char fddiSMTManufacturerData[32U] ;
   u_char fddiSMTUserData[32U] ;
   u_short fddiSMTMIBVersionId ;
    klee_make_symbolic(&fddiSMTMIBVersionId, sizeof(short), "fddiSMTMIBVersionId");
   u_char fddiSMTMac_Ct ;
    klee_make_symbolic(&fddiSMTMac_Ct, sizeof(char), "fddiSMTMac_Ct");
   u_char fddiSMTNonMaster_Ct ;
    klee_make_symbolic(&fddiSMTNonMaster_Ct, sizeof(char), "fddiSMTNonMaster_Ct");
   u_char fddiSMTMaster_Ct ;
    klee_make_symbolic(&fddiSMTMaster_Ct, sizeof(char), "fddiSMTMaster_Ct");
   u_char fddiSMTAvailablePaths ;
    klee_make_symbolic(&fddiSMTAvailablePaths, sizeof(char), "fddiSMTAvailablePaths");
   u_short fddiSMTConfigCapabilities ;
    klee_make_symbolic(&fddiSMTConfigCapabilities, sizeof(short), "fddiSMTConfigCapabilities");
   u_short fddiSMTConfigPolicy ;
    klee_make_symbolic(&fddiSMTConfigPolicy, sizeof(short), "fddiSMTConfigPolicy");
   u_short fddiSMTConnectionPolicy ;
    klee_make_symbolic(&fddiSMTConnectionPolicy, sizeof(short), "fddiSMTConnectionPolicy");
   u_short fddiSMTTT_Notify ;
    klee_make_symbolic(&fddiSMTTT_Notify, sizeof(short), "fddiSMTTT_Notify");
   u_char fddiSMTStatRptPolicy ;
    klee_make_symbolic(&fddiSMTStatRptPolicy, sizeof(char), "fddiSMTStatRptPolicy");
   u_long fddiSMTTrace_MaxExpiration ;
    klee_make_symbolic(&fddiSMTTrace_MaxExpiration, sizeof(long), "fddiSMTTrace_MaxExpiration");
   u_short fddiSMTPORTIndexes[2U] ;
   u_short fddiSMTMACIndexes ;
    klee_make_symbolic(&fddiSMTMACIndexes, sizeof(short), "fddiSMTMACIndexes");
   u_char fddiSMTBypassPresent ;
    klee_make_symbolic(&fddiSMTBypassPresent, sizeof(char), "fddiSMTBypassPresent");
   SMTEnum fddiSMTECMState ;
   SMTEnum fddiSMTCF_State ;
   SMTEnum fddiSMTStationStatus ;
   u_char fddiSMTRemoteDisconnectFlag ;
    klee_make_symbolic(&fddiSMTRemoteDisconnectFlag, sizeof(char), "fddiSMTRemoteDisconnectFlag");
   u_char fddiSMTPeerWrapFlag ;
    klee_make_symbolic(&fddiSMTPeerWrapFlag, sizeof(char), "fddiSMTPeerWrapFlag");
...
struct err_st {
   u_long err_valid ;
    klee_make_symbolic(&err_valid, sizeof(long), "err_valid");
   u_long err_abort ;
    klee_make_symbolic(&err_abort, sizeof(long), "err_abort");
   u_long err_e_indicator ;
    klee_make_symbolic(&err_e_indicator, sizeof(long), "err_e_indicator");
   u_long err_crc ;
    klee_make_symbolic(&err_crc, sizeof(long), "err_crc");
   u_long err_llc_frame ;
    klee_make_symbolic(&err_llc_frame, sizeof(long), "err_llc_frame");
   u_long err_mac_frame ;
    klee_make_symbolic(&err_mac_frame, sizeof(long), "err_mac_frame");
   u_long err_smt_frame ;
    klee_make_symbolic(&err_smt_frame, sizeof(long), "err_smt_frame");
   u_long err_imp_frame ;
    klee_make_symbolic(&err_imp_frame, sizeof(long), "err_imp_frame");
   u_long err_no_buf ;
    klee_make_symbolic(&err_no_buf, sizeof(long), "err_no_buf");
   u_long err_too_long ;
    klee_make_symbolic(&err_too_long, sizeof(long), "err_too_long");
   u_long err_bec_stat ;
    klee_make_symbolic(&err_bec_stat, sizeof(long), "err_bec_stat");
   u_long err_clm_stat ;
    klee_make_symbolic(&err_clm_stat, sizeof(long), "err_clm_stat");
   u_long err_sifg_det ;
    klee_make_symbolic(&err_sifg_det, sizeof(long), "err_sifg_det");
   u_long err_phinv ;
    klee_make_symbolic(&err_phinv, sizeof(long), "err_phinv");
   u_long err_tkiss ;
    klee_make_symbolic(&err_tkiss, sizeof(long), "err_tkiss");
   u_long err_tkerr ;
    klee_make_symbolic(&err_tkerr, sizeof(long), "err_tkerr");
};
struct s_smt_fp_txd {
   __le32 txd_tbctrl ;
   __le32 txd_txdscr ;
...
struct s_smt_tx_queue {
   ...
   u_short tx_free ;
    klee_make_symbolic(&tx_free, sizeof(short), "tx_free");
   u_short tx_used ;
    klee_make_symbolic(&tx_used, sizeof(short), "tx_used");
   void *tx_bmu_ctl ;
   void *tx_bmu_dsc ;
};
struct s_smt_rx_queue {
   ...
   u_short rx_free ;
    klee_make_symbolic(&rx_free, sizeof(short), "rx_free");
   u_short rx_used ;
    klee_make_symbolic(&rx_used, sizeof(short), "rx_used");
   void *rx_bmu_ctl ;
   void *rx_bmu_dsc ;
};
struct s_smt_fifo_conf {
   u_short rbc_ram_start ;
    klee_make_symbolic(&rbc_ram_start, sizeof(short), "rbc_ram_start");
   u_short rbc_ram_end ;
    klee_make_symbolic(&rbc_ram_end, sizeof(short), "rbc_ram_end");
   u_short rx1_fifo_start ;
    klee_make_symbolic(&rx1_fifo_start, sizeof(short), "rx1_fifo_start");
   u_short rx1_fifo_size ;
    klee_make_symbolic(&rx1_fifo_size, sizeof(short), "rx1_fifo_size");
   u_short rx2_fifo_start ;
    klee_make_symbolic(&rx2_fifo_start, sizeof(short), "rx2_fifo_start");
   u_short rx2_fifo_size ;
    klee_make_symbolic(&rx2_fifo_size, sizeof(short), "rx2_fifo_size");
   u_short tx_s_start ;
    klee_make_symbolic(&tx_s_start, sizeof(short), "tx_s_start");
   u_short tx_s_size ;
    klee_make_symbolic(&tx_s_size, sizeof(short), "tx_s_size");
   u_short tx_a0_start ;
    klee_make_symbolic(&tx_a0_start, sizeof(short), "tx_a0_start");
   u_short tx_a0_size ;
    klee_make_symbolic(&tx_a0_size, sizeof(short), "tx_a0_size");
   u_short fifo_config_mode ;
    klee_make_symbolic(&fifo_config_mode, sizeof(short), "fifo_config_mode");
};
struct fddi_mac_sf {
   u_char mac_fc ;
    klee_make_symbolic(&mac_fc, sizeof(char), "mac_fc");
...
struct s_fpmc {
   struct fddi_addr a ;
   u_char n ;
    klee_make_symbolic(&n, sizeof(char), "n");
   u_char perm ;
    klee_make_symbolic(&perm, sizeof(char), "perm");
};
...
struct s_smt_fp {
   u_short mdr2init ;
    klee_make_symbolic(&mdr2init, sizeof(short), "mdr2init");
   u_short mdr3init ;
    klee_make_symbolic(&mdr3init, sizeof(short), "mdr3init");
   u_short frselreg_init ;
    klee_make_symbolic(&frselreg_init, sizeof(short), "frselreg_init");
   u_short rx_mode ;
    klee_make_symbolic(&rx_mode, sizeof(short), "rx_mode");
   u_short nsa_mode ;
    klee_make_symbolic(&nsa_mode, sizeof(short), "nsa_mode");
   u_short rx_prom ;
    klee_make_symbolic(&rx_prom, sizeof(short), "rx_prom");
   u_short exgpa ;
    klee_make_symbolic(&exgpa, sizeof(short), "exgpa");
   ...
   u_short s2u ;
    klee_make_symbolic(&s2u, sizeof(short), "s2u");
   u_short s2l ;
    klee_make_symbolic(&s2l, sizeof(short), "s2l");
   void *fm_st1u ;
   void *fm_st1l ;
   void *fm_st2u ;
   void *fm_st2l ;
   ...
   u_long func_addr ;
    klee_make_symbolic(&func_addr, sizeof(long), "func_addr");
   int smt_slots_used ;
    klee_make_symbolic(&smt_slots_used, sizeof(int), "smt_slots_used");
   int os_slots_used ;
    klee_make_symbolic(&os_slots_used, sizeof(int), "os_slots_used");
};
struct s_smt_hw {
   void *iop ;
   short dma ;
   short irq ;
   short eprom ;
    klee_make_symbolic(&eprom, sizeof(short), "eprom");
   short slot ;
    klee_make_symbolic(&slot, sizeof(short), "slot");
   short max_slots ;
    klee_make_symbolic(&max_slots, sizeof(short), "max_slots");
   short wdog_used ;
    klee_make_symbolic(&wdog_used, sizeof(short), "wdog_used");
   u_short pci_handle ;
    klee_make_symbolic(&pci_handle, sizeof(short), "pci_handle");
   u_long is_imask ;
    klee_make_symbolic(&is_imask, sizeof(long), "is_imask");
   u_long phys_mem_addr ;
    klee_make_symbolic(&phys_mem_addr, sizeof(long), "phys_mem_addr");
   u_short mc_dummy ;
    klee_make_symbolic(&mc_dummy, sizeof(short), "mc_dummy");
   u_short hw_state ;
    klee_make_symbolic(&hw_state, sizeof(short), "hw_state");
   int hw_is_64bit ;
    klee_make_symbolic(&hw_is_64bit, sizeof(int), "hw_is_64bit");
   u_long pci_fix_value ;
    klee_make_symbolic(&pci_fix_value, sizeof(long), "pci_fix_value");
   u_long t_start ;
    klee_make_symbolic(&t_start, sizeof(long), "t_start");
   u_long t_stop ;
    klee_make_symbolic(&t_stop, sizeof(long), "t_stop");
   u_short timer_activ ;
    klee_make_symbolic(&timer_activ, sizeof(short), "timer_activ");
   u_char pic_a1 ;
    klee_make_symbolic(&pic_a1, sizeof(char), "pic_a1");
   u_char pic_21 ;
    klee_make_symbolic(&pic_21, sizeof(char), "pic_21");
   ...
   u_short mac_ring_is_up ;
    klee_make_symbolic(&mac_ring_is_up, sizeof(short), "mac_ring_is_up");
   struct s_smt_fp fp ;
};
struct s_mbuf_pool {
   Mbuf *mb_start ;
...
struct hw_modul {
   ...
   u_short pass_SMT ;
    klee_make_symbolic(&pass_SMT, sizeof(short), "pass_SMT");
   u_short pass_NSA ;
    klee_make_symbolic(&pass_NSA, sizeof(short), "pass_NSA");
   u_short pass_DB ;
    klee_make_symbolic(&pass_DB, sizeof(short), "pass_DB");
   u_short pass_llc_promisc ;
    klee_make_symbolic(&pass_llc_promisc, sizeof(short), "pass_llc_promisc");
   Mbuf *llc_rx_pipe ;
   Mbuf *llc_rx_tail ;
   int queued_rx_frames ;
    klee_make_symbolic(&queued_rx_frames, sizeof(int), "queued_rx_frames");
   Mbuf *txd_tx_pipe ;
   Mbuf *txd_tx_tail ;
   int queued_txd_mb ;
    klee_make_symbolic(&queued_txd_mb, sizeof(int), "queued_txd_mb");
   int rx_break ;
    klee_make_symbolic(&rx_break, sizeof(int), "rx_break");
   int leave_isr ;
    klee_make_symbolic(&leave_isr, sizeof(int), "leave_isr");
   int isr_flag ;
    klee_make_symbolic(&isr_flag, sizeof(int), "isr_flag");
   struct s_smt_tx_queue *tx_p ;
   u_long tx_descr ;
    klee_make_symbolic(&tx_descr, sizeof(long), "tx_descr");
   int tx_len ;
    klee_make_symbolic(&tx_len, sizeof(int), "tx_len");
   Mbuf *tx_mb ;
   char *tx_data ;
   int detec_count ;
    klee_make_symbolic(&detec_count, sizeof(int), "detec_count");
   u_long rx_len_error ;
    klee_make_symbolic(&rx_len_error, sizeof(long), "rx_len_error");
};
struct s_skfp_ioctl {
   unsigned short cmd ;
    klee_make_symbolic(&cmd, sizeof(short), "cmd");
   unsigned short len ;
   unsigned char *data ;
};
struct s_smt_os {
   ...
   ulong SharedMemSize ;
    klee_make_symbolic(&SharedMemSize, sizeof(long), "SharedMemSize");
   ulong SharedMemHeap ;
    klee_make_symbolic(&SharedMemHeap, sizeof(long), "SharedMemHeap");
   void *SharedMemAddr ;
   dma_addr_t SharedMemDMA ;
   ulong QueueSkb ;
    klee_make_symbolic(&QueueSkb, sizeof(long), "QueueSkb");
   struct sk_buff_head SendSkbQueue ;
   ulong MaxFrameSize ;
    klee_make_symbolic(&MaxFrameSize, sizeof(long), "MaxFrameSize");
   unsigned char ResetRequested ;
    klee_make_symbolic(&ResetRequested, sizeof(char), "ResetRequested");
   struct fddi_statistics MacStat ;
   unsigned char *LocalRxBuffer ;
   dma_addr_t LocalRxBufferDMA ;
   u_long smc_version ;
    klee_make_symbolic(&smc_version, sizeof(long), "smc_version");
   struct hw_modul hwm ;
...
struct s_ess {
   u_char sync_bw_available ;
    klee_make_symbolic(&sync_bw_available, sizeof(char), "sync_bw_available");
   u_char local_sba_active ;
    klee_make_symbolic(&local_sba_active, sizeof(char), "local_sba_active");
   char raf_act_timer_poll ;
    klee_make_symbolic(&raf_act_timer_poll, sizeof(char), "raf_act_timer_poll");
   char timer_count ;
    klee_make_symbolic(&timer_count, sizeof(char), "timer_count");
   Mbuf *sba_reply_pend ;
   long sync_bw ;
    klee_make_symbolic(&sync_bw, sizeof(long), "sync_bw");
   u_long alloc_trans_id ;
    klee_make_symbolic(&alloc_trans_id, sizeof(long), "alloc_trans_id");
};
struct event_queue {
   u_short class ;
   u_short event ;
...
struct s_ecm {
   u_char path_test ;
    klee_make_symbolic(&path_test, sizeof(char), "path_test");
   u_char sb_flag ;
    klee_make_symbolic(&sb_flag, sizeof(char), "sb_flag");
   u_char DisconnectFlag ;
    klee_make_symbolic(&DisconnectFlag, sizeof(char), "DisconnectFlag");
   u_char ecm_line_state ;
    klee_make_symbolic(&ecm_line_state, sizeof(char), "ecm_line_state");
   u_long trace_prop ;
    klee_make_symbolic(&trace_prop, sizeof(long), "trace_prop");
   char ec_pad[2U] ;
   struct smt_timer ecm_timer ;
};
struct s_rmt {
   u_char dup_addr_test ;
    klee_make_symbolic(&dup_addr_test, sizeof(char), "dup_addr_test");
   u_char da_flag ;
    klee_make_symbolic(&da_flag, sizeof(char), "da_flag");
   u_char loop_avail ;
    klee_make_symbolic(&loop_avail, sizeof(char), "loop_avail");
   u_char sm_ma_avail ;
    klee_make_symbolic(&sm_ma_avail, sizeof(char), "sm_ma_avail");
   u_char no_flag ;
    klee_make_symbolic(&no_flag, sizeof(char), "no_flag");
   u_char bn_flag ;
    klee_make_symbolic(&bn_flag, sizeof(char), "bn_flag");
   u_char jm_flag ;
    klee_make_symbolic(&jm_flag, sizeof(char), "jm_flag");
   u_char rm_join ;
    klee_make_symbolic(&rm_join, sizeof(char), "rm_join");
   u_char rm_loop ;
    klee_make_symbolic(&rm_loop, sizeof(char), "rm_loop");
   long fast_rm_join ;
    klee_make_symbolic(&fast_rm_join, sizeof(long), "fast_rm_join");
   struct smt_timer rmt_timer0 ;
   struct smt_timer rmt_timer1 ;
   struct smt_timer rmt_timer2 ;
   u_char timer0_exp ;
    klee_make_symbolic(&timer0_exp, sizeof(char), "timer0_exp");
   u_char timer1_exp ;
    klee_make_symbolic(&timer1_exp, sizeof(char), "timer1_exp");
   u_char timer2_exp ;
    klee_make_symbolic(&timer2_exp, sizeof(char), "timer2_exp");
   u_char rm_pad1[1U] ;
};
struct s_cfm {
   u_char cf_state ;
    klee_make_symbolic(&cf_state, sizeof(char), "cf_state");
   u_char cf_pad[3U] ;
};
struct s_pcm {
   u_char pcm_pad[3U] ;
...
struct s_phy {
   ...
   u_char np ;
    klee_make_symbolic(&np, sizeof(char), "np");
   u_char cf_join ;
    klee_make_symbolic(&cf_join, sizeof(char), "cf_join");
   u_char cf_loop ;
    klee_make_symbolic(&cf_loop, sizeof(char), "cf_loop");
   u_char wc_flag ;
    klee_make_symbolic(&wc_flag, sizeof(char), "wc_flag");
   u_char pc_mode ;
    klee_make_symbolic(&pc_mode, sizeof(char), "pc_mode");
   u_char pc_lem_fail ;
    klee_make_symbolic(&pc_lem_fail, sizeof(char), "pc_lem_fail");
   u_char lc_test ;
    klee_make_symbolic(&lc_test, sizeof(char), "lc_test");
   u_char scrub ;
    klee_make_symbolic(&scrub, sizeof(char), "scrub");
   char phy_name ;
    klee_make_symbolic(&phy_name, sizeof(char), "phy_name");
   u_char pmd_type[2U] ;
   u_char pmd_scramble ;
    klee_make_symbolic(&pmd_scramble, sizeof(char), "pmd_scramble");
   u_char curr_ls ;
    klee_make_symbolic(&curr_ls, sizeof(char), "curr_ls");
   u_char ls_flag ;
    klee_make_symbolic(&ls_flag, sizeof(char), "ls_flag");
   u_char rc_flag ;
    klee_make_symbolic(&rc_flag, sizeof(char), "rc_flag");
   u_char tc_flag ;
    klee_make_symbolic(&tc_flag, sizeof(char), "tc_flag");
   u_char td_flag ;
    klee_make_symbolic(&td_flag, sizeof(char), "td_flag");
   u_char bitn ;
    klee_make_symbolic(&bitn, sizeof(char), "bitn");
   u_char tr_flag ;
    klee_make_symbolic(&tr_flag, sizeof(char), "tr_flag");
   u_char twisted ;
    klee_make_symbolic(&twisted, sizeof(char), "twisted");
   u_char t_val[10U] ;
   u_char r_val[10U] ;
   u_long t_next[10U] ;
   ...
   u_char pcm_pad1[1U] ;
   int cem_pst ;
    klee_make_symbolic(&cem_pst, sizeof(int), "cem_pst");
...
struct s_srf {
   u_long SRThreshold ;
    klee_make_symbolic(&SRThreshold, sizeof(long), "SRThreshold");
   u_char RT_Flag ;
    klee_make_symbolic(&RT_Flag, sizeof(char), "RT_Flag");
   u_char sr_state ;
    klee_make_symbolic(&sr_state, sizeof(char), "sr_state");
   u_char any_report ;
    klee_make_symbolic(&any_report, sizeof(char), "any_report");
   u_long TSR ;
    klee_make_symbolic(&TSR, sizeof(long), "TSR");
   u_short ring_status ;
    klee_make_symbolic(&ring_status, sizeof(short), "ring_status");
};
struct s_srf_evc {
   u_char evc_code ;
    klee_make_symbolic(&evc_code, sizeof(char), "evc_code");
   u_char evc_index ;
    klee_make_symbolic(&evc_index, sizeof(char), "evc_index");
   u_char evc_rep_required ;
    klee_make_symbolic(&evc_rep_required, sizeof(char), "evc_rep_required");
   u_short evc_para ;
    klee_make_symbolic(&evc_para, sizeof(short), "evc_para");
   u_char *evc_cond_state ;
   u_char *evc_multiple ;
};
struct smt_values {
   u_long smt_tvu ;
    klee_make_symbolic(&smt_tvu, sizeof(long), "smt_tvu");
   u_long smt_tvd ;
    klee_make_symbolic(&smt_tvd, sizeof(long), "smt_tvd");
   u_long smt_tid ;
    klee_make_symbolic(&smt_tid, sizeof(long), "smt_tid");
   u_long pend[5U] ;
   u_long uniq_time ;
    klee_make_symbolic(&uniq_time, sizeof(long), "uniq_time");
   u_short uniq_ticks ;
    klee_make_symbolic(&uniq_ticks, sizeof(short), "uniq_ticks");
   u_short please_reconnect ;
    klee_make_symbolic(&please_reconnect, sizeof(short), "please_reconnect");
   u_long smt_last_lem ;
    klee_make_symbolic(&smt_last_lem, sizeof(long), "smt_last_lem");
   u_long smt_last_notify ;
    klee_make_symbolic(&smt_last_notify, sizeof(long), "smt_last_notify");
   struct smt_timer smt_timer ;
   u_long last_tok_time[1U] ;
};
struct smt_config {
   u_char attach_s ;
    klee_make_symbolic(&attach_s, sizeof(char), "attach_s");
   u_char sas ;
    klee_make_symbolic(&sas, sizeof(char), "sas");
   u_char build_ring_map ;
    klee_make_symbolic(&build_ring_map, sizeof(char), "build_ring_map");
   u_char numphys ;
    klee_make_symbolic(&numphys, sizeof(char), "numphys");
   u_char sc_pad[1U] ;
   u_long pcm_tb_min ;
    klee_make_symbolic(&pcm_tb_min, sizeof(long), "pcm_tb_min");
   u_long pcm_tb_max ;
    klee_make_symbolic(&pcm_tb_max, sizeof(long), "pcm_tb_max");
   u_long pcm_c_min ;
    klee_make_symbolic(&pcm_c_min, sizeof(long), "pcm_c_min");
   u_long pcm_t_out ;
    klee_make_symbolic(&pcm_t_out, sizeof(long), "pcm_t_out");
   u_long pcm_tl_min ;
    klee_make_symbolic(&pcm_tl_min, sizeof(long), "pcm_tl_min");
   u_long pcm_lc_short ;
    klee_make_symbolic(&pcm_lc_short, sizeof(long), "pcm_lc_short");
   u_long pcm_lc_medium ;
    klee_make_symbolic(&pcm_lc_medium, sizeof(long), "pcm_lc_medium");
   u_long pcm_lc_long ;
    klee_make_symbolic(&pcm_lc_long, sizeof(long), "pcm_lc_long");
   u_long pcm_lc_extended ;
    klee_make_symbolic(&pcm_lc_extended, sizeof(long), "pcm_lc_extended");
   u_long pcm_t_next_9 ;
    klee_make_symbolic(&pcm_t_next_9, sizeof(long), "pcm_t_next_9");
   u_long pcm_ns_max ;
    klee_make_symbolic(&pcm_ns_max, sizeof(long), "pcm_ns_max");
   u_long ecm_i_max ;
    klee_make_symbolic(&ecm_i_max, sizeof(long), "ecm_i_max");
   u_long ecm_in_max ;
    klee_make_symbolic(&ecm_in_max, sizeof(long), "ecm_in_max");
   u_long ecm_td_min ;
    klee_make_symbolic(&ecm_td_min, sizeof(long), "ecm_td_min");
   u_long ecm_test_done ;
    klee_make_symbolic(&ecm_test_done, sizeof(long), "ecm_test_done");
   u_long ecm_check_poll ;
    klee_make_symbolic(&ecm_check_poll, sizeof(long), "ecm_check_poll");
   u_long rmt_t_non_op ;
    klee_make_symbolic(&rmt_t_non_op, sizeof(long), "rmt_t_non_op");
   u_long rmt_t_stuck ;
    klee_make_symbolic(&rmt_t_stuck, sizeof(long), "rmt_t_stuck");
   u_long rmt_t_direct ;
    klee_make_symbolic(&rmt_t_direct, sizeof(long), "rmt_t_direct");
   u_long rmt_t_jam ;
    klee_make_symbolic(&rmt_t_jam, sizeof(long), "rmt_t_jam");
   u_long rmt_t_announce ;
    klee_make_symbolic(&rmt_t_announce, sizeof(long), "rmt_t_announce");
   u_long rmt_t_poll ;
    klee_make_symbolic(&rmt_t_poll, sizeof(long), "rmt_t_poll");
   u_long rmt_dup_mac_behavior ;
    klee_make_symbolic(&rmt_dup_mac_behavior, sizeof(long), "rmt_dup_mac_behavior");
   u_long mac_d_max ;
    klee_make_symbolic(&mac_d_max, sizeof(long), "mac_d_max");
   u_long lct_short ;
    klee_make_symbolic(&lct_short, sizeof(long), "lct_short");
   u_long lct_medium ;
    klee_make_symbolic(&lct_medium, sizeof(long), "lct_medium");
   u_long lct_long ;
    klee_make_symbolic(&lct_long, sizeof(long), "lct_long");
   u_long lct_extended ;
    klee_make_symbolic(&lct_extended, sizeof(long), "lct_extended");
};
struct s_smc {
   struct s_smt_os os ;
   struct s_smt_hw hw ;
...
struct smt_header {
   ...
   u_char smt_class ;
    klee_make_symbolic(&smt_class, sizeof(char), "smt_class");
   u_char smt_type ;
    klee_make_symbolic(&smt_type, sizeof(char), "smt_type");
   u_short smt_version ;
    klee_make_symbolic(&smt_version, sizeof(short), "smt_version");
   u_int smt_tid ;
   struct smt_sid smt_sid ;
   u_short smt_pad ;
    klee_make_symbolic(&smt_pad, sizeof(short), "smt_pad");
   u_short smt_len ;
    klee_make_symbolic(&smt_len, sizeof(short), "smt_len");
};
struct smt_para {
   u_short p_type ;
    klee_make_symbolic(&p_type, sizeof(short), "p_type");
   u_short p_len ;
    klee_make_symbolic(&p_len, sizeof(short), "p_len");
};
struct smt_p_una {
   struct smt_para para ;
   u_short una_pad ;
    klee_make_symbolic(&una_pad, sizeof(short), "una_pad");
   struct fddi_addr una_node ;
};
struct smt_p_sde {
   struct smt_para para ;
   u_char sde_type ;
    klee_make_symbolic(&sde_type, sizeof(char), "sde_type");
   u_char sde_mac_count ;
    klee_make_symbolic(&sde_mac_count, sizeof(char), "sde_mac_count");
   u_char sde_non_master ;
    klee_make_symbolic(&sde_non_master, sizeof(char), "sde_non_master");
   u_char sde_master ;
    klee_make_symbolic(&sde_master, sizeof(char), "sde_master");
};
struct smt_p_state {
   struct smt_para para ;
   u_short st_pad ;
    klee_make_symbolic(&st_pad, sizeof(short), "st_pad");
   u_char st_topology ;
    klee_make_symbolic(&st_topology, sizeof(char), "st_topology");
   u_char st_dupl_addr ;
    klee_make_symbolic(&st_dupl_addr, sizeof(char), "st_dupl_addr");
};
...
struct smt_p_policy {
   struct smt_para para ;
   u_short pl_config ;
    klee_make_symbolic(&pl_config, sizeof(short), "pl_config");
   u_short pl_connect ;
    klee_make_symbolic(&pl_connect, sizeof(short), "pl_connect");
};
struct smt_p_latency {
   struct smt_para para ;
   u_short lt_phyout_idx1 ;
    klee_make_symbolic(&lt_phyout_idx1, sizeof(short), "lt_phyout_idx1");
   u_short lt_latency1 ;
    klee_make_symbolic(&lt_latency1, sizeof(short), "lt_latency1");
   u_short lt_phyout_idx2 ;
    klee_make_symbolic(&lt_phyout_idx2, sizeof(short), "lt_phyout_idx2");
   u_short lt_latency2 ;
    klee_make_symbolic(&lt_latency2, sizeof(short), "lt_latency2");
};
struct smt_p_neighbor {
   struct smt_para para ;
   u_short nb_mib_index ;
    klee_make_symbolic(&nb_mib_index, sizeof(short), "nb_mib_index");
   u_short nb_mac_index ;
    klee_make_symbolic(&nb_mac_index, sizeof(short), "nb_mac_index");
   struct fddi_addr nb_una ;
   struct fddi_addr nb_dna ;
};
struct smt_phy_rec {
   u_short phy_mib_index ;
    klee_make_symbolic(&phy_mib_index, sizeof(short), "phy_mib_index");
   u_char phy_type ;
    klee_make_symbolic(&phy_type, sizeof(char), "phy_type");
   u_char phy_connect_state ;
    klee_make_symbolic(&phy_connect_state, sizeof(char), "phy_connect_state");
   u_char phy_remote_type ;
    klee_make_symbolic(&phy_remote_type, sizeof(char), "phy_remote_type");
   u_char phy_remote_mac ;
    klee_make_symbolic(&phy_remote_mac, sizeof(char), "phy_remote_mac");
   u_short phy_resource_idx ;
    klee_make_symbolic(&phy_resource_idx, sizeof(short), "phy_resource_idx");
};
struct smt_mac_rec {
   struct fddi_addr mac_addr ;
   u_short mac_resource_idx ;
    klee_make_symbolic(&mac_resource_idx, sizeof(short), "mac_resource_idx");
};
struct smt_p_path {
   struct smt_para para ;
...
struct smt_p_mac_status {
   ...
   u_short st_mib_index ;
    klee_make_symbolic(&st_mib_index, sizeof(short), "st_mib_index");
   u_short st_mac_index ;
    klee_make_symbolic(&st_mac_index, sizeof(short), "st_mac_index");
   u_int st_t_req ;
    klee_make_symbolic(&st_t_req, sizeof(int), "st_t_req");
   u_int st_t_neg ;
    klee_make_symbolic(&st_t_neg, sizeof(int), "st_t_neg");
   u_int st_t_max ;
    klee_make_symbolic(&st_t_max, sizeof(int), "st_t_max");
   u_int st_tvx_value ;
    klee_make_symbolic(&st_tvx_value, sizeof(int), "st_tvx_value");
   u_int st_t_min ;
    klee_make_symbolic(&st_t_min, sizeof(int), "st_t_min");
   u_int st_sba ;
    klee_make_symbolic(&st_sba, sizeof(int), "st_sba");
   u_int st_frame_ct ;
    klee_make_symbolic(&st_frame_ct, sizeof(int), "st_frame_ct");
   u_int st_error_ct ;
    klee_make_symbolic(&st_error_ct, sizeof(int), "st_error_ct");
   u_int st_lost_ct ;
    klee_make_symbolic(&st_lost_ct, sizeof(int), "st_lost_ct");
};
struct smt_p_lem {
   struct smt_para para ;
   u_short lem_mib_index ;
    klee_make_symbolic(&lem_mib_index, sizeof(short), "lem_mib_index");
   u_short lem_phy_index ;
    klee_make_symbolic(&lem_phy_index, sizeof(short), "lem_phy_index");
   u_char lem_pad2 ;
    klee_make_symbolic(&lem_pad2, sizeof(char), "lem_pad2");
   u_char lem_cutoff ;
    klee_make_symbolic(&lem_cutoff, sizeof(char), "lem_cutoff");
   u_char lem_alarm ;
    klee_make_symbolic(&lem_alarm, sizeof(char), "lem_alarm");
   u_char lem_estimate ;
    klee_make_symbolic(&lem_estimate, sizeof(char), "lem_estimate");
   u_int lem_reject_ct ;
    klee_make_symbolic(&lem_reject_ct, sizeof(int), "lem_reject_ct");
   u_int lem_ct ;
    klee_make_symbolic(&lem_ct, sizeof(int), "lem_ct");
};
struct smt_p_mac_counter {
   struct smt_para para ;
   u_short mc_mib_index ;
    klee_make_symbolic(&mc_mib_index, sizeof(short), "mc_mib_index");
   u_short mc_index ;
    klee_make_symbolic(&mc_index, sizeof(short), "mc_index");
   u_int mc_receive_ct ;
    klee_make_symbolic(&mc_receive_ct, sizeof(int), "mc_receive_ct");
   u_int mc_transmit_ct ;
    klee_make_symbolic(&mc_transmit_ct, sizeof(int), "mc_transmit_ct");
};
struct smt_p_mac_fnc {
   struct smt_para para ;
   u_short nc_mib_index ;
    klee_make_symbolic(&nc_mib_index, sizeof(short), "nc_mib_index");
   u_short nc_index ;
    klee_make_symbolic(&nc_index, sizeof(short), "nc_index");
   u_int nc_counter ;
    klee_make_symbolic(&nc_counter, sizeof(int), "nc_counter");
};
...
struct smt_p_reason {
   struct smt_para para ;
   u_int rdf_reason ;
    klee_make_symbolic(&rdf_reason, sizeof(int), "rdf_reason");
};
struct smt_p_refused {
   struct smt_para para ;
   u_int ref_fc ;
    klee_make_symbolic(&ref_fc, sizeof(int), "ref_fc");
   struct smt_header ref_header ;
};
struct smt_p_version {
   struct smt_para para ;
   u_short v_pad ;
    klee_make_symbolic(&v_pad, sizeof(short), "v_pad");
   u_char v_n ;
    klee_make_symbolic(&v_n, sizeof(char), "v_n");
   u_char v_index ;
    klee_make_symbolic(&v_index, sizeof(char), "v_index");
   u_short v_version[1U] ;
   u_short v_pad2 ;
    klee_make_symbolic(&v_pad2, sizeof(short), "v_pad2");
};
struct smt_p_fsc {
   struct smt_para para ;
   u_short fsc_pad0 ;
    klee_make_symbolic(&fsc_pad0, sizeof(short), "fsc_pad0");
   u_short fsc_mac_index ;
    klee_make_symbolic(&fsc_mac_index, sizeof(short), "fsc_mac_index");
   u_short fsc_pad1 ;
    klee_make_symbolic(&fsc_pad1, sizeof(short), "fsc_pad1");
   u_short fsc_value ;
    klee_make_symbolic(&fsc_value, sizeof(short), "fsc_value");
};
...
struct smt_pdef {
   int ptype ;
    klee_make_symbolic(&ptype, sizeof(int), "ptype");
   int plen ;
...
struct plt {
   ...
   int para ;
    klee_make_symbolic(&para, sizeof(int), "para");
};
struct smt_p_1048 {
   u_int p1048_flag ;
    klee_make_symbolic(&p1048_flag, sizeof(int), "p1048_flag");
   u_int p1048_cf_state ;
    klee_make_symbolic(&p1048_cf_state, sizeof(int), "p1048_cf_state");
};
struct smt_p_208c {
   u_int p208c_flag ;
    klee_make_symbolic(&p208c_flag, sizeof(int), "p208c_flag");
   u_short p208c_pad ;
    klee_make_symbolic(&p208c_pad, sizeof(short), "p208c_pad");
   u_short p208c_dupcondition ;
    klee_make_symbolic(&p208c_dupcondition, sizeof(short), "p208c_dupcondition");
   struct fddi_addr p208c_fddilong ;
   struct fddi_addr p208c_fddiunalong ;
};
struct smt_p_208d {
   u_int p208d_flag ;
    klee_make_symbolic(&p208d_flag, sizeof(int), "p208d_flag");
   u_int p208d_frame_ct ;
    klee_make_symbolic(&p208d_frame_ct, sizeof(int), "p208d_frame_ct");
   u_int p208d_error_ct ;
    klee_make_symbolic(&p208d_error_ct, sizeof(int), "p208d_error_ct");
   u_int p208d_lost_ct ;
    klee_make_symbolic(&p208d_lost_ct, sizeof(int), "p208d_lost_ct");
   u_int p208d_ratio ;
    klee_make_symbolic(&p208d_ratio, sizeof(int), "p208d_ratio");
};
struct smt_p_208e {
   u_int p208e_flag ;
    klee_make_symbolic(&p208e_flag, sizeof(int), "p208e_flag");
   u_int p208e_not_copied ;
    klee_make_symbolic(&p208e_not_copied, sizeof(int), "p208e_not_copied");
   u_int p208e_copied ;
    klee_make_symbolic(&p208e_copied, sizeof(int), "p208e_copied");
   u_int p208e_not_copied_ratio ;
    klee_make_symbolic(&p208e_not_copied_ratio, sizeof(int), "p208e_not_copied_ratio");
};
struct smt_p_208f {
   u_int p208f_multiple ;
    klee_make_symbolic(&p208f_multiple, sizeof(int), "p208f_multiple");
   u_int p208f_nacondition ;
    klee_make_symbolic(&p208f_nacondition, sizeof(int), "p208f_nacondition");
   ...
   u_short p208f_curren_path ;
    klee_make_symbolic(&p208f_curren_path, sizeof(short), "p208f_curren_path");
   struct fddi_addr p208f_smt_address ;
};
struct smt_p_2090 {
   u_int p2090_multiple ;
    klee_make_symbolic(&p2090_multiple, sizeof(int), "p2090_multiple");
   u_short p2090_availablepaths ;
    klee_make_symbolic(&p2090_availablepaths, sizeof(short), "p2090_availablepaths");
   u_short p2090_currentpath ;
    klee_make_symbolic(&p2090_currentpath, sizeof(short), "p2090_currentpath");
   u_int p2090_requestedpaths ;
    klee_make_symbolic(&p2090_requestedpaths, sizeof(int), "p2090_requestedpaths");
};
struct smt_p_4050 {
   u_int p4050_flag ;
    klee_make_symbolic(&p4050_flag, sizeof(int), "p4050_flag");
   u_char p4050_pad ;
    klee_make_symbolic(&p4050_pad, sizeof(char), "p4050_pad");
   u_char p4050_cutoff ;
    klee_make_symbolic(&p4050_cutoff, sizeof(char), "p4050_cutoff");
   u_char p4050_alarm ;
    klee_make_symbolic(&p4050_alarm, sizeof(char), "p4050_alarm");
   u_char p4050_estimate ;
    klee_make_symbolic(&p4050_estimate, sizeof(char), "p4050_estimate");
   u_int p4050_reject_ct ;
    klee_make_symbolic(&p4050_reject_ct, sizeof(int), "p4050_reject_ct");
   u_int p4050_ct ;
    klee_make_symbolic(&p4050_ct, sizeof(int), "p4050_ct");
};
struct smt_p_4051 {
   u_int p4051_multiple ;
    klee_make_symbolic(&p4051_multiple, sizeof(int), "p4051_multiple");
   u_short p4051_porttype ;
    klee_make_symbolic(&p4051_porttype, sizeof(short), "p4051_porttype");
   u_short p4051_connectstate ;
    klee_make_symbolic(&p4051_connectstate, sizeof(short), "p4051_connectstate");
   u_short p4051_pc_neighbor ;
    klee_make_symbolic(&p4051_pc_neighbor, sizeof(short), "p4051_pc_neighbor");
   u_short p4051_pc_withhold ;
    klee_make_symbolic(&p4051_pc_withhold, sizeof(short), "p4051_pc_withhold");
};
struct smt_p_4052 {
   u_int p4052_flag ;
    klee_make_symbolic(&p4052_flag, sizeof(int), "p4052_flag");
   u_int p4052_eberrorcount ;
    klee_make_symbolic(&p4052_eberrorcount, sizeof(int), "p4052_eberrorcount");
};
struct smt_p_4053 {
   u_int p4053_multiple ;
    klee_make_symbolic(&p4053_multiple, sizeof(int), "p4053_multiple");
   u_short p4053_availablepaths ;
    klee_make_symbolic(&p4053_availablepaths, sizeof(short), "p4053_availablepaths");
   u_short p4053_currentpath ;
    klee_make_symbolic(&p4053_currentpath, sizeof(short), "p4053_currentpath");
   u_int p4053_requestedpaths ;
    klee_make_symbolic(&p4053_requestedpaths, sizeof(int), "p4053_requestedpaths");
   u_short p4053_mytype ;
    klee_make_symbolic(&p4053_mytype, sizeof(short), "p4053_mytype");
   u_short p4053_neighbortype ;
    klee_make_symbolic(&p4053_neighbortype, sizeof(short), "p4053_neighbortype");
};
struct s_pcon {
   int pc_len ;
    klee_make_symbolic(&pc_len, sizeof(int), "pc_len");
   int pc_err ;
    klee_make_symbolic(&pc_err, sizeof(int), "pc_err");
   int pc_badset ;
    klee_make_symbolic(&pc_badset, sizeof(int), "pc_badset");
   void *pc_p ;
};
enum hrtimer_restart;
struct s_p_tab;
struct s_p_tab {
   u_short p_num ;
    klee_make_symbolic(&p_num, sizeof(short), "p_num");
   u_char p_access ;
    klee_make_symbolic(&p_access, sizeof(char), "p_access");
   u_short p_offset ;
    klee_make_symbolic(&p_offset, sizeof(short), "p_offset");
   char p_swap[3U] ;
};
enum hrtimer_restart;
enum hrtimer_restart;
...
struct evc_init {
   u_char code ;
    klee_make_symbolic(&code, sizeof(char), "code");
   u_char index ;
   u_char n ;
   u_short para ;
};
...
struct smt_p_0015 {
   struct smt_para para ;
   u_int res_type ;
    klee_make_symbolic(&res_type, sizeof(int), "res_type");
};
struct smt_p_0016 {
   struct smt_para para ;
   u_int sba_cmd ;
    klee_make_symbolic(&sba_cmd, sizeof(int), "sba_cmd");
};
struct smt_p_0017 {
   struct smt_para para ;
   int sba_pl_req ;
    klee_make_symbolic(&sba_pl_req, sizeof(int), "sba_pl_req");
};
struct smt_p_0018 {
   struct smt_para para ;
   int sba_ov_req ;
    klee_make_symbolic(&sba_ov_req, sizeof(int), "sba_ov_req");
};
struct smt_p_0019 {
   struct smt_para para ;
   u_short sba_pad ;
    klee_make_symbolic(&sba_pad, sizeof(short), "sba_pad");
   struct fddi_addr alloc_addr ;
};
struct smt_p_001a {
   struct smt_para para ;
   u_int category ;
    klee_make_symbolic(&category, sizeof(int), "category");
};
struct smt_p_001b {
   struct smt_para para ;
   u_int max_t_neg ;
    klee_make_symbolic(&max_t_neg, sizeof(int), "max_t_neg");
};
struct smt_p_001c {
   struct smt_para para ;
   u_int min_seg_siz ;
    klee_make_symbolic(&min_seg_siz, sizeof(int), "min_seg_siz");
};
struct smt_p_320b {
   struct smt_para para ;
   u_int mib_index ;
    klee_make_symbolic(&mib_index, sizeof(int), "mib_index");
   u_short path_pad ;
    klee_make_symbolic(&path_pad, sizeof(short), "path_pad");
   u_short path_index ;
    klee_make_symbolic(&path_index, sizeof(short), "path_index");
};
struct smt_p_320f {
   struct smt_para para ;
   u_int mib_index ;
   u_int mib_payload ;
    klee_make_symbolic(&mib_payload, sizeof(int), "mib_payload");
};
struct smt_p_3210 {
   struct smt_para para ;
   u_int mib_index ;
   u_int mib_overhead ;
    klee_make_symbolic(&mib_overhead, sizeof(int), "mib_overhead");
};
...
static int num_boards  ;
    klee_make_symbolic(&num_boards, sizeof(int), "num_boards");
...
{ 
  ...
  struct sk_buff *skb ;
  unsigned char fc ;
    klee_make_symbolic(&fc, sizeof(char), "fc");
  int queue ;
  ...
  unsigned long Flags ;
  int frame_status ;
    klee_make_symbolic(&frame_status, sizeof(int), "frame_status");
  struct _ddebug descriptor ;
  long tmp ;
  struct _ddebug descriptor___0 ;
  long tmp___0 ;
...
{ 
  unsigned char SRBit ;
    klee_make_symbolic(&SRBit, sizeof(char), "SRBit");
  size_t __len ;
  void *__ret ;
...
{ 
  ...
  unsigned char *cp ;
  unsigned short ri ;
    klee_make_symbolic(&ri, sizeof(short), "ri");
  u_int RifLength ;
    klee_make_symbolic(&RifLength, sizeof(int), "RifLength");
  struct _ddebug descriptor ;
  long tmp ;
  struct _ddebug descriptor___0 ;
  long tmp___0 ;
...
{ 
  ...
  unsigned long b_addr ;
    klee_make_symbolic(&b_addr, sizeof(long), "b_addr");
  struct sk_buff *skb ;
...
{ 
  ...
  int res_skfp_open_3 ;
    klee_make_symbolic(&res_skfp_open_3, sizeof(int), "res_skfp_open_3");
  int res_skfp_close_4 ;
    klee_make_symbolic(&res_skfp_close_4, sizeof(int), "res_skfp_close_4");
  struct sk_buff *var_group2 ;
  void *var_skfp_ctl_set_mac_address_9_p1 ;
  struct ifreq *var_group3 ;
  int var_skfp_ioctl_10_p2 ;
    klee_make_symbolic(&var_skfp_ioctl_10_p2, sizeof(int), "var_skfp_ioctl_10_p2");
  struct pci_dev *var_group4 ;
  struct pci_device_id  const  *var_skfp_init_one_0_p1 ;
  int res_skfp_init_one_0 ;
    klee_make_symbolic(&res_skfp_init_one_0, sizeof(int), "res_skfp_init_one_0");
  int var_skfp_interrupt_5_p0 ;
    klee_make_symbolic(&var_skfp_interrupt_5_p0, sizeof(int), "var_skfp_interrupt_5_p0");
  void *var_skfp_interrupt_5_p1 ;
  int ldv_s_skfp_netdev_ops_net_device_ops ;
    klee_make_symbolic(&ldv_s_skfp_netdev_ops_net_device_ops, sizeof(int), "ldv_s_skfp_netdev_ops_net_device_ops");
  int ldv_s_skfddi_pci_driver_pci_driver ;
    klee_make_symbolic(&ldv_s_skfddi_pci_driver_pci_driver, sizeof(int), "ldv_s_skfddi_pci_driver_pci_driver");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
...
{ 
  ...
  u_long phys ;
    klee_make_symbolic(&phys, sizeof(long), "phys");
...
{ 
  ...
  Mbuf *tmp___0 ;
  u_short tmp___1 ;
    klee_make_symbolic(&tmp___1, sizeof(short), "tmp___1");
  u_short tmp___2 ;
  int tmp___3 ;
...
{ 
  ...
  u_long phys ;
  u_long tbctrl ;
    klee_make_symbolic(&tbctrl, sizeof(long), "tbctrl");
...
{ 
  ...
  u_long phys ;
  u_long rbctrl ;
    klee_make_symbolic(&rbctrl, sizeof(long), "rbctrl");
  struct s_smt_fp_rxd  volatile  *r ;
...
{ 
  u_long is ;
    klee_make_symbolic(&is, sizeof(long), "is");
  u_short stu ;
    klee_make_symbolic(&stu, sizeof(short), "stu");
  u_short stl ;
    klee_make_symbolic(&stl, sizeof(short), "stl");
  Mbuf *mb ;
  unsigned int tmp ;
  unsigned int tmp___0 ;
  unsigned int tmp___1 ;
...
{ 
  ...
  int n ;
  int frag_count ;
    klee_make_symbolic(&frag_count, sizeof(int), "frag_count");
  int used_frags ;
    klee_make_symbolic(&used_frags, sizeof(int), "used_frags");
  struct s_smt_rx_queue *queue ;
  struct s_smt_fp_rxd  volatile  *r ;
  struct s_smt_fp_rxd  volatile  *rxd ;
  u_long rbctrl ;
  u_long rfsw ;
    klee_make_symbolic(&rfsw, sizeof(long), "rfsw");
  u_short rx_used ;
  u_char *virt ;
  char *data ;
  Mbuf *mb ;
...
{ 
  u_long tneg ;
    klee_make_symbolic(&tneg, sizeof(long), "tneg");
  unsigned int tmp ;
  unsigned int tmp___0 ;
...
{ 
  u_short rbc_ram_addr ;
    klee_make_symbolic(&rbc_ram_addr, sizeof(short), "rbc_ram_addr");
...
{ 
  long t_requ ;
    klee_make_symbolic(&t_requ, sizeof(long), "t_requ");
...
{ 
  u_int td ;
    klee_make_symbolic(&td, sizeof(int), "td");
  int len ;
...
{ 
  u_short change_s2l ;
    klee_make_symbolic(&change_s2l, sizeof(short), "change_s2l");
  u_short change_s2u ;
    klee_make_symbolic(&change_s2u, sizeof(short), "change_s2u");
...
{ 
  u_short t_max ;
    klee_make_symbolic(&t_max, sizeof(short), "t_max");
  u_short x ;
  u_long time ;
...
{ 
  ...
  u_long upper ;
    klee_make_symbolic(&upper, sizeof(long), "upper");
  u_long lower ;
    klee_make_symbolic(&lower, sizeof(long), "lower");
  int cond ;
...
{ 
  ...
  int illegal ;
    klee_make_symbolic(&illegal, sizeof(int), "illegal");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
...
{ 
  ...
  Mbuf *mb ;
  int ports ;
    klee_make_symbolic(&ports, sizeof(int), "ports");
  int i ;
...
{ 
  ...
  int twist ;
    klee_make_symbolic(&twist, sizeof(int), "twist");
  int tmp ;
...
{ 
  u_long time ;
  u_long utime ;
    klee_make_symbolic(&utime, sizeof(long), "utime");
...
{ 
  ...
  u_char const   *map ;
  u_short in ;
    klee_make_symbolic(&in, sizeof(short), "in");
  u_short out ;
    klee_make_symbolic(&out, sizeof(short), "out");
...
{ 
  ...
  int state ;
  int remote ;
    klee_make_symbolic(&remote, sizeof(int), "remote");
  int mac ;
    klee_make_symbolic(&mac, sizeof(int), "mac");
  int len ;
  int p ;
    klee_make_symbolic(&p, sizeof(int), "p");
  int physp ;
    klee_make_symbolic(&physp, sizeof(int), "physp");
...
{ 
  ...
  int cond ;
  int oldstate ;
    klee_make_symbolic(&oldstate, sizeof(int), "oldstate");
...
{ 
  int ls_a ;
    klee_make_symbolic(&ls_a, sizeof(int), "ls_a");
  int ls_b ;
    klee_make_symbolic(&ls_b, sizeof(int), "ls_b");
  int p ;
  int tmp ;
  u_short tmp___0 ;
...
{ 
  int port_in ;
    klee_make_symbolic(&port_in, sizeof(int), "port_in");
  int port_out ;
    klee_make_symbolic(&port_out, sizeof(int), "port_out");
  u_short tmp ;
...
{ 
  int i ;
  int rev ;
    klee_make_symbolic(&rev, sizeof(int), "rev");
  unsigned int tmp ;
...
{ 
  ...
  struct fddi_mib_p *mib ;
  u_short plc_rev ;
    klee_make_symbolic(&plc_rev, sizeof(short), "plc_rev");
  unsigned int tmp ;
  unsigned int tmp___0 ;
  unsigned int tmp___1 ;
  unsigned int tmp___2 ;
...
{ 
  int cntrl ;
    klee_make_symbolic(&cntrl, sizeof(int), "cntrl");
  unsigned int tmp ;
...
{ 
  int ber ;
    klee_make_symbolic(&ber, sizeof(int), "ber");
  u_long errors ;
    klee_make_symbolic(&errors, sizeof(long), "errors");
  struct lem_counter *lem ;
  struct fddi_mib_p *mib ;
  int cond ;
  unsigned int tmp ;
...
{ 
  ...
  int type ;
  int ne ;
    klee_make_symbolic(&ne, sizeof(int), "ne");
  int policy ;
...
{ 
  ...
  int n ;
  int corr_mask ;
    klee_make_symbolic(&corr_mask, sizeof(int), "corr_mask");
  int i ;
  unsigned int tmp ;
  int j ;
  ...
  unsigned int tmp___2 ;
  int reason ;
    klee_make_symbolic(&reason, sizeof(int), "reason");
  unsigned int tmp___3 ;
  unsigned int tmp___4 ;
...
{ 
  ...
  int index ;
  int idx_end ;
    klee_make_symbolic(&idx_end, sizeof(int), "idx_end");
  int error ;
  int range ;
...
{ 
  ...
  int port ;
  int sp_len ;
    klee_make_symbolic(&sp_len, sizeof(int), "sp_len");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
  int tmp___2 ;
...
{ 
  ...
  int port ;
  u_char byte_val ;
    klee_make_symbolic(&byte_val, sizeof(char), "byte_val");
  u_short word_val ;
    klee_make_symbolic(&word_val, sizeof(short), "word_val");
  u_long long_val ;
    klee_make_symbolic(&long_val, sizeof(long), "long_val");
  int tmp ;
  int tmp___0 ;
  char *tmp___1 ;
  char *tmp___2 ;
...
{ 
  ...
  int tx___0 ;
    klee_make_symbolic(&tx___0, sizeof(int), "tx___0");
  u_short tmp___5 ;
...
{ 
  ...
  u_long smt_boot_time ;
    klee_make_symbolic(&smt_boot_time, sizeof(long), "smt_boot_time");
...
{ 
  int st ;
  int st2 ;
    klee_make_symbolic(&st2, sizeof(int), "st2");
  int tmp ;
...
{ 
  u_long old ;
    klee_make_symbolic(&old, sizeof(long), "old");
...
{ 
  ...
  int offset ;
  u_char fail_safe ;
    klee_make_symbolic(&fail_safe, sizeof(char), "fail_safe");
...
{ 
  struct s_srf_evc *evc ;
  int cond_asserted ;
    klee_make_symbolic(&cond_asserted, sizeof(int), "cond_asserted");
  int cond_deasserted ;
    klee_make_symbolic(&cond_deasserted, sizeof(int), "cond_deasserted");
  int event_occurred ;
    klee_make_symbolic(&event_occurred, sizeof(int), "event_occurred");
  int tsr ;
    klee_make_symbolic(&tsr, sizeof(int), "tsr");
  int T_Limit ;
    klee_make_symbolic(&T_Limit, sizeof(int), "T_Limit");
  u_short tmp ;
  u_long tmp___0 ;
...
{ 
  u_short cnt ;
    klee_make_symbolic(&cnt, sizeof(short), "cnt");
...
{ 
  u_short tr ;
    klee_make_symbolic(&tr, sizeof(short), "tr");
  u_long is ;
  unsigned int tmp ;
  unsigned int tmp___0 ;
...
{ 
  long diff ;
    klee_make_symbolic(&diff, sizeof(long), "diff");
  long interval ;
  int wrapped ;
    klee_make_symbolic(&wrapped, sizeof(int), "wrapped");
  u_long tmp ;
  u_long tmp___0 ;
  unsigned int tmp___1 ;
  u_long tmp___2 ;
...
{ 
  ...
  u_short word ;
    klee_make_symbolic(&word, sizeof(short), "word");
  u_long tmp ;
  unsigned int tmp___0 ;
  unsigned int tmp___1 ;
  unsigned int tmp___2 ;
...
{ 
  int restart_tx ;
    klee_make_symbolic(&restart_tx, sizeof(int), "restart_tx");
  unsigned int tmp ;
  unsigned int tmp___0 ;
...
{ 
  char ConnectorType ;
    klee_make_symbolic(&ConnectorType, sizeof(char), "ConnectorType");
  char PmdType ;
    klee_make_symbolic(&PmdType, sizeof(char), "PmdType");
  int i ;
  unsigned int tmp ;
  unsigned int tmp___0 ;
  unsigned int tmp___1 ;
...
{ 
  u_short led_state ;
    klee_make_symbolic(&led_state, sizeof(short), "led_state");
  struct s_phy *phy ;
...
{ 
  ...
  Mbuf *db ;
  u_long msg_res_type ;
    klee_make_symbolic(&msg_res_type, sizeof(long), "msg_res_type");
  u_long payload ;
    klee_make_symbolic(&payload, sizeof(long), "payload");
  u_long overhead ;
    klee_make_symbolic(&overhead, sizeof(long), "overhead");
  int local ;
  int i ;
  void *tmp ;
  size_t __len ;
