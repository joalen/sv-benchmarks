...
struct mtget {
   long mt_type ;
    klee_make_symbolic(&mt_type, sizeof(long), "mt_type");
   long mt_resid ;
    klee_make_symbolic(&mt_resid, sizeof(long), "mt_resid");
   long mt_dsreg ;
    klee_make_symbolic(&mt_dsreg, sizeof(long), "mt_dsreg");
   long mt_gstat ;
    klee_make_symbolic(&mt_gstat, sizeof(long), "mt_gstat");
   long mt_erreg ;
    klee_make_symbolic(&mt_erreg, sizeof(long), "mt_erreg");
   __kernel_daddr_t mt_fileno ;
   __kernel_daddr_t mt_blkno ;
};
struct mtpos {
   long mt_blkno ;
    klee_make_symbolic(&mt_blkno, sizeof(long), "mt_blkno");
};
struct device_type;
struct class;
struct klist_node;
...
struct st_cmdstatus {
   int midlevel_result ;
    klee_make_symbolic(&midlevel_result, sizeof(int), "midlevel_result");
   struct scsi_sense_hdr sense_hdr ;
   int have_sense ;
    klee_make_symbolic(&have_sense, sizeof(int), "have_sense");
   int residual ;
    klee_make_symbolic(&residual, sizeof(int), "residual");
   u64 uremainder64 ;
   u8 flags ;
   u8 remainder_valid ;
   u8 fixed_format ;
...
struct st_buffer {
   ...
   unsigned char cleared ;
    klee_make_symbolic(&cleared, sizeof(char), "cleared");
   unsigned short do_dio ;
    klee_make_symbolic(&do_dio, sizeof(short), "do_dio");
   int buffer_size ;
    klee_make_symbolic(&buffer_size, sizeof(int), "buffer_size");
   int buffer_blocks ;
    klee_make_symbolic(&buffer_blocks, sizeof(int), "buffer_blocks");
   int buffer_bytes ;
    klee_make_symbolic(&buffer_bytes, sizeof(int), "buffer_bytes");
   int read_pointer ;
    klee_make_symbolic(&read_pointer, sizeof(int), "read_pointer");
   int writing ;
    klee_make_symbolic(&writing, sizeof(int), "writing");
   int syscall_result ;
    klee_make_symbolic(&syscall_result, sizeof(int), "syscall_result");
   struct st_request *last_SRpnt ;
   struct st_cmdstatus cmdstat ;
   struct page **reserved_pages ;
   int reserved_page_order ;
    klee_make_symbolic(&reserved_page_order, sizeof(int), "reserved_page_order");
   struct page **mapped_pages ;
   struct rq_map_data map_data ;
   unsigned char *b_data ;
   unsigned short use_sg ;
    klee_make_symbolic(&use_sg, sizeof(short), "use_sg");
   unsigned short sg_segs ;
    klee_make_symbolic(&sg_segs, sizeof(short), "sg_segs");
   unsigned short frp_segs ;
    klee_make_symbolic(&frp_segs, sizeof(short), "frp_segs");
};
struct st_modedef {
   unsigned char defined ;
    klee_make_symbolic(&defined, sizeof(char), "defined");
   unsigned char sysv ;
    klee_make_symbolic(&sysv, sizeof(char), "sysv");
   unsigned char do_async_writes ;
    klee_make_symbolic(&do_async_writes, sizeof(char), "do_async_writes");
   unsigned char do_buffer_writes ;
    klee_make_symbolic(&do_buffer_writes, sizeof(char), "do_buffer_writes");
   unsigned char do_read_ahead ;
    klee_make_symbolic(&do_read_ahead, sizeof(char), "do_read_ahead");
   unsigned char defaults_for_writes ;
    klee_make_symbolic(&defaults_for_writes, sizeof(char), "defaults_for_writes");
   unsigned char default_compression ;
    klee_make_symbolic(&default_compression, sizeof(char), "default_compression");
   short default_density ;
    klee_make_symbolic(&default_density, sizeof(short), "default_density");
   int default_blksize ;
    klee_make_symbolic(&default_blksize, sizeof(int), "default_blksize");
...
struct st_partstat {
   unsigned char rw ;
    klee_make_symbolic(&rw, sizeof(char), "rw");
   unsigned char eof ;
    klee_make_symbolic(&eof, sizeof(char), "eof");
   unsigned char at_sm ;
    klee_make_symbolic(&at_sm, sizeof(char), "at_sm");
   unsigned char last_block_valid ;
    klee_make_symbolic(&last_block_valid, sizeof(char), "last_block_valid");
   u32 last_block_visited ;
   int drv_block ;
    klee_make_symbolic(&drv_block, sizeof(int), "drv_block");
   int drv_file ;
    klee_make_symbolic(&drv_file, sizeof(int), "drv_file");
};
struct scsi_tape {
   ...
   unsigned char omit_blklims ;
    klee_make_symbolic(&omit_blklims, sizeof(char), "omit_blklims");
   unsigned char do_auto_lock ;
    klee_make_symbolic(&do_auto_lock, sizeof(char), "do_auto_lock");
   unsigned char can_bsr ;
    klee_make_symbolic(&can_bsr, sizeof(char), "can_bsr");
   unsigned char can_partitions ;
    klee_make_symbolic(&can_partitions, sizeof(char), "can_partitions");
   unsigned char two_fm ;
    klee_make_symbolic(&two_fm, sizeof(char), "two_fm");
   unsigned char fast_mteom ;
    klee_make_symbolic(&fast_mteom, sizeof(char), "fast_mteom");
   unsigned char immediate ;
    klee_make_symbolic(&immediate, sizeof(char), "immediate");
   unsigned char restr_dma ;
    klee_make_symbolic(&restr_dma, sizeof(char), "restr_dma");
   unsigned char scsi2_logical ;
    klee_make_symbolic(&scsi2_logical, sizeof(char), "scsi2_logical");
   unsigned char default_drvbuffer ;
    klee_make_symbolic(&default_drvbuffer, sizeof(char), "default_drvbuffer");
   unsigned char cln_mode ;
    klee_make_symbolic(&cln_mode, sizeof(char), "cln_mode");
   unsigned char cln_sense_value ;
    klee_make_symbolic(&cln_sense_value, sizeof(char), "cln_sense_value");
   unsigned char cln_sense_mask ;
    klee_make_symbolic(&cln_sense_mask, sizeof(char), "cln_sense_mask");
   unsigned char use_pf ;
    klee_make_symbolic(&use_pf, sizeof(char), "use_pf");
   unsigned char try_dio ;
    klee_make_symbolic(&try_dio, sizeof(char), "try_dio");
   unsigned char try_dio_now ;
    klee_make_symbolic(&try_dio_now, sizeof(char), "try_dio_now");
   unsigned char c_algo ;
    klee_make_symbolic(&c_algo, sizeof(char), "c_algo");
   unsigned char pos_unknown ;
    klee_make_symbolic(&pos_unknown, sizeof(char), "pos_unknown");
   unsigned char sili ;
    klee_make_symbolic(&sili, sizeof(char), "sili");
   unsigned char immediate_filemark ;
    klee_make_symbolic(&immediate_filemark, sizeof(char), "immediate_filemark");
   int tape_type ;
    klee_make_symbolic(&tape_type, sizeof(int), "tape_type");
   int long_timeout ;
    klee_make_symbolic(&long_timeout, sizeof(int), "long_timeout");
   unsigned long max_pfn ;
    klee_make_symbolic(&max_pfn, sizeof(long), "max_pfn");
   struct st_modedef modes[4U] ;
   int current_mode ;
    klee_make_symbolic(&current_mode, sizeof(int), "current_mode");
   int partition ;
    klee_make_symbolic(&partition, sizeof(int), "partition");
   int new_partition ;
    klee_make_symbolic(&new_partition, sizeof(int), "new_partition");
   int nbr_partitions ;
    klee_make_symbolic(&nbr_partitions, sizeof(int), "nbr_partitions");
   struct st_partstat ps[4U] ;
   unsigned char dirty ;
    klee_make_symbolic(&dirty, sizeof(char), "dirty");
   unsigned char ready ;
    klee_make_symbolic(&ready, sizeof(char), "ready");
   unsigned char write_prot ;
    klee_make_symbolic(&write_prot, sizeof(char), "write_prot");
   unsigned char drv_write_prot ;
    klee_make_symbolic(&drv_write_prot, sizeof(char), "drv_write_prot");
   unsigned char in_use ;
    klee_make_symbolic(&in_use, sizeof(char), "in_use");
   unsigned char blksize_changed ;
    klee_make_symbolic(&blksize_changed, sizeof(char), "blksize_changed");
   unsigned char density_changed ;
    klee_make_symbolic(&density_changed, sizeof(char), "density_changed");
   unsigned char compression_changed ;
    klee_make_symbolic(&compression_changed, sizeof(char), "compression_changed");
   unsigned char drv_buffer ;
    klee_make_symbolic(&drv_buffer, sizeof(char), "drv_buffer");
   unsigned char density ;
    klee_make_symbolic(&density, sizeof(char), "density");
   unsigned char door_locked ;
    klee_make_symbolic(&door_locked, sizeof(char), "door_locked");
   unsigned char autorew_dev ;
    klee_make_symbolic(&autorew_dev, sizeof(char), "autorew_dev");
   unsigned char rew_at_close ;
    klee_make_symbolic(&rew_at_close, sizeof(char), "rew_at_close");
   unsigned char inited ;
    klee_make_symbolic(&inited, sizeof(char), "inited");
   unsigned char cleaning_req ;
    klee_make_symbolic(&cleaning_req, sizeof(char), "cleaning_req");
   int block_size ;
    klee_make_symbolic(&block_size, sizeof(int), "block_size");
   int min_block ;
    klee_make_symbolic(&min_block, sizeof(int), "min_block");
   int max_block ;
    klee_make_symbolic(&max_block, sizeof(int), "max_block");
   int recover_count ;
    klee_make_symbolic(&recover_count, sizeof(int), "recover_count");
   int recover_reg ;
    klee_make_symbolic(&recover_reg, sizeof(int), "recover_reg");
   struct gendisk *disk ;
   struct kref kref ;
};
...
struct osst_buffer {
   ...
   unsigned short orig_sg_segs ;
    klee_make_symbolic(&orig_sg_segs, sizeof(short), "orig_sg_segs");
...
struct osst_tape {
   ...
   unsigned char pos_unknown ;
   int write_threshold ;
    klee_make_symbolic(&write_threshold, sizeof(int), "write_threshold");
   int timeout ;
   int long_timeout ;
   struct st_modedef modes[4U] ;
   int current_mode ;
   ...
   int recover_count ;
   int abort_count ;
    klee_make_symbolic(&abort_count, sizeof(int), "abort_count");
   int write_count ;
    klee_make_symbolic(&write_count, sizeof(int), "write_count");
   int read_count ;
    klee_make_symbolic(&read_count, sizeof(int), "read_count");
   int recover_erreg ;
    klee_make_symbolic(&recover_erreg, sizeof(int), "recover_erreg");
   int os_fw_rev ;
    klee_make_symbolic(&os_fw_rev, sizeof(int), "os_fw_rev");
   unsigned char raw ;
    klee_make_symbolic(&raw, sizeof(char), "raw");
   unsigned char poll ;
    klee_make_symbolic(&poll, sizeof(char), "poll");
   unsigned char frame_in_buffer ;
    klee_make_symbolic(&frame_in_buffer, sizeof(char), "frame_in_buffer");
   int frame_seq_number ;
    klee_make_symbolic(&frame_seq_number, sizeof(int), "frame_seq_number");
   int logical_blk_num ;
    klee_make_symbolic(&logical_blk_num, sizeof(int), "logical_blk_num");
   unsigned int first_frame_position ;
    klee_make_symbolic(&first_frame_position, sizeof(int), "first_frame_position");
   unsigned int last_frame_position ;
    klee_make_symbolic(&last_frame_position, sizeof(int), "last_frame_position");
   int cur_frames ;
    klee_make_symbolic(&cur_frames, sizeof(int), "cur_frames");
   int max_frames ;
    klee_make_symbolic(&max_frames, sizeof(int), "max_frames");
   char application_sig[5U] ;
   unsigned char fast_open ;
    klee_make_symbolic(&fast_open, sizeof(char), "fast_open");
   unsigned short wrt_pass_cntr ;
    klee_make_symbolic(&wrt_pass_cntr, sizeof(short), "wrt_pass_cntr");
   int update_frame_cntr ;
    klee_make_symbolic(&update_frame_cntr, sizeof(int), "update_frame_cntr");
   int onstream_write_error ;
    klee_make_symbolic(&onstream_write_error, sizeof(int), "onstream_write_error");
   int header_ok ;
    klee_make_symbolic(&header_ok, sizeof(int), "header_ok");
   int linux_media ;
    klee_make_symbolic(&linux_media, sizeof(int), "linux_media");
   int linux_media_version ;
    klee_make_symbolic(&linux_media_version, sizeof(int), "linux_media_version");
   os_header_t *header_cache ;
   int filemark_cnt ;
    klee_make_symbolic(&filemark_cnt, sizeof(int), "filemark_cnt");
   int first_mark_ppos ;
    klee_make_symbolic(&first_mark_ppos, sizeof(int), "first_mark_ppos");
   int last_mark_ppos ;
    klee_make_symbolic(&last_mark_ppos, sizeof(int), "last_mark_ppos");
   int last_mark_lbn ;
    klee_make_symbolic(&last_mark_lbn, sizeof(int), "last_mark_lbn");
   int first_data_ppos ;
    klee_make_symbolic(&first_data_ppos, sizeof(int), "first_data_ppos");
   int eod_frame_ppos ;
    klee_make_symbolic(&eod_frame_ppos, sizeof(int), "eod_frame_ppos");
   int eod_frame_lfa ;
    klee_make_symbolic(&eod_frame_lfa, sizeof(int), "eod_frame_lfa");
   int write_type ;
    klee_make_symbolic(&write_type, sizeof(int), "write_type");
   int read_error_frame ;
    klee_make_symbolic(&read_error_frame, sizeof(int), "read_error_frame");
   unsigned long cmd_start_time ;
    klee_make_symbolic(&cmd_start_time, sizeof(long), "cmd_start_time");
   unsigned long max_cmd_time ;
    klee_make_symbolic(&max_cmd_time, sizeof(long), "max_cmd_time");
...
static int osst_nr_dev  ;
    klee_make_symbolic(&osst_nr_dev, sizeof(int), "osst_nr_dev");
...
{ 
  ...
  int notyetprinted ;
    klee_make_symbolic(&notyetprinted, sizeof(int), "notyetprinted");
...
{ 
  ...
  int blk_sz ;
    klee_make_symbolic(&blk_sz, sizeof(int), "blk_sz");
  int i ;
  struct page *tmp___0 ;
  void *tmp___1 ;
  __u32 tmp___2 ;
...
{ 
  ...
  unsigned long startwait ;
    klee_make_symbolic(&startwait, sizeof(long), "startwait");
  unsigned int tmp ;
  int tmp___0 ;
...
{ 
  ...
  char *olddata ;
  int oldsize ;
    klee_make_symbolic(&oldsize, sizeof(int), "oldsize");
...
{ 
  ...
  int past ;
    klee_make_symbolic(&past, sizeof(int), "past");
  int x ;
  int position ;
...
{ 
  ...
  int frame_seq_estimate ;
    klee_make_symbolic(&frame_seq_estimate, sizeof(int), "frame_seq_estimate");
  int ppos_estimate ;
    klee_make_symbolic(&ppos_estimate, sizeof(int), "ppos_estimate");
  int move ;
    klee_make_symbolic(&move, sizeof(int), "move");
  __u32 tmp___0 ;
  __u32 tmp___2 ;
...
{ 
  ...
  int new_frame ;
    klee_make_symbolic(&new_frame, sizeof(int), "new_frame");
  int i ;
  int nframes ;
    klee_make_symbolic(&nframes, sizeof(int), "nframes");
  int blks_per_frame ;
    klee_make_symbolic(&blks_per_frame, sizeof(int), "blks_per_frame");
  __u16 tmp ;
  int frame_seq_number ;
  __u32 tmp___0 ;
  int logical_blk_num ;
...
{ 
  ...
  int retval ;
  int rw_state ;
    klee_make_symbolic(&rw_state, sizeof(int), "rw_state");
  unsigned int frame ;
  unsigned int skip ;
...
{ 
  ...
  int cnt ;
  int next_mark_ppos ;
    klee_make_symbolic(&next_mark_ppos, sizeof(int), "next_mark_ppos");
  int tmp___0 ;
  __u32 tmp___1 ;
  __u32 tmp___2 ;
  __u32 tmp___3 ;
...
{ 
  int result ;
  int this_mark_ppos ;
    klee_make_symbolic(&this_mark_ppos, sizeof(int), "this_mark_ppos");
  int this_mark_lbn ;
    klee_make_symbolic(&this_mark_lbn, sizeof(int), "this_mark_lbn");
  int tmp ;
  __u32 tmp___0 ;
  int tmp___1 ;
...
{ 
  int position ;
  int ppos ;
    klee_make_symbolic(&ppos, sizeof(int), "ppos");
  int first ;
...
{ 
  int frame_position ;
    klee_make_symbolic(&frame_position, sizeof(int), "frame_position");
  int frame_seq_numbr ;
    klee_make_symbolic(&frame_seq_numbr, sizeof(int), "frame_seq_numbr");
  int logical_blk_num ;
  int halfway_frame ;
    klee_make_symbolic(&halfway_frame, sizeof(int), "halfway_frame");
  int read_pointer ;
  int prev_mark_ppos ;
    klee_make_symbolic(&prev_mark_ppos, sizeof(int), "prev_mark_ppos");
  int actual_mark_ppos ;
    klee_make_symbolic(&actual_mark_ppos, sizeof(int), "actual_mark_ppos");
  int i ;
  int n ;
...
{ 
  ...
  int drive_buffer_size ;
    klee_make_symbolic(&drive_buffer_size, sizeof(int), "drive_buffer_size");
  __u16 tmp___0 ;
  __u16 tmp___1 ;
  __u16 tmp___2 ;
...
{ 
  ...
  int result ;
  int pp ;
    klee_make_symbolic(&pp, sizeof(int), "pp");
  char *name ;
  char *tmp ;
...
{ 
  int offset ;
  int transfer ;
    klee_make_symbolic(&transfer, sizeof(int), "transfer");
  int blks ;
...
{ 
  struct st_partstat *STps ;
  int backspace ;
    klee_make_symbolic(&backspace, sizeof(int), "backspace");
  int result ;
  int tmp ;
...
{ 
  ...
  int write_threshold ;
  int doing_write ;
    klee_make_symbolic(&doing_write, sizeof(int), "doing_write");
  char const   *b_point ;
  struct osst_request *SRpnt ;
...
{ 
  ...
  ssize_t transfer ;
  int special ;
    klee_make_symbolic(&special, sizeof(int), "special");
  struct st_modedef *STm ;
  struct st_partstat *STps ;
  struct osst_request *SRpnt ;
  struct osst_tape *STp ;
...
{ 
  int timeout ;
  long ltmp ;
    klee_make_symbolic(&ltmp, sizeof(long), "ltmp");
  int i ;
  int ioctl_result ;
    klee_make_symbolic(&ioctl_result, sizeof(int), "ioctl_result");
  int chg_eof ;
    klee_make_symbolic(&chg_eof, sizeof(int), "chg_eof");
  unsigned char cmd[16U] ;
  struct osst_request *SRpnt ;
  struct st_partstat *STps ;
  int fileno ;
    klee_make_symbolic(&fileno, sizeof(int), "fileno");
  int blkno ;
    klee_make_symbolic(&blkno, sizeof(int), "blkno");
  int at_sm ;
  int frame_seq_numbr ;
  int logical_blk_num ;
  int datalen ;
...
{ 
  ...
  int i ;
  int b_size ;
    klee_make_symbolic(&b_size, sizeof(int), "b_size");
  int new_session ;
    klee_make_symbolic(&new_session, sizeof(int), "new_session");
  int retval ;
  unsigned char cmd[16U] ;
  struct osst_request *SRpnt ;
  struct osst_tape *STp ;
...
{ 
  int i ;
  int cmd_nr ;
    klee_make_symbolic(&cmd_nr, sizeof(int), "cmd_nr");
  int cmd_type ;
  ...
  struct mtop mtc ;
  int auto_weof ;
    klee_make_symbolic(&auto_weof, sizeof(int), "auto_weof");
  unsigned long tmp___2 ;
  bool tmp___3 ;
  int tmp___4 ;
  int tmp___5 ;
...
{ 
  int segs ;
    klee_make_symbolic(&segs, sizeof(int), "segs");
  int nbr ;
    klee_make_symbolic(&nbr, sizeof(int), "nbr");
  int max_segs ;
    klee_make_symbolic(&max_segs, sizeof(int), "max_segs");
  int b_size ;
  int order ;
  int got ;
    klee_make_symbolic(&got, sizeof(int), "got");
  gfp_t priority ;
  struct page *page ;
  struct page *tmp ;
  void *tmp___0 ;
...
{ 
  ...
  int offset ;
  int do_count ;
    klee_make_symbolic(&do_count, sizeof(int), "do_count");
  int cnt ;
  struct page *tmp ;
  void *tmp___0 ;
...
{ 
  ...
  int res_osst_probe_85 ;
    klee_make_symbolic(&res_osst_probe_85, sizeof(int), "res_osst_probe_85");
  ...
  unsigned int var_osst_ioctl_59_p1 ;
    klee_make_symbolic(&var_osst_ioctl_59_p1, sizeof(int), "var_osst_ioctl_59_p1");
  unsigned long var_osst_ioctl_59_p2 ;
    klee_make_symbolic(&var_osst_ioctl_59_p2, sizeof(long), "var_osst_ioctl_59_p2");
  unsigned int var_osst_compat_ioctl_60_p1 ;
    klee_make_symbolic(&var_osst_compat_ioctl_60_p1, sizeof(int), "var_osst_compat_ioctl_60_p1");
  unsigned long var_osst_compat_ioctl_60_p2 ;
    klee_make_symbolic(&var_osst_compat_ioctl_60_p2, sizeof(long), "var_osst_compat_ioctl_60_p2");
  struct inode *var_group3 ;
  int res_os_scsi_tape_open_56 ;
    klee_make_symbolic(&res_os_scsi_tape_open_56, sizeof(int), "res_os_scsi_tape_open_56");
  fl_owner_t var_os_scsi_tape_flush_57_p1 ;
  int ldv_s_osst_template_scsi_driver ;
    klee_make_symbolic(&ldv_s_osst_template_scsi_driver, sizeof(int), "ldv_s_osst_template_scsi_driver");
  int ldv_s_osst_fops_file_operations ;
    klee_make_symbolic(&ldv_s_osst_fops_file_operations, sizeof(int), "ldv_s_osst_fops_file_operations");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
...
static int ldv_mutex_lock_of_osst_tape  ;
    klee_make_symbolic(&ldv_mutex_lock_of_osst_tape, sizeof(int), "ldv_mutex_lock_of_osst_tape");
int ldv_mutex_lock_interruptible_lock_of_osst_tape(struct mutex *lock ) 
{ 
  int nondetermined ;
...
static int ldv_mutex_osst_int_mutex  ;
    klee_make_symbolic(&ldv_mutex_osst_int_mutex, sizeof(int), "ldv_mutex_osst_int_mutex");
