...
struct em28xx_audio {
   ...
   unsigned int num_urb ;
    klee_make_symbolic(&num_urb, sizeof(int), "num_urb");
   char **transfer_buffer ;
   struct urb **urb ;
...
struct soc_camera_subdev_desc {
   ...
   unsigned long clock_state ;
    klee_make_symbolic(&clock_state, sizeof(long), "clock_state");
...
int ldv_0_ldv_param_7_2_default ;
    klee_make_symbolic(&ldv_0_ldv_param_7_2_default, sizeof(int), "ldv_0_ldv_param_7_2_default");
int ldv_statevar_0  ;
...
int ldv_1_probe_retval_default  ;
    klee_make_symbolic(&ldv_1_probe_retval_default, sizeof(int), "ldv_1_probe_retval_default");
