...
{ 
  ...
  int i ;
  int nkeys ;
    klee_make_symbolic(&nkeys, sizeof(int), "nkeys");
...
{ 
  ...
  unsigned int hdr_space ;
    klee_make_symbolic(&hdr_space, sizeof(int), "hdr_space");
  long tmp ;
  int tmp___0 ;
  unsigned char *tmp___1 ;
...
{ 
  ...
  int wol_default ;
    klee_make_symbolic(&wol_default, sizeof(int), "wol_default");
  u32 reg ;
  char buf1[16U] ;
  bool tmp ;
  size_t tmp___0 ;
...
unsigned long long ldv_3_ldv_param_40_1_default  ;
    klee_make_symbolic(&ldv_3_ldv_param_40_1_default, sizeof(long), "ldv_3_ldv_param_40_1_default");
