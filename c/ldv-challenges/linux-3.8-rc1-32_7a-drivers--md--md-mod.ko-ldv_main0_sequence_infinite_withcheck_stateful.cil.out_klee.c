...
struct mdu_array_info_s {
   ...
   int ctime ;
    klee_make_symbolic(&ctime, sizeof(int), "ctime");
   int level ;
   int size ;
   int nr_disks ;
    klee_make_symbolic(&nr_disks, sizeof(int), "nr_disks");
   int raid_disks ;
    klee_make_symbolic(&raid_disks, sizeof(int), "raid_disks");
   int md_minor ;
    klee_make_symbolic(&md_minor, sizeof(int), "md_minor");
   int not_persistent ;
    klee_make_symbolic(&not_persistent, sizeof(int), "not_persistent");
   int utime ;
    klee_make_symbolic(&utime, sizeof(int), "utime");
   int state ;
   int active_disks ;
    klee_make_symbolic(&active_disks, sizeof(int), "active_disks");
   int working_disks ;
    klee_make_symbolic(&working_disks, sizeof(int), "working_disks");
   int failed_disks ;
    klee_make_symbolic(&failed_disks, sizeof(int), "failed_disks");
   int spare_disks ;
    klee_make_symbolic(&spare_disks, sizeof(int), "spare_disks");
   int layout ;
...
int mdp_major ;
    klee_make_symbolic(&mdp_major, sizeof(int), "mdp_major");
...
static int start_readonly  ;
    klee_make_symbolic(&start_readonly, sizeof(int), "start_readonly");
struct bio *bio_alloc_mddev(gfp_t gfp_mask , int nr_iovecs , struct mddev *mddev ) 
{ 
  struct bio *b ;
  struct bio *tmp ;
...
{ 
  ...
  struct list_head  const  *__mptr___0 ;
  int next_minor ;
    klee_make_symbolic(&next_minor, sizeof(int), "next_minor");
  int start ;
  int is_free ;
    klee_make_symbolic(&is_free, sizeof(int), "is_free");
  int dev ;
...
{ 
  ...
  unsigned int disk_csum ;
    klee_make_symbolic(&disk_csum, sizeof(int), "disk_csum");
  unsigned int csum ;
...
{ 
  ...
  int next_spare ;
    klee_make_symbolic(&next_spare, sizeof(int), "next_spare");
  int i ;
  int active ;
    klee_make_symbolic(&active, sizeof(int), "active");
  int working ;
    klee_make_symbolic(&working, sizeof(int), "working");
  int failed ;
    klee_make_symbolic(&failed, sizeof(int), "failed");
  int spare ;
    klee_make_symbolic(&spare, sizeof(int), "spare");
  int nr_disks ;
  void *tmp ;
  size_t __len ;
  void *__ret ;
...
{ 
  ...
  unsigned long long newcsum ;
    klee_make_symbolic(&newcsum, sizeof(long), "newcsum");
  int size ;
  __le32 *isuper ;
  __le32 *tmp ;
...
{ 
  ...
  char b2[32U] ;
  int bmask ;
    klee_make_symbolic(&bmask, sizeof(int), "bmask");
  loff_t tmp ;
  void *tmp___0 ;
  char const   *tmp___1 ;
  __le32 tmp___2 ;
  ...
  int i ;
  int sectors___0 ;
    klee_make_symbolic(&sectors___0, sizeof(int), "sectors___0");
  int tmp___6 ;
...
{ 
  ...
  void *__ret ;
  int role ;
    klee_make_symbolic(&role, sizeof(int), "role");
...
{ 
  ...
  struct md_rdev *rdev2 ;
  int max_dev ;
    klee_make_symbolic(&max_dev, sizeof(int), "max_dev");
  int i ;
  void *tmp ;
  int tmp___0 ;
  int tmp___1 ;
...
{ 
  struct md_rdev *rdev ;
  int sync_req ;
    klee_make_symbolic(&sync_req, sizeof(int), "sync_req");
  int nospares ;
    klee_make_symbolic(&nospares, sizeof(int), "nospares");
  int any_badblocks_changed ;
    klee_make_symbolic(&any_badblocks_changed, sizeof(int), "any_badblocks_changed");
  struct list_head  const  *__mptr ;
  int tmp ;
  struct list_head  const  *__mptr___0 ;
  struct list_head  const  *__mptr___1 ;
...
{ 
  unsigned long long new_offset ;
    klee_make_symbolic(&new_offset, sizeof(long), "new_offset");
  struct mddev *mddev ;
  int tmp ;
  int tmp___0 ;
...
{ 
  ...
  struct mddev *mddev ;
  int overlap ;
    klee_make_symbolic(&overlap, sizeof(int), "overlap");
...
{ 
  unsigned long long recovery_start ;
    klee_make_symbolic(&recovery_start, sizeof(long), "recovery_start");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
...
{ 
  ...
  long decimals ;
    klee_make_symbolic(&decimals, sizeof(long), "decimals");
  unsigned int value ;
...
{ 
  ...
  unsigned long old_delay ;
    klee_make_symbolic(&old_delay, sizeof(long), "old_delay");
...
{ 
  ...
  struct md_rdev *rdev ;
  int olddisks ;
    klee_make_symbolic(&olddisks, sizeof(int), "olddisks");
  struct list_head  const  *__mptr ;
  struct list_head  const  *__mptr___0 ;
...
{ 
  char *end ;
  unsigned long chunk ;
    klee_make_symbolic(&chunk, sizeof(long), "chunk");
  unsigned long end_chunk ;
    klee_make_symbolic(&end_chunk, sizeof(long), "end_chunk");
  char *tmp ;
...
{ 
  unsigned long resync ;
    klee_make_symbolic(&resync, sizeof(long), "resync");
  unsigned long dt ;
    klee_make_symbolic(&dt, sizeof(long), "dt");
  unsigned long db ;
    klee_make_symbolic(&db, sizeof(long), "db");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
...
{ 
  int backwards ;
    klee_make_symbolic(&backwards, sizeof(int), "backwards");
  int tmp ;
  int tmp___0 ;
...
{ 
  ...
  struct gendisk *disk ;
  int partitioned ;
    klee_make_symbolic(&partitioned, sizeof(int), "partitioned");
  int shift ;
  int unit ;
...
static int start_dirty_degraded  ;
    klee_make_symbolic(&start_dirty_degraded, sizeof(int), "start_dirty_degraded");
int md_run(struct mddev *mddev ) 
{ 
  int err ;
  struct md_rdev *rdev ;
...
{ 
  ...
  int working ;
  int insync ;
    klee_make_symbolic(&insync, sizeof(int), "insync");
  int failed ;
  int spare ;
  struct md_rdev *rdev ;
  struct list_head *__ptr ;
...
{ 
  ...
  char *tmp___10 ;
  int err___1 ;
    klee_make_symbolic(&err___1, sizeof(int), "err___1");
  long tmp___11 ;
  long tmp___12 ;
  long tmp___13 ;
  loff_t tmp___14 ;
...
{ 
  ...
  int rv ;
  int fit ;
    klee_make_symbolic(&fit, sizeof(int), "fit");
  struct list_head  const  *__mptr ;
  sector_t avail ;
  struct list_head  const  *__mptr___0 ;
...
{ 
  ...
  sector_t rt ;
  int scale ;
    klee_make_symbolic(&scale, sizeof(int), "scale");
  unsigned int per_milli ;
    klee_make_symbolic(&per_milli, sizeof(int), "per_milli");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
  int _res ;
...
{ 
  ...
  int curr_events ;
    klee_make_symbolic(&curr_events, sizeof(int), "curr_events");
  struct list_head *__ptr ;
  struct list_head  const  *__mptr ;
  struct list_head *_________p1 ;
  bool __warned ;
  ...
  unsigned int _cpu ;
    klee_make_symbolic(&_cpu, sizeof(int), "_cpu");
  void const   *__vpp_verify ;
  unsigned long __ptr___0 ;
  unsigned long res___0 ;
    klee_make_symbolic(&res___0, sizeof(long), "res___0");
  unsigned int _cpu___0 ;
    klee_make_symbolic(&_cpu___0, sizeof(int), "_cpu___0");
  void const   *__vpp_verify___0 ;
  unsigned long __ptr___1 ;
  int tmp___0 ;
  struct list_head *__ptr___2 ;
...
{ 
  int did_change ;
    klee_make_symbolic(&did_change, sizeof(int), "did_change");
  long tmp ;
  int tmp___0 ;
  wait_queue_t __wait ;
  struct task_struct *tmp___1 ;
...
{ 
  ...
  unsigned int currspeed ;
    klee_make_symbolic(&currspeed, sizeof(int), "currspeed");
  unsigned int window ;
  ...
  unsigned long update_time ;
    klee_make_symbolic(&update_time, sizeof(long), "update_time");
  sector_t mark_cnt[10U] ;
  int last_mark ;
    klee_make_symbolic(&last_mark, sizeof(int), "last_mark");
  int m ;
...
{ 
  ...
  int removed ;
    klee_make_symbolic(&removed, sizeof(int), "removed");
  struct list_head  const  *__mptr ;
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
...
{ 
  ...
  sector_t e___0 ;
  int ack___0 ;
    klee_make_symbolic(&ack___0, sizeof(int), "ack___0");
  sector_t a___2 ;
  int lolen ;
    klee_make_symbolic(&lolen, sizeof(int), "lolen");
  int hilen ;
    klee_make_symbolic(&hilen, sizeof(int), "hilen");
  int newlen ;
    klee_make_symbolic(&newlen, sizeof(int), "newlen");
  int ack___1 ;
    klee_make_symbolic(&ack___1, sizeof(int), "ack___1");
  int this_sectors ;
    klee_make_symbolic(&this_sectors, sizeof(int), "this_sectors");
...
{ 
  unsigned long long sector ;
    klee_make_symbolic(&sector, sizeof(long), "sector");
  int length ;
  char newline ;
    klee_make_symbolic(&newline, sizeof(char), "newline");
  int clear___0 ;
    klee_make_symbolic(&clear___0, sizeof(int), "clear___0");
  int tmp ;
  int tmp___0 ;
...
{ 
  ...
  struct mddev *mddev ;
  int need_delay ;
    klee_make_symbolic(&need_delay, sizeof(int), "need_delay");
  int tmp___0 ;
  struct list_head  const  *__mptr ;
  struct list_head  const  *__mptr___0 ;
  unsigned long __ms ;
...
{ 
  ...
  int res_md_open_191 ;
    klee_make_symbolic(&res_md_open_191, sizeof(int), "res_md_open_191");
  struct gendisk *var_group4 ;
  fmode_t var_md_release_192_p1 ;
  fmode_t var_md_ioctl_189_p1 ;
  unsigned int var_md_ioctl_189_p2 ;
    klee_make_symbolic(&var_md_ioctl_189_p2, sizeof(int), "var_md_ioctl_189_p2");
  unsigned long var_md_ioctl_189_p3 ;
    klee_make_symbolic(&var_md_ioctl_189_p3, sizeof(long), "var_md_ioctl_189_p3");
  fmode_t var_md_compat_ioctl_190_p1 ;
  unsigned int var_md_compat_ioctl_190_p2 ;
    klee_make_symbolic(&var_md_compat_ioctl_190_p2, sizeof(int), "var_md_compat_ioctl_190_p2");
  unsigned long var_md_compat_ioctl_190_p3 ;
    klee_make_symbolic(&var_md_compat_ioctl_190_p3, sizeof(long), "var_md_compat_ioctl_190_p3");
  ...
  int res_md_seq_open_205 ;
    klee_make_symbolic(&res_md_seq_open_205, sizeof(int), "res_md_seq_open_205");
  poll_table *var_mdstat_poll_206_p1 ;
  struct notifier_block *var_group9 ;
  unsigned long var_md_notify_reboot_228_p1 ;
    klee_make_symbolic(&var_md_notify_reboot_228_p1, sizeof(long), "var_md_notify_reboot_228_p1");
  void *var_md_notify_reboot_228_p2 ;
  unsigned long var_md_safemode_timeout_158_p0 ;
    klee_make_symbolic(&var_md_safemode_timeout_158_p0, sizeof(long), "var_md_safemode_timeout_158_p0");
  int ldv_s_rdev_ktype_kobj_type ;
    klee_make_symbolic(&ldv_s_rdev_ktype_kobj_type, sizeof(int), "ldv_s_rdev_ktype_kobj_type");
  int ldv_s_md_ktype_kobj_type ;
    klee_make_symbolic(&ldv_s_md_ktype_kobj_type, sizeof(int), "ldv_s_md_ktype_kobj_type");
  int ldv_s_md_fops_block_device_operations ;
    klee_make_symbolic(&ldv_s_md_fops_block_device_operations, sizeof(int), "ldv_s_md_fops_block_device_operations");
  int ldv_s_md_seq_fops_file_operations ;
    klee_make_symbolic(&ldv_s_md_seq_fops_file_operations, sizeof(int), "ldv_s_md_seq_fops_file_operations");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
...
{ 
  ...
  int tmp___0 ;
  unsigned short __y ;
    klee_make_symbolic(&__y, sizeof(short), "__y");
...
{ 
  ...
  loff_t offset ;
  int last_page_size ;
    klee_make_symbolic(&last_page_size, sizeof(int), "last_page_size");
  unsigned short __y ;
  unsigned short tmp ;
...
{ 
  ...
  unsigned long write_behind ;
    klee_make_symbolic(&write_behind, sizeof(long), "write_behind");
  void *tmp ;
  long tmp___0 ;
  bool tmp___1 ;
  int tmp___2 ;
...
{ 
  ...
  unsigned long sectors_reserved ;
    klee_make_symbolic(&sectors_reserved, sizeof(long), "sectors_reserved");
  int err ;
  struct page *sb_page ;
  loff_t isize ;
  loff_t tmp ;
...
{ 
  int pnum ;
    klee_make_symbolic(&pnum, sizeof(int), "pnum");
...
{ 
  unsigned long bit ;
    klee_make_symbolic(&bit, sizeof(long), "bit");
  struct page *page ;
  void *kaddr ;
  unsigned long chunk ;
  int tmp ;
...
{ 
  unsigned long i ;
  int dirty ;
    klee_make_symbolic(&dirty, sizeof(int), "dirty");
  int need_write ;
    klee_make_symbolic(&need_write, sizeof(int), "need_write");
  int wait ;
...
{ 
  ...
  unsigned long oldindex ;
    klee_make_symbolic(&oldindex, sizeof(long), "oldindex");
  unsigned long bit ;
  struct page *page ;
  unsigned long bit_cnt ;
    klee_make_symbolic(&bit_cnt, sizeof(long), "bit_cnt");
  struct file *file ;
  unsigned long offset ;
  int outofdate ;
    klee_make_symbolic(&outofdate, sizeof(int), "outofdate");
  int ret ;
  void *paddr ;
  struct bitmap_storage *store ;
  int needed ;
    klee_make_symbolic(&needed, sizeof(int), "needed");
  char *tmp ;
  loff_t tmp___0 ;
  char *tmp___1 ;
  loff_t tmp___2 ;
  ...
  int tmp___4 ;
  int needed___0 ;
    klee_make_symbolic(&needed___0, sizeof(int), "needed___0");
  char *tmp___5 ;
  char *tmp___6 ;
...
{ 
  ...
  unsigned long nextpage ;
    klee_make_symbolic(&nextpage, sizeof(long), "nextpage");
  sector_t blocks ;
  struct bitmap_counts *counts ;
  int tmp ;
  bitmap_super_t *sb ;
...
{ 
  ...
  unsigned long pageoff ;
    klee_make_symbolic(&pageoff, sizeof(long), "pageoff");
  sector_t csize ;
  int err ;
  int hi ;
...
{ 
  struct bitmap *bitmap ;
  long sleep ;
    klee_make_symbolic(&sleep, sizeof(long), "sleep");
...
{ 
  unsigned long chunk_kb ;
    klee_make_symbolic(&chunk_kb, sizeof(long), "chunk_kb");
  struct bitmap_counts *counts ;
...
{ 
  ...
  int set ;
    klee_make_symbolic(&set, sizeof(int), "set");
  sector_t end ;
  sector_t start ;
  int i ;
  bitmap_counter_t *bmc ;
...
{ 
  ssize_t len ;
  unsigned long secs ;
    klee_make_symbolic(&secs, sizeof(long), "secs");
  unsigned long jifs ;
    klee_make_symbolic(&jifs, sizeof(long), "jifs");
  int tmp ;
  unsigned int tmp___0 ;
  int tmp___1 ;
  int tmp___2 ;
...
{ 
  unsigned long backlog ;
    klee_make_symbolic(&backlog, sizeof(long), "backlog");
  int rv ;
  int tmp ;
...
{ 
  int rv ;
  unsigned long csize ;
    klee_make_symbolic(&csize, sizeof(long), "csize");
  bool tmp ;
  int tmp___0 ;
...
static int ldv_mutex_disks_mutex  ;
    klee_make_symbolic(&ldv_mutex_disks_mutex, sizeof(int), "ldv_mutex_disks_mutex");
...
static int ldv_mutex_mutex_of_NOT_ARG_SIGN  ;
    klee_make_symbolic(&ldv_mutex_mutex_of_NOT_ARG_SIGN, sizeof(int), "ldv_mutex_mutex_of_NOT_ARG_SIGN");
...
static int ldv_mutex_open_mutex_of_mddev  ;
    klee_make_symbolic(&ldv_mutex_open_mutex_of_mddev, sizeof(int), "ldv_mutex_open_mutex_of_mddev");
int ldv_mutex_lock_interruptible_open_mutex_of_mddev(struct mutex *lock ) 
{ 
  int nondetermined ;
...
static int ldv_mutex_reconfig_mutex_of_mddev  ;
    klee_make_symbolic(&ldv_mutex_reconfig_mutex_of_mddev, sizeof(int), "ldv_mutex_reconfig_mutex_of_mddev");
int ldv_mutex_lock_interruptible_reconfig_mutex_of_mddev(struct mutex *lock ) 
{ 
  int nondetermined ;
