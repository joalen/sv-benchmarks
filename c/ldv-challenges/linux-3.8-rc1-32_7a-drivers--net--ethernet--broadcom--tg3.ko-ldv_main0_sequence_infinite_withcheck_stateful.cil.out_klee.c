...
struct tg3_napi {
   ...
   unsigned int irq_vec ;
    klee_make_symbolic(&irq_vec, sizeof(int), "irq_vec");
};
enum TG3_FLAGS {
...
union __anonunion_ldv_47846_266 {
   unsigned long phy_crc_errors ;
    klee_make_symbolic(&phy_crc_errors, sizeof(long), "phy_crc_errors");
   unsigned long last_event_jiffies ;
    klee_make_symbolic(&last_event_jiffies, sizeof(long), "last_event_jiffies");
};
struct tg3 {
   unsigned int irq_sync ;
    klee_make_symbolic(&irq_sync, sizeof(int), "irq_sync");
   spinlock_t lock ;
   ...
   u8 pci_lat_timer ;
   int pci_fn ;
    klee_make_symbolic(&pci_fn, sizeof(int), "pci_fn");
   int pm_cap ;
    klee_make_symbolic(&pm_cap, sizeof(int), "pm_cap");
   int msi_cap ;
    klee_make_symbolic(&msi_cap, sizeof(int), "msi_cap");
   int pcix_cap ;
    klee_make_symbolic(&pcix_cap, sizeof(int), "pcix_cap");
   int pcie_readrq ;
    klee_make_symbolic(&pcie_readrq, sizeof(int), "pcie_readrq");
   struct mii_bus *mdio_bus ;
   int mdio_irq[32U] ;
   int old_link ;
    klee_make_symbolic(&old_link, sizeof(int), "old_link");
   u8 phy_addr ;
   u8 phy_ape_lock ;
   u32 phy_id ;
   u32 phy_flags ;
   ...
   int nvram_lock_cnt ;
    klee_make_symbolic(&nvram_lock_cnt, sizeof(int), "nvram_lock_cnt");
   u32 nvram_size ;
   u32 nvram_pagesize ;
   u32 nvram_jedecnum ;
   unsigned int irq_max ;
    klee_make_symbolic(&irq_max, sizeof(int), "irq_max");
...
struct tg3_fiber_aneginfo {
   ...
   unsigned long link_time ;
    klee_make_symbolic(&link_time, sizeof(long), "link_time");
   unsigned long cur_time ;
    klee_make_symbolic(&cur_time, sizeof(long), "cur_time");
   u32 ability_match_cfg ;
   int ability_match_count ;
    klee_make_symbolic(&ability_match_count, sizeof(int), "ability_match_count");
   char ability_match ;
    klee_make_symbolic(&ability_match, sizeof(char), "ability_match");
   char idle_match ;
    klee_make_symbolic(&idle_match, sizeof(char), "idle_match");
   char ack_match ;
    klee_make_symbolic(&ack_match, sizeof(char), "ack_match");
   u32 txconfig ;
   u32 rxconfig ;
};
...
{ 
  ...
  unsigned int work_exists ;
    klee_make_symbolic(&work_exists, sizeof(int), "work_exists");
  int tmp ;
  int tmp___0 ;
...
{ 
  ...
  unsigned int delay_cnt ;
    klee_make_symbolic(&delay_cnt, sizeof(int), "delay_cnt");
  long time_remain ;
    klee_make_symbolic(&time_remain, sizeof(long), "time_remain");
  unsigned long tmp ;
  u32 tmp___0 ;
...
{ 
  ...
  int do_phy_reset ;
    klee_make_symbolic(&do_phy_reset, sizeof(int), "do_phy_reset");
  int err ;
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
...
{ 
  int i ;
  int iters ;
    klee_make_symbolic(&iters, sizeof(int), "iters");
  u32 tmp ;
...
{ 
  ...
  int tmp___0 ;
  int lock_err ;
    klee_make_symbolic(&lock_err, sizeof(int), "lock_err");
  int tmp___1 ;
  u32 tmp___2 ;
  u32 *fw_data ;
  __u32 tmp___3 ;
...
{ 
  ...
  unsigned long cpu_base ;
    klee_make_symbolic(&cpu_base, sizeof(long), "cpu_base");
  unsigned long cpu_scratch_base ;
    klee_make_symbolic(&cpu_scratch_base, sizeof(long), "cpu_scratch_base");
  unsigned long cpu_scratch_size ;
    klee_make_symbolic(&cpu_scratch_size, sizeof(long), "cpu_scratch_size");
  int err ;
  int tmp ;
  __u32 tmp___0 ;
  __u32 tmp___1 ;
...
{ 
  ...
  int workaround ;
    klee_make_symbolic(&workaround, sizeof(int), "workaround");
  int port_a ;
    klee_make_symbolic(&port_a, sizeof(int), "port_a");
  u32 tmp ;
  u32 tmp___0 ;
  u32 val ;
  u32 local_adv ;
...
{ 
  ...
  int i ;
  int tx_bug ;
    klee_make_symbolic(&tx_bug, sizeof(int), "tx_bug");
  long tmp___0 ;
...
{ 
  unsigned int skb_size ;
    klee_make_symbolic(&skb_size, sizeof(int), "skb_size");
  int _max1 ;
...
{ 
  ...
  int dest_idx ;
    klee_make_symbolic(&dest_idx, sizeof(int), "dest_idx");
  int _max1 ;
  int _max2 ;
  void *tmp ;
  void *tmp___0 ;
...
{ 
  ...
  int ret ;
  int more_headroom ;
    klee_make_symbolic(&more_headroom, sizeof(int), "more_headroom");
  int tmp ;
  unsigned int tmp___0 ;
  u32 save_entry ;
  bool tmp___1 ;
...
{ 
  ...
  int i ;
  int would_hit_hwbug ;
    klee_make_symbolic(&would_hit_hwbug, sizeof(int), "would_hit_hwbug");
  dma_addr_t mapping ;
  struct tg3_napi *tnapi ;
  struct netdev_queue *txq ;
  unsigned int last ;
  ...
  int tmp___23 ;
  int tsflags ;
    klee_make_symbolic(&tsflags, sizeof(int), "tsflags");
  int tsflags___0 ;
    klee_make_symbolic(&tsflags___0, sizeof(int), "tsflags___0");
  int tmp___24 ;
...
{ 
  ...
  u32 mac_stat ;
  int phy_event ;
    klee_make_symbolic(&phy_event, sizeof(int), "phy_event");
  u32 mac_stat___0 ;
  u32 tmp___5 ;
  int need_setup ;
    klee_make_symbolic(&need_setup, sizeof(int), "need_setup");
  int tmp___6 ;
  int tmp___7 ;
  int tmp___8 ;
  int tmp___9 ;
...
{ 
  ...
  int i ;
  int intr_ok ;
    klee_make_symbolic(&intr_ok, sizeof(int), "intr_ok");
  u32 val ;
  bool tmp ;
  int tmp___0 ;
  u32 tmp___1 ;
...
{ 
  int i ;
  int is_5705 ;
    klee_make_symbolic(&is_5705, sizeof(int), "is_5705");
  int is_5750 ;
    klee_make_symbolic(&is_5750, sizeof(int), "is_5750");
  u32 offset ;
  u32 read_mask ;
  u32 write_mask ;
  u32 val ;
...
{ 
  ...
  dma_addr_t map ;
  int num_pkts ;
    klee_make_symbolic(&num_pkts, sizeof(int), "num_pkts");
  int tx_len ;
    klee_make_symbolic(&tx_len, sizeof(int), "tx_len");
  int rx_len ;
    klee_make_symbolic(&rx_len, sizeof(int), "rx_len");
  int i ;
  int err ;
  struct tg3_rx_buffer_desc *desc ;
  struct tg3_napi *tnapi ;
...
{ 
  ...
  int eeprom_phy_serdes ;
    klee_make_symbolic(&eeprom_phy_serdes, sizeof(int), "eeprom_phy_serdes");
  u32 id1 ;
  u32 id2 ;
  int tmp___0 ;
  int tmp___1 ;
...
{ 
  ...
  unsigned int block_end ;
    klee_make_symbolic(&block_end, sizeof(int), "block_end");
  unsigned int rosize ;
    klee_make_symbolic(&rosize, sizeof(int), "rosize");
  unsigned int len ;
  u32 vpdlen ;
  int j ;
  int i ;
...
{ 
  ...
  int i ;
  int dst_off ;
    klee_make_symbolic(&dst_off, sizeof(int), "dst_off");
  bool newver ;
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
...
{ 
  ...
  int i ;
  int vlen ;
    klee_make_symbolic(&vlen, sizeof(int), "vlen");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
  int tmp___2 ;
...
{ 
  ...
  unsigned int devnr ;
    klee_make_symbolic(&devnr, sizeof(int), "devnr");
...
{ 
  ...
  u32 mac_offset ;
  int addr_ok ;
    klee_make_symbolic(&addr_ok, sizeof(int), "addr_ok");
  int err ;
  bool tmp ;
  int tmp___0 ;
  u32 tmp___1 ;
...
{ 
  int cacheline_size ;
    klee_make_symbolic(&cacheline_size, sizeof(int), "cacheline_size");
  u8 byte ;
  int goal ;
...
{ 
  ...
  int var_tg3_ptp_enable_153_p2 ;
    klee_make_symbolic(&var_tg3_ptp_enable_153_p2, sizeof(int), "var_tg3_ptp_enable_153_p2");
  ...
  int var_tg3_get_sset_count_284_p1 ;
    klee_make_symbolic(&var_tg3_get_sset_count_284_p1, sizeof(int), "var_tg3_get_sset_count_284_p1");
  ...
  int res_tg3_open_261 ;
    klee_make_symbolic(&res_tg3_open_261, sizeof(int), "res_tg3_open_261");
  int res_tg3_close_262 ;
    klee_make_symbolic(&res_tg3_close_262, sizeof(int), "res_tg3_close_262");
  ...
  int var_tg3_ioctl_304_p2 ;
    klee_make_symbolic(&var_tg3_ioctl_304_p2, sizeof(int), "var_tg3_ioctl_304_p2");
  int var_tg3_change_mtu_310_p1 ;
    klee_make_symbolic(&var_tg3_change_mtu_310_p1, sizeof(int), "var_tg3_change_mtu_310_p1");
  ...
  int res_tg3_init_one_356 ;
    klee_make_symbolic(&res_tg3_init_one_356, sizeof(int), "res_tg3_init_one_356");
  int var_tg3_interrupt_189_p0 ;
    klee_make_symbolic(&var_tg3_interrupt_189_p0, sizeof(int), "var_tg3_interrupt_189_p0");
  void *var_tg3_interrupt_189_p1 ;
  int var_tg3_interrupt_tagged_190_p0 ;
    klee_make_symbolic(&var_tg3_interrupt_tagged_190_p0, sizeof(int), "var_tg3_interrupt_tagged_190_p0");
  void *var_tg3_interrupt_tagged_190_p1 ;
  int var_tg3_msi_188_p0 ;
    klee_make_symbolic(&var_tg3_msi_188_p0, sizeof(int), "var_tg3_msi_188_p0");
  void *var_tg3_msi_188_p1 ;
  int var_tg3_msi_1shot_187_p0 ;
    klee_make_symbolic(&var_tg3_msi_1shot_187_p0, sizeof(int), "var_tg3_msi_1shot_187_p0");
  void *var_tg3_msi_1shot_187_p1 ;
  int var_tg3_test_isr_191_p0 ;
    klee_make_symbolic(&var_tg3_test_isr_191_p0, sizeof(int), "var_tg3_test_isr_191_p0");
  void *var_tg3_test_isr_191_p1 ;
  unsigned long var_tg3_timer_246_p0 ;
    klee_make_symbolic(&var_tg3_timer_246_p0, sizeof(long), "var_tg3_timer_246_p0");
  int ldv_s_tg3_netdev_ops_net_device_ops ;
    klee_make_symbolic(&ldv_s_tg3_netdev_ops_net_device_ops, sizeof(int), "ldv_s_tg3_netdev_ops_net_device_ops");
  int ldv_s_tg3_driver_pci_driver ;
    klee_make_symbolic(&ldv_s_tg3_driver_pci_driver, sizeof(int), "ldv_s_tg3_driver_pci_driver");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
