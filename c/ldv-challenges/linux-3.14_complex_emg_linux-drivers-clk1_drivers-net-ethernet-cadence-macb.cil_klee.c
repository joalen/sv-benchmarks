...
struct macb_platform_data {
   u32 phy_mask ;
   int phy_irq_pin ;
    klee_make_symbolic(&phy_irq_pin, sizeof(int), "phy_irq_pin");
   u8 is_rmii ;
   u8 rev_eth_addr ;
};
enum ldv_30749 {
...
struct macb {
   ...
   unsigned int rx_tail ;
    klee_make_symbolic(&rx_tail, sizeof(int), "rx_tail");
   unsigned int rx_prepared_head ;
    klee_make_symbolic(&rx_prepared_head, sizeof(int), "rx_prepared_head");
   ...
   int skb_length ;
    klee_make_symbolic(&skb_length, sizeof(int), "skb_length");
};
...
{ 
  long ferr ;
    klee_make_symbolic(&ferr, sizeof(long), "ferr");
  long rate ;
    klee_make_symbolic(&rate, sizeof(long), "rate");
  long rate_rounded ;
    klee_make_symbolic(&rate_rounded, sizeof(long), "rate_rounded");
  long ret ;
  long __x ;
...
{ 
  ...
  unsigned long flags ;
  int status_change ;
    klee_make_symbolic(&status_change, sizeof(int), "status_change");
...
{ 
  unsigned long halt_time ;
    klee_make_symbolic(&halt_time, sizeof(long), "halt_time");
  unsigned long timeout ;
  u32 status ;
  unsigned int tmp ;
...
{ 
  ...
  unsigned int tail ;
  int first_frag ;
    klee_make_symbolic(&first_frag, sizeof(int), "first_frag");
  struct macb_dma_desc *desc ;
  struct macb_dma_desc *tmp ;
  u32 addr ;
  u32 ctrl ;
...
{ 
  ...
  unsigned long pclk_hz ;
    klee_make_symbolic(&pclk_hz, sizeof(long), "pclk_hz");
  unsigned long tmp ;
...
{ 
  ...
  int hash_index ;
    klee_make_symbolic(&hash_index, sizeof(int), "hash_index");
  int tmp ;
...
int ldv_2_ldv_param_14_2_default  ;
    klee_make_symbolic(&ldv_2_ldv_param_14_2_default, sizeof(int), "ldv_2_ldv_param_14_2_default");
