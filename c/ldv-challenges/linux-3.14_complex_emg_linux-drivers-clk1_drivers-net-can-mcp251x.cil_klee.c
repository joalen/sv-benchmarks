...
struct mcp251x_platform_data {
   unsigned long oscillator_frequency ;
    klee_make_symbolic(&oscillator_frequency, sizeof(long), "oscillator_frequency");
};
...
struct mcp251x_priv {
   ...
   int force_quit ;
    klee_make_symbolic(&force_quit, sizeof(int), "force_quit");
   int after_suspend ;
    klee_make_symbolic(&after_suspend, sizeof(int), "after_suspend");
   int restart_tx ;
...
static int mcp251x_enable_dma  ;
    klee_make_symbolic(&mcp251x_enable_dma, sizeof(int), "mcp251x_enable_dma");
...
{ 
  int st1 ;
    klee_make_symbolic(&st1, sizeof(int), "st1");
  int st2 ;
...
{ 
  ...
  u8 clear_intf ;
  int can_id ;
    klee_make_symbolic(&can_id, sizeof(int), "can_id");
  int data1 ;
