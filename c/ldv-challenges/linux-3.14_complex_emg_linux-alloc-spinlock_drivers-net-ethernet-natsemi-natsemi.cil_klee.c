...
struct netdev_private {
   ...
   u32 intr_status ;
   int hands_off ;
    klee_make_symbolic(&hands_off, sizeof(int), "hands_off");
   int ignore_phy ;
    klee_make_symbolic(&ignore_phy, sizeof(int), "ignore_phy");
   int mii ;
    klee_make_symbolic(&mii, sizeof(int), "mii");
   int phy_addr_external ;
    klee_make_symbolic(&phy_addr_external, sizeof(int), "phy_addr_external");
   ...
   int dspcfg_workaround ;
    klee_make_symbolic(&dspcfg_workaround, sizeof(int), "dspcfg_workaround");
   u16 speed ;
   u8 duplex ;
   u8 autoneg ;
   u16 advertising ;
   unsigned int iosize ;
    klee_make_symbolic(&iosize, sizeof(int), "iosize");
   spinlock_t lock ;
   u32 msg_enable ;
   int eeprom_size ;
};
...
{ 
  ...
  void *tmp ;
  int new_setting ;
    klee_make_symbolic(&new_setting, sizeof(int), "new_setting");
  unsigned long flags ;
  int tmp___0 ;
  int tmp___1 ;
  int tmp___2 ;
...
{ 
  ...
  int find_cnt ;
    klee_make_symbolic(&find_cnt, sizeof(int), "find_cnt");
  resource_size_t iostart ;
  unsigned long iosize ;
  void *ioaddr ;
  int pcibar ;
    klee_make_symbolic(&pcibar, sizeof(int), "pcibar");
  int prev_eedata ;
    klee_make_symbolic(&prev_eedata, sizeof(int), "prev_eedata");
  u32 tmp ;
  u32 newtmp ;
  int eedata ;
    klee_make_symbolic(&eedata, sizeof(int), "eedata");
  int tmp___0 ;
  void *tmp___1 ;
...
{ 
  ...
  int dspcfg ;
    klee_make_symbolic(&dspcfg, sizeof(int), "dspcfg");
...
{ 
  ...
  int i ;
  int did_switch ;
    klee_make_symbolic(&did_switch, sizeof(int), "did_switch");
  int tmp___1 ;
  int tmp___2 ;
  char const   *tmp___3 ;
...
{ 
  ...
  int tmp___2 ;
  int wol_status ;
    klee_make_symbolic(&wol_status, sizeof(int), "wol_status");
  unsigned int tmp___3 ;
