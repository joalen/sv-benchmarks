...
struct xgmac_extra_stats {
   ...
   unsigned long tx_local_fault ;
    klee_make_symbolic(&tx_local_fault, sizeof(long), "tx_local_fault");
   unsigned long tx_remote_fault ;
    klee_make_symbolic(&tx_remote_fault, sizeof(long), "tx_remote_fault");
   unsigned long rx_watchdog ;
    klee_make_symbolic(&rx_watchdog, sizeof(long), "rx_watchdog");
   unsigned long rx_da_filter_fail ;
    klee_make_symbolic(&rx_da_filter_fail, sizeof(long), "rx_da_filter_fail");
   unsigned long rx_payload_error ;
    klee_make_symbolic(&rx_payload_error, sizeof(long), "rx_payload_error");
   unsigned long rx_ip_header_error ;
    klee_make_symbolic(&rx_ip_header_error, sizeof(long), "rx_ip_header_error");
   unsigned long tx_process_stopped ;
    klee_make_symbolic(&tx_process_stopped, sizeof(long), "tx_process_stopped");
   unsigned long rx_buf_unav ;
    klee_make_symbolic(&rx_buf_unav, sizeof(long), "rx_buf_unav");
   unsigned long rx_process_stopped ;
    klee_make_symbolic(&rx_process_stopped, sizeof(long), "rx_process_stopped");
   unsigned long tx_early ;
    klee_make_symbolic(&tx_early, sizeof(long), "tx_early");
   unsigned long fatal_bus_error ;
    klee_make_symbolic(&fatal_bus_error, sizeof(long), "fatal_bus_error");
};
struct xgmac_priv {
   ...
   int tx_irq_cnt ;
    klee_make_symbolic(&tx_irq_cnt, sizeof(int), "tx_irq_cnt");
   void *base ;
   ...
   int max_macs ;
    klee_make_symbolic(&max_macs, sizeof(int), "max_macs");
   struct xgmac_extra_stats xstats ;
   spinlock_t stats_lock ;
   int pmt_irq ;
    klee_make_symbolic(&pmt_irq, sizeof(int), "pmt_irq");
   char rx_pause ;
    klee_make_symbolic(&rx_pause, sizeof(char), "rx_pause");
   char tx_pause ;
    klee_make_symbolic(&tx_pause, sizeof(char), "tx_pause");
   int wolopts ;
...
{ 
  ...
  unsigned int desc_flags ;
    klee_make_symbolic(&desc_flags, sizeof(int), "desc_flags");
  unsigned int len ;
  dma_addr_t paddr ;
  int tmp___1 ;
  skb_frag_t *frag ;
...
{ 
  ...
  struct xgmac_dma_desc *p ;
  int ip_checksum ;
    klee_make_symbolic(&ip_checksum, sizeof(int), "ip_checksum");
  struct sk_buff *skb ;
  int frame_len ;
...
int ldv_2_ldv_param_12_1_default  ;
    klee_make_symbolic(&ldv_2_ldv_param_12_1_default, sizeof(int), "ldv_2_ldv_param_12_1_default");
...
unsigned long long ldv_2_ldv_param_24_1_default  ;
    klee_make_symbolic(&ldv_2_ldv_param_24_1_default, sizeof(long), "ldv_2_ldv_param_24_1_default");
