...
int main();
int __return_104949;
    klee_make_symbolic(&__return_104949, sizeof(int), "__return_104949");
int __return_105089;
    klee_make_symbolic(&__return_105089, sizeof(int), "__return_105089");
int __return_105309;
    klee_make_symbolic(&__return_105309, sizeof(int), "__return_105309");
 int main()
 {
 int main__c1;
