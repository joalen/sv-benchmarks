...
int main();
int __return_28296;
    klee_make_symbolic(&__return_28296, sizeof(int), "__return_28296");
int __return_28441;
    klee_make_symbolic(&__return_28441, sizeof(int), "__return_28441");
int __return_28693;
    klee_make_symbolic(&__return_28693, sizeof(int), "__return_28693");
 int main()
 {
 int main__c1;
