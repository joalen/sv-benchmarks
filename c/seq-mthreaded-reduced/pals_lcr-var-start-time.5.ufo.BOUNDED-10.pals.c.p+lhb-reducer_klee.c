...
int __return_1399;
    klee_make_symbolic(&__return_1399, sizeof(int), "__return_1399");
int __return_1499;
    klee_make_symbolic(&__return_1499, sizeof(int), "__return_1499");
int __tmp_1509_0;
    klee_make_symbolic(&__tmp_1509_0, sizeof(int), "__tmp_1509_0");
int __return_1601;
    klee_make_symbolic(&__return_1601, sizeof(int), "__return_1601");
int __return_1512;
