...
int main();
int __return_999;
    klee_make_symbolic(&__return_999, sizeof(int), "__return_999");
int __return_1104;
    klee_make_symbolic(&__return_1104, sizeof(int), "__return_1104");
int __return_1204;
    klee_make_symbolic(&__return_1204, sizeof(int), "__return_1204");
int __tmp_1214_0;
    klee_make_symbolic(&__tmp_1214_0, sizeof(int), "__tmp_1214_0");
int __return_1306;
    klee_make_symbolic(&__return_1306, sizeof(int), "__return_1306");
int __return_1217;
    klee_make_symbolic(&__return_1217, sizeof(int), "__return_1217");
 int main()
 {
 int main__c1;
