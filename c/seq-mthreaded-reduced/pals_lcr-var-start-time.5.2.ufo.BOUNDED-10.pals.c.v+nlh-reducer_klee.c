...
int __return_33136;
    klee_make_symbolic(&__return_33136, sizeof(int), "__return_33136");
int __tmp_33297_0;
    klee_make_symbolic(&__tmp_33297_0, sizeof(int), "__tmp_33297_0");
int __return_33329;
    klee_make_symbolic(&__return_33329, sizeof(int), "__return_33329");
int __return_33342;
    klee_make_symbolic(&__return_33342, sizeof(int), "__return_33342");
 int main()
 {
 int main__c1;
