...
int __return_1970;
    klee_make_symbolic(&__return_1970, sizeof(int), "__return_1970");
int __return_2086;
    klee_make_symbolic(&__return_2086, sizeof(int), "__return_2086");
int __return_2202;
    klee_make_symbolic(&__return_2202, sizeof(int), "__return_2202");
int __tmp_2212_0;
    klee_make_symbolic(&__tmp_2212_0, sizeof(int), "__tmp_2212_0");
int __return_2320;
    klee_make_symbolic(&__return_2320, sizeof(int), "__return_2320");
int __return_2215;
 ...
 int node6____CPAchecker_TMP_1;
    klee_make_symbolic(&node6____CPAchecker_TMP_1, sizeof(int), "node6____CPAchecker_TMP_1");
 if (send6 != nomsg)
 {
 if (p6_new == nomsg)
 {
