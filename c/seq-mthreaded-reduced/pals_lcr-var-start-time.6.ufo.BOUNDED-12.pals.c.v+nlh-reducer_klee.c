...
int main();
int __return_184970;
    klee_make_symbolic(&__return_184970, sizeof(int), "__return_184970");
int __return_185111;
    klee_make_symbolic(&__return_185111, sizeof(int), "__return_185111");
int __tmp_185300_0;
    klee_make_symbolic(&__tmp_185300_0, sizeof(int), "__tmp_185300_0");
int __return_185334;
    klee_make_symbolic(&__return_185334, sizeof(int), "__return_185334");
int __return_185229;
    klee_make_symbolic(&__return_185229, sizeof(int), "__return_185229");
 int main()
 {
 int main__c1;
