...
int main();
int __return_58418;
    klee_make_symbolic(&__return_58418, sizeof(int), "__return_58418");
int __return_58538;
    klee_make_symbolic(&__return_58538, sizeof(int), "__return_58538");
int __return_58726;
    klee_make_symbolic(&__return_58726, sizeof(int), "__return_58726");
 int main()
 {
 int main__c1;
