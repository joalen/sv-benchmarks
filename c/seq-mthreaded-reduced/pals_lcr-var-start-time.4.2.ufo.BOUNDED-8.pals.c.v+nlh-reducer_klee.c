...
int __return_10547;
    klee_make_symbolic(&__return_10547, sizeof(int), "__return_10547");
int __tmp_10696_0;
    klee_make_symbolic(&__tmp_10696_0, sizeof(int), "__tmp_10696_0");
int __return_10712;
    klee_make_symbolic(&__return_10712, sizeof(int), "__return_10712");
int __return_10726;
    klee_make_symbolic(&__return_10726, sizeof(int), "__return_10726");
 int main()
 {
 int main__c1;
