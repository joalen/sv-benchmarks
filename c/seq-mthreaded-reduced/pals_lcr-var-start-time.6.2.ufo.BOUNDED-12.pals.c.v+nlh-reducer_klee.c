...
int main();
int __return_104960;
    klee_make_symbolic(&__return_104960, sizeof(int), "__return_104960");
int __return_105100;
    klee_make_symbolic(&__return_105100, sizeof(int), "__return_105100");
int __tmp_105291_0;
    klee_make_symbolic(&__tmp_105291_0, sizeof(int), "__tmp_105291_0");
int __return_105325;
    klee_make_symbolic(&__return_105325, sizeof(int), "__return_105325");
int __return_105220;
    klee_make_symbolic(&__return_105220, sizeof(int), "__return_105220");
 int main()
 {
 int main__c1;
