...
static int res_tps6105x_probe_4  ;
    klee_make_symbolic(&res_tps6105x_probe_4, sizeof(int), "res_tps6105x_probe_4");
void main(void) 
{ struct i2c_client *var_group1 ;
  struct i2c_device_id  const  *var_tps6105x_probe_4_p1 ;
  int tmp___7 ;
  int ldv_s_tps6105x_driver_i2c_driver ;
    klee_make_symbolic(&ldv_s_tps6105x_driver_i2c_driver, sizeof(int), "ldv_s_tps6105x_driver_i2c_driver");
  int tmp___8 ;
  int tmp___9 ;
  int __cil_tmp7 ;
