...
static int res_waltop_probe_0  ;
    klee_make_symbolic(&res_waltop_probe_0, sizeof(int), "res_waltop_probe_0");
void main(void) 
{ struct hid_device *var_group1 ;
  ...
  int var_waltop_raw_event_2_p3 ;
    klee_make_symbolic(&var_waltop_raw_event_2_p3, sizeof(int), "var_waltop_raw_event_2_p3");
  int tmp ;
  int ldv_s_waltop_driver_hid_driver ;
    klee_make_symbolic(&ldv_s_waltop_driver_hid_driver, sizeof(int), "ldv_s_waltop_driver_hid_driver");
  int tmp___0 ;
  int tmp___1 ;
  int __cil_tmp12 ;
