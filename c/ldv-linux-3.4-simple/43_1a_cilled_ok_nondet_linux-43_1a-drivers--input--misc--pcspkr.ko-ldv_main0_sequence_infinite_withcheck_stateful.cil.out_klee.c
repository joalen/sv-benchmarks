...
{ struct device *var_group1 ;
  ...
  int res_pcspkr_probe_1 ;
    klee_make_symbolic(&res_pcspkr_probe_1, sizeof(int), "res_pcspkr_probe_1");
  int ldv_s_pcspkr_platform_driver_platform_driver ;
    klee_make_symbolic(&ldv_s_pcspkr_platform_driver_platform_driver, sizeof(int), "ldv_s_pcspkr_platform_driver_platform_driver");
  int tmp ;
  int tmp___0 ;
