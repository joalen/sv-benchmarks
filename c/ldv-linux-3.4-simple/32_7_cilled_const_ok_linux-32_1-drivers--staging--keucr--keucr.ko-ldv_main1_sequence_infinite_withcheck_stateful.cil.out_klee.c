...
struct us_data {
   ...
   DWORD bl_num ;
   int SrbStatus ;
    klee_make_symbolic(&SrbStatus, sizeof(int), "SrbStatus");
...
{ struct us_data *us ;
  long __retval ;
    klee_make_symbolic(&__retval, sizeof(long), "__retval");
  long __ret ;
...
static int res_eucr_probe_18  ;
    klee_make_symbolic(&res_eucr_probe_18, sizeof(int), "res_eucr_probe_18");
...
{ struct usb_interface *var_group1 ;
  ...
  int var_eucr_suspend_0_p1_event8 ;
    klee_make_symbolic(&var_eucr_suspend_0_p1_event8, sizeof(int), "var_eucr_suspend_0_p1_event8");
...
{ struct Scsi_Host *var_group1 ;
  ...
  int var_proc_info_8_p4 ;
    klee_make_symbolic(&var_proc_info_8_p4, sizeof(int), "var_proc_info_8_p4");
  int var_proc_info_8_p5 ;
    klee_make_symbolic(&var_proc_info_8_p5, sizeof(int), "var_proc_info_8_p5");
...
{ BYTE cis[10] ;
  int cis_len ;
    klee_make_symbolic(&cis_len, sizeof(int), "cis_len");
  int tmp___7 ;
  int tmp___8 ;
  int tmp___9 ;
  int tmp___10 ;
