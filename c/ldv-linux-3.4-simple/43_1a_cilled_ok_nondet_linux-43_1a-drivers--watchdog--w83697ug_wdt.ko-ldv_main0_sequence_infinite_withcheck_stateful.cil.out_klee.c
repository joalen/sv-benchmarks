...
{ struct file *var_group1 ;
  ...
  unsigned int var_wdt_ioctl_8_p1 ;
    klee_make_symbolic(&var_wdt_ioctl_8_p1, sizeof(int), "var_wdt_ioctl_8_p1");
  unsigned long var_wdt_ioctl_8_p2 ;
    klee_make_symbolic(&var_wdt_ioctl_8_p2, sizeof(long), "var_wdt_ioctl_8_p2");
  struct inode *var_group2 ;
  int res_wdt_open_9 ;
    klee_make_symbolic(&res_wdt_open_9, sizeof(int), "res_wdt_open_9");
  struct notifier_block *var_group3 ;
  unsigned long var_wdt_notify_sys_11_p1 ;
    klee_make_symbolic(&var_wdt_notify_sys_11_p1, sizeof(long), "var_wdt_notify_sys_11_p1");
