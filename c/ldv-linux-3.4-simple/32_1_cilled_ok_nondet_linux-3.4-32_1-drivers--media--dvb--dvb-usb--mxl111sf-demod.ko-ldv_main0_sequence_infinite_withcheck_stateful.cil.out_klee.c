...
static int mxl111sf_demod_debug  ;
    klee_make_symbolic(&mxl111sf_demod_debug, sizeof(int), "mxl111sf_demod_debug");
...
{ struct mxl111sf_demod_state *state ;
  ...
  int cr_lock ;
    klee_make_symbolic(&cr_lock, sizeof(int), "cr_lock");
  int sync_lock ;
    klee_make_symbolic(&sync_lock, sizeof(int), "sync_lock");
  int fec_lock ;
    klee_make_symbolic(&fec_lock, sizeof(int), "fec_lock");
  int __ret ;
  int __ret___0 ;
  int __ret___1 ;
  int __ret___2 ;
...
{ struct dvb_frontend *var_group1 ;
  ...
  int ldv_s_mxl111sf_demod_ops_dvb_frontend_ops ;
    klee_make_symbolic(&ldv_s_mxl111sf_demod_ops_dvb_frontend_ops, sizeof(int), "ldv_s_mxl111sf_demod_ops_dvb_frontend_ops");
  int tmp___7 ;
  int tmp___8 ;
  int __cil_tmp11 ;
