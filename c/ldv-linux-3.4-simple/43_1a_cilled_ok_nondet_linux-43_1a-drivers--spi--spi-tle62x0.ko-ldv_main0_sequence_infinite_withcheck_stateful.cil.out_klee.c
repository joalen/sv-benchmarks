...
struct tle62x0_pdata {
   unsigned int init_state ;
    klee_make_symbolic(&init_state, sizeof(int), "init_state");
   unsigned int gpio_count ;
    klee_make_symbolic(&gpio_count, sizeof(int), "gpio_count");
};
struct tle62x0_state {
   struct spi_device *us ;
   struct mutex lock ;
   unsigned int nr_gpio ;
    klee_make_symbolic(&nr_gpio, sizeof(int), "nr_gpio");
   unsigned int gpio_state ;
    klee_make_symbolic(&gpio_state, sizeof(int), "gpio_state");
...
{ struct tle62x0_state *st ;
  ...
  unsigned char *buff ;
  unsigned long fault ;
    klee_make_symbolic(&fault, sizeof(long), "fault");
  int ptr ;
...
{ struct tle62x0_state *st ;
  void *tmp ;
  int gpio_num ;
    klee_make_symbolic(&gpio_num, sizeof(int), "gpio_num");
  int tmp___0 ;
  int value ;
  int tmp___1 ;
...
{ struct spi_device *var_group1 ;
  int res_tle62x0_probe_7 ;
    klee_make_symbolic(&res_tle62x0_probe_7, sizeof(int), "res_tle62x0_probe_7");
  int ldv_s_tle62x0_driver_spi_driver ;
    klee_make_symbolic(&ldv_s_tle62x0_driver_spi_driver, sizeof(int), "ldv_s_tle62x0_driver_spi_driver");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
