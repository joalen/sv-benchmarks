...
{ struct file *var_group1 ;
  ...
  int res_fop_open_6 ;
    klee_make_symbolic(&res_fop_open_6, sizeof(int), "res_fop_open_6");
  unsigned int var_fop_ioctl_8_p1 ;
    klee_make_symbolic(&var_fop_ioctl_8_p1, sizeof(int), "var_fop_ioctl_8_p1");
  unsigned long var_fop_ioctl_8_p2 ;
    klee_make_symbolic(&var_fop_ioctl_8_p2, sizeof(long), "var_fop_ioctl_8_p2");
  struct notifier_block *var_group3 ;
  unsigned long var_wdt_notify_sys_9_p1 ;
    klee_make_symbolic(&var_wdt_notify_sys_9_p1, sizeof(long), "var_wdt_notify_sys_9_p1");
