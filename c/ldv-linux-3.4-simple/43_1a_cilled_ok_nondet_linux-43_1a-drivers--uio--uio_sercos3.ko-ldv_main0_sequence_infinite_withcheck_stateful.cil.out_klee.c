...
struct uio_port {
   ...
   unsigned long size ;
   int porttype ;
    klee_make_symbolic(&porttype, sizeof(int), "porttype");
...
{ struct pci_dev *var_group1 ;
  ...
  int res_sercos3_pci_probe_5 ;
    klee_make_symbolic(&res_sercos3_pci_probe_5, sizeof(int), "res_sercos3_pci_probe_5");
  int ldv_s_sercos3_pci_driver_pci_driver ;
    klee_make_symbolic(&ldv_s_sercos3_pci_driver_pci_driver, sizeof(int), "ldv_s_sercos3_pci_driver_pci_driver");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
