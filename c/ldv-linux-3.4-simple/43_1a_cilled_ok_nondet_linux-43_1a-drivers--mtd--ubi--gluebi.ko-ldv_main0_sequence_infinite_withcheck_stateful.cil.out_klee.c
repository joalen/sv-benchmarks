...
{ struct gluebi_device *gluebi ;
  int ubi_mode ;
    klee_make_symbolic(&ubi_mode, sizeof(int), "ubi_mode");
  bool tmp ;
  int tmp___0 ;
...
{ int err ;
  ...
  int total_read ;
    klee_make_symbolic(&total_read, sizeof(int), "total_read");
  struct gluebi_device *gluebi ;
  struct mtd_info  const  *__mptr ;
  u64 tmp ;
  size_t to_read ;
...
{ int err ;
  ...
  int offs ;
  int total_written ;
    klee_make_symbolic(&total_written, sizeof(int), "total_written");
  struct gluebi_device *gluebi ;
  struct mtd_info  const  *__mptr ;
  u64 tmp ;
  size_t to_write ;
...
{ struct notifier_block *var_group1 ;
  unsigned long var_gluebi_notify_10_p1 ;
    klee_make_symbolic(&var_gluebi_notify_10_p1, sizeof(long), "var_gluebi_notify_10_p1");
