...
{ struct input_dev *input_dev ;
  unsigned int num_fingers ;
    klee_make_symbolic(&num_fingers, sizeof(int), "num_fingers");
  unsigned int tool_width ;
    klee_make_symbolic(&tool_width, sizeof(int), "tool_width");
  unsigned int x ;
  unsigned int y ;
  unsigned int pressure ;
  unsigned int w ;
...
{ struct synusb *synusb ;
  void *tmp___7 ;
  int autopm_error ;
    klee_make_symbolic(&autopm_error, sizeof(int), "autopm_error");
  unsigned long __cil_tmp5 ;
  unsigned long __cil_tmp6 ;
  struct usb_interface *__cil_tmp7 ;
  unsigned long __cil_tmp8 ;
...
{ struct usb_device *udev ;
  ...
  unsigned int intf_num ;
    klee_make_symbolic(&intf_num, sizeof(int), "intf_num");
...
static int res_synusb_probe_7  ;
    klee_make_symbolic(&res_synusb_probe_7, sizeof(int), "res_synusb_probe_7");
void main(void) 
{ struct usb_interface *var_group1 ;
  ...
  int ldv_s_synusb_driver_usb_driver ;
    klee_make_symbolic(&ldv_s_synusb_driver_usb_driver, sizeof(int), "ldv_s_synusb_driver_usb_driver");
  int tmp___7 ;
  int tmp___8 ;
  int __cil_tmp7 ;
  int var_synusb_suspend_9_p1_event8 ;
    klee_make_symbolic(&var_synusb_suspend_9_p1_event8, sizeof(int), "var_synusb_suspend_9_p1_event8");
