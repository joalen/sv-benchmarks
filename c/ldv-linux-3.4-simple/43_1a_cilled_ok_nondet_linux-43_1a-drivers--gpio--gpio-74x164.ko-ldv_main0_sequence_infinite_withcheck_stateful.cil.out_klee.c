...
{ struct spi_device *var_group1 ;
  int res_gen_74x164_probe_5 ;
    klee_make_symbolic(&res_gen_74x164_probe_5, sizeof(int), "res_gen_74x164_probe_5");
  int ldv_s_gen_74x164_driver_spi_driver ;
    klee_make_symbolic(&ldv_s_gen_74x164_driver_spi_driver, sizeof(int), "ldv_s_gen_74x164_driver_spi_driver");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
