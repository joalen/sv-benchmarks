...
struct eeti_ts_platform_data {
   unsigned int irq_active_high ;
    klee_make_symbolic(&irq_active_high, sizeof(int), "irq_active_high");
};
...
{ char buf[6] ;
  ...
  unsigned int pressed ;
    klee_make_symbolic(&pressed, sizeof(int), "pressed");
  unsigned int to ;
...
{ struct eeti_ts_platform_data *pdata ;
  ...
  long __constr_expr_0_counter101 ;
    klee_make_symbolic(&__constr_expr_0_counter101, sizeof(long), "__constr_expr_0_counter101");
...
static int res_eeti_ts_probe_7  ;
    klee_make_symbolic(&res_eeti_ts_probe_7, sizeof(int), "res_eeti_ts_probe_7");
void main(void) 
{ struct i2c_client *var_group1 ;
  struct i2c_device_id  const  *var_eeti_ts_probe_7_p1 ;
  int var_eeti_ts_isr_2_p0 ;
    klee_make_symbolic(&var_eeti_ts_isr_2_p0, sizeof(int), "var_eeti_ts_isr_2_p0");
  void *var_eeti_ts_isr_2_p1 ;
  int ldv_s_eeti_ts_driver_i2c_driver ;
    klee_make_symbolic(&ldv_s_eeti_ts_driver_i2c_driver, sizeof(int), "ldv_s_eeti_ts_driver_i2c_driver");
  int tmp___7 ;
  int tmp___8 ;
  int __cil_tmp8 ;
