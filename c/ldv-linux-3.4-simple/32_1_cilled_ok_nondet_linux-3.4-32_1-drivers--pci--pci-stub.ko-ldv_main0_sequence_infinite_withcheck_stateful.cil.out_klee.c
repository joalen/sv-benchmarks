...
{ char *p ;
  ...
  unsigned int class_mask ;
    klee_make_symbolic(&class_mask, sizeof(int), "class_mask");
  int fields ;
...
static int res_pci_stub_probe_0  ;
    klee_make_symbolic(&res_pci_stub_probe_0, sizeof(int), "res_pci_stub_probe_0");
void main(void) 
{ struct pci_dev *var_group1 ;
  struct pci_device_id  const  *var_pci_stub_probe_0_p1 ;
  int tmp ;
  int ldv_s_stub_driver_pci_driver ;
    klee_make_symbolic(&ldv_s_stub_driver_pci_driver, sizeof(int), "ldv_s_stub_driver_pci_driver");
  int tmp___0 ;
  int tmp___1 ;
  int __cil_tmp7 ;
