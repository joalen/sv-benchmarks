...
static int res_ltv350qv_probe_6  ;
    klee_make_symbolic(&res_ltv350qv_probe_6, sizeof(int), "res_ltv350qv_probe_6");
void main(void) 
{ struct lcd_device *var_group1 ;
  int var_ltv350qv_set_power_4_p1 ;
    klee_make_symbolic(&var_ltv350qv_set_power_4_p1, sizeof(int), "var_ltv350qv_set_power_4_p1");
  struct spi_device *var_group2 ;
  pm_message_t var_ltv350qv_suspend_8_p1 ;
  int ldv_s_ltv350qv_driver_spi_driver ;
    klee_make_symbolic(&ldv_s_ltv350qv_driver_spi_driver, sizeof(int), "ldv_s_ltv350qv_driver_spi_driver");
  int tmp___7 ;
  int tmp___8 ;
  int __cil_tmp8 ;
  int var_ltv350qv_suspend_8_p1_event9 ;
    klee_make_symbolic(&var_ltv350qv_suspend_8_p1_event9, sizeof(int), "var_ltv350qv_suspend_8_p1_event9");
