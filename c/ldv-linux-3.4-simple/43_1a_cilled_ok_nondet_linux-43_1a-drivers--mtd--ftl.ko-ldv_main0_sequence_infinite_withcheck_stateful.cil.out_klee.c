...
struct erase_info {
   ...
   u_char state ;
    klee_make_symbolic(&state, sizeof(char), "state");
...
{ erase_unit_header_t header ;
  ...
  int hdr_ok ;
    klee_make_symbolic(&hdr_ok, sizeof(int), "hdr_ok");
  int ret ;
...
{ erase_unit_header_t header ;
  struct xfer_info_t *xfer ;
  int nbam ;
    klee_make_symbolic(&nbam, sizeof(int), "nbam");
  int ret ;
  uint32_t ctl ;
  ssize_t retlen ;
  loff_t offset ;
...
{ uint16_t i ;
  ...
  uint32_t best ;
  int queued ;
    klee_make_symbolic(&queued, sizeof(int), "queued");
  int ret ;
  struct _ddebug descriptor ;
  long tmp ;
  ...
  int ne___0 ;
    klee_make_symbolic(&ne___0, sizeof(int), "ne___0");
...
{ partition_t *part ;
  u_long sect ;
    klee_make_symbolic(&sect, sizeof(long), "sect");
  unsigned long __cil_tmp5 ;
  unsigned long __cil_tmp6 ;
  unsigned long __cil_tmp7 ;
  uint32_t __cil_tmp8 ;
...
{ struct mtd_blktrans_dev *var_group1 ;
  unsigned long var_ftl_readsect_13_p1 ;
    klee_make_symbolic(&var_ftl_readsect_13_p1, sizeof(long), "var_ftl_readsect_13_p1");
  char *var_ftl_readsect_13_p2 ;
  unsigned long var_ftl_writesect_14_p1 ;
    klee_make_symbolic(&var_ftl_writesect_14_p1, sizeof(long), "var_ftl_writesect_14_p1");
  char *var_ftl_writesect_14_p2 ;
  unsigned long var_ftl_discardsect_15_p1 ;
    klee_make_symbolic(&var_ftl_discardsect_15_p1, sizeof(long), "var_ftl_discardsect_15_p1");
  unsigned int var_ftl_discardsect_15_p2 ;
    klee_make_symbolic(&var_ftl_discardsect_15_p2, sizeof(int), "var_ftl_discardsect_15_p2");
