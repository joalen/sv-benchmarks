...
struct qlogicfas408_priv {
   int qbase ;
    klee_make_symbolic(&qbase, sizeof(int), "qbase");
   int qinitid ;
    klee_make_symbolic(&qinitid, sizeof(int), "qinitid");
   int qabort ;
    klee_make_symbolic(&qabort, sizeof(int), "qabort");
   int qlirq ;
    klee_make_symbolic(&qlirq, sizeof(int), "qlirq");
   int int_type ;
    klee_make_symbolic(&int_type, sizeof(int), "int_type");
   char qinfo[80U] ;
...
{ unsigned int i ;
  ...
  unsigned int message ;
    klee_make_symbolic(&message, sizeof(int), "message");
  unsigned int phase ;
    klee_make_symbolic(&phase, sizeof(int), "phase");
  unsigned int reqlen ;
    klee_make_symbolic(&reqlen, sizeof(int), "reqlen");
  char *buf ;
  struct qlogicfas408_priv *priv ;
  int qbase ;
  int int_type ;
...
{ int var_qlogicfas408_ihandl_6_p0 ;
    klee_make_symbolic(&var_qlogicfas408_ihandl_6_p0, sizeof(int), "var_qlogicfas408_ihandl_6_p0");
