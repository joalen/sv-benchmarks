...
{ struct hid_device *var_group1 ;
  ...
  int var_zc_raw_event_2_p3 ;
    klee_make_symbolic(&var_zc_raw_event_2_p3, sizeof(int), "var_zc_raw_event_2_p3");
  struct hid_device_id  const  *var_zc_probe_3_p1 ;
  int res_zc_probe_3 ;
    klee_make_symbolic(&res_zc_probe_3, sizeof(int), "res_zc_probe_3");
  int ldv_s_zc_driver_hid_driver ;
    klee_make_symbolic(&ldv_s_zc_driver_hid_driver, sizeof(int), "ldv_s_zc_driver_hid_driver");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
