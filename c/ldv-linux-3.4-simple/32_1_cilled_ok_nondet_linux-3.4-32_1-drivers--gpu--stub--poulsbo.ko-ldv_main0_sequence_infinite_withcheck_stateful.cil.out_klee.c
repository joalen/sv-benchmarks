...
static int res_poulsbo_probe_0  ;
    klee_make_symbolic(&res_poulsbo_probe_0, sizeof(int), "res_poulsbo_probe_0");
void main(void) 
{ struct pci_dev *var_group1 ;
  struct pci_device_id  const  *var_poulsbo_probe_0_p1 ;
  int tmp___7 ;
  int ldv_s_poulsbo_driver_pci_driver ;
    klee_make_symbolic(&ldv_s_poulsbo_driver_pci_driver, sizeof(int), "ldv_s_poulsbo_driver_pci_driver");
  int tmp___8 ;
  int tmp___9 ;
  int __cil_tmp7 ;
