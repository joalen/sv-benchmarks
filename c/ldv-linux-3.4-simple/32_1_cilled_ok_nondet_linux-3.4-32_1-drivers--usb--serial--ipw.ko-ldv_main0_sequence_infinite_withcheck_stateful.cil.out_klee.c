...
struct usb_wwan_intf_private {
   ...
   int in_flight ;
    klee_make_symbolic(&in_flight, sizeof(int), "in_flight");
...
static int res_ipw_open_0  ;
    klee_make_symbolic(&res_ipw_open_0, sizeof(int), "res_ipw_open_0");
static int res_ipw_probe_1  ;
    klee_make_symbolic(&res_ipw_probe_1, sizeof(int), "res_ipw_probe_1");
void main(void) 
{ struct tty_struct *var_group1 ;
  ...
  int var_ipw_dtr_rts_3_p1 ;
    klee_make_symbolic(&var_ipw_dtr_rts_3_p1, sizeof(int), "var_ipw_dtr_rts_3_p1");
  int ldv_s_ipw_device_usb_serial_driver ;
    klee_make_symbolic(&ldv_s_ipw_device_usb_serial_driver, sizeof(int), "ldv_s_ipw_device_usb_serial_driver");
  int tmp___7 ;
  int tmp___8 ;
  int __cil_tmp9 ;
