...
struct regulator_desc {
   ...
   unsigned int n_voltages ;
    klee_make_symbolic(&n_voltages, sizeof(int), "n_voltages");
...
struct regulator_dev {
   ...
   int deferred_disables ;
    klee_make_symbolic(&deferred_disables, sizeof(int), "deferred_disables");
   void *reg_data ;
...
typedef int suspend_state_t;
    klee_make_symbolic(&suspend_state_t, sizeof(int), "suspend_state_t");
struct regulator_state {
   int uV ;
    klee_make_symbolic(&uV, sizeof(int), "uV");
   unsigned int mode ;
   int enabled ;
...
struct regulation_constraints {
   char const   *name ;
   int min_uV ;
    klee_make_symbolic(&min_uV, sizeof(int), "min_uV");
   int max_uV ;
    klee_make_symbolic(&max_uV, sizeof(int), "max_uV");
   int uV_offset ;
    klee_make_symbolic(&uV_offset, sizeof(int), "uV_offset");
   int min_uA ;
    klee_make_symbolic(&min_uA, sizeof(int), "min_uA");
   int max_uA ;
    klee_make_symbolic(&max_uA, sizeof(int), "max_uA");
   unsigned int valid_modes_mask ;
    klee_make_symbolic(&valid_modes_mask, sizeof(int), "valid_modes_mask");
   unsigned int valid_ops_mask ;
    klee_make_symbolic(&valid_ops_mask, sizeof(int), "valid_ops_mask");
   int input_uV ;
    klee_make_symbolic(&input_uV, sizeof(int), "input_uV");
   struct regulator_state state_disk ;
   struct regulator_state state_mem ;
   struct regulator_state state_standby ;
   suspend_state_t initial_state ;
   unsigned int initial_mode ;
    klee_make_symbolic(&initial_mode, sizeof(int), "initial_mode");
...
struct regulator_init_data {
   ...
   int num_consumer_supplies ;
    klee_make_symbolic(&num_consumer_supplies, sizeof(int), "num_consumer_supplies");
...
struct wm831x {
   ...
   int num_gpio ;
    klee_make_symbolic(&num_gpio, sizeof(int), "num_gpio");
   int gpio_update[16U] ;
   bool gpio_level[16U] ;
...
struct wm831x_backlight_pdata {
   int isink ;
    klee_make_symbolic(&isink, sizeof(int), "isink");
   int max_uA ;
};
struct wm831x_backup_pdata {
   int charger_enable ;
    klee_make_symbolic(&charger_enable, sizeof(int), "charger_enable");
   int no_constant_voltage ;
    klee_make_symbolic(&no_constant_voltage, sizeof(int), "no_constant_voltage");
   int vlim ;
    klee_make_symbolic(&vlim, sizeof(int), "vlim");
   int ilim ;
    klee_make_symbolic(&ilim, sizeof(int), "ilim");
};
struct wm831x_battery_pdata {
   int enable ;
    klee_make_symbolic(&enable, sizeof(int), "enable");
   int fast_enable ;
    klee_make_symbolic(&fast_enable, sizeof(int), "fast_enable");
   int off_mask ;
    klee_make_symbolic(&off_mask, sizeof(int), "off_mask");
   int trickle_ilim ;
    klee_make_symbolic(&trickle_ilim, sizeof(int), "trickle_ilim");
   int vsel ;
    klee_make_symbolic(&vsel, sizeof(int), "vsel");
   int eoc_iterm ;
    klee_make_symbolic(&eoc_iterm, sizeof(int), "eoc_iterm");
   int fast_ilim ;
    klee_make_symbolic(&fast_ilim, sizeof(int), "fast_ilim");
   int timeout ;
};
struct wm831x_buckv_pdata {
   int dvs_gpio ;
    klee_make_symbolic(&dvs_gpio, sizeof(int), "dvs_gpio");
   int dvs_control_src ;
    klee_make_symbolic(&dvs_control_src, sizeof(int), "dvs_control_src");
   int dvs_init_state ;
    klee_make_symbolic(&dvs_init_state, sizeof(int), "dvs_init_state");
   int dvs_state_gpio ;
    klee_make_symbolic(&dvs_state_gpio, sizeof(int), "dvs_state_gpio");
};
...
struct wm831x_touch_pdata {
   int fivewire ;
    klee_make_symbolic(&fivewire, sizeof(int), "fivewire");
   int isel ;
    klee_make_symbolic(&isel, sizeof(int), "isel");
   int rpu ;
    klee_make_symbolic(&rpu, sizeof(int), "rpu");
   int pressure ;
    klee_make_symbolic(&pressure, sizeof(int), "pressure");
   unsigned int data_irq ;
    klee_make_symbolic(&data_irq, sizeof(int), "data_irq");
   int data_irqf ;
    klee_make_symbolic(&data_irqf, sizeof(int), "data_irqf");
   unsigned int pd_irq ;
    klee_make_symbolic(&pd_irq, sizeof(int), "pd_irq");
   int pd_irqf ;
    klee_make_symbolic(&pd_irqf, sizeof(int), "pd_irqf");
};
...
struct wm831x_watchdog_pdata {
   ...
   int update_gpio ;
    klee_make_symbolic(&update_gpio, sizeof(int), "update_gpio");
   unsigned char software : 1 ;
};
struct wm831x_pdata {
   int wm831x_num ;
    klee_make_symbolic(&wm831x_num, sizeof(int), "wm831x_num");
   ...
   int irq_base ;
   int gpio_base ;
    klee_make_symbolic(&gpio_base, sizeof(int), "gpio_base");
...
struct wm831x_dcdc {
   ...
   int dvs_gpio ;
   int dvs_gpio_state ;
    klee_make_symbolic(&dvs_gpio_state, sizeof(int), "dvs_gpio_state");
   int on_vsel ;
    klee_make_symbolic(&on_vsel, sizeof(int), "on_vsel");
   int dvs_vsel ;
    klee_make_symbolic(&dvs_vsel, sizeof(int), "dvs_vsel");
};
...
{ struct wm831x_dcdc *dcdc ;
  ...
  unsigned short __cil_tmp12 ;
    klee_make_symbolic(&__cil_tmp12, sizeof(short), "__cil_tmp12");
  unsigned short __cil_tmp13 ;
    klee_make_symbolic(&__cil_tmp13, sizeof(short), "__cil_tmp13");
  int __cil_tmp14 ;
    klee_make_symbolic(&__cil_tmp14, sizeof(int), "__cil_tmp14");
  unsigned short __cil_tmp15 ;
    klee_make_symbolic(&__cil_tmp15, sizeof(short), "__cil_tmp15");
...
{ struct wm831x_dcdc *dcdc ;
  ...
  unsigned short __cil_tmp16 ;
    klee_make_symbolic(&__cil_tmp16, sizeof(short), "__cil_tmp16");
  int __cil_tmp17 ;
...
{ struct wm831x_dcdc *dcdc ;
  ...
  struct wm831x *wm831x ;
  int on_reg ;
    klee_make_symbolic(&on_reg, sizeof(int), "on_reg");
  int dvs_reg ;
    klee_make_symbolic(&dvs_reg, sizeof(int), "dvs_reg");
  int vsel ;
  int ret ;
  int tmp___0 ;
  int tmp___1 ;
...
{ struct wm831x *wm831x ;
  ...
  unsigned short __cil_tmp78 ;
    klee_make_symbolic(&__cil_tmp78, sizeof(short), "__cil_tmp78");
  ...
  unsigned short __cil_tmp84 ;
    klee_make_symbolic(&__cil_tmp84, sizeof(short), "__cil_tmp84");
...
{ struct wm831x *wm831x ;
  ...
  unsigned short __cil_tmp107 ;
    klee_make_symbolic(&__cil_tmp107, sizeof(short), "__cil_tmp107");
  ...
  unsigned short __cil_tmp111 ;
    klee_make_symbolic(&__cil_tmp111, sizeof(short), "__cil_tmp111");
  ...
  unsigned short __cil_tmp125 ;
    klee_make_symbolic(&__cil_tmp125, sizeof(short), "__cil_tmp125");
...
{ struct regulator_dev *var_group1 ;
  int var_wm831x_buckv_set_voltage_13_p1 ;
    klee_make_symbolic(&var_wm831x_buckv_set_voltage_13_p1, sizeof(int), "var_wm831x_buckv_set_voltage_13_p1");
  int var_wm831x_buckv_set_voltage_13_p2 ;
    klee_make_symbolic(&var_wm831x_buckv_set_voltage_13_p2, sizeof(int), "var_wm831x_buckv_set_voltage_13_p2");
  unsigned int *var_wm831x_buckv_set_voltage_13_p3 ;
  unsigned int var_wm831x_buckv_list_voltage_10_p1 ;
    klee_make_symbolic(&var_wm831x_buckv_list_voltage_10_p1, sizeof(int), "var_wm831x_buckv_list_voltage_10_p1");
  int var_wm831x_buckv_set_suspend_voltage_14_p1 ;
    klee_make_symbolic(&var_wm831x_buckv_set_suspend_voltage_14_p1, sizeof(int), "var_wm831x_buckv_set_suspend_voltage_14_p1");
  int var_wm831x_buckv_set_current_limit_16_p1 ;
    klee_make_symbolic(&var_wm831x_buckv_set_current_limit_16_p1, sizeof(int), "var_wm831x_buckv_set_current_limit_16_p1");
  int var_wm831x_buckv_set_current_limit_16_p2 ;
    klee_make_symbolic(&var_wm831x_buckv_set_current_limit_16_p2, sizeof(int), "var_wm831x_buckv_set_current_limit_16_p2");
  unsigned int var_wm831x_dcdc_set_mode_5_p1 ;
    klee_make_symbolic(&var_wm831x_dcdc_set_mode_5_p1, sizeof(int), "var_wm831x_dcdc_set_mode_5_p1");
  unsigned int var_wm831x_dcdc_set_suspend_mode_6_p1 ;
    klee_make_symbolic(&var_wm831x_dcdc_set_suspend_mode_6_p1, sizeof(int), "var_wm831x_dcdc_set_suspend_mode_6_p1");
  struct platform_device *var_group2 ;
  int res_wm831x_buckv_probe_19 ;
    klee_make_symbolic(&res_wm831x_buckv_probe_19, sizeof(int), "res_wm831x_buckv_probe_19");
  int var_wm831x_buckp_set_voltage_23_p1 ;
    klee_make_symbolic(&var_wm831x_buckp_set_voltage_23_p1, sizeof(int), "var_wm831x_buckp_set_voltage_23_p1");
  int var_wm831x_buckp_set_voltage_23_p2 ;
    klee_make_symbolic(&var_wm831x_buckp_set_voltage_23_p2, sizeof(int), "var_wm831x_buckp_set_voltage_23_p2");
  unsigned int *var_wm831x_buckp_set_voltage_23_p3 ;
  unsigned int var_wm831x_buckp_list_voltage_21_p1 ;
    klee_make_symbolic(&var_wm831x_buckp_list_voltage_21_p1, sizeof(int), "var_wm831x_buckp_list_voltage_21_p1");
  int var_wm831x_buckp_set_suspend_voltage_24_p1 ;
    klee_make_symbolic(&var_wm831x_buckp_set_suspend_voltage_24_p1, sizeof(int), "var_wm831x_buckp_set_suspend_voltage_24_p1");
  int res_wm831x_buckp_probe_26 ;
    klee_make_symbolic(&res_wm831x_buckp_probe_26, sizeof(int), "res_wm831x_buckp_probe_26");
  int res_wm831x_boostp_probe_29 ;
    klee_make_symbolic(&res_wm831x_boostp_probe_29, sizeof(int), "res_wm831x_boostp_probe_29");
  int res_wm831x_epe_probe_31 ;
    klee_make_symbolic(&res_wm831x_epe_probe_31, sizeof(int), "res_wm831x_epe_probe_31");
  int var_wm831x_dcdc_oc_irq_9_p0 ;
    klee_make_symbolic(&var_wm831x_dcdc_oc_irq_9_p0, sizeof(int), "var_wm831x_dcdc_oc_irq_9_p0");
  void *var_wm831x_dcdc_oc_irq_9_p1 ;
  int var_wm831x_dcdc_uv_irq_8_p0 ;
    klee_make_symbolic(&var_wm831x_dcdc_uv_irq_8_p0, sizeof(int), "var_wm831x_dcdc_uv_irq_8_p0");
  void *var_wm831x_dcdc_uv_irq_8_p1 ;
  int ldv_s_wm831x_buckv_driver_platform_driver ;
    klee_make_symbolic(&ldv_s_wm831x_buckv_driver_platform_driver, sizeof(int), "ldv_s_wm831x_buckv_driver_platform_driver");
  int ldv_s_wm831x_buckp_driver_platform_driver ;
    klee_make_symbolic(&ldv_s_wm831x_buckp_driver_platform_driver, sizeof(int), "ldv_s_wm831x_buckp_driver_platform_driver");
  int ldv_s_wm831x_boostp_driver_platform_driver ;
    klee_make_symbolic(&ldv_s_wm831x_boostp_driver_platform_driver, sizeof(int), "ldv_s_wm831x_boostp_driver_platform_driver");
  int ldv_s_wm831x_epe_driver_platform_driver ;
    klee_make_symbolic(&ldv_s_wm831x_epe_driver_platform_driver, sizeof(int), "ldv_s_wm831x_epe_driver_platform_driver");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
