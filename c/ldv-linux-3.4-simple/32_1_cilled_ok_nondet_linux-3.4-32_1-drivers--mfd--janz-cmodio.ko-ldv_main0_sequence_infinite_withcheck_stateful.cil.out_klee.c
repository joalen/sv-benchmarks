...
static unsigned int cmodio_id  ;
    klee_make_symbolic(&cmodio_id, sizeof(int), "cmodio_id");
...
{ struct pci_dev *pdev ;
  unsigned int num_probed ;
    klee_make_symbolic(&num_probed, sizeof(int), "num_probed");
  char *name ;
  int i ;
...
static int res_cmodio_pci_probe_3  ;
    klee_make_symbolic(&res_cmodio_pci_probe_3, sizeof(int), "res_cmodio_pci_probe_3");
void main(void) 
{ struct pci_dev *var_group1 ;
  struct pci_device_id  const  *var_cmodio_pci_probe_3_p1 ;
  int tmp ;
  int ldv_s_cmodio_pci_driver_pci_driver ;
    klee_make_symbolic(&ldv_s_cmodio_pci_driver_pci_driver, sizeof(int), "ldv_s_cmodio_pci_driver_pci_driver");
  int tmp___0 ;
  int tmp___1 ;
  int __cil_tmp7 ;
