...
{ struct kobject *var_group1 ;
  ...
  int var_iscsi_boot_tgt_attr_is_visible_2_p2 ;
    klee_make_symbolic(&var_iscsi_boot_tgt_attr_is_visible_2_p2, sizeof(int), "var_iscsi_boot_tgt_attr_is_visible_2_p2");
  int var_iscsi_boot_eth_attr_is_visible_3_p2 ;
    klee_make_symbolic(&var_iscsi_boot_eth_attr_is_visible_3_p2, sizeof(int), "var_iscsi_boot_eth_attr_is_visible_3_p2");
  int var_iscsi_boot_ini_attr_is_visible_4_p2 ;
    klee_make_symbolic(&var_iscsi_boot_ini_attr_is_visible_4_p2, sizeof(int), "var_iscsi_boot_ini_attr_is_visible_4_p2");
  int ldv_s_iscsi_boot_ktype_kobj_type ;
    klee_make_symbolic(&ldv_s_iscsi_boot_ktype_kobj_type, sizeof(int), "ldv_s_iscsi_boot_ktype_kobj_type");
  int tmp ;
  int tmp___0 ;
  int __cil_tmp10 ;
