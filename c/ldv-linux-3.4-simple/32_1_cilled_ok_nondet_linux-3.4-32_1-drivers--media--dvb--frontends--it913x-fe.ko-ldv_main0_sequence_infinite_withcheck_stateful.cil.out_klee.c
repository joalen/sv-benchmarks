...
static int it913x_debug  ;
    klee_make_symbolic(&it913x_debug, sizeof(int), "it913x_debug");
...
{ struct dvb_frontend *var_group1 ;
  ...
  int ldv_s_it913x_fe_ofdm_ops_dvb_frontend_ops ;
    klee_make_symbolic(&ldv_s_it913x_fe_ofdm_ops_dvb_frontend_ops, sizeof(int), "ldv_s_it913x_fe_ofdm_ops_dvb_frontend_ops");
  int tmp___7 ;
  int tmp___8 ;
  int __cil_tmp10 ;
