...
struct rs5c348_plat_data {
   ...
   int rtc_24h ;
    klee_make_symbolic(&rtc_24h, sizeof(int), "rtc_24h");
};
...
static int res_rs5c348_probe_2  ;
    klee_make_symbolic(&res_rs5c348_probe_2, sizeof(int), "res_rs5c348_probe_2");
void main(void) 
{ struct device *var_group1 ;
  struct rtc_time *var_group2 ;
  struct spi_device *var_group3 ;
  int ldv_s_rs5c348_driver_spi_driver ;
    klee_make_symbolic(&ldv_s_rs5c348_driver_spi_driver, sizeof(int), "ldv_s_rs5c348_driver_spi_driver");
  int tmp___7 ;
  int tmp___8 ;
  int __cil_tmp7 ;
