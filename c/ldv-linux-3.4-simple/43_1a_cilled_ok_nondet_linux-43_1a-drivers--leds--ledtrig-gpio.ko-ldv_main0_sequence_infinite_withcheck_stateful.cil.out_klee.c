...
struct gpio_trig_data {
   ...
   unsigned int inverted ;
    klee_make_symbolic(&inverted, sizeof(int), "inverted");
   unsigned int gpio ;
...
{ struct gpio_trig_data *gpio_data ;
  ...
  long __constr_expr_0_counter49 ;
    klee_make_symbolic(&__constr_expr_0_counter49, sizeof(long), "__constr_expr_0_counter49");
...
{ struct led_classdev *var_group1 ;
  int var_gpio_trig_irq_0_p0 ;
    klee_make_symbolic(&var_gpio_trig_irq_0_p0, sizeof(int), "var_gpio_trig_irq_0_p0");
