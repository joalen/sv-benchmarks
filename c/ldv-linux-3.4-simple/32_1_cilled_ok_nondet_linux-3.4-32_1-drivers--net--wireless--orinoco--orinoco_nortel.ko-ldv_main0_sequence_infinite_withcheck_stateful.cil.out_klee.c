...
static int res_orinoco_nortel_init_one_2  ;
    klee_make_symbolic(&res_orinoco_nortel_init_one_2, sizeof(int), "res_orinoco_nortel_init_one_2");
void main(void) 
{ struct pci_dev *var_group1 ;
  ...
  int ldv_s_orinoco_nortel_driver_pci_driver ;
    klee_make_symbolic(&ldv_s_orinoco_nortel_driver_pci_driver, sizeof(int), "ldv_s_orinoco_nortel_driver_pci_driver");
  int tmp___8 ;
  int tmp___9 ;
  int __cil_tmp7 ;
