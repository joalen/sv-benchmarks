...
struct microtune_priv {
   ...
   unsigned int xogc ;
    klee_make_symbolic(&xogc, sizeof(int), "xogc");
   u32 frequency ;
};
...
static unsigned int radio_antenna  ;
    klee_make_symbolic(&radio_antenna, sizeof(int), "radio_antenna");
...
{ struct microtune_priv *priv ;
  int n1 ;
    klee_make_symbolic(&n1, sizeof(int), "n1");
  int n2 ;
...
{ struct microtune_priv *priv ;
  unsigned int fref ;
    klee_make_symbolic(&fref, sizeof(int), "fref");
  unsigned int lo1 ;
    klee_make_symbolic(&lo1, sizeof(int), "lo1");
  unsigned int lo1n ;
    klee_make_symbolic(&lo1n, sizeof(int), "lo1n");
  unsigned int lo1a ;
    klee_make_symbolic(&lo1a, sizeof(int), "lo1a");
  unsigned int s ;
    klee_make_symbolic(&s, sizeof(int), "s");
  unsigned int sel ;
    klee_make_symbolic(&sel, sizeof(int), "sel");
  unsigned int lo1freq ;
    klee_make_symbolic(&lo1freq, sizeof(int), "lo1freq");
  unsigned int desired_lo1 ;
    klee_make_symbolic(&desired_lo1, sizeof(int), "desired_lo1");
  unsigned int desired_lo2 ;
    klee_make_symbolic(&desired_lo2, sizeof(int), "desired_lo2");
  unsigned int lo2 ;
    klee_make_symbolic(&lo2, sizeof(int), "lo2");
  unsigned int lo2n ;
    klee_make_symbolic(&lo2n, sizeof(int), "lo2n");
  unsigned int lo2a ;
    klee_make_symbolic(&lo2a, sizeof(int), "lo2a");
  unsigned int lo2num ;
    klee_make_symbolic(&lo2num, sizeof(int), "lo2num");
  unsigned int lo2freq ;
    klee_make_symbolic(&lo2freq, sizeof(int), "lo2freq");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
  int tmp___2 ;
...
{ struct microtune_priv *priv ;
  unsigned char buf[2U] ;
  int tad1 ;
    klee_make_symbolic(&tad1, sizeof(int), "tad1");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
  int tmp___2 ;
...
{ unsigned char buf[21U] ;
  int lint_try ;
    klee_make_symbolic(&lint_try, sizeof(int), "lint_try");
  int ret ;
  int sel ;
  int lock ;
  struct microtune_priv *priv ;
...
{ struct microtune_priv *priv ;
  ...
  int xogc ;
  int xok ;
    klee_make_symbolic(&xok, sizeof(int), "xok");
  int tmp ;
  int tmp___0 ;
  unsigned long __ms ;
...
{ struct microtune_priv *priv ;
  unsigned int if1 ;
    klee_make_symbolic(&if1, sizeof(int), "if1");
  unsigned int f_lo1 ;
    klee_make_symbolic(&f_lo1, sizeof(int), "f_lo1");
  unsigned int f_lo2 ;
    klee_make_symbolic(&f_lo2, sizeof(int), "f_lo2");
  unsigned int lo1 ;
  unsigned int lo2 ;
  unsigned int f_lo1_modulo ;
    klee_make_symbolic(&f_lo1_modulo, sizeof(int), "f_lo1_modulo");
  unsigned int f_lo2_modulo ;
    klee_make_symbolic(&f_lo2_modulo, sizeof(int), "f_lo2_modulo");
  unsigned int num1 ;
    klee_make_symbolic(&num1, sizeof(int), "num1");
  unsigned int num2 ;
    klee_make_symbolic(&num2, sizeof(int), "num2");
  unsigned int div1a ;
    klee_make_symbolic(&div1a, sizeof(int), "div1a");
  unsigned int div1b ;
    klee_make_symbolic(&div1b, sizeof(int), "div1b");
  unsigned int div2a ;
    klee_make_symbolic(&div2a, sizeof(int), "div2a");
  unsigned int div2b ;
    klee_make_symbolic(&div2b, sizeof(int), "div2b");
  int ret ;
...
{ struct microtune_priv *priv ;
  ...
  unsigned char buf[21U] ;
  int company_code ;
    klee_make_symbolic(&company_code, sizeof(int), "company_code");
  void *tmp ;
  int i ;
  int tmp___0 ;
  int tmp___1 ;
...
{ struct dvb_frontend *var_group1 ;
  ...
  int ldv_s_mt2032_tuner_ops_dvb_tuner_ops ;
    klee_make_symbolic(&ldv_s_mt2032_tuner_ops_dvb_tuner_ops, sizeof(int), "ldv_s_mt2032_tuner_ops_dvb_tuner_ops");
  int ldv_s_mt2050_tuner_ops_dvb_tuner_ops ;
    klee_make_symbolic(&ldv_s_mt2050_tuner_ops_dvb_tuner_ops, sizeof(int), "ldv_s_mt2050_tuner_ops_dvb_tuner_ops");
  int tmp ;
  int tmp___0 ;
