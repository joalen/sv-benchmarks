...
static int acpi5  ;
    klee_make_symbolic(&acpi5, sizeof(int), "acpi5");
...
{ struct inode *var_group1 ;
  ...
  int res_available_error_type_open_12 ;
    klee_make_symbolic(&res_available_error_type_open_12, sizeof(int), "res_available_error_type_open_12");
  int ldv_s_available_error_type_fops_file_operations ;
    klee_make_symbolic(&ldv_s_available_error_type_fops_file_operations, sizeof(int), "ldv_s_available_error_type_fops_file_operations");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
