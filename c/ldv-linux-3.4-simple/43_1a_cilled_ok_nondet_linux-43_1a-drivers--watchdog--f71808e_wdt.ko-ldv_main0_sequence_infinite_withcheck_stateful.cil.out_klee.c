...
struct watchdog_data {
   unsigned short sioaddr ;
    klee_make_symbolic(&sioaddr, sizeof(short), "sioaddr");
   enum chips type ;
   unsigned long opened ;
    klee_make_symbolic(&opened, sizeof(long), "opened");
   struct mutex lock ;
   char expect_close ;
    klee_make_symbolic(&expect_close, sizeof(char), "expect_close");
   struct watchdog_info ident ;
   unsigned short timeout ;
    klee_make_symbolic(&timeout, sizeof(short), "timeout");
   u8 timer_val ;
   char minutes_mode ;
    klee_make_symbolic(&minutes_mode, sizeof(char), "minutes_mode");
   u8 pulse_val ;
   char pulse_mode ;
    klee_make_symbolic(&pulse_mode, sizeof(char), "pulse_mode");
   char caused_reboot ;
    klee_make_symbolic(&caused_reboot, sizeof(char), "caused_reboot");
};
...
static unsigned int start_withtimeout  ;
    klee_make_symbolic(&start_withtimeout, sizeof(int), "start_withtimeout");
...
{ int err ;
  ...
  unsigned short __cil_tmp44 ;
    klee_make_symbolic(&__cil_tmp44, sizeof(short), "__cil_tmp44");
  int __cil_tmp45 ;
  ...
  unsigned short __cil_tmp53 ;
    klee_make_symbolic(&__cil_tmp53, sizeof(short), "__cil_tmp53");
  int __cil_tmp54 ;
...
{ int status ;
  int new_options ;
    klee_make_symbolic(&new_options, sizeof(int), "new_options");
  int new_timeout ;
...
{ int wdt_conf ;
    klee_make_symbolic(&wdt_conf, sizeof(int), "wdt_conf");
  int err ;
  struct watchdog_data *__cil_tmp4 ;
  unsigned long __cil_tmp5 ;
  unsigned long __cil_tmp6 ;
...
{ struct inode *var_group1 ;
  ...
  int res_watchdog_open_16 ;
    klee_make_symbolic(&res_watchdog_open_16, sizeof(int), "res_watchdog_open_16");
  ...
  unsigned int var_watchdog_ioctl_19_p1 ;
    klee_make_symbolic(&var_watchdog_ioctl_19_p1, sizeof(int), "var_watchdog_ioctl_19_p1");
  unsigned long var_watchdog_ioctl_19_p2 ;
    klee_make_symbolic(&var_watchdog_ioctl_19_p2, sizeof(long), "var_watchdog_ioctl_19_p2");
  struct notifier_block *var_group3 ;
  unsigned long var_watchdog_notify_sys_20_p1 ;
    klee_make_symbolic(&var_watchdog_notify_sys_20_p1, sizeof(long), "var_watchdog_notify_sys_20_p1");
  void *var_watchdog_notify_sys_20_p2 ;
  int ldv_s_watchdog_fops_file_operations ;
    klee_make_symbolic(&ldv_s_watchdog_fops_file_operations, sizeof(int), "ldv_s_watchdog_fops_file_operations");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
  int __cil_tmp17 ;
