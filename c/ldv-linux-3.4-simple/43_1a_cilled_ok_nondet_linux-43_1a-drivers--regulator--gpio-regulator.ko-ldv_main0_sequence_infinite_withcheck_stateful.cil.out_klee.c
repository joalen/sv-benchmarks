...
struct gpio_regulator_state {
   int value ;
   int gpios ;
    klee_make_symbolic(&gpios, sizeof(int), "gpios");
};
struct gpio;
struct gpio_regulator_config {
   char const   *supply_name ;
   int enable_gpio ;
    klee_make_symbolic(&enable_gpio, sizeof(int), "enable_gpio");
   unsigned char enable_high : 1 ;
   unsigned char enabled_at_boot : 1 ;
   unsigned int startup_delay ;
    klee_make_symbolic(&startup_delay, sizeof(int), "startup_delay");
   struct gpio *gpios ;
   int nr_gpios ;
    klee_make_symbolic(&nr_gpios, sizeof(int), "nr_gpios");
   struct gpio_regulator_state *states ;
   int nr_states ;
    klee_make_symbolic(&nr_states, sizeof(int), "nr_states");
   enum regulator_type type ;
   struct regulator_init_data *init_data ;
};
struct gpio {
   unsigned int gpio ;
    klee_make_symbolic(&gpio, sizeof(int), "gpio");
   unsigned long flags ;
   char const   *label ;
};
typedef u32 phandle;
...
{ struct regulator_dev *var_group1 ;
  int var_gpio_regulator_set_voltage_6_p1 ;
    klee_make_symbolic(&var_gpio_regulator_set_voltage_6_p1, sizeof(int), "var_gpio_regulator_set_voltage_6_p1");
  int var_gpio_regulator_set_voltage_6_p2 ;
    klee_make_symbolic(&var_gpio_regulator_set_voltage_6_p2, sizeof(int), "var_gpio_regulator_set_voltage_6_p2");
  unsigned int *var_gpio_regulator_set_voltage_6_p3 ;
  unsigned int var_gpio_regulator_list_voltage_7_p1 ;
    klee_make_symbolic(&var_gpio_regulator_list_voltage_7_p1, sizeof(int), "var_gpio_regulator_list_voltage_7_p1");
  int var_gpio_regulator_set_current_limit_8_p1 ;
    klee_make_symbolic(&var_gpio_regulator_set_current_limit_8_p1, sizeof(int), "var_gpio_regulator_set_current_limit_8_p1");
  int var_gpio_regulator_set_current_limit_8_p2 ;
    klee_make_symbolic(&var_gpio_regulator_set_current_limit_8_p2, sizeof(int), "var_gpio_regulator_set_current_limit_8_p2");
  struct platform_device *var_group2 ;
  int res_gpio_regulator_probe_9 ;
    klee_make_symbolic(&res_gpio_regulator_probe_9, sizeof(int), "res_gpio_regulator_probe_9");
  int ldv_s_gpio_regulator_driver_platform_driver ;
    klee_make_symbolic(&ldv_s_gpio_regulator_driver_platform_driver, sizeof(int), "ldv_s_gpio_regulator_driver_platform_driver");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
