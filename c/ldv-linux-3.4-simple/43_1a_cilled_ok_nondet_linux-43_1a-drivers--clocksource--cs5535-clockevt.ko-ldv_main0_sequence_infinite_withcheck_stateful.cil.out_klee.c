...
struct clock_event_device {
   ...
   unsigned long min_delta_ticks ;
    klee_make_symbolic(&min_delta_ticks, sizeof(long), "min_delta_ticks");
   unsigned long max_delta_ticks ;
    klee_make_symbolic(&max_delta_ticks, sizeof(long), "max_delta_ticks");
   char const   *name ;
   int rating ;
    klee_make_symbolic(&rating, sizeof(int), "rating");
   int irq ;
...
{ enum clock_event_mode var_mfgpt_set_mode_2_p0 ;
  ...
  unsigned long var_mfgpt_next_event_3_p0 ;
    klee_make_symbolic(&var_mfgpt_next_event_3_p0, sizeof(long), "var_mfgpt_next_event_3_p0");
  int var_mfgpt_tick_4_p0 ;
    klee_make_symbolic(&var_mfgpt_tick_4_p0, sizeof(int), "var_mfgpt_tick_4_p0");
