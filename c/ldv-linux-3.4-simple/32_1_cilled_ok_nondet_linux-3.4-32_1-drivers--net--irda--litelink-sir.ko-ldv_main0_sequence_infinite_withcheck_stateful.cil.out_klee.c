...
static int res_litelink_open_2  ;
    klee_make_symbolic(&res_litelink_open_2, sizeof(int), "res_litelink_open_2");
void main(void) 
{ struct sir_dev *var_group1 ;
  unsigned int var_litelink_change_speed_4_p1 ;
    klee_make_symbolic(&var_litelink_change_speed_4_p1, sizeof(int), "var_litelink_change_speed_4_p1");
  int tmp___7 ;
  int ldv_s_litelink_dongle_driver ;
    klee_make_symbolic(&ldv_s_litelink_dongle_driver, sizeof(int), "ldv_s_litelink_dongle_driver");
  int tmp___8 ;
  int tmp___9 ;
  int __cil_tmp7 ;
