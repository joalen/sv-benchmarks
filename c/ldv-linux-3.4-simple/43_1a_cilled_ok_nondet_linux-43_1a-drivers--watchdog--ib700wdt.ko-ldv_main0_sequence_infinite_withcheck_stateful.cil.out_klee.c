...
static unsigned long ibwdt_is_open  ;
    klee_make_symbolic(&ibwdt_is_open, sizeof(long), "ibwdt_is_open");
...
{ int wd_margin ;
    klee_make_symbolic(&wd_margin, sizeof(int), "wd_margin");
  int *__cil_tmp2 ;
  int __cil_tmp3 ;
  int __cil_tmp4 ;
  int __cil_tmp5 ;
...
{ int new_margin ;
    klee_make_symbolic(&new_margin, sizeof(int), "new_margin");
  void *argp ;
  int *p ;
...
{ struct file *var_group1 ;
  ...
  unsigned int var_ibwdt_ioctl_4_p1 ;
    klee_make_symbolic(&var_ibwdt_ioctl_4_p1, sizeof(int), "var_ibwdt_ioctl_4_p1");
  unsigned long var_ibwdt_ioctl_4_p2 ;
    klee_make_symbolic(&var_ibwdt_ioctl_4_p2, sizeof(long), "var_ibwdt_ioctl_4_p2");
  struct inode *var_group2 ;
  int res_ibwdt_open_5 ;
    klee_make_symbolic(&res_ibwdt_open_5, sizeof(int), "res_ibwdt_open_5");
  struct platform_device *var_group3 ;
  int res_ibwdt_probe_7 ;
    klee_make_symbolic(&res_ibwdt_probe_7, sizeof(int), "res_ibwdt_probe_7");
  int ldv_s_ibwdt_fops_file_operations ;
    klee_make_symbolic(&ldv_s_ibwdt_fops_file_operations, sizeof(int), "ldv_s_ibwdt_fops_file_operations");
  int ldv_s_ibwdt_driver_platform_driver ;
    klee_make_symbolic(&ldv_s_ibwdt_driver_platform_driver, sizeof(int), "ldv_s_ibwdt_driver_platform_driver");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
  int __cil_tmp17 ;
