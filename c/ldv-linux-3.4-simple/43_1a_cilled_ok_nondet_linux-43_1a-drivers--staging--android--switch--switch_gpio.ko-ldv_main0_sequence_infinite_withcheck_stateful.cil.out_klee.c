...
{ struct gpio_switch_platform_data *pdata ;
  ...
  long __constr_expr_0_counter89 ;
    klee_make_symbolic(&__constr_expr_0_counter89, sizeof(long), "__constr_expr_0_counter89");
...
{ struct platform_device *var_group1 ;
  int res_gpio_switch_probe_3 ;
    klee_make_symbolic(&res_gpio_switch_probe_3, sizeof(int), "res_gpio_switch_probe_3");
  int var_gpio_irq_handler_1_p0 ;
    klee_make_symbolic(&var_gpio_irq_handler_1_p0, sizeof(int), "var_gpio_irq_handler_1_p0");
  void *var_gpio_irq_handler_1_p1 ;
  int ldv_s_gpio_switch_driver_platform_driver ;
    klee_make_symbolic(&ldv_s_gpio_switch_driver_platform_driver, sizeof(int), "ldv_s_gpio_switch_driver_platform_driver");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
