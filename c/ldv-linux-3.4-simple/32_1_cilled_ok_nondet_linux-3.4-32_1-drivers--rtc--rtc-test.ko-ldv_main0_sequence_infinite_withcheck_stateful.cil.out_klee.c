...
static int res_test_probe_8  ;
    klee_make_symbolic(&res_test_probe_8, sizeof(int), "res_test_probe_8");
void main(void) 
{ struct device *var_group1 ;
  ...
  unsigned long var_test_rtc_set_mmss_3_p1 ;
    klee_make_symbolic(&var_test_rtc_set_mmss_3_p1, sizeof(long), "var_test_rtc_set_mmss_3_p1");
  unsigned int var_test_rtc_alarm_irq_enable_5_p1 ;
    klee_make_symbolic(&var_test_rtc_alarm_irq_enable_5_p1, sizeof(int), "var_test_rtc_alarm_irq_enable_5_p1");
  struct platform_device *var_group5 ;
  int tmp ;
  int ldv_s_test_driver_platform_driver ;
    klee_make_symbolic(&ldv_s_test_driver_platform_driver, sizeof(int), "ldv_s_test_driver_platform_driver");
  int tmp___0 ;
  int tmp___1 ;
  int __cil_tmp12 ;
