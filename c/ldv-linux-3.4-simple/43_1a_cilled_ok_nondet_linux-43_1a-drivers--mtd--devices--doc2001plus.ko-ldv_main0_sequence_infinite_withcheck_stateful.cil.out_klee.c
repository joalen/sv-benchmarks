...
struct nand_flash_dev {
   ...
   unsigned long pagesize ;
    klee_make_symbolic(&pagesize, sizeof(long), "pagesize");
   unsigned long chipsize ;
    klee_make_symbolic(&chipsize, sizeof(long), "chipsize");
   unsigned long erasesize ;
    klee_make_symbolic(&erasesize, sizeof(long), "erasesize");
...
struct Nand {
   char floor ;
    klee_make_symbolic(&floor, sizeof(char), "floor");
   char chip ;
    klee_make_symbolic(&chip, sizeof(char), "chip");
   unsigned long curadr ;
    klee_make_symbolic(&curadr, sizeof(long), "curadr");
   unsigned char curmode ;
    klee_make_symbolic(&curmode, sizeof(char), "curmode");
};
struct DiskOnChip {
   unsigned long physadr ;
    klee_make_symbolic(&physadr, sizeof(long), "physadr");
   void *virtadr ;
   unsigned long totlen ;
    klee_make_symbolic(&totlen, sizeof(long), "totlen");
   unsigned char ChipID ;
    klee_make_symbolic(&ChipID, sizeof(char), "ChipID");
   int ioreg ;
    klee_make_symbolic(&ioreg, sizeof(int), "ioreg");
   unsigned long mfr ;
    klee_make_symbolic(&mfr, sizeof(long), "mfr");
   unsigned long id ;
   int chipshift ;
    klee_make_symbolic(&chipshift, sizeof(int), "chipshift");
   char page256 ;
    klee_make_symbolic(&page256, sizeof(char), "page256");
   char pageadrlen ;
    klee_make_symbolic(&pageadrlen, sizeof(char), "pageadrlen");
   char interleave ;
    klee_make_symbolic(&interleave, sizeof(char), "interleave");
   unsigned long erasesize ;
   int curfloor ;
    klee_make_symbolic(&curfloor, sizeof(int), "curfloor");
   int curchip ;
    klee_make_symbolic(&curchip, sizeof(int), "curchip");
   int numchips ;
...
{ unsigned char __cil_tmp3 ;
    klee_make_symbolic(&__cil_tmp3, sizeof(char), "__cil_tmp3");
  int __cil_tmp4 ;
  int __cil_tmp5 ;
...
{ int floor ;
  ...
  int ret ;
  u_char conf ;
    klee_make_symbolic(&conf, sizeof(char), "conf");
  unsigned char tmp ;
  char *tmp___0 ;
  unsigned char tmp___1 ;
  void *tmp___2 ;
...
{ int i ;
  int before ;
    klee_make_symbolic(&before, sizeof(int), "before");
  int ret ;
  loff_t fto ;
  char volatile   dummy ;
  char eccbuf[6U] ;
