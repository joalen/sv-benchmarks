...
{ struct pci_dev *var_group1 ;
  ...
  int res_orinoco_plx_init_one_2 ;
    klee_make_symbolic(&res_orinoco_plx_init_one_2, sizeof(int), "res_orinoco_plx_init_one_2");
  int ldv_s_orinoco_plx_driver_pci_driver ;
    klee_make_symbolic(&ldv_s_orinoco_plx_driver_pci_driver, sizeof(int), "ldv_s_orinoco_plx_driver_pci_driver");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
