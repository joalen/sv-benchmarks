...
{ struct platform_device *var_group1 ;
  int res_regulator_virtual_probe_12 ;
    klee_make_symbolic(&res_regulator_virtual_probe_12, sizeof(int), "res_regulator_virtual_probe_12");
  int ldv_s_regulator_virtual_consumer_driver_platform_driver ;
    klee_make_symbolic(&ldv_s_regulator_virtual_consumer_driver_platform_driver, sizeof(int), "ldv_s_regulator_virtual_consumer_driver_platform_driver");
  int tmp ;
  int tmp___0 ;
