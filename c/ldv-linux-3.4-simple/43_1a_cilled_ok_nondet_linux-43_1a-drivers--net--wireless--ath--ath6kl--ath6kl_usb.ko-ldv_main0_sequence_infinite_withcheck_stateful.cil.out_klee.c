...
struct htc_tx_packet_info {
   u16 tag ;
   int cred_used ;
    klee_make_symbolic(&cred_used, sizeof(int), "cred_used");
   u8 flags ;
   int seqno ;
...
struct htc_ep_callbacks {
   ...
   struct htc_packet *(*rx_allocthresh)(struct htc_target * , enum htc_endpoint_id  ,
                                        int  ) ;
   int rx_alloc_thresh ;
    klee_make_symbolic(&rx_alloc_thresh, sizeof(int), "rx_alloc_thresh");
   int rx_refill_thresh ;
    klee_make_symbolic(&rx_refill_thresh, sizeof(int), "rx_refill_thresh");
};
struct htc_endpoint;
struct htc_endpoint_credit_dist {
   struct list_head list ;
   ...
   u32 dist_flags ;
   int cred_norm ;
    klee_make_symbolic(&cred_norm, sizeof(int), "cred_norm");
   int cred_min ;
    klee_make_symbolic(&cred_min, sizeof(int), "cred_min");
   int cred_assngd ;
    klee_make_symbolic(&cred_assngd, sizeof(int), "cred_assngd");
   int credits ;
    klee_make_symbolic(&credits, sizeof(int), "credits");
   int cred_to_dist ;
    klee_make_symbolic(&cred_to_dist, sizeof(int), "cred_to_dist");
   int seek_cred ;
    klee_make_symbolic(&seek_cred, sizeof(int), "seek_cred");
   int cred_sz ;
    klee_make_symbolic(&cred_sz, sizeof(int), "cred_sz");
   int cred_per_msg ;
    klee_make_symbolic(&cred_per_msg, sizeof(int), "cred_per_msg");
...
struct ath6kl_htc_credit_info {
   int total_avail_credits ;
    klee_make_symbolic(&total_avail_credits, sizeof(int), "total_avail_credits");
   int cur_free_credits ;
    klee_make_symbolic(&cur_free_credits, sizeof(int), "cur_free_credits");
...
struct htc_endpoint {
   ...
   int max_txq_depth ;
    klee_make_symbolic(&max_txq_depth, sizeof(int), "max_txq_depth");
   int len_max ;
    klee_make_symbolic(&len_max, sizeof(int), "len_max");
   int tx_proc_cnt ;
    klee_make_symbolic(&tx_proc_cnt, sizeof(int), "tx_proc_cnt");
   int rx_proc_cnt ;
    klee_make_symbolic(&rx_proc_cnt, sizeof(int), "rx_proc_cnt");
...
struct htc_target {
   ...
   int tgt_creds ;
    klee_make_symbolic(&tgt_creds, sizeof(int), "tgt_creds");
   unsigned int tgt_cred_sz ;
    klee_make_symbolic(&tgt_cred_sz, sizeof(int), "tgt_cred_sz");
   spinlock_t htc_lock ;
   spinlock_t rx_lock ;
   spinlock_t tx_lock ;
   ...
   int msg_per_bndl_max ;
    klee_make_symbolic(&msg_per_bndl_max, sizeof(int), "msg_per_bndl_max");
   u32 tx_bndl_mask ;
   int rx_bndl_enable ;
    klee_make_symbolic(&rx_bndl_enable, sizeof(int), "rx_bndl_enable");
   int max_rx_bndl_sz ;
    klee_make_symbolic(&max_rx_bndl_sz, sizeof(int), "max_rx_bndl_sz");
   int max_tx_bndl_sz ;
    klee_make_symbolic(&max_tx_bndl_sz, sizeof(int), "max_tx_bndl_sz");
   u32 block_sz ;
   u32 block_mask ;
   int max_scat_entries ;
    klee_make_symbolic(&max_scat_entries, sizeof(int), "max_scat_entries");
   int max_xfer_szper_scatreq ;
    klee_make_symbolic(&max_xfer_szper_scatreq, sizeof(int), "max_xfer_szper_scatreq");
   int chk_irq_status_cnt ;
    klee_make_symbolic(&chk_irq_status_cnt, sizeof(int), "chk_irq_status_cnt");
   u32 ac_tx_count[4U] ;
};
...
struct ath6kl_req_key {
   ...
   u8 key_index ;
   int key_type ;
    klee_make_symbolic(&key_type, sizeof(int), "key_type");
   u8 key[32U] ;
   u8 key_len ;
};
...
struct __anonstruct_war_stats_253 {
   unsigned int invalid_rate ;
    klee_make_symbolic(&invalid_rate, sizeof(int), "invalid_rate");
};
struct __anonstruct_debug_252 {
   ...
   unsigned int dbgfs_diag_reg ;
    klee_make_symbolic(&dbgfs_diag_reg, sizeof(int), "dbgfs_diag_reg");
   u32 diag_reg_addr_wr ;
   u32 diag_reg_val_wr ;
   struct __anonstruct_war_stats_253 war_stats ;
   u8 *roam_tbl ;
   unsigned int roam_tbl_len ;
    klee_make_symbolic(&roam_tbl_len, sizeof(int), "roam_tbl_len");
   u8 keepalive ;
   u8 disc_timeout ;
};
struct ath6kl {
   ...
   unsigned int testmode ;
    klee_make_symbolic(&testmode, sizeof(int), "testmode");
   struct ath6kl_bmi bmi ;
   struct ath6kl_hif_ops  const  *hif_ops ;
   struct wmi *wmi ;
   int tx_pending[9U] ;
   int total_tx_data_pend ;
    klee_make_symbolic(&total_tx_data_pend, sizeof(int), "total_tx_data_pend");
   ...
   unsigned int vif_max ;
    klee_make_symbolic(&vif_max, sizeof(int), "vif_max");
   u8 max_norm_iface ;
   u8 avail_idx_map ;
   spinlock_t lock ;
   ...
   unsigned int fw_api ;
    klee_make_symbolic(&fw_api, sizeof(int), "fw_api");
...
struct hif_scatter_req {
   ...
   int status ;
   int scat_entries ;
    klee_make_symbolic(&scat_entries, sizeof(int), "scat_entries");
...
{ struct usb_device *dev ;
  ...
  struct ath6kl_usb *ar_usb ;
  int vendor_id ;
    klee_make_symbolic(&vendor_id, sizeof(int), "vendor_id");
  int product_id ;
...
{ struct ath6kl *var_group1 ;
  ...
  int res_ath6kl_usb_probe_12 ;
    klee_make_symbolic(&res_ath6kl_usb_probe_12, sizeof(int), "res_ath6kl_usb_probe_12");
  int ldv_s_ath6kl_usb_driver_usb_driver ;
    klee_make_symbolic(&ldv_s_ath6kl_usb_driver_usb_driver, sizeof(int), "ldv_s_ath6kl_usb_driver_usb_driver");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
