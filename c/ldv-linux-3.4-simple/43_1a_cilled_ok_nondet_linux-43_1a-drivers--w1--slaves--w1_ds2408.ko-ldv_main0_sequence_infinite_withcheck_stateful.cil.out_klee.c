...
struct w1_reg_num {
   ...
   unsigned long id : 48 ;
   unsigned char crc ;
    klee_make_symbolic(&crc, sizeof(char), "crc");
};
struct w1_slave;
struct w1_slave;
...
struct w1_slave {
   ...
   u32 flags ;
   int ttl ;
    klee_make_symbolic(&ttl, sizeof(int), "ttl");
...
struct w1_master {
   ...
   int max_slave_count ;
    klee_make_symbolic(&max_slave_count, sizeof(int), "max_slave_count");
   int slave_count ;
    klee_make_symbolic(&slave_count, sizeof(int), "slave_count");
   unsigned long attempts ;
    klee_make_symbolic(&attempts, sizeof(long), "attempts");
   int slave_ttl ;
    klee_make_symbolic(&slave_ttl, sizeof(int), "slave_ttl");
   int initialized ;
    klee_make_symbolic(&initialized, sizeof(int), "initialized");
   u32 id ;
   int search_count ;
    klee_make_symbolic(&search_count, sizeof(int), "search_count");
   atomic_t refcnt ;
   void *priv ;
   int priv_size ;
    klee_make_symbolic(&priv_size, sizeof(int), "priv_size");
   int enable_pullup ;
    klee_make_symbolic(&enable_pullup, sizeof(int), "enable_pullup");
   int pullup_duration ;
    klee_make_symbolic(&pullup_duration, sizeof(int), "pullup_duration");
