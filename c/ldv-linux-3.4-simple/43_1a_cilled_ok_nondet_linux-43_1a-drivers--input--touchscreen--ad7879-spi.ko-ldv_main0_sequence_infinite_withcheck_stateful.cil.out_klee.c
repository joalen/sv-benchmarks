...
{ struct device *var_group1 ;
  ...
  int res_ad7879_spi_probe_4 ;
    klee_make_symbolic(&res_ad7879_spi_probe_4, sizeof(int), "res_ad7879_spi_probe_4");
  int ldv_s_ad7879_spi_driver_spi_driver ;
    klee_make_symbolic(&ldv_s_ad7879_spi_driver_spi_driver, sizeof(int), "ldv_s_ad7879_spi_driver_spi_driver");
  int tmp ;
  int tmp___0 ;
  int __cil_tmp13 ;
  u8 __cil_tmp14 ;
