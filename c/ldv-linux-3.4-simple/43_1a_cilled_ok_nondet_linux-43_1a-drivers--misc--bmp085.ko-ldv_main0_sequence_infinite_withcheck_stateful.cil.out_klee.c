...
struct bmp085_data {
   ...
   unsigned char oversampling_setting ;
    klee_make_symbolic(&oversampling_setting, sizeof(char), "oversampling_setting");
   unsigned long last_temp_measurement ;
    klee_make_symbolic(&last_temp_measurement, sizeof(long), "last_temp_measurement");
   s32 b6 ;
};
...
{ struct i2c_client *client ;
  ...
  unsigned long oversampling ;
    klee_make_symbolic(&oversampling, sizeof(long), "oversampling");
  int success ;
...
static ssize_t show_temperature(struct device *dev , struct device_attribute *attr ,
                                char *buf ) 
{ int temperature ;
    klee_make_symbolic(&temperature, sizeof(int), "temperature");
  int status ;
  struct i2c_client *client ;
  struct device  const  *__mptr ;
  struct bmp085_data *data ;
...
{ struct i2c_client *var_group1 ;
  ...
  int res_bmp085_probe_13 ;
    klee_make_symbolic(&res_bmp085_probe_13, sizeof(int), "res_bmp085_probe_13");
  struct i2c_board_info *var_group2 ;
  int ldv_s_bmp085_driver_i2c_driver ;
    klee_make_symbolic(&ldv_s_bmp085_driver_i2c_driver, sizeof(int), "ldv_s_bmp085_driver_i2c_driver");
  int tmp ;
  int tmp___0 ;
