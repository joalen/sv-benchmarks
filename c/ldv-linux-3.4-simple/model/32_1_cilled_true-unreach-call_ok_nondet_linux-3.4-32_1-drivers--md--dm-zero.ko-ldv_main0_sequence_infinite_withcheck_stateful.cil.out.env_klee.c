...
// with type: int dm_register_target(struct target_type *t)
...
// with type: void dm_unregister_target(struct target_type *t)
// with return type: void
...
// with type: void zero_fill_bio(struct bio *bio)
// with return type: void
