...
{ struct file *var_group1 ;
  ...
  int ldv_s_acpi_ec_io_ops_file_operations ;
    klee_make_symbolic(&ldv_s_acpi_ec_io_ops_file_operations, sizeof(int), "ldv_s_acpi_ec_io_ops_file_operations");
  int tmp ;
