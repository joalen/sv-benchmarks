...
struct sd {
   ...
   int vga ;
    klee_make_symbolic(&vga, sizeof(int), "vga");
};
...
{ int i ;
  ...
  int frame_brightness ;
    klee_make_symbolic(&frame_brightness, sizeof(int), "frame_brightness");
  u8 instruction[2U] ;
  unsigned long __cil_tmp6 ;
  unsigned long __cil_tmp7 ;
  unsigned long __cil_tmp8 ;
...
{ struct sd *dev ;
  ...
  int header_read ;
    klee_make_symbolic(&header_read, sizeof(int), "header_read");
  unsigned char header_sig[2U] ;
  int act_len ;
    klee_make_symbolic(&act_len, sizeof(int), "act_len");
  int packet_type ;
    klee_make_symbolic(&packet_type, sizeof(int), "packet_type");
  int ret ;
...
{ struct cam *cam ;
  ...
  long __constr_expr_0_counter44 ;
    klee_make_symbolic(&__constr_expr_0_counter44, sizeof(long), "__constr_expr_0_counter44");
...
{ struct gspca_dev *var_group1 ;
  ...
  int res_sd_probe_16 ;
    klee_make_symbolic(&res_sd_probe_16, sizeof(int), "res_sd_probe_16");
