...
struct digitv_state {
   int is_nxt6000 ;
    klee_make_symbolic(&is_nxt6000, sizeof(int), "is_nxt6000");
};
struct mt352_config {
   u8 demod_address ;
   int adc_clock ;
...
static int dvb_usb_digitv_debug  ;
    klee_make_symbolic(&dvb_usb_digitv_debug, sizeof(int), "dvb_usb_digitv_debug");
...
{ struct i2c_adapter *var_group1 ;
  ...
  int res_digitv_probe_8 ;
    klee_make_symbolic(&res_digitv_probe_8, sizeof(int), "res_digitv_probe_8");
  int ldv_s_digitv_driver_usb_driver ;
    klee_make_symbolic(&ldv_s_digitv_driver_usb_driver, sizeof(int), "ldv_s_digitv_driver_usb_driver");
  int tmp ;
  int tmp___0 ;
