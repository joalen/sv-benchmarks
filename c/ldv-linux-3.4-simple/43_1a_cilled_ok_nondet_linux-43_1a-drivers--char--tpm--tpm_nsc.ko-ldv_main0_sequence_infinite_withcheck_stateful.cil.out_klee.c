...
struct tpm_vendor_specific {
   ...
   int probed_irq ;
    klee_make_symbolic(&probed_irq, sizeof(int), "probed_irq");
   int region_size ;
    klee_make_symbolic(&region_size, sizeof(int), "region_size");
   int have_region ;
    klee_make_symbolic(&have_region, sizeof(int), "have_region");
   ...
   struct list_head list ;
   int locality ;
    klee_make_symbolic(&locality, sizeof(int), "locality");
   unsigned long timeout_a ;
    klee_make_symbolic(&timeout_a, sizeof(long), "timeout_a");
   unsigned long timeout_b ;
    klee_make_symbolic(&timeout_b, sizeof(long), "timeout_b");
   unsigned long timeout_c ;
    klee_make_symbolic(&timeout_c, sizeof(long), "timeout_c");
   unsigned long timeout_d ;
    klee_make_symbolic(&timeout_d, sizeof(long), "timeout_d");
...
struct tpm_chip {
   struct device *dev ;
   int dev_num ;
    klee_make_symbolic(&dev_num, sizeof(int), "dev_num");
   unsigned long is_open ;
    klee_make_symbolic(&is_open, sizeof(long), "is_open");
   int time_expired ;
    klee_make_symbolic(&time_expired, sizeof(int), "time_expired");
   u8 *data_buffer ;
...
{ unsigned char tmp ;
  ...
  unsigned char __cil_tmp4 ;
    klee_make_symbolic(&__cil_tmp4, sizeof(char), "__cil_tmp4");
  int __cil_tmp5 ;
...
{ unsigned long stop ;
    klee_make_symbolic(&stop, sizeof(long), "stop");
...
{ int rc ;
  ...
  int nscAddrBase ;
    klee_make_symbolic(&nscAddrBase, sizeof(int), "nscAddrBase");
  struct tpm_chip *chip ;
  unsigned long base ;
  int tmp ;
  int tmp___0 ;
  ...
  unsigned char __cil_tmp148 ;
    klee_make_symbolic(&__cil_tmp148, sizeof(char), "__cil_tmp148");
  long __cil_tmp149 ;
...
{ struct tpm_chip *var_group1 ;
  ...
  int ldv_s_nsc_drv_platform_driver ;
    klee_make_symbolic(&ldv_s_nsc_drv_platform_driver, sizeof(int), "ldv_s_nsc_drv_platform_driver");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
  int var_tpm_nsc_suspend_7_p1_event12 ;
    klee_make_symbolic(&var_tpm_nsc_suspend_7_p1_event12, sizeof(int), "var_tpm_nsc_suspend_7_p1_event12");
