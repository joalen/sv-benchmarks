...
{ struct tda18212_priv *priv ;
  ...
  u8 bw_params[8U][3U] ;
  int __divisor ;
    klee_make_symbolic(&__divisor, sizeof(int), "__divisor");
...
{ struct dvb_frontend *var_group1 ;
  ...
  int ldv_s_tda18212_tuner_ops_dvb_tuner_ops ;
    klee_make_symbolic(&ldv_s_tda18212_tuner_ops_dvb_tuner_ops, sizeof(int), "ldv_s_tda18212_tuner_ops_dvb_tuner_ops");
  int tmp ;
  int tmp___0 ;
