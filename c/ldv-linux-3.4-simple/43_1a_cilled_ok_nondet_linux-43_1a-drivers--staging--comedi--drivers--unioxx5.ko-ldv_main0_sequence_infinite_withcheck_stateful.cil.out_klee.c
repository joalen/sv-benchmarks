...
struct unioxx5_subd_priv {
   int usp_iobase ;
    klee_make_symbolic(&usp_iobase, sizeof(int), "usp_iobase");
...
{ int iobase ;
  int i ;
  int n_subd ;
    klee_make_symbolic(&n_subd, sizeof(int), "n_subd");
  int id ;
    klee_make_symbolic(&id, sizeof(int), "id");
  int num ;
    klee_make_symbolic(&num, sizeof(int), "num");
  int ba ;
    klee_make_symbolic(&ba, sizeof(int), "ba");
  unsigned char tmp ;
...
static int unioxx5_insn_config(struct comedi_device *dev , struct comedi_subdevice *subdev ,
                               struct comedi_insn *insn , unsigned int *data ) 
{ int channel_offset ;
    klee_make_symbolic(&channel_offset, sizeof(int), "channel_offset");
  int flags ;
  int channel ;
  int type ;
  struct unioxx5_subd_priv *usp ;
...
{ struct unioxx5_subd_priv *usp ;
  ...
  int ndef_flag ;
    klee_make_symbolic(&ndef_flag, sizeof(int), "ndef_flag");
  struct resource *tmp ;
  void *tmp___0 ;
...
static int __unioxx5_analog_write(struct unioxx5_subd_priv *usp , unsigned int *data ,
                                  int channel , int minor ) 
{ int module ;
    klee_make_symbolic(&module, sizeof(int), "module");
  int i ;
  int tmp ;
  unsigned char tmp___0 ;
  int __cil_tmp9 ;
...
static int __unioxx5_analog_read(struct unioxx5_subd_priv *usp , unsigned int *data ,
                                 int channel , int minor ) 
{ int module_no ;
    klee_make_symbolic(&module_no, sizeof(int), "module_no");
  int read_ch ;
    klee_make_symbolic(&read_ch, sizeof(int), "read_ch");
  char control ;
...
static void __unioxx5_analog_config(struct unioxx5_subd_priv *usp , int channel ) 
{ int chan_a ;
    klee_make_symbolic(&chan_a, sizeof(int), "chan_a");
  int chan_b ;
    klee_make_symbolic(&chan_b, sizeof(int), "chan_b");
  int conf ;
    klee_make_symbolic(&conf, sizeof(int), "conf");
  int channel_offset ;
  int __cil_tmp7 ;
