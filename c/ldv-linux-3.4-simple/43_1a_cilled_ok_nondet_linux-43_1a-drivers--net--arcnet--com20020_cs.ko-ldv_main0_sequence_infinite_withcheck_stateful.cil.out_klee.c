...
static int backplane  ;
    klee_make_symbolic(&backplane, sizeof(int), "backplane");
static int clockp  ;
    klee_make_symbolic(&clockp, sizeof(int), "clockp");
static int clockm  ;
    klee_make_symbolic(&clockm, sizeof(int), "clockm");
...
{ struct pcmcia_device *var_group1 ;
  int res_com20020_probe_1 ;
    klee_make_symbolic(&res_com20020_probe_1, sizeof(int), "res_com20020_probe_1");
  int ldv_s_com20020_cs_driver_pcmcia_driver ;
    klee_make_symbolic(&ldv_s_com20020_cs_driver_pcmcia_driver, sizeof(int), "ldv_s_com20020_cs_driver_pcmcia_driver");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
