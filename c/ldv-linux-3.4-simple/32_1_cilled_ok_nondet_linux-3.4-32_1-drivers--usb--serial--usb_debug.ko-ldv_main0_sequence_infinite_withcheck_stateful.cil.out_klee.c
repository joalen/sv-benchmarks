...
{ struct tty_struct *var_group1 ;
  int var_usb_debug_break_ctl_0_p1 ;
    klee_make_symbolic(&var_usb_debug_break_ctl_0_p1, sizeof(int), "var_usb_debug_break_ctl_0_p1");
...
#include "model/32_1_cilled_true-unreach-call_ok_nondet_linux-3_false-termination.4-32_1-drivers--usb--serial--usb_debug.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out.env.c"
#include <klee/klee.h>
