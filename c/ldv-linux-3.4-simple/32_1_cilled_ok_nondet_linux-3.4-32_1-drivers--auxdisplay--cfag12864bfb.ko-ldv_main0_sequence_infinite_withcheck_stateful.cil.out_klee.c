...
static int res_cfag12864bfb_probe_1  ;
    klee_make_symbolic(&res_cfag12864bfb_probe_1, sizeof(int), "res_cfag12864bfb_probe_1");
void main(void) 
{ struct fb_info *var_group1 ;
  ...
  int ldv_s_cfag12864bfb_driver_platform_driver ;
    klee_make_symbolic(&ldv_s_cfag12864bfb_driver_platform_driver, sizeof(int), "ldv_s_cfag12864bfb_driver_platform_driver");
  int tmp___8 ;
  int tmp___9 ;
  int __cil_tmp8 ;
