...
static int res_lxt973_probe_5  ;
    klee_make_symbolic(&res_lxt973_probe_5, sizeof(int), "res_lxt973_probe_5");
void main(void) 
{ struct phy_device *var_group1 ;
  int tmp___7 ;
  int ldv_s_lxt973_driver_phy_driver ;
    klee_make_symbolic(&ldv_s_lxt973_driver_phy_driver, sizeof(int), "ldv_s_lxt973_driver_phy_driver");
  int tmp___8 ;
  int tmp___9 ;
  int __cil_tmp6 ;
