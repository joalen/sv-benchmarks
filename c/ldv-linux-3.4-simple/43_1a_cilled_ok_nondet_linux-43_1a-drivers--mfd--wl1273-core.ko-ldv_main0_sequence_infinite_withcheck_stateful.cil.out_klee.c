...
struct wl1273_fm_platform_data {
   ...
   unsigned int children ;
    klee_make_symbolic(&children, sizeof(int), "children");
};
struct wl1273_core {
   ...
   unsigned int channel_number ;
    klee_make_symbolic(&channel_number, sizeof(int), "channel_number");
   struct mutex lock ;
...
{ struct i2c_client *var_group1 ;
  ...
  int res_wl1273_core_probe_6 ;
    klee_make_symbolic(&res_wl1273_core_probe_6, sizeof(int), "res_wl1273_core_probe_6");
  int ldv_s_wl1273_core_driver_i2c_driver ;
    klee_make_symbolic(&ldv_s_wl1273_core_driver_i2c_driver, sizeof(int), "ldv_s_wl1273_core_driver_i2c_driver");
  int tmp ;
  int tmp___0 ;
