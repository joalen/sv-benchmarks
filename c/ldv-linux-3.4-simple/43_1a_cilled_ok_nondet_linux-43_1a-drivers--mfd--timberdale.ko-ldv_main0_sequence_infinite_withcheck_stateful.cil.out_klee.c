...
struct mfd_cell {
   ...
   size_t pdata_size ;
   int num_resources ;
    klee_make_symbolic(&num_resources, sizeof(int), "num_resources");
...
struct timbgpio_platform_data {
   ...
   int nr_pins ;
    klee_make_symbolic(&nr_pins, sizeof(int), "nr_pins");
   int irq_base ;
...
struct tsc2007_platform_data {
   ...
   unsigned long poll_delay ;
    klee_make_symbolic(&poll_delay, sizeof(long), "poll_delay");
   unsigned long poll_period ;
    klee_make_symbolic(&poll_period, sizeof(long), "poll_period");
   int fuzzx ;
    klee_make_symbolic(&fuzzx, sizeof(int), "fuzzx");
   int fuzzy ;
    klee_make_symbolic(&fuzzy, sizeof(int), "fuzzy");
   int fuzzz ;
    klee_make_symbolic(&fuzzz, sizeof(int), "fuzzz");
...
struct timb_radio_platform_data {
   int i2c_adapter ;
    klee_make_symbolic(&i2c_adapter, sizeof(int), "i2c_adapter");
...
struct timb_video_platform_data {
   int dma_channel ;
    klee_make_symbolic(&dma_channel, sizeof(int), "dma_channel");
   int i2c_adapter ;
...
struct timb_dma_platform_data_channel {
   ...
   unsigned int bytes_per_line ;
    klee_make_symbolic(&bytes_per_line, sizeof(int), "bytes_per_line");
   unsigned int descriptors ;
    klee_make_symbolic(&descriptors, sizeof(int), "descriptors");
   unsigned int descriptor_elements ;
    klee_make_symbolic(&descriptor_elements, sizeof(int), "descriptor_elements");
};
struct timb_dma_platform_data {
   unsigned int nr_channels ;
    klee_make_symbolic(&nr_channels, sizeof(int), "nr_channels");
...
struct ks8842_platform_data {
   u8 macaddr[6U] ;
   int rx_dma_channel ;
    klee_make_symbolic(&rx_dma_channel, sizeof(int), "rx_dma_channel");
   int tx_dma_channel ;
    klee_make_symbolic(&tx_dma_channel, sizeof(int), "tx_dma_channel");
};
...
{ struct pci_dev *var_group1 ;
  ...
  int res_timb_probe_1 ;
    klee_make_symbolic(&res_timb_probe_1, sizeof(int), "res_timb_probe_1");
  int ldv_s_timberdale_pci_driver_pci_driver ;
    klee_make_symbolic(&ldv_s_timberdale_pci_driver_pci_driver, sizeof(int), "ldv_s_timberdale_pci_driver_pci_driver");
  int tmp ;
