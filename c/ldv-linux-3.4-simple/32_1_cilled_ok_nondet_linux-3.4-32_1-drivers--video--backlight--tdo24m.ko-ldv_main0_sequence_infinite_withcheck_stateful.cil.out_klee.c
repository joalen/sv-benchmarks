...
struct tdo24m {
   ...
   int color_invert ;
    klee_make_symbolic(&color_invert, sizeof(int), "color_invert");
   int power ;
   int mode ;
};
...
{ struct spi_transfer *x ;
  ...
  uint32_t *p ;
  int nparams ;
    klee_make_symbolic(&nparams, sizeof(int), "nparams");
  int err ;
...
static int res_tdo24m_probe_9  ;
    klee_make_symbolic(&res_tdo24m_probe_9, sizeof(int), "res_tdo24m_probe_9");
void main(void) 
{ struct lcd_device *var_group1 ;
  int var_tdo24m_set_power_6_p1 ;
    klee_make_symbolic(&var_tdo24m_set_power_6_p1, sizeof(int), "var_tdo24m_set_power_6_p1");
  ...
  int ldv_s_tdo24m_driver_spi_driver ;
    klee_make_symbolic(&ldv_s_tdo24m_driver_spi_driver, sizeof(int), "ldv_s_tdo24m_driver_spi_driver");
  int tmp___7 ;
  int tmp___8 ;
  int __cil_tmp9 ;
  int var_tdo24m_suspend_11_p1_event10 ;
    klee_make_symbolic(&var_tdo24m_suspend_11_p1_event10, sizeof(int), "var_tdo24m_suspend_11_p1_event10");
