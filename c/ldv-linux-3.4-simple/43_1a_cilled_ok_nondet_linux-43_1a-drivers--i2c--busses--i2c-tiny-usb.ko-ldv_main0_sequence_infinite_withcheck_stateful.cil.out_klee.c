...
{ struct i2c_adapter *var_group1 ;
  ...
  int var_usb_xfer_0_p2 ;
    klee_make_symbolic(&var_usb_xfer_0_p2, sizeof(int), "var_usb_xfer_0_p2");
  struct usb_interface *var_group3 ;
  struct usb_device_id  const  *var_i2c_tiny_usb_probe_5_p1 ;
  int res_i2c_tiny_usb_probe_5 ;
    klee_make_symbolic(&res_i2c_tiny_usb_probe_5, sizeof(int), "res_i2c_tiny_usb_probe_5");
  int ldv_s_i2c_tiny_usb_driver_usb_driver ;
    klee_make_symbolic(&ldv_s_i2c_tiny_usb_driver_usb_driver, sizeof(int), "ldv_s_i2c_tiny_usb_driver_usb_driver");
  int tmp ;
  int tmp___0 ;
