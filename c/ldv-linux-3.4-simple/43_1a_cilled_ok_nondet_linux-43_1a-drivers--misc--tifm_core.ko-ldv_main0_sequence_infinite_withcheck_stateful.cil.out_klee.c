...
struct tifm_dev {
   ...
   unsigned int socket_id ;
    klee_make_symbolic(&socket_id, sizeof(int), "socket_id");
...
struct tifm_adapter {
   ...
   unsigned int irq_status ;
    klee_make_symbolic(&irq_status, sizeof(int), "irq_status");
   unsigned int socket_change_set ;
    klee_make_symbolic(&socket_change_set, sizeof(int), "socket_change_set");
   unsigned int id ;
    klee_make_symbolic(&id, sizeof(int), "id");
   unsigned int num_sockets ;
    klee_make_symbolic(&num_sockets, sizeof(int), "num_sockets");
...
{ struct device *var_group1 ;
  ...
  int res_tifm_device_probe_4 ;
    klee_make_symbolic(&res_tifm_device_probe_4, sizeof(int), "res_tifm_device_probe_4");
  pm_message_t var_tifm_device_suspend_7_p1 ;
  int ldv_s_tifm_bus_type_bus_type ;
    klee_make_symbolic(&ldv_s_tifm_bus_type_bus_type, sizeof(int), "ldv_s_tifm_bus_type_bus_type");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
  int var_tifm_device_suspend_7_p1_event10 ;
    klee_make_symbolic(&var_tifm_device_suspend_7_p1_event10, sizeof(int), "var_tifm_device_suspend_7_p1_event10");
