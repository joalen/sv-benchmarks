...
{ struct spi_device *var_group1 ;
  int res_mc33880_probe_3 ;
    klee_make_symbolic(&res_mc33880_probe_3, sizeof(int), "res_mc33880_probe_3");
  int ldv_s_mc33880_driver_spi_driver ;
    klee_make_symbolic(&ldv_s_mc33880_driver_spi_driver, sizeof(int), "ldv_s_mc33880_driver_spi_driver");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
