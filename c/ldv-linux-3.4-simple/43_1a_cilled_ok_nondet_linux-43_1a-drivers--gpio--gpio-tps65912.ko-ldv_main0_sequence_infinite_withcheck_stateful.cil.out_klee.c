...
struct tps65912_board {
   int is_dcdc1_avs ;
    klee_make_symbolic(&is_dcdc1_avs, sizeof(int), "is_dcdc1_avs");
   int is_dcdc2_avs ;
    klee_make_symbolic(&is_dcdc2_avs, sizeof(int), "is_dcdc2_avs");
   int is_dcdc3_avs ;
    klee_make_symbolic(&is_dcdc3_avs, sizeof(int), "is_dcdc3_avs");
   int is_dcdc4_avs ;
    klee_make_symbolic(&is_dcdc4_avs, sizeof(int), "is_dcdc4_avs");
   int irq ;
...
{ struct gpio_chip *var_group1 ;
  unsigned int var_tps65912_gpio_input_3_p1 ;
    klee_make_symbolic(&var_tps65912_gpio_input_3_p1, sizeof(int), "var_tps65912_gpio_input_3_p1");
  unsigned int var_tps65912_gpio_output_2_p1 ;
    klee_make_symbolic(&var_tps65912_gpio_output_2_p1, sizeof(int), "var_tps65912_gpio_output_2_p1");
  int var_tps65912_gpio_output_2_p2 ;
    klee_make_symbolic(&var_tps65912_gpio_output_2_p2, sizeof(int), "var_tps65912_gpio_output_2_p2");
  unsigned int var_tps65912_gpio_get_0_p1 ;
    klee_make_symbolic(&var_tps65912_gpio_get_0_p1, sizeof(int), "var_tps65912_gpio_get_0_p1");
  unsigned int var_tps65912_gpio_set_1_p1 ;
    klee_make_symbolic(&var_tps65912_gpio_set_1_p1, sizeof(int), "var_tps65912_gpio_set_1_p1");
  int var_tps65912_gpio_set_1_p2 ;
    klee_make_symbolic(&var_tps65912_gpio_set_1_p2, sizeof(int), "var_tps65912_gpio_set_1_p2");
  struct platform_device *var_group2 ;
  int res_tps65912_gpio_probe_4 ;
    klee_make_symbolic(&res_tps65912_gpio_probe_4, sizeof(int), "res_tps65912_gpio_probe_4");
  int ldv_s_tps65912_gpio_driver_platform_driver ;
    klee_make_symbolic(&ldv_s_tps65912_gpio_driver_platform_driver, sizeof(int), "ldv_s_tps65912_gpio_driver_platform_driver");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
