...
{ struct i2c_client *client ;
  ...
  unsigned int minute ;
    klee_make_symbolic(&minute, sizeof(int), "minute");
  unsigned int second ;
    klee_make_symbolic(&second, sizeof(int), "second");
  unsigned int week ;
    klee_make_symbolic(&week, sizeof(int), "week");
  unsigned int twelve_hr ;
    klee_make_symbolic(&twelve_hr, sizeof(int), "twelve_hr");
  unsigned int am_pm ;
    klee_make_symbolic(&am_pm, sizeof(int), "am_pm");
  unsigned int century ;
    klee_make_symbolic(&century, sizeof(int), "century");
  unsigned int add_century ;
    klee_make_symbolic(&add_century, sizeof(int), "add_century");
...
static int res_ds3232_probe_9  ;
    klee_make_symbolic(&res_ds3232_probe_9, sizeof(int), "res_ds3232_probe_9");
void main(void) 
{ struct device *var_group1 ;
  struct rtc_time *var_group2 ;
  struct rtc_wkalrm *var_group3 ;
  unsigned int var_ds3232_alarm_irq_enable_6_p1 ;
    klee_make_symbolic(&var_ds3232_alarm_irq_enable_6_p1, sizeof(int), "var_ds3232_alarm_irq_enable_6_p1");
  struct i2c_client *var_group4 ;
  struct i2c_device_id  const  *var_ds3232_probe_9_p1 ;
  int var_ds3232_irq_7_p0 ;
    klee_make_symbolic(&var_ds3232_irq_7_p0, sizeof(int), "var_ds3232_irq_7_p0");
  void *var_ds3232_irq_7_p1 ;
  int ldv_s_ds3232_driver_i2c_driver ;
    klee_make_symbolic(&ldv_s_ds3232_driver_i2c_driver, sizeof(int), "ldv_s_ds3232_driver_i2c_driver");
  int tmp___7 ;
  int tmp___8 ;
  int __cil_tmp12 ;
