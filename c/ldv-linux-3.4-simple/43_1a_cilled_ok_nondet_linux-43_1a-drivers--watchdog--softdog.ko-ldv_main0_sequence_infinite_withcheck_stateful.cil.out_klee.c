...
static int soft_panic  ;
    klee_make_symbolic(&soft_panic, sizeof(int), "soft_panic");
...
{ struct notifier_block *var_group1 ;
  unsigned long var_softdog_notify_sys_4_p1 ;
    klee_make_symbolic(&var_softdog_notify_sys_4_p1, sizeof(long), "var_softdog_notify_sys_4_p1");
  void *var_softdog_notify_sys_4_p2 ;
  struct watchdog_device *var_group2 ;
  unsigned int var_softdog_set_timeout_3_p1 ;
    klee_make_symbolic(&var_softdog_set_timeout_3_p1, sizeof(int), "var_softdog_set_timeout_3_p1");
  int tmp ;
