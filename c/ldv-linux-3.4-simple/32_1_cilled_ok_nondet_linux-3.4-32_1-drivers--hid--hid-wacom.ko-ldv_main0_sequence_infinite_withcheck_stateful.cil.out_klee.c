...
struct wacom_data {
   ...
   unsigned char high_speed ;
    klee_make_symbolic(&high_speed, sizeof(char), "high_speed");
   int battery_capacity ;
    klee_make_symbolic(&battery_capacity, sizeof(int), "battery_capacity");
...
{ struct hid_device *hdev ;
  ...
  int new_speed ;
    klee_make_symbolic(&new_speed, sizeof(int), "new_speed");
  int tmp ;
...
{ int tool ;
    klee_make_symbolic(&tool, sizeof(int), "tool");
  int x ;
  int y ;
...
static int res_wacom_probe_12  ;
    klee_make_symbolic(&res_wacom_probe_12, sizeof(int), "res_wacom_probe_12");
void main(void) 
{ struct hid_device *var_group1 ;
  ...
  int var_wacom_raw_event_10_p3 ;
    klee_make_symbolic(&var_wacom_raw_event_10_p3, sizeof(int), "var_wacom_raw_event_10_p3");
  ...
  int ldv_s_wacom_driver_hid_driver ;
    klee_make_symbolic(&ldv_s_wacom_driver_hid_driver, sizeof(int), "ldv_s_wacom_driver_hid_driver");
  int tmp___0 ;
  int tmp___1 ;
  int __cil_tmp15 ;
