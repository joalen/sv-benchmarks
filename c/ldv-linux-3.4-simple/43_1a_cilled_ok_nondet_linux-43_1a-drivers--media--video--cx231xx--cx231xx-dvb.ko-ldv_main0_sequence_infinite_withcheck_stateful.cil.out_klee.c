...
struct v4l2_ctrl {
   ...
   unsigned char manual_mode_value ;
    klee_make_symbolic(&manual_mode_value, sizeof(char), "manual_mode_value");
...
struct videobuf_dvb_frontends {
   ...
   struct dvb_adapter adapter ;
   int active_fe_id ;
    klee_make_symbolic(&active_fe_id, sizeof(int), "active_fe_id");
   int gate ;
    klee_make_symbolic(&gate, sizeof(int), "gate");
};
...
struct cx231xx_dmaqueue {
   ...
   u8 last_sav ;
   int current_field ;
    klee_make_symbolic(&current_field, sizeof(int), "current_field");
...
struct cx231xx_reg_seq {
   unsigned char bit ;
    klee_make_symbolic(&bit, sizeof(char), "bit");
   unsigned char val ;
...
struct cx231xx_board {
   ...
   v4l2_std_id norm ;
   int demod_addr ;
    klee_make_symbolic(&demod_addr, sizeof(int), "demod_addr");
   u8 demod_xfer_mode ;
   ...
   int output_mode ;
    klee_make_symbolic(&output_mode, sizeof(int), "output_mode");
...
struct cx231xx_tsport {
   ...
   int nr ;
   int sram_chno ;
    klee_make_symbolic(&sram_chno, sizeof(int), "sram_chno");
   ...
   u32 reg_src_sel ;
   int pci_irqmask ;
    klee_make_symbolic(&pci_irqmask, sizeof(int), "pci_irqmask");
   u32 dma_ctl_val ;
   u32 ts_int_msk_val ;
   u32 gen_ctrl_val ;
   u32 ts_clk_en_val ;
...
struct cx231xx {
   ...
   u32 gpio_val ;
   int power_mode ;
    klee_make_symbolic(&power_mode, sizeof(int), "power_mode");
