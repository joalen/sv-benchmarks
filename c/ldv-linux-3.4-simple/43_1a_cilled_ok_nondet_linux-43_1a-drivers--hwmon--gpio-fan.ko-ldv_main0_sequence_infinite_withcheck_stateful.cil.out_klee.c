...
struct gpio_fan_speed {
   int rpm ;
    klee_make_symbolic(&rpm, sizeof(int), "rpm");
   int ctrl_val ;
    klee_make_symbolic(&ctrl_val, sizeof(int), "ctrl_val");
};
struct gpio_fan_platform_data {
   int num_ctrl ;
    klee_make_symbolic(&num_ctrl, sizeof(int), "num_ctrl");
   unsigned int *ctrl ;
...
struct gpio_fan_data {
   ...
   struct gpio_fan_speed *speed ;
   int speed_index ;
    klee_make_symbolic(&speed_index, sizeof(int), "speed_index");
   int resume_speed ;
    klee_make_symbolic(&resume_speed, sizeof(int), "resume_speed");
   bool pwm_enable ;
   struct gpio_fan_alarm *alarm ;
...
{ int err ;
  ...
  int alarm_irq ;
    klee_make_symbolic(&alarm_irq, sizeof(int), "alarm_irq");
  struct platform_device *pdev ;
  ...
  long __constr_expr_0_counter41 ;
    klee_make_symbolic(&__constr_expr_0_counter41, sizeof(long), "__constr_expr_0_counter41");
...
{ struct gpio_fan_data *fan_data ;
  void *tmp ;
  unsigned long pwm ;
    klee_make_symbolic(&pwm, sizeof(long), "pwm");
  int speed_index ;
  int ret ;
...
{ struct platform_device *var_group1 ;
  int res_gpio_fan_probe_22 ;
    klee_make_symbolic(&res_gpio_fan_probe_22, sizeof(int), "res_gpio_fan_probe_22");
  pm_message_t var_gpio_fan_suspend_24_p1 ;
  int var_fan_alarm_irq_handler_1_p0 ;
    klee_make_symbolic(&var_fan_alarm_irq_handler_1_p0, sizeof(int), "var_fan_alarm_irq_handler_1_p0");
  void *var_fan_alarm_irq_handler_1_p1 ;
  int ldv_s_gpio_fan_driver_platform_driver ;
    klee_make_symbolic(&ldv_s_gpio_fan_driver_platform_driver, sizeof(int), "ldv_s_gpio_fan_driver_platform_driver");
  int tmp ;
  int tmp___0 ;
  int var_gpio_fan_suspend_24_p1_event9 ;
    klee_make_symbolic(&var_gpio_fan_suspend_24_p1_event9, sizeof(int), "var_gpio_fan_suspend_24_p1_event9");
