...
{ struct spk_synth *var_group1 ;
  int res_synth_probe_0 ;
    klee_make_symbolic(&res_synth_probe_0, sizeof(int), "res_synth_probe_0");
  int ldv_s_synth_acntsa_spk_synth ;
    klee_make_symbolic(&ldv_s_synth_acntsa_spk_synth, sizeof(int), "ldv_s_synth_acntsa_spk_synth");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
