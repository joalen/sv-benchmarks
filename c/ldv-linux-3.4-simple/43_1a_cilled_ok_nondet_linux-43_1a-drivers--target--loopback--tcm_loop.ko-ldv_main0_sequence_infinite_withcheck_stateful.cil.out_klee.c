...
struct inet_peer {
   ...
   unsigned long pmtu_expires ;
    klee_make_symbolic(&pmtu_expires, sizeof(long), "pmtu_expires");
   u32 pmtu_orig ;
   u32 pmtu_learned ;
...
struct rtable {
   ...
   __be32 rt_src ;
   int rt_route_iif ;
    klee_make_symbolic(&rt_route_iif, sizeof(int), "rt_route_iif");
   int rt_iif ;
    klee_make_symbolic(&rt_iif, sizeof(int), "rt_iif");
   int rt_oif ;
    klee_make_symbolic(&rt_oif, sizeof(int), "rt_oif");
   __u32 rt_mark ;
   __be32 rt_gateway ;
   __be32 rt_spec_dst ;
   u32 rt_peer_genid ;
...
struct t10_alua_lu_gp {
   u16 lu_gp_id ;
   int lu_gp_valid_id ;
    klee_make_symbolic(&lu_gp_valid_id, sizeof(int), "lu_gp_valid_id");
   u32 lu_gp_members ;
...
struct t10_alua_tg_pt_gp {
   ...
   int tg_pt_gp_valid_id ;
    klee_make_symbolic(&tg_pt_gp_valid_id, sizeof(int), "tg_pt_gp_valid_id");
   int tg_pt_gp_alua_access_status ;
    klee_make_symbolic(&tg_pt_gp_alua_access_status, sizeof(int), "tg_pt_gp_alua_access_status");
   int tg_pt_gp_alua_access_type ;
    klee_make_symbolic(&tg_pt_gp_alua_access_type, sizeof(int), "tg_pt_gp_alua_access_type");
   int tg_pt_gp_nonop_delay_msecs ;
    klee_make_symbolic(&tg_pt_gp_nonop_delay_msecs, sizeof(int), "tg_pt_gp_nonop_delay_msecs");
   int tg_pt_gp_trans_delay_msecs ;
    klee_make_symbolic(&tg_pt_gp_trans_delay_msecs, sizeof(int), "tg_pt_gp_trans_delay_msecs");
   int tg_pt_gp_pref ;
    klee_make_symbolic(&tg_pt_gp_pref, sizeof(int), "tg_pt_gp_pref");
   int tg_pt_gp_write_metadata ;
    klee_make_symbolic(&tg_pt_gp_write_metadata, sizeof(int), "tg_pt_gp_write_metadata");
...
struct t10_pr_registration {
   ...
   int pr_reg_all_tg_pt ;
    klee_make_symbolic(&pr_reg_all_tg_pt, sizeof(int), "pr_reg_all_tg_pt");
   int pr_reg_aptpl ;
    klee_make_symbolic(&pr_reg_aptpl, sizeof(int), "pr_reg_aptpl");
   int pr_res_holder ;
    klee_make_symbolic(&pr_res_holder, sizeof(int), "pr_res_holder");
   int pr_res_type ;
    klee_make_symbolic(&pr_res_type, sizeof(int), "pr_res_type");
   int pr_res_scope ;
    klee_make_symbolic(&pr_res_scope, sizeof(int), "pr_res_scope");
...
struct t10_reservation {
   int pr_all_tg_pt ;
    klee_make_symbolic(&pr_all_tg_pt, sizeof(int), "pr_all_tg_pt");
   int pr_aptpl_active ;
    klee_make_symbolic(&pr_aptpl_active, sizeof(int), "pr_aptpl_active");
...
struct se_task {
   unsigned long long task_lba ;
    klee_make_symbolic(&task_lba, sizeof(long), "task_lba");
   u32 task_sectors ;
   u32 task_size ;
...
struct se_tmr_req {
   ...
   u8 response ;
   int call_transport ;
    klee_make_symbolic(&call_transport, sizeof(int), "call_transport");
   u32 ref_task_tag ;
   u64 ref_task_lun ;
   void *fabric_tmr_ptr ;
...
struct se_cmd {
   ...
   int alua_nonop_delay ;
    klee_make_symbolic(&alua_nonop_delay, sizeof(int), "alua_nonop_delay");
   enum dma_data_direction data_direction ;
   int sam_task_attr ;
    klee_make_symbolic(&sam_task_attr, sizeof(int), "sam_task_attr");
   ...
   unsigned long long t_task_lba ;
    klee_make_symbolic(&t_task_lba, sizeof(long), "t_task_lba");
   ...
   unsigned int transport_state ;
    klee_make_symbolic(&transport_state, sizeof(int), "transport_state");
   ...
   unsigned int t_data_nents ;
    klee_make_symbolic(&t_data_nents, sizeof(int), "t_data_nents");
   void *t_data_vmap ;
   struct scatterlist *t_bidi_data_sg ;
   unsigned int t_bidi_data_nents ;
    klee_make_symbolic(&t_bidi_data_nents, sizeof(int), "t_bidi_data_nents");
...
struct se_dev_attrib {
   int emulate_dpo ;
    klee_make_symbolic(&emulate_dpo, sizeof(int), "emulate_dpo");
   int emulate_fua_write ;
    klee_make_symbolic(&emulate_fua_write, sizeof(int), "emulate_fua_write");
   int emulate_fua_read ;
    klee_make_symbolic(&emulate_fua_read, sizeof(int), "emulate_fua_read");
   int emulate_write_cache ;
    klee_make_symbolic(&emulate_write_cache, sizeof(int), "emulate_write_cache");
   int emulate_ua_intlck_ctrl ;
    klee_make_symbolic(&emulate_ua_intlck_ctrl, sizeof(int), "emulate_ua_intlck_ctrl");
   int emulate_tas ;
    klee_make_symbolic(&emulate_tas, sizeof(int), "emulate_tas");
   int emulate_tpu ;
    klee_make_symbolic(&emulate_tpu, sizeof(int), "emulate_tpu");
   int emulate_tpws ;
    klee_make_symbolic(&emulate_tpws, sizeof(int), "emulate_tpws");
   int emulate_reservations ;
    klee_make_symbolic(&emulate_reservations, sizeof(int), "emulate_reservations");
   int emulate_alua ;
    klee_make_symbolic(&emulate_alua, sizeof(int), "emulate_alua");
   int enforce_pr_isids ;
    klee_make_symbolic(&enforce_pr_isids, sizeof(int), "enforce_pr_isids");
   int is_nonrot ;
    klee_make_symbolic(&is_nonrot, sizeof(int), "is_nonrot");
   int emulate_rest_reord ;
    klee_make_symbolic(&emulate_rest_reord, sizeof(int), "emulate_rest_reord");
   u32 hw_block_size ;
   u32 block_size ;
   u32 hw_max_sectors ;
   u32 max_sectors ;
...
struct se_port {
   ...
   int sep_tg_pt_secondary_stat ;
    klee_make_symbolic(&sep_tg_pt_secondary_stat, sizeof(int), "sep_tg_pt_secondary_stat");
   int sep_tg_pt_secondary_write_md ;
    klee_make_symbolic(&sep_tg_pt_secondary_write_md, sizeof(int), "sep_tg_pt_secondary_write_md");
   u32 sep_index ;
...
struct tcm_loop_nexus {
   int it_nexus_active ;
    klee_make_symbolic(&it_nexus_active, sizeof(int), "it_nexus_active");
   struct scsi_host *sh ;
   struct se_session *se_sess ;
};
...
struct tcm_loop_tpg {
   unsigned short tl_tpgt ;
    klee_make_symbolic(&tl_tpgt, sizeof(short), "tl_tpgt");
...
static int tcm_loop_hba_no_cnt  ;
    klee_make_symbolic(&tcm_loop_hba_no_cnt, sizeof(int), "tcm_loop_hba_no_cnt");
...
{ struct tcm_loop_cmd *tl_cmd ;
  ...
  long __constr_expr_0_counter69 ;
    klee_make_symbolic(&__constr_expr_0_counter69, sizeof(long), "__constr_expr_0_counter69");
...
{ struct tcm_loop_hba *tl_hba ;
  ...
  int ret ;
  unsigned short tpgt ;
    klee_make_symbolic(&tpgt, sizeof(short), "tpgt");
  void *tmp ;
...
{ struct device *var_group1 ;
  ...
  int res_tcm_loop_driver_probe_11 ;
    klee_make_symbolic(&res_tcm_loop_driver_probe_11, sizeof(int), "res_tcm_loop_driver_probe_11");
  ...
  int var_tcm_loop_proc_info_2_p4 ;
    klee_make_symbolic(&var_tcm_loop_proc_info_2_p4, sizeof(int), "var_tcm_loop_proc_info_2_p4");
  int var_tcm_loop_proc_info_2_p5 ;
    klee_make_symbolic(&var_tcm_loop_proc_info_2_p5, sizeof(int), "var_tcm_loop_proc_info_2_p5");
  struct scsi_cmnd *var_group4 ;
  struct scsi_device *var_group5 ;
  int var_tcm_loop_change_queue_depth_4_p1 ;
    klee_make_symbolic(&var_tcm_loop_change_queue_depth_4_p1, sizeof(int), "var_tcm_loop_change_queue_depth_4_p1");
  int var_tcm_loop_change_queue_depth_4_p2 ;
    klee_make_symbolic(&var_tcm_loop_change_queue_depth_4_p2, sizeof(int), "var_tcm_loop_change_queue_depth_4_p2");
  int ldv_s_tcm_loop_lld_bus_bus_type ;
    klee_make_symbolic(&ldv_s_tcm_loop_lld_bus_bus_type, sizeof(int), "ldv_s_tcm_loop_lld_bus_bus_type");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
...
#include "model/43_1a_cilled_true-unreach-call_ok_nondet_linux-43_1a-drivers--target--loopback--tcm_loop.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out.env.c"
#include <klee/klee.h>
