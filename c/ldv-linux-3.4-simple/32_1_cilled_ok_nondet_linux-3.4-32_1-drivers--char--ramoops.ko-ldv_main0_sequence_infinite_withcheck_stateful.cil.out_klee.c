...
struct ramoops_platform_data {
   unsigned long mem_size ;
    klee_make_symbolic(&mem_size, sizeof(long), "mem_size");
   unsigned long mem_address ;
    klee_make_symbolic(&mem_address, sizeof(long), "mem_address");
   unsigned long record_size ;
    klee_make_symbolic(&record_size, sizeof(long), "record_size");
   int dump_oops ;
    klee_make_symbolic(&dump_oops, sizeof(int), "dump_oops");
};
