...
struct v3020_platform_data {
   int leftshift ;
    klee_make_symbolic(&leftshift, sizeof(int), "leftshift");
   unsigned char use_gpio : 1 ;
   unsigned int gpio_cs ;
    klee_make_symbolic(&gpio_cs, sizeof(int), "gpio_cs");
   unsigned int gpio_wr ;
    klee_make_symbolic(&gpio_wr, sizeof(int), "gpio_wr");
   unsigned int gpio_rd ;
    klee_make_symbolic(&gpio_rd, sizeof(int), "gpio_rd");
   unsigned int gpio_io ;
    klee_make_symbolic(&gpio_io, sizeof(int), "gpio_io");
};
typedef u32 phandle;
struct property {
   char *name ;
...
{ struct v3020 *var_group1 ;
  ...
  unsigned char var_v3020_mmio_write_bit_2_p1 ;
    klee_make_symbolic(&var_v3020_mmio_write_bit_2_p1, sizeof(char), "var_v3020_mmio_write_bit_2_p1");
  struct v3020_platform_data *var_v3020_gpio_map_4_p2 ;
  unsigned char var_v3020_gpio_write_bit_6_p1 ;
    klee_make_symbolic(&var_v3020_gpio_write_bit_6_p1, sizeof(char), "var_v3020_gpio_write_bit_6_p1");
  struct device *var_group3 ;
  struct rtc_time *var_group4 ;
  int res_rtc_probe_12 ;
    klee_make_symbolic(&res_rtc_probe_12, sizeof(int), "res_rtc_probe_12");
  int ldv_s_rtc_device_driver_platform_driver ;
    klee_make_symbolic(&ldv_s_rtc_device_driver_platform_driver, sizeof(int), "ldv_s_rtc_device_driver_platform_driver");
  int tmp ;
  int tmp___0 ;
  int __cil_tmp13 ;
  unsigned char __cil_tmp14 ;
