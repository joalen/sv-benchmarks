...
{ int chars_sent ;
    klee_make_symbolic(&chars_sent, sizeof(int), "chars_sent");
  char *cp ;
  char *init ;
  char ch ;
...
static int last_index  ;
    klee_make_symbolic(&last_index, sizeof(int), "last_index");
static ssize_t softsynth_write(struct file *fp , char const   *buf , size_t count ,
                               loff_t *pos ) 
{ unsigned long supplied_index ;
    klee_make_symbolic(&supplied_index, sizeof(long), "supplied_index");
  int converted ;
    klee_make_symbolic(&converted, sizeof(int), "converted");
  unsigned long *__cil_tmp7 ;
  unsigned long *__cil_tmp8 ;
...
{ struct spk_synth *var_group1 ;
  int res_softsynth_probe_7 ;
    klee_make_symbolic(&res_softsynth_probe_7, sizeof(int), "res_softsynth_probe_7");
  ...
  int res_softsynth_open_1 ;
    klee_make_symbolic(&res_softsynth_open_1, sizeof(int), "res_softsynth_open_1");
  int ldv_s_synth_soft_spk_synth ;
    klee_make_symbolic(&ldv_s_synth_soft_spk_synth, sizeof(int), "ldv_s_synth_soft_spk_synth");
  int ldv_s_softsynth_fops_file_operations ;
    klee_make_symbolic(&ldv_s_softsynth_fops_file_operations, sizeof(int), "ldv_s_softsynth_fops_file_operations");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
  int __cil_tmp20 ;
