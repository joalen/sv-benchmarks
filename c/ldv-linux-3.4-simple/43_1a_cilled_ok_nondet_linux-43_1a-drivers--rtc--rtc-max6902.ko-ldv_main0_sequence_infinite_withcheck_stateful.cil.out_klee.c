...
{ struct device *var_group1 ;
  ...
  int res_max6902_probe_4 ;
    klee_make_symbolic(&res_max6902_probe_4, sizeof(int), "res_max6902_probe_4");
  int ldv_s_max6902_driver_spi_driver ;
    klee_make_symbolic(&ldv_s_max6902_driver_spi_driver, sizeof(int), "ldv_s_max6902_driver_spi_driver");
  int tmp ;
  int tmp___0 ;
