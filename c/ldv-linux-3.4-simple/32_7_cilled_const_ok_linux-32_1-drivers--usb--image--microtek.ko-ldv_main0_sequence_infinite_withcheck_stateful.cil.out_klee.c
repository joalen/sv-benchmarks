...
struct mts_transfer_context {
   ...
   int data_pipe ;
    klee_make_symbolic(&data_pipe, sizeof(int), "data_pipe");
   int fragment ;
    klee_make_symbolic(&fragment, sizeof(int), "fragment");
   u8 *scsi_status ;
};
struct mts_desc {
...
{ int i ;
  ...
  int ep_out ;
    klee_make_symbolic(&ep_out, sizeof(int), "ep_out");
  int ep_in_set[3] ;
  int *ep_in_current ;
  int err_retval ;
    klee_make_symbolic(&err_retval, sizeof(int), "err_retval");
...
static int res_mts_usb_probe_18  ;
    klee_make_symbolic(&res_mts_usb_probe_18, sizeof(int), "res_mts_usb_probe_18");
void main(void) 
{ struct usb_interface *var_group1 ;
  ...
  int ldv_s_mts_usb_driver_usb_driver ;
    klee_make_symbolic(&ldv_s_mts_usb_driver_usb_driver, sizeof(int), "ldv_s_mts_usb_driver_usb_driver");
  int tmp___7 ;
  int tmp___8 ;
  int __cil_tmp8 ;
