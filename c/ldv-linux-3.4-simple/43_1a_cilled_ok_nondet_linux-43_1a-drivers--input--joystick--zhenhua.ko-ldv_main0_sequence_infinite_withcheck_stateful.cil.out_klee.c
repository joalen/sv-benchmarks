...
{ struct serio *var_group1 ;
  unsigned char var_zhenhua_interrupt_2_p1 ;
    klee_make_symbolic(&var_zhenhua_interrupt_2_p1, sizeof(char), "var_zhenhua_interrupt_2_p1");
  unsigned int var_zhenhua_interrupt_2_p2 ;
    klee_make_symbolic(&var_zhenhua_interrupt_2_p2, sizeof(int), "var_zhenhua_interrupt_2_p2");
  struct serio_driver *var_group2 ;
  int res_zhenhua_connect_4 ;
    klee_make_symbolic(&res_zhenhua_connect_4, sizeof(int), "res_zhenhua_connect_4");
  int ldv_s_zhenhua_drv_serio_driver ;
    klee_make_symbolic(&ldv_s_zhenhua_drv_serio_driver, sizeof(int), "ldv_s_zhenhua_drv_serio_driver");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
  int __cil_tmp10 ;
