...
static int res_tr_connect_2  ;
    klee_make_symbolic(&res_tr_connect_2, sizeof(int), "res_tr_connect_2");
void main(void) 
{ struct serio *var_group1 ;
  unsigned char var_tr_interrupt_0_p1 ;
    klee_make_symbolic(&var_tr_interrupt_0_p1, sizeof(char), "var_tr_interrupt_0_p1");
  unsigned int var_tr_interrupt_0_p2 ;
    klee_make_symbolic(&var_tr_interrupt_0_p2, sizeof(int), "var_tr_interrupt_0_p2");
  struct serio_driver *var_group2 ;
  int tmp ;
  int ldv_s_tr_drv_serio_driver ;
    klee_make_symbolic(&ldv_s_tr_drv_serio_driver, sizeof(int), "ldv_s_tr_drv_serio_driver");
  int tmp___0 ;
  int tmp___1 ;
  int __cil_tmp9 ;
