...
{ struct platform_device *var_group1 ;
  ...
  int ldv_s_w1_gpio_driver_platform_driver ;
    klee_make_symbolic(&ldv_s_w1_gpio_driver_platform_driver, sizeof(int), "ldv_s_w1_gpio_driver_platform_driver");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
  int var_w1_gpio_suspend_5_p1_event7 ;
    klee_make_symbolic(&var_w1_gpio_suspend_5_p1_event7, sizeof(int), "var_w1_gpio_suspend_5_p1_event7");
