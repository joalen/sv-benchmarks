...
struct xenkbd_info {
   ...
   int gref ;
    klee_make_symbolic(&gref, sizeof(int), "gref");
   int irq ;
...
{ int ret ;
  ...
  int abs ;
    klee_make_symbolic(&abs, sizeof(int), "abs");
  struct xenkbd_info *info ;
  struct input_dev *kbd ;
  struct input_dev *ptr ;
  void *tmp ;
...
{ int var_input_handler_0_p0 ;
    klee_make_symbolic(&var_input_handler_0_p0, sizeof(int), "var_input_handler_0_p0");
