...
{ struct net_device *var_group1 ;
  int var_rx_2_p1 ;
    klee_make_symbolic(&var_rx_2_p1, sizeof(int), "var_rx_2_p1");
  struct archdr *var_rx_2_p2 ;
  int var_rx_2_p3 ;
    klee_make_symbolic(&var_rx_2_p3, sizeof(int), "var_rx_2_p3");
  struct sk_buff *var_group2 ;
  unsigned int var_build_header_3_p2 ;
    klee_make_symbolic(&var_build_header_3_p2, sizeof(int), "var_build_header_3_p2");
  uint8_t var_build_header_3_p3 ;
  struct archdr *var_group3 ;
  int var_prepare_tx_4_p2 ;
    klee_make_symbolic(&var_prepare_tx_4_p2, sizeof(int), "var_prepare_tx_4_p2");
  int var_prepare_tx_4_p3 ;
    klee_make_symbolic(&var_prepare_tx_4_p3, sizeof(int), "var_prepare_tx_4_p3");
  int tmp___7 ;
  int tmp___8 ;
  int tmp___9 ;
