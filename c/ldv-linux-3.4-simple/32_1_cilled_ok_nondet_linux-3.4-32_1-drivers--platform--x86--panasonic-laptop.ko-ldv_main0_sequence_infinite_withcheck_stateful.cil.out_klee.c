...
struct pcc_acpi {
   ...
   unsigned long num_sifr ;
    klee_make_symbolic(&num_sifr, sizeof(long), "num_sifr");
   int sticky_mode ;
    klee_make_symbolic(&sticky_mode, sizeof(int), "sticky_mode");
   u32 *sinf ;
...
{ struct acpi_device *var_group1 ;
  int var_acpi_pcc_hotkey_remove_17_p1 ;
    klee_make_symbolic(&var_acpi_pcc_hotkey_remove_17_p1, sizeof(int), "var_acpi_pcc_hotkey_remove_17_p1");
