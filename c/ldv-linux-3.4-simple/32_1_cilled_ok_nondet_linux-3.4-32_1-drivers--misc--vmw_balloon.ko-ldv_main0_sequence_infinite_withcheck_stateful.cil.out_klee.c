...
struct vmballoon_stats {
   ...
   unsigned int sleep_alloc ;
    klee_make_symbolic(&sleep_alloc, sizeof(int), "sleep_alloc");
   unsigned int sleep_alloc_fail ;
    klee_make_symbolic(&sleep_alloc_fail, sizeof(int), "sleep_alloc_fail");
   unsigned int refused_alloc ;
    klee_make_symbolic(&refused_alloc, sizeof(int), "refused_alloc");
   unsigned int refused_free ;
    klee_make_symbolic(&refused_free, sizeof(int), "refused_free");
   unsigned int free ;
    klee_make_symbolic(&free, sizeof(int), "free");
   unsigned int lock ;
    klee_make_symbolic(&lock, sizeof(int), "lock");
   unsigned int lock_fail ;
    klee_make_symbolic(&lock_fail, sizeof(int), "lock_fail");
   unsigned int unlock ;
    klee_make_symbolic(&unlock, sizeof(int), "unlock");
   unsigned int unlock_fail ;
    klee_make_symbolic(&unlock_fail, sizeof(int), "unlock_fail");
   unsigned int target ;
    klee_make_symbolic(&target, sizeof(int), "target");
   unsigned int target_fail ;
    klee_make_symbolic(&target_fail, sizeof(int), "target_fail");
   unsigned int start ;
   unsigned int start_fail ;
    klee_make_symbolic(&start_fail, sizeof(int), "start_fail");
   unsigned int guest_type ;
    klee_make_symbolic(&guest_type, sizeof(int), "guest_type");
   unsigned int guest_type_fail ;
    klee_make_symbolic(&guest_type_fail, sizeof(int), "guest_type_fail");
};
struct vmballoon {
   struct list_head pages ;
   struct list_head refused_pages ;
   unsigned int n_refused_pages ;
    klee_make_symbolic(&n_refused_pages, sizeof(int), "n_refused_pages");
   unsigned int size ;
   unsigned int target ;
   bool reset_required ;
   unsigned int rate_alloc ;
    klee_make_symbolic(&rate_alloc, sizeof(int), "rate_alloc");
   unsigned int rate_free ;
    klee_make_symbolic(&rate_free, sizeof(int), "rate_free");
   unsigned int slow_allocation_cycles ;
    klee_make_symbolic(&slow_allocation_cycles, sizeof(int), "slow_allocation_cycles");
...
{ unsigned long status ;
  ...
  unsigned long __stat ;
    klee_make_symbolic(&__stat, sizeof(long), "__stat");
...
{ struct page *page ;
  ...
  unsigned int hv_status ;
    klee_make_symbolic(&hv_status, sizeof(int), "hv_status");
  int locked ;
...
static void vmballoon_inflate(struct vmballoon *b ) 
{ unsigned int goal ;
    klee_make_symbolic(&goal, sizeof(int), "goal");
  unsigned int rate ;
    klee_make_symbolic(&rate, sizeof(int), "rate");
  unsigned int i ;
    klee_make_symbolic(&i, sizeof(int), "i");
  unsigned int allocations ;
    klee_make_symbolic(&allocations, sizeof(int), "allocations");
  int error ;
...
{ int error ;
  ...
  long __constr_expr_0_counter32 ;
    klee_make_symbolic(&__constr_expr_0_counter32, sizeof(long), "__constr_expr_0_counter32");
...
static int res_vmballoon_debug_open_15  ;
    klee_make_symbolic(&res_vmballoon_debug_open_15, sizeof(int), "res_vmballoon_debug_open_15");
void main(void) 
{ struct inode *var_group1 ;
  struct file *var_group2 ;
  int tmp___7 ;
  int ldv_s_vmballoon_debug_fops_file_operations ;
    klee_make_symbolic(&ldv_s_vmballoon_debug_fops_file_operations, sizeof(int), "ldv_s_vmballoon_debug_fops_file_operations");
  int tmp___8 ;
  int tmp___9 ;
  int __cil_tmp7 ;
