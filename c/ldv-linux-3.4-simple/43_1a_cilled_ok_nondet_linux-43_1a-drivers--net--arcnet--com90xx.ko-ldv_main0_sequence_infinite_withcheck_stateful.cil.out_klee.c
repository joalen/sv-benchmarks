...
static int numcards  ;
    klee_make_symbolic(&numcards, sizeof(int), "numcards");
static int com90xx_skip_probe  =    0;
static int io  ;
    klee_make_symbolic(&io, sizeof(int), "io");
static int irq  ;
static int shmem  ;
    klee_make_symbolic(&shmem, sizeof(int), "shmem");
...
{ int count ;
  ...
  int ioaddr ;
    klee_make_symbolic(&ioaddr, sizeof(int), "ioaddr");
  int numprint ;
    klee_make_symbolic(&numprint, sizeof(int), "numprint");
  int airq ;
    klee_make_symbolic(&airq, sizeof(int), "airq");
  int openparen ;
    klee_make_symbolic(&openparen, sizeof(int), "openparen");
  unsigned long airqmask ;
    klee_make_symbolic(&airqmask, sizeof(long), "airqmask");
  int ports[32U] ;
  unsigned long *shmems ;
  void **iomem ;
  int numports ;
    klee_make_symbolic(&numports, sizeof(int), "numports");
  int numshmems ;
    klee_make_symbolic(&numshmems, sizeof(int), "numshmems");
  int *port ;
  u_long *p ;
  int index ;
  void *tmp ;
  ...
  u_long ptr ;
    klee_make_symbolic(&ptr, sizeof(long), "ptr");
  void *base___0 ;
  int tmp___21 ;
...
{ struct net_device *dev ;
  ...
  u_long first_mirror ;
    klee_make_symbolic(&first_mirror, sizeof(long), "first_mirror");
  u_long last_mirror ;
    klee_make_symbolic(&last_mirror, sizeof(long), "last_mirror");
  int mirror_size ;
    klee_make_symbolic(&mirror_size, sizeof(int), "mirror_size");
  void *tmp ;
  unsigned char tmp___0 ;
  int tmp___1 ;
  int tmp___2 ;
...
{ short ioaddr ;
  ...
  unsigned char __cil_tmp7 ;
    klee_make_symbolic(&__cil_tmp7, sizeof(char), "__cil_tmp7");
  int __cil_tmp8 ;
