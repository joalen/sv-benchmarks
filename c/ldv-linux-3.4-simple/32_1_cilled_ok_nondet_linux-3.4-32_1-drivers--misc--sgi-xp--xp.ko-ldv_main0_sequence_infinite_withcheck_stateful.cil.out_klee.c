...
{ enum xp_retval ret ;
  int ch_number ;
    klee_make_symbolic(&ch_number, sizeof(int), "ch_number");
  int tmp ;
...
{ unsigned long paddr ;
  ...
  unsigned long remap_base ;
    klee_make_symbolic(&remap_base, sizeof(long), "remap_base");
  unsigned long tcp_ptr__ ;
  void const   *__vpp_verify ;
  unsigned long remap_top ;
    klee_make_symbolic(&remap_top, sizeof(long), "remap_top");
  unsigned long tcp_ptr_____0 ;
  void const   *__vpp_verify___0 ;
  unsigned long tcp_ptr_____1 ;
  void const   *__vpp_verify___1 ;
...
extern long sn_region_size ;
    klee_make_symbolic(&sn_region_size, sizeof(long), "sn_region_size");
