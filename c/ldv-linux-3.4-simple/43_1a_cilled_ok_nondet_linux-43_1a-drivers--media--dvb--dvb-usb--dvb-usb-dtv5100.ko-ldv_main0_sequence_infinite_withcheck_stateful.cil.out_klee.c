...
{ struct i2c_adapter *var_group1 ;
  ...
  int res_dtv5100_probe_4 ;
    klee_make_symbolic(&res_dtv5100_probe_4, sizeof(int), "res_dtv5100_probe_4");
  int ldv_s_dtv5100_driver_usb_driver ;
    klee_make_symbolic(&ldv_s_dtv5100_driver_usb_driver, sizeof(int), "ldv_s_dtv5100_driver_usb_driver");
  int tmp ;
  int tmp___0 ;
