...
struct mwifiex_adapter {
   ...
   char fw_name[32U] ;
   int winner ;
    klee_make_symbolic(&winner, sizeof(int), "winner");
   struct device *dev ;
...
{ struct mwifiex_adapter *adapter ;
  struct pcie_service_card *card ;
  int hs_actived ;
    klee_make_symbolic(&hs_actived, sizeof(int), "hs_actived");
  int i ;
  void *tmp ;
...
{ struct mwifiex_adapter *var_group1 ;
  ...
  int var_mwifiex_pcie_interrupt_33_p0 ;
    klee_make_symbolic(&var_mwifiex_pcie_interrupt_33_p0, sizeof(int), "var_mwifiex_pcie_interrupt_33_p0");
