...
static int input_mode  ;
    klee_make_symbolic(&input_mode, sizeof(int), "input_mode");
...
{ struct i2c_client *var_group1 ;
  ...
  int res_pcf8591_probe_4 ;
    klee_make_symbolic(&res_pcf8591_probe_4, sizeof(int), "res_pcf8591_probe_4");
  int res_pcf8591_remove_5 ;
    klee_make_symbolic(&res_pcf8591_remove_5, sizeof(int), "res_pcf8591_remove_5");
  int ldv_s_pcf8591_driver_i2c_driver ;
    klee_make_symbolic(&ldv_s_pcf8591_driver_i2c_driver, sizeof(int), "ldv_s_pcf8591_driver_i2c_driver");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
