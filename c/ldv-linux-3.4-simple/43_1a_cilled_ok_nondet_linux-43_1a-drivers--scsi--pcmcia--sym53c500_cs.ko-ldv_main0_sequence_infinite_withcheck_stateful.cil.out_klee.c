...
struct scsi_info_t {
   ...
   unsigned short manf_id ;
    klee_make_symbolic(&manf_id, sizeof(short), "manf_id");
};
struct sym53c500_data {
   struct scsi_cmnd *current_SC ;
   int fast_pio ;
    klee_make_symbolic(&fast_pio, sizeof(int), "fast_pio");
};
...
{ unsigned long flags ;
  ...
  unsigned char int_reg ;
    klee_make_symbolic(&int_reg, sizeof(char), "int_reg");
  unsigned char pio_status ;
    klee_make_symbolic(&pio_status, sizeof(char), "pio_status");
  int port_base ;
    klee_make_symbolic(&port_base, sizeof(int), "port_base");
  ...
  unsigned char __cil_tmp119 ;
    klee_make_symbolic(&__cil_tmp119, sizeof(char), "__cil_tmp119");
  int __cil_tmp120 ;
...
{ int pio ;
    klee_make_symbolic(&pio, sizeof(int), "pio");
  struct Scsi_Host *SHp ;
  struct device  const  *__mptr ;
  struct sym53c500_data *data ;
  unsigned long tmp ;
...
{ struct device *var_group1 ;
  ...
  int res_SYM53C500_probe_15 ;
    klee_make_symbolic(&res_SYM53C500_probe_15, sizeof(int), "res_SYM53C500_probe_15");
  int var_SYM53C500_intr_4_p0 ;
    klee_make_symbolic(&var_SYM53C500_intr_4_p0, sizeof(int), "var_SYM53C500_intr_4_p0");
  void *var_SYM53C500_intr_4_p1 ;
  int ldv_s_sym53c500_cs_driver_pcmcia_driver ;
    klee_make_symbolic(&ldv_s_sym53c500_cs_driver_pcmcia_driver, sizeof(int), "ldv_s_sym53c500_cs_driver_pcmcia_driver");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
...
#include "model/43_1a_cilled_true-unreach-call_ok_nondet_linux-43_1a-drivers--scsi--pcmcia--sym53c500_cs.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out.env.c"
#include <klee/klee.h>
