...
static int res_mma8450_probe_6  ;
    klee_make_symbolic(&res_mma8450_probe_6, sizeof(int), "res_mma8450_probe_6");
void main(void) 
{ struct i2c_client *var_group1 ;
  struct i2c_device_id  const  *var_mma8450_probe_6_p1 ;
  int ldv_s_mma8450_driver_i2c_driver ;
    klee_make_symbolic(&ldv_s_mma8450_driver_i2c_driver, sizeof(int), "ldv_s_mma8450_driver_i2c_driver");
  int tmp___7 ;
  int tmp___8 ;
  int __cil_tmp6 ;
