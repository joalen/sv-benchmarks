...
union __anonunion____missing_field_name_285 {
   unsigned long error_addr ;
    klee_make_symbolic(&error_addr, sizeof(long), "error_addr");
   unsigned long feature_addr ;
    klee_make_symbolic(&feature_addr, sizeof(long), "feature_addr");
};
union __anonunion____missing_field_name_286 {
   unsigned long status_addr ;
    klee_make_symbolic(&status_addr, sizeof(long), "status_addr");
   unsigned long command_addr ;
    klee_make_symbolic(&command_addr, sizeof(long), "command_addr");
};
struct ide_io_ports {
   unsigned long data_addr ;
    klee_make_symbolic(&data_addr, sizeof(long), "data_addr");
   union __anonunion____missing_field_name_285 __annonCompField51 ;
   unsigned long nsect_addr ;
    klee_make_symbolic(&nsect_addr, sizeof(long), "nsect_addr");
   unsigned long lbal_addr ;
    klee_make_symbolic(&lbal_addr, sizeof(long), "lbal_addr");
   unsigned long lbam_addr ;
    klee_make_symbolic(&lbam_addr, sizeof(long), "lbam_addr");
   unsigned long lbah_addr ;
    klee_make_symbolic(&lbah_addr, sizeof(long), "lbah_addr");
   unsigned long device_addr ;
    klee_make_symbolic(&device_addr, sizeof(long), "device_addr");
   union __anonunion____missing_field_name_286 __annonCompField52 ;
   unsigned long ctl_addr ;
    klee_make_symbolic(&ctl_addr, sizeof(long), "ctl_addr");
   unsigned long irq_addr ;
    klee_make_symbolic(&irq_addr, sizeof(long), "irq_addr");
};
...
struct ide_cmd {
   ...
   int sg_nents ;
    klee_make_symbolic(&sg_nents, sizeof(int), "sg_nents");
   int orig_sg_nents ;
    klee_make_symbolic(&orig_sg_nents, sizeof(int), "orig_sg_nents");
   int sg_dma_direction ;
    klee_make_symbolic(&sg_dma_direction, sizeof(int), "sg_dma_direction");
   unsigned int nbytes ;
    klee_make_symbolic(&nbytes, sizeof(int), "nbytes");
   unsigned int nleft ;
    klee_make_symbolic(&nleft, sizeof(int), "nleft");
   unsigned int last_xfer_len ;
    klee_make_symbolic(&last_xfer_len, sizeof(int), "last_xfer_len");
...
struct ide_atapi_pc {
   ...
   int error ;
   int req_xfer ;
    klee_make_symbolic(&req_xfer, sizeof(int), "req_xfer");
   struct request *rq ;
   unsigned long flags ;
   unsigned long timeout ;
};
...
struct ide_drive_s {
   ...
   unsigned long dev_flags ;
    klee_make_symbolic(&dev_flags, sizeof(long), "dev_flags");
   unsigned long sleep ;
   ...
   unsigned int bios_cyl ;
    klee_make_symbolic(&bios_cyl, sizeof(int), "bios_cyl");
   unsigned int cyl ;
   ...
   unsigned int max_failures ;
    klee_make_symbolic(&max_failures, sizeof(int), "max_failures");
   u64 probed_capacity ;
   u64 capacity64 ;
   int lun ;
    klee_make_symbolic(&lun, sizeof(int), "lun");
   int crc_count ;
    klee_make_symbolic(&crc_count, sizeof(int), "crc_count");
   unsigned long debug_mask ;
    klee_make_symbolic(&debug_mask, sizeof(long), "debug_mask");
   ...
   unsigned long atapi_flags ;
    klee_make_symbolic(&atapi_flags, sizeof(long), "atapi_flags");
...
struct hwif_s {
   ...
   unsigned long port_flags ;
    klee_make_symbolic(&port_flags, sizeof(long), "port_flags");
   u8 major ;
   u8 index ;
   u8 channel ;
   u32 host_flags ;
   ...
   int prd_max_nents ;
    klee_make_symbolic(&prd_max_nents, sizeof(int), "prd_max_nents");
   int prd_ent_size ;
    klee_make_symbolic(&prd_ent_size, sizeof(int), "prd_ent_size");
   struct scatterlist *sg_table ;
   int sg_max_nents ;
    klee_make_symbolic(&sg_max_nents, sizeof(int), "sg_max_nents");
   struct ide_cmd cmd ;
   int rqsize ;
    klee_make_symbolic(&rqsize, sizeof(int), "rqsize");
   int irq ;
   unsigned long dma_base ;
    klee_make_symbolic(&dma_base, sizeof(long), "dma_base");
   unsigned long config_data ;
    klee_make_symbolic(&config_data, sizeof(long), "config_data");
   unsigned long select_data ;
    klee_make_symbolic(&select_data, sizeof(long), "select_data");
   unsigned long extra_base ;
    klee_make_symbolic(&extra_base, sizeof(long), "extra_base");
   unsigned int extra_ports ;
    klee_make_symbolic(&extra_ports, sizeof(int), "extra_ports");
   ...
   unsigned long poll_timeout ;
    klee_make_symbolic(&poll_timeout, sizeof(long), "poll_timeout");
   int (*expiry)(ide_drive_t * ) ;
   int req_gen ;
    klee_make_symbolic(&req_gen, sizeof(int), "req_gen");
   int req_gen_timer ;
    klee_make_symbolic(&req_gen_timer, sizeof(int), "req_gen_timer");
   spinlock_t lock ;
...
struct ide_host {
   ...
   unsigned long host_flags ;
    klee_make_symbolic(&host_flags, sizeof(long), "host_flags");
   int irq_flags ;
    klee_make_symbolic(&irq_flags, sizeof(int), "irq_flags");
   void *host_priv ;
   ide_hwif_t *cur_port ;
...
extern int ide_vlb_clk ;
    klee_make_symbolic(&ide_vlb_clk, sizeof(int), "ide_vlb_clk");
extern int ide_pci_clk ;
    klee_make_symbolic(&ide_pci_clk, sizeof(int), "ide_pci_clk");
...
static unsigned int cmd640_key  ;
    klee_make_symbolic(&cmd640_key, sizeof(int), "cmd640_key");
static void (*__put_cmd640_reg)(u16 reg , u8 val )  ;
static u8 (*__get_cmd640_reg)(u16 reg )  ;
static unsigned int cmd640_chip_version  ;
    klee_make_symbolic(&cmd640_chip_version, sizeof(int), "cmd640_chip_version");
...
{ unsigned long flags ;
  ...
  ide_drive_t *tmp___7 ;
  unsigned int mate ;
    klee_make_symbolic(&mate, sizeof(int), "mate");
...
{ struct ide_timing *t ;
  int setup_time ;
    klee_make_symbolic(&setup_time, sizeof(int), "setup_time");
  int active_time ;
    klee_make_symbolic(&active_time, sizeof(int), "active_time");
  int recovery_time ;
    klee_make_symbolic(&recovery_time, sizeof(int), "recovery_time");
  int clock_time ;
    klee_make_symbolic(&clock_time, sizeof(int), "clock_time");
  u8 setup_count ;
  u8 active_count ;
  u8 recovery_count ;
  u8 recovery_count2 ;
  u8 cycle_count ;
  int bus_speed ;
    klee_make_symbolic(&bus_speed, sizeof(int), "bus_speed");
  bool *__cil_tmp16 ;
  int __cil_tmp17 ;
  int __cil_tmp18 ;
  int __cil_tmp19 ;
...
{ unsigned int index ;
  unsigned int cycle_time ;
    klee_make_symbolic(&cycle_time, sizeof(int), "cycle_time");
  u8 pio ;
  u8 b ;
  u8 tmp___7 ;
  char const   *tmp___8 ;
...
{ int irq_reg ;
    klee_make_symbolic(&irq_reg, sizeof(int), "irq_reg");
  int tmp___7 ;
  u8 irq_mask ;
  int tmp___8 ;
  u8 irq_stat___0 ;
...
{ int second_port_cmd640 ;
    klee_make_symbolic(&second_port_cmd640, sizeof(int), "second_port_cmd640");
  int rc ;
