...
struct i2c_diolan_u2c {
   ...
   int ocount ;
    klee_make_symbolic(&ocount, sizeof(int), "ocount");
};
...
{ int ret ;
  ...
  unsigned int tmp ;
  int tmpret ;
    klee_make_symbolic(&tmpret, sizeof(int), "tmpret");
...
{ int to_val ;
    klee_make_symbolic(&to_val, sizeof(int), "to_val");
  int tmp ;
  u8 __cil_tmp5 ;
  u8 __cil_tmp6 ;
  int __cil_tmp7 ;
...
{ struct i2c_adapter *var_group1 ;
  ...
  int var_diolan_usb_xfer_17_p2 ;
    klee_make_symbolic(&var_diolan_usb_xfer_17_p2, sizeof(int), "var_diolan_usb_xfer_17_p2");
  struct usb_interface *var_group3 ;
  struct usb_device_id  const  *var_diolan_u2c_probe_20_p1 ;
  int res_diolan_u2c_probe_20 ;
    klee_make_symbolic(&res_diolan_u2c_probe_20, sizeof(int), "res_diolan_u2c_probe_20");
  int ldv_s_diolan_u2c_driver_usb_driver ;
    klee_make_symbolic(&ldv_s_diolan_u2c_driver_usb_driver, sizeof(int), "ldv_s_diolan_u2c_driver_usb_driver");
  int tmp ;
  int tmp___0 ;
