...
{ struct device *var_group1 ;
  ...
  int res_ds1390_probe_3 ;
    klee_make_symbolic(&res_ds1390_probe_3, sizeof(int), "res_ds1390_probe_3");
  int ldv_s_ds1390_driver_spi_driver ;
    klee_make_symbolic(&ldv_s_ds1390_driver_spi_driver, sizeof(int), "ldv_s_ds1390_driver_spi_driver");
  int tmp ;
  int tmp___0 ;
