...
static int res_dibusb_mc_probe_0  ;
    klee_make_symbolic(&res_dibusb_mc_probe_0, sizeof(int), "res_dibusb_mc_probe_0");
void main(void) 
{ struct usb_interface *var_group1 ;
  struct usb_device_id  const  *var_dibusb_mc_probe_0_p1 ;
  int ldv_s_dibusb_mc_driver_usb_driver ;
    klee_make_symbolic(&ldv_s_dibusb_mc_driver_usb_driver, sizeof(int), "ldv_s_dibusb_mc_driver_usb_driver");
  int tmp___7 ;
  int tmp___8 ;
  int __cil_tmp6 ;
