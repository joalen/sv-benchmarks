...
{ struct ata_port *var_group1 ;
  ...
  unsigned long var_opti_pre_reset_0_p1 ;
    klee_make_symbolic(&var_opti_pre_reset_0_p1, sizeof(long), "var_opti_pre_reset_0_p1");
  struct pci_dev *var_group4 ;
  struct pci_device_id  const  *var_opti_init_one_3_p1 ;
  int res_opti_init_one_3 ;
    klee_make_symbolic(&res_opti_init_one_3, sizeof(int), "res_opti_init_one_3");
  int ldv_s_opti_pci_driver_pci_driver ;
    klee_make_symbolic(&ldv_s_opti_pci_driver_pci_driver, sizeof(int), "ldv_s_opti_pci_driver_pci_driver");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
