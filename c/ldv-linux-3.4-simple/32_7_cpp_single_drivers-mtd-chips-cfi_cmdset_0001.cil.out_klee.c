 ...
 union {
  struct {
   unsigned long correct;
    klee_make_symbolic(&correct, sizeof(long), "correct");
   unsigned long incorrect;
    klee_make_symbolic(&incorrect, sizeof(long), "incorrect");
  };
  struct {
   unsigned long miss;
    klee_make_symbolic(&miss, sizeof(long), "miss");
   unsigned long hit;
    klee_make_symbolic(&hit, sizeof(long), "hit");
  };
  unsigned long miss_hit[2];
    klee_make_symbolic(miss_hit, sizeof(long)*2, "miss_hit");
 };
};
...
typedef int __kernel_key_t;
    klee_make_symbolic(&__kernel_key_t, sizeof(int), "__kernel_key_t");
typedef int __kernel_mqd_t;
    klee_make_symbolic(&__kernel_mqd_t, sizeof(int), "__kernel_mqd_t");
...
typedef unsigned short __kernel_old_uid_t;
    klee_make_symbolic(&__kernel_old_uid_t, sizeof(short), "__kernel_old_uid_t");
typedef unsigned short __kernel_old_gid_t;
    klee_make_symbolic(&__kernel_old_gid_t, sizeof(short), "__kernel_old_gid_t");


typedef unsigned long __kernel_old_dev_t;
    klee_make_symbolic(&__kernel_old_dev_t, sizeof(long), "__kernel_old_dev_t");
...
typedef unsigned int __kernel_mode_t;
    klee_make_symbolic(&__kernel_mode_t, sizeof(int), "__kernel_mode_t");
...
typedef int __kernel_ipc_pid_t;
    klee_make_symbolic(&__kernel_ipc_pid_t, sizeof(int), "__kernel_ipc_pid_t");



typedef unsigned int __kernel_uid_t;
    klee_make_symbolic(&__kernel_uid_t, sizeof(int), "__kernel_uid_t");
typedef unsigned int __kernel_gid_t;
    klee_make_symbolic(&__kernel_gid_t, sizeof(int), "__kernel_gid_t");
...
typedef int __kernel_daddr_t;
    klee_make_symbolic(&__kernel_daddr_t, sizeof(int), "__kernel_daddr_t");
...
typedef struct {
 int val[2];
    klee_make_symbolic(val, sizeof(long)*2, "val");
} __kernel_fsid_t;
...
typedef unsigned short __kernel_uid16_t;
    klee_make_symbolic(&__kernel_uid16_t, sizeof(short), "__kernel_uid16_t");
typedef unsigned short __kernel_gid16_t;
    klee_make_symbolic(&__kernel_gid16_t, sizeof(short), "__kernel_gid16_t");
...
typedef unsigned short u_short;
    klee_make_symbolic(&u_short, sizeof(short), "u_short");
typedef unsigned int u_int;
    klee_make_symbolic(&u_int, sizeof(int), "u_int");
typedef unsigned long u_long;
    klee_make_symbolic(&u_long, sizeof(long), "u_long");


typedef unsigned char unchar;
    klee_make_symbolic(&unchar, sizeof(char), "unchar");
typedef unsigned short ushort;
    klee_make_symbolic(&ushort, sizeof(short), "ushort");
...
typedef unsigned long irq_hw_number_t;
    klee_make_symbolic(&irq_hw_number_t, sizeof(long), "irq_hw_number_t");
...
struct ustat {
 ...
 char f_fname[6];
    klee_make_symbolic(f_fname, sizeof(char)*6, "f_fname");
 char f_fpack[6];
    klee_make_symbolic(f_fpack, sizeof(char)*6, "f_fpack");
};
...
struct stat {
 unsigned long st_dev;
    klee_make_symbolic(&st_dev, sizeof(long), "st_dev");
 unsigned long st_ino;
    klee_make_symbolic(&st_ino, sizeof(long), "st_ino");
 unsigned long st_nlink;
    klee_make_symbolic(&st_nlink, sizeof(long), "st_nlink");

 unsigned int st_mode;
    klee_make_symbolic(&st_mode, sizeof(int), "st_mode");
 unsigned int st_uid;
    klee_make_symbolic(&st_uid, sizeof(int), "st_uid");
 unsigned int st_gid;
    klee_make_symbolic(&st_gid, sizeof(int), "st_gid");
 unsigned int __pad0;
    klee_make_symbolic(&__pad0, sizeof(int), "__pad0");
 unsigned long st_rdev;
    klee_make_symbolic(&st_rdev, sizeof(long), "st_rdev");
 long st_size;
    klee_make_symbolic(&st_size, sizeof(long), "st_size");
 long st_blksize;
    klee_make_symbolic(&st_blksize, sizeof(long), "st_blksize");
 long st_blocks;
    klee_make_symbolic(&st_blocks, sizeof(long), "st_blocks");

 unsigned long st_atime;
    klee_make_symbolic(&st_atime, sizeof(long), "st_atime");
 unsigned long st_atime_nsec;
    klee_make_symbolic(&st_atime_nsec, sizeof(long), "st_atime_nsec");
 unsigned long st_mtime;
    klee_make_symbolic(&st_mtime, sizeof(long), "st_mtime");
 unsigned long st_mtime_nsec;
    klee_make_symbolic(&st_mtime_nsec, sizeof(long), "st_mtime_nsec");
 unsigned long st_ctime;
    klee_make_symbolic(&st_ctime, sizeof(long), "st_ctime");
 unsigned long st_ctime_nsec;
    klee_make_symbolic(&st_ctime_nsec, sizeof(long), "st_ctime_nsec");
 long __unused[3];
    klee_make_symbolic(__unused, sizeof(long)*3, "__unused");
};
...
extern int printk_delay_msec;
    klee_make_symbolic(&printk_delay_msec, sizeof(int), "printk_delay_msec");
extern int dmesg_restrict;
    klee_make_symbolic(&dmesg_restrict, sizeof(int), "dmesg_restrict");
extern int kptr_restrict;
    klee_make_symbolic(&kptr_restrict, sizeof(int), "kptr_restrict");
...
extern int oops_in_progress;
    klee_make_symbolic(&oops_in_progress, sizeof(int), "oops_in_progress");
extern int panic_timeout;
    klee_make_symbolic(&panic_timeout, sizeof(int), "panic_timeout");
extern int panic_on_oops;
    klee_make_symbolic(&panic_on_oops, sizeof(int), "panic_on_oops");
extern int panic_on_unrecovered_nmi;
    klee_make_symbolic(&panic_on_unrecovered_nmi, sizeof(int), "panic_on_unrecovered_nmi");
extern int panic_on_io_nmi;
    klee_make_symbolic(&panic_on_io_nmi, sizeof(int), "panic_on_io_nmi");
extern int sysctl_panic_on_stackoverflow;
    klee_make_symbolic(&sysctl_panic_on_stackoverflow, sizeof(int), "sysctl_panic_on_stackoverflow");
extern const char *print_tainted(void);
extern void add_taint(unsigned flag);
extern int test_taint(unsigned flag);
extern unsigned long get_taint(void);
extern int root_mountflags;
    klee_make_symbolic(&root_mountflags, sizeof(int), "root_mountflags");
...
extern unsigned long max_pfn;
    klee_make_symbolic(&max_pfn, sizeof(long), "max_pfn");
extern unsigned long phys_base;
    klee_make_symbolic(&phys_base, sizeof(long), "phys_base");
...
extern unsigned long max_low_pfn_mapped;
    klee_make_symbolic(&max_low_pfn_mapped, sizeof(long), "max_low_pfn_mapped");
extern unsigned long max_pfn_mapped;
    klee_make_symbolic(&max_pfn_mapped, sizeof(long), "max_pfn_mapped");
...
struct vm86_regs {
 ...
 long ebx;
    klee_make_symbolic(&ebx, sizeof(long), "ebx");
 long ecx;
    klee_make_symbolic(&ecx, sizeof(long), "ecx");
 long edx;
    klee_make_symbolic(&edx, sizeof(long), "edx");
 long esi;
    klee_make_symbolic(&esi, sizeof(long), "esi");
 long edi;
    klee_make_symbolic(&edi, sizeof(long), "edi");
 long ebp;
    klee_make_symbolic(&ebp, sizeof(long), "ebp");
 long eax;
    klee_make_symbolic(&eax, sizeof(long), "eax");
 long __null_ds;
    klee_make_symbolic(&__null_ds, sizeof(long), "__null_ds");
 long __null_es;
    klee_make_symbolic(&__null_es, sizeof(long), "__null_es");
 long __null_fs;
    klee_make_symbolic(&__null_fs, sizeof(long), "__null_fs");
 long __null_gs;
    klee_make_symbolic(&__null_gs, sizeof(long), "__null_gs");
 long orig_eax;
    klee_make_symbolic(&orig_eax, sizeof(long), "orig_eax");
 long eip;
    klee_make_symbolic(&eip, sizeof(long), "eip");
 unsigned short cs, __csh;
 long eflags;
    klee_make_symbolic(&eflags, sizeof(long), "eflags");
 long esp;
    klee_make_symbolic(&esp, sizeof(long), "esp");
...
struct revectored_struct {
 unsigned long __map[8];
    klee_make_symbolic(__map, sizeof(long)*8, "__map");
};
...
struct vm86_struct {
 ...
 unsigned long screen_bitmap;
    klee_make_symbolic(&screen_bitmap, sizeof(long), "screen_bitmap");
 unsigned long cpu_type;
    klee_make_symbolic(&cpu_type, sizeof(long), "cpu_type");
...
struct vm86plus_info_struct {
 ...
 unsigned char vm86dbg_intxxtab[32];
    klee_make_symbolic(vm86dbg_intxxtab, sizeof(char)*32, "vm86dbg_intxxtab");
};
...
static inline __attribute__((no_instrument_function)) unsigned long get_limit(unsigned long segment)
{
 unsigned long __limit;
    klee_make_symbolic(&__limit, sizeof(long), "__limit");
...
typedef unsigned long pmdval_t;
    klee_make_symbolic(&pmdval_t, sizeof(long), "pmdval_t");
typedef unsigned long pudval_t;
    klee_make_symbolic(&pudval_t, sizeof(long), "pudval_t");
...
extern int nx_enabled;
    klee_make_symbolic(&nx_enabled, sizeof(int), "nx_enabled");
...
struct pv_info {
 unsigned int kernel_rpl;
    klee_make_symbolic(&kernel_rpl, sizeof(int), "kernel_rpl");
 int shared_kernel_pmd;
    klee_make_symbolic(&shared_kernel_pmd, sizeof(int), "shared_kernel_pmd");
 ...
 int paravirt_enabled;
    klee_make_symbolic(&paravirt_enabled, sizeof(int), "paravirt_enabled");
 const char *name;
};
...
struct sigcontext {
 ...
 unsigned long err;
    klee_make_symbolic(&err, sizeof(long), "err");
 unsigned long trapno;
    klee_make_symbolic(&trapno, sizeof(long), "trapno");
 unsigned long oldmask;
    klee_make_symbolic(&oldmask, sizeof(long), "oldmask");
 unsigned long cr2;
    klee_make_symbolic(&cr2, sizeof(long), "cr2");
 void *fpstate;
 unsigned long reserved1[8];
    klee_make_symbolic(reserved1, sizeof(long)*8, "reserved1");
};
struct _xsave_hdr {
 __u64 xstate_bv;
 __u64 reserved1[2];
...
extern unsigned long __per_cpu_offset[4096];
    klee_make_symbolic(__per_cpu_offset, sizeof(long)*4096, "__per_cpu_offset");
...
extern __attribute__((section(".discard"), unused)) char __pcpu_scope_this_cpu_off; extern __attribute__((section(".data..percpu" ""))) __typeof__(unsigned long) this_cpu_off;
    klee_make_symbolic(&__pcpu_scope_this_cpu_off, sizeof(char), "__pcpu_scope_this_cpu_off");
...
extern __attribute__((section(".discard"), unused)) char __pcpu_scope_current_task; extern __attribute__((section(".data..percpu" ""))) __typeof__(struct task_struct *) current_task;
    klee_make_symbolic(&__pcpu_scope_current_task, sizeof(char), "__pcpu_scope_current_task");
...
extern unsigned int __invalid_size_argument_for_IOC;
    klee_make_symbolic(&__invalid_size_argument_for_IOC, sizeof(int), "__invalid_size_argument_for_IOC");
...
static unsigned long __force_order;
    klee_make_symbolic(&__force_order, sizeof(long), "__force_order");

static inline __attribute__((no_instrument_function)) unsigned long native_read_cr0(void)
{
 unsigned long val;
    klee_make_symbolic(&val, sizeof(long), "val");
...
{
 unsigned long cr8;
    klee_make_symbolic(&cr8, sizeof(long), "cr8");
...
struct exec_domain {
 ...
 unsigned char pers_low;
    klee_make_symbolic(&pers_low, sizeof(char), "pers_low");
 unsigned char pers_high;
    klee_make_symbolic(&pers_high, sizeof(char), "pers_high");
...
struct cpuinfo_x86 {
 ...
 char x86_vendor_id[16];
    klee_make_symbolic(x86_vendor_id, sizeof(char)*16, "x86_vendor_id");
 char x86_model_id[64];
    klee_make_symbolic(x86_model_id, sizeof(char)*64, "x86_model_id");
...
extern __attribute__((section(".discard"), unused)) char __pcpu_scope_cpu_info; extern __attribute__((section(".data..percpu" ""))) __typeof__(struct cpuinfo_x86) cpu_info __attribute__((__aligned__((1 << (6)))));
    klee_make_symbolic(&__pcpu_scope_cpu_info, sizeof(char), "__pcpu_scope_cpu_info");
...
extern unsigned short num_cache_leaves;
    klee_make_symbolic(&num_cache_leaves, sizeof(short), "num_cache_leaves");
...
struct tss_struct {
 ...
 unsigned long stack[64];
    klee_make_symbolic(stack, sizeof(long)*64, "stack");
...
extern __attribute__((section(".discard"), unused)) char __pcpu_scope_init_tss; extern __attribute__((section(".data..percpu" ""))) __typeof__(struct tss_struct) init_tss __attribute__((__aligned__((1 << (6)))));
    klee_make_symbolic(&__pcpu_scope_init_tss, sizeof(char), "__pcpu_scope_init_tss");
...
struct orig_ist {
 unsigned long ist[7];
    klee_make_symbolic(ist, sizeof(long)*7, "ist");
};
...
extern __attribute__((section(".discard"), unused)) char __pcpu_scope_orig_ist; extern __attribute__((section(".data..percpu" ""))) __typeof__(struct orig_ist) orig_ist;
    klee_make_symbolic(&__pcpu_scope_orig_ist, sizeof(char), "__pcpu_scope_orig_ist");
...
union irq_stack_union {
 ...
 struct {
  char gs_base[40];
    klee_make_symbolic(gs_base, sizeof(char)*40, "gs_base");
...
extern __attribute__((section(".discard"), unused)) char __pcpu_scope_irq_stack_union; extern __attribute__((section(".data..percpu" "..first"))) __typeof__(union irq_stack_union) irq_stack_union;
    klee_make_symbolic(&__pcpu_scope_irq_stack_union, sizeof(char), "__pcpu_scope_irq_stack_union");
...
extern __attribute__((section(".discard"), unused)) char __pcpu_scope_irq_stack_ptr; extern __attribute__((section(".data..percpu" ""))) __typeof__(char *) irq_stack_ptr;
    klee_make_symbolic(&__pcpu_scope_irq_stack_ptr, sizeof(char), "__pcpu_scope_irq_stack_ptr");
extern __attribute__((section(".discard"), unused)) char __pcpu_scope_irq_count; extern __attribute__((section(".data..percpu" ""))) __typeof__(unsigned int) irq_count;
    klee_make_symbolic(&__pcpu_scope_irq_count, sizeof(char), "__pcpu_scope_irq_count");
extern unsigned long kernel_eflags;
    klee_make_symbolic(&kernel_eflags, sizeof(long), "kernel_eflags");
extern void ignore_sysret(void);
extern unsigned int xstate_size;
    klee_make_symbolic(&xstate_size, sizeof(int), "xstate_size");
...
extern unsigned long mmu_cr4_features;
    klee_make_symbolic(&mmu_cr4_features, sizeof(long), "mmu_cr4_features");

static inline __attribute__((no_instrument_function)) void set_in_cr4(unsigned long mask)
{
 unsigned long cr4;
    klee_make_symbolic(&cr4, sizeof(long), "cr4");
...
extern unsigned long boot_option_idle_override;
    klee_make_symbolic(&boot_option_idle_override, sizeof(long), "boot_option_idle_override");
...
static inline __attribute__((no_instrument_function)) unsigned long get_debugctlmsr(void)
{
 ...
 do { int _err; debugctlmsr = paravirt_read_msr(0x000001d9, &_err); } while (0);
    klee_make_symbolic(&_err, sizeof(int), "_err");
...
extern unsigned int machine_id;
    klee_make_symbolic(&machine_id, sizeof(int), "machine_id");
extern unsigned int machine_submodel_id;
    klee_make_symbolic(&machine_submodel_id, sizeof(int), "machine_submodel_id");
extern unsigned int BIOS_revision;
    klee_make_symbolic(&BIOS_revision, sizeof(int), "BIOS_revision");


extern int bootloader_type;
    klee_make_symbolic(&bootloader_type, sizeof(int), "bootloader_type");
extern int bootloader_version;
    klee_make_symbolic(&bootloader_version, sizeof(int), "bootloader_version");

extern char ignore_fpu_irq;
    klee_make_symbolic(&ignore_fpu_irq, sizeof(char), "ignore_fpu_irq");
...
extern __attribute__((section(".discard"), unused)) char __pcpu_scope_old_rsp; extern __attribute__((section(".data..percpu" ""))) __typeof__(unsigned long) old_rsp;
    klee_make_symbolic(&__pcpu_scope_old_rsp, sizeof(char), "__pcpu_scope_old_rsp");
...
static inline __attribute__((no_instrument_function)) void atomic_or(int i, atomic_t *v)
{
 ...
 int new;
    klee_make_symbolic(&new, sizeof(int), "new");
...
struct thread_info {
 ...
 __u32 cpu;
 int preempt_count;
    klee_make_symbolic(&preempt_count, sizeof(int), "preempt_count");
...
extern __attribute__((section(".discard"), unused)) char __pcpu_scope_kernel_stack; extern __attribute__((section(".data..percpu" ""))) __typeof__(unsigned long) kernel_stack;
    klee_make_symbolic(&__pcpu_scope_kernel_stack, sizeof(char), "__pcpu_scope_kernel_stack");
...
extern int prove_locking;
    klee_make_symbolic(&prove_locking, sizeof(int), "prove_locking");
extern int lock_stat;
    klee_make_symbolic(&lock_stat, sizeof(int), "lock_stat");
...
static inline __attribute__((no_instrument_function)) unsigned long __raw_spin_lock_irqsave(raw_spinlock_t *lock)
{
 ...
 do { do { ({ unsigned long __dummy; typeof(flags) __dummy2; (void)(&__dummy == &__dummy2); 1; }); flags = arch_local_irq_save(); } while (0); trace_hardirqs_off(); } while (0);
    klee_make_symbolic(&__dummy, sizeof(long), "__dummy");
 do { do { (current_thread_info()->preempt_count) += (1); } while (0); __asm__ __volatile__("": : :"memory"); } while (0);
 do { } while (0);
...
struct timezone {
 int tz_minuteswest;
    klee_make_symbolic(&tz_minuteswest, sizeof(int), "tz_minuteswest");
 int tz_dsttime;
    klee_make_symbolic(&tz_dsttime, sizeof(int), "tz_dsttime");
};
...
extern int timekeeping_suspended;
    klee_make_symbolic(&timekeeping_suspended, sizeof(int), "timekeeping_suspended");
...
struct tm {
 ...
 int tm_sec;
    klee_make_symbolic(&tm_sec, sizeof(int), "tm_sec");

 int tm_min;
    klee_make_symbolic(&tm_min, sizeof(int), "tm_min");

 int tm_hour;
    klee_make_symbolic(&tm_hour, sizeof(int), "tm_hour");

 int tm_mday;
    klee_make_symbolic(&tm_mday, sizeof(int), "tm_mday");

 int tm_mon;
    klee_make_symbolic(&tm_mon, sizeof(int), "tm_mon");

 long tm_year;
    klee_make_symbolic(&tm_year, sizeof(long), "tm_year");

 int tm_wday;
    klee_make_symbolic(&tm_wday, sizeof(int), "tm_wday");

 int tm_yday;
    klee_make_symbolic(&tm_yday, sizeof(int), "tm_yday");
};
...
struct wait_bit_key {
 void *flags;
 int bit_nr;
    klee_make_symbolic(&bit_nr, sizeof(int), "bit_nr");
};
...
extern int nr_node_ids;
    klee_make_symbolic(&nr_node_ids, sizeof(int), "nr_node_ids");
extern int nr_online_nodes;
    klee_make_symbolic(&nr_online_nodes, sizeof(int), "nr_online_nodes");
...
extern int page_group_by_mobility_disabled;
    klee_make_symbolic(&page_group_by_mobility_disabled, sizeof(int), "page_group_by_mobility_disabled");
...
struct zone_padding {
 char x[0];
    klee_make_symbolic(x, sizeof(int)*0, "x");
...
struct zone_reclaim_stat {
 unsigned long recent_rotated[2];
    klee_make_symbolic(recent_rotated, sizeof(long)*2, "recent_rotated");
 unsigned long recent_scanned[2];
    klee_make_symbolic(recent_scanned, sizeof(long)*2, "recent_scanned");
};
...
struct zone {
 ...
 unsigned long lowmem_reserve[4];
    klee_make_symbolic(lowmem_reserve, sizeof(long)*4, "lowmem_reserve");
 ...
 int all_unreclaimable;
    klee_make_symbolic(&all_unreclaimable, sizeof(int), "all_unreclaimable");
 ...
 unsigned long pages_scanned;
    klee_make_symbolic(&pages_scanned, sizeof(long), "pages_scanned");
 unsigned long flags;
...
struct node_active_region {
 unsigned long start_pfn;
    klee_make_symbolic(&start_pfn, sizeof(long), "start_pfn");
 unsigned long end_pfn;
    klee_make_symbolic(&end_pfn, sizeof(long), "end_pfn");
 int nid;
...
struct debug_obj {
 ...
 unsigned int astate;
    klee_make_symbolic(&astate, sizeof(int), "astate");
 void *object;
...
extern unsigned long rcutorture_testseq;
    klee_make_symbolic(&rcutorture_testseq, sizeof(long), "rcutorture_testseq");
extern unsigned long rcutorture_vernum;
    klee_make_symbolic(&rcutorture_vernum, sizeof(long), "rcutorture_vernum");
...
struct srcu_struct_array {
 int c[2];
    klee_make_symbolic(c, sizeof(long)*2, "c");
};
...
extern int movable_zone;
    klee_make_symbolic(&movable_zone, sizeof(int), "movable_zone");
...
struct mpf_intel {
 char signature[4];
    klee_make_symbolic(signature, sizeof(char)*4, "signature");
 unsigned int physptr;
    klee_make_symbolic(&physptr, sizeof(int), "physptr");
 unsigned char length;
    klee_make_symbolic(&length, sizeof(char), "length");
 unsigned char specification;
    klee_make_symbolic(&specification, sizeof(char), "specification");
 unsigned char checksum;
    klee_make_symbolic(&checksum, sizeof(char), "checksum");
 unsigned char feature1;
    klee_make_symbolic(&feature1, sizeof(char), "feature1");
 unsigned char feature2;
    klee_make_symbolic(&feature2, sizeof(char), "feature2");
 unsigned char feature3;
    klee_make_symbolic(&feature3, sizeof(char), "feature3");
 unsigned char feature4;
    klee_make_symbolic(&feature4, sizeof(char), "feature4");
 unsigned char feature5;
    klee_make_symbolic(&feature5, sizeof(char), "feature5");
};
...
struct mpc_table {
 ...
 char spec;
    klee_make_symbolic(&spec, sizeof(char), "spec");
 char checksum;
 char oem[8];
    klee_make_symbolic(oem, sizeof(char)*8, "oem");
 char productid[12];
    klee_make_symbolic(productid, sizeof(char)*12, "productid");
 unsigned int oemptr;
    klee_make_symbolic(&oemptr, sizeof(int), "oemptr");
 unsigned short oemsize;
    klee_make_symbolic(&oemsize, sizeof(short), "oemsize");
 unsigned short oemcount;
    klee_make_symbolic(&oemcount, sizeof(short), "oemcount");
 unsigned int lapic;
    klee_make_symbolic(&lapic, sizeof(int), "lapic");
...
struct mpc_cpu {
 ...
 unsigned char apicid;
    klee_make_symbolic(&apicid, sizeof(char), "apicid");
 unsigned char apicver;
    klee_make_symbolic(&apicver, sizeof(char), "apicver");
 unsigned char cpuflag;
    klee_make_symbolic(&cpuflag, sizeof(char), "cpuflag");
 unsigned int cpufeature;
    klee_make_symbolic(&cpufeature, sizeof(int), "cpufeature");
 unsigned int featureflag;
    klee_make_symbolic(&featureflag, sizeof(int), "featureflag");
 unsigned int reserved[2];
    klee_make_symbolic(reserved, sizeof(long)*2, "reserved");
};

struct mpc_bus {
 unsigned char type;
 unsigned char busid;
    klee_make_symbolic(&busid, sizeof(char), "busid");
 unsigned char bustype[6];
    klee_make_symbolic(bustype, sizeof(char)*6, "bustype");
};
struct mpc_ioapic {
 unsigned char type;
 unsigned char apicid;
 ...
 unsigned int apicaddr;
    klee_make_symbolic(&apicaddr, sizeof(int), "apicaddr");
};

struct mpc_intsrc {
 unsigned char type;
 unsigned char irqtype;
    klee_make_symbolic(&irqtype, sizeof(char), "irqtype");
 unsigned short irqflag;
    klee_make_symbolic(&irqflag, sizeof(short), "irqflag");
 unsigned char srcbus;
    klee_make_symbolic(&srcbus, sizeof(char), "srcbus");
 unsigned char srcbusirq;
    klee_make_symbolic(&srcbusirq, sizeof(char), "srcbusirq");
 unsigned char dstapic;
    klee_make_symbolic(&dstapic, sizeof(char), "dstapic");
 unsigned char dstirq;
    klee_make_symbolic(&dstirq, sizeof(char), "dstirq");
};
...
struct mpc_lintsrc {
 ...
 unsigned char srcbusid;
    klee_make_symbolic(&srcbusid, sizeof(char), "srcbusid");
 unsigned char srcbusirq;
 unsigned char destapic;
    klee_make_symbolic(&destapic, sizeof(char), "destapic");
 unsigned char destapiclint;
    klee_make_symbolic(&destapiclint, sizeof(char), "destapiclint");
};
...
struct mpc_oemtable {
 ...
 unsigned short length;
 char rev;
    klee_make_symbolic(&rev, sizeof(char), "rev");
 char checksum;
 char mpc[8];
    klee_make_symbolic(mpc, sizeof(char)*8, "mpc");
};
enum mp_bustype {
 MP_BUS_ISA = 1,
 MP_BUS_EISA,
...
typedef unsigned short apm_event_t;
    klee_make_symbolic(&apm_event_t, sizeof(short), "apm_event_t");
typedef unsigned short apm_eventinfo_t;
    klee_make_symbolic(&apm_eventinfo_t, sizeof(short), "apm_eventinfo_t");
...
struct apm_info {
 ...
 unsigned short connection_version;
    klee_make_symbolic(&connection_version, sizeof(short), "connection_version");
 int get_power_status_broken;
    klee_make_symbolic(&get_power_status_broken, sizeof(int), "get_power_status_broken");
 int get_power_status_swabinminutes;
    klee_make_symbolic(&get_power_status_swabinminutes, sizeof(int), "get_power_status_swabinminutes");
 int allow_ints;
    klee_make_symbolic(&allow_ints, sizeof(int), "allow_ints");
 int forbid_idle;
    klee_make_symbolic(&forbid_idle, sizeof(int), "forbid_idle");
 int realmode_power_off;
    klee_make_symbolic(&realmode_power_off, sizeof(int), "realmode_power_off");
 int disabled;
...
struct edd {
 unsigned int mbr_signature[16];
    klee_make_symbolic(mbr_signature, sizeof(int)*16, "mbr_signature");
 struct edd_info edd_info[6];
 unsigned char mbr_signature_nr;
    klee_make_symbolic(&mbr_signature_nr, sizeof(char), "mbr_signature_nr");
 unsigned char edd_info_nr;
    klee_make_symbolic(&edd_info_nr, sizeof(char), "edd_info_nr");
};
...
extern unsigned long pci_mem_start;
    klee_make_symbolic(&pci_mem_start, sizeof(long), "pci_mem_start");
...
struct edid_info {
 unsigned char dummy[128];
    klee_make_symbolic(dummy, sizeof(char)*128, "dummy");
};
...
struct local_apic {
    ...
    klee_make_symbolic(__reserved, sizeof(int)*4, "__reserved"); } __reserved_01;

        struct { unsigned int __reserved[4];
    klee_make_symbolic(__reserved, sizeof(int)*4, "__reserved"); } __reserved_02;
  ...
  unsigned int __reserved[3];
    klee_make_symbolic(__reserved, sizeof(int)*3, "__reserved");
 } id;
 ...
 struct {
  ...
  unsigned int __reserved[3];
    klee_make_symbolic(__reserved, sizeof(int)*3, "__reserved");
        ...
        struct { unsigned int __reserved[4];
    klee_make_symbolic(__reserved, sizeof(int)*4, "__reserved"); } __reserved_03;

        struct { unsigned int __reserved[4];
    klee_make_symbolic(__reserved, sizeof(int)*4, "__reserved"); } __reserved_04;

        struct { unsigned int __reserved[4];
    klee_make_symbolic(__reserved, sizeof(int)*4, "__reserved"); } __reserved_05;

        struct { unsigned int __reserved[4];
    klee_make_symbolic(__reserved, sizeof(int)*4, "__reserved"); } __reserved_06;

        struct {
  unsigned int priority : 8,
   __reserved_1 : 24;
  unsigned int __reserved_2[3];
    klee_make_symbolic(__reserved_2, sizeof(int)*3, "__reserved_2");
 } tpr;
 ...
 struct {
  ...
  unsigned int __reserved_2[3];
    klee_make_symbolic(__reserved_2, sizeof(int)*3, "__reserved_2");
        ...
        struct {
  unsigned int eoi;
    klee_make_symbolic(&eoi, sizeof(int), "eoi");
  unsigned int __reserved[3];
    klee_make_symbolic(__reserved, sizeof(int)*3, "__reserved");
 } eoi;

        struct { unsigned int __reserved[4];
    klee_make_symbolic(__reserved, sizeof(int)*4, "__reserved"); } __reserved_07;
  ...
  unsigned int __reserved_3[3];
    klee_make_symbolic(__reserved_3, sizeof(int)*3, "__reserved_3");
 } svr;

        struct {
         unsigned int bitfield;
    klee_make_symbolic(&bitfield, sizeof(int), "bitfield");
  unsigned int __reserved[3];
    klee_make_symbolic(__reserved, sizeof(int)*3, "__reserved");
 } isr [8];
  ...
  struct {
   ...
   unsigned int __reserved_3[3];
    klee_make_symbolic(__reserved_3, sizeof(int)*3, "__reserved_3");
        ...
        struct { unsigned int __reserved[4];
    klee_make_symbolic(__reserved, sizeof(int)*4, "__reserved"); } __reserved_08;

        struct { unsigned int __reserved[4];
    klee_make_symbolic(__reserved, sizeof(int)*4, "__reserved"); } __reserved_09;

        struct { unsigned int __reserved[4];
    klee_make_symbolic(__reserved, sizeof(int)*4, "__reserved"); } __reserved_10;

        struct { unsigned int __reserved[4];
    klee_make_symbolic(__reserved, sizeof(int)*4, "__reserved"); } __reserved_11;

        struct { unsigned int __reserved[4];
    klee_make_symbolic(__reserved, sizeof(int)*4, "__reserved"); } __reserved_12;

        struct { unsigned int __reserved[4];
    klee_make_symbolic(__reserved, sizeof(int)*4, "__reserved"); } __reserved_13;

        struct { unsigned int __reserved[4];
    klee_make_symbolic(__reserved, sizeof(int)*4, "__reserved"); } __reserved_14;
  ...
  unsigned int __reserved_4[3];
    klee_make_symbolic(__reserved_4, sizeof(int)*3, "__reserved_4");
 } icr1;
  ...
  unsigned int initial_count;
    klee_make_symbolic(&initial_count, sizeof(int), "initial_count");
  unsigned int __reserved_2[3];
    klee_make_symbolic(__reserved_2, sizeof(int)*3, "__reserved_2");
 } timer_icr;
 ...
 struct {
  unsigned int curr_count;
    klee_make_symbolic(&curr_count, sizeof(int), "curr_count");
  unsigned int __reserved_2[3];
    klee_make_symbolic(__reserved_2, sizeof(int)*3, "__reserved_2");
 } timer_ccr;

        struct { unsigned int __reserved[4];
    klee_make_symbolic(__reserved, sizeof(int)*4, "__reserved"); } __reserved_16;

        struct { unsigned int __reserved[4];
    klee_make_symbolic(__reserved, sizeof(int)*4, "__reserved"); } __reserved_17;

        struct { unsigned int __reserved[4];
    klee_make_symbolic(__reserved, sizeof(int)*4, "__reserved"); } __reserved_18;

        struct { unsigned int __reserved[4];
    klee_make_symbolic(__reserved, sizeof(int)*4, "__reserved"); } __reserved_19;
  ...
  unsigned int __reserved_2[3];
    klee_make_symbolic(__reserved_2, sizeof(int)*3, "__reserved_2");
        ...
        struct { unsigned int __reserved[4];
    klee_make_symbolic(__reserved, sizeof(int)*4, "__reserved"); } __reserved_20;
...
extern int pic_mode;
    klee_make_symbolic(&pic_mode, sizeof(int), "pic_mode");
extern unsigned long mp_bus_not_pci[(((256) + (8 * sizeof(long)) - 1) / (8 * sizeof(long)))];

extern unsigned int boot_cpu_physical_apicid;
    klee_make_symbolic(&boot_cpu_physical_apicid, sizeof(int), "boot_cpu_physical_apicid");
extern unsigned int max_physical_apicid;
    klee_make_symbolic(&max_physical_apicid, sizeof(int), "max_physical_apicid");
extern int mpc_default_type;
    klee_make_symbolic(&mpc_default_type, sizeof(int), "mpc_default_type");
extern unsigned long mp_lapic_addr;
    klee_make_symbolic(&mp_lapic_addr, sizeof(long), "mp_lapic_addr");


extern int smp_found_config;
    klee_make_symbolic(&smp_found_config, sizeof(int), "smp_found_config");
...
extern int enable_update_mptable;
    klee_make_symbolic(&enable_update_mptable, sizeof(int), "enable_update_mptable");
...
struct timex {
 ...
 long offset;
    klee_make_symbolic(&offset, sizeof(long), "offset");
 long freq;
    klee_make_symbolic(&freq, sizeof(long), "freq");
 long maxerror;
    klee_make_symbolic(&maxerror, sizeof(long), "maxerror");
 long esterror;
    klee_make_symbolic(&esterror, sizeof(long), "esterror");
 int status;
    klee_make_symbolic(&status, sizeof(int), "status");
 long constant;
    klee_make_symbolic(&constant, sizeof(long), "constant");
 long precision;
    klee_make_symbolic(&precision, sizeof(long), "precision");
 long tolerance;
    klee_make_symbolic(&tolerance, sizeof(long), "tolerance");


 struct timeval time;
 long tick;
    klee_make_symbolic(&tick, sizeof(long), "tick");

 long ppsfreq;
    klee_make_symbolic(&ppsfreq, sizeof(long), "ppsfreq");
 long jitter;
    klee_make_symbolic(&jitter, sizeof(long), "jitter");
 int shift;
    klee_make_symbolic(&shift, sizeof(int), "shift");
 long stabil;
    klee_make_symbolic(&stabil, sizeof(long), "stabil");
 long jitcnt;
    klee_make_symbolic(&jitcnt, sizeof(long), "jitcnt");
 long calcnt;
    klee_make_symbolic(&calcnt, sizeof(long), "calcnt");
 long errcnt;
    klee_make_symbolic(&errcnt, sizeof(long), "errcnt");
 long stbcnt;
    klee_make_symbolic(&stbcnt, sizeof(long), "stbcnt");

 int tai;
    klee_make_symbolic(&tai, sizeof(int), "tai");
...
typedef unsigned long long cycles_t;
    klee_make_symbolic(&cycles_t, sizeof(long), "cycles_t");

extern unsigned int cpu_khz;
    klee_make_symbolic(&cpu_khz, sizeof(int), "cpu_khz");
extern unsigned int tsc_khz;
    klee_make_symbolic(&tsc_khz, sizeof(int), "tsc_khz");
...
extern int tsc_clocksource_reliable;
    klee_make_symbolic(&tsc_clocksource_reliable, sizeof(int), "tsc_clocksource_reliable");
...
extern unsigned long tick_usec;
    klee_make_symbolic(&tick_usec, sizeof(long), "tick_usec");
extern unsigned long tick_nsec;
    klee_make_symbolic(&tick_nsec, sizeof(long), "tick_nsec");
...
extern unsigned long preset_lpj;
    klee_make_symbolic(&preset_lpj, sizeof(long), "preset_lpj");
...
struct timer_list {
 ...
 void *start_site;
 char start_comm[16];
    klee_make_symbolic(start_comm, sizeof(char)*16, "start_comm");
...
extern int timer_stats_active;
    klee_make_symbolic(&timer_stats_active, sizeof(int), "timer_stats_active");
...
extern int numa_off;
    klee_make_symbolic(&numa_off, sizeof(int), "numa_off");
...
struct vm_struct {
 ...
 unsigned int nr_pages;
    klee_make_symbolic(&nr_pages, sizeof(int), "nr_pages");
...
extern int io_delay_type;
    klee_make_symbolic(&io_delay_type, sizeof(int), "io_delay_type");
...
static inline __attribute__((no_instrument_function)) void outb(unsigned char value, int port) { asm volatile("out" "b" " %" "b" "0, %w1" : : "a"(value), "Nd"(port)); } static inline __attribute__((no_instrument_function)) unsigned char inb(int port) { unsigned char value; asm volatile("in" "b" " %w1, %" "b" "0" : "=a"(value) : "Nd"(port)); return value; } static inline __attribute__((no_instrument_function)) void outb_p(unsigned char value, int port) { outb(value, port); slow_down_io(); } static inline __attribute__((no_instrument_function)) unsigned char inb_p(int port) { unsigned char value = inb(port); slow_down_io(); return value; } static inline __attribute__((no_instrument_function)) void outsb(int port, const void *addr, unsigned long count) { asm volatile("rep; outs" "b" : "+S"(addr), "+c"(count) : "d"(port)); } static inline __attribute__((no_instrument_function)) void insb(int port, void *addr, unsigned long count) { asm volatile("rep; ins" "b" : "+D"(addr), "+c"(count) : "d"(port)); }
    klee_make_symbolic(&value, sizeof(char), "value");
...
struct arch_shared_info {
    ...
    klee_make_symbolic(&pfn_to_mfn_frame_list_list, sizeof(long), "pfn_to_mfn_frame_list_list");
    unsigned long nmi_reason;
    klee_make_symbolic(&nmi_reason, sizeof(long), "nmi_reason");
};
...
struct arch_vcpu_info {
    unsigned long cr2;
    unsigned long pad;
    klee_make_symbolic(&pad, sizeof(long), "pad");
};

typedef unsigned long xen_callback_t;
    klee_make_symbolic(&xen_callback_t, sizeof(long), "xen_callback_t");
...
struct vcpu_guest_context {
    ...
    struct { char x[512];
    klee_make_symbolic(x, sizeof(int)*512, "x"); } fpu_ctxt;
    ...
    klee_make_symbolic(ctrlreg, sizeof(long)*8, "ctrlreg");
    unsigned long debugreg[8];
    klee_make_symbolic(debugreg, sizeof(long)*8, "debugreg");
    ...
    klee_make_symbolic(&event_callback_eip, sizeof(long), "event_callback_eip");
    unsigned long failsafe_callback_eip;
    klee_make_symbolic(&failsafe_callback_eip, sizeof(long), "failsafe_callback_eip");
    unsigned long syscall_callback_eip;
    klee_make_symbolic(&syscall_callback_eip, sizeof(long), "syscall_callback_eip");

    unsigned long vm_assist;
    klee_make_symbolic(&vm_assist, sizeof(long), "vm_assist");
...
struct mmuext_op {
 ...
 union {
  ...
  unsigned long mfn;
    klee_make_symbolic(&mfn, sizeof(long), "mfn");

  unsigned long linear_addr;
    klee_make_symbolic(&linear_addr, sizeof(long), "linear_addr");
 } arg1;
 union {

  unsigned int nr_ents;
    klee_make_symbolic(&nr_ents, sizeof(int), "nr_ents");
...
struct multicall_entry {
    unsigned long op;
    klee_make_symbolic(&op, sizeof(long), "op");
    long result;
    klee_make_symbolic(&result, sizeof(long), "result");
    unsigned long args[6];
    klee_make_symbolic(args, sizeof(long)*6, "args");
};
...
struct vcpu_info {
 ...
 unsigned long evtchn_pending_sel;
    klee_make_symbolic(&evtchn_pending_sel, sizeof(long), "evtchn_pending_sel");
...
struct start_info {
 ...
 char magic[32];
    klee_make_symbolic(magic, sizeof(int)*32, "magic");
 unsigned long nr_pages;
 unsigned long shared_info;
    klee_make_symbolic(&shared_info, sizeof(long), "shared_info");
 uint32_t flags;
 unsigned long store_mfn;
    klee_make_symbolic(&store_mfn, sizeof(long), "store_mfn");
 ...
 unsigned long pt_base;
    klee_make_symbolic(&pt_base, sizeof(long), "pt_base");
 unsigned long nr_pt_frames;
    klee_make_symbolic(&nr_pt_frames, sizeof(long), "nr_pt_frames");
 unsigned long mfn_list;
    klee_make_symbolic(&mfn_list, sizeof(long), "mfn_list");
 unsigned long mod_start;
    klee_make_symbolic(&mod_start, sizeof(long), "mod_start");
 unsigned long mod_len;
    klee_make_symbolic(&mod_len, sizeof(long), "mod_len");
...
static inline __attribute__((no_instrument_function)) uint32_t xen_cpuid_base(void)
{
 ...
 char signature[13];
    klee_make_symbolic(signature, sizeof(char)*13, "signature");
...
extern unsigned long init_rsp;
    klee_make_symbolic(&init_rsp, sizeof(long), "init_rsp");
extern unsigned long initial_code;
    klee_make_symbolic(&initial_code, sizeof(long), "initial_code");
extern unsigned long initial_gs;
    klee_make_symbolic(&initial_gs, sizeof(long), "initial_gs");
...
extern int acpi_lapic;
    klee_make_symbolic(&acpi_lapic, sizeof(int), "acpi_lapic");
extern int acpi_ioapic;
    klee_make_symbolic(&acpi_ioapic, sizeof(int), "acpi_ioapic");
extern int acpi_noirq;
    klee_make_symbolic(&acpi_noirq, sizeof(int), "acpi_noirq");
extern int acpi_strict;
    klee_make_symbolic(&acpi_strict, sizeof(int), "acpi_strict");
extern int acpi_disabled;
    klee_make_symbolic(&acpi_disabled, sizeof(int), "acpi_disabled");
extern int acpi_pci_disabled;
    klee_make_symbolic(&acpi_pci_disabled, sizeof(int), "acpi_pci_disabled");
extern int acpi_skip_timer_override;
    klee_make_symbolic(&acpi_skip_timer_override, sizeof(int), "acpi_skip_timer_override");
extern int acpi_use_timer_override;
    klee_make_symbolic(&acpi_use_timer_override, sizeof(int), "acpi_use_timer_override");
extern int acpi_fix_pin2_polarity;
    klee_make_symbolic(&acpi_fix_pin2_polarity, sizeof(int), "acpi_fix_pin2_polarity");

extern u8 acpi_sci_flags;
extern int acpi_sci_override_gsi;
    klee_make_symbolic(&acpi_sci_override_gsi, sizeof(int), "acpi_sci_override_gsi");
...
extern int acpi_numa;
    klee_make_symbolic(&acpi_numa, sizeof(int), "acpi_numa");
...
extern int vgetcpu_mode;
    klee_make_symbolic(&vgetcpu_mode, sizeof(int), "vgetcpu_mode");
extern struct timezone sys_tz;
...
extern int fixmaps_set;
    klee_make_symbolic(&fixmaps_set, sizeof(int), "fixmaps_set");
...
extern unsigned int apic_verbosity;
    klee_make_symbolic(&apic_verbosity, sizeof(int), "apic_verbosity");
extern int local_apic_timer_c2_ok;
    klee_make_symbolic(&local_apic_timer_c2_ok, sizeof(int), "local_apic_timer_c2_ok");

extern int disable_apic;
    klee_make_symbolic(&disable_apic, sizeof(int), "disable_apic");
extern unsigned int lapic_timer_frequency;
    klee_make_symbolic(&lapic_timer_frequency, sizeof(int), "lapic_timer_frequency");
...
extern int x2apic_mode;
    klee_make_symbolic(&x2apic_mode, sizeof(int), "x2apic_mode");
...
extern int x2apic_phys;
    klee_make_symbolic(&x2apic_phys, sizeof(int), "x2apic_phys");
extern int x2apic_preenabled;
    klee_make_symbolic(&x2apic_preenabled, sizeof(int), "x2apic_preenabled");
...
struct apic {
 ...
 int disable_esr;
    klee_make_symbolic(&disable_esr, sizeof(int), "disable_esr");

 int dest_logical;
    klee_make_symbolic(&dest_logical, sizeof(int), "dest_logical");
 ...
 unsigned long apic_id_mask;
    klee_make_symbolic(&apic_id_mask, sizeof(long), "apic_id_mask");
 ...
 int trampoline_phys_low;
    klee_make_symbolic(&trampoline_phys_low, sizeof(int), "trampoline_phys_low");
 int trampoline_phys_high;
    klee_make_symbolic(&trampoline_phys_high, sizeof(int), "trampoline_phys_high");
...
extern __attribute__((section(".discard"), unused)) char __pcpu_scope_x2apic_extra_bits; extern __attribute__((section(".data..percpu" ""))) __typeof__(int) x2apic_extra_bits;
    klee_make_symbolic(&__pcpu_scope_x2apic_extra_bits, sizeof(char), "__pcpu_scope_x2apic_extra_bits");
...
extern int nr_ioapics;
    klee_make_symbolic(&nr_ioapics, sizeof(int), "nr_ioapics");
...
extern int mp_irq_entries;
    klee_make_symbolic(&mp_irq_entries, sizeof(int), "mp_irq_entries");
...
extern int sis_apic_bug;
    klee_make_symbolic(&sis_apic_bug, sizeof(int), "sis_apic_bug");


extern int skip_ioapic_setup;
    klee_make_symbolic(&skip_ioapic_setup, sizeof(int), "skip_ioapic_setup");


extern int noioapicquirk;
    klee_make_symbolic(&noioapicquirk, sizeof(int), "noioapicquirk");


extern int noioapicreroute;
    klee_make_symbolic(&noioapicreroute, sizeof(int), "noioapicreroute");


extern int timer_through_8259;
    klee_make_symbolic(&timer_through_8259, sizeof(int), "timer_through_8259");
...
extern int smp_num_siblings;
    klee_make_symbolic(&smp_num_siblings, sizeof(int), "smp_num_siblings");
extern unsigned int num_processors;
    klee_make_symbolic(&num_processors, sizeof(int), "num_processors");
...
extern __attribute__((section(".discard"), unused)) char __pcpu_scope_cpu_sibling_map; extern __attribute__((section(".data..percpu" ""))) __typeof__(cpumask_var_t) cpu_sibling_map;
    klee_make_symbolic(&__pcpu_scope_cpu_sibling_map, sizeof(char), "__pcpu_scope_cpu_sibling_map");
extern __attribute__((section(".discard"), unused)) char __pcpu_scope_cpu_core_map; extern __attribute__((section(".data..percpu" ""))) __typeof__(cpumask_var_t) cpu_core_map;
    klee_make_symbolic(&__pcpu_scope_cpu_core_map, sizeof(char), "__pcpu_scope_cpu_core_map");
...
extern __attribute__((section(".discard"), unused)) char __pcpu_scope_cpu_llc_shared_map; extern __attribute__((section(".data..percpu" ""))) __typeof__(cpumask_var_t) cpu_llc_shared_map;
    klee_make_symbolic(&__pcpu_scope_cpu_llc_shared_map, sizeof(char), "__pcpu_scope_cpu_llc_shared_map");
extern __attribute__((section(".discard"), unused)) char __pcpu_scope_cpu_llc_id; extern __attribute__((section(".data..percpu" ""))) __typeof__(u16) cpu_llc_id;
    klee_make_symbolic(&__pcpu_scope_cpu_llc_id, sizeof(char), "__pcpu_scope_cpu_llc_id");
extern __attribute__((section(".discard"), unused)) char __pcpu_scope_cpu_number; extern __attribute__((section(".data..percpu" ""))) __typeof__(int) cpu_number;
    klee_make_symbolic(&__pcpu_scope_cpu_number, sizeof(char), "__pcpu_scope_cpu_number");
...
extern unsigned long stack_start;
    klee_make_symbolic(&stack_start, sizeof(long), "stack_start");
...
struct mem_section {
 unsigned long section_mem_map;
    klee_make_symbolic(&section_mem_map, sizeof(long), "section_mem_map");
...
extern unsigned int total_cpus;
    klee_make_symbolic(&total_cpus, sizeof(int), "total_cpus");
...
extern unsigned int setup_max_cpus;
    klee_make_symbolic(&setup_max_cpus, sizeof(int), "setup_max_cpus");
...
struct pcpu_group_info {
 int nr_units;
    klee_make_symbolic(&nr_units, sizeof(int), "nr_units");
 unsigned long base_offset;
    klee_make_symbolic(&base_offset, sizeof(long), "base_offset");
...
struct pcpu_alloc_info {
 ...
 size_t __ai_size;
 int nr_groups;
    klee_make_symbolic(&nr_groups, sizeof(int), "nr_groups");
...
extern __attribute__((section(".discard"), unused)) char __pcpu_scope_numa_node; extern __attribute__((section(".data..percpu" ""))) __typeof__(int) numa_node;
    klee_make_symbolic(&__pcpu_scope_numa_node, sizeof(char), "__pcpu_scope_numa_node");
...
struct __sysctl_args {
 int *name;
 int nlen;
    klee_make_symbolic(&nlen, sizeof(int), "nlen");
 void *oldval;
 size_t *oldlenp;
 void *newval;
 size_t newlen;
 unsigned long __unused[4];
    klee_make_symbolic(__unused, sizeof(long)*4, "__unused");
};
...
struct user_i387_struct {
 unsigned short cwd;
    klee_make_symbolic(&cwd, sizeof(short), "cwd");
 unsigned short swd;
    klee_make_symbolic(&swd, sizeof(short), "swd");
 unsigned short twd;
    klee_make_symbolic(&twd, sizeof(short), "twd");

 unsigned short fop;
    klee_make_symbolic(&fop, sizeof(short), "fop");
 __u64 rip;
 __u64 rdp;
 __u32 mxcsr;
 __u32 mxcsr_mask;
...
struct user_regs_struct {
 ...
 unsigned long fs_base;
    klee_make_symbolic(&fs_base, sizeof(long), "fs_base");
 unsigned long gs_base;
    klee_make_symbolic(&gs_base, sizeof(long), "gs_base");
 unsigned long ds;
 unsigned long es;
 unsigned long fs;
 unsigned long gs;
...
struct user {
  ...
  int u_fpvalid;
    klee_make_symbolic(&u_fpvalid, sizeof(int), "u_fpvalid");

  int pad0;
    klee_make_symbolic(&pad0, sizeof(int), "pad0");
  struct user_i387_struct i387;

  unsigned long int u_tsize;
    klee_make_symbolic(&u_tsize, sizeof(int), "u_tsize");
  unsigned long int u_dsize;
    klee_make_symbolic(&u_dsize, sizeof(int), "u_dsize");
  unsigned long int u_ssize;
    klee_make_symbolic(&u_ssize, sizeof(int), "u_ssize");
  ...
  long int signal;
    klee_make_symbolic(&signal, sizeof(int), "signal");
  int reserved;
  int pad1;
    klee_make_symbolic(&pad1, sizeof(int), "pad1");
  unsigned long u_ar0;
    klee_make_symbolic(&u_ar0, sizeof(long), "u_ar0");

  struct user_i387_struct *u_fpstate;
  unsigned long magic;
    klee_make_symbolic(&magic, sizeof(long), "magic");
  char u_comm[32];
    klee_make_symbolic(u_comm, sizeof(char)*32, "u_comm");
  unsigned long u_debugreg[8];
    klee_make_symbolic(u_debugreg, sizeof(long)*8, "u_debugreg");
  unsigned long error_code;
  unsigned long fault_address;
    klee_make_symbolic(&fault_address, sizeof(long), "fault_address");
};
...
typedef unsigned long elf_greg_t;
    klee_make_symbolic(&elf_greg_t, sizeof(long), "elf_greg_t");
...
extern unsigned int vdso_enabled;
    klee_make_symbolic(&vdso_enabled, sizeof(int), "vdso_enabled");
...
extern unsigned int sysctl_vsyscall32;
    klee_make_symbolic(&sysctl_vsyscall32, sizeof(int), "sysctl_vsyscall32");
extern int force_personality32;
    klee_make_symbolic(&force_personality32, sizeof(int), "force_personality32");
struct task_struct;
struct linux_binprm;
...
struct va_alignment {
 int flags;
 unsigned long mask;
    klee_make_symbolic(&mask, sizeof(long), "mask");
} __attribute__((__aligned__((1 << (6)))));
...
typedef struct elf32_hdr{
  unsigned char e_ident[16];
    klee_make_symbolic(e_ident, sizeof(char)*16, "e_ident");
  Elf32_Half e_type;
...
struct kobj_uevent_env {
 ...
 char buf[2048];
    klee_make_symbolic(buf, sizeof(int)*2048, "buf");
 int buflen;
...
{
 unsigned long crc;
    klee_make_symbolic(&crc, sizeof(long), "crc");
...
extern int modules_disabled;
    klee_make_symbolic(&modules_disabled, sizeof(int), "modules_disabled");
...
extern int module_sysfs_initialized;
    klee_make_symbolic(&module_sysfs_initialized, sizeof(int), "module_sysfs_initialized");
...
typedef struct __user_cap_header_struct {
 __u32 version;
 int pid;
    klee_make_symbolic(&pid, sizeof(int), "pid");
} *cap_user_header_t;
...
extern int file_caps_enabled;
    klee_make_symbolic(&file_caps_enabled, sizeof(int), "file_caps_enabled");
...
struct prio_tree_iter {
 ...
 unsigned long value;
 int size_level;
    klee_make_symbolic(&size_level, sizeof(int), "size_level");

 struct prio_tree_root *root;
 unsigned long r_index;
    klee_make_symbolic(&r_index, sizeof(long), "r_index");
 unsigned long h_index;
    klee_make_symbolic(&h_index, sizeof(long), "h_index");
};
...
typedef unsigned long vm_flags_t;
    klee_make_symbolic(&vm_flags_t, sizeof(long), "vm_flags_t");
...
struct vm_region {
 ...
 unsigned long vm_top;
    klee_make_symbolic(&vm_top, sizeof(long), "vm_top");
 unsigned long vm_pgoff;
    klee_make_symbolic(&vm_pgoff, sizeof(long), "vm_pgoff");
 struct file *vm_file;

 int vm_usage;
    klee_make_symbolic(&vm_usage, sizeof(int), "vm_usage");
...
struct ipc_perm
{
 ...
 unsigned short seq;
    klee_make_symbolic(&seq, sizeof(short), "seq");
};
...
struct ipc64_perm {
 ...
 unsigned short __pad2;
    klee_make_symbolic(&__pad2, sizeof(short), "__pad2");
 unsigned long __unused1;
    klee_make_symbolic(&__unused1, sizeof(long), "__unused1");
 unsigned long __unused2;
    klee_make_symbolic(&__unused2, sizeof(long), "__unused2");
};
struct ipc_kludge {
 struct msgbuf *msgp;
 long msgtyp;
    klee_make_symbolic(&msgtyp, sizeof(long), "msgtyp");
};
struct kern_ipc_perm
{
 spinlock_t lock;
 int deleted;
    klee_make_symbolic(&deleted, sizeof(int), "deleted");
 int id;
...
struct semid_ds {
 ...
 unsigned short sem_nsems;
    klee_make_symbolic(&sem_nsems, sizeof(short), "sem_nsems");
};
...
struct semid64_ds {
 ...
 unsigned long __unused3;
    klee_make_symbolic(&__unused3, sizeof(long), "__unused3");
 unsigned long __unused4;
    klee_make_symbolic(&__unused4, sizeof(long), "__unused4");
};


struct sembuf {
 unsigned short sem_num;
    klee_make_symbolic(&sem_num, sizeof(short), "sem_num");
 short sem_op;
    klee_make_symbolic(&sem_op, sizeof(short), "sem_op");
 short sem_flg;
    klee_make_symbolic(&sem_flg, sizeof(short), "sem_flg");
};
...
struct seminfo {
 int semmap;
    klee_make_symbolic(&semmap, sizeof(int), "semmap");
 int semmni;
    klee_make_symbolic(&semmni, sizeof(int), "semmni");
 int semmns;
    klee_make_symbolic(&semmns, sizeof(int), "semmns");
 int semmnu;
    klee_make_symbolic(&semmnu, sizeof(int), "semmnu");
 int semmsl;
    klee_make_symbolic(&semmsl, sizeof(int), "semmsl");
 int semopm;
    klee_make_symbolic(&semopm, sizeof(int), "semopm");
 int semume;
    klee_make_symbolic(&semume, sizeof(int), "semume");
 int semusz;
    klee_make_symbolic(&semusz, sizeof(int), "semusz");
 int semvmx;
    klee_make_symbolic(&semvmx, sizeof(int), "semvmx");
 int semaem;
    klee_make_symbolic(&semaem, sizeof(int), "semaem");
};
struct task_struct;
...
struct sem_array {
 ...
 int sem_nsems;
 int complex_count;
    klee_make_symbolic(&complex_count, sizeof(int), "complex_count");
};
...
typedef unsigned long old_sigset_t;
    klee_make_symbolic(&old_sigset_t, sizeof(long), "old_sigset_t");
...
typedef struct sigaltstack {
 void *ss_sp;
 int ss_flags;
    klee_make_symbolic(&ss_flags, sizeof(int), "ss_flags");
 size_t ss_size;
} stack_t;
...
typedef struct sigevent {
 ...
 int sigev_signo;
    klee_make_symbolic(&sigev_signo, sizeof(int), "sigev_signo");
 int sigev_notify;
    klee_make_symbolic(&sigev_notify, sizeof(int), "sigev_notify");
 union {
  int _pad[((64 - (sizeof(int) * 2 + sizeof(sigval_t))) / sizeof(int))];
   int _tid;
    klee_make_symbolic(&_tid, sizeof(int), "_tid");
...
extern int print_fatal_signals;
    klee_make_symbolic(&print_fatal_signals, sizeof(int), "print_fatal_signals");
...
extern int show_unhandled_signals;
    klee_make_symbolic(&show_unhandled_signals, sizeof(int), "show_unhandled_signals");
...
extern int percpu_counter_batch;
    klee_make_symbolic(&percpu_counter_batch, sizeof(int), "percpu_counter_batch");
...
struct prop_local_percpu {
 ...
 unsigned long period;
    klee_make_symbolic(&period, sizeof(long), "period");
 raw_spinlock_t lock;
};
...
struct prop_local_single {
 ...
 unsigned long events;
    klee_make_symbolic(&events, sizeof(long), "events");
...
extern int max_lock_depth;
    klee_make_symbolic(&max_lock_depth, sizeof(int), "max_lock_depth");
struct rt_mutex {
 raw_spinlock_t wait_lock;
...
struct rusage {
 ...
 long ru_maxrss;
    klee_make_symbolic(&ru_maxrss, sizeof(long), "ru_maxrss");
 long ru_ixrss;
    klee_make_symbolic(&ru_ixrss, sizeof(long), "ru_ixrss");
 long ru_idrss;
    klee_make_symbolic(&ru_idrss, sizeof(long), "ru_idrss");
 long ru_isrss;
    klee_make_symbolic(&ru_isrss, sizeof(long), "ru_isrss");
 long ru_minflt;
    klee_make_symbolic(&ru_minflt, sizeof(long), "ru_minflt");
 long ru_majflt;
    klee_make_symbolic(&ru_majflt, sizeof(long), "ru_majflt");
 long ru_nswap;
    klee_make_symbolic(&ru_nswap, sizeof(long), "ru_nswap");
 long ru_inblock;
    klee_make_symbolic(&ru_inblock, sizeof(long), "ru_inblock");
 long ru_oublock;
    klee_make_symbolic(&ru_oublock, sizeof(long), "ru_oublock");
 long ru_msgsnd;
    klee_make_symbolic(&ru_msgsnd, sizeof(long), "ru_msgsnd");
 long ru_msgrcv;
    klee_make_symbolic(&ru_msgrcv, sizeof(long), "ru_msgrcv");
 long ru_nsignals;
    klee_make_symbolic(&ru_nsignals, sizeof(long), "ru_nsignals");
 long ru_nvcsw;
    klee_make_symbolic(&ru_nvcsw, sizeof(long), "ru_nvcsw");
 long ru_nivcsw;
    klee_make_symbolic(&ru_nivcsw, sizeof(long), "ru_nivcsw");
};
...
extern __attribute__((section(".discard"), unused)) char __pcpu_scope_tick_cpu_device; extern __attribute__((section(".data..percpu" ""))) __typeof__(struct tick_device) tick_cpu_device;
    klee_make_symbolic(&__pcpu_scope_tick_cpu_device, sizeof(char), "__pcpu_scope_tick_cpu_device");
...
{
 unsigned long delta;
    klee_make_symbolic(&delta, sizeof(long), "delta");
 ktime_t soft, hard;
...
struct latency_record {
 unsigned long backtrace[12];
    klee_make_symbolic(backtrace, sizeof(long)*12, "backtrace");
 unsigned int count;
 unsigned long time;
...
extern int latencytop_enabled;
    klee_make_symbolic(&latencytop_enabled, sizeof(int), "latencytop_enabled");
...
struct key {
 ...
 union {
  ...
  unsigned long x[2];
    klee_make_symbolic(x, sizeof(int)*2, "x");
  void *p[2];
  int reject_error;
...
extern unsigned long total_forks;
    klee_make_symbolic(&total_forks, sizeof(long), "total_forks");
...
extern __attribute__((section(".discard"), unused)) char __pcpu_scope_process_counts; extern __attribute__((section(".data..percpu" ""))) __typeof__(unsigned long) process_counts;
    klee_make_symbolic(&__pcpu_scope_process_counts, sizeof(char), "__pcpu_scope_process_counts");
...
extern unsigned int softlockup_panic;
    klee_make_symbolic(&softlockup_panic, sizeof(int), "softlockup_panic");
void lockup_detector_init(void);
extern unsigned int sysctl_hung_task_panic;
    klee_make_symbolic(&sysctl_hung_task_panic, sizeof(int), "sysctl_hung_task_panic");
extern unsigned long sysctl_hung_task_check_count;
    klee_make_symbolic(&sysctl_hung_task_check_count, sizeof(long), "sysctl_hung_task_check_count");
extern unsigned long sysctl_hung_task_timeout_secs;
    klee_make_symbolic(&sysctl_hung_task_timeout_secs, sizeof(long), "sysctl_hung_task_timeout_secs");
extern unsigned long sysctl_hung_task_warnings;
    klee_make_symbolic(&sysctl_hung_task_warnings, sizeof(long), "sysctl_hung_task_warnings");
...
extern int sysctl_max_map_count;
    klee_make_symbolic(&sysctl_max_map_count, sizeof(int), "sysctl_max_map_count");
...
extern unsigned long aio_nr;
    klee_make_symbolic(&aio_nr, sizeof(long), "aio_nr");
extern unsigned long aio_max_nr;
    klee_make_symbolic(&aio_max_nr, sizeof(long), "aio_max_nr");
...
struct sched_group_power {
 ...
 unsigned long next_update;
    klee_make_symbolic(&next_update, sizeof(long), "next_update");
...
struct sched_group {
 ...
 unsigned int group_weight;
    klee_make_symbolic(&group_weight, sizeof(int), "group_weight");
 struct sched_group_power *sgp;
 unsigned long cpumask[0];
    klee_make_symbolic(cpumask, sizeof(int)*0, "cpumask");
};
...
struct sched_domain_attr {
 int relax_domain_level;
    klee_make_symbolic(&relax_domain_level, sizeof(int), "relax_domain_level");
};
...
extern int sched_domain_level_max;
    klee_make_symbolic(&sched_domain_level_max, sizeof(int), "sched_domain_level_max");
...
struct sched_domain {
 ...
 unsigned long min_interval;
    klee_make_symbolic(&min_interval, sizeof(long), "min_interval");
 unsigned long max_interval;
    klee_make_symbolic(&max_interval, sizeof(long), "max_interval");
 unsigned int busy_factor;
    klee_make_symbolic(&busy_factor, sizeof(int), "busy_factor");
 unsigned int imbalance_pct;
    klee_make_symbolic(&imbalance_pct, sizeof(int), "imbalance_pct");
 unsigned int cache_nice_tries;
    klee_make_symbolic(&cache_nice_tries, sizeof(int), "cache_nice_tries");
 unsigned int busy_idx;
    klee_make_symbolic(&busy_idx, sizeof(int), "busy_idx");
 unsigned int idle_idx;
    klee_make_symbolic(&idle_idx, sizeof(int), "idle_idx");
 unsigned int newidle_idx;
    klee_make_symbolic(&newidle_idx, sizeof(int), "newidle_idx");
 unsigned int wake_idx;
    klee_make_symbolic(&wake_idx, sizeof(int), "wake_idx");
 unsigned int forkexec_idx;
    klee_make_symbolic(&forkexec_idx, sizeof(int), "forkexec_idx");
 unsigned int smt_gain;
    klee_make_symbolic(&smt_gain, sizeof(int), "smt_gain");
 int flags;
 int level;


 unsigned long last_balance;
    klee_make_symbolic(&last_balance, sizeof(long), "last_balance");
 unsigned int balance_interval;
    klee_make_symbolic(&balance_interval, sizeof(int), "balance_interval");
 unsigned int nr_balance_failed;
    klee_make_symbolic(&nr_balance_failed, sizeof(int), "nr_balance_failed");
 ...
 unsigned int alb_count;
    klee_make_symbolic(&alb_count, sizeof(int), "alb_count");
 unsigned int alb_failed;
    klee_make_symbolic(&alb_failed, sizeof(int), "alb_failed");
 unsigned int alb_pushed;
    klee_make_symbolic(&alb_pushed, sizeof(int), "alb_pushed");


 unsigned int sbe_count;
    klee_make_symbolic(&sbe_count, sizeof(int), "sbe_count");
 unsigned int sbe_balanced;
    klee_make_symbolic(&sbe_balanced, sizeof(int), "sbe_balanced");
 unsigned int sbe_pushed;
    klee_make_symbolic(&sbe_pushed, sizeof(int), "sbe_pushed");


 unsigned int sbf_count;
    klee_make_symbolic(&sbf_count, sizeof(int), "sbf_count");
 unsigned int sbf_balanced;
    klee_make_symbolic(&sbf_balanced, sizeof(int), "sbf_balanced");
 unsigned int sbf_pushed;
    klee_make_symbolic(&sbf_pushed, sizeof(int), "sbf_pushed");


 unsigned int ttwu_wake_remote;
    klee_make_symbolic(&ttwu_wake_remote, sizeof(int), "ttwu_wake_remote");
 unsigned int ttwu_move_affine;
    klee_make_symbolic(&ttwu_move_affine, sizeof(int), "ttwu_move_affine");
 unsigned int ttwu_move_balance;
    klee_make_symbolic(&ttwu_move_balance, sizeof(int), "ttwu_move_balance");
 ...
 unsigned int span_weight;
    klee_make_symbolic(&span_weight, sizeof(int), "span_weight");
 ...
 unsigned long span[0];
    klee_make_symbolic(span, sizeof(long)*0, "span");
};
...
struct task_struct {
 ...
 char comm[16];
    klee_make_symbolic(comm, sizeof(int)*16, "comm");
...
extern int sched_clock_stable;
    klee_make_symbolic(&sched_clock_stable, sizeof(int), "sched_clock_stable");
...
extern unsigned int sysctl_sched_latency;
    klee_make_symbolic(&sysctl_sched_latency, sizeof(int), "sysctl_sched_latency");
extern unsigned int sysctl_sched_min_granularity;
    klee_make_symbolic(&sysctl_sched_min_granularity, sizeof(int), "sysctl_sched_min_granularity");
extern unsigned int sysctl_sched_wakeup_granularity;
    klee_make_symbolic(&sysctl_sched_wakeup_granularity, sizeof(int), "sysctl_sched_wakeup_granularity");
extern unsigned int sysctl_sched_child_runs_first;
    klee_make_symbolic(&sysctl_sched_child_runs_first, sizeof(int), "sysctl_sched_child_runs_first");
...
extern unsigned int sysctl_sched_migration_cost;
    klee_make_symbolic(&sysctl_sched_migration_cost, sizeof(int), "sysctl_sched_migration_cost");
extern unsigned int sysctl_sched_nr_migrate;
    klee_make_symbolic(&sysctl_sched_nr_migrate, sizeof(int), "sysctl_sched_nr_migrate");
extern unsigned int sysctl_sched_time_avg;
    klee_make_symbolic(&sysctl_sched_time_avg, sizeof(int), "sysctl_sched_time_avg");
extern unsigned int sysctl_timer_migration;
    klee_make_symbolic(&sysctl_timer_migration, sizeof(int), "sysctl_timer_migration");
extern unsigned int sysctl_sched_shares_window;
    klee_make_symbolic(&sysctl_sched_shares_window, sizeof(int), "sysctl_sched_shares_window");
...
extern unsigned int sysctl_sched_rt_period;
    klee_make_symbolic(&sysctl_sched_rt_period, sizeof(int), "sysctl_sched_rt_period");
extern int sysctl_sched_rt_runtime;
    klee_make_symbolic(&sysctl_sched_rt_runtime, sizeof(int), "sysctl_sched_rt_runtime");
...
extern unsigned int sysctl_sched_autogroup_enabled;
    klee_make_symbolic(&sysctl_sched_autogroup_enabled, sizeof(int), "sysctl_sched_autogroup_enabled");
...
extern unsigned int sysctl_sched_cfs_bandwidth_slice;
    klee_make_symbolic(&sysctl_sched_cfs_bandwidth_slice, sizeof(int), "sysctl_sched_cfs_bandwidth_slice");
...
extern unsigned long lpj_fine;
    klee_make_symbolic(&lpj_fine, sizeof(long), "lpj_fine");
...
extern int nr_irqs;
    klee_make_symbolic(&nr_irqs, sizeof(int), "nr_irqs");
...
extern __attribute__((section(".discard"), unused)) char __pcpu_scope_irq_regs; extern __attribute__((section(".data..percpu" ""))) __typeof__(struct pt_regs *) irq_regs;
    klee_make_symbolic(&__pcpu_scope_irq_regs, sizeof(char), "__pcpu_scope_irq_regs");
...
struct irq_desc {
 ...
 unsigned int status_use_accessors;
    klee_make_symbolic(&status_use_accessors, sizeof(int), "status_use_accessors");
 unsigned int core_internal_state__do_not_mess_with_it;
    klee_make_symbolic(&core_internal_state__do_not_mess_with_it, sizeof(int), "core_internal_state__do_not_mess_with_it");
 unsigned int depth;
    klee_make_symbolic(&depth, sizeof(int), "depth");
 unsigned int wake_depth;
    klee_make_symbolic(&wake_depth, sizeof(int), "wake_depth");
 unsigned int irq_count;
    klee_make_symbolic(&irq_count, sizeof(int), "irq_count");
 unsigned long last_unhandled;
    klee_make_symbolic(&last_unhandled, sizeof(long), "last_unhandled");
 unsigned int irqs_unhandled;
    klee_make_symbolic(&irqs_unhandled, sizeof(int), "irqs_unhandled");
 raw_spinlock_t lock;
 ...
 unsigned long threads_oneshot;
    klee_make_symbolic(&threads_oneshot, sizeof(long), "threads_oneshot");
...
struct __large_struct { unsigned long buf[100];
    klee_make_symbolic(buf, sizeof(int)*100, "buf"); };
extern unsigned long
...
extern unsigned long io_apic_irqs;
    klee_make_symbolic(&io_apic_irqs, sizeof(long), "io_apic_irqs");
...
struct io_apic_irq_attr {
 int ioapic;
    klee_make_symbolic(&ioapic, sizeof(int), "ioapic");
 int ioapic_pin;
    klee_make_symbolic(&ioapic_pin, sizeof(int), "ioapic_pin");
 int trigger;
    klee_make_symbolic(&trigger, sizeof(int), "trigger");
 int polarity;
    klee_make_symbolic(&polarity, sizeof(int), "polarity");
};
...
typedef int vector_irq_t[256];
    klee_make_symbolic(vector_irq_t, sizeof(int)*256, "vector_irq_t");
extern __attribute__((section(".discard"), unused)) char __pcpu_scope_vector_irq; extern __attribute__((section(".data..percpu" ""))) __typeof__(vector_irq_t) vector_irq;
    klee_make_symbolic(&__pcpu_scope_vector_irq, sizeof(char), "__pcpu_scope_vector_irq");
...
extern int no_irq_affinity;
    klee_make_symbolic(&no_irq_affinity, sizeof(int), "no_irq_affinity");
...
struct irq_chip_regs {
 unsigned long enable;
    klee_make_symbolic(&enable, sizeof(long), "enable");
 unsigned long disable;
    klee_make_symbolic(&disable, sizeof(long), "disable");
 unsigned long mask;
 unsigned long ack;
    klee_make_symbolic(&ack, sizeof(long), "ack");
 unsigned long eoi;
 unsigned long type;
...
struct irq_chip_generic {
 ...
 unsigned int irq_base;
    klee_make_symbolic(&irq_base, sizeof(int), "irq_base");
 unsigned int irq_cnt;
    klee_make_symbolic(&irq_cnt, sizeof(int), "irq_cnt");
 u32 mask_cache;
 u32 type_cache;
 u32 polarity_cache;
 u32 wake_enabled;
 u32 wake_active;
 unsigned int num_ct;
    klee_make_symbolic(&num_ct, sizeof(int), "num_ct");
 void *private;
 struct list_head list;
...
typedef struct {
 unsigned int __softirq_pending;
    klee_make_symbolic(&__softirq_pending, sizeof(int), "__softirq_pending");
 unsigned int __nmi_count;
    klee_make_symbolic(&__nmi_count, sizeof(int), "__nmi_count");

 unsigned int apic_timer_irqs;
    klee_make_symbolic(&apic_timer_irqs, sizeof(int), "apic_timer_irqs");
 unsigned int irq_spurious_count;
    klee_make_symbolic(&irq_spurious_count, sizeof(int), "irq_spurious_count");
 unsigned int icr_read_retry_count;
    klee_make_symbolic(&icr_read_retry_count, sizeof(int), "icr_read_retry_count");

 unsigned int x86_platform_ipis;
    klee_make_symbolic(&x86_platform_ipis, sizeof(int), "x86_platform_ipis");
 unsigned int apic_perf_irqs;
    klee_make_symbolic(&apic_perf_irqs, sizeof(int), "apic_perf_irqs");
 unsigned int apic_irq_work_irqs;
    klee_make_symbolic(&apic_irq_work_irqs, sizeof(int), "apic_irq_work_irqs");

 unsigned int irq_resched_count;
    klee_make_symbolic(&irq_resched_count, sizeof(int), "irq_resched_count");
 unsigned int irq_call_count;
    klee_make_symbolic(&irq_call_count, sizeof(int), "irq_call_count");
 unsigned int irq_tlb_count;
    klee_make_symbolic(&irq_tlb_count, sizeof(int), "irq_tlb_count");


 unsigned int irq_thermal_count;
    klee_make_symbolic(&irq_thermal_count, sizeof(int), "irq_thermal_count");


 unsigned int irq_threshold_count;
    klee_make_symbolic(&irq_threshold_count, sizeof(int), "irq_threshold_count");
...
extern __attribute__((section(".discard"), unused)) char __pcpu_scope_irq_stat; extern __attribute__((section(".data..percpu" ""))) __typeof__(irq_cpustat_t) irq_stat __attribute__((__aligned__((1 << (6)))));
    klee_make_symbolic(&__pcpu_scope_irq_stat, sizeof(char), "__pcpu_scope_irq_stat");
...
struct irqaction {
 ...
 unsigned long thread_flags;
    klee_make_symbolic(&thread_flags, sizeof(long), "thread_flags");
 unsigned long thread_mask;
    klee_make_symbolic(&thread_mask, sizeof(long), "thread_mask");
 const char *name;
 struct proc_dir_entry *dir;
} __attribute__((__aligned__(1 << (12))));
...
extern __attribute__((section(".discard"), unused)) char __pcpu_scope_ksoftirqd; extern __attribute__((section(".data..percpu" ""))) __typeof__(struct task_struct *) ksoftirqd;
    klee_make_symbolic(&__pcpu_scope_ksoftirqd, sizeof(char), "__pcpu_scope_ksoftirqd");
...
extern int C_A_D;
    klee_make_symbolic(&C_A_D, sizeof(int), "C_A_D");
void ctrl_alt_del(void);


extern char poweroff_cmd[256];
    klee_make_symbolic(poweroff_cmd, sizeof(char)*256, "poweroff_cmd");
...
struct map_info {
 ...
 int swap;
    klee_make_symbolic(&swap, sizeof(int), "swap");
 int bankwidth;
    klee_make_symbolic(&bankwidth, sizeof(int), "bankwidth");
 ...
 unsigned long pfow_base;
    klee_make_symbolic(&pfow_base, sizeof(long), "pfow_base");
 unsigned long map_priv_1;
    klee_make_symbolic(&map_priv_1, sizeof(long), "map_priv_1");
 unsigned long map_priv_2;
    klee_make_symbolic(&map_priv_2, sizeof(long), "map_priv_2");
 void *fldrv_priv;
...
extern long sysfs_deprecated;
    klee_make_symbolic(&sysfs_deprecated, sizeof(long), "sysfs_deprecated");
...
struct flchip {
 ...
 int ref_point_counter;
    klee_make_symbolic(&ref_point_counter, sizeof(int), "ref_point_counter");
 flstate_t state;
 flstate_t oldstate;
 ...
 unsigned long in_progress_block_addr;
    klee_make_symbolic(&in_progress_block_addr, sizeof(long), "in_progress_block_addr");

 struct mutex mutex;
 wait_queue_head_t wq;

 int word_write_time;
    klee_make_symbolic(&word_write_time, sizeof(int), "word_write_time");
 int buffer_write_time;
    klee_make_symbolic(&buffer_write_time, sizeof(int), "buffer_write_time");
 int erase_time;
    klee_make_symbolic(&erase_time, sizeof(int), "erase_time");

 int word_write_time_max;
    klee_make_symbolic(&word_write_time_max, sizeof(int), "word_write_time_max");
 int buffer_write_time_max;
    klee_make_symbolic(&buffer_write_time_max, sizeof(int), "buffer_write_time_max");
 int erase_time_max;
    klee_make_symbolic(&erase_time_max, sizeof(int), "erase_time_max");
...
struct cfi_private {
 ...
 void *cmdset_priv;
 int interleave;
    klee_make_symbolic(&interleave, sizeof(int), "interleave");
 int device_type;
    klee_make_symbolic(&device_type, sizeof(int), "device_type");
 int cfi_mode;
    klee_make_symbolic(&cfi_mode, sizeof(int), "cfi_mode");
 int addr_unlock1;
    klee_make_symbolic(&addr_unlock1, sizeof(int), "addr_unlock1");
 int addr_unlock2;
    klee_make_symbolic(&addr_unlock2, sizeof(int), "addr_unlock2");
 struct mtd_info *(*cmdset_setup)(struct map_info *);
 struct cfi_ident *cfiq;

 int mfr, id;
 int numchips;
    klee_make_symbolic(&numchips, sizeof(int), "numchips");
 map_word sector_erase_cmd;
 unsigned long chipshift;
    klee_make_symbolic(&chipshift, sizeof(long), "chipshift");
 const char *im_name;
...
static inline __attribute__((no_instrument_function)) map_word cfi_build_cmd(u_long cmd, struct map_info *map, struct cfi_private *cfi)
{
 ...
 unsigned long onecmd;
    klee_make_symbolic(&onecmd, sizeof(long), "onecmd");
 int i;
...
static int do_point_onechip (struct map_info *map, struct flchip *chip, loff_t adr, size_t len)
{
 unsigned long cmd_addr;
    klee_make_symbolic(&cmd_addr, sizeof(long), "cmd_addr");
 struct cfi_private *cfi = map->fldrv_priv;
 int ret = 0;
  ...
  size_t *retlen, void **virt, resource_size_t *phys)
{
 ...
 int chipnum;
    klee_make_symbolic(&chipnum, sizeof(int), "chipnum");
 int ret = 0;
 ...
 *virt = map->virt + cfi->chips[chipnum].start + ofs;
 ...
 while (len) {
  unsigned long thislen;
    klee_make_symbolic(&thislen, sizeof(long), "thislen");
...
static int cfi_intelext_unpoint(struct mtd_info *mtd, loff_t from, size_t len)
{
 ...
 struct cfi_private *cfi = map->fldrv_priv;
 unsigned long ofs;
    klee_make_symbolic(&ofs, sizeof(long), "ofs");
 int chipnum, err = 0;
        ...
        unsigned long *pvec_seek, int len)
{
 ...
 unsigned long cmd_adr;
    klee_make_symbolic(&cmd_adr, sizeof(long), "cmd_adr");
 int ret, wbufsize, word_gap, words;
 const struct kvec *vec;
 unsigned long vec_seek;
    klee_make_symbolic(&vec_seek, sizeof(long), "vec_seek");
 unsigned long initial_adr;
    klee_make_symbolic(&initial_adr, sizeof(long), "initial_adr");
 int initial_len = len;
...
static void cfi_intelext_save_locks(struct mtd_info *mtd)
{
 ...
 int block, status, i;
 unsigned long adr;
    klee_make_symbolic(&adr, sizeof(long), "adr");
 size_t len;
