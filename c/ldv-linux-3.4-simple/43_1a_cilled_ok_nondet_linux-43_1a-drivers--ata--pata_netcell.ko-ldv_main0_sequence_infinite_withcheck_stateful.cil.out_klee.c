...
{ struct ata_device *var_group1 ;
  ...
  int res_netcell_init_one_1 ;
    klee_make_symbolic(&res_netcell_init_one_1, sizeof(int), "res_netcell_init_one_1");
  int ldv_s_netcell_pci_driver_pci_driver ;
    klee_make_symbolic(&ldv_s_netcell_pci_driver_pci_driver, sizeof(int), "ldv_s_netcell_pci_driver_pci_driver");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
