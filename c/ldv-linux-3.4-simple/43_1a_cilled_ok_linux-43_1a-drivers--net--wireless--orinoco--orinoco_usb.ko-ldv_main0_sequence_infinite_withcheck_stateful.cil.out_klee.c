...
struct key_params {
   ...
   int seq_len ;
    klee_make_symbolic(&seq_len, sizeof(int), "seq_len");
   u32 cipher ;
};
...
struct hermes {
   void *iobase ;
   int reg_spacing ;
    klee_make_symbolic(&reg_spacing, sizeof(int), "reg_spacing");
   u16 inten ;
   bool eeprom_pda ;
...
struct orinoco_private {
   ...
   spinlock_t lock ;
   int hw_unavailable ;
    klee_make_symbolic(&hw_unavailable, sizeof(int), "hw_unavailable");
   ...
   int ibss_port ;
    klee_make_symbolic(&ibss_port, sizeof(int), "ibss_port");
   int nicbuf_size ;
    klee_make_symbolic(&nicbuf_size, sizeof(int), "nicbuf_size");
   u16 channel_mask ;
   ...
   int bitratemode ;
    klee_make_symbolic(&bitratemode, sizeof(int), "bitratemode");
   char nick[33U] ;
   char desired_essid[33U] ;
   char desired_bssid[6U] ;
   int bssid_fixed ;
    klee_make_symbolic(&bssid_fixed, sizeof(int), "bssid_fixed");
   u16 frag_thresh ;
   u16 mwo_robust ;
   u16 channel ;
   u16 ap_density ;
   ...
   struct iw_public_data wireless_data ;
   int port_type ;
    klee_make_symbolic(&port_type, sizeof(int), "port_type");
   int createibss ;
    klee_make_symbolic(&createibss, sizeof(int), "createibss");
   int promiscuous ;
    klee_make_symbolic(&promiscuous, sizeof(int), "promiscuous");
   int mc_count ;
   ...
   u8 *wpa_ie ;
   int wpa_ie_len ;
    klee_make_symbolic(&wpa_ie_len, sizeof(int), "wpa_ie_len");
...
struct ezusb_priv {
   ...
   struct urb *read_urb ;
   int read_pipe ;
    klee_make_symbolic(&read_pipe, sizeof(int), "read_pipe");
   int write_pipe ;
    klee_make_symbolic(&write_pipe, sizeof(int), "write_pipe");
   u8 reply_count ;
};
enum ezusb_state {
    EZUSB_CTX_START = 0,
...
struct request_context {
   ...
   int killed ;
    klee_make_symbolic(&killed, sizeof(int), "killed");
   struct urb *outurb ;
   struct ezusb_priv *upriv ;
   struct ezusb_packet *buf ;
   int buf_length ;
    klee_make_symbolic(&buf_length, sizeof(int), "buf_length");
   struct timer_list timer ;
...
{ struct ezusb_packet *ans ;
  ...
  int reply_count ;
    klee_make_symbolic(&reply_count, sizeof(int), "reply_count");
  struct list_head    *__mptr ;
  u8 tmp ;
  unsigned long __cil_tmp12 ;
  unsigned long __cil_tmp13 ;
...
{ int total_size ;
    klee_make_symbolic(&total_size, sizeof(int), "total_size");
  long tmp ;
  size_t __len ;
  void *__ret ;
...
{ u8 fw_buffer[64U] ;
  ...
  int variant_offset ;
    klee_make_symbolic(&variant_offset, sizeof(int), "variant_offset");
  __u16 tmp ;
  size_t __len ;
  void *__ret ;
...
{ int req_size ;
    klee_make_symbolic(&req_size, sizeof(int), "req_size");
  int retval ;
  enum ezusb_state state ;
  ...
  struct ezusb_packet *ans ;
  int exp_len ;
    klee_make_symbolic(&exp_len, sizeof(int), "exp_len");
  size_t __len ;
  int __min1 ;
...
{ struct orinoco_private *priv ;
  ...
  int err ;
  int tx_control ;
    klee_make_symbolic(&tx_control, sizeof(int), "tx_control");
  unsigned long flags ;
  struct request_context *ctx ;
  u8 *buf ;
  int tx_size ;
    klee_make_symbolic(&tx_size, sizeof(int), "tx_size");
  bool tmp___0 ;
  int tmp___1 ;
  bool tmp___2 ;
  int tmp___3 ;
...
{ struct hermes *var_group1 ;
  ...
  int var_ezusb_read_ltv_19_p1 ;
    klee_make_symbolic(&var_ezusb_read_ltv_19_p1, sizeof(int), "var_ezusb_read_ltv_19_p1");
  u16 var_ezusb_read_ltv_19_p2 ;
  unsigned int var_ezusb_read_ltv_19_p3 ;
    klee_make_symbolic(&var_ezusb_read_ltv_19_p3, sizeof(int), "var_ezusb_read_ltv_19_p3");
  u16 *var_ezusb_read_ltv_19_p4 ;
  void *var_ezusb_read_ltv_19_p5 ;
  int var_ezusb_write_ltv_18_p1 ;
    klee_make_symbolic(&var_ezusb_write_ltv_18_p1, sizeof(int), "var_ezusb_write_ltv_18_p1");
  u16 var_ezusb_write_ltv_18_p2 ;
  u16 var_ezusb_write_ltv_18_p3 ;
  void    *var_ezusb_write_ltv_18_p4 ;
  int var_ezusb_bap_pread_22_p1 ;
    klee_make_symbolic(&var_ezusb_bap_pread_22_p1, sizeof(int), "var_ezusb_bap_pread_22_p1");
  void *var_ezusb_bap_pread_22_p2 ;
  int var_ezusb_bap_pread_22_p3 ;
    klee_make_symbolic(&var_ezusb_bap_pread_22_p3, sizeof(int), "var_ezusb_bap_pread_22_p3");
  ...
  int res_ezusb_probe_38 ;
    klee_make_symbolic(&res_ezusb_probe_38, sizeof(int), "res_ezusb_probe_38");
  int ldv_s_orinoco_driver_usb_driver ;
    klee_make_symbolic(&ldv_s_orinoco_driver_usb_driver, sizeof(int), "ldv_s_orinoco_driver_usb_driver");
  int tmp ;
  int tmp___0 ;
  int __cil_tmp47 ;
  u16 __cil_tmp48 ;
