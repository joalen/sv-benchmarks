...
struct phone_capability {
   ...
   phone_cap captype ;
   int cap ;
    klee_make_symbolic(&cap, sizeof(int), "cap");
   int handle ;
...
struct __anonstruct_PHONE_CID_181 {
   ...
   char min[3U] ;
   int numlen ;
    klee_make_symbolic(&numlen, sizeof(int), "numlen");
   char number[11U] ;
   int namelen ;
...
struct __anonstruct_IXJ_CADENCE_ELEMENT_185 {
   int index ;
   int tone_on_time ;
    klee_make_symbolic(&tone_on_time, sizeof(int), "tone_on_time");
   int tone_off_time ;
    klee_make_symbolic(&tone_off_time, sizeof(int), "tone_off_time");
   int freq0 ;
    klee_make_symbolic(&freq0, sizeof(int), "freq0");
   int gain0 ;
    klee_make_symbolic(&gain0, sizeof(int), "gain0");
   int freq1 ;
    klee_make_symbolic(&freq1, sizeof(int), "freq1");
   int gain1 ;
    klee_make_symbolic(&gain1, sizeof(int), "gain1");
};
...
struct __anonstruct_BYTES_190 {
   unsigned char low ;
    klee_make_symbolic(&low, sizeof(char), "low");
   unsigned char high ;
    klee_make_symbolic(&high, sizeof(char), "high");
};
...
struct __anonstruct_MIX_217 {
   ...
   unsigned int recsrc ;
    klee_make_symbolic(&recsrc, sizeof(int), "recsrc");
   unsigned int modcnt ;
    klee_make_symbolic(&modcnt, sizeof(int), "modcnt");
   unsigned short micpreamp ;
    klee_make_symbolic(&micpreamp, sizeof(short), "micpreamp");
};
...
struct Proc_Info_Tag {
   ...
   int Prev_Frame_Type ;
    klee_make_symbolic(&Prev_Frame_Type, sizeof(int), "Prev_Frame_Type");
   int Current_Frame_Type ;
    klee_make_symbolic(&Current_Frame_Type, sizeof(int), "Current_Frame_Type");
};
typedef struct Proc_Info_Tag Proc_Info_Type;
struct __anonstruct_IXJ_CADENCE_F_257 {
   char enable ;
    klee_make_symbolic(&enable, sizeof(char), "enable");
   char en_filter ;
    klee_make_symbolic(&en_filter, sizeof(char), "en_filter");
   unsigned int filter ;
    klee_make_symbolic(&filter, sizeof(int), "filter");
   unsigned int state ;
   unsigned int on1 ;
    klee_make_symbolic(&on1, sizeof(int), "on1");
   unsigned long on1min ;
    klee_make_symbolic(&on1min, sizeof(long), "on1min");
   unsigned long on1dot ;
    klee_make_symbolic(&on1dot, sizeof(long), "on1dot");
   unsigned long on1max ;
    klee_make_symbolic(&on1max, sizeof(long), "on1max");
   unsigned int off1 ;
    klee_make_symbolic(&off1, sizeof(int), "off1");
   unsigned long off1min ;
    klee_make_symbolic(&off1min, sizeof(long), "off1min");
   unsigned long off1dot ;
    klee_make_symbolic(&off1dot, sizeof(long), "off1dot");
   unsigned long off1max ;
    klee_make_symbolic(&off1max, sizeof(long), "off1max");
   unsigned int on2 ;
    klee_make_symbolic(&on2, sizeof(int), "on2");
   unsigned long on2min ;
    klee_make_symbolic(&on2min, sizeof(long), "on2min");
   unsigned long on2dot ;
    klee_make_symbolic(&on2dot, sizeof(long), "on2dot");
   unsigned long on2max ;
    klee_make_symbolic(&on2max, sizeof(long), "on2max");
   unsigned int off2 ;
    klee_make_symbolic(&off2, sizeof(int), "off2");
   unsigned long off2min ;
    klee_make_symbolic(&off2min, sizeof(long), "off2min");
   unsigned long off2dot ;
    klee_make_symbolic(&off2dot, sizeof(long), "off2dot");
   unsigned long off2max ;
    klee_make_symbolic(&off2max, sizeof(long), "off2max");
   unsigned int on3 ;
    klee_make_symbolic(&on3, sizeof(int), "on3");
   unsigned long on3min ;
    klee_make_symbolic(&on3min, sizeof(long), "on3min");
   unsigned long on3dot ;
    klee_make_symbolic(&on3dot, sizeof(long), "on3dot");
   unsigned long on3max ;
    klee_make_symbolic(&on3max, sizeof(long), "on3max");
   unsigned int off3 ;
    klee_make_symbolic(&off3, sizeof(int), "off3");
   unsigned long off3min ;
    klee_make_symbolic(&off3min, sizeof(long), "off3min");
   unsigned long off3dot ;
    klee_make_symbolic(&off3dot, sizeof(long), "off3dot");
   unsigned long off3max ;
    klee_make_symbolic(&off3max, sizeof(long), "off3max");
};
...
struct __anonstruct_ixj_cadence_259 {
   int elements_used ;
    klee_make_symbolic(&elements_used, sizeof(int), "elements_used");
...
struct __anonstruct_IXJ_260 {
   ...
   unsigned int DSPbase ;
    klee_make_symbolic(&DSPbase, sizeof(int), "DSPbase");
   unsigned int XILINXbase ;
    klee_make_symbolic(&XILINXbase, sizeof(int), "XILINXbase");
   unsigned int serial ;
   ...
   unsigned int rec_codec ;
    klee_make_symbolic(&rec_codec, sizeof(int), "rec_codec");
   unsigned int cid_rec_codec ;
    klee_make_symbolic(&cid_rec_codec, sizeof(int), "cid_rec_codec");
   unsigned int cid_rec_volume ;
    klee_make_symbolic(&cid_rec_volume, sizeof(int), "cid_rec_volume");
   unsigned char cid_rec_flag ;
    klee_make_symbolic(&cid_rec_flag, sizeof(char), "cid_rec_flag");
   signed char rec_mode ;
    klee_make_symbolic(&rec_mode, sizeof(char), "rec_mode");
   unsigned int play_codec ;
    klee_make_symbolic(&play_codec, sizeof(int), "play_codec");
   unsigned int cid_play_codec ;
    klee_make_symbolic(&cid_play_codec, sizeof(int), "cid_play_codec");
   unsigned int cid_play_volume ;
    klee_make_symbolic(&cid_play_volume, sizeof(int), "cid_play_volume");
   unsigned char cid_play_flag ;
    klee_make_symbolic(&cid_play_flag, sizeof(char), "cid_play_flag");
   signed char play_mode ;
    klee_make_symbolic(&play_mode, sizeof(char), "play_mode");
   IXJ_FLAGS flags ;
   unsigned long busyflags ;
    klee_make_symbolic(&busyflags, sizeof(long), "busyflags");
   unsigned int rec_frame_size ;
    klee_make_symbolic(&rec_frame_size, sizeof(int), "rec_frame_size");
   unsigned int play_frame_size ;
    klee_make_symbolic(&play_frame_size, sizeof(int), "play_frame_size");
   unsigned int cid_play_frame_size ;
    klee_make_symbolic(&cid_play_frame_size, sizeof(int), "cid_play_frame_size");
   unsigned int cid_base_frame_size ;
    klee_make_symbolic(&cid_base_frame_size, sizeof(int), "cid_base_frame_size");
   unsigned long cidcw_wait ;
    klee_make_symbolic(&cidcw_wait, sizeof(long), "cidcw_wait");
   int aec_level ;
    klee_make_symbolic(&aec_level, sizeof(int), "aec_level");
   int cid_play_aec_level ;
    klee_make_symbolic(&cid_play_aec_level, sizeof(int), "cid_play_aec_level");
   int readers ;
   ...
   unsigned int read_buffer_ready ;
    klee_make_symbolic(&read_buffer_ready, sizeof(int), "read_buffer_ready");
   ...
   unsigned int write_buffers_empty ;
    klee_make_symbolic(&write_buffers_empty, sizeof(int), "write_buffers_empty");
   unsigned long drybuffer ;
    klee_make_symbolic(&drybuffer, sizeof(long), "drybuffer");
   char *write_buffer_rp ;
   char *write_buffer_wp ;
   char dtmfbuffer[80U] ;
   char dtmf_current ;
    klee_make_symbolic(&dtmf_current, sizeof(char), "dtmf_current");
   int dtmf_wp ;
    klee_make_symbolic(&dtmf_wp, sizeof(int), "dtmf_wp");
   int dtmf_rp ;
    klee_make_symbolic(&dtmf_rp, sizeof(int), "dtmf_rp");
   int dtmf_state ;
    klee_make_symbolic(&dtmf_state, sizeof(int), "dtmf_state");
   int dtmf_proc ;
    klee_make_symbolic(&dtmf_proc, sizeof(int), "dtmf_proc");
   int tone_off_time ;
   int tone_on_time ;
   struct fasync_struct *async_queue ;
   unsigned long tone_start_jif ;
    klee_make_symbolic(&tone_start_jif, sizeof(long), "tone_start_jif");
   char tone_index ;
    klee_make_symbolic(&tone_index, sizeof(char), "tone_index");
   char tone_state ;
    klee_make_symbolic(&tone_state, sizeof(char), "tone_state");
   char maxrings ;
    klee_make_symbolic(&maxrings, sizeof(char), "maxrings");
   ixj_cadence *cadence_t ;
   ixj_cadence *cadence_r ;
   int tone_cadence_state ;
    klee_make_symbolic(&tone_cadence_state, sizeof(int), "tone_cadence_state");
   ...
   PCMCIA_SLIC pslic ;
   char pscdd ;
    klee_make_symbolic(&pscdd, sizeof(char), "pscdd");
   Si3C1 sic1 ;
   Si3C2 sic2 ;
   Si3RXG sirxg ;
   Si3ADC siadc ;
   ...
   unsigned short ring_cadence ;
    klee_make_symbolic(&ring_cadence, sizeof(short), "ring_cadence");
   int ring_cadence_t ;
    klee_make_symbolic(&ring_cadence_t, sizeof(int), "ring_cadence_t");
   unsigned long ring_cadence_jif ;
    klee_make_symbolic(&ring_cadence_jif, sizeof(long), "ring_cadence_jif");
   unsigned long checkwait ;
    klee_make_symbolic(&checkwait, sizeof(long), "checkwait");
   int intercom ;
    klee_make_symbolic(&intercom, sizeof(int), "intercom");
   int m_hook ;
    klee_make_symbolic(&m_hook, sizeof(int), "m_hook");
   int r_hook ;
    klee_make_symbolic(&r_hook, sizeof(int), "r_hook");
   int p_hook ;
    klee_make_symbolic(&p_hook, sizeof(int), "p_hook");
   char pstn_envelope ;
    klee_make_symbolic(&pstn_envelope, sizeof(char), "pstn_envelope");
   char pstn_cid_intr ;
    klee_make_symbolic(&pstn_cid_intr, sizeof(char), "pstn_cid_intr");
   unsigned char fskz ;
    klee_make_symbolic(&fskz, sizeof(char), "fskz");
   unsigned char fskphase ;
    klee_make_symbolic(&fskphase, sizeof(char), "fskphase");
   unsigned char fskcnt ;
    klee_make_symbolic(&fskcnt, sizeof(char), "fskcnt");
   unsigned int cidsize ;
    klee_make_symbolic(&cidsize, sizeof(int), "cidsize");
   unsigned int cidcnt ;
    klee_make_symbolic(&cidcnt, sizeof(int), "cidcnt");
   unsigned long pstn_cid_received ;
    klee_make_symbolic(&pstn_cid_received, sizeof(long), "pstn_cid_received");
   PHONE_CID cid ;
   PHONE_CID cid_send ;
   unsigned long pstn_ring_int ;
    klee_make_symbolic(&pstn_ring_int, sizeof(long), "pstn_ring_int");
   unsigned long pstn_ring_start ;
    klee_make_symbolic(&pstn_ring_start, sizeof(long), "pstn_ring_start");
   unsigned long pstn_ring_stop ;
    klee_make_symbolic(&pstn_ring_stop, sizeof(long), "pstn_ring_stop");
   unsigned long pstn_winkstart ;
    klee_make_symbolic(&pstn_winkstart, sizeof(long), "pstn_winkstart");
   unsigned long pstn_last_rmr ;
    klee_make_symbolic(&pstn_last_rmr, sizeof(long), "pstn_last_rmr");
   unsigned long pstn_prev_rmr ;
    klee_make_symbolic(&pstn_prev_rmr, sizeof(long), "pstn_prev_rmr");
   unsigned long pots_winkstart ;
    klee_make_symbolic(&pots_winkstart, sizeof(long), "pots_winkstart");
   unsigned int winktime ;
    klee_make_symbolic(&winktime, sizeof(int), "winktime");
   unsigned long flash_end ;
    klee_make_symbolic(&flash_end, sizeof(long), "flash_end");
   char port ;
    klee_make_symbolic(&port, sizeof(char), "port");
   char hookstate ;
    klee_make_symbolic(&hookstate, sizeof(char), "hookstate");
   union telephony_exception ex ;
   union telephony_exception ex_sig ;
   int ixj_signals[35U] ;
   IXJ_SIGDEF sigdef ;
   char daa_mode ;
    klee_make_symbolic(&daa_mode, sizeof(char), "daa_mode");
   char daa_country ;
    klee_make_symbolic(&daa_country, sizeof(char), "daa_country");
   unsigned long pstn_sleeptil ;
    klee_make_symbolic(&pstn_sleeptil, sizeof(long), "pstn_sleeptil");
   DAA_REGS m_DAAShadowRegs ;
   Proc_Info_Type Info_read ;
   Proc_Info_Type Info_write ;
   unsigned short frame_count ;
    klee_make_symbolic(&frame_count, sizeof(short), "frame_count");
   unsigned int filter_hist[4U] ;
   unsigned char filter_en[6U] ;
   unsigned short proc_load ;
    klee_make_symbolic(&proc_load, sizeof(short), "proc_load");
   unsigned long framesread ;
    klee_make_symbolic(&framesread, sizeof(long), "framesread");
   unsigned long frameswritten ;
    klee_make_symbolic(&frameswritten, sizeof(long), "frameswritten");
   unsigned long read_wait ;
    klee_make_symbolic(&read_wait, sizeof(long), "read_wait");
   unsigned long write_wait ;
    klee_make_symbolic(&write_wait, sizeof(long), "write_wait");
   unsigned long timerchecks ;
    klee_make_symbolic(&timerchecks, sizeof(long), "timerchecks");
   unsigned long txreadycheck ;
    klee_make_symbolic(&txreadycheck, sizeof(long), "txreadycheck");
   unsigned long rxreadycheck ;
    klee_make_symbolic(&rxreadycheck, sizeof(long), "rxreadycheck");
   unsigned long statuswait ;
    klee_make_symbolic(&statuswait, sizeof(long), "statuswait");
   unsigned long statuswaitfail ;
    klee_make_symbolic(&statuswaitfail, sizeof(long), "statuswaitfail");
   unsigned long pcontrolwait ;
    klee_make_symbolic(&pcontrolwait, sizeof(long), "pcontrolwait");
   unsigned long pcontrolwaitfail ;
    klee_make_symbolic(&pcontrolwaitfail, sizeof(long), "pcontrolwaitfail");
   unsigned long iscontrolready ;
    klee_make_symbolic(&iscontrolready, sizeof(long), "iscontrolready");
   unsigned long iscontrolreadyfail ;
    klee_make_symbolic(&iscontrolreadyfail, sizeof(long), "iscontrolreadyfail");
   unsigned long pstnstatecheck ;
    klee_make_symbolic(&pstnstatecheck, sizeof(long), "pstnstatecheck");
   short fskdata[8000U] ;
   int fsksize ;
    klee_make_symbolic(&fsksize, sizeof(int), "fsksize");
   int fskdcnt ;
    klee_make_symbolic(&fskdcnt, sizeof(int), "fskdcnt");
};
typedef struct __anonstruct_IXJ_260 IXJ;
struct ixj;
struct ixj_info_t {
   int ndev ;
    klee_make_symbolic(&ndev, sizeof(int), "ndev");
   struct ixj *port ;
};
...
{ char *str ;
  ...
  int place ;
    klee_make_symbolic(&place, sizeof(int), "place");
  struct _ddebug descriptor ;
  long tmp ;
  size_t tmp___0 ;
...
{ struct pcmcia_device *var_group1 ;
  int res_ixj_probe_0 ;
    klee_make_symbolic(&res_ixj_probe_0, sizeof(int), "res_ixj_probe_0");
  int ldv_s_ixj_driver_pcmcia_driver ;
    klee_make_symbolic(&ldv_s_ixj_driver_pcmcia_driver, sizeof(int), "ldv_s_ixj_driver_pcmcia_driver");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
