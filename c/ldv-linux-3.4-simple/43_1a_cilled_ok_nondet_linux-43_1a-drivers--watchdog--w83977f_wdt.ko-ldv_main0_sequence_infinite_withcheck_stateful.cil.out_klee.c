...
static int timeoutW  ;
    klee_make_symbolic(&timeoutW, sizeof(int), "timeoutW");
static unsigned long timer_alive  ;
    klee_make_symbolic(&timer_alive, sizeof(long), "timer_alive");
static int testmode  ;
...
{ unsigned long flags ;
  unsigned int pin_map ;
    klee_make_symbolic(&pin_map, sizeof(int), "pin_map");
  unsigned char tmp ;
  unsigned char __cil_tmp4 ;
  int __cil_tmp5 ;
...
{ int tmrval ;
    klee_make_symbolic(&tmrval, sizeof(int), "tmrval");
  int __cil_tmp3 ;
  int *__cil_tmp4 ;
  int __cil_tmp5 ;
...
{ struct file *var_group1 ;
  ...
  int res_wdt_open_5 ;
    klee_make_symbolic(&res_wdt_open_5, sizeof(int), "res_wdt_open_5");
