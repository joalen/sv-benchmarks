...
{ PIA *var_aten_write_regr_0_p0 ;
  int var_aten_write_regr_0_p1 ;
    klee_make_symbolic(&var_aten_write_regr_0_p1, sizeof(int), "var_aten_write_regr_0_p1");
  int var_aten_write_regr_0_p2 ;
    klee_make_symbolic(&var_aten_write_regr_0_p2, sizeof(int), "var_aten_write_regr_0_p2");
  int var_aten_write_regr_0_p3 ;
    klee_make_symbolic(&var_aten_write_regr_0_p3, sizeof(int), "var_aten_write_regr_0_p3");
  PIA *var_aten_read_regr_1_p0 ;
  int var_aten_read_regr_1_p1 ;
    klee_make_symbolic(&var_aten_read_regr_1_p1, sizeof(int), "var_aten_read_regr_1_p1");
  int var_aten_read_regr_1_p2 ;
    klee_make_symbolic(&var_aten_read_regr_1_p2, sizeof(int), "var_aten_read_regr_1_p2");
  PIA *var_aten_write_block_3_p0 ;
  char *var_aten_write_block_3_p1 ;
  int var_aten_write_block_3_p2 ;
    klee_make_symbolic(&var_aten_write_block_3_p2, sizeof(int), "var_aten_write_block_3_p2");
  PIA *var_aten_read_block_2_p0 ;
  char *var_aten_read_block_2_p1 ;
  int var_aten_read_block_2_p2 ;
    klee_make_symbolic(&var_aten_read_block_2_p2, sizeof(int), "var_aten_read_block_2_p2");
  ...
  int var_aten_log_adapter_6_p2 ;
    klee_make_symbolic(&var_aten_log_adapter_6_p2, sizeof(int), "var_aten_log_adapter_6_p2");
  int tmp ;
  int ldv_s_aten_pi_protocol ;
    klee_make_symbolic(&ldv_s_aten_pi_protocol, sizeof(int), "ldv_s_aten_pi_protocol");
  int tmp___0 ;
  int tmp___1 ;
  int __cil_tmp23 ;
...
#include "model/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--block--paride--aten.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out.env.c"
#include <klee/klee.h>
