...
{ struct device *var_group1 ;
  int res_ucb1400_core_probe_1 ;
    klee_make_symbolic(&res_ucb1400_core_probe_1, sizeof(int), "res_ucb1400_core_probe_1");
  int ldv_s_ucb1400_core_driver_device_driver ;
    klee_make_symbolic(&ldv_s_ucb1400_core_driver_device_driver, sizeof(int), "ldv_s_ucb1400_core_driver_device_driver");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
