...
{ struct platform_device *var_group1 ;
  int res_nop_usb_xceiv_probe_5 ;
    klee_make_symbolic(&res_nop_usb_xceiv_probe_5, sizeof(int), "res_nop_usb_xceiv_probe_5");
  int ldv_s_nop_usb_xceiv_driver_platform_driver ;
    klee_make_symbolic(&ldv_s_nop_usb_xceiv_driver_platform_driver, sizeof(int), "ldv_s_nop_usb_xceiv_driver_platform_driver");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
