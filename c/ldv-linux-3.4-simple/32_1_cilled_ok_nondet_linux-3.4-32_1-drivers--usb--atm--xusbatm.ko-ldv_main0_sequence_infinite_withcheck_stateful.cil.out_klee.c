...
static unsigned int num_rx_padding  ;
    klee_make_symbolic(&num_rx_padding, sizeof(int), "num_rx_padding");
...
static unsigned int num_tx_padding  ;
    klee_make_symbolic(&num_tx_padding, sizeof(int), "num_tx_padding");
...
static unsigned int num_rx_altsetting  ;
    klee_make_symbolic(&num_rx_altsetting, sizeof(int), "num_rx_altsetting");
...
static unsigned int num_tx_altsetting  ;
    klee_make_symbolic(&num_tx_altsetting, sizeof(int), "num_tx_altsetting");
