...
{ struct iio_sw_ring_buffer *ring ;
  ...
  int ret ;
  int max_copied ;
    klee_make_symbolic(&max_copied, sizeof(int), "max_copied");
  int bytes_to_rip ;
    klee_make_symbolic(&bytes_to_rip, sizeof(int), "bytes_to_rip");
  int dead_offset ;
    klee_make_symbolic(&dead_offset, sizeof(int), "dead_offset");
