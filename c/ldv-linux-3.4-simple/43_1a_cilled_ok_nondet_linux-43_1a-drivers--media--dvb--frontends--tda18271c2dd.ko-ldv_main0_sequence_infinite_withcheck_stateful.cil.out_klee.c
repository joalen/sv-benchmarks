...
{ u8 *data ;
  unsigned long __lengthofdata ;
    klee_make_symbolic(&__lengthofdata, sizeof(long), "__lengthofdata");
  void *tmp ;
  size_t __len ;
  void *__ret ;
  int tmp___0 ;
...
{ int status ;
  ...
  s32 Count ;
  int sign ;
    klee_make_symbolic(&sign, sizeof(int), "sign");
  bool wait ;
  bool tmp ;
  int tmp___0 ;
  bool tmp___1 ;
...
{ int status ;
  ...
  s32 Capprox ;
  int TComp ;
    klee_make_symbolic(&TComp, sizeof(int), "TComp");
...
{ struct tda_state *state ;
  int status ;
  int Standard ;
    klee_make_symbolic(&Standard, sizeof(int), "Standard");
  u32 bw ;
  u32 delsys ;
  unsigned long __cil_tmp7 ;
  unsigned long __cil_tmp8 ;
...
{ struct dvb_frontend *var_group1 ;
  ...
  int ldv_s_tuner_ops_dvb_tuner_ops ;
    klee_make_symbolic(&ldv_s_tuner_ops_dvb_tuner_ops, sizeof(int), "ldv_s_tuner_ops_dvb_tuner_ops");
  int tmp ;
  int tmp___0 ;
