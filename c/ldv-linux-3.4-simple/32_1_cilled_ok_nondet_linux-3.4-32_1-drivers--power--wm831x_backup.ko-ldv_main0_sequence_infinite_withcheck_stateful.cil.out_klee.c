...
static int res_wm831x_backup_probe_3  ;
    klee_make_symbolic(&res_wm831x_backup_probe_3, sizeof(int), "res_wm831x_backup_probe_3");
void main(void) 
{ struct platform_device *var_group1 ;
  int ldv_s_wm831x_backup_driver_platform_driver ;
    klee_make_symbolic(&ldv_s_wm831x_backup_driver_platform_driver, sizeof(int), "ldv_s_wm831x_backup_driver_platform_driver");
  int tmp ;
  int tmp___0 ;
  int __cil_tmp5 ;
