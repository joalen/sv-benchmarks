...
{ struct file *var_group1 ;
  ...
  int res_ks8995_probe_11 ;
    klee_make_symbolic(&res_ks8995_probe_11, sizeof(int), "res_ks8995_probe_11");
  int ldv_s_ks8995_driver_spi_driver ;
    klee_make_symbolic(&ldv_s_ks8995_driver_spi_driver, sizeof(int), "ldv_s_ks8995_driver_spi_driver");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
