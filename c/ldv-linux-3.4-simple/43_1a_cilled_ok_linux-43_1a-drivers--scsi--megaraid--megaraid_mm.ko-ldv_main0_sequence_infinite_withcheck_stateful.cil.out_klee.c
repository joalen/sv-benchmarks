...
struct mraid_mmadp {
   ...
   unsigned long drvr_data ;
    klee_make_symbolic(&drvr_data, sizeof(long), "drvr_data");
   uint16_t timeout ;
   uint8_t max_kioc ;
   struct pci_dev *pdev ;
...
{ struct lock_class_key __key ;
  ...
  unsigned int __r_expr_0_count15 ;
    klee_make_symbolic(&__r_expr_0_count15, sizeof(int), "__r_expr_0_count15");
  struct lockdep_map __r_expr_0_dep_map16 ;
  void *__r_expr_0_owner17 ;
  unsigned int __r_expr_0_owner_cpu18 ;
    klee_make_symbolic(&__r_expr_0_owner_cpu18, sizeof(int), "__r_expr_0_owner_cpu18");
  unsigned int __r_expr_0_magic19 ;
    klee_make_symbolic(&__r_expr_0_magic19, sizeof(int), "__r_expr_0_magic19");
...
{ uioc_t *kioc ;
  ...
  uint8_t old_ioctl ;
  int drvrcmd_rval ;
    klee_make_symbolic(&drvrcmd_rval, sizeof(int), "drvrcmd_rval");
  void *argp ;
  unsigned long tmp ;
  int tmp___0 ;
...
{ mraid_mmadp_t *adapter ;
  ...
  uint32_t adapno ;
  int iterator ;
    klee_make_symbolic(&iterator, sizeof(int), "iterator");
  unsigned long tmp ;
...
{ mm_dmapool_t *pool ;
  int right_pool ;
    klee_make_symbolic(&right_pool, sizeof(int), "right_pool");
  unsigned long flags ;
  int i ;
...
{ struct inode *var_group1 ;
  ...
  int res_mraid_mm_open_0 ;
    klee_make_symbolic(&res_mraid_mm_open_0, sizeof(int), "res_mraid_mm_open_0");
  unsigned int var_mraid_mm_unlocked_ioctl_2_p1 ;
    klee_make_symbolic(&var_mraid_mm_unlocked_ioctl_2_p1, sizeof(int), "var_mraid_mm_unlocked_ioctl_2_p1");
  unsigned long var_mraid_mm_unlocked_ioctl_2_p2 ;
    klee_make_symbolic(&var_mraid_mm_unlocked_ioctl_2_p2, sizeof(long), "var_mraid_mm_unlocked_ioctl_2_p2");
  unsigned int var_mraid_mm_compat_ioctl_21_p1 ;
    klee_make_symbolic(&var_mraid_mm_compat_ioctl_21_p1, sizeof(int), "var_mraid_mm_compat_ioctl_21_p1");
  unsigned long var_mraid_mm_compat_ioctl_21_p2 ;
    klee_make_symbolic(&var_mraid_mm_compat_ioctl_21_p2, sizeof(long), "var_mraid_mm_compat_ioctl_21_p2");
  unsigned long var_lld_timedout_11_p0 ;
    klee_make_symbolic(&var_lld_timedout_11_p0, sizeof(long), "var_lld_timedout_11_p0");
  int ldv_s_lsi_fops_file_operations ;
    klee_make_symbolic(&ldv_s_lsi_fops_file_operations, sizeof(int), "ldv_s_lsi_fops_file_operations");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
