...
struct ab8500 {
   ...
   u8 *oldmask ;
   int mask_size ;
    klee_make_symbolic(&mask_size, sizeof(int), "mask_size");
...
struct ab8500_ponkey {
   ...
   int irq_dbf ;
    klee_make_symbolic(&irq_dbf, sizeof(int), "irq_dbf");
   int irq_dbr ;
    klee_make_symbolic(&irq_dbr, sizeof(int), "irq_dbr");
};
...
{ struct platform_device *var_group1 ;
  int res_ab8500_ponkey_probe_1 ;
    klee_make_symbolic(&res_ab8500_ponkey_probe_1, sizeof(int), "res_ab8500_ponkey_probe_1");
  int var_ab8500_ponkey_handler_0_p0 ;
    klee_make_symbolic(&var_ab8500_ponkey_handler_0_p0, sizeof(int), "var_ab8500_ponkey_handler_0_p0");
  void *var_ab8500_ponkey_handler_0_p1 ;
  int ldv_s_ab8500_ponkey_driver_platform_driver ;
    klee_make_symbolic(&ldv_s_ab8500_ponkey_driver_platform_driver, sizeof(int), "ldv_s_ab8500_ponkey_driver_platform_driver");
  int tmp ;
  int tmp___0 ;
