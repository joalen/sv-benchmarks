...
struct __anonstruct_regTime_267 {
   unsigned long LowPart ;
    klee_make_symbolic(&LowPart, sizeof(long), "LowPart");
   long HighPart ;
    klee_make_symbolic(&HighPart, sizeof(long), "HighPart");
};
struct _DbgHandle_ {
   char Registered ;
    klee_make_symbolic(&Registered, sizeof(char), "Registered");
   char Version ;
    klee_make_symbolic(&Version, sizeof(char), "Version");
   short id ;
   ...
   unsigned long dbgMask ;
    klee_make_symbolic(&dbgMask, sizeof(long), "dbgMask");
   char drvName[128] ;
   char drvTag[64] ;
...
struct _diva_xdi_dma_descriptor_operation {
   int operation ;
    klee_make_symbolic(&operation, sizeof(int), "operation");
   int descriptor_number ;
    klee_make_symbolic(&descriptor_number, sizeof(int), "descriptor_number");
...
struct _diva_xdi_stream_interface {
   ...
   unsigned char provided_service ;
    klee_make_symbolic(&provided_service, sizeof(char), "provided_service");
   unsigned char requested_service ;
    klee_make_symbolic(&requested_service, sizeof(char), "requested_service");
   void *xdi_context ;
   void *client_context ;
...
struct __anonstruct_SERIAL_STATE_273 {
   unsigned char LineState ;
    klee_make_symbolic(&LineState, sizeof(char), "LineState");
   unsigned char CardState ;
    klee_make_symbolic(&CardState, sizeof(char), "CardState");
   unsigned char IsdnState ;
    klee_make_symbolic(&IsdnState, sizeof(char), "IsdnState");
...
struct __anonstruct_SERIAL_HOOK_274 {
   ...
   unsigned char Rc ;
    klee_make_symbolic(&Rc, sizeof(char), "Rc");
   ...
   unsigned char SyncResult ;
    klee_make_symbolic(&SyncResult, sizeof(char), "SyncResult");
};
...
struct __anonstruct_PORTDRV_HOOK_282 {
   ...
   void *Context ;
   unsigned long Info ;
    klee_make_symbolic(&Info, sizeof(long), "Info");
};
...
struct __anonstruct_GetLineIdx_288 {
   ...
   unsigned long lineIdx ;
    klee_make_symbolic(&lineIdx, sizeof(long), "lineIdx");
};
struct __anonstruct_GetCardType_289 {
   unsigned char Req ;
   unsigned char Rc ;
   unsigned long cardtype ;
    klee_make_symbolic(&cardtype, sizeof(long), "cardtype");
};
...
struct __anonstruct_GetFeatures_292 {
   ...
   unsigned short features ;
    klee_make_symbolic(&features, sizeof(short), "features");
};
...
typedef long diva_os_spin_lock_magic_t;
    klee_make_symbolic(&diva_os_spin_lock_magic_t, sizeof(long), "diva_os_spin_lock_magic_t");
...
static int res_divadidd_proc_open_2  ;
    klee_make_symbolic(&res_divadidd_proc_open_2, sizeof(int), "res_divadidd_proc_open_2");
void main(void) 
{ struct inode *var_group1 ;
  struct file *var_group2 ;
  int tmp___7 ;
  int ldv_s_divadidd_proc_fops_file_operations ;
    klee_make_symbolic(&ldv_s_divadidd_proc_fops_file_operations, sizeof(int), "ldv_s_divadidd_proc_fops_file_operations");
  int tmp___8 ;
  int tmp___9 ;
  int __cil_tmp7 ;
...
{ int x ;
  int dadapter ;
    klee_make_symbolic(&dadapter, sizeof(int), "dadapter");
  IDI_SYNC_REQ req ;
...
{ diva_os_spin_lock_magic_t irql ;
  ...
  int dst ;
    klee_make_symbolic(&dst, sizeof(int), "dst");
  size_t __len ;
  void *__ret ;
  size_t __len___0 ;
  void *__ret___0 ;
...
{ int i ;
  int do_notify ;
    klee_make_symbolic(&do_notify, sizeof(int), "do_notify");
