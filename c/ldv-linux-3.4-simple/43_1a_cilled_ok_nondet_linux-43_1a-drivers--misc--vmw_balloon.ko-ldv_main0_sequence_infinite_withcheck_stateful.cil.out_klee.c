...
{ int error ;
  ...
  long __constr_expr_0_counter36 ;
    klee_make_symbolic(&__constr_expr_0_counter36, sizeof(long), "__constr_expr_0_counter36");
...
#include "model/43_1a_cilled_true-unreach-call_ok_nondet_linux-43_1a-drivers--misc--vmw_balloon_true-termination.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out.env.c"
#include <klee/klee.h>
