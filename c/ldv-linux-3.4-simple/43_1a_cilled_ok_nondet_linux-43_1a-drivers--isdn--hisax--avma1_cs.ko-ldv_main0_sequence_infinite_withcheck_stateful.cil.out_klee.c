...
static void avma1cs_release(struct pcmcia_device *link ) 
{ unsigned long minor ;
    klee_make_symbolic(&minor, sizeof(long), "minor");
  struct _ddebug descriptor ;
  long tmp ;
  unsigned long __cil_tmp5 ;
  unsigned long __cil_tmp6 ;
...
{ struct pcmcia_device *var_group1 ;
  int res_avma1cs_probe_0 ;
    klee_make_symbolic(&res_avma1cs_probe_0, sizeof(int), "res_avma1cs_probe_0");
  int ldv_s_avma1cs_driver_pcmcia_driver ;
    klee_make_symbolic(&ldv_s_avma1cs_driver_pcmcia_driver, sizeof(int), "ldv_s_avma1cs_driver_pcmcia_driver");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
...
#include "model/43_1a_cilled_true-unreach-call_ok_nondet_linux-43_1a-drivers--isdn--hisax--avma1_cs.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out.env.c"
#include <klee/klee.h>
