...
struct dibusb_device_state {
   int old_toggle ;
    klee_make_symbolic(&old_toggle, sizeof(int), "old_toggle");
   int last_repeat_count ;
    klee_make_symbolic(&last_repeat_count, sizeof(int), "last_repeat_count");
};
...
static int res_nova_t_probe_1  ;
    klee_make_symbolic(&res_nova_t_probe_1, sizeof(int), "res_nova_t_probe_1");
void main(void) 
{ struct dvb_usb_device *var_group1 ;
  ...
  int ldv_s_nova_t_driver_usb_driver ;
    klee_make_symbolic(&ldv_s_nova_t_driver_usb_driver, sizeof(int), "ldv_s_nova_t_driver_usb_driver");
  int tmp___7 ;
  int tmp___8 ;
  int __cil_tmp9 ;
