...
static unsigned int data_avail  ;
    klee_make_symbolic(&data_avail, sizeof(int), "data_avail");
...
static int res_virtrng_probe_4  ;
    klee_make_symbolic(&res_virtrng_probe_4, sizeof(int), "res_virtrng_probe_4");
void main(void) 
{ struct hwrng *var_group1 ;
  ...
  int ldv_s_virtio_rng_driver_virtio_driver ;
    klee_make_symbolic(&ldv_s_virtio_rng_driver_virtio_driver, sizeof(int), "ldv_s_virtio_rng_driver_virtio_driver");
  int tmp___0 ;
  int tmp___1 ;
  int __cil_tmp10 ;
