...
struct tua6100_priv {
   int i2c_address ;
    klee_make_symbolic(&i2c_address, sizeof(int), "i2c_address");
...
{ struct dvb_frontend *var_group1 ;
  ...
  int ldv_s_tua6100_tuner_ops_dvb_tuner_ops ;
    klee_make_symbolic(&ldv_s_tua6100_tuner_ops_dvb_tuner_ops, sizeof(int), "ldv_s_tua6100_tuner_ops_dvb_tuner_ops");
  int tmp ;
  int tmp___0 ;
