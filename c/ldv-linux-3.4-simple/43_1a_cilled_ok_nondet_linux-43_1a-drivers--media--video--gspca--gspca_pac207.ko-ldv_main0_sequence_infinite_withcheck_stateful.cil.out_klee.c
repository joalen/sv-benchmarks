...
{ struct sd *sd ;
  int avg_lum ;
    klee_make_symbolic(&avg_lum, sizeof(int), "avg_lum");
  int tmp ;
  int tmp___0 ;
  unsigned long __cil_tmp6 ;
  unsigned long __cil_tmp7 ;
...
{ struct gspca_dev *var_group1 ;
  ...
  int var_sd_pkt_scan_8_p2 ;
    klee_make_symbolic(&var_sd_pkt_scan_8_p2, sizeof(int), "var_sd_pkt_scan_8_p2");
  u8 *var_sd_int_pkt_scan_20_p1 ;
  int var_sd_int_pkt_scan_20_p2 ;
    klee_make_symbolic(&var_sd_int_pkt_scan_20_p2, sizeof(int), "var_sd_int_pkt_scan_20_p2");
  struct usb_interface *var_group2 ;
  struct usb_device_id  const  *var_sd_probe_21_p1 ;
  int res_sd_probe_21 ;
    klee_make_symbolic(&res_sd_probe_21, sizeof(int), "res_sd_probe_21");
