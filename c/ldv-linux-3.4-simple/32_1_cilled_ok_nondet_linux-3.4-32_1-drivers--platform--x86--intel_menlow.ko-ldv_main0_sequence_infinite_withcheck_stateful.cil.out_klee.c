...
struct thermal_zone_device {
   ...
   void *devdata ;
   int trips ;
    klee_make_symbolic(&trips, sizeof(int), "trips");
   int tc1 ;
    klee_make_symbolic(&tc1, sizeof(int), "tc1");
   int tc2 ;
    klee_make_symbolic(&tc2, sizeof(int), "tc2");
   int passive_delay ;
    klee_make_symbolic(&passive_delay, sizeof(int), "passive_delay");
   int polling_delay ;
    klee_make_symbolic(&polling_delay, sizeof(int), "polling_delay");
   int last_temperature ;
    klee_make_symbolic(&last_temperature, sizeof(int), "last_temperature");
   bool passive ;
   unsigned int forced_passive ;
    klee_make_symbolic(&forced_passive, sizeof(int), "forced_passive");
...
{ struct acpi_device *device ;
  ...
  unsigned long max_state ;
    klee_make_symbolic(&max_state, sizeof(long), "max_state");
  int tmp___7 ;
...
{ acpi_status status ;
  unsigned long long bios_enabled ;
    klee_make_symbolic(&bios_enabled, sizeof(long), "bios_enabled");
  char const   *tmp___7 ;
  int tmp___8 ;
  void *__cil_tmp8 ;
...
{ struct thermal_cooling_device *var_group1 ;
  ...
  unsigned long var_memory_set_cur_bandwidth_2_p1 ;
    klee_make_symbolic(&var_memory_set_cur_bandwidth_2_p1, sizeof(long), "var_memory_set_cur_bandwidth_2_p1");
  struct acpi_device *var_group2 ;
  int var_intel_menlow_memory_remove_4_p1 ;
    klee_make_symbolic(&var_intel_menlow_memory_remove_4_p1, sizeof(int), "var_intel_menlow_memory_remove_4_p1");
  int tmp___7 ;
  int tmp___8 ;
  int tmp___9 ;
