...
{ struct ide_host *host ;
  ...
  unsigned long ctl ;
    klee_make_symbolic(&ctl, sizeof(long), "ctl");
  int rc ;
...
{ struct pnp_dev *var_group1 ;
  ...
  int res_idepnp_probe_0 ;
    klee_make_symbolic(&res_idepnp_probe_0, sizeof(int), "res_idepnp_probe_0");
  int ldv_s_idepnp_driver_pnp_driver ;
    klee_make_symbolic(&ldv_s_idepnp_driver_pnp_driver, sizeof(int), "ldv_s_idepnp_driver_pnp_driver");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
