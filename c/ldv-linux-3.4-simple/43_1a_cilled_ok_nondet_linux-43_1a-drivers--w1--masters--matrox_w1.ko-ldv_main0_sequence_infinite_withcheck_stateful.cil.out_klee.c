...
struct matrox_device {
   ...
   void *virt_addr ;
   unsigned long found ;
    klee_make_symbolic(&found, sizeof(long), "found");
   struct w1_bus_master *bus_master ;
};
...
{ struct pci_dev *var_group1 ;
  ...
  int res_matrox_w1_probe_5 ;
    klee_make_symbolic(&res_matrox_w1_probe_5, sizeof(int), "res_matrox_w1_probe_5");
  int ldv_s_matrox_w1_pci_driver_pci_driver ;
    klee_make_symbolic(&ldv_s_matrox_w1_pci_driver_pci_driver, sizeof(int), "ldv_s_matrox_w1_pci_driver_pci_driver");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
