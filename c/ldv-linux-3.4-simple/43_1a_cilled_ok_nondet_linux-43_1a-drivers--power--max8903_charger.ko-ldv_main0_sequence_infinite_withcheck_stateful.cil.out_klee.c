...
struct max8903_pdata {
   int cen ;
    klee_make_symbolic(&cen, sizeof(int), "cen");
   int dok ;
    klee_make_symbolic(&dok, sizeof(int), "dok");
   int uok ;
    klee_make_symbolic(&uok, sizeof(int), "uok");
   int chg ;
    klee_make_symbolic(&chg, sizeof(int), "chg");
   int flt ;
    klee_make_symbolic(&flt, sizeof(int), "flt");
   int dcm ;
    klee_make_symbolic(&dcm, sizeof(int), "dcm");
   int usus ;
    klee_make_symbolic(&usus, sizeof(int), "usus");
   bool dc_valid ;
   bool usb_valid ;
};
struct max8903_data {
...
{ struct max8903_data *data ;
  ...
  int ta_in ;
    klee_make_symbolic(&ta_in, sizeof(int), "ta_in");
  int usb_in ;
    klee_make_symbolic(&usb_in, sizeof(int), "usb_in");
  void *tmp ;
  size_t __len ;
  void *__ret ;
  int tmp___0 ;
...
{ struct platform_device *var_group1 ;
  int res_max8903_probe_4 ;
    klee_make_symbolic(&res_max8903_probe_4, sizeof(int), "res_max8903_probe_4");
  int var_max8903_dcin_1_p0 ;
    klee_make_symbolic(&var_max8903_dcin_1_p0, sizeof(int), "var_max8903_dcin_1_p0");
  void *var_max8903_dcin_1_p1 ;
  int var_max8903_fault_3_p0 ;
    klee_make_symbolic(&var_max8903_fault_3_p0, sizeof(int), "var_max8903_fault_3_p0");
  void *var_max8903_fault_3_p1 ;
  int var_max8903_usbin_2_p0 ;
    klee_make_symbolic(&var_max8903_usbin_2_p0, sizeof(int), "var_max8903_usbin_2_p0");
  void *var_max8903_usbin_2_p1 ;
  int ldv_s_max8903_driver_platform_driver ;
    klee_make_symbolic(&ldv_s_max8903_driver_platform_driver, sizeof(int), "ldv_s_max8903_driver_platform_driver");
  int tmp ;
  int tmp___0 ;
