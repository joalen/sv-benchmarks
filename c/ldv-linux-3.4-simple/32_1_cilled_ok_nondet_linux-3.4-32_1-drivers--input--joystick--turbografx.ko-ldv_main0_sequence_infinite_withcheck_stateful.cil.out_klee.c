...
struct tgfx_config {
   int args[8] ;
   unsigned int nargs ;
    klee_make_symbolic(&nargs, sizeof(int), "nargs");
};
...
struct tgfx {
   ...
   char phys[7][32] ;
   int sticks ;
    klee_make_symbolic(&sticks, sizeof(int), "sticks");
   int used ;
...
{ int i ;
  int have_dev ;
    klee_make_symbolic(&have_dev, sizeof(int), "have_dev");
  int err ;
  long tmp ;
  long tmp___0 ;
  int tmp___1 ;
...
{ unsigned long var_tgfx_timer_0_p0 ;
    klee_make_symbolic(&var_tgfx_timer_0_p0, sizeof(long), "var_tgfx_timer_0_p0");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
