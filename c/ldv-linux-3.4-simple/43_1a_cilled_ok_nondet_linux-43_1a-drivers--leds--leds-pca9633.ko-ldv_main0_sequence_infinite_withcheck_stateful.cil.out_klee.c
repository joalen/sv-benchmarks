...
struct led_platform_data {
   int num_leds ;
    klee_make_symbolic(&num_leds, sizeof(int), "num_leds");
...
struct pca9633_led {
   ...
   int led_num ;
    klee_make_symbolic(&led_num, sizeof(int), "led_num");
   char name[32U] ;
};
...
{ struct pca9633_led *pca9633 ;
  ...
  long __constr_expr_0_counter163 ;
    klee_make_symbolic(&__constr_expr_0_counter163, sizeof(long), "__constr_expr_0_counter163");
...
{ struct i2c_client *var_group1 ;
  ...
  int res_pca9633_probe_2 ;
    klee_make_symbolic(&res_pca9633_probe_2, sizeof(int), "res_pca9633_probe_2");
  int ldv_s_pca9633_driver_i2c_driver ;
    klee_make_symbolic(&ldv_s_pca9633_driver_i2c_driver, sizeof(int), "ldv_s_pca9633_driver_i2c_driver");
  int tmp ;
  int tmp___0 ;
