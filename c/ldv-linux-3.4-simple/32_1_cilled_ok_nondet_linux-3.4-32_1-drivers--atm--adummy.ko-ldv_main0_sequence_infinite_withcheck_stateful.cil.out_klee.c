...
static int res_adummy_open_3  ;
    klee_make_symbolic(&res_adummy_open_3, sizeof(int), "res_adummy_open_3");
void main(void) 
{ struct atm_vcc *var_group1 ;
  ...
  int ldv_s_adummy_ops_atmdev_ops ;
    klee_make_symbolic(&ldv_s_adummy_ops_atmdev_ops, sizeof(int), "ldv_s_adummy_ops_atmdev_ops");
  int tmp___8 ;
  int tmp___9 ;
  int __cil_tmp10 ;
