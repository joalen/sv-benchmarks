...
{ struct apanel *ap ;
  ...
  unsigned short __cil_tmp67 ;
    klee_make_symbolic(&__cil_tmp67, sizeof(short), "__cil_tmp67");
  ...
  long __constr_expr_0_counter109 ;
    klee_make_symbolic(&__constr_expr_0_counter109, sizeof(long), "__constr_expr_0_counter109");
...
{ void *bios ;
  ...
  unsigned char i2c_addr ;
    klee_make_symbolic(&i2c_addr, sizeof(char), "i2c_addr");
  int found ;
    klee_make_symbolic(&found, sizeof(int), "found");
  unsigned char tmp ;
  unsigned char method ;
    klee_make_symbolic(&method, sizeof(char), "method");
  unsigned char slave ;
