...
static int res_wm831x_isink_probe_6  ;
    klee_make_symbolic(&res_wm831x_isink_probe_6, sizeof(int), "res_wm831x_isink_probe_6");
void main(void) 
{ struct regulator_dev *var_group1 ;
  int var_wm831x_isink_set_current_3_p1 ;
    klee_make_symbolic(&var_wm831x_isink_set_current_3_p1, sizeof(int), "var_wm831x_isink_set_current_3_p1");
  int var_wm831x_isink_set_current_3_p2 ;
    klee_make_symbolic(&var_wm831x_isink_set_current_3_p2, sizeof(int), "var_wm831x_isink_set_current_3_p2");
  struct platform_device *var_group2 ;
  int var_wm831x_isink_irq_5_p0 ;
    klee_make_symbolic(&var_wm831x_isink_irq_5_p0, sizeof(int), "var_wm831x_isink_irq_5_p0");
  void *var_wm831x_isink_irq_5_p1 ;
  int tmp___7 ;
  int ldv_s_wm831x_isink_driver_platform_driver ;
    klee_make_symbolic(&ldv_s_wm831x_isink_driver_platform_driver, sizeof(int), "ldv_s_wm831x_isink_driver_platform_driver");
  int tmp___8 ;
  int tmp___9 ;
  int __cil_tmp11 ;
