...
struct zram {
   ...
   struct gendisk *disk ;
   int init_done ;
    klee_make_symbolic(&init_done, sizeof(int), "init_done");
...
extern unsigned long totalram_pages ;
    klee_make_symbolic(&totalram_pages, sizeof(long), "totalram_pages");
...
static int zram_major  ;
    klee_make_symbolic(&zram_major, sizeof(int), "zram_major");
static unsigned int num_devices  ;
    klee_make_symbolic(&num_devices, sizeof(int), "num_devices");
...
{ struct block_device *var_group1 ;
  unsigned long var_zram_slot_free_notify_25_p1 ;
    klee_make_symbolic(&var_zram_slot_free_notify_25_p1, sizeof(long), "var_zram_slot_free_notify_25_p1");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
...
{ int ret ;
  unsigned short do_reset ;
    klee_make_symbolic(&do_reset, sizeof(short), "do_reset");
  struct zram *zram ;
