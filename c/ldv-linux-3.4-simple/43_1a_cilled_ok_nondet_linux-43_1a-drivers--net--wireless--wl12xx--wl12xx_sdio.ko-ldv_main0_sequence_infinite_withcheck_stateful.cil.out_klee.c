...
struct mmc_ext_csd {
   ...
   unsigned int card_type ;
    klee_make_symbolic(&card_type, sizeof(int), "card_type");
...
struct mmc_card {
   ...
   unsigned int poweroff_notify_state ;
    klee_make_symbolic(&poweroff_notify_state, sizeof(int), "poweroff_notify_state");
   unsigned int erase_size ;
...
struct wl12xx_platform_data {
   ...
   bool use_eeprom ;
   int board_ref_clock ;
    klee_make_symbolic(&board_ref_clock, sizeof(int), "board_ref_clock");
   int board_tcxo_clock ;
    klee_make_symbolic(&board_tcxo_clock, sizeof(int), "board_tcxo_clock");
   unsigned long platform_quirks ;
    klee_make_symbolic(&platform_quirks, sizeof(long), "platform_quirks");
   bool pwr_in_suspend ;
...
struct wl1271_stats {
   ...
   unsigned long fw_stats_update ;
    klee_make_symbolic(&fw_stats_update, sizeof(long), "fw_stats_update");
   unsigned int retry_count ;
    klee_make_symbolic(&retry_count, sizeof(int), "retry_count");
   unsigned int excessive_retries ;
    klee_make_symbolic(&excessive_retries, sizeof(int), "excessive_retries");
};
...
struct wl1271 {
   ...
   int irq ;
   int ref_clock ;
    klee_make_symbolic(&ref_clock, sizeof(int), "ref_clock");
   spinlock_t wl_lock ;
   ...
   int cmd_box_addr ;
    klee_make_symbolic(&cmd_box_addr, sizeof(int), "cmd_box_addr");
   int event_box_addr ;
    klee_make_symbolic(&event_box_addr, sizeof(int), "event_box_addr");
   u8 *fw ;
   size_t fw_len ;
   void *nvs ;
   size_t nvs_len ;
   ...
   long stopped_queues_map ;
    klee_make_symbolic(&stopped_queues_map, sizeof(long), "stopped_queues_map");
   ...
   int tx_frames_cnt ;
    klee_make_symbolic(&tx_frames_cnt, sizeof(int), "tx_frames_cnt");
   u32 rx_counter ;
   ...
   struct ieee80211_supported_band bands[2U] ;
   int tcxo_clock ;
    klee_make_symbolic(&tcxo_clock, sizeof(int), "tcxo_clock");
   bool wow_enabled ;
   bool irq_wake_enabled ;
   struct wl1271_link links[12U] ;
   u32 ap_fw_ps_map ;
   unsigned long ap_ps_map ;
    klee_make_symbolic(&ap_ps_map, sizeof(long), "ap_ps_map");
   unsigned int quirks ;
   unsigned int platform_quirks ;
   int ba_rx_session_count ;
    klee_make_symbolic(&ba_rx_session_count, sizeof(int), "ba_rx_session_count");
   int active_sta_count ;
    klee_make_symbolic(&active_sta_count, sizeof(int), "active_sta_count");
...
struct wl12xx_vif {
   ...
   int last_tx_hlid ;
    klee_make_symbolic(&last_tx_hlid, sizeof(int), "last_tx_hlid");
   unsigned long links_map[1U] ;
   u8 ssid[33U] ;
   u8 ssid_len ;
   enum ieee80211_band band ;
   ...
   u16 aid ;
   int session_counter ;
    klee_make_symbolic(&session_counter, sizeof(int), "session_counter");
   u8 psm_entry_retry ;
   int power_level ;
   int rssi_thold ;
    klee_make_symbolic(&rssi_thold, sizeof(int), "rssi_thold");
   int last_rssi_event ;
    klee_make_symbolic(&last_rssi_event, sizeof(int), "last_rssi_event");
   u8 encryption_type ;
   __be32 ip_addr ;
   bool ba_support ;
   bool ba_allowed ;
...
{ struct device *var_group1 ;
  int var_wl12xx_sdio_raw_read_1_p1 ;
    klee_make_symbolic(&var_wl12xx_sdio_raw_read_1_p1, sizeof(int), "var_wl12xx_sdio_raw_read_1_p1");
  ...
  int var_wl12xx_sdio_raw_write_2_p1 ;
    klee_make_symbolic(&var_wl12xx_sdio_raw_write_2_p1, sizeof(int), "var_wl12xx_sdio_raw_write_2_p1");
  ...
  unsigned int var_wl1271_sdio_set_block_size_0_p1 ;
    klee_make_symbolic(&var_wl1271_sdio_set_block_size_0_p1, sizeof(int), "var_wl1271_sdio_set_block_size_0_p1");
  struct sdio_func *var_group2 ;
  struct sdio_device_id  const  *var_wl1271_probe_6_p1 ;
  int res_wl1271_probe_6 ;
    klee_make_symbolic(&res_wl1271_probe_6, sizeof(int), "res_wl1271_probe_6");
  int ldv_s_wl1271_sdio_driver_sdio_driver ;
    klee_make_symbolic(&ldv_s_wl1271_sdio_driver_sdio_driver, sizeof(int), "ldv_s_wl1271_sdio_driver_sdio_driver");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
  int __cil_tmp19 ;
