...
struct saa7146_standard {
   ...
   v4l2_std_id id ;
   int v_offset ;
    klee_make_symbolic(&v_offset, sizeof(int), "v_offset");
   int v_field ;
    klee_make_symbolic(&v_field, sizeof(int), "v_field");
   int h_offset ;
    klee_make_symbolic(&h_offset, sizeof(int), "h_offset");
   int h_pixels ;
    klee_make_symbolic(&h_pixels, sizeof(int), "h_pixels");
   int v_max_out ;
    klee_make_symbolic(&v_max_out, sizeof(int), "v_max_out");
   int h_max_out ;
    klee_make_symbolic(&h_max_out, sizeof(int), "h_max_out");
};
struct saa7146_buf {
...
struct saa7146_overlay {
   ...
   int nclips ;
    klee_make_symbolic(&nclips, sizeof(int), "nclips");
};
struct saa7146_fh {
   struct saa7146_dev *dev ;
   enum v4l2_buf_type type ;
...
struct saa7146_vv {
   ...
   int vbi_fieldcount ;
    klee_make_symbolic(&vbi_fieldcount, sizeof(int), "vbi_fieldcount");
   struct saa7146_fh *vbi_streaming ;
   int video_status ;
    klee_make_symbolic(&video_status, sizeof(int), "video_status");
   ...
   int vflip ;
    klee_make_symbolic(&vflip, sizeof(int), "vflip");
   int hflip ;
    klee_make_symbolic(&hflip, sizeof(int), "hflip");
   int current_hps_source ;
    klee_make_symbolic(&current_hps_source, sizeof(int), "current_hps_source");
   int current_hps_sync ;
    klee_make_symbolic(&current_hps_sync, sizeof(int), "current_hps_sync");
...
struct saa7146_ext_vv {
   int inputs ;
   int audios ;
    klee_make_symbolic(&audios, sizeof(int), "audios");
   u32 capabilities ;
   int flags ;
   struct saa7146_standard *stds ;
   int num_stds ;
    klee_make_symbolic(&num_stds, sizeof(int), "num_stds");
...
{ void *__r ;
  ...
  unsigned short __cil_tmp212 ;
    klee_make_symbolic(&__cil_tmp212, sizeof(short), "__cil_tmp212");
  int __cil_tmp213 ;
...
{ struct budget *budget ;
  ...
  int count ;
  int detected ;
    klee_make_symbolic(&detected, sizeof(int), "detected");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
  int tmp___2 ;
