...
{ struct i2c_client *var_group1 ;
  ...
  int res_egalax_ts_probe_3 ;
    klee_make_symbolic(&res_egalax_ts_probe_3, sizeof(int), "res_egalax_ts_probe_3");
  int var_egalax_ts_interrupt_0_p0 ;
    klee_make_symbolic(&var_egalax_ts_interrupt_0_p0, sizeof(int), "var_egalax_ts_interrupt_0_p0");
  void *var_egalax_ts_interrupt_0_p1 ;
  int ldv_s_egalax_ts_driver_i2c_driver ;
    klee_make_symbolic(&ldv_s_egalax_ts_driver_i2c_driver, sizeof(int), "ldv_s_egalax_ts_driver_i2c_driver");
  int tmp ;
  int tmp___0 ;
