...
{ struct ata_link *var_group1 ;
  unsigned long var_phison_pre_reset_0_p1 ;
    klee_make_symbolic(&var_phison_pre_reset_0_p1, sizeof(long), "var_phison_pre_reset_0_p1");
  struct pci_dev *var_group2 ;
  struct pci_device_id  const  *var_phison_init_one_1_p1 ;
  int res_phison_init_one_1 ;
    klee_make_symbolic(&res_phison_init_one_1, sizeof(int), "res_phison_init_one_1");
  int ldv_s_phison_pci_driver_pci_driver ;
    klee_make_symbolic(&ldv_s_phison_pci_driver_pci_driver, sizeof(int), "ldv_s_phison_pci_driver_pci_driver");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
