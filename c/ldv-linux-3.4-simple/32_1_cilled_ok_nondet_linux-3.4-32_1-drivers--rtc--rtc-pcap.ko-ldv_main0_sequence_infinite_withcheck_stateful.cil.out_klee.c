...
{ struct pcap_rtc *pcap_rtc ;
  unsigned long rtc_events ;
    klee_make_symbolic(&rtc_events, sizeof(long), "rtc_events");
  int tmp ;
  int tmp___0 ;
...
{ struct pcap_rtc *pcap_rtc ;
  int timer_irq ;
    klee_make_symbolic(&timer_irq, sizeof(int), "timer_irq");
  int alarm_irq ;
...
{ struct device *var_group1 ;
  ...
  unsigned long var_pcap_rtc_set_mmss_4_p1 ;
    klee_make_symbolic(&var_pcap_rtc_set_mmss_4_p1, sizeof(long), "var_pcap_rtc_set_mmss_4_p1");
  unsigned int var_pcap_rtc_alarm_irq_enable_6_p1 ;
    klee_make_symbolic(&var_pcap_rtc_alarm_irq_enable_6_p1, sizeof(int), "var_pcap_rtc_alarm_irq_enable_6_p1");
  int var_pcap_rtc_irq_0_p0 ;
    klee_make_symbolic(&var_pcap_rtc_irq_0_p0, sizeof(int), "var_pcap_rtc_irq_0_p0");
