...
static int res_max7301_probe_2  ;
    klee_make_symbolic(&res_max7301_probe_2, sizeof(int), "res_max7301_probe_2");
void main(void) 
{ struct spi_device *var_group1 ;
  int tmp___7 ;
  int ldv_s_max7301_driver_spi_driver ;
    klee_make_symbolic(&ldv_s_max7301_driver_spi_driver, sizeof(int), "ldv_s_max7301_driver_spi_driver");
  int tmp___8 ;
  int tmp___9 ;
  int __cil_tmp6 ;
