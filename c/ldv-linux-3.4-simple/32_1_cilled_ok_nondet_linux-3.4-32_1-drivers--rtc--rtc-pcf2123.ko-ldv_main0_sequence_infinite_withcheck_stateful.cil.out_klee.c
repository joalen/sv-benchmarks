...
static int res_pcf2123_probe_5  ;
    klee_make_symbolic(&res_pcf2123_probe_5, sizeof(int), "res_pcf2123_probe_5");
void main(void) 
{ struct device *var_group1 ;
  struct rtc_time *var_group2 ;
  struct spi_device *var_group3 ;
  int ldv_s_pcf2123_driver_spi_driver ;
    klee_make_symbolic(&ldv_s_pcf2123_driver_spi_driver, sizeof(int), "ldv_s_pcf2123_driver_spi_driver");
  int tmp___7 ;
  int tmp___8 ;
  int __cil_tmp7 ;
