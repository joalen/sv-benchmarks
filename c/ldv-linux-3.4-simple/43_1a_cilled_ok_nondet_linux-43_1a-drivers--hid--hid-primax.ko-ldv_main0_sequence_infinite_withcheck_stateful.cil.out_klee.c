...
{ struct hid_device *var_group1 ;
  ...
  int var_px_raw_event_0_p3 ;
    klee_make_symbolic(&var_px_raw_event_0_p3, sizeof(int), "var_px_raw_event_0_p3");
  struct hid_device_id  const  *var_px_probe_1_p1 ;
  int res_px_probe_1 ;
    klee_make_symbolic(&res_px_probe_1, sizeof(int), "res_px_probe_1");
  int ldv_s_px_driver_hid_driver ;
    klee_make_symbolic(&ldv_s_px_driver_hid_driver, sizeof(int), "ldv_s_px_driver_hid_driver");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
