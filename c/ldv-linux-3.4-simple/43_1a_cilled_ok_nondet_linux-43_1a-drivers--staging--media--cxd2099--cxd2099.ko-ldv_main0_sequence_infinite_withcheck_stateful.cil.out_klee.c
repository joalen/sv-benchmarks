...
struct cxd {
   ...
   int dr ;
    klee_make_symbolic(&dr, sizeof(int), "dr");
   int slot_stat ;
    klee_make_symbolic(&slot_stat, sizeof(int), "slot_stat");
   u8 amem[1024U] ;
   int amem_read ;
    klee_make_symbolic(&amem_read, sizeof(int), "amem_read");
   int cammode ;
    klee_make_symbolic(&cammode, sizeof(int), "cammode");
   struct mutex lock ;
};
...
{ struct dvb_ca_en50221 *var_group1 ;
  int var_read_attribute_mem_18_p1 ;
    klee_make_symbolic(&var_read_attribute_mem_18_p1, sizeof(int), "var_read_attribute_mem_18_p1");
  int var_read_attribute_mem_18_p2 ;
    klee_make_symbolic(&var_read_attribute_mem_18_p2, sizeof(int), "var_read_attribute_mem_18_p2");
  int var_write_attribute_mem_19_p1 ;
    klee_make_symbolic(&var_write_attribute_mem_19_p1, sizeof(int), "var_write_attribute_mem_19_p1");
  int var_write_attribute_mem_19_p2 ;
    klee_make_symbolic(&var_write_attribute_mem_19_p2, sizeof(int), "var_write_attribute_mem_19_p2");
  u8 var_write_attribute_mem_19_p3 ;
  int var_read_cam_control_20_p1 ;
    klee_make_symbolic(&var_read_cam_control_20_p1, sizeof(int), "var_read_cam_control_20_p1");
  u8 var_read_cam_control_20_p2 ;
  int var_write_cam_control_21_p1 ;
    klee_make_symbolic(&var_write_cam_control_21_p1, sizeof(int), "var_write_cam_control_21_p1");
  u8 var_write_cam_control_21_p2 ;
  u8 var_write_cam_control_21_p3 ;
  int var_slot_reset_22_p1 ;
    klee_make_symbolic(&var_slot_reset_22_p1, sizeof(int), "var_slot_reset_22_p1");
  int var_slot_shutdown_23_p1 ;
    klee_make_symbolic(&var_slot_shutdown_23_p1, sizeof(int), "var_slot_shutdown_23_p1");
  int var_slot_ts_enable_24_p1 ;
    klee_make_symbolic(&var_slot_ts_enable_24_p1, sizeof(int), "var_slot_ts_enable_24_p1");
  int var_poll_slot_status_26_p1 ;
    klee_make_symbolic(&var_poll_slot_status_26_p1, sizeof(int), "var_poll_slot_status_26_p1");
  int var_poll_slot_status_26_p2 ;
    klee_make_symbolic(&var_poll_slot_status_26_p2, sizeof(int), "var_poll_slot_status_26_p2");
  int tmp ;
  int tmp___0 ;
  int __cil_tmp19 ;
  u8 __cil_tmp20 ;
