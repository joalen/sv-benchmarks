...
static int vfb_check_var(struct fb_var_screeninfo *var , struct fb_info *info ) 
{ u_long line_length ;
    klee_make_symbolic(&line_length, sizeof(long), "line_length");
  unsigned long __cil_tmp4 ;
  unsigned long __cil_tmp5 ;
  __u32 __cil_tmp6 ;
...
{ struct fb_var_screeninfo *var_group1 ;
  ...
  u_int var_vfb_setcolreg_5_p0 ;
    klee_make_symbolic(&var_vfb_setcolreg_5_p0, sizeof(int), "var_vfb_setcolreg_5_p0");
  u_int var_vfb_setcolreg_5_p1 ;
    klee_make_symbolic(&var_vfb_setcolreg_5_p1, sizeof(int), "var_vfb_setcolreg_5_p1");
  u_int var_vfb_setcolreg_5_p2 ;
    klee_make_symbolic(&var_vfb_setcolreg_5_p2, sizeof(int), "var_vfb_setcolreg_5_p2");
  u_int var_vfb_setcolreg_5_p3 ;
    klee_make_symbolic(&var_vfb_setcolreg_5_p3, sizeof(int), "var_vfb_setcolreg_5_p3");
  u_int var_vfb_setcolreg_5_p4 ;
    klee_make_symbolic(&var_vfb_setcolreg_5_p4, sizeof(int), "var_vfb_setcolreg_5_p4");
  struct fb_info *var_vfb_setcolreg_5_p5 ;
  struct vm_area_struct *var_group3 ;
  struct platform_device *var_group4 ;
  int res_vfb_probe_9 ;
    klee_make_symbolic(&res_vfb_probe_9, sizeof(int), "res_vfb_probe_9");
  int ldv_s_vfb_driver_platform_driver ;
    klee_make_symbolic(&ldv_s_vfb_driver_platform_driver, sizeof(int), "ldv_s_vfb_driver_platform_driver");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
