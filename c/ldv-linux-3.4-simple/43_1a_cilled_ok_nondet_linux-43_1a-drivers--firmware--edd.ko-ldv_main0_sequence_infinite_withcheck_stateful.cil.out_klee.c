...
struct edd_device {
   ...
   unsigned int mbr_signature ;
    klee_make_symbolic(&mbr_signature, sizeof(int), "mbr_signature");
...
{ unsigned char __max1 ;
    klee_make_symbolic(&__max1, sizeof(char), "__max1");
  unsigned char __min1 ;
    klee_make_symbolic(&__min1, sizeof(char), "__min1");
  unsigned char __min2 ;
    klee_make_symbolic(&__min2, sizeof(char), "__min2");
  int tmp ;
  unsigned char __max2 ;
    klee_make_symbolic(&__max2, sizeof(char), "__max2");
  unsigned char __min1___0 ;
    klee_make_symbolic(&__min1___0, sizeof(char), "__min1___0");
  unsigned char __min2___0 ;
    klee_make_symbolic(&__min2___0, sizeof(char), "__min2___0");
  int tmp___0 ;
  int tmp___1 ;
...
{ struct kobject *var_group1 ;
  ...
  int ldv_s_edd_ktype_kobj_type ;
    klee_make_symbolic(&ldv_s_edd_ktype_kobj_type, sizeof(int), "ldv_s_edd_ktype_kobj_type");
  int tmp ;
  int tmp___0 ;
