...
struct spaceball {
   ...
   int escape ;
    klee_make_symbolic(&escape, sizeof(int), "escape");
...
static int res_spaceball_connect_3  ;
    klee_make_symbolic(&res_spaceball_connect_3, sizeof(int), "res_spaceball_connect_3");
void main(void) 
{ struct serio *var_group1 ;
  unsigned char var_spaceball_interrupt_1_p1 ;
    klee_make_symbolic(&var_spaceball_interrupt_1_p1, sizeof(char), "var_spaceball_interrupt_1_p1");
  unsigned int var_spaceball_interrupt_1_p2 ;
    klee_make_symbolic(&var_spaceball_interrupt_1_p2, sizeof(int), "var_spaceball_interrupt_1_p2");
  struct serio_driver *var_group2 ;
  int tmp ;
  int ldv_s_spaceball_drv_serio_driver ;
    klee_make_symbolic(&ldv_s_spaceball_drv_serio_driver, sizeof(int), "ldv_s_spaceball_drv_serio_driver");
  int tmp___0 ;
  int tmp___1 ;
  int __cil_tmp9 ;
