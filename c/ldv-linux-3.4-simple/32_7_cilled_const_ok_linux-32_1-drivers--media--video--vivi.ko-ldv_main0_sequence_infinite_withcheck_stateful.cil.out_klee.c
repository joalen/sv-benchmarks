...
struct vb2_buffer {
   ...
   unsigned int num_planes ;
    klee_make_symbolic(&num_planes, sizeof(int), "num_planes");
...
struct vb2_queue {
   ...
   unsigned int io_modes ;
    klee_make_symbolic(&io_modes, sizeof(int), "io_modes");
   unsigned int io_flags ;
    klee_make_symbolic(&io_flags, sizeof(int), "io_flags");
   struct vb2_ops    *ops ;
   struct vb2_mem_ops    *mem_ops ;
   void *drv_priv ;
   unsigned int buf_struct_size ;
    klee_make_symbolic(&buf_struct_size, sizeof(int), "buf_struct_size");
   enum v4l2_memory memory ;
   struct vb2_buffer *bufs[32] ;
   unsigned int num_buffers ;
    klee_make_symbolic(&num_buffers, sizeof(int), "num_buffers");
...
struct vivi_dmaqueue {
   ...
   int ini_jiffies ;
    klee_make_symbolic(&ini_jiffies, sizeof(int), "ini_jiffies");
};
...
struct vivi_dev {
   ...
   unsigned int button_pressed ;
    klee_make_symbolic(&button_pressed, sizeof(int), "button_pressed");
   int mv_count ;
    klee_make_symbolic(&mv_count, sizeof(int), "mv_count");
   int input ;
...
{ u8 r ;
  ...
  int k ;
  int is_yuv ;
    klee_make_symbolic(&is_yuv, sizeof(int), "is_yuv");
  unsigned long __cil_tmp7 ;
  unsigned long __cil_tmp8 ;
  unsigned long __cil_tmp9 ;
  unsigned long __cil_tmp10 ;
...
{ u8 r_y ;
  ...
  u8 b_v ;
  int color ;
    klee_make_symbolic(&color, sizeof(int), "color");
  u8 *p ;
  unsigned long __cil_tmp9 ;
  unsigned long __cil_tmp10 ;
  unsigned long __cil_tmp11 ;
...
{ int w ;
  ...
  int colorpos ;
    klee_make_symbolic(&colorpos, sizeof(int), "colorpos");
  unsigned long __cil_tmp4 ;
  unsigned long __cil_tmp5 ;
  unsigned int __cil_tmp6 ;
...
{ int wmax ;
    klee_make_symbolic(&wmax, sizeof(int), "wmax");
  int hmax ;
    klee_make_symbolic(&hmax, sizeof(int), "hmax");
  struct timeval ts ;
  void *vbuf ;
  void *tmp___7 ;
  unsigned int ms ;
...
{ struct vb2_buffer *var_group1 = ldv_malloc(sizeof(struct vb2_buffer));
  ...
  int ldv_s_vivi_fops_v4l2_file_operations ;
    klee_make_symbolic(&ldv_s_vivi_fops_v4l2_file_operations, sizeof(int), "ldv_s_vivi_fops_v4l2_file_operations");
  int tmp___8 ;
  int tmp___9 ;
  int __cil_tmp45 ;
