...
static int res_da9052_rtc_probe_10  ;
    klee_make_symbolic(&res_da9052_rtc_probe_10, sizeof(int), "res_da9052_rtc_probe_10");
void main(void) 
{ struct device *var_group1 ;
  struct rtc_time *var_group2 ;
  struct rtc_wkalrm *var_group3 ;
  unsigned int var_da9052_rtc_alarm_irq_enable_9_p1 ;
    klee_make_symbolic(&var_da9052_rtc_alarm_irq_enable_9_p1, sizeof(int), "var_da9052_rtc_alarm_irq_enable_9_p1");
  struct platform_device *var_group4 ;
  int var_da9052_rtc_irq_1_p0 ;
    klee_make_symbolic(&var_da9052_rtc_irq_1_p0, sizeof(int), "var_da9052_rtc_irq_1_p0");
  void *var_da9052_rtc_irq_1_p1 ;
  int ldv_s_da9052_rtc_driver_platform_driver ;
    klee_make_symbolic(&ldv_s_da9052_rtc_driver_platform_driver, sizeof(int), "ldv_s_da9052_rtc_driver_platform_driver");
  int tmp ;
  int tmp___0 ;
  int __cil_tmp11 ;
