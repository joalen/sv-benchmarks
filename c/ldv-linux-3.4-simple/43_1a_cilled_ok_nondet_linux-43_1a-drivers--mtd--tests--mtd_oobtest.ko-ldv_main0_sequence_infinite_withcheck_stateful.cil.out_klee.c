...
static int ebcnt  ;
    klee_make_symbolic(&ebcnt, sizeof(int), "ebcnt");
static int pgcnt  ;
    klee_make_symbolic(&pgcnt, sizeof(int), "pgcnt");
static int errcnt  ;
    klee_make_symbolic(&errcnt, sizeof(int), "errcnt");
static int use_offset  ;
    klee_make_symbolic(&use_offset, sizeof(int), "use_offset");
static int use_len  ;
    klee_make_symbolic(&use_len, sizeof(int), "use_len");
static int use_len_max  ;
    klee_make_symbolic(&use_len_max, sizeof(int), "use_len_max");
static int vary_offset  ;
    klee_make_symbolic(&vary_offset, sizeof(int), "vary_offset");
...
{ int err ;
  ...
  int pg ;
    klee_make_symbolic(&pg, sizeof(int), "pg");
  size_t sz ;
  int tmp___4 ;
