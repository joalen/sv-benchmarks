...
{ acpi_handle handle ;
  ...
  unsigned long long gsb ;
    klee_make_symbolic(&gsb, sizeof(long), "gsb");
...
{ struct pci_dev *var_group1 ;
  ...
  int res_ioapic_probe_0 ;
    klee_make_symbolic(&res_ioapic_probe_0, sizeof(int), "res_ioapic_probe_0");
  int ldv_s_ioapic_driver_pci_driver ;
    klee_make_symbolic(&ldv_s_ioapic_driver_pci_driver, sizeof(int), "ldv_s_ioapic_driver_pci_driver");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
