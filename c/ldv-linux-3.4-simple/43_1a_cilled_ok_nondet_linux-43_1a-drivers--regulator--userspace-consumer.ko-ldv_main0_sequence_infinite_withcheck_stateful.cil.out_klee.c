...
struct regulator_userspace_consumer_data {
   char const   *name ;
   int num_supplies ;
    klee_make_symbolic(&num_supplies, sizeof(int), "num_supplies");
...
{ struct platform_device *var_group1 ;
  int res_regulator_userspace_consumer_probe_3 ;
    klee_make_symbolic(&res_regulator_userspace_consumer_probe_3, sizeof(int), "res_regulator_userspace_consumer_probe_3");
  int ldv_s_regulator_userspace_consumer_driver_platform_driver ;
    klee_make_symbolic(&ldv_s_regulator_userspace_consumer_driver_platform_driver, sizeof(int), "ldv_s_regulator_userspace_consumer_driver_platform_driver");
  int tmp ;
  int tmp___0 ;
