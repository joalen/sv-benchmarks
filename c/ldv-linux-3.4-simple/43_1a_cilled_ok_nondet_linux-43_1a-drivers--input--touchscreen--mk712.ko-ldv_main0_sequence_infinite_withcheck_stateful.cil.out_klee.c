...
{ unsigned char status ;
  ...
  int debounce ;
    klee_make_symbolic(&debounce, sizeof(int), "debounce");
  unsigned short last_x ;
    klee_make_symbolic(&last_x, sizeof(short), "last_x");
  unsigned short last_y ;
    klee_make_symbolic(&last_y, sizeof(short), "last_y");
  unsigned short tmp ;
...
{ int var_mk712_interrupt_0_p0 ;
    klee_make_symbolic(&var_mk712_interrupt_0_p0, sizeof(int), "var_mk712_interrupt_0_p0");
