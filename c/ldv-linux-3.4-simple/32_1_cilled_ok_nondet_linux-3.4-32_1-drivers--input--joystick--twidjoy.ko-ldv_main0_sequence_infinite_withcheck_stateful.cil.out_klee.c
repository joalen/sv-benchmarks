...
{ struct input_dev *dev ;
  ...
  int button_bits ;
    klee_make_symbolic(&button_bits, sizeof(int), "button_bits");
  int abs_x ;
    klee_make_symbolic(&abs_x, sizeof(int), "abs_x");
  int abs_y ;
    klee_make_symbolic(&abs_y, sizeof(int), "abs_y");
  int value ;
  int i ;
...
static int res_twidjoy_connect_3  ;
    klee_make_symbolic(&res_twidjoy_connect_3, sizeof(int), "res_twidjoy_connect_3");
void main(void) 
{ struct serio *var_group1 ;
  unsigned char var_twidjoy_interrupt_1_p1 ;
    klee_make_symbolic(&var_twidjoy_interrupt_1_p1, sizeof(char), "var_twidjoy_interrupt_1_p1");
  unsigned int var_twidjoy_interrupt_1_p2 ;
    klee_make_symbolic(&var_twidjoy_interrupt_1_p2, sizeof(int), "var_twidjoy_interrupt_1_p2");
  struct serio_driver *var_group2 ;
  int tmp ;
  int ldv_s_twidjoy_drv_serio_driver ;
    klee_make_symbolic(&ldv_s_twidjoy_drv_serio_driver, sizeof(int), "ldv_s_twidjoy_drv_serio_driver");
  int tmp___0 ;
  int tmp___1 ;
  int __cil_tmp9 ;
