...
struct capi_ctr {
   ...
   unsigned short state ;
    klee_make_symbolic(&state, sizeof(short), "state");
   int blocked ;
...
struct avmctrl_info {
   char cardname[32] ;
   int versionlen ;
    klee_make_symbolic(&versionlen, sizeof(int), "versionlen");
...
struct avmcard {
   ...
   u_int nr_controllers ;
    klee_make_symbolic(&nr_controllers, sizeof(int), "nr_controllers");
   u_int nlogcontr ;
    klee_make_symbolic(&nlogcontr, sizeof(int), "nlogcontr");
   struct list_head list ;
};
...
static int res_b1pci_pci_probe_6  ;
    klee_make_symbolic(&res_b1pci_pci_probe_6, sizeof(int), "res_b1pci_pci_probe_6");
void main(void) 
{ struct pci_dev *var_group1 ;
  struct pci_device_id  const  *var_b1pci_pci_probe_6_p1 ;
  int tmp ;
  int ldv_s_b1pci_pci_driver_pci_driver ;
    klee_make_symbolic(&ldv_s_b1pci_pci_driver_pci_driver, sizeof(int), "ldv_s_b1pci_pci_driver_pci_driver");
  int tmp___0 ;
  int tmp___1 ;
  int __cil_tmp7 ;
