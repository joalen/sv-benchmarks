...
struct lp5521_platform_data {
   ...
   int num_patterns ;
    klee_make_symbolic(&num_patterns, sizeof(int), "num_patterns");
};
...
{ struct lp5521_chip *chip ;
  ...
  int ret ;
  int nrchars ;
    klee_make_symbolic(&nrchars, sizeof(int), "nrchars");
  int offset ;
  int i ;
  char c[3] ;
  unsigned int cmd ;
...
{ struct lp5521_chip *chip ;
  ...
  int i ;
  int led ;
    klee_make_symbolic(&led, sizeof(int), "led");
  u8 buf ;
  void *tmp___7 ;
  ...
  long __constr_expr_0_counter165 ;
    klee_make_symbolic(&__constr_expr_0_counter165, sizeof(long), "__constr_expr_0_counter165");
...
static int res_lp5521_probe_31  ;
    klee_make_symbolic(&res_lp5521_probe_31, sizeof(int), "res_lp5521_probe_31");
void main(void) 
{ struct i2c_client *var_group1 ;
  struct i2c_device_id  const  *var_lp5521_probe_31_p1 ;
  int ldv_s_lp5521_driver_i2c_driver ;
    klee_make_symbolic(&ldv_s_lp5521_driver_i2c_driver, sizeof(int), "ldv_s_lp5521_driver_i2c_driver");
  int tmp___7 ;
  int tmp___8 ;
  int __cil_tmp6 ;
