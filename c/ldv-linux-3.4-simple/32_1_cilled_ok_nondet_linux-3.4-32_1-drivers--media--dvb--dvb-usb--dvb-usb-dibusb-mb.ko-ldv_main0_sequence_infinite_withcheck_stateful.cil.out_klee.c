...
static int res_dibusb_probe_5  ;
    klee_make_symbolic(&res_dibusb_probe_5, sizeof(int), "res_dibusb_probe_5");
void main(void) 
{ struct dvb_usb_adapter *var_group1 ;
  ...
  int ldv_s_dibusb_driver_usb_driver ;
    klee_make_symbolic(&ldv_s_dibusb_driver_usb_driver, sizeof(int), "ldv_s_dibusb_driver_usb_driver");
  int tmp___7 ;
  int tmp___8 ;
  int __cil_tmp7 ;
