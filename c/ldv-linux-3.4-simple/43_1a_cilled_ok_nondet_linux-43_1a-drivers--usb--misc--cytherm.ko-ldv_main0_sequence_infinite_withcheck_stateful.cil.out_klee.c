...
{ struct usb_interface *var_group1 ;
  ...
  int res_cytherm_probe_11 ;
    klee_make_symbolic(&res_cytherm_probe_11, sizeof(int), "res_cytherm_probe_11");
  int ldv_s_cytherm_driver_usb_driver ;
    klee_make_symbolic(&ldv_s_cytherm_driver_usb_driver, sizeof(int), "ldv_s_cytherm_driver_usb_driver");
  int tmp ;
  int tmp___0 ;
