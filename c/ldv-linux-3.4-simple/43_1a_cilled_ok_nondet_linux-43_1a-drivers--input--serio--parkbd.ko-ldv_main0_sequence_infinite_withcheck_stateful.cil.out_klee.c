...
static unsigned int parkbd_pp_no  ;
    klee_make_symbolic(&parkbd_pp_no, sizeof(int), "parkbd_pp_no");
static unsigned int parkbd_mode  =    1U;
static int parkbd_buffer  ;
    klee_make_symbolic(&parkbd_buffer, sizeof(int), "parkbd_buffer");
static int parkbd_counter  ;
    klee_make_symbolic(&parkbd_counter, sizeof(int), "parkbd_counter");
static unsigned long parkbd_last  ;
    klee_make_symbolic(&parkbd_last, sizeof(long), "parkbd_last");
static int parkbd_writing  ;
    klee_make_symbolic(&parkbd_writing, sizeof(int), "parkbd_writing");
static unsigned long parkbd_start  ;
    klee_make_symbolic(&parkbd_start, sizeof(long), "parkbd_start");
