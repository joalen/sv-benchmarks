...
{ struct usb_interface *intf ;
  ...
  unsigned short ifnum ;
    klee_make_symbolic(&ifnum, sizeof(short), "ifnum");
  unsigned long __cil_tmp10 ;
  unsigned long __cil_tmp11 ;
...
static int res_samsung_probe_5  ;
    klee_make_symbolic(&res_samsung_probe_5, sizeof(int), "res_samsung_probe_5");
void main(void) 
{ struct hid_device *var_group1 ;
  ...
  int ldv_s_samsung_driver_hid_driver ;
    klee_make_symbolic(&ldv_s_samsung_driver_hid_driver, sizeof(int), "ldv_s_samsung_driver_hid_driver");
  int tmp___8 ;
  int tmp___9 ;
  int __cil_tmp14 ;
