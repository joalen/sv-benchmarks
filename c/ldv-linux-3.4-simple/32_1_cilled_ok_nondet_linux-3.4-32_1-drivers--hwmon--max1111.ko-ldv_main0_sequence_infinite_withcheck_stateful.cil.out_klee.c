...
static int res_max1111_probe_5  ;
    klee_make_symbolic(&res_max1111_probe_5, sizeof(int), "res_max1111_probe_5");
void main(void) 
{ struct spi_device *var_group1 ;
  int ldv_s_max1111_driver_spi_driver ;
    klee_make_symbolic(&ldv_s_max1111_driver_spi_driver, sizeof(int), "ldv_s_max1111_driver_spi_driver");
  int tmp___7 ;
  int tmp___8 ;
  int __cil_tmp5 ;
