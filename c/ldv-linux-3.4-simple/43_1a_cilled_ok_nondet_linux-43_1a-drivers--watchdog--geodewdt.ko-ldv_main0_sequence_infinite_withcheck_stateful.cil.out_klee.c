...
static unsigned long wdt_flags  ;
    klee_make_symbolic(&wdt_flags, sizeof(long), "wdt_flags");
static struct cs5535_mfgpt_timer *wdt_timer  ;
static int safe_close  ;
    klee_make_symbolic(&safe_close, sizeof(int), "safe_close");
...
{ struct file *var_group1 ;
  ...
  unsigned int var_geodewdt_ioctl_6_p1 ;
    klee_make_symbolic(&var_geodewdt_ioctl_6_p1, sizeof(int), "var_geodewdt_ioctl_6_p1");
  unsigned long var_geodewdt_ioctl_6_p2 ;
    klee_make_symbolic(&var_geodewdt_ioctl_6_p2, sizeof(long), "var_geodewdt_ioctl_6_p2");
  struct inode *var_group2 ;
  int res_geodewdt_open_3 ;
    klee_make_symbolic(&res_geodewdt_open_3, sizeof(int), "res_geodewdt_open_3");
  struct platform_device *var_group3 ;
  int res_geodewdt_probe_7 ;
    klee_make_symbolic(&res_geodewdt_probe_7, sizeof(int), "res_geodewdt_probe_7");
  int ldv_s_geodewdt_fops_file_operations ;
    klee_make_symbolic(&ldv_s_geodewdt_fops_file_operations, sizeof(int), "ldv_s_geodewdt_fops_file_operations");
  int ldv_s_geodewdt_driver_platform_driver ;
    klee_make_symbolic(&ldv_s_geodewdt_driver_platform_driver, sizeof(int), "ldv_s_geodewdt_driver_platform_driver");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
  int __cil_tmp17 ;
