...
{ struct freecom_cb_wrap *fcb ;
  ...
  unsigned int ipipe ;
    klee_make_symbolic(&ipipe, sizeof(int), "ipipe");
  unsigned int opipe ;
    klee_make_symbolic(&opipe, sizeof(int), "opipe");
  int result ;
...
static int res_freecom_probe_6  ;
    klee_make_symbolic(&res_freecom_probe_6, sizeof(int), "res_freecom_probe_6");
void main(void) 
{ struct usb_interface *var_group1 ;
  struct usb_device_id  const  *var_freecom_probe_6_p1 ;
  int ldv_s_freecom_driver_usb_driver ;
    klee_make_symbolic(&ldv_s_freecom_driver_usb_driver, sizeof(int), "ldv_s_freecom_driver_usb_driver");
  int tmp___7 ;
  int tmp___8 ;
  int __cil_tmp6 ;
...
#include "model/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--usb--storage--ums-freecom.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out.env.c"
#include <klee/klee.h>
