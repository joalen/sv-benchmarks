...
struct rtc_plat_data {
   ...
   unsigned int irqen ;
    klee_make_symbolic(&irqen, sizeof(int), "irqen");
   int alrm_sec ;
    klee_make_symbolic(&alrm_sec, sizeof(int), "alrm_sec");
   int alrm_min ;
    klee_make_symbolic(&alrm_min, sizeof(int), "alrm_min");
   int alrm_hour ;
    klee_make_symbolic(&alrm_hour, sizeof(int), "alrm_hour");
   int alrm_mday ;
    klee_make_symbolic(&alrm_mday, sizeof(int), "alrm_mday");
   spinlock_t lock ;
};
...
{ struct resource *res ;
  unsigned int cal ;
    klee_make_symbolic(&cal, sizeof(int), "cal");
  unsigned int flags ;
  struct rtc_plat_data *pdata ;
  void *ioaddr ;
  int ret ;
...
{ struct device *var_group1 ;
  ...
  unsigned int var_stk17ta8_rtc_alarm_irq_enable_6_p1 ;
    klee_make_symbolic(&var_stk17ta8_rtc_alarm_irq_enable_6_p1, sizeof(int), "var_stk17ta8_rtc_alarm_irq_enable_6_p1");
  ...
  int res_stk17ta8_rtc_probe_9 ;
    klee_make_symbolic(&res_stk17ta8_rtc_probe_9, sizeof(int), "res_stk17ta8_rtc_probe_9");
  int var_stk17ta8_rtc_interrupt_5_p0 ;
    klee_make_symbolic(&var_stk17ta8_rtc_interrupt_5_p0, sizeof(int), "var_stk17ta8_rtc_interrupt_5_p0");
  void *var_stk17ta8_rtc_interrupt_5_p1 ;
  int ldv_s_stk17ta8_rtc_driver_platform_driver ;
    klee_make_symbolic(&ldv_s_stk17ta8_rtc_driver_platform_driver, sizeof(int), "ldv_s_stk17ta8_rtc_driver_platform_driver");
  int tmp ;
  int tmp___0 ;
