...
struct cx88_board {
   ...
   int i2sinputcntl ;
    klee_make_symbolic(&i2sinputcntl, sizeof(int), "i2sinputcntl");
};
enum cx88_tvaudio {
    WW_NONE = 1,
    WW_BTSC = 2,
...
struct cx88_core {
   ...
   int users ;
   int mpeg_users ;
    klee_make_symbolic(&mpeg_users, sizeof(int), "mpeg_users");
...
{ void *var_vp3054_bit_setsda_1_p0 ;
  int var_vp3054_bit_setsda_1_p1 ;
    klee_make_symbolic(&var_vp3054_bit_setsda_1_p1, sizeof(int), "var_vp3054_bit_setsda_1_p1");
  void *var_vp3054_bit_setscl_0_p0 ;
  int var_vp3054_bit_setscl_0_p1 ;
    klee_make_symbolic(&var_vp3054_bit_setscl_0_p1, sizeof(int), "var_vp3054_bit_setscl_0_p1");
