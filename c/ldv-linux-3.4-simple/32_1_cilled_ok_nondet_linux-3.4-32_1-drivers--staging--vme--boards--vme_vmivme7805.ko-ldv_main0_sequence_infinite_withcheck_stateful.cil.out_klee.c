...
static int res_vmic_probe_1  ;
    klee_make_symbolic(&res_vmic_probe_1, sizeof(int), "res_vmic_probe_1");
void main(void) 
{ struct pci_dev *var_group1 ;
  struct pci_device_id  const  *var_vmic_probe_1_p1 ;
  int tmp ;
  int ldv_s_vmic_driver_pci_driver ;
    klee_make_symbolic(&ldv_s_vmic_driver_pci_driver, sizeof(int), "ldv_s_vmic_driver_pci_driver");
  int tmp___0 ;
  int tmp___1 ;
  int __cil_tmp7 ;
