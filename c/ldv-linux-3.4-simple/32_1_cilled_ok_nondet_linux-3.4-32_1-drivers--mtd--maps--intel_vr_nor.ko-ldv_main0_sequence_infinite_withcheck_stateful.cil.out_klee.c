...
{ unsigned int exp_timing_cs0 ;
    klee_make_symbolic(&exp_timing_cs0, sizeof(int), "exp_timing_cs0");
  void *__cil_tmp3 ;
  void *__cil_tmp4 ;
...
{ unsigned long csr_phys ;
    klee_make_symbolic(&csr_phys, sizeof(long), "csr_phys");
  unsigned long csr_len ;
    klee_make_symbolic(&csr_len, sizeof(long), "csr_len");
  unsigned long win_phys ;
    klee_make_symbolic(&win_phys, sizeof(long), "win_phys");
  unsigned long win_len ;
    klee_make_symbolic(&win_len, sizeof(long), "win_len");
  unsigned int exp_timing_cs0 ;
  int err ;
...
static int res_vr_nor_pci_probe_7  ;
    klee_make_symbolic(&res_vr_nor_pci_probe_7, sizeof(int), "res_vr_nor_pci_probe_7");
void main(void) 
{ struct pci_dev *var_group1 ;
  struct pci_device_id  const  *var_vr_nor_pci_probe_7_p1 ;
  int tmp___7 ;
  int ldv_s_vr_nor_pci_driver_pci_driver ;
    klee_make_symbolic(&ldv_s_vr_nor_pci_driver_pci_driver, sizeof(int), "ldv_s_vr_nor_pci_driver_pci_driver");
  int tmp___8 ;
  int tmp___9 ;
  int __cil_tmp7 ;
