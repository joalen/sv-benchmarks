...
struct watchdog_device {
   ...
   unsigned int bootstatus ;
    klee_make_symbolic(&bootstatus, sizeof(int), "bootstatus");
...
struct wm831x_wdt_drvdata {
   ...
   int update_gpio ;
   int update_state ;
    klee_make_symbolic(&update_state, sizeof(int), "update_state");
};
...
{ struct wm831x_wdt_drvdata *driver_data ;
  ...
  unsigned short __cil_tmp37 ;
    klee_make_symbolic(&__cil_tmp37, sizeof(short), "__cil_tmp37");
...
{ struct watchdog_device *var_group1 ;
  unsigned int var_wm831x_wdt_set_timeout_3_p1 ;
    klee_make_symbolic(&var_wm831x_wdt_set_timeout_3_p1, sizeof(int), "var_wm831x_wdt_set_timeout_3_p1");
  struct platform_device *var_group2 ;
  int res_wm831x_wdt_probe_4 ;
    klee_make_symbolic(&res_wm831x_wdt_probe_4, sizeof(int), "res_wm831x_wdt_probe_4");
  int ldv_s_wm831x_wdt_driver_platform_driver ;
    klee_make_symbolic(&ldv_s_wm831x_wdt_driver_platform_driver, sizeof(int), "ldv_s_wm831x_wdt_driver_platform_driver");
  int tmp ;
  int tmp___0 ;
