...
struct ds_device {
   ...
   int ep[4U] ;
   int spu_sleep ;
    klee_make_symbolic(&spu_sleep, sizeof(int), "spu_sleep");
   u16 spu_bit ;
...
{ struct usb_interface *var_group1 ;
  ...
  int res_ds_probe_35 ;
    klee_make_symbolic(&res_ds_probe_35, sizeof(int), "res_ds_probe_35");
  int ldv_s_ds_driver_usb_driver ;
    klee_make_symbolic(&ldv_s_ds_driver_usb_driver, sizeof(int), "ldv_s_ds_driver_usb_driver");
  int tmp ;
  int tmp___0 ;
