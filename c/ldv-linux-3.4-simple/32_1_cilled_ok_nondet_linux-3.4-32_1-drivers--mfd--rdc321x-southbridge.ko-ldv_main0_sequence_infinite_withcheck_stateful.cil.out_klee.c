...
struct rdc321x_gpio_pdata {
   ...
   unsigned int max_gpios ;
    klee_make_symbolic(&max_gpios, sizeof(int), "max_gpios");
};
...
static int res_rdc321x_sb_probe_0  ;
    klee_make_symbolic(&res_rdc321x_sb_probe_0, sizeof(int), "res_rdc321x_sb_probe_0");
void main(void) 
{ struct pci_dev *var_group1 ;
  struct pci_device_id  const  *var_rdc321x_sb_probe_0_p1 ;
  int tmp ;
  int ldv_s_rdc321x_sb_driver_pci_driver ;
    klee_make_symbolic(&ldv_s_rdc321x_sb_driver_pci_driver, sizeof(int), "ldv_s_rdc321x_sb_driver_pci_driver");
  int tmp___0 ;
  int tmp___1 ;
  int __cil_tmp7 ;
