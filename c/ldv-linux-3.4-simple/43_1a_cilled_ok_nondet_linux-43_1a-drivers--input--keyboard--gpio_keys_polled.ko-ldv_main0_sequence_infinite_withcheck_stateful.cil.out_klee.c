...
struct input_polled_dev {
   ...
   unsigned int poll_interval_max ;
    klee_make_symbolic(&poll_interval_max, sizeof(int), "poll_interval_max");
   unsigned int poll_interval_min ;
    klee_make_symbolic(&poll_interval_min, sizeof(int), "poll_interval_min");
...
struct gpio_keys_button {
   ...
   int active_low ;
    klee_make_symbolic(&active_low, sizeof(int), "active_low");
   char const   *desc ;
   unsigned int type ;
   ...
   int debounce_interval ;
    klee_make_symbolic(&debounce_interval, sizeof(int), "debounce_interval");
   bool can_disable ;
   int value ;
   unsigned int irq ;
...
struct gpio_keys_platform_data {
   ...
   int nbuttons ;
    klee_make_symbolic(&nbuttons, sizeof(int), "nbuttons");
   unsigned int poll_interval ;
   unsigned char rep : 1 ;
...
struct gpio_keys_button_data {
   ...
   int can_sleep ;
    klee_make_symbolic(&can_sleep, sizeof(int), "can_sleep");
};
...
{ struct platform_device *var_group1 ;
  int res_gpio_keys_polled_probe_4 ;
    klee_make_symbolic(&res_gpio_keys_polled_probe_4, sizeof(int), "res_gpio_keys_polled_probe_4");
  int ldv_s_gpio_keys_polled_driver_platform_driver ;
    klee_make_symbolic(&ldv_s_gpio_keys_polled_driver_platform_driver, sizeof(int), "ldv_s_gpio_keys_polled_driver_platform_driver");
  int tmp ;
  int tmp___0 ;
