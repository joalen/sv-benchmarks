...
struct parport_private {
   unsigned int a_data ;
    klee_make_symbolic(&a_data, sizeof(int), "a_data");
   unsigned int c_data ;
    klee_make_symbolic(&c_data, sizeof(int), "c_data");
   int enable_irq ;
    klee_make_symbolic(&enable_irq, sizeof(int), "enable_irq");
};
...
{ struct comedi_device *var_group1 ;
  ...
  int var_parport_interrupt_10_p0 ;
    klee_make_symbolic(&var_parport_interrupt_10_p0, sizeof(int), "var_parport_interrupt_10_p0");
