...
{ struct sir_dev *var_group1 ;
  int res_esi_open_2 ;
    klee_make_symbolic(&res_esi_open_2, sizeof(int), "res_esi_open_2");
  unsigned int var_esi_change_speed_4_p1 ;
    klee_make_symbolic(&var_esi_change_speed_4_p1, sizeof(int), "var_esi_change_speed_4_p1");
  int ldv_s_esi_dongle_driver ;
    klee_make_symbolic(&ldv_s_esi_dongle_driver, sizeof(int), "ldv_s_esi_dongle_driver");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
