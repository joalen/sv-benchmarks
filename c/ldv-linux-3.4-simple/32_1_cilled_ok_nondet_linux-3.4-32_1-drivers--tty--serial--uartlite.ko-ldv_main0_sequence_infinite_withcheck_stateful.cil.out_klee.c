...
static int res_ulite_probe_28  ;
    klee_make_symbolic(&res_ulite_probe_28, sizeof(int), "res_ulite_probe_28");
void main(void) 
{ struct uart_port *var_group1 ;
  unsigned int var_ulite_set_mctrl_5_p1 ;
    klee_make_symbolic(&var_ulite_set_mctrl_5_p1, sizeof(int), "var_ulite_set_mctrl_5_p1");
  int var_ulite_break_ctl_10_p1 ;
    klee_make_symbolic(&var_ulite_break_ctl_10_p1, sizeof(int), "var_ulite_break_ctl_10_p1");
  struct ktermios *var_group2 ;
  struct ktermios *var_ulite_set_termios_13_p2 ;
  int var_ulite_config_port_17_p1 ;
    klee_make_symbolic(&var_ulite_config_port_17_p1, sizeof(int), "var_ulite_config_port_17_p1");
  struct serial_struct *var_group3 ;
  unsigned char var_ulite_put_poll_char_20_p1 ;
    klee_make_symbolic(&var_ulite_put_poll_char_20_p1, sizeof(char), "var_ulite_put_poll_char_20_p1");
  struct platform_device *var_group5 ;
  int var_ulite_isr_2_p0 ;
    klee_make_symbolic(&var_ulite_isr_2_p0, sizeof(int), "var_ulite_isr_2_p0");
  void *var_ulite_isr_2_p1 ;
  int tmp___7 ;
  int ldv_s_ulite_platform_driver_platform_driver ;
    klee_make_symbolic(&ldv_s_ulite_platform_driver_platform_driver, sizeof(int), "ldv_s_ulite_platform_driver_platform_driver");
  int tmp___8 ;
  int tmp___9 ;
  int __cil_tmp16 ;
