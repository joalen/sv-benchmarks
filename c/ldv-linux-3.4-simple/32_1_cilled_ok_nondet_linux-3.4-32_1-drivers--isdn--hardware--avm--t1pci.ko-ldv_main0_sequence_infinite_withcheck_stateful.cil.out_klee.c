...
static int res_t1pci_probe_3  ;
    klee_make_symbolic(&res_t1pci_probe_3, sizeof(int), "res_t1pci_probe_3");
void main(void) 
{ struct pci_dev *var_group1 ;
  struct pci_device_id  const  *var_t1pci_probe_3_p1 ;
  int tmp ;
  int ldv_s_t1pci_pci_driver_pci_driver ;
    klee_make_symbolic(&ldv_s_t1pci_pci_driver_pci_driver, sizeof(int), "ldv_s_t1pci_pci_driver_pci_driver");
  int tmp___0 ;
  int tmp___1 ;
  int __cil_tmp7 ;
