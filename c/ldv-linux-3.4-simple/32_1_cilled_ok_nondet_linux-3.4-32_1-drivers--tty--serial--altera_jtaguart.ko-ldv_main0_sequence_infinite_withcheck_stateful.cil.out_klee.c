...
struct altera_jtaguart {
   ...
   unsigned long imr ;
    klee_make_symbolic(&imr, sizeof(long), "imr");
};
...
static int res_altera_jtaguart_probe_24  ;
    klee_make_symbolic(&res_altera_jtaguart_probe_24, sizeof(int), "res_altera_jtaguart_probe_24");
void main(void) 
{ struct uart_port *var_group1 ;
  unsigned int var_altera_jtaguart_set_mctrl_2_p1 ;
    klee_make_symbolic(&var_altera_jtaguart_set_mctrl_2_p1, sizeof(int), "var_altera_jtaguart_set_mctrl_2_p1");
  int var_altera_jtaguart_break_ctl_6_p1 ;
    klee_make_symbolic(&var_altera_jtaguart_break_ctl_6_p1, sizeof(int), "var_altera_jtaguart_break_ctl_6_p1");
  struct ktermios *var_group2 ;
  struct ktermios *var_altera_jtaguart_set_termios_8_p2 ;
  int var_altera_jtaguart_config_port_12_p1 ;
    klee_make_symbolic(&var_altera_jtaguart_config_port_12_p1, sizeof(int), "var_altera_jtaguart_config_port_12_p1");
  struct serial_struct *var_group3 ;
  struct platform_device *var_group5 ;
  int var_altera_jtaguart_interrupt_11_p0 ;
    klee_make_symbolic(&var_altera_jtaguart_interrupt_11_p0, sizeof(int), "var_altera_jtaguart_interrupt_11_p0");
  void *var_altera_jtaguart_interrupt_11_p1 ;
  int tmp___7 ;
  int ldv_s_altera_jtaguart_platform_driver_platform_driver ;
    klee_make_symbolic(&ldv_s_altera_jtaguart_platform_driver_platform_driver, sizeof(int), "ldv_s_altera_jtaguart_platform_driver_platform_driver");
  int tmp___8 ;
  int tmp___9 ;
  int __cil_tmp15 ;
