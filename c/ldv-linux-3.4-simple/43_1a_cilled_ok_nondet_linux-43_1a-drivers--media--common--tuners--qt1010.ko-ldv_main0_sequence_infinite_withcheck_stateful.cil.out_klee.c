...
{ struct dtv_frontend_properties *c ;
  ...
  u8 __cil_tmp557 ;
  int __cil_tmp558 ;
    klee_make_symbolic(&__cil_tmp558, sizeof(int), "__cil_tmp558");
...
{ struct dvb_frontend *var_group1 ;
  ...
  int ldv_s_qt1010_tuner_ops_dvb_tuner_ops ;
    klee_make_symbolic(&ldv_s_qt1010_tuner_ops_dvb_tuner_ops, sizeof(int), "ldv_s_qt1010_tuner_ops_dvb_tuner_ops");
  int tmp ;
  int tmp___0 ;
