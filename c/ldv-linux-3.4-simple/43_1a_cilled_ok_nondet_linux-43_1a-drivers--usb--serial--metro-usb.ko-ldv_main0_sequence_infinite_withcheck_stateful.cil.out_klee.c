...
struct metrousb_private {
   ...
   unsigned long control_state ;
    klee_make_symbolic(&control_state, sizeof(long), "control_state");
};
...
{ struct tty_struct *var_group1 ;
  ...
  int res_metrousb_open_2 ;
    klee_make_symbolic(&res_metrousb_open_2, sizeof(int), "res_metrousb_open_2");
  struct urb *var_group3 ;
  struct usb_serial *var_group4 ;
  unsigned int var_metrousb_tiocmset_8_p1 ;
    klee_make_symbolic(&var_metrousb_tiocmset_8_p1, sizeof(int), "var_metrousb_tiocmset_8_p1");
  unsigned int var_metrousb_tiocmset_8_p2 ;
    klee_make_symbolic(&var_metrousb_tiocmset_8_p2, sizeof(int), "var_metrousb_tiocmset_8_p2");
  int ldv_s_metrousb_device_usb_serial_driver ;
    klee_make_symbolic(&ldv_s_metrousb_device_usb_serial_driver, sizeof(int), "ldv_s_metrousb_device_usb_serial_driver");
  int tmp ;
  int tmp___0 ;
