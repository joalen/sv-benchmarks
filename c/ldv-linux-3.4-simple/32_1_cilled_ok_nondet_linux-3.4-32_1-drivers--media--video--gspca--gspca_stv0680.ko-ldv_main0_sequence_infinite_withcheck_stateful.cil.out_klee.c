...
struct framerates {
   u8 const   *rates ;
   int nrates ;
    klee_make_symbolic(&nrates, sizeof(int), "nrates");
};
struct gspca_ctrl {
   s16 val ;
   s16 def ;
...
struct sd_desc {
   ...
   int nctrls ;
    klee_make_symbolic(&nctrls, sizeof(int), "nctrls");
...
struct gspca_frame {
   __u8 *data ;
   int vma_use_count ;
    klee_make_symbolic(&vma_use_count, sizeof(int), "vma_use_count");
...
struct gspca_dev {
   ...
   unsigned int ctrl_dis ;
    klee_make_symbolic(&ctrl_dis, sizeof(int), "ctrl_dis");
   unsigned int ctrl_inac ;
    klee_make_symbolic(&ctrl_inac, sizeof(int), "ctrl_inac");
   __u8 *usb_buf ;
   struct urb *urb[4] ;
   struct urb *int_urb ;
   __u8 *frbuf ;
   ...
   char nframes ;
    klee_make_symbolic(&nframes, sizeof(char), "nframes");
   u8 fr_o ;
   ...
   int usb_err ;
    klee_make_symbolic(&usb_err, sizeof(int), "usb_err");
   u16 pkt_size ;
   char frozen ;
    klee_make_symbolic(&frozen, sizeof(char), "frozen");
   char present ;
    klee_make_symbolic(&present, sizeof(char), "present");
   char nbufread ;
    klee_make_symbolic(&nbufread, sizeof(char), "nbufread");
   char memory ;
    klee_make_symbolic(&memory, sizeof(char), "memory");
   __u8 iface ;
   __u8 alt ;
   u8 audio ;
};
...
static int res_sd_probe_10  ;
    klee_make_symbolic(&res_sd_probe_10, sizeof(int), "res_sd_probe_10");
void main(void) 
{ struct gspca_dev *var_group1 ;
  struct usb_device_id  const  *var_sd_config_4_p1 ;
  u8 *var_sd_pkt_scan_9_p1 ;
  int var_sd_pkt_scan_9_p2 ;
    klee_make_symbolic(&var_sd_pkt_scan_9_p2, sizeof(int), "var_sd_pkt_scan_9_p2");
  struct usb_interface *var_group2 ;
  struct usb_device_id  const  *var_sd_probe_10_p1 ;
  int ldv_s_sd_desc_sd_desc ;
    klee_make_symbolic(&ldv_s_sd_desc_sd_desc, sizeof(int), "ldv_s_sd_desc_sd_desc");
  int ldv_s_sd_driver_usb_driver ;
    klee_make_symbolic(&ldv_s_sd_driver_usb_driver, sizeof(int), "ldv_s_sd_driver_usb_driver");
  int tmp___7 ;
  int tmp___8 ;
  int __cil_tmp11 ;
  int __cil_tmp12 ;
