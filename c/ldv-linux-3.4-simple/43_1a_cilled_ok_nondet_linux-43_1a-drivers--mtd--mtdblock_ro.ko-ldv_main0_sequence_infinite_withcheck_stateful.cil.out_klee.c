...
{ struct mtd_blktrans_dev *var_group1 ;
  unsigned long var_mtdblock_readsect_0_p1 ;
    klee_make_symbolic(&var_mtdblock_readsect_0_p1, sizeof(long), "var_mtdblock_readsect_0_p1");
  char *var_mtdblock_readsect_0_p2 ;
  unsigned long var_mtdblock_writesect_1_p1 ;
    klee_make_symbolic(&var_mtdblock_writesect_1_p1, sizeof(long), "var_mtdblock_writesect_1_p1");
