...
static unsigned long asr_is_open  ;
    klee_make_symbolic(&asr_is_open, sizeof(long), "asr_is_open");
static char asr_expect_close  ;
    klee_make_symbolic(&asr_expect_close, sizeof(char), "asr_expect_close");
static unsigned int asr_type  ;
    klee_make_symbolic(&asr_type, sizeof(int), "asr_type");
static unsigned int asr_base  ;
    klee_make_symbolic(&asr_base, sizeof(int), "asr_base");
static unsigned int asr_length  ;
    klee_make_symbolic(&asr_length, sizeof(int), "asr_length");
static unsigned int asr_read_addr  ;
    klee_make_symbolic(&asr_read_addr, sizeof(int), "asr_read_addr");
static unsigned int asr_write_addr  ;
    klee_make_symbolic(&asr_write_addr, sizeof(int), "asr_write_addr");
static unsigned char asr_toggle_mask  ;
    klee_make_symbolic(&asr_toggle_mask, sizeof(char), "asr_toggle_mask");
static unsigned char asr_disable_mask  ;
    klee_make_symbolic(&asr_disable_mask, sizeof(char), "asr_disable_mask");
...
{ struct watchdog_info ident ;
  ...
  int *p ;
  int heartbeat ;
    klee_make_symbolic(&heartbeat, sizeof(int), "heartbeat");
  long tmp___0 ;
  int tmp___1 ;
  int __ret_pu ;
...
{ struct file *var_group1 ;
  ...
  unsigned int var_asr_ioctl_6_p1 ;
    klee_make_symbolic(&var_asr_ioctl_6_p1, sizeof(int), "var_asr_ioctl_6_p1");
  unsigned long var_asr_ioctl_6_p2 ;
    klee_make_symbolic(&var_asr_ioctl_6_p2, sizeof(long), "var_asr_ioctl_6_p2");
  struct inode *var_group2 ;
  int res_asr_open_7 ;
    klee_make_symbolic(&res_asr_open_7, sizeof(int), "res_asr_open_7");
  int ldv_s_asr_fops_file_operations ;
    klee_make_symbolic(&ldv_s_asr_fops_file_operations, sizeof(int), "ldv_s_asr_fops_file_operations");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
  int __cil_tmp14 ;
