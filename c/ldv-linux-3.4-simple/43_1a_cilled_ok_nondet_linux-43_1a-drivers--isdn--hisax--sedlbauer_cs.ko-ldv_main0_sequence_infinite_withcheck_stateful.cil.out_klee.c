...
{ struct pcmcia_device *var_group1 ;
  int res_sedlbauer_probe_0 ;
    klee_make_symbolic(&res_sedlbauer_probe_0, sizeof(int), "res_sedlbauer_probe_0");
  int ldv_s_sedlbauer_driver_pcmcia_driver ;
    klee_make_symbolic(&ldv_s_sedlbauer_driver_pcmcia_driver, sizeof(int), "ldv_s_sedlbauer_driver_pcmcia_driver");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
