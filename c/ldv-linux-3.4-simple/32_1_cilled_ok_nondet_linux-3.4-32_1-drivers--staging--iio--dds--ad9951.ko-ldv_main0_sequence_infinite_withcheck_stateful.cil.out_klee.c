...
static int res_ad9951_probe_2  ;
    klee_make_symbolic(&res_ad9951_probe_2, sizeof(int), "res_ad9951_probe_2");
void main(void) 
{ struct spi_device *var_group1 ;
  int ldv_s_ad9951_driver_spi_driver ;
    klee_make_symbolic(&ldv_s_ad9951_driver_spi_driver, sizeof(int), "ldv_s_ad9951_driver_spi_driver");
  int tmp___7 ;
  int tmp___8 ;
  int __cil_tmp5 ;
...
#include "model/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--staging--iio--dds--ad9951.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out.env.c"
#include <klee/klee.h>
