...
struct mtdblk_dev {
   ...
   unsigned long cache_offset ;
    klee_make_symbolic(&cache_offset, sizeof(long), "cache_offset");
...
{ struct mtd_info *mtd ;
  ...
  unsigned long sect_start ;
    klee_make_symbolic(&sect_start, sizeof(long), "sect_start");
  unsigned int offset ;
  unsigned int size ;
  size_t __len ;
  void *__ret ;
...
{ struct mtd_blktrans_dev *var_group1 ;
  int res_mtdblock_open_7 ;
    klee_make_symbolic(&res_mtdblock_open_7, sizeof(int), "res_mtdblock_open_7");
  unsigned long var_mtdblock_readsect_5_p1 ;
    klee_make_symbolic(&var_mtdblock_readsect_5_p1, sizeof(long), "var_mtdblock_readsect_5_p1");
  char *var_mtdblock_readsect_5_p2 ;
  unsigned long var_mtdblock_writesect_6_p1 ;
    klee_make_symbolic(&var_mtdblock_writesect_6_p1, sizeof(long), "var_mtdblock_writesect_6_p1");
  ...
  int ldv_s_mtdblock_tr_mtd_blktrans_ops ;
    klee_make_symbolic(&ldv_s_mtdblock_tr_mtd_blktrans_ops, sizeof(int), "ldv_s_mtdblock_tr_mtd_blktrans_ops");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
