...
{ struct cyttsp *var_group1 ;
  ...
  int res_cyttsp_spi_probe_3 ;
    klee_make_symbolic(&res_cyttsp_spi_probe_3, sizeof(int), "res_cyttsp_spi_probe_3");
  int ldv_s_cyttsp_spi_driver_spi_driver ;
    klee_make_symbolic(&ldv_s_cyttsp_spi_driver_spi_driver, sizeof(int), "ldv_s_cyttsp_spi_driver_spi_driver");
  int tmp ;
  int tmp___0 ;
  int __cil_tmp13 ;
  u8 __cil_tmp14 ;
