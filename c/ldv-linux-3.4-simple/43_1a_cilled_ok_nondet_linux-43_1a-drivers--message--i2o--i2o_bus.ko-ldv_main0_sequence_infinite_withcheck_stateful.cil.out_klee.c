...
{ struct device *var_group1 ;
  int res_i2o_bus_probe_2 ;
    klee_make_symbolic(&res_i2o_bus_probe_2, sizeof(int), "res_i2o_bus_probe_2");
  int ldv_s_i2o_bus_driver_i2o_driver ;
    klee_make_symbolic(&ldv_s_i2o_bus_driver_i2o_driver, sizeof(int), "ldv_s_i2o_bus_driver_i2o_driver");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
