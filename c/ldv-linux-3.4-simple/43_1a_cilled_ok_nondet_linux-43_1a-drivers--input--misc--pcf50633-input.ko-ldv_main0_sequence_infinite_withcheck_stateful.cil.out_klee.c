...
struct pcf50633_bl_platform_data {
   unsigned int default_brightness ;
    klee_make_symbolic(&default_brightness, sizeof(int), "default_brightness");
   unsigned int default_brightness_limit ;
    klee_make_symbolic(&default_brightness_limit, sizeof(int), "default_brightness_limit");
   uint8_t ramp_time ;
};
struct pcf50633;
struct pcf50633;
...
struct pcf50633_platform_data {
   ...
   char **batteries ;
   int num_batteries ;
    klee_make_symbolic(&num_batteries, sizeof(int), "num_batteries");
   int charger_reference_current_ma ;
    klee_make_symbolic(&charger_reference_current_ma, sizeof(int), "charger_reference_current_ma");
...
struct pcf50633 {
   ...
   u8 resume_reason[5U] ;
   int is_suspended ;
    klee_make_symbolic(&is_suspended, sizeof(int), "is_suspended");
   int onkey1s_held ;
    klee_make_symbolic(&onkey1s_held, sizeof(int), "onkey1s_held");
...
{ struct pcf50633_input *input ;
  int onkey_released ;
    klee_make_symbolic(&onkey_released, sizeof(int), "onkey_released");
  u8 tmp ;
...
{ struct platform_device *var_group1 ;
  int res_pcf50633_input_probe_1 ;
    klee_make_symbolic(&res_pcf50633_input_probe_1, sizeof(int), "res_pcf50633_input_probe_1");
  int ldv_s_pcf50633_input_driver_platform_driver ;
    klee_make_symbolic(&ldv_s_pcf50633_input_driver_platform_driver, sizeof(int), "ldv_s_pcf50633_input_driver_platform_driver");
  int tmp ;
  int tmp___0 ;
