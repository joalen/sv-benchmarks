...
struct __anonstruct_iobuff_t_399 {
   int state ;
   int in_frame ;
    klee_make_symbolic(&in_frame, sizeof(int), "in_frame");
   __u8 *head ;
   __u8 *data ;
   int len ;
   int truesize ;
...
struct sir_driver {
   ...
   char const   *driver_name ;
   int qos_mtt_bits ;
    klee_make_symbolic(&qos_mtt_bits, sizeof(int), "qos_mtt_bits");
...
struct sir_dev {
   ...
   atomic_t enable_rx ;
   int raw_tx ;
    klee_make_symbolic(&raw_tx, sizeof(int), "raw_tx");
   spinlock_t tx_lock ;
   u32 new_speed ;
   u32 flags ;
   unsigned int speed ;
...
extern unsigned int irda_debug ;
    klee_make_symbolic(&irda_debug, sizeof(int), "irda_debug");
...
static int res_act200l_open_2  ;
    klee_make_symbolic(&res_act200l_open_2, sizeof(int), "res_act200l_open_2");
void main(void) 
{ struct sir_dev *var_group1 ;
  unsigned int var_act200l_change_speed_4_p1 ;
    klee_make_symbolic(&var_act200l_change_speed_4_p1, sizeof(int), "var_act200l_change_speed_4_p1");
  int tmp___7 ;
  int ldv_s_act200l_dongle_driver ;
    klee_make_symbolic(&ldv_s_act200l_dongle_driver, sizeof(int), "ldv_s_act200l_dongle_driver");
  int tmp___8 ;
  int tmp___9 ;
  int __cil_tmp7 ;
