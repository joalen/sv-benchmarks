...
static int res_dwc3_pci_probe_0  ;
    klee_make_symbolic(&res_dwc3_pci_probe_0, sizeof(int), "res_dwc3_pci_probe_0");
void main(void) 
{ struct pci_dev *var_group1 ;
  struct pci_device_id  const  *var_dwc3_pci_probe_0_p1 ;
  int ldv_s_dwc3_pci_driver_pci_driver ;
    klee_make_symbolic(&ldv_s_dwc3_pci_driver_pci_driver, sizeof(int), "ldv_s_dwc3_pci_driver_pci_driver");
  int tmp ;
  int tmp___0 ;
  int __cil_tmp6 ;
