...
{ struct pcap_keys *pcap_keys ;
  int pirq ;
    klee_make_symbolic(&pirq, sizeof(int), "pirq");
  int tmp ;
  u32 pstat ;
...
static int res_pcap_keys_probe_1  ;
    klee_make_symbolic(&res_pcap_keys_probe_1, sizeof(int), "res_pcap_keys_probe_1");
void main(void) 
{ struct platform_device *var_group1 ;
  int var_pcap_keys_handler_0_p0 ;
    klee_make_symbolic(&var_pcap_keys_handler_0_p0, sizeof(int), "var_pcap_keys_handler_0_p0");
  void *var_pcap_keys_handler_0_p1 ;
  int ldv_s_pcap_keys_device_driver_platform_driver ;
    klee_make_symbolic(&ldv_s_pcap_keys_device_driver_platform_driver, sizeof(int), "ldv_s_pcap_keys_device_driver_platform_driver");
  int tmp ;
  int tmp___0 ;
  int __cil_tmp7 ;
