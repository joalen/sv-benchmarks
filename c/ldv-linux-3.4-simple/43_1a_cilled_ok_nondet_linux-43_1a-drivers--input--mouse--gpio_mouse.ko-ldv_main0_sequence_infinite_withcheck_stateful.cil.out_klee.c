...
struct __anonstruct_ldv_19453_148 {
   ...
   int bleft ;
    klee_make_symbolic(&bleft, sizeof(int), "bleft");
   int bmiddle ;
    klee_make_symbolic(&bmiddle, sizeof(int), "bmiddle");
   int bright ;
...
struct gpio_mouse_platform_data {
   int scan_ms ;
    klee_make_symbolic(&scan_ms, sizeof(int), "scan_ms");
   int polarity ;
...
{ struct platform_device *var_group1 ;
  int res_gpio_mouse_probe_1 ;
    klee_make_symbolic(&res_gpio_mouse_probe_1, sizeof(int), "res_gpio_mouse_probe_1");
  int ldv_s_gpio_mouse_device_driver_platform_driver ;
    klee_make_symbolic(&ldv_s_gpio_mouse_device_driver_platform_driver, sizeof(int), "ldv_s_gpio_mouse_device_driver_platform_driver");
  int tmp ;
  int tmp___0 ;
