...
struct socket_state_t {
   u_int flags ;
   u_int csc_mask ;
    klee_make_symbolic(&csc_mask, sizeof(int), "csc_mask");
   u_char Vcc ;
    klee_make_symbolic(&Vcc, sizeof(char), "Vcc");
   u_char Vpp ;
    klee_make_symbolic(&Vpp, sizeof(char), "Vpp");
   u_char io_irq ;
    klee_make_symbolic(&io_irq, sizeof(char), "io_irq");
};
typedef struct socket_state_t socket_state_t;
struct pccard_io_map {
   u_char map ;
    klee_make_symbolic(&map, sizeof(char), "map");
   u_char flags ;
   u_short speed ;
    klee_make_symbolic(&speed, sizeof(short), "speed");
   phys_addr_t start ;
   phys_addr_t stop ;
};
struct pccard_mem_map {
   ...
   u_int card_start ;
    klee_make_symbolic(&card_start, sizeof(int), "card_start");
   struct resource *res ;
};
...
struct pcmcia_socket {
   ...
   u_int suspended_state ;
    klee_make_symbolic(&suspended_state, sizeof(int), "suspended_state");
   u_short functions ;
    klee_make_symbolic(&functions, sizeof(short), "functions");
   u_short lock_count ;
    klee_make_symbolic(&lock_count, sizeof(short), "lock_count");
   ...
   unsigned int sock ;
    klee_make_symbolic(&sock, sizeof(int), "sock");
   u_int features ;
    klee_make_symbolic(&features, sizeof(int), "features");
   u_int irq_mask ;
    klee_make_symbolic(&irq_mask, sizeof(int), "irq_mask");
   u_int map_size ;
    klee_make_symbolic(&map_size, sizeof(int), "map_size");
   u_int io_offset ;
    klee_make_symbolic(&io_offset, sizeof(int), "io_offset");
   u_int pci_irq ;
   ...
   unsigned int thread_events ;
    klee_make_symbolic(&thread_events, sizeof(int), "thread_events");
   unsigned int sysfs_events ;
    klee_make_symbolic(&sysfs_events, sizeof(int), "sysfs_events");
   ...
   unsigned int pcmcia_irq ;
    klee_make_symbolic(&pcmcia_irq, sizeof(int), "pcmcia_irq");
   struct device dev ;
   void *driver_data ;
   int resume_status ;
    klee_make_symbolic(&resume_status, sizeof(int), "resume_status");
};
...
struct pcmcia_device {
   ...
   unsigned int vpp ;
    klee_make_symbolic(&vpp, sizeof(int), "vpp");
   unsigned int config_flags ;
    klee_make_symbolic(&config_flags, sizeof(int), "config_flags");
   unsigned int config_base ;
    klee_make_symbolic(&config_base, sizeof(int), "config_base");
   unsigned int config_index ;
    klee_make_symbolic(&config_index, sizeof(int), "config_index");
   unsigned int config_regs ;
    klee_make_symbolic(&config_regs, sizeof(int), "config_regs");
   unsigned int io_lines ;
    klee_make_symbolic(&io_lines, sizeof(int), "io_lines");
...
struct fault_attr {
   ...
   unsigned long interval ;
    klee_make_symbolic(&interval, sizeof(long), "interval");
   atomic_t times ;
   atomic_t space ;
...
struct mmc_command {
   ...
   unsigned int cmd_timeout_ms ;
    klee_make_symbolic(&cmd_timeout_ms, sizeof(int), "cmd_timeout_ms");
...
struct mmc_host {
   ...
   unsigned long caps ;
    klee_make_symbolic(&caps, sizeof(long), "caps");
   unsigned int caps2 ;
    klee_make_symbolic(&caps2, sizeof(int), "caps2");
   mmc_pm_flag_t pm_caps ;
   unsigned int power_notify_type ;
    klee_make_symbolic(&power_notify_type, sizeof(int), "power_notify_type");
   int clk_requests ;
   ...
   unsigned int max_discard_to ;
    klee_make_symbolic(&max_discard_to, sizeof(int), "max_discard_to");
   spinlock_t lock ;
   struct mmc_ios ios ;
   u32 ocr ;
...
struct sdricoh_host {
   ...
   int app_cmd ;
    klee_make_symbolic(&app_cmd, sizeof(int), "app_cmd");
};
...
static unsigned int switchlocked  ;
    klee_make_symbolic(&switchlocked, sizeof(int), "switchlocked");
...
{ struct sdricoh_host *host ;
  ...
  unsigned short __cil_tmp71 ;
    klee_make_symbolic(&__cil_tmp71, sizeof(short), "__cil_tmp71");
  int __cil_tmp72 ;
...
{ struct mmc_host *var_group1 ;
  ...
  int res_sdricoh_pcmcia_probe_13 ;
    klee_make_symbolic(&res_sdricoh_pcmcia_probe_13, sizeof(int), "res_sdricoh_pcmcia_probe_13");
  int ldv_s_sdricoh_driver_pcmcia_driver ;
    klee_make_symbolic(&ldv_s_sdricoh_driver_pcmcia_driver, sizeof(int), "ldv_s_sdricoh_driver_pcmcia_driver");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
