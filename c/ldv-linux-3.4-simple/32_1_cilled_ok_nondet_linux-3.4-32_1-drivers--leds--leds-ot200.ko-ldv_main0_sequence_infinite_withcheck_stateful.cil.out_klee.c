...
static int res_ot200_led_probe_1  ;
    klee_make_symbolic(&res_ot200_led_probe_1, sizeof(int), "res_ot200_led_probe_1");
void main(void) 
{ struct platform_device *var_group1 ;
  int ldv_s_ot200_led_driver_platform_driver ;
    klee_make_symbolic(&ldv_s_ot200_led_driver_platform_driver, sizeof(int), "ldv_s_ot200_led_driver_platform_driver");
  int tmp ;
  int tmp___0 ;
  int __cil_tmp5 ;
