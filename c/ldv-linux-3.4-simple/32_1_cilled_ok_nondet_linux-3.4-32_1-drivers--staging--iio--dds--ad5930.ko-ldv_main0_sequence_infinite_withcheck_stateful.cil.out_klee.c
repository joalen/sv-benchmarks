...
static int res_ad5930_probe_1  ;
    klee_make_symbolic(&res_ad5930_probe_1, sizeof(int), "res_ad5930_probe_1");
void main(void) 
{ struct spi_device *var_group1 ;
  int ldv_s_ad5930_driver_spi_driver ;
    klee_make_symbolic(&ldv_s_ad5930_driver_spi_driver, sizeof(int), "ldv_s_ad5930_driver_spi_driver");
  int tmp___7 ;
  int tmp___8 ;
  int __cil_tmp5 ;
