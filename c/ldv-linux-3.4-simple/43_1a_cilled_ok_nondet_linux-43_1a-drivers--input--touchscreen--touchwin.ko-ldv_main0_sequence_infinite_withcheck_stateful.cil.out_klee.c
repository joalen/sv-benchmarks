...
struct tw {
   ...
   int touched ;
    klee_make_symbolic(&touched, sizeof(int), "touched");
...
{ struct serio *var_group1 ;
  unsigned char var_tw_interrupt_0_p1 ;
    klee_make_symbolic(&var_tw_interrupt_0_p1, sizeof(char), "var_tw_interrupt_0_p1");
  unsigned int var_tw_interrupt_0_p2 ;
    klee_make_symbolic(&var_tw_interrupt_0_p2, sizeof(int), "var_tw_interrupt_0_p2");
  struct serio_driver *var_group2 ;
  int res_tw_connect_2 ;
    klee_make_symbolic(&res_tw_connect_2, sizeof(int), "res_tw_connect_2");
  int ldv_s_tw_drv_serio_driver ;
    klee_make_symbolic(&ldv_s_tw_drv_serio_driver, sizeof(int), "ldv_s_tw_drv_serio_driver");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
  int __cil_tmp10 ;
