...
{ 
  ...
  long __err___0 ;
    klee_make_symbolic(&__err___0, sizeof(long), "__err___0");
  struct list_head  const  *__mptr___1 ;
  int tmp___1 ;
...
{ 
  unsigned int ldvarg90 ;
    klee_make_symbolic(&ldvarg90, sizeof(int), "ldvarg90");
  unsigned int tmp ;
  unsigned long ldvarg89 ;
    klee_make_symbolic(&ldvarg89, sizeof(long), "ldvarg89");
...
{ 
  ...
  unsigned long ldvarg92 ;
    klee_make_symbolic(&ldvarg92, sizeof(long), "ldvarg92");
  unsigned long tmp___0 ;
...
static unsigned long cx231xx_devused  ;
    klee_make_symbolic(&cx231xx_devused, sizeof(long), "cx231xx_devused");
...
{ 
  ...
  int i ;
  int isoc_pipe ;
    klee_make_symbolic(&isoc_pipe, sizeof(int), "isoc_pipe");
  char *speed ;
...
{ 
  ...
  int pipe ;
  int unsend_size ;
    klee_make_symbolic(&unsend_size, sizeof(int), "unsend_size");
  u8 *pdata ;
  unsigned int tmp ;
  unsigned int tmp___0 ;
...
{ 
  int errCode ;
  int actlen ;
    klee_make_symbolic(&actlen, sizeof(int), "actlen");
  int ret ;
  u32 *buffer ;
  void *tmp ;
  size_t __len ;
...
{ 
  unsigned long pll_freq_word ;
    klee_make_symbolic(&pll_freq_word, sizeof(long), "pll_freq_word");
...
{ 
  ...
  u32 gpio_logic_value ;
  int nCnt ;
    klee_make_symbolic(&nCnt, sizeof(int), "nCnt");
  int nInit ;
    klee_make_symbolic(&nInit, sizeof(int), "nInit");
...
{ 
  u32 signature[4U] ;
  int signaturecnt ;
    klee_make_symbolic(&signaturecnt, sizeof(int), "signaturecnt");
  u32 value ;
  int i ;
  int ret ;
...
{ 
  ...
  unsigned long ldvarg120 ;
    klee_make_symbolic(&ldvarg120, sizeof(long), "ldvarg120");
...
static unsigned int pcb_debug  ;
    klee_make_symbolic(&pcb_debug, sizeof(int), "pcb_debug");
