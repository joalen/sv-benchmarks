...
static unsigned int vidioc_debug  ;
    klee_make_symbolic(&vidioc_debug, sizeof(int), "vidioc_debug");
...
{ 
  ...
  int lineoff ;
    klee_make_symbolic(&lineoff, sizeof(int), "lineoff");
  int lencopy ;
...
{ 
  ...
  int max_packets ;
    klee_make_symbolic(&max_packets, sizeof(int), "max_packets");
  int num_bufs ;
  void *tmp ;
  void *tmp___0 ;
  void *tmp___1 ;
...
{ 
  unsigned short ldvarg12 ;
    klee_make_symbolic(&ldvarg12, sizeof(short), "ldvarg12");
  unsigned short tmp ;
  unsigned short ldvarg13 ;
    klee_make_symbolic(&ldvarg13, sizeof(short), "ldvarg13");
  unsigned short tmp___0 ;
  unsigned short ldvarg11 ;
    klee_make_symbolic(&ldvarg11, sizeof(short), "ldvarg11");
