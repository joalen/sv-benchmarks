...
struct gtco {
   ...
   char usbpath[64U] ;
   int openCount ;
    klee_make_symbolic(&openCount, sizeof(int), "openCount");
   u32 usage ;
   u32 min_X ;
   u32 max_X ;
   u32 min_Y ;
...
{ 
  ...
  __u32 data32 ;
  int inputnum ;
    klee_make_symbolic(&inputnum, sizeof(int), "inputnum");
  __u32 usage ;
  __u32 globalval[12U] ;
  __u32 oldval[12U] ;
  char maintype ;
    klee_make_symbolic(&maintype, sizeof(char), "maintype");
  char globtype[12U] ;
  int indent ;
    klee_make_symbolic(&indent, sizeof(int), "indent");
  char indentstr[10U] ;
  unsigned int tmp ;
...
{ 
  ...
  long tmp___1 ;
  char buttonbyte ;
    klee_make_symbolic(&buttonbyte, sizeof(char), "buttonbyte");
  u16 tmp___2 ;
  u16 tmp___3 ;
  u16 tmp___4 ;
