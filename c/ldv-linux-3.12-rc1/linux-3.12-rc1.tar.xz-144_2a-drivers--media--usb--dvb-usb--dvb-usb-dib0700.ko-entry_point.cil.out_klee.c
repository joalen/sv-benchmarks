...
int dvb_usb_dib0700_debug  ;
    klee_make_symbolic(&dvb_usb_dib0700_debug, sizeof(int), "dvb_usb_dib0700_debug");
...
int dib0700_device_count ;
    klee_make_symbolic(&dib0700_device_count, sizeof(int), "dib0700_device_count");
...
{ 
  ...
  int i ;
  int adap_num ;
    klee_make_symbolic(&adap_num, sizeof(int), "adap_num");
  u8 *buf ;
  u32 fw_version ;
  void *tmp ;
  size_t __len ;
...
static int force_lna_activation  ;
    klee_make_symbolic(&force_lna_activation, sizeof(int), "force_lna_activation");
