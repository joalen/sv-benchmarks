...
struct esd_tx_urb_context {
   ...
   u32 echo_index ;
   int dlc ;
    klee_make_symbolic(&dlc, sizeof(int), "dlc");
};
struct esd_usb2 {
   ...
   int net_count ;
    klee_make_symbolic(&net_count, sizeof(int), "net_count");
   u32 version ;
   int rxinitdone ;
    klee_make_symbolic(&rxinitdone, sizeof(int), "rxinitdone");
};
struct esd_usb2_net_priv {
   struct can_priv can ;
...
{ 
  ...
  u32 canbtr ;
  int sjw_shift ;
    klee_make_symbolic(&sjw_shift, sizeof(int), "sjw_shift");
  void *tmp___0 ;
