...
struct bas_cardstate {
   ...
   int retry_ctrl ;
    klee_make_symbolic(&retry_ctrl, sizeof(int), "retry_ctrl");
   struct timer_list timer_atrdy ;
   struct urb *urb_cmd_out ;
   struct usb_ctrlrequest dr_cmd_out ;
   int retry_cmd_out ;
    klee_make_symbolic(&retry_cmd_out, sizeof(int), "retry_cmd_out");
   ...
   int retry_int_in ;
    klee_make_symbolic(&retry_int_in, sizeof(int), "retry_int_in");
   spinlock_t lock ;
   int basstate ;
    klee_make_symbolic(&basstate, sizeof(int), "basstate");
   int pending ;
    klee_make_symbolic(&pending, sizeof(int), "pending");
   wait_queue_head_t waitqueue ;
   int rcvbuf_size ;
    klee_make_symbolic(&rcvbuf_size, sizeof(int), "rcvbuf_size");
   int retry_cmd_in ;
    klee_make_symbolic(&retry_cmd_in, sizeof(int), "retry_cmd_in");
};
...
int ldv_timer_2_1  ;
    klee_make_symbolic(&ldv_timer_2_1, sizeof(int), "ldv_timer_2_1");
...
int ldv_timer_2_2  ;
    klee_make_symbolic(&ldv_timer_2_2, sizeof(int), "ldv_timer_2_2");
int ldv_timer_3_3  ;
    klee_make_symbolic(&ldv_timer_3_3, sizeof(int), "ldv_timer_3_3");
int ldv_timer_2_3  ;
    klee_make_symbolic(&ldv_timer_2_3, sizeof(int), "ldv_timer_2_3");
int ldv_timer_1_0  ;
...
int ldv_timer_2_0  ;
    klee_make_symbolic(&ldv_timer_2_0, sizeof(int), "ldv_timer_2_0");
int ldv_timer_1_1  ;
...
{ 
  ...
  int corrbytes ;
    klee_make_symbolic(&corrbytes, sizeof(int), "corrbytes");
  int nframe ;
    klee_make_symbolic(&nframe, sizeof(int), "nframe");
  int rc ;
  long tmp ;
  long tmp___0 ;
  long tmp___1 ;
...
{ 
  ...
  unsigned long flags ;
  int totleft ;
    klee_make_symbolic(&totleft, sizeof(int), "totleft");
  int numbytes ;
  int offset ;
  int frame ;
...
{ 
  ...
  int write ;
  int freebytes ;
    klee_make_symbolic(&freebytes, sizeof(int), "freebytes");
...
{ 
  ...
  unsigned char pbyte ;
    klee_make_symbolic(&pbyte, sizeof(char), "pbyte");
  long tmp ;
  long tmp___0 ;
  long tmp___1 ;
  long tmp___2 ;
...
{ 
  u16 stuff ;
  int shiftinc ;
    klee_make_symbolic(&shiftinc, sizeof(int), "shiftinc");
  int newones ;
    klee_make_symbolic(&newones, sizeof(int), "newones");
...
{ 
  int ones ;
    klee_make_symbolic(&ones, sizeof(int), "ones");
  u16 fcs ;
  int end ;
...
{ 
  ...
  unsigned char tabentry ;
    klee_make_symbolic(&tabentry, sizeof(char), "tabentry");
  unsigned int lead1 ;
    klee_make_symbolic(&lead1, sizeof(int), "lead1");
  unsigned int trail1 ;
    klee_make_symbolic(&trail1, sizeof(int), "trail1");
  unsigned char mask ;
  long tmp___0 ;
  long tmp___1 ;
  long tmp___2 ;
...
{ 
  struct sk_buff *skb ;
  int dobytes ;
    klee_make_symbolic(&dobytes, sizeof(int), "dobytes");
  unsigned char *dst ;
  long tmp ;
  unsigned char *tmp___0 ;
