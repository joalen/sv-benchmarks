...
struct isdnhdlc_vars {
   ...
   int hdlc_bits1 ;
    klee_make_symbolic(&hdlc_bits1, sizeof(int), "hdlc_bits1");
   int data_bits ;
    klee_make_symbolic(&data_bits, sizeof(int), "data_bits");
   int ffbit_shift ;
    klee_make_symbolic(&ffbit_shift, sizeof(int), "ffbit_shift");
   int state ;
   int dstpos ;
    klee_make_symbolic(&dstpos, sizeof(int), "dstpos");
   u16 crc ;
   u8 cbin ;
   u8 shift_reg ;
   u8 ffvalue ;
...
struct hisax_d_if {
   ...
   unsigned long ph_state ;
    klee_make_symbolic(&ph_state, sizeof(long), "ph_state");
};
struct fifo {
   u_char r ;
...
struct st5481_ctrl {
   ...
   unsigned long busy ;
    klee_make_symbolic(&busy, sizeof(long), "busy");
   struct urb *urb ;
};
struct st5481_intr {
   struct urb *urb ;
...
struct st5481_b_out {
   ...
   struct urb *urb[2U] ;
   u_char flow_event ;
    klee_make_symbolic(&flow_event, sizeof(char), "flow_event");
   u_long busy ;
   struct sk_buff *tx_skb ;
};
...
struct st5481_in {
   ...
   unsigned char ep ;
    klee_make_symbolic(&ep, sizeof(char), "ep");
...
struct st5481_adapter {
   int number_of_leds ;
    klee_make_symbolic(&number_of_leds, sizeof(int), "number_of_leds");
   ...
   unsigned char leds ;
    klee_make_symbolic(&leds, sizeof(char), "leds");
   unsigned int led_counter ;
    klee_make_symbolic(&led_counter, sizeof(int), "led_counter");
   unsigned long event ;
   struct FsmInst l1m ;
...
int st5481_debug  ;
    klee_make_symbolic(&st5481_debug, sizeof(int), "st5481_debug");
...
{ 
  struct st5481_ctrl *ctrl ;
  int r_index ;
    klee_make_symbolic(&r_index, sizeof(int), "r_index");
  int tmp ;
  int status ;
...
{ 
  struct st5481_ctrl *ctrl ;
  int w_index ;
    klee_make_symbolic(&w_index, sizeof(int), "w_index");
...
{ 
  ...
  unsigned int packet_offset ;
    klee_make_symbolic(&packet_offset, sizeof(int), "packet_offset");
  int len ;
  int buf_size ;
...
{ 
  ...
  struct st5481_d_out *d_out ;
  long buf_nr ;
    klee_make_symbolic(&buf_nr, sizeof(long), "buf_nr");
  int tmp ;
  long tmp___0 ;
