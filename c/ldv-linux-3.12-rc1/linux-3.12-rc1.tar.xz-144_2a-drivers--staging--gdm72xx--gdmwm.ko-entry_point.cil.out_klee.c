...
struct fsm_s {
   ...
   int c_status ;
    klee_make_symbolic(&c_status, sizeof(int), "c_status");
   int d_status ;
...
struct wm_req_s {
   ...
   unsigned short data_id ;
    klee_make_symbolic(&data_id, sizeof(short), "data_id");
   struct data_s data ;
};
...
struct hci_s {
   unsigned short cmd_evt ;
    klee_make_symbolic(&cmd_evt, sizeof(short), "cmd_evt");
...
typedef int pao_T_____27;
    klee_make_symbolic(&pao_T_____27, sizeof(int), "pao_T_____27");
typedef int pao_T_____28;
    klee_make_symbolic(&pao_T_____28, sizeof(int), "pao_T_____28");
...
struct usbwm_dev {
   ...
   int bw_switch ;
    klee_make_symbolic(&bw_switch, sizeof(int), "bw_switch");
   struct list_head list ;
   struct tx_cxt tx ;
   struct rx_cxt rx ;
   int padding ;
...
{ 
  int next_pos ;
    klee_make_symbolic(&next_pos, sizeof(int), "next_pos");
  __u16 tmp ;
...
{ 
  ...
  unsigned char up_down ;
    klee_make_symbolic(&up_down, sizeof(char), "up_down");
...
{ 
  ...
  int total_free ;
    klee_make_symbolic(&total_free, sizeof(int), "total_free");
  struct list_head  const  *__mptr ;
  struct list_head  const  *__mptr___0 ;
  struct list_head  const  *__mptr___1 ;
...
static int k_mode_stop  ;
    klee_make_symbolic(&k_mode_stop, sizeof(int), "k_mode_stop");
...
{ 
  ...
  int padding ;
  int no_spc ;
    klee_make_symbolic(&no_spc, sizeof(int), "no_spc");
  int ret ;
  u8 *pkt ;
  u16 cmd_evt ;
  unsigned long flags ;
...
{ 
  ...
  int len ;
  int img_len ;
    klee_make_symbolic(&img_len, sizeof(int), "img_len");
  struct firmware  const  *firm ;
  int pad_size ;
    klee_make_symbolic(&pad_size, sizeof(int), "pad_size");
  void *tmp ;
  size_t tmp___0 ;
  size_t __len ;
  void *__ret ;
