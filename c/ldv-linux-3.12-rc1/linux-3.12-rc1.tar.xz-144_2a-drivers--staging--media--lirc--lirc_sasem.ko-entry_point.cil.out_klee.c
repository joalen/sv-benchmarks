...
struct sasem_context {
   struct usb_device *dev ;
   int vfd_isopen ;
    klee_make_symbolic(&vfd_isopen, sizeof(int), "vfd_isopen");
   unsigned int vfd_contrast ;
    klee_make_symbolic(&vfd_contrast, sizeof(int), "vfd_contrast");
   int ir_isopen ;
   ...
   char lastcode[8U] ;
   int codesaved ;
    klee_make_symbolic(&codesaved, sizeof(int), "codesaved");
};
...
{ 
  ...
  int retval ;
  int vfd_ep_found ;
    klee_make_symbolic(&vfd_ep_found, sizeof(int), "vfd_ep_found");
  int ir_ep_found ;
