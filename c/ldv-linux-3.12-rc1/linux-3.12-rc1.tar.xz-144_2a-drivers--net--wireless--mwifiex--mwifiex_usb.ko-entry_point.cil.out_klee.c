...
struct usb_card_rec {
   ...
   int bulk_out_maxpktsize ;
    klee_make_symbolic(&bulk_out_maxpktsize, sizeof(int), "bulk_out_maxpktsize");
   struct urb_context tx_cmd ;
   int tx_data_ix ;
    klee_make_symbolic(&tx_data_ix, sizeof(int), "tx_data_ix");
...
{ 
  ...
  int recv_length ;
    klee_make_symbolic(&recv_length, sizeof(int), "recv_length");
  int size ;
  int status ;
  struct _ddebug descriptor ;
  long tmp ;
