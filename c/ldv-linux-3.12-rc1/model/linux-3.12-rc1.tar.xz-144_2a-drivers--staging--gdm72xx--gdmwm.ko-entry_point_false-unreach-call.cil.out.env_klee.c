...
// Function: netdev_emerg
// with type: int netdev_emerg(const struct net_device *, const char *, ...)
// with return type: int
int __VERIFIER_nondet_int(void);
...
// Function: netlink_kernel_release
// with type: void netlink_kernel_release(struct sock *)
// with return type: void
