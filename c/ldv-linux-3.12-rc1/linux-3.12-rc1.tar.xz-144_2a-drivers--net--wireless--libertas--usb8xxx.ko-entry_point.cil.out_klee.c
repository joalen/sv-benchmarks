...
struct if_usb_card {
   ...
   int8_t bootcmdresp ;
   int ep_in_size ;
    klee_make_symbolic(&ep_in_size, sizeof(int), "ep_in_size");
   void *ep_out_buf ;
   int ep_out_size ;
    klee_make_symbolic(&ep_out_size, sizeof(int), "ep_out_size");
...
{ 
  ...
  struct lbs_private *priv ;
  int recvlength ;
    klee_make_symbolic(&recvlength, sizeof(int), "recvlength");
  uint8_t *recvbuff ;
  uint32_t recvtype ;
  __le32 *pkt ;
  uint32_t event ;
...
{ 
  ...
  int i ;
  int reset_count ;
    klee_make_symbolic(&reset_count, sizeof(int), "reset_count");
  struct thread_info *tmp ;
  int tmp___0 ;
  char const   *tmp___1 ;
  struct thread_info *tmp___2 ;
