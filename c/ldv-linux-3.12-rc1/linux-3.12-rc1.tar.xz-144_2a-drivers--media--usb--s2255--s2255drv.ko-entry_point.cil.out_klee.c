...
struct s2255_framei {
   ...
   unsigned long ulState ;
    klee_make_symbolic(&ulState, sizeof(long), "ulState");
   void *lpvbits ;
   unsigned long cur_size ;
    klee_make_symbolic(&cur_size, sizeof(long), "cur_size");
};
struct s2255_bufferi {
   unsigned long dwFrames ;
    klee_make_symbolic(&dwFrames, sizeof(long), "dwFrames");
...
struct s2255_fw {
   int fw_loaded ;
    klee_make_symbolic(&fw_loaded, sizeof(int), "fw_loaded");
   int fw_size ;
...
struct s2255_channel {
   ...
   unsigned int jpegqual ;
    klee_make_symbolic(&jpegqual, sizeof(int), "jpegqual");
   struct v4l2_captureparm cap_parm ;
   int cur_frame ;
    klee_make_symbolic(&cur_frame, sizeof(int), "cur_frame");
   int last_frame ;
    klee_make_symbolic(&last_frame, sizeof(int), "last_frame");
   int b_acquire ;
    klee_make_symbolic(&b_acquire, sizeof(int), "b_acquire");
   unsigned long req_image_size ;
    klee_make_symbolic(&req_image_size, sizeof(long), "req_image_size");
   unsigned long pkt_size ;
    klee_make_symbolic(&pkt_size, sizeof(long), "pkt_size");
   int bad_payload ;
    klee_make_symbolic(&bad_payload, sizeof(int), "bad_payload");
   unsigned long frame_count ;
    klee_make_symbolic(&frame_count, sizeof(long), "frame_count");
   int jpg_size ;
    klee_make_symbolic(&jpg_size, sizeof(int), "jpg_size");
   int configured ;
    klee_make_symbolic(&configured, sizeof(int), "configured");
   wait_queue_head_t wait_setmode ;
   int setmode_ready ;
    klee_make_symbolic(&setmode_ready, sizeof(int), "setmode_ready");
   int vidstatus ;
    klee_make_symbolic(&vidstatus, sizeof(int), "vidstatus");
   wait_queue_head_t wait_vidstatus ;
   int vidstatus_ready ;
    klee_make_symbolic(&vidstatus_ready, sizeof(int), "vidstatus_ready");
   unsigned int width ;
   unsigned int height ;
...
struct s2255_dev {
   ...
   u32 cc ;
   int frame_ready ;
    klee_make_symbolic(&frame_ready, sizeof(int), "frame_ready");
   int chn_ready ;
    klee_make_symbolic(&chn_ready, sizeof(int), "chn_ready");
   spinlock_t slock ;
   int dsp_fw_ver ;
    klee_make_symbolic(&dsp_fw_ver, sizeof(int), "dsp_fw_ver");
   u16 pid ;
};
struct s2255_fmt {
   char *name ;
...
{ 
  ...
  struct s2255_channel *channel ;
  int is_ntsc ;
    klee_make_symbolic(&is_ntsc, sizeof(int), "is_ntsc");
...
{ 
  int linesPerFrame ;
    klee_make_symbolic(&linesPerFrame, sizeof(int), "linesPerFrame");
  int pixelsPerLine ;
    klee_make_symbolic(&pixelsPerLine, sizeof(int), "pixelsPerLine");
  u32 outImageSize ;
  u32 usbInSize ;
  unsigned int mask_mult ;
    klee_make_symbolic(&mask_mult, sizeof(int), "mask_mult");
...
{ 
  ...
  unsigned long chn_rev ;
    klee_make_symbolic(&chn_rev, sizeof(long), "chn_rev");
  struct s2255_dev *dev ;
  struct s2255_dev *tmp ;
  int i ;
  u32 tmp___0 ;
...
{ 
  ...
  struct s2255_mode mode ;
  int fdec ;
    klee_make_symbolic(&fdec, sizeof(int), "fdec");
  __u32 def_num ;
  __u32 def_dem ;
  int tmp ;
...
{ 
  ...
  int i ;
  int cur_nr ;
    klee_make_symbolic(&cur_nr, sizeof(int), "cur_nr");
  struct s2255_channel *channel ;
...
{ 
  ...
  u32 offset ;
  int bframe ;
    klee_make_symbolic(&bframe, sizeof(int), "bframe");
  char *psrc ;
  ...
  __le32 *pdword ;
  int payload ;
    klee_make_symbolic(&payload, sizeof(int), "payload");
  size_t __len ;
  void *__ret ;
...
{ 
  int fw ;
    klee_make_symbolic(&fw, sizeof(int), "fw");
  int ret ;
...
{ 
  ...
  unsigned long reqsize ;
    klee_make_symbolic(&reqsize, sizeof(long), "reqsize");
...
{ 
  ...
  int fw_ver ;
    klee_make_symbolic(&fw_ver, sizeof(int), "fw_ver");
  int j ;
  struct s2255_pipeinfo *pipe ;
  void *tmp ;
  struct s2255_channel *channel ;
