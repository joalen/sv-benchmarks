...
struct stk_sio_buffer {
   ...
   char *buffer ;
   int mapcount ;
    klee_make_symbolic(&mapcount, sizeof(int), "mapcount");
...
struct stk_camera {
   ...
   int webcam_model ;
    klee_make_symbolic(&webcam_model, sizeof(int), "webcam_model");
   struct file *owner ;
   struct mutex lock ;
   int first_init ;
    klee_make_symbolic(&first_init, sizeof(int), "first_init");
   u8 isoc_ep ;
   atomic_t urbs_used ;
   ...
   int reading ;
    klee_make_symbolic(&reading, sizeof(int), "reading");
   unsigned int n_sbufs ;
    klee_make_symbolic(&n_sbufs, sizeof(int), "n_sbufs");
...
{ 
  ...
  int ret ;
  int value_116 ;
    klee_make_symbolic(&value_116, sizeof(int), "value_116");
  int value_117 ;
    klee_make_symbolic(&value_117, sizeof(int), "value_117");
  int tmp ;
...
{ 
  int i ;
  int tmpval ;
    klee_make_symbolic(&tmpval, sizeof(int), "tmpval");
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
  int tmp___2 ;
...
{ 
  int com7 ;
    klee_make_symbolic(&com7, sizeof(int), "com7");
  unsigned int dummylines ;
    klee_make_symbolic(&dummylines, sizeof(int), "dummylines");
  int flip ;
