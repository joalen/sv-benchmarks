...
signed int __main(signed int argc, char **argv)
{
  ...
  else
  {
    ...
    klee_make_symbolic(&which_cal, sizeof(int), "which_cal");
    unsigned int week_len;
    klee_make_symbolic(&week_len, sizeof(int), "week_len");
...
static void day_array(unsigned int month, unsigned int year, unsigned int *days)
{
  ...
  unsigned int day;
  unsigned int dw;
    klee_make_symbolic(&dw, sizeof(int), "dw");
  unsigned int dm;
    klee_make_symbolic(&dm, sizeof(int), "dm");
...
static void trim_trailing_spaces_and_print(char *s)
{
  ...
  while(!(p == s))
  {
    ...
    klee_make_symbolic(&bb__isspace, sizeof(char), "bb__isspace");
