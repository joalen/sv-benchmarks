...
__CPROVER_DUMP_L4:
  ...
  if(!(src_fd < 0))
  {
    ...
    {
      signed long int rd;
    klee_make_symbolic(&rd, sizeof(int), "rd");
      ...
      {
        signed long int wr;
    klee_make_symbolic(&wr, sizeof(int), "wr");
...
static signed int bb_make_directory(char *path, signed long int mode, signed int flags)
{
  unsigned int cur_mask;
    klee_make_symbolic(&cur_mask, sizeof(int), "cur_mask");
  unsigned int org_mask;
    klee_make_symbolic(&org_mask, sizeof(int), "org_mask");
  const char *fail_msg;
  char *s;
  char c;
  ...
  while((_Bool)1)
  {
    ...
    klee_make_symbolic(&new_mask, sizeof(int), "new_mask");
...
static signed int copy_file(const char *source, const char *dest, signed int flags)
{
  ...
  signed char ovr;
    klee_make_symbolic(&ovr, sizeof(char), "ovr");
  signed int return_value;
    klee_make_symbolic(&return_value, sizeof(int), "return_value");
  ...
  make_links:
    ...
    klee_make_symbolic(&return_value_2, sizeof(int), "return_value_2");
    ...
    klee_make_symbolic(&return_value_1, sizeof(int), "return_value_1");
  ...
  __CPROVER_DUMP_L25:
    ;
    signed int src_fd;
    klee_make_symbolic(&src_fd, sizeof(int), "src_fd");
    signed int dst_fd;
    klee_make_symbolic(&dst_fd, sizeof(int), "dst_fd");
    unsigned int new_mode;
    klee_make_symbolic(&new_mode, sizeof(int), "new_mode");
    if((258 & flags) == 0)
    {
...
signed int __main(signed int argc, char **argv)
{
  ...
  const char *dest;
  signed int s_flags;
    klee_make_symbolic(&s_flags, sizeof(int), "s_flags");
  signed int d_flags;
