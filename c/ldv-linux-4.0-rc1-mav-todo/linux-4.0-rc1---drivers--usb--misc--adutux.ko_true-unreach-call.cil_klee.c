...
struct adu_device {
   ...
   int read_buffer_length ;
    klee_make_symbolic(&read_buffer_length, sizeof(int), "read_buffer_length");
   char *read_buffer_secondary ;
   int secondary_head ;
    klee_make_symbolic(&secondary_head, sizeof(int), "secondary_head");
   int secondary_tail ;
    klee_make_symbolic(&secondary_tail, sizeof(int), "secondary_tail");
   spinlock_t buflock ;
   ...
   int read_urb_finished ;
    klee_make_symbolic(&read_urb_finished, sizeof(int), "read_urb_finished");
   char *interrupt_out_buffer ;
   struct usb_endpoint_descriptor *interrupt_out_endpoint ;
   struct urb *interrupt_out_urb ;
   int out_urb_finished ;
    klee_make_symbolic(&out_urb_finished, sizeof(int), "out_urb_finished");
};
...
{ 
  ...
  int timeout ;
  int should_submit ;
    klee_make_symbolic(&should_submit, sizeof(int), "should_submit");
  unsigned long flags ;
  wait_queue_t wait ;
  ...
  int data_in_secondary ;
    klee_make_symbolic(&data_in_secondary, sizeof(int), "data_in_secondary");
  struct _ddebug descriptor___1 ;
  long tmp___3 ;
  int amount ;
...
{ 
  ...
  int retval ;
  int in_end_size ;
    klee_make_symbolic(&in_end_size, sizeof(int), "in_end_size");
  int out_end_size ;
    klee_make_symbolic(&out_end_size, sizeof(int), "out_end_size");
  int i ;
  void *tmp___0 ;
