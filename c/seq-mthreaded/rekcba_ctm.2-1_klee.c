...
unsigned char __startrek_hidden_nxtcolorsensor_data_mode  ;
    klee_make_symbolic(&__startrek_hidden_nxtcolorsensor_data_mode, sizeof(char), "__startrek_hidden_nxtcolorsensor_data_mode");
...
unsigned char __startrek_hidden_nxtcolorsensor_mode  ;
    klee_make_symbolic(&__startrek_hidden_nxtcolorsensor_mode, sizeof(char), "__startrek_hidden_nxtcolorsensor_mode");
...
{ 
  unsigned char diff ;
  char prev_speed ;
    klee_make_symbolic(&prev_speed, sizeof(char), "prev_speed");
  int tmp ;
...
{ 
  unsigned short color ;
    klee_make_symbolic(&color, sizeof(short), "color");
  unsigned char tmp ;
  _Bool tmp___0 ;
  _Bool tmp___1 ;
