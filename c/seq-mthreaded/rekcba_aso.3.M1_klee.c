...
unsigned char __startrek_task  ;
    klee_make_symbolic(&__startrek_task, sizeof(char), "__startrek_task");
unsigned char __startrek_job  ;
    klee_make_symbolic(&__startrek_job, sizeof(char), "__startrek_job");
unsigned char __startrek_job_end  ;
    klee_make_symbolic(&__startrek_job_end, sizeof(char), "__startrek_job_end");
unsigned char __startrek_error_round  ;
    klee_make_symbolic(&__startrek_error_round, sizeof(char), "__startrek_error_round");
...
unsigned char __startrek_hyper_period  ;
    klee_make_symbolic(&__startrek_hyper_period, sizeof(char), "__startrek_hyper_period");
...
static unsigned int ud_err_theta  ;
    klee_make_symbolic(&ud_err_theta, sizeof(int), "ud_err_theta");
static unsigned int ud_psi  ;
    klee_make_symbolic(&ud_psi, sizeof(int), "ud_psi");
static unsigned int ud_theta_lpf  ;
    klee_make_symbolic(&ud_theta_lpf, sizeof(int), "ud_theta_lpf");
static unsigned int ud_theta_ref  ;
    klee_make_symbolic(&ud_theta_ref, sizeof(int), "ud_theta_ref");
static unsigned int ud_thetadot_cmd_lpf  ;
    klee_make_symbolic(&ud_thetadot_cmd_lpf, sizeof(int), "ud_thetadot_cmd_lpf");
extern unsigned int A_D ;
    klee_make_symbolic(&A_D, sizeof(int), "A_D");
extern unsigned int A_R ;
    klee_make_symbolic(&A_R, sizeof(int), "A_R");
extern unsigned int K_F[4] ;
extern unsigned int K_I ;
    klee_make_symbolic(&K_I, sizeof(int), "K_I");
extern unsigned int K_PHIDOT ;
    klee_make_symbolic(&K_PHIDOT, sizeof(int), "K_PHIDOT");
extern unsigned int K_THETADOT ;
    klee_make_symbolic(&K_THETADOT, sizeof(int), "K_THETADOT");
...
{ 
  unsigned int tmp_theta ;
    klee_make_symbolic(&tmp_theta, sizeof(int), "tmp_theta");
  unsigned int tmp_theta_lpf ;
    klee_make_symbolic(&tmp_theta_lpf, sizeof(int), "tmp_theta_lpf");
  unsigned int tmp_pwm_r_limiter ;
    klee_make_symbolic(&tmp_pwm_r_limiter, sizeof(int), "tmp_pwm_r_limiter");
  unsigned int tmp_psidot ;
    klee_make_symbolic(&tmp_psidot, sizeof(int), "tmp_psidot");
  unsigned int tmp_pwm_turn ;
    klee_make_symbolic(&tmp_pwm_turn, sizeof(int), "tmp_pwm_turn");
  unsigned int tmp_pwm_l_limiter ;
    klee_make_symbolic(&tmp_pwm_l_limiter, sizeof(int), "tmp_pwm_l_limiter");
  unsigned int tmp_thetadot_cmd_lpf ;
    klee_make_symbolic(&tmp_thetadot_cmd_lpf, sizeof(int), "tmp_thetadot_cmd_lpf");
  unsigned int tmp[4] ;
  unsigned int tmp_theta_0[4] ;
  int tmp_0 ;
    klee_make_symbolic(&tmp_0, sizeof(int), "tmp_0");
  int tmp___0 ;
  int tmp___1 ;
...
static unsigned int gyro_offset  ;
    klee_make_symbolic(&gyro_offset, sizeof(int), "gyro_offset");
static unsigned int avg_cnt  ;
    klee_make_symbolic(&avg_cnt, sizeof(int), "avg_cnt");
static unsigned int cal_start_time  ;
    klee_make_symbolic(&cal_start_time, sizeof(int), "cal_start_time");
static char task_cmd_forward  ;
    klee_make_symbolic(&task_cmd_forward, sizeof(char), "task_cmd_forward");
static char task_cmd_turn  ;
    klee_make_symbolic(&task_cmd_turn, sizeof(char), "task_cmd_turn");
void OSEK_Task_ts1(void) ;
static unsigned char saved_version  =    0;
void OSEK_Task_ts1(void) 
{ 
  char pwm_l ;
    klee_make_symbolic(&pwm_l, sizeof(char), "pwm_l");
  char pwm_r ;
    klee_make_symbolic(&pwm_r, sizeof(char), "pwm_r");
  _Bool lobstacle ;
  unsigned char tmp ;
  ...
  unsigned char lversion ;
    klee_make_symbolic(&lversion, sizeof(char), "lversion");
...
{ 
  char sp ;
    klee_make_symbolic(&sp, sizeof(char), "sp");
  char tmp ;
  char tmp___0 ;
...
{ 
  _Bool c1 ;
  unsigned char o2 ;
    klee_make_symbolic(&o2, sizeof(char), "o2");
...
{ 
  ...
  _Bool c2 ;
  unsigned char or3 ;
    klee_make_symbolic(&or3, sizeof(char), "or3");
